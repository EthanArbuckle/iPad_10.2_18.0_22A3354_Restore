...
LABEL_18:
  ...
  do
  {
    ...
    do
    {
      ...
      if (v17)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138545154;
          ...
          v73 = 2048;
          v74 = v17;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] Service %@ Characteristic %@/%@: value %@, delay %lu", buf, 0x52u);
      ...
      objc_msgSend(MEMORY[0x1E0D16428], "responseTupleForCharacteristic:error:", v15, 0);
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v65 = 2048;
    v66 = v12;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] Delaying read-response by %lu", buf, 0x2Au);

  }
  objc_autoreleasePoolPop(v27);
  v32 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, v38);
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x1E0D16428], "responseTupleForCharacteristic:error:", *(_QWORD *)(*((_QWORD *)&v23 + 1) + 8 * v16), 0);
...
- (void)_parseAttributeDatabase:(id)a3
{
  ...
  v4 = a3;
  v5 = *MEMORY[0x1E0D15EA0];
  objc_msgSend(v4, "objectForKeyedSubscript:", *MEMORY[0x1E0D15EA0]);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v59 = 2112;
    v60 = v32;
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@[HMDAccessoryServerDemo %@] No accessory objects found in the attribute database", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v29);
  v33 = objc_alloc(MEMORY[0x1E0CB35C8]);
  v14 = (void *)objc_msgSend(v33, "initWithDomain:code:userInfo:", *MEMORY[0x1E0D160B0], -6727, 0);
  if (!v14)
  {
LABEL_36:
    objc_opt_class();
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v64 = v11;
      v12 = v11;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@[HMDAccessoryServerDemo %@] Expected the value of '%@' to be an array in the attribute database, instead it is a %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v7);
    v13 = objc_alloc(MEMORY[0x1E0CB35C8]);
    v14 = (void *)objc_msgSend(v13, "initWithDomain:code:userInfo:", *MEMORY[0x1E0D160B0], -6727, 0);
    if (!v14)
    {
LABEL_6:
      v47 = v4;
      ...
      if (v16)
      {
        ...
        while (2)
        {
          ...
          do
          {
            if (*(_QWORD *)v53 != v19)
              objc_enumerationMutation(obj);
            objc_msgSend(MEMORY[0x1E0D163F0], "_parseSerializedAccessoryDictionary:server:", *(_QWORD *)(*((_QWORD *)&v52 + 1) + 8 * v21), self, v46);
            ...
            if (!v18)
            {
              ...
              if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v59 = 2112;
                v60 = v37;
                _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@[HMDAccessoryServerDemo %@] Unable to parse serialized accessory", buf, 0x16u);

              }
              objc_autoreleasePoolPop(v34);
              v38 = objc_alloc(MEMORY[0x1E0CB35C8]);
              v14 = (void *)objc_msgSend(v38, "initWithDomain:code:userInfo:", *MEMORY[0x1E0D160B0], -6742, 0);
              goto LABEL_30;
            }
            ...
            if (v27)
            {
              ...
              if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v59 = 2112;
                v60 = v42;
                _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@[HMDAccessoryServerDemo %@] Accessory Server has accessory with duplicate instance ID", buf, 0x16u);

              }
              objc_autoreleasePoolPop(v39);
              v43 = objc_alloc(MEMORY[0x1E0CB35C8]);
              v14 = (void *)objc_msgSend(v43, "initWithDomain:code:userInfo:", *MEMORY[0x1E0D160B0], -6742, 0);
  ...
  if (a3)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v43 = 2048;
      v44 = a3;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] Delaying %@-response by %lu", buf, 0x34u);
    ...
    v23 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, v13);
...
LABEL_19:
  ...
  do
  {
    for (i = 0; i != v47; ++i)
    {
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138545154;
          ...
          v74 = 2048;
          v75 = v16;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] Service %@ Characteristic %@/%@: value %@, delay %lu", buf, 0x52u);
      ...
      objc_msgSend(MEMORY[0x1E0D16428], "responseTupleForCharacteristic:error:", v14, 0);
      v25 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v66 = 2048;
    v67 = v48;
    _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] Delaying write-response by %lu", buf, 0x2Au);

  }
  objc_autoreleasePoolPop(v26);
  v31 = dispatch_source_create(MEMORY[0x1E0C80DD0], 0, 0, v37);
...
- (void)processCharacteristicWrite:(id)a3 value:(id)a4
{
  ...
  v9 = objc_msgSend(v8, "isEqualToString:", *MEMORY[0x1E0D16048]);

  if (v9)
  {
    __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F20]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v95 = v10;
    v11 = (double *)&unk_1CDB8E000;
    if (v10)
      goto LABEL_6;
LABEL_56:
    v95 = 0;
  ...
  v13 = objc_msgSend(v12, "isEqualToString:", *MEMORY[0x1E0D16028]);

  if (v13)
  {
    __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F00]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v95 = v10;
    v11 = (double *)&unk_1CDB8E000;
    if (v10)
  ...
  objc_msgSend(v5, "type");
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = objc_msgSend(v26, "isEqualToString:", *MEMORY[0x1E0D16038]);

  if (v27)
  {
    __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F10]);
    v95 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v93, "characteristicsOfType:", *MEMORY[0x1E0D15F40]);
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v28, "firstObject");
    v29 = (void *)objc_claimAutoreleasedReturnValue();

    __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D16068]);
    v30 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v95)
    {
...
LABEL_15:
  ...
  v36 = objc_msgSend(v35, "isEqualToString:", *MEMORY[0x1E0D16068]);

  if (v36)
  {
    __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F40]);
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    v95 = v37;
    v11 = (double *)&unk_1CDB8E000;
    if (v37)
    {
      ...
      if (v39)
        goto LABEL_7;
      objc_msgSend(v93, "characteristicsOfType:", *MEMORY[0x1E0D15F10]);
      v40 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v5, "type");
  v47 = (void *)objc_claimAutoreleasedReturnValue();
  v48 = objc_msgSend(v47, "isEqualToString:", *MEMORY[0x1E0D16058]);

  if (v48)
  {
    __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F30]);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v95 = v10;
    v11 = (double *)&unk_1CDB8E000;
    if (!v10)
  ...
  else
  {
    objc_msgSend(v5, "type");
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    v50 = objc_msgSend(v49, "isEqualToString:", *MEMORY[0x1E0D16060]);

    if (v50)
    {
      __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F38]);
...
LABEL_18:
    ...
    v61 = objc_msgSend(v60, "isEqualToString:", *MEMORY[0x1E0D16050]);

    if (v61)
    {
      __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F28]);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v95 = v10;
      v11 = (double *)&unk_1CDB8E000;
      if (!v10)
    ...
    else
    {
      ...
      v68 = objc_msgSend(v67, "isEqualToString:", *MEMORY[0x1E0D16040]);

      if (v68)
      {
        __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F18]);
        v10 = (void *)objc_claimAutoreleasedReturnValue();
        v95 = v10;
        v11 = (double *)&unk_1CDB8E000;
        if (!v10)
      ...
      else
      {
        ...
        v84 = objc_msgSend(v83, "isEqualToString:", *MEMORY[0x1E0D16078]);

        if (v84)
        {
          __findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F50]);
          v10 = (void *)objc_claimAutoreleasedReturnValue();
          v95 = v10;
          v11 = (double *)&unk_1CDB8E000;
          if (v10)
        ...
        v89 = objc_msgSend(v88, "isEqualToString:", *MEMORY[0x1E0D15EC8]);

        v11 = (double *)&unk_1CDB8E000;
        v16 = 1.1;
        if (!v89
          || (__findAssociatedCharacteristicWithService(v93, *MEMORY[0x1E0D15F70]),
              v10 = (void *)objc_claimAutoreleasedReturnValue(),
              (v95 = v10) == 0))
        {
          v95 = 0;
...
LABEL_8:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    v110 = 2112;
    v111 = v25;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] responseDelay set to %lu for current state characteristic %@/%@ - bypassing processing effects...", buf, 0x3Eu);
...
LABEL_57:
  ...
  {
    v85 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99DE8]), "initWithCapacity:", objc_msgSend(v94, "count"));
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v28 = 2112;
      v29 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Failed to save public for accessory %@/%@ - error %@", buf, 0x2Au);
...
- (void)addPairing:(id)a3 completionQueue:(id)a4 completionHandler:(id)a5
{
  ...
  if (v7)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D160B0], -6702, 0);
      v10 = (void *)objc_claimAutoreleasedReturnValue();
    }
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v31 = 2112;
      v32 = v11;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Failed to remove public key for accessory %@/%@- error %@", buf, 0x2Au);
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x1E0C99D68], "date", (_QWORD)v13);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
...
uint64_t __104__HMDAccessoryServerDemo_sendDelayedResponse_responses_readOperation_completionQueue_completionHandler___block_invoke_14(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_1CD062000, v3, OS_LOG_TYPE_INFO, "%{public}@[HMDAccessoryServerDemo %@/%@] Sending %@-response", (uint8_t *)&v11, 0x2Au);
