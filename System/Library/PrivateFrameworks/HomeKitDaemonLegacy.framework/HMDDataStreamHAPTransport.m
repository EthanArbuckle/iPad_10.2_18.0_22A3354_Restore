...
- (void)connect
{
  ...
  if (-[HMDDataStreamHAPTransport _isRunning](self, "_isRunning"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-running transport", (uint8_t *)&v26, 0xCu);
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      if (v9)
      {
        ...
        if (v10)
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            v26 = 138543362;
            v27 = v15;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@[Connect] All good; connected!",
              (uint8_t *)&v26,
              0xCu);
        ...
        else
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
          {
            ...
            v26 = 138543362;
            v27 = v24;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Connect] Missing characteristics to create transport for HDS over HAP (Interrupt Characteristic does not exist)", (uint8_t *)&v26, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          v26 = 138543362;
          v27 = v23;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Connect] Missing characteristics to create transport for HDS over HAP (Transport Characteristic does not exist)", (uint8_t *)&v26, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v26 = 138543362;
        v27 = v19;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Connect called but accessory is no longer valid", (uint8_t *)&v26, 0xCu);
...
- (void)close
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@DataStream transport closing.", (uint8_t *)&v10, 0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket invoked closed but nothing to clean up.", (uint8_t *)&v10, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)&location[4] = v11;
        v18 = 2112;
        v19 = v6;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: Closing after session force close failed; error=%@",
          location,
          0x16u);
...
- (void)_registerForMessages
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "isResidentFirstAccessoryCommunicationEnabled");

  if (v6)
  {
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v7, "addObserver:selector:name:object:", self, sel__handleCharacteristicsValueUpdated_, CFSTR("HMDAccessoryCharacteristicsChangedNotification"), v3);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Error: unable to deregister from event notifications on accessory (its weak pointer went to nil)", buf, 0xCu);
...
LABEL_11:
        ...
        if (v8)
        {
          objc_msgSend(MEMORY[0x1E0C99DF0], "dataWithData:", v8);
...
- (id)_buildWriteRequestWithError:(id *)a3 shouldForceClose:(BOOL)a4
{
  ...
  {
LABEL_5:
    v8 = objc_alloc(MEMORY[0x1E0D16610]);
    ...
    v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16498]), "initWithPayload:sessionIdentifier:forceClose:", v7, v10, v13);
    ...
    if (v16)
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 138543362;
        v31 = v21;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Error: failed to serialize Controller Payload; should not happen!",
          (uint8_t *)&v30,
          0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Writing: %u bytes (rts=%d)", (uint8_t *)&v30, 0x18u);
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
  {
    ...
    v30 = 138543362;
    v31 = v29;
    _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Writing: nothing to write", (uint8_t *)&v30, 0xCu);
...
- (void)_writeCharacteristicRequests:(id)a3 completion:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v9, "isResidentFirstAccessoryCommunicationEnabled"))
  {
    objc_msgSend(MEMORY[0x1E0CB3A28], "UUID");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v12[0] = MEMORY[0x1E0C809B0];
    ...
    v14 = v7;
    v13 = v6;
    objc_msgSend(v9, "writeCharacteristicValues:source:identifier:qualityOfService:withCompletionHandler:", v13, 7, v10, -1, v12);
  ...
  else
  {
    -[HMDDataStreamHAPTransport workQueue](self, "workQueue");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "writeCharacteristicValues:source:queue:completionHandler:", v6, 7, v11, v7);
  ...
  if (!-[HMDDataStreamHAPTransport isWriteInProgress](self, "isWriteInProgress"))
  {
    ...
    if (-[HMDDataStreamHAPTransport _isRunning](self, "_isRunning"))
    {
      ...
      if (v5)
      {
        ...
        if (v7)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v27 = v11;
            _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: building next payload failed and should not do that; closing.",
              buf,
              0xCu);

          }
          objc_autoreleasePoolPop(v8);
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:underlyingError:", 1052, v7);
          v12 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v27 = v20;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: HAPAccessory is no longer active; closing.",
            buf,
            0xCu);

        }
        objc_autoreleasePoolPop(v17);
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2100);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v16;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: transport already closed.", buf, 0xCu);
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v58 = 2112;
      v59 = v4;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@[Transport] Handling responses: %@", buf, 0x16u);
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v58 = 2112;
          v59 = v28;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Write response errored out: %@", buf, 0x16u);
      ...
      if (v37 || !v36)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v58 = 2112;
          v59 = v37;
          _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply could not be parsed (error=%@)", buf, 0x16u);
...
LABEL_21:
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v57 = v33;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Write-response contained no response; weird. Erroring out.",
          buf,
          0xCu);
...
LABEL_24:
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v21;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Write-response returned but nothing in progress; stale reply? Ignoring",
        buf,
        0xCu);
...
- (void)_stopTransportForWriteFailureError:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:underlyingError:", 1061, a3);
...
- (void)_handleReceivedData:(id)a3
{
  ...
  if ((v10 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@DataStream has encountered irrecoverable framing issue. Closing stream.", (uint8_t *)&v22, 0xCu);
...
- (void)_handleInterruptCharacteristicValue:(id)a3
{
  ...
  {
    v29 = 0;
    objc_msgSend(MEMORY[0x1E0D164A8], "parsedFromData:error:", v8, &v29);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v29;
    if (v10 || !v9)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 2112;
        v33 = v10;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Interrupt] The interrupt value could not be parsed (error=%@)", buf, 0x16u);
    ...
    else
    {
      ...
      if (v17)
      {
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v32 = 1024;
          LODWORD(v33) = v16;
          _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@[Interrupt] The interrupt value contains valid accessory Request To Send (0x%x)", buf, 0x12u);
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v32 = 1024;
        LODWORD(v33) = v16;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEBUG, "%{public}@[Interrupt] The interrupt value does not contain any Request To Send (0x%x)", buf, 0x12u);
...
LABEL_19:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v31 = v26;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@[Interrupt] Received interrupt value but it was not of the expected type; IGNORING.",
      buf,
      0xCu);
...
LABEL_5:
  ...
  v9 = 0;
LABEL_7:
  objc_msgSend(v9, "na_firstObjectPassingTest:", &__block_literal_global_100694);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
  {
    v11 = (void *)MEMORY[0x1D17BA0A0]();
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling characteristics value updated notification: %@", (uint8_t *)&v18, 0x16u);
