...
- (NSDictionary)prettyJSONDictionary
{
  ...
  if (v4)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Unknown (%d)"), v4);
...
- (id)description
{
  ...
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB37A0]), "initWithCapacity:", 8);
  v4 = -[HMDNetworkRouterFirewallRuleICMPType protocol](self, "protocol");
  if (v4 == 1)
  {
    v5 = CFSTR("v6:");
    ...
    if (objc_msgSend(v6, "unsignedCharValue") > 1)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v23 = 2112;
        v24 = v4;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", buf, 0x20u);
...
LABEL_26:
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v42 = 2112;
        v43 = v6;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid '%@' value: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v42 = 2112;
      v43 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid '%@' value: %@", buf, 0x20u);
