...
- (id)dataSourceDataProviders
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get host accessories due to no data source", (uint8_t *)&v11, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_34742 != -1)
    dispatch_once(&logCategory__hmf_once_t1_34742, &__block_literal_global_34743);
  return (id)logCategory__hmf_once_v2_34744;
}
...
void __61__HMDUnifiedLanguageValueListSettingDataProvider_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_34744;
  logCategory__hmf_once_v2_34744 = v0;
