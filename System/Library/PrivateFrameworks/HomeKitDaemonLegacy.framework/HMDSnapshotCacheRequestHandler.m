...
- (void)addSnapshotFileToCache:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Added Cache Entry %@ for snapshotCharacteristicEventUUID: %@", (uint8_t *)&v11, 0x20u);
...
- (void)removeSnapshotFileToCache:(id)a3 error:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Snapshot request completion is already set for %@, calling completion with error %@", (uint8_t *)&v21, 0x20u);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Removing Cache Entry for snapshotCharacteristicEventUUID: %@", (uint8_t *)&v21, 0x16u);
...
- (void)setSnapshotFileToCache:(id)a3 snapshotCharacteristicEventUUID:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Snapshot request completion is already set for %@, calling completion with %@", (uint8_t *)&v25, 0x20u);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v7;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting Cache Entry %@ for snapshotCharacteristicEventUUID: %@", (uint8_t *)&v25, 0x20u);
        ...
        if (v14 == v4)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v27 = 2112;
            v28 = v11;
            _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Cache entry for %@ has expired", buf, 0x16u);
...
- (BOOL)isSnapshotPresentForCharacteristicEventUUID:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Snapshot file is present in cache for %@", (uint8_t *)&v13, 0x16u);
...
void __86__HMDSnapshotCacheRequestHandler_requestSnapshot_streamingTierType_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Did not find the snapshot cache file for %@", (uint8_t *)&v23, 0x16u);
  ...
  if (v7)
  {
    if (v11)
    {
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Found the snapshot cache file for %@", (uint8_t *)&v23, 0x16u);
...
LABEL_11:
  ...
  if (v11)
  {
    ...
    v23 = 138543362;
    v24 = v22;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Found the snapshot cache file placeholder, saving the completion handler", (uint8_t *)&v23, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_170582 != -1)
    dispatch_once(&logCategory__hmf_once_t0_170582, &__block_literal_global_170583);
  return (id)logCategory__hmf_once_v1_170584;
}
...
void __45__HMDSnapshotCacheRequestHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_170584;
  logCategory__hmf_once_v1_170584 = v0;
