...
- (void)_handleAuthenticationResponse:(id)a3 error:(id)a4
{
  ...
  if (objc_msgSend(v12, "conformsToProtocol:", &unk_1EFAA49C0))
    v13 = v12;
  else
    v13 = 0;
  v14 = v13;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_173061 != -1)
    dispatch_once(&logCategory__hmf_once_t0_173061, &__block_literal_global_173062);
  return (id)logCategory__hmf_once_v1_173063;
}
...
void __52__HMDRemoteLoginInitiatorAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_173063;
  logCategory__hmf_once_v1_173063 = v0;
