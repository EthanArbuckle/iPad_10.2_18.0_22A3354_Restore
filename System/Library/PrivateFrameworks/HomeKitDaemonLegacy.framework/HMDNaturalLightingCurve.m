...
- (HMDNaturalLightingCurve)initWithCoder:(id)a3
{
  ...
  if (v5 != 1)
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v22 = 32;
LABEL_14:
    _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, v20, buf, v22);
  ...
  if (v7 >= (unint64_t)v6)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v61 = 2048;
      v62 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Minimum brightness is greater than equal to maximum brightness (%ld:%ld)", buf, 0x20u);
  ...
  if (v9 > v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v17 = 32;
LABEL_24:
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, v15, buf, v17);
    ...
    if (v30)
    {
      ...
      while (2)
      {
        for (i = 0; i != v31; ++i)
        {
          ...
          v50 = 0;
          objc_msgSend(MEMORY[0x1E0D16438], "parsedFromData:error:", v34, &v50);
          ...
          if (!v35)
          {
            ...
            if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v61 = 2112;
              v62 = (uint64_t)v36;
              _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse encoded transition point %@:%@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v43;
      _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode transition points", buf, 0xCu);
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v27 = 2112;
            v28 = v13;
            _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize transition point %@:%@", buf, 0x20u);
...
- (id)attributeDescriptions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDNaturalLightingCurve version](self, "version"));
  v40 = (void *)objc_claimAutoreleasedReturnValue();
  v39 = (void *)objc_msgSend(v3, "initWithName:value:", CFSTR("Version"), v40);
  v41[0] = v39;
  v4 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDNaturalLightingCurve minimumBrightness](self, "minimumBrightness"));
  v38 = (void *)objc_claimAutoreleasedReturnValue();
  v37 = (void *)objc_msgSend(v4, "initWithName:value:", CFSTR("Minimum Brightness"), v38);
  v41[1] = v37;
  v5 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDNaturalLightingCurve maximumBrightness](self, "maximumBrightness"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDNaturalLightingCurve minimumColorTemperature](self, "minimumColorTemperature"));
  v28 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = (void *)objc_msgSend(v9, "initWithName:value:", CFSTR("Minimum Color Temperature"), v28);
  v41[5] = v27;
  v10 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[HMDNaturalLightingCurve maximumColorTemperature](self, "maximumColorTemperature"));
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = (void *)objc_msgSend(v10, "initWithName:value:", CFSTR("Maximum Color Temperature"), v26);
  v41[6] = v11;
  v12 = objc_alloc(MEMORY[0x1E0D28548]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDNaturalLightingCurve colorTemperatureNotifyIntervalThresholdInMilliseconds](self, "colorTemperatureNotifyIntervalThresholdInMilliseconds"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDNaturalLightingCurve colorTemperatureNotifyValueChangeThreshold](self, "colorTemperatureNotifyValueChangeThreshold"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDNaturalLightingCurve colorTemperatureUpdateIntervalInMilliseconds](self, "colorTemperatureUpdateIntervalInMilliseconds"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", -[HMDNaturalLightingCurve checksum](self, "checksum"));
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v23 = (void *)objc_msgSend(v21, "initWithName:value:", CFSTR("Transition Checksum"), v22);
  v41[10] = v23;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v41, 11);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_8:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2112;
    v21 = v8;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Transition point for milliseconds elapsed since start of day %llums is %@", (uint8_t *)&v16, 0x20u);

  }
  objc_autoreleasePoolPop(v11);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", objc_msgSend(v8, "colorTemperatureForBrightness:", a3));
...
LABEL_16:
    ...
    {
      v23 = obj;
      objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", objc_msgSend(obj, "count") + 1);
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      if (v11 == a3)
      {
        v25 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", &unk_1E8B33240);
        v26 = v21;
        v27 = objc_alloc(MEMORY[0x1E0D16438]);
      ...
      else if (v16)
      {
        ...
        v46 = objc_alloc(MEMORY[0x1E0D16610]);
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLongLong:", v22);
        v47 = (void *)objc_claimAutoreleasedReturnValue();
        v48 = objc_msgSend(v46, "initWithValue:", v47);

        v77 = v45;
        objc_msgSend(MEMORY[0x1E0D16438], "transitionPointWithPreviousTransitionPoint:nextTransitionPoint:timeElapsedSincePreviousTransitionPoint:minimumBrightness:maximumBrightness:", v16, v21, v45, v74, v73);
        v49 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v24, "addObject:");
        v50 = objc_alloc(MEMORY[0x1E0D16438]);
        ...
        v60 = objc_alloc(MEMORY[0x1E0D16438]);
        v61 = v49;
        objc_msgSend(v49, "scale");
        v62 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v49, "offset");
        v63 = (void *)objc_claimAutoreleasedReturnValue();
        v64 = objc_alloc(MEMORY[0x1E0D16610]);
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", v77);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v88 = 2048;
          v89 = a3;
          _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_ERROR, "%{public}@Next transition point for current time: %llums not found", buf, 0x16u);
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v88 = 2048;
      v89 = v22;
      _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@Time to reach next transiton point is negative: %lldms", buf, 0x16u);
...
LABEL_23:
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v88 = 2048;
      v89 = a3;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Next transition point for current time: %llums not found", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19 != -1)
    dispatch_once(&logCategory__hmf_once_t19, &__block_literal_global_66168);
