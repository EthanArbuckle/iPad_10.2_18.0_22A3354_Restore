...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_45441 != -1)
    dispatch_once(&logCategory__hmf_once_t8_45441, &__block_literal_global_45442);
  return (id)logCategory__hmf_once_v9_45443;
}
...
void __44__HMDCameraMediaConfigGenerator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_45443;
  logCategory__hmf_once_v9_45443 = v0;
...
- (BOOL)extractSelectedConfigFromProtocolParameters:(id)a3 videoStreamConfig:(id *)a4 audioStreamConfig:(id *)a5
{
  ...
  if (-[HMDCameraMediaConfigGenerator _loadAVCVideoStreamConfig:protocolParameters:](self, "_loadAVCVideoStreamConfig:protocolParameters:", v9, v8))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v19 = 138543362;
        v20 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to load audio config from the protocol parameters", (uint8_t *)&v19, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to load video config from the protocol parameters", (uint8_t *)&v19, 0xCu);
...
LABEL_9:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v114 = 2048;
        v115 = v14;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to translate the HMD audio codec type: %tu, sample rate: %tu", buf, 0x20u);
...
LABEL_23:
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, v28, buf, 0x16u);
...
LABEL_4:
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v100, 0x16u);
...
LABEL_5:
  ...
  else
  {
    ...
    if ((unint64_t)(v35 - 1) >= 0x1D)
      ...
      v36 = (uint64_t *)((char *)&unk_1CDB8F440 + 8 * v35 - 8);
    v37 = *v36;
    ...
    if (v37 == -1)
    {
      ...
      v100 = 138543362;
      v101 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to translate image resolution", (uint8_t *)&v100, 0xCu);
      goto LABEL_5;
    }
    objc_msgSend(v6, "video");
    v38 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)extractReselectedConfigFromVideoTier:(id)a3 videoStreamConfig:(id *)a4
{
  ...
  if ((unint64_t)(v8 - 1) >= 0x1D)
    ...
    v9 = (uint64_t *)((char *)&unk_1CDB8F440 + 8 * v8 - 8);
  v10 = *v9;
  ...
  if (v10 == -1)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 138543362;
      v26 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to translate image resolution", (uint8_t *)&v25, 0xCu);
...
- (BOOL)_loadConfig:(id)a3 cipherCuite:(id)a4
{
  ...
  v7 = (uint64_t *)((char *)&unk_1CDB8F528 + 8 * v6);
  if (v6 >= 3)
