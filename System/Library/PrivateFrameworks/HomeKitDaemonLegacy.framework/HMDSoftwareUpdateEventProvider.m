...
- (void)scanWithOptions:(unint64_t)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2048;
    v29 = a3;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Scanning with options: %lu", buf, 0x16u);
...
- (void)forwardDescriptorEventWithErrorCode:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Forwarding descriptor event", buf, 0xCu);
...
- (id)descriptorFromControllerStatus:(id)a3 controllerDescriptor:(id)a4 errorCode:(id)a5
{
  ...
  if (!v9)
  {
    ...
    objc_msgSend(v13, "lastEventForTopicSuffixID:", *MEMORY[0x1E0CB7C40]);
    v14 = (void *)objc_claimAutoreleasedReturnValue();

    if (v14)
    {
      objc_msgSend(MEMORY[0x1E0CBA898], "descriptorFromEvent:", v14);
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      if (v15)
      {
        v12 = v15;

        v16 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "setStatus:", objc_msgSend(v11, "status")));
        v17 = self;
        HMFGetOSLogHandle();
        v18 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          v31 = 2112;
          v32 = v12;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Forwarding previous descriptor: %@", (uint8_t *)&v29, 0x16u);
...
LABEL_13:
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 2112;
        v32 = v14;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse descriptor from previous event: %@", (uint8_t *)&v29, 0x16u);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v27;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Current and previous descriptor are both nil", (uint8_t *)&v29, 0xCu);
...
- (void)forwardProgressEventWithProgress:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v31 = 138543362;
    v32 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Debouncing progress event", (uint8_t *)&v31, 0xCu);
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v31 = 138543362;
      v32 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Progress is nil. Refreshing software update descriptor.", (uint8_t *)&v31, 0xCu);
  ...
  if (v13)
  {
    ...
    if (v15)
    {
      v16 = objc_alloc(MEMORY[0x1E0CBA8C0]);
      -[HMDSoftwareUpdateEventProvider context](v6, "context");
      v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        v31 = 138543362;
        v32 = v30;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Event source was nil", (uint8_t *)&v31, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = 138543362;
      v32 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create HMSoftwareUpdateProgress", (uint8_t *)&v31, 0xCu);
...
- (void)forwardDebouncedProgressEvent
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Forwarding progress event", (uint8_t *)&v13, 0xCu);

    }
    objc_autoreleasePoolPop(v8);
    -[HMDSoftwareUpdateEventProvider context](v9, "context");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "forwardEvent:withTopicSuffixID:", v4, *MEMORY[0x1E0CB7C48]);
...
- (void)manager:(id)a3 scanRequestDidLocateUpdate:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager scanRequestDidLocateUpdate with error: %@", (uint8_t *)&v16, 0x16u);
...
- (void)manager:(id)a3 scanRequestPostponed:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager scanRequestPostponed with error: %@", (uint8_t *)&v16, 0x16u);
...
- (void)manager:(id)a3 didChangeProgressOnDownload:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didChangeProgressOnDownload", (uint8_t *)&v13, 0xCu);
...
- (void)manager:(id)a3 didFailDownload:(id)a4 withError:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 138543362;
    v17 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFailDownload", (uint8_t *)&v16, 0xCu);
...
- (void)manager:(id)a3 didFinishDownload:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishDownload", (uint8_t *)&v12, 0xCu);
...
- (void)manager:(id)a3 didFinishDownload:(id)a4 willProceedWithInstallation:(BOOL)a5 waitingForAdmissionControl:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 138543362;
    v15 = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishDownload", (uint8_t *)&v14, 0xCu);
...
- (void)manager:(id)a3 didFinishDownload:(id)a4 willProceedWithInstallation:(BOOL)a5 waitingForAdmissionControl:(BOOL)a6 denialReasons:(id)a7
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    v17 = 138543362;
    v18 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishDownload", (uint8_t *)&v17, 0xCu);
...
- (void)manager:(id)a3 didFailInstallation:(id)a4 withError:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 138543362;
    v17 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFailInstallation", (uint8_t *)&v16, 0xCu);
...
- (void)manager:(id)a3 didFinishInstallation:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishInstallation", (uint8_t *)&v12, 0xCu);
...
void __64__HMDSoftwareUpdateEventProvider_respondToScanFuturesWithError___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Responding to scan futures with didFindUpdate: %@", (uint8_t *)&v9, 0x16u);
...
void __70__HMDSoftwareUpdateEventProvider_forwardDescriptorEventWithErrorCode___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    v38 = 2112;
    v39 = v9;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Controller status:\n%@\n\nController descriptor:\n%@\nerror: %@", (uint8_t *)&v32, 0x2Au);
...
LABEL_7:
    ...
    v20 = 22;
LABEL_6:
    _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v32, v20);
  ...
  if (v23)
  {
    v24 = objc_alloc(MEMORY[0x1E0CBA8A0]);
    objc_msgSend(*(id *)(a1 + 32), "context");
    ...
    objc_msgSend(*(id *)(a1 + 32), "context");
    v27 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v27, "forwardEvent:withTopicSuffixID:", v26, *MEMORY[0x1E0CB7C40]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 138543362;
      v33 = v31;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Event source was nil", (uint8_t *)&v32, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_103958 != -1)
    dispatch_once(&logCategory__hmf_once_t29_103958, &__block_literal_global_103959);
  return (id)logCategory__hmf_once_v30_103960;
}
...
void __45__HMDSoftwareUpdateEventProvider_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v30_103960;
  logCategory__hmf_once_v30_103960 = v0;
