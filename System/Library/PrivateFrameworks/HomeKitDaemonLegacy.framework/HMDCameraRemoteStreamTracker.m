...
void __64__HMDCameraRemoteStreamTracker_stopTrackingStreamWithSessionID___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v15 = 2112;
      v16 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@No longer tracking stream with session ID: %@", (uint8_t *)&v13, 0x16u);
  ...
  else
  {
    if (v7)
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Cannot find stream to stop tracking: %@", (uint8_t *)&v13, 0x16u);
...
void __59__HMDCameraRemoteStreamTracker_startTrackingStreamSession___block_invoke(uint64_t a1)
{
  ...
  if (v3 >= v4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = (uint64_t)v22;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Cannot start tracking stream session: %@. Already tracking maximum number of stream sessions: %@", (uint8_t *)&v23, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Started tracking stream session: %@. Total count is now %lu", (uint8_t *)&v23, 0x20u);
...
{
  if (sharedTracker_onceToken_99347 != -1)
    dispatch_once(&sharedTracker_onceToken_99347, &__block_literal_global_99348);
  return (HMDCameraRemoteStreamTracker *)(id)streamTracker;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t4_99342 != -1)
    dispatch_once(&logCategory__hmf_once_t4_99342, &__block_literal_global_4_99343);
  return (id)logCategory__hmf_once_v5_99344;
}
...
void __43__HMDCameraRemoteStreamTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_99344;
  logCategory__hmf_once_v5_99344 = v0;
