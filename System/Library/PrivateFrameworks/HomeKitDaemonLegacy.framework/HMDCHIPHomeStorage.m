...
LABEL_7:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v70 = 2112;
    v71 = v14;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating storage fabric ID from %@ to %@", (uint8_t *)&v66, 0x20u);
...
LABEL_8:
  ...
  if (objc_msgSend(v17, "containsObject:", CFSTR("chipLastNodeID")))
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v70 = 2112;
      v71 = v26;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating storage last node ID from %@ to %@", (uint8_t *)&v66, 0x20u);
...
LABEL_14:
  ...
  if (objc_msgSend(v27, "containsObject:", CFSTR("chipRootCertificate")))
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      v70 = 2112;
      v71 = v36;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating storage root certificate from %@ to %@", (uint8_t *)&v66, 0x20u);
...
LABEL_20:
  ...
  if (objc_msgSend(v37, "containsObject:", CFSTR("chipOperationalCertificate")))
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      v70 = 2112;
      v71 = v46;
      _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating storage operational certificate from %@ to %@", (uint8_t *)&v66, 0x20u);
...
LABEL_26:
  ...
  if (objc_msgSend(v47, "containsObject:", CFSTR("chipIntermediateCertificate")))
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      v70 = 2112;
      v71 = v56;
      _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_INFO, "%{public}@Updating storage intermediate certificate from %@ to %@", (uint8_t *)&v66, 0x20u);
...
LABEL_37:
  ...
  if ((v60 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
    {
      ...
      v66 = 138543362;
      v67 = v64;
      _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating storage key-value store", (uint8_t *)&v66, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_9939 != -1)
    dispatch_once(&logCategory__hmf_once_t7_9939, &__block_literal_global_9940);
  return (id)logCategory__hmf_once_v8_9941;
}
...
void __33__HMDCHIPHomeStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_9941;
  logCategory__hmf_once_v8_9941 = v0;
