...
+ (id)sharedStore
{
  if (sharedStore_onceToken != -1)
    dispatch_once(&sharedStore_onceToken, &__block_literal_global_89948);
  return (id)store;
}
...
LABEL_15:
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 22;
LABEL_14:
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, v24, (uint8_t *)&v32, v26);
  ...
  if ((v17 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v32 = 138543362;
      v33 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Already exists, do not need to proceed further.", (uint8_t *)&v32, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v36 = 2112;
      v37 = v11;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Updating new entry %@ for application bundle ID %@", (uint8_t *)&v32, 0x20u);
...
- (id)vendorIDForApplication:(id)a3
{
  ...
  if (v4)
  {
    ...
    v12 = &v11;
    v13 = 0x3032000000;
    v14 = __Block_byref_object_copy__89923;
    v15 = __Block_byref_object_dispose__89924;
    v16 = 0;
    -[HMDApplicationVendorIDStore clientQueue](self, "clientQueue");
    v5 = objc_claimAutoreleasedReturnValue();
    block[0] = MEMORY[0x1E0C809B0];
  ...
  if (!v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v11;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@There is no vendor id for %@, newly extracted vendor id is %@", (uint8_t *)&v14, 0x20u);
...
- (void)_extractVendorIDForApplication:(id)a3
{
  ...
  v4 = a3;
  v13 = 0;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CA5870]), "initWithBundleIdentifier:allowPlaceholder:error:", v4, 0, &v13);
  v6 = v13;
  if (v5)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Bundle ID: %@ cannot be extracted (or cannot determine): %@", buf, 0x20u);
...
- (void)_save
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 2112;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Archiving vendor id store %@", (uint8_t *)&v7, 0x16u);
  ...
  if (!v6)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v18 = 2112;
        v19 = v6;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating Mach UUID mapping with application bundle ID %@ and %@", (uint8_t *)&v14, 0x20u);
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        v18 = 2112;
        v19 = v9;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Retrieved application vendor ID store: %@", (uint8_t *)&v16, 0x16u);
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (v3)
    {
      ...
      if (!v4)
      {
        if (v7)
        {
          ...
          v27 = 2112;
          v28 = v15;
          _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Removing mapping for application bundle id %@", (uint8_t *)&v25, 0x16u);
        ...
        if (isWatch())
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              v27 = 2112;
              v28 = v24;
              _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@WatchOS : Companion app does not exist for %@. Hence not removing the mapping.", (uint8_t *)&v25, 0x16u);
      ...
      if (v7)
      {
        ...
        v25 = 138543362;
        v26 = v8;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@This is an internal client, do not remove it.", (uint8_t *)&v25, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 2112;
        v28 = v13;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Unknown application %@, cannot remove", (uint8_t *)&v25, 0x16u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 138543362;
    v26 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Received invalid application bundle identifier, cannot remove", (uint8_t *)&v25, 0xCu);
              ...
              if ((v16 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = v31;
                  ...
                  v48 = 2112;
                  v49 = v8;
                  _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Vendor IDs are mismatching (Known: %@, Now: %@) for bundle ID: %@", buf, 0x2Au);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v46 = 2112;
                v47 = v14;
                _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Bundle ID: %@ does not exist (or cannot determine) anymore, removing it from the store: %@", buf, 0x20u);
  ...
  if (objc_msgSend(v2, "count"))
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v44 = 2112;
      v45 = v33;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Removing the entries for bundle IDs: %@ from the store", buf, 0x16u);
...
uint64_t __42__HMDApplicationVendorIDStore_sharedStore__block_invoke()
{
  ...
  if (!store)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v9 = 138543362;
      v10 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@No archived vendor ID store, creating a new one", (uint8_t *)&v9, 0xCu);
