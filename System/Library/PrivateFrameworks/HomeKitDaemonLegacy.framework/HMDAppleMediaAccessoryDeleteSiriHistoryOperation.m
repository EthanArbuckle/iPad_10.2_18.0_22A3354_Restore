...
- (void)main
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Started delete siri history operation", buf, 0xCu);
...
void __56__HMDAppleMediaAccessoryDeleteSiriHistoryOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Delete siri history completed with error: %@", (uint8_t *)&v10, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Delete siri history completed", (uint8_t *)&v10, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_102664 != -1)
    dispatch_once(&logCategory__hmf_once_t3_102664, &__block_literal_global_102665);
  return (id)logCategory__hmf_once_v4_102666;
}
...
void __63__HMDAppleMediaAccessoryDeleteSiriHistoryOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_102666;
  logCategory__hmf_once_v4_102666 = v0;
