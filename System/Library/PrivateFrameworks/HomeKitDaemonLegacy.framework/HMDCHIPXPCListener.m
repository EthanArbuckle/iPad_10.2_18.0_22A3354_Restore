...
- (HMDCHIPXPCListener)initWithHomeManager:(id)a3
{
  ...
  if (v5)
  {
    ...
    v12 = objc_msgSend(v11, "initWithMachServiceName:", *MEMORY[0x1E0CBA140]);
    ...
    objc_msgSend(MEMORY[0x1E0CB3B50], "interfaceWithProtocol:", &unk_1EFAC6600);
    v14 = objc_claimAutoreleasedReturnValue();
    exportedInterface = v5->_exportedInterface;
    v5->_exportedInterface = (NSXPCInterface *)v14;

    objc_msgSend(MEMORY[0x1E0CB3B50], "interfaceWithProtocol:", &unk_1EFB9F660);
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Starting CHIP XPC listener", (uint8_t *)&v8, 0xCu);
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v40 = 2112;
    v41 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@New CHIP XPC connection requested: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v40 = 2112;
        v41 = v7;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_INFO, "%{public}@XPC connection does not have public HomeKit entitlement: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v7;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@XPC connection has no permission to access Home data: %@", buf, 0x16u);
...
uint64_t __57__HMDCHIPXPCListener_listener_shouldAcceptNewConnection___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 1024;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@CHIP XPC client invalidated: %d", (uint8_t *)&v8, 0x12u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6 != -1)
    dispatch_once(&logCategory__hmf_once_t6, &__block_literal_global_2268);
