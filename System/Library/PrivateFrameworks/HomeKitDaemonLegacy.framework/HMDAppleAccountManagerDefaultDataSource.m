...
- (HMDAppleAccountManagerDefaultDataSource)initWithQueue:(id)a3
{
  ...
  if (v6)
  {
    ...
    v9 = objc_msgSend(v8, "initWithEnvironmentName:namedDelegatePort:queue:", *MEMORY[0x1E0CFE130], *MEMORY[0x1E0CFE118], v5);
    ...
    v13 = (HMDACAccountStore *)objc_alloc_init(MEMORY[0x1E0C8F2B8]);
