...
- (HMDBackingStoreCacheUpdateGroupSubscriptionOperation)initWithGroup:(id)a3 subscription:(id)a4 resultBlock:(id)a5
{
  id v9;
  id v10;
  HMDBackingStoreCacheUpdateGroupSubscriptionOperation *v11;
  HMDBackingStoreCacheUpdateGroupSubscriptionOperation *v12;
  HMDBackingStoreCacheUpdateGroupSubscriptionOperation *v13;
  objc_super v15;
...
- (id)mainReturningError
{
  ...
  if (v5)
    goto LABEL_2;
  -[HMDBackingStoreCacheUpdateGroupSubscriptionOperation subscription](self, "subscription");
...
LABEL_7:
  ...
  -[HMDBackingStoreCacheUpdateGroupSubscriptionOperation record](self, "record");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v14 = objc_msgSend(v13, "groupID");
  -[HMDBackingStoreCacheUpdateGroupSubscriptionOperation subscription](self, "subscription");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v12, "_updateGroupWithID:subscription:", v14, v15);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v17, "setSubscription:", v16);
