...
- (void)notifyUpdatedDestinationWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying updated destination with identifier: %@", buf, 0x16u);
  ...
  if (!v4)
  {
    ...
    v10 = (void *)objc_msgSend(v11, "initWithUUIDString:", *MEMORY[0x1E0CB9498]);
  }
  v15[1] = v10;
...
- (id)destinationIdentifierInMessage:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    objc_msgSend(v7, "hmf_stringForKey:", *MEMORY[0x1E0CB9490]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v9;
    if (v9)
    {
      if ((objc_msgSend(v9, "isEqualToString:", *MEMORY[0x1E0CB9498]) & 1) == 0)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            v31 = 2112;
            v32 = v6;
            _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse destination identifier: %@ message: %@", (uint8_t *)&v27, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v6;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination identifier from message: %@", (uint8_t *)&v27, 0x16u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", (uint8_t *)&v27, 0x16u);
...
- (unint64_t)upateOptionsInMessage:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    objc_msgSend(v7, "hmf_numberForKey:", *MEMORY[0x1E0CB9480]);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = v9;
    if (v9)
    {
...
LABEL_18:
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v16;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform update due to unknown update options: %@", (uint8_t *)&v27, 0x16u);
...
LABEL_16:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v29 = 2112;
        v30 = v6;
        _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to get update options from message: %@", (uint8_t *)&v27, 0x16u);
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
  {
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", (uint8_t *)&v27, 0x16u);
...
- (void)handleMediaDestinationControllerUpdateDestinationRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v37 = 2112;
    v38 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update destination request message: %@", buf, 0x16u);
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v39 = 2112;
        v40 = v11;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination identifier from update destination message: %@ error: %@", buf, 0x20u);
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v39 = 2112;
        v40 = v17;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get update options from update destination message: %@ error: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v31;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of update destination request message due to no delegate", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v4;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response handler from update destination request message: %@", buf, 0x16u);
...
- (void)handleMediaDestinationUpdatedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination updated notification: %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media destination updated notification due to no delegate", (uint8_t *)&v15, 0xCu);
...
- (void)handleHomeAccessoryRemovedNotification:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling home accessory removed notification: %@", (uint8_t *)&v23, 0x16u);
    ...
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          v23 = 138543362;
          v24 = v22;
          _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of accessory removed notification due to no delegate", (uint8_t *)&v23, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v18;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping home accessory removed notification due to no destination", (uint8_t *)&v23, 0xCu);
...
- (void)handleMediaSystemAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media system added notification: %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media system added notification due to no delegate", (uint8_t *)&v15, 0xCu);
...
- (void)handleMediaSystemRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media system removed notification: %@", (uint8_t *)&v15, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media system removed notification due to no delegate", (uint8_t *)&v15, 0xCu);
...
- (void)handleNotificationAccessoryChangedRoom:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2112;
      v31 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling accessory changed room notification: %@", (uint8_t *)&v28, 0x16u);
          ...
          (v17 & 1) != 0))
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          v28 = 138543362;
          v29 = v23;
          _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of accessory changed rooms notification due to no delegate", (uint8_t *)&v28, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 138543362;
        v29 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Skipping accessory changed room notification due to no destination and no related destination controller", (uint8_t *)&v28, 0xCu);
...
- (void)handleMediaDestinationControllerUpdatedDestinationNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2112;
    v41 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination controller updated destination notification: %@", (uint8_t *)&v38, 0x16u);
  ...
  if (v9)
  {
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v40 = 2112;
        v41 = v10;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media destination controller identifier from media destination controller updated destination notification user info: %@", (uint8_t *)&v38, 0x16u);
    ...
    if (v12)
    {
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v15 = objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0CB9498]);
      ...
      if (!v15)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
          {
            ...
            v38 = 138543362;
            v39 = v37;
            _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media destination controller updated destination notification due to no delegate", (uint8_t *)&v38, 0xCu);
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 12;
LABEL_17:
        _os_log_impl(&dword_1CD062000, v21, v22, v20, (uint8_t *)&v38, v23);
...
LABEL_26:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    v40 = 2112;
    v41 = v4;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get user info in media destination controller updated destination notification: %@", (uint8_t *)&v38, 0x16u);
...
- (void)handleMediaGroupsAggregateConsumerUpdatedAggregateDataNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media groups aggregate consumer updated aggregate data notification", (uint8_t *)&v15, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media groups aggregate consumer updated aggregate data notification due to no delegate", (uint8_t *)&v15, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t34_154012 != -1)
    dispatch_once(&logCategory__hmf_once_t34_154012, &__block_literal_global_154013);
  return (id)logCategory__hmf_once_v35_154014;
}
...
void __58__HMDMediaDestinationControllerMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v35_154014;
  logCategory__hmf_once_v35_154014 = v0;
