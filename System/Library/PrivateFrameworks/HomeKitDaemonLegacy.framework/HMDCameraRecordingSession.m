...
LABEL_22:
  ...
  if (v25)
  {
    ...
    v26->_active = 1;
    v29 = (__int128 *)MEMORY[0x1E0CA2E18];
    ...
    *(_OWORD *)&v26->_timelapseClipStartTime.value = v31;
    ...
    v38 = objc_alloc(MEMORY[0x1E0D31A48]);
    ...
    v46 = objc_alloc_init(MEMORY[0x1E0D31AB8]);
    ...
    v52 = objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:parent:options:", CFSTR("Recording Session"), 0, 3);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v10 = 2112;
    v11 = v4;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating recording session: %@", buf, 0x16u);
...
- (void)configure
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v12, "na_map:", &__block_literal_global_154661);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 138543362;
      v24 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Can't configure recording session because home reference is nil", (uint8_t *)&v23, 0xCu);
...
- (void)handleFragment:(id)a3
{
  ...
  if (!v7)
  {
    if (-[HMDCameraRecordingSession _isValidFirstSessionFragment:](self, "_isValidFirstSessionFragment:", v4))
    {
      ...
      objc_msgSend(MEMORY[0x1E0C99E08], "dictionaryWithDictionary:", &unk_1E8B36B50);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDCameraRecordingSession camera](self, "camera");
...
LABEL_17:
      _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, v49, buf, 0x16u);

    }
LABEL_18:

    objc_autoreleasePoolPop(v45);
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDCameraRecordingSessionErrorDomain"), 1, 0);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[HMDCameraRecordingSession isActive](self, "isActive"))
  {
    ...
    {
      v8 = objc_alloc(MEMORY[0x1E0D31AF8]);
      objc_msgSend(v7, "data");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v4, "data");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDCameraRecordingSession currentFragmentNumber](self, "currentFragmentNumber"));
      ...
      v15 = (void *)MEMORY[0x1D17BA0A0](-[HMDCameraRecordingSession setPendingFragmentsCount:](self, "setPendingFragmentsCount:", -[HMDCameraRecordingSession pendingFragmentsCount](self, "pendingFragmentsCount") + 1));
      v16 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v13;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Requesting analysis for fragment: %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v15);
      v19 = objc_alloc_init(MEMORY[0x1E0D31AC0]);
  ...
  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&buf[4] = v44;
    _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Dropping fragment for analysis as session is no longer active", buf, 0xCu);
...
- (void)handleNoMoreFragmentsAvailable
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Accessory has no more fragments available for analysis", (uint8_t *)&v12, 0xCu);
    ...
    && -[HMDCameraRecordingSession isActive](v5, "isActive"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Finalizing session because all fragments have been analyzed", (uint8_t *)&v12, 0xCu);
  ...
  if (Seconds > v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v131 = 2048;
      v132 = v17;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Finishing current clip upload because segment would exceed max duration (%.2f > %.2f)", buf, 0x20u);
...
LABEL_10:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v129 = 2112;
    v130 = v24;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Comparing fragment with recording event triggers: %@", buf, 0x16u);
    ...
    if (v38 <= 0.0)
    {
      if (v42)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v129 = 2112;
        v130 = v47;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@Flagging fragment for recording because remaining recording extension duration is %@s. Extension duration will be cleared", buf, 0x16u);
    ...
    else
    {
      if (v42)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v131 = 2048;
        v132 = v38;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@Flagging fragment for recording because remaining recording extension duration is %@s. New extension duration will be %fs", buf, 0x20u);
...
LABEL_31:
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v6, "sequenceNumber"));
  ...
  v126[3] = v52;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v126, v125, 4);
  ...
  if (!(_DWORD)v37)
  {
    if (v57)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v129 = 2048;
      v130 = *(double *)&v65;
      _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@Fragment %lu was not flagged for recording", buf, 0x16u);
  ...
  if (v57)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v129 = 2048;
    v130 = *(double *)&v59;
    _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@Fragment %lu was flagged for recording", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v129 = 2112;
      v130 = v83;
      _os_log_impl(&dword_1CD062000, v81, OS_LOG_TYPE_INFO, "%{public}@Created new clip uploader: %@", buf, 0x16u);
  ...
  if (v60 && v61)
  {
    ...
    if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v129 = 2048;
      v130 = *(double *)&v89;
      _os_log_impl(&dword_1CD062000, v87, OS_LOG_TYPE_INFO, "%{public}@Uploading intro fragment %lu", buf, 0x16u);
        ...
        (v12 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v34 = 2112;
      v35 = v10;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Analysis video init fragment changed from %@ to %@", buf, 0x20u);
...
- (void)_uploadTimelapseFragment:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v59 = 2112;
    v60 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Uploading timelapse fragment: %@", buf, 0x16u);
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v24;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Created new timelapse clip uploader: %@", buf, 0x16u);
        ...
        (v30 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v61 = 2112;
      v62 = v28;
      _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Analysis timelapse video init fragment changed from %@ to %@", buf, 0x20u);
...
- (void)_handleDidFailAnalysisWithError:(id)a3
{
  ...
  v6 = (void *)MEMORY[0x1D17BA0A0](-[HMDCameraRecordingSession setPendingFragmentsCount:](self, "setPendingFragmentsCount:", -[HMDCameraRecordingSession pendingFragmentsCount](self, "pendingFragmentsCount") - 1));
  v7 = self;
  HMFGetOSLogHandle();
  v8 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Analysis failed with error: %@", (uint8_t *)&v11, 0x16u);

  }
  objc_autoreleasePoolPop(v6);
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDCameraRecordingSessionErrorDomain"), 2, 0);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_shouldRecordFragmentWithAnalyzerResult:(id)a3 sequenceNumber:(unint64_t)a4 recordingEventTriggers:(unint64_t)a5 fragmentAnalyzedEvent:(id)a6
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v62 = 2048;
    v63 = Seconds;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Doorbell is active: %@ for fragment at time offset: %f and duration: %f", buf, 0x2Au);

  }
  objc_autoreleasePoolPop(v20);
  if (v19)
  {
    v25 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v10, "setRecordingReason:", 2));
    v26 = v21;
    HMFGetOSLogHandle();
    v27 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v28;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Doorbell event detected, starting recording", buf, 0xCu);
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    v62 = 2048;
    v63 = Seconds;
    _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_INFO, "%{public}@Motion is active: %@ for fragment at time offset: %f and duration: %f", buf, 0x2Au);
  ...
  if ((v37 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v60 = 2112;
      v61 = *(double *)&v46;
      _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Fragment analysis was skipped, recordingTriggerEvent is %@ and motion is %@", buf, 0x20u);
...
LABEL_29:
  ...
  if (!v39)
  {
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v51;
      _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_DEFAULT, "%{public}@No user recording trigger events match any detected significant events", buf, 0xCu);
...
LABEL_6:
        ...
        v13 = 12;
LABEL_19:
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, v11, buf, v13);
...
LABEL_20:
    ...
    if (v22)
    {
      v7 = (void *)MEMORY[0x1D17BA0A0](v23, v24, v25, v26, v27, v28);
      v29 = self;
      HMFGetOSLogHandle();
      v9 = objc_claimAutoreleasedReturnValue();
      if (!os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
...
LABEL_18:
    ...
    if (v33)
    {
      v7 = (void *)MEMORY[0x1D17BA0A0](v34, v35, v36, v37, v38, v39);
      v40 = self;
      HMFGetOSLogHandle();
      v9 = objc_claimAutoreleasedReturnValue();
      if (!os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    ...
    if ((_DWORD)v42)
    {
      ...
      if ((v50 & 1) == 0)
      {
        v7 = (void *)MEMORY[0x1D17BA0A0](v42, v43, v44, v45, v46, v47);
        v52 = self;
        HMFGetOSLogHandle();
        v9 = objc_claimAutoreleasedReturnValue();
        if (!os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
...
LABEL_26:
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, v17, buf, 0xCu);
...
- (BOOL)_createSessionDirectory
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v15;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Writing session data to directory: %@", buf, 0x16u);
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v30 = 2112;
      v31 = v18;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create directory at path: %@ error: %@", buf, 0x20u);
...
LABEL_10:
          _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, v23, buf, 0x20u);
...
- (void)_writeEvent:(id)a3
{
    ...
    && -[HMDCameraRecordingSession _createSessionDirectory](self, "_createSessionDirectory"))
  {
    ...
    v38 = 0;
    objc_msgSend(MEMORY[0x1E0CB36D8], "dataWithJSONObject:options:error:", v8, 0, &v38);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = v38;
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v43 = 2112;
        v44 = v12;
        _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize log event: %@ error: %@", buf, 0x20u);
    ...
    objc_msgSend(MEMORY[0x1E0CB3608], "fileHandleForWritingAtPath:", v19);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = v20;
    if (v20)
    {
...
LABEL_14:
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, v26, buf, 0x20u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v17 = 2112;
      v18 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Finishing clip uploader: %@", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v16 = 2112;
      v17 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Finishing timelapse clip uploader: %@", buf, 0x16u);
...
- (void)uploaderDidFailUpload:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Current clip uploader did fail upload", (uint8_t *)&v19, 0xCu);
  ...
  else
  {
    ...
    if (v7 == v4)
    {
      if (v11)
      {
        ...
        v19 = 138543362;
        v20 = v18;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Timelapse clip uploader did fail upload", (uint8_t *)&v19, 0xCu);
    ...
    else
    {
      if (v11)
      {
        ...
        v19 = 138543362;
        v20 = v12;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Previous clip uploader did fail upload", (uint8_t *)&v19, 0xCu);
...
LABEL_4:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping upload for placeholder fragment because the timelapse clip uploader is not created yet, fragment: %@", (uint8_t *)&v17, 0x16u);
...
void __50__HMDCameraRecordingSession__endSessionWithError___block_invoke_2(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@Video analyzer finished with error: %@", (uint8_t *)&v21, 0x16u);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Timelapse clip uploader is still expecting a timelapse fragment", (uint8_t *)&v21, 0xCu);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v17;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Finishing timelapse clip uploader: %@", (uint8_t *)&v21, 0x16u);
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_submitNotificationSuccessMetricWithRecordingEventTriggers:fragmentNumber:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
void __65__HMDCameraRecordingSession_analyzer_didCreateTimelapseFragment___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Timelapse fragment was created: %@", (uint8_t *)&v8, 0x16u);
...
uint64_t __67__HMDCameraRecordingSession_analyzer_didAnalyzeFragmentWithResult___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Fragment was analyzed: %@", (uint8_t *)&v8, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t52 != -1)
    dispatch_once(&logCategory__hmf_once_t52, &__block_literal_global_101);
