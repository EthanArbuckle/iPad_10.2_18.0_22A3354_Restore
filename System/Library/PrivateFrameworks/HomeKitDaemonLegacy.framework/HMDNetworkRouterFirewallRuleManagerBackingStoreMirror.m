...
- (BOOL)__shouldFailCloudRecordFetchError:(id)a3 error:(id)a4
{
  ...
  if (objc_msgSend(v7, "hmbIsCKZoneDeletedError"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(_QWORD *)&buf[14] = v16;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Zone '%@' does not exist", buf, 0x16u);
...
LABEL_9:
  ...
  if (objc_msgSend(v7, "hmbIsCloudKitError"))
  {
    if (objc_msgSend(v7, "code") == 11)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v22;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Record '%@' does not exist", buf, 0x16u);
    ...
    if (objc_msgSend(v7, "code") == 2)
    {
      ...
      objc_msgSend(v24, "objectForKeyedSubscript:", *MEMORY[0x1E0C94940]);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v7;
    _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch records: %@", buf, 0x16u);
...
- (void)__fetchRecordByID:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v40 = 2112;
    v41 = v14;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching record: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v9);
  v15 = objc_alloc(MEMORY[0x1E0C94E18]);
  objc_msgSend(v4, "recordID");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v37 = v16;
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v40 = 2112;
      v41 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Only fetching specific fields: %@", buf, 0x16u);
...
- (void)__fetchRecordsByQuery:(id)a3
{
  ...
  if (v6)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v33 = 2112;
    v34 = v16;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching records from zone %@", buf, 0x16u);
  ...
  else
  {
    ...
    *(_DWORD *)buf = 138543362;
    v32 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching all records", buf, 0xCu);
  }
...
LABEL_7:
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Only fetching specific fields: %@", buf, 0x16u);
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue();
  v27 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95010]), "initWithRecordType:predicate:", CFSTR("CD_CloudAccessory"), v26);
  v28 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95038]), "initWithQuery:", v27);
  objc_msgSend(v4, "zoneID");
    ...
    && objc_msgSend(*(id *)(a1 + 48), "__shouldFailCloudRecordFetchError:error:", *(_QWORD *)(a1 + 56)))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch records: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (*(_QWORD *)(a1 + 64))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v17 = v12;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Previous fetch completed successfully, now fetching more records from cursor", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v9);
      v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95038]), "initWithCursor:", *(_QWORD *)(a1 + 64));
  ...
  if (objc_msgSend(v6, "hmbIsCloudKitError") && objc_msgSend(v6, "code") == 11)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Record '%@' does not exist", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v25 = 2112;
      v26 = v6;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch record %@: %@", buf, 0x20u);
...
- (id)__loadOrCreateInternalStateModelWithLocalZone:(id)a3 activity:(id)a4
{
  ...
  if (v10)
  {
    v13 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "markWithFormat:", CFSTR("Loaded existing internal state model")));
    v14 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Loaded existing internal state model", buf, 0xCu);
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v21;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Last synchronized recordIDs: %@", buf, 0x16u);
  ...
  {
    v22 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "markWithFormat:", CFSTR("Creating new internal state model because existing one was not found: %@"), v11));
    v23 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v12;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Creating new internal state model because existing one was not found: %@", buf, 0x16u);
...
- (void)__startupWithLocalZone:(id)a3 activity:(id)a4
{
  ...
  {
    v9 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "markWithFormat:", CFSTR("Already shutting down")));
    v10 = self;
    HMFGetOSLogHandle();
    v11 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Already shutting down", (uint8_t *)&v20, 0xCu);
  ...
  {
    v15 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v7, "markWithFormat:", CFSTR("Starting up")));
    v16 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Starting up", (uint8_t *)&v20, 0xCu);
...
- (void)__shutdownWithActivity:(id)a3
{
  ...
  if (-[HMDNetworkRouterFirewallRuleManagerBackingStoreMirror isShuttingDown](self, "isShuttingDown"))
  {
    v6 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v4, "markWithFormat:", CFSTR("Already shutting down")));
    v7 = self;
    HMFGetOSLogHandle();
    v8 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Already shutting down", buf, 0xCu);
  ...
  {
    v14 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v4, "markWithFormat:", CFSTR("Shutting down")));
    v15 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Shutting down", buf, 0xCu);
    ...
    if (v20)
    {
      v21 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v4, "markWithFormat:", CFSTR("Shut down before startup completed")));
      v22 = v15;
      HMFGetOSLogHandle();
      v23 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v38 = v24;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Shut down before startup completed", buf, 0xCu);
...
uint64_t __91__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_Lifecycle____shutdownWithActivity___block_invoke_4(uint64_t a1)
{
  ...
  if (v2)
  {
    v3 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 40), "markWithFormat:", CFSTR("Failed to shut down cloud database: %@"), v2));
    v4 = *(id *)(a1 + 48);
    HMFGetOSLogHandle();
    v5 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v15 = 2112;
      v16 = v7;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down cloud database: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v3);
  }
  v8 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 40), "markWithFormat:", CFSTR("Shutdown completed")));
  v9 = *(id *)(a1 + 48);
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Shutdown completed", buf, 0xCu);
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        v28 = 2112;
        v29 = v18;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get any usable public keys from record: %@", (uint8_t *)&v26, 0x16u);
...
LABEL_14:
  ...
  if (!objc_msgSend(v8, "shouldRetry"))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2112;
      v29 = v25;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Fetch returned no verification certificates record: %@", (uint8_t *)&v26, 0x16u);
        ...
        objc_msgSend(v7, "shouldRetry")))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Ignoring non-fatal error: %@", buf, 0x16u);
...
- (void)__retryFetchVerificationCertificatesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v22 = 2048;
    v23 = (unint64_t)v12;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Will retry the fetch in %lu seconds", buf, 0x16u);
...
void __138__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchVerificationCertificates____retryFetchVerificationCertificatesWithFetchInfo___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Retrying fetch for verification certificates", (uint8_t *)&v9, 0xCu);
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Mirror has been deallocated", buf, 0xCu);
...
+ (id)__certificatesRecordID
{
  if (__certificatesRecordID_onceToken != -1)
    dispatch_once(&__certificatesRecordID_onceToken, &__block_literal_global_50391);
...
+ (id)__recordKeyCertificatePrefix:(id)a3
{
  ...
  if (__recordKeyCertificatePrefix__onceToken != -1)
    dispatch_once(&__recordKeyCertificatePrefix__onceToken, &__block_literal_global_16_50388);
...
LABEL_5:
        ...
        while (1)
        {
          ...
          v25 = (const __CFData *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99D50]), "initWithBase64EncodedString:options:", *(_QWORD *)(*((_QWORD *)&v86 + 1) + 8 * v24), 0);
          if (!v25)
            break;
          v26 = v25;
          ...
          if (!v27)
          {
            ...
            if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_QWORD *)&trust[4] = v59;
              v93 = 2112;
              *(_QWORD *)v94 = v84;
              _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@Failed to create certificate from data using keys: %@", trust, 0x16u);
...
LABEL_31:
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&v94[8] = 2112;
          v17 = v81;
          *(_QWORD *)&v94[10] = v81;
          _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_ERROR, "%{public}@Invalid certificate data in record using keys: %@: %@", trust, 0x20u);
...
LABEL_12:
        ...
        *(_QWORD *)trust = 0;
        ...
        if (!*(_QWORD *)trust || v30)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&v94[4] = 2112;
            *(_QWORD *)&v94[6] = v84;
            _os_log_impl(&dword_1CD062000, v66, OS_LOG_TYPE_ERROR, "%{public}@Failed to create trust (result %i) from certificate using keys: %@", trust, 0x1Cu);
          ...
          *(_QWORD *)trust = 0;
          ...
          if (!v33 || v34)
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&v94[8] = 2112;
              *(_QWORD *)&v94[10] = v77;
              _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Certificate did not pass trust evaluation with keys: %@, error: %@", trust, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_QWORD *)&trust[4] = v38;
              v93 = 2112;
              *(_QWORD *)v94 = v84;
              _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Trusted certificate found in record using keys: %@", trust, 0x16u);

              v11 = v83;
            }

            objc_autoreleasePoolPop(context);
            v39 = (void *)MEMORY[0x1D17B95B4](v32);
            v40 = v39;
            if (v39)
            {
              v41 = v39;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_QWORD *)&trust[4] = v73;
                v93 = 2112;
                *(_QWORD *)v94 = v84;
                _os_log_impl(&dword_1CD062000, v71, OS_LOG_TYPE_ERROR, "%{public}@Failed to get public key from trust in record using keys: %@", trust, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_QWORD *)&trust[4] = v63;
          _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to create security policy to verify certificates", trust, 0xCu);
...
LABEL_49:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v94[8] = 2112;
        *(_QWORD *)&v94[10] = v17;
        _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_ERROR, "%{public}@No certificates found on record using keys: %@: %@", trust, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v94[8] = 2112;
      *(_QWORD *)&v94[10] = v44;
      _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to read data from certificate record using keys: %@: %@", trust, 0x20u);
...
void __117__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchVerificationCertificates____recordKeyCertificatePrefix___block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x1E0CB38E8], "regularExpressionWithPattern:options:error:", CFSTR("^(CD_certificate(?:\\d+|))(?:$|_ckAsset$)"), 0, 0);
...
void __110__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchVerificationCertificates____certificatesRecordID__block_invoke()
{
  ...
  v3 = (id)objc_msgSend(v0, "initWithZoneName:ownerName:", CFSTR("certificates"), *MEMORY[0x1E0C94730]);
  v1 = objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initWithRecordName:zoneID:", CFSTR("certificates"), v3);
...
- (id)__createCloudZoneIDForZoneID:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D32C40];
  v5 = a3;
  v6 = [v4 alloc];
  -[HMDNetworkRouterFirewallRuleManagerBackingStoreMirror cloudDatabase](self, "cloudDatabase");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)__openLocalZoneForCloudZoneID:(id)a3 error:(id *)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_alloc_init(MEMORY[0x1E0D32C58]);
        ...
        if (v21)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v59 = 2112;
            v60 = v28;
            _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Opened local zone for %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (!v30)
          {
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v61 = 2112;
              v62 = v22;
              _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to open local zone for %@: %@", buf, 0x20u);
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v59 = 2112;
            v60 = v37;
            _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_DEBUG, "%{public}@No local zone for %@, skipping", buf, 0x16u);
...
- (id)__fetchAllDataForRecordIDs:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
            ...
            if (v20)
            {
              ...
              if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v74 = 2112;
                v75 = v29;
                _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Model %@ found for record %@", buf, 0x20u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v43, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v76 = 2112;
                v77 = v64;
                _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_DEBUG, "%{public}@No model %@ for record %@ found: %@", buf, 0x2Au);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v74 = 2112;
              v75 = v40;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_DEBUG, "%{public}@No local zone for model %@ for record %@ found", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v52;
      _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@localZones is nil, can't fetch paired metadata", buf, 0xCu);
...
- (id)__fetchAllDataForZoneID:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v134 = 2112;
    v135 = v19;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching all models for zone %@", buf, 0x16u);
    ...
    if (v23)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v136 = 2112;
        v137 = v27;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Found models in local zone for %@: %@", buf, 0x20u);
      ...
      if (v118)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            if (!v40)
            {
              ...
              if (os_log_type_enabled(v83, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v138 = 2112;
                v139 = v41;
                _os_log_impl(&dword_1CD062000, v83, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch external id for model %@ in %@: %@", buf, 0x2Au);
            ...
            v124 = v41;
            objc_msgSend(MEMORY[0x1E0C95070], "recordIDFromExternalID:error:", v40, &v124);
            v42 = (void *)objc_claimAutoreleasedReturnValue();
            v35 = v124;
            ...
            if (!v42)
            {
              ...
              if (os_log_type_enabled(v92, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v138 = 2112;
                v139 = v89;
                _os_log_impl(&dword_1CD062000, v92, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert external id for model %@ in %@: %@", buf, 0x2Au);
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v134 = 2112;
              v135 = v50;
              _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_DEBUG, "%{public}@Fetched model for %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v136 = 2112;
        v137 = v70;
        _os_log_impl(&dword_1CD062000, v69, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch models from local zone for %@: %@", buf, 0x20u);
    ...
    if (v99)
    {
      ...
      if (os_log_type_enabled(v104, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v136 = 2112;
        v137 = v99;
        _os_log_impl(&dword_1CD062000, v104, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down local zone for %@: %@", buf, 0x20u);
  ...
  if (v56)
  {
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v134 = 2112;
      v135 = v64;
      _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_DEBUG, "%{public}@Local zone does not exist for %@", buf, 0x16u);

      v20 = v62;
    }

    objc_autoreleasePoolPop(v59);
    v65 = (void *)MEMORY[0x1E0C9AA70];
  }
  else
  {
    ...
    if (os_log_type_enabled(v75, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v136 = 2112;
      v137 = v22;
      _os_log_impl(&dword_1CD062000, v75, OS_LOG_TYPE_ERROR, "%{public}@Failed to open local zone for %@: %@", buf, 0x20u);
...
- (id)__fetchAllDataForZoneName:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (v46)
  {
    ...
    v11 = (void *)objc_msgSend(v10, "initWithZoneName:ownerName:", v46, *MEMORY[0x1E0C94730]);
    objc_msgSend(MEMORY[0x1E0C99E60], "setWithObject:", v11);
    v12 = (void *)objc_claimAutoreleasedReturnValue();

LABEL_12:
    v25 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v51, "markWithFormat:", CFSTR("Fetching models from zones: %@"), v12));
    v50 = self;
    HMFGetOSLogHandle();
    v26 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v63 = 2112;
      v64 = v12;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching models from zones: %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v65 = 2112;
              v66 = v33;
              _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch models for zone %@: %@", buf, 0x20u);
  ...
  v14 = (os_unfair_lock_s *)&v13[*MEMORY[0x1E0D32D00]];
  ...
  obj = v17;
  v42 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v51, "markWithFormat:", CFSTR("No local zones exist")));
  v43 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v62 = v45;
    _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_DEBUG, "%{public}@No local zones exist", buf, 0xCu);
...
- (BOOL)__removeAllLocalRulesWithOptions:(id)a3 activity:(id)a4 error:(id *)a5
{
  ...
  {
    v12 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v8, "markWithFormat:", CFSTR("Removing cloud zones: %@"), v11));
    v13 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Removing cloud zones: %@", buf, 0x16u);
  ...
  v18 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v8, "markWithFormat:", CFSTR("Resetting database change token")));
  v19 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v21;
    _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Resetting database change token", buf, 0xCu);
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v53 = 2112;
            v54 = v24;
            _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Model %@ (%@) found in override zone", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v55 = 2112;
            v56 = v17;
            _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEBUG, "%{public}@No model %@ (%@) found in override zone: %@", buf, 0x2Au);
...
- (id)__fetchOverridesForZoneName:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (v10)
  {
    v14 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Fetching overrides for zone '%@'"), v10));
    v15 = self;
    HMFGetOSLogHandle();
    v16 = objc_claimAutoreleasedReturnValue();
    if (!os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  ...
  {
    v14 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Fetching all overrides")));
    v21 = self;
    HMFGetOSLogHandle();
    v16 = objc_claimAutoreleasedReturnValue();
    if (!os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  ...
  _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_DEFAULT, v18, buf, v20);
...
LABEL_7:
      ...
      if (v26)
      {
        ...
        do
        {
          for (i = 0; i != v28; ++i)
          {
            ...
            {
              v67 = v34;
              objc_msgSend(MEMORY[0x1E0C95070], "recordIDFromExternalID:error:", v33, &v67);
              v35 = (void *)objc_claimAutoreleasedReturnValue();
              v36 = v67;
              ...
              {
                v48 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v63, "markWithFormat:", CFSTR("Failed to convert externalID (%@) to CKRecordID for modelID %@: %@"), v33, v31, v36));
                v49 = v27;
                HMFGetOSLogHandle();
                ...
                if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  v80 = 2112;
                  v81 = v36;
                  _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert externalID (%@) to CKRecordID for modelID %@: %@", buf, 0x2Au);
            ...
            {
              v44 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v63, "markWithFormat:", CFSTR("Failed to fetch externalID for modelID %@: %@"), v31, v34));
              v45 = v27;
              HMFGetOSLogHandle();
              v46 = objc_claimAutoreleasedReturnValue();
              if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v78 = 2112;
                v79 = v34;
                _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch externalID for modelID %@: %@", buf, 0x20u);
  ...
  {
    v53 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Failed to fetch override models: %@"), v25));
    v54 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v76 = 2112;
      v77 = v25;
      _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch override models: %@", buf, 0x16u);
...
- (BOOL)__addOverrides:(id)a3 replace:(BOOL)a4 options:(id)a5 activity:(id)a6 error:(id *)a7
{
  ...
  if (v17)
  {
    ...
    v45 = &v44;
    v46 = 0x3032000000;
    v47 = __Block_byref_object_copy__92963;
    v48 = __Block_byref_object_dispose__92964;
    v49 = 0;
    ...
    {
      context = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v18, "markWithFormat:", CFSTR("Committing overrides")));
      v21 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = v23;
        _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Committing overrides", buf, 0xCu);
      ...
      if ((v20 & 1) != 0)
      {
        v25 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v18, "markWithFormat:", CFSTR("Committed overrides successfully")));
        v26 = v21;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v51 = v28;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Committed overrides successfully", buf, 0xCu);
      ...
      {
        v29 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v18, "markWithFormat:", CFSTR("Failed to commit: %@"), v24));
        v30 = v21;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v52 = 2112;
          v53 = contexta;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
...
- (BOOL)__removeAllOverridesWithOptions:(id)a3 activity:(id)a4 error:(id *)a5
{
  ...
  v11 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v9, "markWithFormat:", CFSTR("Removing all overrides")));
  v12 = self;
  HMFGetOSLogHandle();
  v13 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v32 = v14;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Removing all overrides", buf, 0xCu);
  ...
  if (v19)
  {
    v21 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v9, "markWithFormat:", CFSTR("Failed to remove all previous overrides: %@"), v19));
    v22 = v12;
    HMFGetOSLogHandle();
    v23 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v20;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove all previous overrides: %@", buf, 0x16u);
  ...
  {
    v25 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v9, "markWithFormat:", CFSTR("Successfully removed all previous overrides")));
    v26 = v12;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v28;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_INFO, "%{public}@Successfully removed all previous overrides", buf, 0xCu);
...
- (BOOL)__removeOverridesForRecordIDs:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  v14 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Removing overrides for recordIDs: %@"), v10));
  v15 = self;
  HMFGetOSLogHandle();
  v16 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v69 = 2112;
    v70 = v10;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Removing overrides for recordIDs: %@", buf, 0x16u);
          ...
          if ((v29 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v71 = 2112;
              v72 = v23;
              _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove model %@: %@", buf, 0x20u);
...
LABEL_32:
    ...
    v37 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Committing removal of overrides")));
    v38 = v15;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v41;
      _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Committing removal of overrides", buf, 0xCu);
    ...
    if ((v36 & 1) != 0)
    {
      v44 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Committed removal of overrides successfully")));
      v45 = v38;
      HMFGetOSLogHandle();
      v46 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v68 = v48;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Committed removal of overrides successfully", buf, 0xCu);
    ...
    {
      v49 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Failed to commit: %@"), v42));
      v50 = v38;
      HMFGetOSLogHandle();
      v51 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v69 = 2112;
        v70 = v43;
        _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
...
- (BOOL)__removeOverridesForZoneName:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  v14 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Removing overrides for zone '%@'"), v10));
  v15 = self;
  HMFGetOSLogHandle();
  v16 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v108 = 2112;
    v109 = v10;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Removing overrides for zone '%@'", buf, 0x16u);
  ...
  if (!v20)
  {
    v43 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Failed to fetch override models: %@"), v21));
    v44 = v15;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v108 = 2112;
      v109 = v21;
      _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch override models: %@", buf, 0x16u);
  ...
  while (2)
  {
    for (i = 0; i != v93; ++i)
    {
      ...
      if (!v29)
      {
        v48 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Failed to fetch externalID for modelID %@: %@"), v27, v30));
        v49 = v96;
        HMFGetOSLogHandle();
        v50 = objc_claimAutoreleasedReturnValue();
        if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v110 = 2112;
          v111 = v30;
          _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch externalID for modelID %@: %@", buf, 0x20u);
      ...
      v99 = v30;
      objc_msgSend(MEMORY[0x1E0C95070], "recordIDFromExternalID:error:", v29, &v99);
      v31 = (void *)objc_claimAutoreleasedReturnValue();
      v32 = v99;

      if (!v31)
      {
        v52 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Failed to convert externalID (%@) to CKRecordID for modelID %@: %@"), v29, v27, v32));
        v53 = v96;
        v54 = v96;
        HMFGetOSLogHandle();
        v55 = objc_claimAutoreleasedReturnValue();
        ...
        if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v112 = 2112;
          v113 = v32;
          _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert externalID (%@) to CKRecordID for modelID %@: %@", buf, 0x2Au);
      ...
      if (v35)
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v108 = 2112;
          v109 = v41;
          _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Removing override for %@", buf, 0x16u);
        ...
        if ((v42 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v110 = 2112;
            v111 = (char *)v25;
            _os_log_impl(&dword_1CD062000, v55, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove model %@: %@", buf, 0x20u);
...
LABEL_41:
  ...
  if (!v25 && v92)
  {
    v61 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Committing removal of %lu overrides"), v92));
    v62 = v96;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v108 = 2048;
      v109 = v92;
      _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_DEFAULT, "%{public}@Committing removal of %lu overrides", buf, 0x16u);
    ...
    if ((v47 & 1) != 0)
    {
      v68 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Committed removal of overrides successfully")));
      v69 = v62;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v70, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v107 = v72;
        _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_INFO, "%{public}@Committed removal of overrides successfully", buf, 0xCu);
    ...
    {
      v78 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v12, "markWithFormat:", CFSTR("Failed to commit: %@"), v66));
      v79 = v62;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v80, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v108 = 2112;
        v109 = v67;
        _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
...
LABEL_50:
    ...
    if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v107 = v77;
      _os_log_impl(&dword_1CD062000, v75, OS_LOG_TYPE_INFO, "%{public}@No matching models found, aborting", buf, 0xCu);
...
- (BOOL)__removeOverridesForZoneName:(id)a3 recordName:(id)a4 options:(id)a5 activity:(id)a6 error:(id *)a7
{
  ...
  if (v12 && v13)
  {
    ...
    v18 = (void *)objc_msgSend(v17, "initWithZoneName:ownerName:", v12, *MEMORY[0x1E0C94730]);
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C95070]), "initWithRecordName:zoneID:", v13, v18);
...
void __112__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_Records____addOverrides_replace_options_activity_error___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
      ...
      if ((v17 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v44 = 2112;
          v45 = v32;
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to update model for %@: %@", buf, 0x20u);
  ...
  {
    v26 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Failed to determine externalID: %@"), v11));
    v27 = *(id *)(a1 + 40);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v42 = 2112;
      v43 = (uint64_t)v11;
      _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalID: %@", buf, 0x16u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v18;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down local zone %@", buf, 0x16u);
...
+ (id)__overrideParentModelID
{
  if (__overrideParentModelID_onceToken != -1)
    dispatch_once(&__overrideParentModelID_onceToken, &__block_literal_global_93057);
...
void __89__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_Records____overrideParentModelID__block_invoke()
{
  ...
  v0 = objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("56e3068a-cb39-4cef-b4a3-78d7cc58e7d5"));
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v17;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Database change token has not been updated: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (!v18)
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v58 = v53;
        _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Should never have a nil change token here", buf, 0xCu);
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v59 = 2112;
      v60 = v27;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Updating database change token: %@", buf, 0x16u);
    ...
    v29 = (os_unfair_lock_s *)&v28[*MEMORY[0x1E0D32D00]];
    os_unfair_lock_lock_with_options();
    ...
    if (v36)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v59 = 2112;
        v60 = v36;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to update database state model: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v58 = v44;
        _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@Updated database change token successfully", buf, 0xCu);
...
void __111__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_RemoveDeletedZones____removeDeletedZonesWithFetchInfo___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    v5 = objc_alloc(MEMORY[0x1E0D32C40]);
...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreMirror)initWithLocalDatabase:(id)a3 cloudDatabase:(id)a4 useAnonymousRequests:(BOOL)a5 ownerQueue:(id)a6
{
  ...
  if (v14)
  {
    ...
    objc_msgSend(MEMORY[0x1E0D519E8], "schedulerWithDispatchQueue:", v13);
    v16 = objc_claimAutoreleasedReturnValue();
...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel)internalState
{
  ...
  if (!-[HMDNetworkRouterFirewallRuleManagerBackingStoreMirror isRunning](self, "isRunning"))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_FAULT))
    {
      ...
      v11 = 138543362;
      v12 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Should only get internal state while running", (uint8_t *)&v11, 0xCu);
...
- (id)__asyncFutureWithActivity:(id)a3 ignoreErrors:(BOOL)a4 block:(id)a5
{
  ...
  v25 = &v24;
  v26 = 0x3032000000;
  v27 = __Block_byref_object_copy__130172;
  v28 = __Block_byref_object_dispose__130173;
  v29 = 0;
  v10 = MEMORY[0x1E0C809B0];
  v20[0] = MEMORY[0x1E0C809B0];
  v20[1] = 3221225472;
...
- (void)startUpWithLocalZone:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("Startup"));
  v8[0] = MEMORY[0x1E0C809B0];
  v8[1] = 3221225472;
...
- (id)triggerOutputForOutputRow:(unint64_t)a3 options:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:", 58, a4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)flush
{
  ...
  v12 = &v11;
  v13 = 0x3032000000;
  v14 = __Block_byref_object_copy__130172;
  v15 = __Block_byref_object_dispose__130173;
  v16 = 0;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("Flush"));
...
- (id)shutdown
{
  ...
  v15 = __Block_byref_object_dispose__130173;
  v16 = 0;
  v3 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("Shutdown"));
  v7[0] = MEMORY[0x1E0C809B0];
  v7[1] = 3221225472;
...
- (void)fetchCloudRecordIDsForZoneID:(id)a3 options:(id)a4 completion:(id)a5
{
  ...
  v14 = v8;
  v12 = v8;
  -[HMDNetworkRouterFirewallRuleManagerBackingStoreMirror _fetchCloudRecordsForZoneID:recordID:options:desiredKeys:completion:](self, "_fetchCloudRecordsForZoneID:recordID:options:desiredKeys:completion:", v10, 0, v9, MEMORY[0x1E0C9AA60], v13);
...
- (id)fetchAllDataForRecordIDs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  v40 = &v39;
  v41 = 0x3032000000;
  v42 = __Block_byref_object_copy__130172;
  v43 = __Block_byref_object_dispose__130173;
  v44 = 0;
  v33 = 0;
  v34 = &v33;
  v35 = 0x3032000000;
  v36 = __Block_byref_object_copy__130172;
  v37 = __Block_byref_object_dispose__130173;
  v38 = 0;
  ...
  else
  {
    ...
    v20 = (void *)MEMORY[0x1D17BA0A0](v17);
    v21 = self;
    HMFGetOSLogHandle();
    v22 = (id)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v47 = 2112;
      v48 = v24;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Failed to fetch paired metadata dictionary with error %@", buf, 0x16u);
...
- (id)_fetchAllDataForZoneName:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  v28 = &v27;
  v29 = 0x3032000000;
  v30 = __Block_byref_object_copy__130172;
  v31 = __Block_byref_object_dispose__130173;
  v32 = 0;
  v11 = objc_alloc(MEMORY[0x1E0D28540]);
  objc_msgSend(v9, "label");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)removeAllLocalRulesWithOptions:(id)a3 error:(id *)a4
{
  ...
  v22 = &v21;
  v23 = 0x3032000000;
  v24 = __Block_byref_object_copy__130172;
  v25 = __Block_byref_object_dispose__130173;
  v26 = 0;
  v8 = objc_alloc(MEMORY[0x1E0D28540]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v47 = 2112;
      v48 = v24;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@No overrides fetched with error %@", buf, 0x16u);
...
- (id)_fetchOverridesForZoneName:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  v33 = &v32;
  v34 = 0x3032000000;
  v35 = __Block_byref_object_copy__130172;
  v36 = __Block_byref_object_dispose__130173;
  v37 = 0;
  v26 = 0;
  v27 = &v26;
  v28 = 0x3032000000;
  v29 = __Block_byref_object_copy__130172;
  v30 = __Block_byref_object_dispose__130173;
  v31 = 0;
  v11 = objc_alloc(MEMORY[0x1E0D28540]);
  objc_msgSend(v9, "label");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)addOverrides:(id)a3 replace:(BOOL)a4 options:(id)a5 error:(id *)a6
{
  ...
  v31 = __Block_byref_object_dispose__130173;
  v32 = 0;
  v13 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("AddOverrides"));
...
- (BOOL)removeOverridesForRecordIDs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  v24 = &v23;
  v25 = 0x3032000000;
  v26 = __Block_byref_object_copy__130172;
  v27 = __Block_byref_object_dispose__130173;
  v28 = 0;
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("RemoveOverridesForRecordIDs"));
  v17[0] = MEMORY[0x1E0C809B0];
  v17[1] = 3221225472;
...
- (BOOL)_removeOverridesForZoneName:(id)a3 recordName:(id)a4 options:(id)a5 error:(id *)a6
{
  ...
  v29 = &v28;
  v30 = 0x3032000000;
  v31 = __Block_byref_object_copy__130172;
  v32 = __Block_byref_object_dispose__130173;
  v33 = 0;
  v14 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("RemoveOverrides"));
...
- (void)__saveInternalStateWithActivity:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v26;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have internal state", buf, 0xCu);
  ...
  v7 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v4, "markWithFormat:", CFSTR("Saving internal state model")));
  v8 = self;
  HMFGetOSLogHandle();
  v9 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v30 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Saving internal state model", buf, 0xCu);
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v33 = 2112;
      v34 = v14;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to save internal state model %@: %@", buf, 0x20u);
...
uint64_t __92__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_addOverrides_replace_options_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v25 = 2112;
    v26 = v10;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Applying overrides for recordIDs: %@", buf, 0x16u);
...
uint64_t __98__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchOverridesForRecordIDs_options_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching overrides for recordIDs: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@No local zone, can't fetch overrides", buf, 0xCu);
...
uint64_t __94__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_removeAllLocalRulesWithOptions_error___block_invoke(uint64_t a1)
{
  ...
  v20 = *MEMORY[0x1E0C80C00];
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Removing all local rules")));
  v3 = *(id *)(a1 + 40);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v19 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Removing all local rules", buf, 0xCu);
...
uint64_t __96__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror__fetchAllDataForZoneName_options_error___block_invoke(uint64_t a1)
{
  ...
  v23 = *MEMORY[0x1E0C80C00];
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Fetching records with zone name '%@'"), *(_QWORD *)(a1 + 40)));
  v3 = *(id *)(a1 + 48);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching records with zone name '%@'", buf, 0x16u);
...
uint64_t __96__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchAllDataForRecordIDs_options_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2112;
    v28 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching records for recordIDs: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Failed to fetch paired metadata dictionary due to nil local zone", buf, 0xCu);
...
void __125__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror__fetchCloudRecordsForZoneID_recordID_options_desiredKeys_completion___block_invoke(id *a1)
{
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(a1[4], "markWithFormat:", CFSTR("Scheduling cloud fetch")));
  v3 = a1[5];
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling cloud fetch", buf, 0xCu);
...
uint64_t __125__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror__fetchCloudRecordsForZoneID_recordID_options_desiredKeys_completion___block_invoke_5(uint64_t a1)
{
  ...
  if (v3)
  {
    v4 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v2, "markWithFormat:", CFSTR("Cloud fetch completed successfully")));
    v5 = *(id *)(a1 + 48);
    HMFGetOSLogHandle();
    v6 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v12 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Cloud fetch completed successfully", buf, 0xCu);

    }
  }
  else
  {
    v4 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v2, "markWithFormat:", CFSTR("Cloud fetch completed unsuccessfully: %@"), *(_QWORD *)(a1 + 56)));
    v5 = *(id *)(a1 + 48);
    HMFGetOSLogHandle();
    v6 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Cloud fetch completed unsuccessfully: %@", buf, 0x16u);
...
void __148__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchCloudChangesForRecordIDs_options_ignoreLastSynchronizedRecords_xpcActivity_completion___block_invoke(uint64_t a1)
{
  ...
  v25 = *MEMORY[0x1E0C80C00];
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Scheduling cloud sync")));
  v3 = *(id *)(a1 + 40);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling cloud sync", buf, 0xCu);
...
void __148__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchCloudChangesForRecordIDs_options_ignoreLastSynchronizedRecords_xpcActivity_completion___block_invoke_167(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a2;
  v47 = a3;
  v6 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Beginning cloud sync")));
  v7 = v5;
  HMFGetOSLogHandle();
  v8 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v49 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Beginning cloud sync", buf, 0xCu);
  ...
  if (objc_msgSend(*(id *)(a1 + 40), "count"))
  {
    if (*(_BYTE *)(a1 + 64))
    {
      v10 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Ignoring last fetched accessories")));
      v11 = v7;
      HMFGetOSLogHandle();
      v12 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v13;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring last fetched accessories", buf, 0xCu);
...
LABEL_15:
      ...
      v27 = (char *)objc_claimAutoreleasedReturnValue();
      v28 = (os_unfair_lock_s *)&v27[*MEMORY[0x1E0D32D00]];
      os_unfair_lock_lock_with_options();
    ...
    if (v21)
    {
      v23 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v22, "markWithFormat:", CFSTR("Set of interested accessories has grown since last fetch: %@"), v18));
      v24 = v7;
      HMFGetOSLogHandle();
      v25 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v50 = 2112;
        v51 = v18;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_INFO, "%{public}@Set of interested accessories has grown since last fetch: %@", buf, 0x16u);
    ...
    v41 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v22, "markWithFormat:", CFSTR("Set of interested accessories has not grown, skipping fetch")));
    v42 = v7;
    HMFGetOSLogHandle();
    v43 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v44;
      _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Set of interested accessories has not grown, skipping fetch", buf, 0xCu);
  ...
  {
    v14 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Not interested in any records, skipping fetch")));
    v15 = v7;
    HMFGetOSLogHandle();
    v16 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Not interested in any records, skipping fetch", buf, 0xCu);
...
void __148__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchCloudChangesForRecordIDs_options_ignoreLastSynchronizedRecords_xpcActivity_completion___block_invoke_4(uint64_t a1)
{
  ...
  if (v2)
  {
    v7 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v6, "markWithFormat:", CFSTR("Cloud sync completed successfully: %@"), v5));
    v8 = *(id *)(a1 + 48);
    HMFGetOSLogHandle();
    v9 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v15 = 2112;
      v16 = v5;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Cloud sync completed successfully: %@", buf, 0x16u);

    }
  }
  else
  {
    v7 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v6, "markWithFormat:", CFSTR("Cloud sync completed unsuccessfully: %@"), *(_QWORD *)(a1 + 56)));
    v8 = *(id *)(a1 + 48);
    HMFGetOSLogHandle();
    v9 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@Cloud sync completed unsuccessfully: %@", buf, 0x16u);
...
void __65__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_shutdown__block_invoke(uint64_t a1)
{
  ...
  v15 = *MEMORY[0x1E0C80C00];
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Scheduling shutdown")));
  v3 = *(id *)(a1 + 40);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling shutdown", buf, 0xCu);
...
void __62__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_flush__block_invoke(uint64_t a1)
{
  ...
  v15 = *MEMORY[0x1E0C80C00];
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Scheduling flush")));
  v3 = *(id *)(a1 + 40);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling flush", buf, 0xCu);
...
void __62__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_flush__block_invoke_155(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a2;
  v6 = a3;
  v7 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Flushed")));
  v8 = v5;
  HMFGetOSLogHandle();
  v9 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v11 = 138543362;
    v12 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Flushed", (uint8_t *)&v11, 0xCu);
...
void __78__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_startUpWithLocalZone___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 32), "markWithFormat:", CFSTR("Scheduling startup")));
  v3 = *(id *)(a1 + 40);
  HMFGetOSLogHandle();
  v4 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v15 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling startup", buf, 0xCu);
...
void __102__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror___asyncFutureWithActivity_ignoreErrors_block___block_invoke_2_142(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 2112;
    v10 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring error from promise: %@", (uint8_t *)&v7, 0x16u);
...
void __102__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror___asyncFutureWithActivity_ignoreErrors_block___block_invoke_6(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v4 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(*(id *)(a1 + 40), "markWithFormat:", CFSTR("Not running block because we're already shutting down")));
      v5 = v3;
      HMFGetOSLogHandle();
      v6 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v16 = 138543362;
        v17 = v7;
        _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Not running block because we're already shutting down", (uint8_t *)&v16, 0xCu);
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v11;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Not running block because we're already shutting down", (uint8_t *)&v16, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_130275 != -1)
    dispatch_once(&logCategory__hmf_once_t4_130275, &__block_literal_global_130276);
  return (id)logCategory__hmf_once_v5_130277;
}
...
void __68__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_logCategory__block_invoke()
{
  ...
  v0 = objc_claimAutoreleasedReturnValue();
  v1 = (void *)logCategory__hmf_once_v5_130277;
  logCategory__hmf_once_v5_130277 = v0;
...
- (void)__fetchDatabaseChangesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v52 = 2112;
    v53 = v14;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Checking for database changes with change token: %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v9);
  v15 = objc_alloc(MEMORY[0x1E0C94DB0]);
  objc_msgSend(v4, "databaseChangeToken");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v6, "code") == 21)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Change token has expired: %@", buf, 0x16u);
...
- (void)__retryFetchDatabaseChangesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v29 = 2048;
    v30 = (unint64_t)v16;
    _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Will %s in %lu seconds", buf, 0x20u);
...
void __115__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchDatabaseChanges____fetchDatabaseChangesWithFetchInfo___block_invoke_2_23(uint64_t a1)
{
  ...
  _os_log_impl(&dword_1CD062000, v15, v16, v14, buf, v17);
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v25;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Mirror has been deallocated", buf, 0xCu);
...
uint64_t __115__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchDatabaseChanges____fetchDatabaseChangesWithFetchInfo___block_invoke_2_18(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v12 = 2112;
    v13 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Change token was updated: %@", buf, 0x16u);
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Zone was deleted: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring deleted zone: %@", buf, 0x16u);
        ...
        v5))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Zone has changes: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v17;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Forcing all zones to drop change tokens and refresh", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v14);
      objc_msgSend(*(id *)(a1 + 40), "zoneInfoMap");
      v18 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "enumerateKeysAndObjectsUsingBlock:", &__block_literal_global_143333);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v28 = 2112;
      v29 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changes from zone: %@", buf, 0x16u);
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Creating cloud zones", (uint8_t *)&buf, 0xCu);
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v29 = 0x3032000000;
    v30 = __Block_byref_object_copy__173785;
    v31 = __Block_byref_object_dispose__173786;
    v32 = 0;
    -[HMDNetworkRouterFirewallRuleManagerBackingStoreMirror cloudDatabase](v12, "cloudDatabase");
    v15 = (char *)objc_claimAutoreleasedReturnValue();
    v16 = (os_unfair_lock_s *)&v15[*MEMORY[0x1E0D32D00]];
    os_unfair_lock_lock_with_options();
...
- (void)__startUpCloudZonesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v42 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting up cloud zones", buf, 0xCu);
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2048;
      v44 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Waiting for %lu cloud zones to start up", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v32;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Not waiting for any cloud zones to start up", buf, 0xCu);
...
- (void)__performCloudZonePullsWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v42 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting to pull from cloud zones", buf, 0xCu);
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2048;
      v44 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Waiting for %lu cloud zones to pull", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v32;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Not waiting for any cloud zones to pull", buf, 0xCu);
      ...
      if (v12)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v37 = 2112;
          v38 = v20;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Fetching changes for zone %@ but ignoring change token", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v37 = 2112;
          v38 = v25;
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Fetching changes for zone %@", buf, 0x16u);
...
void __112__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____performCloudZonePullsWithFetchInfo___block_invoke_4(uint64_t a1)
{
  ...
  v7 = &v6;
  v8 = 0x3032000000;
  v9 = __Block_byref_object_copy__173785;
  v10 = __Block_byref_object_dispose__173786;
  v11 = 0;
  v4 = *(void **)(a1 + 40);
  v5[0] = v3;
  v5[1] = 3221225472;
...
void __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    v8 = objc_alloc_init(MEMORY[0x1E0D32CC8]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v51 = 2112;
        v52 = v35;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to create mirrored local zone for %@: %@", buf, 0x20u);
      ...
      v31 = a1[6];
      v20 = v35;
      objc_msgSend(MEMORY[0x1E0D519C0], "futureWithError:", v35);
      v19 = (void *)objc_claimAutoreleasedReturnValue();
...
void __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke_4(uint64_t a1)
{
  ...
  v5 = &v4;
  v6 = 0x3032000000;
  v7 = __Block_byref_object_copy__173785;
  v8 = __Block_byref_object_dispose__173786;
  v9 = 0;
  v2 = *(void **)(a1 + 32);
  v3[0] = MEMORY[0x1E0C809B0];
  v3[1] = 3221225472;
...
id __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke_24(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v10;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Zone %@ started up", buf, 0x16u);
...
void __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke_28(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v15 = 2112;
    v16 = v3;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Zone %@ failed to start up: %@", buf, 0x20u);
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v94 = 2112;
        v95 = v24;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Already have a model for zone %@", buf, 0x16u);
        ...
        if ((isKindOfClass & 1) != 0)
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v94 = 2112;
            v95 = v36;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Already have an open HMDNetworkRouterFirewallRuleCloudZone for zone %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v96 = 2112;
            v97 = v26;
            _os_log_impl(&dword_1CD062000, v72, OS_LOG_TYPE_ERROR, "%{public}@Another HMBCloudZone open for %@ that isn't one of ours: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v94 = 2112;
        v95 = v48;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Saving new cloud zone model for zone %@", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v44);
      v49 = objc_alloc(MEMORY[0x1E0D32C48]);
      ...
      objc_msgSend(v12, "setNeedsZoneCreation:", MEMORY[0x1E0C9AAA0]);
      objc_msgSend(*(id *)(a1 + 40), "cloudDatabase");
      v52 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40))
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v96 = 2112;
          v97 = v69;
          _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_ERROR, "%{public}@Failed to save new cloud zone model for zone %@: %@", buf, 0x20u);
...
LABEL_29:
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v94 = 2112;
    v95 = v43;
    _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring zone %@ that has no changes", buf, 0x16u);
