...
- (void)addListener:(id)a3 forDeviceAddress:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v25 = 2112;
    v26 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Adding listener %p for address: %@", (uint8_t *)&v21, 0x20u);
...
- (void)removeListener:(id)a3 forDeviceAddress:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing listener %p for address: %@", (uint8_t *)&v23, 0x20u);
  ...
  if ((-[NSMutableArray containsObject:](self->_devicesWithPendingUnreachability, "containsObject:", v4) & 1) == 0)
  {
          ...
          v8))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v16 = 2112;
        v17 = v13;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Device address %@ reported unreachable.  Debouncing reachability", (uint8_t *)&v14, 0x16u);
...
- (void)transport:(id)a3 idsIdentifier:(id)a4 didAppearReachable:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_QWORD *)&v24[14] = v14;
    v25 = 2112;
    v26 = v9;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Device with idsIdentifier reporting %@: %@ ", v24, 0x20u);
...
LABEL_13:
  ...
  objc_msgSend(v17, "setReachability:", MEMORY[0x1E0C9AAB0], *(_OWORD *)v24);
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying listeners that device address is %@: %@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v21;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot notify listeners for reachability change with nil address", buf, 0xCu);
    ...
    do
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v35 = 2112;
        v36 = v18;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Unreachable Debounce timer did fire for device address %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_150945 != -1)
    dispatch_once(&logCategory__hmf_once_t12_150945, &__block_literal_global_150946);
  return (id)logCategory__hmf_once_v13_150947;
}
...
void __59__HMDModernTransportDeviceReachabilityObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_150947;
  logCategory__hmf_once_v13_150947 = v0;
