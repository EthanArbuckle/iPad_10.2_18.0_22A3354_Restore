...
- (id)periodicRemoteMessageCounterEventNameWithMessageName:(id)a3 peerInformation:(id)a4
{
  ...
  if (a3)
  {
    if (!v5)
      v6 = CFSTR("Unknown");
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%@/%@"), v6, a3);
...
- (void)_handleRemoteMessageLogEvent:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v13 > 6)
      ...
      v14 = off_1E89C1C90[v13];
    v15 = v14;
    v16 = objc_msgSend(v4, "msgType");
    if (v16 > 3)
      v17 = 0;
    else
      v17 = off_1E89C1CE0[v16];
    v18 = v17;
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v38 = 2114;
    v39 = v19;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@[CA] HMDRemoteMessageLogEvent -- %{public}@message %{public}@ %{public}@ over %{public}@ as %{public}@ (QoS: %{public}@)", buf, 0x48u);
...
LABEL_10:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          v28 = 2112;
          v29 = v14;
          _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Unable to retrieve eventName for remoteMessage - dropping remote message log event with identifier %@", (uint8_t *)&v26, 0x16u);
    ...
    default:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        v28 = 2112;
        v29 = v14;
        _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Invalid transport type - dropping remote message log event with identifier %@", (uint8_t *)&v26, 0x16u);
...
LABEL_6:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v4;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Unknown XPC message counter type - dropping the LogEvent %@", buf, 0x16u);
...
- (void)handlePrimaryResidentChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received update primary resident notification but the primary resident is nil", (uint8_t *)&v15, 0xCu);
