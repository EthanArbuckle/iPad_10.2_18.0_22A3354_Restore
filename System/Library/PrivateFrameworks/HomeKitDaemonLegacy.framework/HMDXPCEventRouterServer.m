...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_7805 != -1)
    dispatch_once(&logCategory__hmf_once_t0_7805, &__block_literal_global_7806);
  return (id)logCategory__hmf_once_v1_7807;
}
...
void __61__HMDXPCEventRouterServer_handleConnectionActiveStateChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@[HMDXPCEventRouterSever] Received notification that connection active state changed: %@", (uint8_t *)&v13, 0x16u);
...
- (void)_handleChangeRegistrationsRequest:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v33;
      _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@No transport on message.", buf, 0xCu);
  ...
  if ((objc_msgSend(v4, "isEntitledForSPIAccess") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v38;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@Not entitled.", buf, 0xCu);
...
LABEL_24:
  ...
  if (v9)
  {
    ...
    if ((v10 & 1) != 0)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Found xpc connection in message", buf, 0xCu);

      }
      objc_autoreleasePoolPop(v11);
      objc_msgSend(v4, "dataForKey:", *MEMORY[0x1E0CBA130]);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      if (v16)
      {
        v17 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CBA968]), "initWithData:", v16);
        objc_msgSend(v17, "topicFilterAdditions");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v18, "na_map:", &__block_literal_global_22_7786);
        ...
        objc_msgSend(v24, "na_map:", &__block_literal_global_24);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v52 = v48;
          _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@No message payload present.", buf, 0xCu);
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v53 = 2112;
        v54 = v9;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Connection is not active %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v42;
      _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_ERROR, "%{public}@Transport is not XPC connection.", buf, 0xCu);
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Sending events: %ld to connection: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v7;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Sending events: %@ to connection: %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v15);
    objc_msgSend(v6, "na_map:", &__block_literal_global_33);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v20 = objc_alloc_init(MEMORY[0x1E0CBA970]);
    v21 = (void *)objc_msgSend(v19, "mutableCopy");
    objc_msgSend(v20, "setEvents:", v21);

    objc_msgSend(v20, "data", *MEMORY[0x1E0CBA128]);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    v30 = v22;
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v30, &v29, 1);
    v23 = (void *)objc_claimAutoreleasedReturnValue();

    v24 = (void *)MEMORY[0x1E0D285D0];
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = (uint64_t)v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Could not obtain xpc connection from %@", buf, 0x16u);
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Sending cached events: %ld to connection: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v35 = 2112;
      v36 = v7;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Sending cached events: %@ to connection: %@", buf, 0x20u);
...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D32D68]), "initWithQueue:provider:registrationEventRouter:storeReadHandle:logCategory:", a1[4], a1[5], a1[6], a1[7], "XPCEventRouter.Server");
}
...
void __38__HMDXPCEventRouterServer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_7807;
  logCategory__hmf_once_v1_7807 = v0;
