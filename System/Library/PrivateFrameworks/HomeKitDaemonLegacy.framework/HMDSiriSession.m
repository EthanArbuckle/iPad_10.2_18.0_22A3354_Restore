...
- (BOOL)activateAfterHubInitiation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Hub initiated Siri input not supported for this Siri session (%@)", (uint8_t *)&v9, 0x16u);
...
LABEL_6:
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Siri session is inactive and activation is pending, reading first frame (%@)", (uint8_t *)&v13, 0x16u);
...
- (void)activeSiriSession:(id)a3 didCreateAudioFrame:(id)a4 sequenceNumber:(id)a5 gain:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@[session %@] Send frame (%lu bytes)", buf, 0x20u);
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Invalidate", (uint8_t *)&v8, 0x16u);
...
- (void)publish
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Telling plugin to add this session as device", buf, 0x16u);
...
- (void)handleStartStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Starting stream", (uint8_t *)&v15, 0x16u);
  ...
  if (v11 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v8))
  {
    ...
    v15 = 138412290;
    v16 = v12;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, v8, OS_SIGNPOST_EVENT, v11, "SiriRecording", "AccessoryID=%@", (uint8_t *)&v15, 0xCu);
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:", 1055);
...
- (void)handleStopStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Stopping stream", (uint8_t *)&v8, 0x16u);
...
- (void)handleResetStream
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@[session %@] Resetting stream", (uint8_t *)&v8, 0x16u);
...
- (void)activeSiriSessionDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@[session %@] Deactivating Siri Session", (uint8_t *)&v10, 0x16u);
...
- (void)stopStream
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v26 = 2112;
      v27 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Session %@ stopped the audio", (uint8_t *)&v24, 0x16u);
    ...
    if (v13 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v10))
    {
      ...
      v24 = 138412290;
      v25 = v14;
      _os_signpost_emit_with_name_impl(&dword_1CD062000, v10, OS_SIGNPOST_INTERVAL_END, v13, "SiriSession", "AccessoryID=%@", (uint8_t *)&v24, 0xCu);
  ...
  else
  {
    if (v7)
    {
      ...
      v26 = 2112;
      v27 = v18;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Session %@ did stop but was not active (stale notification?)", (uint8_t *)&v24, 0x16u);
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 138543362;
      v25 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Releasing boost message", (uint8_t *)&v24, 0xCu);
...
- (void)beginTrackingStreamStartMetricWithActivationType:(unint64_t)a3
{
  ...
  if (v7 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled((os_log_t)v8))
  {
    ...
    v21 = 2112;
    v22 = v12;
    _os_signpost_emit_with_name_impl(&dword_1CD062000, v9, OS_SIGNPOST_INTERVAL_BEGIN, v7, "SiriSession", "ActivationType=%@ AccessoryID=%@", (uint8_t *)&v19, 0x16u);
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Resetting start stream metric", (uint8_t *)&v19, 0xCu);
