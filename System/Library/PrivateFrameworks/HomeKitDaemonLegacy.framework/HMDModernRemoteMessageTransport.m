...
- (HMDModernRemoteMessageTransport)initWithAccountRegistry:(id)a3
{
  ...
  v8 = -[HMDIDSMessageTransport initModernTransportWithAccountRegistry:]([HMDIDSMessageTransport alloc], "initModernTransportWithAccountRegistry:", v4);
...
- (HMDModernRemoteMessageTransport)initWithAccountRegistry:(id)a3 rapportTransport:(id)a4 idsTransport:(id)a5 contextManager:(id)a6 systemDateProvider:(id)a7 idsDateProvider:(id)a8 timerProvider:(id)a9 isWatch:(BOOL)a10
{
  ...
  if (v22)
  {
    ...
    v35 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99E10]), "initWithCapacity:", 100);
...
- (id)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v20 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting", buf, 0xCu);
  ...
  else
  {
    ...
    if (v7
      && (objc_msgSend(v7, "device"),
          ...
          v9 = (void *)objc_claimAutoreleasedReturnValue(),
          v10 = objc_msgSend(v9, "supportsModernTransport"),
          v9,
          v8,
          v10))
    {
      v13 = !-[HMDModernRemoteMessageTransport isWatch](self, "isWatch")
         && (-[HMDModernRemoteMessageTransport rapportTransport](self, "rapportTransport"),
             v11 = (void *)objc_claimAutoreleasedReturnValue(),
             v12 = objc_msgSend(v11, "canSendMessage:", v4),
             v11,
             (v12 & 1) != 0)
         || objc_msgSend(v4, "restriction") == -1;
    }
    else
    {
      v13 = 0;
...
- (void)sendMessage:(id)a3 completionHandler:(id)a4
{
    ...
    if (!-[HMDModernRemoteMessageTransport isStarted](self, "isStarted"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v23 = 2114;
        v24 = v15;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Received request to send message %{public}@ before transport was started; message may fail",
          buf,
          0x16u);
  ...
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 3, CFSTR("Invalid parameter"), CFSTR("Not a remote message"), 0);
  ...
  if (a1)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v163, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(_QWORD *)&buf[4] = v164;
        _os_log_impl(&dword_1CD062000, v163, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Received message that is not HMDRemoteMessage.", buf, 0xCu);
        ...
        if (vabdd_f64(v28, v21) >= *(double *)&v17)
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(double *)&v184[10] = v24 - v28;
            _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Dropping message %{public}@ received on %{public}@ outside its TTL: IDS time now = %{public}f, system time now = %{public}f, sent = %{public}f, ttl = %{public}f, IDS time delta = %{public}f, drift = %{public}f", buf, 0x5Cu);
    ...
    if (!v36)
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v180 = v11;
        _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Received invalid %@ message %@, No Identifier", buf, 0x20u);
    ...
    if (v42)
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v180 = v11;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_FAULT, "%{public}@Received invalid %{public}@ message %@, message is from ourselves", buf, 0x20u);
    ...
    if (v60)
    {
      if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[22] = 2114;
        v180 = v73;
        _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_INFO, "%{public}@Dropping duplicate message %{public}@ received on %{public}@", buf, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v67, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v180 = v11;
        _os_log_impl(&dword_1CD062000, v68, OS_LOG_TYPE_DEFAULT, "%{public}@Received message over %{public}@: %@", buf, 0x20u);
      ...
      if (os_log_type_enabled(v78, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&buf[22] = 2113;
        v180 = v83;
        _os_log_impl(&dword_1CD062000, v78, OS_LOG_TYPE_DEBUG, "%{public}@Received message %{public}@ with payload: %{private}@", buf, 0x20u);
      ...
      if (!objc_msgSend(v177, "type"))
      {
        ...
        *(_QWORD *)&buf[16] = __69__HMDModernRemoteMessageTransport__responseHandlerForRequestMessage___block_invoke;
        v180 = (HMDAssertionLogEvent *)&unk_1E89B0220;
      ...
      if (objc_msgSend(v177, "type") == 1)
      {
        ...
        if (v87)
        {
          ...
          if (v89)
          {
            ...
            if (v92)
            {
              ...
              if (!v96)
              {
                ...
                if (os_log_type_enabled(v100, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_WORD *)&buf[22] = 2112;
                  v180 = v97;
                  _os_log_impl(&dword_1CD062000, v100, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize response error for message %{public}@ with error: %@", buf, 0x20u);

                }
                objc_autoreleasePoolPop(v98);
                objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 52, CFSTR("Generic error."), CFSTR("Failed to deserialize remote error."), 0, v97);
                v96 = (void *)objc_claimAutoreleasedReturnValue();
                v89 = v169;
              }
              ...
              && v134)
            {
              ...
              if (os_log_type_enabled(v138, OS_LOG_TYPE_INFO))
              {
                ...
                *(_WORD *)v181 = 2114;
                *(_QWORD *)&v181[2] = v142;
                _os_log_impl(&dword_1CD062000, v138, OS_LOG_TYPE_INFO, "%{public}@Ignoring response message %{public}@ with error: %@, for request %{public}@", buf, 0x2Au);
            ...
            else
            {
              ...
              v147 = v146;
              v148 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v133, "receivedResponseOverTransport:withError:", v146, v132));
              v149 = v172;
              HMFGetOSLogHandle();
              ...
              if (os_log_type_enabled(v150, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *(_WORD *)&buf[12] = 2114;
                *(_QWORD *)&buf[14] = v152;
                _os_log_impl(&dword_1CD062000, v150, OS_LOG_TYPE_DEFAULT, "%{public}@Received response for message %{public}@", buf, 0x16u);

              }
              objc_autoreleasePoolPop(v148);
              v153 = (void *)MEMORY[0x1E0C99E08];
              ...
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[HMDAssertionLogEvent transportType](v147, "transportType"));
              v157 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(v143, "setObject:forKeyedSubscript:", v157, CFSTR("kRemoteMessageTransportAttributionKey"));

              objc_msgSend(v143, "setObject:forKeyedSubscript:", MEMORY[0x1E0C9AAB0], CFSTR("kRemoteMessageIsModernTransportUsedKey"));
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", objc_msgSend(v149, "isRapportLinkSlow"));
          ...
          else
          {
            ...
            if (os_log_type_enabled(v127, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&buf[12] = 2114;
              *(_QWORD *)&buf[14] = v130;
              _os_log_impl(&dword_1CD062000, v127, OS_LOG_TYPE_INFO, "%{public}@Could not find the context and dropping message %{public}@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v122, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2114;
            *(_QWORD *)&buf[14] = v124;
            _os_log_impl(&dword_1CD062000, v122, OS_LOG_TYPE_ERROR, "%{public}@Received a response message %{public}@ without a transaction identifier", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v16 = 2112;
        v17 = objc_opt_class();
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Unexpected transport class: %@", buf, 0x16u);
...
- (void)_notifyDeviceReachabilityForDestination:(uint64_t)a3 isReachable:
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v21 = 2112;
      v22 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Reachability update - isReachable: %@, device: %@", (uint8_t *)&v17, 0x20u);
...
void __69__HMDModernRemoteMessageTransport__responseHandlerForRequestMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v23 = 2114;
    v24 = v18;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Sending response for message %{public}@ using message: %{public}@", buf, 0x20u);
...
void __65__HMDModernRemoteMessageTransport_sendMessage_completionHandler___block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)((char *)&v103[1] + 2) = *MEMORY[0x1E0C80C00];
  v1 = *(void **)(a1 + 32);
  v2 = *(void **)(a1 + 48);
  v96 = *(id *)(a1 + 40);
  v95 = v2;
  if (v1)
  {
    ...
    else
    {
      ...
      v5 = (void *)objc_claimAutoreleasedReturnValue();
      v4 = objc_msgSend(v5, "canSendMessage:", v96);

    }
    objc_msgSend(v1, "idsTransport");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = objc_msgSend(v6, "canSendMessage:", v96);
    ...
    if (((v4 | v7) & 1) != 0)
    {
      ...
      if (v9 && objc_msgSend(v8, "type"))
      {
        ...
        if (os_log_type_enabled(v90, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v91;
          _os_log_impl(&dword_1CD062000, v90, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Message expects a response but is not a request type. Remove the response handler or change the message type.", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v88);
        v92 = -[HMDAssertionLogEvent initWithReason:]([HMDAssertionLogEvent alloc], "initWithReason:", CFSTR("Message expects a response but is not a request type. Remove the response handler or change the message type."));
        +[HMDMetricsManager sharedLogEventSubmitter](HMDMetricsManager, "sharedLogEventSubmitter");
        v93 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v93, "submitLogEvent:", v92);
      ...
      *(_QWORD *)&v101[8] = v94;
      v101[18] = 0;
      v11 = v95;
      v12 = +[HMDModernTransportMessageContextOptions newWithBuilder:](HMDModernTransportMessageContextOptions, "newWithBuilder:", buf);
      ...
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v13, "createContextWithMessage:options:completionHandler:dateProvider:timerProvider:", v94, v12, v11, v14, v15);
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v16)
      {
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          HMFBooleanToString();
          v22 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v18, "isRapportLinkSlow");
          HMFBooleanToString();
          ...
          *(_QWORD *)&v101[2] = v24;
          *(_WORD *)&v101[10] = 2114;
          *(_QWORD *)&v101[12] = CFSTR("N/A");
          v102 = 2112;
          v103[0] = v94;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Sending message over Rapport = %{public}@ (isSlow = %{public}@), IDS = %{public}@, Resident to Resident = %{public}@: %@", buf, 0x3Eu);
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
        {
          ...
          objc_msgSend(v94, "messagePayload");
          ...
          *(_WORD *)&buf[22] = 2113;
          v100 = v30;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Sending message %{public}@ with payload: %{private}@", buf, 0x20u);

        }
        objc_autoreleasePoolPop(v25);
        v31 = v16;
        if (objc_msgSend(v31, "expectsResponse"))
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
          {
            ...
            objc_msgSend(v31, "messageID");
            v36 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v31, "timeout");
            *(_DWORD *)buf = 138543874;
            *(_QWORD *)&buf[4] = v35;
            *(_WORD *)&buf[12] = 2114;
            *(_QWORD *)&buf[14] = v36;
            *(_WORD *)&buf[22] = 2048;
            v100 = v37;
            _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_INFO, "%{public}@Starting response timer for message %{public}@. Timeout is %.0f seconds", buf, 0x20u);
          ...
          *(_QWORD *)v101 = v31;
          objc_msgSend(*(id *)v101, "startResponseTimerWithTimeInterval:queue:completionHandler:", v40, buf, v39);
        ...
        if (v4)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[12] = 2114;
            *(_QWORD *)&buf[14] = v45;
            _os_log_impl(&dword_1CD062000, v43, OS_LOG_TYPE_INFO, "%{public}@Sending message %{public}@ over Rapport", buf, 0x16u);

          }
          objc_autoreleasePoolPop(v41);
          objc_msgSend(v31, "remainingTransports");
          ...
          if (v47)
          {
            objc_msgSend(v31, "timeoutRemaining");
            if (v49 <= 0.0)
              v48 = 15.0;
            else
              v48 = v49;
          }
          objc_msgSend(v42, "systemDateProvider");
          v50 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v50, "timeIntervalSince1970");
          v52 = v51;

          objc_msgSend(v42, "rapportTransport");
          v53 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v31, "startSendingOverTransport:", v53);
          ...
          *(_QWORD *)&buf[16] = __59__HMDModernRemoteMessageTransport__sendMessageOverRapport___block_invoke;
          ...
          v55 = v54;
          *(_QWORD *)v101 = v55;
          *(_QWORD *)((char *)v103 + 2) = v52;
          v56 = _Block_copy(buf);
          v57 = (void *)v42[12];
          objc_msgSend(v31, "preparedMessageWithTimeout:", v48);
          v58 = (void *)objc_claimAutoreleasedReturnValue();
          objc_msgSend(v57, "sendMessage:completionHandler:", v58, v56);
          ...
          if ((v7 & 1) != 0)
          {
            v59 = objc_msgSend(v42, "isRapportLinkSlow");
            v60 = objc_msgSend(v94, "remoteDisallowsIDSRacing");
            v61 = v60;
            if (v59)
            {
              ...
              if (v61)
              {
                if (v65)
                {
                  ...
                  *(_WORD *)&buf[12] = 2114;
                  *(_QWORD *)&buf[14] = v67;
                  _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, "%{public}@Not sending message %{public}@ over IDS initially even though Rapport link is slow because message disallows IDS racing", buf, 0x16u);
              ...
              else
              {
                if (v65)
                {
                  ...
                  *(_WORD *)&buf[12] = 2114;
                  *(_QWORD *)&buf[14] = v87;
                  _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, "%{public}@Also sending message %{public}@ over IDS because Rapport link is slow", buf, 0x16u);
            ...
            else if (v60)
            {
              ...
              if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
              {
                ...
                *(_WORD *)&buf[12] = 2114;
                *(_QWORD *)&buf[14] = v81;
                _os_log_impl(&dword_1CD062000, v79, OS_LOG_TYPE_INFO, "%{public}@Not starting fallback timer for message %{public}@ because message disallows IDS racing", buf, 0x16u);
            ...
            {
              v31 = v31;
              objc_msgSend(v31, "inProgressTransports");
              ...
              if (v84)
              {
                ...
                *(_QWORD *)&buf[16] = __65__HMDModernRemoteMessageTransport__startFallbackTimerForContext___block_invoke;
                ...
                objc_copyWeak((id *)&v101[8], &location);
                *(_QWORD *)v101 = v31;
                objc_msgSend(*(id *)v101, "startTransportFallbackTimerWithTimeInterval:queue:completionHandler:", v85, buf, 0.2);
      ...
      else
      {
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2114;
          *(_QWORD *)&buf[14] = v75;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create context for message %{public}@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(_QWORD *)&buf[14] = v96;
        _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_ERROR, "%{public}@Message %@ cannot be sent over modern transport", buf, 0x16u);

      }
      objc_autoreleasePoolPop(v68);
      v72 = (void *)MEMORY[0x1E0CB35C8];
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmPrivateErrorWithCode:", 2031);
      v31 = (id)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v72, "hmErrorWithCode:description:reason:suggestion:underlyingError:", 2, CFSTR("Cannot be sent over Modern Transport"), CFSTR("Not support by Modern Transport or there is no available transport"), 0, v31);
...
- (void)_sendMessageOverIDS:(void *)a1
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2114;
    v31 = v8;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Sending message %{public}@ over IDS", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2114;
      v31 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot send message %{public}@ over IDS because we exceeded the message timeout", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v12);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 8, CFSTR("Message timed out"), CFSTR("Message already expired before being able to send"), 0);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (WeakRetained)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v15 = 2114;
        v16 = v12;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Rapport is slow, falling back to IDS for message %{public}@", (uint8_t *)&v13, 0x16u);
  ...
  if (v5)
  {
    ...
    if (v5 != v6)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
      {
        ...
        v14 = 138543362;
        v15 = v11;
        _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Remaining transport is not IDS", (uint8_t *)&v14, 0xCu);
...
- (void)_handleCompletionOnTransport:(void *)a3 context:(void *)a4 error:
{
  ...
  if (v13)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v48 = 2112;
      v49 = v9;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Message %{public}@ over %{public}@ completed with error: %@", (uint8_t *)&v42, 0x2Au);
    ...
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v44 = 2114;
        v45 = v35;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully sent message %{public}@ that does not expect a response", (uint8_t *)&v42, 0x16u);
      ...
      if (!v22 && !-[HMDModernRemoteMessageTransport _sendOverRemainingTransportForContext:](v15, v8))
      {
        if (objc_msgSend(v9, "code") == 3204)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
          {
            ...
            v46 = 2114;
            v47 = v23;
            _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send multicast message %{public}@ to destination %{public}@", (uint8_t *)&v42, 0x20u);
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v46 = 2112;
          v47 = v9;
          _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send message %{public}@ with error: %@", (uint8_t *)&v42, 0x20u);
...
LABEL_22:
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      v44 = 2114;
      v45 = v30;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Context not found for identifier %{public}@", (uint8_t *)&v42, 0x16u);
...
void __55__HMDModernRemoteMessageTransport__sendMessageOverIDS___block_invoke_2(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 2114;
      v13 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Context was already released for identifier %{public}@ completed on IDS transport", (uint8_t *)&v10, 0x16u);
...
void __59__HMDModernRemoteMessageTransport__sendMessageOverRapport___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Rapport response for message %{public}@ received in %lu ms", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v21 = 2114;
      v22 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Context was already released for identifier %{public}@ completed on Rapport transport", (uint8_t *)&v19, 0x16u);
...
void __65__HMDModernRemoteMessageTransport__startResponseTimerForContext___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v16 = 2114;
      v17 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Message %{public}@ timed out", (uint8_t *)&v14, 0x16u);
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = *(_QWORD *)(a1 + 32);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 8, CFSTR("Operation timed out."), CFSTR("Message timed out waiting for a response."), 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
...
void __141__HMDModernRemoteMessageTransport__createContextWithRemoteMessage_canSendOverRapport_canSendOverIDS_expectsRapportSuccess_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v7)
  {
    ...
    {
      v11 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v3, "setTimeoutOverride:", 60.0));
      v12 = *(id *)(a1 + 32);
      HMFGetOSLogHandle();
      v13 = objc_claimAutoreleasedReturnValue();
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        v45 = 2048;
        v46 = v16;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Message %{public}@ expects a response but timeout is not set. Setting timeout to %.0f seconds", (uint8_t *)&v41, 0x20u);
  ...
  if (v18)
  {
    ...
    if ((isKindOfClass & 1) != 0)
    {
      ...
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      if ((objc_msgSend(v23, "isValidMessage:", v20) & 1) != 0)
      {
        objc_msgSend((id)v18, "idsTransport");
        v24 = (void *)objc_claimAutoreleasedReturnValue();
        v25 = objc_msgSend(v24, "isValidMessage:", v20);
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
      {
        ...
        v43 = 2112;
        v44 = v20;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Not tracking reachability for restricted message: %@", (uint8_t *)&v41, 0x16u);
...
LABEL_22:
  ...
  v35 = v34;
  v36 = 0.0;
  if (v31 && objc_msgSend(v34, "type") != 1 && (objc_msgSend(v35, "sendOptions") & 1) == 0)
  {
    if (v33 < 2.22044605e-16)
    {
      objc_msgSend(v35, "timeout");
      v33 = v37;
    }
    v38 = 15.0;
    if (v33 >= 15.0)
  ...
  objc_msgSend(v3, "setTimeToLive:", v36);
  objc_msgSend((id)objc_opt_class(), "requestStartTimeHeaderKey");
  v39 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setRequestStartTimeHeaderKey:", v39);

  objc_msgSend((id)objc_opt_class(), "timeToLiveHeaderKey");
  v40 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setTimeToLiveHeaderKey:", v40);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t50 != -1)
    dispatch_once(&logCategory__hmf_once_t50, &__block_literal_global_84961);
