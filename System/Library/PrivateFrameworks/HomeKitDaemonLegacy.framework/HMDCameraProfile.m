  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v36 = 2112;
      v37 = v4;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because one of the properties of service is nil: service.accessory.home %@  service.accessory.home.name %@  service.name %@", buf, 0x2Au);
      if (v6)
...
- (HMDCameraProfile)initWithAccessory:(id)a3 services:(id)a4 msgDispatcher:(id)a5 workQueue:(id)a6 home:(id)a7 settingsManager:(id)a8
{
  ...
  void *v57;
  void *v58;
  HMDCameraClipUserNotificationCenter *v59;
  void *v60;
  uint64_t v61;
  void *v62;
  HMDCameraStreamSnapshotHandler *v63;
  void *v64;
  void *v65;
  void *v66;
  void *v67;
  ...
  void *v70;
  void *v71;
  HMDCameraProfile *v72;
  void *v74;
  HMDCameraRecordingReachabilityEventManager *v75;
  HMDCameraStreamSnapshotHandler *v76;
  id v77;
  id v78;
  HMDCameraStreamSnapshotHandler *v79;
  void *v80;
  void *v82;
  id v83;
  HMDCameraSnapshotManager *v84;
  HMDCameraClipManager *v85;
  void *v86;
  id v87;
  id v88;
  void *v89;
...
LABEL_46:
  ...
  v91 = 0;
  v22 = *(_QWORD *)v108;
  v23 = *MEMORY[0x1E0CB99D0];
  v24 = *MEMORY[0x1E0CB99D8];
  do
  {
    for (i = 0; i != v21; ++i)
    {
...
LABEL_21:
  ...
  if (v91)
  {
    ...
    v57 = (void *)v53;
    v85 = -[HMDCameraClipManager initWithHome:zoneUUID:messageDispatcher:workQueue:cameraProfileUUID:]([HMDCameraClipManager alloc], "initWithHome:zoneUUID:messageDispatcher:workQueue:cameraProfileUUID:", v89, v56, v90, v87, v53);
    +[HMDCameraProfile bulletinBoard](HMDCameraProfile, "bulletinBoard");
    v58 = (void *)objc_claimAutoreleasedReturnValue();
    if (v58)
    {
      v59 = [HMDCameraClipUserNotificationCenter alloc];
      -[HMDAccessoryProfile logIdentifier](self, "logIdentifier");
      v60 = (void *)objc_claimAutoreleasedReturnValue();
      v61 = -[HMDCameraClipUserNotificationCenter initWithBulletinBoard:workQueue:logIdentifier:](v59, "initWithBulletinBoard:workQueue:logIdentifier:", v58, v87, v60);
    ...
    v74 = (void *)v61;
    v62 = v82;
    v75 = -[HMDCameraRecordingReachabilityEventManager initWithHAPAccessory:workQueue:]([HMDCameraRecordingReachabilityEventManager alloc], "initWithHAPAccessory:workQueue:");
  ...
  v78 = objc_alloc_init(MEMORY[0x1E0D28610]);
  v63 = [HMDCameraStreamSnapshotHandler alloc];
  ...
  objc_msgSend(v65, "stringWithFormat:", CFSTR("%@/%@/%@"), v66, v67, v57);
  v68 = (void *)objc_claimAutoreleasedReturnValue();
  v76 = -[HMDCameraStreamSnapshotHandler initWithWorkQueue:services:logID:](v63, "initWithWorkQueue:services:logID:", v87, v64, v68);

  v84 = -[HMDCameraSnapshotManager initWithAccessory:workQueue:streamSnapshotHandler:uniqueIdentifier:msgDispatcher:networkMonitor:]([HMDCameraSnapshotManager alloc], "initWithAccessory:workQueue:streamSnapshotHandler:uniqueIdentifier:msgDispatcher:networkMonitor:", v62, v87, v76, v57, v90, v78);
  ...
  v72 = objc_retain(-[HMDCameraProfile initWithAccessory:services:recordingManagementService:msgDispatcher:workQueue:home:settingsManager:uniqueIdentifier:clipManager:clipUserNotificationCenter:reachabilityEventManager:networkMonitor:streamSnapshotHandler:snapshotManager:cameraStreamManagers:notificationCenter:](self, "initWithAccessory:services:recordingManagementService:msgDispatcher:workQueue:home:settingsManager:uniqueIdentifier:clipManager:clipUserNotificationCenter:reachabilityEventManager:networkMonitor:streamSnapshotHandler:snapshotManager:cameraStreamManagers:notificationCenter:", v83, v42, v91, v90, v88, v89, v86, v69, v85, v74, v75, v77, v79, v84,
            v70,
            v71));
...
LABEL_24:
  ...
  {
LABEL_25:
    v45 = (HMDCameraProfile *)_HMFPreconditionFailure();
    return (HMDCameraProfile *)-[HMDCameraProfile isCameraRecordingFeatureSupported](v45, v46);
  }
  v49 = v27;
  ...
  v35 = -[HMDAccessoryProfile initWithAccessory:uniqueIdentifier:services:workQueue:](&v62, sel_initWithAccessory_uniqueIdentifier_services_workQueue_, v57, v58, v34, v31);

  if (v35)
  {
    objc_storeWeak((id *)&v35->_hapAccessory, v57);
    v36 = [HMDPredicateUtilities alloc];
    -[HMDAccessoryProfile logIdentifier](v35, "logIdentifier");
    v37 = (void *)objc_claimAutoreleasedReturnValue();
    v38 = -[HMDPredicateUtilities initWithHome:logIdentifier:](v36, "initWithHome:logIdentifier:", v23, v37);
    ...
    objc_storeStrong((id *)&v35->_recordingManagementService, v48);
    ...
    -[HMDCameraProfile _setControlSupport](v35, "_setControlSupport");
    recordingEventsCleanupTimerFactory = v35->_recordingEventsCleanupTimerFactory;
    v35->_recordingEventsCleanupTimerFactory = &__block_literal_global_149876;

    recordingManagerFactory = v35->_recordingManagerFactory;
    v35->_recordingManagerFactory = &__block_literal_global_49_149877;
...
- (void)setUp
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        HMFGetLogIdentifier();
        v14 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDCameraProfile cameraSettingsManager](v12, "cameraSettingsManager");
        v15 = (void *)objc_claimAutoreleasedReturnValue();
        ...
        v37 = 2112;
        v38 = v16;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Using zone %@ for camera settings", (uint8_t *)&v35, 0x16u);
      ...
      v21 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "configureWithMessageDispatcher:adminMessageDispatcher:deviceIsResidentCapable:", v19, v20, objc_msgSend(v21, "isResidentCapable"));

      -[HMDCameraProfile reachabilityEventManager](v12, "reachabilityEventManager");
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDAccessoryProfile msgDispatcher](v12, "msgDispatcher");
      v23 = (void *)objc_claimAutoreleasedReturnValue();
      -[HMDCameraProfile currentSettings](v12, "currentSettings");
      v24 = (void *)objc_claimAutoreleasedReturnValue();
      v25 = objc_msgSend(v6, "isCurrentDeviceConfirmedPrimaryResident");
      -[HMDCameraProfile networkMonitor](v12, "networkMonitor");
      v26 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v22, "configureWithMessageDispatcher:currentSettings:isCurrentDeviceConfirmedPrimaryResident:isCurrentDeviceConnectedToNetwork:", v23, v24, v25, objc_msgSend(v26, "isReachable"));
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 138543362;
        v36 = v34;
        _os_log_impl(&dword_1CD062000, v33, OS_LOG_TYPE_ERROR, "%{public}@Skipping camera profile setup because home reference is nil", (uint8_t *)&v35, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v35 = 138543362;
      v36 = v30;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@Skipping camera profile setup because accessory reference is nil", (uint8_t *)&v35, 0xCu);
...
- (void)tearDownWithReplacementCameraProfile:(id)a3
{
    ...
    && (objc_msgSend(v4, "isCameraRecordingFeatureSupported") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing clip data because we have a recording management service %@ and we are transitioning to a replacement camera profile that does not", (uint8_t *)&v13, 0x16u);
...
- (void)_createCameraRecordingManager
{
  ...
  if (v4)
  {
    ...
    if (v10 && (v7 & 1) != 0)
    {
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 138543362;
          v30 = v15;
          _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Creating camera recording manager", (uint8_t *)&v29, 0xCu);
    ...
    else if (v11)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        v29 = 138543362;
        v30 = v27;
        _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Destroying camera recording manager", (uint8_t *)&v29, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 138543362;
      v30 = v23;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Not configuring for recording because there is no recording service", (uint8_t *)&v29, 0xCu);
...
- (void)unconfigure
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = v4;
  if (v3 && objc_msgSend(v4, "isCurrentDeviceAvailableResident"))
  {
    objc_msgSend(v5, "notificationRegistry");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "disableReachabilityEventNotificationForAccessoryUUIDs:forUserID:", v8, 0);

  }
  -[HMDCameraProfile notificationCenter](self, "notificationCenter");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "postNotificationName:object:", CFSTR("HMDCameraProfileUnconfiguredNotification"), self);
...
- (void)_setControlSupport
{
  ...
  if (v3)
  {
    v4 = v3;
    v5 = *(_QWORD *)v17;
    v6 = *MEMORY[0x1E0CB9A88];
    v7 = *MEMORY[0x1E0CB9AC0];
    do
    {
      for (i = 0; i != v4; ++i)
      {
...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v63 = v7;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Registering for messages", buf, 0xCu);
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB8648], v5, v13, sel__handleNegotiateStreamRequest_);

  -[HMDAccessoryProfile msgDispatcher](v5, "msgDispatcher");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v15, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB8660], v5, v13, sel__handleStreamControlRequest_);

  -[HMDAccessoryProfile msgDispatcher](v5, "msgDispatcher");
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB8650], v5, v13, sel__handleStreamControlRequest_);
  ...
  -[HMDAccessoryProfile msgDispatcher](v5, "msgDispatcher");
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v18, "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E0CB8658], v5, v17, sel__handleStreamControlRequest_);
...
- (BOOL)_areFaceClassificationsSuppressedForSignificantEvent:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Classification notifications enabled is %@ for person: %@", (uint8_t *)&v19, 0x20u);
...
- (BOOL)_shouldNotifyForSignificantEvent:(id)a3 homePresence:(id)a4
{
  ...
  id v22;
  void *v23;
  HMDCameraProfile *v24;
  NSObject *v25;
  void *v26;
  void *v27;
  _BOOL4 v28;
  void *v29;
  HMDCameraProfile *v30;
  NSObject *v31;
  void *v32;
  void *v33;
  void *v34;
...
LABEL_9:
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = objc_msgSend(v11, "isSmartBulletinBoardNotificationEnabled");
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v67 = 2112;
      v68 = v27;
      _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Not notifying for significant event %@ because smart notification bulletin is disabled", buf, 0x16u);
  ...
  -[HMDCameraProfile currentSettings](self, "currentSettings");
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v13, "notificationSettings");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "smartBulletinBoardNotificationCondition");
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v15)
  {
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDCameraProfile predicateUtilities](self, "predicateUtilities");
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v20 = v6;
    v21 = v15;
    v64 = v7;
    v61 = v18;
    v22 = v19;
    if (objc_msgSend(v20, "reason") == 6)
    {
      objc_msgSend(v22, "setCameraSignificantEvent:", 31);
    }
    else
    {
      v34 = (void *)MEMORY[0x1E0C99E60];
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v20, "reason"));
      v35 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v34, "setWithObject:", v35);
      v36 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v22, "setCameraSignificantEvent:", HMCameraSignificantEventTypesFromReasons());

    }
    if (objc_msgSend(v20, "reason") == 2)
    {
      objc_msgSend(v20, "faceClassification");
      v37 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v37, "person");
    ...
    objc_msgSend(v22, "setPersonFamiliarityOptions:", v40);
    v60 = v21;
    objc_msgSend(v22, "rewritePredicate:currentCharacteristicInPredicate:characteristicsToRead:homePresence:", v21, 0, 0, v64);
    v42 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v42, "allowEvaluation");
    v71 = CFSTR("THIS_OBJECT");
    v72[0] = v22;
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", v72, &v71, 1);
    v43 = (void *)objc_claimAutoreleasedReturnValue();
    v63 = objc_msgSend(v42, "evaluateWithObject:substitutionVariables:", v22, v43);
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v69 = 2112;
      v70 = v49;
      _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@Evaluated predicate: %@ with result: %@", buf, 0x20u);
    ...
    v28 = -[HMDCameraProfile _areFaceClassificationsSuppressedForSignificantEvent:](self, "_areFaceClassificationsSuppressedForSignificantEvent:", v20) & v63;
    ...
    if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v69 = 2112;
      v70 = v57;
      _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_INFO, "%{public}@Determined should add notification for significant event %@: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v67 = 2112;
      v68 = v33;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Notifying for significant event %@ because smart notification bulletin condition is nil", buf, 0x16u);
...
- (void)_postNotificationForUpdatedSignificantEvent:(id)a3 homePresence:(id)a4
{
  ...
  -[HMDCameraProfile clipUserNotificationCenter](self, "clipUserNotificationCenter");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "bulletinForClipSignificantEvent:cameraProfile:", v6, self);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v10)
  {
    ...
    v14 = v6;
    v15 = v7;
    objc_msgSend(v11, "updateDoorbellPressNotificationsWithSignificantEventBulletin:completion:", v13, v12);
...
- (void)_handleNegotiateStreamRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v71 = 2114;
    v72 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling negotiate stream request message payload: %{public}@", buf, 0x16u);
  ...
  if (v12)
  {
    ...
    if (v14)
      ...
      v16 = objc_alloc_init(MEMORY[0x1E0CBA438]);
    v21 = v16;
    ...
    else
    {
            ...
            if ((objc_msgSend(v43, "isStreamingSessionInProgress") & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v71 = 2112;
                v72 = v43;
                _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_INFO, "%{public}@Accessory is not reachable, routing request to camera streaming service: %@", buf, 0x16u);
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v70 = v47;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_ERROR, "%{public}@Accessory is not reachable and cannot route request to a camera streaming service", buf, 0xCu);
...
LABEL_45:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v70 = v20;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Stream session ID is not present in negotiate request", buf, 0xCu);
...
- (void)_handleStreamControlRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v60 = 2112;
    v61 = v11;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling %@ message with payload: %@", buf, 0x20u);
  ...
  if (v12)
  {
        ...
        for (j = 0; j != v22; ++j)
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v60 = 2112;
            v61 = v12;
            _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Checking if stream message handler's session ID %@ matches with given %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v58 = 2112;
      v59 = v12;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Did not find the stream with Session ID %@", buf, 0x16u);
...
LABEL_30:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v41;
      _os_log_impl(&dword_1CD062000, v40, OS_LOG_TYPE_ERROR, "%{public}@Stream session ID is not present in start request", buf, 0xCu);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (v6)
    objc_msgSend(v4, "encodeObject:forKey:", v6, *MEMORY[0x1E0CB8560]);
  -[HMDCameraProfile cameraSettingsManager](self, "cameraSettingsManager");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "currentSettings");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v8, *MEMORY[0x1E0CB8568]);
...
- (void)clipManager:(id)a3 didUpdateSignificantEvent:(id)a4 withHomePresence:(id)a5
{
  ...
  -[HMDCameraProfile hapAccessory](self, "hapAccessory");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "doorbellChimeController");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "handleUpdatedPersonIdentificationInformation");

  -[HMDCameraProfile _postNotificationForUpdatedSignificantEvent:homePresence:](self, "_postNotificationForUpdatedSignificantEvent:homePresence:", v11, v7);
}
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Performing recording events cleanup due to timer firing", (uint8_t *)&v13, 0xCu);
...
void __77__HMDCameraProfile__postNotificationForUpdatedSignificantEvent_homePresence___block_invoke_2(uint64_t a1)
{
  ...
  if (*(_BYTE *)(a1 + 64)
    && (objc_msgSend(*(id *)(a1 + 32), "significantEvents"),
        v2 = (void *)objc_claimAutoreleasedReturnValue(),
        v3 = objc_msgSend(v2, "na_allObjectsPassTest:", &__block_literal_global_80_149828),
        v2,
        v3))
  {
    v4 = (void *)MEMORY[0x1D17BA0A0]();
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v12 = 2112;
      v13 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Not posting notification since we found recent doorbell bulletin(s) to update for significant event: %@", buf, 0x16u);

    }
    objc_autoreleasePoolPop(v4);
  }
  else if (objc_msgSend(*(id *)(a1 + 40), "_shouldNotifyForSignificantEvent:homePresence:", *(_QWORD *)(a1 + 48), *(_QWORD *)(a1 + 56)))
  {
...
void __35__HMDCameraProfile_removeCloudData__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing all cloud data", (uint8_t *)&v9, 0xCu);
...
+ (HMDCameraBulletinBoard)bulletinBoard
{
  ...
  if (!_bulletinBoard)
  {
    if (bulletinBoard_onceToken != -1)
      dispatch_once(&bulletinBoard_onceToken, &__block_literal_global_53_149920);
    v2 = (void *)_bulletinBoard;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_149916 != -1)
    dispatch_once(&logCategory__hmf_once_t8_149916, &__block_literal_global_55);
  return (id)logCategory__hmf_once_v9_149917;
}
...
void __31__HMDCameraProfile_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_149917;
  logCategory__hmf_once_v9_149917 = v0;
