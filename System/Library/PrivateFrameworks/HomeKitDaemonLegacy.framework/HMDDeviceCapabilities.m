...
+ (HMDDeviceCapabilities)deviceCapabilities
{
  if (deviceCapabilities_onceToken != -1)
    dispatch_once(&deviceCapabilities_onceToken, &__block_literal_global_146350);
...
- (HMDDeviceCapabilities)initWithProductInfo:(id)a3 mobileGestaltClient:(id)a4 homekitVersion:(id)a5
{
  ...
  if (v8)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsCompanionInitiatedRestart(v8));
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCompanionInitiatedRestart:](v13, "setSupportsCompanionInitiatedRestart:", v28);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsCompanionInitiatedObliterate(v8));
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsAnnounce(v8));
    v46 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsAnnounce:](v13, "setSupportsAnnounce:", v46);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsThirdPartyMusic(v8));
    v47 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsThirdPartyMusic:](v13, "setSupportsThirdPartyMusic:", v47);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsPreferredMediaUser(v8));
    v48 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsPreferredMediaUser:](v13, "setSupportsPreferredMediaUser:", v48);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", 0);
    v49 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsThreadBorderRouter:](v13, "setSupportsThreadBorderRouter:", v49);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsThirdPartyMusic(v8));
    v50 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsDoorbellChime:](v13, "setSupportsDoorbellChime:", v50);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsUserMediaSettings(v8));
    v51 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsUserMediaSettings:](v13, "setSupportsUserMediaSettings:", v51);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsCoordinationDoorbellChime(v8));
    v52 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCoordinationDoorbellChime:](v13, "setSupportsCoordinationDoorbellChime:", v52);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsCoordinationFreeDoorbellChime(v8));
    v53 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCoordinationFreeDoorbellChime:](v13, "setSupportsCoordinationFreeDoorbellChime:", v53);

    v54 = (void *)MEMORY[0x1E0CB37E8];
    objc_msgSend(v8, "productClass");
    objc_msgSend(v54, "numberWithBool:", 0);
    v55 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsTVOSUpdateManualUpdateAvailableNotification:](v13, "setSupportsTVOSUpdateManualUpdateAvailableNotification:", v55);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsSiriEndpointSetup(v8));
    v56 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsSiriEndpointSetup:](v13, "setSupportsSiriEndpointSetup:", v56);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsHomeHub(v8, v9));
    v57 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsHomeHub:](v13, "setSupportsHomeHub:", v57);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsWakeOnLAN(v8));
    v58 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsWakeOnLAN:](v13, "setSupportsWakeOnLAN:", v58);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsLockNotificationContext(v8));
    v59 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsLockNotificationContext:](v13, "setSupportsLockNotificationContext:", v59);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsAudioReturnChannel(v8, v9));
    v60 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsAudioReturnChannel:](v13, "setSupportsAudioReturnChannel:", v60);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsLockNotificationContext(v8));
    v61 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsWalletKey:](v13, "setSupportsWalletKey:", v61);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsLockNotificationContext(v8));
    v62 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCameraPackageDetection:](v13, "setSupportsCameraPackageDetection:", v62);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsLockNotificationContext(v8));
    v63 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsAccessCodes:](v13, "setSupportsAccessCodes:", v63);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsLockNotificationContext(v8));
    v64 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCHIP:](v13, "setSupportsCHIP:", v64);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsUnifiedMediaNotifications(v8));
    v65 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsUnifiedMediaNotifications:](v13, "setSupportsUnifiedMediaNotifications:", v65);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsUserMediaSettings(v8));
    v66 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsManagedConfigurationProfile:](v13, "setSupportsManagedConfigurationProfile:", v66);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsCaptiveNetworks(v8));
    v67 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCaptiveNetworks:](v13, "setSupportsCaptiveNetworks:", v67);

    -[HMDDeviceCapabilitiesModel setSupportsModernTransport:](v13, "setSupportsModernTransport:", MEMORY[0x1E0C9AAB0]);
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsResidentFirstAccessoryCommunication(v8));
    v68 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsResidentFirstAccessoryCommunication:](v13, "setSupportsResidentFirstAccessoryCommunication:", v68);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsMessagedHomePodSettings(v8, v10));
    v69 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsMessagedHomePodSettings:](v13, "setSupportsMessagedHomePodSettings:", v69);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsCustomMediaApplicationDestination(v8));
    v70 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsCustomMediaApplicationDestination:](v13, "setSupportsCustomMediaApplicationDestination:", v70);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsThreadNetworkCredentialSharing(v8, v9, v10));
    v71 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsThreadNetworkCredentialSharing:](v13, "setSupportsThreadNetworkCredentialSharing:", v71);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsMatterSharedAdminPairing(v8, v9, v10));
    v72 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsMatterSharedAdminPairing:](v13, "setSupportsMatterSharedAdminPairing:", v72);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsRMVonAppleTV(v8));
    v73 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsRMVonAppleTV:](v13, "setSupportsRMVonAppleTV:", v73);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsJustSiri(v8));
    v74 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsJustSiri:](v13, "setSupportsJustSiri:", v74);

    v75 = (void *)MEMORY[0x1E0CB37E8];
    v92 = 0;
    memset(buf, 0, sizeof(buf));
    v76 = v8;
    objc_msgSend(v76, "softwareVersion");
    ...
    v83 = objc_msgSend(v76, "productPlatform");
    v84 = objc_msgSend(v76, "productClass");
    ...
    if (v84 > 0xA || ((1 << v84) & 0x78A) == 0)
      goto LABEL_24;
    if (v83 == 2
      && (v89 = *(_OWORD *)buf, v90 = v92, HMFOperatingSystemVersionCompare() != 1)
...
LABEL_24:
    objc_msgSend(v75, "numberWithBool:", v85, v89, v90);
    v86 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsThreadService:](v13, "setSupportsThreadService:", v86);

    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", productSupportsMatterOwnerCertFetch(v76, v9, v10));
    v87 = (void *)objc_claimAutoreleasedReturnValue();
    -[HMDDeviceCapabilitiesModel setSupportsMatterOwnerCertFetch:](v13, "setSupportsMatterOwnerCertFetch:", v87);
  ...
  if (os_log_type_enabled(v80, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_QWORD *)&buf[4] = v81;
    _os_log_impl(&dword_1CD062000, v80, OS_LOG_TYPE_ERROR, "%{public}@Product info is a required argument", buf, 0xCu);
...
- (HMDDeviceCapabilities)initWithObjectModel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Model object is a required argument", buf, 0xCu);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (v20 != -[HMDDeviceCapabilities supportsHomeLevelLocationServiceSetting](v6, "supportsHomeLevelLocationServiceSetting"))goto LABEL_62;
    ...
    if (v22 != -[HMDDeviceCapabilities supportsCompanionInitiatedObliterate](v6, "supportsCompanionInitiatedObliterate"))goto LABEL_62;
    ...
    if (v34 != -[HMDDeviceCapabilities supportsCameraRecordingReachabilityNotifications](v6, "supportsCameraRecordingReachabilityNotifications"))goto LABEL_62;
    ...
    if (v35 != -[HMDDeviceCapabilities supportsAnnounce](v6, "supportsAnnounce"))
      goto LABEL_62;
    v36 = -[HMDDeviceCapabilities supportsThirdPartyMusic](self, "supportsThirdPartyMusic");
    if (v36 != -[HMDDeviceCapabilities supportsThirdPartyMusic](v6, "supportsThirdPartyMusic"))
      goto LABEL_62;
    v37 = -[HMDDeviceCapabilities supportsPreferredMediaUser](self, "supportsPreferredMediaUser");
    if (v37 != -[HMDDeviceCapabilities supportsPreferredMediaUser](v6, "supportsPreferredMediaUser"))
      goto LABEL_62;
    v38 = -[HMDDeviceCapabilities supportsThreadBorderRouter](self, "supportsThreadBorderRouter");
    if (v38 != -[HMDDeviceCapabilities supportsThreadBorderRouter](v6, "supportsThreadBorderRouter"))
      goto LABEL_62;
    v39 = -[HMDDeviceCapabilities supportsSiriEndpointSetup](self, "supportsSiriEndpointSetup");
    if (v39 != -[HMDDeviceCapabilities supportsSiriEndpointSetup](v6, "supportsSiriEndpointSetup"))
      goto LABEL_62;
    v40 = -[HMDDeviceCapabilities supportsHomeHub](self, "supportsHomeHub");
    if (v40 != -[HMDDeviceCapabilities supportsHomeHub](v6, "supportsHomeHub"))
      goto LABEL_62;
    v41 = -[HMDDeviceCapabilities supportsWakeOnLAN](self, "supportsWakeOnLAN");
    if (v41 != -[HMDDeviceCapabilities supportsWakeOnLAN](v6, "supportsWakeOnLAN"))
      goto LABEL_62;
    v42 = -[HMDDeviceCapabilities supportsLockNotificationContext](self, "supportsLockNotificationContext");
    if (v42 != -[HMDDeviceCapabilities supportsLockNotificationContext](v6, "supportsLockNotificationContext"))
      goto LABEL_62;
    v43 = -[HMDDeviceCapabilities supportsCoordinationDoorbellChime](self, "supportsCoordinationDoorbellChime");
    if (v43 != -[HMDDeviceCapabilities supportsCoordinationDoorbellChime](v6, "supportsCoordinationDoorbellChime"))
      goto LABEL_62;
    v44 = -[HMDDeviceCapabilities supportsCoordinationFreeDoorbellChime](self, "supportsCoordinationFreeDoorbellChime");
    if (v44 != -[HMDDeviceCapabilities supportsCoordinationFreeDoorbellChime](v6, "supportsCoordinationFreeDoorbellChime"))goto LABEL_62;
    v45 = -[HMDDeviceCapabilities supportsTVOSUpdateManualUpdateAvailableNotification](self, "supportsTVOSUpdateManualUpdateAvailableNotification");
    if (v45 != -[HMDDeviceCapabilities supportsTVOSUpdateManualUpdateAvailableNotification](v6, "supportsTVOSUpdateManualUpdateAvailableNotification"))goto LABEL_62;
    v46 = -[HMDDeviceCapabilities supportsManagedConfigurationProfile](self, "supportsManagedConfigurationProfile");
    if (v46 != -[HMDDeviceCapabilities supportsManagedConfigurationProfile](v6, "supportsManagedConfigurationProfile"))
      goto LABEL_62;
    v47 = -[HMDDeviceCapabilities supportsAudioReturnChannel](self, "supportsAudioReturnChannel");
    if (v47 != -[HMDDeviceCapabilities supportsAudioReturnChannel](v6, "supportsAudioReturnChannel"))
      goto LABEL_62;
    v48 = -[HMDDeviceCapabilities supportsWalletKey](self, "supportsWalletKey");
    if (v48 != -[HMDDeviceCapabilities supportsWalletKey](v6, "supportsWalletKey"))
      goto LABEL_62;
    v49 = -[HMDDeviceCapabilities supportsCameraPackageDetection](self, "supportsCameraPackageDetection");
    if (v49 != -[HMDDeviceCapabilities supportsCameraPackageDetection](v6, "supportsCameraPackageDetection"))
      goto LABEL_62;
    v50 = -[HMDDeviceCapabilities supportsAccessCodes](self, "supportsAccessCodes");
    if (v50 != -[HMDDeviceCapabilities supportsAccessCodes](v6, "supportsAccessCodes"))
      goto LABEL_62;
    v51 = -[HMDDeviceCapabilities supportsCHIP](self, "supportsCHIP");
    if (v51 != -[HMDDeviceCapabilities supportsCHIP](v6, "supportsCHIP"))
      goto LABEL_62;
    v52 = -[HMDDeviceCapabilities supportsUnifiedMediaNotifications](self, "supportsUnifiedMediaNotifications");
    if (v52 != -[HMDDeviceCapabilities supportsUnifiedMediaNotifications](v6, "supportsUnifiedMediaNotifications"))
      goto LABEL_62;
    v53 = -[HMDDeviceCapabilities supportsCaptiveNetworks](self, "supportsCaptiveNetworks");
    if (v53 != -[HMDDeviceCapabilities supportsCaptiveNetworks](v6, "supportsCaptiveNetworks"))
      goto LABEL_62;
    v54 = -[HMDDeviceCapabilities supportsModernTransport](self, "supportsModernTransport");
    if (v54 != -[HMDDeviceCapabilities supportsModernTransport](v6, "supportsModernTransport"))
      goto LABEL_62;
    v55 = -[HMDDeviceCapabilities supportsResidentFirstAccessoryCommunication](self, "supportsResidentFirstAccessoryCommunication");
    if (v55 != -[HMDDeviceCapabilities supportsResidentFirstAccessoryCommunication](v6, "supportsResidentFirstAccessoryCommunication"))goto LABEL_62;
    v56 = -[HMDDeviceCapabilities supportsMessagedHomePodSettings](self, "supportsMessagedHomePodSettings");
    if (v56 == -[HMDDeviceCapabilities supportsMessagedHomePodSettings](v6, "supportsMessagedHomePodSettings")
      && (v57 = -[HMDDeviceCapabilities supportsCustomMediaApplicationDestination](self, "supportsCustomMediaApplicationDestination"), v57 == -[HMDDeviceCapabilities supportsCustomMediaApplicationDestination](v6, "supportsCustomMediaApplicationDestination"))&& (v58 = -[HMDDeviceCapabilities supportsThreadNetworkCredentialSharing](self, "supportsThreadNetworkCredentialSharing"), v58 == -[HMDDeviceCapabilities supportsThreadNetworkCredentialSharing](v6, "supportsThreadNetworkCredentialSharing"))&& (v59 = -[HMDDeviceCapabilities supportsMatterSharedAdminPairing](self, "supportsMatterSharedAdminPairing"), v59 == -[HMDDeviceCapabilities supportsMatterSharedAdminPairing](v6, "supportsMatterSharedAdminPairing"))&& (v60 = -[HMDDeviceCapabilities supportsRMVonAppleTV](self, "supportsRMVonAppleTV"), v60 == -[HMDDeviceCapabilities supportsRMVonAppleTV](v6, "supportsRMVonAppleTV"))&& (v61 = -[HMDDeviceCapabilities supportsJustSiri](self, "supportsJustSiri"), v61 == -[HMDDeviceCapabilities supportsJustSiri](v6, "supportsJustSiri"))&& (v62 = -[HMDDeviceCapabilities supportsThreadService](self, "supportsThreadService"), v62 == -[HMDDeviceCapabilities supportsThreadService](v6, "supportsThreadService")))
    {
      v65 = -[HMDDeviceCapabilities supportsMatterOwnerCertFetch](self, "supportsMatterOwnerCertFetch");
      v63 = v65 ^ -[HMDDeviceCapabilities supportsMatterOwnerCertFetch](v6, "supportsMatterOwnerCertFetch") ^ 1;
    }
    else
    {
LABEL_62:
...
- (id)attributeDescriptions
{
  ...
  v161[52] = *MEMORY[0x1E0C80C00];
  v3 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsKeychainSync](self, "supportsKeychainSync");
  HMFBooleanToString();
  v160 = (void *)objc_claimAutoreleasedReturnValue();
  v159 = (void *)objc_msgSend(v3, "initWithName:value:", CFSTR("Keychain Sync"), v160);
  v161[0] = v159;
  v4 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsDeviceSetup](self, "supportsDeviceSetup");
  HMFBooleanToString();
  v158 = (void *)objc_claimAutoreleasedReturnValue();
  v157 = (void *)objc_msgSend(v4, "initWithName:value:", CFSTR("Device Setup"), v158);
  v161[1] = v157;
  v5 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsKeyTransferClient](self, "supportsKeyTransferClient");
  HMFBooleanToString();
  v156 = (void *)objc_claimAutoreleasedReturnValue();
  v155 = (void *)objc_msgSend(v5, "initWithName:value:", CFSTR("Key Transfer Client"), v156);
  v161[2] = v155;
  v6 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsKeyTransferServer](self, "supportsKeyTransferServer");
  HMFBooleanToString();
  v154 = (void *)objc_claimAutoreleasedReturnValue();
  v153 = (void *)objc_msgSend(v6, "initWithName:value:", CFSTR("Key Transfer Server"), v154);
  v161[3] = v153;
  v7 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsStandaloneMode](self, "supportsStandaloneMode");
  HMFBooleanToString();
  v152 = (void *)objc_claimAutoreleasedReturnValue();
  v151 = (void *)objc_msgSend(v7, "initWithName:value:", CFSTR("Standalone Mode"), v152);
  v161[4] = v151;
  v8 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCloudDataSync](self, "supportsCloudDataSync");
  HMFBooleanToString();
  v150 = (void *)objc_claimAutoreleasedReturnValue();
  v149 = (void *)objc_msgSend(v8, "initWithName:value:", CFSTR("Cloud Data Sync"), v150);
  v161[5] = v149;
  v9 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsWholeHouseAudio](self, "supportsWholeHouseAudio");
  HMFBooleanToString();
  v148 = (void *)objc_claimAutoreleasedReturnValue();
  v147 = (void *)objc_msgSend(v9, "initWithName:value:", CFSTR("Whole House Audio"), v148);
  v161[6] = v147;
  v10 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsAssistantAccessControl](self, "supportsAssistantAccessControl");
  HMFBooleanToString();
  v146 = (void *)objc_claimAutoreleasedReturnValue();
  v145 = (void *)objc_msgSend(v10, "initWithName:value:", CFSTR("Assistant Access Control"), v146);
  v161[7] = v145;
  v11 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities isResidentCapable](self, "isResidentCapable");
  HMFBooleanToString();
  v144 = (void *)objc_claimAutoreleasedReturnValue();
  v143 = (void *)objc_msgSend(v11, "initWithName:value:", CFSTR("Resident"), v144);
  v161[8] = v143;
  v12 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities isRemoteGatewayCapable](self, "isRemoteGatewayCapable");
  HMFBooleanToString();
  v142 = (void *)objc_claimAutoreleasedReturnValue();
  v141 = (void *)objc_msgSend(v12, "initWithName:value:", CFSTR("Remote Gateway"), v142);
  v161[9] = v141;
  v13 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsTargetControl](self, "supportsTargetControl");
  HMFBooleanToString();
  v140 = (void *)objc_claimAutoreleasedReturnValue();
  v139 = (void *)objc_msgSend(v13, "initWithName:value:", CFSTR("Target Control"), v140);
  v161[10] = v139;
  v14 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsMultiUser](self, "supportsMultiUser");
  HMFBooleanToString();
  v138 = (void *)objc_claimAutoreleasedReturnValue();
  v137 = (void *)objc_msgSend(v14, "initWithName:value:", CFSTR("Multi-User"), v138);
  v161[11] = v137;
  v15 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsHomeLevelLocationServiceSetting](self, "supportsHomeLevelLocationServiceSetting");
  HMFBooleanToString();
  v136 = (void *)objc_claimAutoreleasedReturnValue();
  v135 = (void *)objc_msgSend(v15, "initWithName:value:", CFSTR("Home Level Location Services"), v136);
  v161[12] = v135;
  v16 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCompanionInitiatedRestart](self, "supportsCompanionInitiatedRestart");
  HMFBooleanToString();
  v134 = (void *)objc_claimAutoreleasedReturnValue();
  v133 = (void *)objc_msgSend(v16, "initWithName:value:", CFSTR("Restart"), v134);
  v161[13] = v133;
  v17 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCompanionInitiatedObliterate](self, "supportsCompanionInitiatedObliterate");
  HMFBooleanToString();
  v132 = (void *)objc_claimAutoreleasedReturnValue();
  v131 = (void *)objc_msgSend(v17, "initWithName:value:", CFSTR("Factory Reset"), v132);
  v161[14] = v131;
  v18 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsHomeInvitation](self, "supportsHomeInvitation");
  HMFBooleanToString();
  v130 = (void *)objc_claimAutoreleasedReturnValue();
  v129 = (void *)objc_msgSend(v18, "initWithName:value:", CFSTR("Home Invitation"), v130);
  v161[15] = v129;
  v19 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCameraRecording](self, "supportsCameraRecording");
  HMFBooleanToString();
  v128 = (void *)objc_claimAutoreleasedReturnValue();
  v127 = (void *)objc_msgSend(v19, "initWithName:value:", CFSTR("Camera Recording"), v128);
  v161[16] = v127;
  v20 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsRouterManagement](self, "supportsRouterManagement");
  HMFBooleanToString();
  v126 = (void *)objc_claimAutoreleasedReturnValue();
  v125 = (void *)objc_msgSend(v20, "initWithName:value:", CFSTR("Router Management"), v126);
  v161[17] = v125;
  v21 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsShortcutActions](self, "supportsShortcutActions");
  HMFBooleanToString();
  v124 = (void *)objc_claimAutoreleasedReturnValue();
  v123 = (void *)objc_msgSend(v21, "initWithName:value:", CFSTR("Shortcut Actions"), v124);
  v161[18] = v123;
  v22 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsMediaActions](self, "supportsMediaActions");
  HMFBooleanToString();
  v122 = (void *)objc_claimAutoreleasedReturnValue();
  v121 = (void *)objc_msgSend(v22, "initWithName:value:", CFSTR("Media Actions"), v122);
  v161[19] = v121;
  v23 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsFirmwareUpdate](self, "supportsFirmwareUpdate");
  HMFBooleanToString();
  v120 = (void *)objc_claimAutoreleasedReturnValue();
  v119 = (void *)objc_msgSend(v23, "initWithName:value:", CFSTR("Firmware Update"), v120);
  v161[20] = v119;
  v24 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsResidentFirmwareUpdate](self, "supportsResidentFirmwareUpdate");
  HMFBooleanToString();
  v118 = (void *)objc_claimAutoreleasedReturnValue();
  v117 = (void *)objc_msgSend(v24, "initWithName:value:", CFSTR("Resident Firmware Update"), v118);
  v161[21] = v117;
  v25 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCameraActivityZones](self, "supportsCameraActivityZones");
  HMFBooleanToString();
  v116 = (void *)objc_claimAutoreleasedReturnValue();
  v115 = (void *)objc_msgSend(v25, "initWithName:value:", CFSTR("Camera Activity Zones"), v116);
  v161[22] = v115;
  v26 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsMusicAlarm](self, "supportsMusicAlarm");
  HMFBooleanToString();
  v114 = (void *)objc_claimAutoreleasedReturnValue();
  v113 = (void *)objc_msgSend(v26, "initWithName:value:", CFSTR("Music Alarms"), v114);
  v161[23] = v113;
  v27 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsFaceClassification](self, "supportsFaceClassification");
  HMFBooleanToString();
  v112 = (void *)objc_claimAutoreleasedReturnValue();
  v111 = (void *)objc_msgSend(v27, "initWithName:value:", CFSTR("Face Classification"), v112);
  v161[24] = v111;
  v28 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsNaturalLighting](self, "supportsNaturalLighting");
  HMFBooleanToString();
  v110 = (void *)objc_claimAutoreleasedReturnValue();
  v109 = (void *)objc_msgSend(v28, "initWithName:value:", CFSTR("Natural Lighting"), v110);
  v161[25] = v109;
  v29 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsIDSActivityMonitorPresence](self, "supportsIDSActivityMonitorPresence");
  HMFBooleanToString();
  v108 = (void *)objc_claimAutoreleasedReturnValue();
  v107 = (void *)objc_msgSend(v29, "initWithName:value:", CFSTR("IDS Activity Monitor (Presence)"), v108);
  v161[26] = v107;
  v30 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCameraRecordingReachabilityNotifications](self, "supportsCameraRecordingReachabilityNotifications");
  HMFBooleanToString();
  v106 = (void *)objc_claimAutoreleasedReturnValue();
  v105 = (void *)objc_msgSend(v30, "initWithName:value:", CFSTR("Camera Recording Reachability Notifications"), v106);
  v161[27] = v105;
  v31 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsAnnounce](self, "supportsAnnounce");
  HMFBooleanToString();
  v104 = (void *)objc_claimAutoreleasedReturnValue();
  v103 = (void *)objc_msgSend(v31, "initWithName:value:", CFSTR("Announce"), v104);
  v161[28] = v103;
  v32 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsThirdPartyMusic](self, "supportsThirdPartyMusic");
  HMFBooleanToString();
  v102 = (void *)objc_claimAutoreleasedReturnValue();
  v101 = (void *)objc_msgSend(v32, "initWithName:value:", CFSTR("ThirdPartyMusic"), v102);
  v161[29] = v101;
  v33 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsPreferredMediaUser](self, "supportsPreferredMediaUser");
  HMFBooleanToString();
  v100 = (void *)objc_claimAutoreleasedReturnValue();
  v99 = (void *)objc_msgSend(v33, "initWithName:value:", CFSTR("PreferredMediaUser"), v100);
  v161[30] = v99;
  v34 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsThreadBorderRouter](self, "supportsThreadBorderRouter");
  HMFBooleanToString();
  v98 = (void *)objc_claimAutoreleasedReturnValue();
  v97 = (void *)objc_msgSend(v34, "initWithName:value:", CFSTR("Thread Border Router"), v98);
  v161[31] = v97;
  v35 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsSiriEndpointSetup](self, "supportsSiriEndpointSetup");
  HMFBooleanToString();
  v96 = (void *)objc_claimAutoreleasedReturnValue();
  v95 = (void *)objc_msgSend(v35, "initWithName:value:", CFSTR("Siri Endpoint Setup"), v96);
  v161[32] = v95;
  v36 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsHomeHub](self, "supportsHomeHub");
  HMFBooleanToString();
  v94 = (void *)objc_claimAutoreleasedReturnValue();
  v93 = (void *)objc_msgSend(v36, "initWithName:value:", CFSTR("Home Hub"), v94);
  v161[33] = v93;
  v37 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsWakeOnLAN](self, "supportsWakeOnLAN");
  HMFBooleanToString();
  v92 = (void *)objc_claimAutoreleasedReturnValue();
  v91 = (void *)objc_msgSend(v37, "initWithName:value:", CFSTR("LPM Wake On LAN"), v92);
  v161[34] = v91;
  v38 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsLockNotificationContext](self, "supportsLockNotificationContext");
  HMFBooleanToString();
  v90 = (void *)objc_claimAutoreleasedReturnValue();
  v89 = (void *)objc_msgSend(v38, "initWithName:value:", CFSTR("Lock Notification Context"), v90);
  v161[35] = v89;
  v39 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsAudioReturnChannel](self, "supportsAudioReturnChannel");
  HMFBooleanToString();
  v88 = (void *)objc_claimAutoreleasedReturnValue();
  v87 = (void *)objc_msgSend(v39, "initWithName:value:", CFSTR("Audio Return Channel"), v88);
  v161[36] = v87;
  v40 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsWalletKey](self, "supportsWalletKey");
  HMFBooleanToString();
  v86 = (void *)objc_claimAutoreleasedReturnValue();
  v85 = (void *)objc_msgSend(v40, "initWithName:value:", CFSTR("Wallet Key"), v86);
  v161[37] = v85;
  v41 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCameraPackageDetection](self, "supportsCameraPackageDetection");
  HMFBooleanToString();
  v84 = (void *)objc_claimAutoreleasedReturnValue();
  v83 = (void *)objc_msgSend(v41, "initWithName:value:", CFSTR("Camera Package Detection"), v84);
  v161[38] = v83;
  v42 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsAccessCodes](self, "supportsAccessCodes");
  HMFBooleanToString();
  v82 = (void *)objc_claimAutoreleasedReturnValue();
  v81 = (void *)objc_msgSend(v42, "initWithName:value:", CFSTR("Access Codes"), v82);
  v161[39] = v81;
  v43 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCHIP](self, "supportsCHIP");
  HMFBooleanToString();
  v80 = (void *)objc_claimAutoreleasedReturnValue();
  v79 = (void *)objc_msgSend(v43, "initWithName:value:", CFSTR("CHIP"), v80);
  v161[40] = v79;
  v44 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsUnifiedMediaNotifications](self, "supportsUnifiedMediaNotifications");
  HMFBooleanToString();
  v78 = (void *)objc_claimAutoreleasedReturnValue();
  v77 = (void *)objc_msgSend(v44, "initWithName:value:", CFSTR("Unified Media Notifications"), v78);
  v161[41] = v77;
  v45 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCaptiveNetworks](self, "supportsCaptiveNetworks");
  HMFBooleanToString();
  v76 = (void *)objc_claimAutoreleasedReturnValue();
  v75 = (void *)objc_msgSend(v45, "initWithName:value:", CFSTR("Captive Networks"), v76);
  v161[42] = v75;
  v46 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsModernTransport](self, "supportsModernTransport");
  HMFBooleanToString();
  v74 = (void *)objc_claimAutoreleasedReturnValue();
  v73 = (void *)objc_msgSend(v46, "initWithName:value:", CFSTR("Modern Transport"), v74);
  v161[43] = v73;
  v47 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsResidentFirstAccessoryCommunication](self, "supportsResidentFirstAccessoryCommunication");
  HMFBooleanToString();
  v72 = (void *)objc_claimAutoreleasedReturnValue();
  v71 = (void *)objc_msgSend(v47, "initWithName:value:", CFSTR("Resident First Accessory Communication"), v72);
  v161[44] = v71;
  v48 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsCustomMediaApplicationDestination](self, "supportsCustomMediaApplicationDestination");
  HMFBooleanToString();
  v70 = (void *)objc_claimAutoreleasedReturnValue();
  v69 = (void *)objc_msgSend(v48, "initWithName:value:", CFSTR("Custom Destination Media Action"), v70);
  v161[45] = v69;
  v49 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsThreadNetworkCredentialSharing](self, "supportsThreadNetworkCredentialSharing");
  HMFBooleanToString();
  v68 = (void *)objc_claimAutoreleasedReturnValue();
  v67 = (void *)objc_msgSend(v49, "initWithName:value:", CFSTR("Thread Network Credential Sharing"), v68);
  v161[46] = v67;
  v50 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsMatterSharedAdminPairing](self, "supportsMatterSharedAdminPairing");
  HMFBooleanToString();
  v66 = (void *)objc_claimAutoreleasedReturnValue();
  v51 = (void *)objc_msgSend(v50, "initWithName:value:", CFSTR("Matter Shared Admin Pairing"), v66);
  v161[47] = v51;
  v52 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsRMVonAppleTV](self, "supportsRMVonAppleTV");
  HMFBooleanToString();
  v53 = (void *)objc_claimAutoreleasedReturnValue();
  v54 = (void *)objc_msgSend(v52, "initWithName:value:", CFSTR("RMV on AppleTV"), v53);
  v161[48] = v54;
  v55 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsJustSiri](self, "supportsJustSiri");
  HMFBooleanToString();
  v56 = (void *)objc_claimAutoreleasedReturnValue();
  v57 = (void *)objc_msgSend(v55, "initWithName:value:", CFSTR("Just Siri"), v56);
  v161[49] = v57;
  v58 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsThreadService](self, "supportsThreadService");
  HMFBooleanToString();
  v59 = (void *)objc_claimAutoreleasedReturnValue();
  v60 = (void *)objc_msgSend(v58, "initWithName:value:", CFSTR("Thread Service"), v59);
  v161[50] = v60;
  v61 = objc_alloc(MEMORY[0x1E0D28548]);
  -[HMDDeviceCapabilities supportsMatterOwnerCertFetch](self, "supportsMatterOwnerCertFetch");
  HMFBooleanToString();
  v62 = (void *)objc_claimAutoreleasedReturnValue();
  v63 = (void *)objc_msgSend(v61, "initWithName:value:", CFSTR("Matter Owner Cert Fetch"), v62);
  v161[51] = v63;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v161, 52);
  v64 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if (self)
    {
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(_QWORD *)&buf[4] = v20;
          _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Updating device capabilities", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)&buf[4] = v28;
      ...
      v29 = v39;
      _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated:newValues:message:]", buf, 0x20u);
...
- (void)setModelParentIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v22;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Parent identifier is already present for this object", buf, 0xCu);
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v28;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Parent identifier is already present for this object", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v32 = 2112;
          v33 = v11;
          _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to update model with error: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v14;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Model parent UUID is a required argument", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_146345 != -1)
    dispatch_once(&logCategory__hmf_once_t4_146345, &__block_literal_global_143_146346);
  return (id)logCategory__hmf_once_v5_146347;
}

+ (BOOL)isInternalVirtualDevice
{
  if (isInternalVirtualDevice_onceToken != -1)
    dispatch_once(&isInternalVirtualDevice_onceToken, &__block_literal_global_261_146342);
...
void __36__HMDDeviceCapabilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_146347;
  logCategory__hmf_once_v5_146347 = v0;
