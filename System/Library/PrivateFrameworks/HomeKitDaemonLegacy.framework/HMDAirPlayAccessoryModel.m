...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_86954 != -1)
    dispatch_once(&properties_onceToken_86954, block);
  return (id)properties__properties_86955;
}
...
void __38__HMDAirPlayAccessoryModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_86955;
  properties__properties_86955 = v3;

  v5 = (void *)properties__properties_86955;
  ...
  v8 = (void *)properties__properties_86955;
  v17 = CFSTR("password");
  +[HMDBackingStoreModelObjectStorageInfo infoWithClass:](HMDBackingStoreModelObjectStorageInfo, "infoWithClass:", objc_opt_class());
  ...
  v11 = (void *)properties__properties_86955;
