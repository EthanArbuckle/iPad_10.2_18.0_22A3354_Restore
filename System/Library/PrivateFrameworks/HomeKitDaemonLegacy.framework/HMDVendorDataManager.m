...
+ (id)sharedVendorDataManager
{
  if (sharedVendorDataManager_onceToken != -1)
    dispatch_once(&sharedVendorDataManager_onceToken, &__block_literal_global_123542);
...
- (HMDVendorDataManager)initWithDefaults
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    v48 = 2112;
    v49 = CFSTR("start");
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\", buf, 0x34u);
  ...
  objc_msgSend(MEMORY[0x1E0CB39F0], "sessionWithConfiguration:", v19);
  ...
  v24 = (void *)MEMORY[0x1D17BA0A0](-[HMDVendorDataManager _loadDatabaseFromLocalFiles](v23, "_loadDatabaseFromLocalFiles"));
  v25 = v23;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    v52 = 2112;
    v53 = v30;
    _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x48u);
...
- (id)vendorModelEntryForProductData:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v8;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid product data: %@", (uint8_t *)&v16, 0x16u);
...
- (BOOL)_loadDatabaseFromFileURL:(id)a3 fileDescription:(id)a4
{
  ...
  v7 = a4;
  v25 = 0;
  objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithContentsOfURL:error:", v6, &v25);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = v25;
...
LABEL_13:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v7;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Read data from %@ plist file on disk", buf, 0x16u);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v7;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Loaded database from %@ plist file on disk", buf, 0x16u);
...
- (void)_loadDatabaseFromLocalFiles
{
  ...
  v2[3] = &unk_1E89C2730;
  v2[4] = self;
  objc_msgSend(MEMORY[0x1E0D28540], "activityWithName:parent:options:block:", CFSTR("ManufacturerDB.load"), 0, 1, v2);
}
...
- (void)_fetchDataFromServer
{
  ...
  if ((v7 & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v30 = 2112;
      v31 = v11;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Found a cached vendor info response: %@", buf, 0x16u);
  ...
  v16 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:parent:options:", CFSTR("ManufacturerDB.fetch"), 0, 1);
  -[HMDVendorDataManager urlSession](self, "urlSession");
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v30 = 2112;
    v31 = v19;
    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Resuming task: %@", buf, 0x16u);
...
- (void)_handleServerResponse:(id)a3 withData:(id)a4 error:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 22;
LABEL_9:
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, v16, (uint8_t *)&v26, v18);
...
LABEL_10:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      v28 = 2048;
      v29 = v21;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received status code %ld from vendor info request", (uint8_t *)&v26, 0x16u);
...
- (void)_handleDataFromServer:(id)a3
{
  ...
  v4 = a3;
  v38 = 0;
  objc_msgSend(MEMORY[0x1E0CB38B0], "propertyListWithData:options:format:error:", v4, 0, 0, &v38);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = v38;
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v42 = v14;
        _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully parsed database from server, saving to disk", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_ERROR, "%{public}@Error while deserializing plist from server data: %@", buf, 0x16u);
...
- (BOOL)_parseDatabaseFromDictionary:(id)a3 dataVersion:(int64_t *)a4 collectionsByManufacturer:(id *)a5 entriesByProductData:(id *)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\", buf, 0x34u);
  ...
  if (v24 != 1)
  {
    ...
    if (v38)
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      v129 = 2112;
      v130 = v41;
      _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x5Cu);

    }
    objc_autoreleasePoolPop(v35);
    objc_msgSend(MEMORY[0x1E0D334B8], "sharedInstance");
    v32 = (__CFString *)objc_claimAutoreleasedReturnValue();
    v42 = objc_alloc(MEMORY[0x1E0D334C8]);
    objc_msgSend(v10, "hmf_numberForKey:", CFSTR("SchemaVersion"));
  ...
  if (v26 <= 52)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138545922;
      ...
      v133 = 2112;
      v134 = &unk_1E8B33E40;
      _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x70u);

    }
    objc_autoreleasePoolPop(v27);
    objc_msgSend(MEMORY[0x1E0D334B8], "sharedInstance");
    v32 = (__CFString *)objc_claimAutoreleasedReturnValue();
    v33 = objc_alloc(MEMORY[0x1E0D334C8]);
    objc_msgSend(v10, "hmf_numberForKey:", CFSTR("DataVersion"));
    v34 = (id)objc_claimAutoreleasedReturnValue();
    v97 = v34;
...
LABEL_22:
  ...
  if (v26 < -[HMDVendorDataManager dataVersion](v15, "dataVersion"))
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", -[HMDVendorDataManager dataVersion](v47, "dataVersion"));
      ...
      *(_DWORD *)buf = 138545922;
      ...
      v133 = 2112;
      v134 = v51;
      _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x70u);

    }
    objc_autoreleasePoolPop(v46);
    objc_msgSend(MEMORY[0x1E0D334B8], "sharedInstance");
    v32 = (__CFString *)objc_claimAutoreleasedReturnValue();
    v52 = objc_alloc(MEMORY[0x1E0D334C8]);
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", v26);
    v34 = (id)objc_claimAutoreleasedReturnValue();
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithLong:", -[HMDVendorDataManager dataVersion](v47, "dataVersion"));
    v43 = (id)objc_claimAutoreleasedReturnValue();
    v94 = MEMORY[0x1E0C9AAA0];
    HMDTaggedLoggingCreateDictionary();
  ...
  if (v26 == v55)
  {
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      v129 = 2112;
      v130 = v61;
      _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x5Cu);
  ...
  if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing data version %ld", buf, 0x16u);
  ...
  if (!v65)
  {
    ...
    if (os_log_type_enabled(v76, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      v129 = 2112;
      v130 = v78;
      _os_log_impl(&dword_1CD062000, v76, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x5Cu);

    }
    objc_autoreleasePoolPop(v74);
    objc_msgSend(MEMORY[0x1E0D334B8], "sharedInstance");
    v34 = (id)objc_claimAutoreleasedReturnValue();
    v79 = objc_alloc(MEMORY[0x1E0D334C8]);
    objc_msgSend(v10, "objectForKeyedSubscript:", CFSTR("Manufacturers"));
    v43 = (id)objc_claimAutoreleasedReturnValue();
  ...
  if (!v104)
  {
    if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544898;
      ...
      v125 = 2112;
      v126 = (void *)MEMORY[0x1E0C9AAA0];
      _os_log_impl(&dword_1CD062000, v67, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x48u);

    }
    objc_autoreleasePoolPop(context);
    objc_msgSend(MEMORY[0x1E0D334B8], "sharedInstance");
    v84 = (void *)objc_claimAutoreleasedReturnValue();
    v85 = objc_alloc(MEMORY[0x1E0D334C8]);
    v96 = MEMORY[0x1E0C9AAA0];
    HMDTaggedLoggingCreateDictionary();
    ...
    if (os_log_type_enabled(v91, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v115 = 2112;
      v116 = v32;
      _os_log_impl(&dword_1CD062000, v91, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse manufacturers: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545922;
    ...
    v128 = CFSTR("success");
    v129 = 2112;
    v130 = (void *)MEMORY[0x1E0C9AAB0];
    v131 = 2114;
    v132 = CFSTR("DataVersion");
    v133 = 2112;
    v134 = v99;
    _os_log_impl(&dword_1CD062000, v67, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\", buf, 0x70u);

  }
  objc_autoreleasePoolPop(context);
  objc_msgSend(MEMORY[0x1E0D334B8], "sharedInstance");
  v110 = (void *)objc_claimAutoreleasedReturnValue();
  v103 = objc_alloc(MEMORY[0x1E0D334C8]);
...
LABEL_7:
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@:%@ contains an invalid %@ value: %@", (uint8_t *)&v24, 0x34u);
...
- (id)_parseVendorModelEntryForManufacturer:(id)a3 model:(id)a4 dictionary:(id)a5
{
  ...
  if (v11 && !+[HMDAccessory validateProductData:](HMDAccessory, "validateProductData:", v11))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v38[10] = 2112;
      *(_QWORD *)&v38[12] = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@:%@ contains an invalid %@ value: %@", buf, 0x34u);
  ...
  if (v16)
  {
    ...
    *(_QWORD *)&buf[16] = 0x3032000000;
    v37 = __Block_byref_object_copy__123406;
    *(_QWORD *)v38 = __Block_byref_object_dispose__123407;
...
LABEL_13:
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v38[10] = 2112;
        *(_QWORD *)&v38[12] = v25;
        _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@:%@ contains an invalid %@ value: %@", buf, 0x34u);
...
- (BOOL)_parseManufacturersList:(id)a3 collectionsByManufacturer:(id *)a4 entriesByProductData:(id *)a5
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v101 = 2112;
    v102 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Parsing manufacturers dictionary: %@", buf, 0x16u);
        ...
        if (!-[__CFString length](v19, "length"))
        {
          ...
          if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v101 = 2112;
            v102 = v16;
            _os_log_impl(&dword_1CD062000, v70, OS_LOG_TYPE_ERROR, "%{public}@Manufacturers dictionary contains invalid key: %@", buf, 0x16u);
                ...
                if (!v33)
                {
                  ...
                  if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v103 = 2112;
                    v104 = v32;
                    _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_ERROR, "%{public}@Manufacturer %@ contains an invalid model entry for %@", buf, 0x20u);
...
LABEL_46:
              ...
              if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v103 = 2112;
                v104 = v29;
                _os_log_impl(&dword_1CD062000, v59, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@ contains invalid key: %@", buf, 0x20u);
...
LABEL_47:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v103 = 2112;
              v104 = v56;
              _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@Manufacturers dictionary contains an invalid %@ value: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v101 = 2112;
            v102 = v19;
            _os_log_impl(&dword_1CD062000, v47, OS_LOG_TYPE_ERROR, "%{public}@Manufacturers dictionary contains an invalid entry for %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v65, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v101 = 2112;
    v102 = v85;
    _os_log_impl(&dword_1CD062000, v65, OS_LOG_TYPE_DEBUG, "%{public}@Prepared vendor model entries: %@", buf, 0x16u);
...
uint64_t __37__HMDVendorDataManager_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Timer fired after %.0lf sec", (uint8_t *)&v7, 0x16u);
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "_loadDatabaseFromFilePath:fileDescription:", CFSTR("/var/mobile/Library/homed/vendor-database"), CFSTR("cached")) & 1) == 0)
  {
    ...
    if ((v11 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = 138543362;
        v17 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to read any local database files", (uint8_t *)&v16, 0xCu);

      }
      objc_autoreleasePoolPop(v12);
      objc_msgSend(*(id *)(a1 + 32), "setDataVersion:", 0);
      objc_msgSend(*(id *)(a1 + 32), "setCollectionsByManufacturer:", MEMORY[0x1E0C9AA70]);
    }
  }
}
...
+ (id)dbURL
{
  if (dbURL_onceToken != -1)
    dispatch_once(&dbURL_onceToken, &__block_literal_global_44_123537);
  return (id)dbURL_url;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t39_123532 != -1)
    dispatch_once(&logCategory__hmf_once_t39_123532, &__block_literal_global_122_123533);
  return (id)logCategory__hmf_once_v40_123534;
}
...
void __35__HMDVendorDataManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v40_123534;
  logCategory__hmf_once_v40_123534 = v0;
