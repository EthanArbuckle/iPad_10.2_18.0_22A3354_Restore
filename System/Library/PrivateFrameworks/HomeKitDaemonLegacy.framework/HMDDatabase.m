...
- (HMDDatabase)initWithFileURL:(id)a3 cloudConfiguration:(id)a4
{
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32C70]), "initWithDataVersion:legacyDataVersion:", v8, v8);
  v10 = objc_alloc_init(MEMORY[0x1E0D32CC0]);
  objc_msgSend(v10, "setModelContainer:", v9);
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32C50]), "initWithDatastorePath:configuration:", v6, v10);
  if (v11)
  {
    v12 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32C20]), "initWithLocalDatabase:configuration:", v11, v7);
    if (v12)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v25 = 2112;
        v26 = v7;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create cloud database with configuration %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v27 = 2112;
      v28 = v7;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create local database with file URL %@ and cloud configuration %@", buf, 0x20u);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating database", buf, 0xCu);
...
- (void)start
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting database", buf, 0xCu);
...
- (id)registerSharedSubscriptionForExternalRecordType:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering shared subscription for external record type %@", (uint8_t *)&v12, 0x16u);
...
- (id)unregisterSharedSubscriptionForExternalRecordType:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering shared subscription for external record type %@", (uint8_t *)&v12, 0x16u);
...
- (id)existingPrivateZonesWithName:(id)a3 configuration:(id)a4 delegate:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v10;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching existing private zones with name %@", (uint8_t *)&v21, 0x16u);

  }
  objc_autoreleasePoolPop(v13);
  -[HMDDatabase start](v14, "start");
  v17 = objc_alloc(MEMORY[0x1E0C95098]);
  v18 = (void *)objc_msgSend(v17, "initWithZoneName:ownerName:", v10, *MEMORY[0x1E0C94730]);
...
- (id)privateZonesWithName:(id)a3 configuration:(id)a4 delegate:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v10;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching private zones with name %@", (uint8_t *)&v21, 0x16u);
...
- (id)existingSharedZoneIDWithName:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v26 = 2112;
    v27 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Finding shared zone ID with zone name %@", buf, 0x16u);
...
- (id)sharedZonesWithID:(id)a3 configuration:(id)a4 delegate:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v10;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching shared zones with zone ID %@", (uint8_t *)&v20, 0x16u);
...
- (id)synchronizeSharedZones
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Synchronizing shared zones", (uint8_t *)&v10, 0xCu);
...
- (id)removePrivateZonesWithName:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing private zones with name %@", (uint8_t *)&v13, 0x16u);

  }
  objc_autoreleasePoolPop(v5);
  v9 = objc_alloc(MEMORY[0x1E0C95098]);
  v10 = (void *)objc_msgSend(v9, "initWithZoneName:ownerName:", v4, *MEMORY[0x1E0C94730]);
...
- (id)removeSharedZonesWithName:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing shared zones with name %@", (uint8_t *)&v18, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Attempted to remove a non-existing shared zone with name: %@", (uint8_t *)&v18, 0x16u);
...
- (id)removeLocalAndCloudDataForLocalZone:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing local and cloud data for local zone %@", buf, 0x16u);
...
- (id)acceptInvitation:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Accepting sharing invitation %@", (uint8_t *)&v12, 0x16u);
...
- (id)zonesWithID:(id)a3 isPrivate:(BOOL)a4 shouldCreate:(BOOL)a5 configuration:(id)a6 delegate:(id)a7 error:(id *)a8
{
  ...
  {
    v42 = v14;
    v21 = objc_alloc_init(MEMORY[0x1E0D32CC8]);
    ...
    if (v23)
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v55 = 2112;
        v56 = v44;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_INFO, "%{public}@Successfully opened %@ zones with zoneID: %@, delegate: %@", buf, 0x2Au);
    ...
    else
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v55 = 2112;
        v56 = v24;
        _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ local zone with zoneID %@: %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v55 = 2112;
      v56 = v20;
      _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ cloud zone with zoneID %@: %@", buf, 0x2Au);
...
- (id)removeZonesWithID:(id)a3 isPrivate:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v44 = 2112;
    v45 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing %@ zones with ID %@", buf, 0x20u);

  }
  objc_autoreleasePoolPop(v7);
  v12 = objc_alloc_init(MEMORY[0x1E0D32C38]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v46 = 2112;
        v47 = v22;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ local zone with zoneID %@: %@", buf, 0x2Au);

        v30 = v36;
      }

      objc_autoreleasePoolPop(v30);
      objc_msgSend(MEMORY[0x1E0D519C0], "futureWithError:", v22);
      v23 = objc_claimAutoreleasedReturnValue();
    }
    v29 = (void *)v23;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v46 = 2112;
      v47 = v18;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ cloud zone with zoneID %@: %@", buf, 0x2Au);

    }
    objc_autoreleasePoolPop(v24);
    objc_msgSend(MEMORY[0x1E0D519C0], "futureWithError:", v18);
    v29 = (void *)objc_claimAutoreleasedReturnValue();
  }
...
- (void)localDatabase:(id)a3 detectedLocalCorruptionWithInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Local database %@ detected local corruption with info: %@", (uint8_t *)&v12, 0x20u);
...
- (void)localDatabase:(id)a3 willRemoveZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 2112;
    v17 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Local database %@ will remove zone with ID: %@", (uint8_t *)&v12, 0x20u);
...
- (void)cloudDatabase:(id)a3 didCreateZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v20 = 2112;
    v21 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ created zone with zone ID %@", buf, 0x20u);
...
- (id)cloudDatabase:(id)a3 willRemoveZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v25 = 2112;
    v26 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ will remove zone with zone ID %@", buf, 0x20u);
  ...
  objc_msgSend(MEMORY[0x1E0D519C0], "chainFutures:", v13);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)cloudDatabase:(id)a3 didRemoveZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v20 = 2112;
    v21 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ removed zone with zone ID %@", buf, 0x20u);
...
- (void)cloudDatabase:(id)a3 didReceiveMessageWithUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v19 = 2112;
    v20 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ received message with user info %@", buf, 0x20u);
...
void __50__HMDDatabase_mergedActionFutureForActionFutures___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0D32CA8];
  v4 = a2;
  v6 = objc_alloc_init(v3);
  v5 = objc_msgSend(v4, "na_any:", &__block_literal_global_90534);
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v22 = 2112;
        v23 = v11;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding default container identifier to %@", (uint8_t *)&v20, 0x16u);
    ...
    v13 = objc_alloc(MEMORY[0x1E0C94C40]);
    v14 = (void *)objc_msgSend(v13, "initWithContainerIdentifier:environment:", v12, cloudKitContainerEnvironment);
    v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D32CB0]), "initWithContainerID:", v14);
    ...
    objc_msgSend(v15, "setSubscriptionPushRegistrationAction:", 1);
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v22 = 2112;
        v23 = v11;
        _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding camera clips container identifier to %@", (uint8_t *)&v20, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t42 != -1)
    dispatch_once(&logCategory__hmf_once_t42, &__block_literal_global_74);
