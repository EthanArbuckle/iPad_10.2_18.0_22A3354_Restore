...
- (id)sunrise
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Sunrise time: %@", (uint8_t *)&v13, 0x16u);
...
- (id)sunset
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v11;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Sunset time: %@", (uint8_t *)&v13, 0x16u);
...
LABEL_22:
    ...
    if (objc_msgSend(v28, "expressionType") == 3)
    {
      ...
      v45 = objc_msgSend(v44, "isEqualToString:", *MEMORY[0x1E0CB86F0]);
...
LABEL_59:
    ...
    if (objc_msgSend(v28, "expressionType") == 3)
    {
      ...
      v48 = objc_msgSend(v47, "isEqualToString:", *MEMORY[0x1E0CB8B58]);
      ...
      if (v48)
      {
        ...
        v52 = (void *)MEMORY[0x1E0CB35D0];
        objc_msgSend(v46, "constantValue");
        v53 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v23, "predicateOperatorType"));
    ...
    v58 = objc_msgSend(v57, "isEqualToString:", *MEMORY[0x1E0CB9880]);
...
LABEL_61:
    v50 = objc_msgSend(objc_alloc(*(Class *)(v24 + 1304)), "initWithLeftExpression:rightExpression:modifier:type:options:", v28, v27, objc_msgSend(v23, "comparisonPredicateModifier"), v56, objc_msgSend(v23, "options"));
    v46 = v27;
LABEL_62:
  ...
  {
    v22 = v82;
    v23 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3528]), "initWithType:subpredicates:", objc_msgSend(v82, "compoundPredicateType"), v15);
    v13 = v91;
  }
  else
  {
...
- (id)comparePresence:(id)a3 operatorType:(id)a4 homePresence:(id)a5
{
  ...
  if (objc_msgSend(v9, "unsignedIntegerValue") == 4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v8;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Checking whether the homePresence %@ agree with the presence events in condition: %@", (uint8_t *)&v20, 0x20u);
...
LABEL_24:
    if (objc_msgSend(v29, "expressionType") != 3
      || (objc_msgSend(v29, "keyPath"),
          v42 = (void *)objc_claimAutoreleasedReturnValue(),
          v43 = objc_msgSend(v42, "isEqualToString:", *MEMORY[0x1E0CB86F0]),
          v42,
          !v43))
    {
      if (objc_msgSend(v29, "expressionType") == 3)
      {
        ...
        v56 = objc_msgSend(v55, "isEqualToString:", *MEMORY[0x1E0CB8B58]);
        ...
        if (v59)
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v79 = 2112;
            v80 = v72;
            _os_log_impl(&dword_1CD062000, v52, OS_LOG_TYPE_INFO, "%{public}@Char %@ has been removed, and it has reference in the condition, updating the condition", buf, 0x16u);
...
LABEL_51:
  ...
  {
    v25 = v63;
    v26 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3528]), "initWithType:subpredicates:", objc_msgSend(v63, "compoundPredicateType"), v18);
  }
  else
  {
    v26 = 0;
...
- (id)updatePredicate:(id)a3 removedUser:(id)a4 conditionModified:(BOOL *)a5
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (objc_msgSend(v12, "count"))
      v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3528]), "initWithType:subpredicates:", objc_msgSend(v11, "compoundPredicateType"), v12);
    else
      v19 = 0;
    v10 = v52;
...
LABEL_26:
  ...
  if (objc_msgSend(v21, "expressionType") != 3
    || (objc_msgSend(v21, "keyPath"),
        ...
        v23 = objc_msgSend(v22, "isEqualToString:", *MEMORY[0x1E0CB9880]),
        v22,
        !v23))
  {
LABEL_25:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v61 = 2112;
    v62 = v48;
    _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@presence event dictionary: %@", buf, 0x16u);
  ...
  else
  {
    ...
    v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3518]), "initWithLeftExpression:rightExpression:modifier:type:options:", v21, v43, objc_msgSend(v20, "comparisonPredicateModifier"), v51, objc_msgSend(v20, "options"));
    if (a5)
      *a5 = 1;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v24, "expressionType") == 3
        && (objc_msgSend(v24, "keyPath"),
            v25 = (void *)objc_claimAutoreleasedReturnValue(),
            v26 = objc_msgSend(v25, "isEqualToString:", *MEMORY[0x1E0CB86F0]),
            v25,
            v26))
      {
              ...
              if (!v32)
              {
                ...
                if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v55 = 2112;
                  v56 = v22;
                  _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Removing predicate %@ because referenced characteristic no longer exists", buf, 0x16u);
      ...
      else if (objc_msgSend(v24, "expressionType") == 3)
      {
        objc_msgSend(v24, "keyPath");
        v39 = (void *)objc_claimAutoreleasedReturnValue();
        v40 = objc_msgSend(v39, "isEqualToString:", *MEMORY[0x1E0CB8B58]);
...
LABEL_30:
  ...
  {
    v20 = v45;
    v21 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3528]), "initWithType:subpredicates:", objc_msgSend(v45, "compoundPredicateType"), v13);
  }
  else
  {
    v21 = 0;
...
- (id)rewriteNowAdjustedForHomeTimeZone:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x1E0CB35D0], "expressionWithFormat:", CFSTR("FUNCTION($THIS_OBJECT, 'dateTodayMatchingComponents:', %@)"), v5);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)rewritePredicate:(id)a3 forDaemon:(BOOL)a4 message:(id)a5
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v22, "expressionType") == 3)
      {
        ...
        v23 = (void *)objc_claimAutoreleasedReturnValue();
        v24 = objc_msgSend(v23, "isEqualToString:", *MEMORY[0x1E0CB9880]);
        ...
        if (v24)
        {
          ...
          if (!objc_msgSend(v25, "expressionType"))
          {
            ...
            if ((isKindOfClass & 1) != 0)
            {
              ...
              v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3518]), "initWithLeftExpression:rightExpression:modifier:type:options:", v22, v32, objc_msgSend(v20, "comparisonPredicateModifier"), v37, objc_msgSend(v20, "options"));
              goto LABEL_24;
            }
          }
  ...
  {
    v18 = v36;
    v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3528]), "initWithType:subpredicates:", objc_msgSend(v36, "compoundPredicateType"), v11);
  }
  else
  {
    v19 = 0;
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v13, "expressionType") == 3
        && (objc_msgSend(v13, "keyPath"),
            v14 = (void *)objc_claimAutoreleasedReturnValue(),
            v15 = objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0CB9880]),
            v14,
            v15)
      ...
      if (v16)
      {
        ...
        if (!objc_msgSend(v21, "expressionType"))
        {
          ...
          if ((isKindOfClass & 1) != 0 && objc_msgSend(v14, "expressionType") == 3)
          {
            ...
            v24 = (void *)objc_claimAutoreleasedReturnValue();
            if (objc_msgSend(v24, "isEqualToString:", *MEMORY[0x1E0CB9B88]))
            {
            ...
            else
            {
              objc_msgSend(v14, "keyPath");
              v47 = (void *)objc_claimAutoreleasedReturnValue();
              v49 = objc_msgSend(v47, "isEqualToString:", *MEMORY[0x1E0CB9B90]);
...
LABEL_46:
               ...
               v29))
    {
      if (objc_msgSend(v14, "expressionType") == 3)
      {
        objc_msgSend(v14, "keyPath");
        v30 = (void *)objc_claimAutoreleasedReturnValue();
        if (objc_msgSend(v30, "isEqualToString:", *MEMORY[0x1E0CB9B88]))
        {
        ...
        else
        {
          ...
          v46 = objc_msgSend(v45, "isEqualToString:", *MEMORY[0x1E0CB9B90]);
    ...
    else
    {
      if (objc_msgSend(v14, "expressionType") != 3
        || (objc_msgSend(v14, "keyPath"),
            v31 = (void *)objc_claimAutoreleasedReturnValue(),
            v32 = objc_msgSend(v31, "isEqualToString:", *MEMORY[0x1E0CB86F0]),
            v31,
            !v32))
      {
        if (objc_msgSend(v14, "expressionType") == 3)
        {
          objc_msgSend(v14, "keyPath");
          v33 = (void *)objc_claimAutoreleasedReturnValue();
          v34 = objc_msgSend(v33, "isEqualToString:", *MEMORY[0x1E0CB9880]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_131241 != -1)
    dispatch_once(&logCategory__hmf_once_t1_131241, &__block_literal_global_131242);
  return (id)logCategory__hmf_once_v2_131243;
}
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (objc_msgSend(v9, "expressionType") == 3)
      {
        ...
        v19 = (void *)objc_claimAutoreleasedReturnValue();
        v20 = objc_msgSend(v19, "isEqualToString:", *MEMORY[0x1E0CB9880]);
              ...
              if (objc_msgSend(v25, "count"))
              {
                ...
                if (v27 < objc_msgSend(v25, "count"))
                {
                  if (objc_msgSend(v26, "count"))
                  {
                    ...
                    v29 = objc_alloc(MEMORY[0x1E0CB3518]);
...
LABEL_24:
  ...
  v18 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3528]), "initWithType:subpredicates:", objc_msgSend(v36, "compoundPredicateType"), v9);
LABEL_25:
  v34 = v18;
LABEL_26:
...
+ (id)unarchiveFromData:(id)a3 error:(id *)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = 0;
  objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClasses:fromData:error:", v9, v6, &v18);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v11 = v18;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v11;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive predicate: %@", buf, 0x16u);
...
void __36__HMDPredicateUtilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_131243;
  logCategory__hmf_once_v2_131243 = v0;
