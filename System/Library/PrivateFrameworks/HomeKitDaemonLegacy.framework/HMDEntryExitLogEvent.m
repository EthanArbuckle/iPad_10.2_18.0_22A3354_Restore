...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  if (-[HMDEntryExitLogEvent isInitial](self, "isInitial"))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDEntryExitLogEvent isEntry](self, "isEntry"));
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDEntryExitLogEvent isExit](self, "isExit"));
    ...
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDEntryExitLogEvent isFalse](self, "isFalse"));
