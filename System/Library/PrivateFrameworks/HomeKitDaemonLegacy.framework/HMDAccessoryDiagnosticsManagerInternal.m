...
- (void)_handleDiagnosticsTransferRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v25 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received message to start diagnostics transfer", buf, 0xCu);
  ...
  if ((v10 & 1) != 0)
  {
    ...
    {
      v23 = 0;
      objc_msgSend(MEMORY[0x1E0CB3710], "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v12, &v23);
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = v23;
    }
    else
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v14;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Decoded diagnostics options with error %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v26 = 2112;
      v27 = v4;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Diagnostics transfer request message: %@ when accessory is not reachable", buf, 0x16u);
...
void __111__HMDAccessoryDiagnosticsManagerInternal_notifyClientsOfDiagnosticsTransferSupport_supportDiagnosticsTransfer___block_invoke(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    encodeRootObject();
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKeyedSubscript:", v5, *MEMORY[0x1E0CB8038]);

  }
  objc_msgSend(MEMORY[0x1E0D285D0], "messageWithName:messagePayload:", *MEMORY[0x1E0CB7BE0], v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_42263 != -1)
    dispatch_once(&logCategory__hmf_once_t3_42263, &__block_literal_global_42264);
  return (id)logCategory__hmf_once_v4_42265;
}
...
void __53__HMDAccessoryDiagnosticsManagerInternal_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_42265;
  logCategory__hmf_once_v4_42265 = v0;
