...
- (void)updateWithProgressState:(id)a3 date:(id)a4
{
  ...
  if (v6)
  {
    ...
    objc_msgSend(v12, "setObject:forKey:", &unk_1E8B32D78, v6);
    ...
    v15 = (void *)MEMORY[0x1D17BA0A0](-[HMDAccessoryPairingProgressStateMap setLastProgressStateEventTime:](self, "setLastProgressStateEventTime:", v7));
    v16 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Successfully added progress state: %@ to the pairing progress state map: %@", (uint8_t *)&v38, 0x20u);

    }
LABEL_9:

    objc_autoreleasePoolPop(v15);
    -[NSMutableDictionary keysSortedByValueUsingComparator:](self->_progressStateMap, "keysSortedByValueUsingComparator:", &__block_literal_global_37584);
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Updated longest progress state to: %@", (uint8_t *)&v38, 0x16u);
  ...
  if (self->_lastProgressState)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      v40 = 2112;
      v41 = v24;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Successfully updated duration of last progress state to: %@", (uint8_t *)&v38, 0x16u);

    }
    goto LABEL_9;
  }
  v34 = (void *)MEMORY[0x1D17BA0A0](v9);
  v35 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
  {
    ...
    v38 = 138543362;
    v39 = v37;
    _os_log_impl(&dword_1CD062000, v36, OS_LOG_TYPE_DEBUG, "%{public}@No previous state information to update last state duration", (uint8_t *)&v38, 0xCu);
