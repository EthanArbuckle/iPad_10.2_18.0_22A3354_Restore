@implementation AWDHomeKitDurationEvent
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDHomeKitDurationEvent;
  -[AWDHomeKitDurationEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDHomeKitDurationEvent dictionaryRepresentation](self, "dictionaryRepresentation");
