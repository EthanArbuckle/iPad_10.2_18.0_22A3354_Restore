...
- (void)respondToRequestWithIdentifier:(id)a3 withPayload:(id)a4 error:(id)a5
{
  ...
  if (v13)
  {
    ...
    if (v10)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR(" with error %@"), v10);
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      v42 = 2114;
      v43 = v33;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Answering incoming message %{public}@ (%{public}@) from client '%{public}@' that expects a response%{public}@", buf, 0x34u);
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v31;
        _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Suspending timer after last request was removed", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v38 = 2114;
      v39 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to find request with identifier %{public}@ for client '%{public}@' to remove from request tracker", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_158349 != -1)
    dispatch_once(&logCategory__hmf_once_t17_158349, &__block_literal_global_158350);
  return (id)logCategory__hmf_once_v18_158351;
}
...
- (HMDXPCRequestTracker)initWithQueue:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x1E0D286C8];
  v5 = a3;
...
- (void)addRequestWithIdentifier:(id)a3 name:(id)a4 qualityOfService:(int64_t)a5 isTimeoutDisabled:(BOOL)a6 responseHandler:(id)a7
{
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v19;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Starting watchdog timer", buf, 0xCu);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v38 = 2112;
      v39 = v11;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Disabling timeout for message %@(%@)", buf, 0x20u);
...
- (void)cancelAllRequests
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v28 = v5;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Canceling all pending requests", buf, 0xCu);
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v33 = 2112;
            v34 = clientName;
            _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Canceling pending request %@ (%@) from client '%@' that expects a response", buf, 0x2Au);
        ...
        for (i = 0; i != v8; ++i)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            v47 = 2112;
            v48 = v10;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Checking if request %@ (%@) timed out after watchdog timer fired", buf, 0x20u);
          ...
          if (v19)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              v49 = 2112;
              v50 = clientName;
              _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Reaping timed out pending request %@ (%@) from client '%@' that expects a response", buf, 0x2Au);
            ...
            if ((_DWORD)v27)
            {
              ...
              if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v44 = v32;
                _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Suspending watchdog timer after handling timeout", buf, 0xCu);
...
void __35__HMDXPCRequestTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_158351;
  logCategory__hmf_once_v18_158351 = v0;
