...
- (id)mainReturningError
{
  ...
  v43 = &v42;
  v44 = 0x3032000000;
  v45 = __Block_byref_object_copy__16441;
  v46 = __Block_byref_object_dispose__16442;
  v47 = 0;
  ...
  v19 = objc_msgSend(MEMORY[0x1E0C99D68], "timeIntervalSinceReferenceDate");
  v21 = v20;
  v22 = (void *)MEMORY[0x1D17BA0A0](v19);
  v23 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v54 = 2048;
    v55 = v21 - v7;
    _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@time to fetch migrated records: %.4f s", buf, 0x16u);
          ...
          if (!v8 || (objc_msgSend(v8, "isEqual:", v20) & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v29 = 2048;
              v30 = v25;
              _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@detected migrations is need for %lu", buf, 0x16u);
    ...
    if (v50 || !v26)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v58 = 2112;
        v59 = v17;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_ERROR, "%{public}@unable to decode object for %lu / %@", buf, 0x20u);
      ...
      if (!v21 || (objc_msgSend(v21, "isEqual:", v46) & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138544642;
          ...
          v65 = v46;
          v30 = v29;
          _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@detected a schema change for %lu / %@/%@ from %@ to %@", buf, 0x3Eu);
