...
- (id)tlvData
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDSetupEndPointRead responseStatus](self, "responseStatus"));
...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 2, CFSTR("kSetupEndPointRead__Status"));
...
- (BOOL)_parseFromTLVDataOnSuccess
{
  ...
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 6, CFSTR("kSetupEndPointRead__VideoSSRC"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x1E0D16590], "wrappertlv:name:", 7, CFSTR("kSetupEndPointRead__AudioSSRC"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v14[0] = v3;
  v14[1] = v4;
