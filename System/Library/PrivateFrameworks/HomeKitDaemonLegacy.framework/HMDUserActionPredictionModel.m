...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_39643 != -1)
    dispatch_once(&hmbProperties_onceToken_39643, &__block_literal_global_39644);
  return (id)hmbProperties_properties_39645;
}
...
void __45__HMDUserActionPredictionModel_hmbProperties__block_invoke()
{
  ...
  v24 = (void *)hmbProperties_properties_39645;
  hmbProperties_properties_39645 = v23;
...
- (HMDUserActionPredictionModel)initWithUserActionPrediction:(id)a3
{
  ...
  v18 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("D73F97DF-5711-4EAA-9CA4-EB5C028A5EE8"));
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v4, "predictionType"));
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMDUserActionPredictionModel setType:](v19, "setType:", v23);

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(v4, "targetGroupType"));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v45 = 2112;
      v46 = v30;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@User Action Prediction: %@, resulted in nil hmbModelID for prediction model: %@", (uint8_t *)&v41, 0x20u);
    ...
    if (!v33)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
      {
        ...
        v41 = 138543362;
        v42 = v38;
        _os_log_impl(&dword_1CD062000, v37, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: User Action Prediction ModelID should not be nil", (uint8_t *)&v41, 0xCu);
...
- (id)userActionPrediction
{
  ...
  v3 = objc_alloc(MEMORY[0x1E0CBA938]);
