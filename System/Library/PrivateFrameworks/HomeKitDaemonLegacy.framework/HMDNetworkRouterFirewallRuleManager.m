  ...
  if (self->_state)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v11 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: should be stopped", buf, 0xCu);
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v14 = 2048;
      v15 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Operation started (%lu operations now pending)", buf, 0x16u);
  ...
  if (v1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
      {
        ...
        v12 = (void *)v16;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Operation count unbalanced", (uint8_t *)&v15, 0xCu);
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v17 = 2048;
      v18 = v4;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Operation finished (%lu operations now pending)", (uint8_t *)&v15, 0x16u);
    ...
    if ((v2 & 0xFFFFFFFFFFFFFFFDLL) == 0)
    {
      ...
      if (v6)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&v58[22] = 2048;
          v59 = (void *)v5;
          _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Purged %lu deallocated client(s) (now have %lu)", v58, 0x20u);
        ...
        else
        {
          ...
          if (-[os_unfair_lock_s state](a1, "state") != 2)
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_QWORD *)&v58[4] = v49;
              _os_log_impl(&dword_1CD062000, v48, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be running", v58, 0xCu);
          ...
          if (-[os_unfair_lock_s operationsInProgressCount](a1, "operationsInProgressCount"))
          {
            ...
            if (os_log_type_enabled(v54, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)v58 = 138543362;
              *(_QWORD *)&v58[4] = v55;
              _os_log_impl(&dword_1CD062000, v54, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have finished all operations", v58, 0xCu);
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v58 = 138543362;
            *(_QWORD *)&v58[4] = v30;
            _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Shutdown initiated", v58, 0xCu);
      ...
      else
      {
        ...
        if (-[os_unfair_lock_s state](a1, "state"))
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)v58 = 138543362;
            *(_QWORD *)&v58[4] = v43;
            _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be stopped", v58, 0xCu);
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v58 = 138543362;
          *(_QWORD *)&v58[4] = v21;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Startup initiated", v58, 0xCu);
...
void __49__HMDNetworkRouterFirewallRuleManager___shutdown__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down: %@", (uint8_t *)&v9, 0x16u);
...
void __48__HMDNetworkRouterFirewallRuleManager___startup__block_invoke(uint64_t a1, void *a2)
{
  ...
  v7 = v6;
  v19 = v7;
  v8 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v5, "hmf_enumerateWithAutoreleasePoolUsingBlock:", &v14));
  v9 = *(id *)(a1 + 32);
  HMFGetOSLogHandle();
  ...
  if (v3)
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v22 = 2112;
      v23 = v3;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Startup failed: %@", buf, 0x16u);
  ...
  else
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Startup completed successfully", buf, 0xCu);
...
void __48__HMDNetworkRouterFirewallRuleManager___startup__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Completion should not have been called yet", (uint8_t *)&v14, 0xCu);
...
void __57__HMDNetworkRouterFirewallRuleManager_shutdownForClient___block_invoke(uint64_t a1)
{
  ...
  v40 = &v39;
  v41 = 0x3032000000;
  v42 = __Block_byref_object_copy__37430;
  v43 = __Block_byref_object_dispose__37431;
  v44 = 0;
  v35 = 0;
  v36 = &v35;
  v37 = 0x2020000000;
  ...
  if (v40[5])
  {
    v4 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v2, "removeObjectAtIndex:", v36[3], v28, v29, v30, v31));
    v5 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v50 = 2112;
      v51 = v9;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Removed active client (now have %lu): %@", buf, 0x20u);
      ...
      if ((v10 & 0xFFFFFFFFFFFFFFFDLL) != 1)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v47 = v24;
          v25 = (void *)v24;
          _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be starting or stopping", buf, 0xCu);
  ...
  {
    v16 = (void *)MEMORY[0x1D17BA0A0](v3);
    v17 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v48 = 2112;
      v49 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Ignoring unbalanced shutdown request for client %@", buf, 0x16u);
...
void __67__HMDNetworkRouterFirewallRuleManager_startupForClient_completion___block_invoke(id *a1)
{
  ...
  v33 = &v32;
  v34 = 0x3032000000;
  v35 = __Block_byref_object_copy__37430;
  v36 = __Block_byref_object_dispose__37431;
  ...
  if (v33[5])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = (uint64_t)v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Ignoring duplicate startup request for client %@", buf, 0x16u);
  ...
  else
  {
    ...
    v15 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v2, "addObject:", v33[5]));
    v16 = a1[4];
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v43 = 2112;
      v44 = v20;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Added active client (now have %lu): %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_37480 != -1)
    dispatch_once(&logCategory__hmf_once_t0_37480, &__block_literal_global_37481);
  return (id)logCategory__hmf_once_v1_37482;
}

+ (HMDNetworkRouterFirewallRuleManager)sharedInstance
{
  if (sharedInstance_onceToken != -1)
    dispatch_once(&sharedInstance_onceToken, &__block_literal_global_14_37478);
...
void __50__HMDNetworkRouterFirewallRuleManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_37482;
  logCategory__hmf_once_v1_37482 = v0;
