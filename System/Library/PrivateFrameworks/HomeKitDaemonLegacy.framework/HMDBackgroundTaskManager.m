...
- (BOOL)scheduleTaskWithIdentifier:(id)a3 fireDate:(id)a4 onObserver:(id)a5 selector:(SEL)a6 error:(id *)a7
{
  ...
  if (v22 == -1)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v13;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to schedule task for identifier %@ with fire date in the past: %@", (uint8_t *)&v34, 0x20u);
  ...
  else
  {
    ...
    v24 = (void *)MEMORY[0x1D17BA0A0](-[HMDBackgroundTaskManager _setTask:forIdentifier:](self, "_setTask:forIdentifier:", v23, v12));
    v25 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v38 = 2048;
      v39 = v28;
      _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Scheduling task %@ (in %fs)", (uint8_t *)&v34, 0x20u);
...
- (void)cancelTaskWithIdentifier:(id)a3 onObserver:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Cancelling task with identifier: %@", (uint8_t *)&v18, 0x16u);
...
- (void)_handleEvent:(id)a3
{
  ...
  if (string)
  {
    ...
    if (v7)
    {
      ...
      if (v8)
      {
        ...
        if (v13)
        {
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            v41 = 2112;
            v42 = v7;
            _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@Not executing task because xpc event was delivered too late, expected fire date: %@, identifier: %@", (uint8_t *)&v37, 0x20u);
        ...
        else
        {
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            v39 = 2112;
            v40 = (const char *)v8;
            _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Executing task %@", (uint8_t *)&v37, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          v39 = 2112;
          v40 = (const char *)v7;
          _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Pausing scheduled task until observer is added, identifier: %@", (uint8_t *)&v37, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        v39 = 2080;
        v40 = v6;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unable to execute task with missing identifier for event key name: %s", (uint8_t *)&v37, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v24;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@Unable to execute task because xpc event key name is missing", (uint8_t *)&v37, 0xCu);
  ...
  if (v9)
  {
    ...
    if (v11 <= 10.0)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Executing pending task identifier: %@", (uint8_t *)&v21, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v6;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Not executing pending task because client was registered too late, expected fire date: %@, identifier: %@", (uint8_t *)&v21, 0x20u);
...
+ (HMDBackgroundTaskManager)sharedManager
{
  if (sharedManager__hmf_once_t0 != -1)
    dispatch_once(&sharedManager__hmf_once_t0, &__block_literal_global_41194);
  return (HMDBackgroundTaskManager *)(id)sharedManager__hmf_once_v1;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t18_41189 != -1)
    dispatch_once(&logCategory__hmf_once_t18_41189, &__block_literal_global_16_41190);
  return (id)logCategory__hmf_once_v19_41191;
}
...
void __39__HMDBackgroundTaskManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v19_41191;
  logCategory__hmf_once_v19_41191 = v0;
