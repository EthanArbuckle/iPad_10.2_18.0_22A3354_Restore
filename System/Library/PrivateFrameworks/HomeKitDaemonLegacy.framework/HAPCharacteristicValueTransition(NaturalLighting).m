...
LABEL_20:
  ...
  v28 = 0;
  objc_msgSend(MEMORY[0x1E0D16460], "parsedFromData:error:", v9, &v28);
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v33 = 2112;
      v34 = v11;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode controller context %@:%@", buf, 0x20u);
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v31 = 2112;
      v32 = v10;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Start time missing in the controller context %@", buf, 0x16u);
...
- (id)naturalLightingActiveTransitionContextLightProfile:()NaturalLighting
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", (uint8_t *)&v14, 0x20u);
...
+ (id)naturalLightingValueTransitionWithLightProfile:()NaturalLighting naturalLightingEnabled:startDate:dataSource:
{
  ...
  if (v16)
  {
    ...
    if (v19 > 0)
    {
      ...
      if (!v71)
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v76 = 2112;
          v77 = v10;
          _os_log_impl(&dword_1CD062000, v49, OS_LOG_TYPE_ERROR, "%{public}@Natural lighting curve is not set on light profile %@:%@", buf, 0x20u);
      ...
      v22 = (void *)*MEMORY[0x1E0CB8810];
      objc_msgSend(v21, "findCharacteristicWithType:", *MEMORY[0x1E0CB8810]);
      ...
      if (!v70)
      {
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v76 = 2112;
          v77 = v22;
          _os_log_impl(&dword_1CD062000, v53, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", buf, 0x20u);
      ...
      v23 = (void *)*MEMORY[0x1E0CB87C0];
      v68 = v21;
      objc_msgSend(v21, "findCharacteristicWithType:", *MEMORY[0x1E0CB87C0]);
      v24 = objc_claimAutoreleasedReturnValue();
      v67 = (void *)v24;
      if (!v24)
      {
        ...
        if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          v76 = 2112;
          v77 = v23;
          _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support brightness Characteristic %@:%@", buf, 0x20u);
      ...
      if (a4)
      {
        ...
        if ((objc_msgSend((id)objc_opt_class(), "updateTransition:withCurve:brightnessCharacteristic:millisecondsElapsedSinceStartOfDay:transitionStartTimeInMilliseconds:", v29, v71, v25, v20, v19) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v73 = v62;
            _os_log_impl(&dword_1CD062000, v61, OS_LOG_TYPE_ERROR, "%{public}@Failed to update transition with Natural Lighting Curve", buf, 0xCu);
        ...
        {
          v31 = objc_alloc(MEMORY[0x1E0D16610]);
          v32 = v28;
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v71, "colorTemperatureNotifyIntervalThresholdInMilliseconds"));
        ...
        {
          v35 = objc_alloc(MEMORY[0x1E0D16610]);
          v36 = v28;
          objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v71, "colorTemperatureUpdateIntervalInMilliseconds"));
...
LABEL_37:
    ...
    v42 = (void *)MEMORY[0x1D17BA0A0](v17);
    v43 = a1;
    HMFGetOSLogHandle();
...
LABEL_20:
      _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_ERROR, v46, buf, 0x16u);
    ...
    do
    {
      ...
      if (v10 && objc_msgSend(a1, "canCoalesceTransitionPoint1:transitionPoint2:ofCurve:", v9, v10, v39))
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = v36;
          ...
          v50 = 2048;
          v51 = v12;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Coalescing transition point: %@ at index: %lu with transition point: %@ at index: %lu", buf, 0x34u);
      ...
      else
      {
        ...
        if (v11)
        {
          ...
          v24 = objc_alloc(MEMORY[0x1E0D16610]);
...
+ (uint64_t)updateTransition:()NaturalLighting withCurve:brightnessCharacteristic:millisecondsElapsedSinceStartOfDay:transitionStartTimeInMilliseconds:
{
  ...
  v12 = a4;
  v66 = a5;
  v13 = objc_msgSend(objc_alloc(MEMORY[0x1E0D16468]), "initWithValue:", 1);
  v14 = objc_alloc(MEMORY[0x1E0D16610]);
  ...
  v77[0] = 0;
  v77[1] = 0;
  v64 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("C4F33DA9-63C9-4C0F-8B89-6C36A33EEF9E"));
  objc_msgSend(v64, "getUUIDBytes:", v77);
  objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v77, 16);
  v17 = objc_claimAutoreleasedReturnValue();
  v18 = objc_alloc(MEMORY[0x1E0D16460]);
  v19 = objc_alloc(MEMORY[0x1E0D16610]);
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedLongLong:", objc_msgSend(v12, "checksum"));
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v71 = 2112;
        v72 = (uint64_t)v26;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@No transition points found: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        v75 = 2048;
        v76 = v42;
        _os_log_impl(&dword_1CD062000, v46, OS_LOG_TYPE_INFO, "%{public}@Sending coalesced transition points to accessory, transition points count: %lu, start transition point: %@, time elapsed since start of the day: %llums", buf, 0x2Au);
      ...
      *(_DWORD *)buf = objc_msgSend(v12, "minimumBrightness");
      ...
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", &v67, 4);
      v51 = (void *)objc_claimAutoreleasedReturnValue();
      v52 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16440]), "initWithLowerBound:upperBound:", v50, v51);
      v53 = objc_alloc(MEMORY[0x1E0D16610]);
      v35 = v66;
      objc_msgSend(v66, "instanceID");
      v54 = (void *)objc_claimAutoreleasedReturnValue();
      v55 = (void *)objc_msgSend(v53, "initWithValue:", v54);

      v56 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16430]), "initWithTransitionPoints:sourceHAPInstanceID:sourceValueRange:", v43, v55, v52);
      v11 = v61;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v73 = 2112;
      v74 = v39;
      _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize controller context %@:%@", buf, 0x20u);
