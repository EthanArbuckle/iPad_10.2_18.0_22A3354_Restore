...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[HMDEventRouterEventSizeLogEvent size](self, "size"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("eventSize"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[HMDEventRouterEventSizeLogEvent isCached](self, "isCached"));
