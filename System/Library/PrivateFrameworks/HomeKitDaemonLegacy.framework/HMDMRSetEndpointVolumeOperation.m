...
- (HMDMRSetEndpointVolumeOperation)initWithRouteIDs:(id)a3 volume:(id)a4 externalObjectInterface:(id)a5
{
  ...
  if (v11)
  {
    ...
    *(float *)&v14 = v13 / 100.0;
    ...
    v19 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", CFSTR("HMDMRSetEndpointVolumeOperation"));
...
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v84 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Volume futures completed", buf, 0xCu);
  ...
  objc_msgSend(v14, "na_map:", &__block_literal_global_94_24057);
  ...
  if ((objc_msgSend(v17, "isEqualToSet:", v20) & 1) == 0)
  {
    ...
    v22 = (void *)MEMORY[0x1D17BA0A0](objc_msgSend(v21, "minusSet:", v20));
    v67 = v12;
    v23 = v12;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v85 = 2112;
      v86 = v21;
      _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_ERROR, "%{public}@Couldn't discover these endpoints to set their volume: %@", buf, 0x16u);
    ...
    if (v27)
    {
      ...
      do
      {
        for (i = 0; i != v28; ++i)
        {
          ...
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 2, CFSTR("Could not find endpoint"));
  ...
  if (!objc_msgSend(v14, "na_any:", &__block_literal_global_100_24060))
    goto LABEL_40;
  ...
  if (v52)
  {
    ...
    if (os_log_type_enabled(v57, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v85 = 2112;
      v86 = v51;
      _os_log_impl(&dword_1CD062000, v57, OS_LOG_TYPE_DEFAULT, "%{public}@Operation finished with partial success <%@>", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v85 = 2112;
      v86 = v51;
      _os_log_impl(&dword_1CD062000, v63, OS_LOG_TYPE_ERROR, "%{public}@Operation canceled due to failure <%@>", buf, 0x16u);
...
- (BOOL)cancelOnSetup
{
      ...
      for (i = 0; i != v5; ++i)
      {
        ...
        if (v9)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v42 = v14;
            _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Volume Operation canceled by dependency failure", buf, 0xCu);
  ...
  if (!v24 && v25)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 3, v30);
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v43 = 2112;
      v44 = v30;
      _os_log_impl(&dword_1CD062000, v34, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
...
- (id)discoverRemoteControlEndpointsForUIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Begin discoverRemoteControlEndpointsMatchingUIDs", buf, 0xCu);
...
- (id)connectToEndpoint:(id)a3 connection:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v29 = 2112;
    v30 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Begin connect to endpoint %@", buf, 0x16u);
...
- (id)getVolumeCapabilitiesForEndpoint:(id)a3 outputDeviceUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v26 = 2112;
    v27 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Begin getMRAVEndpointOutputDeviceUIDVolumeControlCapabilitiesForEndpoint on outputDeviceUID %@", buf, 0x16u);
...
- (id)setVolumeOnEndpoint:(id)a3 outputDeviceUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v39 = 2112;
    v40 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Begin setMRAVOutputDeviceVolume on outputDeviceUID %@", buf, 0x16u);
...
void __71__HMDMRSetEndpointVolumeOperation_setVolumeOnEndpoint_outputDeviceUID___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v28 = 2112;
    v29 = v13;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Complete setMRAVOutputDeviceVolume on outputDeviceUID %@", buf, 0x16u);
  ...
  if (v6)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v24 = 42;
LABEL_8:
      _os_log_impl(&dword_1CD062000, v22, v23, v21, buf, v24);
...
void __84__HMDMRSetEndpointVolumeOperation_getVolumeCapabilitiesForEndpoint_outputDeviceUID___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine if volume control is supported on endpoint %@ : %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v17;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Complete getMRAVEndpointOutputDeviceUIDVolumeControlCapabilitiesForEndpoint on outputDeviceUID %@", buf, 0x16u);
...
void __64__HMDMRSetEndpointVolumeOperation_connectToEndpoint_connection___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v23 = 2112;
      v24 = v6;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to connect to endpoint %@, %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v21 = 2112;
    v22 = v18;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Complete connect to endpoint %@", buf, 0x16u);
...
void __73__HMDMRSetEndpointVolumeOperation_discoverRemoteControlEndpointsForUIDs___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v6;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Operation endpoints %@ : output devices %@", (uint8_t *)&v23, 0x20u);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 138543362;
    v24 = v16;
    _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Completed discoverRemoteControlEndpointsMatchingUIDs", (uint8_t *)&v23, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 138543362;
      v24 = v21;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@No endpoints found for volume operation", (uint8_t *)&v23, 0xCu);

    }
    objc_autoreleasePoolPop(v18);
    v22 = *(_QWORD *)(a1 + 32);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:reason:", 15, CFSTR("Could not find endpoints"));
    v17 = (void *)objc_claimAutoreleasedReturnValue();
...
id __39__HMDMRSetEndpointVolumeOperation_main__block_invoke_3(uint64_t a1, void *a2)
{
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            v64 = 2112;
            v65 = v11;
            _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Found %@ matching route IDs (%@) on the output device: %@", buf, 0x2Au);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            v60 = 2112;
            v61 = v6;
            _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_ERROR, "%{public}@Got nil output device from outputDeviceRef %@", buf, 0x16u);
  ...
  objc_msgSend(v32, "flatMap:", &__block_literal_global_24081);
  v33 = (void *)objc_claimAutoreleasedReturnValue();
...
id __39__HMDMRSetEndpointVolumeOperation_main__block_invoke_77(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v3;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Skipping setMRAVOutputDeviceVolume on outputDeviceUID %@. Volume not controllable with given capabilities: %@", (uint8_t *)&v14, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_24098 != -1)
    dispatch_once(&logCategory__hmf_once_t24_24098, &__block_literal_global_152);
  return (id)logCategory__hmf_once_v25_24099;
}
...
void __46__HMDMRSetEndpointVolumeOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_24099;
  logCategory__hmf_once_v25_24099 = v0;
