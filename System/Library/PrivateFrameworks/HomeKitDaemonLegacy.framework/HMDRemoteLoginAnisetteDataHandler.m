...
- (HMDRemoteLoginAnisetteDataHandler)initWithUUID:(id)a3 accessory:(id)a4
{
  ...
  if (v9)
  {
    ...
    v11 = (AKAnisetteProvisioningController *)objc_alloc_init(MEMORY[0x1E0D00120]);
...
- (void)registerForMessages
{
  ...
  objc_msgSend(MEMORY[0x1E0CBA790], "messageName");
  ...
  objc_msgSend(MEMORY[0x1E0CBA8F0], "messageName");
  ...
  objc_msgSend(MEMORY[0x1E0CBA4B0], "messageName");
  ...
  objc_msgSend(MEMORY[0x1E0CBA508], "messageName");
  ...
  objc_msgSend(MEMORY[0x1E0CBA5B8], "messageName");
...
- (void)_handleProvisionAnisetteDataRequestMessage:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CBA790], "objWithMessage:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling provision anisette data request: %@", buf, 0x16u);
...
- (void)_handleSyncAnisetteDataRequestMessage:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CBA8F0], "objWithMessage:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x1D17BA0A0]();
  v7 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling sync anisette data request: %@", buf, 0x16u);
...
- (void)_handleEraseAnisetteDataRequestMessage:(id)a3
{
  ...
  v20 = *MEMORY[0x1E0C80C00];
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CBA4B0], "objWithMessage:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x1D17BA0A0]();
  v7 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling erase anisette data request: %@", buf, 0x16u);
...
- (void)_handleFetchAnisetteDataRequestMessage:(id)a3
{
  ...
  v20 = *MEMORY[0x1E0C80C00];
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CBA508], "objWithMessage:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x1D17BA0A0]();
  v7 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch anisette data request: %@", buf, 0x16u);
...
- (void)_handleLegacyAnisetteDataRequestMessage:(id)a3
{
  ...
  v21 = *MEMORY[0x1E0C80C00];
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CBA5B8], "objWithMessage:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (void *)MEMORY[0x1D17BA0A0]();
  v7 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v19 = 2112;
    v20 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling legacy anisette data request: %@", buf, 0x16u);
...
void __77__HMDRemoteLoginAnisetteDataHandler__handleLegacyAnisetteDataRequestMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0CBA5C0];
  v4 = a2;
  v5 = [v3 alloc];
...
void __76__HMDRemoteLoginAnisetteDataHandler__handleFetchAnisetteDataRequestMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = (objc_class *)MEMORY[0x1E0CBA510];
  v4 = a2;
  v5 = [v3 alloc];
  objc_msgSend(*(id *)(a1 + 32), "sessionID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
void __76__HMDRemoteLoginAnisetteDataHandler__handleEraseAnisetteDataRequestMessage___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v4 = objc_alloc(MEMORY[0x1E0CBA4B8]);
  objc_msgSend(*(id *)(a1 + 32), "sessionID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
void __75__HMDRemoteLoginAnisetteDataHandler__handleSyncAnisetteDataRequestMessage___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v4 = objc_alloc(MEMORY[0x1E0CBA8F8]);
  objc_msgSend(*(id *)(a1 + 32), "sessionID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (id)objc_msgSend(v4, "initWithSessionID:", v5);
...
void __80__HMDRemoteLoginAnisetteDataHandler__handleProvisionAnisetteDataRequestMessage___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v4 = objc_alloc(MEMORY[0x1E0CBA798]);
  objc_msgSend(*(id *)(a1 + 32), "sessionID");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (id)objc_msgSend(v4, "initWithSessionID:", v5);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_110306 != -1)
    dispatch_once(&logCategory__hmf_once_t5_110306, &__block_literal_global_110307);
  return (id)logCategory__hmf_once_v6_110308;
}
...
void __48__HMDRemoteLoginAnisetteDataHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_110308;
  logCategory__hmf_once_v6_110308 = v0;
