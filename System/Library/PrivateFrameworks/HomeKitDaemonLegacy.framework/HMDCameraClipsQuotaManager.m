...
- (id)fetchNamesForZonesWithEnabledCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Sending get active cameras message %@", buf, 0x16u);
...
- (id)enableCloudStorageForZoneWithName:(id)a3
{
  ...
  v6 = (void *)MEMORY[0x1D17BA0A0](-[HMDCameraClipsQuotaEnableCameraMessage setZoneName:](v5, "setZoneName:", v4));
  v7 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v18 = 2112;
    v19 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending enable camera message %@ for zone with name %@", buf, 0x20u);
...
- (id)disableCloudStorageForZoneWithName:(id)a3
{
  ...
  v6 = (void *)MEMORY[0x1D17BA0A0](-[HMDCameraClipsQuotaDisableCameraMessage setZoneName:](v5, "setZoneName:", v4));
  v7 = self;
  HMFGetOSLogHandle();
  v8 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v21 = 2112;
    v22 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending disable camera message %@ for zone with name %@", buf, 0x20u);
...
- (id)database:(id)a3 willRemoveZoneWithName:(id)a4 isPrivate:(BOOL)a5
{
  ...
  if (objc_msgSend(v9, "hasPrefix:", CFSTR("camera-clips-")) && a5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v9;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Disabling cloud storage before removing zone with name %@", (uint8_t *)&v17, 0x16u);
...
id __65__HMDCameraClipsQuotaManager_disableCloudStorageForZoneWithName___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully disabled camera with response: %@", (uint8_t *)&v10, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v9;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Assuming success for disable camera request because zone does not exist", (uint8_t *)&v13, 0xCu);
...
id __64__HMDCameraClipsQuotaManager_enableCloudStorageForZoneWithName___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully enabled camera with response: %@", (uint8_t *)&v10, 0x16u);
...
id __71__HMDCameraClipsQuotaManager_fetchNamesForZonesWithEnabledCloudStorage__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = (uint64_t)v9;
      _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully got active cameras with zone names: %@", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v3;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Received get active cameras response of unexpected type %@: %@", (uint8_t *)&v23, 0x20u);
...
void __41__HMDCameraClipsQuotaManager_synchronize__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    v11 = 138543362;
    v12 = v10;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Finished initial cloud sync for camera clips quota manager cloud database", (uint8_t *)&v11, 0xCu);
...
+ (id)_quotaErrorFromServerError:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Determining quota error based on underlying quota server error: %@", (uint8_t *)&v14, 0x16u);
  ...
  objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("HMDCameraClipsQuotaErrorDomain"), v11, 0);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15 != -1)
    dispatch_once(&logCategory__hmf_once_t15, &__block_literal_global_40689);
