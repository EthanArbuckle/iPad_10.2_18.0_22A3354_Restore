...
- (HMDSecureRemoteSession)initWithDevice:(id)a3 deviceMonitor:(id)a4 accountRegistry:(id)a5
{
  ...
  id v9;
  id v10;
  HMDSecureRemoteSessionDefaultDataSource *v11;
  ...
  v12 = -[HMDSecureRemoteSession initWithDevice:deviceMonitor:accountRegistry:dataSource:](self, "initWithDevice:deviceMonitor:accountRegistry:dataSource:", v10, v9, v8, v11);
...
LABEL_13:
    _os_log_impl(&dword_1CD062000, v30, OS_LOG_TYPE_DEFAULT, v32, buf, 0xCu);
...
LABEL_14:
  ...
  v15 = -[HMDSecureRemoteSession init](&v34, sel_init);
  v16 = v15;
  if (v15)
  {
    ...
    objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", -[HMDSecureRemoteSession maximumRemoteStreams](v16, "maximumRemoteStreams"));
...
- (void)dealloc
{
  ...
  if (self->_state)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v9 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_ERROR, "%{public}@Secure Remote Session abandoned without being closed", buf, 0xCu);
...
- (void)_closeWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v55 = 2112;
    v56 = v34;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Closed with error: %@", buf, 0x16u);
  ...
  if (objc_msgSend(v9, "conformsToProtocol:", &unk_1EFB0FC08))
    v10 = v9;
  else
    v10 = 0;
  v35 = v10;
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
    objc_msgSend(v35, "secureRemoteSession:didCloseWithError:", v6, v34);
  os_unfair_lock_lock_with_options();
  ...
  v33 = (void *)-[NSMutableArray copy](v6->_clientStreams, "copy");
  -[NSMutableArray removeAllObjects](v6->_clientStreams, "removeAllObjects");
  v32 = (void *)-[NSMutableArray copy](v6->_serverStreams, "copy");
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v46 + 1) + 8 * i), "message");
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v55 = 2114;
          v56 = v15;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Cancelling queued message: %{public}@", buf, 0x16u);
        ...
        if (v20)
        {
          ...
          ((void (**)(_QWORD, id, _QWORD))v21)[2](v21, v37, 0);
  ...
  if (v23)
  {
    ...
    do
    {
      for (j = 0; j != v23; ++j)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v42 + 1) + 8 * j), "stop");
      }
      v23 = objc_msgSend(v22, "countByEnumeratingWithState:objects:count:", &v42, v51, 16);
    }
    while (v23);
  ...
  if (v27)
  {
    ...
    do
    {
      for (k = 0; k != v27; ++k)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v38 + 1) + 8 * k), "stop");
      }
      v27 = objc_msgSend(v26, "countByEnumeratingWithState:objects:count:", &v38, v50, 16);
    }
    while (v27);
  ...
  objc_msgSend(v30, "removeObserver:name:object:", v6, CFSTR("HMDRemoteDeviceIsReachableNotification"), 0);

  objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
  v31 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v31, "removeObserver:name:object:", v6, CFSTR("HMDRemoteDeviceIsNotReachableNotification"), 0);
...
- (void)_queueMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Queueing message: %@", buf, 0x16u);
  ...
  *(_QWORD *)&buf[16] = 0x2020000000;
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v34 = 138543874;
    ...
    v38 = 2048;
    v39 = v22;
    _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Message, %@, queued at position %tu", v34, 0x20u);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)v34 = 138543618;
    ...
    v36 = 2112;
    v37 = v27;
    _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Queued messages: %@", v34, 0x16u);
...
- (id)_dequeMessage
{
  ...
  if (!-[HMDSecureRemoteSession isReachable](self, "isReachable"))
    return 0;
  os_unfair_lock_lock_with_options();
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Dequeuing message: %@", (uint8_t *)&v12, 0x16u);
...
- (void)_handleSecureClientMessage:(id)a3 fromDevice:(id)a4 transport:(id)a5
{
  ...
  objc_msgSend(v13, "stringWithFormat:", CFSTR("%@, %s:%ld"), v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Messaging/Remote/Secure/HMDSecureRemoteSession.m", 624);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v22;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Stream not found: %@", buf, 0x16u);
...
- (void)_handleStreamInvalidationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v46 = 2112;
    v47 = v5;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Received invalidation message for stream %@", buf, 0x16u);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v10;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Closing stream due to remote invalidation: %@", buf, 0x16u);
          ...
          if ((v24 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v46 = 2112;
              v47 = v21;
              _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Closing inactive stream due to remote invalidation: %@", buf, 0x16u);
...
- (void)_openClientStreamWithCompletionHandler:(id)a3
{
  ...
  if (v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v12;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Opening client stream", buf, 0xCu);
          ...
          if (objc_msgSend(*(id *)(*((_QWORD *)&v33 + 1) + 8 * i), "qualityOfService") == 9)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v39 = 2112;
              v40 = v26;
              _os_log_impl(&dword_1CD062000, v24, OS_LOG_TYPE_INFO, "%{public}@Setting QoS to %@ for client stream", buf, 0x16u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v38 = v21;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Cannot open additional streams", buf, 0xCu);
...
- (void)_closeClientStream:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v38 = 2112;
    v39 = v7;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Client stream stopped due to error %@", buf, 0x16u);
  ...
  if (objc_msgSend(v8, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v16;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Last client stream closed, attempting to open a new client stream", buf, 0xCu);
...
LABEL_7:
    ...
    v30[3] = &unk_1E89AAD18;
    v30[4] = v10;
    -[HMDSecureRemoteSession _openClientStreamWithCompletionHandler:](v10, "_openClientStreamWithCompletionHandler:", v30);
    goto LABEL_21;
  }
  if (objc_msgSend(v6, "qualityOfService") == 9)
  {
    ...
    if (v18)
    {
      ...
      while (2)
      {
        ...
        do
        {
          if (*(_QWORD *)v32 != v19)
            objc_enumerationMutation(v17);
          if (objc_msgSend(*(id *)(*((_QWORD *)&v31 + 1) + 8 * v20), "qualityOfService") == 9)
          {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v21;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Last background client stream closed, attempting to open a new client stream", buf, 0xCu);
    ...
    if ((objc_msgSend(v22, "isEqualToString:", *MEMORY[0x1E0CB2F90]) & 1) != 0)
    {
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v37 = v27;
          _os_log_impl(&dword_1CD062000, v26, OS_LOG_TYPE_INFO, "%{public}@Confirming the remote device is reachable due to stream error", buf, 0xCu);

        }
        objc_autoreleasePoolPop(v24);
        -[HMDSecureRemoteSession deviceMonitor](v25, "deviceMonitor");
        v28 = (void *)objc_claimAutoreleasedReturnValue();
        -[HMDSecureRemoteSession device](v25, "device");
        v29 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v28, "confirmDevice:forClient:timeout:completionHandler:", v29, v25, 0, 0.0);
...
- (void)_openServerStreamWithIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  {
    objc_msgSend(v9, "sortUsingComparator:", &__block_literal_global_47291);
...
- (void)_closeServerStream:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v43 = 2112;
    v44 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Server stream stopped due to error %@", buf, 0x16u);

  }
  objc_autoreleasePoolPop(v8);
  -[HMFMessageTransport delegate](v9, "delegate");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v12, "conformsToProtocol:", &unk_1EFB0FC08))
    v13 = v12;
  else
    v13 = 0;
  v33 = v13;
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    objc_msgSend(v7, "domain");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    if (!objc_msgSend(v14, "isEqualToString:", *MEMORY[0x1E0CB2F90]))
    {
LABEL_18:
    ...
    if (!v15)
    {
      objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", -[HMDSecureRemoteSession maximumRemoteStreams](v9, "maximumRemoteStreams"));
      v14 = (void *)objc_claimAutoreleasedReturnValue();
      v36 = 0u;
      v37 = 0u;
      v34 = 0u;
...
- (void)secureRemoteStream:(id)a3 receivedRequestToSendMessage:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v8, "conformsToProtocol:", &unk_1EFB0FC08))
    v9 = v8;
  else
    v9 = 0;
  v10 = v9;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Cannot send message, no delegate: %@", (uint8_t *)&v18, 0x16u);
...
- (void)messageTransport:(id)a3 didReceiveMessage:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Cannot send message, no delegate: %@", (uint8_t *)&v16, 0x16u);
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v14;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Queued message timed out: %@", buf, 0x16u);
...
void __35__HMDSecureRemoteSession_dumpState__block_invoke(uint64_t a1)
{
  ...
  v45 = *MEMORY[0x1E0C80C00];
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("%tu"), objc_msgSend(*(id *)(a1 + 40), "maximumRemoteStreams"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
void __51__HMDSecureRemoteSession_secureRemoteStreamIsIdle___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_INFO, "%{public}@Stream is idle: %@", (uint8_t *)&v12, 0x16u);
...
void __76__HMDSecureRemoteSession__openServerStreamWithIdentifier_completionHandler___block_invoke_3(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v7;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Failed to start server stream due to error: %@", (uint8_t *)&v11, 0x16u);
...
void __51__HMDSecureRemoteSession__closeClientStream_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to open primary stream, closing session", (uint8_t *)&v11, 0xCu);
...
void __65__HMDSecureRemoteSession__openClientStreamWithCompletionHandler___block_invoke_2(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to start client stream due to error: %@", (uint8_t *)&v27, 0x16u);
    ...
    {
      v11 = objc_msgSend(*(id *)(a1 + 32), "code") == -6722;
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        v27 = 138543362;
        v28 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, "%{public}@Confirming the remote device is reachable", (uint8_t *)&v27, 0xCu);

      }
      objc_autoreleasePoolPop(v12);
      objc_msgSend(*(id *)(a1 + 40), "deviceMonitor");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(*(id *)(a1 + 40), "device");
      v16 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v10, "confirmDevice:forClient:timeout:completionHandler:", v16, *(_QWORD *)(a1 + 40), 0, 0.0);
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = 2112;
      v30 = v3;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_INFO, "%{public}@Opened client stream: %@", (uint8_t *)&v27, 0x16u);
    ...
    if (v24 != -1)
    {
      ...
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      if (v10)
        objc_msgSend(v3, "sendMessage:completionHandler:", v10, 0);
LABEL_19:
...
uint64_t __53__HMDSecureRemoteSession_handleDeviceIsNotReachable___block_invoke(uint64_t a1)
{
  ...
  result = objc_msgSend(*(id *)(a1 + 32), "isReachable");
  if ((_DWORD)result)
  {
    v3 = (void *)MEMORY[0x1D17BA0A0]();
    v4 = *(id *)(a1 + 32);
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v7 = 138543362;
      v8 = v6;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification device is no longer reachable", (uint8_t *)&v7, 0xCu);

    }
    objc_autoreleasePoolPop(v3);
    return objc_msgSend(*(id *)(a1 + 32), "setReachable:", 0);
  }
  return result;
}
...
void __50__HMDSecureRemoteSession_handleDeviceIsReachable___block_invoke(uint64_t a1)
{
  ...
  if ((objc_msgSend(*(id *)(a1 + 32), "isReachable") & 1) == 0)
  {
    v2 = (void *)MEMORY[0x1D17BA0A0]();
    v3 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v5;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification device is reachable", buf, 0xCu);
    ...
    v20 = 0u;
    v21 = 0u;
    objc_msgSend(*(id *)(a1 + 32), "clientStreams", 0);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      do
      {
        for (i = 0; i != v8; ++i)
        {
          ...
          if (objc_msgSend(v11, "isOpen"))
          {
            ...
            v14 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v14, "qualityOfService");
            objc_msgSend(v11, "qualityOfService");
    ...
    if (v18)
    {
      for (j = 0; j != v18; ++j)
      {
        if (j >= objc_msgSend(*(id *)(a1 + 32), "maximumRemoteStreams"))
          break;
        objc_msgSend(*(id *)(a1 + 32), "_openClientStreamWithCompletionHandler:", 0);
      }
    }
  }
}
...
void __56__HMDSecureRemoteSession_sendMessage_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (objc_msgSend(*(id *)(a1 + 40), "state"))
  {
    ...
    if (!v3)
    {
      ...
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "setIdentifier:", v7);

      objc_msgSend(*(id *)(a1 + 48), "responseHandler");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v18, "setResponseHandler:", v8);

    }
    objc_msgSend(*(id *)(a1 + 40), "_clientStreamForMessage:", v18);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    if (v9 && objc_msgSend(*(id *)(a1 + 40), "isReachable"))
    {
      objc_msgSend(v9, "sendMessage:completionHandler:", v18, *(_QWORD *)(a1 + 56));
    }
    else
    {
      objc_msgSend(*(id *)(a1 + 40), "_queueMessage:", v18);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot send message on closed session: %@", buf, 0x16u);
...
void __52__HMDSecureRemoteSession_openWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v7;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Session already opened", buf, 0xCu);
  ...
  else
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v9;
      _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Opening", buf, 0xCu);
    ...
    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "addObserver:selector:name:object:", *(_QWORD *)(a1 + 32), sel_handleDeviceIsReachable_, CFSTR("HMDRemoteDeviceIsReachableNotification"), 0);

    objc_msgSend(MEMORY[0x1E0CB37D0], "defaultCenter");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "addObserver:selector:name:object:", *(_QWORD *)(a1 + 32), sel_handleDeviceIsNotReachable_, CFSTR("HMDRemoteDeviceIsNotReachableNotification"), 0);

    objc_msgSend(*(id *)(a1 + 32), "deviceMonitor");
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v12, "unreachableDevices");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(*(id *)(a1 + 32), "device");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = objc_msgSend(v13, "containsObject:", v14);

    objc_msgSend(*(id *)(a1 + 32), "setReachable:", v15 ^ 1u);
    v17[0] = MEMORY[0x1E0C809B0];
    v17[1] = 3221225472;
    v17[2] = __52__HMDSecureRemoteSession_openWithCompletionHandler___block_invoke_100;
    v17[3] = &unk_1E89AAC78;
    v16 = *(void **)(a1 + 40);
    v18 = *(id *)(a1 + 32);
    v19 = v16;
    objc_msgSend(v18, "_openClientStreamWithCompletionHandler:", v17);

  }
}

void __52__HMDSecureRemoteSession_openWithCompletionHandler___block_invoke_100(uint64_t a1, void *a2, void *a3)
{
  id v5;
  id v6;
  void *v7;
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      v23 = 138543362;
      v24 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Opened", (uint8_t *)&v23, 0xCu);
    ...
    if (v12)
    {
      ...
      if (v14 != objc_msgSend(*(id *)(a1 + 32), "maximumRemoteStreams"))
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          v25 = 2048;
          v26 = v14;
          _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@Upgrading number of streams to '%tu'", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    if (v10)
    {
      ...
      v25 = 2112;
      v26 = (unint64_t)v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to open initial client stream with error: %@", (uint8_t *)&v23, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t61 != -1)
    dispatch_once(&logCategory__hmf_once_t61, &__block_literal_global_142);
