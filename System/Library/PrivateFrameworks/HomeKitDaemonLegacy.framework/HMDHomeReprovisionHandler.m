...
- (void)configure:(id)a3 queue:(id)a4 messageDispatcher:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(_QWORD *)&buf[14] = v15;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Configured reprovision handler for home %@", buf, 0x16u);
...
- (void)_handleRequestSearchForAccessoriesNeedingReprovisioning:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v37 = v8;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Received request to start searching for accessories need reprovisioning", buf, 0xCu);
  ...
  if (v6 && v6->_reprovisionBrowsingAllowed)
  {
    ...
    if (!v6->_disableReprovisionBrowsingTimer)
    {
      ...
      v14 = (void *)MEMORY[0x1D17BA0A0](-[HMFTimer resume](v6->_disableReprovisionBrowsingTimer, "resume"));
      v15 = v6;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Started disable reprovision browsing timer %p for %f sec", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v22;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_INFO, "%{public}@Request to start searching for accessories need reprovisioning is deferred", buf, 0xCu);
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v85 = 2112;
        v86 = v34;
        _os_log_impl(&dword_1CD062000, v32, OS_LOG_TYPE_ERROR, "%{public}@Missing target accessory UUID from message payload: %@", buf, 0x16u);
    ...
    if (v10)
    {
      if ((objc_msgSend(v10, "reachableTransports") & 1) != 0)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v85 = 2112;
          v86 = v47;
          _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Reprovision accessory failed since the accessory: %@ is already in the network", buf, 0x16u);
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v85 = 2112;
          v86 = v52;
          _os_log_impl(&dword_1CD062000, v50, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to NotRequired", buf, 0x16u);
        ...
        objc_msgSend(v19, "setObject:forKeyedSubscript:", &unk_1E8B333F0, *MEMORY[0x1E0CBAA80]);
        v56 = (void *)MEMORY[0x1E0D285F8];
        v57 = *MEMORY[0x1E0CBAA70];
        ...
        if (v60)
        {
          objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 52, CFSTR("Accessory already in the network"), 0, 0, 0);
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v85 = 2112;
          v86 = v17;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to InProgress", buf, 0x16u);
        ...
        objc_msgSend(v19, "setObject:forKeyedSubscript:", &unk_1E8B33408, *MEMORY[0x1E0CBAA80]);
        v22 = (void *)MEMORY[0x1E0D285F8];
        v23 = *MEMORY[0x1E0CBAA70];
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v85 = 2112;
        v86 = v66;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Reprovision accessory failed since the accessory: %@ is not paired", buf, 0x16u);
      ...
      if (!v67)
        goto LABEL_42;
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:underlyingError:", 10, CFSTR("Accessory not paired"), 0, 0, 0);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v85 = 2112;
        v86 = v5;
        _os_log_impl(&dword_1CD062000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to find accessory with UUID: %@", buf, 0x16u);
...
- (void)handleFoundAccessoryNeedingReprovisioning:(id)a3 error:(id)a4
{
  ...
  if (!objc_msgSend(v6, "accessoryReprovisionState"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to Required", (uint8_t *)&v16, 0x16u);
...
LABEL_10:
  ...
  if (self->_disableReprovisionBrowsingTimer == v16)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v8;
      _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Disable reprovision browsing timer fired", buf, 0xCu);
    ...
    if (v6->_reprovisionBrowsingPending)
    {
      ...
      v10 = (void *)MEMORY[0x1D17BA0A0](-[HMFTimer resume](v6->_disableReprovisionBrowsingTimer, "resume"));
      v11 = v6;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@Resumed disable reprovision browsing timer %p for %f sec", buf, 0x20u);
...
- (void)_reportAccessoryNeedingReprovision:(void *)a3 error:
{
  ...
  if (a1)
  {
    ...
    objc_msgSend(v8, "setObject:forKeyedSubscript:", &unk_1E8B33420, *MEMORY[0x1E0CBAA80]);
    if (v16)
    {
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v33 = 2112;
      v34 = v13;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Storing reprovison request message identifier for accessory with identifier: %@", buf, 0x16u);
...
void __57__HMDHomeReprovisionHandler__handleReprovisionAccessory___block_invoke_2(uint64_t a1)
{
  ...
  if (*(_QWORD *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v7;
      _os_log_impl(&dword_1CD062000, v4, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate WiFi credential for accessory %@ with error: %@", (uint8_t *)&v8, 0x20u);
  ...
  if (v5)
  {
    if (v3)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        v38 = 2112;
        v39 = v10;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to reprovision accessory with identifier: %@", (uint8_t *)&v36, 0x16u);
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v38 = 2112;
        v39 = v19;
        _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to NotRequired", (uint8_t *)&v36, 0x16u);
      ...
      objc_msgSend(v27, "setObject:forKeyedSubscript:", &unk_1E8B33408, *MEMORY[0x1E0CBAA80]);
      v30 = (void *)MEMORY[0x1E0D285F8];
      v31 = *MEMORY[0x1E0CBAA70];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_82349 != -1)
    dispatch_once(&logCategory__hmf_once_t1_82349, &__block_literal_global_82350);
  return (id)logCategory__hmf_once_v2_82351;
}
...
void __40__HMDHomeReprovisionHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_82351;
  logCategory__hmf_once_v2_82351 = v0;
