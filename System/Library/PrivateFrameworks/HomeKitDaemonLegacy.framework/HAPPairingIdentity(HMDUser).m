...
- (id)hmd_dictionaryEncoding
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", objc_msgSend(a1, "permissions"));
...
+ (id)hmd_pairingIdentityWithDictionary:()HMDUser
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (v5)
    v6 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28658]), "initWithPairingKeyData:", v5);
  else
    v6 = 0;
  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("HAP.publicKey"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
    v8 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D28658]), "initWithPairingKeyData:", v7);
  else
    v8 = 0;
  objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("HAP.permissions"));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D165A8]), "initWithIdentifier:publicKey:privateKey:permissions:", v4, v8, v6, objc_msgSend(v9, "integerValue"));
