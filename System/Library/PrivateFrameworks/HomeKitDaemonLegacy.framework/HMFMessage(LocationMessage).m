...
+ (id)locationAuthorizedMessageWithName:()LocationMessage messagePayload:
{
  ...
  objc_msgSend(MEMORY[0x1E0D285F8], "messageWithName:messagePayload:");
  v0 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "setUserInfoValue:forKey:", MEMORY[0x1E0C9AAB0], CFSTR("locationAuthorized"));
...
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:()LocationMessage target:messagePayload:
{
  ...
  objc_msgSend(v9, "setUserInfoValue:forKey:", MEMORY[0x1E0C9AAB0], CFSTR("locationAuthorized"));
  objc_msgSend(v9, "setUserInfoValue:forKey:", v10, CFSTR("HMDMessageRequiresHomeLocationEntitlement"));
  v11 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285D8]), "initWithTarget:", v8);
