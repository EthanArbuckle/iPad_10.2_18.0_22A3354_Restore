...
- (void)activateWithCompletion:(id)a3
{
    ...
    if (self->_activateState)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v16;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Activate called more than once.", buf, 0xCu);
      ...
      if (self->_activateState)
      {
        objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", -1, CFSTR("Unexpected error."), CFSTR("Activate called more than once."), 0);
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v23 = 2112;
    v24 = v11;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Activating client for destination: %@", buf, 0x16u);
    ...
    else
    {
      if (activateState != 2)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
        {
          ...
          v24 = 138543362;
          v25 = v21;
          _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: State is not activated.", (uint8_t *)&v24, 0xCu);
...
- (void)_queueRequestID:(id)a3 request:(id)a4 options:(id)a5 responseHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v36 = 2112;
    v37 = v20;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Queuing request to device: %@", buf, 0x16u);
  ...
  if ((-[NSMutableArray hmf_isEmpty](requestQueue, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v34 = 2112;
      v35 = v4;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Completing %lu queued request(s) to device: %@, with error: %@", buf, 0x2Au);
...
void __56__HMDRapportDeviceClientWrapper_activateWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmInternalErrorWithCode:underlyingError:", 3203, v3);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_163791 != -1)
    dispatch_once(&logCategory__hmf_once_t5_163791, &__block_literal_global_163792);
  return (id)logCategory__hmf_once_v6_163793;
}
...
void __44__HMDRapportDeviceClientWrapper_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_163793;
  logCategory__hmf_once_v6_163793 = v0;
