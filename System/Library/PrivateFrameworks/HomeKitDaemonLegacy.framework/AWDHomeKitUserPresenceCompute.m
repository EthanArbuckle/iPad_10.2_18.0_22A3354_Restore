@implementation AWDHomeKitUserPresenceCompute
...
- (void)setCompute:(int)a3
{
  *(_BYTE *)&self->_has |= 2u;
  self->_compute = a3;
}

- (void)setHasCompute:(BOOL)a3
{
  char v3;
...
- (id)computeAsString:(int)a3
{
  if (a3 < 5)
    return off_1E89A3850[a3];
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), *(_QWORD *)&a3);
  return (id)objc_claimAutoreleasedReturnValue();
}

- (int)StringAsCompute:(id)a3
{
  id v3;
  int v4;
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDHomeKitUserPresenceCompute;
  -[AWDHomeKitUserPresenceCompute description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[AWDHomeKitUserPresenceCompute dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    if (compute >= 5)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_compute);
      v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v7 = off_1E89A3850[compute];
    }
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("compute"));
...
LABEL_11:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 2) == 0 || self->_compute != *((_DWORD *)v4 + 4))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
