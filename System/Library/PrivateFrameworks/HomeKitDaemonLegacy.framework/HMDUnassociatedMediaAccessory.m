...
- (HMDUnassociatedMediaAccessory)initWithIdentifier:(id)a3 name:(id)a4 category:(id)a5 messageDispatcher:(id)a6
{
  ...
  if (!v12)
  {
    ...
    v16 = (void *)objc_msgSend(v15, "initWithUUIDString:", *MEMORY[0x1E0CB7AA8]);
...
- (BOOL)isHAPAirPlay2Accessory
{
  ...
  if (v4)
  {
    ...
    v6 = MEMORY[0x1D17B91DC](objc_msgSend(v5, "outputDevice"));
...
- (id)dumpDescription
{
  ...
  objc_msgSend(v3, "setObject:forKey:", v10, *MEMORY[0x1E0D27F80]);
  return v3;
}
  ...
  if (v13)
  {
    ...
    if (!v15)
    {
      ...
      if ((v19 & 1) == 0)
      {
        ...
        v22 = objc_msgSend(v21, "isEqualToString:", *MEMORY[0x1E0CB7A58]);
          ...
          if (v35)
          {
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              v48 = 2112;
              v49 = v40;
              _os_log_impl(&dword_1CD062000, v38, OS_LOG_TYPE_INFO, "%{public}@Populating configuredName with providedName: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_46594 != -1)
    dispatch_once(&logCategory__hmf_once_t4_46594, &__block_literal_global_46595);
  return (id)logCategory__hmf_once_v5_46596;
}
...
void __44__HMDUnassociatedMediaAccessory_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_46596;
  logCategory__hmf_once_v5_46596 = v0;
