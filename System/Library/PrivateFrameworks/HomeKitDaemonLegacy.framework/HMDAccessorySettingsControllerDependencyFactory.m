...
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x1E0D286C8]), "initWithTimeInterval:options:", 16, a4);
}
...
- (id)createMessageHandlerWithQueue:(id)a3 delegate:(id)a4
{
  id v5;
  id v6;
  HMDAccessorySettingsMessageHandler *v7;

  v5 = a4;
  v6 = a3;
  v7 = -[HMDAccessorySettingsMessageHandler initWithQueue:delegate:]([HMDAccessorySettingsMessageHandler alloc], "initWithQueue:delegate:", v6, v5);
  ...
  if (!a3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v15 = 2112;
      v16 = v6;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@", buf, 0x16u);
