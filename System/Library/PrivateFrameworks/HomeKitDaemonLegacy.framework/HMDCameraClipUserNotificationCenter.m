...
- (id)bulletinForClipSignificantEvent:(id)a3 cameraProfile:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (v43)
    {
      ...
      if (!objc_msgSend(v12, "count"))
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v46 = 2112;
          v47 = v17;
          _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find any significant events for clip with UUID %@", buf, 0x16u);
      ...
      objc_msgSend(v19, "sortedArrayUsingComparator:", &__block_literal_global_162545);
      ...
      LOBYTE(v23) = objc_msgSend(v12, "na_allObjectsPassTest:", &__block_literal_global_3_162546);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v46 = 2112;
        v47 = v9;
        _os_log_impl(&dword_1CD062000, v35, OS_LOG_TYPE_INFO, "%{public}@Could not create a bulletin for clip significant event because the home is nil for accessory: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v46 = 2112;
      v47 = v7;
      _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_INFO, "%{public}@Could not create a bulletin for clip significant event because the accessory is nil for camera profile: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Fetching hero frame URL to post notification for significant event: %@", buf, 0x16u);
...
- (void)removeEventNotificationForClipWithUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Removing bulletin for clip with UUID: %@", (uint8_t *)&v12, 0x16u);
...
- (void)removeEventNotificationsForCameraProfile:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v4;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing camera clip bulletins for camera profile: %@", (uint8_t *)&v11, 0x16u);
...
- (void)_insertClipSignificantEventBulletin:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v11;
    _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_INFO, "%{public}@Inserting bulletin with clip significant events: %@ hero frame URL: %@", (uint8_t *)&v13, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v34 = 2112;
        v35 = v17;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to write hero frame data to %@ error: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v34 = 2112;
      v35 = v10;
      _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create hero frame directory at URL %@: %@", buf, 0x20u);
...
void __84__HMDCameraClipUserNotificationCenter_postNotificationForBulletin_significantEvent___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_INFO, v13, (uint8_t *)&v20, v15);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_162554 != -1)
    dispatch_once(&logCategory__hmf_once_t11_162554, &__block_literal_global_9_162555);
  return (id)logCategory__hmf_once_v12_162556;
}
...
void __50__HMDCameraClipUserNotificationCenter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_162556;
  logCategory__hmf_once_v12_162556 = v0;
