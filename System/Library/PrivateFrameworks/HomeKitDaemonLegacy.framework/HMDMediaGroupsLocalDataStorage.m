...
- (void)updateUsingParticipantAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4 backedUpGroupData:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v15;
    _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating using participant accessory uuid: %@ associated group identifier: %@ backup data count: %@", (uint8_t *)&v23, 0x2Au);

  }
  objc_autoreleasePoolPop(v11);
  objc_msgSend(MEMORY[0x1E0CBA618], "groupsWithProtoBufferData:", v10);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v16;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Failed to decode all encoded groups of count: %@ decoded groups: %@", (uint8_t *)&v23, 0x20u);
...
- (void)updateGroup:(id)a3 participantAccessoryUUIDs:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    v24 = 2112;
    v25 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating using group: %@ participant accessory uuids: %@", buf, 0x20u);
...
- (id)backupGroupsForParticipantAccessoryUUID:(id)a3
{
  ...
  objc_msgSend(v5, "na_map:", &__block_literal_global_80354);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v21 = 2112;
      v22 = v9;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to find associated group with identifier: %@", buf, 0x16u);
...
- (void)unsetParticipantAccessoryUUIDsWithAssociatedGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v15 = 2112;
    v16 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Unsetting participant accessory uuids with associated group identifier: %@", buf, 0x16u);
...
- (void)setParticipantAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v7;
    _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Setting participant accessory uuid: %@ associated group identifier: %@", (uint8_t *)&v14, 0x20u);
...
- (void)addBackedUpGroup:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      if (v12)
      {
        ...
        v21 = 2112;
        v22 = v4;
        _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Already added backed up group: %@", (uint8_t *)&v19, 0x16u);
    ...
    else if (v12)
    {
      ...
      v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Dropping backed up group: %@ existing group: %@", (uint8_t *)&v19, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Added backed up group: %@", (uint8_t *)&v19, 0x16u);
...
- (void)updateGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Update group: %@", (uint8_t *)&v12, 0x16u);
...
- (void)removeGroupWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2112;
    v12 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@Remove group with identifier: %@", (uint8_t *)&v9, 0x16u);
...
- (id)routerForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to get router for participant accessory UUID: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
- (id)receiverForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to get reciever for participant accessory UUID: %@ due to no data source", (uint8_t *)&v13, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_80366 != -1)
    dispatch_once(&logCategory__hmf_once_t24_80366, &__block_literal_global_10_80367);
  return (id)logCategory__hmf_once_v25_80368;
}
...
void __45__HMDMediaGroupsLocalDataStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_80368;
  logCategory__hmf_once_v25_80368 = v0;
