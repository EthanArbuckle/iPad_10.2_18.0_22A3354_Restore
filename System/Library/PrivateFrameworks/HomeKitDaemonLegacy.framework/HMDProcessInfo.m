  ...
  if (v6 && -[HMDProcessInfo shouldMonitor](v5, "shouldMonitor"))
  {
    ...
    switch(objc_msgSend(v7, "taskState"))
    {
      ...
      case 4u:
        ...
        v8 = (void *)objc_claimAutoreleasedReturnValue();
        v9 = objc_msgSend(v8, "containsObject:", *MEMORY[0x1E0D22E58]);
        ...
        *(_QWORD *)&buf[16] = 0x3032000000;
        v37 = __Block_byref_object_copy__159642;
        v38 = __Block_byref_object_dispose__159643;
        v39 = 0;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(_QWORD *)&buf[14] = v17;
            _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_INFO, "%{public}@Upgrading app state to foreground with reason: %@", buf, 0x16u);
...
LABEL_21:
        ...
        v24 = objc_msgSend(v23, "na_any:", &__block_literal_global_193);
        ...
        v26 = objc_msgSend(v25, "isEqualToString:", *MEMORY[0x1E0CB9608]);
...
LABEL_26:
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(_QWORD *)&buf[14] = v7;
          _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@Upgrading app state to foreground as the client (%@) has SPI access and is background running", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      if (a3 > 4)
        ...
        v11 = off_1E89B7558[a3];
      v12 = v11;
      *(_DWORD *)buf = 138543618;
      v20 = v10;
      v21 = 2114;
      v22 = v12;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Updated state to: %{public}@", buf, 0x16u);
...
- (id)clientIdentifierSalt:(id *)a3
{
  ...
  else
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB35C8], "hmErrorWithCode:description:reason:suggestion:", 48, 0, CFSTR("Cannot generate client identifier for non-application process."), 0);
      v5 = 0;
...
+ (NSData)privateClientIdentifierSalt
{
  if (privateClientIdentifierSalt_onceToken != -1)
    dispatch_once(&privateClientIdentifierSalt_onceToken, &__block_literal_global_159695);
    ...
    if (v5 > 0xA)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        v10 = (void *)v18;
        _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Process '%@' has > 10 active connections to homed which may indicate an issue", buf, 0x16u);
...
- (HMDProcessInfo)initWithIdentifier:(int)a3
{
  ...
  if (v4)
  {
    ...
    objc_msgSend(MEMORY[0x1E0D87D70], "identifierWithPid:", v3);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    v19 = 0;
    ...
    if (!v5->_processHandle)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v25 = 2112;
        v26 = v11;
        _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine process handle from pid %@: %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_159688 != -1)
    dispatch_once(&logCategory__hmf_once_t15_159688, &__block_literal_global_48_159689);
  return (id)logCategory__hmf_once_v16_159690;
}
...
+ (id)locationAuthorizationFromEffectiveBundleIdentifier:(id)a3 processInfo:(id)a4
{
  ...
  {
    v8 = (void *)v7;
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285B8]), "initWithBundle:", v7);

  }
  else if (v5)
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D285B8]), "initWithBundleIdentifier:", v5);
  }
  else
  {
    v9 = 0;
...
void __29__HMDProcessInfo_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_159690;
  logCategory__hmf_once_v16_159690 = v0;
...
void __45__HMDProcessInfo_privateClientIdentifierSalt__block_invoke()
{
  ...
  v5 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("FDAF31D2-4895-48A8-BE45-04B4E974F0CD"));
