...
- (void)submitLogEventForTask:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 2112;
    v20 = v13;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Submitting log %@ with identifier %@", (uint8_t *)&v15, 0x20u);
...
- (void)submitNotFiredLogEventForTask:(id)a3
{
  ...
  if (v8 != 1)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v22 = 2112;
      v23 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Submitting never fired log %@ with identifier %@", (uint8_t *)&v18, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_150312 != -1)
    dispatch_once(&logCategory__hmf_once_t2_150312, &__block_literal_global_150313);
  return (id)logCategory__hmf_once_v3_150314;
}
...
void __38__HMDBackgroundTaskLogger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_150314;
  logCategory__hmf_once_v3_150314 = v0;
