...
LABEL_11:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v21 = v13;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_ERROR, "%{public}@A proxy service is required", buf, 0xCu);
  ...
  if (v8)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        v23 = 2112;
        v24 = v10;
        _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Replacing device destination, %@, with device: %@", (uint8_t *)&v19, 0x20u);
...
LABEL_15:
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      v24 = 2112;
      v25 = v20;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message, the device, %@, is not currently connected", (uint8_t *)&v22, 0x16u);
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v24 = 2112;
      v25 = v16;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message, the device, %@, is not supported", (uint8_t *)&v22, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v25 = 2112;
    v26 = v18;
    _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Dropping incoming message from unsupported device: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_170518 != -1)
    dispatch_once(&logCategory__hmf_once_t3_170518, &__block_literal_global_170519);
  return (id)logCategory__hmf_once_v4_170520;
}
...
void __42__HMDIDSProxyMessageTransport_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_170520;
  logCategory__hmf_once_v4_170520 = v0;
