...
LABEL_9:
          ...
          if (v14)
          {
            v15 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3A28]), "initWithUUIDString:", CFSTR("5FA86C71-D9DE-4FE8-80BB-823164245F58"));
            objc_msgSend(MEMORY[0x1E0CB3A28], "hmf_UUIDWithNamespace:data:", v15, v14);
            v5 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)configurationWithClientIdentifier:(id)a3 lanIdentifier:(int64_t)a4
{
  ...
  if (v5)
  {
    v7 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D16610]), "initWithValue:", v5);
    ...
    while (1)
    {
      ...
      switch(v36)
      {
        case 1:
          ...
          v31 = v10;
          v17 = &v31;
          objc_msgSend(MEMORY[0x1E0D16610], "parsedFromData:error:", v16, &v31);
          v18 = (void *)v26;
        ...
        case 3:
          ...
          v30 = v10;
          v17 = &v30;
          objc_msgSend(MEMORY[0x1E0D16610], "parsedFromData:error:", v16, &v30);
          v18 = v14;
          v14 = (void *)objc_claimAutoreleasedReturnValue();
          goto LABEL_14;
        case 4:
