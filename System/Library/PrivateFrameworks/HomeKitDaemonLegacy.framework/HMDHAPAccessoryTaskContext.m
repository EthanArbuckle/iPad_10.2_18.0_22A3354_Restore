...
- (HMDHAPAccessoryTaskContext)initWithIdentifier:(id)a3 operationType:(int64_t)a4 home:(id)a5 sourceType:(unint64_t)a6 requestMessage:(id)a7 name:(id)a8
{
  ...
  if (v19)
  {
    ...
    v21 = objc_msgSend(objc_alloc(MEMORY[0x1E0D28540]), "initWithName:", v18);
...
- (id)residentMapForAccessories:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "sortedArrayUsingComparator:", &__block_literal_global_180253);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  -[HMDHAPAccessoryTaskContext home](self, "home");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "balancedResidentMapForAccessories:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
