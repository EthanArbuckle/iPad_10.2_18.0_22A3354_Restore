...
+ (id)logCategory
{
  if (logCategory__hmf_once_t132 != -1)
    dispatch_once(&logCategory__hmf_once_t132, &__block_literal_global_436);
  return (id)logCategory__hmf_once_v133;
}
...
LABEL_11:
      _os_log_impl(&dword_1CD062000, v17, v18, v16, (uint8_t *)&v25, 0x16u);
...
LABEL_12:
  ...
  if (a5)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v8;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_INFO, "%{public}@Rejecting insecure remote message: %@", (uint8_t *)&v25, 0x16u);
...
+ (BOOL)isAllowedMessage:(id)a3
{
  ...
  v3 = isAllowedMessage__pred_442;
  v4 = a3;
  if (v3 != -1)
    dispatch_once(&isAllowedMessage__pred_442, &__block_literal_global_444);
  v5 = objc_msgSend((id)isAllowedMessage___allowedMessages_443, "containsObject:", v4);
...
void __49__HMDSecureRemoteMessageFilter_isAllowedMessage___block_invoke()
{
  ...
  v4[4] = CFSTR("kElectDeviceForIDSSessionKey");
  v4[5] = CFSTR("kKeyTransferAgentKey");
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v4, 6);
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "setWithArray:", v1);
  v2 = objc_claimAutoreleasedReturnValue();
  v3 = (void *)isAllowedMessage___allowedMessages_443;
  isAllowedMessage___allowedMessages_443 = v2;
...
void __43__HMDSecureRemoteMessageFilter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v133;
