...
- (id)logEventsPopulatedForHomeWithUUID:(id)a3 associatedWithDate:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_INFO, "%{public}@Returning NULL (for onboarded configuration) to household metrics request for home with UUID: %@", (uint8_t *)&v16, 0x16u);
...
- (id)accessoryCategoryLogEventsForHomeWithUUID:(id)a3
{
  ...
  {
    v48 = *(_QWORD *)v65;
    v55 = *MEMORY[0x1E0CB7AC8];
    v54 = *MEMORY[0x1E0CB7AD8];
    v53 = *MEMORY[0x1E0CB7AE0];
    v51 = *MEMORY[0x1E0CB7AA8];
    do
    {
      for (i = 0; i != v49; ++i)
      {
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    v70 = 2112;
                    v71 = v34;
                    _os_log_impl(&dword_1CD062000, v42, OS_LOG_TYPE_ERROR, "%{public}@Accessory category not found for: %@", buf, 0x16u);
