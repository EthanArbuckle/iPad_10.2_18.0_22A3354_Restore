...
- (void)configureWithSoftwareUpdateProvider:(id)a3
{
  ...
  if ((v6 & 1) != 0)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring with matter software update provider", (uint8_t *)&v13, 0xCu);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", (uint8_t *)&v13, 0x16u);
...
- (id)_queryImageResponseWithStatus:(id)a3 delayedActionTime:(id)a4
{
  ...
  v5 = (objc_class *)MEMORY[0x1E0D332B0];
  v6 = a4;
  v7 = a3;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      v30 = 2112;
      v31 = v10;
      _os_log_impl(&dword_1CD062000, v18, OS_LOG_TYPE_INFO, "%{public}@%@ Firmware version from uarpAccessory (%@) doesn't match accessory version (%@)", buf, 0x2Au);
...
- (void)notifyUpdateRequestedForHMDHAPAccessory:(id)a3 isUserTriggered:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v34 = 2112;
    v35 = v12;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ notifyUpdateRequestedForHMDHAPAccessory, isUserTriggered: %@", (uint8_t *)&v30, 0x20u);
  ...
  if ((objc_msgSend(v6, "supportsCHIP") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        v32 = 2112;
        v33 = v29;
        _os_log_impl(&dword_1CD062000, v27, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", (uint8_t *)&v30, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = v24;
      _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", (uint8_t *)&v30, 0x16u);
...
- (BOOL)canEstablishConnectionForHMDHAPAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v9;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ canEstablishConnectionForHMDHAPAccessory", (uint8_t *)&v25, 0x16u);
  ...
  if ((objc_msgSend(v4, "supportsCHIP") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v27 = 2112;
        v28 = v23;
        _os_log_impl(&dword_1CD062000, v21, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", (uint8_t *)&v25, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 2112;
      v28 = v18;
      _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", (uint8_t *)&v25, 0x16u);
...
- (void)resetOTAProviderStateForHMDHAPAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v4;
    _os_log_impl(&dword_1CD062000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ Resetting OTA provider state for %@", (uint8_t *)&v23, 0x20u);
  ...
  if ((objc_msgSend(v4, "supportsCHIP") & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        v25 = 2112;
        v26 = v22;
        _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", (uint8_t *)&v23, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v17;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", (uint8_t *)&v23, 0x16u);
...
void __103__HMDMatterSoftwareUpdateProviderDelegate_queryImageWithPairing_requestParams_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (v3)
    {
      ...
      v7 = objc_msgSend(v6, "containsObject:", &unk_1E8B34380);
        ...
        if ((_DWORD)v8)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_INFO, "%{public}@%@ Version has changed, request accessory to check back in %f secs", buf, 0x20u);

          }
          objc_autoreleasePoolPop(v10);
          v15 = *(_QWORD *)(a1 + 56);
          objc_msgSend(*(id *)(a1 + 32), "_queryImageResponseWithStatus:delayedActionTime:", &unk_1E8B34398, &unk_1E8B36C08);
          ...
          case 2:
            ...
            if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v118 = 2048;
              v119 = 0x405E000000000000;
              _os_log_impl(&dword_1CD062000, v44, OS_LOG_TYPE_INFO, "%{public}@%@ Software image is busy downloading. Request accessory to check back in %f secs", buf, 0x20u);
            ...
            if (!v37)
            {
              if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v118 = 2112;
                v119 = (uint64_t)v16;
                _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_ERROR, "%{public}@%@ Received nil asset ID even though status is OnLocalStorage, Error:%@", buf, 0x20u);
...
LABEL_44:
              v76 = *(_QWORD *)(a1 + 56);
              objc_msgSend(*(id *)(a1 + 32), "_queryImageResponseWithStatus:delayedActionTime:", &unk_1E8B34368, 0);
              v47 = (void *)objc_claimAutoreleasedReturnValue();
            ...
            if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v118 = 2112;
              v119 = (uint64_t)v37;
              _os_log_impl(&dword_1CD062000, v51, OS_LOG_TYPE_INFO, "%{public}@%@ A software image is available for accessory with asset = %@", buf, 0x20u);
...
LABEL_28:
            ...
            if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              v118 = 2112;
              v119 = (uint64_t)v59;
              _os_log_impl(&dword_1CD062000, v56, OS_LOG_TYPE_INFO, "%{public}@Accessory software version: %@. Software update version: %@", buf, 0x20u);
                ...
                if (v78 <= v80)
                {
                  ...
                  if (os_log_type_enabled(v97, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    v120 = 2112;
                    v121 = v101;
                    _os_log_impl(&dword_1CD062000, v97, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory software version (%@) is already at latest available version (%@).", buf, 0x2Au);
...
LABEL_54:
                    v89 = v65 ^ 1u;
                    v110 = *(_QWORD *)(a1 + 56);
                    v109 = objc_alloc(MEMORY[0x1E0D332B0]);
                    ...
                    objc_msgSend(&unk_1E8B34350, "unsignedIntValue");
                    HMFRandomDataWithLength();
                    v92 = (void *)objc_claimAutoreleasedReturnValue();
                    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", v89);
                    v93 = (void *)objc_claimAutoreleasedReturnValue();
                    v94 = (void *)objc_msgSend(v109, "initWithStatus:delayedActionTime:imageURI:softwareVersion:softwareVersionString:updateToken:userConsentNeeded:metadataForRequestor:", &unk_1E8B34380, &unk_1E8B36BF8, v108, v90, v91, v92, v93, 0);
                  ...
                  if ((v82 & 1) != 0)
                  {
                    if (v86)
                    {
                      ...
                      *(_DWORD *)buf = 138543618;
                      ...
                      v116 = 2112;
                      v117 = v88;
                      _os_log_impl(&dword_1CD062000, v85, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented yet but requestor can consent. Delegating consent to requestor", buf, 0x16u);
                  ...
                  if (v86)
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    v118 = 2048;
                    v119 = 0x405E000000000000;
                    _os_log_impl(&dword_1CD062000, v85, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented to firmware update and requestor cannot consent. Request accessory to check back in %f secs", buf, 0x20u);
...
LABEL_45:
              ...
              if (v70 != 5)
              {
                if (v71)
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v116 = 2112;
                  v117 = v73;
                  _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, "%{public}@%@ User consent pending.", buf, 0x16u);
            ...
            _os_log_impl(&dword_1CD062000, v64, OS_LOG_TYPE_INFO, v68, buf, 0x16u);
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v118 = 2112;
        v119 = (uint64_t)v34;
        _os_log_impl(&dword_1CD062000, v31, OS_LOG_TYPE_ERROR, "%{public}@%@ Transfer protocols not supported in request: %@", buf, 0x20u);

      }
      objc_autoreleasePoolPop(v29);
      v35 = *(_QWORD *)(a1 + 56);
      objc_msgSend(*(id *)(a1 + 32), "_queryImageResponseWithStatus:delayedActionTime:", &unk_1E8B343B0, 0);
      v16 = (id)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v115 = v26;
        _os_log_impl(&dword_1CD062000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v116 = 2112;
      v117 = v21;
      _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot proceed with software update. Accessory not found for pairing : %@", buf, 0x16u);
...
void __111__HMDMatterSoftwareUpdateProviderDelegate_notifyCheckFirmwareUpdateSessionWithPairing_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v15;
        _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", (uint8_t *)&v18, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v10;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", (uint8_t *)&v18, 0x16u);
...
void __98__HMDMatterSoftwareUpdateProviderDelegate_notifyUpdateWithPairing_params_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v17;
      _os_log_impl(&dword_1CD062000, v15, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", (uint8_t *)&v36, 0x16u);
  ...
  if ((objc_msgSend(v2, "supportsCHIP") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v25;
      _os_log_impl(&dword_1CD062000, v23, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory has updated software image, but Accessory does not support Matter", (uint8_t *)&v36, 0x16u);
...
LABEL_13:
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = objc_msgSend(v4, "isEqualToNumber:", &unk_1E8B34398);
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 2112;
      v39 = v11;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory update timed out", (uint8_t *)&v36, 0x16u);

    }
    objc_autoreleasePoolPop(v6);
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D27FC8], 13, 0);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 2112;
      v41 = v28;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ Accessory has updated software image. New version: %@", (uint8_t *)&v36, 0x20u);
...
void __104__HMDMatterSoftwareUpdateProviderDelegate_applyUpdateWithPairing_requestParams_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 2112;
      v18 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@%@ Inform accessory to proceed with applying the software image", (uint8_t *)&v15, 0x16u);

    }
    objc_autoreleasePoolPop(v3);
    v9 = *(_QWORD *)(a1 + 48);
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D332A8]), "initWithAction:delayedActionTime:", &unk_1E8B34380, &unk_1E8B36BF8);
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_ERROR, "%{public}@Accessory should not proceed with applying the software image. Accessory not found for pairing : %@", (uint8_t *)&v15, 0x16u);

    }
    objc_autoreleasePoolPop(v3);
    v13 = *(_QWORD *)(a1 + 48);
    v10 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D332A8]), "initWithAction:delayedActionTime:", &unk_1E8B34368, &unk_1E8B36BF8);
    objc_msgSend(MEMORY[0x1E0CB35C8], "hmfErrorWithCode:", 2);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t34 != -1)
    dispatch_once(&logCategory__hmf_once_t34, &__block_literal_global_134794);
