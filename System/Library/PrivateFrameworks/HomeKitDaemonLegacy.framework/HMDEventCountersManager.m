...
- (id)counterGroupForSpecifier:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Specifier's class must be registered in the allowedSpecifierClasses in HMDEventCountersManager: %@"), objc_opt_class());
      v38 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v37, "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], v38, 0);
      ...
      else
      {
        ...
        else
        {
          if (v8 != objc_opt_class())
          {
            ...
            objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Specifier is allowed class %@, but not handled with bridged counters"), objc_opt_class());
            v41 = (void *)objc_claimAutoreleasedReturnValue();
            objc_msgSend(v40, "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], v41, 0);
...
- (HMDEventCountersManager)initWithEventCountersStorage:(id)a3 bridgedCountersManager:(id)a4 bridgedDateProvider:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x1E0D334D0], "sharedInstance");
...
- (id)unarchiveEventCounters
{
  ...
  v10 = (void *)MEMORY[0x1D17BA0A0](v6, v7, v8, v9);
  v11 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_1CD062000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Final restored event counters: %@", buf, 0x16u);
...
+ (NSSet)allowedSpecifierClasses
{
  if (allowedSpecifierClasses__hmf_once_t2 != -1)
    dispatch_once(&allowedSpecifierClasses__hmf_once_t2, &__block_literal_global_160932);
