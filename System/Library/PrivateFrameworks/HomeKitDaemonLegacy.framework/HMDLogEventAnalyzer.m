...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_82902 != -1)
    dispatch_once(&logCategory__hmf_once_t0_82902, &__block_literal_global_82903);
  return (id)logCategory__hmf_once_v1_82904;
}
...
void __34__HMDLogEventAnalyzer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_82904;
  logCategory__hmf_once_v1_82904 = v0;
