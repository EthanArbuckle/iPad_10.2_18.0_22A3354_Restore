...
{
  void *v3;
  HMDRemoteLoginInitiatorSignoutSession *v4;
  NSObject *v5;
  void *v6;
  objc_super v7;
  uint8_t buf[4];
  void *v9;
  __int16 v10;
  HMDRemoteLoginInitiatorSignoutSession *v11;
  uint64_t v12;
  ...
  -[HMDRemoteLoginInitiatorSignoutSession dealloc](&v7, sel_dealloc);
}
...
- (id)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("[Login-Initiator-Signout-Session: %@]"), v3);
