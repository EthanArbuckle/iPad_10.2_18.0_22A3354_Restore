...
- (BOOL)_parseFromTLVData
{
  ...
  objc_msgSend(MEMORY[0x1E0D16400], "wrappertlv:name:objectCreator:", 1, CFSTR("kSupportedVideoStreamConfiguration_VideoCodecConfigurations"), &__block_literal_global_259);
