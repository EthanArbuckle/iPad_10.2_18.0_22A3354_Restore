...
- (HMDCameraRecordingSessionNotificationTrigger)initWithCamera:(id)a3 workQueue:(id)a4
{
  ...
  v19[0] = *MEMORY[0x1E0CB9A90];
  v6 = (void *)MEMORY[0x1E0C99E60];
  v7 = *MEMORY[0x1E0CB8958];
  v8 = a4;
  v9 = a3;
  objc_msgSend(v6, "setWithObject:", v7);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  v20[0] = v10;
  v19[1] = *MEMORY[0x1E0CB9A08];
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1CD062000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating recording session notification trigger: %@", buf, 0x16u);
...
- (void)_handleObservedCharacteristicsValueUpdate:(id)a3
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (objc_msgSend(v4, "count"))
    {
      ...
      v7 = v6;
      v8 = *(_QWORD *)v74;
      v66 = *MEMORY[0x1E0CB8958];
      v65 = *MEMORY[0x1E0CB8908];
      v68 = *(_QWORD *)v74;
      while (1)
      {
        for (i = 0; i != v7; ++i)
              ...
              if (v18)
              {
                ...
                if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v84 = 2112;
                  v85 = v24;
                  _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Motion characteristic isActive changed to %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (v34)
                {
                  ...
                  if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543362;
                    v83 = v37;
                    v25 = 1;
                    _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_INFO, "%{public}@Doorbell event detected", buf, 0xCu);
                ...
                if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  v84 = 2112;
                  v85 = v10;
                  _os_log_impl(&dword_1CD062000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unsupported characteristics type: %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                v84 = 2112;
                v85 = v32;
                _os_log_impl(&dword_1CD062000, v28, OS_LOG_TYPE_ERROR, "%{public}@Expected a number for characteristic value, was %@", buf, 0x16u);
...
LABEL_31:
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v46;
      _os_log_impl(&dword_1CD062000, v45, OS_LOG_TYPE_INFO, "%{public}@No changed characteristics provided, only evaluating motion detected for triggers", buf, 0xCu);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                v86 = 2112;
                v87 = v58;
                _os_log_impl(&dword_1CD062000, v62, OS_LOG_TYPE_INFO, "%{public}@Unhandled characteristic: %@ value type: %@", buf, 0x20u);
...
LABEL_55:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v83 = v42;
      _os_log_impl(&dword_1CD062000, v41, OS_LOG_TYPE_INFO, "%{public}@No delegate to notify", buf, 0xCu);
...
- (void)listener:(id)a3 didUpdateAvailableCharacteristics:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v7;
    _os_log_impl(&dword_1CD062000, v11, OS_LOG_TYPE_INFO, "%{public}@Enabling notification for characteristics: %@", (uint8_t *)&v17, 0x16u);
  ...
  if (objc_msgSend(v13, "isReachable"))
    -[HMDCameraRecordingSessionNotificationTrigger _handleObservedCharacteristicsValueUpdate:](v10, "_handleObservedCharacteristicsValueUpdate:", MEMORY[0x1E0C9AA60]);
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_handleObservedCharacteristicsValueUpdate:", MEMORY[0x1E0C9AA60]);
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t11_161176 != -1)
    dispatch_once(&logCategory__hmf_once_t11_161176, &__block_literal_global_161177);
  return (id)logCategory__hmf_once_v12_161178;
}
...
void __59__HMDCameraRecordingSessionNotificationTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_161178;
  logCategory__hmf_once_v12_161178 = v0;
