...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_97684 != -1)
    dispatch_once(&hmbProperties_onceToken_97684, &__block_literal_global_97685);
  return (id)hmbProperties__properties_97686;
}
...
void __65__HMDCameraSignificantEventFaceClassificationModel_hmbProperties__block_invoke()
{
  ...
  v7 = (void *)hmbProperties__properties_97686;
  hmbProperties__properties_97686 = v6;
...
- (id)createFaceClassification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot create face classification from model: %@", (uint8_t *)&v17, 0x16u);
