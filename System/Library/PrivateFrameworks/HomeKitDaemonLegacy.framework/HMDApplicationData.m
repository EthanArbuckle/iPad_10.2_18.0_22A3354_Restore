...
- (NSUUID)uuid
{
  ...
  if (!uuid
    || (objc_msgSend(MEMORY[0x1E0CB3A28], "zeroUUID"),
        ...
        v5))
  {
    objc_msgSend(MEMORY[0x1E0CB3A28], "hm_deriveUUIDFromBaseUUID:identifierSalt:withSalts:", self->_parentUUID, 0, &unk_1E8B31C80);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    v7 = v6;
    if (v6)
    {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  v59 = 2112;
                  v60 = v15;
                  _os_log_impl(&dword_1CD062000, v29, OS_LOG_TYPE_INFO, "%{public}@%@ is not a dictionary, but %@", buf, 0x20u);
...
- (void)updateWithModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v21 = 2112;
      v22 = v13;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Updating the application data from transaction: %@ / %@", (uint8_t *)&v17, 0x20u);
...
LABEL_6:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing entire app data for container: %@", (uint8_t *)&v17, 0x16u);
...
- (void)updateParentUUIDIfNil:(id)a3
{
        ...
        v7))
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3A28], "hm_deriveUUIDFromBaseUUID:identifierSalt:withSalts:", self->_parentUUID, 0, &unk_1E8B31C98);
    v8 = (NSUUID *)objc_claimAutoreleasedReturnValue();
    uuid = self->_uuid;
    self->_uuid = v8;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_11425 != -1)
    dispatch_once(&logCategory__hmf_once_t6_11425, &__block_literal_global_11426);
  return (id)logCategory__hmf_once_v7_11427;
}
...
void __33__HMDApplicationData_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_11427;
  logCategory__hmf_once_v7_11427 = v0;
