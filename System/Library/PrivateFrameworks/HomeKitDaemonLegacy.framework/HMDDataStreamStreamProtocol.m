...
- (void)_reevaluateTrafficClassForDataStream
{
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v29 = 2112;
        v30 = v6;
        _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Setting data stream's traffic class to %lu (requested by: '%@')", buf, 0x20u);
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v27 = 2048;
    v28 = v7;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_INFO, "%{public}@Setting data stream's traffic class to %lu (reset)", buf, 0x16u);
...
- (void)_notifyActiveStatusChangedFromPreviousValue:(BOOL)a3
{
  ...
  if (-[HMDDataStreamStreamProtocol isActive](self, "isActive") != a3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v8;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_INFO, "%{public}@Stream protocol changes active to %@", (uint8_t *)&v10, 0x16u);
...
LABEL_8:
      _os_log_impl(&dword_1CD062000, v23, v24, v22, (uint8_t *)&v25, 0x20u);
...
- (void)dataStream:(id)a3 didReceiveRequest:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v24 = 2112;
    v25 = v13;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Stream protocol does not support request message with topic=%@, header=%@, payload=%@", (uint8_t *)&v18, 0x2Au);
...
- (void)dataStream:(id)a3 didReceiveResponse:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    v24 = 2112;
    v25 = v13;
    _os_log_impl(&dword_1CD062000, v16, OS_LOG_TYPE_ERROR, "%{public}@Stream protocol does not support response message with topic=%@, header=%@, payload=%@", (uint8_t *)&v18, 0x2Au);
