...
- (void)_retrieveMetadataOnController:(id)a3 homeHasResident:(BOOL)a4 completion:(id)a5
{
  ...
  v27 = &v26;
  v28 = 0x3032000000;
  v29 = __Block_byref_object_copy__130996;
  v30 = __Block_byref_object_dispose__130997;
  v31 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CE9200]), "initWithKeychainAccessGroup:", CFSTR("com.apple.thread.network"));
  if (v27[5])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v18;
      _os_log_impl(&dword_1CD062000, v17, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", buf, 0xCu);
...
- (void)_retrieveBorderRouterPreferredNetworkWithCompletion:(id)a3
{
  ...
  v16 = &v15;
  v17 = 0x3032000000;
  v18 = __Block_byref_object_copy__130996;
  v19 = __Block_byref_object_dispose__130997;
  v20 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CE9200]), "initWithKeychainAccessGroup:", CFSTR("com.apple.thread.network"));
  v6 = (void *)v16[5];
  if (v6)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", buf, 0xCu);
...
- (void)_retrievePreferredNetwork:(id)a3 completion:(id)a4
{
  ...
  if ((isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled() & 1) != 0)
  {
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v32 = 0x3032000000;
    v33 = __Block_byref_object_copy__130996;
    v34 = __Block_byref_object_dispose__130997;
    v35 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CE9200]), "initWithKeychainAccessGroup:", CFSTR("com.apple.thread.network"));
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v29 = 138543362;
        v30 = v20;
        _os_log_impl(&dword_1CD062000, v19, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", v29, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = v15;
      _os_log_impl(&dword_1CD062000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot retrieve or generate thread preferred network on this platform", (uint8_t *)&buf, 0xCu);
...
- (void)_triggerPreferredNetworkUpdateWithCompletion:(id)a3
{
  ...
  v10 = &v9;
  v11 = 0x3032000000;
  v12 = __Block_byref_object_copy__130996;
  v13 = __Block_byref_object_dispose__130997;
  v14 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CE9200]), "initWithKeychainAccessGroup:", CFSTR("com.apple.thread.network"));
  v4 = (void *)v10[5];
  if (v4)
  {
...
- (void)_removePreferredNetworkWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v10;
      _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable - cannot clear preferred thread credentials", buf, 0xCu);
...
- (void)_checkIfThreadNetworkIsRunningWithCompletion:(id)a3
{
  ...
  v12 = &v11;
  v13 = 0x3032000000;
  v14 = __Block_byref_object_copy__130996;
  v15 = __Block_byref_object_dispose__130997;
  v16 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0CE9200]), "initWithKeychainAccessGroup:", CFSTR("com.apple.thread.network"));
  v6 = (void *)v12[5];
  if (v6)
  {
  ...
  if (!v8 || v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v41 = 2112;
      v42 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve preferred thread network credentials record : %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v43 = 2112;
      v44 = v8;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@retrievePreferredNetworkInternallyOnMdnsAndSig returned THCredential:%@, uuid %@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v10);
    v15 = objc_alloc(MEMORY[0x1E0CBA908]);
  ...
  if (!v8 || v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@retrievePreferredNetworkWithNoScan failed : %@", buf, 0x16u);
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v39 = 2112;
      v40 = v8;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@retrievePreferredNetworkWithNoScan returned THCredential:%@, uuid %@", buf, 0x20u);
  ...
  if (!v5 || v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v32 = 2112;
      v33 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, operational dataset validation failed. Error: %@, credentials: %@", buf, 0x20u);
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v32 = 2112;
      v33 = v5;
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, "%{public}@Operational dataset validation passed, store cached AOD: %@, THCredential:%@", buf, 0x20u);

    }
    objc_autoreleasePoolPop(v7);
    v13 = objc_alloc(MEMORY[0x1E0CBA908]);
...
void __118__HMDThreadNetworkMetadataStore__validateOperationalDatasetWithTHClient_operationalDataset_storeCachedAOD_completion___block_invoke_20(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v11 = 22;
LABEL_6:
      _os_log_impl(&dword_1CD062000, v10, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v13, v11);
...
void __85__HMDThreadNetworkMetadataStore__retrieveBorderRouterPreferredNetworkWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v8 || v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v10;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve preferred thread network credentials record : %@", buf, 0x16u);
  ...
  {
    v24 = objc_alloc(MEMORY[0x1E0CBA908]);
    objc_msgSend(v7, "networkName");
    v22 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v8 || v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v27 = 2112;
      v28 = v10;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@retrievePreferredCredentialsInternally failed : %@", buf, 0x16u);
...
void __116__HMDThreadNetworkMetadataStore__retrieveMetadataOnThreadCapableController_threadClient_homeHasResident_completion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v8 || v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v37 = 2112;
      v38 = v10;
      _os_log_impl(&dword_1CD062000, v20, OS_LOG_TYPE_ERROR, "%{public}@retrievePreferredNetworkWithNoScan failed : %@", buf, 0x16u);
  ...
  {
    v30 = objc_alloc(MEMORY[0x1E0CBA908]);
    objc_msgSend(v7, "networkName");
  ...
  if (!v8 || v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      v29 = 2112;
      v30 = v9;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_ERROR, "%{public}@retrieveOrGeneratePreferredNetworkInternally failed : %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      v31 = 2112;
      v32 = v8;
      _os_log_impl(&dword_1CD062000, v13, OS_LOG_TYPE_DEBUG, "%{public}@retrieveOrGeneratePreferredNetworkInternally returned THCredential:%@, uuid %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_131052 != -1)
    dispatch_once(&logCategory__hmf_once_t0_131052, &__block_literal_global_131053);
  return (id)logCategory__hmf_once_v1_131054;
}
...
+ (HMDThreadNetworkMetadataStore)defaultStore
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v11 = 138543362;
      v12 = v7;
      _os_log_impl(&dword_1CD062000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reusing existing store", (uint8_t *)&v11, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1CD062000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Creating new store", (uint8_t *)&v11, 0xCu);
...
void __44__HMDThreadNetworkMetadataStore_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_131054;
  logCategory__hmf_once_v1_131054 = v0;
