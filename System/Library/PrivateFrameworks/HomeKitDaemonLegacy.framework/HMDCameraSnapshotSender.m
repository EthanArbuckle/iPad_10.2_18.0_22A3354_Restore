...
- (void)_sendImageSendFailure:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v26 = 2112;
    v27 = v6;
    _os_log_impl(&dword_1CD062000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending image send failure to %@", buf, 0x16u);
  ...
  objc_msgSend(MEMORY[0x1E0D285F8], "internalMessageWithName:messagePayload:", CFSTR("kTakeSnapshotSendFailedNotificationKey"), v14);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_53512 != -1)
    dispatch_once(&logCategory__hmf_once_t0_53512, &__block_literal_global_53513);
  return (id)logCategory__hmf_once_v1_53514;
}
...
void __38__HMDCameraSnapshotSender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_53514;
  logCategory__hmf_once_v1_53514 = v0;
