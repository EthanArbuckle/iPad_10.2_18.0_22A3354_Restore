...
{
  id v4;
  WLKAddToUpNextRequest *v5;
  uint64_t v6;
  NSString *canonicalID;
  WLKAddToUpNextRequest *v8;
  objc_super v10;
  ...
  if (v4)
  {
    ...
    v5 = -[WLKAddToUpNextRequest init](&v10, sel_init);
    if (v5)
    {
...
LABEL_9:
  ...
  if (v10)
  {
    ...
    v11 = -[WLKAddToUpNextRequest init](&v23, sel_init);
    if (v11)
    {
...
- (void)makeRequestWithCompletion:(id)a3
{
  ...
  if ((v6 & 1) != 0)
  {
    if (self->_canonicalID)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = -[WLKWatchListModificationRequestOperation initWithAction:canonicalID:caller:](v7, "initWithAction:canonicalID:caller:", 0, canonicalID, v9);
    }
    else
    {
      if (!self->_statsID)
      {
        if (self->_channelID && self->_externalID)
        {
          ...
          v15 = -[WLKWatchListModificationRequestOperation initWithAction:channelID:externalID:caller:](v17, "initWithAction:channelID:externalID:caller:", 0, channelID, externalID, v20);
      ...
      -[WLKRequest caller](self, "caller");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      v10 = -[WLKWatchListModificationRequestOperation initWithAction:statsID:caller:](v13, "initWithAction:statsID:caller:", 0, statsID, v9);
    }
...
void __51__WLKAddToUpNextRequest_makeRequestWithCompletion___block_invoke(uint64_t a1)
{
  ...
  if (v1)
  {
    objc_msgSend(MEMORY[0x1E0CB35C8], "errorWithDomain:code:userInfo:", CFSTR("WLKAddToUpNextRequestErrorDomain"), 9056, 0);
