...
- (WLKSiriSearchRequest)initWithQuery:(id)a3
{
  ...
  v5 = -[WLKSiriSearchRequest init](&v9, sel_init);
  if (v5)
  {
...
{
  id v4;
  WLKSiriSearchRequestOperation *v5;
  NSDictionary *query;
  void *v7;
  WLKSiriSearchRequestOperation *v8;
  id v9;
  void *v10;
  _QWORD v11[4];
  id v12;
  ...
  v8 = -[WLKSiriSearchRequestOperation initWithQuery:caller:](v5, "initWithQuery:caller:", query, v7);
  ...
  v9 = v4;
  v12 = v9;
  -[WLKSiriSearchRequestOperation setCompletionBlock:](v8, "setCompletionBlock:", v11);
