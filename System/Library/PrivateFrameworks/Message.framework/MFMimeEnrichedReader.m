...
- (void)mismatchError:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    v5 = 138412290;
    v6 = a3;
    _os_log_impl(&dword_1A4F90000, v4, OS_LOG_TYPE_INFO, "Ignoring unmatched </%@> command", (uint8_t *)&v5, 0xCu);
  }
}
...
- (void)nowWouldBeAGoodTimeToAppendToTheAttributedString
{
  ...
  if ((*((_BYTE *)self + 212) & 1) != 0)
  {
    ...
    -[NSMutableString setString:](self->_outputBuffer, "setString:", &stru_1E4F1C8F8);
    return;
  }
          ...
          else
          {
            if (v54 <= v26 || (v31 = v53, v53 > v26))
            {
              ...
              if (v52 >= v34)
                v29 = v34;
              v55.length = v29 + v33;
              v55.location = v35 + v51;
              CFStringGetCharacters((CFStringRef)v48, v55, buffer);
              v31 = v53;
            }
            v30 = buffer[v26 - v31];
          }
...
LABEL_80:
    ...
    CFStringReplaceAll(self->_prependHTML, &stru_1E4F1C8F8);
    CFStringReplaceAll(self->_postpendHTML, &stru_1E4F1C8F8);
    CFStringReplaceAll((CFMutableStringRef)self->_outputBuffer, &stru_1E4F1C8F8);
  }
}
...
LABEL_22:
      ...
      if (v6)
      {
        ...
        if (!objc_msgSend(v7, "scanHexInt:", &v20))
          goto LABEL_19;
        a3 = 0;
...
LABEL_12:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134218496;
    ...
    v19 = 2048;
    v20 = v13;
    _os_log_impl(&dword_1A4F90000, v10, OS_LOG_TYPE_INFO, "elapsed time %gs (input length=%ld, output length=%lu)", buf, 0x20u);
  }
}
