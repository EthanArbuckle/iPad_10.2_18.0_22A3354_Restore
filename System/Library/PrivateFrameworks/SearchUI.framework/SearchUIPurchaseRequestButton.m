...
- (int)getRequestState
{
  ...
  -[SearchUIPurchaseRequestButton requestIdentifier](self, "requestIdentifier");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (v2)
  {
    +[SearchUIPurchaseRequestStatusManager sharedManager](SearchUIPurchaseRequestStatusManager, "sharedManager");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)updateWithRowModel:(id)a3
{
  ...
  -[SearchUIPurchaseRequestButton setupSubscription](self, "setupSubscription");
  v12.receiver = self;
  v12.super_class = (Class)SearchUIPurchaseRequestButton;
  -[SearchUIRequestButton updateButtonState:withState:](&v12, sel_updateButtonState_withState_, 0, -[SearchUIPurchaseRequestButton getRequestState](self, "getRequestState"));
...
- (void)setupSubscription
{
  ...
  -[SearchUIPurchaseRequestButton purchaseRequestStatusObserver](self, "purchaseRequestStatusObserver");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v3)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[SearchUIPurchaseRequestButton setPurchaseRequestStatusObserver:](self, "setPurchaseRequestStatusObserver:", v5);
...
- (void)dealloc
{
  ...
  -[SearchUIPurchaseRequestButton dealloc](&v6, sel_dealloc);
}
...
{
  objc_storeStrong((id *)&self->_purchaseRequestStatusObserver, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_purchaseRequestStatusObserver, 0);
}
