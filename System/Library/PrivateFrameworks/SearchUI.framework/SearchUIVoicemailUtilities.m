...
+ (void)playVoicemailWithIdentifier:(NSString *)a3 completionHandler:(id)a4
{
  ...
  v14[5] = v13;
  v15 = a3;
  sub_1DADFDE48((uint64_t)v9, (uint64_t)&unk_1F029DA28, (uint64_t)v14);
  swift_release();
}
...
{
  if (qword_1F02A03D8)
    objc_msgSend((id)qword_1F02A03D8, sel_play);
}

+ (void)pauseVoicemail
{
  if (qword_1F02A03D8)
    objc_msgSend((id)qword_1F02A03D8, sel_pause);
}
...
- (_TtC8SearchUI26SearchUIVoicemailUtilities)init
{
  ...
  return -[SearchUIVoicemailUtilities init](&v3, sel_init);
}
