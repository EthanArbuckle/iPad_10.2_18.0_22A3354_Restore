...
+ (void)fetchSportsFavoritesEnabledStatusWithCompletionHandler:(id)a3
{
  ...
  *(_QWORD *)(v9 + 24) = a1;
  ...
  v12[4] = &unk_1F029E538;
  v12[5] = v11;
  sub_1DADFDE48((uint64_t)v7, (uint64_t)&unk_1F029E540, (uint64_t)v12);
  swift_release();
}
...
+ (void)fetchSportsItemIsFavoritedWithSportsItem:(SFSportsItem *)a3 completionHandler:(id)a4
{
  ...
  v14[5] = v13;
  v15 = a3;
  sub_1DADFDE48((uint64_t)v9, (uint64_t)&unk_1F029E520, (uint64_t)v14);
  swift_release();
}
...
- (_TtC8SearchUI19SearchUITVUtilities)init
{
  ...
  return -[SearchUITVUtilities init](&v3, sel_init);
}
