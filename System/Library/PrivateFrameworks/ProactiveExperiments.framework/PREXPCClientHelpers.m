...
- (PREXPCClientHelpers)initWithServiceName:(id)a3 whitelistedServerInterface:(id)a4 clientExportedObject:(id)a5 interruptionHandler:(id)a6 invalidationHandler:(id)a7
{
  ...
  id v16;
  id v17;
  PREXPCClientHelpers *v18;
  PREXPCClientHelpers *v19;
  uint64_t v20;
  ...
  v18 = -[PREXPCClientHelpers init](&v25, sel_init);
  v19 = v18;
  if (v18)
  {
...
- (void)dealloc
{
  ...
  -[PREXPCClientHelpers dealloc](&v3, sel_dealloc);
}
  ...
  if (!self->_conn)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_QWORD *)&buf[4] = serviceName;
      _os_log_impl(&dword_1C35DB000, v3, OS_LOG_TYPE_DEFAULT, "Establishing new connection to %@ .", buf, 0xCu);
    }
    ...
    *(_QWORD *)buf = 0;
    ...
    v9 = v8;
    v10 = 3221225472;
    v11 = __50__PREXPCClientHelpers__locked_establishConnection__block_invoke_3;
    v12 = &unk_1E7D9E0F8;
...
- (id)remoteObjectProxy
{
  ...
  -[PREXPCClientHelpers _locked_establishConnection](self, "_locked_establishConnection");
...
void __50__PREXPCClientHelpers__locked_establishConnection__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR))
    {
      ...
      v4 = 138412290;
      v5 = v3;
      _os_log_error_impl(&dword_1C35DB000, v2, OS_LOG_TYPE_ERROR, "Connection to %@ interrupted.", (uint8_t *)&v4, 0xCu);
    }
...
void __50__PREXPCClientHelpers__locked_establishConnection__block_invoke_3(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v5 = 138412290;
      v6 = v3;
      _os_log_impl(&dword_1C35DB000, v2, OS_LOG_TYPE_DEFAULT, "Connection to %@ invalidated.", (uint8_t *)&v5, 0xCu);
    }
