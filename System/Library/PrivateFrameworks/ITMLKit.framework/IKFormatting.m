...
void __30__IKFormatting_sharedInstance__block_invoke()
{
  IKFormatting *v0;
  void *v1;
...
+ (id)rfc1123DateFormatter
{
  if (rfc1123DateFormatter_onceToken != -1)
    dispatch_once(&rfc1123DateFormatter_onceToken, &__block_literal_global_1_1);
...
+ (id)isoDateFormatter
{
  if (isoDateFormatter_onceToken != -1)
    dispatch_once(&isoDateFormatter_onceToken, &__block_literal_global_8_0);
...
- (IKFormatting)init
{
  ...
  v2 = -[IKFormatting init](&v12, sel_init);
  if (v2)
  {
...
- (id)formatDuration:(id)a3
{
  ...
  v5 = v4 % 3600;
  v6 = ((unsigned __int128)(v4 % 3600 * (__int128)(uint64_t)0x8888888888888889) >> 64) + v4 % 3600;
  v7 = (void *)MEMORY[0x1E0CB3578];
  objc_msgSend(MEMORY[0x1E0C99DC8], "currentLocale");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  if (v4 <= 3599)
  {
    objc_msgSend(v7, "dateFormatFromTemplate:options:locale:", CFSTR("mmss"), 0, v8);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    v10 = (void *)objc_msgSend(v17, "mutableCopy");

    goto LABEL_8;
  }
  objc_msgSend(v7, "dateFormatFromTemplate:options:locale:", CFSTR("HHmmss"), 0, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = (void *)objc_msgSend(v9, "mutableCopy");

  v11 = objc_msgSend(v10, "rangeOfString:", CFSTR("HH"));
  if (v11 != 0x7FFFFFFFFFFFFFFFLL
    || (v11 = objc_msgSend(v10, "rangeOfString:", CFSTR("H")), v11 != 0x7FFFFFFFFFFFFFFFLL)
    || (v11 = objc_msgSend(v10, "rangeOfString:", CFSTR("kk")), v11 != 0x7FFFFFFFFFFFFFFFLL)
    || (v11 = objc_msgSend(v10, "rangeOfString:", CFSTR("k")), v11 != 0x7FFFFFFFFFFFFFFFLL))
  {
    v13 = v11;
    v14 = v12;
    durationFormatter = self->_durationFormatter;
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", v4 / 3600);
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSNumberFormatter stringFromNumber:](durationFormatter, "stringFromNumber:", v16);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_8:
  ...
  v18 = (v6 >> 5) + ((unint64_t)v6 >> 63);
  v19 = objc_msgSend(v10, "rangeOfString:", CFSTR("mm"));
  if (v19 == 0x7FFFFFFFFFFFFFFFLL)
  {
    v21 = objc_msgSend(v10, "rangeOfString:", CFSTR("m"));
    v23 = 0x1E0CB3000;
  ...
  if (v4 > 3599)
    v26 = 48;
  v27 = *(void **)(v23 + 2024);
  v28 = *(id *)((char *)&self->super.isa + v26);
  objc_msgSend(v27, "numberWithInteger:", (v6 >> 5) + ((unint64_t)v6 >> 63));
...
LABEL_16:
  v31 = objc_msgSend(v10, "rangeOfString:", CFSTR("ss"));
  if (v31 != 0x7FFFFFFFFFFFFFFFLL
    || (v31 = objc_msgSend(v10, "rangeOfString:", CFSTR("s")), v31 != 0x7FFFFFFFFFFFFFFFLL))
  {
    v33 = v31;
    v34 = v32;
    durationPaddedFormatter = self->_durationPaddedFormatter;
    objc_msgSend(*(id *)(v23 + 2024), "numberWithInteger:", v5 - 60 * v18);
    v36 = (void *)objc_claimAutoreleasedReturnValue();
    -[NSNumberFormatter stringFromNumber:](durationPaddedFormatter, "stringFromNumber:", v36);
          ...
          if (v23)
          {
            ...
            if (v19 != v39)
            {
              while (1)
              {
                ...
                v28 = vdupq_n_s32(v26);
                if ((vmaxv_u16((uint16x4_t)vmovn_s32((int32x4_t)vcgtq_u32((uint32x4_t)xmmword_1D96A7B70, (uint32x4_t)vaddq_s32(v28, (int32x4_t)xmmword_1D96A7B60)))) & 1) != 0|| (v26 & 0xFFFFFF00) == 0x600)
                {
                  v29 = v36;
                  goto LABEL_30;
                }
                ...
                if ((vmaxv_u8((uint8x8_t)vmovn_s16(vuzp1q_s16((int16x8_t)vcgtq_u32((uint32x4_t)xmmword_1D96A7BA0, (uint32x4_t)vaddq_s32(v28, (int32x4_t)xmmword_1D96A7B80)), (int16x8_t)vcgtq_u32((uint32x4_t)xmmword_1D96A7BB0, (uint32x4_t)vaddq_s32(v28, (int32x4_t)xmmword_1D96A7B90))))) & 1) != 0|| (v26 - 194560) < 0x220)
                {
                  v29 = v33;
LABEL_30:
                  v30 = v29;
...
{
  return -[IKFormatting joinComponents:withASCII:arabic:ethiopic:ideograph:](self, "joinComponents:withASCII:arabic:ethiopic:ideograph:", a3, CFSTR(", "), CFSTR("، "), CFSTR("፣ "), CFSTR("、"));
}

- (id)joinComponentsWithLocalizedSemicolonAndSpace:(id)a3
{
  return -[IKFormatting joinComponents:withASCII:arabic:ethiopic:ideograph:](self, "joinComponents:withASCII:arabic:ethiopic:ideograph:", a3, CFSTR("; "),
           CFSTR("؛ "),
           CFSTR("፤ "),
           CFSTR("、"));
}
