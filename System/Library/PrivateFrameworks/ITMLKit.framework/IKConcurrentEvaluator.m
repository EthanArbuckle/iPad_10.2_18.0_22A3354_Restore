...
{
  return -[IKConcurrentEvaluator initWithQueue:concurrencyCount:](self, "initWithQueue:concurrencyCount:", a3, 10);
}

- (IKConcurrentEvaluator)initWithQueue:(id)a3 concurrencyCount:(int64_t)a4
{
  id v7;
  IKConcurrentEvaluator *v8;
  IKConcurrentEvaluator *v9;
  int64_t v10;
  ...
  v8 = -[IKConcurrentEvaluator init](&v14, sel_init);
  v9 = v8;
  if (v8)
  {
...
- (void)addEvaluationBlock:(id)a3 forKey:(id)a4
{
  ...
  v20[1] = 3221225472;
  v20[2] = __51__IKConcurrentEvaluator_addEvaluationBlock_forKey___block_invoke;
  v20[3] = &unk_1E9F4C4D0;
  objc_copyWeak(&v23, &location);
  v10 = v8;
  v21 = v10;
  v22 = v24;
  v11 = (void *)MEMORY[0x1DF092410](v20);
  v16[0] = v9;
  v16[1] = 3221225472;
  v16[2] = __51__IKConcurrentEvaluator_addEvaluationBlock_forKey___block_invoke_2;
  v16[3] = &unk_1E9F4C4F8;
  v19 = v24;
  v12 = v6;
  v18 = v12;
  v13 = v10;
  v17 = v13;
  v14 = (void *)MEMORY[0x1DF092410](v16);
  v15 = self;
  objc_sync_enter(v15);
  -[IKConcurrentEvaluator _insertFetcher:getter:forKey:](v15, "_insertFetcher:getter:forKey:", v14, v11, v7);
  -[IKConcurrentEvaluator _scheduleFetchRelayed:](v15, "_scheduleFetchRelayed:", 0);
  objc_sync_exit(v15);
...
intptr_t __51__IKConcurrentEvaluator_addEvaluationBlock_forKey___block_invoke_2(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
...
- (id)objectForKey:(id)a3
{
  ...
  v5 = self;
  objc_sync_enter(v5);
  -[IKConcurrentEvaluator _getterForKey:](v5, "_getterForKey:", v4);
...
- (void)_insertFetcher:(id)a3 getter:(id)a4 forKey:(id)a5
{
  ...
  v12 = (void *)MEMORY[0x1DF092410](v19);
  ...
  v18 = (void *)MEMORY[0x1DF092410](v8);
...
- (id)_getterForKey:(id)a3
{
  ...
  v4 = a3;
  -[IKConcurrentEvaluator _removeFetcherForKey:](self, "_removeFetcherForKey:", v4);
...
- (void)_scheduleFetchRelayed:(BOOL)a3
{
  ...
  v9 = MEMORY[0x1E0C809B0];
  v10 = 3221225472;
  v11 = __47__IKConcurrentEvaluator__scheduleFetchRelayed___block_invoke;
  v12 = &unk_1E9F4BCC8;
  objc_copyWeak(&v13, &location);
  v5 = (void *)MEMORY[0x1DF092410](&v9);
  if (v3)
  ...
  if (-[NSMutableArray count](self->_orderedKeys, "count", v9, v10, v11, v12))
  {
    ...
    if (activeFetchCount < -[IKConcurrentEvaluator concurrencyCount](self, "concurrencyCount")
      && !self->_numberOfSchedulingLocksAcquired)
    {
      v7 = self->_activeFetchCount + 1;
LABEL_9:
      self->_activeFetchCount = v7;
      -[IKConcurrentEvaluator queue](self, "queue");
