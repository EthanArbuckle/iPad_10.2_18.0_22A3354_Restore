...
- (IKJSManagedArray)initWithArray:(id)a3 ownerObject:(id)a4
{
  ...
  v8 = -[IKJSManagedArray init](&v29, sel_init);
  v9 = v8;
  if (v8)
  {
    v23 = v8;
...
- (void)dealloc
{
  ...
  v16 = 0u;
  v17 = 0u;
  -[IKJSManagedArray managedArray](self, "managedArray");
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          ...
          -[IKJSManagedArray ownerObject](self, "ownerObject");
  ...
  -[IKJSManagedArray setManagedArray:](self, "setManagedArray:", 0);
  v13.receiver = self;
  v13.super_class = (Class)IKJSManagedArray;
  -[IKJSManagedArray dealloc](&v13, sel_dealloc);
}
...
- (id)jsValuesWithContext:(id)a3
{
  ...
  v16 = 0u;
  v17 = 0u;
  -[IKJSManagedArray managedArray](self, "managedArray", 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
