...
- (MODiagnosticReporter)init
{
  ...
  if (v2)
  {
    ...
    *(_OWORD *)(v2 + 56) = xmmword_1CAE9D570;
...
- (void)_notificationHandlerWithNotificationRef:(__CFUserNotification *)a3 andOptionFlags:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 138412290;
    v14 = v9;
    _os_log_impl(&dword_1CAE42000, v8, OS_LOG_TYPE_DEFAULT, "Received response flags %@", (uint8_t *)&v13, 0xCu);
  ...
  CFRunLoopRemoveSource(Main, self->_notificationSource, (CFRunLoopMode)*MEMORY[0x1E0C9B270]);
  *p_notification = 0;
  p_notification[1] = 0;
...
- (void)showUserNotificationWithTitle:(id)a3 message:(id)a4 cancelButtonTitle:(id)a5 acceptButtonTitle:(id)a6 withAcceptanceBlock:(id)a7
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjectsAndKeys:", a3, *MEMORY[0x1E0C9B800], a4, *MEMORY[0x1E0C9B810], a6, *MEMORY[0x1E0C9B838], a5, *MEMORY[0x1E0C9B830], 0);
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v24 = v14;
      _os_log_impl(&dword_1CAE42000, v15, OS_LOG_TYPE_DEFAULT, "Prompting diagnostic report notification with alert parameters %@", buf, 0xCu);
    }

    *(_DWORD *)buf = 0;
    v16 = (const __CFAllocator *)*MEMORY[0x1E0C9AE00];
    v17 = CFUserNotificationCreate((CFAllocatorRef)*MEMORY[0x1E0C9AE00], 60.0, 0, (SInt32 *)buf, v14);
    ...
    if (v17)
    {
      ...
      if (RunLoopSource)
      {
        ...
        Main = CFRunLoopGetMain();
        CFRunLoopAddSource(Main, self->_notificationSource, (CFRunLoopMode)*MEMORY[0x1E0C9B270]);
LABEL_15:
...
LABEL_21:
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              v38 = 2112;
              v39 = v10;
              _os_log_impl(&dword_1CAE42000, v18, OS_LOG_TYPE_DEFAULT, "MODiagnosticReporter reporting incident [subtype=%@,context=%@]", buf, 0x16u);
            }
            ...
            objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", v19, v21);
          ...
          else
          {
            ...
            {
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", v11->_lastResult);
              v30 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v11->_timeOfLastIncident);
              v31 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v15);
              v26 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v11->_refractoryPeriodAfterAcceptance);
              v27 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v11->_refractoryPeriodAfterRejection);
              v28 = (void *)objc_claimAutoreleasedReturnValue();
              objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", self->_onboardingStatus);
              ...
              *(_DWORD *)buf = 138413570;
              ...
              v46 = 2112;
              v47 = v29;
              _os_log_debug_impl(&dword_1CAE42000, v24, OS_LOG_TYPE_DEBUG, "MODiagnosticReporter states [_lastResult=%@, _timeOfLastIncident=%@, interval=%@, _refractoryPeriodAfterAcceptance=%@, _refractoryPeriodAfterRejection=%@, _onboardingStatus=%@]", buf, 0x3Eu);
...
- (void)reportIncidentAfterUserConsent:(id)a3 subtype:(id)a4 context:(id)a5
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_timeOfLastIncident);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v16, "stringWithFormat:", CFSTR("Subtype: %@\n\nContext: %@\n\nApproximate timestamp: %@"), v11, v10, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("?Title=%@&Description=%@&Classification=%@&Reproducibility=%@&ComponentName=%@&ComponentVersion=%@&ComponentID=%@"), v15, v18, CFSTR("Crash/Hang/Data Loss"), CFSTR("I Didn't Try"), CFSTR("Journaling Suggestions"), CFSTR("All"), CFSTR("1330744"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  v20 = (void *)MEMORY[0x1E0C99E98];
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("tap-to-radar://new%@"), v19);
  v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412290;
    v27 = v24;
    _os_log_impl(&dword_1CAE42000, v23, OS_LOG_TYPE_DEFAULT, "Triggering tap to radar with url [%@]", buf, 0xCu);
...
- (void)_notificationHandlerWithNotificationRef:andOptionFlags:.cold.1()
{
  ...
  OUTLINED_FUNCTION_4_2(&dword_1CAE42000, v0, v1, "Unexpected notification handler call", v2, v3, v4, v5, v6);
...
- (void)showUserNotificationWithTitle:(int *)a1 message:(NSObject *)a2 cancelButtonTitle:acceptButtonTitle:withAcceptanceBlock:.cold.1(int *a1, NSObject *a2)
{
  ...
  v3[0] = 67109120;
  v3[1] = v2;
  _os_log_error_impl(&dword_1CAE42000, a2, OS_LOG_TYPE_ERROR, "Could not create diagnostic reporter user notification (error:%i)", (uint8_t *)v3, 8u);
  OUTLINED_FUNCTION_1_2();
}
...
- (void)showUserNotificationWithTitle:message:cancelButtonTitle:acceptButtonTitle:withAcceptanceBlock:.cold.2()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_0_3(&dword_1CAE42000, v0, v1, "Could not create diagnostic reporter user notification runloop", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_2();
}
...
- (void)showUserNotificationWithTitle:message:cancelButtonTitle:acceptButtonTitle:withAcceptanceBlock:.cold.3()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_4_2(&dword_1CAE42000, v0, v1, "A notification is already being processed", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_2();
}
...
- (void)reportIncident:subtype:context:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_2_2(&dword_1CAE42000, v0, v1, "Attempting to report MODiagnosticReporter incident but user is not onboarded in journaling suggestions. Skipping.", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_2();
}
...
- (void)reportIncident:subtype:context:.cold.2()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_2_2(&dword_1CAE42000, v0, v1, "Attempting to report MODiagnosticReporter incident but user is not onboarded in journal study. Skipping.", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_2();
}
...
- (void)reportIncident:subtype:context:.cold.3()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_0_3(&dword_1CAE42000, v0, v1, "Attempting to report MODiagnosticReporter incident but recent incident is too close in the past. Skipping.", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_2();
}
...
- (void)reportIncident:subtype:context:.cold.4()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_2_2(&dword_1CAE42000, v0, v1, "Attempting to report MODiagnosticReporter incident but report feature is overriden as disabled. Skipping.", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1_2();
}
...
void __71__MODiagnosticReporter_reportIncidentAfterUserConsent_subtype_context___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v2 = 138412290;
  v3 = a1;
  _os_log_error_impl(&dword_1CAE42000, a2, OS_LOG_TYPE_ERROR, "Launching TTR failed %@", (uint8_t *)&v2, 0xCu);
}
...
- (void)_configureFromDictionary:(uint64_t)a3 .cold.1(uint64_t a1, NSObject *a2, uint64_t a3)
{
  ...
  v3 = 138412290;
  v4 = a1;
  OUTLINED_FUNCTION_5_3(&dword_1CAE42000, a2, a3, "Received configuration %@", (uint8_t *)&v3);
}
