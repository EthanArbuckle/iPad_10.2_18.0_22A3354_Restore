...
uint64_t OUTLINED_FUNCTION_5_0(uint64_t a1, void *a2)
{
...
void sub_1CAE5A4B8(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_1CAE5A64C(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_1CAE5A6EC(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_1CAE5AA78(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, id obj)
{
  objc_sync_exit(obj);
  _Unwind_Resume(a1);
}
...
void sub_1CAE67E4C(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_1CAE68228(_Unwind_Exception *a1)
{
  uint64_t v1;
...
uint64_t OUTLINED_FUNCTION_5_1(uint64_t a1, void *a2)
{
...
void sub_1CAE77E54(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}

void sub_1CAE780B8(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  id *v3;
...
_BYTE *OUTLINED_FUNCTION_1_6(_BYTE *result, _BYTE *a2)
{
  *result = 0;
  *a2 = 0;
  return result;
...
void sub_1CAE79FC8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void sub_1CAE7AC58(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, id location)
{
  objc_destroyWeak(&location);
  _Unwind_Resume(a1);
}
...
os_log_t _mo_log_facility_prepare(uint64_t a1)
{
  ...
  result = os_log_create("com.apple.Moments", *(const char **)(a1 + 8));
  *(_QWORD *)(a1 + 16) = result;
  return result;
}
...
void sub_1CAE85DE4(_Unwind_Exception *a1)
{
  void *v1;
...
void _MODiagnosticReporter_NotificationHandler_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v5 = 138412290;
  v6 = v3;
  OUTLINED_FUNCTION_5_3(&dword_1CAE42000, a2, v4, "_MODiagnosticReporter_NotificationHandler with flags %@", (uint8_t *)&v5);
...
{
  return MEMORY[0x1E0D2F560]();
}

uint64_t HKUILocalizedWorkoutTypeName()
{
  return MEMORY[0x1E0D2F568]();
}
