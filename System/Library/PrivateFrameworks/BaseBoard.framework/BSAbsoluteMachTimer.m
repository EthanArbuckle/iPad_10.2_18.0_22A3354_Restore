    ...
    && (*(_QWORD *)&a3 & 0x7FFFFFFFFFFFFFFFLL) != 0)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v46 = self;
      v47 = 2114;
      v48 = CFSTR("BSAbsoluteMachTimer.m");
      v49 = 1024;
      v50 = 61;
      v51 = 2114;
      v52 = v22;
...
- (BSAbsoluteMachTimer)initWithIdentifier:(id)a3
{
  ...
  v5 = -[BSAbsoluteMachTimer init](&v9, sel_init);
  if (v5)
  {
...
- (void)dealloc
{
  ...
  if ((-[BSDispatchTimer hasBeenInvalidated]((os_unfair_lock_s *)self->_timer) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v17 = self;
      v18 = 2114;
      v19 = CFSTR("BSAbsoluteMachTimer.m");
      v20 = 1024;
      v21 = 30;
      v22 = 2114;
      v23 = v7;
  ...
  -[BSAbsoluteMachTimer dealloc](&v11, sel_dealloc);
}
    ...
    && (*(_QWORD *)&a3 & 0x7FFFFFFFFFFFFFFFLL) != 0)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v58 = self;
      v59 = 2114;
      v60 = CFSTR("BSAbsoluteMachTimer.m");
      v61 = 1024;
      v62 = 78;
      v63 = 2114;
      v64 = v29;
