...
- (void)dealloc
{
  ...
  -[SMB_rq dealloc](&v3, sel_dealloc);
}

- (void)smb_rq_callback:(int)a3
{
  void (**sr_callback)(id, _QWORD);
  id v5;

  sr_callback = (void (**)(id, _QWORD))self->_sr_callback;
  if (sr_callback)
  {
    sr_callback[2](sr_callback, *(_QWORD *)&a3);
...
- (void)smb_rq_done
{
  ...
  mb_done(&self->sr_rp);
  md_done(&self->sr_rq);
  -[SMB_rq setSr_callback:](self, "setSr_callback:", 0);
}
