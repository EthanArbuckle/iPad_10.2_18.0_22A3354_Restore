...
{
  return -[TVImageScaleDecorator initWithScaleToSize:scaleMode:](self, "initWithScaleToSize:scaleMode:", 1, *MEMORY[0x24BDBF148], *(double *)(MEMORY[0x24BDBF148] + 8));
}
...
- (TVImageScaleDecorator)initWithScaleToSize:(CGSize)a3 scaleMode:(int64_t)a4
{
  ...
  result = -[TVImageScaleDecorator init](&v8, sel_init);
  if (result)
  {
    ...
    *(_OWORD *)&result->_cornerRadii.bottomLeft = *(_OWORD *)&qword_222E77538;
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = a3;
  if (objc_msgSend(v4, "scaleMode") == 2 && -[TVImageScaleDecorator scaleMode](self, "scaleMode") == 2)
  {
    objc_msgSend(v4, "bgColor");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[TVImageScaleDecorator bgColor](self, "bgColor");
  ...
  if (v9 == v16
    && (-[TVImageScaleDecorator cornerRadii](self, "cornerRadii"), v11 == v17)
    && (-[TVImageScaleDecorator cornerRadii](self, "cornerRadii"), v13 == v18))
  {
    -[TVImageScaleDecorator cornerRadii](self, "cornerRadii");
    v20 = v15 == v19;
  }
  ...
  if (!-[TVImageDecorator isEqual:](&v45, sel_isEqual_, v4))
    goto LABEL_20;
  objc_msgSend(v4, "scaleToSize");
  v22 = v21;
  v24 = v23;
  -[TVImageScaleDecorator scaleToSize](self, "scaleToSize");
  v26 = 0;
  if (v22 == v27 && v24 == v25)
  {
    ...
    v33 = v32;
    v35 = v34;
    -[TVImageScaleDecorator padding](self, "padding");
    v26 = 0;
    if (v31 == v39 && v29 == v36 && v35 == v38 && v33 == v37)
    {
      v40 = objc_msgSend(v4, "scaleMode");
      if (v40 == -[TVImageScaleDecorator scaleMode](self, "scaleMode"))
      {
        objc_msgSend(v4, "focusedSizeIncrease");
        v42 = v41;
        -[TVImageScaleDecorator focusedSizeIncrease](self, "focusedSizeIncrease");
        if (v42 == v43)
        {
          v26 = v7 && v20;
          goto LABEL_21;
...
LABEL_13:
  ...
  -[TVImageScaleDecorator padding](self, "padding");
  if (v24 != *(double *)(MEMORY[0x24BDF7718] + 8)
    || v21 != *MEMORY[0x24BDF7718]
    || v23 != *(double *)(MEMORY[0x24BDF7718] + 24)
...
- (id)decorate:(id)a3 scaledWithSize:(CGSize)a4 croppedToFit:(BOOL)a5
{
  ...
  v11 = v10;
  v13 = v12;
  -[TVImageScaleDecorator _paddingAdjustedForUpscaling](self, "_paddingAdjustedForUpscaling");
  v18 = v14;
  v19 = v15;
  if (v11 != *MEMORY[0x24BDBF148] || v13 != *(double *)(MEMORY[0x24BDBF148] + 8))
  {
    v21 = v16;
    v22 = v17;
    ...
    if (!v23
      || ((scaleMode = self->_scaleMode, scaleMode == 3) ? (v25 = !v5) : (v25 = 0),
          ...
          v27
       || (v15 == *(double *)(MEMORY[0x24BDF7718] + 8) ? (v67 = v14 == *MEMORY[0x24BDF7718]) : (v67 = 0),
           v67 ? (v68 = v17 == *(double *)(MEMORY[0x24BDF7718] + 24)) : (v68 = 0),
           v68 ? (v69 = v16 == *(double *)(MEMORY[0x24BDF7718] + 16)) : (v69 = 0),
           !v69)))
    {
      v79 = v11;
      ...
      switch(self->_scaleMode)
      {
        case 1:
          ...
          v43 = *MEMORY[0x24BDBEFB0];
          v35 = *(double *)(MEMORY[0x24BDBEFB0] + 8);
          v44 = v35;
          v45 = *MEMORY[0x24BDBEFB0];
          goto LABEL_41;
        case 2:
          v100.width = v30;
          v100.height = v32;
...
LABEL_39:
          ...
          break;
        default:
          v45 = *MEMORY[0x24BDBF090];
          v44 = *(double *)(MEMORY[0x24BDBF090] + 8);
          v101.size.width = *(CGFloat *)(MEMORY[0x24BDBF090] + 16);
          v101.size.height = *(CGFloat *)(MEMORY[0x24BDBF090] + 24);
          break;
      }
      v43 = 0.0;
      v42 = v79;
LABEL_41:
      ...
      +[TVGraphicsImageRenderer formatWithCGImage:](TVGraphicsImageRenderer, "formatWithCGImage:", objc_msgSend(v59, "image"));
      v60 = (void *)objc_claimAutoreleasedReturnValue();
      v61 = -[TVImageScaleDecorator needsAlphaForImage:](self, "needsAlphaForImage:", v59);
      -[TVImageScaleDecorator bgColor](self, "bgColor");
      ...
      +[TVImage imageWithCGImageRef:preserveAlpha:](TVImage, "imageWithCGImageRef:preserveAlpha:", objc_msgSend(v65, "CGImage"), v64);
    ...
    || !+[TVCornerUtilities radiiIsZero:](TVCornerUtilities, "radiiIsZero:", self->_cornerRadii.topLeft, self->_cornerRadii.topRight, self->_cornerRadii.bottomLeft, self->_cornerRadii.bottomRight))
  {
    ...
    +[TVGraphicsImageRenderer formatWithCGImage:](TVGraphicsImageRenderer, "formatWithCGImage:", objc_msgSend(v74, "image"));
    v60 = (void *)objc_claimAutoreleasedReturnValue();
    v75 = -[TVImageScaleDecorator needsAlphaForImage:](self, "needsAlphaForImage:", v74);
    ...
    v85 = v73;
    v81 = v74;
    +[TVGraphicsImageRenderer imageWithSize:format:actions:](TVGraphicsImageRenderer, "imageWithSize:format:actions:", v60, v80, v71, v73);
    v76 = (void *)objc_claimAutoreleasedReturnValue();
    v77 = v76;
    if (v76)
    {
      +[TVImage imageWithCGImageRef:preserveAlpha:](TVImage, "imageWithCGImageRef:preserveAlpha:", objc_msgSend(objc_retainAutorelease(v76), "CGImage"), v75);
      v66 = (id)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
- (double)_focusedSizeIncreaseFactor
{
  ...
  {
    v4 = -[TVImageScaleDecorator centerGrowth](self, "centerGrowth");

    result = 1.0;
    if (!v4)
    {
      -[TVImageScaleDecorator _scaleToSizeAdjustedForUpscaling](self, "_scaleToSizeAdjustedForUpscaling", 1.0);
      v7 = v6;
      -[TVImageScaleDecorator scaleToSize](self, "scaleToSize");
      return v7 / v8;
    }
...
- (BOOL)needsAlphaForImage:(id)a3
{
  ...
  v4 = a3;
  if (-[TVImageScaleDecorator preservesAlpha](self, "preservesAlpha"))
  {
    ...
    {
      -[TVImageScaleDecorator cornerRadii](self, "cornerRadii");
      v5 = !+[TVCornerUtilities radiiIsZero:](TVCornerUtilities, "radiiIsZero:");
    }
  }
  else
  {
...
- (id)_imageFixedForRotation:(id)a3
{
  ...
  +[TVGraphicsImageRenderer formatWithCGImage:](TVGraphicsImageRenderer, "formatWithCGImage:", objc_msgSend(v3, "image"));
  ...
  v18 = v3;
  v14 = v3;
  +[TVGraphicsImageRenderer imageWithSize:format:actions:](TVGraphicsImageRenderer, "imageWithSize:format:actions:", v4, v17, v12, v13);
...
void __48__TVImageScaleDecorator__imageFixedForRotation___block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = xmmword_222E76EA0;
  v6 = xmmword_222E76EB0;
  v7 = 0.0;
  switch(*(_QWORD *)(a1 + 56))
  {
    case 2:
      v5 = xmmword_222E76EB0;
      v6 = xmmword_222E76EC0;
      v4 = *(double *)(a1 + 64);
      break;
    case 3:
      v5 = xmmword_222E76ED0;
      v6 = xmmword_222E76EC0;
      v4 = *(double *)(a1 + 64);
      v7 = *(double *)(a1 + 72);
      break;
    case 4:
      v5 = xmmword_222E76ED0;
      v6 = xmmword_222E76EA0;
      v7 = *(double *)(a1 + 72);
      break;
    case 5:
      v5 = xmmword_222E76EC0;
      v6 = xmmword_222E76ED0;
      v7 = *(double *)(a1 + 64);
      v4 = *(double *)(a1 + 72);
      break;
    case 6:
    ...
    default:
      ...
      v4 = *(double *)(MEMORY[0x24BDBD8B8] + 32);
...
- (CGSize)_scaleToSizeAdjustedForUpscaling
{
  ...
  if (v4 > 0.0 && v3 > 0.0)
  {
    -[TVImageScaleDecorator focusedSizeIncrease](self, "focusedSizeIncrease");
    v8 = v7;
    if (-[TVImageScaleDecorator centerGrowth](self, "centerGrowth"))
    {
      v6 = v6 + v8;
    }
    else
...
- (void)_applyCornerMaskForRect:(CGRect)a3 toContext:(CGContext *)a4
{
  ...
  {
    v19 = +[TVCornerUtilities createPathForRadii:inRect:isContinuous:](TVCornerUtilities, "createPathForRadii:inRect:isContinuous:", -[TVImageScaleDecorator cornerContinuous](self, "cornerContinuous"), v10 * v12, v10 * v14, v10 * v16, v10 * v18, x, y, width, height);
