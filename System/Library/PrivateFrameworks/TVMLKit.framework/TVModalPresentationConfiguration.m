...
+ (id)presentationTypeKeyMap
{
  if (presentationTypeKeyMap_onceToken != -1)
    dispatch_once(&presentationTypeKeyMap_onceToken, &__block_literal_global_173);
...
{
  TVModalPresentationConfiguration *v2;
  TVModalPresentationConfiguration *v3;
  ...
  v2 = -[TVModalPresentationConfiguration init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    ...
    *(_WORD *)&v2->_allowsModalOverModal = 256;
    ...
    v3->_popOverSourceRect.origin = (CGPoint)*MEMORY[0x24BDBF090];
...
- (TVModalPresentationConfiguration)initWithOptions:(id)a3
{
  ...
  v4 = a3;
  v5 = -[TVModalPresentationConfiguration init](self, "init");
  if (v5)
  {
...
- (void)_applyAlertActionsForController:(id)a3
{
  ...
  v4 = a3;
  -[TVModalPresentationConfiguration alertActions](self, "alertActions");
