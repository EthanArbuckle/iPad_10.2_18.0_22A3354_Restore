...
- (void)tv_addLanguageAwareness:()TVMLKitAdditions
{
  ...
  if (v6)
  {
    ...
    *(_OWORD *)buffer = 0u;
    ...
    v49 = v7 - 1;
    v15 = -1;
    v51 = *MEMORY[0x24BDF6628];
    v52 = *MEMORY[0x24BDF66E0];
...
LABEL_12:
        ...
        {
          v28 = MEMORY[0x22767F5FC](CharacterAtIndex);
          v29 = 0;
          v30 = 0;
          v18 = 0;
          v21 = 1;
...
LABEL_94:
    ...
    if (v11 && (double)v11 / (double)(v11 + v12) >= 0.4)
    {
      if (defaultParagraphStyle_sOnceForRightToLeft != -1)
        dispatch_once(&defaultParagraphStyle_sOnceForRightToLeft, &__block_literal_global_23_1);
      v39 = 1;
    ...
    else
    {
      ...
      if (defaultParagraphStyle_sOnceForNatural != -1)
        dispatch_once(&defaultParagraphStyle_sOnceForNatural, &__block_literal_global_22_0);
      v39 = -1;
