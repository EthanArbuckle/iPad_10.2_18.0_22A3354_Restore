...
- (TVURLImageRequest)initWithURL:(id)a3 headers:(id)a4 identifier:(id)a5 decrypter:(id)a6
{
  ...
  id v13;
  id v14;
  TVURLImageRequest *v15;
  TVURLImageRequest *v16;
  objc_super v18;
  ...
  v15 = -[TVURLImageRequest init](&v18, sel_init);
  v16 = v15;
  if (v15)
  {
...
{
  return -[TVURLImageRequest initWithURL:headers:identifier:decrypter:](self, "initWithURL:headers:identifier:decrypter:", a3, a4, 0, a5);
}
