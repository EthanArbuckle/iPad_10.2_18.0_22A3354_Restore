...
{
  _TVProgressBarView *v3;
  _TVProgressBarView *v4;
  objc_super v6;
  ...
  v4 = v3;
  if (v3)
    -[_TVProgressBarView setContentMode:](v3, "setContentMode:", 3);
  return v4;
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  -[_TVProgressBarView bounds](self, "bounds");
  v10 = v9;
  v12 = v11;
  v14 = v13;
  v16 = v15;
  ...
  {
    -[_TVProgressBarView completeTintColor](self, "completeTintColor");
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v17, "setFill");
    objc_msgSend(MEMORY[0x24BDF6870], "bezierPathWithRoundedRect:cornerRadius:", v10, v12, v14, v16, self->_cornerRadius);
  ...
  -[_TVProgressBarView progress](self, "progress");
  v23 = 0.0;
  if (v24 > 0.0)
  {
    -[_TVProgressBarView progress](self, "progress");
  ...
  if (self->_shouldProgressBarUseRoundCorner)
    ...
    v30 = 5;
  objc_msgSend(MEMORY[0x24BDF6870], "bezierPathWithRoundedRect:byRoundingCorners:cornerRadii:", v30, v26, v27, v28, v29, self->_cornerRadius, self->_cornerRadius);
  ...
  {
    -[_TVProgressBarView progressTintColor](self, "progressTintColor");
...
- (void)setCompleteTintColor:(id)a3
{
  ...
  if ((-[UIColor isEqual:](self->_completeTintColor, "isEqual:") & 1) == 0)
  {
    ...
    -[_TVProgressBarView setNeedsDisplay](self, "setNeedsDisplay");
  }
