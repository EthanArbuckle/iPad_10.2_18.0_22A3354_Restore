...
void __WBS_LOG_CHANNEL_PREFIXWebExtensions_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "WebExtensions");
...
void __WBS_LOG_CHANNEL_PREFIXBuiltInContentBlockers_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "BuiltInContentBlockers");
...
void __WBS_LOG_CHANNEL_PREFIXDownloads_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "Downloads");
...
void __WBS_LOG_CHANNEL_PREFIXFaviconDatabase_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "FaviconDatabase");
...
void __WBS_LOG_CHANNEL_PREFIXFaviconPersistence_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "FaviconPersistence");
...
void __WBS_LOG_CHANNEL_PREFIXParsec_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "Parsec");
...
void __WBS_LOG_CHANNEL_PREFIXPrivacyTransparency_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "PrivacyTransparency");
...
void __WBS_LOG_CHANNEL_PREFIXThemeColor_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "ThemeColor");
...
void __WBS_LOG_CHANNEL_PREFIXUniversalLinks_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "UniversalLinks");
...
void __WBS_LOG_CHANNEL_PREFIXWebApps_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "WebApps");
...
void __WBS_LOG_CHANNEL_PREFIXSchemaDataLoading_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "SchemaDataLoading");
...
void __WBS_LOG_CHANNEL_PREFIXSystemNoteTaking_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "SystemNoteTaking");
...
void __WBS_LOG_CHANNEL_PREFIXHideMyEmail_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "HideMyEmail");
...
void __WBS_LOG_CHANNEL_PREFIXSharedTabGroups_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "SharedTabGroups");
...
void __WBS_LOG_CHANNEL_PREFIXManagedExtensions_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "ManagedExtensions");
...
void __WBS_LOG_CHANNEL_PREFIXScribble_block_invoke()
{
  ...
  v0 = os_log_create("com.apple.SafariShared", "Scribble");
