...
+ (id)applicationCategoryTypeForCategories:(id)a3
{
  ...
  objc_msgSend(v4, "URLForResource:withExtension:", CFSTR("WebAppCategories"), CFSTR("plist"));
  ...
  if (v8)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        objc_msgSend(v6, "objectForKeyedSubscript:", *(_QWORD *)(*((_QWORD *)&v15 + 1) + 8 * v11), (_QWORD)v15);
