...
- (void)setEndpoint:(id)a3
{
  ...
  objc_msgSend(v5, "setObject:forSetting:", v4, 2883987265);
...
- (void)setWidgetStyle:(unint64_t)a3
{
  ...
  objc_msgSend(v5, "setObject:forSetting:", v4, 2883987264);
...
{
  return -[FBSSettings initWithSettings:](+[CRSUIDashboardWidgetSceneSettings allocWithZone:](CRSUIDashboardWidgetSceneSettings, "allocWithZone:", a3), "initWithSettings:", self);
}
