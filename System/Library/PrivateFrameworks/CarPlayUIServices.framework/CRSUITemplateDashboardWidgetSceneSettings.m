...
{
  return -[FBSSettings initWithSettings:](+[CRSUIMutableTemplateDashboardWidgetSceneSettings allocWithZone:](CRSUIMutableTemplateDashboardWidgetSceneSettings, "allocWithZone:", a3), "initWithSettings:", self);
}
