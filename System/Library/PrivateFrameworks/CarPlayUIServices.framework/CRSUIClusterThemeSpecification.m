...
+ (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.CarPlayApp.cluster-theme");
}
...
void __43__CRSUIClusterThemeSpecification_interface__block_invoke()
{
  ...
  objc_msgSend(MEMORY[0x24BE0BE50], "protocolForProtocol:", &unk_2549C5958);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "setServer:", v3);

  objc_msgSend(MEMORY[0x24BE0BE50], "protocolForProtocol:", &unk_2549CB878);
