...
- (MTDefaultsChangeNotifier)initWithProperties:(id)a3 defaults:(id)a4
{
  ...
  v8 = -[MTDictionaryDiff initWithProperties:](&v11, sel_initWithProperties_, a3);
  v9 = v8;
  if (v8)
...
- (void)dealloc
{
  ...
  -[MTDefaultsChangeNotifier dealloc](&v3, sel_dealloc);
}
...
- (void)start
{
  ...
  if (!-[MTDefaultsChangeNotifier isRunning](self, "isRunning"))
  {
    ...
    v8 = 0u;
    v9 = 0u;
    -[MTDictionaryDiff properties](self, "properties", 0);
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[NSUserDefaults addObserver:forKeyPath:options:context:](self->_defaults, "addObserver:forKeyPath:options:context:", self, *(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++), 0, self);
        }
        while (v5 != v7);
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          if (*(_QWORD *)v9 != v6)
            objc_enumerationMutation(v3);
          -[NSUserDefaults removeObserver:forKeyPath:context:](self->_defaults, "removeObserver:forKeyPath:context:", self, *(_QWORD *)(*((_QWORD *)&v8 + 1) + 8 * v7++), self);
        }
        while (v5 != v7);
        v5 = objc_msgSend(v3, "countByEnumeratingWithState:objects:count:", &v8, v12, 16);
      }
...
- (void)_defaultsChanged
{
  ...
  v2 = self;
  objc_sync_enter(v2);
  -[NSUserDefaults dictionaryRepresentation](v2->_defaults, "dictionaryRepresentation");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4.receiver = v2;
  v4.super_class = (Class)MTDefaultsChangeNotifier;
  -[MTDictionaryDiff setDictionary:](&v4, sel_setDictionary_, v3);
