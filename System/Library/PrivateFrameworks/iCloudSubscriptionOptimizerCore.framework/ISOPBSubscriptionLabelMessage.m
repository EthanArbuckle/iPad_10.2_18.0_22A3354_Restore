...
- (id)description
{
  ...
  -[ISOPBSubscriptionLabelMessage description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ISOPBSubscriptionLabelMessage dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("minsUntilICloudNotificationOpened"));
  ...
  if ((has & 2) != 0)
  {
    ...
    if (label >= 3)
    {
      objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_label);
      v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v7 = off_24F187E78[label];
    }
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("label"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 1) != 0)
  {
    *((_QWORD *)result + 1) = self->_minsUntilICloudNotificationOpened;
    *((_BYTE *)result + 20) |= 1u;
    has = (char)self->_has;
  }
  if ((has & 2) != 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 20) & 1) == 0 || self->_minsUntilICloudNotificationOpened != *((_QWORD *)v4 + 1))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 2) == 0 || self->_label != *((_DWORD *)v4 + 4))
      goto LABEL_11;
    v5 = 1;
  }
LABEL_12:
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 1) != 0)
  {
    self->_minsUntilICloudNotificationOpened = *((_QWORD *)v4 + 1);
    *(_BYTE *)&self->_has |= 1u;
    v5 = *((_BYTE *)v4 + 20);
  }
  if ((v5 & 2) != 0)
  {
    self->_label = *((_DWORD *)v4 + 4);
    *(_BYTE *)&self->_has |= 2u;
  }
