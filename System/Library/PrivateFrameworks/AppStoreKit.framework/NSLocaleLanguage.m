...
- (NSLocaleLanguage)init
{
  ...
  return -[NSLocaleLanguage initWithLocaleIdentifier:](self, "initWithLocaleIdentifier:", &stru_1E9DB4A20);
}
...
- (NSLocaleLanguage)initWithLocaleIdentifier:(id)a3
{
  ...
  void *v8;
  void *v9;
  NSLocaleLanguage *v10;
  objc_super v12;

  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NSLocaleLanguage;
  v5 = -[NSLocaleLanguage init](&v12, sel_init);
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      {
        -[NSLocaleLanguage setTwoCharacterCode:](v5, "setTwoCharacterCode:", v8);
        objc_msgSend(v7, "threeCharacterLanguageCode");
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        -[NSLocaleLanguage setThreeCharacterCode:](v5, "setThreeCharacterCode:", v9);
...
- (unint64_t)hash
{
  ...
  -[NSLocaleLanguage twoCharacterCode](self, "twoCharacterCode");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[NSLocaleLanguage twoCharacterCode](v4, "twoCharacterCode");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
