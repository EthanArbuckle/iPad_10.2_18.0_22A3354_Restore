...
+ (id)defaultURLOfModelInThisBundle
{
  ...
  if (v10)
  {
    objc_msgSend_URLWithString_relativeToURL_(MEMORY[0x1E0C99E98], v7, (uint64_t)CFSTR("diffusion_latn_denoiser.bundle"), (uint64_t)v10, v8, v9);
...
+ (id)inputNames
{
  ...
  v5[0] = CFSTR("input_diffusion_x_timestep");
  v5[1] = CFSTR("input_diffusion_timestep");
  v5[2] = CFSTR("input_labels");
  v5[3] = CFSTR("input_labels_length");
  v5[4] = CFSTR("input_length");
  v5[5] = CFSTR("input_diffusion_style_encoding");
  objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E0C99D20], a2, (uint64_t)v5, 6, v2, v3);
...
+ (id)outputNames
{
  ...
  v5[0] = CFSTR("pred_noise");
  v5[1] = CFSTR("pred_penup");
...
- (CHDiffusionModelE5ML)initWithProgramLibrary:(id)a3 width:(unint64_t)a4
{
  ...
  self = -[CHDiffusionModelE5ML init](&v60, sel_init);
  if (!self)
    goto LABEL_16;
  v14 = v13;
  v59 = v12;
...
{
  CHDiffusionModelE5MLExecutionContext *v3;
  const char *v4;
  uint64_t v5;
  uint64_t v6;
  uint64_t v7;
