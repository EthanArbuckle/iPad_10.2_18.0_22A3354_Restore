...
- (CHLineWrappableLine)initWithQuad:(id)a3 text:(id)a4 locale:(id)a5
{
  ...
  id v10;
  id v11;
  CHLineWrappableLine *v12;
  CHLineWrappableLine *v13;
  const char *v14;
  uint64_t v15;
  uint64_t v16;
  uint64_t v17;
  ...
  v12 = -[CHLineWrappableLine init](&v22, sel_init);
  v13 = v12;
  if (v12)
  {
    objc_storeStrong((id *)&v12->_boundingQuad, a3);
    *(_OWORD *)&v13->_layoutDirection = xmmword_1BE8D52D0;
    objc_storeStrong((id *)&v13->_locale, a5);
    objc_storeStrong((id *)&v13->_text, a4);
    v13->_textRegionType = 2;
    objc_msgSend_UUID(MEMORY[0x1E0CB3A28], v14, v15, v16, v17, v18);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeInteger_forKey_(v4, v20, v19, (uint64_t)CFSTR("layoutDirection"), v21, v22);
  v28 = objc_msgSend_lineWrappingType(self, v23, v24, v25, v26, v27);
  objc_msgSend_encodeInteger_forKey_(v4, v29, v28, (uint64_t)CFSTR("lineWrappingType"), v30, v31);
  objc_msgSend_locale(self, v32, v33, v34, v35, v36);
  v37 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v4, v38, (uint64_t)v37, (uint64_t)CFSTR("locale"), v39, v40);
...
- (CHLineWrappableLine)initWithCoder:(id)a3
{
  ...
  v5 = -[CHLineWrappableLine init](&v43, sel_init);
  if (v5)
  {
    v6 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, (uint64_t)CFSTR("boundingQuad"), v8, v9);
    v10 = objc_claimAutoreleasedReturnValue();
    boundingQuad = v5->_boundingQuad;
    v5->_boundingQuad = (CRNormalizedQuad *)v10;

    v5->_layoutDirection = objc_msgSend_decodeIntegerForKey_(v4, v12, (uint64_t)CFSTR("layoutDirection"), v13, v14, v15);
    v5->_lineWrappingType = objc_msgSend_decodeIntegerForKey_(v4, v16, (uint64_t)CFSTR("lineWrappingType"), v17, v18, v19);
    v20 = objc_opt_class();
    objc_msgSend_decodeObjectOfClass_forKey_(v4, v21, v20, (uint64_t)CFSTR("locale"), v22, v23);
    ...
    v5->_textRegionType = objc_msgSend_decodeIntegerForKey_(v4, v32, (uint64_t)CFSTR("textRegionType"), v33, v34, v35);
    v36 = objc_opt_class();
