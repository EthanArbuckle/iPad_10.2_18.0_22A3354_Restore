...
void ___ButtonSpecificationSampleForFullLevel_block_invoke()
{
  ...
  +[ICQLink linkWithText:options:action:parameters:](ICQLink, "linkWithText:options:action:parameters:", CFSTR("Cannot Send or Receive Mail – Upgrade Storage [ENG]"), 1, 3, MEMORY[0x1E0C9AA70]);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v8[0] = v2;
  v7[1] = CFSTR("com.apple.iCloudDriveApp");
  +[ICQLink linkWithText:options:action:parameters:](ICQLink, "linkWithText:options:action:parameters:", CFSTR("iCloud Storage is Full – Upgrade Storage [ENG]"), 1, 3, v1);
