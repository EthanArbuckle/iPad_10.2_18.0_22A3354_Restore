...
- (void)setKey:(id)a3
{
  ...
  uint64_t v5;
  uint64_t v6;
  _TtC27SiriVirtualDeviceResolution26AssistantEnabledCapability *v7;
...
{
  _TtC27SiriVirtualDeviceResolution26AssistantEnabledCapability *v2;
  int64_t v3;
  int64_t v4;
...
{
  AssistantEnabledCapability.init()();
}
