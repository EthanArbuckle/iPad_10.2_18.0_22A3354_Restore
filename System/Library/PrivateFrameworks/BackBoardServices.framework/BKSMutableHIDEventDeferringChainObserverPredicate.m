...
{
  return -[BKSHIDEventDeferringChainObserverPredicate _initWithCopyOf:]((id *)[BKSHIDEventDeferringChainObserverPredicate alloc], self);
}
...
- (void)setDisplay:(id)a3
{
  ...
  void *v27;
  __int16 v28;
  BKSMutableHIDEventDeferringChainObserverPredicate *v29;
  __int16 v30;
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v29 = self;
      v30 = 2114;
      v31 = CFSTR("BKSHIDEventDeferringChainObserverPredicate.m");
      v32 = 1024;
      v33 = 164;
      v34 = 2114;
      v35 = v11;
