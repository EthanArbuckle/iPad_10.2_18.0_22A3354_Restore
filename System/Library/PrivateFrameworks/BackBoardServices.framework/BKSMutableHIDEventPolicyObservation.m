...
- (void)setDisplay:(id)a3
{
  ...
  void *v27;
  __int16 v28;
  BKSMutableHIDEventPolicyObservation *v29;
  __int16 v30;
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      v29 = self;
      v30 = 2114;
      v31 = CFSTR("BKSHIDEventPolicyObservation.m");
      v32 = 1024;
      v33 = 210;
      v34 = 2114;
      v35 = v11;
...
- (void)setToken:(id)a3
{
  ...
  if (!v5)
  {
    ...
    NSStringFromClass(v9);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "stringWithFormat:", CFSTR("Value for '%@' was unexpectedly nil. Expected %@."), CFSTR("token"), v10);
    v11 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v15 = (void *)MEMORY[0x1E0CB3940];
    v16 = (objc_class *)-[BKSHIDEventDeferringToken classForCoder](v6, "classForCoder");
    if (!v16)
      v16 = (objc_class *)objc_opt_class();
    NSStringFromClass(v16);
    v17 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    NSStringFromClass(v18);
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "stringWithFormat:", CFSTR("Value for '%@' was of unexpected class %@. Expected %@."), CFSTR("token"), v17, v19);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
