...
- (PPEventServerDelegate)init
{
  ...
  return -[PPEventServerDelegate init](&v3, sel_init);
}
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  objc_msgSend(MEMORY[0x1E0CB3B50], "interfaceWithProtocol:", &unk_1EF903750);
  ...
  objc_msgSend(v7, "setClasses:forSelector:argumentIndex:ofReply:", v11, sel_resolveEventNameRecordChanges_client_queryId_, 0, 0);

  objc_msgSend(MEMORY[0x1E0CB3B50], "interfaceWithProtocol:", &unk_1EF919840);
  ...
  v24[0] = v14;
  v24[1] = 3221225472;
  v24[2] = __60__PPEventServerDelegate_listener_shouldAcceptNewConnection___block_invoke_2;
  v24[3] = &unk_1E7E1D488;
  v25 = v15;
  v22[0] = v14;
  v22[1] = 3221225472;
  v22[2] = __60__PPEventServerDelegate_listener_shouldAcceptNewConnection___block_invoke_3;
  v22[3] = &unk_1E7E1F4F0;
  v23 = v25;
  v20[0] = v14;
  v20[1] = 3221225472;
  v20[2] = __60__PPEventServerDelegate_listener_shouldAcceptNewConnection___block_invoke_4;
  v20[3] = &unk_1E7E1F4F0;
  v21 = v23;
  v17 = v23;
  v18 = +[PPXPCServerHelper shouldAcceptConnection:serviceName:allowedServerInterface:allowedClientInterface:requestHandler:validateConnection:setupClientProxy:interruptionHandler:invalidationHandler:](PPXPCServerHelper, "shouldAcceptConnection:serviceName:allowedServerInterface:allowedClientInterface:requestHandler:validateConnection:setupClientProxy:interruptionHandler:invalidationHandler:", v6, CFSTR("com.apple.proactive.PersonalizationPortrait.Event"), v7, v12, v17, v16, v24, v22, v20);
...
BOOL __60__PPEventServerDelegate_listener_shouldAcceptNewConnection___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v6 = +[PPXPCServerHelper checkForAndLogTrueBooleanEntitlement:connection:serviceName:](PPXPCServerHelper, "checkForAndLogTrueBooleanEntitlement:connection:serviceName:", CFSTR("com.apple.proactive.PersonalizationPortrait.Event"), v5, CFSTR("com.apple.proactive.PersonalizationPortrait.Event"));
