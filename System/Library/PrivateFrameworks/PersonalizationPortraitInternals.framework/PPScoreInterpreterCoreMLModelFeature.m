...
{
  id v6;
  PPScoreInterpreterCoreMLModelFeature *v7;
  PPScoreInterpreterCoreMLModelFeature *v8;
  uint64_t v9;
  ...
  v7 = -[PPScoreInterpreterCoreMLModelFeature init](&v13, sel_init);
  v8 = v7;
  if (v7)
  {
...
{
  return -[PPScoreInterpreterCoreMLModelFeature initWithFeatureName:multiArraySize:](self, "initWithFeatureName:multiArraySize:", a3, 0);
}
