...
- (id)description
{
  ...
  -[PPM2NamedEntitiesPerDonation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2NamedEntitiesPerDonation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    ...
    {
      v5 = off_1E7E14738[donationSource];
    }
