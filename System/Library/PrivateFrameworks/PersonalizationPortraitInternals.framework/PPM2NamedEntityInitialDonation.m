...
- (id)description
{
  ...
  -[PPM2NamedEntityInitialDonation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2NamedEntityInitialDonation dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_source != *((_DWORD *)v4 + 5))
      goto LABEL_14;
  }
...
LABEL_14:
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_algorithm != *((_DWORD *)v4 + 4))
      goto LABEL_14;
  }
...
LABEL_5:
    v3 = 0;
    return v3 ^ v2 ^ -[NSString hash](self->_activeTreatments, "hash");
  }
  v2 = 0;
  if ((*(_BYTE *)&self->_has & 1) == 0)
    goto LABEL_5;
