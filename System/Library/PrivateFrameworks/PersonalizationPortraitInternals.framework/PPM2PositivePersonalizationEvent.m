...
- (id)description
{
  ...
  -[PPM2PositivePersonalizationEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2PositivePersonalizationEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)options
{
  if (options_once_22633 != -1)
    dispatch_once(&options_once_22633, &__block_literal_global_22634);
  return (id)options_sOptions_22635;
}
...
void __43__PPM2PositivePersonalizationEvent_options__block_invoke()
{
  ...
  v0 = (void *)options_sOptions_22635;
  options_sOptions_22635 = (uint64_t)&unk_1E7E5C030;
