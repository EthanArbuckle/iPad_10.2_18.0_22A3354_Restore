...
- (id)description
{
  ...
  -[PPM2DeviceStats description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2DeviceStats dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)options
{
  if (options_once_882 != -1)
    dispatch_once(&options_once_882, &__block_literal_global_883);
  return (id)options_sOptions_884;
}
...
void __26__PPM2DeviceStats_options__block_invoke()
{
  ...
  v0 = (void *)options_sOptions_884;
  options_sOptions_884 = (uint64_t)&unk_1E7E5BE28;
