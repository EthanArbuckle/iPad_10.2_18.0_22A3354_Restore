...
- (id)description
{
  ...
  -[PPM2UniqueNamedEntitiesFound description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2UniqueNamedEntitiesFound dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)options
{
  if (options_once_2037 != -1)
    dispatch_once(&options_once_2037, &__block_literal_global_2038);
  return (id)options_sOptions_2039;
}
...
void __39__PPM2UniqueNamedEntitiesFound_options__block_invoke()
{
  ...
  v0 = (void *)options_sOptions_2039;
  options_sOptions_2039 = (uint64_t)&unk_1E7E5BE78;
