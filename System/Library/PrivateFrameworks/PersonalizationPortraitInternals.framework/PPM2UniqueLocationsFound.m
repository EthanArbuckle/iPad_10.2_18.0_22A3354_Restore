...
- (id)description
{
  ...
  -[PPM2UniqueLocationsFound description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2UniqueLocationsFound dictionaryRepresentation](self, "dictionaryRepresentation");
...
+ (id)options
{
  if (options_once_10495 != -1)
    dispatch_once(&options_once_10495, &__block_literal_global_10496);
  return (id)options_sOptions_10497;
}
...
void __35__PPM2UniqueLocationsFound_options__block_invoke()
{
  ...
  v0 = (void *)options_sOptions_10497;
  options_sOptions_10497 = (uint64_t)&unk_1E7E5BF18;
