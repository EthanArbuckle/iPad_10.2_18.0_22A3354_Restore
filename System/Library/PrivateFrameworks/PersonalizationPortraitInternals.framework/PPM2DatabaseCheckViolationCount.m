...
- (int)StringAsPragmaCheckType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("UnknownCheck")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("IntegrityCheck")) & 1) != 0)
  {
    v4 = 1;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("ForeignKeyCheck")))
  {
    v4 = 2;
  }
  else
...
- (id)description
{
  ...
  -[PPM2DatabaseCheckViolationCount description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2DatabaseCheckViolationCount dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("schemaVersion"));
  ...
  if ((has & 1) != 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("(unknown: %i)"), self->_pragmaCheckType);
      v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v7 = off_1E7E189C0[pragmaCheckType];
    }
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("pragmaCheckType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 24) & 2) == 0 || self->_schemaVersion != *((_DWORD *)v4 + 5))
      goto LABEL_14;
  }
...
LABEL_14:
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) == 0 || self->_pragmaCheckType != *((_DWORD *)v4 + 4))
      goto LABEL_14;
  }
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    v2 = 2654435761 * self->_schemaVersion;
    if ((*(_BYTE *)&self->_has & 1) != 0)
      goto LABEL_3;
LABEL_5:
    v3 = 0;
  ...
  if ((*(_BYTE *)&self->_has & 1) == 0)
    goto LABEL_5;
LABEL_3:
  v3 = 2654435761 * self->_pragmaCheckType;
  return v3 ^ v2 ^ -[NSString hash](self->_activeTreatments, "hash");
}
