...
- (id)description
{
  ...
  -[PPM2TopicInitialDonation description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[PPM2TopicInitialDonation dictionaryRepresentation](self, "dictionaryRepresentation");
