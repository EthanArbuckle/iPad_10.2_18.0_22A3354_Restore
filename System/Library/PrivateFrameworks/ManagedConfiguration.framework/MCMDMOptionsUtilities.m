...
{
  return (id)(id)CFPreferencesCopyAppValue(CFSTR("DefaultMDMOptions"), CFSTR("com.apple.managedconfiguration.notbackedup"));
}

+ (void)setDefaultMDMOptions:(id)a3
{
  CFPreferencesSetAppValue(CFSTR("DefaultMDMOptions"), a3, CFSTR("com.apple.managedconfiguration.notbackedup"));
