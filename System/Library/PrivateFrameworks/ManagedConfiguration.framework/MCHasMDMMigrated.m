@implementation MCHasMDMMigrated
...
void __MCHasMDMMigrated_block_invoke(uint64_t a1)
{
  ...
  if (!v5)
    goto LABEL_7;
  objc_msgSend(MEMORY[0x1E0CB38B0], "MCSafePropertyListWithData:options:format:error:", v5, 0, 0, 0);
...
LABEL_7:
  ...
  else
  {
    ...
    kMCMetaStopFilteringGrandfatheredRestrictions_block_invoke_2_migrationCheckQueueHasMDMMigrated = objc_msgSend(v7, "isEqualToString:", v11);
