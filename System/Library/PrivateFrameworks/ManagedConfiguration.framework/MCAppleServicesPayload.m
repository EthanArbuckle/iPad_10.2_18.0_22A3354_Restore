...
+ (id)typeStrings
{
  ...
  v3[0] = CFSTR("com.apple.security.appleservices");
...
+ (id)localizedSingularForm
{
  ...
  return MCLocalizedFormat(CFSTR("APPLE_SERVICES_DESCRIPTION_SINGULAR"), (uint64_t)a2, v2, v3, v4, v5, v6, v7, v9);
}
...
+ (id)localizedPluralForm
{
  ...
  return MCLocalizedFormat(CFSTR("APPLE_SERVICES_DESCRIPTION_PLURAL"), (uint64_t)a2, v2, v3, v4, v5, v6, v7, v9);
}

- (MCAppleServicesPayload)initWithDictionary:(id)a3 profile:(id)a4 outError:(id *)a5
{
  id v8;
  MCAppleServicesPayload *v9;
  void *v10;
  void *v11;
  id v12;
  uint64_t v13;
  ...
  v49 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveArrayOfClass:withKey:isRequired:outError:", objc_opt_class(), CFSTR("PinningAdditions"), 0, &v49);
  ...
  v14 = v13;
  v15 = *(_QWORD *)v46;
  v42 = *MEMORY[0x1E0CD7078];
  v41 = *MEMORY[0x1E0CD7080];
  v40 = v11;
  while (2)
  {
    for (i = 0; i != v14; ++i)
...
- (id)stubDictionary
{
  ...
  if (v4)
  {
    v5 = v4;
    v6 = *(_QWORD *)v18;
    v7 = *MEMORY[0x1E0CD7078];
    v8 = *MEMORY[0x1E0CD7080];
    do
    {
      v9 = 0;
      do
  ...
  objc_msgSend(v15, "setObject:forKeyedSubscript:", v3, CFSTR("PinningAdditions"));
  return v15;
}
...
- (id)subtitle1Label
{
  ...
  {
    if (v2 == (void *)1)
      v3 = CFSTR("APPLE_SERVICES_PINNING_ADDITION_SINGULAR");
    else
      v3 = CFSTR("APPLE_SERVICES_PINNING_ADDITION_PLURAL");
