...
+ (id)typeStrings
{
  return (id)objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObject:", CFSTR("com.apple.carddav.account"));
}
...
+ (id)localizedSingularForm
{
  ...
  return MCLocalizedFormat(CFSTR("CARDDAV_ACCOUNT_DESCRIPTION_SINGULAR_FORMAT"), (uint64_t)a2, v2, v3, v4, v5, v6, v7, v9);
}
...
+ (id)localizedPluralForm
{
  ...
  return MCLocalizedFormat(CFSTR("CARDDAV_ACCOUNT_DESCRIPTION_PLURAL_FORMAT"), (uint64_t)a2, v2, v3, v4, v5, v6, v7, v9);
}
...
- (MCCardDAVAccountPayload)initWithDictionary:(id)a3 profile:(id)a4 outError:(id *)a5
{
  ...
  v10 = -[MCPayload initWithDictionary:profile:outError:](&v59, sel_initWithDictionary_profile_outError_, v8, v9, a5);
  if (!v10)
    goto LABEL_20;
  v58 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVAccountDescription"), 0, &v58);
  ...
  if (v12)
    goto LABEL_11;
  v57 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVUsername"), 0, &v57);
  ...
  if (v12)
    goto LABEL_11;
  v56 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVPrincipalURL"), 0, &v56);
  ...
  if (v12)
    goto LABEL_11;
  v55 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveObjectOfClass:withKey:isRequired:outError:", objc_opt_class(), CFSTR("CardDAVUseSSL"), 0, &v55);
  ...
  v54 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveObjectOfClass:withKey:isRequired:outError:", objc_opt_class(), CFSTR("CardDAVPort"), 0, &v54);
  ...
  v53 = 0;
  objc_msgSend(v8, "MCValidateAndRemoveObjectOfClass:withKey:isRequired:outError:", objc_opt_class(), CFSTR("CommunicationServiceRules"), 0, &v53);
  v22 = (void *)objc_claimAutoreleasedReturnValue();
  v12 = v53;
  if (v12)
    goto LABEL_10;
  v52 = 0;
  +[MCCommunicationServiceRulesUtilities validatedCommunicationServiceRules:outError:](MCCommunicationServiceRulesUtilities, "validatedCommunicationServiceRules:outError:", v22, &v52);
  ...
  if (v12
    || (v51 = 0,
        objc_msgSend(v8, "MCValidateAndRemoveObjectOfClass:withKey:isRequired:outError:", objc_opt_class(), CFSTR("VPNUUID"), 0, &v51), v25 = objc_claimAutoreleasedReturnValue(), v12 = v51, VPNUUID = v10->_VPNUUID, v10->_VPNUUID = (NSString *)v25, VPNUUID, v12))
  {
LABEL_10:
...
LABEL_11:
  ...
  {
    v48 = 0;
    objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVHostName"), 0, &v48);
    ...
    if (v12)
      goto LABEL_10;
    v47 = 0;
    objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVAccountPersistentUUID"), 0, &v47);
    ...
    if (v12)
      goto LABEL_10;
    v46 = 0;
    objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("ACAccountIdentifier"), 0, &v46);
  ...
  {
    v50 = 0;
    objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVHostName"), 1, &v50);
    ...
    if (v12)
      goto LABEL_10;
    v49 = 0;
    objc_msgSend(v8, "MCValidateAndRemoveNonZeroLengthStringWithKey:isRequired:outError:", CFSTR("CardDAVPassword"), 0, &v49);
    v41 = objc_claimAutoreleasedReturnValue();
    v12 = v49;
    v42 = 112;
  }
...
- (id)stubDictionary
{
  ...
  if (accountDescription)
    objc_msgSend(v3, "setObject:forKey:", accountDescription, CFSTR("CardDAVAccountDescription"));
  hostname = self->_hostname;
  if (hostname)
    objc_msgSend(v4, "setObject:forKey:", hostname, CFSTR("CardDAVHostName"));
  username = self->_username;
  if (username)
    objc_msgSend(v4, "setObject:forKey:", username, CFSTR("CardDAVUsername"));
  principalURL = self->_principalURL;
  if (principalURL)
    objc_msgSend(v4, "setObject:forKey:", principalURL, CFSTR("CardDAVPrincipalURL"));
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", self->_useSSL);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setObject:forKey:", v9, CFSTR("CardDAVUseSSL"));

  if (self->_port)
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "setObject:forKey:", v10, CFSTR("CardDAVPort"));
  ...
  if (accountPersistentUUID)
    objc_msgSend(v4, "setObject:forKey:", accountPersistentUUID, CFSTR("CardDAVAccountPersistentUUID"));
...
- (id)restrictions
{
  ...
  -[MCCardDAVAccountPayload communicationServiceRules](self, "communicationServiceRules");
...
- (id)subtitle1Label
{
  ...
  -[MCCardDAVAccountPayload hostname](self, "hostname");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (v2)
    v3 = CFSTR("CARDDAV_SERVER_NAME_COLON");
  else
    v3 = CFSTR("CARDDAV_SERVER_NAME_MISSING");
...
- (id)subtitle2Label
{
  ...
  -[MCCardDAVAccountPayload username](self, "username");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  if (v3)
  {
    v4 = v3;
    ...
    if (v5)
    {
      MCLocalizedString(CFSTR("CARDDAV_USERNAME_COLON"));
      v3 = (void *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
...
- (BOOL)containsSensitiveUserInformation
{
  ...
  if (-[MCPayload containsSensitiveUserInformation](&v6, sel_containsSensitiveUserInformation))
    return 1;
  -[MCCardDAVAccountPayload password](self, "password");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = v4 != 0;
