...
{
  return objc_msgSend(a1, "MCErrorWithDomain:code:descriptionArray:suggestion:USEnglishSuggestion:underlyingError:errorType:", a3, a4, a5, 0, 0, 0, a6);
}

+ (uint64_t)MCErrorWithDomain:()MCExtension code:descriptionArray:underlyingError:errorType:
{
  return objc_msgSend(a1, "MCErrorWithDomain:code:descriptionArray:suggestion:USEnglishSuggestion:underlyingError:errorType:extraUserInfo:", a3, a4, a5, 0, 0, a6, a7, 0);
}
...
+ (id)MCErrorWithDomain:()MCExtension code:descriptionArray:suggestion:USEnglishSuggestion:underlyingError:errorType:extraUserInfo:
{
  ...
  {
    MCLocalizedErrorString(CFSTR("UNKNOWN_ERROR"));
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "setObject:forKey:", v28, *MEMORY[0x1E0CB2D50]);

    MCUSEnglishErrorString(CFSTR("UNKNOWN_ERROR"));
...
LABEL_7:
  ...
  if (!v15)
  {
    if (!v17)
      goto LABEL_20;
    objc_msgSend(v17, "MCFindPrimaryError");
    ...
    objc_msgSend(v29, "MCUSEnglishDescription");
...
LABEL_20:
  if (v18)
    objc_msgSend(v20, "setObject:forKey:", v18, CFSTR("MCErrorType"));
  if (v19)
...
- (id)MCVerboseDescription
{
  ...
  objc_msgSend(a1, "MCUSEnglishDescription");
  v10 = objc_claimAutoreleasedReturnValue();
  v11 = (void *)v10;
  if (v10)
    objc_msgSend(v5, "appendFormat:", CFSTR("US Desc: %@\n"), v10);
  v27 = v7;
  objc_msgSend(a1, "MCUSEnglishSuggestion");
  ...
  objc_msgSend(v15, "objectForKey:", CFSTR("MCErrorType"));
  ...
  objc_msgSend(v24, "removeObjectForKey:", CFSTR("MCErrorType"));
...
- (id)MCErrorType
{
  ...
  objc_msgSend(a1, "userInfo");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v1, "objectForKey:", CFSTR("MCErrorType"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
