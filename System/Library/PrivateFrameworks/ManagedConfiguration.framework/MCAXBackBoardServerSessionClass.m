@implementation MCAXBackBoardServerSessionClass
...
void __MCAXBackBoardServerSessionClass_block_invoke()
{
  ...
  URLForCanonicalFilePath(CFSTR("/System/Library/PrivateFrameworks/AccessibilityUtilities.framework"));
  v0 = (void *)objc_claimAutoreleasedReturnValue();
  v2[0] = MEMORY[0x1E0C809B0];
  v2[1] = 3221225472;
  v2[2] = __MCAXBackBoardServerSessionClass_block_invoke_2;
  v2[3] = &unk_1E41E30B8;
  v3 = CFSTR("AXBackBoardServer");
