...
{
  return objc_msgSend(*(id *)(a1 + 32), "_registerAsObserver");
}

uint64_t ____DaemonLaunchNotification_block_invoke_2(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "_connectEventConnection");
}

uint64_t ____DaemonLaunchNotification_block_invoke_3(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "_reconnectToDaemonWithCompletionBlock:", 0);
}
