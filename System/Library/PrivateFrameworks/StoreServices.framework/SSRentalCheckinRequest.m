...
{
  return -[SSRentalCheckinRequest initWithAccountIdentifier:rentalKeyIdentifier:](self, "initWithAccountIdentifier:rentalKeyIdentifier:", 0, 0);
}

- (SSRentalCheckinRequest)initWithAccountIdentifier:(id)a3 rentalKeyIdentifier:(id)a4
{
  SSRentalCheckinRequest *v7;
  void *v8;
  uint64_t v9;
...
- (void)startWithCompletionBlock:(id)a3
{
  ...
  v3[3] = &unk_1E47BA798;
  v3[4] = a3;
  -[SSRentalCheckinRequest startWithConnectionResponseBlock:](self, "startWithConnectionResponseBlock:", v3);
}
...
uint64_t __59__SSRentalCheckinRequest_startWithConnectionResponseBlock___block_invoke_2(_QWORD *a1)
{
