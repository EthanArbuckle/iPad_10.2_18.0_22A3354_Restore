...
LABEL_12:
  ...
  v19 = -[SSDownloadManagerAppShim initWithManagerOptions:](&v43, sel_initWithManagerOptions_, v4);
...
LABEL_12:
  -[SSDownloadManagerBookShim __book_downloadsForStati:overrideFinished:overrideFailed:](self, "__book_downloadsForStati:overrideFinished:overrideFailed:", v5, 0, 0);
...
LABEL_12:
  -[SSDownloadManagerBookShim __book_downloadsForStati:overrideFinished:overrideFailed:](self, "__book_downloadsForStati:overrideFinished:overrideFailed:", v7, a5 == 0, a5 != 0, v35);
...
- (void)cancelDownloads:(id)a3 completionBlock:(id)a4
{
  ...
  v9 = v6;
  v7 = v6;
  -[SSDownloadManagerBookShim __book_filterDownloads:withResult:](self, "__book_filterDownloads:withResult:", a3, v8);
...
- (void)moveDownload:(id)a3 afterDownload:(id)a4 completionBlock:(id)a5
{
  ...
  if ((IsBookToShimKind & 1) == 0 && (v14 & 1) == 0)
  {
    ...
    -[SSDownloadManagerAppShim moveDownload:afterDownload:completionBlock:](&v15, sel_moveDownload_afterDownload_completionBlock_, v8, v9, v10);
  }
...
- (void)moveDownload:(id)a3 beforeDownload:(id)a4 completionBlock:(id)a5
{
  ...
  if ((IsBookToShimKind & 1) == 0 && (v14 & 1) == 0)
  {
    v15.receiver = self;
    v15.super_class = (Class)SSDownloadManagerBookShim;
    -[SSDownloadManagerAppShim moveDownload:beforeDownload:completionBlock:](&v15, sel_moveDownload_beforeDownload_completionBlock_, v8, v9, v10);
  }
...
- (id)_copyDownloadsForMessage:(int64_t)a3 downloadIDs:(id)a4
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SSDownloadManagerBookShim;
  v5 = -[SSDownloadManagerAppShim _copyDownloadsForMessage:downloadIDs:](&v8, sel__copyDownloadsForMessage_downloadIDs_, a3, a4);
  -[SSDownloadManagerBookShim __book_getAllDownloads](self, "__book_getAllDownloads");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  if (objc_msgSend(v6, "count"))
...
- (void)_pauseDownloads:(id)a3 forced:(BOOL)a4 completionBlock:(id)a5
{
  ...
  v12 = a4;
  v9 = v8;
  -[SSDownloadManagerBookShim __book_filterDownloads:withResult:](self, "__book_filterDownloads:withResult:", a3, v10);
...
- (void)__book_cancelDownloads:(id)a3 completionBlock:(id)a4
{
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v17[0] = v11;
          v17[1] = 3221225472;
          v17[2] = __68__SSDownloadManagerBookShim___book_cancelDownloads_completionBlock___block_invoke;
          v17[3] = &unk_1E47BFFD0;
          v17[4] = self;
          v18 = v7;
  ...
  {
    -[SSDownloadManagerBookShim __book_dispatchBlock:withError:](self, "__book_dispatchBlock:withError:", v7, 0);
  }
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v17[0] = v11;
          v17[1] = 3221225472;
          v17[2] = __67__SSDownloadManagerBookShim___book_pauseDownloads_completionBlock___block_invoke;
          v17[3] = &unk_1E47BFFD0;
          v17[4] = self;
          v18 = v7;
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v17[0] = v11;
          v17[1] = 3221225472;
          v17[2] = __68__SSDownloadManagerBookShim___book_resumeDownloads_completionBlock___block_invoke;
          v17[3] = &unk_1E47BFFD0;
          v17[4] = self;
          v18 = v7;
...
- (id)__book_getAllDownloads
{
  ...
  -[SSDownloadManagerBookShim __book_downloadsForStati:overrideFinished:overrideFailed:](self, "__book_downloadsForStati:overrideFinished:overrideFailed:", v3, 0, 0);
