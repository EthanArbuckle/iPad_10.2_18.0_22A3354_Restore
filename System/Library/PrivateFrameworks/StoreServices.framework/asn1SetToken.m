...
- (id)_initWithID:(unint64_t)a3 class:(unsigned __int8)a4 length:(unint64_t)a5 content:(const char *)a6 opaque:(BOOL)a7
{
  ...
  result = -[asn1SetToken init](&v13, sel_init, a3, a4, a5, a6, a7);
  if (a3 != 17 || v9)
  {
    v12 = result;
    return 0;
...
- (id)description
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("SET Token. (length:%ld)"), self->super.mLength);
}
