...
{
  id v4;
  SSVPlayActivityEventContainerIDs *v5;
  uint64_t v6;
  ...
  v4 = a3;
  v5 = -[SSVPlayActivityEventContainerIDs init](self, "init");
  if (v5)
  {
    v5->_adamID = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("SSVPlayActivityEventContainerIDsAdamID"));
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("SSVPlayActivityEventContainerIDsCloudAlbumID"));
    v6 = objc_claimAutoreleasedReturnValue();
    cloudAlbumID = v5->_cloudAlbumID;
    v5->_cloudAlbumID = (NSString *)v6;

    v5->_cloudPlaylistID = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("SSVPlayActivityEventContainerIDsCloudPlaylistID"));
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("SSVPlayActivityEventContainerIDsGlobalPlaylistID"));
    v8 = objc_claimAutoreleasedReturnValue();
    globalPlaylistID = v5->_globalPlaylistID;
    v5->_globalPlaylistID = (NSString *)v8;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("SSVPlayActivityEventContainerIDsPlaylistVersionHash"));
    v10 = objc_claimAutoreleasedReturnValue();
    playlistVersionHash = v5->_playlistVersionHash;
    v5->_playlistVersionHash = (NSString *)v10;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("SSVPlayActivityEventContainerIDsStationHash"));
    v12 = objc_claimAutoreleasedReturnValue();
    stationHash = v5->_stationHash;
    v5->_stationHash = (NSString *)v12;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("SSVPlayActivityEventContainerIDsStationStringID"));
    v14 = objc_claimAutoreleasedReturnValue();
    stationStringID = v5->_stationStringID;
    v5->_stationStringID = (NSString *)v14;

    v5->_stationID = objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("SSVPlayActivityEventContainerIDsStationID"));
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  adamID = self->_adamID;
  v5 = a3;
  objc_msgSend(v5, "encodeInt64:forKey:", adamID, CFSTR("SSVPlayActivityEventContainerIDsAdamID"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_cloudAlbumID, CFSTR("SSVPlayActivityEventContainerIDsCloudAlbumID"));
  objc_msgSend(v5, "encodeInt64:forKey:", self->_cloudPlaylistID, CFSTR("SSVPlayActivityEventContainerIDsCloudPlaylistID"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_globalPlaylistID, CFSTR("SSVPlayActivityEventContainerIDsGlobalPlaylistID"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_playlistVersionHash, CFSTR("SSVPlayActivityEventContainerIDsPlaylistVersionHash"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_stationHash, CFSTR("SSVPlayActivityEventContainerIDsStationHash"));
  objc_msgSend(v5, "encodeObject:forKey:", self->_stationStringID, CFSTR("SSVPlayActivityEventContainerIDsStationStringID"));
  objc_msgSend(v5, "encodeInt64:forKey:", self->_stationID, CFSTR("SSVPlayActivityEventContainerIDsStationID"));
