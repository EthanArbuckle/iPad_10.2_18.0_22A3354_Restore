...
- (SSPromiseCompletionBlocks)init
{
  ...
  v2 = -[SSPromiseCompletionBlocks init](&v6, sel_init);
  if (v2)
  {
...
- (void)addSuccessBlock:(id)a3
{
  ...
  v7 = v4;
  v5 = v4;
  -[SSPromiseCompletionBlocks addCompletionBlock:](self, "addCompletionBlock:", v6);

}

- (void)addCompletionBlock:(id)a3
{
  SSPromiseCompletionBlocks *v4;
  NSMutableArray *completionBlocks;
  void *v6;
  id v7;
...
- (void)callSuccessBlock:(id)a3 withPromiseResult:(id)a4
{
  ...
  v9 = v6;
  v7 = v6;
  -[SSPromiseCompletionBlocks callCompletionBlock:withPromiseResult:](self, "callCompletionBlock:withPromiseResult:", v8, a4);
