...
- (void)appWillEnterForeground:(id)a3
{
  ...
  objc_msgSend(v6, "connectionWithServiceID:withGrade:", v7, -[DNSProxySetupListController vpnGrade](self, "vpnGrade"));
...
- (void)dealloc
{
  ...
  -[DNSProxySetupListController dealloc](&v6, sel_dealloc);
}

- (DNSProxySetupListController)init
{
  DNSProxySetupListController *v2;
  void *v3;
  void *v4;
  void *v5;
  objc_super v7;
  ...
  v2 = -[DNSProxySetupListController init](&v7, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x24BDD16D0], "defaultCenter");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[DNSProxySetupListController viewWillAppear:](&v10, sel_viewWillAppear_, v3);
  objc_destroyWeak(&location);
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  -[DNSProxySetupListController viewDidAppear:](&v3, sel_viewDidAppear_, a3);
}
...
- (void)setStateForServiceID:(id)a3
{
  ...
  -[DNSProxySetupListController setServiceID:](self, "setServiceID:", v5);
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[DNSProxySetupListController setVpnGrade:](self, "setVpnGrade:", objc_msgSend(v8, "unsignedIntegerValue"));
  ...
  if (v15)
  {
    ...
    -[DNSProxySetupListController setDisplayName:](self, "setDisplayName:", v10);

    objc_msgSend(v15, "objectForKey:", CFSTR("VPNApplicationName"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[DNSProxySetupListController setAppName:](self, "setAppName:", v11);

    objc_msgSend(v15, "objectForKey:", CFSTR("VPNIncludedBundleIDs"));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    -[DNSProxySetupListController setIncludedBundleIDs:](self, "setIncludedBundleIDs:", v12);

    objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.isa + v6), "userInfo");
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "objectForKey:", CFSTR("vpn-organization"));
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    -[DNSProxySetupListController setOrganization:](self, "setOrganization:", v14);
...
- (void)loadView
{
  ...
  -[DNSProxySetupListController loadView](&v5, sel_loadView);
  objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.isa + (int)*MEMORY[0x24BE757A8]), "userInfo");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "objectForKey:", CFSTR("vpn-service-id"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  -[DNSProxySetupListController setStateForServiceID:](self, "setStateForServiceID:", v4);
}
...
- (id)connection
{
  ...
  +[VPNConnectionStore sharedInstance](VPNConnectionStore, "sharedInstance");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[DNSProxySetupListController serviceID](self, "serviceID");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "connectionWithServiceID:withGrade:", v4, -[DNSProxySetupListController vpnGrade](self, "vpnGrade"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)statusForConnection:(id)a3
{
  ...
  -[DNSProxySetupListController connection](self, "connection", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
...
- (id)specifiers
{
  ...
  void *v22;
  uint64_t v23;
  DNSProxySetupListController *v24;
  uint64_t v25;
  uint64_t v26;
  unint64_t v27;
  uint64_t i;
  ...
  void *v37;
  void *v38;
  DNSProxySetupListController *v39;
  void *v40;
  void *v41;
  void *v42;
  void *v43;
  ...
  {
    -[DNSProxySetupListController displayName](self, "displayName");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[DNSProxySetupListController setTitle:](v2, "setTitle:", v3);
    ...
    -[DNSProxySetupListController includedBundleIDs](v2, "includedBundleIDs");
          ...
          do
          {
            for (i = 0; i != v25; ++i)
            {
              ...
              if (v34)
              {
                ...
                -[DNSProxySetupListController includedBundleIDs](v24, "includedBundleIDs");
  ...
  {
    -[DNSProxySetupListController navigationController](self, "navigationController");
