...
- (id)newSpecifiers
{
  ...
  objc_msgSend(v13, "localizedStringForKey:value:table:", CFSTR("CHOOSE_KEY_ACTION"), &stru_24E732B90, CFSTR("Keyboard"));
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  if (!v25)
  {
    v25 = (void *)objc_msgSend(objc_alloc(MEMORY[0x24BDF6F90]), "initWithFrame:", v26, v27, v28, v29);
