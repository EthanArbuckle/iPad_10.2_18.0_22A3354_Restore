...
- (void)dealloc
{
  ...
  -[TIHardwareKeyboardDetailController dealloc](&v3, sel_dealloc);
}
...
- (void)viewDidLoad
{
  ...
  -[TIHardwareKeyboardDetailController viewDidLoad](&v4, sel_viewDidLoad);
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  -[TIHardwareKeyboardDetailController viewWillAppear:](&v6, sel_viewWillAppear_, a3);
  v4 = (void *)-[TIHardwareKeyboardDetailController specifier](self, "specifier");
...
- (id)specifiers
{
  ...
  if (!result)
  {
    result = -[TIHardwareKeyboardDetailController newSpecifiers](self, "newSpecifiers");
...
- (id)newSpecifiers
{
  ...
  v3 = -[TIHardwareKeyboardDetailController inputMode](self, "inputMode");
  ...
  v28 = 0u;
  v29 = 0u;
  v6 = +[TIKeyboardListController inputModes](TIKeyboardListController, "inputModes");
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v19 = (void *)objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", +[TIKeyboardListController displayNameForHardwareLayout:inputMode:](TIKeyboardListController, "displayNameForHardwareLayout:inputMode:", v18, -[TIHardwareKeyboardDetailController uiKeyboardinputMode](self, "uiKeyboardinputMode")), self, 0, 0, 0, 3, 0);
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (objc_msgSend(v9, "length"))
      -[TIHardwareKeyboardDetailController setHardwareLayout:](self, "setHardwareLayout:", v9);
  }
}
...
- (UIKeyboardInputMode)uiKeyboardinputMode
{
  ...
  if (!result)
  {
    ...
    v5 = (void *)-[TIHardwareKeyboardDetailController specifier](self, "specifier");
...
LABEL_4:
      ...
      do
      {
        ...
        if (-[NSString isEqualToString:](-[TIHardwareKeyboardDetailController inputMode](self, "inputMode"), "isEqualToString:", TIInputModeGetNormalizedIdentifier()))
        {
