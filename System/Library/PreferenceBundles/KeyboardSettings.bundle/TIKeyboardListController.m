...
- (void)viewDidLoad
{
  ...
  v3 = (void *)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController");
  if ((objc_opt_respondsToSelector() & 1) != 0)
    objc_msgSend(v3, "setDisableFloatingKeyboardFilter:", 1);
  v5.receiver = self;
  v5.super_class = (Class)TIKeyboardListController;
  -[TIKeyboardListController viewDidLoad](&v5, sel_viewDidLoad);
...
{
  TIKeyboardListController *v2;
  PSSpecifier *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)TIKeyboardListController;
  v2 = -[TIKeyboardListController init](&v5, sel_init);
  ...
  {
    v3 = (PSSpecifier *)(id)objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("ADD_NEW_KEYBOARD"), &stru_24E732B90, CFSTR("Keyboard")), v2, 0, 0, 0, 13, 0);
...
- (void)dealloc
{
  ...
  -[TIKeyboardListController dealloc](&v4, sel_dealloc);
}
...
- (void)updateEditButtonState
{
  ...
  v2 = (void *)-[TIKeyboardListController parentController](self, "parentController");
  if ((objc_opt_respondsToSelector() & 1) != 0)
...
_QWORD *__48__TIKeyboardListController_setEditing_animated___block_invoke(uint64_t a1)
{
  _QWORD *result;
...
{
  self->deletingRow = 1;
  -[TIKeyboardListController setEditing:animated:](self, "setEditing:animated:", 1, 1);
}

- (void)tableView:(id)a3 didEndEditingRowAtIndexPath:(id)a4
{
  if (-[TIKeyboardListController isEditing](self, "isEditing", a3, a4) && self->deletingRow)
    -[TIKeyboardListController setEditing:animated:](self, "setEditing:animated:", 0, 1);
  self->deletingRow = 0;
}
...
- (void)tableView:(id)a3 moveRowAtIndexPath:(id)a4 toIndexPath:(id)a5
{
  ...
  if (objc_msgSend(a4, "section", a3))
    objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1448], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TIKeyboardListController.m"), 277, CFSTR("Row moved from invalid section."));
  if (objc_msgSend(a5, "section"))
    objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1448], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("TIKeyboardListController.m"), 278, CFSTR("Row moved to an invalid section."));
  v9 = objc_msgSend(a4, "row") + 1;
  v10 = objc_msgSend(a5, "row") + 1;
  v11 = objc_alloc_init(MEMORY[0x24BDBCEB8]);
  v12 = (int)*MEMORY[0x24BE756E0];
  objc_msgSend(v11, "addObjectsFromArray:", *(Class *)((char *)&self->super.super.super.super.super.isa + v12));
  v13 = (void *)objc_msgSend(v11, "objectAtIndex:", v9);
  v14 = v13;
  objc_msgSend(v11, "removeObject:", v13);
  objc_msgSend(v11, "insertObject:atIndex:", v13, v10);

  *(Class *)((char *)&self->super.super.super.super.super.isa + v12) = (Class)v11;
  -[TIKeyboardListController _writeKeyboards](self, "_writeKeyboards");
}
...
- (id)specifierForExtensionInputMode:(id)a3
{
  ...
  v6 = (void *)objc_msgSend(MEMORY[0x24BDF6B40], "keyboardInputModeWithIdentifier:", a3);
  v24[0] = v6;
  ...
  v21 = 0u;
  v22 = 0u;
  v8 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "extensionInputModes");
  ...
  -[TIAddExtensionKeyboardController setParentController:](v17, "setParentController:", self);
  -[TIAddExtensionKeyboardController setSpecifier:](v17, "setSpecifier:", v5);
...
- (void)reloadSpecifiers
{
  ...
  {
    -[TIKeyboardListController updateEditButtonState](self, "updateEditButtonState");
    self->_newKeyboardsAdded = 0;
  }
  v4.receiver = self;
  v4.super_class = (Class)TIKeyboardListController;
  -[TIKeyboardListController reloadSpecifiers](&v4, sel_reloadSpecifiers);
  v3 = (-[TIKeyboardListController isEditing](self, "isEditing") & 1) != 0 || self->_numberOfEnabledKeyboards > 1;
...
- (id)specifiers
{
  ...
  -[TIKeyboardListController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("KEYBOARDS_SHORT"), &stru_24E732B90, CFSTR("Keyboard")));
  v21 = v3;
  ...
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "_clearAllExtensionsIfNeeded");
  obj = (id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledInputModeIdentifiers");
  v5 = 0;
  ...
  do
  {
    for (i = 0; i != v7; ++i)
    {
      ...
      if (objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "identifierIsValidSystemInputMode:", NormalizedIdentifier))
      {
        if (_os_feature_enabled_impl()
          && (unint64_t)objc_msgSend(MultilingualSetFromInputModes, "count") >= 2)
        {
          v14 = -[TIKeyboardListController specifierForMultilingualInputModes:](self, "specifierForMultilingualInputModes:", MultilingualSetFromInputModes);
        }
        else
        {
          v14 = -[TIKeyboardListController specifierForInputMode:](self, "specifierForInputMode:", v10);
        }
      ...
      {
        if (!objc_msgSend(MEMORY[0x24BDF6B40], "keyboardInputModeWithIdentifier:", v10))
          continue;
  ...
  while (v7);
LABEL_30:
  if ((self->deletingRow || (-[TIKeyboardListController isEditing](self, "isEditing") & 1) == 0)
    && !-[TIKeyboardListController allKeyboardsEnabled](self, "allKeyboardsEnabled")
  ...
  if ((v18 & 1) != 0)
  {
    if (-[TIKeyboardListController aboutPrivacyController](self, "aboutPrivacyController"))
      -[TIAboutKeyboardPrivacyController setSpecifier:](-[TIKeyboardListController aboutPrivacyController](self, "aboutPrivacyController"), "setSpecifier:", v16);
    else
      -[TIKeyboardListController setAboutPrivacyController:](self, "setAboutPrivacyController:", -[TIAboutKeyboardPrivacyController initWithGroupSpecifier:asHeader:inListController:]([TIAboutKeyboardPrivacyController alloc], "initWithGroupSpecifier:asHeader:inListController:", v16, 0, self));
  }
...
{
  -[TIAboutKeyboardPrivacyController addPrivacyLinkViewIfNecessaryToHeaderView:forSection:](-[TIKeyboardListController aboutPrivacyController](self, "aboutPrivacyController", a3), "addPrivacyLinkViewIfNecessaryToHeaderView:forSection:", a4, a5);
}
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v6 = -[TIKeyboardListController tableView:cellForRowAtIndexPath:](&v9, sel_tableView_cellForRowAtIndexPath_, a3);
  v7 = (void *)-[TIKeyboardListController specifierAtIndex:](self, "specifierAtIndex:", -[TIKeyboardListController indexForIndexPath:](self, "indexForIndexPath:", a4));
...
{
  TIAddKeyboardLanguageListSetupController *v5;
  ...
  -[TIKeyboardListController showController:](self, "showController:", v5);
}
...
- (void)_writeKeyboards
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.isa + *(int *)(v8 + 2096)), "containsObject:", v12))
        {
          if (_os_feature_enabled_impl())
          {
            v13 = v7;
  ...
  if (-[TIKeyboardListController allKeyboardsEnabled](self, "allKeyboardsEnabled"))
  {
    if (self->_addNewInputModeSpecifier)
    {
      -[TIKeyboardListController removeSpecifier:animated:](self, "removeSpecifier:animated:", self->_groupSeparator, 1);
      -[TIKeyboardListController removeSpecifier:animated:](self, "removeSpecifier:animated:", self->_addNewInputModeSpecifier, 1);
    }
  }
}
...
- (void)tableView:(id)a3 commitEditingStyle:(int64_t)a4 forRowAtIndexPath:(id)a5
{
  ...
  if (a4 == 1)
  {
    ...
    -[TIKeyboardListController removeInputModeWithIdentifier:](self, "removeInputModeWithIdentifier:", objc_msgSend(v6, "propertyForKey:", *MEMORY[0x24BE75AC0]));
    -[TIKeyboardListController removeSpecifier:animated:](self, "removeSpecifier:animated:", v6, 1);
    -[TIKeyboardListController updateEditButtonState](self, "updateEditButtonState");
    if (-[TIKeyboardListController isEditing](self, "isEditing") && self->_numberOfEnabledKeyboards == 1)
      -[TIKeyboardListController setEditing:animated:](self, "setEditing:animated:", 0, 1);
    else
      -[TIKeyboardListController reloadSpecifiers](self, "reloadSpecifiers");
  }
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)TIKeyboardListController;
  -[TIKeyboardListController viewWillAppear:](&v5, sel_viewWillAppear_, a3);
  -[TIKeyboardListController reloadSpecifiers](self, "reloadSpecifiers");
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)TIKeyboardListController;
  -[TIKeyboardListController viewDidAppear:](&v4, sel_viewDidAppear_, a3);
  -[TIKeyboardListController emitNavigationEventForKeyboardListController](self, "emitNavigationEventForKeyboardListController");
}
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)TIKeyboardListController;
  -[TIKeyboardListController viewWillDisappear:](&v5, sel_viewWillDisappear_, v3);
}
...
+ (id)inputModes
{
  return (id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledInputModeIdentifiers");
}
...
+ (void)setInputModes:(id)a3
{
  ...
  v4 = (void *)objc_msgSend(MEMORY[0x24BDF6B38], "sharedInstance");
...
+ (id)supportedBaseInputModesForLanguage:(id)a3
{
  ...
  if (!a3)
    return 0;
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "_clearAllExtensions");
...
+ (id)softwareLayoutsForBaseInputMode:(id)a3
{
  ...
  else if (TIInputModeIsChineseShuangpin())
  {
...
+ (id)availableInputModesForLanguage:(id)a3
{
  ...
  v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledInputModeIdentifiers");
...
+ (id)availableSoftwareLayoutsForBaseInputMode:(id)a3
{
  ...
  if (TIInputModeIsChineseShuangpin())
    v4 = (id)objc_msgSend(TIFilteredLayoutsByCurrentShuangpinType(v4), "mutableCopy");
  v14 = 0u;
  v15 = 0u;
  v13 = 0u;
...
+ (id)displayNameForHardwareLayout:(id)a3 inputMode:(id)a4
{
  ...
  {
    v6 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Automatic"), &stru_24E732B90, CFSTR("KeyboardLayouts"));
    v5 = (id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "hardwareLayoutToUseForInputMode:", a4);
  }
  else
  {
    v6 = 0;
  ...
  if (displayNameForHardwareLayout_inputMode____keyboardLayoutsBundle
    || (v8 = (void *)objc_msgSend((id)MEMORY[0x2276700E8](), "stringByAppendingPathComponent:", CFSTR("System/Library/KeyboardLayouts/USBKeyboardLayouts.bundle")), v7 = (id)objc_msgSend(MEMORY[0x24BDD1488], "bundleWithPath:", objc_msgSend(v8, "stringByResolvingSymlinksInPath")), (displayNameForHardwareLayout_inputMode____keyboardLayoutsBundle = (uint64_t)v7) != 0)|| (NSLog(CFSTR("%s: Error: could not locate bundle at '%@'"), "+[TIKeyboardListController displayNameForHardwareLayout:inputMode:]", v8), (v7 = (id)displayNameForHardwareLayout_inputMode____keyboardLayoutsBundle) != 0))
  {
    v5 = (id)objc_msgSend(v7, "localizedStringForKey:value:table:", v5, 0, CFSTR("InfoPlist"));
    if (v6)
      return (id)objc_msgSend(MEMORY[0x24BDD17C8], "localizedStringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("%@ — %@"), &stru_24E732B90, CFSTR("Automatic - <Resolved Keyboard Layout Name>")), v6, v5);
  }
  else if (v6)
  {
    return v6;
...
+ (id)attributedTitleForSymbolName:(id)a3 cellTitle:(id)a4
{
  ...
  if (a3)
  {
    ...
    {
      v8 = v7;
      if (objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6800], "sharedApplication"), "userInterfaceLayoutDirection") == 1)
  ...
  v9 = (id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6750], "defaultParagraphStyle"), "mutableCopy");
  v10 = objc_alloc(MEMORY[0x24BDF6780]);
  v11 = MEMORY[0x24BDBD1B8];
  v15[0] = (id)objc_msgSend(v10, "initWithTextAlignment:location:options:", 4, MEMORY[0x24BDBD1B8], 0.0);
  v15[1] = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDF6780]), "initWithTextAlignment:location:options:", 1, v11, 10.0);
  v15[2] = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDF6780]), "initWithTextAlignment:location:options:", 4, v11, 28.0);
...
+ (id)attributedStringForSymbolName:(id)a3
{
  ...
  v5 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6AC8], "systemImageNamed:", a3), "imageWithRenderingMode:", 2);
  if (!v5)
    return 0;
  v6 = v5;
  v7 = (id)objc_msgSend(objc_alloc(MEMORY[0x24BDF6768]), "initWithData:ofType:", 0, 0);
...
- (void)emitNavigationEventForKeyboardListController
{
  ...
  v3 = objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", CFSTR("settings-navigation://com.apple.Settings.General/Keyboard/KEYBOARDS"));
  ...
  v7[0] = v4;
  -[TIKeyboardListController pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:](self, "pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:", CFSTR("com.apple.graphic-icon.keyboard"), objc_msgSend(v5, "initWithKey:table:locale:bundleURL:", CFSTR("KEYBOARDS_SHORT"), CFSTR("Keyboard"), v6, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "bundleURL")), objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v7, 2), v3);
}
