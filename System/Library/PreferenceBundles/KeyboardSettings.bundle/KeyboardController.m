...
{
  -[KeyboardController setOfflineStatusForLanguage:](self, "setOfflineStatusForLanguage:", a3);
  -[KeyboardController reloadSpecifiers](self, "reloadSpecifiers");
}
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        if (objc_msgSend((id)objc_msgSend(v7, "objectForKeyedSubscript:", objc_msgSend(v12, "identifier")), "BOOLValue"))
        {
          ...
          if (!-[NSDictionary objectForKeyedSubscript:](-[KeyboardController offlineStatusForLanguage](self, "offlineStatusForLanguage"), "objectForKeyedSubscript:", objc_msgSend((id)objc_msgSend(v12, "identifier"), "stringByReplacingOccurrencesOfString:withString:", CFSTR("_"), CFSTR("-"))))
          {
            v13 = _AFPreferencesReplacementLanguageForLocalRecognizerLanguageCode();
            if (v13)
              -[NSDictionary objectForKeyedSubscript:](-[KeyboardController offlineStatusForLanguage](self, "offlineStatusForLanguage"), "objectForKeyedSubscript:", v13);
          }
...
- (KeyboardController)init
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)KeyboardController;
  v2 = -[KeyboardController init](&v10, sel_init);
  if (v2)
  {
    ...
    objc_msgSend(v5, "addObserver:selector:name:object:", v2, sel__dismissConfirmationSheet, *MEMORY[0x24BDF7528], 0);
    ...
    if (!v7)
      -[KeyboardController init].cold.1();
    ...
    if (AFOfflineDictationCapable())
      v2->_dictationOfflineStatusObserver = -[DictationOfflineStatusObserver initWithDelegate:]([DictationOfflineStatusObserver alloc], "initWithDelegate:", v2);
  }
  return v2;
}
...
- (void)dealloc
{
  ...
  -[KeyboardController dealloc](&v4, sel_dealloc);
}
...
- (id)readPreferenceValue:(id)a3
{
  ...
  {
    v6 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledInputModeIdentifiers");
  ...
  {
    v9 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledInputModeIdentifiers");
    v7 = (void *)MEMORY[0x24BDD16E0];
  ...
  return -[KeyboardController readPreferenceValue:](&v11, sel_readPreferenceValue_, a3);
}

uint64_t __42__KeyboardController_readPreferenceValue___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, _BYTE *a4)
{
  uint64_t result;
...
uint64_t __42__KeyboardController_readPreferenceValue___block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, _BYTE *a4)
{
  uint64_t result;
...
- (void)setKeyboardPreferenceValue:(id)a3 forSpecifier:(id)a4
{
  ...
  {
    v8 = (id)objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledInputModeIdentifiers"), "mutableCopy");
    if (v8)
    {
      v9 = v8;
      v10 = objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "normalizedEnabledInputModeIdentifiers"), "indexOfObject:", CFSTR("ja_JP-Kana"));
      if (v10 < objc_msgSend(v9, "count"))
      {
        ...
        +[TIKeyboardListController setInputModes:](TIKeyboardListController, "setInputModes:", v9);
      }
    }
  }
  else
  {
    ...
    else if (objc_msgSend(v7, "isEqualToString:", *MEMORY[0x24BDF7960]))
    {
      TIStatisticGetKey();
      objc_msgSend(a3, "BOOLValue");
  ...
  {
    v15 = -[KeyboardController containsSpecifier:](self, "containsSpecifier:", -[KeyboardController deleteWordSpecifier](self, "deleteWordSpecifier"));
    if (!objc_msgSend(a3, "BOOLValue") || (v15 & 1) != 0)
    {
      if ((objc_msgSend(a3, "BOOLValue") & 1) == 0 && ((v15 ^ 1) & 1) == 0)
      {
        ...
        -[KeyboardController removeSpecifier:animated:](self, "removeSpecifier:animated:", -[KeyboardController deleteWordSpecifier](self, "deleteWordSpecifier"), 1);
      }
    }
    else
    {
      -[KeyboardController deleteWordSpecifierIndex](self, "deleteWordSpecifierIndex");
      v16 = -[KeyboardController deleteWordSpecifierIndex](self, "deleteWordSpecifierIndex");
      v17 = objc_msgSend(-[KeyboardController specifiers](self, "specifiers"), "count");
      v18 = -[KeyboardController deleteWordSpecifier](self, "deleteWordSpecifier");
      if (v16 >= v17)
        -[KeyboardController addSpecifier:animated:](self, "addSpecifier:animated:", v18, 1);
      else
        -[KeyboardController insertSpecifier:atIndex:animated:](self, "insertSpecifier:atIndex:animated:", v18, -[KeyboardController deleteWordSpecifierIndex](self, "deleteWordSpecifierIndex"), 1);
    }
  }
  if (objc_msgSend((id)objc_msgSend(a4, "propertyForKey:", v14), "isEqualToString:", CFSTR("KeyboardPrediction")))
  {
    v19 = -[KeyboardController containsSpecifier:](self, "containsSpecifier:", -[KeyboardController inlineCompletionSpecifier](self, "inlineCompletionSpecifier"));
    if (!objc_msgSend(a3, "BOOLValue") || (v19 & 1) != 0)
    {
      if ((objc_msgSend(a3, "BOOLValue") & 1) == 0 && ((v19 ^ 1) & 1) == 0)
      {
        ...
        -[KeyboardController removeSpecifier:animated:](self, "removeSpecifier:animated:", -[KeyboardController inlineCompletionSpecifier](self, "inlineCompletionSpecifier"), 1);
      }
    }
    else
    {
      -[KeyboardController inlineCompletionSpecifierIndex](self, "inlineCompletionSpecifierIndex");
      v20 = -[KeyboardController inlineCompletionSpecifierIndex](self, "inlineCompletionSpecifierIndex");
      v21 = objc_msgSend(-[KeyboardController specifiers](self, "specifiers"), "count");
      v22 = -[KeyboardController inlineCompletionSpecifier](self, "inlineCompletionSpecifier");
      if (v20 >= v21)
        -[KeyboardController addSpecifier:animated:](self, "addSpecifier:animated:", v22, 1);
      else
        -[KeyboardController insertSpecifier:atIndex:animated:](self, "insertSpecifier:atIndex:animated:", v22, -[KeyboardController inlineCompletionSpecifierIndex](self, "inlineCompletionSpecifierIndex"), 1);
    }
  }
...
- (id)readKeyboardMathExpressionCompletionPreferenceValue:(id)a3
{
  ...
  v3 = (void *)objc_msgSend(MEMORY[0x24BEB4EA8], "sharedPreferencesController", a3);
  return (id)objc_msgSend(v3, "valueForPreferenceKey:", *MEMORY[0x24BEB50A0]);
}
...
- (id)readKeyboardAllowPaddlePreferenceValue:(id)a3
{
  ...
  objc_msgSend(a3, "propertyForKey:", *MEMORY[0x24BE75B50]);
...
- (void)setAutocorrectionPreferenceValue:(id)a3 forSpecifier:(id)a4
{
  ...
  if (!-[KeyboardController feedbackFeatureEnabled](self, "feedbackFeatureEnabled", a3, a4))
    goto LABEL_10;
  if (!KeyboardSettingsFeedbackLibraryCore_frameworkLibrary)
  {
    v12 = xmmword_24E732450;
    v13 = 0;
  ...
  *((_QWORD *)&v12 + 1) = &v12;
  ...
  {
    objc_msgSend(MEMORY[0x24BEB4D30], "getSupportedFeedbackLanguages");
    v7 = (void *)objc_msgSend(v6, "controller");
...
- (BOOL)feedbackFeatureEnabled
{
  ...
  if (feedbackFeatureEnabled_once_token != -1)
    dispatch_once(&feedbackFeatureEnabled_once_token, &__block_literal_global_163);
  ...
  if (IXACanLogMessageAtLevel())
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
      -[KeyboardController feedbackFeatureEnabled].cold.1(v2, v3);
  }
  return v2;
}
...
+ (id)singleActiveDisabledDictationLanguage
{
  ...
  v2 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "activeDictationSupportedInputModeIdentifiers");
  ...
  {
    v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController"), "preferencesActions");
    result = (id)objc_msgSend((id)objc_msgSend(v5, "valueForPreferenceKey:", *MEMORY[0x24BDF76E0]), "objectForKeyedSubscript:", objc_msgSend(v4, "firstObject"));
    if (!result)
      return result;
...
- (void)showDictationEnableDialogForSpecifier:(id)a3
{
  ...
  v7 = objc_msgSend(v5, "localizedStringForKey:value:table:", v6, &stru_24E732B90, CFSTR("Keyboard"));
  v13 = (void *)MEMORY[0x24BDBCE70];
  v14 = v7;
  if (objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF69C8], "currentDevice"), "sf_isiPad"))
    v8 = CFSTR("DICTATION_ENABLE_TITLE_IPAD");
  else
    v8 = CFSTR("DICTATION_ENABLE_TITLE_IPHONE");
  v9 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v8, &stru_24E732B90, CFSTR("Keyboard"));
  v10 = *MEMORY[0x24BE75990];
  v11 = *MEMORY[0x24BE75988];
  v12 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ENABLE_OK"), &stru_24E732B90, CFSTR("Keyboard"));
  objc_msgSend(a3, "setupWithDictionary:", objc_msgSend(v13, "dictionaryWithObjectsAndKeys:", v9, v10, v14, v11, v12, *MEMORY[0x24BE75980], objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ENABLE_CANCEL"), &stru_24E732B90, CFSTR("Keyboard")), *MEMORY[0x24BE75970], 0));
  -[KeyboardController showConfirmationViewForSpecifier:useAlert:swapAlertButtons:](self, "showConfirmationViewForSpecifier:useAlert:swapAlertButtons:", a3, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF69C8], "currentDevice"), "sf_isiPad"), 0);
}
...
- (void)showDictationDisabledDialogForSpecifier:(id)a3
{
  ...
  v13 = objc_msgSend(v5, "localizedStringForKey:value:table:", v6, &stru_24E732B90, CFSTR("Keyboard"));
  ...
  v8 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v7, &stru_24E732B90, CFSTR("Keyboard"));
  v9 = *MEMORY[0x24BE75990];
  v10 = *MEMORY[0x24BE75988];
  v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_DISABLE_OK"), &stru_24E732B90, CFSTR("Keyboard"));
  objc_msgSend(a3, "setupWithDictionary:", objc_msgSend(v12, "dictionaryWithObjectsAndKeys:", v8, v9, v13, v10, v11, *MEMORY[0x24BE75980], objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_DISABLE_CANCEL"), &stru_24E732B90, CFSTR("Keyboard")), *MEMORY[0x24BE75970], 0));
  -[KeyboardController showConfirmationViewForSpecifier:useAlert:swapAlertButtons:](self, "showConfirmationViewForSpecifier:useAlert:swapAlertButtons:", a3, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF69C8], "currentDevice"), "sf_isiPad"), 0);
}
...
- (void)setDictationEnabled:(id)a3 forSpecifier:(id)a4
{
  ...
  {
    -[KeyboardController showDictationEnableDialogForSpecifier:](self, "showDictationEnableDialogForSpecifier:", a4);
  }
  else if ((objc_msgSend((id)objc_msgSend(MEMORY[0x24BE09270], "sharedPreferences"), "dictationIsEnabled") & 1) != 0)
  {
    -[KeyboardController showDictationDisabledDialogForSpecifier:](self, "showDictationDisabledDialogForSpecifier:", a4);
  }
  else
  {
    -[KeyboardController dictationDisabledConfirmed:](self, "dictationDisabledConfirmed:", a4);
  }
}
...
- (void)dictationEnabledConfirmed:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0)
    {
      v7 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController"), "preferencesActions");
      v9 = v6;
      ...
      objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController"), "preferencesActions"), "synchronizePreferences");
    }
  }
  ...
  v8 = -[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier");
  if (v8)
    v3 = v8;
  if (-[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"))
  {
    -[KeyboardController insertSpecifier:afterSpecifier:animated:](self, "insertSpecifier:afterSpecifier:animated:", -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"), v3, 1);
    v3 = -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier");
  }
  if (-[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"))
  {
    -[KeyboardController insertSpecifier:afterSpecifier:animated:](self, "insertSpecifier:afterSpecifier:animated:", -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"), v3, 1);
    -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier");
  }
  -[KeyboardController reloadSpecifiers](self, "reloadSpecifiers");
}
...
- (void)dictationDisabledConfirmed:(id)a3
{
  ...
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BE09270], "sharedPreferences"), "synchronize");
  if (-[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"))
    -[KeyboardController removeSpecifier:animated:](self, "removeSpecifier:animated:", -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"), 1);
  if (-[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"))
    -[KeyboardController removeSpecifier:animated:](self, "removeSpecifier:animated:", -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"), 1);
  -[KeyboardController reloadSpecifiers](self, "reloadSpecifiers");
}
...
{
  -[KeyboardController presentedViewController](self, "presentedViewController");
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    -[KeyboardController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 0, 0);
  -[KeyboardController reloadSpecifierID:animated:](self, "reloadSpecifierID:animated:", CFSTR("Dictation"), 0);
}
...
+ (id)localizedStringForGeneralKeyboardSpecifier
{
  ...
  result = (id)localizedStringForGeneralKeyboardSpecifier_sKeyboardLocalizedString;
  if (!localizedStringForGeneralKeyboardSpecifier_sKeyboardLocalizedString)
  {
    v3 = objc_msgSend(MEMORY[0x24BDD1488], "bundleWithIdentifier:", CFSTR("com.apple.GeneralSettingsUI"));
    if (v3)
    {
      v4 = (void *)v3;
      v5 = objc_alloc(MEMORY[0x24BDD19B8]);
      result = (id)objc_msgSend(v5, "initWithKey:table:locale:bundleURL:", CFSTR("Keyboard"), CFSTR("General"), objc_msgSend(MEMORY[0x24BDBCEA0], "currentLocale"), objc_msgSend(v4, "bundleURL"));
    }
    else
    {
      result = +[KeyboardController localizedStringForKeyboardController](KeyboardController, "localizedStringForKeyboardController");
    }
...
+ (id)localizedStringForKeyboardController
{
  ...
  result = (id)localizedStringForKeyboardController_sKeyboardControllerTitleLocalizedString;
  if (!localizedStringForKeyboardController_sKeyboardControllerTitleLocalizedString)
  {
    v3 = objc_alloc(MEMORY[0x24BDD19B8]);
    v4 = objc_msgSend(MEMORY[0x24BDBCEA0], "currentLocale");
    result = (id)objc_msgSend(v3, "initWithKey:table:locale:bundleURL:", CFSTR("KEYBOARDS"), CFSTR("Keyboard"), v4, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "bundleURL"));
...
- (void)emitNavigationEventForRootController
{
  ...
  v3 = objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", CFSTR("settings-navigation://com.apple.Settings.General/Keyboard"));
  ...
  v5 = +[KeyboardController localizedStringForKeyboardController](KeyboardController, "localizedStringForKeyboardController");
  v6[0] = v4;
  -[KeyboardController pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:](self, "pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:", CFSTR("com.apple.graphic-icon.keyboard"), v5, objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v6, 1), v3);
}
...
+ (void)emitNavigationEventForSpecifier:(id)a3 viewController:(id)a4
{
  ...
  if (objc_msgSend(v6, "isSubclassOfClass:", objc_opt_class()))
  {
    ...
    {
      v8 = v7;
      v9 = objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("settings-navigation://com.apple.Settings.General/Keyboard/%@"), v7);
      v10 = objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", v9);
      v17[0] = CFSTR("ReachableKeyboard");
      v17[1] = CFSTR("HardwareKeyboard");
      v18[0] = CFSTR("REACHABLE_KEYBOARD");
      v18[1] = CFSTR("Hardware Keyboard");
      v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithObjects:forKeys:count:", v18, v17, 2), "objectForKeyedSubscript:", v8);
      if (v11)
      {
        v12 = v11;
        v13 = +[KeyboardController localizedStringForGeneralKeyboardSpecifier](KeyboardController, "localizedStringForGeneralKeyboardSpecifier");
        v14 = objc_alloc(MEMORY[0x24BDD19B8]);
        v15 = objc_msgSend(MEMORY[0x24BDBCEA0], "currentLocale");
        v16 = v13;
        objc_msgSend(a4, "pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:", CFSTR("com.apple.graphic-icon.keyboard"), objc_msgSend(v14, "initWithKey:table:locale:bundleURL:", v12, CFSTR("Keyboard"), v15, objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "bundleURL")), objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", &v16, 2), v10);
      }
    }
  }
}
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)KeyboardController;
  -[KeyboardController viewDidAppear:](&v4, sel_viewDidAppear_, a3);
  -[KeyboardController emitNavigationEventForRootController](self, "emitNavigationEventForRootController");
}
...
- (void)disableLockedDownPreferencesForGroup:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (objc_msgSend(v10, "isPreferenceKeyLockedDown:", *MEMORY[0x24BEB5090]))
      objc_msgSend(v8, "setProperty:forKey:", MEMORY[0x24BDBD1C0], *MEMORY[0x24BE75A18]);
    objc_msgSend(a3, "specifierForID:", CFSTR("KeyboardMathExpressionCompletion"));
    v11 = (void *)objc_msgSend(MEMORY[0x24BEB4EA8], "sharedPreferencesController");
    if (objc_msgSend(v11, "isPreferenceKeyLockedDown:", *MEMORY[0x24BEB50A0]))
      objc_msgSend(v8, "setProperty:forKey:", MEMORY[0x24BDBD1C0], *MEMORY[0x24BE75A18]);
  }
  else
  {
  ...
  v12 = objc_msgSend(a3, "specifierForID:", CFSTR("KeyboardCheckSpelling"));
  if (v12)
  {
    v13 = (void *)v12;
    v14 = (void *)objc_msgSend(MEMORY[0x24BEB4EA8], "sharedPreferencesController");
    if (objc_msgSend(v14, "isPreferenceKeyLockedDown:", *MEMORY[0x24BEB5078]))
      objc_msgSend(v13, "setProperty:forKey:", MEMORY[0x24BDBD1C0], *MEMORY[0x24BE75A18]);
  }
  v15 = objc_msgSend(a3, "specifierForID:", CFSTR("SmartTyping"));
  if (v15)
  {
    v16 = (void *)v15;
    v17 = (void *)objc_msgSend(MEMORY[0x24BEB4EA8], "sharedPreferencesController");
    if (objc_msgSend(v17, "isPreferenceKeyLockedDown:", *MEMORY[0x24BEB5118]))
      objc_msgSend(v16, "setProperty:forKey:", MEMORY[0x24BDBD1C0], *MEMORY[0x24BE75A18]);
  }
  v18 = objc_msgSend(a3, "specifierForID:", CFSTR("KeyboardContinuousPathEnabled"));
  if (v18)
  {
    v19 = (void *)v18;
    v20 = (void *)objc_msgSend(MEMORY[0x24BEB4EA8], "sharedPreferencesController");
    if (objc_msgSend(v20, "isPreferenceKeyLockedDown:", *MEMORY[0x24BEB5088]))
...
- (void)movePeriodShortcutPreferenceToEndAndAddFooterTextForGroup:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      objc_msgSend(v6, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("PERIOD_SHORTCUT_DESCRIPTION"), &stru_24E732B90, CFSTR("Keyboard")), *MEMORY[0x24BE75A68]);
      objc_msgSend(a3, "removeObject:", v5);
      objc_msgSend(a3, "addObject:", v5);
    }
  }
...
- (void)removeShuangpinPreferenceIfNotApplicableForGroup:(id)a3
{
  ...
  v12 = 0u;
  v13 = 0u;
  v4 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController", 0, 0), "enabledInputModeIdentifiers");
...
- (void)removeDialectPreferenceIfNotApplicableForGroup:(id)a3
{
  ...
  v13 = 0u;
  v14 = 0u;
  v4 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController", 0), "enabledInputModeIdentifiers");
...
LABEL_3:
    ...
    while (1)
    {
      ...
      {
        if ((objc_msgSend((id)MEMORY[0x22767007C](v9), "isEqualToString:", CFSTR("Hans")) & 1) != 0)
          break;
      }
      if (v6 == ++v8)
      {
...
- (void)addFooterTextForDialectSpecifierForGroup:(id)a3
{
  ...
  if (v3)
  {
    v4 = (void *)v3;
    v5 = (void *)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class());
    objc_msgSend(v4, "setProperty:forKey:", objc_msgSend(v5, "localizedStringForKey:value:table:", SFLocalizableWAPIStringKeyForKey(), &stru_24E732B90, CFSTR("Preferences_pinyin")), *MEMORY[0x24BE75CD0]);
  }
}
...
- (void)moveSpaceConfirmationPreferenceToEndAndAddFooterTextForGroup:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!objc_msgSend(v4, "propertyForKey:", *MEMORY[0x24BE75A68]))
    {
      ...
      {
        v8 = v7;
        objc_msgSend(v5, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("SPACE_CONFIRMATION_EXPLANATION"), &stru_24E732B90, CFSTR("Keyboard")), v6);
    ...
    if (v7)
    {
      ...
      if (v9 | objc_msgSend(a3, "specifierForID:", CFSTR("SpaceConfirmation")))
      {
        if (objc_msgSend(v8, "name"))
          v10 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_GROUP_TITLE"), &stru_24E732B90, CFSTR("Keyboard"));
        else
          v10 = 0;
...
+ (void)localizeAndSortPreferencesArray:(id)a3
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v8 + 1) + 8 * v7), "setName:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", objc_msgSend(*(id *)(*((_QWORD *)&v8 + 1) + 8 * v7), "name"), &stru_24E732B90, CFSTR("Keyboard")));
        ++v7;
      }
      while (v5 != v7);
  ...
  objc_msgSend(a3, "sortedArrayUsingComparator:", &__block_literal_global_279);
}
...
+ (id)localizedDisplayNameForInputMode:(id)a3 forDictation:(BOOL)a4
{
  ...
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "identifierIsValidSystemInputMode:", NormalizedIdentifier);
  return v5;
}
  ...
  if (v42)
  {
    ...
    do
    {
      for (j = 0; j != v42; ++j)
      {
        ...
        v26 = (void *)-[KeyboardController loadSpecifiersFromPlistName:target:](self, "loadSpecifiersFromPlistName:target:", *(_QWORD *)(*((_QWORD *)&v47 + 1) + 8 * j), self);
        v43 = 0u;
        v44 = 0u;
        v45 = 0u;
        v46 = 0u;
...
uint64_t __63__KeyboardController_mergePreferences_inputModesToPreferences___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v8 = objc_msgSend(v7, "isEqualToSet:", objc_msgSend(MEMORY[0x24BDBCF20], "setWithArray:", &unk_24E73DF40));
  if ((v8 & 1) != 0)
    return v8 ^ 1u;
...
- (id)addAllPreferencesToArray:(id)a3 mapPreferenceToInputMode:(id)a4
{
  ...
  v22 = 0u;
  v23 = 0u;
  v7 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "activeInputModes");
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        if (!objc_msgSend(v5, "member:", Variant))
        {
          ...
          -[KeyboardController loadPreferenceForInputModeIdentifier:keyboardInputMode:addNewPreferencesToArray:defaultPreferenceIdentifiers:additionalPreferenceIdentifiers:mapPreferenceToInputMode:](self, "loadPreferenceForInputModeIdentifier:keyboardInputMode:addNewPreferencesToArray:defaultPreferenceIdentifiers:additionalPreferenceIdentifiers:mapPreferenceToInputMode:", v13, v12, a3, v16, v4, a4);
        }
      }
...
{
  return +[KeyboardController compareUsingOrderInArray:withFirst:second:](KeyboardController, "compareUsingOrderInArray:withFirst:second:", *(_QWORD *)(a1 + 32), a2, a3);
}
...
- (id)sortPreferencesKeysByInputModeOrderAndCount:(id)a3 inputModes:(id)a4
{
  ...
  v7[1] = 3221225472;
  v7[2] = __77__KeyboardController_sortPreferencesKeysByInputModeOrderAndCount_inputModes___block_invoke;
  v7[3] = &unk_24E732418;
  v7[4] = a4;
...
int64_t __77__KeyboardController_sortPreferencesKeysByInputModeOrderAndCount_inputModes___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    if (v6 == v9)
      return +[KeyboardController compareUsingOrderInArray:withFirst:second:](KeyboardController, "compareUsingOrderInArray:withFirst:second:", *(_QWORD *)(a1 + 32), objc_msgSend(a2, "objectAtIndex:", 0), objc_msgSend(a3, "objectAtIndex:", 0));
  }
  return result;
}
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_msgSend(a5, "containsObject:", TIInputModeGetBaseLanguage())
           ...
           || (v14 = +[KeyboardController localizedDisplayNameForInputMode:forDictation:](KeyboardController, "localizedDisplayNameForInputMode:forDictation:", v13, v6)) != 0)&& (objc_msgSend(v8, "containsObject:", v14) & 1) == 0)
        {
...
- (id)loadAllKeyboardPreferences
{
  ...
  v3 = -[KeyboardController loadSpecifiersFromPlistName:target:](self, "loadSpecifiersFromPlistName:target:", CFSTR("Preferences_base"), self);
  if (!v3)
    return 0;
  v4 = v3;
  v5 = objc_msgSend(MEMORY[0x24BDBCED8], "dictionary");
  v6 = -[KeyboardController addAllPreferencesToArray:mapPreferenceToInputMode:](self, "addAllPreferencesToArray:mapPreferenceToInputMode:", v4, v5);
  v7 = -[KeyboardController groupPreferences:forMapping:inputModes:](self, "groupPreferences:forMapping:inputModes:", v4, v5, v6);
  if (!objc_msgSend((id)objc_msgSend(v7, "allKeys"), "count"))
    return 0;
  v8 = -[KeyboardController sortPreferencesKeysByInputModeOrderAndCount:inputModes:](self, "sortPreferencesKeysByInputModeOrderAndCount:inputModes:", v7, v6);
  v9 = -[KeyboardController mergePreferences:inputModesToPreferences:](self, "mergePreferences:inputModesToPreferences:", v8, v7);
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (v10 >= 2)
        {
          if ((v13 & 1) != 0)
          {
            v18 = +[KeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v16, 0, 0);
            goto LABEL_14;
          }
          if (v22 == v21)
          {
            v18 = (id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("All Keyboards"), &stru_24E732B90, CFSTR("Keyboard"));
LABEL_14:
            v19 = v18;
          }
          else
        ...
        v19 = 0;
LABEL_17:
        +[KeyboardController localizeAndSortPreferencesArray:](KeyboardController, "localizeAndSortPreferencesArray:", v17);
        ...
        if (objc_msgSend(v16, "count") == 1)
        {
          ...
          if (objc_msgSend((id)TIInputModeGetVariant(), "isEqualToString:", CFSTR("Pinyin")))
          {
            -[KeyboardController removeShuangpinPreferenceIfNotApplicableForGroup:](self, "removeShuangpinPreferenceIfNotApplicableForGroup:", v17);
            -[KeyboardController removeDialectPreferenceIfNotApplicableForGroup:](self, "removeDialectPreferenceIfNotApplicableForGroup:", v17);
            -[KeyboardController moveSpaceConfirmationPreferenceToEndAndAddFooterTextForGroup:](self, "moveSpaceConfirmationPreferenceToEndAndAddFooterTextForGroup:", v17);
          }
        }
        -[KeyboardController addFooterTextForDialectSpecifierForGroup:](self, "addFooterTextForDialectSpecifierForGroup:", v17);
        -[KeyboardController disableLockedDownPreferencesForGroup:](self, "disableLockedDownPreferencesForGroup:", v17);
        -[KeyboardController movePeriodShortcutPreferenceToEndAndAddFooterTextForGroup:](self, "movePeriodShortcutPreferenceToEndAndAddFooterTextForGroup:", v17);
        -[KeyboardController moveEnableDictationPreferenceToEndAndAddFooterTextForGroup:](self, "moveEnableDictationPreferenceToEndAndAddFooterTextForGroup:", v17);
...
- (void)addHardwareKeyboardAndShortcuts:(id)a3
{
  ...
  v7 = -[KeyboardController openShortcutsSpecifiers](self, "openShortcutsSpecifiers");
  if (v6)
    v8 = v6;
  else
    v8 = v5;
  ...
  if (v9)
    v5 = v9;
  if (-[KeyboardController _supportsReachableKeyboard](self, "_supportsReachableKeyboard"))
  {
    v10 = -[KeyboardController reachableKeyboardSpecifier](self, "reachableKeyboardSpecifier");
    objc_msgSend(a3, "ps_insertObject:afterObject:", v10, v5);
    v5 = (uint64_t)v10;
  }
  if (-[KeyboardController _supportsProKeyboard](self, "_supportsProKeyboard"))
    objc_msgSend(a3, "ps_insertObject:afterObject:", -[KeyboardController proKeyboardSpecifier](self, "proKeyboardSpecifier"), v5);
}
...
- (void)addDictationItems:(id)a3
{
  ...
  v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "activeDictationSupportedInputModeIdentifiers");
  ...
  {
    -[KeyboardController setDictationLanguageSpecifier:](self, "setDictationLanguageSpecifier:", 0);
  }
  else
  {
    v8 = (void *)MEMORY[0x24BE75590];
    v9 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Dictation Languages"), &stru_24E732B90, CFSTR("Dictation"));
    -[KeyboardController setDictationLanguageSpecifier:](self, "setDictationLanguageSpecifier:", objc_msgSend(v8, "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", v9, 0, 0, 0, objc_opt_class(), 1, 0));
    v10 = -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier");
  ...
  {
    -[KeyboardController setDictationAutoPunctuationSpecifier:](self, "setDictationAutoPunctuationSpecifier:", objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Auto-Punctuation"), &stru_24E732B90, CFSTR("Dictation")), self, sel_setAutoPunctuation_specifier_, sel_autoPunctuation_, 0, 6, 0));
    v11 = -[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier");
  ...
  {
    -[KeyboardController setDictationHardwareShortcutSpecifier:](self, "setDictationHardwareShortcutSpecifier:", -[KeyboardController dictationHWShortcutSpecifier](self, "dictationHWShortcutSpecifier"));
    if (-[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"))
    {
      v12 = -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier");
      v13 = -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier");
      v14 = a3;
      v15 = v12;
    }
    else
    {
      v16 = -[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier");
      v17 = -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier");
      if (v16)
      {
        v13 = -[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier");
        v14 = a3;
        v15 = v17;
      }
      else
...
- (id)specifiers
{
  ...
  {
    v4 = -[KeyboardController loadSpecifiersFromPlistName:target:](self, "loadSpecifiersFromPlistName:target:", CFSTR("Preferences"), self);
    if (v4)
    {
      v5 = (void *)v4;
      v6 = -[KeyboardController loadAllKeyboardPreferences](self, "loadAllKeyboardPreferences");
      if (v6)
      ...
      -[KeyboardController addHardwareKeyboardAndShortcuts:](self, "addHardwareKeyboardAndShortcuts:", v5);
      -[KeyboardController addEnabledExtensionSpecifiersToArray:](self, "addEnabledExtensionSpecifiersToArray:", v5);
      -[KeyboardController addFooterTextForStickers:](self, "addFooterTextForStickers:", v5);
      -[KeyboardController addDictationItems:](self, "addDictationItems:", v5);
      -[KeyboardController setDeleteWordSpecifier:](self, "setDeleteWordSpecifier:", objc_msgSend(v5, "specifierForID:", CFSTR("KeyboardContinuousPathDeleteWholeWord")));
      ...
      -[KeyboardController setInlineCompletionSpecifier:](self, "setInlineCompletionSpecifier:", objc_msgSend(v5, "specifierForID:", CFSTR("KeyboardInlineCompletion")));
      ...
      *(Class *)((char *)&self->super.super.super.super.super.super.isa + v3) = (Class)v5;
      -[KeyboardController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("KEYBOARDS"), &stru_24E732B90, CFSTR("Keyboard")));
      -[KeyboardController setSpecifierID:](self, "setSpecifierID:", CFSTR("Keyboard"));
...
- (void)addFooterTextForStickers:(id)a3
{
  ...
  if (v4 && v5 != 0x7FFFFFFFFFFFFFFFLL)
  {
    if (v5)
    {
      ...
      objc_msgSend(v7, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("SHOW_STICKERS_DESCRIPTION"), &stru_24E732B90, CFSTR("Keyboard")), *MEMORY[0x24BE75A68]);
...
- (void)addEnabledExtensionSpecifiersToArray:(id)a3
{
  ...
  v12 = 0u;
  v13 = 0u;
  v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController", 0), "activeInputModes");
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(a3, "addObjectsFromArray:", +[TIAddExtensionKeyboardController specifiersForExtensionInputMode:parentSpecifier:](TIAddExtensionKeyboardController, "specifiersForExtensionInputMode:parentSpecifier:", *(_QWORD *)(*((_QWORD *)&v10 + 1) + 8 * v9++), -[KeyboardController specifier](self, "specifier")));
      }
      while (v7 != v9);
...
- (id)hardwareKeyboardSpecifier
{
  ...
  v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("Hardware Keyboard"), &stru_24E732B90, CFSTR("Keyboard"));
  v5 = (void *)objc_msgSend(v3, "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", v4, self, 0, 0, objc_opt_class(), 2, 0);
  objc_msgSend(v5, "setProperty:forKey:", CFSTR("HardwareKeyboard"), *MEMORY[0x24BE75AC0]);
  return v5;
}
...
- (id)dictationHWShortcutSpecifier
{
  ...
  v3 = (void *)MEMORY[0x24BE75590];
  v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_SHORTCUT"), &stru_24E732B90, CFSTR("Dictation"));
...
{
  objc_msgSend((id)objc_msgSend((id)-[KeyboardController cachedCellForSpecifier:](self, "cachedCellForSpecifier:", a3), "valueLabel"), "setAttributedText:", +[TIDictationShortcutController attributedTitleForDictationShortcutValue:](TIDictationShortcutController, "attributedTitleForDictationShortcutValue:", (int)objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BEB4EA8], "sharedPreferencesController"), "valueForPreferenceKey:", CFSTR("HWKeyboardDictationShortcut")), "intValue")));
}
...
- (void)hardwareKeyboardAvailabilityChanged
{
  ...
  {
    if (!-[KeyboardController specifierForID:](self, "specifierForID:", CFSTR("HardwareKeyboard")))
      -[KeyboardController insertSpecifier:afterSpecifierID:animated:](self, "insertSpecifier:afterSpecifierID:animated:", -[KeyboardController hardwareKeyboardSpecifier](self, "hardwareKeyboardSpecifier"), CFSTR("KEYBOARDS"), 1);
    if (!-[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"))
      -[KeyboardController setDictationHardwareShortcutSpecifier:](self, "setDictationHardwareShortcutSpecifier:", -[KeyboardController dictationHWShortcutSpecifier](self, "dictationHWShortcutSpecifier"));
    v3 = -[KeyboardController specifierForID:](self, "specifierForID:", CFSTR("Dictation"));
    if (-[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"))
    {
      v4 = -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier");
    }
    else
    {
      if (!-[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier"))
      {
LABEL_13:
        -[KeyboardController insertSpecifier:afterSpecifier:animated:](self, "insertSpecifier:afterSpecifier:animated:", -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"), v3, 1);
        return;
      }
      v4 = -[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier");
    }
    v3 = (uint64_t)v4;
    goto LABEL_13;
  }
  -[KeyboardController removeSpecifierID:animated:](self, "removeSpecifierID:animated:", CFSTR("HardwareKeyboard"), 1);
  if (-[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"))
    -[KeyboardController removeSpecifier:animated:](self, "removeSpecifier:animated:", -[KeyboardController dictationHardwareShortcutSpecifier](self, "dictationHardwareShortcutSpecifier"), 1);
}
...
- (BOOL)_supportsReachableKeyboard
{
  ...
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6D38], "mainScreen"), "_referenceBounds");
  return (v2 > 320.0) & ~objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF69C8], "currentDevice"), "sf_isiPad");
}

- (id)getReachableKeybordSetting:(id)a3
{
  return (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInteger:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController", a3), "handBias"));
}

- (void)setReachableKeyboardSetting:(id)a3 specifier:(id)a4
{
  objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController", a3, a4), "setHandBias:", objc_msgSend(a3, "integerValue"));
}
...
- (id)selectSpecifier:(id)a3
{
  ...
  v4 = -[KeyboardController selectSpecifier:](&v6, sel_selectSpecifier_);
  +[KeyboardController emitNavigationEventForSpecifier:viewController:](KeyboardController, "emitNavigationEventForSpecifier:viewController:", a3, v4);
  return v4;
}
...
- (id)reachableKeyboardSpecifier
{
  ...
  v3 = (void *)MEMORY[0x24BE75590];
  v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("REACHABLE_KEYBOARD"), &stru_24E732B90, CFSTR("Keyboard"));
  ...
  objc_msgSend(v5, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("REACHABLE_EXPLANATION"), &stru_24E732B90, CFSTR("Keyboard")), *MEMORY[0x24BE75CD0]);
  v7[0] = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("REACHABLE_OPTION_NONE"), &stru_24E732B90, CFSTR("Keyboard"));
  v7[1] = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("REACHABLE_OPTION_LEFT"), &stru_24E732B90, CFSTR("Keyboard"));
  v7[2] = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("REACHABLE_OPTION_RIGHT"), &stru_24E732B90, CFSTR("Keyboard"));
  objc_msgSend(v5, "setValues:titles:", &unk_24E73DF58, objc_msgSend(MEMORY[0x24BDBCE30], "arrayWithObjects:count:", v7, 3));
  return v5;
}
...
- (BOOL)_supportsProKeyboard
{
  ...
  if (TIGetToggleFourOrFiveRowKeyboardValue_onceToken != -1)
    dispatch_once(&TIGetToggleFourOrFiveRowKeyboardValue_onceToken, &__block_literal_global_584);
  ...
  if (v2)
    LOBYTE(v2) = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF69C8], "currentDevice"), "sf_isiPad");
  return v2;
}
...
- (id)getProKeyboardSetting:(id)a3
{
  ...
  v3 = (void *)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController", a3);
  if ((objc_opt_respondsToSelector() & 1) != 0)
...
- (void)setProKeyboardSetting:(id)a3 specifier:(id)a4
{
  ...
  v5 = (void *)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController", a3, a4);
  if ((objc_opt_respondsToSelector() & 1) != 0)
...
{
  return (id)objc_msgSend(MEMORY[0x24BE75590], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("PRO_KEYBOARD"), &stru_24E732B90, CFSTR("Keyboard")), self, sel_setProKeyboardSetting_specifier_, sel_getProKeyboardSetting_, 0, 6, 0);
}
...
- (NSArray)openShortcutsSpecifiers
{
  ...
  if (self->_openShortcutsSpecifiers
    || (v3 = (void *)MEMORY[0x24BE75590],
        v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("USER_DICTIONARY"), &stru_24E732B90, CFSTR("Keyboard")), v5 = (void *)objc_msgSend(v3, "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", v4, 0, 0, 0, objc_opt_class(), 2, 0), objc_msgSend(v5, "setProperty:forKey:", CFSTR("USER_DICTIONARY"), *MEMORY[0x24BE75AC0]), v6 = objc_alloc(MEMORY[0x24BDBCE30]), result = (NSArray *)objc_msgSend(v6,
                              "initWithObjects:",
                              objc_msgSend(MEMORY[0x24BE75590], "groupSpecifierWithName:", &stru_24E732B90),
                              v5,
                              0),
...
- (void)init
{
  ...
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", "NSString *getMCKeyboardSettingsChangedNotification(void)"), CFSTR("KeyboardController.m"), 64, CFSTR("%s"), dlerror());
  __break(1u);
}
...
- (void)feedbackFeatureEnabled
{
  ...
  *(_DWORD *)buf = 138412290;
  v4 = objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%s Feedback %@: RC_SEED_BUILD: 0 enabled: %d"), "-[KeyboardController feedbackFeatureEnabled]", CFSTR("KeyboardAutocorrection"), a1 & 1);
  _os_log_debug_impl(&dword_221678000, a2, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
}
