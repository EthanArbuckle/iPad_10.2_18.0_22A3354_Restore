...
- (id)isKeyboardEnabled:(id)a3
{
  ...
  v4 = +[TIKeyboardListController inputModes](TIKeyboardListController, "inputModes");
...
- (void)setKeyboardEnabled:(id)a3 specifier:(id)a4
{
  ...
  v7 = (id)objc_msgSend(+[TIKeyboardListController inputModes](TIKeyboardListController, "inputModes"), "mutableCopy");
  ...
  {
    v9 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B58], "sharedPreferencesController"), "preferencesActions");
  ...
  if (-[TIAddExtensionKeyboardController networkAccessSpecifier](-[TIKeyboardExtensionController addExtensionKeyboardController](self, "addExtensionKeyboardController"), "networkAccessSpecifier"))
  {
    ...
    {
      -[TIKeyboardExtensionController insertSpecifier:afterSpecifier:animated:](self, "insertSpecifier:afterSpecifier:animated:", -[TIAddExtensionKeyboardController networkAccessSpecifier](-[TIKeyboardExtensionController addExtensionKeyboardController](self, "addExtensionKeyboardController", 0x7FFFFFFFFFFFFFFFLL), "networkAccessSpecifier"), -[TIKeyboardExtensionController lastInputModeSpecifier](self, "lastInputModeSpecifier"), 1);
      -[TIAddExtensionKeyboardController updateNetworkPolicyState](-[TIKeyboardExtensionController addExtensionKeyboardController](self, "addExtensionKeyboardController"), "updateNetworkPolicyState");
    }
  }
}
...
- (id)specifiers
{
  ...
  if (!v24)
  {
    ...
    -[TIKeyboardExtensionController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("KEYBOARDS_SHORT"), &stru_24E732B90, CFSTR("Keyboard")));
    v24 = v3;
    ...
    v18 = +[TIKeyboardListController keyboardDisplayNameForIdentifier:](TIKeyboardListController, "keyboardDisplayNameForIdentifier:", objc_msgSend(v16, "identifier"));
    objc_msgSend(v17, "setProperty:forKey:", v18, *MEMORY[0x24BE75D50]);
    -[TIKeyboardExtensionController setAddExtensionKeyboardController:](v23, "setAddExtensionKeyboardController:", objc_alloc_init(TIAddExtensionKeyboardController));
    -[TIAddExtensionKeyboardController setSpecifier:](-[TIKeyboardExtensionController addExtensionKeyboardController](v23, "addExtensionKeyboardController"), "setSpecifier:", -[TIKeyboardExtensionController specifier](v23, "specifier"));
    -[TIAddExtensionKeyboardController setNetworkAccessSpecifierForKeyboardInputMode:](-[TIKeyboardExtensionController addExtensionKeyboardController](v23, "addExtensionKeyboardController"), "setNetworkAccessSpecifierForKeyboardInputMode:", v16);
    if ((v10 & 1) != 0
      && -[TIAddExtensionKeyboardController networkAccessSpecifier](-[TIKeyboardExtensionController addExtensionKeyboardController](v23, "addExtensionKeyboardController"), "networkAccessSpecifier"))
    {
    ...
    if (-[TIKeyboardExtensionController aboutPrivacyController](v23, "aboutPrivacyController"))
      -[TIAboutKeyboardPrivacyController setSpecifier:](-[TIKeyboardExtensionController aboutPrivacyController](v23, "aboutPrivacyController"), "setSpecifier:", v22);
    else
      -[TIKeyboardExtensionController setAboutPrivacyController:](v23, "setAboutPrivacyController:", -[TIAboutKeyboardPrivacyController initWithGroupSpecifier:asHeader:inListController:]([TIAboutKeyboardPrivacyController alloc], "initWithGroupSpecifier:asHeader:inListController:", v22, 0, v23));
...
{
  -[TIAddExtensionKeyboardController updateNetworkPolicyState](-[TIKeyboardExtensionController addExtensionKeyboardController](self, "addExtensionKeyboardController", a3), "updateNetworkPolicyState");
  -[TIAboutKeyboardPrivacyController addPrivacyLinkViewIfNecessaryToHeaderView:forSection:](-[TIKeyboardExtensionController aboutPrivacyController](self, "aboutPrivacyController"), "addPrivacyLinkViewIfNecessaryToHeaderView:forSection:", a4, a5);
}
...
+ (id)keyboardsForBundleID:(id)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController", 0), "extensionInputModes");
