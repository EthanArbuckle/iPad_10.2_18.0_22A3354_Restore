...
- (DictationFooterView)initWithSpecifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    v6 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_ABOUT_LINK"), &stru_24E732B90, CFSTR("Keyboard"));
    v7 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_MANAGE_STORAGE_LINK"), &stru_24E732B90, CFSTR("Keyboard"));
...
- (id)offlineExplanationSuffixTextWithOfflineDictationStatus:(id)a3 privacyLinkText:(id)a4
{
  ...
  if (objc_msgSend((id)v20[5], "count"))
  {
    ...
    v12 = objc_msgSend(v7, "localizedStringForKey:value:table:", v8, &stru_24E732B90, CFSTR("Keyboard"));
    v10 = objc_msgSend(v6, "stringWithFormat:", v12, +[KeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", objc_msgSend((id)v20[5], "allObjects"), 1, 0));
    if (v10)
      goto LABEL_9;
  }
  else if (*((_BYTE *)v16 + 24))
  {
    ...
    v10 = objc_msgSend(v9, "localizedStringForKey:value:table:", SFLocalizableWAPIStringKeyForKey(), &stru_24E732B90, CFSTR("Keyboard"));
    if (v10)
    {
LABEL_9:
      v11 = (void *)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), v10, a4);
      goto LABEL_10;
    }
  }
  v11 = 0;
...
uint64_t __94__DictationFooterView_offlineExplanationSuffixTextWithOfflineDictationStatus_privacyLinkText___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ((_DWORD)result)
  {
    v5 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledDictationLanguages");
...
- (id)explanationSuffixTextWithOfflineDictationStatus:(id)a3 privacyLinkText:(id)a4 lowStorage:(BOOL)a5
{
  ...
  v8 = (void *)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "activeDictationSupportedInputModeIdentifiers");
  ...
  if (objc_msgSend(v10, "count") == 1
    && DictationIsEnabled()
    && objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledDictationLanguages"), "containsObject:", objc_msgSend(v10, "firstObject")))
  {
    ...
    if (AFOfflineDictationStatusStringIsHighQualityModelSupported())
    {
      ...
      if (IsInstalled)
      {
        v19 = objc_msgSend(v18, "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_PRIVATE_PROCESSING"), &stru_24E732B90, CFSTR("Keyboard"));
        ...
        v31 = (id)objc_msgSend(v20, "localizedStringForKey:value:table:", v21, &stru_24E732B90, CFSTR("Keyboard"));
        v32 = a4;
        v30 = v19;
        v22 = CFSTR("%@ %@ %@");
        goto LABEL_28;
      }
      v25 = objc_msgSend(v18, "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER_WHEN_NECESSARY"), &stru_24E732B90, CFSTR("Keyboard"));
      v26 = v25;
      if (IsInstalling)
      {
        if (!a5)
...
LABEL_27:
          v31 = a4;
          v32 = (id)objc_msgSend(v27, "localizedStringForKey:value:table:", v28, &stru_24E732B90, CFSTR("Keyboard"));
          v30 = v26;
          v22 = CFSTR("%@ %@\n\n%@");
          goto LABEL_28;
        }
...
LABEL_28:
    ...
    v23 = (void *)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), objc_msgSend((id)objc_msgSend(MEMORY[0x24BDD1488], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", CFSTR("DICTATION_ON_DEVICE_SERVER"), &stru_24E732B90, CFSTR("Keyboard")), a4, v32);
  }
  else
  {
    v23 = 0;
...
+ (id)dictationAutoPunctuationText
{
  ...
  v7 = objc_msgSend((id)objc_msgSend(MEMORY[0x24BDF6B48], "sharedInputModeController"), "enabledDictationLanguages");
