...
{
  id v4;
  RAWOpcodeWarpFisheye *v5;
  const char *v6;
  uint64_t v7;
  uint64_t v8;
  RAWOpcodeWarpFisheye *v9;
  objc_super v11;

  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RAWOpcodeWarpFisheye;
  v5 = -[RAWOpcodeWarpFisheye init](&v11, sel_init);
  v9 = v5;
  if (v5)
...
- (id)outputImage
{
  ...
  objc_msgSend_kernelWithString_(MEMORY[0x1E0C9DD88], a2, (uint64_t)CFSTR("kernel vec4 rc_warp_fisheye (__sample c) { return c; }"),
    v2,
    v3);
