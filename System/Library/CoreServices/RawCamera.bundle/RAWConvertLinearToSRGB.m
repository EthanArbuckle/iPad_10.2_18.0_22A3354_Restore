...
- (id)outputImage
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1D527F000, v4, OS_SIGNPOST_INTERVAL_BEGIN, (os_signpost_id_t)self, "RAWConvertLinearToSRGB", (const char *)&unk_1D548AF1A, buf, 2u);
  }
  ...
  v6 = self->inputImage;
  objc_msgSend_kernelWithName_(RAWKernels, v7, (uint64_t)CFSTR("raw_linear_to_srgb"), v8, v9);
