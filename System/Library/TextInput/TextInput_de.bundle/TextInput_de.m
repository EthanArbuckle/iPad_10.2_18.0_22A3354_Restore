...
KB::InputManagerSpecialization_de *KB::InputManagerSpecialization_de::InputManagerSpecialization_de(KB::InputManagerSpecialization_de *this, const __CFLocale *a2)
{
  ...
  *(_QWORD *)v3 = &off_25011FDB0;
  *(_BYTE *)(v3 + 16) = 0;
  if (*(_QWORD *)(v3 + 8))
  {
    v4 = (const __CFString *)MEMORY[0x234901900]();
    if (v4)
    {
      if (CFStringCompare(v4, CFSTR("de_CH"), 0) == kCFCompareEqualTo)
        *((_BYTE *)this + 16) = 1;
    }
  }
  return this;
...
BOOL KB::InputManagerSpecialization_de::get_period_ends_sentence_after_word(KB::InputManagerSpecialization_de *this, const KB::String *a2)
{
  ...
  MEMORY[0x234901978](v13, 0, "0123456789.", 0, 0);
...
uint64_t KB::InputManagerSpecialization_de::do_filter_spellcheck_candidates(uint64_t a1, uint64_t a2)
{
  ...
  if (*(_QWORD *)a2 != result)
  {
    if (*v3)
    {
      result = KB::InputManagerSpecialization_de::has_umlaut((KB::InputManagerSpecialization_de *)result, (const KB::String *)(v3[1] + 240 * *v3 - 240));
      if ((result & 1) != 0)
        return result;
      v3 = *(_QWORD **)a2;
      result = *(_QWORD *)(a2 + 8);
    }
    while ((_QWORD *)result != v3)
      result = MEMORY[0x23490199C](result - 1000);
    *(_QWORD *)(a2 + 8) = v3;
  }
  return result;
}
...
uint64_t KB::InputManagerSpecialization_de::create_input_segment_filter@<X0>(uint64_t *a1@<X1>, uint64_t *a2@<X8>)
{
  uint64_t v3;
  uint64_t result;
...
void InputSegmentFilter_de::~InputSegmentFilter_de(InputSegmentFilter_de *this)
{
  ...
  *(_QWORD *)this = MEMORY[0x24BEB5A78] + 16;
...
{
  if ((a2 - 196) < 0x39 && ((0x104000101040001uLL >> (a2 + 60)) & 1) != 0)
    return 1;
  else
    return KB::InputSegmentFilter::character_is_digraph(this);
}
...
unsigned int *WTF::RefCounted<TI::Favonius::KeyboardLayout>::deref(unsigned int *result)
{
  ...
  if (v2 == 1)
  {
    ...
    return (unsigned int *)MEMORY[0x234901A20](v1, 0x10B0C409EA53459);
  }
  else
  {
    do
...
uint64_t WTF::RefCounted<TI::Favonius::Key>::deref(uint64_t result)
{
  ...
  if (v2 == 1)
  {
    if (*(unsigned __int16 *)(result + 40) >= 0xFu)
    {
      v3 = *(_QWORD *)(result + 48);
      if (v3)
        MEMORY[0x234901A08](v3, 0x1000C8077774924);
    }
...
{
  return __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_2322F0000);
}
...
void _GLOBAL__sub_I_TIKeyboardFeatureSpecialization_de_mm()
{
  ...
  v0 = (void *)MEMORY[0x234901A68]();
  __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_2322F0000);
...
uint64_t KB::InputSegmentFilter::character_is_digraph(KB::InputSegmentFilter *this)
{
  return MEMORY[0x24BEB59B0](this);
}

uint64_t KB::String::replace_char(KB::String *this, uint64_t a2, const KB::String *a3)
{
  return MEMORY[0x24BEB59F0](this, a2, a3);
}

uint64_t KB::String::find_first_not_of(KB::String *this, const KB::String *a2, const KB::String::iterator *a3)
{
  return MEMORY[0x24BEB59F8](this, a2, a3);
}
...
uint64_t operator delete()
{
  return off_25011FD28();
}

void *__cdecl operator new(size_t __sz)
{
  return (void *)off_25011FD30(__sz);
}

uint64_t operator new()
{
  return off_25011FD38();
}
