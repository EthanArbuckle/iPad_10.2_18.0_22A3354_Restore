...
- (id)locale
{
  return (id)objc_msgSend(objc_alloc(MEMORY[0x24BDBCEA0]), "initWithLocaleIdentifier:", CFSTR("zh-Hans"));
}
...
- (id)keyEventMap
{
  return (id)objc_msgSend(MEMORY[0x24BEB4D68], "sharedInstance");
}
...
- (BOOL)usesComposingInput
{
  ...
  LOBYTE(v2) = objc_msgSend(v4, "isEqualToString:", CFSTR("Pinyin-Simplified"));
  return (char)v2;
}
