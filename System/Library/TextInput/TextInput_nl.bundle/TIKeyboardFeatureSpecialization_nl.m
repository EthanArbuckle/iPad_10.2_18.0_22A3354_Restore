...
- (void)createInputManager
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)TIKeyboardFeatureSpecialization_nl;
  v3 = -[TIKeyboardQuickTypeSpecialization createInputManager](&v17, sel_createInputManager);
  ...
  v6->__vftable = (std::__shared_weak_count_vtbl *)&unk_251C8E728;
  v8 = KB::InputManagerSpecialization::InputManagerSpecialization((KB::InputManagerSpecialization *)&v6[1], v5);
  v6[1].__vftable = (std::__shared_weak_count_vtbl *)&unk_251C8E628;
  v15 = v8;
  v16 = v6;
  do
    v9 = __ldxr(p_shared_owners);
  while (__stxr(v9 + 1, p_shared_owners));
  TIInputManager::set_input_manager_specialization(v3, &v15);
  v10 = v16;
  if (v16)
  {
