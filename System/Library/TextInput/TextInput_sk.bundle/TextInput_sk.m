...
void _GLOBAL__sub_I_TIKeyboardFeatureSpecialization_sk_mm()
{
  ...
  v0 = (void *)MEMORY[0x2349032E8]();
  __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_232344000);
...
{
  return (void *)off_25012BDB8(__sz);
}
