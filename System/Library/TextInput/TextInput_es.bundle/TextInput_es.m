...
{
  this->__vftable = (std::__shared_weak_count_vtbl *)&unk_250120768;
  std::__shared_weak_count::~__shared_weak_count(this);
}

void std::__shared_ptr_emplace<KB::InputManagerSpecialization_es>::~__shared_ptr_emplace(std::__shared_weak_count *a1)
{
  a1->__vftable = (std::__shared_weak_count_vtbl *)&unk_250120768;
  std::__shared_weak_count::~__shared_weak_count(a1);
  JUMPOUT(0x234901D8CLL);
}
...
void KB::InputManagerSpecialization::create_input_segment_filter(_QWORD *a1@<X8>)
{
  ...
  if ((v2 & 1) == 0
  {
    __cxa_atexit((void (*)(void *))WTF::RefPtr<KB::InputSegmentFilter>::~RefPtr, &KB::InputManagerSpecialization::create_input_segment_filter(WTF::PassRefPtr<TI::Favonius::KeyboardLayout>)const::filter, &dword_2322F7000);
  }
...
unsigned int *WTF::RefCounted<TI::Favonius::KeyboardLayout>::deref(unsigned int *result)
{
  ...
  if (v2 == 1)
  {
    ...
    return (unsigned int *)MEMORY[0x234901D8C](v1, 0x10B0C409EA53459);
  }
  else
  {
    do
...
uint64_t WTF::RefCounted<TI::Favonius::Key>::deref(uint64_t result)
{
  ...
  if (v2 == 1)
  {
    if (*(unsigned __int16 *)(result + 40) >= 0xFu)
    {
      v3 = *(_QWORD *)(result + 48);
      if (v3)
        MEMORY[0x234901D74](v3, 0x1000C8077774924);
    }
...
void _GLOBAL__sub_I_TIKeyboardFeatureSpecialization_es_mm()
{
  ...
  v0 = (void *)MEMORY[0x234901DEC]();
  __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_2322F7000);
...
uint64_t operator delete()
{
  return off_2501206C8();
}

void *__cdecl operator new(size_t __sz)
{
  return (void *)off_2501206D0(__sz);
}

uint64_t operator new()
{
  return off_2501206D8();
}
