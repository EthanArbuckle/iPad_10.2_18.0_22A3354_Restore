...
unsigned int *WTF::RefCounted<TI::Favonius::KeyboardLayout>::deref(unsigned int *result)
{
  ...
  if (v2 == 1)
  {
    ...
    return (unsigned int *)MEMORY[0x234903944](v1, 0x10B0C409EA53459);
  }
  else
  {
    do
...
uint64_t WTF::RefCounted<TI::Favonius::Key>::deref(uint64_t result)
{
  ...
  if (v2 == 1)
  {
    if (*(unsigned __int16 *)(result + 40) >= 0xFu)
    {
      v3 = *(_QWORD *)(result + 48);
      if (v3)
        MEMORY[0x23490392C](v3, 0x1000C8077774924);
    }
...
void _GLOBAL__sub_I_TIKeyboardFeatureSpecialization_tr_mm()
{
  ...
  v0 = (void *)MEMORY[0x234903980]();
  __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_232350000);
  objc_autoreleasePoolPop(v0);
}

uint64_t KB::InputManagerSpecialization_tr::create_input_segment_filter@<X0>(uint64_t *a1@<X1>, uint64_t *a2@<X8>)
{
  uint64_t v3;
  uint64_t result;
...
uint64_t InputSegmentFilter_tr::swap_case(InputSegmentFilter_tr *this, int a2)
{
  if (a2 > 303)
  {
    if (a2 != 305)
    {
      if (a2 == 304)
        return 105;
      return KB::LayoutBasedInputSegmentFilter::swap_case(this);
    }
    return 73;
  }
  else
...
{
  return __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_232350000);
}
...
uint64_t KB::LayoutBasedInputSegmentFilter::swap_case(KB::LayoutBasedInputSegmentFilter *this)
{
  return MEMORY[0x24BEB59D8](this);
}
...
uint64_t operator delete()
{
  return off_25012D270();
}

void *__cdecl operator new(size_t __sz)
{
  return (void *)off_25012D278(__sz);
}

uint64_t operator new()
{
  return off_25012D280();
}
