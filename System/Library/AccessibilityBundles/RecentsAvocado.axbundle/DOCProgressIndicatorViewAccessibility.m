...
{
  return CFSTR("RecentsAvocado.DOCProgressIndicatorView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("RecentsAvocado.DOCProgressIndicatorView"), CFSTR("fractionCompleted"), "d", 0);
}
