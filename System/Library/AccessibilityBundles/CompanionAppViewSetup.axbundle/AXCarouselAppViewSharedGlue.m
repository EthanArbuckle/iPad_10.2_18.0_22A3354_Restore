...
uint64_t __60__AXCarouselAppViewSharedGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("CompanionAppViewSetup AX"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("CompanionAppViewSetup"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CSLPRFWatchChoiceViewAccessibility"), 1);
}
