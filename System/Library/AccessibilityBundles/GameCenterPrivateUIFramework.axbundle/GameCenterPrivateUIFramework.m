id AXGameCenterUIFrameworkLocString(void *a1)
{
  ...
  {
    objc_msgSend((id)AXGameCenterUIFrameworkLocString_bundle, "localizedStringForKey:value:table:", v1, &stru_2502142A0, CFSTR("GameCenterUIFrameworkAccessibility"));
...
id AXGameCenterPrivateUIFrameworkLocString(void *a1)
{
  ...
  {
    objc_msgSend((id)AXGameCenterPrivateUIFrameworkLocString_bundle, "localizedStringForKey:value:table:", v1, &stru_2502142A0, CFSTR("Accessibility"));
    v2 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
void sub_23262E34C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, ...)
{
  va_list va;
