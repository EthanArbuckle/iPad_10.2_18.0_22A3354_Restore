...
{
  return CFSTR("SKUIOnboardingCircleView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SKUIOnboardingCircleView"), CFSTR("UIView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIOnboardingCircleView"), CFSTR("titleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("PKPhysicsBody"), CFSTR("applyForce:"), "v", "{CGPoint=dd}", 0);
  objc_msgSend(v3, "validateClass:", CFSTR("SKUIPhysicalCirclesView"));
...
- (id)accessibilityPath
{
  ...
  -[SKUIOnboardingCircleViewAccessibility accessibilityFrame](self, "accessibilityFrame");
  x = v10.origin.x;
  y = v10.origin.y;
...
- (BOOL)_accessibilityScrollToVisible
{
  ...
  v17 = 0;
  -[SKUIOnboardingCircleViewAccessibility superview](self, "superview");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  __UIAccessibilitySafeClass();
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  -[SKUIOnboardingCircleViewAccessibility frame](self, "frame");
  v6 = v5;
  v8 = v7;
  v10 = v9;
  v12 = v11;
...
{
  return objc_msgSend(*(id *)(a1 + 32), "applyForce:", dbl_230C42290[*(double *)(a1 + 40) < 0.0], *(double *)(MEMORY[0x24BDBEFB0] + 8));
}
...
- (id)accessibilityLabel
{
  ...
  -[SKUIOnboardingCircleViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("titleLabel"));
...
- (id)accessibilityCustomActions
{
  ...
  accessibilitySKUILocalizedString(CFSTR("remove.circle.action"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)accessibilityValue
{
  ...
  -[SKUIOnboardingCircleViewAccessibility _accessibilityPhysicalCirclesViewSuperview](self, "_accessibilityPhysicalCirclesViewSuperview");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  -[SKUIOnboardingCircleViewAccessibility _accessibilityActivateCircle](self, "_accessibilityActivateCircle");
  return 1;
}

- (id)accessibilityHint
{
  return accessibilitySKUILocalizedString(CFSTR("circle.hint"));
}
