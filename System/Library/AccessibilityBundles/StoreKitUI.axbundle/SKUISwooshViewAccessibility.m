...
- (void)setTitle:(id)a3
{
  ...
  -[SKUISwooshViewAccessibility setTitle:](&v5, sel_setTitle_, a3);
  -[SKUISwooshViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_titleLabel"));
