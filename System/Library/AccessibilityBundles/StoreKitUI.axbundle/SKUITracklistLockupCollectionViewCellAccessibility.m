...
{
  return CFSTR("SKUITracklistLockupCollectionViewCell");
}
...
- (id)accessibilityLabel
{
  ...
  -[SKUITracklistLockupCollectionViewCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("contentView"));
  ...
  if (v34)
  {
    ...
    while (1)
    {
      ...
      do
      {
        ...
        NSClassFromString(CFSTR("SKUIBarRatingView"));
        if ((objc_opt_isKindOfClass() & 1) != 0)
        {
          accessibilitySKUILocalizedString(CFSTR("popularity"));
