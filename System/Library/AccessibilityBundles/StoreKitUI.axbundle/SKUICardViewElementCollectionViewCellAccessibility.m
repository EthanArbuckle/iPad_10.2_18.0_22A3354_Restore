...
{
  return CFSTR("SKUICardViewElementCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:", CFSTR("SKUIStackListCollectionViewCell"));
}
...
- (id)_axLockupElements
{
  ...
  objc_opt_class();
  -[SKUICardViewElementCollectionViewCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("allExistingViews"));
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) != 0
          || (NSClassFromString(CFSTR("SKUIHorizontalListView")), (objc_opt_isKindOfClass() & 1) != 0)
          || (NSClassFromString(CFSTR("SKUIAttributedStringView")), (objc_opt_isKindOfClass() & 1) != 0)
          || (NSClassFromString(CFSTR("SKUIStyledButton")), (objc_opt_isKindOfClass() & 1) != 0)
          || (NSClassFromString(CFSTR("SKUIStackListCollectionViewCell")), (objc_opt_isKindOfClass() & 1) != 0))
        {
...
- (id)accessibilityLabel
{
  ...
  v20 = 0u;
  v21 = 0u;
  -[SKUICardViewElementCollectionViewCellAccessibility _axLockupElements](self, "_axLockupElements");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!objc_msgSend(v6, "length"))
  {
    -[SKUICardViewElementCollectionViewCellAccessibility _axAdornedImageElement](self, "_axAdornedImageElement");
    v13 = (void *)objc_claimAutoreleasedReturnValue();

    if (v13)
    {
      accessibilitySKUILocalizedString(CFSTR("play"));
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (-[SKUICardViewElementCollectionViewCellAccessibility pointInside:withEvent:](self, "pointInside:withEvent:", v7, x, y))
  {
    ...
    v17 = 0u;
    v18 = 0u;
    -[SKUICardViewElementCollectionViewCellAccessibility _accessibilitySupplementaryFooterViews](self, "_accessibilitySupplementaryFooterViews");
    ...
    -[SKUICardViewElementCollectionViewCellAccessibility _accessibilityHitTest:withEvent:](&v16, sel__accessibilityHitTest_withEvent_, v7, x, y);
    v14 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (BOOL)accessibilityActivate
{
  ...
  if (!v3)
    return 0;
  -[SKUICardViewElementCollectionViewCellAccessibility _accessibilityFindPlayButton](self, "_accessibilityFindPlayButton");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
          ...
          if (v11)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                if ((objc_opt_isKindOfClass() & 1) == 0
                  || (NSClassFromString(CFSTR("SKUIImageView")), (objc_opt_isKindOfClass() & 1) == 0))
                {
...
- (CGPoint)accessibilityActivationPoint
{
  ...
  else
  {
    ...
    -[SKUICardViewElementCollectionViewCellAccessibility accessibilityActivationPoint](&v11, sel_accessibilityActivationPoint);
  }
  result.y = v10;
  result.x = v9;
  return result;
...
- (unint64_t)accessibilityTraits
{
  ...
  return *MEMORY[0x24BDF73B0] | -[SKUICardViewElementCollectionViewCellAccessibility accessibilityTraits](&v3, sel_accessibilityTraits);
}
...
- (id)accessibilityCustomActions
{
  ...
  v14 = 0u;
  v15 = 0u;
  -[SKUICardViewElementCollectionViewCellAccessibility _axLockupElements](self, "_axLockupElements", 0);
  v2 = (void *)objc_claimAutoreleasedReturnValue();
