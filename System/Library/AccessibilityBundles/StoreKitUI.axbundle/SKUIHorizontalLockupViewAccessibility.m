...
{
  return CFSTR("SKUIHorizontalLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_layout"), "SKUIHorizontalLockupLayout");
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_viewElementViews"), "NSMapTable");
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_lockupElement"), "SKUILockupViewElement");
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIHorizontalLockupLayout"), CFSTR("columns"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIHorizontalLockupColumn"), CFSTR("childViewElements"), "@", 0);
  objc_msgSend(v3, "validateClass:", CFSTR("SKUIImageView"));
  objc_msgSend(v3, "validateClass:", CFSTR("SKUISectionHeaderView"));
  objc_msgSend(v3, "validateClass:", CFSTR("SKUITextBoxView"));
  objc_msgSend(v3, "validateClass:", CFSTR("SKUIStyledImageButton"));
  objc_msgSend(v3, "validateClass:", CFSTR("SKUIToggleButton"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_previewMediaURL"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_resolvePreviewStateAfterTransitionForFlipView:"), "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_previewState"), "NSInteger");
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_previewProgressIndicator"), "SKUIPreviewProgressIndicator");
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIHorizontalLockupView"), CFSTR("_previewFrontView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUILockupViewElement"), CFSTR("isSelectable"), "B", 0);
...
- (BOOL)isAccessibilityElement
{
  ...
  -[SKUIHorizontalLockupViewAccessibility accessibilityLabel](self, "accessibilityLabel");
...
- (BOOL)isAdvertisementView:(id)a3
{
  ...
  v3 = a3;
  NSClassFromString(CFSTR("SKUIStyledImageButton"));
  v4 = (objc_opt_isKindOfClass() & 1) != 0 && (objc_msgSend(v3, "conformsToProtocol:", &unk_255EAE8E8) & 1) != 0;
...
- (id)accessibilityLabel
{
  ...
  v64 = 0;
  -[SKUIHorizontalLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_layout"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  HIBYTE(v64) = 0;
  -[SKUIHorizontalLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_viewElementViews"));
...
LABEL_23:
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                ...
                objc_msgSend(v19, "_accessibilityFindSubviewDescendantsPassingTest:", &__block_literal_global_0);
                v20 = (id)objc_claimAutoreleasedReturnValue();

                goto LABEL_24;
              }
              NSClassFromString(CFSTR("SKUISectionHeaderView"));
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
                v21 = v17;
                v22 = &__block_literal_global_283;
                goto LABEL_22;
              }
              NSClassFromString(CFSTR("SKUITextBoxView"));
              if ((objc_opt_isKindOfClass() & 1) != 0)
              {
              ...
              {
                NSClassFromString(CFSTR("SKUIAttributedStringWrapperView"));
                if ((objc_opt_isKindOfClass() & 1) != 0)
                {
                  v21 = v17;
                  v22 = &__block_literal_global_288;
LABEL_22:
                  objc_msgSend(v21, "_accessibilityFindSubviewDescendantsPassingTest:", v22);
                  v18 = objc_claimAutoreleasedReturnValue();
                  goto LABEL_23;
                }
                NSClassFromString(CFSTR("SKUIHorizontalListView"));
                if ((objc_opt_isKindOfClass() & 1) != 0)
                {
                  v21 = v17;
                  v22 = &__block_literal_global_291;
                  goto LABEL_22;
                }
                v20 = 0;
              }
LABEL_24:
              ...
              v8 = -[SKUIHorizontalLockupViewAccessibility isAdvertisementView:](self, "isAdvertisementView:", v47) | v49;
              v16 = v48 + 1;
            }
            while (v48 + 1 != v46);
      ...
      if (!v40)
      {
        ...
        if ((v8 & 1) != 0)
        {
          accessibilitySKUILocalizedString(CFSTR("Ad"));
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  v7 = a4;
  -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryHeaderViews](self, "_accessibilitySupplementaryHeaderViews");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryFooterViews](self, "_accessibilitySupplementaryFooterViews");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  if (v8)
  {
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilityHitTest:withEvent:](&v19, sel__accessibilityHitTest_withEvent_, v7, x, y);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_13:
...
- (id)_accessibilitySupplementaryHeaderViews
{
  ...
  void *v24;
  void *v25;
  SKUIHorizontalLockupViewAccessibility *v26;
  void *v27;
  void *v28;
  id obj;
  uint64_t v31;
        ...
        if (v16)
        {
          ...
          do
          {
            for (i = 0; i != v17; ++i)
            {
              ...
              -[SKUIHorizontalLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", v9);
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0 && v21)
              {
                ...
                accessibilitySKUILocalizedString(CFSTR("preview.button"));
...
- (CGRect)accessibilityFrame
{
  ...
  -[SKUIHorizontalLockupViewAccessibility bounds](self, "bounds");
  v4 = v3;
  v15 = 0u;
  v16 = 0u;
  v17 = 0u;
  v18 = 0u;
  -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryFooterViews](self, "_accessibilitySupplementaryFooterViews", 0);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_accessibilitySupplementaryFooterViewsIncludePlayButton:(BOOL)a3 includeStyledImageButton:(BOOL)a4
{
  ...
  SKUIHorizontalLockupViewAccessibility *v25;
  void *v26;
  void *v27;
  void *v28;
  id obj;
          ...
          do
          {
            for (i = 0; i != v19; ++i)
            {
              ...
              if (objc_msgSend(v22, "isAccessibilityElement")
                && (NSClassFromString(CFSTR("SKUIStyledImageButton")), (objc_opt_isKindOfClass() & 1) != 0))
              {
                if (objc_msgSend(v22, "_accessibilityViewIsVisible"))
                {
                  if (!-[SKUIHorizontalLockupViewAccessibility isAdvertisementView:](self, "isAdvertisementView:", v22)
...
LABEL_27:
              ...
              else
              {
                ...
                if ((objc_opt_isKindOfClass() & 1) != 0 && (objc_msgSend(v22, "isAccessibilityElement") & 1) != 0
                  || (NSClassFromString(CFSTR("SKUIOfferView")), (objc_opt_isKindOfClass() & 1) != 0))
                {
                  objc_msgSend(v6, "addObject:", v22);
                }
                else
                {
                  NSClassFromString(CFSTR("SKUIVideoThumbnailView"));
                  if ((objc_opt_isKindOfClass() & 1) != 0
              ...
              NSClassFromString(CFSTR("SKUIToggleButton"));
              if ((objc_opt_isKindOfClass() & 1) != 0 && objc_msgSend(v22, "_accessibilityViewIsVisible"))
                objc_msgSend(v6, "axSafelyAddObject:", v22);
              if (v4)
              {
                NSClassFromString(CFSTR("SKUIPlayButton"));
                if ((objc_opt_isKindOfClass() & 1) != 0)
                {
                  if (objc_msgSend(v22, "_accessibilityViewIsVisible"))
                  {
  ...
  if (-[SKUIHorizontalLockupViewAccessibility safeIntegerForKey:](self, "safeIntegerForKey:", CFSTR("_previewState")) == 2)
  {
    -[SKUIHorizontalLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_previewProgressIndicator"));
    v28 = (void *)objc_claimAutoreleasedReturnValue();
    if (v28)
...
- (id)accessibilityElements
{
  ...
  if (-[SKUIHorizontalLockupViewAccessibility isAccessibilityElement](self, "isAccessibilityElement"))
  {
    v3 = 0;
  }
  else
  {
    -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:](self, "_accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:", 0, 1);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v3;
}
...
- (id)_accessibilityFindPlayButton
{
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:](self, "_accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:", 1, 1);
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
...
- (BOOL)_toggleButtonAction:(id)a3
{
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilityFindToggleButton](self, "_accessibilityFindToggleButton", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
    ...
    accessibilitySKUILocalizedString(CFSTR("activated.toggle"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "stringWithFormat:", v7, v5, v10, 3221225472, __61__SKUIHorizontalLockupViewAccessibility__toggleButtonAction___block_invoke, &unk_24FF2BD50);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)_styledImageButtonAction:(id)a3
{
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilityFindStyledImageButton](self, "_accessibilityFindStyledImageButton", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
...
- (BOOL)_playAction:(id)a3
{
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilityFindPlayButton](self, "_accessibilityFindPlayButton", a3);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
    v5 = objc_msgSend(v3, "accessibilityActivate");
...
- (id)accessibilityCustomActions
{
  ...
  objc_msgSend(MEMORY[0x24BDBCEB8], "array");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[SKUIHorizontalLockupViewAccessibility _accessibilityFindPlayButton](self, "_accessibilityFindPlayButton");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = v4;
  if (v4)
  {
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilityFindStyledImageButton](self, "_accessibilityFindStyledImageButton");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = v8;
  if (v8)
  {
    ...
    if (-[SKUIHorizontalLockupViewAccessibility isAdvertisementView:](self, "isAdvertisementView:", v9))
    {
      accessibilitySKUILocalizedString(CFSTR("about.Ad"));
  ...
  -[SKUIHorizontalLockupViewAccessibility _accessibilityFindToggleButton](self, "_accessibilityFindToggleButton");
...
- (id)_accessibilitySupplementaryFooterViews
{
  ...
  if (-[SKUIHorizontalLockupViewAccessibility isAccessibilityElement](self, "isAccessibilityElement")
    && (-[SKUIHorizontalLockupViewAccessibility _accessibilityFindPlayButton](self, "_accessibilityFindPlayButton"),
        ...
        !v3))
  {
    -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:](self, "_accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:", 0, _AXSAutomationEnabled() != 0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
{
  return -[SKUIHorizontalLockupViewAccessibility _accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:](self, "_accessibilitySupplementaryFooterViewsIncludePlayButton:includeStyledImageButton:", 1, 1);
}
...
- (unint64_t)accessibilityTraits
{
  ...
  v14 = -[SKUIHorizontalLockupViewAccessibility accessibilityTraits](&v10, sel_accessibilityTraits);
  -[SKUIHorizontalLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_lockupElement"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v9[3] = &unk_24FF2BEE0;
  v9[4] = &v11;
  v6 = (id)-[SKUIHorizontalLockupViewAccessibility _accessibilityFindSubviewDescendant:](self, "_accessibilityFindSubviewDescendant:", v9);
  v7 = v12[3];
...
- (void)_resolvePreviewStateAfterTransitionForFlipView:(id)a3
{
  ...
  -[SKUIHorizontalLockupViewAccessibility _resolvePreviewStateAfterTransitionForFlipView:](&v9, sel__resolvePreviewStateAfterTransitionForFlipView_, a3);
  v4 = -[SKUIHorizontalLockupViewAccessibility safeIntegerForKey:](self, "safeIntegerForKey:", CFSTR("_previewState"));
  if (v4)
  {
    if (v4 == 2)
    {
  ...
  else
  {
    ...
    {
      -[SKUIHorizontalLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_previewFrontView"));
      v7 = (void *)objc_claimAutoreleasedReturnValue();
