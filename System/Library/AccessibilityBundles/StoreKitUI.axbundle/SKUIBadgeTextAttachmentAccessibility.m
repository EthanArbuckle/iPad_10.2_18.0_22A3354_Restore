...
{
  return CFSTR("SKUIBadgeTextAttachment");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SKUIBadgeTextAttachment"), CFSTR("NSTextAttachment"));
...
- (id)accessibilityLabel
{
  ...
  v11 = 0;
  objc_opt_class();
  -[SKUIBadgeTextAttachmentAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("image"));
  ...
  else
  {
      ...
      && !objc_msgSend(v5, "isEqualToString:", CFSTR("rottenTomatoesRottenLarge")))
    {
      ...
      -[SKUIBadgeTextAttachmentAccessibility accessibilityLabel](&v10, sel_accessibilityLabel);
