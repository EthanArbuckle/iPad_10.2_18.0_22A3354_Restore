...
{
  return CFSTR("SKUIHorizontalLockupCollectionViewCell");
}
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  {
    -[SKUIHorizontalLockupCollectionViewCellAccessibility _accessibilityParentView](self, "_accessibilityParentView");
    ...
    v18[4] = v25;
    v18[5] = &v19;
    -[SKUIHorizontalLockupCollectionViewCellAccessibility accessibilityEnumerateContainerElementsUsingBlock:](self, "accessibilityEnumerateContainerElementsUsingBlock:", v18);
    v13 = (void *)v20[5];
    if (v13)
    {
      v14 = v13;
...
- (BOOL)accessibilityScrollToVisible
{
  ...
  v3 = -[SKUIHorizontalLockupCollectionViewCellAccessibility accessibilityScrollToVisible](&v10, sel_accessibilityScrollToVisible);
  -[SKUIHorizontalLockupCollectionViewCellAccessibility _accessibilityViewAncestorIsKindOf:](self, "_accessibilityViewAncestorIsKindOf:", NSClassFromString(CFSTR("SKUICollectionView")));
...
- (void)layoutSubviews
{
  ...
  -[SKUIHorizontalLockupCollectionViewCellAccessibility layoutSubviews](&v4, sel_layoutSubviews);
  if (_AXSAutomationEnabled())
  {
    -[SKUIHorizontalLockupCollectionViewCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_lockupView"));
...
{
  return (id)-[SKUIHorizontalLockupCollectionViewCellAccessibility _accessibilityAncestorIsKindOf:](self, "_accessibilityAncestorIsKindOf:", objc_opt_class());
}
