...
{
  return CFSTR("SKUISectionHeaderView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUISectionHeaderView"), CFSTR("layoutSubviews"), "v", 0);
}
...
- (void)layoutSubviews
{
  ...
  -[SKUISectionHeaderViewAccessibility layoutSubviews](&v15, sel_layoutSubviews);
  v13 = 0u;
  v14 = 0u;
  v11 = 0u;
  v12 = 0u;
  -[SKUISectionHeaderViewAccessibility subviews](self, "subviews", 0);
...
- (BOOL)_axHasOnlyStringViews
{
  ...
  v11 = 0u;
  v12 = 0u;
  -[SKUISectionHeaderViewAccessibility subviews](self, "subviews", 0, 0);
...
- (id)accessibilityLabel
{
  ...
  -[SKUISectionHeaderViewAccessibility subviews](self, "subviews");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)accessibilityTraits
{
  ...
  if (!-[SKUISectionHeaderViewAccessibility _axHasOnlyStringViews](self, "_axHasOnlyStringViews"))
