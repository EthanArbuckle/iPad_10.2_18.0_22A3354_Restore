...
{
  return CFSTR("SKUIReviewCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SKUIReviewCollectionViewCell"), CFSTR("SKUIViewReuseCollectionViewCell"));
...
- (id)accessibilityLabel
{
  ...
  -[SKUIReviewCollectionViewCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("allExistingViews"));
