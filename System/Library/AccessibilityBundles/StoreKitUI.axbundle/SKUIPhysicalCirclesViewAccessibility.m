...
{
  return CFSTR("SKUIPhysicalCirclesView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIPhysicalCirclesView"), CFSTR("_circleBodies"), "NSMutableArray");
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIPhysicalCirclesView"), CFSTR("delegate"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIPhysicalCirclesView"), CFSTR("removeCircleAtIndex: animated: completionBlock:"), "v", "q", "B", "@?", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIPhysicalCirclesView"), CFSTR("_reloadDidFinish"), "v", 0);
  objc_msgSend(v3, "validateProtocol:hasOptionalInstanceMethod:", CFSTR("SKUIPhysicalCirclesDelegate"), CFSTR("circleView:didTapCircleAtIndex:"));
  ...
  objc_msgSend(v3, "validateClass:", CFSTR("SKUIOnboardingAffiliationCirclesViewController"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIOnboardingAffiliationCirclesViewController"), CFSTR("_completeDeletionForCircleAtIndex:"), "v", "q", 0);
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SKUIOnboardingAffiliationCirclesViewController"), CFSTR("_affiliationItems"), "NSMutableArray");
  objc_msgSend(v3, "validateClass:", CFSTR("SKUIOnboardingAffiliationItem"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SKUIOnboardingAffiliationItem"), CFSTR("userAffinityCount"), "q", 0);
...
- (void)_accessibilityDeleteCircle:(id)a3
{
  ...
  if (v3)
  {
    ...
    accessibilitySKUILocalizedString(CFSTR("removed.genre.circle"));
...
- (id)_accessibilityValueForCircle:(id)a3
{
  ...
  v4 = a3;
  -[SKUIPhysicalCirclesViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("delegate"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(v7, "objectAtIndex:", -[SKUIPhysicalCirclesViewAccessibility _accessibilityIndexOfCircle:](self, "_accessibilityIndexOfCircle:", v4));
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(v8, "safeIntegerForKey:", CFSTR("userAffinityCount"));

  -[SKUIPhysicalCirclesViewAccessibility _accessibilityValueForAffinityCount:](self, "_accessibilityValueForAffinityCount:", v9);
...
- (id)accessibilityElementAtIndex:(int64_t)a3
{
  ...
  -[SKUIPhysicalCirclesViewAccessibility _accessibilityCircleBodies](self, "_accessibilityCircleBodies");
...
- (BOOL)accessibilityScroll:(int64_t)a3
{
  ...
  -[SKUIPhysicalCirclesViewAccessibility _accessibilityPushingScrollStatusInDirection:](self, "_accessibilityPushingScrollStatusInDirection:", a3);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_accessibilityPushingScrollStatusInDirection:(int64_t)a3
{
  if ((unint64_t)(a3 - 1) > 3)
    return 0;
  accessibilitySKUILocalizedString(off_24FF2C088[a3 - 1]);
...
- (void)removeCircleAtIndex:(int64_t)a3 animated:(BOOL)a4 completionBlock:(id)a5
{
  ...
  v5 = a4;
  v8 = a5;
  -[SKUIPhysicalCirclesViewAccessibility accessibilityElementAtIndex:](self, "accessibilityElementAtIndex:", a3);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[SKUIPhysicalCirclesViewAccessibility removeCircleAtIndex:animated:completionBlock:](&v14, sel_removeCircleAtIndex_animated_completionBlock_, a3, v5, v8);
...
- (void)_reloadDidFinish
{
  ...
  -[SKUIPhysicalCirclesViewAccessibility _reloadDidFinish](&v2, sel__reloadDidFinish);
  UIAccessibilityPostNotification(*MEMORY[0x24BDF72C8], 0);
}
...
- (id)_accessibilityCircleBodies
{
  ...
  objc_opt_class();
  -[SKUIPhysicalCirclesViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_circleBodies"));
...
- (id)_accessibilityValueForAffinityCount:(int64_t)a3
{
  if ((unint64_t)a3 > 2)
    return 0;
  accessibilitySKUILocalizedString(off_24FF2C0A8[a3]);
  return (id)objc_claimAutoreleasedReturnValue();
}
