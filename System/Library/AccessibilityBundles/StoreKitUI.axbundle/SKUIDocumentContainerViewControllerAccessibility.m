...
{
  return CFSTR("SKUIDocumentContainerViewController");
}
...
- (id)_accessibilityRightBarButtonItem
{
  ...
  -[SKUIDocumentContainerViewControllerAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("navigationController"));
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0 && v2)
  {
    ...
    NSClassFromString(CFSTR("SKUIScrollingTabNavigationBar"));
    v3 = 0;
...
- (id)_rightBarButtonAccessibilityLabel
{
  ...
  -[SKUIDocumentContainerViewControllerAccessibility _accessibilityRightBarButtonItem](self, "_accessibilityRightBarButtonItem");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)documentDidUpdate:(id)a3
{
  ...
  v4 = a3;
  -[SKUIDocumentContainerViewControllerAccessibility _rightBarButtonAccessibilityLabel](self, "_rightBarButtonAccessibilityLabel");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[SKUIDocumentContainerViewControllerAccessibility _rightBarButtonIsEnabled](self, "_rightBarButtonIsEnabled");
  v20.receiver = self;
  v20.super_class = (Class)SKUIDocumentContainerViewControllerAccessibility;
  -[SKUIDocumentContainerViewControllerAccessibility documentDidUpdate:](&v20, sel_documentDidUpdate_, v4);

  -[SKUIDocumentContainerViewControllerAccessibility _rightBarButtonAccessibilityLabel](self, "_rightBarButtonAccessibilityLabel");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = -[SKUIDocumentContainerViewControllerAccessibility _rightBarButtonIsEnabled](self, "_rightBarButtonIsEnabled");
  if (objc_msgSend(v5, "isEqualToString:", v7) && v6 != v8)
  {
    ...
    if (v8)
    {
      accessibilitySKUILocalizedString(CFSTR("button.enabled"));
    ...
    {
      accessibilitySKUILocalizedString(CFSTR("button.disabled"));
