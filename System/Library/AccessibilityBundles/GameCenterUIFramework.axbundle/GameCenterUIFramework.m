void sub_23263242C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
id AXGameCenterUIFrameworkLocString(void *a1)
{
  ...
  {
    objc_msgSend((id)AXGameCenterUIFrameworkLocString_bundle, "localizedStringForKey:value:table:", v1, &stru_250216B90, CFSTR("GameCenterUIFrameworkAccessibility"));
...
void sub_232634A34(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
