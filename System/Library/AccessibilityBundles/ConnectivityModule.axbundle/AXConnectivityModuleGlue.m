...
uint64_t __57__AXConnectivityModuleGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Connectivity Module (ControlCenter)"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Connectivity Module (ControlCenter)"));
...
void __57__AXConnectivityModuleGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIConnectivityButtonViewControllerAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIConnectivityAirplaneViewControllerAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIConnectivityBluetoothViewControllerAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIWiFiMenuModuleViewControllerAccessibility"), 1);
