...
uint64_t __53__AXTVRemoteModuleGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("TVRemote Module (ControlCenter)"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("TVRemote Module (ControlCenter)"));
...
void __53__AXTVRemoteModuleGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("TVRMContentViewControllerAccessibility"), 1);
