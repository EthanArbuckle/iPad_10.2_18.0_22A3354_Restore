...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXAirTrafficSettingsUIGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __59__AXAirTrafficSettingsUIGlue_accessibilityInitializeBundle__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "validateClass:isKindOfClass:", CFSTR("SyncFooterView"), CFSTR("UIView"));
  objc_msgSend(v2, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SyncFooterView"), CFSTR("updateProgress: dataSource:"), "B", "@", "@", 0);
...
uint64_t __59__AXAirTrafficSettingsUIGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("AirTraffic AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("AirTraffic"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("SyncFooterViewAccessibility"), 1);
}
