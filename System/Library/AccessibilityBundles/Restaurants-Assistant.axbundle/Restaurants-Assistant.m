id restaurantAccessibilityLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_25032B3D8, CFSTR("RestaurantsAccessibility"));
...
void sub_23294F2DC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_23294F9D4(_Unwind_Exception *a1)
{
  uint64_t v1;
