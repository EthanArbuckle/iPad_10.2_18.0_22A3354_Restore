id accessibilityPreferencesFrameworkBundleLocalizedString(void *a1)
{
  ...
  objc_msgSend(v2, "stringByAppendingPathComponent:", CFSTR("PreferencesFramework.axbundle"));
  ...
  if (v4)
  {
    objc_msgSend(v4, "localizedStringForKey:value:table:", v1, &stru_250398570, CFSTR("Accessibility"));
