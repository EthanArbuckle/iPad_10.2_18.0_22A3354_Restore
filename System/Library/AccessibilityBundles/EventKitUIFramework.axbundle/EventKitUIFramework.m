void LoadMessageUI()
{
  ...
  if ((LoadedMessage & 1) == 0)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD1488], "bundleWithIdentifier:", CFSTR("com.apple.messageui"));
...
id MobileCalAXLocalizedString(void *a1)
{
  ...
  if (MobileCalAXLocalizedString_axBundle
    || (objc_msgSend(MEMORY[0x24BDD1488], "bundleWithIdentifier:", CFSTR("com.apple.MobileCal.axbundle")),
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2501FDFB0, CFSTR("Accessibility"));
...
id accessibilityLocalizedString(void *a1)
{
  ...
  if (accessibilityLocalizedString_axBundle
    || (objc_msgSend(MEMORY[0x24BDD1488], "bundleWithIdentifier:", CFSTR("com.apple.EventKitUIFramework.axbundle")),
        v3 = objc_claimAutoreleasedReturnValue(),
...
id accessibilityCalendarTitleForEventIfNecessary(void *a1)
{
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        objc_msgSend(v10, "source", (_QWORD)v18);
        v11 = (void *)objc_claimAutoreleasedReturnValue();
        if (objc_msgSend(v11, "sourceType") == 5)
        {

        }
        else
        {
          v12 = objc_msgSend(v10, "isSubscribedHolidayCalendar");
  ...
  if (objc_msgSend(v2, "containsObject:", v13) && (unint64_t)objc_msgSend(v2, "count") < 2)
  {
    v16 = 0;
    goto LABEL_18;
  }
  objc_msgSend(v1, "calendar", (_QWORD)v18);
...
void sub_2325E225C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_2325E32C4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_2325E454C(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_2325E52B8(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_2325E5CFC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, id *location)
{
  uint64_t v13;
...
void sub_2325E65F4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_2325E6848(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void __getAXCustomContentClass_block_invoke_cold_1(_QWORD *a1)
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "handleFailureInFunction:file:lineNumber:description:", v3, CFSTR("EKEventDetailTitleCellAccessibility.m"), 35, CFSTR("%s"), *a1);
...
void __getAXCustomContentClass_block_invoke_cold_2()
{
  ...
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", "Class getAXCustomContentClass(void)_block_invoke");
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, CFSTR("EKEventDetailTitleCellAccessibility.m"), 36, CFSTR("Unable to find class %s"), "AXCustomContent");
...
{
  return MEMORY[0x24BDC75A0]();
}

uint64_t CalDisplayedTitleForCalendar()
{
  return MEMORY[0x24BDC75A8]();
}

uint64_t CalRoundPointToScreenScale()
{
  return MEMORY[0x24BDC75C0]();
}

uint64_t CalShow24Hours()
{
  return MEMORY[0x24BDC75C8]();
}

uint64_t CalStringForHour()
{
  return MEMORY[0x24BDC75D0]();
}

uint64_t CalStringForMonthNumber()
{
  return MEMORY[0x24BDC75D8]();
}

uint64_t CalStringForMonthYear()
{
  return MEMORY[0x24BDC75E0]();
}

uint64_t CarImage()
{
  return MEMORY[0x24BDC75F0]();
}
