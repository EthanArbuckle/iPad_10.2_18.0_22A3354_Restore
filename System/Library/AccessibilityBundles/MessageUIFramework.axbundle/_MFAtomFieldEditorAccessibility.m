...
{
  return CFSTR("_MFAtomFieldEditor");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("MFAtomTextView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("MFAtomTextView"), CFSTR("placeholderLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("_MFAtomFieldEditor"), CFSTR("UIView"));
...
- (id)_axAtomTextViewAncestor
{
  ...
  -[_MFAtomFieldEditorAccessibility _accessibilityViewAncestorIsKindOf:](self, "_accessibilityViewAncestorIsKindOf:", NSClassFromString(CFSTR("MFAtomTextView")));
...
- (unint64_t)accessibilityTraits
{
  ...
  -[_MFAtomFieldEditorAccessibility accessibilityTraits](&v7, sel_accessibilityTraits);
  v3 = _AXTraitsRemoveTrait();
  -[_MFAtomFieldEditorAccessibility _axAtomTextViewAncestor](self, "_axAtomTextViewAncestor");
...
- (BOOL)_accessibilityCanBeFirstResponder
{
  ...
  else
  {
    v7.receiver = self;
    v7.super_class = (Class)_MFAtomFieldEditorAccessibility;
    v5 = -[_MFAtomFieldEditorAccessibility _accessibilityCanBeFirstResponder](&v7, sel__accessibilityCanBeFirstResponder);
  }
