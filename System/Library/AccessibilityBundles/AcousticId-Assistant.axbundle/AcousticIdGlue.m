...
uint64_t __47__AcousticIdGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("AcousticId AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("AcousticId"));
...
void __47__AcousticIdGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("SiriAcousticIdHeaderViewAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("SiriAcousticIdAttributionFooterViewAccessibility"), 1);
