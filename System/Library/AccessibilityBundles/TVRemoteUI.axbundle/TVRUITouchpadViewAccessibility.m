...
{
  return CFSTR("TVRUITouchpadView");
}
...
- (BOOL)accessibilityActivate
{
  ...
  -[TVRUITouchpadViewAccessibility _accessibilitySetIsDirectTouching:](self, "_accessibilitySetIsDirectTouching:", 1);
  ...
  objc_msgSend(v6, "setAttribute:forKey:", &unk_2503B02A0, *MEMORY[0x24BDFEAD8]);
...
- (unint64_t)accessibilityTraits
{
  ...
  if (!UIAccessibilityIsSwitchControlRunning()
    && -[TVRUITouchpadViewAccessibility _accessibilityIsDirectTouching](self, "_accessibilityIsDirectTouching"))
  {
...
- (id)accessibilityLabel
{
  ...
  if (-[TVRUITouchpadViewAccessibility _accessibilityIsDirectTouching](self, "_accessibilityIsDirectTouching"))
  {
    v5.receiver = self;
    v5.super_class = (Class)TVRUITouchpadViewAccessibility;
    -[TVRUITouchpadViewAccessibility accessibilityLabel](&v5, sel_accessibilityLabel);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (id)accessibilityHint
{
  ...
  if (-[TVRUITouchpadViewAccessibility _accessibilityIsDirectTouching](self, "_accessibilityIsDirectTouching"))
  {
    v5.receiver = self;
    v5.super_class = (Class)TVRUITouchpadViewAccessibility;
    -[TVRUITouchpadViewAccessibility accessibilityHint](&v5, sel_accessibilityHint);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (void)_accessibilityFocusChanged:(id)a3
{
  ...
  -[TVRUITouchpadViewAccessibility _accessibilitySetIsDirectTouching:](self, "_accessibilitySetIsDirectTouching:", 0);
  UIAccessibilityPostNotification(*MEMORY[0x24BDF72C8], 0);
...
- (BOOL)_accessibilityIsDirectTouching
{
  ...
  objc_getAssociatedObject(self, &isDirectTouching_0);
