...
{
  return CFSTR("TVRUIDirectionalControlView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("TVRUIDirectionalControlView"), CFSTR("selectIndicator"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("TVRUIDirectionalControlView"), CFSTR("upImageView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("TVRUIDirectionalControlView"), CFSTR("rightImageView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("TVRUIDirectionalControlView"), CFSTR("downImageView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("TVRUIDirectionalControlView"), CFSTR("leftImageView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("TVRUIDirectionalControlView"), CFSTR("directionControlsWrapperView"), "@", 0);
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  -[TVRUIDirectionalControlViewAccessibility _accessibilityLoadAccessibilityInformation](&v35, sel__accessibilityLoadAccessibilityInformation);
  -[TVRUIDirectionalControlViewAccessibility safeUIViewForKey:](self, "safeUIViewForKey:", CFSTR("selectIndicator"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[TVRUIDirectionalControlViewAccessibility safeUIViewForKey:](self, "safeUIViewForKey:", CFSTR("upImageView"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[TVRUIDirectionalControlViewAccessibility safeUIViewForKey:](self, "safeUIViewForKey:", CFSTR("rightImageView"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[TVRUIDirectionalControlViewAccessibility safeUIViewForKey:](self, "safeUIViewForKey:", CFSTR("downImageView"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[TVRUIDirectionalControlViewAccessibility safeUIViewForKey:](self, "safeUIViewForKey:", CFSTR("leftImageView"));
  ...
  v15 = v14;
  v17 = v16;
  -[TVRUIDirectionalControlViewAccessibility safeUIViewForKey:](self, "safeUIViewForKey:", CFSTR("directionControlsWrapperView"));
...
- (void)layoutSubviews
{
  ...
  -[TVRUIDirectionalControlViewAccessibility layoutSubviews](&v3, sel_layoutSubviews);
  -[TVRUIDirectionalControlViewAccessibility _accessibilityLoadAccessibilityInformation](self, "_accessibilityLoadAccessibilityInformation");
}
