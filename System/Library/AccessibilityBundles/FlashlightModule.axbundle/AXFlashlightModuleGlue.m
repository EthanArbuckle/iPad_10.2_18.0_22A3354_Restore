...
uint64_t __55__AXFlashlightModuleGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Flashlight Module (ControlCenter)"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Flashlight Module (ControlCenter)"));
...
void __55__AXFlashlightModuleGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIFlashlightModuleViewControllerAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIFlashlightModuleAccessibility"), 1);
