...
{
  return CFSTR("SaveToFiles.DOCMetadataKeyValueRow");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCMetadataKeyValueRow"), CFSTR("accessibilityElementWithLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCMetadataKeyValueRow"), CFSTR("accessibilityElementWithValue"), "@", 0);
