...
{
  return CFSTR("SaveToFiles.DOCCopyableLabel");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCCopyableLabel"), CFSTR("copyDetail"), "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCCopyableLabel"), CFSTR("handleTapWithSender:"), "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("SaveToFiles.DOCCopyableLabel"), CFSTR("supportsCopy"), "Bool");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("SaveToFiles.DOCCopyableLabel"), CFSTR("behaveAsLink"), "Bool");
