...
{
  return CFSTR("SaveToFiles.DOCItemCollectionGridCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionGridCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionGridCell"), CFSTR("accessibilitySecondSubtitleLabel"), "@", 0);
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SaveToFiles.DOCItemCollectionListCell"), CFSTR("com_apple_DocumentManager_Service.DOCItemCollectionCell"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SaveToFiles.DOCItemCollectionGridCell"), CFSTR("com_apple_DocumentManager_Service.DOCItemCollectionCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCellContent"), CFSTR("accessibilityIsFolder"), "B", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("accessibilityThumbnailView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
