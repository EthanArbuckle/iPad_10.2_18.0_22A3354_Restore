...
{
  return CFSTR("SaveToFiles.DOCSidebarViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("SaveToFiles.DOCSidebarViewController"), CFSTR("UIViewController"));
}
