...
{
  return CFSTR("SaveToFiles.DOCItemCollectionListCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionListCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionListCell"), CFSTR("accessibilityDateLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionListCell"), CFSTR("accessibilitySizeLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionListCell"), CFSTR("accessibilityTagView"), "@", 0);
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SaveToFiles.DOCItemCollectionListCell"), CFSTR("SaveToFiles.DOCItemCollectionCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
