...
{
  return CFSTR("SaveToFiles.DOCItemCollectionCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("accessibilityCellManager"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("UICollectionViewCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("accessibilityCellManager"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCell"), CFSTR("accessibilityIsRenaming"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionCellContent"), CFSTR("accessibilityShouldDim"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionViewController"), CFSTR("accessibilityIsRenamingInline"), "B", 0);
  objc_msgSend(v3, "validateClass:conformsToProtocol:", CFSTR("SaveToFiles.DOCItemCollectionViewController"), CFSTR("UIContextMenuInteractionDelegate"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionViewController"), CFSTR("contextMenuForItemsAt:"), "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SaveToFiles.DOCItemCollectionViewController"), CFSTR("contextMenuForFolder"), "@", 0);
...
uint64_t __80__DOCItemCollectionCellAccessibility__accessibilityItemCollectionViewController__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  NSClassFromString(CFSTR("SaveToFiles.DOCItemCollectionViewController"));
