...
{
  return CFSTR("SaveToFiles.DOCSidebarHeaderCell");
}
...
{
  objc_msgSend(a3, "validateClass:", CFSTR("_UICollectionViewListAccessoryDisclosure"));
}
...
- (CGPoint)accessibilityActivationPoint
{
  ...
  -[DOCSidebarHeaderCellAccessibility _accessibilityFindSubviewDescendant:](self, "_accessibilityFindSubviewDescendant:", &__block_literal_global);
