...
{
  return CFSTR("ASMessagesProvider.ActionCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.ActionCollectionViewCell"), CFSTR("accessibilityTextLabel"), "@", 0);
}
