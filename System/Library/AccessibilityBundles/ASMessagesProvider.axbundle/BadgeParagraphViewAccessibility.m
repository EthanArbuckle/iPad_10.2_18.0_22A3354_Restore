...
{
  return CFSTR("ASMessagesProvider.BadgeParagraphView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.BadgeParagraphView"), CFSTR("accessibilityParagraphLabel"), "@", 0);
}
