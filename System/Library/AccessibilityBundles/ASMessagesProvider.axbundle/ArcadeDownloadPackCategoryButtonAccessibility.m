...
{
  return CFSTR("ASMessagesProvider.ArcadeDownloadPackCategoryButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.ArcadeDownloadPackCategoryButton"), CFSTR("titleLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.ArcadeDownloadPackCategoryButton"), CFSTR("UIControl"));
