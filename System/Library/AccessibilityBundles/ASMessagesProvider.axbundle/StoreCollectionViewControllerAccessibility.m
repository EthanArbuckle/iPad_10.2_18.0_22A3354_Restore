...
{
  return CFSTR("ASMessagesProvider.StoreCollectionViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.StoreCollectionViewController"), CFSTR("UICollectionViewController"));
}
