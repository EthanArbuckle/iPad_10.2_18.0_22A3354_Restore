...
{
  return CFSTR("ASMessagesProvider.SmallBreakoutCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallBreakoutCollectionViewCell"), CFSTR("accessibilityDetailsView"), "@", 0);
}
