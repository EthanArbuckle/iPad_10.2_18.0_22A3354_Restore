...
{
  return CFSTR("ASMessagesProvider.SearchResultsContainerViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.SearchResultsContainerViewController"), CFSTR("UIViewController"));
}
