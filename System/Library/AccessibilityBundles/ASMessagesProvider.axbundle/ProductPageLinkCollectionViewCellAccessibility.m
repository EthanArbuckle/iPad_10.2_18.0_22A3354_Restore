...
{
  return CFSTR("ASMessagesProvider.ProductPageLinkCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.ProductPageLinkCollectionViewCell"), CFSTR("acccessibilityTextLabel"), "@", 0);
}
