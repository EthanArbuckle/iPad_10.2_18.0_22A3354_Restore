...
{
  return CFSTR("ASMessagesProvider.ExpandableTextView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.ExpandableTextView"), CFSTR("accessibilityTextLabel"), "@", 0);
}
