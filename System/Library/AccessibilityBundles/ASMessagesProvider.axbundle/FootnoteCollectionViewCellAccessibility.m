...
{
  return CFSTR("ASMessagesProvider.FootnoteCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.FootnoteCollectionViewCell"), CFSTR("accessibilityFootnoteView"), "@", 0);
}
