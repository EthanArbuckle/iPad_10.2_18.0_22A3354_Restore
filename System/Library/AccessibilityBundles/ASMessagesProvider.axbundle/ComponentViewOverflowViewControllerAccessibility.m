...
{
  return CFSTR("ASMessagesProvider.ComponentViewOverflowViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.ComponentViewOverflowViewController"), CFSTR("UIViewController"));
}
