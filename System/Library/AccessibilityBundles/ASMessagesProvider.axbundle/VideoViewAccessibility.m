...
{
  return CFSTR("ASMessagesProvider.VideoView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("ASMessagesProvider.ProductLockupCollectionViewCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.VideoView"), CFSTR("accessibilityUpdatePlayerControllerControls"), "v", 0);
...
- (void)accessibilityUpdatePlayerControllerControls
{
  ...
  v5[3] = &unk_250134128;
  v6 = CFSTR("ASMessagesProvider.ProductLockupCollectionViewCell");
