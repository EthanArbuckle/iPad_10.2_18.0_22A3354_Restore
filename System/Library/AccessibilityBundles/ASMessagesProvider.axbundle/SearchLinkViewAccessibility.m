...
{
  return CFSTR("ASMessagesProvider.SearchLinkView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.SearchLinkView"), CFSTR("linkLabel"), "DynamicLabel");
}
