...
{
  return CFSTR("ASMessagesProvider.SmallLockupCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
}
