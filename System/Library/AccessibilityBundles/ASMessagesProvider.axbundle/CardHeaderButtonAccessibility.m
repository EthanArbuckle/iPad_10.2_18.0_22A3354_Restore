...
{
  return CFSTR("ASMessagesProvider.CardHeaderButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.CardHeaderButton"), CFSTR("vibrantImageView"), "UIImageView");
}
