...
{
  return CFSTR("ASMessagesProvider.LargeGameCenterPlayerCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.LargeGameCenterPlayerCollectionViewCell"), CFSTR("alias"), "DynamicTypeLabel");
}
