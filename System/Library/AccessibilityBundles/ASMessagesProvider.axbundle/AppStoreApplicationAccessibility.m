...
{
  return CFSTR("ASMessagesProvider.AppStoreApplication");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("ASMessagesProvider.ActivityViewController"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.ActivityViewController"), CFSTR("UIViewController"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.AppDelegate"), CFSTR("tabBarController"), "Optional<FlowTabBarController>");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.FlowTabBarController"), CFSTR("UITabBarController"));
