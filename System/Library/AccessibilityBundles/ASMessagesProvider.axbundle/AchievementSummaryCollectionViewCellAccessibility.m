...
{
  return CFSTR("ASMessagesProvider.AchievementSummaryCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.AchievementSummaryCollectionViewCell"), CFSTR("achievementGroupView"), "Optional<AchievementGroupView>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.AchievementSummaryCollectionViewCell"), CFSTR("numberCompletedLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.AchievementSummaryCollectionViewCell"), CFSTR("outOfTotalLabel"), "DynamicTypeLabel");
...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v9, "stringByReplacingOccurrencesOfString:withString:", CFSTR("\u202A/ "), &stru_2501342D0);
