...
{
  return CFSTR("ASMessagesProvider.ChartOrCategoryBrickCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.ChartOrCategoryBrickCollectionViewCell"), CFSTR("titleText"), "Optional<String>");
}
