...
{
  return CFSTR("ASMessagesProvider.GuidedSearchTokenPaletteView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.GuidedSearchTokenPaletteView"), CFSTR("tokens"), "Array<Token>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.GuidedSearchTokenPaletteView"), CFSTR("collectionView"), "Optional<UICollectionView>");
