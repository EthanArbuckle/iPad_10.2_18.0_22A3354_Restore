...
{
  return CFSTR("ASMessagesProvider.ArticlePageViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.ArticlePageViewController"), CFSTR("UICollectionViewController"));
}
