...
{
  return CFSTR("ASMessagesProvider.ParagraphCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.ParagraphCollectionViewCell"), CFSTR("accessibilityExpandableTextView"), "@", 0);
}
