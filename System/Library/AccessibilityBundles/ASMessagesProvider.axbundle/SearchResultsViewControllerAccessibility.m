...
{
  return CFSTR("ASMessagesProvider.SearchResultsViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.SearchResultsViewController"), CFSTR("UIViewController"));
}
