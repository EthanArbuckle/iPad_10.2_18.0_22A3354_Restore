...
{
  return CFSTR("ASMessagesProvider.SmallSearchLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("accessibilitytUserRatingView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("accessibilityRatingCountLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("accessibilityIsAd"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("accessibilityAdButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("accessibilityDescriptionLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("accessibilitySearchTagsRibbonView"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ASMessagesProvider.SmallSearchLockupView"), CFSTR("ASMessagesProvider.BaseLockupView"));
...
void __56__SmallSearchLockupViewAccessibility_accessibilityLabel__block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  v6 = a2;
  MEMORY[0x2349043FC](CFSTR("AppStore.EditorsChoiceView"));
