...
{
  return CFSTR("ASMessagesProvider.SearchActionCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.SearchActionCollectionViewCell"), CFSTR("actionContentView"), "SearchActionContentView");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.SearchActionContentView"), CFSTR("linkLabel"), "DynamicLabel");
