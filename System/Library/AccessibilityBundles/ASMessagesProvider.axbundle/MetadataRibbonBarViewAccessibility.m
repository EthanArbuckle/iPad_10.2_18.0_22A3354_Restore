...
{
  return CFSTR("ASMessagesProvider.MetadataRibbonBarView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ASMessagesProvider.MetadataRibbonBarView"), CFSTR("dividerLabel"), "DynamicTypeLabel");
}
