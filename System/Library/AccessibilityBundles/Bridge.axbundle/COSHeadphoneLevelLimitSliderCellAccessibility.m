...
{
  return CFSTR("COSHeadphoneLevelLimitSliderCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("COSHeadphoneLevelLimitSliderCell"), CFSTR("PSControlTableCell"));
...
- (id)accessibilityValue
{
  ...
  objc_opt_class();
  -[COSHeadphoneLevelLimitSliderCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("controlValue"));
