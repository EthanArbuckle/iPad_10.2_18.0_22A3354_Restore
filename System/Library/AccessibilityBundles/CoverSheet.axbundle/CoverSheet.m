id accessibilitySBLocalizedString(void *a1)
{
  ...
  objc_msgSend(v3, "stringByAppendingPathComponent:", CFSTR("System/Library/AccessibilityBundles/SpringBoard.axbundle"));
  ...
  if (v5)
  {
    objc_msgSend(v5, "localizedStringForKey:value:table:", v1, &stru_2501EDF88, CFSTR("Accessibility"));
...
void sub_2325A2E1C(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_2325A2ED0(_Unwind_Exception *a1)
{
  id *v1;
...
id accessibilityLocalizedString(void *a1)
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2501EDF88, CFSTR("Accessibility"));
...
void sub_2325A3D24(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_2325A3E88(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_2325A4FFC(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
...
void sub_2325A5564(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void sub_2325A55FC(_Unwind_Exception *a1)
{
  id *v1;
...
void sub_2325A5E20(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_2325A5F30(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_2325A61AC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_2325A6244(_Unwind_Exception *a1)
{
  id *v1;
