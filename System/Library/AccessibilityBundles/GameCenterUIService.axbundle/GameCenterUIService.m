id AXGameCenterLocString(void *a1)
{
  ...
  {
    objc_msgSend((id)AXGameCenterLocString_bundle, "localizedStringForKey:value:table:", v1, &stru_25021A690, CFSTR("GameCenter"));
...
id AXGameCenterUIFrameworkLocString(void *a1)
{
  ...
  {
    objc_msgSend((id)AXGameCenterUIFrameworkLocString_bundle, "localizedStringForKey:value:table:", v1, &stru_25021A690, CFSTR("GameCenterUIFrameworkAccessibility"));
    v2 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
