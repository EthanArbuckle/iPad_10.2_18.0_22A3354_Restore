...
uint64_t __55__AXAppearanceModuleGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Appearance Module (ControlCenter)"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Appearance Module (ControlCenter)"));
...
void __55__AXAppearanceModuleGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CCUIAppearanceModuleAccessibility"), 1);
