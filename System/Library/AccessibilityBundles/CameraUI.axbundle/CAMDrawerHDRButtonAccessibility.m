...
{
  return CFSTR("CAMDrawerHDRButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("CAMDrawerHDRButton"), CFSTR("hdrMode"), "q", 0);
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("CAMDrawerHDRButton"), CFSTR("CAMControlDrawerButton"));
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("CAMDrawerHDRButton"), CFSTR("CAMControlDrawerMenuButton"));
...
- (BOOL)accessibilityActivate
{
  ...
  void (*v9)(uint64_t);
  void *v10;
  CAMDrawerHDRButtonAccessibility *v11;
  uint64_t v12;

  if (AXRequestingClient() == 3)
  {
    v3 = -[CAMDrawerHDRButtonAccessibility safeIntegerForKey:](self, "safeIntegerForKey:", CFSTR("hdrMode"));
  ...
  else
  {
    ...
    return -[CAMDrawerHDRButtonAccessibility accessibilityActivate](&v6, sel_accessibilityActivate);
  }
}
...
{
  return accessibilityCameraUILocalizedString(CFSTR("HDR_MODE_BUTTON_HINT"));
}
...
- (id)accessibilityValue
{
  ...
  -[CAMDrawerHDRButtonAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("hdrMode"));
  ...
  {
    accessibilityCameraUILocalizedString(off_24FEE05E0[v3]);
...
- (void)layoutSubviews
{
  ...
  -[CAMDrawerHDRButtonAccessibility layoutSubviews](&v7, sel_layoutSubviews);
  -[CAMDrawerHDRButtonAccessibility safeArrayForKey:](self, "safeArrayForKey:", CFSTR("_itemLabels"));
  ...
  -[CAMDrawerHDRButtonAccessibility safeArrayForKey:](self, "safeArrayForKey:", CFSTR("_cachedMenuItems"));
...
void __49__CAMDrawerHDRButtonAccessibility_layoutSubviews__block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  if (objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 40), "count") > a3)
  {
    ...
    if (v7)
    {
      ...
      v8 = CFSTR("HDR_MODE_BUTTON_VALUE_ON");
    }
    else
    {
      v8 = CFSTR("HDR_MODE_BUTTON_VALUE_OFF");
    }
    accessibilityCameraUILocalizedString(v8);
...
id __49__CAMDrawerHDRButtonAccessibility_layoutSubviews__block_invoke_2()
{
  ...
  accessibilityCameraUILocalizedString(CFSTR("HDR_MODE_BUTTON_LABEL"));
...
- (unint64_t)accessibilityTraits
{
  ...
  return *MEMORY[0x24BDF73B0] | -[CAMDrawerHDRButtonAccessibility accessibilityTraits](&v3, sel_accessibilityTraits);
}
