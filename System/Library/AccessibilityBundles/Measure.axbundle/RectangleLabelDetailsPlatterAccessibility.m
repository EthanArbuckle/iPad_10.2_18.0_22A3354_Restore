...
{
  return CFSTR("Measure.RectangleLabelDetailsPlatter");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Measure.RectangleLabelDetailsPlatter"), CFSTR("UIView"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Measure.RectangleLabelDetailsPlatter"), CFSTR("Measure.GenericPlatter"));
...
- (void)_axAnnotateCloseButton
{
  ...
  -[RectangleLabelDetailsPlatterAccessibility _accessibilityFindDescendant:](self, "_accessibilityFindDescendant:", &__block_literal_global_1);
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  -[RectangleLabelDetailsPlatterAccessibility _accessibilityLoadAccessibilityInformation](&v3, sel__accessibilityLoadAccessibilityInformation);
  -[RectangleLabelDetailsPlatterAccessibility _axAnnotateCloseButton](self, "_axAnnotateCloseButton");
  -[RectangleLabelDetailsPlatterAccessibility _axSetDidInitializeZeroAlpha:](self, "_axSetDidInitializeZeroAlpha:", 1);
}
...
- (BOOL)accessibilityPerformEscape
{
  ...
  void *v8;
  RectangleLabelDetailsPlatterAccessibility *v9;

  if (-[RectangleLabelDetailsPlatterAccessibility accessibilityViewIsModal](self, "accessibilityViewIsModal"))
  {
  ...
  else
  {
    ...
    return -[RectangleLabelDetailsPlatterAccessibility accessibilityPerformEscape](&v4, sel_accessibilityPerformEscape);
  }
}
...
- (void)didMoveToWindow
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RectangleLabelDetailsPlatterAccessibility;
  -[RectangleLabelDetailsPlatterAccessibility didMoveToWindow](&v3, sel_didMoveToWindow);
  -[RectangleLabelDetailsPlatterAccessibility _axAnnotateCloseButton](self, "_axAnnotateCloseButton");
}
...
- (void)setAlpha:(double)a3
{
  ...
  -[RectangleLabelDetailsPlatterAccessibility setAlpha:](&v9, sel_setAlpha_, a3);
  objc_msgSend(v5, "alpha");
  if (vabdd_f64(v7, v8) >= 2.22044605e-16)
  {
    if (-[RectangleLabelDetailsPlatterAccessibility _axDidInitializeZeroAlpha](self, "_axDidInitializeZeroAlpha"))
