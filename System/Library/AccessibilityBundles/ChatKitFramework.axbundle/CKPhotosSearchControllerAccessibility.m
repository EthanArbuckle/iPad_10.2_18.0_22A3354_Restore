...
{
  return CFSTR("CKPhotosSearchController");
}
...
- (id)cellForItemInCollectionView:(id)a3 atIndexPath:(id)a4 withIdentifier:(id)a5
{
  ...
  -[CKPhotosSearchControllerAccessibility cellForItemInCollectionView:atIndexPath:withIdentifier:](&v26, sel_cellForItemInCollectionView_atIndexPath_withIdentifier_, v8, v9, v10);
  ...
  if (v12)
  {
    -[CKPhotosSearchControllerAccessibility safeArrayForKey:](self, "safeArrayForKey:", CFSTR("results"));
    ...
    if (v14 < objc_msgSend(v13, "count"))
    {
      ...
      objc_msgSend(v12, "_axSetContact:", v16, v18, 3221225472, __96__CKPhotosSearchControllerAccessibility_cellForItemInCollectionView_atIndexPath_withIdentifier___block_invoke, &unk_2501B1B28);
...
void __96__CKPhotosSearchControllerAccessibility_cellForItemInCollectionView_atIndexPath_withIdentifier___block_invoke(uint64_t a1)
{
  uint64_t v2;
  uint64_t v3;
  void *v4;
