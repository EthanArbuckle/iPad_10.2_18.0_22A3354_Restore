id accessibilityLocalizedString(void *a1)
{
  ...
  if (accessibilityLocalizedString_axBundle
    || (objc_msgSend(MEMORY[0x24BDD1488], "bundleWithIdentifier:", CFSTR("com.apple.VoiceTriggerUI.axbundle")),
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2503E0D78, CFSTR("Accessibility"));
...
void sub_232BA8A84(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_232BA8F94(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_list va;
