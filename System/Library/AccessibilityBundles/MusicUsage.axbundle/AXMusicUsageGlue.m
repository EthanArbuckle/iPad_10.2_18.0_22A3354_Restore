...
uint64_t __49__AXMusicUsageGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("MusicUsage Usage UI Settings AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("MusicUsage Usage UI Settings"));

  return AXPerformValidationChecks();
}

uint64_t __49__AXMusicUsageGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("MusicUsageDetailHeaderViewAccessibility"), 1);
}
