id accessibilityLocalizedString(void *a1)
{
  ...
  if (v2)
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_25020F3A8, CFSTR("Accessibility"));
...
CGFloat UnionExcludingEmptyRects(CGFloat a1, CGFloat a2, CGFloat a3, CGFloat a4, CGFloat a5, CGFloat a6, CGFloat a7, CGFloat a8)
{
  ...
  if (!CGRectIsEmpty(*(CGRect *)&a1))
  {
    ...
    else
    {
      ...
      v19.size.width = a7;
      v19.size.height = a8;
      *(_QWORD *)&a5 = (unint64_t)CGRectUnion(v18, v19);
    }
  }
  return a5;
}

void sub_23261990C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, ...)
{
  uint64_t v15;
  va_list va;
