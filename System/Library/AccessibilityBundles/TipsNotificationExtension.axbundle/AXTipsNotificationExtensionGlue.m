...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXTipsNotificationExtensionGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __64__AXTipsNotificationExtensionGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("TipsNotificationExtension AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("TipsNotificationExtension"));
...
void __64__AXTipsNotificationExtensionGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("TPSSingleTipViewControllerAccessibility"), 1);
