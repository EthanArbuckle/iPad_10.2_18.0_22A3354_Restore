...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXSIMSetupUIServiceGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __56__AXSIMSetupUIServiceGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("SIMSetupUIService AX"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("SIMSetupUIService"));
...
void __56__AXSIMSetupUIServiceGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("TSSIMUnlockEntryViewAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("TSSIMUnlockDetailViewAccessibility"), 1);
