id accessibilityLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2502C0A38, CFSTR("MoviesAccessibility"));
...
void sub_23281F02C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
