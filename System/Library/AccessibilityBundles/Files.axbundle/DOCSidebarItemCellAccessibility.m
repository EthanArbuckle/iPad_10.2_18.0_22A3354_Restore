...
{
  return CFSTR("Files.DOCSidebarItemCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:", CFSTR("Files.DOCEjectButton"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCEjectButton"), CFSTR("UIButton"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCSidebarItemCell"), CFSTR("UICollectionViewListCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCSidebarItemCell"), CFSTR("accessibilityShowFolder"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCSidebarItemCell"), CFSTR("accessibilityTitle"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCSidebarItemCell"), CFSTR("accessibilitySubtitle"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCSidebarItemCell"), CFSTR("accessibilityIsEjectable"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCSidebarItemCell"), CFSTR("accessibilityTitleTextField"), "@", 0);
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        NSClassFromString(CFSTR("Files.DOCEjectButton"));
