...
{
  return CFSTR("Files.DOCCopyableLabel");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCCopyableLabel"), CFSTR("copyDetail"), "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCCopyableLabel"), CFSTR("handleTapWithSender:"), "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Files.DOCCopyableLabel"), CFSTR("supportsCopy"), "Bool");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Files.DOCCopyableLabel"), CFSTR("behaveAsLink"), "Bool");
