...
{
  return CFSTR("Files.DOCProgressIndicatorView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCProgressIndicatorView"), CFSTR("fractionCompleted"), "d", 0);
}
