...
{
  return CFSTR("Files.DOCItemRenameTextView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCItemRenameTextView"), CFSTR("UIView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemRenameTextView"), CFSTR("accessibilityClearButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemRenameTextView"), CFSTR("installClearButton"), "v", 0);
