...
{
  return CFSTR("Files.UIDocumentBrowserActionBarButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.UIDocumentBrowserActionBarButton"), CFSTR("docAction"), "@", 0);
}
