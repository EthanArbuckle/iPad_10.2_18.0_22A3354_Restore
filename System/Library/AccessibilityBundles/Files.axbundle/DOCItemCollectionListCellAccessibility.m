...
{
  return CFSTR("Files.DOCItemCollectionListCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionListCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionListCell"), CFSTR("accessibilityDateLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionListCell"), CFSTR("accessibilitySizeLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionListCell"), CFSTR("accessibilityTagView"), "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCellContent"), CFSTR("accessibilityIsFolder"), "B", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCItemCollectionListCell"), CFSTR("Files.DOCItemCollectionCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
