...
{
  return CFSTR("Files.DOCItemCollectionView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCItemCollectionView"), CFSTR("UIView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionViewController"), CFSTR("displayMode"), "q", 0);
