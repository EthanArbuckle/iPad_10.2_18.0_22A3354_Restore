...
{
  return CFSTR("Files.DOCItemCollectionCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("accessibilityCellManager"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("UICollectionViewCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("accessibilityCellManager"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("accessibilityIsRenaming"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCellContent"), CFSTR("accessibilityShouldDim"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionViewController"), CFSTR("accessibilityIsRenamingInline"), "B", 0);
  objc_msgSend(v3, "validateClass:conformsToProtocol:", CFSTR("Files.DOCItemCollectionViewController"), CFSTR("UIContextMenuInteractionDelegate"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionViewController"), CFSTR("contextMenuForItemsAt:"), "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionViewController"), CFSTR("contextMenuForFolder"), "@", 0);
...
uint64_t __80__DOCItemCollectionCellAccessibility__accessibilityItemCollectionViewController__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  NSClassFromString(CFSTR("Files.DOCItemCollectionViewController"));
