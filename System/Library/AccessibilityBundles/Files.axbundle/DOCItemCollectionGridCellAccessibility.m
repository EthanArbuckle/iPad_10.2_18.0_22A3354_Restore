...
{
  return CFSTR("Files.DOCItemCollectionGridCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionGridCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionGridCell"), CFSTR("accessibilitySecondSubtitleLabel"), "@", 0);
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Files.DOCItemCollectionGridCell"), CFSTR("Files.DOCItemCollectionCell"));
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCell"), CFSTR("accessibilityThumbnailView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCItemCollectionCellContent"), CFSTR("accessibilityItem"), "@", 0);
