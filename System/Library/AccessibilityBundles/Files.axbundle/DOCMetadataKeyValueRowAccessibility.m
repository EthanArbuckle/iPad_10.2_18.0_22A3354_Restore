...
{
  return CFSTR("Files.DOCMetadataKeyValueRow");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCMetadataKeyValueRow"), CFSTR("accessibilityElementWithLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Files.DOCMetadataKeyValueRow"), CFSTR("accessibilityElementWithValue"), "@", 0);
