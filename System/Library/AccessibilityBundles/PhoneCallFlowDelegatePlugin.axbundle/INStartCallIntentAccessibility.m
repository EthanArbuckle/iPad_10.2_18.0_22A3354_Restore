...
{
  return CFSTR("INStartCallIntent");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("INStartCallIntent"), CFSTR("setContacts:"), "v", "@", 0);
}
              ...
              while (2)
              {
                for (j = 0; j != v14; ++j)
                {
                  ...
                  if (objc_msgSend(v17, "length")
                    && -[INStartCallIntentAccessibility _axIsContactSelectedInClarity:](self, "_axIsContactSelectedInClarity:", v17))
                  {
