...
uint64_t __54__CalendarAssistantGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Siri Calendar AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Siri Calendar"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CalendarAssistantUIControllerAccessibility"), 1);
}
