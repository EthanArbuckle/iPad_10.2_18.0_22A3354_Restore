...
uint64_t __53__AXSafariSharedUIGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("SafariSharedUI"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("SafariSharedUI"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("WBSFluidProgressControllerAccessibility"), 1);
}
