id accessibilityLocalizedString(void *a1)
{
  ...
  if (v2)
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2503CED10, CFSTR("Accessibility"));
...
void sub_232B77BF8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_232B77CAC(_Unwind_Exception *a1)
{
  id *v1;
