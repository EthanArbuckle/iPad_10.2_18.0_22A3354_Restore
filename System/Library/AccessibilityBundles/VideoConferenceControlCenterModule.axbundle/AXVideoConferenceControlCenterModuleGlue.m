...
uint64_t __73__AXVideoConferenceControlCenterModuleGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("VideoConferenceControlCenterModule Module (ControlCenter)"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("VideoConferenceControlCenterModule Module (ControlCenter)"));
...
void __73__AXVideoConferenceControlCenterModuleGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v4, "installSafeCategory:canInteractWithTargetClass:", CFSTR("VideoConferenceControlCenterModuleEffectControlAccessibility"), 1);
  objc_msgSend(v4, "installSafeCategory:canInteractWithTargetClass:", CFSTR("VideoEffectsViewAccessibility"), 1);
  objc_msgSend(v4, "installSafeCategory:canInteractWithTargetClass:", CFSTR("RPCCUIOptionsControlAccessibility"), 1);
