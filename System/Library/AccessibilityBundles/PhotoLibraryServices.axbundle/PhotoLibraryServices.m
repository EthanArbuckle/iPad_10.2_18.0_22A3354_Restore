id accessibilityCameraUILocalizedString(void *a1)
{
  ...
  {
LABEL_3:
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_24FF03AE0, CFSTR("CameraUI"));
...
id accessibilityPLServicesLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_24FF03AE0, CFSTR("PhotoLibraryServicesStrings"));
