...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXDDActionsServiceGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __55__AXDDActionsServiceGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("DDActionsService"));
  objc_msgSend(v2, "setDebugBuild:", 0);
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("DDActionsService"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("DDParsecServiceCollectionViewControllerAccessibility"), 1);
}
