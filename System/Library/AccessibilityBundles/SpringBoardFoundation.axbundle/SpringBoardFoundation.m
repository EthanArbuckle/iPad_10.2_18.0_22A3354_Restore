id accessibilitySBLocalizedString(void *a1)
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_250381BC8, CFSTR("Accessibility"));
...
id accessibilityLocalizedString(void *a1)
{
  ...
  {
    v2 = (id)accessibilityBundle_axBundle_0;
  }
  else
  {
    v3 = (void *)MEMORY[0x24BDD1488];
...
void sub_232A608B4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_232A60A18(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
