...
{
  return CFSTR("HealthArticlesUI.ParagraphView");
}
...
- (id)accessibilityLabel
{
  ...
  -[ParagraphViewAccessibility _accessibilityFindSubviewDescendant:](self, "_accessibilityFindSubviewDescendant:", &__block_literal_global);
