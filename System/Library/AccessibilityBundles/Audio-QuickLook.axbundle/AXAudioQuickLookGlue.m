...
uint64_t __53__AXAudioQuickLookGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("MobileQuickLook Audio AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("MobileQuickLook Audio"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("QLAudioViewControllerAccessibility"), 1);
}
