id accessibilityLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_250351660, CFSTR("ShareSheetAccessibility"));
...
uint64_t accessibilityIsPagesApp()
{
  if (accessibilityIsPagesApp_onceToken != -1)
    dispatch_once(&accessibilityIsPagesApp_onceToken, &__block_literal_global_214);
...
void __accessibilityIsPagesApp_block_invoke()
{
  ...
  accessibilityIsPagesApp_IsPagesApp = objc_msgSend(v0, "isEqualToString:", v1);
