...
{
  return CFSTR("NowPlayingUI.NowPlayingTransportButton");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("NowPlayingUI.NowPlayingTransportButton"), CFSTR("UIButton"));
}
