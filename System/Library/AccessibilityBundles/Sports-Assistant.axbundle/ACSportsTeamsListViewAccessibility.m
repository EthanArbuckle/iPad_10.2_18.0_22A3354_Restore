...
{
  return CFSTR("ACSportsTeamsListView");
}
...
- (id)accessibilityLabel
{
  ...
  -[ACSportsTeamsListViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("domainObjectViews"));
...
void __56__ACSportsTeamsListViewAccessibility_accessibilityLabel__block_invoke(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
