...
{
  return CFSTR("Arcade.ListTodayCardCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Arcade.ListTodayCardCollectionViewCell"), CFSTR("labelsView"), "TodayCardLabelsView");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Arcade.ListTodayCardCollectionViewCell"), CFSTR("lockupContainer"), "TodayListCardLockupContainer");
