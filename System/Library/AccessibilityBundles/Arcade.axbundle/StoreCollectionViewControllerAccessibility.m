...
{
  return CFSTR("Arcade.StoreCollectionViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("Arcade.StoreCollectionViewController"), CFSTR("UICollectionViewController"));
}
