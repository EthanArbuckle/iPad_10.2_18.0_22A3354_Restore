...
{
  return CFSTR("Arcade.ExpandableTextView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ExpandableTextView"), CFSTR("accessibilityTextLabel"), "@", 0);
}
