...
{
  return CFSTR("Arcade.AppEventTodayCardCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Arcade.AppEventTodayCardCollectionViewCell"), CFSTR("formattedDateView"), "AppPromotionFormattedDateView");
}
