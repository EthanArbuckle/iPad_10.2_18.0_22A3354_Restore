...
{
  return CFSTR("Arcade.ArticlePageViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("Arcade.ArticlePageViewController"), CFSTR("UICollectionViewController"));
}
