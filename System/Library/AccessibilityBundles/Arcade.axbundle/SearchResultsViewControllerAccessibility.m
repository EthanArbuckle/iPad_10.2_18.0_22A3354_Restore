...
{
  return CFSTR("Arcade.SearchResultsViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("Arcade.SearchResultsViewController"), CFSTR("UIViewController"));
}
