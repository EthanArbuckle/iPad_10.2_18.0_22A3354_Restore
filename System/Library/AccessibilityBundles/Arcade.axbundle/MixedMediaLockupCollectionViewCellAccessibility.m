...
{
  return CFSTR("Arcade.MixedMediaLockupCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.MixedMediaLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.MixedMediaLockupCollectionViewCell"), CFSTR("accessibilityVideoView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.MixedMediaLockupCollectionViewCell"), CFSTR("accessibilityMediaView"), "@", 0);
