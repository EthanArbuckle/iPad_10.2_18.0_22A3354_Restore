...
{
  return CFSTR("Arcade.ProductLockupCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("initWithFrame:"), "@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("layoutSubviews"), "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityArtworkView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityOfferButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityOfferSubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityDownloadProgressLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("expandedOfferTitleLabel"), "Optional<DynamicTypeLabel>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("expandedOfferSubtitleLabel"), "Optional<DynamicTypeLabel>");
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityOfferTopLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityDescriptionHeaderLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityTextualBadges"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductLockupCollectionViewCell"), CFSTR("accessibilityStandardBadges"), "@", 0);
