...
{
  return CFSTR("Arcade.AppStoreApplication");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("Arcade.ActivityViewController"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Arcade.ActivityViewController"), CFSTR("UIViewController"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("Arcade.AppDelegate"), CFSTR("tabBarController"), "Optional<FlowTabBarController>");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("Arcade.FlowTabBarController"), CFSTR("UITabBarController"));
