...
{
  return CFSTR("Arcade.SearchResultsContainerViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("Arcade.SearchResultsContainerViewController"), CFSTR("UIViewController"));
}
