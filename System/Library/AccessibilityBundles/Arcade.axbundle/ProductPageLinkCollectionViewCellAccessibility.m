...
{
  return CFSTR("Arcade.ProductPageLinkCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductPageLinkCollectionViewCell"), CFSTR("accessibilityButton"), "@", 0);
}
