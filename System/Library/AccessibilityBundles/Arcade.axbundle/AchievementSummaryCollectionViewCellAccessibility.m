...
{
  return CFSTR("Arcade.AchievementSummaryCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStoreKitInternal.AchievementGroupView"), CFSTR("achievement"), "Optional<AchievementCard>");
}
...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v9, "stringByReplacingOccurrencesOfString:withString:", CFSTR("\u202A/ "), &stru_25016E988);
