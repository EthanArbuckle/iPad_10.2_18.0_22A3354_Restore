...
{
  return CFSTR("Arcade.ProductNoRatingsView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Arcade.ProductNoRatingsView"), CFSTR("accessibilityStatusLabel"), "@", 0);
}
