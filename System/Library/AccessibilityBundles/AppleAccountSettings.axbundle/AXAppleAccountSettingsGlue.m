...
uint64_t __59__AXAppleAccountSettingsGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("AppleAccount settings"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("AppleAccount settings"));
...
void __59__AXAppleAccountSettingsGlue_accessibilityInitializeBundle__block_invoke_5(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("AAUserNotificationAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("AAUIAppleAccountHeaderViewAccessibility"), 1);
