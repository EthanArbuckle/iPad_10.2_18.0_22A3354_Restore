...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXVoiceShortcutsUIGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __55__AXVoiceShortcutsUIGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("VoiceShortcutsUI AX"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("VoiceShortcutsUI"));
