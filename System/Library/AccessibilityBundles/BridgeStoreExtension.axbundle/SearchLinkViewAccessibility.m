...
{
  return CFSTR("BridgeStoreExtension.SearchLinkView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.SearchLinkView"), CFSTR("linkLabel"), "DynamicLabel");
}
