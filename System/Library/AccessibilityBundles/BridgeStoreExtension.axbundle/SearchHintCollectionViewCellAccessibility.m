...
{
  return CFSTR("BridgeStoreExtension.SearchHintCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SearchHintCollectionViewCell"), CFSTR("accessibilityHintView"), "@", 0);
...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v2, "_accessibilityDescendantOfType:", MEMORY[0x23490950C](CFSTR("AppStoreKit.DynamicTypeLabel")));
