...
{
  return CFSTR("BridgeStoreExtension.GuidedSearchTokenPaletteView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.GuidedSearchTokenPaletteView"), CFSTR("tokens"), "Array<Token>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.GuidedSearchTokenPaletteView"), CFSTR("collectionView"), "Optional<UICollectionView>");
