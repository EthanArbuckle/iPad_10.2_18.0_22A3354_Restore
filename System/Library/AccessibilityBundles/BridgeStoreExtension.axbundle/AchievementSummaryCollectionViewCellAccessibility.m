...
{
  return CFSTR("BridgeStoreExtension.AchievementSummaryCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.AchievementSummaryCollectionViewCell"), CFSTR("achievementGroupView"), "Optional<AchievementGroupView>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.AchievementSummaryCollectionViewCell"), CFSTR("numberCompletedLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.AchievementSummaryCollectionViewCell"), CFSTR("outOfTotalLabel"), "DynamicTypeLabel");
...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v9, "stringByReplacingOccurrencesOfString:withString:", CFSTR("\u202A/ "), &stru_25019B1B8);
