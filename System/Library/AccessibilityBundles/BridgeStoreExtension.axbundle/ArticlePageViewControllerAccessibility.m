...
{
  return CFSTR("BridgeStoreExtension.ArticlePageViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("BridgeStoreExtension.ArticlePageViewController"), CFSTR("UICollectionViewController"));
}
