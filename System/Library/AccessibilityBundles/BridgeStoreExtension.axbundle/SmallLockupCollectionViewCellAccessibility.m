...
{
  return CFSTR("BridgeStoreExtension.SmallLockupCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
}
