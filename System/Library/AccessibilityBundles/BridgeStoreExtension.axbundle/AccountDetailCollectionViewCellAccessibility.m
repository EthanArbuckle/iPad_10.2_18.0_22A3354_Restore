...
{
  return CFSTR("BridgeStoreExtension.AccountDetailCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.AccountDetailCollectionViewCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.AccountDetailCollectionViewCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.AccountDetailCollectionViewCell"), CFSTR("detailLabel"), "DynamicTypeLabel");
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x23490950C](CFSTR("AppStore.CountBadgeView"));
  ...
  {
    MEMORY[0x23490950C](CFSTR("AppStoreKit.DynamicTypeLabel"));
