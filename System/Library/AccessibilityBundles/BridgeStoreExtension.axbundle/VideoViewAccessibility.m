...
{
  return CFSTR("BridgeStoreExtension.VideoView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("BridgeStoreExtension.ProductLockupCollectionViewCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.VideoView"), CFSTR("accessibilityUpdatePlayerControllerControls"), "v", 0);
...
- (void)accessibilityUpdatePlayerControllerControls
{
  ...
  v5[3] = &unk_25019B010;
  v6 = CFSTR("BridgeStoreExtension.ProductLockupCollectionViewCell");
