...
{
  return CFSTR("BridgeStoreExtension.SearchResultsViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("BridgeStoreExtension.SearchResultsViewController"), CFSTR("UIViewController"));
}
