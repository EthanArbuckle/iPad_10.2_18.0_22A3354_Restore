...
{
  return CFSTR("BridgeStoreExtension.ShelfHeaderView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ShelfHeaderView"), CFSTR("eyebrowButton"), "DynamicTypeButton");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ShelfHeaderView"), CFSTR("titleButton"), "DynamicTypeButton");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ShelfHeaderView"), CFSTR("subtitleLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ShelfHeaderView"), CFSTR("accessoryButton"), "DynamicTypeButton");
...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v8, "stringByReplacingOccurrencesOfString:withString:", CFSTR("\uFFFC"), &stru_25019B1B8);
