...
{
  return CFSTR("BridgeStoreExtension.ExpandableTextView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.ExpandableTextView"), CFSTR("accessibilityTextLabel"), "@", 0);
}
