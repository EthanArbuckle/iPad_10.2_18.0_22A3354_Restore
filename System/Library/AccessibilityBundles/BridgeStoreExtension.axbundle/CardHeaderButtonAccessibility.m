...
{
  return CFSTR("BridgeStoreExtension.CardHeaderButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.CardHeaderButton"), CFSTR("vibrantImageView"), "UIImageView");
}
