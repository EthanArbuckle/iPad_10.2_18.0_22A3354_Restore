...
{
  return CFSTR("BridgeStoreExtension.ProductPageLinkCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.ProductPageLinkCollectionViewCell"), CFSTR("acccessibilityTextLabel"), "@", 0);
}
