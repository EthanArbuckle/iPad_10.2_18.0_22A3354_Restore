...
{
  return CFSTR("BridgeStoreExtension.ReviewSummaryView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ReviewSummaryView"), CFSTR("subtitleLabel"), "DynamicTypeLabel");
