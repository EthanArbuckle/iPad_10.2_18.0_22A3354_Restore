...
{
  return CFSTR("BridgeStoreExtension.ArcadeDownloadPackCategoryButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ArcadeDownloadPackCategoryButton"), CFSTR("titleLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("BridgeStoreExtension.ArcadeDownloadPackCategoryButton"), CFSTR("UIControl"));
