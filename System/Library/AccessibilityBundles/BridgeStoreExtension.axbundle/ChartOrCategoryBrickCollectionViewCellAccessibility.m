...
{
  return CFSTR("BridgeStoreExtension.ChartOrCategoryBrickCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ChartOrCategoryBrickCollectionViewCell"), CFSTR("titleText"), "Optional<String>");
}
