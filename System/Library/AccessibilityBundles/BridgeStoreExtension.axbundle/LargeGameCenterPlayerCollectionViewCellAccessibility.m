...
{
  return CFSTR("BridgeStoreExtension.LargeGameCenterPlayerCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.LargeGameCenterPlayerCollectionViewCell"), CFSTR("alias"), "DynamicTypeLabel");
}
