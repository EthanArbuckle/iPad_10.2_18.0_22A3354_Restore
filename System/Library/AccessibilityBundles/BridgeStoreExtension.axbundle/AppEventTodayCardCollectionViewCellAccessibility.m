...
{
  return CFSTR("BridgeStoreExtension.AppEventTodayCardCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.AppEventTodayCardCollectionViewCell"), CFSTR("formattedDateView"), "AppPromotionFormattedDateView");
}
