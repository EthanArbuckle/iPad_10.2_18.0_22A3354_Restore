...
{
  return CFSTR("BridgeStoreExtension.SearchActionCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.SearchActionCollectionViewCell"), CFSTR("actionContentView"), "SearchActionContentView");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.SearchActionContentView"), CFSTR("linkLabel"), "DynamicLabel");
