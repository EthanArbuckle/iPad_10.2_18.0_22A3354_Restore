...
{
  return CFSTR("BridgeStoreExtension.FootnoteCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.FootnoteCollectionViewCell"), CFSTR("accessibilityFootnoteView"), "@", 0);
}
