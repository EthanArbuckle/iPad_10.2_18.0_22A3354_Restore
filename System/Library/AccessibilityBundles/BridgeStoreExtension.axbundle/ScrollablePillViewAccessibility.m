...
{
  return CFSTR("BridgeStoreExtension.ScrollablePillView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("BridgeStoreExtension.ScrollablePillView"), CFSTR("linkLabel"), "DynamicLabel");
}
