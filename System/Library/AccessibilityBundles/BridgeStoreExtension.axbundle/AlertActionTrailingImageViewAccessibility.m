...
{
  return CFSTR("BridgeStoreExtension.AlertActionTrailingImageView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.AlertActionTrailingImageView"), CFSTR("accessibilityAlertActionLabel"), "@", 0);
}
