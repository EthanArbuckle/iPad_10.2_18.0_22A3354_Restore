...
{
  return CFSTR("BridgeStoreExtension.UpdatesLockupCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.UpdatesLockupCollectionViewCell"), CFSTR("accessibilitytLockupView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.UpdatesLockupCollectionViewCell"), CFSTR("accessibilityExpandableTextView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.UpdatesLockupCollectionViewCell"), CFSTR("accessibilityVersionMetadata"), "@", 0);
...
- (id)accessibilityCustomContent
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDB3D68], "customContentWithLabel:value:", &stru_25019B1B8, v4);
