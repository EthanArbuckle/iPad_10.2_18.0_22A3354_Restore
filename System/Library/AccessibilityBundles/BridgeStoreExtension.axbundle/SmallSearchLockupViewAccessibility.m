...
{
  return CFSTR("BridgeStoreExtension.SmallSearchLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("accessibilitytUserRatingView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("accessibilityRatingCountLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("accessibilityIsAd"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("accessibilityAdButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("accessibilityDescriptionLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("accessibilitySearchTagsRibbonView"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("BridgeStoreExtension.SmallSearchLockupView"), CFSTR("BridgeStoreExtension.BaseLockupView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.BaseLockupView"), CFSTR("accessibilityTitleLabel"), "@", 0);
...
void __56__SmallSearchLockupViewAccessibility_accessibilityLabel__block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  v6 = a2;
  MEMORY[0x23490950C](CFSTR("AppStore.EditorsChoiceView"));
