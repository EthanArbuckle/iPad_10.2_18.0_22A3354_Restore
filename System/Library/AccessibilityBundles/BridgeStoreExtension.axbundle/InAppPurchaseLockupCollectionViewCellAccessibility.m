...
{
  return CFSTR("BridgeStoreExtension.InAppPurchaseLockupCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.InAppPurchaseLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
}
