...
{
  return CFSTR("BridgeStoreExtension.SmallBreakoutCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("BridgeStoreExtension.SmallBreakoutCollectionViewCell"), CFSTR("accessibilityDetailsView"), "@", 0);
}
