...
{
  return CFSTR("HKMedicalIDEditorWeightCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("HKMedicalIDEditorWeightCell"), CFSTR("_picker"), "UIPickerView");
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("HKMedicalIDEditorWeightCell"), CFSTR("_showPicker"), "v", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("HKMedicalIDEditorWeightCell"), CFSTR("HKMedicalIDEditorCell"));
...
- (void)_showPicker
{
  ...
  v7 = 0;
  -[HKMedicalIDEditorWeightCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("inputTextField"));
