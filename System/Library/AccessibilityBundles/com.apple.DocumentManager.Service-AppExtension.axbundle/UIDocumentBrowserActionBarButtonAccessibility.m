...
{
  return CFSTR("com_apple_DocumentManager_Service.UIDocumentBrowserActionBarButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("com_apple_DocumentManager_Service.UIDocumentBrowserActionBarButton"), CFSTR("docAction"), "@", 0);
}
