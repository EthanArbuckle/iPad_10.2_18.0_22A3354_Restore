...
{
  return CFSTR("com_apple_DocumentManager_Service.DOCProgressIndicatorView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("com_apple_DocumentManager_Service.DOCProgressIndicatorView"), CFSTR("fractionCompleted"), "d", 0);
}
