...
{
  return CFSTR("com_apple_DocumentManager_Service.DOCItemCollectionView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("com_apple_DocumentManager_Service.DOCItemCollectionView"), CFSTR("UIView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("com_apple_DocumentManager_Service.DOCItemCollectionViewController"), CFSTR("displayMode"), "q", 0);
