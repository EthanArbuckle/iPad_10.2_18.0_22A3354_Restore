...
{
  return CFSTR("AppInstallExtension.SearchLinkView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.SearchLinkView"), CFSTR("linkLabel"), "DynamicLabel");
}
