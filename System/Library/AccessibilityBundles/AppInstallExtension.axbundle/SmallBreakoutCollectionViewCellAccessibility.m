...
{
  return CFSTR("AppInstallExtension.SmallBreakoutCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.SmallBreakoutCollectionViewCell"), CFSTR("accessibilityDetailsView"), "@", 0);
}
