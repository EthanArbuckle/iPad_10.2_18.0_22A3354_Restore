...
{
  return CFSTR("AppInstallExtension.FootnoteCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.FootnoteCollectionViewCell"), CFSTR("accessibilityFootnoteView"), "@", 0);
}
