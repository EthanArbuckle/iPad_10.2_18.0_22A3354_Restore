...
{
  return CFSTR("AppInstallExtension.ComponentViewOverflowViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppInstallExtension.ComponentViewOverflowViewController"), CFSTR("UIViewController"));
}
