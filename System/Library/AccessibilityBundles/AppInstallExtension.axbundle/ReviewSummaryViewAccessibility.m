...
{
  return CFSTR("AppInstallExtension.ReviewSummaryView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.ReviewSummaryView"), CFSTR("subtitleLabel"), "DynamicTypeLabel");
