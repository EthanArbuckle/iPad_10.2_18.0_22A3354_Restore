...
{
  return CFSTR("AppInstallExtension.ParagraphCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.ParagraphCollectionViewCell"), CFSTR("accessibilityExpandableTextView"), "@", 0);
}
