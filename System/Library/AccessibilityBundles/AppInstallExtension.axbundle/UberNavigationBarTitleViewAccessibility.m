...
{
  return CFSTR("AppInstallExtension.UberNavigationBarTitleView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.UberNavigationBarTitleView"), CFSTR("accessibilityNonStandardDismissButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.UberNavigationBarTitleView"), CFSTR("layoutSubviews"), "v", 0);
