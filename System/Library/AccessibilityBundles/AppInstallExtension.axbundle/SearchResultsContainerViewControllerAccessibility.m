...
{
  return CFSTR("AppInstallExtension.SearchResultsContainerViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppInstallExtension.SearchResultsContainerViewController"), CFSTR("UIViewController"));
}
