...
{
  return CFSTR("AppInstallExtension.PlatformSelectorView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.PlatformSelectorView"), CFSTR("accessibilityDescriptionLabel"), "@", 0);
