...
{
  return CFSTR("AppInstallExtension.AccountButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.AccountButton"), CFSTR("accessibilityBadgeCount"), "@", 0);
}
