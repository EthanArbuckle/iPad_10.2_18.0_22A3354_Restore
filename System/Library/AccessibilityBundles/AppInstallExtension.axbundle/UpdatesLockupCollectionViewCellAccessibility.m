...
{
  return CFSTR("AppInstallExtension.UpdatesLockupCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.UpdatesLockupCollectionViewCell"), CFSTR("accessibilitytLockupView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.UpdatesLockupCollectionViewCell"), CFSTR("accessibilityExpandableTextView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.UpdatesLockupCollectionViewCell"), CFSTR("accessibilityVersionMetadata"), "@", 0);
...
- (id)accessibilityCustomContent
{
  ...
  {
    objc_msgSend(MEMORY[0x24BDB3D68], "customContentWithLabel:value:", &stru_2501532F8, v4);
