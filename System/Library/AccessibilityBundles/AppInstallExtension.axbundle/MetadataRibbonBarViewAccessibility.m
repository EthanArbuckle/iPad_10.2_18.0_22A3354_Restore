...
{
  return CFSTR("AppInstallExtension.MetadataRibbonBarView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.MetadataRibbonBarView"), CFSTR("dividerLabel"), "DynamicTypeLabel");
}
