...
{
  return CFSTR("AppInstallExtension.CondensedEditorialSearchResultContentView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.CondensedEditorialSearchResultContentView"), CFSTR("accessibilityHeaderLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.CondensedEditorialSearchResultContentView"), CFSTR("accessibilityTitleLabel"), "@", 0);
