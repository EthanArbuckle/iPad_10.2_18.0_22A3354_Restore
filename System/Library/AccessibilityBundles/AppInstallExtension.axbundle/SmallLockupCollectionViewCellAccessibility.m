...
{
  return CFSTR("AppInstallExtension.SmallLockupCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.SmallLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
}
