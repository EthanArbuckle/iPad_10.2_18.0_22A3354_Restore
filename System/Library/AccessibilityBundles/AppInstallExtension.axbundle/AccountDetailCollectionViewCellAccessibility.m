...
{
  return CFSTR("AppInstallExtension.AccountDetailCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.AccountDetailCollectionViewCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.AccountDetailCollectionViewCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.AccountDetailCollectionViewCell"), CFSTR("detailLabel"), "DynamicTypeLabel");
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x234905BBC](CFSTR("AppStore.CountBadgeView"));
  ...
  {
    MEMORY[0x234905BBC](CFSTR("AppStoreKit.DynamicTypeLabel"));
