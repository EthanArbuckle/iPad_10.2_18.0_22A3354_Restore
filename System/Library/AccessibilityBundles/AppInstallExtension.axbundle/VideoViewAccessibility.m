...
{
  return CFSTR("AppInstallExtension.VideoView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("AppInstallExtension.ProductLockupCollectionViewCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.VideoView"), CFSTR("accessibilityUpdatePlayerControllerControls"), "v", 0);
...
- (void)accessibilityUpdatePlayerControllerControls
{
  ...
  v5[3] = &unk_250153150;
  v6 = CFSTR("AppInstallExtension.ProductLockupCollectionViewCell");
