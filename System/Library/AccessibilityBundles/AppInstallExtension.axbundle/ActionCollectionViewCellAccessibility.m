...
{
  return CFSTR("AppInstallExtension.ActionCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.ActionCollectionViewCell"), CFSTR("accessibilityTextLabel"), "@", 0);
}
