...
{
  return CFSTR("AppInstallExtension.AppStoreApplication");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("AppInstallExtension.ActivityViewController"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppInstallExtension.ActivityViewController"), CFSTR("UIViewController"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.AppDelegate"), CFSTR("tabBarController"), "Optional<FlowTabBarController>");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppInstallExtension.FlowTabBarController"), CFSTR("UITabBarController"));
