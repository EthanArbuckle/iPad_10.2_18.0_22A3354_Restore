...
{
  return CFSTR("AppInstallExtension.AlertActionTrailingImageView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.AlertActionTrailingImageView"), CFSTR("accessibilityAlertActionLabel"), "@", 0);
}
