...
{
  return CFSTR("AppInstallExtension.ChartOrCategoryBrickCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.ChartOrCategoryBrickCollectionViewCell"), CFSTR("titleText"), "Optional<String>");
}
