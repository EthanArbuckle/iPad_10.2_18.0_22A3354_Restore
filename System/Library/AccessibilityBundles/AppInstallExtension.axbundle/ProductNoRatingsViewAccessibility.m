...
{
  return CFSTR("AppInstallExtension.ProductNoRatingsView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppInstallExtension.ProductNoRatingsView"), CFSTR("accessibilityStatusLabel"), "@", 0);
}
