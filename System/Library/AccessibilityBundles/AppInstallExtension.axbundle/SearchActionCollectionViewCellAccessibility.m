...
{
  return CFSTR("AppInstallExtension.SearchActionCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.SearchActionCollectionViewCell"), CFSTR("actionContentView"), "SearchActionContentView");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.SearchActionContentView"), CFSTR("linkLabel"), "DynamicLabel");
