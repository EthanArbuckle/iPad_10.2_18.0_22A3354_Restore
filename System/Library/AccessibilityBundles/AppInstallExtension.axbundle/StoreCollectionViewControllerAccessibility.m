...
{
  return CFSTR("AppInstallExtension.StoreCollectionViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppInstallExtension.StoreCollectionViewController"), CFSTR("UICollectionViewController"));
}
