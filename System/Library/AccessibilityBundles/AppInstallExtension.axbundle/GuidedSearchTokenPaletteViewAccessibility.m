...
{
  return CFSTR("AppInstallExtension.GuidedSearchTokenPaletteView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.GuidedSearchTokenPaletteView"), CFSTR("tokens"), "Array<Token>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.GuidedSearchTokenPaletteView"), CFSTR("collectionView"), "Optional<UICollectionView>");
