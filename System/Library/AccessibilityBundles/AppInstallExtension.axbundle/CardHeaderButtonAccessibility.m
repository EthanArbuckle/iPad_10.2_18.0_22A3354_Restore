...
{
  return CFSTR("AppInstallExtension.CardHeaderButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppInstallExtension.CardHeaderButton"), CFSTR("vibrantImageView"), "UIImageView");
}
