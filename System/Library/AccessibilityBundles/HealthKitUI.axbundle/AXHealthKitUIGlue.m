...
uint64_t __50__AXHealthKitUIGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("AX HealthKitUI"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("AX HealthKitUI"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("HKActivityRingViewAccessibility"), 1);
}
