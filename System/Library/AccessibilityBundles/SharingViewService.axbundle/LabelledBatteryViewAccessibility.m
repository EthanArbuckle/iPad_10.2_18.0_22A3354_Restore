...
{
  return CFSTR("SharingViewService.LabelledBatteryView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("SharingViewService.LabelledBatteryView"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("SharingViewService.LabelledBatteryView"), CFSTR("batteryView"), "_UIBatteryView");
