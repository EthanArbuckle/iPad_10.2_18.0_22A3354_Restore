...
{
  return localizedString(CFSTR("SharingViewService-Accessibility"), a1);
}
...
id localizedString(void *a1, void *a2)
{
  ...
  if (v5)
  {
    objc_msgSend(v5, "localizedStringForKey:value:table:", v4, &stru_250355630, v3);
...
{
  return localizedString(CFSTR("SharingViewService-Accessibility_b188"), a1);
}

void sub_2329C924C(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  id *v3;
...
void sub_2329C9C4C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_2329CAE1C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_list va;
