...
{
  return CFSTR("ProductPageExtension.UberNavigationBarTitleView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.UberNavigationBarTitleView"), CFSTR("accessibilityNonStandardDismissButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.UberNavigationBarTitleView"), CFSTR("layoutSubviews"), "v", 0);
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  objc_msgSend(v3, "_setAccessibilityLabelBlock:", &__block_literal_global_3);
  v4.receiver = self;
