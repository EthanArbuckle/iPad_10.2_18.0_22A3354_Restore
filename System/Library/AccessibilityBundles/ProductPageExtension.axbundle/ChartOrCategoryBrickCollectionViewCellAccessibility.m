...
{
  return CFSTR("ProductPageExtension.ChartOrCategoryBrickCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.ChartOrCategoryBrickCollectionViewCell"), CFSTR("titleText"), "Optional<String>");
}
