...
{
  return CFSTR("ProductPageExtension.SearchResultsContainerViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.SearchResultsContainerViewController"), CFSTR("UIViewController"));
}
