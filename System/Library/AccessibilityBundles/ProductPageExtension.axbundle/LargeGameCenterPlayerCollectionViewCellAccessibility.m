...
{
  return CFSTR("ProductPageExtension.LargeGameCenterPlayerCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.LargeGameCenterPlayerCollectionViewCell"), CFSTR("alias"), "DynamicTypeLabel");
}
