...
{
  return CFSTR("ProductPageExtension.AppEventTodayCardCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.AppEventTodayCardCollectionViewCell"), CFSTR("formattedDateView"), "AppPromotionFormattedDateView");
}
