...
{
  return CFSTR("ProductPageExtension.ExpandableTextView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.ExpandableTextView"), CFSTR("accessibilityTextLabel"), "@", 0);
}
