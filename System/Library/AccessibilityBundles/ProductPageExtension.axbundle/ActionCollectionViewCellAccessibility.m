...
{
  return CFSTR("ProductPageExtension.ActionCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.ActionCollectionViewCell"), CFSTR("accessibilityTextLabel"), "@", 0);
}
