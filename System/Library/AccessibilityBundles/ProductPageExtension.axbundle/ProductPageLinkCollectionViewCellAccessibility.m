...
{
  return CFSTR("ProductPageExtension.ProductPageLinkCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.ProductPageLinkCollectionViewCell"), CFSTR("acccessibilityTextLabel"), "@", 0);
}
