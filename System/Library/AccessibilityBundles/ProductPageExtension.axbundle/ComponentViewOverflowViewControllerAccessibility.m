...
{
  return CFSTR("ProductPageExtension.ComponentViewOverflowViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.ComponentViewOverflowViewController"), CFSTR("UIViewController"));
}
