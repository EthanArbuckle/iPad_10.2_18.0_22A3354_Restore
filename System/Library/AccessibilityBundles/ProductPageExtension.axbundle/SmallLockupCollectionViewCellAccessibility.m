...
{
  return CFSTR("ProductPageExtension.SmallLockupCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
}
