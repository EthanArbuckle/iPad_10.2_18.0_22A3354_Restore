...
{
  return CFSTR("ProductPageExtension.ReviewSummaryView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.ReviewSummaryView"), CFSTR("subtitleLabel"), "DynamicTypeLabel");
