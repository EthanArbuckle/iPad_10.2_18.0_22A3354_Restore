...
{
  return CFSTR("ProductPageExtension.AnnotationCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilitySummaryLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilityDetailItems"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilityCellIsExpanded"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilityLinkLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilityLinkLabelTapped"), "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AnnotationCollectionViewCell"), CFSTR("accessibilityIsSummaryExpandable"), "B", 0);
