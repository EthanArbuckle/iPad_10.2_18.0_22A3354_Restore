...
{
  return CFSTR("ProductPageExtension.SearchLinkView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.SearchLinkView"), CFSTR("linkLabel"), "DynamicLabel");
}
