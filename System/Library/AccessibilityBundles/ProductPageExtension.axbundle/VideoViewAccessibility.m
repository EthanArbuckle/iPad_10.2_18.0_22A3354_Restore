...
{
  return CFSTR("ProductPageExtension.VideoView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("ProductPageExtension.ProductLockupCollectionViewCell"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.VideoView"), CFSTR("accessibilityUpdatePlayerControllerControls"), "v", 0);
...
- (void)accessibilityUpdatePlayerControllerControls
{
  ...
  v5[3] = &unk_25031B878;
  v6 = CFSTR("ProductPageExtension.ProductLockupCollectionViewCell");
