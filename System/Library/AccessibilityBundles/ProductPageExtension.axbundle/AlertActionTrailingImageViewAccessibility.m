...
{
  return CFSTR("ProductPageExtension.AlertActionTrailingImageView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AlertActionTrailingImageView"), CFSTR("accessibilityAlertActionLabel"), "@", 0);
}
