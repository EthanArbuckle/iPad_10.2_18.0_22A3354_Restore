...
{
  return CFSTR("ProductPageExtension.FootnoteCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.FootnoteCollectionViewCell"), CFSTR("accessibilityFootnoteView"), "@", 0);
}
