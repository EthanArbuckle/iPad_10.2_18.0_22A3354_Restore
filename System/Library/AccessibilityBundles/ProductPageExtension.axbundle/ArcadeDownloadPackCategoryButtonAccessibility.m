...
{
  return CFSTR("ProductPageExtension.ArcadeDownloadPackCategoryButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.ArcadeDownloadPackCategoryButton"), CFSTR("titleLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.ArcadeDownloadPackCategoryButton"), CFSTR("UIControl"));
