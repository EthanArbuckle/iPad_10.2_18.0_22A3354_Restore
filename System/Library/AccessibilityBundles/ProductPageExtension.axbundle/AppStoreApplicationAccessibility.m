...
{
  return CFSTR("ProductPageExtension.AppStoreApplication");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("ProductPageExtension.ActivityViewController"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.ActivityViewController"), CFSTR("UIViewController"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.AppDelegate"), CFSTR("tabBarController"), "Optional<FlowTabBarController>");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.FlowTabBarController"), CFSTR("UITabBarController"));
