...
{
  return CFSTR("ProductPageExtension.SmallBreakoutCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallBreakoutCollectionViewCell"), CFSTR("accessibilityDetailsView"), "@", 0);
}
