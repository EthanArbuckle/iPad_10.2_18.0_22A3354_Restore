...
{
  return CFSTR("ProductPageExtension.CondensedEditorialSearchResultContentView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.CondensedEditorialSearchResultContentView"), CFSTR("accessibilityHeaderLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.CondensedEditorialSearchResultContentView"), CFSTR("accessibilityTitleLabel"), "@", 0);
