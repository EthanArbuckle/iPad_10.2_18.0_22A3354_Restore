...
{
  return CFSTR("ProductPageExtension.AccountButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AccountButton"), CFSTR("accessibilityBadgeCount"), "@", 0);
}
