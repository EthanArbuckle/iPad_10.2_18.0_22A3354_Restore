...
{
  return CFSTR("ProductPageExtension.StoreCollectionViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.StoreCollectionViewController"), CFSTR("UICollectionViewController"));
}
