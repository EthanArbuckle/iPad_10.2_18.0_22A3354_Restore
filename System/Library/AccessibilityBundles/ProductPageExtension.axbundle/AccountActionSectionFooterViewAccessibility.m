...
{
  return CFSTR("ProductPageExtension.AccountActionSectionFooterView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AccountActionSectionFooterView"), CFSTR("accessibilityTextLabel"), "@", 0);
