...
{
  return CFSTR("ProductPageExtension.AccountDetailCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AccountDetailCollectionViewCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.AccountDetailCollectionViewCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.AccountDetailCollectionViewCell"), CFSTR("detailLabel"), "DynamicTypeLabel");
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x23491B00C](CFSTR("AppStore.CountBadgeView"));
  ...
  {
    MEMORY[0x23491B00C](CFSTR("AppStoreKit.DynamicTypeLabel"));
