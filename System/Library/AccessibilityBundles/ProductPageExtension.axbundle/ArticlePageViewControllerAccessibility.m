...
{
  return CFSTR("ProductPageExtension.ArticlePageViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.ArticlePageViewController"), CFSTR("UICollectionViewController"));
}
