...
{
  return CFSTR("ProductPageExtension.ScrollablePillView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.ScrollablePillView"), CFSTR("linkLabel"), "DynamicLabel");
}
