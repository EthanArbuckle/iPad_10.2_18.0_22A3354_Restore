...
{
  return CFSTR("ProductPageExtension.CardHeaderButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("ProductPageExtension.CardHeaderButton"), CFSTR("vibrantImageView"), "UIImageView");
}
