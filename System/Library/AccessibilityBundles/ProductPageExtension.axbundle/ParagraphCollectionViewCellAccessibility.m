...
{
  return CFSTR("ProductPageExtension.ParagraphCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.ParagraphCollectionViewCell"), CFSTR("accessibilityExpandableTextView"), "@", 0);
}
