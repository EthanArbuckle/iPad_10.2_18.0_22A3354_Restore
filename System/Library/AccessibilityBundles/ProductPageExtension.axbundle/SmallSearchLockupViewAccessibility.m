...
{
  return CFSTR("ProductPageExtension.SmallSearchLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("accessibilitytUserRatingView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("accessibilityRatingCountLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("accessibilityIsAd"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("accessibilityAdButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("accessibilityDescriptionLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("accessibilitySearchTagsRibbonView"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("ProductPageExtension.SmallSearchLockupView"), CFSTR("ProductPageExtension.BaseLockupView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("ProductPageExtension.BaseLockupView"), CFSTR("accessibilityTitleLabel"), "@", 0);
...
void __56__SmallSearchLockupViewAccessibility_accessibilityLabel__block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  v6 = a2;
  MEMORY[0x23491B00C](CFSTR("AppStore.EditorsChoiceView"));
