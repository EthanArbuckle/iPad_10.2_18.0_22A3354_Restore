...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXStocksFrameworkGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __54__AXStocksFrameworkGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Stocks Framework AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Stocks Framework"));
...
void __54__AXStocksFrameworkGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("StockAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("StockGraphViewAccessibility"), 1);
