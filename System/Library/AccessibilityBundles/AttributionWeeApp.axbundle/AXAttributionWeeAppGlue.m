...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXAttributionWeeAppGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __56__AXAttributionWeeAppGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Attribution Wee App AX Bundle"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Attribution Wee App"));
...
void __56__AXAttributionWeeAppGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("AttributionWeeAppNSTextAttachmentAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("AttributionWeeAppControllerAccessibility"), 1);
