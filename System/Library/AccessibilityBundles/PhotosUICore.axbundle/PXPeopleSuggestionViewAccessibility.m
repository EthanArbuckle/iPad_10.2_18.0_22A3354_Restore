...
{
  return CFSTR("PXPeopleSuggestionView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("PXPeopleSuggestionView"), CFSTR("suggestion"), "@", 0);
...
- (id)accessibilityLabel
{
  ...
  -[PXPeopleSuggestionViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("suggestion"));
  ...
  -[PXPeopleSuggestionViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("imageView"));
