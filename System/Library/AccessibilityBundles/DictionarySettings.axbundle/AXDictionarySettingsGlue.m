...
uint64_t __57__AXDictionarySettingsGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Dictionary Settings"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Dictionary Settings"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("DSDictionaryTableCellAccessibility"), 1);
}
