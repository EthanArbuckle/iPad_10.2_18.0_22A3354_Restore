...
{
  return CFSTR("Music.PlayerTimeControl");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.PlayerTimeControl"), CFSTR("accessibilityTotalDuration"), "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.PlayerTimeControl"), CFSTR("accessibilityElapsedDuration"), "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.PlayerTimeControl"), CFSTR("accessibilityUpdateWithElapsedDuration:"), "v", "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.PlayerTimeControl"), CFSTR("accessibilityIsLiveContent"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.PlayerTimeControl"), CFSTR("liveLabel"), "@", 0);
