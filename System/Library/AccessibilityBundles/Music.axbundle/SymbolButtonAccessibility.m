...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:", CFSTR("MusicCoreUI.CircularProgressView"));
...
- (BOOL)_axIsCircularProgressView
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  if (v2 && (MEMORY[0x234917228](CFSTR("MusicCoreUI.CircularProgressView")), (objc_opt_isKindOfClass() & 1) != 0))
...
- (id)_accessibilityLabelHelper
{
  ...
  if (!objc_msgSend(v5, "length"))
  {
    ...
    else if (objc_msgSend(v9, "isEqualToString:", CFSTR("person.fill.badge.plus")))
    {
      v10 = CFSTR("collaboration.button");
    }
    else
    {
      if (!objc_msgSend(v9, "isEqualToString:", CFSTR("plus"))
        || (-[SymbolButtonAccessibility accessibilityIdentifier](self, "accessibilityIdentifier"),
            v19 = (void *)objc_claimAutoreleasedReturnValue(),
            v20 = objc_msgSend(v19, "isEqualToString:", CFSTR("Music.ContainerDetail.AddButton")),
            v19,
            !v20))
      {
        if (objc_msgSend(v9, "isEqualToString:", CFSTR("dolby.audio")))
        {
          v21 = CFSTR("dolby.audio");
        }
        else if (objc_msgSend(v9, "isEqualToString:", CFSTR("dolby.atmos")))
        {
          v21 = CFSTR("dolby.atmos");
        }
        else if (objc_msgSend(v9, "isEqualToString:", CFSTR("apple.digital.master")))
        {
          v21 = CFSTR("apple.digital.master");
        }
        ...
        accessibilityOasisMusicLocalizedString(v21);
        v11 = objc_claimAutoreleasedReturnValue();
LABEL_14:
        v12 = (void *)v11;
...
LABEL_15:
        if (!objc_msgSend(v5, "length"))
        {
          ...
          if (v13)
          {
            ...
            if ((objc_msgSend(v16, "isEqualToString:", CFSTR("Favorite")) & 1) != 0
              || objc_msgSend(v16, "isEqualToString:", CFSTR("FavoriteDark")))
            {
...
uint64_t __54__SymbolButtonAccessibility__accessibilityLabelHelper__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  MEMORY[0x234917228](CFSTR("MusicCoreUI.CoreAnimationPackageView"));
...
- (unint64_t)accessibilityTraits
{
  ...
  -[SymbolButtonAccessibility _accessibilityFindSubviewDescendant:](self, "_accessibilityFindSubviewDescendant:", &__block_literal_global_298);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
