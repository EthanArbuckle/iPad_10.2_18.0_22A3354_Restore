...
- (BOOL)isAccessibilityElement
{
  ...
  -[UIButtonAccessibility__Music__UIKit accessibilityIdentifier](self, "accessibilityIdentifier");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("AXNowPlayingSubtitleButton"));

  if (v4)
  {
    -[UIButtonAccessibility__Music__UIKit safeValueForKey:](self, "safeValueForKey:", CFSTR("titleLabel"));
  ...
  else
  {
    ...
    return -[UIButtonAccessibility__Music__UIKit isAccessibilityElement](&v12, sel_isAccessibilityElement);
  }
  return v10;
}
...
- (id)accessibilityLabel
{
  ...
  -[UIButtonAccessibility__Music__UIKit safeValueForKey:](self, "safeValueForKey:", CFSTR("currentImage"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  else
  {
    if (!objc_msgSend(v4, "isEqualToString:", CFSTR("Context-Hate")))
    {
      ...
      -[UIButtonAccessibility__Music__UIKit accessibilityLabel](&v9, sel_accessibilityLabel);
