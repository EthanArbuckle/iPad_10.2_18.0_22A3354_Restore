...
{
  return CFSTR("Music.LyricsSelectionViewController");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.LyricsSelectionViewController"), CFSTR("accessibilityCharacterCount"), "q", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.LyricsSelectionViewController"), CFSTR("accessibilityDidSelectItem"), "v", 0);
