...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("Music.NowPlayingLyricsViewController"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.NowPlayingLyricsViewController"), CFSTR("cardHeight"), "d", 0);
...
- (id)_accessibilityScrollStatus
{
  ...
  -[MusicUIScrollViewAccessibility accessibilityIdentifier](self, "accessibilityIdentifier");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("AXSyncedLyricsScrollView"));

  if (!v4)
    goto LABEL_16;
  -[MusicUIScrollViewAccessibility _accessibilityFindAncestor:startWithSelf:](self, "_accessibilityFindAncestor:startWithSelf:", &__block_literal_global_2, 1);
...
LABEL_16:
    ...
    -[MusicUIScrollViewAccessibility _accessibilityScrollStatus](&v24, sel__accessibilityScrollStatus);
...
uint64_t __60__MusicUIScrollViewAccessibility__accessibilityScrollStatus__block_invoke(uint64_t a1, void *a2)
{
  ...
  MEMORY[0x234917228](CFSTR("MusicCoreUI.SyncedLyricsViewController"));
...
- (double)_accessibilityScrollHeightDistance
{
  ...
  if (v4
    && (-[MusicUIScrollViewAccessibility _accessibilityFindAncestor:startWithSelf:](self, "_accessibilityFindAncestor:startWithSelf:", &__block_literal_global_198, 1), v5 = (void *)objc_claimAutoreleasedReturnValue(), objc_msgSend(v5, "_accessibilityViewController"), v6 = (void *)objc_claimAutoreleasedReturnValue(), v5, v6))
  {
    objc_opt_class();
    __UIAccessibilityCastAsClass();
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[MusicUIScrollViewAccessibility contentOffset](self, "contentOffset");
  ...
  else
  {
    ...
    -[MusicUIScrollViewAccessibility _accessibilityScrollHeightDistance](&v15, sel__accessibilityScrollHeightDistance);
    return v13;
  }
  return v10;
}
