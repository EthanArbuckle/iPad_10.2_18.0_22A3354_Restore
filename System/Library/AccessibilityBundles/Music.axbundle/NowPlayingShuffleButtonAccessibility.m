...
{
  return CFSTR("Music.NowPlayingShuffleButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.NowPlayingShuffleButton"), CFSTR("accessibilityShuffleType"), "q", 0);
}
...
- (id)accessibilityValue
{
  ...
  {
    accessibilityMusicLocalizedString(off_2502C26B0[v2]);
