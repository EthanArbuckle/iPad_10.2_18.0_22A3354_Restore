...
{
  return CFSTR("Music.NowPlayingContentView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("Music.NowPlayingContentView"), CFSTR("accessibilityPlayerVideoLayer"), "@", 0);
