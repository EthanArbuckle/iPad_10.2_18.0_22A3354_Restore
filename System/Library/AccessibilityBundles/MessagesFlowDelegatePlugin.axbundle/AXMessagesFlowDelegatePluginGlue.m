...
+ (void)initialize
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXMessagesFlowDelegatePluginGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __46__AXMessagesFlowDelegatePluginGlue_initialize__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("MessagesFlowDelegatePlugin AX"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("MessagesFlowDelegatePlugin"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("INSendMessageIntentAccessibility"), 1);
}
