...
{
  return CFSTR("SUUITabularLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SUUITabularLockupView"), CFSTR("_layout"), "SUUITabularLockupLayout");
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SUUITabularLockupView"), CFSTR("_viewElementViews"), "NSMapTable");
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SUUITabularLockupLayout"), CFSTR("columns"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("SUUITabularLockupColumn"), CFSTR("childViewElements"), "@", 0);
...
- (id)accessibilityLabel
{
  ...
  v49 = 0;
  -[SUUITabularLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_layout"));
  ...
  -[SUUITabularLockupViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_viewElementViews"));
