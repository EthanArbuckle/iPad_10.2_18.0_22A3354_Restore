...
{
  return CFSTR("SUUIImageCollectionViewCell");
}
...
- (unint64_t)accessibilityTraits
{
  ...
  unint64_t v9;
  objc_super v11;
  SUUIImageCollectionViewCellAccessibility *v12;
  char v13;

  v13 = 0;
  objc_opt_class();
  -[SUUIImageCollectionViewCellAccessibility superview](self, "superview");
...
- (id)accessibilityLabel
{
  ...
  v36[3] = &unk_2502A6CC0;
  v36[4] = self;
  -[SUUIImageCollectionViewCellAccessibility _accessibilityFindDescendant:](self, "_accessibilityFindDescendant:", v36);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (v9)
      {
        ...
        while (2)
        {
          for (i = 0; i != v10; ++i)
          {
            ...
            NSClassFromString(CFSTR("SUUIProductLockupCollectionViewCell"));
        ...
        while (2)
        {
          for (j = 0; j != v18; ++j)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              ...
              accessibilityLocalizedString(CFSTR("cover.photo.of.artist"));
