...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SUUINavigationBarButtonsController"), CFSTR("_buttonItemElements"), "NSMapTable");
  objc_msgSend(v3, "validateClass:", CFSTR("SUUIButtonViewElement"));
...
- (id)_accessibilityComputedLabelForNavigationBarWithAssociatedBarButtonItem:(id)a3
{
  ...
  -[SUUI_UIViewAccessibility _accessibilityComputedLabelForNavigationBarWithAssociatedBarButtonItem:](&v14, sel__accessibilityComputedLabelForNavigationBarWithAssociatedBarButtonItem_, v4);
  ...
  else
  {
    ...
    NSClassFromString(CFSTR("SUUINavigationBarButtonsController"));
