...
{
  return CFSTR("SUUIButtonCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("SUUIButtonCollectionViewCell"), CFSTR("_button"), "UIControl");
...
- (id)accessibilityLabel
{
  ...
  -[SUUIButtonCollectionViewCellAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_button"));
