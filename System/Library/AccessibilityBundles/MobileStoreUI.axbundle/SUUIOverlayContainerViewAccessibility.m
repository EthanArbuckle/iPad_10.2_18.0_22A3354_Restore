...
{
  return CFSTR("SUUIOverlayContainerView");
}
...
{
  objc_msgSend(a3, "validateClass:", CFSTR("SUUIOverlayContainerViewController"));
}
...
- (id)accessibilityElements
{
  ...
  -[SUUIOverlayContainerViewAccessibility _accessibilityValueForKey:](self, "_accessibilityValueForKey:", CFSTR("Backstop"));
  ...
  if (!v3)
  {
    ...
    -[SUUIOverlayContainerViewAccessibility _accessibilitySetRetainedValue:forKey:](self, "_accessibilitySetRetainedValue:forKey:", v3, CFSTR("Backstop"));
  }
  -[SUUIOverlayContainerViewAccessibility subviews](self, "subviews");
...
- (id)_accessibilityObscuredScreenAllowedViews
{
  ...
  -[SUUIOverlayContainerViewAccessibility accessibilityIdentifier](self, "accessibilityIdentifier");
...
LABEL_14:
    ...
    -[SUUIOverlayContainerViewAccessibility _accessibilityObscuredScreenAllowedViews](&v18, sel__accessibilityObscuredScreenAllowedViews);
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    return v8;
  }
