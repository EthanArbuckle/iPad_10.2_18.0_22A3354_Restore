...
- (id)accessibilityLabel
{
  ...
  -[SUUIImageViewAccessibility accessibilityIdentifier](self, "accessibilityIdentifier");
  ...
  else
  {
    if (!objc_msgSend(v3, "isEqualToString:", CFSTR("itunes-mastered")))
    {
      ...
      -[SUUIImageViewAccessibility accessibilityLabel](&v8, sel_accessibilityLabel);
...
- (id)accessibilityValue
{
  ...
  else
  {
    if (!objc_msgSend(v3, "isEqualToString:", CFSTR("Badge_TV_MA")))
    {
      v8.receiver = self;
      v8.super_class = (Class)SUUIImageViewAccessibility;
      -[SUUIImageViewAccessibility accessibilityValue](&v8, sel_accessibilityValue);
      v5 = objc_claimAutoreleasedReturnValue();
      goto LABEL_26;
    }
    v4 = CFSTR("tv.ma");
...
- (BOOL)isAccessibilityElement
{
  ...
  if ((v4 & 1) != 0)
    return 0;
  -[SUUIImageViewAccessibility isAccessibilityUserDefinedElement](self, "isAccessibilityUserDefinedElement");
  ...
  return -[SUUIImageViewAccessibility isAccessibilityElement](&v7, sel_isAccessibilityElement);
}
