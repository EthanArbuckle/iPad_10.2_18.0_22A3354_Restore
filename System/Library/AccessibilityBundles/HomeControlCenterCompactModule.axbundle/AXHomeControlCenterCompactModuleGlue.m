...
uint64_t __69__AXHomeControlCenterCompactModuleGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("Compact Home Module (ControlCenter)"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("Compact Home Module (ControlCenter)"));
...
void __69__AXHomeControlCenterCompactModuleGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("HUCCCompactModuleContentViewControllerAccessibility"), 1);
