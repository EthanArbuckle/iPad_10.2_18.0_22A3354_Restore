...
uint64_t __54__AXCoreRecognitionGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("AX CoreRecognition"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("AX CoreRecognition"));
...
{
  return objc_msgSend(a2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CRCameraReaderAccessibility"), 1);
}
