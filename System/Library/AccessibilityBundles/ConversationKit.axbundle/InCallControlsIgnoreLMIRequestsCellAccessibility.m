...
{
  return CFSTR("ConversationKit.InCallControlsIgnoreLMIRequestsCell");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("ConversationKit.InCallControlsIgnoreLMIRequestsCell"), CFSTR("UICollectionViewListCell"));
}
...
- (id)accessibilityValue
{
  ...
  -[InCallControlsIgnoreLMIRequestsCellAccessibility _axCellSwitch](self, "_axCellSwitch");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)accessibilityTraits
{
  ...
  return *MEMORY[0x24BEBB1A8] | -[InCallControlsIgnoreLMIRequestsCellAccessibility accessibilityTraits](&v3, sel_accessibilityTraits);
}
