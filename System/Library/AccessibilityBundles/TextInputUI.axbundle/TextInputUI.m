id accessibilityLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2503B5180, CFSTR("Accessibility"));
...
void sub_232AFF6CC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, id location, id a16)
{
  id *v16;
  id *v17;
...
void sub_232B00648(_Unwind_Exception *a1)
{
...
void sub_232B01860(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_232B01AFC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void sub_232B01CF8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
...
void __getSpeakTypingServicesClass_block_invoke_cold_1(_QWORD *a1)
{
  ...
  objc_msgSend(v2, "handleFailureInFunction:file:lineNumber:description:", v3, CFSTR("TUIPredictionViewCellAccessibility.m"), 18, CFSTR("%s"), *a1);
...
void __getSpeakTypingServicesClass_block_invoke_cold_2()
{
  ...
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, CFSTR("TUIPredictionViewCellAccessibility.m"), 19, CFSTR("Unable to find class %s"), "SpeakTypingServices");
