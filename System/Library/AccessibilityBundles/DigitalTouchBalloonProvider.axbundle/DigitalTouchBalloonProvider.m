id accessibilityLocalizedString(void *a1)
{
  ...
  if (v2)
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2501F45A0, CFSTR("Accessibility"));
...
void sub_2325BAE30(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_list va;
