id accessibilityLocalizedString(void *a1)
{
  ...
  if (v2)
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_250273068, CFSTR("Accessibility"));
...
void sub_232742020(_Unwind_Exception *a1)
{
  uint64_t v1;
...
void sub_232742BBC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,id location)
{
  id *v26;
  uint64_t v27;
...
void sub_2327430B8(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  id *v3;
...
void sub_232743890(_Unwind_Exception *a1)
{
  id *v1;
  id *v2;
  uint64_t v3;
...
void sub_232744E78(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_2327458D0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
...
void sub_232746C58(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, id *location, id *a10, id *a11, id *a12)
{
  id *v12;
  id *v13;
  uint64_t v14;
  ...
  objc_destroyWeak((id *)(v14 - 248));
  objc_destroyWeak(location);
  objc_destroyWeak(a10);
  objc_destroyWeak((id *)(v14 - 192));
