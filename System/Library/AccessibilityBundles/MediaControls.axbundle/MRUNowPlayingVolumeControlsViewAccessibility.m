...
{
  return CFSTR("MRUNowPlayingVolumeControlsView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceVariable:withType:", CFSTR("MRUNowPlayingVolumeControlsView"), CFSTR("_volumeController"), "MRUVolumeController");
...
- (id)accessibilityValue
{
  ...
  -[MRUNowPlayingVolumeControlsViewAccessibility volumeController](self, "volumeController");
...
{
  -[MRUNowPlayingVolumeControlsViewAccessibility _accessibilityIncreaseVolume:](self, "_accessibilityIncreaseVolume:", 1);
}

- (void)accessibilityDecrement
{
  -[MRUNowPlayingVolumeControlsViewAccessibility _accessibilityIncreaseVolume:](self, "_accessibilityIncreaseVolume:", 0);
}
...
- (id)volumeController
{
  return (id)-[MRUNowPlayingVolumeControlsViewAccessibility safeValueForKey:](self, "safeValueForKey:", CFSTR("_volumeController"));
}
