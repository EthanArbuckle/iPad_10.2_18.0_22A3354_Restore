...
+ (void)accessibilityInitializeBundle
{
  ...
  if (!_Failover)
  {
    ...
    v3 = objc_msgSend(objc_allocWithZone((Class)AXCoverSheetKitGlue), "init");
    v4 = (void *)_Failover;
    _Failover = v3;
...
uint64_t __52__AXCoverSheetKitGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "setValidationTargetName:", CFSTR("CoverSheetKit AX"));
  objc_msgSend(v2, "setOverrideProcessName:", CFSTR("CoverSheetKit"));
...
void __52__AXCoverSheetKitGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CSProminentDisplayViewAccessibility"), 1);
  objc_msgSend(v2, "installSafeCategory:canInteractWithTargetClass:", CFSTR("CSProminentLabeledElementViewAccessibility"), 1);
