...
{
  return CFSTR("MusicApplication.AudioTraitButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateSwiftEnum:", CFSTR("MusicApplication.AudioTrait"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("MusicNowPlayingControlsViewController"), CFSTR("playingItemAudioTrait"), "Optional<AudioTrait>");
...
- (id)_accessibilityLabelHelper
{
  ...
  {
    -[AudioTraitButtonAccessibility _accessibilityFindViewAncestor:startWithSelf:](self, "_accessibilityFindViewAncestor:startWithSelf:", &__block_literal_global_0, 0);
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v4, "_accessibilityViewController");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v5, "safeSwiftValueForKey:", CFSTR("playingItemAudioTrait"));
...
uint64_t __58__AudioTraitButtonAccessibility__accessibilityLabelHelper__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  MEMORY[0x234917594](CFSTR("MusicNowPlayingControlsViewController"));
