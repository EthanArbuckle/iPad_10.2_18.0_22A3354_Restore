...
{
  return CFSTR("MusicApplication.NowPlayingTransportButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("MusicApplication.NowPlayingTransportButton"), CFSTR("UIButton"));
