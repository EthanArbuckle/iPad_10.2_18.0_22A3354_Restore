...
{
  return CFSTR("MusicApplication.NowPlayingRepeatButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("MusicApplication.NowPlayingRepeatButton"), CFSTR("accessibilityRepeatType"), "q", 0);
}
...
- (id)accessibilityValue
{
  ...
  {
    accessibilityMusicLocalizedString(off_2502C94F0[v2]);
