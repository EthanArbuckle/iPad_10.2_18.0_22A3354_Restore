...
{
  return CFSTR("MusicApplication.VolumeSlider");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("MusicApplication.VolumeSlider"), CFSTR("accessibilityUpdateWithVolume:"), "v", "f", 0);
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("MusicApplication.VolumeSlider"), CFSTR("volumeController"), "MPVolumeController");
