...
{
  return CFSTR("MusicApplication.NowPlayingQueueHeaderView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("MusicApplication.NowPlayingQueueHeaderView"), CFSTR("clearButton"), "UIButton");
}
