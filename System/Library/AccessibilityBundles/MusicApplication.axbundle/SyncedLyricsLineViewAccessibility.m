...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v4, "_accessibilityDescendantOfType:", MEMORY[0x234917594](CFSTR("MusicSBS_TextContentView")));
  ...
  objc_msgSend(v4, "_accessibilityDescendantOfType:", MEMORY[0x234917594](CFSTR("MusicTextContentView")));
  ...
  {
LABEL_6:
    objc_msgSend(v4, "_accessibilityDescendantOfType:", MEMORY[0x234917594](CFSTR("MusicInstrumentalContentView")));
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    if (!v12)
    {
      v9 = 0;
