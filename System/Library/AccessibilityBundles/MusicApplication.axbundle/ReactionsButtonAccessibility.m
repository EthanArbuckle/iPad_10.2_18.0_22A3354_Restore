...
{
  return CFSTR("_TtCE16MusicApplicationO11MusicCoreUI9Reactions6Button");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("_TtCE16MusicApplicationO11MusicCoreUI9Reactions6Button"), CFSTR("context"), "Context");
