...
{
  return CFSTR("MusicApplication.PromotionalImageryView");
}
...
- (BOOL)_isTransparentFocusRegion
{
  ...
  if ((-[PromotionalImageryViewAccessibility _accessibilityIsFKARunningForFocusItem](self, "_accessibilityIsFKARunningForFocusItem") & 1) != 0)return 1;
  v4.receiver = self;
  v4.super_class = (Class)PromotionalImageryViewAccessibility;
  return -[PromotionalImageryViewAccessibility _isTransparentFocusRegion](&v4, sel__isTransparentFocusRegion);
}
