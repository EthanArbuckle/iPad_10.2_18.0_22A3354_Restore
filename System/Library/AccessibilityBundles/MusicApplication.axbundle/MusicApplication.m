void sub_232836838(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
id accessibilityMusicLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2502CB200, CFSTR("Accessibility"));
...
id accessibilityOasisMusicLocalizedString(void *a1)
{
  ...
  {
    objc_msgSend(v2, "localizedStringForKey:value:table:", v1, &stru_2502CB200, CFSTR("Accessibility-AQ"));
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
void sub_232840568(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_232841064(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, id *location, id *a14, id *a15)
{
  id *v15;
  id *v16;
  uint64_t v17;
...
void sub_232843818(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
