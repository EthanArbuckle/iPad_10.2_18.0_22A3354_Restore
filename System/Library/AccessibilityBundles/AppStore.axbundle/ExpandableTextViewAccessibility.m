...
{
  return CFSTR("AppStore.ExpandableTextView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.ExpandableTextView"), CFSTR("accessibilityTextLabel"), "@", 0);
}
