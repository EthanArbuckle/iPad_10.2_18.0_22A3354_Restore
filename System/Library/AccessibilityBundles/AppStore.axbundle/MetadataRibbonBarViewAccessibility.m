...
{
  return CFSTR("AppStore.MetadataRibbonBarView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.MetadataRibbonBarView"), CFSTR("dividerLabel"), "DynamicTypeLabel");
}
