...
{
  return CFSTR("AppStore.ReviewSummaryView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.ReviewSummaryView"), CFSTR("subtitleLabel"), "DynamicTypeLabel");
