...
{
  return CFSTR("AppStore.ComponentViewOverflowViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppStore.ComponentViewOverflowViewController"), CFSTR("UIViewController"));
}
