...
{
  return CFSTR("AppStore.AppEventTodayCardCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.AppEventTodayCardCollectionViewCell"), CFSTR("formattedDateView"), "AppPromotionFormattedDateView");
}
