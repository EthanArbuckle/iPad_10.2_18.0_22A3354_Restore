...
{
  return CFSTR("AppStore.InAppPurchaseLockupCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.InAppPurchaseLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
}
