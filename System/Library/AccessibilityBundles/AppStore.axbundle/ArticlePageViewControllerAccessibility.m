...
{
  return CFSTR("AppStore.ArticlePageViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppStore.ArticlePageViewController"), CFSTR("UICollectionViewController"));
}
