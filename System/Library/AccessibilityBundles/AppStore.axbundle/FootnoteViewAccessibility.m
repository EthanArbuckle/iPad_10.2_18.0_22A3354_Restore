...
{
  return CFSTR("AppStore.FootnoteView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.FootnoteView"), CFSTR("accessibilityTextLabel"), "@", 0);
}
