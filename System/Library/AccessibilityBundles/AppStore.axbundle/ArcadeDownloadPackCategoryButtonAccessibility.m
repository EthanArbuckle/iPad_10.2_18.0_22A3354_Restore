...
{
  return CFSTR("AppStore.ArcadeDownloadPackCategoryButton");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.ArcadeDownloadPackCategoryButton"), CFSTR("titleLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppStore.ArcadeDownloadPackCategoryButton"), CFSTR("UIControl"));
