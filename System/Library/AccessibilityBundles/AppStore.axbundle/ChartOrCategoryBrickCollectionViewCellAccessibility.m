...
{
  return CFSTR("AppStore.ChartOrCategoryBrickCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.ChartOrCategoryBrickCollectionViewCell"), CFSTR("titleText"), "Optional<String>");
}
