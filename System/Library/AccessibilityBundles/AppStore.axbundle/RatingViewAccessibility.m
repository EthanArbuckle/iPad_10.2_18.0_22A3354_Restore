...
{
  return CFSTR("AppStore.RatingView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.RatingView"), CFSTR("accessibilityRating"), "d", 0);
}
