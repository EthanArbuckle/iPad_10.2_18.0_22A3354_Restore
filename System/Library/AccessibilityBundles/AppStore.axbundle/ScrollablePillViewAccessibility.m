...
{
  return CFSTR("AppStore.ScrollablePillView");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.ScrollablePillView"), CFSTR("linkLabel"), "DynamicLabel");
}
