...
{
  return CFSTR("AppStore.CardHeaderButton");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.CardHeaderButton"), CFSTR("vibrantImageView"), "UIImageView");
}
