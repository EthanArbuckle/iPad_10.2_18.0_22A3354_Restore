...
{
  return CFSTR("AppStore.ProductNoRatingsView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.ProductNoRatingsView"), CFSTR("accessibilityStatusLabel"), "@", 0);
}
