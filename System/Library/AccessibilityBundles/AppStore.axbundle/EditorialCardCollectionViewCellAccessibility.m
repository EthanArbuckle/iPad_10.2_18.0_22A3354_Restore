...
{
  return CFSTR("AppStore.EditorialCardCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.EditorialCardCollectionViewCell"), CFSTR("accessibilityCaptionLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.EditorialCardCollectionViewCell"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.EditorialCardCollectionViewCell"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.EditorialCardCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
...
- (id)accessibilityCustomActions
{
  ...
  if (objc_msgSend(v4, "_accessibilityViewIsVisible"))
  {
    ...
    v7 = (void *)objc_msgSend(v5, "initWithName:actionHandler:", v6, &__block_literal_global_3);
