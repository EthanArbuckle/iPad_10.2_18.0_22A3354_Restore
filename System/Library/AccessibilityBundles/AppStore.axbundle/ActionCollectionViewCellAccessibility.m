...
{
  return CFSTR("AppStore.ActionCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.ActionCollectionViewCell"), CFSTR("accessibilityTextLabel"), "@", 0);
}
