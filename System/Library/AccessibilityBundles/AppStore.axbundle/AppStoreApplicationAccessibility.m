...
{
  return CFSTR("AppStore.AppStoreApplication");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("AppStore.ActivityViewController"));
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppStore.ActivityViewController"), CFSTR("UIViewController"));
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.AppDelegate"), CFSTR("tabBarController"), "Optional<FlowTabBarController>");
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppStore.FlowTabBarController"), CFSTR("UITabBarController"));
