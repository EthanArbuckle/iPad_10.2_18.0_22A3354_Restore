...
{
  return CFSTR("AppStore.StoreCollectionViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppStore.StoreCollectionViewController"), CFSTR("UICollectionViewController"));
}
