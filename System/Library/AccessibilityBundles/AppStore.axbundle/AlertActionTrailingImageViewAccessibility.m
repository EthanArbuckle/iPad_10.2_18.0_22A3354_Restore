...
{
  return CFSTR("AppStore.AlertActionTrailingImageView");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.AlertActionTrailingImageView"), CFSTR("accessibilityAlertActionLabel"), "@", 0);
}
