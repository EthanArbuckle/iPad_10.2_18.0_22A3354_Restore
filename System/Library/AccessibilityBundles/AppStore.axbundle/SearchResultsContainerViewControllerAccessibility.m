...
{
  return CFSTR("AppStore.SearchResultsContainerViewController");
}
...
{
  objc_msgSend(a3, "validateClass:isKindOfClass:", CFSTR("AppStore.SearchResultsContainerViewController"), CFSTR("UIViewController"));
}
