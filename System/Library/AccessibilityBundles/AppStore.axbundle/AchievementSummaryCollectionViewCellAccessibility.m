...
{
  return CFSTR("AppStore.AchievementSummaryCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.AchievementSummaryCollectionViewCell"), CFSTR("achievementGroupView"), "Optional<AchievementGroupView>");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.AchievementSummaryCollectionViewCell"), CFSTR("numberCompletedLabel"), "DynamicTypeLabel");
  objc_msgSend(v3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.AchievementSummaryCollectionViewCell"), CFSTR("outOfTotalLabel"), "DynamicTypeLabel");
...
- (id)accessibilityLabel
{
  ...
  objc_msgSend(v9, "stringByReplacingOccurrencesOfString:withString:", CFSTR("\u202A/ "), &stru_2501601F8);
