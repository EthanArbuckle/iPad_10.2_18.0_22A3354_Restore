...
{
  return CFSTR("AppStore.SmallLockupCollectionViewCell");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallLockupCollectionViewCell"), CFSTR("accessibilityLockupView"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppStore.SmallLockupView"), CFSTR("BaseLockupView"));
