...
{
  return CFSTR("AppStore.BaseLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:", CFSTR("AppStore.SearchAdTransparencyLabel"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilityHeadingLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilityTertiaryTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilityOfferLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilityOrdinalLabel"), "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilitySubtitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilityOfferButton"), "@", 0);
...
{
  return (id)-[BaseLockupViewAccessibility _accessibilityFindSubviewDescendant:](self, "_accessibilityFindSubviewDescendant:", &__block_literal_global_2);
}
...
uint64_t __65__BaseLockupViewAccessibility__accessibilityAdvertisementElement__block_invoke(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  MEMORY[0x234905FEC](CFSTR("AppStore.SearchAdTransparencyLabel"));
