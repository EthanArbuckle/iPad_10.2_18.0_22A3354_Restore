...
{
  return CFSTR("AppStore.SmallSearchLockupView");
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilitytUserRatingView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilityRatingCountLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilityIsAd"), "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilityAdButton"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilityDescriptionLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilityMetadataRibbonView"), "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("accessibilitySearchTagsRibbonView"), "@", 0);
  objc_msgSend(v3, "validateClass:isKindOfClass:", CFSTR("AppStore.SmallSearchLockupView"), CFSTR("AppStore.BaseLockupView"));
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.BaseLockupView"), CFSTR("accessibilityTitleLabel"), "@", 0);
  objc_msgSend(v3, "validateClass:", CFSTR("AppStore.EditorsChoiceView"));
...
void __56__SmallSearchLockupViewAccessibility_accessibilityLabel__block_invoke(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  v6 = a2;
  MEMORY[0x234905FEC](CFSTR("AppStore.EditorsChoiceView"));
