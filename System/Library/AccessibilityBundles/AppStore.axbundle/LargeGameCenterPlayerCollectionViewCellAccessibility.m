...
{
  return CFSTR("AppStore.LargeGameCenterPlayerCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasSwiftField:withSwiftType:", CFSTR("AppStore.LargeGameCenterPlayerCollectionViewCell"), CFSTR("alias"), "DynamicTypeLabel");
}
