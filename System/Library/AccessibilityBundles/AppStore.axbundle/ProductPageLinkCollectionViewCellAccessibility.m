...
{
  return CFSTR("AppStore.ProductPageLinkCollectionViewCell");
}
...
{
  objc_msgSend(a3, "validateClass:hasInstanceMethod:withFullSignature:", CFSTR("AppStore.ProductPageLinkCollectionViewCell"), CFSTR("acccessibilityTextLabel"), "@", 0);
}
