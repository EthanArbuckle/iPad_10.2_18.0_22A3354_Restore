...
- (DeferredAuthCPServiceWrapper)initWithIOService:(unsigned int)a3 withMgr:(id)a4
{
  uint64_t v4;
  id v6;
  DeferredAuthCPServiceWrapper *v7;
  DeferredAuthCPServiceWrapper *v8;
  objc_super v10;
  ...
  v7 = -[DeferredAuthCPServiceWrapper init](&v10, sel_init);
  v8 = v7;
  if (v7)
  {
    -[DeferredAuthCPServiceWrapper setService:](v7, "setService:", v4);
    -[DeferredAuthCPServiceWrapper setMgr:](v8, "setMgr:", v6);
  }
