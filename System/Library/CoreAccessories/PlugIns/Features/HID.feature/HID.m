...
void sub_21A9A575C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_21A9A5AE4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_21A9A5D68(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
void sub_21A9A5FD0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_list va;
...
void sub_21A9A6220(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_list va;
...
uint64_t __hidGetReportCallback(void *a1, uint64_t a2, unsigned __int8 a3, uint64_t a4, uint64_t a5)
{
  ...
  v8 = 3758097084;
  v9 = a1;
  +[ACCFeaturePluginHIDProvider sharedHIDProvider](ACCFeaturePluginHIDProvider, "sharedHIDProvider");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "getDescriptor:", v9);
  v11 = (void *)objc_claimAutoreleasedReturnValue();

  if (v11 && (objc_msgSend(v11, "isShuttingDown") & 1) == 0)
  {
    if (a5 < 0)
    {
      ...
      {
        *(_WORD *)v16 = 0;
        _os_log_impl(&dword_21A9A3000, v13, OS_LOG_TYPE_INFO, "reportLength < 0, not requesting hid report", v16, 2u);
      }
    ...
    else
    {
      ...
      v8 = objc_msgSend(v11, "handleGetReport:reportID:report:", a2, a3, v12);
...
uint64_t __hidSetReportCallback(void *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  ...
  objc_msgSend(v8, "getDescriptor:", v7);
  ...
  if (v9)
  {
    if (a5 < 0)
    {
      ...
      {
        *(_WORD *)v13 = 0;
        _os_log_impl(&dword_21A9A3000, v10, OS_LOG_TYPE_INFO, "reportLength < 0, not sending report", v13, 2u);
      }
    }
    else
    {
      ...
      objc_msgSend(v9, "handleOutReport:", v10);
    }
...
void __hidServiceRegisteredCallback(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 2112;
    v18 = a3;
    _os_log_impl(&dword_21A9A3000, v8, OS_LOG_TYPE_DEFAULT, "%s: descriptorUUID %@, target (%d), service %@", (uint8_t *)&v11, 0x26u);
  }

  +[ACCFeaturePluginHIDProvider sharedHIDProvider](ACCFeaturePluginHIDProvider, "sharedHIDProvider");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v9, "getDescriptor:", v5);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  if (v10 && (objc_msgSend(v10, "isShuttingDown") & 1) == 0)
    objc_msgSend(v10, "handleHIDComponentUpdate:", 1);
...
void __init_logging_modules_block_invoke(uint64_t a1)
{
    ...
    do
    {
      ...
      if (!v8)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 67109120;
          LODWORD(v13) = v4;
          _os_log_error_impl(&dword_21A9A3000, v6, OS_LOG_TYPE_ERROR, "Subsystem missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
          v7 = *(_QWORD *)(a1 + 32);
          v8 = "<Undefined>";
        }
      }
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 40) + 8 * v4) = v10;
      if (v10)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 136315394;
          ...
          v14 = 2080;
          v15 = v9;
          _os_log_debug_impl(&dword_21A9A3000, v6, OS_LOG_TYPE_DEBUG, "Created log object %s: %s", buf, 0x16u);
        }
      }
      else if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        ...
        v14 = 2080;
        v15 = v9;
        _os_log_error_impl(&dword_21A9A3000, v6, OS_LOG_TYPE_ERROR, "Failed to create os_log_t object %s: %s!", buf, 0x16u);
      }
      ++v4;
  ...
  {
    *(_DWORD *)buf = *((_QWORD *)v2 + 29);
    LODWORD(v13) = v5;
    _os_log_impl(&dword_21A9A3000, MEMORY[0x24BDACB70], OS_LOG_TYPE_INFO, "Created %d log object(s)!", buf, 8u);
...
void __init_logging_modules_block_invoke_cold_1(uint8_t *buf, int a2, _DWORD *a3)
{
  *(_DWORD *)buf = 67109120;
  *a3 = a2;
  _os_log_error_impl(&dword_21A9A3000, MEMORY[0x24BDACB70], OS_LOG_TYPE_ERROR, "Category missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
}
