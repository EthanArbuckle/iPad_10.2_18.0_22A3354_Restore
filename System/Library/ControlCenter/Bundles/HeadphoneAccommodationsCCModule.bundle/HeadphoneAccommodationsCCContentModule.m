...
{
  uint64_t v3;
  HeadphoneAccommodationsCCModuleViewController *moduleViewController;
  HeadphoneAccommodationsCCModuleViewController *v6;
  HeadphoneAccommodationsCCModuleViewController *v7;
  void *v8;
  const char *v9;
  uint64_t v10;
