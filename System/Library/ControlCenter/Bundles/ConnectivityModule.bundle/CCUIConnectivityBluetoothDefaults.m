@implementation CCUIConnectivityBluetoothDefaults

+ (id)standardDefaults
{
  if (qword_25414CC18 != -1)
    dispatch_once(&qword_25414CC18, &unk_24FFCA900);
  return (id)qword_25414CC08;
}

- (CCUIConnectivityBluetoothDefaults)init
{
  return (CCUIConnectivityBluetoothDefaults *)MEMORY[0x24BEDD108](self, sel__initWithDomain_, CFSTR("com.apple.control-center.BluetoothModule"));
}
