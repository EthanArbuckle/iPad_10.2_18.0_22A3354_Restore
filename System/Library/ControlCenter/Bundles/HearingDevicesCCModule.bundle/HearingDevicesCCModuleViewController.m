...
{
  HearingDevicesCCModuleViewController *v2;
  id v3;
  const char *v4;
  uint64_t v5;
  ...
  v2 = -[HearingDevicesCCModuleViewController init](&v21, sel_init);
  if (v2)
  {
    v3 = objc_alloc(MEMORY[0x24BE4BDE8]);
    v5 = objc_msgSend_initWithDelegate_andAvailableModules_(v3, v4, (uint64_t)v2, (uint64_t)&unk_2503FC008);
    ...
    objc_msgSend__systemImageNamed_withConfiguration_(MEMORY[0x24BDF6AC8], v16, (uint64_t)CFSTR("hearingdevice.and.signal.meter"), (uint64_t)v15);
...
- (void)viewDidLoad
{
  ...
  v37.receiver = self;
  v37.super_class = (Class)HearingDevicesCCModuleViewController;
  ...
  objc_msgSend_setAccessibilityIdentifier_(v23, v24, (uint64_t)CFSTR("AX_HEARING_DEVICES"), v25);
