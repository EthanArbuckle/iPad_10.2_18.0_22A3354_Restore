...
{
  MTLFunctionStitchingInputImageblock *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)MTLFunctionStitchingInputImageblock;
  result = -[MTLFunctionStitchingInputImageblock init](&v5, sel_init);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (Class != object_getClass(a3))
    return 0;
  v7 = -[MTLFunctionStitchingInputImageblock bindIndex](self, "bindIndex");
...
- (unint64_t)hash
{
  ...
  v3 = -[MTLFunctionStitchingInputImageblock bindIndex](self, "bindIndex");
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = -[MTLFunctionStitchingInputImageblock description](&v8, sel_description);
  v9[0] = v4;
...
{
  return (NSString *)-[MTLFunctionStitchingInputImageblock formattedDescription:](self, "formattedDescription:", 0);
}
