...
{
  MTLResourceStatePassSampleBufferAttachmentDescriptorInternal *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)MTLResourceStatePassSampleBufferAttachmentDescriptorInternal;
  result = -[MTLResourceStatePassSampleBufferAttachmentDescriptorInternal init](&v3, sel_init);
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)MTLResourceStatePassSampleBufferAttachmentDescriptorInternal;
  -[MTLResourceStatePassSampleBufferAttachmentDescriptorInternal dealloc](&v3, sel_dealloc);
}
...
{
  MTLResourceStatePassSampleBufferAttachmentDescriptorInternal *v4;
...
- (BOOL)isEqual:(id)a3
{
  objc_class *Class;
  int v6;
  MTLResourceStatePassSampleBufferAttachmentDescriptorPrivate *p_private;
