...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  if ((id)objc_opt_class() == a1)
    return +[MTLIntersectionFunctionTableDescriptorInternal allocWithZone:](MTLIntersectionFunctionTableDescriptorInternal, "allocWithZone:", a3);
  v6.receiver = a1;
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  void *v5;
  id v6;
  MTLIntersectionFunctionTableDescriptorPrivate *p_private;
  const __CFString *v8;
  objc_super v10;
  _QWORD v11[10];
  ...
  v6 = -[MTLIntersectionFunctionTableDescriptorInternal description](&v10, sel_description);
  v11[0] = v4;
...
- (id)description
{
  return -[MTLIntersectionFunctionTableDescriptorInternal formattedDescription:](self, "formattedDescription:", 0);
}
