...
{
  -[_MTLAccelerationStructureCommandEncoder doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2, a4, a5, a6);
}

- (void)writeCompactedAccelerationStructureSize:(id)a3 toBuffer:(id)a4 offset:(unint64_t)a5
{
  -[_MTLAccelerationStructureCommandEncoder doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2, a4, a5);
}
...
{
  -[_MTLAccelerationStructureCommandEncoder doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2, a4);
}
...
{
  -[_MTLAccelerationStructureCommandEncoder doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2, a4, a5, a6, a7);
}
...
{
  -[_MTLAccelerationStructureCommandEncoder doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2, a4, a5, a6, a7, a8);
}
...
{
  -[_MTLAccelerationStructureCommandEncoder doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
}
