...
{
  MTLFunctionStitchingInputThreadgroup *result;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)MTLFunctionStitchingInputThreadgroup;
  result = -[MTLFunctionStitchingInputThreadgroup init](&v5, sel_init);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (Class != object_getClass(a3))
    return 0;
  v7 = -[MTLFunctionStitchingInputThreadgroup bindIndex](self, "bindIndex");
...
- (unint64_t)hash
{
  ...
  v3 = -[MTLFunctionStitchingInputThreadgroup bindIndex](self, "bindIndex");
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = -[MTLFunctionStitchingInputThreadgroup description](&v8, sel_description);
  v9[0] = v4;
...
{
  return (NSString *)-[MTLFunctionStitchingInputThreadgroup formattedDescription:](self, "formattedDescription:", 0);
}
