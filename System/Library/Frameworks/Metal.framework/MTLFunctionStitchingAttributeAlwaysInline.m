...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = -[MTLFunctionStitchingAttributeAlwaysInline description](&v8, sel_description);
  v9[0] = v4;
  v9[1] = CFSTR("alwaysInline");
...
{
  return (NSString *)-[MTLFunctionStitchingAttributeAlwaysInline formattedDescription:](self, "formattedDescription:", 0);
}
