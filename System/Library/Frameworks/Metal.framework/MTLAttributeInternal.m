...
- (MTLAttributeInternal)initWithName:(id)a3 attributeIndex:(unint64_t)a4 attributeType:(unint64_t)a5 flags:(MTLAttributeFlags)a6
{
  ...
  v10 = -[MTLAttributeInternal init](&v13, sel_init);
...
- (void)dealloc
{
  ...
  -[MTLAttributeInternal dealloc](&v3, sel_dealloc);
}
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = -[MTLAttributeInternal description](&v9, sel_description);
  v10[0] = v4;
  v10[1] = CFSTR("name =");
...
- (id)description
{
  return -[MTLAttributeInternal formattedDescription:](self, "formattedDescription:", 0);
}
