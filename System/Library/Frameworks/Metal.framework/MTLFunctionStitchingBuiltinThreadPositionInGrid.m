...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = -[MTLFunctionStitchingBuiltinThreadPositionInGrid description](&v8, sel_description);
  v9[0] = v4;
  v9[1] = &stru_1E0FE5DC8;
...
{
  return (NSString *)-[MTLFunctionStitchingBuiltinThreadPositionInGrid formattedDescription:](self, "formattedDescription:", 0);
}
