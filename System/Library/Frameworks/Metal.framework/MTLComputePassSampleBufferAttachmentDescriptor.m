...
+ (MTLComputePassSampleBufferAttachmentDescriptor)allocWithZone:(_NSZone *)a3
{
  ...
  if ((id)objc_opt_class() == a1)
    return (MTLComputePassSampleBufferAttachmentDescriptor *)+[MTLComputePassSampleBufferAttachmentDescriptor allocWithZone:](MTLComputePassSampleBufferAttachmentDescriptorInternal, "allocWithZone:", a3);
  v6.receiver = a1;
