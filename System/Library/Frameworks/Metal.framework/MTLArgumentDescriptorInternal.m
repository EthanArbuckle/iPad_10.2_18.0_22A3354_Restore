...
{
  MTLArgumentDescriptorInternal *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)MTLArgumentDescriptorInternal;
  result = -[MTLArgumentDescriptorInternal init](&v3, sel_init);
  if (result)
  {
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = -[MTLArgumentDescriptorInternal description](&v8, sel_description);
  return (id)objc_msgSend(v5, "stringWithFormat:", CFSTR("%@%@"), v6, indirectArgumentFormattedDescription(a3, &self->_private));
}

- (id)description
{
  return -[MTLArgumentDescriptorInternal formattedDescription:](self, "formattedDescription:", 0);
}
