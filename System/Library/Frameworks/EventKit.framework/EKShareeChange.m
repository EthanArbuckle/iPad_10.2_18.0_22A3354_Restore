...
- (EKShareeChange)initWithChangeProperties:(id)a3
{
  ...
  if (v5)
  {
    ...
    +[EKObjectChangeOwnerIDHelper createOwnerIDWithRowID:objectType:databaseID:](EKObjectChangeOwnerIDHelper, "createOwnerIDWithRowID:objectType:databaseID:", v6, 1, objc_msgSend(v7, "databaseID"));
