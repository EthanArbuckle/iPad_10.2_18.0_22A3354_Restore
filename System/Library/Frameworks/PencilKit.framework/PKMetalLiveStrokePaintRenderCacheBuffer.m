...
- (_QWORD)initWithPoints:(uint64_t)a3 liveStrokePoints:(uint64_t)a4 numPoints:(uint64_t)a5 numVertices:(void *)a6 resourceHandler:
{
  id v11;
  _QWORD *v12;
  id v13;
  ...
  if (a1)
  {
    ...
    if (v12)
    {
      v12[5] = a5;
      v12[6] = a4;
      v13 = -[PKMetalResourceHandler newBufferWithLength:bytes:outOffset:](v11, 24 * a4, a2, (uint64_t)(v12 + 2));
      v14 = (void *)a1[1];
      a1[1] = v13;

      v15 = -[PKMetalResourceHandler newBufferWithLength:bytes:outOffset:](v11, 16 * a4, a3, (uint64_t)(a1 + 4));
      v16 = (void *)a1[3];
      a1[3] = v15;
