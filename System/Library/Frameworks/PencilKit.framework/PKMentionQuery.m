...
- (PKMentionQuery)initWithRecognitionSessionManager:(id)a3
{
  ...
  if (v5)
  {
    v6 = (void *)MEMORY[0x1E0D16820];
    -[PKRecognitionSessionManager session](v4);
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "mentionQueryForRecognitionSession:", v7);
...
- (void)setValidSuffixes:(id)a3
{
  ...
  objc_msgSend(v5, "setValidSuffixes:", v4);
...
- (void)queryDidUpdateResult:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = -[PKMentionQueryItem initWithCoreHandwritingPrefixQueryItem:]([PKMentionQueryItem alloc], "initWithCoreHandwritingPrefixQueryItem:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v13));
    ...
    if ((v16 & 1) != 0)
    {
      ...
      objc_msgSend(v17, "mentionQuery:foundItems:", self, v18);
