...
- (PKHashtagQuery)initWithRecognitionSessionManager:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v6, "hashtagQueryForRecognitionSession:", v7);
...
- (void)queryDidUpdateResult:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = -[PKHashtagQueryItem initWithCoreHandwritingPrefixQueryItem:]([PKHashtagQueryItem alloc], "initWithCoreHandwritingPrefixQueryItem:", *(_QWORD *)(*((_QWORD *)&v19 + 1) + 8 * v13));
    ...
    if ((v16 & 1) != 0)
    {
      ...
      objc_msgSend(v17, "hashtagQuery:foundItems:", self, v18);
