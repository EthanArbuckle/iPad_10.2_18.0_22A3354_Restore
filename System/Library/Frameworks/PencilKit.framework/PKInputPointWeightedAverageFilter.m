...
- (void)addInputPoint:(id *)a3
{
  ...
  double x;
  double xyPositionSmoothingFactor;
  double y;
  double altitude;
  double azimuth;
  double zPosition;
  ...
  double v13;
  double var6;
  double zPositionSmoothingFactor;
  long double var3;
  double altitudeSmoothingFactor;
  double v18;
  long double var2;
  double azimuthSmoothingFactor;
  double v21;
  ...
  if (self)
  {
    ...
    if (numInputPoints)
    {
      ...
      if (xyPositionSmoothingFactor > 1.0)
        x = (x + self->super._filteredPoint.var0.point.x * (xyPositionSmoothingFactor + -1.0))
