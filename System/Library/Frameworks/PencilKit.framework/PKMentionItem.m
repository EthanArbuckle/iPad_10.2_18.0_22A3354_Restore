...
+ (id)mentionItemWithQueryItem:(id)a3 sessionManager:(id)a4
{
  ...
  if (valid)
  {
    v10 = -[PKDetectionItem initWithSessionManager:]([PKMentionItem alloc], "initWithSessionManager:", v6);
...
- (id)_actionNameForActivation:(BOOL)a3
{
  ...
  v5 = v4;
  if (v3)
    objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("Activate Mention"), CFSTR("Activate Mention"), CFSTR("Localizable"));
  else
    objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("Deactivate Mention"), CFSTR("Deactivate Mention"), CFSTR("Localizable"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)description
{
  ...
  v4 = objc_opt_class();
  -[PKMentionItem mentionResult](self, "mentionResult");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[PKMentionItem mentionUUID](self, "mentionUUID");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[PKDetectionItem queryItem](self, "queryItem");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
