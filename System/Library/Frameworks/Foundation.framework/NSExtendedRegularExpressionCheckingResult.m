...
{
  NSExtendedRegularExpressionCheckingResult *v8;
  _NSRange *ranges;
  unint64_t v10;
  _NSRange v11;
  void *v13;
  ...
  {
    v13 = (void *)objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@: must have 1-7 ranges"), _NSFullMethodName((objc_class *)self, a2)), 0);
  ...
  if (v8)
  {
    ...
    while (v10);
    if (a4 <= 6)
      memset_pattern16(&v8->_ranges[a4], &unk_1822CCAE0, 112 - 16 * a4);
  }
  return v8;
}
