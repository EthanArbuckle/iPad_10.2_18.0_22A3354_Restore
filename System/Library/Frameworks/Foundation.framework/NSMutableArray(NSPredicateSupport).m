...
- (void)filterUsingPredicate:()NSPredicateSupport
{
  ...
  if (v9)
  {
    ...
    v14 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99D20]), "_initByAdoptingBuffer:count:size:", v9, v10, v10);
  }
  else
  {
    v14 = objc_msgSend(objc_alloc(MEMORY[0x1E0C99D20]), "initWithObjects:count:", v7, v19[0]);
  }
  v15 = (void *)v14;
  objc_msgSend(a1, "setArray:", v14);
