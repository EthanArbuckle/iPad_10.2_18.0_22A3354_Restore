...
{
  objc_msgSend(-[NSKeyValueSlowMutableOrderedSet _nonNilOrderedSetValueWithSelector:](self, "_nonNilOrderedSetValueWithSelector:", a2), "getObjects:range:", a3, a4.location, a4.length);
}
...
- (void)insertObject:(id)a3 atIndex:(unint64_t)a4
{
  ...
  else
  {
    ...
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E10]), "initWithObjects:count:", &v10, 1);
  }
  ...
  if (!v8)
  {
    if (self->_treatNilValuesLikeEmptyOrderedSets)
    {
      if (a3 && a4)
      {
        ...
        v14 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@: the counts of the passed-in ordered set (%lu) and index set (%lu) must be identical."), _NSMethodExceptionProem((objc_class *)self, a2), v9, v10);
      }
      else
      {
        v12 = _NSMethodExceptionProem((objc_class *)self, a2);
        v13 = CFSTR("passed-in ordered set");
        if (a3)
          v13 = CFSTR("index set");
...
- (void)removeObjectAtIndex:(unint64_t)a3
{
  ...
  v5 = -[NSKeyValueSlowMutableOrderedSet _createNonNilMutableOrderedSetValueWithSelector:](self, "_createNonNilMutableOrderedSetValueWithSelector:", a2);
...
- (void)replaceObjectAtIndex:(unint64_t)a3 withObject:(id)a4
{
  ...
  v7 = -[NSKeyValueSlowMutableOrderedSet _createNonNilMutableOrderedSetValueWithSelector:](self, "_createNonNilMutableOrderedSetValueWithSelector:", a2);
