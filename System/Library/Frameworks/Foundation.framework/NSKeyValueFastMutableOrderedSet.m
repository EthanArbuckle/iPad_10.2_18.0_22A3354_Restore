...
- (void)insertObjects:(id)a3 atIndexes:(id)a4
{
  ...
  else
  {
    ...
    -[NSKeyValueFastMutableOrderedSet insertObjects:atIndexes:](&v4, sel_insertObjects_atIndexes_, a3, a4);
  }
}
...
- (void)removeObjectsAtIndexes:(id)a3
{
  ...
  else
  {
    v3.receiver = self;
    v3.super_class = (Class)NSKeyValueFastMutableOrderedSet;
    -[NSKeyValueFastMutableOrderedSet removeObjectsAtIndexes:](&v3, sel_removeObjectsAtIndexes_, a3);
  }
}

- (void)replaceObjectAtIndex:(unint64_t)a3 withObject:(id)a4
{
  NSKeyValueMutatingOrderedSetMethodSet *mutatingMethods;
  NSIndexSet *v8;
  void *v9;
  _QWORD v10[2];
  ...
  else
  {
    ...
    -[NSKeyValueFastMutableOrderedSet insertObject:atIndex:](self, "insertObject:atIndex:", a4, a3);
  }
}
...
- (void)replaceObjectsAtIndexes:(id)a3 withObjects:(id)a4
{
  ...
  else
  {
    v4.receiver = self;
    v4.super_class = (Class)NSKeyValueFastMutableOrderedSet;
    -[NSKeyValueFastMutableOrderedSet replaceObjectsAtIndexes:withObjects:](&v4, sel_replaceObjectsAtIndexes_withObjects_, a3, a4);
  }
}
