...
+ (id)_proxyShare
{
  ...
  result = (id)_proxyShare_proxyShare_4;
...
- (id)_proxyInitWithContainer:(id)a3 getter:(id)a4
{
  ...
  if (v6)
  {
    ...
    v6->_methods = (NSKeyValueNonmutatingOrderedSetMethodSet *)(id)objc_msgSend(a4, "methods");
  }
  return v6;
}
...
- (id)objectsAtIndexes:(id)a3
{
  ...
  else
  {
    v4.receiver = self;
    v4.super_class = (Class)NSKeyValueOrderedSet;
    return -[NSKeyValueOrderedSet objectsAtIndexes:](&v4, sel_objectsAtIndexes_, a3);
  }
  return result;
}
