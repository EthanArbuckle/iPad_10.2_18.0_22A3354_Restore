...
- (void)filterUsingPredicate:()NSPredicateSupport
{
  ...
  *(_QWORD *)&v6 = MEMORY[0x1E0C80A78](v5).n128_u64[0];
  ...
  _filterObjectsUsingPredicate((void *)objc_msgSend(a1, "array", v6), a3, (uint64_t)v8, v16);
  v11 = objc_alloc(MEMORY[0x1E0C99E10]);
  v12 = (void *)objc_msgSend(v11, "initWithObjects:count:", v8, v16[0]);
  objc_msgSend(a1, "setOrderedSet:", v12);
