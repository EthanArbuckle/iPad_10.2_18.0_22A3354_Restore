...
- (NSTransitInformationCheckingResult)initWithRange:(_NSRange)a3 components:(id)a4 underlyingResult:(void *)a5
{
  NSUInteger length;
  NSUInteger location;
  NSTransitInformationCheckingResult *v9;
  NSTransitInformationCheckingResult *v10;
  objc_super v12;
  uint64_t v13;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = -[NSTransitInformationCheckingResult components](self, "components");
  v6 = objc_msgSend(a3, "allowsKeyedCoding");
  -[NSTextCheckingResult encodeRangeWithCoder:](self, "encodeRangeWithCoder:", a3);
  if ((v6 & 1) != 0)
    objc_msgSend(a3, "encodeObject:forKey:", v5, CFSTR("NSTransitInformationComponents"));
  else
...
- (NSTransitInformationCheckingResult)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(a3, "allowsKeyedCoding") & 1) != 0)
  {
    ...
    v10 = objc_opt_class();
    v11 = objc_msgSend(a3, "decodeObjectOfClasses:forKey:", objc_msgSend(v9, "setWithObjects:", v10, objc_opt_class(), 0), CFSTR("NSTransitInformationComponents"));
...
- (id)resultByAdjustingRangesWithOffset:(int64_t)a3
{
  ...
  v6 = -[NSTransitInformationCheckingResult range](self, "range");
  v8 = v7;
