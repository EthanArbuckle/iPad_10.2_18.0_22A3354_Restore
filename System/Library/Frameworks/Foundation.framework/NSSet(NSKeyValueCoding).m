...
- (id)valueForKey:()NSKeyValueCoding
{
  ...
  else
  {
    ...
    v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E60]), "initWithObjects:count:", v10, v11);
    free(v10);
  }
  return v9;
}
...
- (NSDecimalNumber)_sumForKeyPath:()NSKeyValueCoding
{
  ...
  v15 = 0u;
  v16 = 0u;
  v6 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v15, v14, 16);
  if (v6)
  {
    v7 = v6;
    v8 = *(_QWORD *)v16;
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*(_QWORD *)v16 != v8)
          objc_enumerationMutation(a1);
        v10 = (void *)objc_msgSend(*(id *)(*((_QWORD *)&v15 + 1) + 8 * i), "valueForKeyPath:", a3);
        if (v10)
        {
          LODWORD(v13) = 0;
          objc_msgSend(v10, "decimalValue", 0, 0, v13);
          NSDecimalAdd(&leftOperand, &leftOperand, (const NSDecimal *)&v12, NSRoundBankers);
        }
      }
      v7 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v15, v14, 16);
    }
    while (v7);
  }
  v12 = (__int128)leftOperand;
  LODWORD(v13) = *(_DWORD *)&leftOperand._mantissa[6];
  return +[NSDecimalNumber decimalNumberWithDecimal:](NSDecimalNumber, "decimalNumberWithDecimal:", &v12);
}
...
- (void)_maxForKeyPath:()NSKeyValueCoding
{
  ...
  v16 = 0u;
  v17 = 0u;
  v5 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v14, v13, 16);
  if (!v5)
    return 0;
  v6 = v5;
  v7 = 0;
  ...
  do
  {
    for (i = 0; i != v6; ++i)
    {
      if (*(_QWORD *)v15 != v8)
        objc_enumerationMutation(a1);
      v10 = objc_msgSend(*(id *)(*((_QWORD *)&v14 + 1) + 8 * i), "valueForKeyPath:", a3);
      if (v10)
      {
        v11 = (void *)v10;
    ...
    v6 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v14, v13, 16);
  }
  while (v6);
  return v7;
}
...
- (void)_distinctUnionOfArraysForKeyPath:()NSKeyValueCoding
{
  ...
  v5 = (void *)objc_msgSend(MEMORY[0x1E0C99E20], "setWithCapacity:", objc_msgSend(a1, "count"));
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
  v6 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v13, v12, 16);
  if (v6)
  {
    v7 = v6;
    v8 = *(_QWORD *)v14;
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v14 != v8)
          objc_enumerationMutation(a1);
        v10 = objc_msgSend(*(id *)(*((_QWORD *)&v13 + 1) + 8 * v9), "valueForKeyPath:", a3);
        if (v10)
          objc_msgSend(v5, "addObjectsFromArray:", v10);
        ++v9;
      }
      while (v7 != v9);
      v7 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v13, v12, 16);
    }
    while (v7);
  }
  return v5;
...
- (void)_distinctUnionOfObjectsForKeyPath:()NSKeyValueCoding
{
  ...
  v14 = 0u;
  v15 = 0u;
  v6 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v12, v11, 16);
  if (v6)
  {
    v7 = v6;
    v8 = *(_QWORD *)v13;
    do
    {
      ...
      do
      {
        if (*(_QWORD *)v13 != v8)
          objc_enumerationMutation(a1);
        objc_msgSend(v5, "addObject:", objc_msgSend(*(id *)(*((_QWORD *)&v12 + 1) + 8 * v9++), "valueForKeyPath:", a3));
      }
      while (v7 != v9);
      v7 = objc_msgSend(a1, "countByEnumeratingWithState:objects:count:", &v12, v11, 16);
    }
    while (v7);
  }
  return v5;
