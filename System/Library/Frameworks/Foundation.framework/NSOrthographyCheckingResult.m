...
- (NSOrthographyCheckingResult)initWithRange:(_NSRange)a3 orthography:(id)a4
{
  NSUInteger length;
  NSUInteger location;
  NSOrthographyCheckingResult *v7;
  NSOrthographyCheckingResult *v8;
  objc_super v10;
  uint64_t v11;
  ...
  if (v7)
  {
    ...
    v7->_orthography = (NSOrthography *)objc_msgSend(a4, "copy");
  }
  return v8;
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)NSOrthographyCheckingResult;
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@{%@}"), -[NSTextCheckingResult description](&v3, sel_description), -[NSOrthographyCheckingResult orthography](self, "orthography"));
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = -[NSOrthographyCheckingResult orthography](self, "orthography");
  v6 = objc_msgSend(a3, "allowsKeyedCoding");
  -[NSTextCheckingResult encodeRangeWithCoder:](self, "encodeRangeWithCoder:", a3);
  if ((v6 & 1) != 0)
    objc_msgSend(a3, "encodeObject:forKey:", v5, CFSTR("NSOrthography"));
  else
...
- (NSOrthographyCheckingResult)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(a3, "allowsKeyedCoding") & 1) != 0)
  {
    ...
    v8 = v7;
    v9 = objc_msgSend(a3, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("NSOrthography"));
...
- (id)resultByAdjustingRangesWithOffset:(int64_t)a3
{
  ...
  v6 = -[NSOrthographyCheckingResult range](self, "range");
  v8 = v7;
