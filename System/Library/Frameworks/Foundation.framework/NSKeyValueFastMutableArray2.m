...
{
  objc_msgSend(-[NSKeyValueFastMutableArray2 _nonNilArrayValueWithSelector:](self, "_nonNilArrayValueWithSelector:", a2), "getObjects:range:", a3, a4.location, a4.length);
}
