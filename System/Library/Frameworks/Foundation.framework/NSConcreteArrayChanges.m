...
- (NSConcreteArrayChanges)initWithObjects:(const void *)a3 count:(unint64_t)a4
{
  ...
  v6 = -[NSConcreteArrayChanges init](&v9, sel_init);
  if (v6)
  {
...
{
  NSConcreteArrayChanges *v4;

  v4 = +[NSArrayChanges allocWithZone:](NSConcreteArrayChanges, "allocWithZone:", a3);
...
- (void)enumerateChangesUsingBlock:(id)a3
{
  ...
  v4 = *MEMORY[0x1E0C80C00];
  v3 = 0;
  -[NSConcreteArrayChanges _enumerateChanges:stop:usingBlock:](self, "_enumerateChanges:stop:usingBlock:", 62, &v3, a3);
}
...
- (void)addChange:(id)a3
{
  ...
  -[NSConcreteArrayChanges willChangeValueForKey:](self, "willChangeValueForKey:", CFSTR("changeCount"));
  v7 = objc_msgSend(a3, "changeType");
  if (v5 == v6)
    v5 = 0x7FFFFFFFFFFFFFFFLL;
  _NSOrderedChangesAddChange((uint64_t)&self->_changes, v7, v5, v6, (void *)objc_msgSend(a3, "value"));
  -[NSConcreteArrayChanges didChangeValueForKey:](self, "didChangeValueForKey:", CFSTR("changeCount"));
}
