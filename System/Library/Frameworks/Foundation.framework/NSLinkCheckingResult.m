...
- (NSLinkCheckingResult)initWithRange:(_NSRange)a3 URL:(id)a4
{
  NSUInteger length;
  NSUInteger location;
  NSLinkCheckingResult *v7;
  NSLinkCheckingResult *v8;
  objc_super v10;
  uint64_t v11;
  ...
  if (v7)
  {
    ...
    v7->_url = (NSURL *)objc_msgSend(a4, "copy");
  }
  return v8;
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)NSLinkCheckingResult;
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@{%@}"), -[NSTextCheckingResult description](&v3, sel_description), -[NSLinkCheckingResult URL](self, "URL"));
}
...
- (NSLinkCheckingResult)initWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(a3, "allowsKeyedCoding") & 1) != 0)
  {
    ...
    v8 = v7;
    v9 = objc_msgSend(a3, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("NSURL"));
...
- (id)resultByAdjustingRangesWithOffset:(int64_t)a3
{
  ...
  v6 = -[NSLinkCheckingResult range](self, "range");
  v8 = v7;
