...
{
  objc_msgSend(-[NSKeyValueIvarMutableOrderedSet _nonNilMutableOrderedSetValueWithSelector:](self, "_nonNilMutableOrderedSetValueWithSelector:", a2), "getObjects:range:", a3, a4.location, a4.length);
}
...
- (unint64_t)indexOfObject:(id)a3
{
  ...
  if (v5)
    return objc_msgSend(v5, "indexOfObject:", a3);
  else
...
- (void)insertObject:(id)a3 atIndex:(unint64_t)a4
{
  ...
  else
  {
    ...
    *(Class *)((char *)&container->isa + Offset) = (Class)objc_msgSend(objc_alloc(MEMORY[0x1E0C99E10]), "initWithObjects:count:", v11, 1);
  }
}
...
- (void)insertObjects:(id)a3 atIndexes:(id)a4
{
  ...
  if (!a3 || !a4)
  {
    ...
    v15 = CFSTR("passed-in ordered set");
    if (a3)
      v15 = CFSTR("index set");
...
LABEL_14:
  ...
  if (v11 != v12)
  {
    v16 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@: the counts of the passed-in ordered set (%lu) and index set (%lu) must be identical."), _NSMethodExceptionProem((objc_class *)self, a2), v11, v12);
    goto LABEL_14;
  }
...
{
  objc_msgSend(-[NSKeyValueIvarMutableOrderedSet _nonNilMutableOrderedSetValueWithSelector:](self, "_nonNilMutableOrderedSetValueWithSelector:", a2), "removeObjectAtIndex:", a3);
}

- (void)removeObjectsAtIndexes:(id)a3
{
  objc_msgSend(-[NSKeyValueIvarMutableOrderedSet _nonNilMutableOrderedSetValueWithSelector:](self, "_nonNilMutableOrderedSetValueWithSelector:", a2), "removeObjectsAtIndexes:", a3);
}

- (void)replaceObjectAtIndex:(unint64_t)a3 withObject:(id)a4
{
  objc_msgSend(-[NSKeyValueIvarMutableOrderedSet _nonNilMutableOrderedSetValueWithSelector:](self, "_nonNilMutableOrderedSetValueWithSelector:", a2), "replaceObjectAtIndex:withObject:", a3, a4);
}

- (void)replaceObjectsAtIndexes:(id)a3 withObjects:(id)a4
{
  objc_msgSend(-[NSKeyValueIvarMutableOrderedSet _nonNilMutableOrderedSetValueWithSelector:](self, "_nonNilMutableOrderedSetValueWithSelector:", a2), "replaceObjectsAtIndexes:withObjects:", a3, a4);
}
