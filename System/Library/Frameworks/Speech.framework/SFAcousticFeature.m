...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = a3;
  objc_msgSend(v5, "encodeObject:forKey:", acousticFeatureValuePerFrame, CFSTR("_acousticFeaturePerFrame"));
...
- (SFAcousticFeature)initWithCoder:(id)a3
{
  ...
  v5 = -[SFAcousticFeature init](&v13, sel_init);
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v8, CFSTR("_acousticFeaturePerFrame"));
...
- (id)_initWithAcousticFeatureValue:(id)a3 frameDuration:(double)a4
{
  ...
  v7 = -[SFAcousticFeature init](&v11, sel_init);
  if (v7)
  {
...
- (id)description
{
  ...
  -[SFAcousticFeature description](&v6, sel_description);
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringByAppendingFormat:", CFSTR(", featureValues=%@, frameDuration=%f"), self->_acousticFeatureValuePerFrame, *(_QWORD *)&self->_frameDuration);
