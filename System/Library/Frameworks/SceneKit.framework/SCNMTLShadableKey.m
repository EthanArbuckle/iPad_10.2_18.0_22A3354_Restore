...
- (unint64_t)hash
{
  ...
  v2 = ((uint64_t)&self->_geometry[12289054].var6
...
- (BOOL)isEqual:(id)a3
{
  return self->_material == (__C3DMaterial *)*((_QWORD *)a3 + 1)
      && self->_geometry == (__C3DGeometry *)*((_QWORD *)a3 + 2)
      && self->_pipeline == (SCNMTLRenderPipeline *)*((_QWORD *)a3 + 3);
}
