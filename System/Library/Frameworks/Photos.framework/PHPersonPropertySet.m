...
- (PHPerson)person
{
  return (PHPerson *)objc_loadWeakRetained((id *)&self->_person);
}

- (void).cxx_destruct
{
  objc_destroyWeak((id *)&self->_person);
}
...
{
  pl_dispatch_once();
  return (id)propertiesToPrefetch_propertiesToPrefetch_23859;
}
...
void __43__PHPersonPropertySet_propertiesToPrefetch__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v15 = (void *)propertiesToPrefetch_propertiesToPrefetch_23859;
    propertiesToPrefetch_propertiesToPrefetch_23859 = v14;

    v3 = v17;
  }
  else
  {
    objc_storeStrong((id *)&propertiesToPrefetch_propertiesToPrefetch_23859, v3);
  }
