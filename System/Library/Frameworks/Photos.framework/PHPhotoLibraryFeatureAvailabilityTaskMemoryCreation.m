...
void __85___PHPhotoLibraryFeatureAvailabilityTaskMemoryCreation_executeWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  v3 = *(_QWORD *)(a1 + 32);
  v13 = 0;
  v4 = objc_msgSend(WeakRetained, "addGraphAvailabilityToAvailabilityStatus:error:", v3, &v13);
  v5 = v13;
...
void __85___PHPhotoLibraryFeatureAvailabilityTaskMemoryCreation_executeWithCompletionHandler___block_invoke_3(uint64_t a1)
{
  ...
  {
    *(_WORD *)v13 = 0;
    _os_signpost_emit_with_name_impl(&dword_1991EC000, v11, OS_SIGNPOST_INTERVAL_END, v12, "MemoriesCreationFeatureAvailability", ", v13, 2u);
  }
