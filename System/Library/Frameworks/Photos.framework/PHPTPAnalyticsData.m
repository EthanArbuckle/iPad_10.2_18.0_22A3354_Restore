...
- (PHPTPAnalyticsData)init
{
  ...
  v2 = -[PHPTPAnalyticsData init](&v7, sel_init);
  if (v2)
  {
...
- (void)incrementConversionCountForAssetType:(signed __int16)a3
{
  ...
  if ((a3 - 2) < 2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      v5[0] = 67109120;
      v5[1] = v3;
      _os_log_impl(&dword_1991EC000, v4, OS_LOG_TYPE_ERROR, "Unexpected asset type for transcode: %d", (uint8_t *)v5, 8u);
    }
...
- (void)report
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    v13 = 138412290;
    v14 = self;
    _os_log_impl(&dword_1991EC000, v3, OS_LOG_TYPE_DEBUG, "PTP Analytics:\n%@", (uint8_t *)&v13, 0xCu);
  }
  ...
  -[PHPTPAnalyticsData cplStateString](self, "cplStateString");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
