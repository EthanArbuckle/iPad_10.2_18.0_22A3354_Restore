...
- (PHPTPConversionDestinationAssetReader)initWithDestination:(id)a3
{
  ...
  if (!v8)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PHPTPFormatConversionManager.m"), 48, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("path"));
...
- (id)dataSourcePathForDataRange:(_NSRange)a3 error:(id *)a4
{
  ...
  *(_QWORD *)&v27[13] = *MEMORY[0x1E0C80C00];
  -[PHPTPConversionDestinationAssetReader destination](self, "destination");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_QWORD *)v27 = location + length;
    _os_log_impl(&dword_1991EC000, v10, OS_LOG_TYPE_DEBUG, "Begin wait for data availability of range %@ (= file size %lu)", buf, 0x16u);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(double *)&v27[3] = (double)(v16 - v12) / 1000000000.0;
    _os_log_impl(&dword_1991EC000, v17, OS_LOG_TYPE_DEBUG, "End wait for data availability of range %@: %d (%.3fs)", buf, 0x1Cu);
...
LABEL_8:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 138412290;
    v25 = v15;
    _os_log_impl(&dword_1991EC000, v22, OS_LOG_TYPE_ERROR, "Wait for data availability failed %@", buf, 0xCu);
  }
...
- (id)path
{
  ...
  if (v5)
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PHPTPFormatConversionManager.m"), 78, CFSTR("Call to method %@ is incompatible with a wrapped single pass video conversion destination"), v11);
