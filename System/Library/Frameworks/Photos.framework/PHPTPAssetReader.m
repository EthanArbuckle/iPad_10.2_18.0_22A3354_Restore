...
- (PHPTPAssetReader)initWithPath:(id)a3
{
  ...
  v5 = -[PHPTPAssetReader init](&v10, sel_init);
  if (v5)
  {
...
- (PHPTPAssetReader)initWithTemporaryFileDeletedOnDeallocPath:(id)a3
{
  ...
  v3 = -[PHPTPAssetReader initWithPath:](self, "initWithPath:", a3);
  v4 = v3;
  if (v3)
  {
    ...
    if (v28)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412290;
        ...
        v14 = 12;
LABEL_8:
        _os_log_impl(&dword_1991EC000, v13, OS_LOG_TYPE_ERROR, v12, buf, v14);
        goto LABEL_16;
      }
      goto LABEL_16;
    }
    ...
    if (v16)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412290;
        ...
        v23 = 12;
LABEL_14:
        _os_log_impl(&dword_1991EC000, v21, v22, v20, buf, v23);
      }
    }
...
LABEL_17:
  ...
  -[PHPTPAssetReader dealloc](&v25, sel_dealloc);
}
