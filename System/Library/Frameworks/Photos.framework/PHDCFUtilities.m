...
+ (id)dcfCompliantFileNameForFileName:(id)a3 createDate:(id)a4 fileSize:(unint64_t)a5 filenameMarker:(id)a6
{
  ...
  if (v10)
  {
    objc_msgSend(a1, "fileNameByInsertingAuxiliaryResourceTypeMarker:intoFileName:", v10, v11);
...
+ (id)dcfRegexForAuxiliaryResourceFilenameMarker:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v8, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("PHDCFUtilities.m"), 71, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("marker"));
  ...
  if (!v6)
  {
    ...
    objc_msgSend(v9, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, CFSTR("PHDCFUtilities.m"), 91, CFSTR("Unknown auxiliary resource type marker: %@"), v5);
...
+ (id)renderDCFRegex
{
  return (id)objc_msgSend(a1, "dcfRegexForAuxiliaryResourceFilenameMarker:", PHAuxiliaryResourceFilenameMarkerRender);
}
...
+ (id)makeDCFFileNameByHashingFileName:(id)a3 createDate:(id)a4 fileSize:(unint64_t)a5
{
  ...
  v8 = a3;
  objc_msgSend(a1, "dcfCompliantFileNameFromFileNameHash:", objc_msgSend(a1, "hashForFileName:createDate:fileSize:", v8, a4, a5));
  v9 = (void *)objc_claimAutoreleasedReturnValue();
...
+ (id)dcfCompliantFileNameFromFileNameHash:(unsigned int)a3
{
  ...
  v3 = *(_QWORD *)&a3;
  pl_dispatch_once();
  objc_msgSend(a1, "convertHash:usingPlaceValues:", v3, dcfCompliantFileNameFromFileNameHash__pl_once_object_17);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
void __55__PHDCFUtilities_dcfCompliantFileNameFromFileNameHash___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "placeValuesFromBases:", &unk_1E3657618);
