...
- (PHFace)face
{
  return (PHFace *)objc_loadWeakRetained((id *)&self->_face);
}
...
+ (NSString)propertySetName
{
  ...
  objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99768], CFSTR("Abstract base class method"), 0);
...
{
  pl_dispatch_once();
  return (id)propertiesToPrefetch_propertiesToPrefetch_28489;
}
...
void __41__PHFacePropertySet_propertiesToPrefetch__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v15 = (void *)propertiesToPrefetch_propertiesToPrefetch_28489;
    propertiesToPrefetch_propertiesToPrefetch_28489 = v14;

    v3 = v17;
  }
  else
  {
    objc_storeStrong((id *)&propertiesToPrefetch_propertiesToPrefetch_28489, v3);
  }
