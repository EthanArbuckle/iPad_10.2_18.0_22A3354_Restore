@implementation FPDocumentURLFromBookmarkableString
  ...
  if (v5 | v6)
  {
    ...
    if (v5)
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v11 = 138412290;
        v12 = v9;
        _os_log_impl(&dword_1A0A34000, v8, OS_LOG_TYPE_INFO, "[INFO] Resolved bookmark to URL %@", (uint8_t *)&v11, 0xCu);
...
void __FPDocumentURLFromBookmarkableString_block_invoke_2_cold_1(void *a1)
{
  ...
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_11_3(&dword_1A0A34000, v2, v3, "[ERROR] Could not resolve bookmark. Error: %@", v4, v5, v6, v7, v8);
