...
- (MDLTransformRotateXOp)initWithName:(id)a3 inverse:(BOOL)a4 data:(id)a5
{
  id v9;
  id v10;
  MDLTransformRotateXOp *v11;
  MDLTransformRotateXOp *v12;
  MDLTransformRotateXOp *v13;
  objc_super v15;
  ...
  v11 = -[MDLTransformRotateXOp init](&v15, sel_init);
  v12 = v11;
  if (v11)
  {
...
- (double)float4x4AtTime:(uint64_t)a3
{
  ...
  v5.f64[0] = 0.0;
  sub_1DCB51168((uint64_t)v18, v4 * 0.0174532925, (float64x2_t)COERCE_UNSIGNED_INT64(1.0), 0.0, v5);
  v6 = 0;
...
- (double)double4x4AtTime:(uint64_t)a3@<X2>
{
  ...
  v11 = 0u;
  v7.f64[0] = 0.0;
  sub_1DCB51168((uint64_t)&v10, v6 * 0.0174532925, (float64x2_t)COERCE_UNSIGNED_INT64(1.0), 0.0, v7);
  if (*(_BYTE *)(a1 + 8))
  {
    __invert_d4();
  }
