@implementation MPMediaRemoteCollectionInfoToNowPlaying
...
void __MPMediaRemoteCollectionInfoToNowPlaying_block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (objc_msgSend(v5, "isEqualToString:", CFSTR("_MPNowPlayingCollectionInfoKeyIdentifiers")))
  {
    ...
    v12[1] = 3221225472;
    v12[2] = __MPMediaRemoteCollectionInfoToNowPlaying_block_invoke_2;
    v12[3] = &unk_1E315EFE8;
    v13 = *(id *)(a1 + 32);
    v14 = v9;
    v10 = v9;
