...
{
  MPARC4RandomSource *v3;
  MPRandomDistribution *v4;

  v3 = objc_alloc_init(MPARC4RandomSource);
  v4 = -[MPRandomDistribution initWithRandomSource:lowestValue:highestValue:](self, "initWithRandomSource:lowestValue:highestValue:", v3, 0, 0);
...
{
  id v9;
  MPRandomDistribution *v10;
  MPRandomDistribution *v11;
  objc_super v13;

  v9 = a3;
  v13.receiver = self;
  v13.super_class = (Class)MPRandomDistribution;
  v10 = -[MPRandomDistribution init](&v13, sel_init);
  v11 = v10;
  if (v10)
  {
...
- (MPRandomDistribution)initWithCoder:(id)a3
{
  ...
  v8 = -[MPRandomDistribution initWithRandomSource:lowestValue:highestValue:](self, "initWithRandomSource:lowestValue:highestValue:", v5, v6, v7);
  return v8;
}
...
- (unint64_t)nextIntWithUpperBound:(unint64_t)a3
{
  ...
  if (v5 >= a3 - 1)
    v5 = a3 - 1;
  return -[MPRandom nextIntWithUpperBound:](self->_source, "nextIntWithUpperBound:", v5 - lowestValue + 1) + v4;
}
