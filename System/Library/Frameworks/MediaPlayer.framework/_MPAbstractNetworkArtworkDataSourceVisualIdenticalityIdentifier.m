...
- (BOOL)isEqual:(id)a3
{
  _MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier *v4;
  _MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier *v5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  -[_MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier setImageArtworkIdentifier:](v4, "setImageArtworkIdentifier:", self->_imageArtworkIdentifier);
  -[_MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier setVideoArtworkIdentifier:](v4, "setVideoArtworkIdentifier:", self->_videoArtworkIdentifier);
  return v4;
}
...
- (id)stringRepresentation
{
  ...
  -[_MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier imageArtworkIdentifier](self, "imageArtworkIdentifier");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = (void *)objc_msgSend(v3, "copy");

  -[_MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier videoArtworkIdentifier](self, "videoArtworkIdentifier");
