...
{
  _MPDownloadProgressRingView *v3;
  _MPDownloadProgressRingView *v4;
  void *v5;
  id v6;
  id v7;
  objc_super v9;
  ...
  v3 = -[_MPDownloadProgressRingView initWithFrame:](&v9, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    -[_MPDownloadProgressRingView setClipsToBounds:](v3, "setClipsToBounds:", 1);
    -[_MPDownloadProgressRingView layer](v4, "layer");
    ...
    -[_MPDownloadProgressRingView tintColor](v4, "tintColor");
    v7 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
    objc_msgSend(v5, "setStrokeColor:", objc_msgSend(v7, "CGColor"));

    objc_msgSend(v5, "setLineCap:", CFSTR("round"));
    -[_MPDownloadProgressRingView _updateShapePath](v4, "_updateShapePath");
...
- (void)layoutSubviews
{
  ...
  -[_MPDownloadProgressRingView layoutSubviews](&v3, sel_layoutSubviews);
  -[_MPDownloadProgressRingView _updateShapePath](self, "_updateShapePath");
}
...
- (void)tintColorDidChange
{
  ...
  -[_MPDownloadProgressRingView tintColorDidChange](&v6, sel_tintColorDidChange);
  -[_MPDownloadProgressRingView tintColor](self, "tintColor");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[_MPDownloadProgressRingView layer](self, "layer");
...
- (BOOL)_shouldAnimatePropertyWithKey:(id)a3
{
  ...
  if (-[_MPDownloadProgressRingView _shouldAnimatePropertyWithKey:](&v7, sel__shouldAnimatePropertyWithKey_, v4))
    v5 = 1;
  else
...
- (void)_updateShapePath
{
  ...
  -[_MPDownloadProgressRingView bounds](self, "bounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  -[_MPDownloadProgressRingView traitCollection](self, "traitCollection");
  ...
  objc_msgSend(v27, "setLineWidth:", 1.0 / SafeScaleForValue + 2.0);
