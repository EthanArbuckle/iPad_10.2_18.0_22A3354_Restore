...
+ (id)propertyForMPMediaEntityProperty:()MPMediaAdditions
{
  ...
  if (propertyForMPMediaEntityProperty__once_19 != -1)
    dispatch_once(&propertyForMPMediaEntityProperty__once_19, &__block_literal_global_20);
  objc_msgSend((id)propertyForMPMediaEntityProperty__ML3ForMP_18, "objectForKeyedSubscript:", v4);
  ...
  {
    v10.receiver = a1;
    v10.super_class = (Class)&off_1EE35D398;
