...
- (void)appendSection:(id)a3
{
  ...
  v4 = a3;
  -[MPMutableSectionedCollection insertSection:atIndex:](self, "insertSection:atIndex:", v4, -[MPSectionedCollection numberOfSections](self, "numberOfSections"));
...
- (void)appendItem:(id)a3
{
  ...
  v4 = a3;
  v5 = -[MPSectionedCollection numberOfSections](self, "numberOfSections") - 1;
  ...
  -[MPMutableSectionedCollection insertItem:atIndexPath:](self, "insertItem:atIndexPath:", v4, v7);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[MPMutableSectionedCollection appendItem:](self, "appendItem:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++));
      }
      while (v6 != v8);
