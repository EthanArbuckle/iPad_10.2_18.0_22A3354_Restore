...
void ___MPMRInitPropertyAlbumMap_block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    ...
    v17[1] = 3221225472;
    v17[2] = ___MPMRInitPropertyAlbumMap_block_invoke_2;
    v17[3] = &unk_1E3162B80;
    v18 = v4;
  ...
  if (objc_msgSend(v10, "length"))
  {
    v15[0] = v8;
    v15[1] = 3221225472;
    v15[2] = ___MPMRInitPropertyAlbumMap_block_invoke_3;
    v15[3] = &unk_1E3162BA8;
    v16 = v4;
  ...
  v13[0] = v8;
  v13[1] = 3221225472;
  v13[2] = ___MPMRInitPropertyAlbumMap_block_invoke_4;
  v13[3] = &unk_1E3163A30;
  v14 = v4;
  v11 = v4;
...
void ___MPMRInitPropertyAlbumMap_block_invoke_3(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v2, "deviceSpecificUserInfo");
  v5 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "objectForKeyedSubscript:", CFSTR("claid"));
  v4 = (void *)objc_claimAutoreleasedReturnValue();
