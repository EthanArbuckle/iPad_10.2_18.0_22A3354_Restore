...
+ (id)kindWithAlbumKind:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Genre:a%p"), v4);
...
- (void)applyToView:(shared_ptr<mlcore:(id)a4 :LibraryView>)a3 withContext:
{
  ...
  var0 = a3.var0;
  v6 = a3.var1;
  -[MPModelGenreKind albumKind](self, "albumKind");
...
- (id)humanDescription
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("genres with %@"), v3);
...
- (MPModelGenreKind)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    +[MPModelGenreKind kindWithAlbumKind:](MPModelGenreKind, "kindWithAlbumKind:", v5);
    v6 = (MPModelGenreKind *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v6 = 0;
