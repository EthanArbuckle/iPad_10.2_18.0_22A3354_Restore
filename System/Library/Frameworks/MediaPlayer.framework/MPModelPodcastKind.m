...
- (id)humanDescription
{
  ...
  -[MPModelPodcastEpisodeKind humanDescription](self->_episodeKind, "humanDescription");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "stringWithFormat:", CFSTR("podcasts containing %@"), v3);
...
- (unint64_t)hash
{
  ...
  return -[MPModelPodcastEpisodeKind hash](self->_episodeKind, "hash") ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[MPModelKind isEqual:](&v7, sel_isEqual_, v4))
    v5 = -[MPModelPodcastEpisodeKind isEqual:](self->_episodeKind, "isEqual:", v4[2]);
  else
    v5 = 0;
...
- (MPModelPodcastKind)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    +[MPModelPodcastKind kindWithEpisodeKind:](MPModelPodcastKind, "kindWithEpisodeKind:", v5);
    v6 = (MPModelPodcastKind *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v6 = 0;
...
+ (id)kindWithEpisodeKind:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("Podcast:e%p"), v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_opt_class();
...
- (void)applyToView:(shared_ptr<mlcore:(id)a4 :LibraryView>)a3 withContext:
{
  ...
  var0 = a3.var0;
  v6 = a3.var1;
  -[MPModelPodcastKind episodeKind](self, "episodeKind");
