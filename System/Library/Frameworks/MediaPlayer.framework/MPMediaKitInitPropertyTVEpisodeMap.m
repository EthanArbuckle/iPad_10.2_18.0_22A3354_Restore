...
void ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_9(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  v5 = a4;
  objc_msgSend(a2, "objectForKeyedSubscript:", CFSTR("artistName"));
...
id ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_8(uint64_t a1, void *a2)
{
  ...
  v2 = a2;
  _MPKeyPathValueTransformHasNonnullValue(&unk_1E31E5FB0, v2);
  ...
  else
  {
    ...
    v5 = objc_msgSend(v6, "containsObject:", CFSTR("subscription"));
...
id ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_7(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = a3;
  objc_msgSend(a2, "valueForKeyPath:", CFSTR("attributes.previews"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "firstObject");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  MPMediaKitEntityTranslatorTransformArtwork(&unk_1E31E5F80, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
id ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_5(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(a2, "valueForKeyPath:", CFSTR("attributes.contentRatingsBySystem"));
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
id ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  v4 = a3;
  objc_msgSend(a2, "valueForKeyPath:", CFSTR("attributes.offers"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "firstObject");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  MPTranslatorUtilitiesTransformMillisecondsToSeconds(&unk_1E31E5F20, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
void ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  v12[1] = 3221225472;
  v12[2] = ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_2;
  v12[3] = &unk_1E3162A20;
  v13 = v6;
  v14 = v7;
  v8 = v7;
  ...
  objc_msgSend(v9, "setPersonalStoreIdentifiersWithPersonID:block:", v10, &__block_literal_global_421);
