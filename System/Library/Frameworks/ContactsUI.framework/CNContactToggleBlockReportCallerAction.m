...
- (BOOL)isContactBlockedPreservingChanges:(BOOL)a3
{
  ...
  void *v5;
  char v6;
  CNContactToggleBlockReportCallerAction *v8;
  ...
  v6 = objc_msgSend(v5, "BOOLValue", v4, 3221225472, __76__CNContactToggleBlockReportCallerAction_isContactBlockedPreservingChanges___block_invoke_2, &unk_1E204FA50, v8);
...
- (id)checkIsContactBlocked
{
  ...
  -[CNContactToggleBlockReportCallerAction allNumbersAndEmails](self, "allNumbersAndEmails");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "_cn_any:", &__block_literal_global_38264);
...
- (void)performActionWithSender:(id)a3
{
  ...
  v4 = a3;
  if (-[CNContactToggleBlockReportCallerAction isContactBlockedPreservingChanges:](self, "isContactBlockedPreservingChanges:", 1))
  {
    -[CNContactToggleBlockReportCallerAction setContactBlocked:](self, "setContactBlocked:", 0);
  ...
  else
  {
    ...
    objc_msgSend(v7, "localizedStringForKey:value:table:", CFSTR("CARD_ACTION_BLOCK_REPORT_CONTACT_INFO_TEXT"), &stru_1E20507A8, CFSTR("Localized"));
    ...
    objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("CARD_ACTION_BLOCK"), &stru_1E20507A8, CFSTR("Localized"));
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = MEMORY[0x1E0C809B0];
    v25[0] = MEMORY[0x1E0C809B0];
    v25[1] = 3221225472;
    v25[2] = __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke;
    v25[3] = &unk_1E204F7F0;
    v25[4] = self;
    objc_msgSend(v9, "actionWithTitle:style:handler:", v11, 2, v25);
    ...
    objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("CARD_ACTION_BLOCK_REPORT"), &stru_1E20507A8, CFSTR("Localized"));
    v16 = (void *)objc_claimAutoreleasedReturnValue();
    v24[0] = v12;
    v24[1] = 3221225472;
    v24[2] = __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke_2;
    v24[3] = &unk_1E204F7F0;
    v24[4] = self;
    objc_msgSend(v14, "actionWithTitle:style:handler:", v16, 2, v24);
    ...
    v23[0] = v12;
    v23[1] = 3221225472;
    v23[2] = __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke_3;
    v23[3] = &unk_1E204F7F0;
    v23[4] = self;
    ...
    objc_msgSend(v22, "action:presentViewController:sender:", self, v5, v4);
...
- (id)allNumbersAndEmails
{
  ...
  v18[1] = 3221225472;
  v18[2] = __61__CNContactToggleBlockReportCallerAction_allNumbersAndEmails__block_invoke;
  v18[3] = &unk_1E204C980;
  v7 = v3;
  v19 = v7;
  ...
  v13 = v6;
  v14 = 3221225472;
  v15 = __61__CNContactToggleBlockReportCallerAction_allNumbersAndEmails__block_invoke_2;
  v16 = &unk_1E204C980;
  v17 = v7;
  v10 = v7;
...
- (void)setContactBlocked:(BOOL)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[CNContactToggleBlockReportCallerAction setIsBlockedCachedValue:](self, "setIsBlockedCachedValue:", v5);
...
void __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke_2(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "delegate");
  v2 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "actionDidFinishFromSecondaryAction:", *(_QWORD *)(a1 + 32));
