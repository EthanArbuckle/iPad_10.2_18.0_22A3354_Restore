...
void __LoadScreenTimeUI_block_invoke()
{
  ...
  if (!LoadScreenTimeUI_frameworkLibrary && os_log_type_enabled(MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR))
  {
    ...
    v1[0] = 67109120;
    v1[1] = v0;
    _os_log_error_impl(&dword_18AC56000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Failed to Soft Link: /System/Library/PrivateFrameworks/ScreenTimeUI.framework/ScreenTimeUI (%d)", (uint8_t *)v1, 8u);
  }
}
