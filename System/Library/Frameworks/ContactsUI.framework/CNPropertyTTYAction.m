...
LABEL_9:
    ...
    if ((v14 & 1) != 0)
    {
      ...
      {
        objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_ttyURLWithHandle:contact:channelIdentifier:", v12, v11, v17);
...
LABEL_8:
    ...
    objc_msgSend(MEMORY[0x1E0C99E98], "_cnui_ttyURLWithHandle:contact:", v12, v11);
    v18 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_8;
  }
LABEL_10:
