...
void __get_CDInteractionAdvisorSettingsClass_block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = objc_getClass("_CDInteractionAdvisorSettings");
  ...
  else
  {
    ...
    objc_msgSend(v2, "handleFailureInFunction:file:lineNumber:description:", v3, CFSTR("CNCoreDuet.h"), 30, CFSTR("Unable to find class %s"), "_CDInteractionAdvisorSettings");
