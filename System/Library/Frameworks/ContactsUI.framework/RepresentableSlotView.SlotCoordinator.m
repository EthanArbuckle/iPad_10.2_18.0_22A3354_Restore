...
{
  _TtCV10ContactsUI21RepresentableSlotView15SlotCoordinator *result;
...
- (void).cxx_destruct
{
  sub_18ACCDDA8((uint64_t)self + OBJC_IVAR____TtCV10ContactsUI21RepresentableSlotView15SlotCoordinator_parent);
