...
- (CNInstantMessageAddress)imAddress
{
  ...
  if ((isKindOfClass & 1) == 0)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("CNPropertyInstantMessageCell.m"), 39, CFSTR("Unexpected instant message profile value"));
...
- (void)labelButtonClicked:(id)a3
{
  ...
  void *v6;
  unint64_t v7;
  CNInstantMessagePickerController *v8;
  void *v9;
  void *v10;
  uint64_t v11;
  void *v12;
  ...
  if (v7 >= 2)
  {
    v8 = -[CNInstantMessagePickerController initWithStyle:]([CNInstantMessagePickerController alloc], "initWithStyle:", 1);
    ...
    if (objc_msgSend(v14, "count"))
    {
      ...
      -[CNPropertyInstantMessageEditingCell imAddress](self, "imAddress");
