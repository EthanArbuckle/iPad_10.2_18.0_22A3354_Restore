...
{
  CNStarkContactViewController *v3;
  CNStarkContactViewController *v4;
  void *v5;
  CNStarkContactViewController *v6;
  objc_super v8;

  v8.receiver = self;
  v8.super_class = (Class)CNStarkContactViewController;
  v3 = -[CNContactContentUnitaryViewController initWithContact:](&v8, sel_initWithContact_, a3);
  v4 = v3;
  if (v3)
  {
    -[CNContactContentUnitaryViewController setAllowsActions:](v3, "setAllowsActions:", 1);
    -[CNContactContentUnitaryViewController setAllowsCardActions:](v4, "setAllowsCardActions:", 0);
    -[CNContactContentUnitaryViewController setAllowsEditing:](v4, "setAllowsEditing:", 0);
    -[CNContactContentUnitaryViewController setAllowsAddingToAddressBook:](v4, "setAllowsAddingToAddressBook:", 0);
    -[CNContactContentUnitaryViewController setAllowsSharing:](v4, "setAllowsSharing:", 0);
    -[CNContactContentUnitaryViewController setAllowsAddToFavorites:](v4, "setAllowsAddToFavorites:", 0);
    +[CNCapabilitiesManager defaultCapabilitiesManager](CNCapabilitiesManager, "defaultCapabilitiesManager");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[CNContactContentUnitaryViewController setAllowsConferencing:](v4, "setAllowsConferencing:", objc_msgSend(v5, "isFaceTimeAudioAvailable"));
...
- (void)dealloc
{
  ...
  -[CNStarkContactViewController bestiMessageQuery](self, "bestiMessageQuery");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "cancel");

  v4.receiver = self;
  v4.super_class = (Class)CNStarkContactViewController;
  -[CNContactContentUnitaryViewController dealloc](&v4, sel_dealloc);
}
...
- (void)viewWillLayoutSubviews
{
  ...
  -[CNContactContentUnitaryViewController viewWillLayoutSubviews](&v21, sel_viewWillLayoutSubviews);
  -[CNStarkContactViewController contactNameView](self, "contactNameView");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  -[CNStarkContactViewController view](self, "view");
  ...
  -[CNStarkContactViewController navigationItem](self, "navigationItem");
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  -[CNContactContentUnitaryViewController viewDidAppear:](&v5, sel_viewDidAppear_, a3);
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)CNStarkContactViewController;
  -[CNContactContentUnitaryViewController viewWillDisappear:](&v5, sel_viewWillDisappear_, a3);
  -[CNContactContentUnitaryViewController contactView](self, "contactView");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)loadContactViewControllerViews
{
  ...
  -[CNStarkContactViewController setContactNameView:](self, "setContactNameView:", v27);
...
- (void)setupConstraints
{
  ...
  -[CNStarkContactViewController activatedConstraints](self, "activatedConstraints");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  -[CNStarkContactViewController setActivatedConstraints:](self, "setActivatedConstraints:", v13);
...
- (void)viewDidLoad
{
  ...
  -[CNContactContentUnitaryViewController viewDidLoad](&v3, sel_viewDidLoad);
  -[CNStarkContactViewController _initiateBestiMessagePropertyQuery](self, "_initiateBestiMessagePropertyQuery");
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CNStarkContactViewController;
  -[CNContactContentUnitaryViewController viewWillAppear:](&v8, sel_viewWillAppear_, a3);
...
- (void)_initiateBestiMessagePropertyQuery
{
  ...
  getIDSServiceNameiMessage_40255();
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = -[CNPropertyBestIDSValueQuery initWithPropertyItems:service:](v11, "initWithPropertyItems:service:", v6, v12);
  -[CNStarkContactViewController setBestiMessageQuery:](self, "setBestiMessageQuery:", v13);
...
LABEL_14:
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[CNStarkContactViewController iMessageEmailGroup](self, "iMessageEmailGroup");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (!v11)
    {
      objc_msgSend(v23, "setAllowsIMessage:", 1);
      objc_msgSend(v23, "setAllowsEmail:", 0);
      v12 = [CNCardiMessageEmailGroup alloc];
      -[CNContactContentUnitaryViewController contact](self, "contact");
      v13 = (void *)objc_claimAutoreleasedReturnValue();
      v14 = -[CNCardiMessageEmailGroup initWithContact:propertyItem:](v12, "initWithContact:propertyItem:", v13, v23);
      -[CNStarkContactViewController setIMessageEmailGroup:](self, "setIMessageEmailGroup:", v14);
    ...
    if (v4)
    {
      -[CNStarkContactViewController iMessageEmailGroup](self, "iMessageEmailGroup");
      v15 = (void *)objc_claimAutoreleasedReturnValue();
      -[CNContactContentUnitaryViewController addCardGroup:afterGroup:](self, "addCardGroup:afterGroup:", v15, v4);
    ...
    -[CNStarkContactViewController iMessageEmailGroup](self, "iMessageEmailGroup");
    v21 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v20, "insertObject:atIndex:", v21, v18);

    objc_msgSend(MEMORY[0x1E0CB36B8], "indexSetWithIndex:", v18);
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "insertSections:withRowAnimation:", v22, 6);
