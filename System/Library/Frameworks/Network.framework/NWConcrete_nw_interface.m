...
- (void)dealloc
{
  ...
  -[NWConcrete_nw_interface dealloc](&v2, sel_dealloc);
}

- (NSString)description
{
  if (self)
    self = (NWConcrete_nw_interface *)CFStringCreateWithCString((CFAllocatorRef)*MEMORY[0x1E0C9AE00], self->name, 0x8000100u);
...
- (NWConcrete_nw_interface)init
{
  ...
  v2 = -[NWConcrete_nw_interface init](&v16, sel_init);
  v3 = v2;
  if (v2)
  {
    v4 = v2;
