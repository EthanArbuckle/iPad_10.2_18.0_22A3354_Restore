...
{
  NWConcrete_nw_interface_status_monitor *v2;
  NWConcrete_nw_interface_status_monitor *v3;
  NWConcrete_nw_interface_status_monitor *v4;
  void *v6;
  char *v7;
  NSObject *v8;
  os_log_type_t v9;
  ...
  v2 = -[NWConcrete_nw_interface_status_monitor init](&v16, sel_init);
  v3 = v2;
  if (v2)
  {
    v4 = v2;
...
- (void)dealloc
{
  ...
  -[NWConcrete_nw_interface_status_monitor dealloc](&v2, sel_dealloc);
}

- (NSString)description
{
  return (NSString *)(id)CFStringCreateWithFormat((CFAllocatorRef)*MEMORY[0x1E0C9AE00], 0, CFSTR("<nw_interface_status_monitor %@>"), self->interface);
}
