...
- (id)description
{
  ...
  -[NWPBStartBrowse description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NWPBStartBrowse dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (descriptor)
  {
    -[NWPBBrowseDescriptor dictionaryRepresentation](descriptor, "dictionaryRepresentation");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NWPBBrowseDescriptor copyWithZone:](self->_descriptor, "copyWithZone:", a3);
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NWPBParameters isEqual:](parameters, "isEqual:")))
  {
    ...
    if ((unint64_t)clientUUID | v4[1])
      v8 = -[NSString isEqual:](clientUUID, "isEqual:");
    else
      v8 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NWPBBrowseDescriptor hash](self->_descriptor, "hash");
  v4 = -[NWPBParameters hash](self->_parameters, "hash") ^ v3;
