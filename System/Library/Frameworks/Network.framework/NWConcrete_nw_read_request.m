...
{
  NWConcrete_nw_read_request *v2;
  NWConcrete_nw_read_request *v3;
  NWConcrete_nw_read_request *v4;
  void *v6;
  char *v7;
  NSObject *v8;
  os_log_type_t v9;
  ...
  v2 = -[NWConcrete_nw_read_request init](&v16, sel_init);
  v3 = v2;
  if (v2)
  {
    v4 = v2;
...
- (void)dealloc
{
  ...
  -[NWConcrete_nw_read_request dealloc](&v4, sel_dealloc);
}
...
- (NSString)description
{
  ...
  if ((*((_BYTE *)self + 176) & 1) != 0)
    ...
    v2 = "";
  return (NSString *)(id)CFStringCreateWithFormat((CFAllocatorRef)*MEMORY[0x1E0C9AE00], 0, CFSTR("<nw_read_request %zu/[%zu-%zu]%s>"), self->progress, self->min, self->max, v2);
}
