...
- (id)description
{
  ...
  -[NWPBHostEndpoint description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[NWPBHostEndpoint dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  port = self->_port;
  if (port)
    objc_msgSend(v4, "setObject:forKey:", port, CFSTR("port"));
  return v4;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_hostname, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;

  v8 = -[NSString copyWithZone:](self->_port, "copyWithZone:", a3);
  v9 = (void *)v5[2];
  v5[2] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](hostname, "isEqual:")))
  {
    ...
    if ((unint64_t)port | v4[2])
      v7 = -[NSString isEqual:](port, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_hostname, "hash");
