...
{
  NWConcrete_nw_path_observer *v2;
  NWConcrete_nw_path_observer *v3;
  NWConcrete_nw_path_observer *v4;
  void *v6;
  char *v7;
  NSObject *v8;
  os_log_type_t v9;
  ...
  v2 = -[NWConcrete_nw_path_observer init](&v16, sel_init);
  v3 = v2;
  if (v2)
  {
    v4 = v2;
...
- (void)dealloc
{
  ...
  -[NWConcrete_nw_path_observer dealloc](&v2, sel_dealloc);
}
