...
- (MLAppleGazetteer)initWithParameters:(id)a3 modelDescription:(id)a4 nlpHandle:(id)a5 configuration:(id)a6 error:(id *)a7
{
  ...
  void *v17;
  char isKindOfClass;
  MLAppleGazetteer *v19;
  void *v20;
  MLAppleGazetteer *v21;
  void *v22;
  objc_super v24;
...
LABEL_14:
  ...
  if (!v13)
  {
    if (!a7)
      goto LABEL_15;
    +[MLModelErrorUtils genericErrorWithFormat:](MLModelErrorUtils, "genericErrorWithFormat:", CFSTR("Invalid parameters for Gazetteer"));
    v22 = (void *)objc_claimAutoreleasedReturnValue();
    goto LABEL_14;
  }
...
LABEL_7:
  ...
  v19->gazetteerModel = (void *)objc_msgSend(v15, "initializeGazetteerModelWithData:error:", v20, a7);
  ...
  if (a7)
  {
    +[MLModelErrorUtils genericErrorWithFormat:](MLModelErrorUtils, "genericErrorWithFormat:", CFSTR("initialization of gazetteer model with model data failed"));
    v21 = 0;
...
- (void)dealloc
{
  ...
  -[MLAppleGazetteer dealloc](&v4, sel_dealloc);
}
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  ElapsedTimeRecorder::ElapsedTimeRecorder((ElapsedTimeRecorder *)v27, v9, 9, -[MLModel signpostID](self, "signpostID"), objc_msgSend(v8, "parentSignpostID"), -[MLModel nextPredictionRequestID](self, "nextPredictionRequestID"));
  ...
  {
    -[MLAppleGazetteerParameters inputFeatureName](self->_parameters, "inputFeatureName");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v25, "featureValueForName:", v14);
    ...
    if (v16)
    {
      objc_msgSend(v13, "predictLabelForWordString:inputString:error:", self->gazetteerModel, v16, a5);
      v17 = (void *)objc_claimAutoreleasedReturnValue();
      if (v17)
      {
        v18 = [MLDictionaryFeatureProvider alloc];
        -[MLAppleGazetteerParameters outputFeatureName](self->_parameters, "outputFeatureName");
...
LABEL_14:
      ...
      if (*a5)
      {
        ...
        +[MLModelErrorUtils genericErrorWithFormat:](MLModelErrorUtils, "genericErrorWithFormat:", CFSTR("Gazette does not contain input string '%@'. %@"), v16, v23);
        *a5 = (id)objc_claimAutoreleasedReturnValue();

        goto LABEL_14;
      }
      +[MLModelErrorUtils genericErrorWithFormat:](MLModelErrorUtils, "genericErrorWithFormat:", CFSTR("Gazette does not contain input string '%@'. "), v16);
...
+ (id)loadModelFromSpecification:(void *)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  id v8;
  void *v9;
  CoreML::Specification::CoreMLModels::protobuf_Gazetteer_2eproto *v10;
  uint64_t *v11;
  MLAppleGazetteer *v12;
  uint64_t v13;
  uint64_t v14;
  uint64_t v15;
  uint64_t v16;
  ...
  void *v42;
  std::string v43;
  void (**v44)(CoreML::Specification::CoreMLModels::Gazetteer *__hidden);
  uint64_t v45;
  std::string *v46;
  std::string *v47;
  unsigned int v48;
  CoreML::Specification::StringVector *v49;
  int v50;
  int v51;

  v7 = a4;
  if (*(_DWORD *)(*(_QWORD *)a3 + 44) == 2004)
  {
    ...
    v10 = (CoreML::Specification::CoreMLModels::protobuf_Gazetteer_2eproto *)objc_msgSend(v9, "isValid");
    if ((v10 & 1) != 0)
    {
      if (*(_DWORD *)(*(_QWORD *)a3 + 44) == 2004)
      {
      ...
      else
      {
        ...
        v11 = &CoreML::Specification::CoreMLModels::_Gazetteer_default_instance_;
      }
      v44 = &off_1E3D4DA80;
      v45 = 0;
      v50 = 0;
      v13 = v11[1];
      if ((v13 & 1) != 0)
        google::protobuf::internal::InternalMetadataWithArenaLite::DoMergeFrom(&v45, v13 & 0xFFFFFFFFFFFFFFFELL);
      v46 = (std::string *)&google::protobuf::internal::fixed_address_empty_string;
      v14 = v11[2];
      if (*(char *)(v14 + 23) < 0)
        v15 = *(_QWORD *)(v14 + 8);
      else
      ...
      if ((__int128 *)v14 != &google::protobuf::internal::fixed_address_empty_string && v15)
        google::protobuf::internal::ArenaStringPtr::CreateInstanceNoArena(&v46, v14);
      v47 = (std::string *)&google::protobuf::internal::fixed_address_empty_string;
      v16 = v11[3];
      if (*(char *)(v16 + 23) < 0)
        v17 = *(_QWORD *)(v16 + 8);
      else
      ...
      if ((__int128 *)v16 != &google::protobuf::internal::fixed_address_empty_string && v17)
        google::protobuf::internal::ArenaStringPtr::CreateInstanceNoArena(&v47, v16);
      v48 = *((_DWORD *)v11 + 8);
      v51 = 0;
      if (*((_DWORD *)v11 + 13) == 200)
      {
        ...
        if (*((_DWORD *)v11 + 13) == 200)
        {
          v20 = (const CoreML::Specification::MILSpec::TensorValue_RepeatedStrings *)v11[5];
        }
        else
        {
      ...
      v21 = objc_alloc_init(MLAppleGazetteerParameters);
      -[MLAppleGazetteerParameters setRevision:](v21, "setRevision:", v48);
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:");
      v22 = (void *)objc_claimAutoreleasedReturnValue();
      -[MLAppleGazetteerParameters setLanguage:](v21, "setLanguage:", v22);
      ...
      -[MLAppleGazetteerParameters setInputFeatureName:](v21, "setInputFeatureName:", v25);
      ...
      -[MLAppleGazetteerParameters setOutputFeatureName:](v21, "setOutputFeatureName:", v28);

      if (v51 == 200)
      {
        v42 = v9;
        v29 = v49;
        v30 = *((unsigned int *)v49 + 6);
        ...
        if ((int)v30 >= 1)
        {
          ...
          do
          {
            v34 = *(uint64_t **)(*((_QWORD *)v29 + 4) + v32 + 8);
            if (*((char *)v34 + 23) < 0)
              v34 = (uint64_t *)*v34;
        ...
        if (v31)
        {
          ...
          -[MLAppleGazetteerParameters setLabelNames:](v21, "setLabelNames:", v36);

          objc_msgSend(v8, "setClassLabels:", v31);
        }
      }
      else
      {
      ...
      {
        v37 = *(_OWORD *)&v47->__r_.__value_.__l.__data_;
        v43.__r_.__value_.__r.__words[2] = v47->__r_.__value_.__r.__words[2];
      ...
      objc_msgSend(MEMORY[0x1E0C99D50], "dataWithBytes:length:", v38, size);
      v40 = (void *)objc_claimAutoreleasedReturnValue();
      -[MLAppleGazetteerParameters setModelParameterData:](v21, "setModelParameterData:", v40);

      v12 = -[MLAppleGazetteer initWithParameters:modelDescription:nlpHandle:configuration:error:]([MLAppleGazetteer alloc], "initWithParameters:modelDescription:nlpHandle:configuration:error:", v21, v8, v9, v7, a5);
      if (SHIBYTE(v43.__r_.__value_.__r.__words[2]) < 0)
        operator delete(v43.__r_.__value_.__l.__data_);

      CoreML::Specification::CoreMLModels::Gazetteer::~Gazetteer((CoreML::Specification::CoreMLModels::Gazetteer *)&v44);
    }
    else if (a5)
    {
      +[MLModelErrorUtils genericErrorWithFormat:](MLModelErrorUtils, "genericErrorWithFormat:", CFSTR("NaturalLanguage framework not available on this OS version"));
  ...
  {
    +[MLModelErrorUtils IOErrorWithFormat:](MLModelErrorUtils, "IOErrorWithFormat:", CFSTR("Model type is not a Gazetteer"));
    v12 = 0;
    *a5 = (id)objc_claimAutoreleasedReturnValue();
  }
  else
...
+ (BOOL)saveAppleGazetteerModelToURL:(id)a3 gazetteerParameters:(id)a4 error:(id *)a5
{
  ...
  *((_DWORD *)v104 + 6) = 9;
  ...
  else
  {
    ...
    *((_DWORD *)v17 + 11) = 2004;
    v18 = operator new();
    CoreML::Specification::CoreMLModels::Gazetteer::Gazetteer((CoreML::Specification::CoreMLModels::Gazetteer *)v18);
    *((_QWORD *)v17 + 4) = v18;
  }
...
LABEL_75:
  ...
  if (v73)
  {
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("This is a gazetteer model (version %lu) which classifies text according to set {"), objc_msgSend(v94, "revision"));
  ...
  else
  {
    ...
    objc_msgSend(v74, "stringWithFormat:", CFSTR("This is a gazetteer model (version %lu) which classifies %@ text according to set {"), v75, v76, v90);
    v77 = (void *)objc_claimAutoreleasedReturnValue();
