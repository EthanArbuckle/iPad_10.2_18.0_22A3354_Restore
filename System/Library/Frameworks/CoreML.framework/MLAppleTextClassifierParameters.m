...
- (MLAppleTextClassifierParameters)initWithData:(unint64_t)a3 language:(id)a4 inputFeatureName:(id)a5 outputFeatureName:(id)a6 modelData:(id)a7 labelNames:(id)a8 metadata:(id)a9 error:(id *)a10
{
  id v17;
  id v18;
  MLAppleTextClassifierParameters *v19;
  MLAppleTextClassifierParameters *v20;
  MLAppleTextClassifierParameters *v21;
  id v23;
  id v24;
  id v25;
  id v26;
  ...
  v19 = -[MLAppleTextClassifierParameters init](&v27, sel_init);
  v20 = v19;
  if (v19)
  {
    v19->_revision = a3;
  ...
  {
    +[MLModelErrorUtils genericErrorWithFormat:](MLModelErrorUtils, "genericErrorWithFormat:", CFSTR("Initialization of Text classifier parameters failed"), v23, v24, v25, v26);
...
{
  return -[MLAppleTextClassifierParameters initWithData:language:inputFeatureName:outputFeatureName:modelData:labelNames:metadata:error:](self, "initWithData:language:inputFeatureName:outputFeatureName:modelData:labelNames:metadata:error:", a3, a4, a5, a6, a7, a8, MEMORY[0x1E0C9AA70], a9);
}
