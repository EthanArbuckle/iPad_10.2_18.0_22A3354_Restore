...
- (void)setPixelBufferPool:(id)a3
{
  ...
  v5 = a3;
  -[MLE5OutputPort binder](self, "binder");
...
- (MLE5OutputPort)initWithPortHandle:(e5rt_io_port *)a3 name:(id)a4 featureDescription:(id)a5
{
  ...
  v10 = -[MLE5OutputPort init](&v17, sel_init);
  v11 = v10;
  if (v10)
  {
    v10->_portHandle = a3;
    ...
    v14 = -[MLE5OutputPortBinder initWithPort:featureDescription:]([MLE5OutputPortBinder alloc], "initWithPort:featureDescription:", a3, v9);
    binder = v11->_binder;
    v11->_binder = v14;
...
- (void)dealloc
{
  ...
  -[MLE5OutputPort dealloc](&v3, sel_dealloc);
}
...
- (NSString)description
{
  ...
  -[MLE5OutputPort name](self, "name");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("<MLE5OutputPort: %p> %@"), self, v4);
...
- (BOOL)outputBackingWasDirectlyBound
{
  ...
  -[MLE5OutputPort binder](self, "binder");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "outputBackingWasDirectlyBound");
...
- (BOOL)boundFeatureDirectly
{
  ...
  -[MLE5OutputPort binder](self, "binder");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "boundFeatureDirectly");
...
- (BOOL)reusableForOutputBacking:(id)a3 willBindDirectly:(BOOL *)a4
{
  ...
  LOBYTE(a4) = objc_msgSend(v7, "reusableForOutputBacking:willBindDirectly:", v6, a4);
...
- (BOOL)prepareWithOptions:(id)a3 error:(id *)a4
{
  ...
  -[MLE5OutputPort binder](self, "binder");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "outputBackings");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[MLE5OutputPort name](self, "name");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "objectForKeyedSubscript:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "setOutputBacking:", v10);

  LOBYTE(v8) = objc_msgSend(v7, "bindAndReturnError:", a4);
  return (char)v8;
}
