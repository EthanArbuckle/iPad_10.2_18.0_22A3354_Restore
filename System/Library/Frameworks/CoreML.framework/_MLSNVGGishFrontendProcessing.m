...
- (_MLSNVGGishFrontendProcessing)initWithModelDescription:(id)a3 parameterDictionary:(id)a4 error:(id *)p_isa
{
  ...
  if (!NSClassFromString(CFSTR("_SNVGGishFrontEndProcessingCustomModel")))
  {
    if (!p_isa)
      goto LABEL_15;
    v16 = (void *)MEMORY[0x1E0CB35C8];
    v27 = *MEMORY[0x1E0CB2D50];
    v28 = CFSTR("Frontend processing not available on this version");
    v17 = (void *)MEMORY[0x1E0C99D80];
    v18 = &v28;
    v19 = &v27;
    goto LABEL_14;
  ...
  self = -[_MLSNVGGishFrontendProcessing init](&v22, sel_init);
  if (self)
  {
    v12 = (MLCustomModel *)objc_alloc(NSClassFromString(CFSTR("_SNVGGishFrontEndProcessingCustomModel")));
    frontendProcessingModel = self->_frontendProcessingModel;
    self->_frontendProcessingModel = v12;

    v14 = -[MLCustomModel initWithModelDescription:parameterDictionary:error:](self->_frontendProcessingModel, "initWithModelDescription:parameterDictionary:error:", v9, v10, p_isa);
    ...
    v24 = CFSTR("Frontend processing failed to init");
    v17 = (void *)MEMORY[0x1E0C99D80];
    v18 = &v24;
    v19 = &v23;
LABEL_14:
...
{
  return (id)-[MLCustomModel predictionFromFeatures:options:error:](self->_frontendProcessingModel, "predictionFromFeatures:options:error:", a3, a4, a5);
}
