...
{
  return @objc ClarityUIApplicationSceneClientSettings.mutableCopy(with:)((uint64_t)self, (uint64_t)a2, (uint64_t)a3, type metadata accessor for ClarityUIMutableApplicationSceneSettings);
}

- (_TtC7SwiftUI33ClarityUIApplicationSceneSettings)initWithSettings:(id)a3
{
  return (_TtC7SwiftUI33ClarityUIApplicationSceneSettings *)@objc ClarityUIApplicationSceneClientSettings.init(settings:)(self, (uint64_t)a2, (uint64_t)a3, type metadata accessor for ClarityUIApplicationSceneSettings);
}

- (_TtC7SwiftUI33ClarityUIApplicationSceneSettings)init
{
  return (_TtC7SwiftUI33ClarityUIApplicationSceneSettings *)@objc ClarityUIApplicationSceneClientSettings.init()(self, (uint64_t)a2, type metadata accessor for ClarityUIApplicationSceneSettings);
}
