...
{
  MTRLevelControlClusterMoveToLevelParams *v2;
  MTRLevelControlClusterMoveToLevelParams *v3;
  NSNumber *level;
  ...
  v2 = -[MTRLevelControlClusterMoveToLevelParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    level = v2->_level;
...
{
  MTRLevelControlClusterMoveToLevelParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
