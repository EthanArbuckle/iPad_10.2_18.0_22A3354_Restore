...
{
  MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent *v2;
  MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent *v3;
  NSNumber *connectionStatus;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent;
  v2 = -[MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
