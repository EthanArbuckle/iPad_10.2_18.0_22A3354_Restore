...
{
  MTRScenesManagementClusterStoreSceneResponseParams *v2;
  MTRScenesManagementClusterStoreSceneResponseParams *v3;
  NSNumber *status;
  NSNumber *groupID;
  NSNumber *sceneID;
  objc_super v8;
  ...
  v2 = -[MTRScenesManagementClusterStoreSceneResponseParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRScenesManagementClusterStoreSceneResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRScenesManagementClusterStoreSceneResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRScenesManagementClusterStoreSceneResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRScenesManagementClusterStoreSceneResponseParams *v30;
  _BYTE v32[2];
  __int16 v33;
  char v34;
  __int128 v35;
  ...
  v8 = -[MTRScenesManagementClusterStoreSceneResponseParams init](&v39, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v38)
  {
    ...
    if (!(_DWORD)v35)
    {
      ...
      v33 = 0;
      v34 = 0;
      sub_233D181F0((uint64_t)v32, (uint64_t)v37, (uint64_t)&buf);
      v35 = buf;
      v36 = v43;
      if (!(_DWORD)buf)
      {
