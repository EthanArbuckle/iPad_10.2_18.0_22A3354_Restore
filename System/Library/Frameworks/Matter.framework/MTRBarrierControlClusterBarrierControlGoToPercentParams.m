...
{
  MTRBarrierControlClusterBarrierControlGoToPercentParams *v2;
  MTRBarrierControlClusterBarrierControlGoToPercentParams *v3;
  ...
  v2 = -[MTRBarrierControlClusterBarrierControlGoToPercentParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    percentOpen = v2->_percentOpen;
    v2->_percentOpen = (NSNumber *)&unk_250591A40;
...
{
  MTRBarrierControlClusterBarrierControlGoToPercentParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_percentOpen(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: percentOpen:%@; >"), v5, self->_percentOpen);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_setProperty_nonatomic_copy(self, a2, percentOpen, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_percentOpen(self, a3, (uint64_t)a4);
