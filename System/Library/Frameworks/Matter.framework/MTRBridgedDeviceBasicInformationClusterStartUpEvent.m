...
{
  MTRBridgedDeviceBasicInformationClusterStartUpEvent *v2;
  MTRBridgedDeviceBasicInformationClusterStartUpEvent *v3;
  NSNumber *softwareVersion;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRBridgedDeviceBasicInformationClusterStartUpEvent;
  v2 = -[MTRBridgedDeviceBasicInformationClusterStartUpEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRBridgedDeviceBasicInformationClusterStartUpEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: softwareVersion:%@; >"), v5, self->_softwareVersion);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
