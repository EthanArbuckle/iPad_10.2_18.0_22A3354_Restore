...
{
  MTRScenesManagementClusterRemoveSceneParams *v2;
  MTRScenesManagementClusterRemoveSceneParams *v3;
  NSNumber *groupID;
  NSNumber *sceneID;
  ...
  v2 = -[MTRScenesManagementClusterRemoveSceneParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
{
  MTRScenesManagementClusterRemoveSceneParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: groupID:%@; sceneID:%@; >"),
    v5,
    self->_groupID,
    self->_sceneID);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v21)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D17750(&v24, v16, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
