...
- (MTROperationalCredentialsClusterAttestationRequestParams)init
{
  const char *v2;
  uint64_t v3;
  MTROperationalCredentialsClusterAttestationRequestParams *v4;
  uint64_t v5;
  ...
  v4 = -[MTROperationalCredentialsClusterAttestationRequestParams init](&v10, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_attestationNonce(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_attestationNonce, v6, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: attestationNonce:%@; >"), v5, v7);
...
{
  objc_setProperty_nonatomic_copy(self, a2, attestationNonce, 8);
}
