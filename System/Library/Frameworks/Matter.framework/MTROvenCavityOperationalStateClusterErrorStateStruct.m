...
{
  MTROvenCavityOperationalStateClusterErrorStateStruct *v2;
  MTROvenCavityOperationalStateClusterErrorStateStruct *v3;
  ...
  v2 = -[MTROvenCavityOperationalStateClusterErrorStateStruct init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTROvenCavityOperationalStateClusterErrorStateStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
