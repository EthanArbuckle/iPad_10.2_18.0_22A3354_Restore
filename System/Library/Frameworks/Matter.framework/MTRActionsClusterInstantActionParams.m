...
{
  MTRActionsClusterInstantActionParams *v2;
  MTRActionsClusterInstantActionParams *v3;
  NSNumber *actionID;
  NSNumber *invokeID;
  ...
  v2 = -[MTRActionsClusterInstantActionParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRActionsClusterInstantActionParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
