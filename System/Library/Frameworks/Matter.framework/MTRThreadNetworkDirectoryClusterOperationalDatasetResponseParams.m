...
- (MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams)init
{
  const char *v2;
  uint64_t v3;
  MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams *v4;
  uint64_t v5;
  ...
  v4 = -[MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams init](&v8, sel_init);
  if (v4)
  {
...
- (MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams *v30;
  __int128 v32;
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      v32 = 0uLL;
      sub_233D33038(&v32, (uint64_t)v35, (uint64_t)buf);
      v33 = *(_OWORD *)buf;
      v34 = v41;
      if (!*(_DWORD *)buf)
      {
