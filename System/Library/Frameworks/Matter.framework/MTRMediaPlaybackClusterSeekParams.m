...
{
  MTRMediaPlaybackClusterSeekParams *v2;
  MTRMediaPlaybackClusterSeekParams *v3;
  NSNumber *position;
  ...
  v2 = -[MTRMediaPlaybackClusterSeekParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    position = v2->_position;
    v2->_position = (NSNumber *)&unk_250591A40;
...
{
  MTRMediaPlaybackClusterSeekParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: position:%@; >"), v5, self->_position);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_setProperty_nonatomic_copy(self, a2, position, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_position(self, a3, (uint64_t)a4);
