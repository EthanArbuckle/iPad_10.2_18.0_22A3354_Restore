...
- (MTRNetworkCommissioningClusterAddOrUpdateThreadNetworkParams)init
{
  const char *v2;
  uint64_t v3;
  MTRNetworkCommissioningClusterAddOrUpdateThreadNetworkParams *v4;
  uint64_t v5;
  ...
  v4 = -[MTRNetworkCommissioningClusterAddOrUpdateThreadNetworkParams init](&v11, sel_init);
  if (v4)
  {
...
- (id)description
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: operationalDataset:%@; breadcrumb:%@; >"),
    v5,
    v7,
    self->_breadcrumb);
...
{
  objc_setProperty_nonatomic_copy(self, a2, operationalDataset, 8);
}
