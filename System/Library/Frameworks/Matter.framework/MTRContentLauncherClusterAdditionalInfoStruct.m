...
{
  MTRContentLauncherClusterAdditionalInfoStruct *v2;
  MTRContentLauncherClusterAdditionalInfoStruct *v3;
  NSString *name;
  NSString *value;
  objc_super v7;
  ...
  v2 = -[MTRContentLauncherClusterAdditionalInfoStruct init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    name = v2->_name;
...
{
  MTRContentLauncherClusterAdditionalInfoStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: name:%@; value:%@; >"), v5, self->_name, self->_value);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
