...
{
  MTRUnitTestingClusterTestAddArgumentsParams *v2;
  MTRUnitTestingClusterTestAddArgumentsParams *v3;
  NSNumber *arg1;
  NSNumber *arg2;
  ...
  v2 = -[MTRUnitTestingClusterTestAddArgumentsParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterTestAddArgumentsParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
