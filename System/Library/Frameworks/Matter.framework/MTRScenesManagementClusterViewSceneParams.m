...
{
  MTRScenesManagementClusterViewSceneParams *v2;
  MTRScenesManagementClusterViewSceneParams *v3;
  NSNumber *groupID;
  NSNumber *sceneID;
  ...
  v2 = -[MTRScenesManagementClusterViewSceneParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
{
  MTRScenesManagementClusterViewSceneParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
