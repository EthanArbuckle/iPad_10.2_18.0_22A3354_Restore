...
{
  MTRAccountLoginClusterGetSetupPINParams *v2;
  MTRAccountLoginClusterGetSetupPINParams *v3;
  ...
  v2 = -[MTRAccountLoginClusterGetSetupPINParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRAccountLoginClusterGetSetupPINParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: tempAccountIdentifier:%@; >"),
    v5,
