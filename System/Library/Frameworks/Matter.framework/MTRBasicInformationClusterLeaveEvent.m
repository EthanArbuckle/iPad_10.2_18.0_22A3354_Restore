...
{
  MTRBasicInformationClusterLeaveEvent *v2;
  MTRBasicInformationClusterLeaveEvent *v3;
  NSNumber *fabricIndex;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRBasicInformationClusterLeaveEvent;
  v2 = -[MTRBasicInformationClusterLeaveEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRBasicInformationClusterLeaveEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
