...
{
  MTRSampleMEIClusterAddArgumentsResponseParams *v2;
  MTRSampleMEIClusterAddArgumentsResponseParams *v3;
  NSNumber *returnValue;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRSampleMEIClusterAddArgumentsResponseParams;
  v2 = -[MTRSampleMEIClusterAddArgumentsResponseParams init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRSampleMEIClusterAddArgumentsResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRSampleMEIClusterAddArgumentsResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRSampleMEIClusterAddArgumentsResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRSampleMEIClusterAddArgumentsResponseParams *v30;
  char v32;
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRSampleMEIClusterAddArgumentsResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      v32 = 0;
      sub_233D44CC4(&v32, (uint64_t)v35, (uint64_t)&buf);
      v33 = buf;
      v34 = v41;
      if (!(_DWORD)buf)
      {
