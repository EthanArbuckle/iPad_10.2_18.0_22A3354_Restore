...
- (MTRThermostatClusterSetActiveScheduleRequestParams)init
{
  const char *v2;
  uint64_t v3;
  MTRThermostatClusterSetActiveScheduleRequestParams *v4;
  uint64_t v5;
  ...
  v4 = -[MTRThermostatClusterSetActiveScheduleRequestParams init](&v10, sel_init);
  if (v4)
  {
...
- (id)description
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: scheduleHandle:%@; >"), v5, v7);
