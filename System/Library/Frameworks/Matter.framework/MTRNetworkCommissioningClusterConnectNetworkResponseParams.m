...
{
  MTRNetworkCommissioningClusterConnectNetworkResponseParams *v2;
  MTRNetworkCommissioningClusterConnectNetworkResponseParams *v3;
  ...
  v2 = -[MTRNetworkCommissioningClusterConnectNetworkResponseParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRNetworkCommissioningClusterConnectNetworkResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_errorValue(self, v13, v14);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: networkingStatus:%@; debugText:%@; errorValue:%@; >"),
    v5,
...
- (MTRNetworkCommissioningClusterConnectNetworkResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRNetworkCommissioningClusterConnectNetworkResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRNetworkCommissioningClusterConnectNetworkResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRNetworkCommissioningClusterConnectNetworkResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      ...
      v43 = 0;
      v44 = 0;
      sub_233D0695C((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
{
  objc_setProperty_nonatomic_copy(self, a2, errorValue, 24);
}
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (*((_BYTE *)a4 + 8))
  {
    ...
    if (!v19)
    {
      *(_OWORD *)&retstr->mError = xmmword_2504EEBF8;
      *(_QWORD *)&retstr->mLine = 5775;
      return result;
    }
  }
  else
  ...
  if (*((_BYTE *)a4 + 36))
  {
    objc_msgSend_numberWithInt_(MEMORY[0x24BDD16E0], v21, *((unsigned int *)a4 + 8));
