...
{
  MTRDoorLockClusterGetWeekDayScheduleParams *v2;
  MTRDoorLockClusterGetWeekDayScheduleParams *v3;
  ...
  v2 = -[MTRDoorLockClusterGetWeekDayScheduleParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterGetWeekDayScheduleParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
