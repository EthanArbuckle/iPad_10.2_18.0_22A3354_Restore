...
{
  MTRUnitTestingClusterTestSecondBatchHelperRequestParams *v2;
  MTRUnitTestingClusterTestSecondBatchHelperRequestParams *v3;
  ...
  v2 = -[MTRUnitTestingClusterTestSecondBatchHelperRequestParams init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
    sleepBeforeResponseTimeMs = v2->_sleepBeforeResponseTimeMs;
    v2->_sleepBeforeResponseTimeMs = (NSNumber *)&unk_250591A40;

    sizeOfResponseBuffer = v3->_sizeOfResponseBuffer;
    v3->_sizeOfResponseBuffer = (NSNumber *)&unk_250591A40;

    fillCharacter = v3->_fillCharacter;
    v3->_fillCharacter = (NSNumber *)&unk_250591A40;
...
{
  MTRUnitTestingClusterTestSecondBatchHelperRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_sleepBeforeResponseTimeMs(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setSleepBeforeResponseTimeMs_(v4, v8, (uint64_t)v7);

  objc_msgSend_sizeOfResponseBuffer(self, v9, v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setSizeOfResponseBuffer_(v4, v12, (uint64_t)v11);

  objc_msgSend_fillCharacter(self, v13, v14);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: sleepBeforeResponseTimeMs:%@; sizeOfResponseBuffer:%@; fillCharacter:%@; >"),
    v5,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v28[1] = 0;
  v27 = v28;
  objc_msgSend_sleepBeforeResponseTimeMs(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  LOWORD(v29) = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_msgSend_sizeOfResponseBuffer(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  HIWORD(v29) = objc_msgSend_unsignedShortValue(v12, v13, v14);

  objc_msgSend_fillCharacter(self, v15, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  v30 = objc_msgSend_unsignedCharValue(v17, v18, v19);
  ...
  if (v26)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D42E88((unsigned __int16 *)&v29, v21, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
