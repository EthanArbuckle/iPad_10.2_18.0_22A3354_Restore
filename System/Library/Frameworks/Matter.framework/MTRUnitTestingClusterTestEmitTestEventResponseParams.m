...
{
  MTRUnitTestingClusterTestEmitTestEventResponseParams *v2;
  MTRUnitTestingClusterTestEmitTestEventResponseParams *v3;
  NSNumber *value;
  ...
  v2 = -[MTRUnitTestingClusterTestEmitTestEventResponseParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    value = v2->_value;
...
{
  MTRUnitTestingClusterTestEmitTestEventResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRUnitTestingClusterTestEmitTestEventResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRUnitTestingClusterTestEmitTestEventResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRUnitTestingClusterTestEmitTestEventResponseParams *v30;
  uint64_t v32;
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRUnitTestingClusterTestEmitTestEventResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      v32 = 0;
      sub_233D41CD4(&v32, (uint64_t)v35, (uint64_t)&buf);
      v33 = buf;
      v34 = v41;
      if (!(_DWORD)buf)
      {
