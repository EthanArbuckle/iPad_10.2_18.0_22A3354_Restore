...
{
  MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams *v2;
  MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams *v3;
  NSNumber *arg1;
  ...
  v2 = -[MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
