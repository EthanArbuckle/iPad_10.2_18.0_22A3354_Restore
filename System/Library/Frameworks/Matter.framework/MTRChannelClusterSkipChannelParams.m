...
{
  MTRChannelClusterSkipChannelParams *v2;
  MTRChannelClusterSkipChannelParams *v3;
  NSNumber *count;
  ...
  v2 = -[MTRChannelClusterSkipChannelParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    count = v2->_count;
    v2->_count = (NSNumber *)&unk_250591A40;
...
{
  MTRChannelClusterSkipChannelParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: count:%@; >"), v5, self->_count);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_setProperty_nonatomic_copy(self, a2, count, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_getCount(self, a3, (uint64_t)a4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v18 = objc_msgSend_shortValue(v6, v7, v8);
  ...
  if (v15)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D34DD8(&v18, v10, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
