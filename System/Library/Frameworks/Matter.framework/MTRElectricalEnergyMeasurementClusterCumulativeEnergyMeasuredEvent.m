...
{
  MTRElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent *v2;
  MTRElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent *v3;
  ...
  v2 = -[MTRElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRElectricalEnergyMeasurementClusterCumulativeEnergyMeasuredEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
