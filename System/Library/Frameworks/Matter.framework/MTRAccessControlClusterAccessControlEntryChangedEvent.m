...
{
  MTRAccessControlClusterAccessControlEntryChangedEvent *v2;
  MTRAccessControlClusterAccessControlEntryChangedEvent *v3;
  ...
  v2 = -[MTRAccessControlClusterAccessControlEntryChangedEvent init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRAccessControlClusterAccessControlEntryChangedEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
