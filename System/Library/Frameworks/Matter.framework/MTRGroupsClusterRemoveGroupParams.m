...
{
  MTRGroupsClusterRemoveGroupParams *v2;
  MTRGroupsClusterRemoveGroupParams *v3;
  NSNumber *groupID;
  ...
  v2 = -[MTRGroupsClusterRemoveGroupParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
{
  MTRGroupsClusterRemoveGroupParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
