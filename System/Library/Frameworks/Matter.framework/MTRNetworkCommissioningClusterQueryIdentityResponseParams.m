...
- (MTRNetworkCommissioningClusterQueryIdentityResponseParams)init
{
  const char *v2;
  uint64_t v3;
  MTRNetworkCommissioningClusterQueryIdentityResponseParams *v4;
  uint64_t v5;
  NSData *identity;
  ...
  v4 = -[MTRNetworkCommissioningClusterQueryIdentityResponseParams init](&v9, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_identity(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setIdentity_(v4, v8, (uint64_t)v7);

  objc_msgSend_possessionSignature(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_identity, v6, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_base64EncodedStringWithOptions_(self->_possessionSignature, v8, 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v10, (uint64_t)CFSTR("<%@: identity:%@; possessionSignature:%@; >"), v5, v7, v9);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTRNetworkCommissioningClusterQueryIdentityResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRNetworkCommissioningClusterQueryIdentityResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRNetworkCommissioningClusterQueryIdentityResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRNetworkCommissioningClusterQueryIdentityResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      buf = 0uLL;
      LOBYTE(v42) = 0;
      sub_233D07078(&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    objc_msgSend_dataWithBytes_length_(MEMORY[0x24BDBCE50], v13, *v12, v12[1]);
