...
{
  MTROvenCavityOperationalStateClusterResumeParams *v2;
  MTROvenCavityOperationalStateClusterResumeParams *v3;
  ...
  v2 = -[MTROvenCavityOperationalStateClusterResumeParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTROvenCavityOperationalStateClusterResumeParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
