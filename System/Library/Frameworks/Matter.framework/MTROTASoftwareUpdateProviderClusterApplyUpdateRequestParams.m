...
- (MTROTASoftwareUpdateProviderClusterApplyUpdateRequestParams)init
{
  const char *v2;
  uint64_t v3;
  MTROTASoftwareUpdateProviderClusterApplyUpdateRequestParams *v4;
  uint64_t v5;
  NSData *updateToken;
  NSNumber *newVersion;
  ...
  v4 = -[MTROTASoftwareUpdateProviderClusterApplyUpdateRequestParams init](&v11, sel_init);
  if (v4)
  {
    ...
    v4->_newVersion = (NSNumber *)&unk_250591A40;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_getNewVersion(self, v9, v10);
...
- (id)description
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: updateToken:%@; newVersion:%@; >"),
    v5,
    v7,
    self->_newVersion);
...
{
  objc_setProperty_nonatomic_copy(self, a2, newVersion, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v28 = *(_OWORD *)v20;
  objc_msgSend_getNewVersion(self, v14, v15);
