...
{
  MTRScenesManagementClusterGetSceneMembershipParams *v2;
  MTRScenesManagementClusterGetSceneMembershipParams *v3;
  NSNumber *groupID;
  ...
  v2 = -[MTRScenesManagementClusterGetSceneMembershipParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
{
  MTRScenesManagementClusterGetSceneMembershipParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: groupID:%@; >"), v5, self->_groupID);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
