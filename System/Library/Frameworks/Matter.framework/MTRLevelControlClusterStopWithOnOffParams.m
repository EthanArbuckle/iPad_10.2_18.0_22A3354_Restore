...
{
  MTRLevelControlClusterStopWithOnOffParams *v2;
  MTRLevelControlClusterStopWithOnOffParams *v3;
  ...
  v2 = -[MTRLevelControlClusterStopWithOnOffParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    optionsMask = v2->_optionsMask;
    v2->_optionsMask = (NSNumber *)&unk_250591A40;
...
{
  MTRLevelControlClusterStopWithOnOffParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_optionsMask(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setOptionsMask_(v4, v8, (uint64_t)v7);

  objc_msgSend_optionsOverride(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_optionsMask,
...
{
  objc_setProperty_nonatomic_copy(self, a2, optionsMask, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, optionsOverride, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v23[1] = 0;
  v22 = v23;
  objc_msgSend_optionsMask(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v24) = objc_msgSend_unsignedCharValue(v7, v8, v9);

  objc_msgSend_optionsOverride(self, v10, v11);
