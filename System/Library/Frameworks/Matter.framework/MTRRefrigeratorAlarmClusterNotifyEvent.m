...
{
  MTRRefrigeratorAlarmClusterNotifyEvent *v2;
  MTRRefrigeratorAlarmClusterNotifyEvent *v3;
  NSNumber *active;
  NSNumber *inactive;
  NSNumber *state;
  NSNumber *mask;
  ...
  v2 = -[MTRRefrigeratorAlarmClusterNotifyEvent init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    active = v2->_active;
...
{
  MTRRefrigeratorAlarmClusterNotifyEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
