...
{
  MTRColorControlClusterStepHueParams *v2;
  MTRColorControlClusterStepHueParams *v3;
  NSNumber *stepMode;
  NSNumber *stepSize;
  ...
  v2 = -[MTRColorControlClusterStepHueParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterStepHueParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
