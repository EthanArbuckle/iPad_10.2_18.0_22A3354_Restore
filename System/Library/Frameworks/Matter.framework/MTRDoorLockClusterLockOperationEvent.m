...
{
  MTRDoorLockClusterLockOperationEvent *v2;
  MTRDoorLockClusterLockOperationEvent *v3;
  ...
  v2 = -[MTRDoorLockClusterLockOperationEvent init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterLockOperationEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_userIndex(self, v13, v14);
  ...
  objc_msgSend_sourceNode(self, v21, v22);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setSourceNode_(v4, v24, (uint64_t)v23);

  objc_msgSend_credentials(self, v25, v26);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: lockOperationType:%@; operationSource:%@; userIndex:%@; fabricIndex:%@; sourceNode:%@; credentials:%@; >"),
    v5,
...
{
  objc_setProperty_nonatomic_copy(self, a2, userIndex, 24);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, sourceNode, 40);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, credentials, 48);
}
