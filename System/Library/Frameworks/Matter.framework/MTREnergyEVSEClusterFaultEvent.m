...
{
  MTREnergyEVSEClusterFaultEvent *v2;
  MTREnergyEVSEClusterFaultEvent *v3;
  NSNumber *sessionID;
  NSNumber *state;
  ...
  v2 = -[MTREnergyEVSEClusterFaultEvent init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    ...
    v3->_faultStatePreviousState = (NSNumber *)&unk_250591B18;

    faultStateCurrentState = v3->_faultStateCurrentState;
    v3->_faultStateCurrentState = (NSNumber *)&unk_250591B18;
...
{
  MTREnergyEVSEClusterFaultEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_faultStatePreviousState(self, v13, v14);
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setFaultStatePreviousState_(v4, v16, (uint64_t)v15);

  objc_msgSend_faultStateCurrentState(self, v17, v18);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: sessionID:%@; state:%@; faultStatePreviousState:%@; faultStateCurrentState:%@; >"),
    v5,
    self->_sessionID,
    self->_state,
    self->_faultStatePreviousState,
    self->_faultStateCurrentState);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
