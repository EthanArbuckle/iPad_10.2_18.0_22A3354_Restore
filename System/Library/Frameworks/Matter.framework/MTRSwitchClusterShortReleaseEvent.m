...
{
  MTRSwitchClusterShortReleaseEvent *v2;
  MTRSwitchClusterShortReleaseEvent *v3;
  NSNumber *previousPosition;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRSwitchClusterShortReleaseEvent;
  v2 = -[MTRSwitchClusterShortReleaseEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRSwitchClusterShortReleaseEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
