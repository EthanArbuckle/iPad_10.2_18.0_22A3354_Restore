...
{
  MTRMediaInputClusterSelectInputParams *v2;
  MTRMediaInputClusterSelectInputParams *v3;
  NSNumber *index;
  ...
  v2 = -[MTRMediaInputClusterSelectInputParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
...
{
  MTRMediaInputClusterSelectInputParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
