...
{
  MTRGroupsClusterRemoveAllGroupsParams *v2;
  MTRGroupsClusterRemoveAllGroupsParams *v3;
  ...
  v2 = -[MTRGroupsClusterRemoveAllGroupsParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRGroupsClusterRemoveAllGroupsParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
