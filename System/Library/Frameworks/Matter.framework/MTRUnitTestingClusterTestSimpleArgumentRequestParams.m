...
{
  MTRUnitTestingClusterTestSimpleArgumentRequestParams *v2;
  MTRUnitTestingClusterTestSimpleArgumentRequestParams *v3;
  NSNumber *arg1;
  ...
  v2 = -[MTRUnitTestingClusterTestSimpleArgumentRequestParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterTestSimpleArgumentRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v18 = objc_msgSend_BOOLValue(v6, v7, v8);
  ...
  if (v15)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D0C978(&v18, v10, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
