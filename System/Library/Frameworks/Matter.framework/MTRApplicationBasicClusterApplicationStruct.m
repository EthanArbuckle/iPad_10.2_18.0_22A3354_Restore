...
{
  MTRApplicationBasicClusterApplicationStruct *v2;
  MTRApplicationBasicClusterApplicationStruct *v3;
  ...
  v2 = -[MTRApplicationBasicClusterApplicationStruct init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRApplicationBasicClusterApplicationStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
