...
{
  MTRAccountLoginClusterLogoutParams *v2;
  MTRAccountLoginClusterLogoutParams *v3;
  NSNumber *node;
  ...
  v2 = -[MTRAccountLoginClusterLogoutParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    node = v2->_node;
...
{
  MTRAccountLoginClusterLogoutParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v21[1] = 0;
  v20 = v21;
  objc_msgSend_node(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    v22[0] = 1;
    v23 = 0;
    objc_msgSend_node(self, v8, v9);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v23 = objc_msgSend_unsignedLongLongValue(v10, v11, v12);
  ...
  if (v19)
  {
    ...
    sub_234106CA8((uint64_t)v14, (uint64_t)&v15, 0xFFFFFFFF, (uint64_t)v24);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D3B50C(v22, v14, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
