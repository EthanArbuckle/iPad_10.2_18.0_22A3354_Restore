...
{
  MTRDoorLockClusterClearHolidayScheduleParams *v2;
  MTRDoorLockClusterClearHolidayScheduleParams *v3;
  ...
  v2 = -[MTRDoorLockClusterClearHolidayScheduleParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterClearHolidayScheduleParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: holidayIndex:%@; >"), v5, self->_holidayIndex);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
