...
{
  MTRAudioOutputClusterSelectOutputParams *v2;
  MTRAudioOutputClusterSelectOutputParams *v3;
  NSNumber *index;
  ...
  v2 = -[MTRAudioOutputClusterSelectOutputParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
    v2->_index = (NSNumber *)&unk_250591A40;
...
{
  MTRAudioOutputClusterSelectOutputParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: index:%@; >"), v5, self->_index);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_index(self, a3, (uint64_t)a4);
