...
{
  MTRDoorLockClusterClearUserParams *v2;
  MTRDoorLockClusterClearUserParams *v3;
  NSNumber *userIndex;
  ...
  v2 = -[MTRDoorLockClusterClearUserParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterClearUserParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: userIndex:%@; >"), v5, self->_userIndex);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_userIndex(self, a3, (uint64_t)a4);
