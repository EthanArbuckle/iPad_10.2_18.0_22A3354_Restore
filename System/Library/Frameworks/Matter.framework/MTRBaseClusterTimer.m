...
{
  MTRTimerClusterSetTimerParams *v6;
  id v7;
  id v8;
  void *v9;
  const char *v10;
  ...
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v15, v25, (uint64_t)v18, &unk_250592868, &unk_250591C08, v6, v12, v21, 0, v24, v9, v26, v27, v28, v29);

}

- (void)resetTimerWithCompletion:(id)a3
{
  MEMORY[0x24BEDD108](self, sel_resetTimerWithParams_completion_, 0);
}

- (void)resetTimerWithParams:(id)a3 completion:(id)a4
{
  MTRTimerClusterResetTimerParams *v6;
  id v7;
  id v8;
  void *v9;
  const char *v10;
  ...
  objc_msgSend_callbackQueue(self, v22, v23);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v15, v25, (uint64_t)v18, &unk_250592868, &unk_250591D10, v6, v12, v21, 0, v24, v9, v26, v27, v28, v29);

}

- (void)addTimeWithParams:(id)a3 completion:(id)a4
{
  MTRTimerClusterAddTimeParams *v6;
  id v7;
  id v8;
  void *v9;
  const char *v10;
  ...
  objc_msgSend_callbackQueue(self, v22, v23);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v15, v25, (uint64_t)v18, &unk_250592868, &unk_250591D28, v6, v12, v21, 0, v24, v9, v26, v27, v28, v29);

}

- (void)reduceTimeWithParams:(id)a3 completion:(id)a4
{
  MTRTimerClusterReduceTimeParams *v6;
  id v7;
  id v8;
  void *v9;
  const char *v10;
  ...
  objc_msgSend_callbackQueue(self, v22, v23);
  v24 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v15, v25, (uint64_t)v18, &unk_250592868, &unk_250591D40, v6, v12, v21, 0, v24, v9, v26, v27, v28, v29);
...
- (void)readAttributeSetTimeWithCompletion:(id)a3
{
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591C38, 0, v12, v14);
...
- (void)subscribeAttributeSetTimeWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591C38, v20, v18, v9, v8);
...
- (void)readAttributeTimeRemainingWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591C50, 0, v12, v14);
...
- (void)subscribeAttributeTimeRemainingWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591C50, v20, v18, v9, v8);
...
- (void)readAttributeTimerStateWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591EC0, 0, v12, v14);
...
- (void)subscribeAttributeTimerStateWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591EC0, v20, v18, v9, v8);
...
- (void)readAttributeGeneratedCommandListWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591C68, 0, v12, v14);
...
- (void)subscribeAttributeGeneratedCommandListWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591C68, v20, v18, v9, v8);
...
- (void)readAttributeAcceptedCommandListWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591C80, 0, v12, v14);
...
- (void)subscribeAttributeAcceptedCommandListWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591C80, v20, v18, v9, v8);
...
- (void)readAttributeEventListWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591C98, 0, v12, v14);
...
- (void)subscribeAttributeEventListWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591C98, v20, v18, v9, v8);
...
- (void)readAttributeAttributeListWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591CB0, 0, v12, v14);
...
- (void)subscribeAttributeAttributeListWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591CB0, v20, v18, v9, v8);
...
- (void)readAttributeFeatureMapWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591CC8, 0, v12, v14);
...
- (void)subscribeAttributeFeatureMapWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591CC8, v20, v18, v9, v8);
...
- (void)readAttributeClusterRevisionWithCompletion:(id)a3
{
  ...
  objc_msgSend_callbackQueue(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__readKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_completion_(v6, v13, (uint64_t)v9, &unk_250592868, &unk_250591CE0, 0, v12, v14);
...
- (void)subscribeAttributeClusterRevisionWithParams:(id)a3 subscriptionEstablished:(id)a4 reportHandler:(id)a5
{
  ...
  objc_msgSend_callbackQueue(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__subscribeToKnownAttributeWithEndpointID_clusterID_attributeID_params_queue_reportHandler_subscriptionEstablished_(v12, v19, (uint64_t)v15, &unk_250592868, &unk_250591CE0, v20, v18, v9, v8);
