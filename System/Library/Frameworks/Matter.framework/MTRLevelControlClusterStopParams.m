...
{
  MTRLevelControlClusterStopParams *v2;
  MTRLevelControlClusterStopParams *v3;
  ...
  v2 = -[MTRLevelControlClusterStopParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRLevelControlClusterStopParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
