...
{
  MTRBasicInformationClusterProductAppearanceStruct *v2;
  MTRBasicInformationClusterProductAppearanceStruct *v3;
  NSNumber *finish;
  ...
  v2 = -[MTRBasicInformationClusterProductAppearanceStruct init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    finish = v2->_finish;
...
{
  MTRBasicInformationClusterProductAppearanceStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
