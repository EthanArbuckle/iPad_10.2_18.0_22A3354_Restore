...
{
  MEMORY[0x24BEDD108](self, sel_offWithParams_expectedValues_expectedValueInterval_completion_, 0);
}
...
- (void)offWithParams:(MTROnOffClusterOffParams *)params expectedValues:(NSArray *)expectedDataValueDictionaries expectedValueInterval:(NSNumber *)expectedValueIntervalMs completion:(MTRStatusCompletion)completion
{
  ...
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_250594698, &unk_2505944E8, v10, v11, v12, v18, v27, 0, v30, v15);
...
{
  MEMORY[0x24BEDD108](self, sel_onWithParams_expectedValues_expectedValueInterval_completion_, 0);
}
...
- (void)onWithParams:(MTROnOffClusterOnParams *)params expectedValues:(NSArray *)expectedDataValueDictionaries expectedValueInterval:(NSNumber *)expectedValueIntervalMs completion:(MTRStatusCompletion)completion
{
  ...
  objc_msgSend_callbackQueue(self, v28, v29);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_250594698, &unk_250594608, v10, v11, v12, v18, v27, 0, v30, v15);
...
{
  MEMORY[0x24BEDD108](self, sel_toggleWithParams_expectedValues_expectedValueInterval_completion_, 0);
}
...
{
  MTROnOffClusterToggleParams *v10;
  NSArray *v11;
  NSNumber *v12;
  MTRStatusCompletion v13;
  id v14;
  ...
  objc_msgSend_callbackQueue(self, v28, v29);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_250594698, &unk_250594620, v10, v11, v12, v18, v27, 0, v30, v15);
...
{
  MTROnOffClusterOffWithEffectParams *v10;
  NSArray *v11;
  NSNumber *v12;
  MTRStatusCompletion v13;
  id v14;
  ...
  objc_msgSend_callbackQueue(self, v28, v29);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_250594698, &unk_250594500, v10, v11, v12, v18, v27, 0, v30, v15);
...
{
  MEMORY[0x24BEDD108](self, sel_onWithRecallGlobalSceneWithParams_expectedValues_expectedValueInterval_completion_, 0);
}
...
{
  MTROnOffClusterOnWithRecallGlobalSceneParams *v10;
  NSArray *v11;
  NSNumber *v12;
  MTRStatusCompletion v13;
  id v14;
  ...
  objc_msgSend_callbackQueue(self, v28, v29);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_250594698, &unk_2505946B0, v10, v11, v12, v18, v27, 0, v30, v15);
...
{
  MTROnOffClusterOnWithTimedOffParams *v10;
  NSArray *v11;
  NSNumber *v12;
  MTRStatusCompletion v13;
  id v14;
  ...
  objc_msgSend_callbackQueue(self, v28, v29);
  v30 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_250594698, &unk_2505946C8, v10, v11, v12, v18, v27, 0, v30, v15);
...
- (NSDictionary)readAttributeOnOffWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594530, v4);
...
- (NSDictionary)readAttributeGlobalSceneControlWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_2505946F8, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)readAttributeOnTimeWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594710, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  MEMORY[0x24BEDD108](self, sel_writeAttributeOnTimeWithValue_expectedValueInterval_params_, dataValueDictionary);
}
...
- (void)writeAttributeOnTimeWithValue:(NSDictionary *)dataValueDictionary expectedValueInterval:(NSNumber *)expectedValueIntervalMs params:(MTRWriteParams *)params
{
  ...
  objc_msgSend_writeAttributeWithEndpointID_clusterID_attributeID_value_expectedValueInterval_timedWriteTimeout_(v14, v18, (uint64_t)v17, &unk_2505946E0, &unk_250594710, v19, v8, v11);
...
- (NSDictionary)readAttributeOffWaitTimeWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594728, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  MEMORY[0x24BEDD108](self, sel_writeAttributeOffWaitTimeWithValue_expectedValueInterval_params_, dataValueDictionary);
}
...
- (void)writeAttributeOffWaitTimeWithValue:(NSDictionary *)dataValueDictionary expectedValueInterval:(NSNumber *)expectedValueIntervalMs params:(MTRWriteParams *)params
{
  ...
  objc_msgSend_endpointID(self, v15, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_writeAttributeWithEndpointID_clusterID_attributeID_value_expectedValueInterval_timedWriteTimeout_(v14, v18, (uint64_t)v17, &unk_2505946E0, &unk_250594728, v19, v8, v11);
...
- (NSDictionary)readAttributeStartUpOnOffWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594740, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  MEMORY[0x24BEDD108](self, sel_writeAttributeStartUpOnOffWithValue_expectedValueInterval_params_, dataValueDictionary);
}
...
- (void)writeAttributeStartUpOnOffWithValue:(NSDictionary *)dataValueDictionary expectedValueInterval:(NSNumber *)expectedValueIntervalMs params:(MTRWriteParams *)params
{
  ...
  objc_msgSend_endpointID(self, v15, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_writeAttributeWithEndpointID_clusterID_attributeID_value_expectedValueInterval_timedWriteTimeout_(v14, v18, (uint64_t)v17, &unk_2505946E0, &unk_250594740, v19, v8, v11);
...
- (NSDictionary)readAttributeGeneratedCommandListWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594560, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)readAttributeAcceptedCommandListWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594578, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)readAttributeEventListWithParams:(id)a3
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_250594590, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)readAttributeAttributeListWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_2505945A8, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)readAttributeFeatureMapWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_2505945C0, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (NSDictionary)readAttributeClusterRevisionWithParams:(MTRReadParams *)params
{
  ...
  objc_msgSend_endpointID(self, v8, v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_2505946E0, &unk_2505945D8, v4);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTRClusterOnOff)initWithDevice:(MTRDevice *)device endpoint:(uint16_t)endpoint queue:(dispatch_queue_t)queue
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = (MTRClusterOnOff *)objc_msgSend_initWithDevice_endpointID_queue_(self, v12, (uint64_t)v8, v11, v9);
...
{
  MEMORY[0x24BEDD108](self, sel_offWithParams_expectedValues_expectedValueInterval_completion_, params);
}
...
{
  MEMORY[0x24BEDD108](self, sel_offWithParams_expectedValues_expectedValueInterval_completionHandler_, 0);
}
...
{
  MEMORY[0x24BEDD108](self, sel_onWithParams_expectedValues_expectedValueInterval_completion_, params);
}
...
{
  MEMORY[0x24BEDD108](self, sel_onWithParams_expectedValues_expectedValueInterval_completionHandler_, 0);
}
...
{
  MEMORY[0x24BEDD108](self, sel_toggleWithParams_expectedValues_expectedValueInterval_completion_, params);
}
...
{
  MEMORY[0x24BEDD108](self, sel_toggleWithParams_expectedValues_expectedValueInterval_completionHandler_, 0);
}
...
{
  MEMORY[0x24BEDD108](self, sel_offWithEffectWithParams_expectedValues_expectedValueInterval_completion_, params);
}
...
{
  MEMORY[0x24BEDD108](self, sel_onWithRecallGlobalSceneWithParams_expectedValues_expectedValueInterval_completion_, params);
}
...
{
  MEMORY[0x24BEDD108](self, sel_onWithRecallGlobalSceneWithParams_expectedValues_expectedValueInterval_completionHandler_, 0);
}
...
{
  MEMORY[0x24BEDD108](self, sel_onWithTimedOffWithParams_expectedValues_expectedValueInterval_completion_, params);
}
