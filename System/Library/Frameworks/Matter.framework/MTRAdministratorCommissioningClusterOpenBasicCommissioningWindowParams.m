...
{
  MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams *v2;
  MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams *v3;
  ...
  v2 = -[MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: commissioningTimeout:%@; >"),
    v5,
    self->_commissioningTimeout);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
