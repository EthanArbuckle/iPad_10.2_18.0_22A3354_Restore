...
{
  MTRContentControlClusterResetPINResponseParams *v2;
  MTRContentControlClusterResetPINResponseParams *v3;
  NSString *pinCode;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRContentControlClusterResetPINResponseParams;
  v2 = -[MTRContentControlClusterResetPINResponseParams init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
    pinCode = v2->_pinCode;
    v2->_pinCode = (NSString *)&stru_2505249E8;
...
{
  MTRContentControlClusterResetPINResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: pinCode:%@; >"), v5, self->_pinCode);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTRContentControlClusterResetPINResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRContentControlClusterResetPINResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRContentControlClusterResetPINResponseParams *v30;
  __int128 v32;
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRContentControlClusterResetPINResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      v32 = 0uLL;
      sub_233D3BC94(&v32, (uint64_t)v35, (uint64_t)buf);
      v33 = *(_OWORD *)buf;
      v34 = v41;
      if (!*(_DWORD *)buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_pinCode(self, v12, v13);
  ...
  {
    *(_OWORD *)&retstr->mError = xmmword_2504EF0F0;
    *(_QWORD *)&retstr->mLine = 30384;
  }
  return result;
}
