...
- (MTRNetworkCommissioningClusterReorderNetworkParams)init
{
  const char *v2;
  uint64_t v3;
  MTRNetworkCommissioningClusterReorderNetworkParams *v4;
  uint64_t v5;
  NSData *networkID;
  ...
  v4 = -[MTRNetworkCommissioningClusterReorderNetworkParams init](&v12, sel_init);
  if (v4)
  {
    ...
    v4->_networkIndex = (NSNumber *)&unk_250591A40;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_networkIndex(self, v9, v10);
...
- (id)description
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: networkID:%@; networkIndex:%@; breadcrumb:%@; >"),
    v5,
    v7,
    self->_networkIndex,
    self->_breadcrumb);
...
{
  objc_setProperty_nonatomic_copy(self, a2, networkIndex, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  sub_233BF7114(v28, v10, v13);

  v36 = *(_OWORD *)v28;
  objc_msgSend_networkIndex(self, v14, v15);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  v37 = objc_msgSend_unsignedCharValue(v16, v17, v18);
  ...
  if (v21)
  {
    v38 = 1;
    v39 = 0;
    objc_msgSend_breadcrumb(self, v22, v23);
    v24 = (void *)objc_claimAutoreleasedReturnValue();
    v39 = objc_msgSend_unsignedLongLongValue(v24, v25, v26);

  }
  sub_234118674(0x62FuLL, 0, &v33);
  if (v33)
  {
    sub_234106C48((uint64_t)v28);
    v30 = 0;
    v31 = 0;
    v29 = &unk_250504030;
    v32 = 0;
    sub_233CAF098((uint64_t)&v29, &v33, 0);
    sub_234106CA8((uint64_t)v28, (uint64_t)&v29, 0xFFFFFFFF, (uint64_t)v40);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D06B78((uint64_t)&v36, v28, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
      *(_QWORD *)&retstr->mLine = 0;
      sub_233C115F0((uint64_t)v28, &v33, retstr);
      if (!retstr->mError)
      {
        sub_233C11670((uint64_t)a4, &v33);
  ...
  sub_233CAF128(&v33);
  return (ChipError *)sub_233CAF15C((uint64_t)&v34);
}
