...
{
  MTRSmokeCOAlarmClusterInterconnectCOAlarmEvent *v2;
  MTRSmokeCOAlarmClusterInterconnectCOAlarmEvent *v3;
  NSNumber *alarmSeverityLevel;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRSmokeCOAlarmClusterInterconnectCOAlarmEvent;
  v2 = -[MTRSmokeCOAlarmClusterInterconnectCOAlarmEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRSmokeCOAlarmClusterInterconnectCOAlarmEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
