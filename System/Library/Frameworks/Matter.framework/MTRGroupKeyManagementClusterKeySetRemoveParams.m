...
{
  MTRGroupKeyManagementClusterKeySetRemoveParams *v2;
  MTRGroupKeyManagementClusterKeySetRemoveParams *v3;
  ...
  v2 = -[MTRGroupKeyManagementClusterKeySetRemoveParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    groupKeySetID = v2->_groupKeySetID;
    v2->_groupKeySetID = (NSNumber *)&unk_250591A40;
...
{
  MTRGroupKeyManagementClusterKeySetRemoveParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: groupKeySetID:%@; >"), v5, self->_groupKeySetID);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_groupKeySetID(self, a3, (uint64_t)a4);
