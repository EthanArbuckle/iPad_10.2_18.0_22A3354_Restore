...
{
  MTRDoorLockClusterUnlockWithTimeoutParams *v2;
  MTRDoorLockClusterUnlockWithTimeoutParams *v3;
  NSNumber *timeout;
  NSData *pinCode;
  ...
  v2 = -[MTRDoorLockClusterUnlockWithTimeoutParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    timeout = v2->_timeout;
    v2->_timeout = (NSNumber *)&unk_250591A40;
...
{
  MTRDoorLockClusterUnlockWithTimeoutParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_timeout(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setTimeout_(v4, v8, (uint64_t)v7);

  objc_msgSend_pinCode(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_pinCode, v7, 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v9, (uint64_t)CFSTR("<%@: timeout:%@; pinCode:%@; >"), v5, timeout, v8);
...
{
  objc_setProperty_nonatomic_copy(self, a2, timeout, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, pinCode, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v30[1] = 0;
  v29 = v30;
  objc_msgSend_timeout(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v31 = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_msgSend_pinCode(self, v10, v11);
  ...
  if (v28)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D242A8(&v31, v23, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
