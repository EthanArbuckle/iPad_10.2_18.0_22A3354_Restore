...
{
  MTRColorControlClusterMoveHueParams *v2;
  MTRColorControlClusterMoveHueParams *v3;
  NSNumber *moveMode;
  NSNumber *rate;
  ...
  v2 = -[MTRColorControlClusterMoveHueParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterMoveHueParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
