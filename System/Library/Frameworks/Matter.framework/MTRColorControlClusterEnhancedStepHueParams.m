...
{
  MTRColorControlClusterEnhancedStepHueParams *v2;
  MTRColorControlClusterEnhancedStepHueParams *v3;
  NSNumber *stepMode;
  NSNumber *stepSize;
  ...
  v2 = -[MTRColorControlClusterEnhancedStepHueParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterEnhancedStepHueParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v36)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2F8A4((uint64_t)v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
