...
{
  MTRUnitTestingClusterTestEnumsRequestParams *v2;
  MTRUnitTestingClusterTestEnumsRequestParams *v3;
  NSNumber *arg1;
  NSNumber *arg2;
  ...
  v2 = -[MTRUnitTestingClusterTestEnumsRequestParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterTestEnumsRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v21)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D40518((unsigned __int8 *)&v24, v16, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
