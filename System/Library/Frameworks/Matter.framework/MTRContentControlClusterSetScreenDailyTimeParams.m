...
{
  MTRContentControlClusterSetScreenDailyTimeParams *v2;
  MTRContentControlClusterSetScreenDailyTimeParams *v3;
  NSNumber *screenTime;
  ...
  v2 = -[MTRContentControlClusterSetScreenDailyTimeParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    screenTime = v2->_screenTime;
    v2->_screenTime = (NSNumber *)&unk_250591A40;
...
{
  MTRContentControlClusterSetScreenDailyTimeParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_screenTime(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: screenTime:%@; >"), v5, self->_screenTime);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_screenTime(self, a3, (uint64_t)a4);
