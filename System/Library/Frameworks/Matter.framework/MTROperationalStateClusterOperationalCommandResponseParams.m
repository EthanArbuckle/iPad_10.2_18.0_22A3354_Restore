...
{
  MTROperationalStateClusterOperationalCommandResponseParams *v2;
  uint64_t v3;
  ...
  v2 = -[MTROperationalStateClusterOperationalCommandResponseParams init](&v6, sel_init);
  if (v2)
  {
    v3 = objc_opt_new();
...
{
  MTROperationalStateClusterOperationalCommandResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTROperationalStateClusterOperationalCommandResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTROperationalStateClusterOperationalCommandResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTROperationalStateClusterOperationalCommandResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTROperationalStateClusterOperationalCommandResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      ...
      BYTE8(buf) = 0;
      v43 = 0;
      sub_233D15DA0((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
