...
{
  MTRRVCCleanModeClusterChangeToModeParams *v2;
  MTRRVCCleanModeClusterChangeToModeParams *v3;
  NSNumber *newMode;
  ...
  v2 = -[MTRRVCCleanModeClusterChangeToModeParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    newMode = v2->_newMode;
...
{
  MTRRVCCleanModeClusterChangeToModeParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
