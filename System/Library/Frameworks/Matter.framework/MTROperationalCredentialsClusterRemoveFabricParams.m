...
{
  MTROperationalCredentialsClusterRemoveFabricParams *v2;
  MTROperationalCredentialsClusterRemoveFabricParams *v3;
  ...
  v2 = -[MTROperationalCredentialsClusterRemoveFabricParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    fabricIndex = v2->_fabricIndex;
    v2->_fabricIndex = (NSNumber *)&unk_250591A40;
...
{
  MTROperationalCredentialsClusterRemoveFabricParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_fabricIndex(self, a3, (uint64_t)a4);
