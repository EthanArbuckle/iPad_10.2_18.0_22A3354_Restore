...
- (MTROperationalCredentialsClusterCSRResponseParams)init
{
  ...
  v4 = -[MTROperationalCredentialsClusterCSRResponseParams init](&v13, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_nocsrElements(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_nocsrElements, v6, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_base64EncodedStringWithOptions_(self->_attestationSignature, v8, 0);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v10, (uint64_t)CFSTR("<%@: nocsrElements:%@; attestationSignature:%@; >"),
    v5,
    v7,
    v9);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTROperationalCredentialsClusterCSRResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTROperationalCredentialsClusterCSRResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTROperationalCredentialsClusterCSRResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTROperationalCredentialsClusterCSRResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      buf = 0u;
      v42 = 0u;
      sub_233D0F604(&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
{
  objc_setProperty_nonatomic_copy(self, a2, nocsrElements, 8);
}
