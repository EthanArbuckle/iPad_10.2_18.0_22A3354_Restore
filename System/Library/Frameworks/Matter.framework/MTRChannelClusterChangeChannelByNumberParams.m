...
{
  MTRChannelClusterChangeChannelByNumberParams *v2;
  MTRChannelClusterChangeChannelByNumberParams *v3;
  ...
  v2 = -[MTRChannelClusterChangeChannelByNumberParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    majorNumber = v2->_majorNumber;
    v2->_majorNumber = (NSNumber *)&unk_250591A40;

    minorNumber = v3->_minorNumber;
    v3->_minorNumber = (NSNumber *)&unk_250591A40;
...
{
  MTRChannelClusterChangeChannelByNumberParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: majorNumber:%@; minorNumber:%@; >"),
    v5,
    self->_majorNumber,
    self->_minorNumber);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v23[1] = 0;
  v22 = v23;
  objc_msgSend_majorNumber(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  LOWORD(v24) = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_msgSend_minorNumber(self, v10, v11);
  ...
  if (v21)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D00224((unsigned __int16 *)&v24, v16, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
