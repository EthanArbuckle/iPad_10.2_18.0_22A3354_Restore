...
{
  MTRGroupsClusterRemoveGroupResponseParams *v2;
  MTRGroupsClusterRemoveGroupResponseParams *v3;
  NSNumber *status;
  NSNumber *groupID;
  ...
  v2 = -[MTRGroupsClusterRemoveGroupResponseParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRGroupsClusterRemoveGroupResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRGroupsClusterRemoveGroupResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRGroupsClusterRemoveGroupResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRGroupsClusterRemoveGroupResponseParams *v30;
  _BYTE v32[2];
  __int16 v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRGroupsClusterRemoveGroupResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      v32[0] = 0;
      v33 = 0;
      sub_233CFA3B0((uint64_t)v32, (uint64_t)v36, (uint64_t)&buf);
      v34 = buf;
      v35 = v42;
      if (!(_DWORD)buf)
      {
