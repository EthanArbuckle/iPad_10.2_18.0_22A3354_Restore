...
{
  MTRRVCOperationalStateClusterErrorStateStruct *v2;
  MTRRVCOperationalStateClusterErrorStateStruct *v3;
  ...
  v2 = -[MTRRVCOperationalStateClusterErrorStateStruct init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRRVCOperationalStateClusterErrorStateStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
