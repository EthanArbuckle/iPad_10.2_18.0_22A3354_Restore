...
{
  MTRDishwasherAlarmClusterResetParams *v2;
  MTRDishwasherAlarmClusterResetParams *v3;
  NSNumber *alarms;
  ...
  v2 = -[MTRDishwasherAlarmClusterResetParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    alarms = v2->_alarms;
    v2->_alarms = (NSNumber *)&unk_250591A40;
...
{
  MTRDishwasherAlarmClusterResetParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_alarms(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: alarms:%@; >"), v5, self->_alarms);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_alarms(self, a3, (uint64_t)a4);
