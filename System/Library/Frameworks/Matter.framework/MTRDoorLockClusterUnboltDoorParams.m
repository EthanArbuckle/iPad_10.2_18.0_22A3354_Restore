...
{
  MTRDoorLockClusterUnboltDoorParams *v2;
  MTRDoorLockClusterUnboltDoorParams *v3;
  NSData *pinCode;
  ...
  v2 = -[MTRDoorLockClusterUnboltDoorParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    pinCode = v2->_pinCode;
...
{
  MTRDoorLockClusterUnboltDoorParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
