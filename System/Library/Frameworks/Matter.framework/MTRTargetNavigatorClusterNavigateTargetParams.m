...
{
  MTRTargetNavigatorClusterNavigateTargetParams *v2;
  MTRTargetNavigatorClusterNavigateTargetParams *v3;
  NSNumber *target;
  NSString *data;
  ...
  v2 = -[MTRTargetNavigatorClusterNavigateTargetParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    target = v2->_target;
    v2->_target = (NSNumber *)&unk_250591A40;
...
{
  MTRTargetNavigatorClusterNavigateTargetParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_target(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: target:%@; data:%@; >"), v5, self->_target, self->_data);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_setProperty_nonatomic_copy(self, a2, target, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v29[1] = 0;
  v28 = v29;
  objc_msgSend_target(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v27)
  {
    ...
    sub_234106CA8((uint64_t)v22, (uint64_t)&v23, 0xFFFFFFFF, (uint64_t)v33);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CF8EA8(v30, v22, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
