...
{
  MTRUnitTestingClusterSimpleStructEchoRequestParams *v2;
  uint64_t v3;
  ...
  v2 = -[MTRUnitTestingClusterSimpleStructEchoRequestParams init](&v8, sel_init);
  if (v2)
  {
    v3 = objc_opt_new();
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterSimpleStructEchoRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
