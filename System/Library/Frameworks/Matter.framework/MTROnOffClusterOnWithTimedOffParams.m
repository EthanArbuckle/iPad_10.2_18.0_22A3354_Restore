...
{
  MTROnOffClusterOnWithTimedOffParams *v2;
  MTROnOffClusterOnWithTimedOffParams *v3;
  ...
  v2 = -[MTROnOffClusterOnWithTimedOffParams init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
    onOffControl = v2->_onOffControl;
    v2->_onOffControl = (NSNumber *)&unk_250591A40;

    onTime = v3->_onTime;
    v3->_onTime = (NSNumber *)&unk_250591A40;

    offWaitTime = v3->_offWaitTime;
    v3->_offWaitTime = (NSNumber *)&unk_250591A40;
...
{
  MTROnOffClusterOnWithTimedOffParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: onOffControl:%@; onTime:%@; offWaitTime:%@; >"),
    v5,
    self->_onOffControl,
    self->_onTime,
    self->_offWaitTime);
...
{
  objc_setProperty_nonatomic_copy(self, a2, onOffControl, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, onTime, 16);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, offWaitTime, 24);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v28[1] = 0;
  v27 = v28;
  objc_msgSend_onOffControl(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v29[0] = objc_msgSend_unsignedCharValue(v7, v8, v9);

  objc_msgSend_onTime(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  LOWORD(v30) = objc_msgSend_unsignedShortValue(v12, v13, v14);

  objc_msgSend_offWaitTime(self, v15, v16);
  ...
  if (v26)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CFAA34(v29, v21, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
