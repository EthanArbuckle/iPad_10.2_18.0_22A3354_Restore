...
{
  MTRICDManagementClusterUnregisterClientParams *v2;
  MTRICDManagementClusterUnregisterClientParams *v3;
  ...
  v2 = -[MTRICDManagementClusterUnregisterClientParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRICDManagementClusterUnregisterClientParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_verificationKey, v7, 0);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v9, (uint64_t)CFSTR("<%@: checkInNodeID:%@; verificationKey:%@; >"),
    v5,
    checkInNodeID,
    v8);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v31 = objc_msgSend_unsignedLongLongValue(v7, v8, v9);

  objc_msgSend_verificationKey(self, v10, v11);
  ...
  if (v28)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D12000((uint64_t)&v31, v23, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
