...
{
  MTRAudioOutputClusterRenameOutputParams *v2;
  MTRAudioOutputClusterRenameOutputParams *v3;
  NSNumber *index;
  NSString *name;
  ...
  v2 = -[MTRAudioOutputClusterRenameOutputParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
...
{
  MTRAudioOutputClusterRenameOutputParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: index:%@; name:%@; >"), v5, self->_index, self->_name);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v24)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D29E58(v27, v19, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
