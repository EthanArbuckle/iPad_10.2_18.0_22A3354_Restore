...
{
  MTRColorControlClusterEnhancedMoveHueParams *v2;
  MTRColorControlClusterEnhancedMoveHueParams *v3;
  NSNumber *moveMode;
  NSNumber *rate;
  ...
  v2 = -[MTRColorControlClusterEnhancedMoveHueParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterEnhancedMoveHueParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v31)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2F608((uint64_t)v34, v26, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
