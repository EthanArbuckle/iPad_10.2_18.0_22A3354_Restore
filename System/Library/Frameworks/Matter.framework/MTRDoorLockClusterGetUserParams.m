...
{
  MTRDoorLockClusterGetUserParams *v2;
  MTRDoorLockClusterGetUserParams *v3;
  NSNumber *userIndex;
  ...
  v2 = -[MTRDoorLockClusterGetUserParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterGetUserParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
