...
{
  MTRDoorLockClusterClearWeekDayScheduleParams *v2;
  MTRDoorLockClusterClearWeekDayScheduleParams *v3;
  ...
  v2 = -[MTRDoorLockClusterClearWeekDayScheduleParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterClearWeekDayScheduleParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: weekDayIndex:%@; userIndex:%@; >"),
    v5,
    self->_weekDayIndex,
    self->_userIndex);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v24[0] = objc_msgSend_unsignedCharValue(v7, v8, v9);

  objc_msgSend_userIndex(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v25 = objc_msgSend_unsignedShortValue(v12, v13, v14);
  ...
  if (v21)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CF983C(v24, v16, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
