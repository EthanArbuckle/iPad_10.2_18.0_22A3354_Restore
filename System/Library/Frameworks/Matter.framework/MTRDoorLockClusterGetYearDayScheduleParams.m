...
{
  MTRDoorLockClusterGetYearDayScheduleParams *v2;
  MTRDoorLockClusterGetYearDayScheduleParams *v3;
  ...
  v2 = -[MTRDoorLockClusterGetYearDayScheduleParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterGetYearDayScheduleParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
