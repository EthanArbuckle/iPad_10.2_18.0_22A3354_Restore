...
{
  MTRModeSelectClusterSemanticTagStruct *v2;
  MTRModeSelectClusterSemanticTagStruct *v3;
  NSNumber *mfgCode;
  NSNumber *value;
  objc_super v7;
  ...
  v2 = -[MTRModeSelectClusterSemanticTagStruct init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    mfgCode = v2->_mfgCode;
    v2->_mfgCode = (NSNumber *)&unk_250591B18;
...
{
  MTRModeSelectClusterSemanticTagStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
{
  objc_setProperty_nonatomic_copy(self, a2, mfgCode, 8);
}
