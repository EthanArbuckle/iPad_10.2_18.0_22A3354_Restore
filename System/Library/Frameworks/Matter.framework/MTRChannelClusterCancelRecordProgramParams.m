...
{
  MTRChannelClusterCancelRecordProgramParams *v2;
  MTRChannelClusterCancelRecordProgramParams *v3;
  ...
  v2 = -[MTRChannelClusterCancelRecordProgramParams init](&v17, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRChannelClusterCancelRecordProgramParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
