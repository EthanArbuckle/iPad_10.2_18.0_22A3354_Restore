...
- (MTROperationalCredentialsClusterUpdateNOCParams)init
{
  const char *v2;
  uint64_t v3;
  MTROperationalCredentialsClusterUpdateNOCParams *v4;
  uint64_t v5;
  NSData *nocValue;
  NSData *icacValue;
  ...
  v4 = -[MTROperationalCredentialsClusterUpdateNOCParams init](&v11, sel_init);
  if (v4)
  {
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v10, (uint64_t)CFSTR("<%@: nocValue:%@; icacValue:%@; >"), v5, v7, v9);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
