...
{
  MTRColorControlClusterStepColorParams *v2;
  MTRColorControlClusterStepColorParams *v3;
  NSNumber *stepX;
  NSNumber *stepY;
  ...
  v2 = -[MTRColorControlClusterStepColorParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
    stepX = v2->_stepX;
    v2->_stepX = (NSNumber *)&unk_250591A40;

    stepY = v3->_stepY;
    v3->_stepY = (NSNumber *)&unk_250591A40;
...
{
  MTRColorControlClusterStepColorParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_stepX(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setStepX_(v4, v8, (uint64_t)v7);

  objc_msgSend_stepY(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: stepX:%@; stepY:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_stepX,
    self->_stepY,
...
{
  objc_setProperty_nonatomic_copy(self, a2, stepX, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, stepY, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  objc_msgSend_stepX(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  LOWORD(v39) = objc_msgSend_shortValue(v7, v8, v9);

  objc_msgSend_stepY(self, v10, v11);
  ...
  if (v36)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2ED64((__int16 *)&v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
