...
{
  MTRApplicationLauncherClusterLauncherResponseParams *v2;
  MTRApplicationLauncherClusterLauncherResponseParams *v3;
  NSNumber *status;
  NSData *data;
  ...
  v2 = -[MTRApplicationLauncherClusterLauncherResponseParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRApplicationLauncherClusterLauncherResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v9, (uint64_t)CFSTR("<%@: status:%@; data:%@; >"), v5, status, v8);
...
- (MTRApplicationLauncherClusterLauncherResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRApplicationLauncherClusterLauncherResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRApplicationLauncherClusterLauncherResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRApplicationLauncherClusterLauncherResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_233D3AD10(&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
