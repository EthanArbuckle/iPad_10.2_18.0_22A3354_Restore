...
{
  MTRGeneralCommissioningClusterArmFailSafeResponseParams *v2;
  MTRGeneralCommissioningClusterArmFailSafeResponseParams *v3;
  NSNumber *errorCode;
  NSString *debugText;
  ...
  v2 = -[MTRGeneralCommissioningClusterArmFailSafeResponseParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRGeneralCommissioningClusterArmFailSafeResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRGeneralCommissioningClusterArmFailSafeResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRGeneralCommissioningClusterArmFailSafeResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRGeneralCommissioningClusterArmFailSafeResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRGeneralCommissioningClusterArmFailSafeResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      ...
      *((_QWORD *)&buf + 1) = 0;
      v42 = 0;
      sub_233D045B0((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  {
    *(_OWORD *)&retstr->mError = xmmword_2504EEB68;
    *(_QWORD *)&retstr->mLine = 4567;
  }
  return result;
}
