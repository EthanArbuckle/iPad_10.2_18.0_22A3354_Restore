...
{
  MTRChannelClusterAdditionalInfoStruct *v2;
  MTRChannelClusterAdditionalInfoStruct *v3;
  NSString *name;
  NSString *value;
  objc_super v7;
  ...
  v2 = -[MTRChannelClusterAdditionalInfoStruct init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    name = v2->_name;
...
{
  MTRChannelClusterAdditionalInfoStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
