...
{
  MTRLevelControlClusterStepWithOnOffParams *v2;
  MTRLevelControlClusterStepWithOnOffParams *v3;
  NSNumber *stepMode;
  NSNumber *stepSize;
  ...
  v2 = -[MTRLevelControlClusterStepWithOnOffParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRLevelControlClusterStepWithOnOffParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: stepMode:%@; stepSize:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_stepMode,
    self->_stepSize,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v17)
  {
    ...
    v41 = objc_msgSend_unsignedShortValue(v20, v21, v22);

  }
  objc_msgSend_optionsMask(self, v18, v19);
  v23 = (void *)objc_claimAutoreleasedReturnValue();
  LOBYTE(v43) = objc_msgSend_unsignedCharValue(v23, v24, v25);

  objc_msgSend_optionsOverride(self, v26, v27);
  ...
  if (v37)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CFB524((uint64_t)&v40, v32, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
