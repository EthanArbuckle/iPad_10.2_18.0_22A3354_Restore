...
{
  MEMORY[0x24BEDD108](self, sel_mfgSpecificPingWithParams_completion_, params);
}

- (void)mfgSpecificPingWithCompletionHandler:(MTRStatusCompletion)completionHandler
{
  MEMORY[0x24BEDD108](self, sel_mfgSpecificPingWithParams_completionHandler_, 0);
}
