...
{
  MTRDoorLockClusterClearYearDayScheduleParams *v2;
  MTRDoorLockClusterClearYearDayScheduleParams *v3;
  ...
  v2 = -[MTRDoorLockClusterClearYearDayScheduleParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDoorLockClusterClearYearDayScheduleParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: yearDayIndex:%@; userIndex:%@; >"),
    v5,
    self->_yearDayIndex,
    self->_userIndex);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
