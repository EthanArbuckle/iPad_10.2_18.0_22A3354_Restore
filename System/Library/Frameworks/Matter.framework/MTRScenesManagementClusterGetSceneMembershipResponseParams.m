...
{
  MTRScenesManagementClusterGetSceneMembershipResponseParams *v2;
  MTRScenesManagementClusterGetSceneMembershipResponseParams *v3;
  NSNumber *status;
  NSNumber *capacity;
  NSNumber *groupID;
  NSArray *sceneList;
  ...
  v2 = -[MTRScenesManagementClusterGetSceneMembershipResponseParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRScenesManagementClusterGetSceneMembershipResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: status:%@; capacity:%@; groupID:%@; sceneList:%@; >"),
    v5,
    self->_status,
    self->_capacity,
    self->_groupID,
...
- (MTRScenesManagementClusterGetSceneMembershipResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRScenesManagementClusterGetSceneMembershipResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRScenesManagementClusterGetSceneMembershipResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRScenesManagementClusterGetSceneMembershipResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      ...
      WORD2(buf) = 0;
      BYTE8(buf) = 0;
      sub_233D187CC((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_numberWithUnsignedShort_(MEMORY[0x24BDD16E0], v12, *((unsigned __int16 *)a4 + 2));
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v17)
  {
    ...
    v19 = sub_233C25EA4(v16);
    v27[0] = v19[72];
    if (v27[0])
      v27[1] = v19[73];
    sub_233C05E38((uint64_t)v24, (uint64_t)v19, v27);
    while (sub_233CAFFB0((uint64_t)v24))
    {
      objc_msgSend_numberWithUnsignedChar_(MEMORY[0x24BDD16E0], v20, v24[0]);
