...
{
  MTRRefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct *v2;
  MTRRefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct *v3;
  NSString *label;
  NSNumber *mode;
  const char *v6;
  uint64_t v7;
  ...
  v2 = -[MTRRefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    label = v2->_label;
...
{
  MTRRefrigeratorAndTemperatureControlledCabinetModeClusterModeOptionStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
