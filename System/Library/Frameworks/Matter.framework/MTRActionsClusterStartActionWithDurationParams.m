...
{
  MTRActionsClusterStartActionWithDurationParams *v2;
  MTRActionsClusterStartActionWithDurationParams *v3;
  NSNumber *actionID;
  NSNumber *invokeID;
  NSNumber *duration;
  ...
  v2 = -[MTRActionsClusterStartActionWithDurationParams init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRActionsClusterStartActionWithDurationParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
