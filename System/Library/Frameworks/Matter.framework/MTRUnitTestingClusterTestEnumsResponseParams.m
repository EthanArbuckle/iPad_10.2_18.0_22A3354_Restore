...
{
  MTRUnitTestingClusterTestEnumsResponseParams *v2;
  MTRUnitTestingClusterTestEnumsResponseParams *v3;
  NSNumber *arg1;
  NSNumber *arg2;
  ...
  v2 = -[MTRUnitTestingClusterTestEnumsResponseParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterTestEnumsResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRUnitTestingClusterTestEnumsResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRUnitTestingClusterTestEnumsResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRUnitTestingClusterTestEnumsResponseParams *v30;
  __int16 v32;
  char v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRUnitTestingClusterTestEnumsResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      v32 = 0;
      v33 = 0;
      sub_233D40608((uint64_t)&v32, (uint64_t)v36, (uint64_t)&buf);
      v34 = buf;
      v35 = v42;
      if (!(_DWORD)buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_numberWithUnsignedShort_(MEMORY[0x24BDD16E0], a3, *(unsigned __int16 *)&a4->var0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setArg1_(self, v8, (uint64_t)v7);

  objc_msgSend_numberWithUnsignedChar_(MEMORY[0x24BDD16E0], v9, a4[2].var0);
