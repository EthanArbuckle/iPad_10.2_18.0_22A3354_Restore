...
{
  MTRMediaInputClusterRenameInputParams *v2;
  MTRMediaInputClusterRenameInputParams *v3;
  NSNumber *index;
  NSString *name;
  ...
  v2 = -[MTRMediaInputClusterRenameInputParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
...
{
  MTRMediaInputClusterRenameInputParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
