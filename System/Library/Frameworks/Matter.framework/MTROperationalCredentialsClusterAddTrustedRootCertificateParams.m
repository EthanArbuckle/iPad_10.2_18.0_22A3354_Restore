...
- (MTROperationalCredentialsClusterAddTrustedRootCertificateParams)init
{
  const char *v2;
  uint64_t v3;
  MTROperationalCredentialsClusterAddTrustedRootCertificateParams *v4;
  uint64_t v5;
  ...
  v4 = -[MTROperationalCredentialsClusterAddTrustedRootCertificateParams init](&v10, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_rootCACertificate(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_rootCACertificate, v6, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: rootCACertificate:%@; >"), v5, v7);
...
{
  objc_setProperty_nonatomic_copy(self, a2, rootCACertificate, 8);
}
