...
{
  MTRLevelControlClusterStepParams *v2;
  MTRLevelControlClusterStepParams *v3;
  NSNumber *stepMode;
  NSNumber *stepSize;
  ...
  v2 = -[MTRLevelControlClusterStepParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRLevelControlClusterStepParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
