...
{
  MTROvenModeClusterChangeToModeResponseParams *v2;
  MTROvenModeClusterChangeToModeResponseParams *v3;
  NSNumber *status;
  NSString *statusText;
  objc_super v7;
  ...
  v2 = -[MTROvenModeClusterChangeToModeResponseParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTROvenModeClusterChangeToModeResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTROvenModeClusterChangeToModeResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTROvenModeClusterChangeToModeResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTROvenModeClusterChangeToModeResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTROvenModeClusterChangeToModeResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_233D12F80((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    if (!v21)
    {
      *(_OWORD *)&retstr->mError = xmmword_2504EEC58;
      *(_QWORD *)&retstr->mLine = 10806;
      return result;
    }
  }
  else
