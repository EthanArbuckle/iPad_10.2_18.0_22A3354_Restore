...
{
  MTRActionsClusterEnableActionParams *v2;
  MTRActionsClusterEnableActionParams *v3;
  NSNumber *actionID;
  NSNumber *invokeID;
  ...
  v2 = -[MTRActionsClusterEnableActionParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRActionsClusterEnableActionParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
