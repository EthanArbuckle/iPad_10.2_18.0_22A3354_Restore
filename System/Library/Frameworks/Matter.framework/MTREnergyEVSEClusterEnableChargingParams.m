...
{
  MTREnergyEVSEClusterEnableChargingParams *v2;
  MTREnergyEVSEClusterEnableChargingParams *v3;
  ...
  v2 = -[MTREnergyEVSEClusterEnableChargingParams init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
    ...
    v3->_minimumChargeCurrent = (NSNumber *)&unk_250591A40;

    maximumChargeCurrent = v3->_maximumChargeCurrent;
    v3->_maximumChargeCurrent = (NSNumber *)&unk_250591A40;
...
{
  MTREnergyEVSEClusterEnableChargingParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_chargingEnabledUntil(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setChargingEnabledUntil_(v4, v8, (uint64_t)v7);

  objc_msgSend_minimumChargeCurrent(self, v9, v10);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setMinimumChargeCurrent_(v4, v12, (uint64_t)v11);

  objc_msgSend_maximumChargeCurrent(self, v13, v14);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: chargingEnabledUntil:%@; minimumChargeCurrent:%@; maximumChargeCurrent:%@; >"),
    v5,
    self->_chargingEnabledUntil,
    self->_minimumChargeCurrent,
    self->_maximumChargeCurrent);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v29[1] = 0;
  v28 = v29;
  objc_msgSend_chargingEnabledUntil(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v7)
  {
    v30 = 0;
    v31 = 1;
    objc_msgSend_chargingEnabledUntil(self, v8, v9);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v30 = objc_msgSend_unsignedIntValue(v10, v11, v12);

  }
  objc_msgSend_minimumChargeCurrent(self, v8, v9);
  v13 = (void *)objc_claimAutoreleasedReturnValue();
  v32 = objc_msgSend_longLongValue(v13, v14, v15);

  objc_msgSend_maximumChargeCurrent(self, v16, v17);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v33 = objc_msgSend_longLongValue(v18, v19, v20);
  ...
  if (v27)
  {
    ...
    sub_234106CA8((uint64_t)v22, (uint64_t)&v23, 0xFFFFFFFF, (uint64_t)v34);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D21E14((uint64_t)&v30, v22, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
