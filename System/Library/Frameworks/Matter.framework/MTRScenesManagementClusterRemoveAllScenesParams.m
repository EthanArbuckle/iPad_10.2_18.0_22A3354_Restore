...
{
  MTRScenesManagementClusterRemoveAllScenesParams *v2;
  MTRScenesManagementClusterRemoveAllScenesParams *v3;
  NSNumber *groupID;
  ...
  v2 = -[MTRScenesManagementClusterRemoveAllScenesParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
{
  MTRScenesManagementClusterRemoveAllScenesParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
