...
{
  MTRColorControlClusterEnhancedMoveToHueParams *v2;
  MTRColorControlClusterEnhancedMoveToHueParams *v3;
  ...
  v2 = -[MTRColorControlClusterEnhancedMoveToHueParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
    enhancedHue = v2->_enhancedHue;
    v2->_enhancedHue = (NSNumber *)&unk_250591A40;
...
{
  MTRColorControlClusterEnhancedMoveToHueParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_enhancedHue(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setEnhancedHue_(v4, v8, (uint64_t)v7);

  objc_msgSend_direction(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: enhancedHue:%@; direction:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_enhancedHue,
    self->_direction,
...
{
  objc_setProperty_nonatomic_copy(self, a2, enhancedHue, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, direction, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  objc_msgSend_enhancedHue(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v39 = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_msgSend_direction(self, v10, v11);
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  v40 = objc_msgSend_unsignedCharValue(v12, v13, v14);
  ...
  if (v36)
  {
    ...
    sub_234106CA8((uint64_t)v31, (uint64_t)&v32, 0xFFFFFFFF, (uint64_t)v42);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2F320((unsigned __int8 *)&v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
