...
{
  MTRScenesManagementClusterRemoveAllScenesResponseParams *v2;
  MTRScenesManagementClusterRemoveAllScenesResponseParams *v3;
  NSNumber *status;
  NSNumber *groupID;
  objc_super v7;
  ...
  v2 = -[MTRScenesManagementClusterRemoveAllScenesResponseParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRScenesManagementClusterRemoveAllScenesResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (MTRScenesManagementClusterRemoveAllScenesResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRScenesManagementClusterRemoveAllScenesResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRScenesManagementClusterRemoveAllScenesResponseParams *v30;
  _BYTE v32[2];
  __int16 v33;
  __int128 v34;
  uint64_t v35;
  ...
  v8 = -[MTRScenesManagementClusterRemoveAllScenesResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      v32[0] = 0;
      v33 = 0;
      sub_233D17FD8((uint64_t)v32, (uint64_t)v36, (uint64_t)&buf);
      v34 = buf;
      v35 = v42;
      if (!(_DWORD)buf)
      {
