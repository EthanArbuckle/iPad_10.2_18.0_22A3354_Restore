...
- (MTRServiceAreaClusterSkipCurrentLocationResponseParams)init
{
  MTRServiceAreaClusterSkipCurrentLocationResponseParams *v2;
  MTRServiceAreaClusterSkipCurrentLocationResponseParams *v3;
  NSNumber *status;
  NSString *statusText;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)MTRServiceAreaClusterSkipCurrentLocationResponseParams;
  v2 = -[MTRServiceAreaClusterSkipCurrentLocationResponseParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRServiceAreaClusterSkipCurrentLocationResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  v4 = objc_alloc_init(MTRServiceAreaClusterSkipCurrentLocationResponseParams);
  objc_msgSend_status(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setStatus_(v4, v8, (uint64_t)v7);

  objc_msgSend_statusText(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: status:%@; statusText:%@; >"),
    v5,
    self->_status,
    self->_statusText);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTRServiceAreaClusterSkipCurrentLocationResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRServiceAreaClusterSkipCurrentLocationResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRServiceAreaClusterSkipCurrentLocationResponseParams *v30;
  __int128 v32;
  uint64_t v33;
  __int128 v34;
  uint64_t v35;
  ...
  v6 = a3;
  v38.receiver = self;
  v38.super_class = (Class)MTRServiceAreaClusterSkipCurrentLocationResponseParams;
  v8 = -[MTRServiceAreaClusterSkipCurrentLocationResponseParams init](&v38, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!(_DWORD)v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_233D2A7D4((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      v34 = v32;
      v35 = v33;
      if (!(_DWORD)v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    objc_msgSend_statusText(self, v19, v20);
    v21 = (void *)objc_claimAutoreleasedReturnValue();

    if (!v21)
    {
      *(_OWORD *)&retstr->mError = xmmword_2504EEDD8;
      *(_QWORD *)&retstr->mLine = 21688;
      return result;
    }
  }
  else
