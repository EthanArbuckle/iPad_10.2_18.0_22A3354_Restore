...
{
  MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams *v2;
  MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams *v3;
  NSNumber *arg1;
  ...
  v2 = -[MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
{
  MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
