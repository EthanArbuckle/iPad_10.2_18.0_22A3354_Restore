...
{
  MTRColorControlClusterEnhancedMoveToHueAndSaturationParams *v2;
  MTRColorControlClusterEnhancedMoveToHueAndSaturationParams *v3;
  ...
  v2 = -[MTRColorControlClusterEnhancedMoveToHueAndSaturationParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterEnhancedMoveToHueAndSaturationParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: enhancedHue:%@; saturation:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_enhancedHue,
    self->_saturation,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v36)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2FB88(&v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
