...
{
  MTRElectricalMeasurementClusterGetProfileInfoCommandParams *v2;
  MTRElectricalMeasurementClusterGetProfileInfoCommandParams *v3;
  ...
  v2 = -[MTRElectricalMeasurementClusterGetProfileInfoCommandParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRElectricalMeasurementClusterGetProfileInfoCommandParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
