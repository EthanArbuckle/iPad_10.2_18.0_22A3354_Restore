...
{
  MTRGroupKeyManagementClusterKeySetReadAllIndicesParams *v2;
  MTRGroupKeyManagementClusterKeySetReadAllIndicesParams *v3;
  ...
  v2 = -[MTRGroupKeyManagementClusterKeySetReadAllIndicesParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRGroupKeyManagementClusterKeySetReadAllIndicesParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
{
  objc_setProperty_nonatomic_copy(self, a2, groupKeySetIDs, 24);
}
