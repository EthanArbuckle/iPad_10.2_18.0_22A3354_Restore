...
{
  MTRRVCCleanModeClusterModeTagStruct *v2;
  MTRRVCCleanModeClusterModeTagStruct *v3;
  NSNumber *mfgCode;
  NSNumber *value;
  objc_super v7;
  ...
  v2 = -[MTRRVCCleanModeClusterModeTagStruct init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    mfgCode = v2->_mfgCode;
...
{
  MTRRVCCleanModeClusterModeTagStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
