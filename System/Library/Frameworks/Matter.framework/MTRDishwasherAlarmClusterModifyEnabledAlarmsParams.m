...
{
  MTRDishwasherAlarmClusterModifyEnabledAlarmsParams *v2;
  MTRDishwasherAlarmClusterModifyEnabledAlarmsParams *v3;
  NSNumber *mask;
  ...
  v2 = -[MTRDishwasherAlarmClusterModifyEnabledAlarmsParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    mask = v2->_mask;
    v2->_mask = (NSNumber *)&unk_250591A40;
...
{
  MTRDishwasherAlarmClusterModifyEnabledAlarmsParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: mask:%@; >"), v5, self->_mask);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_mask(self, a3, (uint64_t)a4);
