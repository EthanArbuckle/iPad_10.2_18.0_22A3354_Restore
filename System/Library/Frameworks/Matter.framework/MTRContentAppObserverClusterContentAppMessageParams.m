...
{
  MTRContentAppObserverClusterContentAppMessageParams *v2;
  MTRContentAppObserverClusterContentAppMessageParams *v3;
  NSString *data;
  ...
  v2 = -[MTRContentAppObserverClusterContentAppMessageParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    data = v2->_data;
    ...
    v3->_encodingHint = (NSString *)&stru_2505249E8;
...
{
  MTRContentAppObserverClusterContentAppMessageParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_encodingHint(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: data:%@; encodingHint:%@; >"),
    v5,
    self->_data,
    self->_encodingHint);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v30[1] = 0;
  v29 = v30;
  objc_msgSend_data(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
