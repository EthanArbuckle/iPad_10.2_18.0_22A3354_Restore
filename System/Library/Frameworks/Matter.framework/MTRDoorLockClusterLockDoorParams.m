...
{
  MTRDoorLockClusterLockDoorParams *v2;
  MTRDoorLockClusterLockDoorParams *v3;
  NSData *pinCode;
  ...
  v2 = -[MTRDoorLockClusterLockDoorParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    pinCode = v2->_pinCode;
...
{
  MTRDoorLockClusterLockDoorParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
