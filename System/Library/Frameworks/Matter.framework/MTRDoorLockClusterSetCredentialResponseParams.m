...
{
  MTRDoorLockClusterSetCredentialResponseParams *v2;
  MTRDoorLockClusterSetCredentialResponseParams *v3;
  NSNumber *status;
  NSNumber *userIndex;
  ...
  v2 = -[MTRDoorLockClusterSetCredentialResponseParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
{
  MTRDoorLockClusterSetCredentialResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_nextCredentialIndex(self, v13, v14);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: status:%@; userIndex:%@; nextCredentialIndex:%@; >"),
    v5,
    self->_status,
    self->_userIndex,
...
- (MTRDoorLockClusterSetCredentialResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRDoorLockClusterSetCredentialResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRDoorLockClusterSetCredentialResponseParams *v30;
  char v32[10];
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRDoorLockClusterSetCredentialResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    if (!(_DWORD)v33)
    {
      ...
      v32[6] = 0;
      v32[8] = 0;
      sub_233D26C8C(v32, (uint64_t)v35, (uint64_t)&buf);
      v33 = buf;
      v34 = v41;
      if (!(_DWORD)buf)
      {
...
{
  objc_setProperty_nonatomic_copy(self, a2, nextCredentialIndex, 24);
}
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (*((_BYTE *)a4 + 8))
  {
    objc_msgSend_numberWithUnsignedShort_(MEMORY[0x24BDD16E0], v12, *((unsigned __int16 *)a4 + 3));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
