...
{
  MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct *v2;
  MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct *v3;
  ...
  v2 = -[MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct init](&v13, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRElectricalEnergyMeasurementClusterMeasurementAccuracyStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
