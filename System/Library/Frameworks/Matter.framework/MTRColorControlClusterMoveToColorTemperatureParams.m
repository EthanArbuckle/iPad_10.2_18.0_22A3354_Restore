...
{
  MTRColorControlClusterMoveToColorTemperatureParams *v2;
  MTRColorControlClusterMoveToColorTemperatureParams *v3;
  ...
  v2 = -[MTRColorControlClusterMoveToColorTemperatureParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    colorTemperatureMireds = v2->_colorTemperatureMireds;
    v2->_colorTemperatureMireds = (NSNumber *)&unk_250591A40;
...
{
  MTRColorControlClusterMoveToColorTemperatureParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_colorTemperatureMireds(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: colorTemperatureMireds:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
...
{
  objc_setProperty_nonatomic_copy(self, a2, colorTemperatureMireds, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v33[1] = 0;
  v32 = v33;
  objc_msgSend_colorTemperatureMireds(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v31)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2F068((unsigned __int16 *)&v34, v26, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
