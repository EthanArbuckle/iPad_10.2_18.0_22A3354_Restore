...
{
  MTRICDManagementClusterStayActiveResponseParams *v2;
  MTRICDManagementClusterStayActiveResponseParams *v3;
  NSNumber *promisedActiveDuration;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRICDManagementClusterStayActiveResponseParams;
  v2 = -[MTRICDManagementClusterStayActiveResponseParams init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
    promisedActiveDuration = v2->_promisedActiveDuration;
    v2->_promisedActiveDuration = (NSNumber *)&unk_250591A40;
...
{
  MTRICDManagementClusterStayActiveResponseParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_promisedActiveDuration(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: promisedActiveDuration:%@; >"),
    v5,
    self->_promisedActiveDuration);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTRICDManagementClusterStayActiveResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRICDManagementClusterStayActiveResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRICDManagementClusterStayActiveResponseParams *v30;
  int v32;
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRICDManagementClusterStayActiveResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      v32 = 0;
      sub_233D122EC(&v32, (uint64_t)v35, (uint64_t)&buf);
      v33 = buf;
      v34 = v41;
      if (!(_DWORD)buf)
      {
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_promisedActiveDuration, 0);
}
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_numberWithUnsignedInt_(MEMORY[0x24BDD16E0], a3, *(unsigned int *)&a4->var0);
