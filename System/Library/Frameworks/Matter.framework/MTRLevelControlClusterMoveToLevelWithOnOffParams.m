...
{
  MTRLevelControlClusterMoveToLevelWithOnOffParams *v2;
  MTRLevelControlClusterMoveToLevelWithOnOffParams *v3;
  NSNumber *level;
  ...
  v2 = -[MTRLevelControlClusterMoveToLevelWithOnOffParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    level = v2->_level;
    v2->_level = (NSNumber *)&unk_250591A40;
...
{
  MTRLevelControlClusterMoveToLevelWithOnOffParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: level:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_level,
...
{
  objc_setProperty_nonatomic_copy(self, a2, level, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v34[1] = 0;
  v33 = v34;
  objc_msgSend_level(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v12)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v36 = objc_msgSend_unsignedShortValue(v15, v16, v17);
  ...
  if (v32)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CFAEF8(&v35, v27, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
