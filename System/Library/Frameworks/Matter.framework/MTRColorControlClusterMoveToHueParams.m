...
{
  MTRColorControlClusterMoveToHueParams *v2;
  MTRColorControlClusterMoveToHueParams *v3;
  NSNumber *hue;
  NSNumber *direction;
  ...
  v2 = -[MTRColorControlClusterMoveToHueParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
    hue = v2->_hue;
...
{
  MTRColorControlClusterMoveToHueParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: hue:%@; direction:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_hue,
    self->_direction,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v36)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2D614((unsigned __int8 *)&v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
