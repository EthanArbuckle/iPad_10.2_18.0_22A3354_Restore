...
{
  MTRDeviceEnergyManagementClusterResumeRequestParams *v2;
  MTRDeviceEnergyManagementClusterResumeRequestParams *v3;
  ...
  v2 = -[MTRDeviceEnergyManagementClusterResumeRequestParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDeviceEnergyManagementClusterResumeRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
