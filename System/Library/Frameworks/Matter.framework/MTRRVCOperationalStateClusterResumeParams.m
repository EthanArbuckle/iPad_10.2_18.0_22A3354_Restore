...
{
  MTRRVCOperationalStateClusterResumeParams *v2;
  MTRRVCOperationalStateClusterResumeParams *v3;
  ...
  v2 = -[MTRRVCOperationalStateClusterResumeParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRRVCOperationalStateClusterResumeParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
