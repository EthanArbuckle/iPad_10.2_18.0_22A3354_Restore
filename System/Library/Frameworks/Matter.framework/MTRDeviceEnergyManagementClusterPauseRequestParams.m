...
{
  MTRDeviceEnergyManagementClusterPauseRequestParams *v2;
  MTRDeviceEnergyManagementClusterPauseRequestParams *v3;
  NSNumber *duration;
  NSNumber *cause;
  ...
  v2 = -[MTRDeviceEnergyManagementClusterPauseRequestParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRDeviceEnergyManagementClusterPauseRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: duration:%@; cause:%@; >"),
    v5,
    self->_duration,
    self->_cause);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
