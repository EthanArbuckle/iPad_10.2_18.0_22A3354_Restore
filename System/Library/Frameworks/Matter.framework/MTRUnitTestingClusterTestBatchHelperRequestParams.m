...
{
  MTRUnitTestingClusterTestBatchHelperRequestParams *v2;
  MTRUnitTestingClusterTestBatchHelperRequestParams *v3;
  ...
  v2 = -[MTRUnitTestingClusterTestBatchHelperRequestParams init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRUnitTestingClusterTestBatchHelperRequestParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
