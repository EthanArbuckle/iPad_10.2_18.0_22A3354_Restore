...
- (MTRUnitTestingClusterTestBatchHelperResponseParams)init
{
  const char *v2;
  uint64_t v3;
  MTRUnitTestingClusterTestBatchHelperResponseParams *v4;
  uint64_t v5;
  NSData *buffer;
  objc_super v8;
  ...
  v4 = -[MTRUnitTestingClusterTestBatchHelperResponseParams init](&v8, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_buffer(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_base64EncodedStringWithOptions_(self->_buffer, v6, 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v3, v8, (uint64_t)CFSTR("<%@: buffer:%@; >"), v5, v7);
...
- (MTRUnitTestingClusterTestBatchHelperResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  id v6;
  const char *v7;
  MTRUnitTestingClusterTestBatchHelperResponseParams *v8;
  const char *v9;
  void *v10;
  char *v11;
  const char *v12;
  ...
  void *v28;
  const char *v29;
  MTRUnitTestingClusterTestBatchHelperResponseParams *v30;
  __int128 v32;
  __int128 v33;
  uint64_t v34;
  _BYTE v35[72];
  ...
  v8 = -[MTRUnitTestingClusterTestBatchHelperResponseParams init](&v37, sel_init);
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      v32 = 0uLL;
      sub_233D42104(&v32, (uint64_t)v35, (uint64_t)buf);
      v33 = *(_OWORD *)buf;
      v34 = v41;
      if (!*(_DWORD *)buf)
      {
