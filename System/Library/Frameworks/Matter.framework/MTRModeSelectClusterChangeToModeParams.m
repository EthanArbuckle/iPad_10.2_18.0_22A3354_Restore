...
{
  MTRModeSelectClusterChangeToModeParams *v2;
  MTRModeSelectClusterChangeToModeParams *v3;
  NSNumber *newMode;
  ...
  v2 = -[MTRModeSelectClusterChangeToModeParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    newMode = v2->_newMode;
...
{
  MTRModeSelectClusterChangeToModeParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
{
  objc_setProperty_nonatomic_copy(self, a2, newMode, 8);
}
