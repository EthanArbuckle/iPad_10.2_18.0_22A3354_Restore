...
{
  MTRRVCOperationalStateClusterOperationalErrorEvent *v2;
  uint64_t v3;
  ...
  v2 = -[MTRRVCOperationalStateClusterOperationalErrorEvent init](&v6, sel_init);
  if (v2)
  {
    v3 = objc_opt_new();
...
{
  MTRRVCOperationalStateClusterOperationalErrorEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
