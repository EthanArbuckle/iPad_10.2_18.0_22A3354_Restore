...
- (MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams)init
{
  const char *v2;
  uint64_t v3;
  MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams *v4;
  uint64_t v5;
  ...
  v4 = -[MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams init](&v9, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_groupKeySetIDs(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: groupKeySetIDs:%@; >"), v5, self->_groupKeySetIDs);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  NSDictionary *v6;
  const char *v7;
  MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams *v8;
  uint64_t v9;
  const char *v10;
  void *v11;
  char *v12;
  ...
  void *v29;
  const char *v30;
  MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams *v31;
  __int128 v33;
  uint64_t v34;
  __int128 v35;
  uint64_t v36;
  ...
  v8 = -[MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams init](&v39, sel_init);
  if (!v8)
  {
    v31 = 0;
    goto LABEL_16;
  ...
  if (v38)
  {
    ...
    if (!(_DWORD)v35)
    {
      ...
      sub_233D111E0((uint64_t)&buf, (uint64_t)v37, (uint64_t)&v33);
      v35 = v33;
      v36 = v34;
      if (!(_DWORD)v33)
      {
...
{
  objc_setProperty_nonatomic_copy(self, a2, groupKeySetIDs, 8);
}
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  while (sub_233CAF3D8((uint64_t)&v12))
  {
    objc_msgSend_numberWithUnsignedShort_(MEMORY[0x24BDD16E0], v8, v12);
