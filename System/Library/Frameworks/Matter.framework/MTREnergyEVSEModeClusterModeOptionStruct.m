...
{
  MTREnergyEVSEModeClusterModeOptionStruct *v2;
  MTREnergyEVSEModeClusterModeOptionStruct *v3;
  NSString *label;
  NSNumber *mode;
  const char *v6;
  uint64_t v7;
  ...
  v2 = -[MTREnergyEVSEModeClusterModeOptionStruct init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    label = v2->_label;
...
{
  MTREnergyEVSEModeClusterModeOptionStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
