...
{
  MTRColorControlClusterMoveSaturationParams *v2;
  MTRColorControlClusterMoveSaturationParams *v3;
  NSNumber *moveMode;
  NSNumber *rate;
  ...
  v2 = -[MTRColorControlClusterMoveSaturationParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterMoveSaturationParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v31)
  {
    ...
    sub_234106CA8((uint64_t)v26, (uint64_t)&v27, 0xFFFFFFFF, (uint64_t)v35);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2D8FC((unsigned __int8 *)&v34, v26, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
