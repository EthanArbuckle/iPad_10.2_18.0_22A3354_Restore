...
{
  MTRGroupsClusterAddGroupIfIdentifyingParams *v2;
  MTRGroupsClusterAddGroupIfIdentifyingParams *v3;
  NSNumber *groupID;
  NSString *groupName;
  ...
  v2 = -[MTRGroupsClusterAddGroupIfIdentifyingParams init](&v9, sel_init);
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
{
  MTRGroupsClusterAddGroupIfIdentifyingParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_groupName(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: groupID:%@; groupName:%@; >"),
    v5,
    self->_groupID,
    self->_groupName);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_setProperty_nonatomic_copy(self, a2, groupName, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v24)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CF87FC(&v27, v19, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
