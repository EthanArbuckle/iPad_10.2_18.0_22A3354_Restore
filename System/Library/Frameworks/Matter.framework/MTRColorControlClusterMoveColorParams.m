...
{
  MTRColorControlClusterMoveColorParams *v2;
  MTRColorControlClusterMoveColorParams *v3;
  NSNumber *rateX;
  NSNumber *rateY;
  ...
  v2 = -[MTRColorControlClusterMoveColorParams init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    rateX = v2->_rateX;
    v2->_rateX = (NSNumber *)&unk_250591A40;

    rateY = v3->_rateY;
    v3->_rateY = (NSNumber *)&unk_250591A40;
...
{
  MTRColorControlClusterMoveColorParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_rateX(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setRateX_(v4, v8, (uint64_t)v7);

  objc_msgSend_rateY(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: rateX:%@; rateY:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_rateX,
    self->_rateY,
    self->_optionsMask,
...
{
  objc_setProperty_nonatomic_copy(self, a2, rateX, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, rateY, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v33[1] = 0;
  v32 = v33;
  objc_msgSend_rateX(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  LOWORD(v34) = objc_msgSend_shortValue(v7, v8, v9);

  objc_msgSend_rateY(self, v10, v11);
  ...
  if (v31)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2EAAC((__int16 *)&v34, v26, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
