...
{
  MTRSmokeCOAlarmClusterInterconnectSmokeAlarmEvent *v2;
  MTRSmokeCOAlarmClusterInterconnectSmokeAlarmEvent *v3;
  NSNumber *alarmSeverityLevel;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRSmokeCOAlarmClusterInterconnectSmokeAlarmEvent;
  v2 = -[MTRSmokeCOAlarmClusterInterconnectSmokeAlarmEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRSmokeCOAlarmClusterInterconnectSmokeAlarmEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
