...
{
  MTRActionsClusterDisableActionWithDurationParams *v2;
  MTRActionsClusterDisableActionWithDurationParams *v3;
  NSNumber *actionID;
  NSNumber *invokeID;
  NSNumber *duration;
  ...
  v2 = -[MTRActionsClusterDisableActionWithDurationParams init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
    ...
    v3->_duration = (NSNumber *)&unk_250591A40;
...
{
  MTRActionsClusterDisableActionWithDurationParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: actionID:%@; invokeID:%@; duration:%@; >"),
    v5,
    self->_actionID,
    self->_invokeID,
    self->_duration);
...
{
  objc_setProperty_nonatomic_copy(self, a2, duration, 24);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v12)
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    v32 = objc_msgSend_unsignedIntValue(v15, v16, v17);

  }
  objc_msgSend_duration(self, v13, v14);
  v18 = (void *)objc_claimAutoreleasedReturnValue();
  v33 = objc_msgSend_unsignedIntValue(v18, v19, v20);
  ...
  if (v27)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233CFF10C(v30, v22, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
