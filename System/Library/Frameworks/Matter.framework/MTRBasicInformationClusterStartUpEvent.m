...
{
  MTRBasicInformationClusterStartUpEvent *v2;
  MTRBasicInformationClusterStartUpEvent *v3;
  NSNumber *softwareVersion;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MTRBasicInformationClusterStartUpEvent;
  v2 = -[MTRBasicInformationClusterStartUpEvent init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRBasicInformationClusterStartUpEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
