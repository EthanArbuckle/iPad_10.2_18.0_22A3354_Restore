...
- (MTRServiceAreaClusterSkipCurrentLocationParams)init
{
  MTRServiceAreaClusterSkipCurrentLocationParams *v2;
  MTRServiceAreaClusterSkipCurrentLocationParams *v3;
  NSNumber *timedInvokeTimeoutMs;
  NSNumber *serverSideProcessingTimeout;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)MTRServiceAreaClusterSkipCurrentLocationParams;
  v2 = -[MTRServiceAreaClusterSkipCurrentLocationParams init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRServiceAreaClusterSkipCurrentLocationParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  v4 = objc_alloc_init(MTRServiceAreaClusterSkipCurrentLocationParams);
