...
{
  MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct *v2;
  MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct *v3;
  NSNumber *rangeMin;
  NSNumber *rangeMax;
  NSNumber *percentMax;
  NSNumber *percentMin;
  ...
  v2 = -[MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct init](&v13, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRElectricalEnergyMeasurementClusterMeasurementAccuracyRangeStruct *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
