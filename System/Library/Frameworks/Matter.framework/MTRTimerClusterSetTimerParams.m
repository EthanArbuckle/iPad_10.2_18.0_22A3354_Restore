...
{
  MTRTimerClusterSetTimerParams *v2;
  MTRTimerClusterSetTimerParams *v3;
  NSNumber *newTime;
  ...
  v2 = -[MTRTimerClusterSetTimerParams init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
    newTime = v2->_newTime;
    v2->_newTime = (NSNumber *)&unk_250591A40;
...
{
  MTRTimerClusterSetTimerParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_getNewTime(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: newTime:%@; >"), v5, self->_newTime);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  objc_msgSend_getNewTime(self, a3, (uint64_t)a4);
