...
{
  MTROvenCavityOperationalStateClusterOperationCompletionEvent *v2;
  MTROvenCavityOperationalStateClusterOperationCompletionEvent *v3;
  ...
  v2 = -[MTROvenCavityOperationalStateClusterOperationCompletionEvent init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTROvenCavityOperationalStateClusterOperationCompletionEvent *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
