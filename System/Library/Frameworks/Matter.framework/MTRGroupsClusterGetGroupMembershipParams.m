...
- (MTRGroupsClusterGetGroupMembershipParams)init
{
  const char *v2;
  uint64_t v3;
  MTRGroupsClusterGetGroupMembershipParams *v4;
  uint64_t v5;
  NSArray *groupList;
  ...
  v4 = -[MTRGroupsClusterGetGroupMembershipParams init](&v10, sel_init);
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_groupList(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: groupList:%@; >"), v5, self->_groupList);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  objc_setProperty_nonatomic_copy(self, a2, groupList, 8);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v51[1] = 0;
  v50 = v51;
  objc_msgSend_groupList(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (v10)
  {
    ...
    objc_msgSend_groupList(self, v12, v13);
    ...
    *v11 = &off_2504EF238;
    ...
    if (v11[1])
    {
      ...
      for (i = 0; ; ++i)
      {
        objc_msgSend_groupList(self, v17, v18);
        ...
        {
          v38 = v11[1];
          objc_msgSend_groupList(self, v24, v25);
          v39 = (void *)objc_claimAutoreleasedReturnValue();
          v42 = objc_msgSend_count(v39, v40, v41);
          sub_233CAF22C(v44, v38, v42);
          v52 = *(_OWORD *)v44;
        ...
        if ((isKindOfClass & 1) == 0)
          break;
        objc_msgSend_groupList(self, v30, v31);
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_objectAtIndexedSubscript_(v32, v33, i);
        v34 = (void *)objc_claimAutoreleasedReturnValue();

        *(_WORD *)(v11[1] + 2 * i) = objc_msgSend_unsignedShortValue(v34, v35, v36);
      }
      retstr->mError = 47;
...
LABEL_10:
    ...
    if (v49)
    {
      ...
      *(_QWORD *)&retstr->mLine = 0;
      sub_233CF9D8C((unsigned __int16 **)&v52, (char *)v44, 0x100uLL, (uint64_t)retstr);
      if (!retstr->mError)
      {
        *(_QWORD *)&retstr->mError = 0;
        retstr->mFile = 0;
