...
{
  MTRColorControlClusterMoveToColorParams *v2;
  MTRColorControlClusterMoveToColorParams *v3;
  NSNumber *colorX;
  NSNumber *colorY;
  ...
  v2 = -[MTRColorControlClusterMoveToColorParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
    colorX = v2->_colorX;
    v2->_colorX = (NSNumber *)&unk_250591A40;

    colorY = v3->_colorY;
    v3->_colorY = (NSNumber *)&unk_250591A40;
...
{
  MTRColorControlClusterMoveToColorParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
  ...
  objc_msgSend_colorX(self, v5, v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_setColorX_(v4, v8, (uint64_t)v7);

  objc_msgSend_colorY(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, (uint64_t)CFSTR("<%@: colorX:%@; colorY:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >"),
    v5,
    self->_colorX,
    self->_colorY,
...
{
  objc_setProperty_nonatomic_copy(self, a2, colorX, 8);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, colorY, 16);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  objc_msgSend_colorX(self, a3, (uint64_t)a4);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  LOWORD(v39) = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_msgSend_colorY(self, v10, v11);
  ...
  if (v36)
  {
    ...
    sub_234106CA8((uint64_t)v31, (uint64_t)&v32, 0xFFFFFFFF, (uint64_t)v40);
    *(_QWORD *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2E7AC((unsigned __int16 *)&v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
