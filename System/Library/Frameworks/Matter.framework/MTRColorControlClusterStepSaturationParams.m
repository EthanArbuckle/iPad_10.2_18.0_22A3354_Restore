...
{
  MTRColorControlClusterStepSaturationParams *v2;
  MTRColorControlClusterStepSaturationParams *v3;
  NSNumber *stepMode;
  NSNumber *stepSize;
  ...
  v2 = -[MTRColorControlClusterStepSaturationParams init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  MTRColorControlClusterStepSaturationParams *v4;
  const char *v5;
  uint64_t v6;
  void *v7;
  const char *v8;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v27 = (void *)objc_claimAutoreleasedReturnValue();
  v40 = objc_msgSend_unsignedCharValue(v27, v28, v29);
  ...
  if (v36)
  {
    ...
    *(_QWORD *)&retstr->mLine = 0;
    sub_233D2DBF4((unsigned __int8 *)&v39, v31, 0x100uLL, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(_QWORD *)&retstr->mError = 0;
      retstr->mFile = 0;
