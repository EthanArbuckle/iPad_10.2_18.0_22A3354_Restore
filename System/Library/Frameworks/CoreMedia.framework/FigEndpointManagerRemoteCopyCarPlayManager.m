@implementation FigEndpointManagerRemoteCopyCarPlayManager
...
void __FigEndpointManagerRemoteCopyCarPlayManager_block_invoke()
{
  ...
  FigEndpointManagerRemoteCopyCarPlayManager_sCreationResult = FigEndpointManagerRemoteCreateWithType(CFSTR("CarPlay"), (CFTypeRef *)&FigEndpointManagerRemoteCopyCarPlayManager_sCarPlayManager);
  v6[0] = 0;
