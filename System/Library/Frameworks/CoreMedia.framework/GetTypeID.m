...
void __figProcessStateMonitorRemote_GetTypeID_block_invoke()
{
  ...
  fig_note_initialize_category_with_default_work_cf((uint64_t)&gFigProcessStateMonitorRemoteTrace[1], CFSTR("figprocessstatemonitor_trace"), CFSTR("com.apple.coremedia"), (uint64_t)", (uint64_t)"com.apple.coremedia", v0, 0, gFigProcessStateMonitorRemoteTrace);
  fig_note_initialize_category_with_default_work_cf((uint64_t)&dword_1ECDA84D8, CFSTR("figprocessstatemonitor_trace"), CFSTR("com.apple.coremedia"), (uint64_t)", (uint64_t)"com.apple.coremedia", 1u, 0, &qword_1ECDA84D0);
}
