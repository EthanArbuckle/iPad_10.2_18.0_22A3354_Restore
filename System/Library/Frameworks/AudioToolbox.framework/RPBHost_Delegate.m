...
- (void).cxx_destruct
{
  ...
  uint64_t v5;
  RPBHost_Delegate *p_get_property_callback;
  uint64_t v7;
  RPBHost_Delegate *p_get_property_info_callback;
  uint64_t v9;
  RPBHost_Delegate *p_set_parameter_callback;
  uint64_t v11;
  RPBHost_Delegate *p_get_parameter_callback;
  uint64_t v13;
  RPBHost_Delegate *p_get_parameter_info_callback;
  uint64_t v15;
...
LABEL_6:
  p_get_property_callback = (RPBHost_Delegate *)self->get_property_callback.__f_.__f_;
  if (p_get_property_callback == (RPBHost_Delegate *)&self->get_property_callback)
  {
    v7 = 4;
    p_get_property_callback = (RPBHost_Delegate *)&self->get_property_callback;
  }
  else
  {
...
LABEL_11:
  p_get_property_info_callback = (RPBHost_Delegate *)self->get_property_info_callback.__f_.__f_;
  if (p_get_property_info_callback == (RPBHost_Delegate *)&self->get_property_info_callback)
  {
    v9 = 4;
    p_get_property_info_callback = (RPBHost_Delegate *)&self->get_property_info_callback;
  }
  else
  {
...
LABEL_16:
  p_set_parameter_callback = (RPBHost_Delegate *)self->set_parameter_callback.__f_.__f_;
  if (p_set_parameter_callback == (RPBHost_Delegate *)&self->set_parameter_callback)
  {
    v11 = 4;
    p_set_parameter_callback = (RPBHost_Delegate *)&self->set_parameter_callback;
  }
  else
  {
...
LABEL_21:
  p_get_parameter_callback = (RPBHost_Delegate *)self->get_parameter_callback.__f_.__f_;
  if (p_get_parameter_callback == (RPBHost_Delegate *)&self->get_parameter_callback)
  {
    v13 = 4;
    p_get_parameter_callback = (RPBHost_Delegate *)&self->get_parameter_callback;
  }
  else
  {
...
LABEL_26:
  p_get_parameter_info_callback = (RPBHost_Delegate *)self->get_parameter_info_callback.__f_.__f_;
  if (p_get_parameter_info_callback == (RPBHost_Delegate *)&self->get_parameter_info_callback)
  {
    v15 = 4;
    p_get_parameter_info_callback = (RPBHost_Delegate *)&self->get_parameter_info_callback;
  }
  else
  {
