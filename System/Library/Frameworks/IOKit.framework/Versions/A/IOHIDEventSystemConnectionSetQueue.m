...
void ___IOHIDEventSystemConnectionSetQueue_block_invoke(uint64_t a1)
{
  ...
  *(_QWORD *)&v3->msgh_bits = 0x5C00000000;
  v4 = *(_DWORD *)(*(_QWORD *)(a1 + 32) + 104);
    ...
    while (1)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 136315394;
        ...
        v18 = 2080;
        v19 = v9;
        _os_log_impl(&dword_18AAAF000, v7, OS_LOG_TYPE_INFO, "%s: mach_msg(sendPossiblePort):%s", buf, 0x16u);
      }
      if (v6 != 268451844)
        break;
...
LABEL_7:
    ...
    if (msgh_id == 72)
    {
      ...
      *(_DWORD *)(v12 + 128) = 0;
      ...
      v14 = *(_QWORD *)(v12 + 8);
      if (v14)
        _IOHIDEventSystemSetPropertyForConnection(v14, CFSTR("IOHIDEventSystemClientIsUnresponsive"), (const void *)*MEMORY[0x1E0C9AE50], (const void *)v12);
    }
    else if (msgh_id == 66)
    {
      os_unfair_recursive_lock_lock_with_options();
      ...
      {
        IsActive = IOHIDEventQueueIsActive(*(_QWORD *)(v12 + 24));
        os_unfair_recursive_lock_unlock();
        if (IsActive)
...
{
  dispatch_release(*(dispatch_object_t *)(*(_QWORD *)(a1 + 32) + 112));
