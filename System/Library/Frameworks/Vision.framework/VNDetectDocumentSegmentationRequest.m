...
- (id)applicableDetectorTypeForRevision:(unint64_t)a3 error:(id *)a4
{
  ...
  v4 = CFSTR("VNDocumentSegmentationDetectorType");
  return CFSTR("VNDocumentSegmentationDetectorType");
}
...
- (id)newDefaultDetectorOptionsForRequestRevision:(unint64_t)a3 session:(id)a4
{
  ...
  v4 = -[VNRequest newDefaultDetectorOptionsForRequestRevision:session:](&v6, sel_newDefaultDetectorOptionsForRequestRevision_session_, a3, a4);
  objc_msgSend(v4, "setObject:forKeyedSubscript:", &unk_1E459CA90, CFSTR("VNDetectorProcessOption_ImageCropAndScaleOption"));
  return v4;
}
...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VNDetectDocumentSegmentationRequest(Revisioning) revisionAvailability]::ourRevisionAvailability;
}
