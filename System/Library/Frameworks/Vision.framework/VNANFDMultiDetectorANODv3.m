...
+ (id)detectedObjectClassToRequestKey
{
  ...
  return (id)+[VNANFDMultiDetectorANODv3 detectedObjectClassToRequestKey]::detectedObjectClassToRequestKey;
}
...
+ (id)detectedObjectRequestKeyToRequestInfo
{
  ...
  return (id)+[VNANFDMultiDetectorANODv3 detectedObjectRequestKeyToRequestInfo]::detectedObjectRequestKeyToRequestInfo;
}
...
+ (NSDictionary)recognizedFoodAndDrinkObjectClassToFoodAndDrinkCategoryName
{
  if (+[VNANFDMultiDetectorANODv3 recognizedFoodAndDrinkObjectClassToFoodAndDrinkCategoryName]::onceToken != -1)
    dispatch_once(&+[VNANFDMultiDetectorANODv3 recognizedFoodAndDrinkObjectClassToFoodAndDrinkCategoryName]::onceToken, &__block_literal_global_10707);
  return (NSDictionary *)(id)+[VNANFDMultiDetectorANODv3 recognizedFoodAndDrinkObjectClassToFoodAndDrinkCategoryName]::recognizedFoodAndDrinkObjectClassToFoodAndDrinkCategoryName;
}
...
+ (NSArray)knownFoodAndDrinkIdentifiers
{
  ...
  return (NSArray *)(id)+[VNANFDMultiDetectorANODv3 knownFoodAndDrinkIdentifiers]::knownFoodAndDrinkIdentifiers;
}

+ (BOOL)shouldAlignFacesForRequestWithSpecifier:(id)a3
{
  return objc_msgSend(a3, "requestRevision") != 3737841668;
}
...
void __57__VNANFDMultiDetectorANODv3_knownFoodAndDrinkIdentifiers__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "recognizedFoodAndDrinkObjectClassToFoodAndDrinkCategoryName");
...
void __60__VNANFDMultiDetectorANODv3_detectedObjectClassToRequestKey__block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(v2, "setObject:forKey:", v4, &unk_1E459C8F8);

  v5 = (objc_class *)objc_opt_class();
  NSStringFromClass(v5);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "setObject:forKey:", v6, &unk_1E459C910);

  v7 = objc_msgSend(v2, "copy");
  v8 = (void *)+[VNANFDMultiDetectorANODv3 detectedObjectClassToRequestKey]::detectedObjectClassToRequestKey;
...
- (BOOL)updateRuntimeParametersFromOptions:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  +[VNValidationUtilities originatingRequestSpecifierForKey:inOptions:specifyingRequestClass:error:](VNValidationUtilities, "originatingRequestSpecifierForKey:inOptions:specifyingRequestClass:error:", CFSTR("VNANFDMultiDetectorProcessingOption_HumanFaceDetectorOriginatingRequestSpecifier"), v6, objc_opt_class(), 0);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
    v13.receiver = self;
    v13.super_class = (Class)VNANFDMultiDetectorANODv3;
    if (-[VNANFDMultiDetector updateRuntimeParametersFromOptions:error:](&v13, sel_updateRuntimeParametersFromOptions_error_, v6, a4))
    {
      v12 = 0;
      v8 = +[VNValidationUtilities getFloatValue:forKey:inOptions:error:](VNValidationUtilities, "getFloatValue:forKey:inOptions:error:", &v12, CFSTR("VNANFDMultiDetectorProcessingOption_PrecisionRecallThreshold"), v6, a4);
      if (v8)
      {
        -[VNANFDMultiDetector VNShotflowDetector](self, "VNShotflowDetector");
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        objc_opt_class();
        if (!((a4 == 0) | objc_opt_isKindOfClass() & 1))
        {
          +[VNError errorForInternalErrorWithLocalizedDescription:](VNError, "errorForInternalErrorWithLocalizedDescription:", CFSTR("Unexpected detector object type"));
          *a4 = (id)objc_claimAutoreleasedReturnValue();
        }
        LODWORD(v10) = v12;
        objc_msgSend(v9, "setFaceDetectionPrecisionRecallThreshold:", v10);
    ...
    if (v8)
    {
      ...
      while (2)
      {
        for (i = 0; i != v8; ++i)
        {
          ...
          v12 = -[VNANFDMultiDetector isDetectedObject:ofAGivenObjectSubClass:](self, "isDetectedObject:ofAGivenObjectSubClass:", v11, CFSTR("Food"));
          v13 = v5;
          if (!v12)
          {
            v14 = -[VNANFDMultiDetector isDetectedObject:ofAGivenObjectSubClass:](self, "isDetectedObject:ofAGivenObjectSubClass:", v11, CFSTR("Drink"));
            v13 = v6;
            if (!v14)
            {
              v18.receiver = self;
