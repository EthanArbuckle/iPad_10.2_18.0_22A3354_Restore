...
+ (id)privateRevisionsSet
{
  if (+[VN6Mb1ME89lyW3HpahkEygIG privateRevisionsSet]::onceToken != -1)
    dispatch_once(&+[VN6Mb1ME89lyW3HpahkEygIG privateRevisionsSet]::onceToken, &__block_literal_global_18245);
  return (id)+[VN6Mb1ME89lyW3HpahkEygIG privateRevisionsSet]::ourPrivateRevisions;
}
...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  ...
  if (a3 - 3737841664u < 3)
    return off_1E45462F8[a3 - 3737841664u];
  v4.receiver = a1;
  v4.super_class = (Class)&OBJC_METACLASS___VN6Mb1ME89lyW3HpahkEygIG;
...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VN6Mb1ME89lyW3HpahkEygIG revisionAvailability]::ourRevisionAvailability;
}
...
void __47__VN6Mb1ME89lyW3HpahkEygIG_privateRevisionsSet__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  uint64_t v8;
  void *v9;
  ...
  v9 = (void *)+[VN6Mb1ME89lyW3HpahkEygIG privateRevisionsSet]::ourPrivateRevisions;
  +[VN6Mb1ME89lyW3HpahkEygIG privateRevisionsSet]::ourPrivateRevisions = v8;
...
- (id)supportedIdentifiersAndReturnError:(id *)a3
{
  ...
  if (!-[objc_class isSubclassOfClass:](v6, "isSubclassOfClass:", objc_opt_class()))
  {
    ...
    if (v11)
    {
      ...
      {
        objc_msgSend(v11, "allSignificantEventIdentifiersWithOptions:error:", v9, a3);
        v8 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_12:
  ...
  -[objc_class allSignificantEventIdentifiersWithConfigurationOptions:error:](v6, "allSignificantEventIdentifiersWithConfigurationOptions:error:", v7, a3);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
LABEL_5:
  v9 = v7;
LABEL_13:
...
- (id)newDefaultDetectorOptionsForRequestRevision:(unint64_t)a3 session:(id)a4
{
  ...
  void *v7;
  objc_class *v8;
  VNCoreSceneUnderstandingDetectorSignificantEventConfiguration *v9;
  void *v10;
  id v11;
  unint64_t v12;
  void *v13;
  VNImageAnalyzerMultiDetectorVN6Mb1ME89lyW3HpahkEygIGConfiguration *v14;
  id v15;
  objc_super v17;
  _QWORD v18[2];
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", -[VN6Mb1ME89lyW3HpahkEygIG imageCropAndScaleOption](self, "imageCropAndScaleOption"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  {
    v9 = -[VNCoreSceneUnderstandingDetectorFeatureConfiguration initWithObservationsRecipient:]([VNCoreSceneUnderstandingDetectorSignificantEventConfiguration alloc], "initWithObservationsRecipient:", self);
    v18[0] = v9;
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v18, 1);
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v10, CFSTR("VNCoreSceneUnderstandingDetectorProcessingOption_SignificantEventConfigurations"));
  ...
  else
  {
    ...
    if (v12)
    {
      ...
      v14 = -[VNImageAnalyzerMultiDetectorAnalysisConfiguration initWithObservationsRecipient:]([VNImageAnalyzerMultiDetectorVN6Mb1ME89lyW3HpahkEygIGConfiguration alloc], "initWithObservationsRecipient:", self);
      objc_msgSend(v6, "setObject:forKeyedSubscript:", v14, CFSTR("VNImageAnalyzerMultiDetectorOption_VN6Mb1ME89lyW3HpahkEygIGConfiguration"));
...
- (BOOL)willAcceptCachedResultsFromRequestWithConfiguration:(id)a3
{
  ...
  v4 = a3;
  v5 = -[VN6Mb1ME89lyW3HpahkEygIG imageCropAndScaleOption](self, "imageCropAndScaleOption");
