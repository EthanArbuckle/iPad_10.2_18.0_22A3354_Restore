...
- (id)newDefaultDetectorOptionsForRequestRevision:(unint64_t)a3 session:(id)a4
{
  id v6;
  objc_class *v7;
  VNCoreSceneUnderstandingDetectorImageFingerprintsConfiguration *v8;
  void *v9;
  unint64_t v10;
  void *v11;
  objc_super v13;
  ...
  if (+[VNCoreSceneUnderstandingDetector handlesRequestClass:revision:](VNCoreSceneUnderstandingDetector, "handlesRequestClass:revision:", v7, a3))
  {
    v8 = -[VNCoreSceneUnderstandingDetectorFeatureConfiguration initWithObservationsRecipient:]([VNCoreSceneUnderstandingDetectorImageFingerprintsConfiguration alloc], "initWithObservationsRecipient:", self);
    v14[0] = v8;
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v14, 1);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v9, CFSTR("VNCoreSceneUnderstandingDetectorProcessingOption_ImageFingerprintsConfigurations"));
...
LABEL_5:
  ...
  if (v10)
  {
    ...
    v8 = -[VNImageAnalyzerMultiDetectorAnalysisConfiguration initWithObservationsRecipient:]([VNImageAnalyzerMultiDetectorImageFingerprintsConfiguration alloc], "initWithObservationsRecipient:", self);
    objc_msgSend(v6, "setObject:forKeyedSubscript:", v8, CFSTR("VNImageAnalyzerMultiDetectorOption_ImageFingerprintsConfiguration"));
    goto LABEL_5;
  }
  return v6;
}
...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VNCreateImageFingerprintsRequest revisionAvailability]::ourRevisionAvailability;
}
