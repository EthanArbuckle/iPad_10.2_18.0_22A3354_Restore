...
- (VNRecognizedPoints3DSpecifier)initWithOriginatingRequestSpecifier:(id)a3 allRecognizedPoints:(id)a4
{
  id v7;
  id v8;
  VNRecognizedPoints3DSpecifier *v9;
  VNRecognizedPoints3DSpecifier *v10;
  uint64_t v11;
  ...
  v9 = -[VNRecognizedPoints3DSpecifier init](&v14, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)recognizedPointsForGroupKey:(id)a3 error:(id *)a4
{
  ...
  {
    -[VNRecognizedPoints3DSpecifier pointKeyGroupLabelsMapping](self, "pointKeyGroupLabelsMapping");
...
- (BOOL)isEqual:(id)a3
{
  VNRecognizedPoints3DSpecifier *v4;
  ...
  v4 = (VNRecognizedPoints3DSpecifier *)a3;
  if (self == v4)
  {
    v9 = 1;
  }
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[VNRecognizedPoints3DSpecifier originatingRequestSpecifier](v5, "originatingRequestSpecifier");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v5, "encodeObject:forKey:", self->_allRecognizedPoints, CFSTR("AllPoints3D"));
...
- (VNRecognizedPoints3DSpecifier)initWithCoder:(id)a3
{
  ...
  void *v9;
  void *v10;
  VNRecognizedPoints3DSpecifier *v11;
  void *v12;
  ...
  objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v9, CFSTR("AllPoints3D"));
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  if (v10)
  {
    self = -[VNRecognizedPoints3DSpecifier initWithOriginatingRequestSpecifier:allRecognizedPoints:](self, "initWithOriginatingRequestSpecifier:allRecognizedPoints:", v5, v10);
    v11 = self;
  }
  else
  {
...
- (id)recognizedPointForKey:(id)a3 error:(id *)a4
{
  ...
  {
    v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3940]), "initWithFormat:", CFSTR("unable to locate point '%@'"), v6);
