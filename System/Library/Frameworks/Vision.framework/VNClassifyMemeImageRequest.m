...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VNClassifyMemeImageRequest revisionAvailability]::ourRevisionAvailability;
}
...
LABEL_6:
  ...
  objc_msgSend(v6, "supportedIdentifiersWithOptions:error:", v7, a3);
...
- (id)applicableDetectorTypeForRevision:(unint64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 3)
  {
    v4 = CFSTR("VNMemeClassifierType");
    v5 = CFSTR("VNMemeClassifierType");
  }
  else if (a4)
  {
