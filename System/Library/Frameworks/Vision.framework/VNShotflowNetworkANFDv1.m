...
- (VNShotflowNetworkANFDv1)initWithModelPath:(id)a3 espressoEngineID:(int)a4 espressoDeviceID:(int)a5 espressoStorageType:(int)a6 threshold:(float)a7
{
  ...
  id v12;
  double v13;
  VNShotflowNetworkANFDv1 *v14;
  VNShotflowNetworkANFDv1 *v15;
  VNShotflowNetworkANFDv1 *v16;
  objc_super v18;
  ...
  *(float *)&v13 = a7;
  ...
  if (v14)
  {
    -[VNShotflowNetworkANFDv1 initializeBuffers](v14, "initializeBuffers");
    v16 = v15;
  }
...
- (void)initializeBuffers
{
  ...
  v22.receiver = self;
  v22.super_class = (Class)VNShotflowNetworkANFDv1;
...
- (int)setInputShape:(unint64_t)a3 height:(unint64_t)a4
{
  ...
  v4 = -[VNShotflowNetwork setInputShape:height:](&v11, sel_setInputShape_height_, a3, a4);
  if (!v4)
  {
    v6 = 0;
    v7 = 0;
    while (1)
    {
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("logits_roll_%ld"), v7);
      v8 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue());
      objc_msgSend(v8, "UTF8String");
      v4 = espresso_network_bind_buffer();
      if (v4)
        break;
      objc_msgSend(MEMORY[0x1E0CB3940], "stringWithFormat:", CFSTR("logits_yaw_%ld"), v7);
...
+ (id)modelName
{
  return CFSTR("6ziz6uinva_opt.espresso");
}
...
+ (const)ratios
{
  if (+[VNShotflowNetworkANFDv1 ratios]::onceToken != -1)
    dispatch_once(&+[VNShotflowNetworkANFDv1 ratios]::onceToken, &__block_literal_global_125);
...
+ (const)cellStartsX
{
  if (+[VNShotflowNetworkANFDv1 cellStartsX]::onceToken != -1)
    dispatch_once(&+[VNShotflowNetworkANFDv1 cellStartsX]::onceToken, &__block_literal_global_126);
...
+ (const)cellStartsY
{
  if (+[VNShotflowNetworkANFDv1 cellStartsY]::onceToken != -1)
    dispatch_once(&+[VNShotflowNetworkANFDv1 cellStartsY]::onceToken, &__block_literal_global_128);
...
+ (const)importantClasses
{
  if (+[VNShotflowNetworkANFDv1 importantClasses]::onceToken != -1)
    dispatch_once(&+[VNShotflowNetworkANFDv1 importantClasses]::onceToken, &__block_literal_global_130);
...
_QWORD *__43__VNShotflowNetworkANFDv1_importantClasses__block_invoke()
{
  _QWORD *v0;
  _QWORD *v1;
  _QWORD *result;
  ...
  *v1 = 1;
  ...
  v0[1] = result;
  v0[2] = result;
  +[VNShotflowNetworkANFDv1 importantClasses]::importantClasses = (uint64_t)v0;
  return result;
}

double __38__VNShotflowNetworkANFDv1_cellStartsY__block_invoke()
{
  _QWORD *v0;
  _QWORD *v1;
  double result;
  ...
  *v0 = 0;
  ...
  v0[2] = v1 + 3;
  result = 1879048450.0;
  *(_OWORD *)v1 = xmmword_1A15FA068;
  v1[2] = 0x432B800042D70000;
  *v0 = v1;
  +[VNShotflowNetworkANFDv1 cellStartsY]::cellStartsY = (uint64_t)v0;
  return result;
}

double __38__VNShotflowNetworkANFDv1_cellStartsX__block_invoke()
{
  _QWORD *v0;
  _QWORD *v1;
  double result;
  ...
  *v0 = 0;
  ...
  v0[2] = v1 + 3;
  result = 1879048450.0;
  *(_OWORD *)v1 = xmmword_1A15FA050;
  v1[2] = 0x433B800042F70000;
  *v0 = v1;
  +[VNShotflowNetworkANFDv1 cellStartsX]::cellStartsX = (uint64_t)v0;
  return result;
}

_DWORD *__33__VNShotflowNetworkANFDv1_ratios__block_invoke()
{
  _QWORD *v0;
  _DWORD *v1;
  _DWORD *result;
  ...
  *v1 = 1065353216;
  ...
  v0[1] = result;
  v0[2] = result;
  +[VNShotflowNetworkANFDv1 ratios]::ratios = (uint64_t)v0;
  return result;
}
