...
+ (id)privateRevisionsSet
{
  if (+[VNRecognizeFoodAndDrinkRequest privateRevisionsSet]::onceToken != -1)
    dispatch_once(&+[VNRecognizeFoodAndDrinkRequest privateRevisionsSet]::onceToken, &__block_literal_global_22406);
  return (id)+[VNRecognizeFoodAndDrinkRequest privateRevisionsSet]::ourPrivateRevisions;
}
...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  ...
  if (a3 - 3737841664u < 3)
    return off_1E4546C88[a3 - 3737841664u];
  v4.receiver = a1;
  v4.super_class = (Class)&OBJC_METACLASS___VNRecognizeFoodAndDrinkRequest;
...
- (id)supportedIdentifiersAndReturnError:(id *)a3
{
  ...
  if (v5)
  {
    ...
    {
      -[objc_class knownFoodAndDrinkIdentifiers](v6, "knownFoodAndDrinkIdentifiers");
...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VNRecognizeFoodAndDrinkRequest(Revisioning) revisionAvailability]::ourRevisionAvailability;
}
