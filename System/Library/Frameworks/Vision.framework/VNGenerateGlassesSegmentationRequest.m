...
{
  VNGenerateGlassesSegmentationRequest *v4;
  VNGenerateGlassesSegmentationRequest *v5;
  objc_super v6;

  v4 = (VNGenerateGlassesSegmentationRequest *)a3;
  if (self != v4)
  {
    v6.receiver = self;
    ...
    {
      v5 = v4;
      -[VNGenerateGlassesSegmentationRequest setQualityLevel:](self, "setQualityLevel:", -[VNGenerateGlassesSegmentationRequest qualityLevel](v5, "qualityLevel"));
...
- (id)applicableDetectorTypeForRevision:(unint64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 3737841664)
  {
    v7 = -[VNGenerateGlassesSegmentationRequest qualityLevel](self, "qualityLevel");
    if (v7 == 1)
    {
    ...
    if (v7)
    {
      ...
      {
LABEL_16:
        objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInteger:", -[VNGenerateGlassesSegmentationRequest qualityLevel](self, "qualityLevel"));
...
LABEL_17:
  ...
  else
  {
    ...
    v6 = -[VNGenerateGlassesSegmentationRequest qualityLevel](self, "qualityLevel");
    if (v6 == 1)
    {
...
- (BOOL)willAcceptCachedResultsFromRequestWithConfiguration:(id)a3
{
  ...
  v4 = a3;
  v5 = -[VNGenerateGlassesSegmentationRequest qualityLevel](self, "qualityLevel");
...
- (BOOL)internalPerformRevision:(unint64_t)a3 inContext:(id)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    ...
    v11 = -[VNGenerateGlassesSegmentationRequest newDefaultDetectorOptionsForRequestRevision:session:](self, "newDefaultDetectorOptionsForRequestRevision:session:", a3, v10);
    v21[0] = v9;
    objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v21, 1);
    v12 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v11, "setObject:forKeyedSubscript:", v12, CFSTR("VNDetectorProcessOption_InputImageBuffers"));

    v13 = -[VNGenerateGlassesSegmentationRequest qualityLevel](self, "qualityLevel");
    if (v13)
    {
      if (v13 == 1)
      {
...
{
  VNGenerateGlassesSegmentationRequest *v3;

  v3 = objc_alloc_init(VNGenerateGlassesSegmentationRequest);
  -[VNGenerateGlassesSegmentationRequest applyConfigurationOfRequest:](v3, "applyConfigurationOfRequest:", self);
  -[VNGenerateGlassesSegmentationRequest setQualityLevel:](v3, "setQualityLevel:", 1);
  return v3;
}
...
- (id)description
{
  ...
  v3[2](v3, -[VNGenerateGlassesSegmentationRequest qualityLevel](self, "qualityLevel"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
const __CFString *__51__VNGenerateGlassesSegmentationRequest_description__block_invoke(uint64_t a1)
{
  uint64_t v1;
  const __CFString *v2;
...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VNGenerateGlassesSegmentationRequest revisionAvailability]::revisionAvailability;
}

+ (id)privateRevisionsSet
{
  if (+[VNGenerateGlassesSegmentationRequest privateRevisionsSet]::onceToken != -1)
    dispatch_once(&+[VNGenerateGlassesSegmentationRequest privateRevisionsSet]::onceToken, &__block_literal_global_26468);
  return (id)+[VNGenerateGlassesSegmentationRequest privateRevisionsSet]::privateRevisions;
}
...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  ...
  if (a3 == 3737841664)
  {
    v5 = CFSTR("VNGenerateGlassesSegmentationRequestPrivateRevisionSemanticV6");
  }
  else
  {
    v8 = v3;
...
void __59__VNGenerateGlassesSegmentationRequest_privateRevisionsSet__block_invoke()
{
  ...
  v1 = (void *)+[VNGenerateGlassesSegmentationRequest privateRevisionsSet]::privateRevisions;
