...
+ (id)createNSErrorWithStatus:(int64_t)a3 andMessage:(id)a4
{
  ...
  objc_msgSend(v10, "localizedStringForKey:value:table:", v7, &stru_1E4549388, 0);
  ...
  objc_msgSend(v12, "localizedStringForKey:value:table:", v13, &stru_1E4549388, 0);
...
+ (id)createNSExceptionWithStatus:(int64_t)a3 andMessage:(id)a4
{
  ...
  objc_msgSend(MEMORY[0x1E0CB34D0], "mainBundle");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v10, "localizedStringForKey:value:table:", v9, &stru_1E4549388, 0);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  v19[0] = v11;
  ...
  objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", CVML_getStatusDescription(a3));
  v15 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v14, "localizedStringForKey:value:table:", v15, &stru_1E4549388, 0);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
