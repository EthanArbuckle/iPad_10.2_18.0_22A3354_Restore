...
+ (id)privateRevisionsSet
{
  if (+[VNRecognizeAnimalHeadsRequest privateRevisionsSet]::onceToken != -1)
    dispatch_once(&+[VNRecognizeAnimalHeadsRequest privateRevisionsSet]::onceToken, &__block_literal_global_17565);
  return (id)+[VNRecognizeAnimalHeadsRequest privateRevisionsSet]::ourPrivateRevisions;
}
...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  ...
  if (a3 == 3737841664)
    return CFSTR("VNRecognizeAnimalHeadsRequestPrivateRevisionANSTModel");
  if (a3 == 3737841665)
  {
    v5 = CFSTR("VNRecognizeAnimalHeadsRequestPrivateRevisionANODv5");
  }
  else
  {
    v8 = v3;
...
- (id)supportedIdentifiersAndReturnError:(id *)a3
{
  ...
  if (v5)
  {
    ...
    {
      -[objc_class knownAnimalHeadIdentifiers](v6, "knownAnimalHeadIdentifiers");
...
{
  return (const $FA132638BE9F3789EDBDEDD04080CB9E *)&+[VNRecognizeAnimalHeadsRequest(Revisioning) revisionAvailability]::ourRevisionAvailability;
}
