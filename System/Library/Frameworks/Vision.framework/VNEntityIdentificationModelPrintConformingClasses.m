@implementation VNEntityIdentificationModelPrintConformingClasses
...
void __VNEntityIdentificationModelPrintConformingClasses_block_invoke()
{
  ...
  v3 = (void *)VNEntityIdentificationModelPrintConformingClasses::ourEntityPrintClasses;
  VNEntityIdentificationModelPrintConformingClasses::ourEntityPrintClasses = v2;
...
void __VNEntityIdentificationModelPrintConformingClasses_block_invoke_2(uint64_t a1, Class aClass)
{
  ...
  if ((v5 & 1) != 0 && class_conformsToProtocol(aClass, (Protocol *)&unk_1EE657D20))
