...
- (BOOL)isEqual:(id)a3
{
  VNPersonsModelReadOptions *v4;
  VNPersonsModelReadOptions *v5;
  void *v6;
  void *v7;
  char v8;

  v4 = (VNPersonsModelReadOptions *)a3;
  if (v4 == self)
  {
    v8 = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      -[VNPersonsModelReadOptions acceptableVersions](self, "acceptableVersions");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[VNPersonsModelReadOptions acceptableVersions](v5, "acceptableVersions");
...
- (VNPersonsModelReadOptions)initWithCoder:(id)a3
{
  ...
  VNPersonsModelReadOptions *v8;

  v4 = a3;
  v5 = -[VNPersonsModelReadOptions init](self, "init");
  if (v5)
  {
