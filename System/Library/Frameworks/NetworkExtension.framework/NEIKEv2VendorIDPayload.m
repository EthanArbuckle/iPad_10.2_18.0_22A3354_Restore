...
- (id)descriptionWithIndent:(int)a3 options:(unint64_t)a4
{
  ...
  if (self)
    ...
    Property = 0;
  objc_msgSend(v7, "appendPrettyObject:withName:andIndent:options:", Property, CFSTR("Vendor Data"), v5, a4);
  return v7;
}

- (id)description
{
  return -[NEIKEv2VendorIDPayload descriptionWithIndent:options:](self, "descriptionWithIndent:options:", 0, 14);
}
...
LABEL_5:
    ...
    if (-[NEIKEv2VendorIDPayload hasRequiredFields](self, "hasRequiredFields"))
    {
  ...
  {
    *(_WORD *)v11 = 0;
    _os_log_error_impl(&dword_19BD16000, v10, OS_LOG_TYPE_ERROR, "Vendor ID payload missing required fields", v11, 2u);
  }
...
- (BOOL)parsePayloadData
{
  ...
  if (self && objc_getProperty(self, a2, 16, 1))
  {
    ...
    return -[NEIKEv2VendorIDPayload hasRequiredFields](self, "hasRequiredFields");
  }
  else
  {
    ne_log_obj();
