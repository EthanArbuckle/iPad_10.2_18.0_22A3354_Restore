...
{
  id v4;
  NEIKEv2StringAttribute *v5;
  const char *v6;
  NEIKEv2StringAttribute *v7;
  SEL v8;
  NEIKEv2StringAttribute *v9;
  NSObject *v11;
  uint8_t v12[16];
  objc_super v13;
  ...
  if (v5)
  {
    objc_setProperty_atomic(v5, v6, CFSTR("AssignedString"), 8);
...
- (id)initCustomWithAttributeType:(unint64_t)a3 attributeName:(id)a4 stringValue:(id)a5
{
  id v8;
  id v9;
  NEIKEv2StringAttribute *v10;
  const char *v11;
  NEIKEv2StringAttribute *v12;
  SEL v13;
  NEIKEv2StringAttribute *v14;
  NSObject *v16;
  __int16 v17[8];
  objc_super v18;
...
- (id)descriptionWithIndent:(int)a3 options:(unint64_t)a4
{
  ...
  -[NEIKEv2StringAttribute stringValue](self, "stringValue");
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "appendPrettyObject:withName:andIndent:options:", v11, CFSTR("Value"), v5, a4);
...
- (id)description
{
  return -[NEIKEv2StringAttribute descriptionWithIndent:options:](self, "descriptionWithIndent:options:", 0, 14);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[NEIKEv2StringAttribute attributeType](self, "attributeType");
  -[NEIKEv2ConfigurationAttribute attributeName](self, "attributeName");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[NEIKEv2StringAttribute stringValue](self, "stringValue");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  v8 = (void *)objc_msgSend(v7, "copy");
  v9 = (void *)objc_msgSend(v4, "initCustomWithAttributeType:attributeName:stringValue:", v5, v6, v8);
