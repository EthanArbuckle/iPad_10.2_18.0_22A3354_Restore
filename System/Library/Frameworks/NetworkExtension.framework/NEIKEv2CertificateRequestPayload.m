...
- (id)description
{
  return -[NEIKEv2CertificateRequestPayload descriptionWithIndent:options:](self, "descriptionWithIndent:options:", 0, 14);
}

- (BOOL)hasRequiredFields
{
  NEIKEv2CertificateRequestPayload *v2;
  id v3;
...
- (BOOL)generatePayloadData
{
  ...
  if (self)
  {
    if (objc_getProperty(self, a2, 16, 1))
      goto LABEL_7;
    if (-[NEIKEv2CertificateRequestPayload hasRequiredFields](self, "hasRequiredFields"))
    {
      encoding = self->_encoding;
...
LABEL_7:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_19BD16000, v12, OS_LOG_TYPE_ERROR, "Certificate Request payload missing required fields", buf, 2u);
  }
...
LABEL_11:
  ...
  if (objc_msgSend(objc_getProperty(self, v3, 16, 1), "length"))
  {
    ...
    return -[NEIKEv2CertificateRequestPayload hasRequiredFields](self, "hasRequiredFields");
  }
  ne_log_obj();
  v12 = objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
