@implementation NEIPSecDBAddSA

_OWORD *__NEIPSecDBAddSA_block_invoke(_QWORD *a1)
{
  ...
  *(_DWORD *)(*(_QWORD *)(a1[4] + 8) + 24) = v4;
  ...
  {
    v7 = MutableCopy;
    CFDictionaryAddValue(MutableCopy, CFSTR("Direction"), CFSTR("Out"));
    NEAddValueToIntKeyedDictionary(*(__CFDictionary **)(a1[6] + 80), *(_DWORD *)(*(_QWORD *)(a1[4] + 8) + 24), v7);
    CFRelease(v7);
  }
  result = NEIPSecDBCreateQueuedRequest(a1[6], 3, *(_DWORD *)(*(_QWORD *)(a1[4] + 8) + 24));
