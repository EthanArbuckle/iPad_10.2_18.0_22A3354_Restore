...
{
  CNChangeHistoryAddMemberToGroupEvent *v2;
  id v3;
...
- (CNChangeHistoryAddMemberToGroupEvent)initWithMember:(id)a3 group:(id)a4
{
  ...
  void *v9;
  void *v10;
  CNChangeHistoryAddMemberToGroupEvent *v11;
  CNChangeHistoryAddMemberToGroupEvent *v12;
  CNChangeHistoryAddMemberToGroupEvent *v13;
  objc_super v15;
...
LABEL_12:
  ...
  v11 = -[CNChangeHistoryAddMemberToGroupEvent init](&v15, sel_init);
  v12 = v11;
  if (v11)
  {
...
- (CNChangeHistoryAddMemberToGroupEvent)initWithCoder:(id)a3
{
  ...
  v7 = -[CNChangeHistoryAddMemberToGroupEvent initWithMember:group:](self, "initWithMember:group:", v5, v6);
  return v7;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v13;
  CNChangeHistoryAddMemberToGroupEvent *v14;
  id v15;
  _QWORD v16[5];
  id v17;
  ...
  v16[1] = 3221225472;
  v16[2] = __48__CNChangeHistoryAddMemberToGroupEvent_isEqual___block_invoke;
  v16[3] = &unk_1E29F7D70;
  v16[4] = self;
  v17 = v4;
  aBlock = v5;
  v11 = 3221225472;
  v12 = __48__CNChangeHistoryAddMemberToGroupEvent_isEqual___block_invoke_2;
  v13 = &unk_1E29F7D70;
  v14 = self;
  v15 = v17;
  v7 = v17;
...
- (id)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[CNChangeHistoryAddMemberToGroupEvent member](self, "member");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (id)objc_msgSend(v3, "appendName:object:", CFSTR("member"), v4);

  -[CNChangeHistoryAddMemberToGroupEvent group](self, "group");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)acceptEventVisitor:(id)a3
{
  ...
  -[CNSafeChangeHistoryEventVisitorWrapper visitAddMemberToGroupEvent:](v5, "visitAddMemberToGroupEvent:", self);
}
...
- (void)initWithMember:(void *)a1 group:.cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_0_4(&dword_18F8BD000, v3, v4, "parameter ‘member’ must be nonnull and of type %{public}@", v5, v6, v7, v8, v9);
