...
- (__CFArray)cn_copyPeopleInAddressBook:(void *)a3 fetchRequest:(id)a4 matchInfos:(id *)a5 environment:(id)a6 error:(__CFError *)a7
{
  ...
  v8 = a4;
  objc_msgSend(v7, "predicateForContactsMissingBackgroundColors");
...
{
  return (id)objc_msgSend(MEMORY[0x1E0CF5D88], "predicateForContactsMissingBackgroundColors", a3, a4, a5);
}
