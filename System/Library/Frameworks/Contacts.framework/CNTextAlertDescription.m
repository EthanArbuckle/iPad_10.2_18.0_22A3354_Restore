...
{
  objc_msgSend(a3, "encodeObject:forKey:", *((_QWORD *)a4 + 64), CFSTR("_textAlert"));
}

- (void)setCNValue:(id)a3 onContact:(id)a4
{
  objc_msgSend(a4, "_setTextAlert:", a3);
}

- (id)CNValueForContact:(id)a3
{
  return (id)objc_msgSend(a3, "textAlert");
}
...
{
  return -[CNPropertyDescription initWithKey:readSelector:writeSelector:](self, "initWithKey:readSelector:writeSelector:", CFSTR("textAlert"), sel_textAlert, sel_setTextAlert_);
}
...
- (void)decodeUsingCoder:(id)a3 contact:(id)a4
{
  ...
  v5 = a4;
  v6 = a3;
  objc_msgSend(v6, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("_textAlert"));
...
- (void)ABValueForABPerson:(void *)a3
{
  ...
  v4 = (const void *)MEMORY[0x194005BF8](a3, 4294967294);
  if (v4)
    v5 = (const __CFString *)CFAutorelease(v4);
  else
    v5 = 0;
  v6 = (const void *)MEMORY[0x194005BF8](a3, 4294967194);
  if (v6)
    v7 = (const __CFString *)CFAutorelease(v6);
  else
    v7 = 0;
  v8 = (const void *)MEMORY[0x194005BF8](a3, 4294967291);
  if (v8)
