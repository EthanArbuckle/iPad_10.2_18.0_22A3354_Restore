...
{
  CNChangeHistoryRemoveSubgroupFromGroupEvent *v2;
  id v3;
...
- (CNChangeHistoryRemoveSubgroupFromGroupEvent)initWithSubgroup:(id)a3 group:(id)a4
{
  ...
  void *v9;
  void *v10;
  CNChangeHistoryRemoveSubgroupFromGroupEvent *v11;
  CNChangeHistoryRemoveSubgroupFromGroupEvent *v12;
  CNChangeHistoryRemoveSubgroupFromGroupEvent *v13;
  objc_super v15;
...
LABEL_12:
  ...
  v11 = -[CNChangeHistoryRemoveSubgroupFromGroupEvent init](&v15, sel_init);
  v12 = v11;
  if (v11)
  {
...
- (CNChangeHistoryRemoveSubgroupFromGroupEvent)initWithCoder:(id)a3
{
  ...
  v7 = -[CNChangeHistoryRemoveSubgroupFromGroupEvent initWithSubgroup:group:](self, "initWithSubgroup:group:", v5, v6);
  return v7;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v13;
  CNChangeHistoryRemoveSubgroupFromGroupEvent *v14;
  id v15;
  _QWORD v16[5];
  id v17;
  ...
  v16[1] = 3221225472;
  v16[2] = __55__CNChangeHistoryRemoveSubgroupFromGroupEvent_isEqual___block_invoke;
  v16[3] = &unk_1E29F7D70;
  v16[4] = self;
  v17 = v4;
  aBlock = v5;
  v11 = 3221225472;
  v12 = __55__CNChangeHistoryRemoveSubgroupFromGroupEvent_isEqual___block_invoke_2;
  v13 = &unk_1E29F7D70;
  v14 = self;
  v15 = v17;
  v7 = v17;
...
- (id)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[CNChangeHistoryRemoveSubgroupFromGroupEvent subgroup](self, "subgroup");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (id)objc_msgSend(v3, "appendName:object:", CFSTR("subgroup"), v4);

  -[CNChangeHistoryRemoveSubgroupFromGroupEvent group](self, "group");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)acceptEventVisitor:(id)a3
{
  ...
  -[CNSafeChangeHistoryEventVisitorWrapper visitRemoveSubgroupFromGroupEvent:](v5, "visitRemoveSubgroupFromGroupEvent:", self);
}
