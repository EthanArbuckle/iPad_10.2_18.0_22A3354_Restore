...
{
  CNChangeHistoryPreferredContactForImageEvent *v2;
  id v3;
...
- (CNChangeHistoryPreferredContactForImageEvent)initWithPreferredContact:(id)a3 unifiedContact:(id)a4
{
  ...
  void *v9;
  void *v10;
  CNChangeHistoryPreferredContactForImageEvent *v11;
  CNChangeHistoryPreferredContactForImageEvent *v12;
  CNChangeHistoryPreferredContactForImageEvent *v13;
  objc_super v15;
...
LABEL_12:
  ...
  v11 = -[CNChangeHistoryPreferredContactForImageEvent init](&v15, sel_init);
  v12 = v11;
  if (v11)
  {
...
- (CNChangeHistoryPreferredContactForImageEvent)initWithCoder:(id)a3
{
  ...
  v7 = -[CNChangeHistoryPreferredContactForImageEvent initWithPreferredContact:unifiedContact:](self, "initWithPreferredContact:unifiedContact:", v5, v6);
  return v7;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v13;
  CNChangeHistoryPreferredContactForImageEvent *v14;
  id v15;
  _QWORD v16[5];
  id v17;
  ...
  v16[1] = 3221225472;
  v16[2] = __56__CNChangeHistoryPreferredContactForImageEvent_isEqual___block_invoke;
  v16[3] = &unk_1E29F7D70;
  v16[4] = self;
  v17 = v4;
  aBlock = v5;
  v11 = 3221225472;
  v12 = __56__CNChangeHistoryPreferredContactForImageEvent_isEqual___block_invoke_2;
  v13 = &unk_1E29F7D70;
  v14 = self;
  v15 = v17;
  v7 = v17;
...
- (id)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  -[CNChangeHistoryPreferredContactForImageEvent preferredContact](self, "preferredContact");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = (id)objc_msgSend(v3, "appendName:object:", CFSTR("preferredContact"), v4);

  -[CNChangeHistoryPreferredContactForImageEvent unifiedContact](self, "unifiedContact");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)acceptEventVisitor:(id)a3
{
  ...
  -[CNSafeChangeHistoryEventVisitorWrapper visitPreferredContactForImageEvent:](v5, "visitPreferredContactForImageEvent:", self);
}
