...
- (SLYahooWebClient)initWithCoder:(id)a3
{
  ...
  return -[SLYahooWebClient init](&v4, sel_init, a3);
}
...
- (NSString)clientID
{
  return (NSString *)CFSTR("dj0yJmk9blBKcUh4SVNnZWFCJmQ9WVdrOVdEWk5XRlkyTXpBbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD1iMQ--");
}
...
- (NSString)clientSecret
{
  ...
  v2 = objc_msgSend(CFSTR("1ff1e68bef:b72224e516b1480b95f14f8e6:b44"), "length");
  MEMORY[0x1E0C80A78]();
  v4 = (char *)v9 - v3;
  v5 = objc_msgSend(CFSTR("1ff1e68bef:b72224e516b1480b95f14f8e6:b44"), "UTF8String");
  if (v2 < 1)
  {
    v7 = 0;
  }
...
- (NSString)tokenURL
{
  return (NSString *)CFSTR("https://api.login.yahoo.com/oauth2/get_token");
}

- (NSString)authRequestURL
{
  return (NSString *)CFSTR("https://api.login.yahoo.com/oauth2/request_auth");
}

- (NSString)userInfoURL
{
  return (NSString *)CFSTR("https://api.login.yahoo.com/openid/v1/userinfo?scope=openid%20sdpp-w");
}
