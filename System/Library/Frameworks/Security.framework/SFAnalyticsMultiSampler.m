...
- (SFAnalyticsMultiSampler)initWithName:(id)a3 interval:(double)a4 block:(id)a5 clientClass:(Class)a6
{
  id v11;
  id v12;
  SFAnalyticsMultiSampler *v13;
  NSObject *v14;
  NSObject *v15;
  SFAnalyticsMultiSampler *v16;
  void *v17;
  id block;
  objc_super v20;
  uint8_t buf[4];
...
void __36__SFAnalyticsMultiSampler_sampleNow__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  objc_msgSend(v8, "logMetric:withName:oncePerReport:", v6, v7, *(unsigned __int8 *)(*(_QWORD *)(a1 + 32) + 56));
...
void __45__SFAnalyticsMultiSampler_setupPeriodicTimer__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    v4[3] = &unk_1E1FCC130;
    v4[4] = v2;
    -[NSObject enumerateKeysAndObjectsUsingBlock:](v3, "enumerateKeysAndObjectsUsingBlock:", v4);
  }
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_18A900000, v3, OS_LOG_TYPE_DEFAULT, "sampler went away before we could run its once-per-report block", buf, 2u);
    }
  }
...
void __41__SFAnalyticsMultiSampler_setupOnceTimer__block_invoke(uint64_t a1, int a2)
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_18A900000, v6, OS_LOG_TYPE_DEFAULT, "sampler went away before we could run its once-per-report block", buf, 2u);
    }
