...
void __CFDictionaryCopySuperCompactDescription_block_invoke(uint64_t a1, const __CFString *a2, const __CFString *cf)
{
  ...
  {
    MutableCopy = CFStringCreateMutableCopy((CFAllocatorRef)*MEMORY[0x1E0C9AE00], 0, CFSTR("0x"));
  ...
  if (v12 != CFStringGetTypeID())
  {
    ...
    if (v16 == CFNumberGetTypeID())
    {
      ...
      Copy = CFStringCreateWithFormat((CFAllocatorRef)*MEMORY[0x1E0C9AE00], 0, CFSTR("%@"), cf);
      goto LABEL_14;
    }
LABEL_12:
    MutableCopy = 0;
  ...
  if (v13 > 5)
  {
    v21.location = 0;
    v21.length = 6;
    Copy = CFStringCreateWithSubstring((CFAllocatorRef)*MEMORY[0x1E0C9AE00], cf, v21);
  }
  else
  {
    Copy = CFStringCreateCopy((CFAllocatorRef)*MEMORY[0x1E0C9AE00], cf);
  }
LABEL_14:
  v17 = Copy;
