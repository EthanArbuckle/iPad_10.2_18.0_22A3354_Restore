...
- (id)description
{
  ...
  -[SECSFAActionAutomaticBugCapture description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[SECSFAActionAutomaticBugCapture dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (BOOL)isEqual:(id)a3
{
    ...
    && ((type = self->_type, !((unint64_t)type | v4[3])) || -[NSString isEqual:](type, "isEqual:")))
  {
    ...
    if ((unint64_t)subtype | v4[2])
      v8 = -[NSString isEqual:](subtype, "isEqual:");
    else
      v8 = 1;
  }
  else
