...
void *__CGImageCreateWithPNGDataProvider_block_invoke_3(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  CGImageCreateWithPNGDataProvider_f_8 = (uint64_t (*)(_QWORD, _QWORD, _QWORD))result;
  return result;
}

uint64_t (*__CGImageCreateWithPNGDataProvider_block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8))(_QWORD)
{
...
void *__CGImageCreateWithPNGDataProvider_block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  CGImageCreateWithPNGDataProvider_f = (uint64_t (*)(_QWORD, _QWORD))result;
  return result;
}
