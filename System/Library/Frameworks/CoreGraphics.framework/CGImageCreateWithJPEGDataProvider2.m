...
void *__CGImageCreateWithJPEGDataProvider2_block_invoke_3(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  CGImageCreateWithJPEGDataProvider2_f_83 = (uint64_t (*)(_QWORD, _QWORD, _QWORD))result;
  return result;
}

uint64_t (*__CGImageCreateWithJPEGDataProvider2_block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8))(_QWORD)
{
  ...
  CGImageCreateWithJPEGDataProvider2_f_76 = result;
  return result;
}
...
void *__CGImageCreateWithJPEGDataProvider2_block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  CGImageCreateWithJPEGDataProvider2_f = (uint64_t (*)(_QWORD, _QWORD))result;
  return result;
}
