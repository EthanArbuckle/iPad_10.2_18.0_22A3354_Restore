...
uint64_t (*__CGPDFNodeCreateImageData_block_invoke_3(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8))(_QWORD)
{
  ...
  CGPDFNodeCreateImageData_f_33 = result;
  return result;
}
...
void *__CGPDFNodeCreateImageData_block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  CGPDFNodeCreateImageData_f_28 = (uint64_t (*)(_QWORD, _QWORD, _QWORD))result;
  return result;
}
...
void *__CGPDFNodeCreateImageData_block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  CGPDFNodeCreateImageData_f = (uint64_t (*)(_QWORD, _QWORD, _QWORD, _QWORD))result;
  return result;
}
