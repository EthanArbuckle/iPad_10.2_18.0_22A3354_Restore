...
void __CGCMSUtilsCreateLinearDisplayP3Profile_block_invoke()
{
  ...
  if (_block_invoke_4_cglibrarypredicate != -1)
    dispatch_once(&_block_invoke_4_cglibrarypredicate, &__block_literal_global_190);
  v0 = (uint64_t (*)(uint64_t))_block_invoke_4_f;
  if (_block_invoke_4_cglibrarypredicate_191 != -1)
    dispatch_once(&_block_invoke_4_cglibrarypredicate_191, &__block_literal_global_193);
  ...
  if (v1)
  {
    ...
    *(_OWORD *)keys = xmmword_1E16314C8;
    ...
    if (_block_invoke_4_cglibrarypredicate_197 != -1)
      dispatch_once(&_block_invoke_4_cglibrarypredicate_197, &__block_literal_global_199);
    v4 = (const void *)_block_invoke_4_f_196(v2, CFSTR("rXYZ"));
    if (_block_invoke_4_cglibrarypredicate_201 != -1)
      dispatch_once(&_block_invoke_4_cglibrarypredicate_201, &__block_literal_global_203);
    v5 = (const void *)_block_invoke_4_f_200(v2, CFSTR("gXYZ"));
    if (_block_invoke_4_cglibrarypredicate_205 != -1)
      dispatch_once(&_block_invoke_4_cglibrarypredicate_205, &__block_literal_global_207);
    v6 = (const void *)_block_invoke_4_f_204(v2, CFSTR("bXYZ"));
    v57 = 0u;
    v58 = 0u;
    v56[0] = CFNumberCreate(0, kCFNumberSInt16Type, &_block_invoke_4_iccDate);
    v56[1] = CFNumberCreate(0, kCFNumberSInt16Type, &unk_184F0C74E);
    v56[2] = CFNumberCreate(0, kCFNumberSInt16Type, &unk_184F0C750);
    v56[3] = CFNumberCreate(0, kCFNumberSInt16Type, &unk_184F0C752);
    v56[4] = CFNumberCreate(0, kCFNumberSInt16Type, &unk_184F0C754);
    v56[5] = CFNumberCreate(0, kCFNumberSInt16Type, &unk_184F0C756);
    ...
    *(_QWORD *)bytes = CFSTR("displayRGB");
    ...
    if (_block_invoke_4_cglibrarypredicate_211 != -1)
      dispatch_once(&_block_invoke_4_cglibrarypredicate_211, &__block_literal_global_213);
    CGCMSUtilsCreateLinearDisplayP3Profile_linear_profile = _block_invoke_4_f_210(v13);
    if (v3)
      CFRelease(v3);
    if (v7)
      CFRelease(v7);
