...
- (id)headerTitle
{
  ...
  objc_msgSend(v2, "localizedStringForKey:value:table:", CFSTR("All Invitees Can Attend"), &stru_1E601DFA8, 0);
...
- (id)searcherTimeSlots
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "timesWhenAllAttendeesCanAttend");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)searchingForMoreTimes
{
  ...
  -[EKUIInviteesViewAlternativeTimeSection availabilitySearcher](self, "availabilitySearcher");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = objc_msgSend(v2, "searchingForMoreTimesWhenAllAttendeesCanAttend");
...
- (void)searchForMoreTimes
{
  ...
  objc_msgSend(v2, "searchForMoreTimesWhenAllAttendeesCanAttend");
