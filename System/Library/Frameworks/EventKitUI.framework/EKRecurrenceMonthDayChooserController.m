...
{
  EKRecurrenceMonthDayChooserController *v3;
  uint64_t v4;
...
- (void)updateRecurrenceRuleBuilder:(id)a3
{
  ...
  v4 = a3;
  -[EKRecurrenceMonthDayChooserController daysOfTheMonth](self, "daysOfTheMonth");
...
- (void)updateFromRecurrenceRule:(id)a3
{
  ...
  if (v4)
  {
    ...
    -[EKRecurrenceMonthDayChooserController setDaysOfTheMonth:](self, "setDaysOfTheMonth:", v5);

    -[EKRecurrenceMonthDayChooserController refreshCells](self, "refreshCells");
  }
...
- (void)prepareForDisplay
{
  ...
  {
    -[EKRecurrenceChooserController startDateComponents:](self, "startDateComponents:", 16);
    v3 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)selectCell:(id)a3 atIndex:(int64_t)a4
{
  ...
  if (-[NSMutableSet count](self->_daysOfTheMonthSet, "count") != 1 || (objc_msgSend(v6, "selected") & 1) == 0)
  {
    ...
    if (objc_msgSend(v6, "selected")
      && -[EKRecurrenceMonthDayChooserController prohibitsMultipleDaysInMonthlyRecurrence](self, "prohibitsMultipleDaysInMonthlyRecurrence"))
    {
      v11[0] = v7;
      objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v11, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      -[EKRecurrenceMonthDayChooserController setDaysOfTheMonth:](self, "setDaysOfTheMonth:", v8);
