...
{
  return CFSTR("SKLinearGravityFieldNode");
}
...
{
  SKLinearGravityFieldNode *v2;
  SKLinearGravityFieldNode *v3;
  objc_super v5;
  ...
  v3 = v2;
  if (v2)
    -[SKLinearGravityFieldNode _initialize](v2, "_initialize");
  return v3;
}
...
- (SKLinearGravityFieldNode)initWithCoder:(id)a3
{
  ...
  if (v6)
    -[SKLinearGravityFieldNode _initialize](v6, "_initialize");
