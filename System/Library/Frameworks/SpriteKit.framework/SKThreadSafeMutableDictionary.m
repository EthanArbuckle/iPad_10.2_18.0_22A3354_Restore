...
{
  id v4;
  SKThreadSafeMutableDictionary *v5;
  SKThreadSafeMutableDictionary *v6;
  uint64_t v7;
  ...
  v5 = -[SKThreadSafeMutableDictionary init](&v10, sel_init);
  v6 = v5;
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSMutableDictionary copyWithZone:](self->_storage, "copyWithZone:", a3);
  v7 = *(void **)(v5 + 72);
  *(_QWORD *)(v5 + 72) = v6;
...
- (void)forwardInvocation:(id)a3
{
  ...
  else
  {
    ...
    -[SKThreadSafeMutableDictionary forwardInvocation:](&v5, sel_forwardInvocation_, v4);
  }
...
- (id)methodSignatureForSelector:(SEL)a3
{
  ...
  -[SKThreadSafeMutableDictionary methodSignatureForSelector:](&v7, sel_methodSignatureForSelector_);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v5)
  {
    -[NSMutableDictionary methodSignatureForSelector:](self->_storage, "methodSignatureForSelector:", a3);
    v5 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v5;
}
...
- (id)description
{
  return (id)-[NSMutableDictionary description](self->_storage, "description");
}
