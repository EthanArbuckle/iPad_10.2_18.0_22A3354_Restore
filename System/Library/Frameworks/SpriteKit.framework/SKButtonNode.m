...
- (SKButtonNode)init
{
  ...
  v2 = -[SKLabelNode init](&v12, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (SKButtonNode)initWithCoder:(id)a3
{
  ...
  v5 = -[SKLabelNode initWithCoder:](&v10, sel_initWithCoder_, v4);
  v6 = v5;
  if (v5)
  {
    ...
    -[SKButtonNode setDownAction:](v6, "setDownAction:", v7);

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("_upAction"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKButtonNode setUpAction:](v6, "setUpAction:", v8);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[SKLabelNode encodeWithCoder:](&v5, sel_encodeWithCoder_, v4);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKButtonNode touchBegan:location:](self, "touchBegan:location:", objc_msgSend(v12, "hash"), v15, v14);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKButtonNode touchEnded:location:](self, "touchEnded:location:", objc_msgSend(v12, "hash"), v15, v14);
...
- (void)touchBegan:(unint64_t)a3 location:(CGPoint)a4
{
  ...
  id WeakRetained;
  id v7;
  void (**downBlock)(id, SKButtonNode *);
  ...
  if (!touches)
  {
    ...
    downBlock = (void (**)(id, SKButtonNode *))self->_downBlock;
    if (downBlock)
...
- (void)touchEnded:(unint64_t)a3 location:(CGPoint)a4
{
  ...
  SKAction *upAction;
  void *v10;
  void (**upBlock)(id, SKButtonNode *);
  id WeakRetained;
  id v13;
  void (**upInsideBlock)(id, SKButtonNode *);
  ...
  if ((touches < 0) ^ v5 | (touches == 0))
  {
    ...
    upBlock = (void (**)(id, SKButtonNode *))self->_upBlock;
    if (upBlock)
    ...
    if (-[SKNode containsPoint:](self, "containsPoint:", x, y))
    {
      ...
      upInsideBlock = (void (**)(id, SKButtonNode *))self->_upInsideBlock;
      if (upInsideBlock)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = -[SKLabelNode copyWithZone:](&v7, sel_copyWithZone_, a3);
...
{
  return (SKButtonNodeDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
