...
- (SKNoiseFieldNode)init
{
  ...
  v3 = v2;
  if (v2)
    -[SKNoiseFieldNode _initialize](v2, "_initialize");
  return v3;
}
...
- (float)smoothness
{
  ...
  -[PKPhysicsField smoothness](self->super._field, "smoothness");
  return result;
}

- (void)setSmoothness:(float)a3
{
  -[PKPhysicsField setSmoothness:](self->super._field, "setSmoothness:");
}
...
- (float)animationSpeed
{
  ...
  -[PKPhysicsField animationSpeed](self->super._field, "animationSpeed");
  return result;
}

- (void)setAnimationSpeed:(float)a3
{
  -[PKPhysicsField setAnimationSpeed:](self->super._field, "setAnimationSpeed:");
}
...
- (SKNoiseFieldNode)initWithCoder:(id)a3
{
  ...
  if (v6)
    -[SKNoiseFieldNode _initialize](v6, "_initialize");
