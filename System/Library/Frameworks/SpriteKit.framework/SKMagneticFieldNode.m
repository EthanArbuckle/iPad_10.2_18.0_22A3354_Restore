...
{
  return CFSTR("SKMagneticFieldNode");
}
...
{
  SKMagneticFieldNode *v2;
  SKMagneticFieldNode *v3;
  objc_super v5;
  ...
  v3 = v2;
  if (v2)
    -[SKMagneticFieldNode _initialize](v2, "_initialize");
  return v3;
}
...
- (SKMagneticFieldNode)initWithCoder:(id)a3
{
  ...
  if (v6)
    -[SKMagneticFieldNode _initialize](v6, "_initialize");
