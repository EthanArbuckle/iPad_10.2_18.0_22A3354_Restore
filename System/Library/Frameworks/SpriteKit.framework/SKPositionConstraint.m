...
- (SKPositionConstraint)initWithXRange:(id)a3 YRange:(id)a4
{
  id v6;
  id v7;
  SKPositionConstraint *v8;
  SKPositionConstraint *v9;
  objc_super v11;
  ...
  if (v8)
  {
    -[SKPositionConstraint setXRange:](v8, "setXRange:", v6);
    -[SKPositionConstraint setYRange:](v9, "setYRange:", v7);
  }
...
- (SKPositionConstraint)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    -[SKPositionConstraint setXRange:](v5, "setXRange:", v6);

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("_yRange"));
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKPositionConstraint setYRange:](v5, "setYRange:", v7);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[SKPositionConstraint xRange](self, "xRange");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("_xRange"));

  -[SKPositionConstraint yRange](self, "yRange");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)isEqualToPositionConstraint:(id)a3
{
  ...
  else
  {
    -[SKPositionConstraint xRange](self, "xRange");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[SKPositionConstraint xRange](v4, "xRange");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    ...
    if ((v7 & 1) != 0)
    {
      ...
      -[SKPositionConstraint yRange](v4, "yRange");
