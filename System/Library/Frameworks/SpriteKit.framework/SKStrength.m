...
- (SKStrength)init
{
  ...
  SKCStrength *v3;
  SKCAction *v4;
  SKCStrength *mycaction;
  objc_super v7;
  objc_super v8;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)SKStrength;
  v2 = -[SKAction init](&v9, sel_init);
  if (v2)
  {
    v3 = (SKCStrength *)operator new();
    v8.receiver = v2;
    v8.super_class = (Class)SKStrength;
    v4 = -[SKAction caction](&v8, sel_caction);
    SKCStrength::SKCStrength(v3, v4);
    v2->_mycaction = v3;
    v7.receiver = v2;
...
- (SKStrength)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)SKStrength;
  v5 = -[SKAction initWithCoder:](&v21, sel_initWithCoder_, v4);
  if (v5)
  {
    v6 = (SKCStrength *)operator new();
    v20.receiver = v5;
    v20.super_class = (Class)SKStrength;
    v7 = -[SKAction caction](&v20, sel_caction);
    SKCStrength::SKCStrength(v6, v7);
    v5->_mycaction = v6;
    v19.receiver = v5;
    v19.super_class = (Class)SKStrength;
    -[SKAction setCppAction:](&v19, sel_setCppAction_, v6);
    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("_strengthTarget"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v8, "doubleValue");
    *(float *)&v9 = v9;
    v5->_mycaction->var19 = *(float *)&v9;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("_strengthTargetReversed"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v10, "doubleValue");
    *(float *)&v11 = v11;
    v5->_mycaction->var20 = *(float *)&v11;

    objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(), CFSTR("_deltastrength"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("_strengthTarget"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_mycaction->var20);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v6, CFSTR("_strengthTargetReversed"));

  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", self->_mycaction->var23);
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v7, CFSTR("_deltastrength"));
