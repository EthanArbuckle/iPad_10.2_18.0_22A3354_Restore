...
uint64_t ___CFXPCCreateCFObjectFromXPCObject_block_invoke_2(_QWORD *a1, const char *a2, uint64_t a3)
{
  uint64_t result;
  const void *v6;
  CFStringRef v7;
  ...
  if (result)
  {
    ...
    v7 = CFStringCreateWithCString((CFAllocatorRef)&__kCFAllocatorSystemDefault, a2, 0x8000100u);
    if (v7)
    {
