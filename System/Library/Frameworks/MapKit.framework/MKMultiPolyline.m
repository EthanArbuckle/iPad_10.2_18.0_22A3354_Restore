...
- (id)_initWithGeoJSONObject:(id)a3 error:(id *)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    if (a4)
    {
      v19 = CFSTR("MultiLineString object must be a dictionary");
LABEL_17:
...
LABEL_18:
  ...
  if (v8 != 4)
  {
    if (a4)
    {
      v19 = CFSTR("Input is not a MultiLineString GeoJSON object");
      goto LABEL_17;
    }
    goto LABEL_18;
  }
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (v12)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          v16 = -[MKPolyline _initWithGeoJSONPoints:error:]([MKPolyline alloc], "_initWithGeoJSONPoints:error:", *(_QWORD *)(*((_QWORD *)&v22 + 1) + 8 * v15), a4);
          if (!v16)
          {
    ...
    self = -[MKMultiPolyline initWithPolylines:](self, "initWithPolylines:", v10);
    v18 = self;
LABEL_22:
  ...
  {
    _errorWithReason(CFSTR("MultiLineString coordinates must be an array"));
    v18 = 0;
    *a4 = (id)objc_claimAutoreleasedReturnValue();
  }
  else
...
- (MKMultiPolyline)initWithPolylines:(NSArray *)polylines
{
  ...
  v5 = -[MKMultiPolyline init](&v14, sel_init);
  if (v5)
  {
    ...
    -[MKMultiPolyline _boundingMapRectForPolylines:](v5, "_boundingMapRectForPolylines:", v5->_polylines);
...
{
  return -[MKMultiPolyline initWithPolylines:](self, "initWithPolylines:", MEMORY[0x1E0C9AA60]);
}
...
- (MKMultiPolyline)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v8, CFSTR("MKMultiPolylinePolylines"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", self->_polylines, CFSTR("MKMultiPolylinePolylines"), v5.receiver, v5.super_class);
