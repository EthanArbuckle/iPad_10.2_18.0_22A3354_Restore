...
- (_GCMotionEventHIDAdapter)initWithSource:(id)a3 service:(id)a4
{
  ...
  v9 = -[_GCMotionEventHIDAdapter init](&v19, sel_init);
  if (v9)
  {
...
{
  -[_GCMotionEventHIDAdapter doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
...
- (void)dealloc
{
  ...
  -[_GCMotionEventHIDAdapter dealloc](&v5, sel_dealloc);
}
...
- (id)observeMotionEvents:(id)a3
{
  ...
  -[_GCMotionEventHIDAdapter observers](self, "observers");
  ...
  if ((v7 & 1) == 0)
  {
    do
    {
      ...
      -[_GCMotionEventHIDAdapter setObservers:](self, "setObservers:", v9);
      -[_GCMotionEventHIDAdapter observers](self, "observers");
