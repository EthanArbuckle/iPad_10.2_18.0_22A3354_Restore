...
- (_GCGamepadEventGamepadHIDAdapter)initWithSource:(id)a3 service:(id)a4
{
  id v7;
  id v8;
  _GCGamepadEventGamepadHIDAdapter *v9;
  void *v10;
  uint64_t v11;
  void *v12;
  uint64_t v13;
  ...
  v9 = -[_GCGamepadEventGamepadHIDAdapter init](&v19, sel_init);
  if (v9)
  {
...
{
  -[_GCGamepadEventGamepadHIDAdapter doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
...
- (void)dealloc
{
  ...
  -[_GCGamepadEventGamepadHIDAdapter dealloc](&v5, sel_dealloc);
}
...
- (id)observeGamepadEvents:(id)a3
{
  ...
  -[_GCGamepadEventGamepadHIDAdapter observers](self, "observers");
  ...
  if ((v7 & 1) == 0)
  {
    do
    {
      ...
      -[_GCGamepadEventGamepadHIDAdapter setObservers:](self, "setObservers:", v9);
      -[_GCGamepadEventGamepadHIDAdapter observers](self, "observers");
