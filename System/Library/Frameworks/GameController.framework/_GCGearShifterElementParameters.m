...
{
  _GCGearShifterElementParameters *result;
  objc_super v3;

  v3.receiver = self;
  v3.super_class = (Class)_GCGearShifterElementParameters;
  result = -[_GCGearShifterElementParameters init](&v3, sel_init);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *((_BYTE *)v4 + 40) = self->_patternShifter;
  *((_OWORD *)v4 + 4) = self->_positionRange;
  v4[7] = (id)self->_eventShifterValueField;
  return v4;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = -[_GCDevicePhysicalInputElementParameters isEqual:](&v9, sel_isEqual_, v4)
    ...
    && ((NSSet *)self->_positionRange.location == v4[8] ? (v6 = self->_positionRange.length == (_QWORD)v4[9]) : (v6 = 0),
        v6)
    && self->_eventShifterValueField == (_QWORD)v4[7];
