...
- (_GCMotionEventHIDAdapterDescription)initWithSource:(id)a3 service:(id)a4
{
  id v7;
  id v8;
  _GCMotionEventHIDAdapterDescription *v9;
  _GCMotionEventHIDAdapterDescription *v10;
  objc_super v12;
  ...
  v9 = -[_GCMotionEventHIDAdapterDescription init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  -[_GCMotionEventHIDAdapterDescription doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
  return self;
}
...
- (_GCMotionEventHIDAdapterDescription)initWithCoder:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)_GCMotionEventHIDAdapterDescription;
  v5 = -[_GCMotionEventHIDAdapterDescription init](&v12, sel_init);
  if (v5)
  {
...
{
  id v4;
  _GCMotionEventHIDAdapter *materializedObject;
  _GCMotionEventHIDAdapter *v6;
  uint64_t v7;
  void *v8;
  uint64_t v9;
  void *v10;
  _GCMotionEventHIDAdapter *v12;
  _GCMotionEventHIDAdapter *v13;
...
LABEL_7:
  ...
  v12 = -[_GCMotionEventHIDAdapter initWithSource:service:]([_GCMotionEventHIDAdapter alloc], "initWithSource:service:", v8, v9);
