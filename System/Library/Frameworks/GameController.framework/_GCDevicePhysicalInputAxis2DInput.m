...
{
  -[_GCDevicePhysicalInputAxis2DInput doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
  return self;
}
...
{
  _QWORD *v4;
  _GCDevicePhysicalInputAxis2DInput *v5;
  _GCDevicePhysicalInputAxis2DInput *v6;
  uint64_t v7;
  uint64_t v8;
  objc_super v10;
...
- (uint64_t)_setSources:(uint64_t)result
{
  ...
  if (result)
  {
    ...
    if (!a2)
    {
      ...
      objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", sel__setSources_, v3, CFSTR("_GCDevicePhysicalInputAxis2DInput.m"), 181, CFSTR("Invalid parameter not satisfying: %s"), "newValue != nil");
...
- (_GCDevicePhysicalInputAxis2DInput)initWithTemplate:(id)a3 context:(id)a4
{
  id v5;
  _QWORD *v6;
  _GCDevicePhysicalInputAxis2DInput *v7;
  uint64_t v8;
  objc_super v10;
...
- (BOOL)update:(void *)a3 forUsages:(unint64_t)a4 with:(id)a5
{
  ...
  v9 = -[_GCDevicePhysicalInputView update:forUsages:with:](&v32, sel_update_forUsages_with_);
  ...
  v13 = -[_GCDevicePhysicalInputAxis2DInput _setSources:]((uint64_t)self, (uint64_t)v12);
...
LABEL_22:
    if (a5)
    {
      v23 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)a5, (uint64_t)a5 + 56);
    ...
    else
    {
      ...
      {
LABEL_24:
        v26 = -[_GCDevicePhysicalInputView _testAndSetPrimitiveValue:forSlot:]((uint64_t)self, v25 | v24, (uint64_t)&self->_valueSlot);
        if (v26)
          v27 = 16;
        else
          v27 = 0;
LABEL_27:
        *((_BYTE *)a3 + v11) = *((_BYTE *)a3 + v11) & 0xEF | v27;
        if (a5)
        {
          v28 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)a5, (uint64_t)a5 + 64);
          if (self)
            goto LABEL_29;
        }
        else
        {
          ...
          {
LABEL_29:
            v29 = -[_GCDevicePhysicalInputView _testAndSetPrimitiveValue:forSlot:]((uint64_t)self, v28, (uint64_t)&self->_valueTimestampSlot);
            if (v29)
              v30 = 32;
            else
              v30 = 0;
...
LABEL_18:
  ...
  v21 = -[_GCDevicePhysicalInputAxis2DInput _setValueDidChangeHandler:]((uint64_t)self, (uint64_t)v20);
  if (v21)
    v22 = 8;
  else
    v22 = 0;
...
- (void)postCommit:(const void *)a3 sender:(id)a4
{
  ...
  char v8;
  uint64_t v9;
  void (**v10)(_QWORD, _QWORD, _QWORD, __n128, __n128);
  __n128 v11;
  __n128 v12;
  uint64_t v13;
  objc_super v14;
...
LABEL_9:
  if ((v8 & 0x10) == 0)
    return;
LABEL_17:
  v10 = (void (**)(_QWORD, _QWORD, _QWORD, __n128, __n128))-[_GCDevicePhysicalInputAxis2DInput _valueDidChangeHandler]((uint64_t)self);
  if (v10)
  {
    if (self)
    {
      v13 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)self, (uint64_t)&self->_valueSlot);
    ...
    ((void (**)(_QWORD, id, _GCDevicePhysicalInputAxis2DInput *, __n128, __n128))v10)[2](v10, a4, self, v11, v12);
  }
...
- (uint64_t)isEqualToInput:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      objc_msgSend(v5, "handleFailureInMethod:object:file:lineNumber:description:", sel_isEqualToInput_, v2, CFSTR("_GCDevicePhysicalInputAxis2DInput.m"), 168, CFSTR("Invalid parameter not satisfying: %s"), "[otherElement isKindOfClass:_GCDevicePhysicalInputAxis2DInput.class]");
      v2 = 0;
      goto LABEL_12;
    }
...
{
  return (id)-[_GCDevicePhysicalInputAxis2DInput _valueDidChangeHandler]((uint64_t)self);
}

- (void)setValueDidChangeHandler:(id)a3
{
  -[_GCDevicePhysicalInputAxis2DInput _setValueDidChangeHandler:]((uint64_t)self, (uint64_t)a3);
}
...
- (GCPoint2)value
{
  ...
  if (self)
  {
    v4 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)self, (uint64_t)&self->_valueSlot);
    v3 = *((float *)&v4 + 1);
    v2 = *(float *)&v4;
  }
  else
...
LABEL_6:
    v3 = 0.0;
    return (double)(mach_absolute_time() * lastValueLatency_sTimebaseInfo_1 / dword_254DBE0AC)
         / 1000000000.0
         - v3;
  }
  if (!self)
...
- (NSSet)sources
{
  return (NSSet *)(id)-[_GCDevicePhysicalInputAxis2DInput _sources]((uint64_t)self);
}
...
- (uint64_t)update:(float)a3 withValue:(float)a4 timestamp:(double)a5
{
  ...
  if (result)
  {
    ...
    v11 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:](v9, v9 + 56);
