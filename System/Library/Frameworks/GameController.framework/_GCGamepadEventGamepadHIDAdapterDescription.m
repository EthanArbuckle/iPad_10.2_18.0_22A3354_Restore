...
- (_GCGamepadEventGamepadHIDAdapterDescription)initWithSource:(id)a3 service:(id)a4
{
  id v7;
  id v8;
  _GCGamepadEventGamepadHIDAdapterDescription *v9;
  _GCGamepadEventGamepadHIDAdapterDescription *v10;
  objc_super v12;
  ...
  v9 = -[_GCGamepadEventGamepadHIDAdapterDescription init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
...
{
  -[_GCGamepadEventGamepadHIDAdapterDescription doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
  return self;
}
...
{
  id v4;
  _GCGamepadEventGamepadHIDAdapterDescription *v5;
  void *v6;
  uint64_t v7;
  ...
  v12.receiver = self;
  v12.super_class = (Class)_GCGamepadEventGamepadHIDAdapterDescription;
  v5 = -[_GCGamepadEventGamepadHIDAdapterDescription init](&v12, sel_init);
  if (v5)
  {
...
{
  id v4;
  _GCGamepadEventGamepadHIDAdapter *materializedObject;
  _GCGamepadEventGamepadHIDAdapter *v6;
  uint64_t v7;
  void *v8;
  uint64_t v9;
  void *v10;
  _GCGamepadEventGamepadHIDAdapter *v12;
  _GCGamepadEventGamepadHIDAdapter *v13;
...
LABEL_7:
  ...
  v12 = -[_GCGamepadEventGamepadHIDAdapter initWithSource:service:]([_GCGamepadEventGamepadHIDAdapter alloc], "initWithSource:service:", v8, v9);
