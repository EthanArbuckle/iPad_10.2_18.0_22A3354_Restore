...
{
  FigFCRCALayerOutputNodeLayer *v2;
  OpaqueFigCaptionRendererCALayerOutputNodeLayerInternal *v3;
  FigFCRCALayerOutputNodeContentLayer *v4;
  OpaqueFigCaptionRendererCALayerOutputNodeLayerInternal *layerInternal;
  FigCaptionBackdropLayer *var4;
  OpaqueFigCaptionRendererCALayerOutputNodeLayerInternal *v7;
  objc_super v9;
...
- (void)dealloc
{
  ...
  -[FigFCRCALayerOutputNodeLayer dealloc](&v5, sel_dealloc);
}
...
- (void)setContents:(id)a3
{
  ...
  if (self->layerInternal->var5)
  {
    v5.receiver = self;
    v5.super_class = (Class)FigFCRCALayerOutputNodeLayer;
    -[FigFCRCALayerOutputNodeLayer setContents:](&v5, sel_setContents_, a3);
  }
...
- (void)setPosition:(CGPoint)a3
{
  ...
  -[FigFCRCALayerOutputNodeLayer bounds](self, "bounds");
  v8 = v7 * 0.5;
  -[FigFCRCALayerOutputNodeLayer bounds](self, "bounds");
...
- (void)setCornerRadius:(double)a3
{
  ...
  -[FigFCRCALayerOutputNodeLayer setCornerRadius:](&v6, sel_setCornerRadius_, a3);
}
...
- (void)_addBoundsAnimationToLayer:(id)a3 usingAnimation:(id)a4 forKey:(id)a5
{
  ...
  v8 = _animationByTransformingValues(a4, (uint64_t)&__block_literal_global_92);
...
- (void)_addPositionAnimationToLayer:(id)a3 usingAnimation:(id)a4 forKey:(id)a5
{
  ...
  if (objc_msgSend(a4, "isAdditive"))
  {
    v9 = &__block_literal_global_23_4;
  }
  else
  {
...
- (void)addAnimation:(id)a3 forKey:(id)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    {
      -[FigFCRCALayerOutputNodeLayer _addBoundsAnimationToLayer:usingAnimation:forKey:](self, "_addBoundsAnimationToLayer:usingAnimation:forKey:", self->layerInternal->var3, a3, a4);
      -[FigFCRCALayerOutputNodeLayer _addBoundsAnimationToLayer:usingAnimation:forKey:](self, "_addBoundsAnimationToLayer:usingAnimation:forKey:", self->layerInternal->var4, a3, a4);
    }
    else
    {
      -[FigFCRCALayerOutputNodeLayer _addPositionAnimationToLayer:usingAnimation:forKey:](self, "_addPositionAnimationToLayer:usingAnimation:forKey:", self->layerInternal->var3, a3, a4);
      -[FigFCRCALayerOutputNodeLayer _addPositionAnimationToLayer:usingAnimation:forKey:](self, "_addPositionAnimationToLayer:usingAnimation:forKey:", self->layerInternal->var4, a3, a4);
    }
  }
  v7.receiver = self;
  v7.super_class = (Class)FigFCRCALayerOutputNodeLayer;
  -[FigFCRCALayerOutputNodeLayer addAnimation:forKey:](&v7, sel_addAnimation_forKey_, a3, a4);
}
