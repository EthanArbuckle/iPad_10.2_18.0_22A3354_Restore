...
{
  FigAssetVariantQualifierForMinimumInKeyPathObjC *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)FigAssetVariantQualifierForMinimumInKeyPathObjC;
  v4 = -[FigAssetVariantQualifierForMinimumInKeyPathObjC init](&v6, sel_init);
  if (v4)
...
- (void)dealloc
{
  ...
  -[FigAssetVariantQualifierForMinimumInKeyPathObjC dealloc](&v3, sel_dealloc);
}
