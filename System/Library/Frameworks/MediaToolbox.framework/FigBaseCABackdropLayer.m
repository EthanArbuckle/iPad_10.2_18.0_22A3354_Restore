...
- (FigBaseCABackdropLayer)init
{
  ...
  return -[FigBaseCABackdropLayer init](&v3, sel_init);
}
...
- (void)setSublayers:(id)a3
{
  ...
  if (!*(&self->super._disablesOccludedBackdropBlurs + 1))
  {
    v3.receiver = self;
    v3.super_class = (Class)FigBaseCABackdropLayer;
    -[FigBaseCABackdropLayer setSublayers:](&v3, sel_setSublayers_, a3);
  }
}
...
- (void)addSublayer:(id)a3
{
  ...
  if (!*(&self->super._disablesOccludedBackdropBlurs + 1))
  {
    v3.receiver = self;
    v3.super_class = (Class)FigBaseCABackdropLayer;
    -[FigBaseCABackdropLayer addSublayer:](&v3, sel_addSublayer_, a3);
  }
}
...
- (void)insertSublayer:(id)a3 atIndex:(unsigned int)a4
{
  ...
  if (!*(&self->super._disablesOccludedBackdropBlurs + 1))
  {
    ...
    -[FigBaseCABackdropLayer insertSublayer:atIndex:](&v4, sel_insertSublayer_atIndex_, a3, *(_QWORD *)&a4);
  }
}
...
- (void)insertSublayer:(id)a3 below:(id)a4
{
  ...
  if (!*(&self->super._disablesOccludedBackdropBlurs + 1))
  {
    v4.receiver = self;
    v4.super_class = (Class)FigBaseCABackdropLayer;
    -[FigBaseCABackdropLayer insertSublayer:below:](&v4, sel_insertSublayer_below_, a3, a4);
  }
}
...
- (void)insertSublayer:(id)a3 above:(id)a4
{
  ...
  if (!*(&self->super._disablesOccludedBackdropBlurs + 1))
  {
    v4.receiver = self;
    v4.super_class = (Class)FigBaseCABackdropLayer;
    -[FigBaseCABackdropLayer insertSublayer:above:](&v4, sel_insertSublayer_above_, a3, a4);
  }
}
...
- (void)replaceSublayer:(id)a3 with:(id)a4
{
  ...
  if (!*(&self->super._disablesOccludedBackdropBlurs + 1))
  {
    v4.receiver = self;
    v4.super_class = (Class)FigBaseCABackdropLayer;
    -[FigBaseCABackdropLayer replaceSublayer:with:](&v4, sel_replaceSublayer_with_, a3, a4);
  }
}
...
- (void)removeFromSuperlayer
{
  ...
  -[FigBaseCABackdropLayer removeFromSuperlayer](&v2, sel_removeFromSuperlayer);
}
