...
- (id)_kernel
{
  return +[CIKernel kernelWithInternalRepresentation:](CIWarpKernel, "kernelWithInternalRepresentation:", &CI::_fourfoldReflectedTile);
}
...
- (id)outputImage
{
  ...
  *((float *)&v20 + 1) = v21;
  ...
  v36 = +[CIVector vectorWithX:Y:Z:W:](CIVector, "vectorWithX:Y:Z:W:", v47[0] * 0.5, v47[2] * 0.5, v47[1] * 0.5, v47[3] * 0.5);
  v37 = +[CIVector vectorWithX:Y:Z:W:](CIVector, "vectorWithX:Y:Z:W:", v48, v50, v49, v51);
  v38 = -[CIFourfoldReflectedTile _kernel](self, "_kernel");
