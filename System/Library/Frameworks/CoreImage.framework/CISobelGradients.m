...
- (id)outputImage
{
  ...
  v3 = +[CIKernel kernelWithInternalRepresentation:](CIKernel, "kernelWithInternalRepresentation:", &CI::_sobel);
  ...
  v11[0] = v4;
  v9 = -[CIKernel applyWithExtent:roiCallback:arguments:](v3, "applyWithExtent:roiCallback:arguments:", &__block_literal_global_36_0, objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v11, 1), v5, v6, v7, v8);
