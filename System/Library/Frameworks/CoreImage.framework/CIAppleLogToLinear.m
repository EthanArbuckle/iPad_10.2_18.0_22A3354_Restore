...
- (id)outputImage
{
  ...
  v3 = +[CIKernel kernelWithInternalRepresentation:](CIColorKernel, "kernelWithInternalRepresentation:", &CI::_appleLogToLinear);
  v4 = -[CIImage imageByUnpremultiplyingAlpha](-[CIAppleLogToLinear inputImage](self, "inputImage"), "imageByUnpremultiplyingAlpha");
