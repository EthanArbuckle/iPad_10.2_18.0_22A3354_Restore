...
- (id)outputImage
{
  ...
  if (CGRectIsInfinite(v23))
    return 0;
  v4 = +[CIKernel kernelWithInternalRepresentation:](CIKernel, "kernelWithInternalRepresentation:", &CI::_planarToInterleaved3);
  -[CIImage extent](v2, "extent");
  v6 = v5;
  -[CIImage extent](v2, "extent");
  v8 = v7;
  ...
  v21[0] = v2;
  v21[1] = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithDouble:", v25.size.height, MEMORY[0x1E0C809B0], 3221225472, __37__CIPlanarToInterleaved3_outputImage__block_invoke, &__block_descriptor_40_e73__CGRect__CGPoint_dd__CGSize_dd__44__0i8_CGRect__CGPoint_dd__CGSize_dd__12l, v6);
