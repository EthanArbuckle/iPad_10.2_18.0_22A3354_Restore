...
- (id)outputImage
{
  ...
  if (outputImage_onceToken_21 != -1)
    dispatch_once(&outputImage_onceToken_21, &__block_literal_global_22);
  v3 = (void *)objc_msgSend((id)outputImage_kernels_20, "objectAtIndexedSubscript:", 0);
  -[CIImage extent](self->inputImage, "extent");
  v9[0] = self->inputImage;
  return (id)objc_msgSend(v3, "applyWithExtent:roiCallback:arguments:", &__block_literal_global_23_0, objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v9, 1), v4, v5, v6, v7);
}
...
NSArray *__29__RedEyeGradient_outputImage__block_invoke()
{
  ...
  result = objc_retain(+[CIKernel kernelsWithString:](CIKernel, "kernelsWithString:", objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "kernel vec4 _redEyeGaborToYAndVF(sampler src) { vec2 dc = destCoord(); vec2 pt, u, u2, v, v2; pt = samp"
  ...
  outputImage_kernels_20 = (uint64_t)result;
  return result;
}
