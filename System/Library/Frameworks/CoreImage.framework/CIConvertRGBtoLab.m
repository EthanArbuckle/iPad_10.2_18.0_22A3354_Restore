...
- (id)outputImage
{
  ...
  v3 = +[CIKernel kernelWithInternalRepresentation:](CIColorKernel, "kernelWithInternalRepresentation:", &CI::_LAB_normalize);
  v4 = -[CIImage imageByConvertingWorkingSpaceToLab](self->inputImage, "imageByConvertingWorkingSpaceToLab");
  if (-[NSNumber BOOLValue](self->inputNormalize, "BOOLValue"))
  {
    -[CIImage extent](v4, "extent");
    v10[0] = v4;
    return -[CIColorKernel applyWithExtent:arguments:](v3, "applyWithExtent:arguments:", objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v10, 1), v5, v6, v7, v8);
  }
  return v4;
}
