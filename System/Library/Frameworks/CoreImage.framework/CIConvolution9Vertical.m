...
- (id)outputImage
{
  ...
  if (!inputWeights || -[CIVector count](inputWeights, "count") != 9)
    return 0;
  if (-[CIConvolution9Vertical _isIdentity](self, "_isIdentity"))
  ...
  v9 = v8;
  v5 = apply1DConvolution(self->inputImage, self->inputWeights, v7, 0, v8);
  v10 = CI_ENABLE_MPS();
  if ((v9 & 1) != 0 || !v10)
    return v5;
  return +[CIImage imageForRenderingWithMPS:orNonMPS:](CIImage, "imageForRenderingWithMPS:orNonMPS:", +[CIConvolutionProcessor applyConToImage:width:height:bias:weights:](CIConvolutionProcessor, "applyConToImage:width:height:bias:weights:", self->inputImage, 1, 9, self->inputWeights, v7), v5);
}
