...
- (id)_kernel
{
  return +[CIKernel kernelWithInternalRepresentation:](CIColorKernel, "kernelWithInternalRepresentation:", &CI::_bloom);
}
...
- (id)outputImage
{
  ...
  if (!self->inputImage)
    return 0;
  v3 = -[CIBloom _isIdentity](self, "_isIdentity");
  ...
  v23 = -[CIBloom _kernel](self, "_kernel");
