@implementation ZN2CI8TileTask23incrementNanoSecForNodeEPKNS

char *___ZN2CI8TileTask23incrementNanoSecForNodeEPKNS_11ProgramNodeEy_block_invoke(_QWORD *a1)
{
  uint64_t v2;
  uint64_t v3;
  char *result;
