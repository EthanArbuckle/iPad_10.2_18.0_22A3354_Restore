@implementation ZNK2CI19RenderToPixelBuffer6renderEPNS

unsigned __int16 *___ZNK2CI19RenderToPixelBuffer6renderEPNS_5ImageEPNS_7ContextE_block_invoke_2_9(unsigned __int16 *result, uint64_t a2, uint64_t a3, double a4, double a5, float a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  int v9;
  int v10;
...
_WORD *___ZNK2CI19RenderToPixelBuffer6renderEPNS_5ImageEPNS_7ContextE_block_invoke_3_11(_WORD *result, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  int v6;
  int v7;
...
__int16 *___ZNK2CI19RenderToPixelBuffer6renderEPNS_5ImageEPNS_7ContextE_block_invoke_4(__int16 *result, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  int v6;
  int v7;
