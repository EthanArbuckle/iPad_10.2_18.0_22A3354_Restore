...
- (id)_kernel
{
  return +[CIKernel kernelWithInternalRepresentation:](CIColorKernel, "kernelWithInternalRepresentation:", &CI::_linearGradient);
}
...
- (id)outputImage
{
  ...
  v15 = -[CILinearGradient _kernel](self, "_kernel");
