...
- (id)outputImage
{
  ...
  if (outputImage_onceToken_1 != -1)
    dispatch_once(&outputImage_onceToken_1, &__block_literal_global_79);
  -[NSNumber floatValue](self->inputRadius, "floatValue");
  v4 = v3;
  v5 = (void *)objc_msgSend((id)outputImage_kernels_0, "objectAtIndexedSubscript:", 0);
  -[CIImage extent](self->inputImage, "extent");
  v6 = MEMORY[0x1E0C809B0];
  v22[0] = MEMORY[0x1E0C809B0];
  v22[1] = 3221225472;
  v22[2] = __34__RedEyeMinMorphology_outputImage__block_invoke_2;
  ...
  v13 = (void *)objc_msgSend((id)outputImage_kernels_0, "objectAtIndexedSubscript:", 1);
  -[CIImage extent](self->inputImage, "extent");
  v20[0] = v6;
  v20[1] = 3221225472;
  v20[2] = __34__RedEyeMinMorphology_outputImage__block_invoke_3;
...
NSArray *__34__RedEyeMinMorphology_outputImage__block_invoke()
{
  ...
  result = objc_retain(+[CIKernel kernelsWithString:](CIKernel, "kernelsWithString:", objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", "kernel vec4 _redEyeHorizontalMinKernel(sampler im, float radius) { float offset; vec2 pt, sd; vec4 s, m"
