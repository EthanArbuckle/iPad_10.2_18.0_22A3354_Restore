...
- (void)computeRotation
{
  ...
  v3 = -[CIKeystoneCorrection inputTopLeft](self, "inputTopLeft");
  -[CIVector X](v3, "X");
  *(float *)&v4 = v4;
  v34 = *(float *)&v4;
  -[CIVector Y](v3, "Y");
  *(float *)&v5 = v5;
  v33 = *(float *)&v5;
  v6 = -[CIKeystoneCorrection inputTopRight](self, "inputTopRight");
  -[CIVector X](v6, "X");
  *(float *)&v7 = v7;
  v32 = *(float *)&v7;
  -[CIVector Y](v6, "Y");
  *(float *)&v8 = v8;
  v31 = *(float *)&v8;
  v9 = -[CIKeystoneCorrection inputBottomLeft](self, "inputBottomLeft");
  -[CIVector X](v9, "X");
  *(float *)&v10 = v10;
  v30 = *(float *)&v10;
  -[CIVector Y](v9, "Y");
  *(float *)&v11 = v11;
  v29 = *(float *)&v11;
  v12 = -[CIKeystoneCorrection inputBottomRight](self, "inputBottomRight");
  -[CIVector X](v12, "X");
  *(float *)&v13 = v13;
  v28 = *(float *)&v13;
  -[CIVector Y](v12, "Y");
