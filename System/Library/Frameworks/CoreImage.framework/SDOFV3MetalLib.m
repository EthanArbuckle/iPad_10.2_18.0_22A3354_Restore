@implementation SDOFV3MetalLib

uint64_t __SDOFV3MetalLib_block_invoke()
{
  uint64_t result;
  void *v1;
  const __CFString *v2;
  ...
  if (result)
  {
    ...
    if (CI_ENABLE_FUNCTION_STITCHING())
      v2 = CFSTR("CIPortraitBlurStitchableV3");
    else
      v2 = CFSTR("CIPortraitBlurV3");
