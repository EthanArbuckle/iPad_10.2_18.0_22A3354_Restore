...
- (id)outputImage
{
  ...
  -[NSNumber floatValue](self->inputSigma, "floatValue");
  v10 = fmaxf(v9, 0.0);
  if (v10 < 0.01)
  ...
  v11 = +[CIKernel kernelWithInternalRepresentation:](CIColorKernel, "kernelWithInternalRepresentation:", &CI::_blurredrect);
  v12 = +[CIVector vectorWithX:Y:Z:W:](CIVector, "vectorWithX:Y:Z:W:", x, y, x + width, y + height);
  v22.origin.x = x;
  v22.origin.y = y;
  v22.size.width = width;
  v22.size.height = height;
  v23 = CGRectInset(v22, v10 * -3.0, v10 * -3.0);
  v13 = v23.origin.x;
  v14 = v23.origin.y;
  v15 = v23.size.width;
  v16 = v23.size.height;
  *(float *)&v23.origin.x = v10;
  v17 = objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithFloat:", v23.origin.x, v12);
  inputColor = self->inputColor;
  v19[1] = v17;
  v19[2] = inputColor;
  return -[CIColorKernel applyWithExtent:arguments:](v11, "applyWithExtent:arguments:", objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", v19, 3), v13, v14, v15, v16);
}
