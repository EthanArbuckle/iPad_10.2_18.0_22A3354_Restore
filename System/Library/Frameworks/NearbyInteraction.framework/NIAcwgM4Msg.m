...
- (NIAcwgM4Msg)initWithStsIndex0:(unsigned int)a3 uwbTime0:(unint64_t)a4 hopKey:(unsigned int)a5 selectedSyncCodeIndex:(unsigned __int8)a6
{
  ...
  result = -[NIAcwgM4Msg init](&v11, sel_init);
  if (result)
  {
    result->_uwbTime0 = a4;
...
{
  return (id)objc_msgSend(objc_alloc((Class)a1), "initWithStsIndex0:uwbTime0:hopKey:selectedSyncCodeIndex:", a3->var0, a3->var1, a3->var2, a3->var3);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return (id)objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "allocWithZone:", a3), "initWithStsIndex0:uwbTime0:hopKey:selectedSyncCodeIndex:", self->_stsIndex0, self->_uwbTime0, self->_hopKey, self->_selectedSyncCodeIndex);
}
...
- (NIAcwgM4Msg)initWithCoder:(id)a3
{
  ...
  if (self)
  {
    ...
    self->_uwbTime0 = objc_msgSend(v5, "decodeInt64ForKey:", CFSTR("uwbTime0"));
