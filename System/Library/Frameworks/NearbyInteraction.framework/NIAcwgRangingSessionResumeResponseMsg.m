...
- (NIAcwgRangingSessionResumeResponseMsg)initWithStsIndex0:(unsigned int)a3 uwbTime0:(unint64_t)a4
{
  ...
  result = -[NIAcwgRangingSessionResumeResponseMsg init](&v7, sel_init);
  if (result)
  {
...
{
  return (id)objc_msgSend(objc_alloc((Class)a1), "initWithStsIndex0:uwbTime0:", *(_QWORD *)&a3.var0, a3.var1);
}

- (id)copyWithZone:(_NSZone *)a3
{
  return (id)objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "allocWithZone:", a3), "initWithStsIndex0:uwbTime0:", self->_stsIndex0, self->_uwbTime0);
}
