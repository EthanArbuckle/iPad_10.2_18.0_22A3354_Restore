@implementation SWCollaborationMetadataForDocumentURL
...
void __SWCollaborationMetadataForDocumentURL_block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  else
  {
    ...
    v7[1] = 3221225472;
    v7[2] = __SWCollaborationMetadataForDocumentURL_block_invoke_2;
    v7[3] = &unk_1E217B1C8;
    v8 = *(id *)(a1 + 32);
    v5 = *(id *)(a1 + 40);
    v9 = 0;
    ...
    objc_msgSend(v6, "collaborationMetadataWithCompletionHandler:", *(_QWORD *)(a1 + 40));
...
void __SWCollaborationMetadataForDocumentURL_block_invoke_2_cold_1(uint64_t a1, void *a2)
{
  ...
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0(&dword_18B618000, v5, v6, "[ERROR] Cannot fetch share options for item at %@. Error: %@", v7, v8, v9, v10, v11);
