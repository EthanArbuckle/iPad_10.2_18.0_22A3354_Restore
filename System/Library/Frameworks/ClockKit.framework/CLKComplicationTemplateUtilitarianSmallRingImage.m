...
{
  CLKImageProvider *v8;
  CLKComplicationTemplateUtilitarianSmallRingImage *v9;
  CLKComplicationTemplateUtilitarianSmallRingImage *v10;
  double v11;
  objc_super v13;
  ...
  if (v9)
  {
    -[CLKComplicationTemplateUtilitarianSmallRingImage setImageProvider:](v9, "setImageProvider:", v8);
    *(float *)&v11 = fillFraction;
    -[CLKComplicationTemplateUtilitarianSmallRingImage setFillFraction:](v10, "setFillFraction:", v11);
    -[CLKComplicationTemplateUtilitarianSmallRingImage setRingStyle:](v10, "setRingStyle:", ringStyle);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, void *, char *))a3 + 2))(a3, CFSTR("ringStyle"), 1, &__block_literal_global_646, &v3);
}
