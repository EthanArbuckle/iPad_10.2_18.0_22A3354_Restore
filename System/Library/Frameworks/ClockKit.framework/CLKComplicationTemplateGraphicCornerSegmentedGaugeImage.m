...
- (CLKComplicationTemplateGraphicCornerSegmentedGaugeImage)initWithImageProvider:(id)a3 gaugeProvider:(id)a4 textProvider:(id)a5
{
  ...
  id v11;
  id *v12;
  CLKComplicationTemplateGraphicCornerSegmentedGaugeImage *v13;
  objc_super v15;
...
- (void)_enumerateTextProviderKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, uint64_t, char *))a3 + 2))(a3, CFSTR("leadingTextProvider"), 1, 1, &v3);
}
...
- (void)_enumerateFullColorImageProviderKeysWithBlock:(id)a3
{
  ...
  os_unfair_lock_lock((os_unfair_lock_t)&_enumerateFullColorImageProviderKeysWithBlock____lock_934);
  WeakRetained = objc_loadWeakRetained(&_enumerateFullColorImageProviderKeysWithBlock____cachedDevice_935);
  if (!WeakRetained)
    goto LABEL_5;
  v8 = WeakRetained;
  v9 = objc_loadWeakRetained(&_enumerateFullColorImageProviderKeysWithBlock____cachedDevice_935);
  if (v6 != v9)
  {

LABEL_5:
    v12 = objc_storeWeak(&_enumerateFullColorImageProviderKeysWithBlock____cachedDevice_935, v6);
    _enumerateFullColorImageProviderKeysWithBlock____previousCLKDeviceVersion_936 = objc_msgSend(v6, "version");
  ...
  v11 = _enumerateFullColorImageProviderKeysWithBlock____previousCLKDeviceVersion_936;

  if (v10 != v11)
    goto LABEL_5;
LABEL_6:
  os_unfair_lock_unlock((os_unfair_lock_t)&_enumerateFullColorImageProviderKeysWithBlock____lock_934);
  v14 = *(double *)&qword_254AB85F8;
  v15 = *(double *)&_enumerateFullColorImageProviderKeysWithBlock___imageDiameter_932[-[CLKComplicationTemplate sdkVersion](self, "sdkVersion")];
  v17 = 0;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", *(double *)&_enumerateFullColorImageProviderKeysWithBlock___pointSize_933);
...
void __105__CLKComplicationTemplateGraphicCornerSegmentedGaugeImage__enumerateFullColorImageProviderKeysWithBlock___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  _enumerateFullColorImageProviderKeysWithBlock___pointSize_933 = v2;
  objc_msgSend(v5, "scaledValue:", 20.0);
  qword_254AB85F8 = v3;
  objc_msgSend(v5, "setNewestAllowedSizeClass:", &unk_24CC16DB0);
  objc_msgSend(v5, "scaledValue:", 20.0);
  _enumerateFullColorImageProviderKeysWithBlock___imageDiameter_932 = v4;
