...
- (CLKComplicationTemplateModularSmallColumnsText)initWithRow1Column1TextProvider:(CLKTextProvider *)row1Column1TextProvider row1Column2TextProvider:(CLKTextProvider *)row1Column2TextProvider row2Column1TextProvider:(CLKTextProvider *)row2Column1TextProvider row2Column2TextProvider:(CLKTextProvider *)row2Column2TextProvider
{
  ...
  CLKTextProvider *v12;
  CLKTextProvider *v13;
  CLKComplicationTemplateModularSmallColumnsText *v14;
  CLKComplicationTemplateModularSmallColumnsText *v15;
  objc_super v17;
  ...
  if (v14)
  {
    -[CLKComplicationTemplateModularSmallColumnsText setRow1Column1TextProvider:](v14, "setRow1Column1TextProvider:", v10);
    -[CLKComplicationTemplateModularSmallColumnsText setRow1Column2TextProvider:](v15, "setRow1Column2TextProvider:", v11);
    -[CLKComplicationTemplateModularSmallColumnsText setRow2Column1TextProvider:](v15, "setRow2Column1TextProvider:", v12);
    -[CLKComplicationTemplateModularSmallColumnsText setRow2Column2TextProvider:](v15, "setRow2Column2TextProvider:", v13);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, void *, char *))a3 + 2))(a3, CFSTR("column2Alignment"), 1, &__block_literal_global_396, &v3);
}
