...
- (CLKComplicationTemplateModularSmallStackText)initWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  CLKTextProvider *v6;
  CLKTextProvider *v7;
  CLKComplicationTemplateModularSmallStackText *v8;
  CLKComplicationTemplateModularSmallStackText *v9;
  objc_super v11;
  ...
  if (v8)
  {
    -[CLKComplicationTemplateModularSmallStackText setLine1TextProvider:](v8, "setLine1TextProvider:", v6);
    -[CLKComplicationTemplateModularSmallStackText setLine2TextProvider:](v9, "setLine2TextProvider:", v7);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, _QWORD, void *, char *))a3 + 2))(a3, CFSTR("highlightMode"), 0, &__block_literal_global_333, &v3);
}
...
{
  -[CLKComplicationTemplateModularSmallStackText setHighlightMode:](self, "setHighlightMode:", highlightLine2);
}

- (BOOL)highlightLine2
{
  return -[CLKComplicationTemplateModularSmallStackText highlightMode](self, "highlightMode") != 0;
}
...
- (id)JSONObjectRepresentationWritingResourcesToBundlePath:(id)a3
{
  ...
  -[CLKComplicationTemplate JSONObjectRepresentationWritingResourcesToBundlePath:purpose:](self, "JSONObjectRepresentationWritingResourcesToBundlePath:purpose:", a3, 0);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[CLKComplicationTemplateModularSmallStackText highlightLine2](self, "highlightLine2"));
