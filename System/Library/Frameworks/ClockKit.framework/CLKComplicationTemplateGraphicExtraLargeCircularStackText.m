...
- (CLKComplicationTemplateGraphicExtraLargeCircularStackText)initWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  CLKTextProvider *v6;
  CLKTextProvider *v7;
  CLKComplicationTemplateGraphicExtraLargeCircularStackText *v8;
  CLKComplicationTemplateGraphicExtraLargeCircularStackText *v9;
  objc_super v11;
  ...
  if (v8)
  {
    -[CLKComplicationTemplateGraphicExtraLargeCircularStackText setLine1TextProvider:](v8, "setLine1TextProvider:", v6);
    -[CLKComplicationTemplateGraphicExtraLargeCircularStackText setLine2TextProvider:](v9, "setLine2TextProvider:", v7);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, _QWORD, void *, char *))a3 + 2))(a3, CFSTR("highlightMode"), 0, &__block_literal_global_1199, &v3);
}
...
{
  -[CLKComplicationTemplateGraphicExtraLargeCircularStackText setHighlightMode:](self, "setHighlightMode:", a3);
}

- (BOOL)highlightLine2
{
  return -[CLKComplicationTemplateGraphicExtraLargeCircularStackText highlightMode](self, "highlightMode") != 0;
}
...
- (id)JSONObjectRepresentationWritingResourcesToBundlePath:(id)a3
{
  ...
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", -[CLKComplicationTemplateGraphicExtraLargeCircularStackText highlightLine2](self, "highlightLine2"));
