...
- (id)serializableCopyWithImageProviders:(id)a3
{
  ...
  void *v6;
  CLKComplicationTemplateGraphicCornerCircularImage *v7;
  ...
  v7 = -[CLKComplicationTemplateGraphicCornerCircularImage initWithImageProvider:](v5, "initWithImageProvider:", v6);
