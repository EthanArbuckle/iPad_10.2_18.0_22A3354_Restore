...
{
  return -[CLKComplicationTemplateExtraLargeSimpleText initWithTextProvider:](self, "initWithTextProvider:", 0);
}

- (CLKComplicationTemplateExtraLargeSimpleText)initWithTextProvider:(CLKTextProvider *)textProvider
{
  CLKTextProvider *v4;
  CLKComplicationTemplateExtraLargeSimpleText *v5;
  CLKComplicationTemplateExtraLargeSimpleText *v6;
  objc_super v8;
  ...
  if (v5)
  {
    ...
    -[CLKComplicationTemplateExtraLargeSimpleText setTextProvider:](v5, "setTextProvider:", v4);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, _QWORD, void *, char *))a3 + 2))(a3, CFSTR("maxDynamicFontSize"), 0, &__block_literal_global_709, &v3);
}
