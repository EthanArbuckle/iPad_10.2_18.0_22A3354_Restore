...
{
  return -[CLKComplicationTemplateModularSmallSimpleText initWithTextProvider:](self, "initWithTextProvider:", 0);
}

- (CLKComplicationTemplateModularSmallSimpleText)initWithTextProvider:(CLKTextProvider *)textProvider
{
  CLKTextProvider *v4;
  CLKComplicationTemplateModularSmallSimpleText *v5;
  CLKComplicationTemplateModularSmallSimpleText *v6;
  objc_super v8;
  ...
  if (v5)
  {
    -[CLKComplicationTemplateModularSmallSimpleText setTextProvider:](v5, "setTextProvider:", v4);
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, _QWORD, void *, char *))a3 + 2))(a3, CFSTR("maxDynamicFontSize"), 0, &__block_literal_global_264, &v3);
}
