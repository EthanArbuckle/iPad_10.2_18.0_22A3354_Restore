...
- (void)_enumerateFullColorImageProviderKeysWithBlock:(id)a3
{
  ...
  os_unfair_lock_lock((os_unfair_lock_t)&_enumerateFullColorImageProviderKeysWithBlock____lock_924);
  WeakRetained = objc_loadWeakRetained(&_enumerateFullColorImageProviderKeysWithBlock____cachedDevice_925);
  if (!WeakRetained)
    goto LABEL_5;
  v8 = WeakRetained;
  v9 = objc_loadWeakRetained(&_enumerateFullColorImageProviderKeysWithBlock____cachedDevice_925);
  if (v6 != v9)
  {

LABEL_5:
    v12 = objc_storeWeak(&_enumerateFullColorImageProviderKeysWithBlock____cachedDevice_925, v6);
    _enumerateFullColorImageProviderKeysWithBlock____previousCLKDeviceVersion_926 = objc_msgSend(v6, "version");
  ...
  v11 = _enumerateFullColorImageProviderKeysWithBlock____previousCLKDeviceVersion_926;

  if (v10 != v11)
    goto LABEL_5;
LABEL_6:
  os_unfair_lock_unlock((os_unfair_lock_t)&_enumerateFullColorImageProviderKeysWithBlock____lock_924);
  v14 = *(double *)&qword_254AB85C8;
  v15 = *(double *)&_enumerateFullColorImageProviderKeysWithBlock___imageDiameter_922[-[CLKComplicationTemplate sdkVersion](self, "sdkVersion")];
  v17 = 0;
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithDouble:", *(double *)&_enumerateFullColorImageProviderKeysWithBlock___pointSize_923);
...
void __103__CLKComplicationTemplateGraphicCornerMeteredGaugeImage__enumerateFullColorImageProviderKeysWithBlock___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  _enumerateFullColorImageProviderKeysWithBlock___pointSize_923 = v2;
  objc_msgSend(v5, "scaledValue:", 20.0);
  qword_254AB85C8 = v3;
  objc_msgSend(v5, "setNewestAllowedSizeClass:", &unk_24CC16DB0);
  objc_msgSend(v5, "scaledValue:", 20.0);
  _enumerateFullColorImageProviderKeysWithBlock___imageDiameter_922 = v4;
