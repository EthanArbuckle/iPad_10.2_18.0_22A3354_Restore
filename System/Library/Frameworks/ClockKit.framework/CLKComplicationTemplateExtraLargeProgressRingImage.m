...
- (CLKComplicationTemplateExtraLargeProgressRingImage)initWithImageProvider:(id)a3 progressProvider:(id)a4 ringStyle:(int64_t)a5
{
  id v8;
  id v9;
  CLKComplicationTemplateExtraLargeProgressRingImage *v10;
  CLKComplicationTemplateExtraLargeProgressRingImage *v11;
  objc_super v13;
  ...
  if (v10)
  {
    -[CLKComplicationTemplateExtraLargeProgressRingImage setImageProvider:](v10, "setImageProvider:", v8);
    -[CLKComplicationTemplateExtraLargeProgressRingImage setProgressProvider:](v11, "setProgressProvider:", v9);
    -[CLKComplicationTemplateExtraLargeProgressRingImage setRingStyle:](v11, "setRingStyle:", a5);
  }
...
- (void)_enumerateImageProviderKeysWithBlock:(id)a3
{
  ...
  v7 = 0.0;
  v8 = 0.0;
  _SquareImageSizeScaled(v6, 1, -[CLKComplicationTemplate sdkVersion](self, "sdkVersion"), &v9, &v7, 52.0);
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, void *, char *))a3 + 2))(a3, CFSTR("ringStyle"), 1, &__block_literal_global_747, &v3);
}
