...
{
  id v4;
  CLKComplicationTemplateGraphicCircularClosedGaugeImage *v5;
  void *v6;
  void *v7;
  ...
  -[CLKComplicationTemplateGraphicCircularClosedGaugeViewBridge gaugeProvider](self, "gaugeProvider");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("labelData"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  v8 = -[CLKComplicationTemplateGraphicCircularClosedGaugeImage initWithGaugeProvider:imageProvider:](v5, "initWithGaugeProvider:imageProvider:", v6, v7);
