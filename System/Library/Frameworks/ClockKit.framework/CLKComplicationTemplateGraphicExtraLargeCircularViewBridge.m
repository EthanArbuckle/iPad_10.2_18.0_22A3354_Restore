...
- (id)serializableCopyWithImageProviders:(id)a3
{
  ...
  void *v6;
  CLKComplicationTemplateGraphicExtraLargeCircularImage *v7;
  ...
  v7 = -[CLKComplicationTemplateGraphicExtraLargeCircularImage initWithImageProvider:](v5, "initWithImageProvider:", v6);
