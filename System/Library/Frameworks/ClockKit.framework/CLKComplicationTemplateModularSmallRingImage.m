...
{
  CLKImageProvider *v8;
  CLKComplicationTemplateModularSmallRingImage *v9;
  CLKComplicationTemplateModularSmallRingImage *v10;
  double v11;
  objc_super v13;
  ...
  if (v9)
  {
    -[CLKComplicationTemplateModularSmallRingImage setImageProvider:](v9, "setImageProvider:", v8);
    *(float *)&v11 = fillFraction;
    -[CLKComplicationTemplateModularSmallRingImage setFillFraction:](v10, "setFillFraction:", v11);
    -[CLKComplicationTemplateModularSmallRingImage setRingStyle:](v10, "setRingStyle:", ringStyle);
  }
...
- (void)_enumerateImageProviderKeysWithBlock:(id)a3
{
  ...
  v7 = 0.0;
  v8 = 0.0;
  _SquareImageSizeScaled(v6, 1, -[CLKComplicationTemplate sdkVersion](self, "sdkVersion"), &v9, &v7, 19.0);
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, void *, char *))a3 + 2))(a3, CFSTR("ringStyle"), 1, &__block_literal_global_321, &v3);
}
