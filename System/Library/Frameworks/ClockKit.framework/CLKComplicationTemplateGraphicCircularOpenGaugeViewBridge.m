...
{
  id v4;
  CLKComplicationTemplateGraphicCircularOpenGaugeImage *v5;
  void *v6;
  void *v7;
  void *v8;
  CLKComplicationTemplateGraphicCircularOpenGaugeImage *v9;

  v4 = a3;
  v5 = [CLKComplicationTemplateGraphicCircularOpenGaugeImage alloc];
  -[CLKComplicationTemplateGraphicCircularOpenGaugeViewBridge gaugeProvider](self, "gaugeProvider");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("bottomLabelData"));
  v7 = (void *)objc_claimAutoreleasedReturnValue();

  -[CLKComplicationTemplateGraphicCircularOpenGaugeViewBridge centerTextProvider](self, "centerTextProvider");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = -[CLKComplicationTemplateGraphicCircularOpenGaugeImage initWithGaugeProvider:bottomImageProvider:centerTextProvider:](v5, "initWithGaugeProvider:bottomImageProvider:centerTextProvider:", v6, v7, v8);
