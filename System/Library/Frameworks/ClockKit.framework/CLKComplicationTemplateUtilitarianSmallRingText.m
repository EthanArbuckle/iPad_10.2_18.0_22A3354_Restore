...
{
  CLKTextProvider *v8;
  CLKComplicationTemplateUtilitarianSmallRingText *v9;
  CLKComplicationTemplateUtilitarianSmallRingText *v10;
  double v11;
  objc_super v13;
  ...
  if (v9)
  {
    -[CLKComplicationTemplateUtilitarianSmallRingText setTextProvider:](v9, "setTextProvider:", v8);
    *(float *)&v11 = fillFraction;
    -[CLKComplicationTemplateUtilitarianSmallRingText setFillFraction:](v10, "setFillFraction:", v11);
    -[CLKComplicationTemplateUtilitarianSmallRingText setRingStyle:](v10, "setRingStyle:", ringStyle);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, void *, char *))a3 + 2))(a3, CFSTR("ringStyle"), 1, &__block_literal_global_640, &v3);
}
