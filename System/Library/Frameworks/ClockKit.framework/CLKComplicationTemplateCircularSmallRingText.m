...
{
  CLKTextProvider *v8;
  CLKComplicationTemplateCircularSmallRingText *v9;
  CLKComplicationTemplateCircularSmallRingText *v10;
  double v11;
  objc_super v13;
  ...
  if (v9)
  {
    -[CLKComplicationTemplateCircularSmallRingText setTextProvider:](v9, "setTextProvider:", v8);
    *(float *)&v11 = fillFraction;
    -[CLKComplicationTemplateCircularSmallRingText setFillFraction:](v10, "setFillFraction:", v11);
    -[CLKComplicationTemplateCircularSmallRingText setRingStyle:](v10, "setRingStyle:", ringStyle);
  }
...
- (void)_enumerateIntegerKeysWithBlock:(id)a3
{
  ...
  v3 = 0;
  (*((void (**)(id, const __CFString *, uint64_t, void *, char *))a3 + 2))(a3, CFSTR("ringStyle"), 1, &__block_literal_global_669, &v3);
}
