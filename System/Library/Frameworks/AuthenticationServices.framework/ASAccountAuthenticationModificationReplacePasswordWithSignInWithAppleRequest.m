...
- (ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest)initWithUser:(NSString *)user serviceIdentifier:(ASCredentialServiceIdentifier *)serviceIdentifier userInfo:(NSDictionary *)userInfo
{
  ...
  NSDictionary *v10;
  ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest *v11;
  uint64_t v12;
  NSString *v13;
  uint64_t v14;
  NSDictionary *v15;
  ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest *v16;
  objc_super v18;
  ...
  v11 = -[ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest init](&v18, sel_init);
  if (v11)
  {
...
- (ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest)initWithUser:(id)a3 password:(id)a4 extension:(id)a5 serviceIdentifier:(id)a6 userInfo:(id)a7
{
  ...
  id v15;
  id v16;
  ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest *v17;
  uint64_t v18;
  NSString *user;
  uint64_t v20;
  NSString *password;
  ...
  ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest *v24;
  objc_super v26;
  ...
  v17 = -[ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest init](&v26, sel_init);
  if (v17)
  {
