...
+ (id)attachmentWithAtomLayoutView:(id)a3 representedObject:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_msgSend(objc_alloc((Class)a1), "initWithAtomLayoutView:representedObject:", v6, v7);
...
- (_MFAtomAttachment)initWithAtomLayoutView:(id)a3 representedObject:(id)a4
{
  id v7;
  id v8;
  _MFAtomAttachment *v9;
  _MFAtomAttachment *v10;
  _MFAtomAttachment *v11;
  objc_super v13;
  ...
  v9 = -[_MFAtomAttachment initWithData:ofType:](&v13, sel_initWithData_ofType_, 0, 0);
  v10 = v9;
  if (v9)
  {
