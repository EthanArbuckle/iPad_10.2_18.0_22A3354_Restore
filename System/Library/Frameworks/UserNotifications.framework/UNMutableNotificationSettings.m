...
{
  UNNotificationSettings *v4;
  uint64_t v6;

  v4 = +[UNNotificationSettings allocWithZone:](UNNotificationSettings, "allocWithZone:", a3);
  LOBYTE(v6) = self->super._providesAppNotificationSettings;
  return -[UNNotificationSettings initWithAuthorizationStatus:soundSetting:badgeSetting:alertSetting:notificationCenterSetting:lockScreenSetting:carPlaySetting:remoteNotificationsSetting:announcementSetting:criticalAlertSetting:timeSensitiveSetting:scheduledDeliverySetting:directMessagesSetting:alertStyle:showPreviewsSetting:groupingSetting:providesAppNotificationSettings:](v4, "initWithAuthorizationStatus:soundSetting:badgeSetting:alertSetting:notificationCenterSetting:lockScreenSetting:carPlaySetting:remoteNotificationsSetting:announcementSetting:criticalAlertSetting:timeSensitiveSetting:scheduledDeliverySetting:directMessagesSetting:alertStyle:showPreviewsSetting:groupingSetting:providesAppNotificationSettings:", self->super._authorizationStatus, self->super._soundSetting, self->super._badgeSetting, self->super._alertSetting, self->super._notificationCenterSetting, self->super._lockScreenSetting, self->super._carPlaySetting, self->super._remoteNotificationsSetting, self->super._announcementSetting, self->super._criticalAlertSetting, self->super._timeSensitiveSetting, self->super._scheduledDeliverySetting, self->super._directMessagesSetting, self->super._alertStyle, self->super._showPreviewsSetting,
