...
{
  VSIdentityProviderAppsResponse *v2;
  void *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)VSIdentityProviderAppsResponse;
  v2 = -[VSIdentityProviderAppsResponse init](&v5, sel_init);
  if (v2)
  {
...
{
  id v4;
  VSIdentityProviderAppsResponse *v5;
  void *v6;
  objc_super v8;
  ...
  v5 = -[VSIdentityProviderAppsResponse init](&v8, sel_init);
  if (v5)
  {
    VSIdentityProviderAppsResponseValueType();
