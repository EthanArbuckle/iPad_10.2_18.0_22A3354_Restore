...
{
  VSUserAccountServiceConnection *v2;
  uint64_t v3;
  ...
  v2 = -[VSUserAccountServiceConnection init](&v8, sel_init);
  if (v2)
  {
...
- (void)dealloc
{
  ...
  -[VSUserAccountServiceConnection dealloc](&v3, sel_dealloc);
}
...
- (id)serviceWithErrorHandler:(id)a3
{
  ...
  v4 = a3;
  -[VSUserAccountServiceConnection connection](self, "connection");
