...
+ (id)ruleIdentifier
{
  return CFSTR("IOSVersionGreaterThan");
}
...
LABEL_12:
  ...
  -[HKRemoteFeatureAvailabilityIOSVersionGreaterThanRule targetVersion](self, "targetVersion");
