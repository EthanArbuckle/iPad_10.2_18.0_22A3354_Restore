...
+ (id)ruleIdentifier
{
  return CFSTR("IOSBuildVersionGreaterThan");
}
...
- (void)processUserInfo:(id)a3
{
  ...
  -[HKRemoteFeatureAvailabilityIOSBuildVersionGreaterThanRule setBuildVersion:](self, "setBuildVersion:", v4);
...
- (BOOL)evaluate
{
  ...
  -[HKRemoteFeatureAvailabilityIOSBuildVersionGreaterThanRule buildVersion](self, "buildVersion");
