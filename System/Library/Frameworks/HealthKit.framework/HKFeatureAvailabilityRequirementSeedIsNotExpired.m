...
{
  return (NSString *)CFSTR("SeedIsNotExpired");
}
...
- (NSString)requirementDescription
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("The developer seed must not have expired for %@"), v3);
...
{
  return (id)objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", (objc_msgSend(a3, "ineligibilityReasons") & 0x80) == 0);
}
