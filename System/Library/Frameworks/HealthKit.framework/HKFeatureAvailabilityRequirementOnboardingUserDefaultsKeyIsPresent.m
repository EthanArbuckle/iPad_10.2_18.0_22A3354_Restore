...
{
  return CFSTR("OnboardingUserDefaultsKeyIsPresent");
}
...
- (id)requirementDescription
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("The value of the onboarding user defaults key %@ must not be nil"), v3);
