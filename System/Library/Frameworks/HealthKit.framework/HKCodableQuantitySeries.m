...
- (id)description
{
  ...
  -[HKCodableQuantitySeries description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HKCodableQuantitySeries dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HKCodableQuantitySeries valuesCount](self, "valuesCount"))
  {
    objc_msgSend(v8, "clearValues");
    v4 = -[HKCodableQuantitySeries valuesCount](self, "valuesCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HKCodableQuantitySeries valuesAtIndex:](self, "valuesAtIndex:", i);
        v7 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v8, "addValues:", v7);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HKCodableQuantitySeries addValues:](self, "addValues:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
