...
+ (id)ruleIdentifier
{
  return CFSTR("WatchOSBuildVersionLessThan");
}
...
- (void)processUserInfo:(id)a3
{
  ...
  -[HKRemoteFeatureAvailabilityWatchOSBuildVersionLessThanRule setBuildVersion:](self, "setBuildVersion:", v4);
...
- (BOOL)evaluate
{
  ...
  -[HKRemoteFeatureAvailabilityWatchOSBuildVersionLessThanRule buildVersion](self, "buildVersion");
