...
{
  objc_msgSend(a3, "fetchPluginServiceEndpointForIdentifier:endpointHandler:errorHandler:", a4, a5, a6);
}

- (id)proxyServiceEndpointFromSource:(id)a3 serviceIdentifier:(id)a4 error:(id *)a5
{
  return (id)objc_msgSend(a3, "pluginServiceEndpointForIdentifier:error:", a4, a5);
}
