...
+ (id)ruleIdentifier
{
  return CFSTR("WatchAtrialFibrillationDetectionVersionLessThan");
}
...
- (void)processUserInfo:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v5 = v7;
    v6 = v8;
    -[HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionLessThanRule setTargetVersion:](self, "setTargetVersion:", &v5);
  }
...
LABEL_15:
  ...
  if (!v8)
  {
    -[HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionLessThanRule targetVersion](self, "targetVersion");
    -[HKRemoteFeatureAvailabilityBaseRule dataSource](self, "dataSource");
