...
{
  return (NSString *)CFSTR("HeightIsPresent");
}

- (NSString)requirementDescription
{
  return (NSString *)CFSTR("A height sample must be added in either Health Details or Health App > Browse > Body Measurements > Height > Add Data");
}
...
- (id)isSatisfiedWithDataSource:(id)a3 error:(id *)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      -[HKFeatureAvailabilityRequirementHeightIsPresent isSatisfiedWithDataSource:error:].cold.1();
...
- (void)registerObserver:(id)a3 forDataSource:(id)a4
{
  ...
  v13[0] = v9;
  v13[1] = 3221225472;
  v13[2] = __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke_8;
  v13[3] = &unk_1E37EC480;
  v12 = v10;
  v14 = v12;
...
uint64_t __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke_8(uint64_t a1)
{
...
- (void)isSatisfiedWithDataSource:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_6(&dword_19A0E6000, v2, v3, "[%{public}@] Error while pulling height characteristic: %{public}@", v4, v5, v6, v7, v8);
