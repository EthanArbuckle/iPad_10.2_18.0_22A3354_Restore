...
+ (id)ruleIdentifier
{
  return CFSTR("WatchAtrialFibrillationDetectionVersionGreaterThan");
}
...
- (void)processUserInfo:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v5 = v7;
    v6 = v8;
    -[HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionGreaterThanRule setTargetVersion:](self, "setTargetVersion:", &v5);
  }
...
LABEL_15:
  ...
  if (!v8)
  {
    -[HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionGreaterThanRule targetVersion](self, "targetVersion");
    -[HKRemoteFeatureAvailabilityBaseRule dataSource](self, "dataSource");
