...
- (void)setWeakExportedObject:(id)a3
{
  ...
  -[_HKXPCExportedObjectProxy setWeakExportedObjectClass:](self, "setWeakExportedObjectClass:", v6);
}
...
- (id)methodSignatureForSelector:(SEL)a3
{
  ...
  -[_HKXPCExportedObjectProxy weakExportedObject](self, "weakExportedObject");
  ...
  if (!v6)
  {
    -[objc_class instanceMethodSignatureForSelector:](-[_HKXPCExportedObjectProxy weakExportedObjectClass](self, "weakExportedObjectClass"), "instanceMethodSignatureForSelector:", a3);
    v6 = (void *)objc_claimAutoreleasedReturnValue();
  }
  return v6;
}
