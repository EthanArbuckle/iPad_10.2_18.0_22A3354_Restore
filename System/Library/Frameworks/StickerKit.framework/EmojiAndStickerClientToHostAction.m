...
{
  id v4;
  _TtC10StickerKit33EmojiAndStickerClientToHostAction *v5;
...
- (_TtC10StickerKit33EmojiAndStickerClientToHostAction)initWithInfo:(id)a3 responder:(id)a4
{
  ...
  return -[EmojiAndStickerClientToHostAction initWithInfo:responder:](&v7, sel_initWithInfo_responder_, a3, a4);
}
...
- (_TtC10StickerKit33EmojiAndStickerClientToHostAction)initWithInfo:(id)a3 timeout:(double)a4 forResponseOnQueue:(id)a5 withHandler:(id)a6
{
  ...
  v11 = a3;
  v12 = a5;
  return (_TtC10StickerKit33EmojiAndStickerClientToHostAction *)sub_23470F0B8(a3, a5, (uint64_t)v9, v10, a4);
}
...
- (_TtC10StickerKit33EmojiAndStickerClientToHostAction)init
{
  ...
  return -[EmojiAndStickerClientToHostAction init](&v3, sel_init);
}

- (_TtC10StickerKit33EmojiAndStickerClientToHostAction)initWithXPCDictionary:(id)a3
{
  return (_TtC10StickerKit33EmojiAndStickerClientToHostAction *)sub_23470F2A4(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithXPCDictionary_);
}

- (_TtC10StickerKit33EmojiAndStickerClientToHostAction)initWithCoder:(id)a3
{
  return (_TtC10StickerKit33EmojiAndStickerClientToHostAction *)sub_23470F2A4(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}
