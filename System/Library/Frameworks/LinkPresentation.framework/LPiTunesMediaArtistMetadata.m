...
{
  id v4;
  LPiTunesMediaArtistMetadata *v5;
  uint64_t v6;
  ...
  LPiTunesMediaArtistMetadata *v18;
  objc_super v20;

  v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)LPiTunesMediaArtistMetadata;
  v5 = -[LPiTunesMediaArtistMetadata init](&v20, sel_init);
  if (v5)
  {
...
{
  LPiTunesMediaArtistMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  void *v10;
  LPiTunesMediaArtistMetadata *v11;

  v4 = +[LPiTunesMediaArtistMetadata allocWithZone:](LPiTunesMediaArtistMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[LPiTunesMediaArtistMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaArtistMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[LPiTunesMediaArtistMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaArtistMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[LPiTunesMediaArtistMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaArtistMetadata setName:](v4, "setName:", v7);

    -[LPiTunesMediaArtistMetadata genre](self, "genre");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaArtistMetadata setGenre:](v4, "setGenre:", v8);

    -[LPiTunesMediaArtistMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaArtistMetadata setArtwork:](v4, "setArtwork:", v9);

    -[LPiTunesMediaArtistMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaArtistMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[LPiTunesMediaArtistMetadata isEqual:](&v8, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
...
- (id)presentationPropertiesForTransformer:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "commonPresentationPropertiesForStyle:", 7);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (objc_msgSend(v4, "effectiveSizeClass") == 2)
  {
    -[LPiTunesMediaArtistMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    LPLocalizedString(CFSTR("Artist"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  -[LPiTunesMediaArtistMetadata storeIdentifier](self, "storeIdentifier", a3);
