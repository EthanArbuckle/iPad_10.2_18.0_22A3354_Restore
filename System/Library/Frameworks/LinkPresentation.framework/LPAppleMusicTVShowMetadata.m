...
- (LPAppleMusicTVShowMetadata)initWithCoder:(id)a3
{
  ...
  LPAppleMusicTVShowMetadata *v16;
  objc_super v18;

  v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)LPAppleMusicTVShowMetadata;
  v5 = -[LPAppleMusicTVShowMetadata init](&v18, sel_init);
  if (v5)
  {
...
{
  LPAppleMusicTVShowMetadata *v4;
  void *v5;
  void *v6;
  void *v7;
  void *v8;
  void *v9;
  LPAppleMusicTVShowMetadata *v10;

  v4 = +[LPAppleMusicTVShowMetadata allocWithZone:](LPAppleMusicTVShowMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[LPAppleMusicTVShowMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPAppleMusicTVShowMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[LPAppleMusicTVShowMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPAppleMusicTVShowMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[LPAppleMusicTVShowMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPAppleMusicTVShowMetadata setName:](v4, "setName:", v7);

    -[LPAppleMusicTVShowMetadata artwork](self, "artwork");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPAppleMusicTVShowMetadata setArtwork:](v4, "setArtwork:", v8);

    -[LPAppleMusicTVShowMetadata artworkMetadata](self, "artworkMetadata");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPAppleMusicTVShowMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v9);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[LPAppleMusicTVShowMetadata isEqual:](&v8, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
...
- (id)presentationPropertiesForTransformer:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "commonPresentationPropertiesForStyle:", 37);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)previewSummaryForTransformer:(id)a3
{
  ...
  LPLocalizedString(CFSTR("TV Show: %@"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  -[LPAppleMusicTVShowMetadata name](self, "name");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  -[LPAppleMusicTVShowMetadata storeIdentifier](self, "storeIdentifier", a3);
