...
{
  LPARAssetMetadata *v2;
  LPARAssetMetadata *v3;
  LPARAssetMetadata *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)LPARAssetMetadata;
  v2 = -[LPARAssetMetadata init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
    v2->_version = 1;
...
{
  id v5;
  LPARAssetMetadata *v6;
  LPARAssetMetadata *v7;
  LPARAssetMetadata *v8;

  v5 = a3;
  v6 = -[LPARAssetMetadata init](self, "init");
  v7 = v6;
  if (v6)
  {
...
- (id)_initWithDictionary:(id)a3
{
  ...
  LPARAssetMetadata *v12;

  v4 = a3;
  v5 = -[LPARAssetMetadata init](self, "init");
  if (v5
    && (URLForKey(v4, (uint64_t)CFSTR("LPMetadataARAssetURL")),
...
- (LPARAssetMetadata)initWithCoder:(id)a3
{
  ...
  v5 = -[LPARAssetMetadata init](&v14, sel_init);
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[LPARAssetMetadata isEqual:](&v9, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
