...
- (LPiTunesMediaAlbumMetadata)initWithCoder:(id)a3
{
  ...
  uint64_t v18;
  NSArray *offers;
  LPiTunesMediaAlbumMetadata *v20;
  objc_super v22;

  v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)LPiTunesMediaAlbumMetadata;
  v5 = -[LPiTunesMediaAlbumMetadata init](&v22, sel_init);
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  void *v10;
  void *v11;
  LPiTunesMediaAlbumMetadata *v12;

  v4 = +[LPiTunesMediaAlbumMetadata allocWithZone:](LPiTunesMediaAlbumMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[LPiTunesMediaAlbumMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[LPiTunesMediaAlbumMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[LPiTunesMediaAlbumMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setName:](v4, "setName:", v7);

    -[LPiTunesMediaAlbumMetadata artist](self, "artist");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setArtist:](v4, "setArtist:", v8);

    -[LPiTunesMediaAlbumMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setArtwork:](v4, "setArtwork:", v9);

    -[LPiTunesMediaAlbumMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);

    -[LPiTunesMediaAlbumMetadata offers](self, "offers");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaAlbumMetadata setOffers:](v4, "setOffers:", v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[LPiTunesMediaAlbumMetadata isEqual:](&v8, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
...
- (id)presentationPropertiesForTransformer:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "commonPresentationPropertiesForStyle:", 6);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (!v12)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    storefrontIdentifierFromURL(v9);
    v13 = (void *)objc_claimAutoreleasedReturnValue();
  }
  -[LPiTunesMediaAlbumMetadata offers](self, "offers");
  v14 = (void *)objc_claimAutoreleasedReturnValue();
  +[LPInlineMediaPlaybackInformation albumPlaybackInformationWithStoreIdentifier:storefrontIdentifier:offers:](LPInlineMediaPlaybackInformation, "albumPlaybackInformationWithStoreIdentifier:storefrontIdentifier:offers:", v11, v13, v14);
  ...
  objc_msgSend(v5, "setInlinePlaybackInformation:", v15);
...
{
  -[LPiTunesMediaAlbumMetadata storeIdentifier](self, "storeIdentifier", a3);
