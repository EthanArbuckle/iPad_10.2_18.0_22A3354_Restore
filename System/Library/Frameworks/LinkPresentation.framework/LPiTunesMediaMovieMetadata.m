...
- (LPiTunesMediaMovieMetadata)initWithCoder:(id)a3
{
  ...
  LPiTunesMediaMovieMetadata *v18;
  objc_super v20;

  v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)LPiTunesMediaMovieMetadata;
  v5 = -[LPiTunesMediaMovieMetadata init](&v20, sel_init);
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  void *v9;
  void *v10;
  LPiTunesMediaMovieMetadata *v11;

  v4 = +[LPiTunesMediaMovieMetadata allocWithZone:](LPiTunesMediaMovieMetadata, "allocWithZone:", a3);
  if (v4)
  {
    -[LPiTunesMediaMovieMetadata storeFrontIdentifier](self, "storeFrontIdentifier");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaMovieMetadata setStoreFrontIdentifier:](v4, "setStoreFrontIdentifier:", v5);

    -[LPiTunesMediaMovieMetadata storeIdentifier](self, "storeIdentifier");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaMovieMetadata setStoreIdentifier:](v4, "setStoreIdentifier:", v6);

    -[LPiTunesMediaMovieMetadata name](self, "name");
    v7 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaMovieMetadata setName:](v4, "setName:", v7);

    -[LPiTunesMediaMovieMetadata genre](self, "genre");
    v8 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaMovieMetadata setGenre:](v4, "setGenre:", v8);

    -[LPiTunesMediaMovieMetadata artwork](self, "artwork");
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaMovieMetadata setArtwork:](v4, "setArtwork:", v9);

    -[LPiTunesMediaMovieMetadata artworkMetadata](self, "artworkMetadata");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    -[LPiTunesMediaMovieMetadata setArtworkMetadata:](v4, "setArtworkMetadata:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (-[LPiTunesMediaMovieMetadata isEqual:](&v8, sel_isEqual_, v4))
  {
    v5 = 1;
  }
  else
...
{
  -[LPiTunesMediaMovieMetadata storeIdentifier](self, "storeIdentifier", a3);
