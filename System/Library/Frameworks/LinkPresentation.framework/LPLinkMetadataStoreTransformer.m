...
- (LPLinkMetadataStoreTransformer)initWithMetadata:(id)a3 URL:(id)a4
{
  id v7;
  id v8;
  LPLinkMetadataStoreTransformer *v9;
  LPLinkMetadataStoreTransformer *v10;
  LPLinkMetadataStoreTransformer *v11;
  objc_super v13;
  ...
  v9 = -[LPLinkMetadataStoreTransformer init](&v13, sel_init);
  v10 = v9;
  if (v9)
  {
...
- (id)storeIdentifier
{
  ...
  if (v3)
  {
    ...
    if ((objc_msgSend(v5, "conformsToProtocol:", &unk_1EE5E8748) & 1) == 0)
    {
    ...
    if ((v7 & 1) != 0)
    {
      ...
      objc_msgSend(v4, "storeIdentifierForTransformer:", self);
