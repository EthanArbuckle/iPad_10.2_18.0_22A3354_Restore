...
- (CLSensorRecorderRecordSensorTypeFor)initWithCoder:(id)a3
{
  ...
  uint64_t v5;
  uint64_t v6;
  CLSensorRecorderRecordSensorTypeFor *v7;
  const char *v8;
  uint64_t v9;
  uint64_t v10;
  objc_super v12;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CLSensorRecorderRecordSensorTypeFor;
  v7 = -[CLSensorRecorderRecordSensorTypeFor init](&v12, sel_init);
  if (v7)
  {
