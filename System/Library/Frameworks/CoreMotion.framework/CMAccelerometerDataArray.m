...
- (CMAccelerometerDataArray)initWithBinarySampleRepresentation:(id)a3 metadata:(id)a4 timestamp:(double)a5
{
  ...
  uint64_t v51;
  unsigned int v52;
  CMRecordedAccelerometerData *v53;
  const char *v54;
  uint64_t v55;
  uint64_t v56;
  uint64_t v57;
  ...
  if (objc_msgSend_length(a3, a2, (uint64_t)a3, (uint64_t)a4, v5, a5))
  {
    ...
    if (objc_msgSend_dataSize(v12, v48, v49, v50, v51))
    {
      ...
      do
      {
        ...
        v77[1] = 0;
        v78 = 0;
        sub_18F4C01DC((int *)&v80, &v79, (uint64_t)v77);
        v52 += v79;
        v53 = [CMRecordedAccelerometerData alloc];
    ...
    return (CMAccelerometerDataArray *)objc_msgSend_initWithArray_(v72, v73, (uint64_t)v47, v74, v75);
  }
  else
  {
