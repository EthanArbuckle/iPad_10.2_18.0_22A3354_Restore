...
- (CLSensorRecorderSensorMetaRequestByDateRange)initWithCoder:(id)a3
{
  ...
  uint64_t v5;
  uint64_t v6;
  CLSensorRecorderSensorMetaRequestByDateRange *v7;
  double v8;
  const char *v9;
  uint64_t v10;
  uint64_t v11;
  ...
  v17.receiver = self;
  v17.super_class = (Class)CLSensorRecorderSensorMetaRequestByDateRange;
  v7 = -[CLSensorRecorderSensorMetaRequestByDateRange init](&v17, sel_init);
  if (v7)
  {
