...
{
  CMAudioAccessoryManagerInternal *v2;
  CMAudioAccessoryManagerInternal *v3;
  Dispatcher *value;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)CMAudioAccessoryManagerInternal;
  v2 = -[CMAudioAccessoryManagerInternal init](&v6, sel_init);
  v3 = v2;
  if (v2)
  {
...
{
  *((_QWORD *)self + 34) = 0;
  *((_QWORD *)self + 35) = 0x3F80000000000000;
  *((_QWORD *)self + 39) = 0;
  return self;
}
