...
- (CMGyroData)initWithRotationRate:(id)a3 andTimestamp:(double)a4
{
  ...
  var0 = a3.var0;
  v17.receiver = self;
  v17.super_class = (Class)CMGyroData;
...
- (CMGyroData)initWithCoder:(id)a3
{
  ...
  v29.receiver = self;
  v29.super_class = (Class)CMGyroData;
  v4 = -[CMLogItem initWithCoder:](&v29, sel_initWithCoder_);
  if (v4)
  {
    v5 = [CMGyroDataInternal alloc];
    v4->_internal = v5;
    objc_msgSend_decodeDoubleForKey_(a3, v6, (uint64_t)CFSTR("kCMRotationRateCodingKeyX"), v7, v8);
    v10 = v9;
    objc_msgSend_decodeDoubleForKey_(a3, v11, (uint64_t)CFSTR("kCMRotationRateCodingKeyY"), v12, v13);
    v15 = v14;
    objc_msgSend_decodeDoubleForKey_(a3, v16, (uint64_t)CFSTR("kCMRotationRateCodingKeyZ"), v17, v18);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeDouble_forKey_(a3, v8, (uint64_t)CFSTR("kCMRotationRateCodingKeyX"), v9, v10, (float)(internal[2] * 0.017453));
  objc_msgSend_encodeDouble_forKey_(a3, v11, (uint64_t)CFSTR("kCMRotationRateCodingKeyY"), v12, v13, v6);
  objc_msgSend_encodeDouble_forKey_(a3, v14, (uint64_t)CFSTR("kCMRotationRateCodingKeyZ"), v15, v16, v7);
}
...
- (id)description
{
  ...
  v6 = internal[4];
  v12.receiver = self;
  v12.super_class = (Class)CMGyroData;
