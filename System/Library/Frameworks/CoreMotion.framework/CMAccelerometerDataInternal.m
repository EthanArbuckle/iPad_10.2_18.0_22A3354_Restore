...
- (CMAccelerometerDataInternal)initWithAcceleration:(id)a3
{
  ...
  float var1;
  float var0;
  CMAccelerometerDataInternal *v6;
  const char *v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  ...
  double v12;
  double v13;
  CMAccelerometerDataInternal *v14;
  objc_super v16;
  ...
  var0 = a3.var0;
  v16.receiver = self;
  v16.super_class = (Class)CMAccelerometerDataInternal;
  v6 = -[CMAccelerometerDataInternal init](&v16, sel_init);
  v14 = v6;
  if (v6)
  {
    *(float *)&v11 = var0;
    *(float *)&v12 = var1;
    *(float *)&v13 = var2;
    objc_msgSend_setAcceleration_(v6, v7, v8, v9, v10, v11, v12, v13);
  }
  return v14;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (result)
  {
    v15 = *(_QWORD *)&self->fAcceleration.x;
