...
- (LAPasscodeVerificationService)init
{
  ...
  LAPasscodeVerificationService *v4;

  v3 = objc_alloc_init(LAPSPasscodeChangeControllerProvider);
  v4 = -[LAPasscodeVerificationService initWithControllerBuilder:](self, "initWithControllerBuilder:", v3);
...
{
  id v5;
  LAPasscodeVerificationService *v6;
  LAPasscodeVerificationService *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)LAPasscodeVerificationService;
  v6 = -[LAPasscodeVerificationService init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (void)startInParentVC:(id)a3 completion:(id)a4
{
  id v6;
  id v7;
  LAPasscodeVerificationServiceOptions *v8;

  v6 = a4;
  v7 = a3;
  v8 = objc_alloc_init(LAPasscodeVerificationServiceOptions);
  -[LAPasscodeVerificationService startInParentVC:options:completion:](self, "startInParentVC:options:completion:", v7, v8, v6);
...
- (void)startInParentVC:(id)a3 options:(id)a4 completion:(id)a5
{
  ...
  id v24;
  uint8_t buf[4];
  LAPasscodeVerificationService *v26;
  __int16 v27;
  id v28;
  __int16 v29;
  id v30;
  ...
  v15 = v9;
  v24 = v15;
  __68__LAPasscodeVerificationService_startInParentVC_options_completion___block_invoke((uint64_t)v22);
  v16 = (void *)objc_claimAutoreleasedReturnValue();
  -[LAPSPasscodeChangeControllerProviding passcodeVerificationControllerWithOptions:](builder, "passcodeVerificationControllerWithOptions:", v16);
  ...
  v18 = v10;
  v20 = v18;
  -[LAPasscodeVerificationService _startOperation:completion:](self, "_startOperation:completion:", v17, v19);
...
LAPSPasscodeChangeControllerProviderOptions *__68__LAPasscodeVerificationService_startInParentVC_options_completion___block_invoke(uint64_t a1)
{
  ...
  {
    +[LALocalizedString passcodeVerificationTitle](LALocalizedString, "passcodeVerificationTitle");
  ...
  {
    +[LALocalizedString passcodeVerificationPrompt](LALocalizedString, "passcodeVerificationPrompt");
    v6 = (void *)objc_claimAutoreleasedReturnValue();
    -[LAPSPasscodeChangeControllerProviderOptions setOldPasscodePrompt:](v2, "setOldPasscodePrompt:", v6);

  }
  -[LAPSPasscodeChangeControllerProviderOptions setDismissUIAfterCompletion:](v2, "setDismissUIAfterCompletion:", objc_msgSend(*(id *)(a1 + 40), "dismissUIAfterCompletion"));
  return v2;
}
...
- (void)cancel
{
  ...
  v2 = 138543362;
  v3 = a1;
  _os_log_error_impl(&dword_22FE91000, a2, OS_LOG_TYPE_ERROR, "%{public}@ will cancel", (uint8_t *)&v2, 0xCu);
}
