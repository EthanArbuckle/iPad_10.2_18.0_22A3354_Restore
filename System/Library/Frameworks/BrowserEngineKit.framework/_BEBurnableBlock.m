...
- (_BEBurnableBlock)initWithTimeout:(double)a3 block:(id)a4 defaultInputProvider:(id)a5
{
  id v8;
  id v9;
  _BEBurnableBlock *v10;
  void *v11;
  id block;
  NSObject *v13;
  dispatch_time_t v14;
  _BEBurnableBlock *v15;
  OS_dispatch_source *timer;
  NSObject *v17;
  _QWORD v19[4];
  _BEBurnableBlock *v20;
  id v21;
  objc_super v22;
  ...
  v10 = -[_BEBurnableBlock init](&v22, sel_init);
  if (v10)
  {
    v11 = _Block_copy(v8);
    block = v10->_block;
...
- (BOOL)performWithInput:(id)a3
{
  ...
  v4 = a3;
  -[_BEBurnableBlock _cancelTimerIfNeeded](self, "_cancelTimerIfNeeded");
...
- (void)dealloc
{
  ...
  -[_BEBurnableBlock dealloc](&v3, sel_dealloc);
}
