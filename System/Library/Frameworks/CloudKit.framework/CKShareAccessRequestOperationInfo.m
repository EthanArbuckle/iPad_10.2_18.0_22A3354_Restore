...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_shareURLsToRequestAccessFor(self, v6, v7, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_encodeObject_forKey_(v4, v10, (uint64_t)v9, (uint64_t)CFSTR("ShareURLsToRequestAccessFor"));
...
{
  id v4;
  CKShareAccessRequestOperationInfo *v5;
  void *v6;
  void *v7;
  const char *v8;
  void *v9;
  ...
  if (v5)
  {
    ...
    objc_msgSend_decodeObjectOfClasses_forKey_(v4, v13, (uint64_t)v12, (uint64_t)CFSTR("ShareURLsToRequestAccessFor"));
