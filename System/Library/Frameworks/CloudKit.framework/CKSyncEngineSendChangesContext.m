...
{
  id v7;
  CKSyncEngineSendChangesContext *v8;
  CKSyncEngineSendChangesContext *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)CKSyncEngineSendChangesContext;
  v8 = -[CKSyncEngineSendChangesContext init](&v11, sel_init);
  v9 = v8;
  if (v8)
  {
    v8->_reason = a3;
...
{
  return (id)((uint64_t (*)(CKSyncEngineSendChangesContext *, char *))MEMORY[0x1E0DE7D20])(self, sel_CKRedactedDescription);
}
...
{
  return CFSTR("SendChangesContext");
}

- (NSString)description
{
  return (NSString *)((uint64_t (*)(CKSyncEngineSendChangesContext *, char *))MEMORY[0x1E0DE7D20])(self, sel_CKUnredactedDescription);
}
