...
- (void)setFetchRegisteredBundleIDsCompletionBlock:(id)a3
{
    ...
    && !dispatch_get_specific(kCKOperationCallbackQueueName))
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_18A7D58DC;
    block[3] = &unk_1E1F5F730;
    block[4] = self;
    v16 = v14;
    dispatch_sync(v13, block);

    fetchRegisteredBundleIDsCompletionBlock = v16;
    goto LABEL_9;
  }
  v10 = v14;
  if (self->_fetchRegisteredBundleIDsCompletionBlock != v14)
  {
    ...
    self->_fetchRegisteredBundleIDsCompletionBlock = v11;
LABEL_9:
...
- (BOOL)hasCKOperationCallbacksSet
{
  ...
  if (-[CKOperation hasCKOperationCallbacksSet](&v9, sel_hasCKOperationCallbacksSet))
    return 1;
  objc_msgSend_fetchRegisteredBundleIDsCompletionBlock(self, v3, v4, v5);
...
- (void)_finishOnCallbackQueueWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_18A5C5000, v15, OS_SIGNPOST_EVENT, v21, "CKFetchRegisteredBundleIDsOperation", "Finishing", buf, 2u);
    }

  }
  objc_msgSend_fetchRegisteredBundleIDsCompletionBlock(self, v7, v8, v9);
...
- (void)ckSignpostEndWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v18 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v12))
    {
      v19 = 138412290;
      v20 = v4;
      _os_signpost_emit_with_name_impl(&dword_18A5C5000, v12, OS_SIGNPOST_INTERVAL_END, v18, "CKFetchRegisteredBundleIDsOperation", "Error=%{signpost.description:attribute}@ ", (uint8_t *)&v19, 0xCu);
    }
