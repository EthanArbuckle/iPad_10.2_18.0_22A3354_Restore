...
- (CKMarkNotificationsReadOperation)initWithNotificationIDsToMarkRead:(NSArray *)notificationIDs
{
  ...
  return -[CKOperation init](&v4, sel_init, notificationIDs);
}
...
- (void)_finishOnCallbackQueueWithError:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend_markNotificationsReadCompletionBlock(self, v5, v6, v7);
...
{
  objc_setProperty_nonatomic_copy(self, a2, notificationIDs, 504);
}
...
{
  objc_setProperty_nonatomic_copy(self, a2, markNotificationsReadCompletionBlock, 512);
}
