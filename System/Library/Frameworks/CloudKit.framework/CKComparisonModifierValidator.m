...
{
  CKComparisonModifierValidator *v4;
  const char *v5;
  uint64_t v6;
  objc_super v8;
  ...
  v4 = -[CKComparisonModifierValidator init](&v8, sel_init);
...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  v18 = objc_msgSend_comparisonPredicateModifier(v6, v8, v9, v10);
  v22 = objc_msgSend_modifier(self, v19, v20, v21);
  v26 = v18 == v22;
  if (a4 && v18 != v22)
  {
    ...
    v29 = objc_msgSend_comparisonPredicateModifier(v6, v23, v24, v25);
    sub_18A7D2C50(v29, v30, v31, v32);
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_stringWithFormat_(v28, v34, (uint64_t)CFSTR("Unsupported predicate modifier: %@"), v35, v33);
...
- (id)CKPropertiesDescription
{
  ...
  v5 = objc_msgSend_modifier(self, a2, v2, v3);
  sub_18A7D2C50(v5, v6, v7, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v4, v10, (uint64_t)CFSTR("modifier=%@"), v11, v9);
