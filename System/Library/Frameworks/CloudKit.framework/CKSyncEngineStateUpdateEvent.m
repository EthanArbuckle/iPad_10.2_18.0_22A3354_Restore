...
- (CKSyncEngineStateUpdateEvent)initWithStateSerialization:(id)a3
{
  ...
  id v7;
  id *v8;
  CKSyncEngineStateUpdateEvent *v9;
  void *v11;
  CKException *v12;
  const char *v13;
  uint64_t v14;
  ...
  v5 = a3;
  v24 = 0;
  v6 = _CKCheckArgument((uint64_t)"serialization", v5, 0, 0, 0, &v24);
  v7 = v24;
  if ((v6 & 1) == 0)
  {
    v11 = v7;
...
- (void)CKDescribePropertiesUsing:(id)a3
{
  ...
  objc_msgSend_stateSerialization(self, v5, v6, v7, v10.receiver, v10.super_class);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_addProperty_value_shouldRedact_(v4, v9, (uint64_t)CFSTR("stateSerialization"), (uint64_t)v8, 0);
