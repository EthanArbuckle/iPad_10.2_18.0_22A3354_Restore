...
- (void)setFetchUserQuotaCompletionBlock:(id)a3
{
    ...
    && !dispatch_get_specific(kCKOperationCallbackQueueName))
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_18A813730;
    block[3] = &unk_1E1F5F730;
    block[4] = self;
    v16 = v14;
    dispatch_sync(v13, block);

    fetchUserQuotaCompletionBlock = v16;
    goto LABEL_9;
  }
  v10 = v14;
  if (self->_fetchUserQuotaCompletionBlock != v14)
  {
    v11 = (void *)objc_msgSend_copy(v14, v7, v8, v9);
    fetchUserQuotaCompletionBlock = self->_fetchUserQuotaCompletionBlock;
    self->_fetchUserQuotaCompletionBlock = v11;
LABEL_9:
...
- (BOOL)hasCKOperationCallbacksSet
{
  ...
  if (-[CKOperation hasCKOperationCallbacksSet](&v9, sel_hasCKOperationCallbacksSet))
    return 1;
  objc_msgSend_fetchUserQuotaCompletionBlock(self, v3, v4, v5);
...
- (void)handleOperationDidCompleteWithQuotaAvailable:(unint64_t)a3 metrics:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled((os_log_t)ck_log_facility_ck, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    v24 = 2048;
    v25 = a3;
    _os_log_debug_impl(&dword_18A5C5000, v16, OS_LOG_TYPE_DEBUG, "Received completion callback for operation %{public}@ with quota %llu;",
      buf,
      0x16u);
  ...
  -[CKOperation handleOperationDidCompleteWithMetrics:error:](&v21, sel_handleOperationDidCompleteWithMetrics_error_, v9, v8);
...
- (void)_finishOnCallbackQueueWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_18A5C5000, v15, OS_SIGNPOST_EVENT, v21, "CKFetchUserQuotaOperation", "Finishing", buf, 2u);
    }

  }
  objc_msgSend_fetchUserQuotaCompletionBlock_wrapper(self, v7, v8, v9);
  ...
  {
    objc_msgSend_fetchUserQuotaCompletionBlock(self, v23, v24, v25);
  ...
  if (v27)
  {
    v32 = objc_msgSend_quotaAvailable(self, v29, v30, v31);
    objc_msgSend_CKClientSuitableError(v4, v33, v34, v35);
...
- (void)ckSignpostEndWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v18 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v12))
    {
      v19 = 138412290;
      v20 = v4;
      _os_signpost_emit_with_name_impl(&dword_18A5C5000, v12, OS_SIGNPOST_INTERVAL_END, v18, "CKFetchUserQuotaOperation", "Error=%{signpost.description:attribute}@ ", (uint8_t *)&v19, 0xCu);
    }
...
- (id)activityCreate
{
  return _os_activity_create(&dword_18A5C5000, "client/fetch-user-quota", MEMORY[0x1E0C80FC8], OS_ACTIVITY_FLAG_DEFAULT);
}
