...
{
  CKCompoundTypePredicateValidator *v4;
  const char *v5;
  uint64_t v6;
  objc_super v8;
  ...
  v4 = -[CKCompoundTypePredicateValidator init](&v8, sel_init);
...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  v18 = objc_msgSend_compoundPredicateType(v6, v8, v9, v10);
  ...
  if (a4 && v18 != v22)
  {
    ...
    v29 = objc_msgSend_compoundPredicateType(v6, v23, v24, v25);
    sub_18A7D10A4(v29, v30, v31, v32);
    v33 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend_stringWithFormat_(v28, v34, (uint64_t)CFSTR("Invalid compound predicate type %@: <%@>"), v35, v33, v6);
...
- (id)CKPropertiesDescription
{
  ...
  sub_18A7D10A4(v5, v6, v7, v8);
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend_stringWithFormat_(v4, v10, (uint64_t)CFSTR("type=%@"), v11, v9);
