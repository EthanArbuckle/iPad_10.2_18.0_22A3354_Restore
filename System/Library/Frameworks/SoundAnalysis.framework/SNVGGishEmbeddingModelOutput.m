...
- (SNVGGishEmbeddingModelOutput)initWithOutput1:(id)a3
{
  ...
  SNVGGishEmbeddingModelOutput *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SNVGGishEmbeddingModelOutput;
  v6 = -[SNVGGishEmbeddingModelOutput init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E97DA7A0);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("output1")))
  {
    ...
    -[SNVGGishEmbeddingModelOutput output1](self, "output1");
