...
{
  id v5;
  SNSoundPrintKEmbeddingModelInput *v6;
  ...
  v6 = -[SNSoundPrintKEmbeddingModelInput init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E97DA998);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("audioSamples")))
  {
    ...
    -[SNSoundPrintKEmbeddingModelInput audioSamples](self, "audioSamples");
