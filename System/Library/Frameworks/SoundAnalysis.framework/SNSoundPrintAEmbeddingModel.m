...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("SNSoundPrintAEmbeddingModel"), CFSTR("mlmodelc"));
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1D42A7000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Could not load SNSoundPrintAEmbeddingModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
{
  id v5;
  SNSoundPrintAEmbeddingModel *v6;
  SNSoundPrintAEmbeddingModel *v7;
  SNSoundPrintAEmbeddingModel *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[SNSoundPrintAEmbeddingModel init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
{
  void *v3;
  SNSoundPrintAEmbeddingModel *v4;

  objc_msgSend((id)objc_opt_class(), "URLOfModelInThisBundle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[SNSoundPrintAEmbeddingModel initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (SNSoundPrintAEmbeddingModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[SNSoundPrintAEmbeddingModel initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (SNSoundPrintAEmbeddingModel)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[SNSoundPrintAEmbeddingModel initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (SNSoundPrintAEmbeddingModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[SNSoundPrintAEmbeddingModel initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[SNSoundPrintAEmbeddingModel predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  SNSoundPrintAEmbeddingModelOutput *v12;
  void *v13;
  void *v14;
  SNSoundPrintAEmbeddingModelOutput *v15;

  v8 = a4;
  v9 = a3;
  -[SNSoundPrintAEmbeddingModel model](self, "model");
  ...
  if (v11)
  {
    ...
    objc_msgSend(v11, "featureValueForName:", CFSTR("637"));
    v13 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v13, "multiArrayValue");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = -[SNSoundPrintAEmbeddingModelOutput initWith_637:](v12, "initWith_637:", v14);
...
- (id)predictionFromAudioSamples:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = -[SNSoundPrintAEmbeddingModelInput initWithAudioSamples:]([SNSoundPrintAEmbeddingModelInput alloc], "initWithAudioSamples:", v6);

  -[SNSoundPrintAEmbeddingModel predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  SNSoundPrintAEmbeddingModelOutput *v16;
  void *v17;
  void *v18;
  SNSoundPrintAEmbeddingModelOutput *v19;
  id v21;
  id v22;
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        objc_msgSend(v15, "featureValueForName:", CFSTR("637"));
        v17 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v17, "multiArrayValue");
        v18 = (void *)objc_claimAutoreleasedReturnValue();
        v19 = -[SNSoundPrintAEmbeddingModelOutput initWith_637:](v16, "initWith_637:", v18);
