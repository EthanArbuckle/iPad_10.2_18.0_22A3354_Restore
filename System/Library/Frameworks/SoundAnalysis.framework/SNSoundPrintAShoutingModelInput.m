...
{
  return -[SNSoundPrintAShoutingModelInput initWithInput1:stateIn:detectedHistoryIn:](self, "initWithInput1:stateIn:detectedHistoryIn:", a3, 0, 0);
}
...
- (SNSoundPrintAShoutingModelInput)initWithInput1:(id)a3 stateIn:(id)a4 detectedHistoryIn:(id)a5
{
  ...
  id v10;
  id v11;
  SNSoundPrintAShoutingModelInput *v12;
  ...
  v12 = -[SNSoundPrintAShoutingModelInput init](&v15, sel_init);
  v13 = v12;
  if (v12)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E97DA8A8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isEqualToString:", CFSTR("input1")))
  {
    ...
    {
      -[SNSoundPrintAShoutingModelInput stateIn](self, "stateIn");
...
LABEL_9:
    ...
    else
    {
      ...
      -[SNSoundPrintAShoutingModelInput detectedHistoryIn](self, "detectedHistoryIn");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      if (v6)
      {
        v8 = (void *)MEMORY[0x1E0C9E918];
  ...
  -[SNSoundPrintAShoutingModelInput input1](self, "input1");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
