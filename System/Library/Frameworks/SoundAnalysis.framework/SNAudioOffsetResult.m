...
{
  SNAudioOffsetResult.offset.setter(a3);
}
...
{
  SNAudioOffsetResult.confidence.setter(a3);
}

- (SNAudioOffsetResult)init
{
  return (SNAudioOffsetResult *)sub_1D4465190();
}

- (id)copyWithZone:(void *)a3
{
  SNAudioOffsetResult *v3;
  void *v4;
  _QWORD v6[4];
...
- (BOOL)isEqual:(id)a3
{
  SNAudioOffsetResult *v4;
  SNAudioOffsetResult *v5;
  BOOL v6;
  _OWORD v8[2];
  ...
  v6 = SNAudioOffsetResult.isEqual(_:)((uint64_t)v8);
