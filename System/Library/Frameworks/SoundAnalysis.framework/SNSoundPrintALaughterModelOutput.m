...
- (SNSoundPrintALaughterModelOutput)initWithInput_1:(id)a3 Confidence:(id)a4 Detected:(id)a5 detectedHistoryOut:(id)a6
{
  ...
  id v13;
  id v14;
  SNSoundPrintALaughterModelOutput *v15;
  ...
  v15 = -[SNSoundPrintALaughterModelOutput init](&v18, sel_init);
  v16 = v15;
  if (v15)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E97DA980);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToString:", CFSTR("input_1")))
  {
    ...
    -[SNSoundPrintALaughterModelOutput input](self, "input");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("Confidence")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[SNSoundPrintALaughterModelOutput Confidence](self, "Confidence");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("Detected")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[SNSoundPrintALaughterModelOutput Detected](self, "Detected");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  else
  {
    ...
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[SNSoundPrintALaughterModelOutput detectedHistoryOut](self, "detectedHistoryOut");
    v6 = objc_claimAutoreleasedReturnValue();
  }
  v7 = (void *)v6;
