...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("SNSoundPrintALaughterModel"), CFSTR("mlmodelc"));
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1D42A7000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Could not load SNSoundPrintALaughterModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
{
  id v5;
  SNSoundPrintALaughterModel *v6;
  SNSoundPrintALaughterModel *v7;
  SNSoundPrintALaughterModel *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[SNSoundPrintALaughterModel init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
{
  void *v3;
  SNSoundPrintALaughterModel *v4;

  objc_msgSend((id)objc_opt_class(), "URLOfModelInThisBundle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[SNSoundPrintALaughterModel initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (SNSoundPrintALaughterModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[SNSoundPrintALaughterModel initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (SNSoundPrintALaughterModel)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[SNSoundPrintALaughterModel initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (SNSoundPrintALaughterModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[SNSoundPrintALaughterModel initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[SNSoundPrintALaughterModel predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  SNSoundPrintALaughterModelOutput *v12;
  void *v13;
  void *v14;
  void *v15;
  void *v16;
  ...
  void *v19;
  void *v20;
  SNSoundPrintALaughterModelOutput *v21;

  v8 = a4;
  v9 = a3;
  -[SNSoundPrintALaughterModel model](self, "model");
  ...
  if (v11)
  {
    ...
    v21 = -[SNSoundPrintALaughterModelOutput initWithInput_1:Confidence:Detected:detectedHistoryOut:](v12, "initWithInput_1:Confidence:Detected:detectedHistoryOut:", v14, v16, v18, v20);
...
- (id)predictionFromInput1:(id)a3 stateIn:(id)a4 detectedHistoryIn:(id)a5 error:(id *)a6
{
  ...
  v11 = a4;
  v12 = a3;
  v13 = -[SNSoundPrintALaughterModelInput initWithInput1:stateIn:detectedHistoryIn:]([SNSoundPrintALaughterModelInput alloc], "initWithInput1:stateIn:detectedHistoryIn:", v12, v11, v10);

  -[SNSoundPrintALaughterModel predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v13, a6);
  v14 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  SNSoundPrintALaughterModelOutput *v16;
  void *v17;
  void *v18;
  void *v19;
  void *v20;
  ...
  void *v22;
  void *v23;
  SNSoundPrintALaughterModelOutput *v24;
  void *v26;
  id v27;
  id v28;
  void *v29;
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v24 = -[SNSoundPrintALaughterModelOutput initWithInput_1:Confidence:Detected:detectedHistoryOut:](v16, "initWithInput_1:Confidence:Detected:detectedHistoryOut:", v17, v19, v21, v23);
