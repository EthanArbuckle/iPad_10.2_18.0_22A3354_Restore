...
{
  return (SNEstimateAudioOffsetRequest *)sub_1D42F2C1C();
}

- (id)copyWithZone:(void *)a3
{
  SNEstimateAudioOffsetRequest *v3;
  void *v4;
  _QWORD v6[4];
...
- (int64_t)hash
{
  ...
  SNEstimateAudioOffsetRequest.hash.getter();
  return result;
}

- (BOOL)isEqual:(id)a3
{
  SNEstimateAudioOffsetRequest *v4;
  SNEstimateAudioOffsetRequest *v5;
  char v6;
  _OWORD v8[2];
  ...
  v6 = SNEstimateAudioOffsetRequest.isEqual(_:)((uint64_t)v8);
