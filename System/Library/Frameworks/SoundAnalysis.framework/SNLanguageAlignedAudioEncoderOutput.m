...
- (SNLanguageAlignedAudioEncoderOutput)initWithEmbedding:(id)a3
{
  ...
  SNLanguageAlignedAudioEncoderOutput *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SNLanguageAlignedAudioEncoderOutput;
  v6 = -[SNLanguageAlignedAudioEncoderOutput init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E97DA830);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("embedding")))
  {
    v4 = (void *)MEMORY[0x1E0C9E918];
    -[SNLanguageAlignedAudioEncoderOutput embedding](self, "embedding");
