...
- (SNVGGishMusicModelInput)initWithInput1:(id)a3
{
  ...
  v6 = -[SNVGGishMusicModelInput init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E97DA9C8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("input1")))
  {
    ...
    -[SNVGGishMusicModelInput input1](self, "input1");
