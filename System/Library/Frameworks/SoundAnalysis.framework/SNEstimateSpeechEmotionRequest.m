...
{
  return (SNEstimateSpeechEmotionRequest *)sub_1D42F2C1C();
}

- (id)copyWithZone:(void *)a3
{
  SNEstimateSpeechEmotionRequest *v3;
  void *v4;
  _QWORD v6[4];
...
- (int64_t)hash
{
  ...
  SNEstimateSpeechEmotionRequest.hash.getter();
  return result;
}

- (BOOL)isEqual:(id)a3
{
  SNEstimateSpeechEmotionRequest *v4;
  SNEstimateSpeechEmotionRequest *v5;
  char v6;
  _OWORD v8[2];
  ...
  v6 = SNEstimateSpeechEmotionRequest.isEqual(_:)((uint64_t)v8);
