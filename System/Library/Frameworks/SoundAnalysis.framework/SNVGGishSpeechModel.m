...
+ (id)URLOfModelInThisBundle
{
  ...
  objc_msgSend(v2, "pathForResource:ofType:", CFSTR("SNVGGishSpeechModel"), CFSTR("mlmodelc"));
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1D42A7000, MEMORY[0x1E0C81028], OS_LOG_TYPE_ERROR, "Could not load SNVGGishSpeechModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
{
  id v5;
  SNVGGishSpeechModel *v6;
  SNVGGishSpeechModel *v7;
  SNVGGishSpeechModel *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[SNVGGishSpeechModel init](&v10, sel_init);
    v7 = v6;
    if (v6)
...
{
  void *v3;
  SNVGGishSpeechModel *v4;

  objc_msgSend((id)objc_opt_class(), "URLOfModelInThisBundle");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = -[SNVGGishSpeechModel initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v3, 0);
...
- (SNVGGishSpeechModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = -[SNVGGishSpeechModel initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v7, v6, a4);
...
- (SNVGGishSpeechModel)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[SNVGGishSpeechModel initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (SNVGGishSpeechModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[SNVGGishSpeechModel initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  -[SNVGGishSpeechModel predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v7, v8, a4);
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  SNVGGishSpeechModelOutput *v12;
  void *v13;
  void *v14;
  SNVGGishSpeechModelOutput *v15;

  v8 = a4;
  v9 = a3;
  -[SNVGGishSpeechModel model](self, "model");
  ...
  if (v11)
  {
    ...
    v15 = -[SNVGGishSpeechModelOutput initWithOutput1:](v12, "initWithOutput1:", v14);
...
- (id)predictionFromInput1:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = -[SNVGGishSpeechModelInput initWithInput1:]([SNVGGishSpeechModelInput alloc], "initWithInput1:", v6);

  -[SNVGGishSpeechModel predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  SNVGGishSpeechModelOutput *v16;
  void *v17;
  void *v18;
  SNVGGishSpeechModelOutput *v19;
  id v21;
  id v22;
  ...
  if (v12)
  {
    ...
    if (objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v19 = -[SNVGGishSpeechModelOutput initWithOutput1:](v16, "initWithOutput1:", v18);
