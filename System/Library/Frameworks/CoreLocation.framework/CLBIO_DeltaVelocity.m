...
{
  CLBIO_DeltaVelocity *result;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)CLBIO_DeltaVelocity;
  result = -[CLBIO_DeltaVelocity init](&v9, sel_init);
  if (result)
  {
    result->_X = a3;
    result->_Y = a4;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeDouble_forKey_(a3, v6, (uint64_t)CFSTR("deltaVelocityX"), v7);
  objc_msgSend_Y(self, v8, v9, v10);
  objc_msgSend_encodeDouble_forKey_(a3, v11, (uint64_t)CFSTR("deltaVelocityY"), v12);
  objc_msgSend_Z(self, v13, v14, v15);
  objc_msgSend_encodeDouble_forKey_(a3, v16, (uint64_t)CFSTR("deltaVelocityZ"), v17);
}
...
- (CLBIO_DeltaVelocity)initWithCoder:(id)a3
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)CLBIO_DeltaVelocity;
  v6 = -[CLBIO_DeltaVelocity init](&v15, sel_init);
  if (v6)
  {
    objc_msgSend_decodeDoubleForKey_(a3, v4, (uint64_t)CFSTR("deltaVelocityX"), v5);
    v6->_X = v7;
    objc_msgSend_decodeDoubleForKey_(a3, v8, (uint64_t)CFSTR("deltaVelocityY"), v9);
    v6->_Y = v10;
    objc_msgSend_decodeDoubleForKey_(a3, v11, (uint64_t)CFSTR("deltaVelocityZ"), v12);
    v6->_Z = v13;
  }
  return v6;
}
