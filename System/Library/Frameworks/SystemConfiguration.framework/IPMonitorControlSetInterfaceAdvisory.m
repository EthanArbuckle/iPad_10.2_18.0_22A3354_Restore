@implementation IPMonitorControlSetInterfaceAdvisory
...
void __IPMonitorControlSetInterfaceAdvisory_block_invoke(uint64_t a1)
{
  ...
  v4 = *(_DWORD *)(a1 + 48);
  valuePtr = v4;
  v5 = *(__CFDictionary **)(v3 + 40);
  if (!v5)
  {
    if (!v4)
      goto LABEL_9;
    *(_QWORD *)(v3 + 40) = CFDictionaryCreateMutable(0, 0, MEMORY[0x1E0C9B390], MEMORY[0x1E0C9B3A0]);
LABEL_8:
