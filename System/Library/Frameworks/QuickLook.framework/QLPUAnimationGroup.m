...
{
  void (**v3)(_QWORD);
  QLPUAnimationGroup *v4;

  v3 = (void (**)(_QWORD))a3;
  v4 = objc_alloc_init(QLPUAnimationGroup);
  +[QLPUAnimationGroup pushAnimationGroup:](QLPUAnimationGroup, "pushAnimationGroup:", v4);
  v3[2](v3);

  +[QLPUAnimationGroup popAnimationGroup:](QLPUAnimationGroup, "popAnimationGroup:", v4);
  return v4;
}
...
+ (void)pushAnimationGroup:(id)a3
{
  ...
  if (__rootAnimationGroup)
    objc_msgSend((id)__currentAnimationGroup, "addSubAnimationGroup:", v4);
  else
...
+ (void)popAnimationGroup:(id)a3
{
  ...
  v6 = a3;
  objc_msgSend(v6, "superAnimationGroup");
  v3 = objc_claimAutoreleasedReturnValue();
  v4 = (void *)__currentAnimationGroup;
...
- (void)dealloc
{
  ...
  -[QLPUAnimationGroup dealloc](&v4, sel_dealloc);
}
...
- (double)elapsedTime
{
  ...
  -[QLPUAnimationGroup subAnimationGroups](self, "subAnimationGroups");
...
- (void)setPaused:(BOOL)a3
{
  ...
  if (self->_paused != a3)
  {
    ...
    self->_paused = a3;
    if (a3)
      -[QLPUAnimationGroup pauseAnimations](self, "pauseAnimations");
    else
      -[QLPUAnimationGroup resumeAnimations](self, "resumeAnimations");
    v12 = 0u;
    v13 = 0u;
    v10 = 0u;
    v11 = 0u;
...
- (void)addSubAnimationGroup:(id)a3
{
  ...
  objc_msgSend(v8, "setSuperAnimationGroup:", self);
}
...
- (void)completeIfNeeded
{
  ...
  v15 = *MEMORY[0x24BDAC8D0];
  -[QLPUAnimationGroup superAnimationGroup](self, "superAnimationGroup");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = v3;
  if (v3)
  {
  ...
  else if (-[QLPUAnimationGroup isReadyToComplete](self, "isReadyToComplete"))
  {
    -[QLPUAnimationGroup complete](self, "complete");
    v12 = 0u;
    v13 = 0u;
    v10 = 0u;
    v11 = 0u;
...
- (void)complete
{
  ...
  -[QLPUAnimationGroup completionHandler](self, "completionHandler");
  v3 = (void (**)(void))objc_claimAutoreleasedReturnValue();
  if (v3)
  {
    -[QLPUAnimationGroup setCompletionHandler:](self, "setCompletionHandler:", 0);
    v3[2]();
  }
...
- (id)description
{
  ...
  -[QLPUAnimationGroup description](&v26, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  return (QLPUAnimationGroup *)objc_loadWeakRetained((id *)&self->_superAnimationGroup);
}
