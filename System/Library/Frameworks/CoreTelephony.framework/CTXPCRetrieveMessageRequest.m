...
- (CTXPCRetrieveMessageRequest)initWithContext:(id)a3 messageID:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCRetrieveMessageRequest *v9;
  objc_super v11;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCRetrieveMessageRequest messageID](self, "messageID");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "retrieveMessage:withMessageID:completion:", v8, v9, v11);
...
{
  id v5;
  CTXPCRetrieveMessageResponse *v6;
  id v7;

  v7 = a2;
  v5 = a3;
  if (v7)
    v6 = -[CTXPCRetrieveMessageResponse initWithMessageEnvelope:]([CTXPCRetrieveMessageResponse alloc], "initWithMessageEnvelope:", v7);
  else
    v6 = 0;
