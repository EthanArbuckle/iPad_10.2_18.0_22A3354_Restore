...
- (CTXPCRenewOneTimePasswordRequest)initWithSourceIccid:(id)a3
{
  id v4;
  void *v5;
  CTXPCRenewOneTimePasswordRequest *v6;
  objc_super v8;
  const __CFString *v9;
  _QWORD v10[2];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCRenewOneTimePasswordRequest sourceIccid](self, "sourceIccid");
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "renewOneTimePassword:completion:", v8, v10);
