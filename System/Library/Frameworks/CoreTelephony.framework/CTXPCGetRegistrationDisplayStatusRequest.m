...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "copyRegistrationDisplayStatus:completion:", v8, v10);
...
{
  id v5;
  CTXPCGetRegistrationDisplayStatusResponse *v6;
  id v7;

  v7 = a2;
  v5 = a3;
  if (v7)
    v6 = -[CTXPCGetRegistrationDisplayStatusResponse initWithStatus:]([CTXPCGetRegistrationDisplayStatusResponse alloc], "initWithStatus:", v7);
  else
    v6 = 0;
