...
- (CTXPCGetPlanTransferCredentialsRequest)initWithIccid:(id)a3
{
  id v4;
  void *v5;
  CTXPCGetPlanTransferCredentialsRequest *v6;
  objc_super v8;
  const __CFString *v9;
  _QWORD v10[2];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCGetPlanTransferCredentialsRequest iccid](self, "iccid");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = MEMORY[0x1E0C809B0];
  v10[1] = 3221225472;
  v10[2] = __86__CTXPCGetPlanTransferCredentialsRequest_performRequestWithHandler_completionHandler___block_invoke;
  v10[3] = &unk_1E152FBF0;
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "getPlanTransferCredentials:completion:", v8, v10);
...
{
  id v5;
  CTXPCGetPlanTransferCredentialsResponse *v6;
  id v7;

  v7 = a2;
  v5 = a3;
  v6 = -[CTXPCGetPlanTransferCredentialsResponse initWithInfo:]([CTXPCGetPlanTransferCredentialsResponse alloc], "initWithInfo:", v7);
...
- (id)iccid
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKey:", CFSTR("iccid"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
