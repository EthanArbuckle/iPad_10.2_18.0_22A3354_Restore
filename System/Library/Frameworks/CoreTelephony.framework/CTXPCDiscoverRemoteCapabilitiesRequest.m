...
- (CTXPCDiscoverRemoteCapabilitiesRequest)initWithContext:(id)a3 destination:(id)a4 operationID:(id)a5
{
  ...
  id v10;
  void *v11;
  CTXPCDiscoverRemoteCapabilitiesRequest *v12;
  objc_super v14;
  _QWORD v15[2];
  _QWORD v16[3];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCDiscoverRemoteCapabilitiesRequest destination](self, "destination");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCDiscoverRemoteCapabilitiesRequest operationID](self, "operationID");
  ...
  v11 = v7;
  v13 = v11;
  objc_msgSend(v6, "discoverRemoteCapabilities:forDestination:withOperationID:completion:", v8, v9, v10, v12);
