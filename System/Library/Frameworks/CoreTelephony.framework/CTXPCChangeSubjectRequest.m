...
- (CTLazuliGroupChatSubject)subject
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  CTThrowingCastIfClass<CTLazuliGroupChatSubject>(v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCChangeSubjectRequest groupChatURI](self, "groupChatURI");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCChangeSubjectRequest subject](self, "subject");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCChangeSubjectRequest operationID](self, "operationID");
  ...
  v12 = v7;
  v14 = v12;
  objc_msgSend(v6, "changeSubject:forGroupChat:withNewSubject:withOperationID:completion:", v8, v9, v10, v11, v13);
