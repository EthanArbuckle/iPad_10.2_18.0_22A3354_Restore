...
{
  CTSweetgumUserConsentFlowInfo *v2;
  CTSweetgumUserConsentFlowInfo *v3;
  NSString *webURL;
  NSString *postData;
  objc_super v7;
  ...
  v2 = -[CTSweetgumUserConsentFlowInfo init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
    webURL = v2->_webURL;
...
- (id)description
{
  ...
  -[CTSweetgumUserConsentFlowInfo webURL](self, "webURL");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(" URL=%@"), v4);

  -[CTSweetgumUserConsentFlowInfo postData](self, "postData");
...
- (BOOL)isEqual:(id)a3
{
  void *v3;
  void *v4;
  CTSweetgumUserConsentFlowInfo *v6;
  void *v7;
  void *v8;
  char v9;
  void *v10;
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CTSweetgumUserConsentFlowInfo webURL](v6, "webURL");
            ...
            objc_msgSend(v3, "isEqualToString:", v4)))
      {
        ...
        -[CTSweetgumUserConsentFlowInfo postData](v6, "postData");
...
{
  id v4;
  CTSweetgumUserConsentFlowInfo *v5;
  uint64_t v6;
  NSString *webURL;
  uint64_t v8;
  NSString *postData;
  ...
  v5 = -[CTSweetgumUserConsentFlowInfo init](&v11, sel_init);
  if (v5)
  {
