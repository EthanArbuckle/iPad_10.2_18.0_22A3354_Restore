...
- (CTXPCMobileSubscriberISOSubregionCodeRequest)initWithMcc:(id)a3 mnc:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCMobileSubscriberISOSubregionCodeRequest *v9;
  objc_super v11;
  _QWORD v12[2];
  _QWORD v13[3];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCMobileSubscriberISOSubregionCodeRequest mcc](self, "mcc");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCMobileSubscriberISOSubregionCodeRequest mnc](self, "mnc");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "copyMobileSubscriberIsoSubregionCode:MNC:completion:", v8, v9, v11);
...
- (NSString)mnc
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "valueForKey:", CFSTR("mnc"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
