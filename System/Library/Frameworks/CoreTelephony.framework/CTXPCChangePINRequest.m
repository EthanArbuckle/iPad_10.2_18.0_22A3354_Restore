...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCChangePINRequest currentPin](self, "currentPin");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCChangePINRequest updatedPin](self, "updatedPin");
  ...
  v11 = v7;
  v13 = v11;
  objc_msgSend(v6, "changePIN:oldPin:newPin:completion:", v8, v9, v10, v12);
