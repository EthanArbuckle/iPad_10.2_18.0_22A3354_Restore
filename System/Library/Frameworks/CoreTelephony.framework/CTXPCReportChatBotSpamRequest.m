...
- (CTXPCReportChatBotSpamRequest)initWithContext:(id)a3 destination:(id)a4 spamReportInfo:(id)a5 operationID:(id)a6
{
  ...
  id v13;
  void *v14;
  CTXPCReportChatBotSpamRequest *v15;
  objc_super v17;
  _QWORD v18[3];
  _QWORD v19[4];
...
- (CTLazuliChatBotSpamReportInformation)spamReportInfo
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKey:", CFSTR("spamReportInfo"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  CTThrowingCastIfClass<CTLazuliChatBotSpamReportInformation>(v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCReportChatBotSpamRequest destination](self, "destination");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCReportChatBotSpamRequest spamReportInfo](self, "spamReportInfo");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCReportChatBotSpamRequest operationID](self, "operationID");
  ...
  v12 = v7;
  v14 = v12;
  objc_msgSend(v6, "reportChatbotSpam:forChatbot:withSpamReportInfo:andOperationID:completion:", v8, v9, v10, v11, v13);
