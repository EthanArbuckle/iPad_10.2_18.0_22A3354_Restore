...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "getSupports5GStandalone:completion:", v8, v10);
...
{
  id v5;
  CTXPCGetSupports5GStandaloneResponse *v6;
  id v7;
  ...
  if (v5)
    ...
    v6 = -[CTXPCGetSupports5GStandaloneResponse initWithSupport:]([CTXPCGetSupports5GStandaloneResponse alloc], "initWithSupport:", objc_msgSend(v7, "BOOLValue"));
