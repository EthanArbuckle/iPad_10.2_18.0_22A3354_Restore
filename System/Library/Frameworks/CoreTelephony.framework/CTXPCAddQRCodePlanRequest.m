...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCAddQRCodePlanRequest request](self, "request");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCAddQRCodePlanRequest appName](self, "appName");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  v10 = -[CTXPCAddQRCodePlanRequest appType](self, "appType");
  ...
  v11 = v7;
  v13 = v11;
  objc_msgSend(v6, "addQRCodePlanWith:appName:appType:completionHandler:", v8, v9, v10, v12);
...
{
  CTXPCAddQRCodePlanResponse *v5;
  id v6;

  v6 = a3;
  v5 = -[CTXPCAddQRCodePlanResponse initWithResult:]([CTXPCAddQRCodePlanResponse alloc], "initWithResult:", a2);
