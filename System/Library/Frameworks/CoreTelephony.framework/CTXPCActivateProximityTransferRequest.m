...
- (CTXPCActivateProximityTransferRequest)initWithEndpoint:(unint64_t)a3
{
  void *v4;
  void *v5;
  CTXPCActivateProximityTransferRequest *v6;
  objc_super v8;
  const __CFString *v9;
  _QWORD v10[2];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = -[CTXPCActivateProximityTransferRequest endpoint](self, "endpoint");
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "activateProximityTransfer:completion:", v8, v10);
