...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "copyIsInHomeCountry:completion:", v8, v10);
...
{
  CTXPCGetIsInHomeCountryResponse *v5;
  id v6;
  ...
  if (v6)
    ...
    v5 = -[CTXPCGetIsInHomeCountryResponse initWithIsHome:]([CTXPCGetIsInHomeCountryResponse alloc], "initWithIsHome:", a2);
