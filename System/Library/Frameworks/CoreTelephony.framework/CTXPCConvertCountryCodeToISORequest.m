...
- (CTXPCConvertCountryCodeToISORequest)initWithMcc:(id)a3
{
  id v4;
  void *v5;
  CTXPCConvertCountryCodeToISORequest *v6;
  objc_super v8;
  const __CFString *v9;
  _QWORD v10[2];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCConvertCountryCodeToISORequest mcc](self, "mcc");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v10[0] = MEMORY[0x1E0C809B0];
  v10[1] = 3221225472;
  v10[2] = __83__CTXPCConvertCountryCodeToISORequest_performRequestWithHandler_completionHandler___block_invoke;
  v10[3] = &unk_1E152FBF0;
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "copyMobileSubscriberIsoCountryCode:completion:", v8, v10);
