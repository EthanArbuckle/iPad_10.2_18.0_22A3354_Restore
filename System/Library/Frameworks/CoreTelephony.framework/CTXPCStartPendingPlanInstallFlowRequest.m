...
- (CTXPCStartPendingPlanInstallFlowRequest)initWithPlan:(id)a3 carrierName:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCStartPendingPlanInstallFlowRequest *v9;
  objc_super v11;
  _QWORD v12[2];
  _QWORD v13[3];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCStartPendingPlanInstallFlowRequest plan](self, "plan");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCStartPendingPlanInstallFlowRequest carrierName](self, "carrierName");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "startPendingPlanInstallationForPlan:carrierName:completionHandler:", v8, v9, v11);
...
void __87__CTXPCStartPendingPlanInstallFlowRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  v7 = a3;
  v5 = *(_QWORD *)(a1 + 32);
  v6 = -[CTXPCTriggerPendingPlanInstallFlowResponse initWithResult:]([CTXPCTriggerPendingPlanInstallFlowResponse alloc], "initWithResult:", a2);
...
- (id)carrierName
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("carrier"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
