...
- (CTXPCPrepareCrossPlatformPlanTransferRequest)initWithRequest:(id)a3
{
  id v4;
  void *v5;
  CTXPCPrepareCrossPlatformPlanTransferRequest *v6;
  objc_super v8;
  const __CFString *v9;
  _QWORD v10[2];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCPrepareCrossPlatformPlanTransferRequest request](self, "request");
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "prepareCrossPlatformPlanTransfer:completion:", v8, v10);
...
- (id)request
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("request"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  CTThrowingCastIfClass<CTCellularPlanTransferCrossPlatformRequest>(v3);
