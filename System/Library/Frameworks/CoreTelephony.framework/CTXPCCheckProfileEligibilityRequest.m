...
- (CTXPCCheckProfileEligibilityRequest)initWithSmdpURL:(id)a3 metadata:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCCheckProfileEligibilityRequest *v9;
  objc_super v11;

  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_opt_new();
  objc_msgSend(v8, "setObject:forKeyedSubscript:", v6, CFSTR("urlString"));
  objc_msgSend(v8, "setObject:forKeyedSubscript:", v7, CFSTR("metadata"));
  v11.receiver = self;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCCheckProfileEligibilityRequest smdpUrl](self, "smdpUrl");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCCheckProfileEligibilityRequest metadata](self, "metadata");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "checkProfileEligibility:metadata:completion:", v8, v9, v11);
...
- (id)metadata
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("metadata"));
  v3 = (id)objc_claimAutoreleasedReturnValue();
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0)
    v4 = v3;
