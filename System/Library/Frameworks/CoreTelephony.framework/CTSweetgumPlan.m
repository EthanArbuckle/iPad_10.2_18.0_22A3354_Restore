...
- (CTSweetgumPlan)init
{
  ...
  v2 = -[CTSweetgumPlan init](&v11, sel_init);
  v3 = v2;
  if (v2)
  {
    planId = v2->_planId;
...
- (id)description
{
  ...
  -[CTSweetgumPlan planId](self, "planId");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planId=%@"), v4);

  -[CTSweetgumPlan planLabel](self, "planLabel");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planLabel=%@"), v5);

  -[CTSweetgumPlan planValue](self, "planValue");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planValue=%@"), v6);

  objc_msgSend(v3, "appendFormat:", CFSTR(", planStatus=%s"), CTSweetgumPlanStatusAsString(-[CTSweetgumPlan planStatus](self, "planStatus")));
  objc_msgSend(v3, "appendFormat:", CFSTR(", planPurchasable=%d"), -[CTSweetgumPlan planPurchasable](self, "planPurchasable"));
  -[CTSweetgumPlan planDetailsURL](self, "planDetailsURL");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planDetailsURL=%@"), v7);

  -[CTSweetgumPlan planTermsURL](self, "planTermsURL");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planTermsURL=%@"), v8);

  -[CTSweetgumPlan planPurchaseURL](self, "planPurchaseURL");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", planPurchaseURL=%@"), v9);

  objc_msgSend(v3, "appendFormat:", CFSTR(", planType=%ld"), -[CTSweetgumPlan planType](self, "planType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      -[CTSweetgumPlan planId](self, "planId");
      v6 = (void *)objc_claimAutoreleasedReturnValue();
      -[CTSweetgumPlan planId](v5, "planId");
      v7 = (void *)objc_claimAutoreleasedReturnValue();
      if (v6 != v7)
      {
        -[CTSweetgumPlan planId](self, "planId");
      ...
      -[CTSweetgumPlan planLabel](self, "planLabel");
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      -[CTSweetgumPlan planLabel](v5, "planLabel");
...
LABEL_21:
      ...
      -[CTSweetgumPlan planValue](v5, "planValue");
      ...
      v13 = -[CTSweetgumPlan planSubscriptionStatus](self, "planSubscriptionStatus");
      if (v13 != -[CTSweetgumPlan planSubscriptionStatus](v5, "planSubscriptionStatus")
        || (v14 = -[CTSweetgumPlan planPurchasable](self, "planPurchasable"),
            v14 != -[CTSweetgumPlan planPurchasable](v5, "planPurchasable")))
      {
        v8 = 0;
        if (v11 == v12)
          goto LABEL_18;
      ...
      -[CTSweetgumPlan planDetailsURL](v5, "planDetailsURL");
      v31 = v3;
...
LABEL_17:
      ...
      -[CTSweetgumPlan planTermsURL](v5, "planTermsURL");
            ...
            objc_msgSend(v27, "isEqualToString:")))
      {
        ...
        -[CTSweetgumPlan planPurchaseURL](v5, "planPurchaseURL");
...
- (int64_t)planStatus
{
  ...
  if (planSubscriptionStatus > 2)
    ...
    return qword_1843CDCE0[planSubscriptionStatus];
}
...
- (CTSweetgumPlan)initWithCoder:(id)a3
{
  ...
  v5 = -[CTSweetgumPlan init](&v19, sel_init);
  if (v5)
  {
