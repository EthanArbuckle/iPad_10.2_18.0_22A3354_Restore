...
- (CTXPCRemoveParticipantsRequest)initWithContext:(id)a3 groupChatURI:(id)a4 participants:(id)a5 operationID:(id)a6
{
  ...
  id v13;
  void *v14;
  CTXPCRemoveParticipantsRequest *v15;
  objc_super v17;
  _QWORD v18[3];
  _QWORD v19[4];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCRemoveParticipantsRequest groupChatURI](self, "groupChatURI");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCRemoveParticipantsRequest participants](self, "participants");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCRemoveParticipantsRequest operationID](self, "operationID");
  ...
  v12 = v7;
  v14 = v12;
  objc_msgSend(v6, "removeParticipants:fromGroupChat:withParticipantsToRemove:withOperationID:completion:", v8, v9, v10, v11, v13);
