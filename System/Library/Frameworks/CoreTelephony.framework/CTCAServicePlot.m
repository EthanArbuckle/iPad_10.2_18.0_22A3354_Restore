...
- (id)description
{
  ...
  -[CTCAServicePlot startsAt](self, "startsAt");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", startsAt=%@"), v4);

  -[CTCAServicePlot endsAt](self, "endsAt");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", endsAt=%@"), v5);

  -[CTCAServicePlot readings](self, "readings");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", readings=%@"), v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend(v5, "setReadings:", v11);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[CTCAServicePlot readings](self, "readings");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v7, "encodeObject:forKey:", v6, CFSTR("readings"));
...
- (CTCAServicePlot)initWithCoder:(id)a3
{
  ...
  v5 = -[CTCAServicePlot init](&v16, sel_init);
  if (v5)
  {
    ...
    objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v12, CFSTR("readings"));
...
{
  objc_storeStrong((id *)&self->_readings, a3);
}
