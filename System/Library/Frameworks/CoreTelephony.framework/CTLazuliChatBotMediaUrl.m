...
- (id)description
{
  ...
  -[CTLazuliChatBotMediaUrl url](self, "url");
...
- (BOOL)isEqual:(id)a3
{
  CTLazuliChatBotMediaUrl *v4;
  CTLazuliChatBotMediaUrl *v5;
  BOOL v6;

  v4 = (CTLazuliChatBotMediaUrl *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[CTLazuliChatBotMediaUrl isEqualToCTLazuliChatBotMediaUrl:](self, "isEqualToCTLazuliChatBotMediaUrl:", v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = +[CTLazuliChatBotMediaUrl allocWithZone:](CTLazuliChatBotMediaUrl, "allocWithZone:", a3);
  -[CTLazuliChatBotMediaUrl setUrl:](v4, "setUrl:", self->_url);
  return v4;
}
...
- (CTLazuliChatBotMediaUrl)initWithCoder:(id)a3
{
  ...
  v5 = -[CTLazuliChatBotMediaUrl init](&v9, sel_init);
  if (v5)
  {
...
- (CTLazuliChatBotMediaUrl)initWithReflection:(const void *)a3
{
  ...
  v4 = -[CTLazuliChatBotMediaUrl init](&v15, sel_init);
  if (v4)
  {
