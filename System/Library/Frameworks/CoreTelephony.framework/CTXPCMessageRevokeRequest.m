...
- (CTXPCMessageRevokeRequest)initWithContext:(id)a3 revokeData:(id)a4 messageID:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v15[0] = CFSTR("revokeData");
  v15[1] = CFSTR("messageID");
  v16[0] = v9;
  v16[1] = v10;
...
- (CTLazuliMessageRevokeData)revokeData
{
  ...
  objc_msgSend(v2, "objectForKey:", CFSTR("revokeData"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  CTThrowingCastIfClass<CTLazuliMessageRevokeData>(v3);
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCMessageRevokeRequest revokeData](self, "revokeData");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCMessageRevokeRequest messageID](self, "messageID");
  ...
  v11 = v7;
  v13 = v11;
  objc_msgSend(v6, "revokeMessage:withRevokeData:withMessageID:completion:", v8, v9, v10, v12);
