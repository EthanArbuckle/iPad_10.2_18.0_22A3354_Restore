...
- (CTXPCHideTransferPlanRequest)initWithPlan:(id)a3 fromDevice:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCHideTransferPlanRequest *v9;
  objc_super v11;
  _QWORD v12[2];
  _QWORD v13[3];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCHideTransferPlanRequest plan](self, "plan");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCHideTransferPlanRequest deviceIdentifier](self, "deviceIdentifier");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "hideTransferCellularPlan:fromDevice:completion:", v8, v9, v11);
