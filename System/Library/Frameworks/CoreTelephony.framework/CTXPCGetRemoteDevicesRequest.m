...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = v5;
  v6 = v5;
  objc_msgSend(a3, "getRemoteDevices:", v7);
...
{
  id v5;
  CTXPCGetRemoteDevicesResponse *v6;
  id v7;

  v7 = a2;
  v5 = a3;
  v6 = -[CTXPCGetRemoteDevicesResponse initWithList:]([CTXPCGetRemoteDevicesResponse alloc], "initWithList:", v7);
