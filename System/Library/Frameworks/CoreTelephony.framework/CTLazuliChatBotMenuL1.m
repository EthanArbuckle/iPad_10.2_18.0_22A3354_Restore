...
- (id)description
{
  ...
  -[CTLazuliChatBotMenuL1 displayText](self, "displayText");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", displayText = %@"), v4);

  -[CTLazuliChatBotMenuL1 list](self, "list");
...
- (BOOL)isEqual:(id)a3
{
  CTLazuliChatBotMenuL1 *v4;
  CTLazuliChatBotMenuL1 *v5;
  BOOL v6;

  v4 = (CTLazuliChatBotMenuL1 *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[CTLazuliChatBotMenuL1 isEqualToCTLazuliChatBotMenuL1:](self, "isEqualToCTLazuliChatBotMenuL1:", v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = +[CTLazuliChatBotMenuL1 allocWithZone:](CTLazuliChatBotMenuL1, "allocWithZone:", a3);
  -[CTLazuliChatBotMenuL1 setDisplayText:](v4, "setDisplayText:", self->_displayText);
  -[CTLazuliChatBotMenuL1 setList:](v4, "setList:", self->_list);
  return v4;
}
...
- (CTLazuliChatBotMenuL1)initWithCoder:(id)a3
{
  ...
  v5 = -[CTLazuliChatBotMenuL1 init](&v14, sel_init);
  if (v5)
  {
...
- (CTLazuliChatBotMenuL1)initWithReflection:(const void *)a3
{
  ...
  uint64_t v9;
  uint64_t i;
  CTLazuliChatBotMenuL1Content *v11;
  NSArray *list;
  objc_super v14;

  v14.receiver = self;
  v14.super_class = (Class)CTLazuliChatBotMenuL1;
  v4 = -[CTLazuliChatBotMenuL1 init](&v14, sel_init);
  if (v4)
  {
    if (*((char *)a3 + 23) >= 0)
      v5 = a3;
    ...
    v9 = *((_QWORD *)a3 + 3);
    for (i = *((_QWORD *)a3 + 4); v9 != i; v9 += 248)
    {
      v11 = -[CTLazuliChatBotMenuL1Content initWithReflection:]([CTLazuliChatBotMenuL1Content alloc], "initWithReflection:", v9);
