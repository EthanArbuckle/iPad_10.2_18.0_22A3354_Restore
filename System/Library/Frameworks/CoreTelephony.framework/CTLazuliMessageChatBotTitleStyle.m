...
- (id)description
{
  ...
  -[CTLazuliMessageChatBotTitleStyle style](self, "style");
...
- (BOOL)isEqual:(id)a3
{
  CTLazuliMessageChatBotTitleStyle *v4;
  CTLazuliMessageChatBotTitleStyle *v5;
  BOOL v6;

  v4 = (CTLazuliMessageChatBotTitleStyle *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[CTLazuliMessageChatBotTitleStyle isEqualToCTLazuliMessageChatBotTitleStyle:](self, "isEqualToCTLazuliMessageChatBotTitleStyle:", v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = +[CTLazuliMessageChatBotTitleStyle allocWithZone:](CTLazuliMessageChatBotTitleStyle, "allocWithZone:", a3);
  -[CTLazuliMessageChatBotTitleStyle setStyle:](v4, "setStyle:", self->_style);
  return v4;
}
...
- (CTLazuliMessageChatBotTitleStyle)initWithCoder:(id)a3
{
  ...
  v5 = -[CTLazuliMessageChatBotTitleStyle init](&v9, sel_init);
  if (v5)
  {
...
- (CTLazuliMessageChatBotTitleStyle)initWithReflection:(const MessageChatBotTitleStyle *)a3
{
  ...
  v4 = -[CTLazuliMessageChatBotTitleStyle init](&v8, sel_init);
  if (v4)
  {
