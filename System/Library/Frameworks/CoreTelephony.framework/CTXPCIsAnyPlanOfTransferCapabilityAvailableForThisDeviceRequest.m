...
- (CTXPCIsAnyPlanOfTransferCapabilityAvailableForThisDeviceRequest)initWithCapability:(unint64_t)a3
{
  void *v4;
  void *v5;
  CTXPCIsAnyPlanOfTransferCapabilityAvailableForThisDeviceRequest *v6;
  objc_super v8;
  const __CFString *v9;
  _QWORD v10[2];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = -[CTXPCIsAnyPlanOfTransferCapabilityAvailableForThisDeviceRequest capability](self, "capability");
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "isAnyPlanOfTransferCapability:availableForThisDeviceWithCompletion:", v8, v10);
...
- (unint64_t)capability
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("capability"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
