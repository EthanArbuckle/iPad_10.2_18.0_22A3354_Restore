...
{
  CTSweetgumAppsInfo *v2;
  CTSweetgumAppsInfo *v3;
  NSArray *appsList;
  NSString *appsURL;
  objc_super v7;
  ...
  v2 = -[CTSweetgumAppsInfo init](&v7, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTSweetgumAppsInfo appsList](self, "appsList");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(" appIdList=%@"), v4);

  -[CTSweetgumAppsInfo appsURL](self, "appsURL");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CTSweetgumAppsInfo appsList](v6, "appsList");
            ...
            objc_msgSend(v3, "isEqualToArray:", v4)))
      {
        ...
        -[CTSweetgumAppsInfo appsURL](v6, "appsURL");
...
- (CTSweetgumAppsInfo)initWithCoder:(id)a3
{
  ...
  v5 = -[CTSweetgumAppsInfo init](&v14, sel_init);
  if (v5)
  {
