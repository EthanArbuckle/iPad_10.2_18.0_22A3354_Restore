...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCSetSimLabelRequest label](self, "label");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "setLabel:label:completion:", v8, v9, v11);
...
- (id)label
{
  ...
  objc_msgSend(v2, "objectForKey:", CFSTR("label"));
