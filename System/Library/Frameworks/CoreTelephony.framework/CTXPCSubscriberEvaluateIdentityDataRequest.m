...
- (CTXPCSubscriberEvaluateIdentityDataRequest)initWithContext:(id)a3 identityData:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCSubscriberEvaluateIdentityDataRequest *v9;
  objc_super v11;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCSubscriberEvaluateIdentityDataRequest identity](self, "identity");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "evaluateMobileSubscriberIdentity:identity:completion:", v8, v9, v11);
...
- (NSData)identity
{
  ...
  CTThrowingCastIfClass<NSData>(v3);
