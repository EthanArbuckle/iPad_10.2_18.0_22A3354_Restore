...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = v5;
  v6 = v5;
  objc_msgSend(a3, "getDeviceInfo:", v7);
...
void __73__CTXPCGetDeviceInfoRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v5;
  uint64_t v6;
  CTXPCGetDeviceInfoResponse *v7;
  id v8;

  v8 = a2;
  v5 = a3;
  v6 = *(_QWORD *)(a1 + 32);
  v7 = -[CTXPCGetDeviceInfoResponse initWithInfo:]([CTXPCGetDeviceInfoResponse alloc], "initWithInfo:", v8);
