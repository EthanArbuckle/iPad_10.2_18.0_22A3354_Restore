...
- (CTXPCCreateEncryptedIdentityRequest)initWithContext:(id)a3 identity:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCCreateEncryptedIdentityRequest *v9;
  objc_super v11;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCCreateEncryptedIdentityRequest identity](self, "identity");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "createEncryptedIdentity:identity:completion:", v8, v9, v11);
...
void __83__CTXPCCreateEncryptedIdentityRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a3;
  if (v7)
    v6 = -[CTXPCCreateEncryptedIdentityResponse initWithIdentities:]([CTXPCCreateEncryptedIdentityResponse alloc], "initWithIdentities:", v7);
  else
    v6 = 0;
