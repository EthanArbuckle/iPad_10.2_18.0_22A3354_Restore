...
{
  CTSweetgumUsagePlanItemData *v2;
  CTSweetgumUsagePlanItemData *v3;
  NSString *capacity;
  ...
  v2 = -[CTSweetgumUsagePlanItemData init](&v10, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR(", units=%s"), CTSweetgumDataUnitsAsString(-[CTSweetgumUsagePlanItemData units](self, "units")));
  -[CTSweetgumUsagePlanItemData capacity](self, "capacity");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", capacity=%@"), v4);

  -[CTSweetgumUsagePlanItemData maxDataBeforeThrottling](self, "maxDataBeforeThrottling");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", maxDataBeforeThrottling=%@"), v5);

  -[CTSweetgumUsagePlanItemData thisDeviceDataUsed](self, "thisDeviceDataUsed");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", used=%@"), v6);

  -[CTSweetgumUsagePlanItemData sharedDataUsed](self, "sharedDataUsed");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", sharedDataUsed=%@"), v7);

  -[CTSweetgumUsagePlanItemData sharedPlanIdentifier](self, "sharedPlanIdentifier");
...
- (BOOL)isEqual:(id)a3
{
  ...
  void *v4;
  void *v5;
  CTSweetgumUsagePlanItemData *v7;
  int64_t v8;
  void *v9;
  void *v10;
  void *v11;
  ...
  else
  {
    ...
    {
      v8 = -[CTSweetgumUsagePlanItemData units](self, "units");
      if (v8 == -[CTSweetgumUsagePlanItemData units](v7, "units"))
      {
        -[CTSweetgumUsagePlanItemData capacity](self, "capacity");
        v9 = (void *)objc_claimAutoreleasedReturnValue();
        -[CTSweetgumUsagePlanItemData capacity](v7, "capacity");
        ...
        -[CTSweetgumUsagePlanItemData maxDataBeforeThrottling](v7, "maxDataBeforeThrottling");
...
LABEL_32:
        ...
        -[CTSweetgumUsagePlanItemData thisDeviceDataUsed](v7, "thisDeviceDataUsed");
...
LABEL_29:
        ...
        -[CTSweetgumUsagePlanItemData sharedDataUsed](v7, "sharedDataUsed");
        ...
        -[CTSweetgumUsagePlanItemData sharedPlanIdentifier](v7, "sharedPlanIdentifier");
...
{
  id v4;
  CTSweetgumUsagePlanItemData *v5;
  uint64_t v6;
  NSString *capacity;
  uint64_t v8;
  NSString *maxDataBeforeThrottling;
  ...
  v5 = -[CTSweetgumUsagePlanItemData init](&v17, sel_init);
  if (v5)
  {
