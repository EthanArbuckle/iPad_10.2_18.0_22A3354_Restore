...
- (CTXPCSendDeviceActionRequest)initWithContext:(id)a3 destination:(id)a4 messageID:(id)a5 action:(id)a6
{
  ...
  id v13;
  void *v14;
  CTXPCSendDeviceActionRequest *v15;
  objc_super v17;
  _QWORD v18[3];
  _QWORD v19[4];
...
- (CTLazuliSuggestedActionDevice)action
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  CTThrowingCastIfClass<CTLazuliSuggestedActionDevice>(v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCSendDeviceActionRequest destination](self, "destination");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCSendDeviceActionRequest messageID](self, "messageID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCSendDeviceActionRequest action](self, "action");
  ...
  v12 = v7;
  v14 = v12;
  objc_msgSend(v6, "sendDeviceAction:to:withMessageID:withAction:completion:", v8, v9, v10, v11, v13);
