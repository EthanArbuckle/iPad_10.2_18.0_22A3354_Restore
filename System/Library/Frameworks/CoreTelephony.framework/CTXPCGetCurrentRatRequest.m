...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "getCurrentRat:completion:", v8, v10);
...
void __73__CTXPCGetCurrentRatRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = 0;
  if (v7 && !v5)
    v6 = -[CTXPCGetCurrentRatResponse initWithRat:]([CTXPCGetCurrentRatResponse alloc], "initWithRat:", v7);
