...
- (CTXPCGetSignalStrengthMeasurementsRequest)initWithDescriptor:(id)a3 synchronous:(BOOL)a4
{
  ...
  void *v7;
  void *v8;
  CTXPCGetSignalStrengthMeasurementsRequest *v9;
  objc_super v11;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "objectForKey:", CFSTR("synchronouys"));
  ...
  if (v11)
  {
    ...
    v13 = v15;
    v15[4] = v7;
    objc_msgSend(v6, "getSignalStrengthMeasurements:completion:", v12, v15);
  }
  else
  {
    ...
    v13 = v14;
    v14[4] = v7;
    objc_msgSend(v6, "getSignalStrengthMeasurementsAsync:completion:", v12, v14);
  }
...
{
  id v5;
  CTXPCGetSignalStrengthMeasurementsResponse *v6;
  id v7;
  ...
  v6 = 0;
  if (v7 && !v5)
    v6 = -[CTXPCGetSignalStrengthMeasurementsResponse initWithSignalStrengthMeasurements:]([CTXPCGetSignalStrengthMeasurementsResponse alloc], "initWithSignalStrengthMeasurements:", v7);
