...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = v7;
  v11 = v9;
  objc_msgSend(v6, "getVoiceLinkQualityMetric:completion:", v8, v10);
...
{
  id v5;
  CTXPCGetVoiceLinkQualityMetricResponse *v6;
  id v7;
  ...
  v6 = 0;
  if (v7 && !v5)
    v6 = -[CTXPCGetVoiceLinkQualityMetricResponse initWithVoiceLinkQualityMetric:]([CTXPCGetVoiceLinkQualityMetricResponse alloc], "initWithVoiceLinkQualityMetric:", v7);
