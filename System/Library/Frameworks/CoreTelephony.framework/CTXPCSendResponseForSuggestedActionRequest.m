...
- (CTXPCSendResponseForSuggestedActionRequest)initWithContext:(id)a3 destination:(id)a4 messageID:(id)a5 response:(id)a6
{
  ...
  id v13;
  void *v14;
  CTXPCSendResponseForSuggestedActionRequest *v15;
  objc_super v17;
  _QWORD v18[3];
  _QWORD v19[4];
...
- (CTLazuliChatBotResponseForSuggestedAction)response
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKey:", CFSTR("response"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  CTThrowingCastIfClass<CTLazuliChatBotResponseForSuggestedAction>(v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  -[CTXPCSendResponseForSuggestedActionRequest destination](self, "destination");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCSendResponseForSuggestedActionRequest messageID](self, "messageID");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCSendResponseForSuggestedActionRequest response](self, "response");
  ...
  v12 = v7;
  v14 = v12;
  objc_msgSend(v6, "sendResponseForSuggestedAction:to:withMessageID:response:completion:", v8, v9, v10, v11, v13);
