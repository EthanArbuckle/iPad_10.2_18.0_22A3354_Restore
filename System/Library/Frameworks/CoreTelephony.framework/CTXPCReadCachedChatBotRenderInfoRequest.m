...
- (CTXPCReadCachedChatBotRenderInfoRequest)initWithContext:(id)a3 destination:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCReadCachedChatBotRenderInfoRequest *v9;
  objc_super v11;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCReadCachedChatBotRenderInfoRequest destination](self, "destination");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "readCachedChatBotRenderInformation:forChatBot:completion:", v8, v9, v11);
...
{
  id v5;
  CTXPCReadCachedChatBotRenderInfoResponse *v6;
  id v7;

  v7 = a2;
  v5 = a3;
  if (v7)
    v6 = -[CTXPCReadCachedChatBotRenderInfoResponse initWithInfo:]([CTXPCReadCachedChatBotRenderInfoResponse alloc], "initWithInfo:", v7);
  else
    v6 = 0;
