...
- (NSString)chat
{
  ...
  objc_msgSend(v2, "objectForKey:", CFSTR("chat"));
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCDeleteChatRequest chat](self, "chat");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "deleteChat:chat:completion:", v8, v9, v11);
