...
- (CTXPCValidateProximityTransferRequest)initWithEndpoint:(unint64_t)a3 pin:(id)a4
{
  ...
  void *v7;
  void *v8;
  CTXPCValidateProximityTransferRequest *v9;
  objc_super v11;
  _QWORD v12[2];
  _QWORD v13[3];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = -[CTXPCValidateProximityTransferRequest endpoint](self, "endpoint");
  -[CTXPCValidateProximityTransferRequest pin](self, "pin");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "validateProximityTransfer:pin:completion:", v8, v9, v11);
...
- (id)pin
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("pin"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
