...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = v5;
  v6 = v5;
  objc_msgSend(a3, "copyFirmwareUpdateInfo:", v7);
...
void __78__CTXPCFirmwareUpdateInfoRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a3;
  if (v7)
    v6 = -[CTXPCFirmwareUpdateInfoResponse initWithFimwareUpdateInfo:]([CTXPCFirmwareUpdateInfoResponse alloc], "initWithFimwareUpdateInfo:", v7);
  else
    v6 = 0;
