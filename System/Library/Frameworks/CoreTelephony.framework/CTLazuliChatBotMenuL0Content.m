...
- (id)description
{
  ...
  v4 = -[CTLazuliChatBotMenuL0Content type](self, "type");
  v6 = -[CTLazuliChatBotMenuL0Content type](self, "type");
  objc_msgSend(v3, "appendFormat:", CFSTR(", type = [%ld - %s]"), v4, print_CTLazuliMenuL0ContentType(&v6));
...
- (BOOL)isEqualToCTLazuliChatBotMenuL0Content:(id)a3
{
  ...
  v4 = a3;
  v5 = -[CTLazuliChatBotMenuL0Content type](self, "type");
  if (v5 == objc_msgSend(v4, "type"))
  {
    ...
    if (v6 == 1)
    {
      ...
      -[CTLazuliChatBotMenuL0Content item](self, "item");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
      v9 = objc_msgSend(v7, "isEqualToCTLazuliChatBotMenuL1:", v8);
    }
    else
    {
      if (v6)
...
- (BOOL)isEqual:(id)a3
{
  CTLazuliChatBotMenuL0Content *v4;
  CTLazuliChatBotMenuL0Content *v5;
  BOOL v6;

  v4 = (CTLazuliChatBotMenuL0Content *)a3;
  v5 = v4;
  if (v4 == self)
    v6 = 1;
  else
    v6 = v4
      ...
      && -[CTLazuliChatBotMenuL0Content isEqualToCTLazuliChatBotMenuL0Content:](self, "isEqualToCTLazuliChatBotMenuL0Content:", v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = +[CTLazuliChatBotMenuL0Content allocWithZone:](CTLazuliChatBotMenuL0Content, "allocWithZone:", a3);
  -[CTLazuliChatBotMenuL0Content setType:](v4, "setType:", self->_type);
  -[CTLazuliChatBotMenuL0Content setItem:](v4, "setItem:", self->_item);
  return v4;
}
...
- (CTLazuliChatBotMenuL0Content)initWithCoder:(id)a3
{
  ...
  v5 = -[CTLazuliChatBotMenuL0Content init](&v14, sel_init);
  if (v5)
  {
...
- (CTLazuliChatBotMenuL0Content)initWithReflection:(const void *)a3
{
  ...
  v4 = -[CTLazuliChatBotMenuL0Content init](&v12, sel_init);
  if (v4)
  {
    ...
    if (v5 == 1)
    {
      ...
      *(_QWORD *)&v14[24] = 0;
      v15 = 0uLL;
      std::vector<Lazuli::ChatBotMenuL1Content>::__init_with_size[abi:nn180100]<Lazuli::ChatBotMenuL1Content*,Lazuli::ChatBotMenuL1Content*>(&v14[24], *((_QWORD *)a3 + 4), *((_QWORD *)a3 + 5), 0xEF7BDEF7BDEF7BDFLL * ((uint64_t)(*((_QWORD *)a3 + 5) - *((_QWORD *)a3 + 4)) >> 3));
      v9 = -[CTLazuliChatBotMenuL1 initWithReflection:]([CTLazuliChatBotMenuL1 alloc], "initWithReflection:", v14);
      item = v4->_item;
      v4->_item = v9;
