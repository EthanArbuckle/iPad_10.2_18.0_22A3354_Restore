...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCTransferPlansRequest plans](self, "plans");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCTransferPlansRequest deviceIdentifier](self, "deviceIdentifier");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "transferCellularPlans:fromDevice:completionHandler:", v8, v9, v11);
