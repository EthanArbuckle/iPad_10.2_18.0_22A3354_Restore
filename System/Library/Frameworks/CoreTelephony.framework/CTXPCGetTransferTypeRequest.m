...
- (CTXPCGetTransferTypeRequest)initWithPlan:(id)a3 remoteEid:(id)a4
{
  ...
  id v7;
  void *v8;
  CTXPCGetTransferTypeRequest *v9;
  objc_super v11;
  _QWORD v12[2];
  _QWORD v13[3];
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  -[CTXPCGetTransferTypeRequest plan](self, "plan");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  -[CTXPCGetTransferTypeRequest remoteEid](self, "remoteEid");
  ...
  v10 = v7;
  v12 = v10;
  objc_msgSend(v6, "getTransferType:remoteEid:completion:", v8, v9, v11);
...
{
  CTXPCGetTransferTypeResponse *v3;

  v3 = -[CTXPCGetTransferTypeResponse initWithCapability:]([CTXPCGetTransferTypeResponse alloc], "initWithCapability:", a2);
...
- (id)remoteEid
{
  ...
  -[CTXPCMessage namedArguments](self, "namedArguments");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "objectForKey:", CFSTR("remoteEID"));
  v3 = (void *)objc_claimAutoreleasedReturnValue();
