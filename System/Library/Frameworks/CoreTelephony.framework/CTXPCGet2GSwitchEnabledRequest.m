...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v8 = v5;
  v6 = v5;
  objc_msgSend(a3, "get2GSwitchEnabled:", v7);
...
{
  CTXPCGet2GSwitchEnabledResponse *v5;
  id v6;
  ...
  if (v6)
    ...
    v5 = -[CTXPCGet2GSwitchEnabledResponse initWithIsEnabled:]([CTXPCGet2GSwitchEnabledResponse alloc], "initWithIsEnabled:", a2);
