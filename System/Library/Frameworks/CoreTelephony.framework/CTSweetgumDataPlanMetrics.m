...
{
  CTSweetgumDataPlanMetrics *v2;
  CTSweetgumDataPlanMetrics *v3;
  ...
  v2 = -[CTSweetgumDataPlanMetrics init](&v8, sel_init);
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  -[CTSweetgumDataPlanMetrics billingCycleEndDate](self, "billingCycleEndDate");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", billingCycleEndDate=%@"), v4);

  objc_msgSend(v3, "appendFormat:", CFSTR(", regStatus=%s"), CTSweetgumRegistrationStatusAsString(-[CTSweetgumDataPlanMetrics regStatus](self, "regStatus")));
  -[CTSweetgumDataPlanMetrics domesticCapacity](self, "domesticCapacity");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", domesticCapacity=%@"), v5);

  -[CTSweetgumDataPlanMetrics domestic](self, "domestic");
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[CTSweetgumDataPlanMetrics billingCycleEndDate](v6, "billingCycleEndDate");
      ...
      {
        v10 = -[CTSweetgumDataPlanMetrics regStatus](self, "regStatus");
        if (v10 == -[CTSweetgumDataPlanMetrics regStatus](v6, "regStatus"))
        {
          -[CTSweetgumDataPlanMetrics domesticCapacity](self, "domesticCapacity");
          v11 = (void *)objc_claimAutoreleasedReturnValue();
          -[CTSweetgumDataPlanMetrics domesticCapacity](v6, "domesticCapacity");
...
- (CTSweetgumDataPlanMetricsItem)domestic
{
  ...
  else
  {
    ...
    -[CTSweetgumDataPlanMetricsItem setCapacityBytes:](v2, "setCapacityBytes:", self->_domesticCapacity);
  }
  return v2;
}
...
- (CTSweetgumDataPlanMetrics)initWithCoder:(id)a3
{
  ...
  v5 = -[CTSweetgumDataPlanMetrics init](&v11, sel_init);
  if (v5)
  {
