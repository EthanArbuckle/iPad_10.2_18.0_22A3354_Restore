...
- (id)description
{
  ...
  -[CTLazuliSuggestedActionDialVideoCall phoneNumber](self, "phoneNumber");
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "appendFormat:", CFSTR(", phoneNumber = %@"), v4);

  -[CTLazuliSuggestedActionDialVideoCall fallbackUrl](self, "fallbackUrl");
...
- (BOOL)isEqual:(id)a3
{
  CTLazuliSuggestedActionDialVideoCall *v4;
  CTLazuliSuggestedActionDialVideoCall *v5;
  BOOL v6;
  ...
  if (v4 == self)
    ...
    v6 = v4
      ...
      && -[CTLazuliSuggestedActionDialVideoCall isEqualToCTLazuliSuggestedActionDialVideoCall:](self, "isEqualToCTLazuliSuggestedActionDialVideoCall:", v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = +[CTLazuliSuggestedActionDialVideoCall allocWithZone:](CTLazuliSuggestedActionDialVideoCall, "allocWithZone:", a3);
  -[CTLazuliSuggestedActionDialVideoCall setPhoneNumber:](v4, "setPhoneNumber:", self->_phoneNumber);
  -[CTLazuliSuggestedActionDialVideoCall setFallbackUrl:](v4, "setFallbackUrl:", self->_fallbackUrl);
  return v4;
}
...
- (CTLazuliSuggestedActionDialVideoCall)initWithCoder:(id)a3
{
  ...
  v5 = -[CTLazuliSuggestedActionDialVideoCall init](&v11, sel_init);
  if (v5)
  {
...
- (CTLazuliSuggestedActionDialVideoCall)initWithReflection:(const void *)a3
{
  ...
  v4 = -[CTLazuliSuggestedActionDialVideoCall init](&v15, sel_init);
  if (v4)
  {
    if (*((char *)a3 + 23) >= 0)
      v5 = a3;
