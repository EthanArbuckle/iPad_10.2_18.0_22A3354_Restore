...
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3B50], "__mf_messageComposerExtensionInterface");
}

+ (id)_extensionAuxiliaryHostProtocol
{
  return (id)objc_msgSend(MEMORY[0x1E0CB3B50], "__mf_messageComposerHostInterface");
}
...
+ (id)_extensionContextHostProtocolAllowedClassesForItems
{
  ...
  return (id)_extensionContextHostProtocolAllowedClassesForItems_allowedClasses;
}
...
{
  id v8;
  _MSMessageAppExtensionContext *v9;
  NSObject *v10;
  uint64_t v11;
  uint64_t v12;
  uint64_t v13;
  ...
  char v23;
  uint64_t v24;
  _MSMessageAppExtensionContext *v25;
  _MSMessageAppExtensionContext *v26;
  CGSize v27;
  void *v28;
  void *v29;
  CGFloat v30;
  ...
  CGFloat v32;
  CGFloat v33;
  _MSMessageAppContext *v34;
  _MSMessageComposeExtensionImplProtocol *containingContext;
  uint64_t v37;
  uint64_t v38;
  void (*v39)(uint64_t);
  void *v40;
  _MSMessageAppExtensionContext *v41;
  char v42;
  _QWORD block[4];
  _MSMessageAppExtensionContext *v44;
  char v45;
  objc_super v46;

  v8 = a3;
  v46.receiver = self;
  v46.super_class = (Class)_MSMessageAppExtensionContext;
  v9 = -[_MSMessageAppExtensionContext initWithInputItems:listenerEndpoint:contextUUID:](&v46, sel_initWithInputItems_listenerEndpoint_contextUUID_, v8, a4, a5);
  if (v9)
  {
    ms_traceLog();
    v10 = objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      -[_MSMessageAppExtensionContext initWithInputItems:listenerEndpoint:contextUUID:].cold.1(v10, v11, v12, v13, v14, v15, v16, v17);
    ...
    objc_msgSend(v19, "objectForKeyedSubscript:", CFSTR("wants-live-view"));
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    v21 = objc_msgSend(v20, "BOOLValue");

    if (v21)
    {
      -[_MSMessageAppExtensionContext setPresentationStyle:](v9, "setPresentationStyle:", 2);
      -[_MSMessageAppExtensionContext _installPrincipalObjectObserver](v9, "_installPrincipalObjectObserver");
    }
    else
    {
      objc_msgSend(v19, "objectForKeyedSubscript:", CFSTR("context-is-primary"));
      ...
      v26 = v25;
      v41 = v26;
      -[_MSMessageAppExtensionContext _setRequestCleanUpBlock:](v26, "_setRequestCleanUpBlock:", &v37);
      v27 = *(CGSize *)(MEMORY[0x1E0C9D648] + 16);
      v26->_initialFrameOfHostView.origin = (CGPoint)*MEMORY[0x1E0C9D648];
      v26->_initialFrameOfHostView.size = v27;
      objc_msgSend(v19, "objectForKeyedSubscript:", CFSTR("host-view-bounds"), v37, v38, v39, v40);
      ...
      -[_MSMessageAppExtensionContext _installPrincipalObjectObserver](v26, "_installPrincipalObjectObserver");

    }
    v34 = -[_MSMessageAppContext initWithAppContext:]([_MSMessageAppContext alloc], "initWithAppContext:", v9);
    containingContext = v9->_containingContext;
    v9->_containingContext = (_MSMessageComposeExtensionImplProtocol *)v34;
...
- (void)_installPrincipalObjectObserver
{
  ...
  CFRunLoopAddObserver(Main, self->_principalObjectCreationObserver, (CFRunLoopMode)*MEMORY[0x1E0C9B270]);
}
...
- (void)_uninstallPrincipalObjectObserverIfNeeded
{
  ...
  {
    Main = CFRunLoopGetMain();
    CFRunLoopRemoveObserver(Main, self->_principalObjectCreationObserver, (CFRunLoopMode)*MEMORY[0x1E0C9B270]);
...
- (void)openURL:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    -[_MSMessageAppExtensionContext remoteProxy](self, "remoteProxy");
    ...
    v10 = &v14;
    v14 = v8;
    objc_msgSend(v9, "_openURL:completionHandler:", v6, v13);
...
- (UIViewController)viewController
{
  ...
  -[_MSMessageAppExtensionContext _principalObject](self, "_principalObject");
...
- (void)_handlePrincipalObjectCreated
{
  ...
  -[_MSMessageAppExtensionContext _principalObject](self, "_principalObject");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "conformsToProtocol:", &unk_1F02D8448);

  if (v4)
  {
    -[_MSMessageAppExtensionContext _principalObject](self, "_principalObject");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[_MSMessageAppExtensionContext initialFrameOfHostView](self, "initialFrameOfHostView");
    objc_msgSend(v5, "setInitialFrameBeforeAppearance:");

  }
  -[_MSMessageAppExtensionContext _uninstallPrincipalObjectObserverIfNeeded](self, "_uninstallPrincipalObjectObserverIfNeeded");
}
...
- (id)remoteProxy
{
  ...
  -[_MSMessageAppExtensionContext _auxiliaryConnection](self, "_auxiliaryConnection");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)stageMediaItem:(id)a3 skipShelf:(BOOL)a4 forceStage:(BOOL)a5 completionHandler:(id)a6
{
  ...
  objc_msgSend(v11, "_stageMediaItem:skipShelf:forceStage:completionHandler:", v13, v8, v7, v10);

  if (objc_msgSend(v13, "isSticker"))
  {
    v12 = -[MSStickerUsageEvent initWithMediaPayload:]([MSStickerUsageEvent alloc], "initWithMediaPayload:", v13);
    -[MSStickerUsageEvent setUsageType:](v12, "setUsageType:", 0);
    -[MSStickerUsageEvent send](v12, "send");
...
{
  -[_MSMessageAppExtensionContext requestPresentationStyle:](self, "requestPresentationStyle:", 1);
}
...
- (void)_requestStickerExtensionMetadataDictionary:(id)a3
{
  ...
  v4 = a3;
  -[_MSMessageAppExtensionContext containingContext](self, "containingContext");
  v5 = (id)objc_claimAutoreleasedReturnValue();
...
- (void)_setHostBundleID:(id)a3
{
  ...
  v4 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "setHostBundleID:", v3);
