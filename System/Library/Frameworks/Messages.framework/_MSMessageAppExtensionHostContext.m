...
+ (id)_extensionContextHostProtocolAllowedClassesForItems
{
  ...
  return (id)_extensionContextHostProtocolAllowedClassesForItems_allowedClasses_0;
}
...
- (void)_canShowBrowserForPluginIdentifier:(id)a3 completion:(id)a4
{
  ...
  id v12;
  void *v13;
  id queuedCanShowBrowserCompletion;
  id v15;
  ...
  if (WeakRetained)
  {
    ...
    {
      v12 = objc_loadWeakRetained((id *)p_delegate);
      objc_msgSend(v12, "_canShowBrowserForPluginIdentifier:completion:", v15, v7);
  ...
  else
  {
    ...
    v13 = (void *)MEMORY[0x1DF0AA1E8](v7);
    queuedCanShowBrowserCompletion = self->_queuedCanShowBrowserCompletion;
    self->_queuedCanShowBrowserCompletion = v13;
...
{
  NSString *queuedCanShowBrowserPluginIdentifier;
  id queuedCanShowBrowserCompletion;

  objc_storeWeak((id *)&self->_delegate, a3);
  if (self->_queuedCanShowBrowserPluginIdentifier)
  {
    if (self->_queuedCanShowBrowserCompletion)
    {
