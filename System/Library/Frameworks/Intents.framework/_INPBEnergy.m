...
- (_INPBEnergy)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBEnergy *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBEnergy initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBEnergy init](+[_INPBEnergy allocWithZone:](_INPBEnergy, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBEnergy setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBEnergy values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
