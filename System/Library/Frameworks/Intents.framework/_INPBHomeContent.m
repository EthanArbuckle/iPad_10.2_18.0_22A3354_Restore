...
- (void)writeTo:(id)a3
{
  ...
  -[_INPBHomeContent filter](self, "filter", v12);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  if (v10)
  {
    -[_INPBHomeContent filter](self, "filter");
...
- (_INPBHomeContent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBHomeContent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBHomeContent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBHomeContent data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBHomeContent init](+[_INPBHomeContent allocWithZone:](_INPBHomeContent, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_actions, "copyWithZone:", a3);
  -[_INPBHomeContent setActions:](v5, "setActions:", v6);

  v7 = -[_INPBHomeFilter copyWithZone:](self->_filter, "copyWithZone:", a3);
  -[_INPBHomeContent setFilter:](v5, "setFilter:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[_INPBHomeContent actions](self, "actions");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  ...
  v3 = -[NSArray hash](self->_actions, "hash");
  return -[_INPBHomeFilter hash](self->_filter, "hash") ^ v3;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_actions, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("actions"));
  }
  -[_INPBHomeContent filter](self, "filter", (_QWORD)v14);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v11, "dictionaryRepresentation");
  v12 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v12, CFSTR("filter"));
