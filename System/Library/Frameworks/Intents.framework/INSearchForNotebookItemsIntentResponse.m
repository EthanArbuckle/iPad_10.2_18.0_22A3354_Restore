...
- (id)init
{
  return -[INSearchForNotebookItemsIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INSearchForNotebookItemsIntentResponse)initWithCode:(INSearchForNotebookItemsIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  __CFString *v8;
  NSObject *v9;
  INSearchForNotebookItemsIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INSearchForNotebookItemsIntentResponseCode v16;
  __int16 v17;
  __CFString *v18;
  __int16 v19;
  NSUserActivity *v20;
...
{
  INSearchForNotebookItemsIntentResponseCode v2;

  v2 = -[INSearchForNotebookItemsIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForNotebookItemsIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForNotebookItemsIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForNotebookItemsIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForNotebookItemsIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForNotebookItemsIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForNotebookItemsIntentResponseCodeFailureRequiringAppLaunch"));
...
- (NSArray)notes
{
  ...
  INIntentSlotValueTransformFromNotes(v3);
...
- (NSArray)taskLists
{
  ...
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v2, "taskLists");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  INIntentSlotValueTransformFromTaskLists(v3);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INSortType)sortType
{
  ...
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_msgSend(v3, "hasSortType");
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_msgSend(v5, "sortType");
  v7 = 2 * (v6 == 1);
  if (!v6)
    v7 = 1;
  if (v4)
...
- (void)setNotes:(NSArray *)notes
{
  ...
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  INIntentSlotValueTransformToNotes(v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v5, "setNotes:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
- (void)setTaskLists:(NSArray *)taskLists
{
  ...
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  INIntentSlotValueTransformToTaskLists(v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v5, "setTaskLists:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v8 = (id)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v8, "data");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)setSortType:(INSortType)sortType
{
  ...
  if ((_DWORD)v5 == 0x7FFFFFFF)
    objc_msgSend(v6, "setHasSortType:", 0);
  else
...
{
  INSearchForNotebookItemsIntentResponseCode v3;
  unint64_t v4;
  __CFString *v5;
  void *v6;
  void *v7;
  ...
  v17[0] = CFSTR("code");
  v3 = -[INSearchForNotebookItemsIntentResponse code](self, "code");
  v4 = v3;
  ...
  v18[0] = v5;
  v17[1] = CFSTR("notes");
  -[INSearchForNotebookItemsIntentResponse notes](self, "notes");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
  ...
  v18[1] = v7;
  v17[2] = CFSTR("taskLists");
  -[INSearchForNotebookItemsIntentResponse taskLists](self, "taskLists");
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = v8;
  if (!v8)
  {
  ...
  v18[2] = v9;
  v17[3] = CFSTR("tasks");
  -[INSearchForNotebookItemsIntentResponse tasks](self, "tasks");
  ...
  v18[3] = v11;
  v17[4] = CFSTR("sortType");
  v12 = -[INSearchForNotebookItemsIntentResponse sortType](self, "sortType");
  v13 = CFSTR("unknown");
