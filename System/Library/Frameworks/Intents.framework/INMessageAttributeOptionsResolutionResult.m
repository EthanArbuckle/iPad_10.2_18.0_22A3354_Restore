...
+ (INMessageAttributeOptionsResolutionResult)successWithResolvedMessageAttributeOptions:(INMessageAttributeOptions)resolvedMessageAttributeOptions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", resolvedMessageAttributeOptions);
...
+ (INMessageAttributeOptionsResolutionResult)confirmationRequiredWithMessageAttributeOptionsToConfirm:(INMessageAttributeOptions)messageAttributeOptionsToConfirm
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", messageAttributeOptionsToConfirm);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v10 == 85)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      INMessageAttributeOptionsGetNames(objc_msgSend(v5, "unsignedIntegerValue"));
...
{
  return objc_msgSend(*(id *)(a1 + 32), "addPayloadMessageAttribute:", a2);
}
