...
- (BOOL)executeRemotelyWithVendorRemote:(id)a3 completionHandler:(id)a4
{
  ...
  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)INConfirmIntentForwardingAction;
  if (!-[INIntentForwardingAction executeRemotelyWithVendorRemote:completionHandler:](&v11, sel_executeRemotelyWithVendorRemote_completionHandler_, v6, v7))
  {
    ...
    -[INConfirmIntentForwardingAction _completionHandlerWithActionCompletionHandler:](self, "_completionHandlerWithActionCompletionHandler:", v7);
    v9 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v6, "confirmIntent:withCompletion:", v8, v9);
...
- (void)executeLocallyWithIntentDeliverer:(id)a3 completionHandler:(id)a4
{
  ...
  -[INConfirmIntentForwardingAction _completionHandlerWithActionCompletionHandler:](self, "_completionHandlerWithActionCompletionHandler:", v6);
  v8 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v7, "confirmIntent:withCompletion:", v9, v8);
}
...
void __81__INConfirmIntentForwardingAction__completionHandlerWithActionCompletionHandler___block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  id v11;
  id v12;
  INConfirmIntentForwardingActionResponse *v13;

  v9 = a5;
  v10 = a4;
  v11 = a3;
  v12 = a2;
  v13 = -[INConfirmIntentForwardingActionResponse initWithIntentResponse:launchContextActivityData:cacheItems:error:]([INConfirmIntentForwardingActionResponse alloc], "initWithIntentResponse:launchContextActivityData:cacheItems:error:", v12, v11, v10, v9);
