...
- (_INPBPaymentMethod)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBPaymentMethod *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBPaymentMethod initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBPaymentMethod data](self, "data");
...
{
  _INPBPaymentMethod *v5;
  void *v6;

  v5 = -[_INPBPaymentMethod init](+[_INPBPaymentMethod allocWithZone:](_INPBPaymentMethod, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBPaymentMethod setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBPaymentMethod values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
