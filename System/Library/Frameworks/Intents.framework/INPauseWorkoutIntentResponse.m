...
- (id)init
{
  return -[INPauseWorkoutIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INPauseWorkoutIntentResponse)initWithCode:(INPauseWorkoutIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  __CFString *v8;
  NSObject *v9;
  INPauseWorkoutIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INPauseWorkoutIntentResponseCode v16;
  __int16 v17;
  __CFString *v18;
  __int16 v19;
  NSUserActivity *v20;
...
{
  INPauseWorkoutIntentResponseCode v2;

  v2 = -[INPauseWorkoutIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 6)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeContinueInApp")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeSuccess")))
    v4 = 7;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeHandleInApp")))
    v4 = 6;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeFailure")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeFailureRequiringAppLaunch")))v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INPauseWorkoutIntentResponseCodeFailureNoMatchingWorkout"));
...
{
  return -[INPauseWorkoutIntentResponse code](self, "code") == INPauseWorkoutIntentResponseCodeHandleInApp;
}
