...
- (id)confirmationReasonAsString:(int)a3
{
  ...
  if (a3 == 1)
    return CFSTR("SCHEDULE_CONFLICT");
  if (a3 == 2)
  {
    v3 = CFSTR("UPDATE_ALL_RECURRENCES");
  }
  else
  {
...
- (int)StringAsConfirmationReason:(id)a3
{
  ...
  {
    if (objc_msgSend(v3, "isEqualToString:", CFSTR("UPDATE_ALL_RECURRENCES")))
      v4 = 2;
    else
      v4 = 1;
  }
...
{
  objc_storeStrong((id *)&self->_updatedEvent, a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (-[_INPBUpdateEventIntentResponse hasConfirmationReason](self, "hasConfirmationReason"))
  ...
  -[_INPBUpdateEventIntentResponse updatedEvent](self, "updatedEvent", v12);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  if (v10)
  {
    -[_INPBUpdateEventIntentResponse updatedEvent](self, "updatedEvent");
...
- (_INPBUpdateEventIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBUpdateEventIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBUpdateEventIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBUpdateEventIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBUpdateEventIntentResponse data](self, "data");
...
{
  _INPBUpdateEventIntentResponse *v5;
  void *v6;
  id v7;

  v5 = -[_INPBUpdateEventIntentResponse init](+[_INPBUpdateEventIntentResponse allocWithZone:](_INPBUpdateEventIntentResponse, "allocWithZone:"), "init");
  if (-[_INPBUpdateEventIntentResponse hasConfirmationReason](self, "hasConfirmationReason"))
    -[_INPBUpdateEventIntentResponse setConfirmationReason:](v5, "setConfirmationReason:", -[_INPBUpdateEventIntentResponse confirmationReason](self, "confirmationReason"));
  v6 = (void *)-[NSArray copyWithZone:](self->_conflictingEventIdentifiers, "copyWithZone:", a3);
  -[_INPBUpdateEventIntentResponse setConflictingEventIdentifiers:](v5, "setConflictingEventIdentifiers:", v6);

  v7 = -[_INPBCalendarEvent copyWithZone:](self->_updatedEvent, "copyWithZone:", a3);
  -[_INPBUpdateEventIntentResponse setUpdatedEvent:](v5, "setUpdatedEvent:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_16;
  v5 = -[_INPBUpdateEventIntentResponse hasConfirmationReason](self, "hasConfirmationReason");
  ...
  -[_INPBUpdateEventIntentResponse conflictingEventIdentifiers](self, "conflictingEventIdentifiers");
...
- (unint64_t)hash
{
  ...
  return v4 ^ -[_INPBCalendarEvent hash](self->_updatedEvent, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBUpdateEventIntentResponse hasConfirmationReason](self, "hasConfirmationReason"))
  {
    v4 = -[_INPBUpdateEventIntentResponse confirmationReason](self, "confirmationReason");
    if ((_DWORD)v4 == 1)
    {
      v5 = CFSTR("SCHEDULE_CONFLICT");
    }
    else if ((_DWORD)v4 == 2)
    {
      v5 = CFSTR("UPDATE_ALL_RECURRENCES");
    }
    else
    {
  ...
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v9, CFSTR("updatedEvent"));
