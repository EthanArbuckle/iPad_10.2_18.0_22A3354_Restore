...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_INPBPauseWorkoutIntent intentMetadata](self, "intentMetadata");
  ...
  -[_INPBPauseWorkoutIntent workoutName](self, "workoutName");
...
- (_INPBPauseWorkoutIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBPauseWorkoutIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBPauseWorkoutIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBPauseWorkoutIntent data](self, "data");
...
{
  _INPBPauseWorkoutIntent *v5;
  id v6;
  id v7;

  v5 = -[_INPBPauseWorkoutIntent init](+[_INPBPauseWorkoutIntent allocWithZone:](_INPBPauseWorkoutIntent, "allocWithZone:"), "init");
  v6 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBPauseWorkoutIntent setIntentMetadata:](v5, "setIntentMetadata:", v6);

  v7 = -[_INPBDataString copyWithZone:](self->_workoutName, "copyWithZone:", a3);
  -[_INPBPauseWorkoutIntent setWorkoutName:](v5, "setWorkoutName:", v7);
