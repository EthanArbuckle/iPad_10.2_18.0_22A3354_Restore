...
{
  return -[INJoinCallIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (int64_t)_intentResponseCode
{
  ...
  result = -[INJoinCallIntentResponse code](self, "code");
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeContinueInApp")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeInProgress")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeSuccess")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeFailure")))
    v5 = 5;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INJoinCallIntentResponseCodeFailureRequiringAppLaunch"));
...
- (id)_dictionaryRepresentation
{
  ...
  v7 = CFSTR("code");
  v2 = -[INJoinCallIntentResponse code](self, "code");
  v3 = v2;
  if (v2 <= 6)
  {
    v4 = off_1E2295358[v2];
