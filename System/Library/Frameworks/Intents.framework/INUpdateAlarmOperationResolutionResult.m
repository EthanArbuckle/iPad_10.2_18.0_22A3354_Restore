...
+ (id)successWithResolvedUpdateAlarmOperation:(int64_t)a3
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INUpdateAlarmOperationUnknown will be reformed to notRequired."), a2);
...
+ (id)confirmationRequiredWithUpdateAlarmOperationToConfirm:(int64_t)a3
{
  ...
  if (!a3)
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INUpdateAlarmOperationUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 183)
  {
    ...
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v8 == 2)
          ...
          v10 = v9;
        -[_INPBIntentSlotValue addPayloadUpdateAlarmOperation:](v7, "addPayloadUpdateAlarmOperation:", v10);
      }
    }
  }
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v8 == 183)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v10 = CFSTR("unknown");
      if (v9 == 2)
        v10 = CFSTR("updateTime");
      if (v9 == 1)
        v10 = CFSTR("updateLabel");
      v11 = v10;
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INUpdateAlarmOperationResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INUpdateAlarmOperationResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
