...
- (id)_metadata
{
  ...
  -[INStartPhotoPlaybackIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INStartPhotoPlaybackIntent)initWithDateCreated:(INDateComponentsRange *)dateCreated locationCreated:(CLPlacemark *)locationCreated albumName:(NSString *)albumName searchTerms:(NSArray *)searchTerms includedAttributes:(INPhotoAttributeOptions)includedAttributes excludedAttributes:(INPhotoAttributeOptions)excludedAttributes peopleInPhoto:(NSArray *)peopleInPhoto
{
  ...
  NSArray *v18;
  NSArray *v19;
  INStartPhotoPlaybackIntent *v20;
  INStartPhotoPlaybackIntent *v21;
  objc_super v23;
  ...
  if (v20)
  {
    -[INStartPhotoPlaybackIntent setDateCreated:](v20, "setDateCreated:", v15);
    -[INStartPhotoPlaybackIntent setLocationCreated:](v21, "setLocationCreated:", v16);
    -[INStartPhotoPlaybackIntent setAlbumName:](v21, "setAlbumName:", v17);
    -[INStartPhotoPlaybackIntent setSearchTerms:](v21, "setSearchTerms:", v18);
    -[INStartPhotoPlaybackIntent setIncludedAttributes:](v21, "setIncludedAttributes:", includedAttributes);
    -[INStartPhotoPlaybackIntent setExcludedAttributes:](v21, "setExcludedAttributes:", excludedAttributes);
    -[INStartPhotoPlaybackIntent setPeopleInPhoto:](v21, "setPeopleInPhoto:", v19);
  }
...
- (id)_dictionaryRepresentation
{
  ...
  -[INStartPhotoPlaybackIntent dateCreated](self, "dateCreated");
  ...
  -[INStartPhotoPlaybackIntent locationCreated](self, "locationCreated");
  ...
  -[INStartPhotoPlaybackIntent albumName](self, "albumName");
  ...
  -[INStartPhotoPlaybackIntent searchTerms](self, "searchTerms");
  ...
  INPhotoAttributeOptionsGetNames(-[INStartPhotoPlaybackIntent includedAttributes](self, "includedAttributes"));
  ...
  INPhotoAttributeOptionsGetNames(-[INStartPhotoPlaybackIntent excludedAttributes](self, "excludedAttributes"));
  ...
  -[INStartPhotoPlaybackIntent peopleInPhoto](self, "peopleInPhoto");
...
- (id)verb
{
  return CFSTR("StartPhotoPlayback");
}
