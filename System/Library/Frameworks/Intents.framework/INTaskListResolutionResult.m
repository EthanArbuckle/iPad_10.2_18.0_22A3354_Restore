...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 135)
  {
          ...
          if (v11)
          {
            ...
            do
            {
              for (i = 0; i != v12; ++i)
              {
                ...
                INIntentSlotValueTransformToTaskList(*(void **)(*((_QWORD *)&v17 + 1) + 8 * i));
                v15 = (void *)objc_claimAutoreleasedReturnValue();
                -[_INPBIntentSlotValue addPayloadTaskList:](v7, "addPayloadTaskList:", v15);
...
LABEL_16:
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v10)
        -[_INPBIntentSlotValue addPayloadTaskList:](v7, "addPayloadTaskList:", v10);
      goto LABEL_16;
    }
  }
LABEL_17:
