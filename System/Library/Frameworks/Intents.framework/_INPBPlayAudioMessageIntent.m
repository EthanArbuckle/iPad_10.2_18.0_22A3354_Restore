...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[_INPBPlayAudioMessageIntent intentMetadata](self, "intentMetadata");
  ...
  -[_INPBPlayAudioMessageIntent messageIdentifier](self, "messageIdentifier");
...
- (_INPBPlayAudioMessageIntent)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBPlayAudioMessageIntent *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBPlayAudioMessageIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBPlayAudioMessageIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBPlayAudioMessageIntent data](self, "data");
...
{
  _INPBPlayAudioMessageIntent *v5;
  id v6;
  void *v7;

  v5 = -[_INPBPlayAudioMessageIntent init](+[_INPBPlayAudioMessageIntent allocWithZone:](_INPBPlayAudioMessageIntent, "allocWithZone:"), "init");
  v6 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBPlayAudioMessageIntent setIntentMetadata:](v5, "setIntentMetadata:", v6);

  v7 = (void *)-[NSString copyWithZone:](self->_messageIdentifier, "copyWithZone:", a3);
  -[_INPBPlayAudioMessageIntent setMessageIdentifier:](v5, "setMessageIdentifier:", v7);
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_messageIdentifier, "hash") ^ v3;
}
