...
- (id)init
{
  return -[INSearchForBillsIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INSearchForBillsIntentResponse)initWithCode:(INSearchForBillsIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  __CFString *v8;
  NSObject *v9;
  INSearchForBillsIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INSearchForBillsIntentResponseCode v16;
  __int16 v17;
  __CFString *v18;
  __int16 v19;
  NSUserActivity *v20;
...
{
  INSearchForBillsIntentResponseCode v2;

  v2 = -[INSearchForBillsIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 6)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeFailureRequiringAppLaunch")))v4 = 5;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeFailureCredentialsUnverified")))v5 = 6;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSearchForBillsIntentResponseCodeFailureBillNotFound"));
...
- (NSArray)bills
{
  ...
  objc_msgSend(v2, "bills");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  INIntentSlotValueTransformFromBillDetailsValues(v3);
...
- (void)setBills:(NSArray *)bills
{
  ...
  INIntentSlotValueTransformToBillDetailsValues(v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v5, "setBills:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
{
  INSearchForBillsIntentResponseCode v3;
  unint64_t v4;
  __CFString *v5;
  void *v6;
  void *v7;
  ...
  v10[0] = CFSTR("code");
  v3 = -[INSearchForBillsIntentResponse code](self, "code");
  v4 = v3;
  ...
  v10[1] = CFSTR("bills");
  v11[0] = v5;
  -[INSearchForBillsIntentResponse bills](self, "bills");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
