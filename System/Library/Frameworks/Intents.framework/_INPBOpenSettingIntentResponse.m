...
- (void)writeTo:(id)a3
{
  ...
  v6 = a3;
  -[_INPBOpenSettingIntentResponse errorDetail](self, "errorDetail");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[_INPBOpenSettingIntentResponse punchoutUrl](self, "punchoutUrl");
...
- (_INPBOpenSettingIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBOpenSettingIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBOpenSettingIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBOpenSettingIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBOpenSettingIntentResponse data](self, "data");
...
{
  _INPBOpenSettingIntentResponse *v5;
  void *v6;
  void *v7;

  v5 = -[_INPBOpenSettingIntentResponse init](+[_INPBOpenSettingIntentResponse allocWithZone:](_INPBOpenSettingIntentResponse, "allocWithZone:"), "init");
  v6 = (void *)-[NSString copyWithZone:](self->_errorDetail, "copyWithZone:", a3);
  -[_INPBOpenSettingIntentResponse setErrorDetail:](v5, "setErrorDetail:", v6);

  v7 = (void *)-[NSString copyWithZone:](self->_punchoutUrl, "copyWithZone:", a3);
  -[_INPBOpenSettingIntentResponse setPunchoutUrl:](v5, "setPunchoutUrl:", v7);
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_punchoutUrl, "hash") ^ v3;
}
