...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[_INPBDataValue value](self, "value");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteDataField();
  -[_INPBDataValue valueMetadata](self, "valueMetadata");
...
- (_INPBDataValue)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDataValue *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDataValue initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBDataValue init](+[_INPBDataValue allocWithZone:](_INPBDataValue, "allocWithZone:"), "init");
  v6 = (void *)-[NSData copyWithZone:](self->_value, "copyWithZone:", a3);
  -[_INPBDataValue setValue:](v5, "setValue:", v6);

  v7 = -[_INPBValueMetadata copyWithZone:](self->_valueMetadata, "copyWithZone:", a3);
  -[_INPBDataValue setValueMetadata:](v5, "setValueMetadata:", v7);
...
- (unint64_t)hash
{
  ...
  v3 = -[NSData hash](self->_value, "hash");
