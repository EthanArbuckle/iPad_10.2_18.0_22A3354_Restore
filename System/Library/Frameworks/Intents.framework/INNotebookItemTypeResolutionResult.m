...
+ (INNotebookItemTypeResolutionResult)successWithResolvedNotebookItemType:(INNotebookItemType)resolvedNotebookItemType
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INNotebookItemTypeUnknown will be reformed to notRequired."), a2);
...
+ (INNotebookItemTypeResolutionResult)confirmationRequiredWithNotebookItemTypeToConfirm:(INNotebookItemType)notebookItemTypeToConfirm
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INNotebookItemTypeUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 129)
  {
    ...
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v8 >= 4)
          ...
          v9 = (10 * v8);
        -[_INPBIntentSlotValue addPayloadNotebookItemType:](v7, "addPayloadNotebookItemType:", v9);
      }
    }
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INNotebookItemTypeResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INNotebookItemTypeResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
