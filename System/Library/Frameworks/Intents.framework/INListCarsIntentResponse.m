...
- (id)init
{
  return -[INListCarsIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INListCarsIntentResponse)initWithCode:(INListCarsIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  uint64_t v8;
  NSObject *v9;
  INListCarsIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INListCarsIntentResponseCode v16;
  __int16 v17;
  uint64_t v18;
  __int16 v19;
  NSUserActivity *v20;
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INListCarsIntentResponseCodeFailureRequiringAppLaunch)
      ...
      v8 = (uint64_t)*(&off_1E22941B8 + code);
...
{
  INListCarsIntentResponseCode v2;

  v2 = -[INListCarsIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INListCarsIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INListCarsIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INListCarsIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INListCarsIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INListCarsIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INListCarsIntentResponseCodeFailureRequiringAppLaunch"));
...
- (NSArray)cars
{
  ...
  objc_msgSend(v2, "cars");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  INIntentSlotValueTransformFromCars(v3);
...
- (void)setCars:(NSArray *)cars
{
  ...
  INIntentSlotValueTransformToCars(v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v5, "setCars:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
{
  INListCarsIntentResponseCode v3;
  unint64_t v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  v10[0] = CFSTR("code");
  v3 = -[INListCarsIntentResponse code](self, "code");
  v4 = v3;
  ...
  v10[1] = CFSTR("cars");
  v11[0] = v5;
  -[INListCarsIntentResponse cars](self, "cars");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
