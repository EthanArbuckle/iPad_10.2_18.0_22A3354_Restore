...
{
  return -[INChangeAlarmStatusIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INChangeAlarmStatusIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  __CFString *v8;
  NSObject *v9;
  INChangeAlarmStatusIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INChangeAlarmStatusIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INChangeAlarmStatusIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INChangeAlarmStatusIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INChangeAlarmStatusIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INChangeAlarmStatusIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INChangeAlarmStatusIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INChangeAlarmStatusIntentResponseCodeFailureRequiringAppLaunch"));
...
- (NSArray)modifiedAlarms
{
  ...
  objc_msgSend(v2, "modifiedAlarms");
...
- (void)setModifiedAlarms:(id)a3
{
  ...
  objc_msgSend(v5, "setModifiedAlarms:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = CFSTR("code");
  v3 = -[INChangeAlarmStatusIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 5)
  {
    v5 = off_1E2294CE0[v3];
  ...
  v10[1] = CFSTR("modifiedAlarms");
  v11[0] = v5;
  -[INChangeAlarmStatusIntentResponse modifiedAlarms](self, "modifiedAlarms");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
