...
- (_INPBVolume)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBVolume *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBVolume initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBVolume init](+[_INPBVolume allocWithZone:](_INPBVolume, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBVolume setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBVolume values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
