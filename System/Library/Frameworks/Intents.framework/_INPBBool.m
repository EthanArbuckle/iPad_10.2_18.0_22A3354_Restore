...
- (_INPBBool)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBBool *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBBool initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBBool init](+[_INPBBool allocWithZone:](_INPBBool, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBBool setValues:](v5, "setValues:", v6);
