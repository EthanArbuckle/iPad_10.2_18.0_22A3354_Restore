...
- (id)localizeValueOfSlotDescription:(id)a3 withLocalizer:(id)a4
{
  ...
  if (!v9)
    goto LABEL_5;
  -[INCancelWorkoutIntent workoutName](self, "workoutName");
...
- (id)_metadata
{
  ...
  -[INCancelWorkoutIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INCancelWorkoutIntent)initWithWorkoutName:(INSpeakableString *)workoutName
{
  ...
  INCancelWorkoutIntent *v5;
  INCancelWorkoutIntent *v6;
  objc_super v8;
  ...
  v6 = v5;
  if (v5)
    -[INCancelWorkoutIntent setWorkoutName:](v5, "setWorkoutName:", v4);
...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  ...
  -[INCancelWorkoutIntent _typedBackingStore](self, "_typedBackingStore", a3, a4);
  v6 = (id)objc_claimAutoreleasedReturnValue();
