...
void ___INWorkflowDomainLoadIntentDescriptionIfNeeded_block_invoke()
{
  ...
  v1 = objc_opt_class();
  v2 = objc_opt_class();
  v3 = -[INIntentSlotDescription initWithName:tag:facadePropertyName:dataPropertyName:isExtended:isPrivate:valueType:valueStyle:defaultValueSelectorStrings:provideOptionsSelectorStrings:resolutionResultClass:resolveSelectors:]([INIntentSlotDescription alloc], "initWithName:tag:facadePropertyName:dataPropertyName:isExtended:isPrivate:valueType:valueStyle:defaultValueSelectorStrings:provideOptionsSelectorStrings:resolutionResultClass:resolveSelectors:", CFSTR("workflow"), 2, CFSTR("workflow"), CFSTR("workflow"), 0, 0, 12, 1, &unk_1E23F94F8, &unk_1E23F9510, objc_opt_class(), sel_resolveWorkflowForRunWorkflow_withCompletion_, sel_resolveWorkflowForRunWorkflow_completion_, 0);
  v28 = v3;
  objc_msgSend(MEMORY[0x1E0C99D20], "arrayWithObjects:count:", &v28, 1);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  _INIntentSchemaBuildIntentSlotDescriptionMap(v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = -[INIntentDescription initWithName:responseName:facadeClass:dataClass:type:isPrivate:handleSelector:confirmSelector:slotsByName:](v0, "initWithName:responseName:facadeClass:dataClass:type:isPrivate:handleSelector:confirmSelector:slotsByName:", CFSTR("RunWorkflowIntent"), CFSTR("RunWorkflowIntentResponse"), v1, v2, CFSTR("sirikit.intent.workflow.RunWorkflowIntent"), 0, sel_handleRunWorkflow_completion_, sel_confirmRunWorkflow_completion_, v5);
  v29[0] = v6;
