...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_INPBGetCarPowerLevelStatusIntent carName](self, "carName");
  ...
  -[_INPBGetCarPowerLevelStatusIntent intentMetadata](self, "intentMetadata");
...
- (_INPBGetCarPowerLevelStatusIntent)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBGetCarPowerLevelStatusIntent *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBGetCarPowerLevelStatusIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBGetCarPowerLevelStatusIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBGetCarPowerLevelStatusIntent data](self, "data");
...
{
  _INPBGetCarPowerLevelStatusIntent *v5;
  id v6;
  id v7;

  v5 = -[_INPBGetCarPowerLevelStatusIntent init](+[_INPBGetCarPowerLevelStatusIntent allocWithZone:](_INPBGetCarPowerLevelStatusIntent, "allocWithZone:"), "init");
  v6 = -[_INPBDataString copyWithZone:](self->_carName, "copyWithZone:", a3);
  -[_INPBGetCarPowerLevelStatusIntent setCarName:](v5, "setCarName:", v6);

  v7 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBGetCarPowerLevelStatusIntent setIntentMetadata:](v5, "setIntentMetadata:", v7);
