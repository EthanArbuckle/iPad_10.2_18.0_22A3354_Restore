...
- (id)_metadata
{
  ...
  -[INIdentifyIncomingCallerIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  ...
  -[INIdentifyIncomingCallerIntent _typedBackingStore](self, "_typedBackingStore", a3, a4);
...
- (id)verb
{
  return CFSTR("IdentifyIncomingCaller");
}
