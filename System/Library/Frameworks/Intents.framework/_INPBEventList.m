...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBEventList condition](self, "condition");
...
- (_INPBEventList)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBEventList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBEventList initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBEventList init](+[_INPBEventList allocWithZone:](_INPBEventList, "allocWithZone:"), "init");
  v6 = -[_INPBCondition copyWithZone:](self->_condition, "copyWithZone:", a3);
  -[_INPBEventList setCondition:](v5, "setCondition:", v6);

  v7 = (void *)-[NSArray copyWithZone:](self->_events, "copyWithZone:", a3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[_INPBEventList events](self, "events");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  ...
  return -[NSArray hash](self->_events, "hash") ^ v3;
}
