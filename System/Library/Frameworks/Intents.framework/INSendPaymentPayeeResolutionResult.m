...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  ...
  if (v7)
  {
    ...
    v9 = objc_msgSend(v8, "hasSendPaymentIntentPayeeUnsupportedReason");

    if (v9)
    {
      objc_msgSend(v6, "payloadUnsupported");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = objc_msgSend(v10, "sendPaymentIntentPayeeUnsupportedReason") - 1;
      if (v11 < 4)
        v12 = v11 + 1;
      else
        v12 = 0;
...
- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
    ...
    && -[INIntentResolutionResult unsupportedReason](self, "unsupportedReason"))
  {
    ...
    if (v7 < 4)
      ...
      v8 = 0x7FFFFFFFLL;
    objc_msgSend(v6, "setSendPaymentIntentPayeeUnsupportedReason:", v8);
