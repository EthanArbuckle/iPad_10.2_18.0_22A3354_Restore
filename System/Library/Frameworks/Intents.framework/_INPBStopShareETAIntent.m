...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBStopShareETAIntent intentMetadata](self, "intentMetadata");
...
- (_INPBStopShareETAIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBStopShareETAIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBStopShareETAIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBStopShareETAIntent data](self, "data");
...
{
  _INPBStopShareETAIntent *v5;
  id v6;
  void *v7;

  v5 = -[_INPBStopShareETAIntent init](+[_INPBStopShareETAIntent allocWithZone:](_INPBStopShareETAIntent, "allocWithZone:"), "init");
  v6 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBStopShareETAIntent setIntentMetadata:](v5, "setIntentMetadata:", v6);

  v7 = (void *)-[NSArray copyWithZone:](self->_recipients, "copyWithZone:", a3);
  -[_INPBStopShareETAIntent setRecipients:](v5, "setRecipients:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[_INPBStopShareETAIntent recipients](self, "recipients");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
