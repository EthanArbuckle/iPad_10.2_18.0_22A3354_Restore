...
- (_INPBInteger)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBInteger *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBInteger initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBInteger init](+[_INPBInteger allocWithZone:](_INPBInteger, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBInteger setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBInteger values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
