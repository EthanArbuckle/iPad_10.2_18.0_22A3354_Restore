...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBIntegerList conditionType](self, "conditionType");
...
- (_INPBIntegerList)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBIntegerList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBIntegerList initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBIntegerList data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBIntegerList init](+[_INPBIntegerList allocWithZone:](_INPBIntegerList, "allocWithZone:"), "init");
  v6 = -[_INPBCondition copyWithZone:](self->_conditionType, "copyWithZone:", a3);
  -[_INPBIntegerList setConditionType:](v5, "setConditionType:", v6);

  v7 = (void *)-[NSArray copyWithZone:](self->_dataStrings, "copyWithZone:", a3);
  -[_INPBIntegerList setDataStrings:](v5, "setDataStrings:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[_INPBIntegerList dataStrings](self, "dataStrings");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
