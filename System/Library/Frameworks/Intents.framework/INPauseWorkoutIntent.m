...
- (id)localizeValueOfSlotDescription:(id)a3 withLocalizer:(id)a4
{
  ...
  if (!v9)
    goto LABEL_5;
  -[INPauseWorkoutIntent workoutName](self, "workoutName");
...
- (id)_metadata
{
  ...
  -[INPauseWorkoutIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INPauseWorkoutIntent)initWithWorkoutName:(INSpeakableString *)workoutName
{
  ...
  INPauseWorkoutIntent *v5;
  INPauseWorkoutIntent *v6;
  objc_super v8;
  ...
  v6 = v5;
  if (v5)
    -[INPauseWorkoutIntent setWorkoutName:](v5, "setWorkoutName:", v4);
...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  ...
  -[INPauseWorkoutIntent _typedBackingStore](self, "_typedBackingStore", a3, a4);
  v6 = (id)objc_claimAutoreleasedReturnValue();
