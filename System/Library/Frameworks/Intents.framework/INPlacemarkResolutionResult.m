...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 27)
  {
          ...
          if (v11)
          {
            ...
            do
            {
              for (i = 0; i != v12; ++i)
              {
                ...
                INIntentSlotValueTransformToLocation(*(void **)(*((_QWORD *)&v35 + 1) + 8 * i));
                v15 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v15, "values");
                v16 = (void *)objc_claimAutoreleasedReturnValue();
                objc_msgSend(v16, "firstObject");
                v17 = (void *)objc_claimAutoreleasedReturnValue();
                -[_INPBIntentSlotValue addPayloadLocation:](v7, "addPayloadLocation:", v17);
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      -[_INPBIntentSlotValue addPayloadLocation:](v7, "addPayloadLocation:", v29);

LABEL_27:
    }
  }
  else if (objc_msgSend(v6, "valueType") == 28)
  {
    -[_INPBIntentSlotValue setType:](v7, "setType:", 55);
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if ((v19 & 1) != 0)
        {
          ...
          if (v23)
          {
            ...
            do
            {
              for (j = 0; j != v24; ++j)
              {
                ...
                INIntentSlotValueTransformToLocation(*(void **)(*((_QWORD *)&v31 + 1) + 8 * j));
                v27 = (void *)objc_claimAutoreleasedReturnValue();
                -[_INPBLocationList addLocation:](v21, "addLocation:", v27, (_QWORD)v31);
          ...
          -[_INPBIntentSlotValue addPayloadLocationList:](v7, "addPayloadLocationList:", v21);
        }
      }
    }
  }
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") != 27)
  {
    if (objc_msgSend(v6, "valueType") != 28)
      goto LABEL_12;
    if (objc_msgSend(v6, "valueStyle") == 3)
      goto LABEL_12;
    objc_opt_class();
...
LABEL_10:
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v15, "if_escapedComponentsJoinedByString:forLocale:", v9, v8);
