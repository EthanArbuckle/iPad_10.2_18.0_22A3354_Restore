...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_INPBResumeWorkoutIntent intentMetadata](self, "intentMetadata");
  ...
  -[_INPBResumeWorkoutIntent workoutName](self, "workoutName");
...
- (_INPBResumeWorkoutIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBResumeWorkoutIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBResumeWorkoutIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBResumeWorkoutIntent data](self, "data");
...
{
  _INPBResumeWorkoutIntent *v5;
  id v6;
  id v7;

  v5 = -[_INPBResumeWorkoutIntent init](+[_INPBResumeWorkoutIntent allocWithZone:](_INPBResumeWorkoutIntent, "allocWithZone:"), "init");
  v6 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBResumeWorkoutIntent setIntentMetadata:](v5, "setIntentMetadata:", v6);

  v7 = -[_INPBDataString copyWithZone:](self->_workoutName, "copyWithZone:", a3);
  -[_INPBResumeWorkoutIntent setWorkoutName:](v5, "setWorkoutName:", v7);
