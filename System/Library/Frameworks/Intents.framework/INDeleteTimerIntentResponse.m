...
{
  return -[INDeleteTimerIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INDeleteTimerIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  uint64_t v8;
  NSObject *v9;
  INDeleteTimerIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INDeleteTimerIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 6)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeFailureRequiringAppLaunch")))v4 = 5;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeFailureNotFound")))
    v5 = 6;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTimerIntentResponseCodeFailureNoTimers"));
...
- (void)setDeletedTimers:(id)a3
{
  ...
  objc_msgSend(v5, "setDeletedTimers:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = CFSTR("code");
  v3 = -[INDeleteTimerIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 7)
  {
    v5 = *(&off_1E2292AD8 + v3);
  ...
  v10[1] = CFSTR("deletedTimers");
  v11[0] = v5;
  -[INDeleteTimerIntentResponse deletedTimers](self, "deletedTimers");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
