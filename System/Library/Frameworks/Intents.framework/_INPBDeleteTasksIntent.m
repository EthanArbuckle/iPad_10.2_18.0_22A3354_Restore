...
{
  objc_storeStrong((id *)&self->_taskList, a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (-[_INPBDeleteTasksIntent hasAll](self, "hasAll"))
    PBDataWriterWriteBOOLField();
  -[_INPBDeleteTasksIntent intentMetadata](self, "intentMetadata");
  ...
  -[_INPBDeleteTasksIntent taskList](self, "taskList");
...
- (_INPBDeleteTasksIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDeleteTasksIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDeleteTasksIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBDeleteTasksIntent data](self, "data");
...
{
  _INPBDeleteTasksIntent *v5;
  id v6;
  id v7;
  void *v8;

  v5 = -[_INPBDeleteTasksIntent init](+[_INPBDeleteTasksIntent allocWithZone:](_INPBDeleteTasksIntent, "allocWithZone:"), "init");
  if (-[_INPBDeleteTasksIntent hasAll](self, "hasAll"))
    -[_INPBDeleteTasksIntent setAll:](v5, "setAll:", -[_INPBDeleteTasksIntent all](self, "all"));
  v6 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBDeleteTasksIntent setIntentMetadata:](v5, "setIntentMetadata:", v6);

  v7 = -[_INPBTaskList copyWithZone:](self->_taskList, "copyWithZone:", a3);
  -[_INPBDeleteTasksIntent setTaskList:](v5, "setTaskList:", v7);

  v8 = (void *)-[NSArray copyWithZone:](self->_tasks, "copyWithZone:", a3);
  -[_INPBDeleteTasksIntent setTasks:](v5, "setTasks:", v8);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_21;
  v5 = -[_INPBDeleteTasksIntent hasAll](self, "hasAll");
  ...
  -[_INPBDeleteTasksIntent tasks](self, "tasks");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  ...
  v5 = -[_INPBTaskList hash](self->_taskList, "hash");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBDeleteTasksIntent hasAll](self, "hasAll"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_INPBDeleteTasksIntent all](self, "all"));
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v8, CFSTR("taskList"));
