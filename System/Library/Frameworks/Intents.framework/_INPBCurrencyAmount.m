...
- (_INPBCurrencyAmount)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBCurrencyAmount *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBCurrencyAmount initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBCurrencyAmount data](self, "data");
...
{
  _INPBCurrencyAmount *v5;
  void *v6;

  v5 = -[_INPBCurrencyAmount init](+[_INPBCurrencyAmount allocWithZone:](_INPBCurrencyAmount, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBCurrencyAmount setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBCurrencyAmount values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
