...
- (_INPBSearchForMediaIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBSearchForMediaIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBSearchForMediaIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBSearchForMediaIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSearchForMediaIntentResponse data](self, "data");
...
{
  _INPBSearchForMediaIntentResponse *v5;
  void *v6;

  v5 = -[_INPBSearchForMediaIntentResponse init](+[_INPBSearchForMediaIntentResponse allocWithZone:](_INPBSearchForMediaIntentResponse, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_mediaItems, "copyWithZone:", a3);
  -[_INPBSearchForMediaIntentResponse setMediaItems:](v5, "setMediaItems:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBSearchForMediaIntentResponse mediaItems](self, "mediaItems");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (unint64_t)hash
{
  return -[NSArray hash](self->_mediaItems, "hash");
}
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_mediaItems, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("mediaItems"));
  }
  return v3;
}
