...
- (_INPBMediaItemGroup)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBMediaItemGroup *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBMediaItemGroup initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBMediaItemGroup data](self, "data");
...
{
  _INPBMediaItemGroup *v5;
  void *v6;

  v5 = -[_INPBMediaItemGroup init](+[_INPBMediaItemGroup allocWithZone:](_INPBMediaItemGroup, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBMediaItemGroup setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBMediaItemGroup values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if (-[NSArray count](self->_values, "count"))
  {
    ...
    objc_msgSend(v3, "setObject:forKeyedSubscript:", v4, CFSTR("values"));
  }
  return v3;
}
