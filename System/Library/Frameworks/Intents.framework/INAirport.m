...
- (INAirport)initWithName:(NSString *)name iataCode:(NSString *)iataCode icaoCode:(NSString *)icaoCode
{
  ...
  v11 = -[INAirport init](&v19, sel_init);
  if (v11)
  {
...
- (INAirport)initWithCoder:(id)a3
{
  ...
  v17 = -[INAirport initWithName:iataCode:icaoCode:](self, "initWithName:iataCode:icaoCode:", v8, v12, v16);
  return v17;
}
...
{
  return (NSString *)-[INAirport descriptionAtIndent:](self, "descriptionAtIndent:", 0);
}
...
- (id)descriptionAtIndent:(unint64_t)a3
{
  ...
  -[INAirport description](&v11, sel_description);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  -[INAirport _dictionaryRepresentation](self, "_dictionaryRepresentation");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
