...
- (id)init
{
  return -[INAppendToNoteIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INAppendToNoteIntentResponse)initWithCode:(INAppendToNoteIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  __CFString *v8;
  NSObject *v9;
  INAppendToNoteIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INAppendToNoteIntentResponseCode v16;
  __int16 v17;
  __CFString *v18;
  __int16 v19;
  NSUserActivity *v20;
...
{
  INAppendToNoteIntentResponseCode v2;

  v2 = -[INAppendToNoteIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 5)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeFailureRequiringAppLaunch")))v5 = 5;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INAppendToNoteIntentResponseCodeFailureCannotUpdatePasswordProtectedNote"));
...
{
  INAppendToNoteIntentResponseCode v3;
  unint64_t v4;
  __CFString *v5;
  void *v6;
  void *v7;
  ...
  v10[0] = CFSTR("code");
  v3 = -[INAppendToNoteIntentResponse code](self, "code");
  v4 = v3;
  ...
  v10[1] = CFSTR("note");
  v11[0] = v5;
  -[INAppendToNoteIntentResponse note](self, "note");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
