...
- (_INPBTemperature)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBTemperature *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBTemperature initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBTemperature data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBTemperature init](+[_INPBTemperature allocWithZone:](_INPBTemperature, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBTemperature setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBTemperature values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
