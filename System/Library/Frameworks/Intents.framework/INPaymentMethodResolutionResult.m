...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 54)
  {
          ...
          if (v11)
          {
            ...
            do
            {
              for (i = 0; i != v12; ++i)
              {
                ...
                INIntentSlotValueTransformToPaymentMethodValue(*(void **)(*((_QWORD *)&v17 + 1) + 8 * i));
                v15 = (void *)objc_claimAutoreleasedReturnValue();
                -[_INPBIntentSlotValue addPayloadPaymentMethodValue:](v7, "addPayloadPaymentMethodValue:", v15);
...
LABEL_16:
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      if (v10)
        -[_INPBIntentSlotValue addPayloadPaymentMethodValue:](v7, "addPayloadPaymentMethodValue:", v10);
      goto LABEL_16;
    }
  }
LABEL_17:
