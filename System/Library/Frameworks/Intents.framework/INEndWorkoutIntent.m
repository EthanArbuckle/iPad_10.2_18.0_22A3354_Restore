...
- (id)_metadata
{
  ...
  -[INEndWorkoutIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INEndWorkoutIntent)initWithWorkoutName:(INSpeakableString *)workoutName
{
  ...
  INEndWorkoutIntent *v5;
  INEndWorkoutIntent *v6;
  objc_super v8;
  ...
  v6 = v5;
  if (v5)
    -[INEndWorkoutIntent setWorkoutName:](v5, "setWorkoutName:", v4);
...
- (id)_dictionaryRepresentation
{
  ...
  -[INEndWorkoutIntent workoutName](self, "workoutName");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = v2;
  if (!v2)
  {
...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  ...
  -[INEndWorkoutIntent _typedBackingStore](self, "_typedBackingStore", a3, a4);
  v6 = (id)objc_claimAutoreleasedReturnValue();
