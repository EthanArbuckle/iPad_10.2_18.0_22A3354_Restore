...
{
  return -[INSetLabeledSettingIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INSetLabeledSettingIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  uint64_t v8;
  NSObject *v9;
  INSetLabeledSettingIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INSetLabeledSettingIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 7)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeFailureRequiringAppLaunch")))v4 = 5;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeFailureInvalidValue")))v4 = 6;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeFailureUnsupported")))v5 = 7;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetLabeledSettingIntentResponseCodeFailureOtherWithReason"));
...
- (void)setOldValue:(id)a3
{
  ...
  objc_msgSend(v5, "setOldValue:", v4);
...
- (void)setUpdatedValue:(id)a3
{
  ...
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "setUpdatedValue:", v4);
...
- (id)_dictionaryRepresentation
{
  ...
  v14[0] = CFSTR("code");
  v3 = -[INSetLabeledSettingIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 8)
  {
    v5 = *(&off_1E22946A0 + v3);
  ...
  v15[0] = v5;
  v14[1] = CFSTR("oldValue");
  -[INSetLabeledSettingIntentResponse oldValue](self, "oldValue");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
  ...
  v15[1] = v7;
  v14[2] = CFSTR("updatedValue");
  -[INSetLabeledSettingIntentResponse updatedValue](self, "updatedValue");
  ...
  v15[2] = v9;
  v14[3] = CFSTR("errorDetail");
  -[INSetLabeledSettingIntentResponse errorDetail](self, "errorDetail");
