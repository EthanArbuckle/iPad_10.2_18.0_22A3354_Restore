...
- (id)_metadata
{
  ...
  -[INGetCarPowerLevelStatusIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INGetCarPowerLevelStatusIntent)initWithCarName:(INSpeakableString *)carName
{
  ...
  INGetCarPowerLevelStatusIntent *v5;
  INGetCarPowerLevelStatusIntent *v6;
  objc_super v8;
  ...
  v6 = v5;
  if (v5)
    -[INGetCarPowerLevelStatusIntent setCarName:](v5, "setCarName:", v4);
...
- (id)_dictionaryRepresentation
{
  ...
  v6 = CFSTR("carName");
  -[INGetCarPowerLevelStatusIntent carName](self, "carName");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = v2;
  if (!v2)
  {
...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  ...
  -[INGetCarPowerLevelStatusIntent _typedBackingStore](self, "_typedBackingStore", a3, a4);
  v6 = (id)objc_claimAutoreleasedReturnValue();
...
- (id)verb
{
  return CFSTR("GetCarPowerLevelStatus");
}
