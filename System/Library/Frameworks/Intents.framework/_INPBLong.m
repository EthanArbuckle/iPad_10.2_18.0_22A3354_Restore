...
- (_INPBLong)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBLong *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBLong initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBLong init](+[_INPBLong allocWithZone:](_INPBLong, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBLong setValues:](v5, "setValues:", v6);
