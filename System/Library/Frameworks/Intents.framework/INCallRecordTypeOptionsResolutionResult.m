...
+ (INCallRecordTypeOptionsResolutionResult)successWithResolvedCallRecordTypeOptions:(INCallRecordTypeOptions)resolvedCallRecordTypeOptions
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", resolvedCallRecordTypeOptions);
...
+ (INCallRecordTypeOptionsResolutionResult)confirmationRequiredWithCallRecordTypeOptionsToConfirm:(INCallRecordTypeOptions)callRecordTypeOptionsToConfirm
{
  ...
  objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithUnsignedInteger:", callRecordTypeOptionsToConfirm);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v10 == 72)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      INCallRecordTypeOptionsGetNames(objc_msgSend(v5, "unsignedIntegerValue"));
...
{
  return objc_msgSend(*(id *)(a1 + 32), "addPayloadCallRecordType:", a2);
}
