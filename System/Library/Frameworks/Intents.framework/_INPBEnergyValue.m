...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  if (-[_INPBEnergyValue hasMagnitude](self, "hasMagnitude"))
    PBDataWriterWriteDoubleField();
  if (-[_INPBEnergyValue hasUnit](self, "hasUnit"))
    PBDataWriterWriteInt32Field();
  -[_INPBEnergyValue valueMetadata](self, "valueMetadata");
...
- (_INPBEnergyValue)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBEnergyValue *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBEnergyValue initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBEnergyValue data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBEnergyValue init](+[_INPBEnergyValue allocWithZone:](_INPBEnergyValue, "allocWithZone:"), "init");
  if (-[_INPBEnergyValue hasMagnitude](self, "hasMagnitude"))
  {
    -[_INPBEnergyValue magnitude](self, "magnitude");
    -[_INPBEnergyValue setMagnitude:](v5, "setMagnitude:");
  }
  if (-[_INPBEnergyValue hasUnit](self, "hasUnit"))
    -[_INPBEnergyValue setUnit:](v5, "setUnit:", -[_INPBEnergyValue unit](self, "unit"));
  v6 = -[_INPBValueMetadata copyWithZone:](self->_valueMetadata, "copyWithZone:", a3);
  -[_INPBEnergyValue setValueMetadata:](v5, "setValueMetadata:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = -[_INPBEnergyValue hasMagnitude](self, "hasMagnitude");
    if (v5 == objc_msgSend(v4, "hasMagnitude"))
    {
      ...
      {
        v8 = -[_INPBEnergyValue hasUnit](self, "hasUnit");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBEnergyValue hasUnit](self, "hasUnit"))
  {
    v6 = -[_INPBEnergyValue unit](self, "unit");
    if (v6 >= 6)
    {
