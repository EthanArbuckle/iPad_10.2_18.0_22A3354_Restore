...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  if (-[_INPBIntegerValue hasValue](self, "hasValue"))
    PBDataWriterWriteInt32Field();
  -[_INPBIntegerValue valueMetadata](self, "valueMetadata");
...
- (_INPBIntegerValue)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBIntegerValue *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBIntegerValue initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBIntegerValue data](self, "data");
...
{
  _INPBIntegerValue *v5;
  id v6;

  v5 = -[_INPBIntegerValue init](+[_INPBIntegerValue allocWithZone:](_INPBIntegerValue, "allocWithZone:"), "init");
  if (-[_INPBIntegerValue hasValue](self, "hasValue"))
    -[_INPBIntegerValue setValue:](v5, "setValue:", -[_INPBIntegerValue value](self, "value"));
  v6 = -[_INPBValueMetadata copyWithZone:](self->_valueMetadata, "copyWithZone:", a3);
  -[_INPBIntegerValue setValueMetadata:](v5, "setValueMetadata:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = -[_INPBIntegerValue hasValue](self, "hasValue");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBIntegerValue hasValue](self, "hasValue"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[_INPBIntegerValue value](self, "value"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
