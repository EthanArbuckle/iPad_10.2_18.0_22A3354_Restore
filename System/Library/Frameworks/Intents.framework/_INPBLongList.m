...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBLongList conditionType](self, "conditionType");
...
- (_INPBLongList)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBLongList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBLongList initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBLongList init](+[_INPBLongList allocWithZone:](_INPBLongList, "allocWithZone:"), "init");
  v6 = -[_INPBCondition copyWithZone:](self->_conditionType, "copyWithZone:", a3);
  -[_INPBLongList setConditionType:](v5, "setConditionType:", v6);

  v7 = (void *)-[NSArray copyWithZone:](self->_dataStrings, "copyWithZone:", a3);
  -[_INPBLongList setDataStrings:](v5, "setDataStrings:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[_INPBLongList dataStrings](self, "dataStrings");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
