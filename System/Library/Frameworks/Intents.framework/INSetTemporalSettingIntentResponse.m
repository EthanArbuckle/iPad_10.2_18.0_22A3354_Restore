...
{
  return -[INSetTemporalSettingIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INSetTemporalSettingIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  uint64_t v8;
  NSObject *v9;
  INSetTemporalSettingIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INSetTemporalSettingIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 7)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeFailureRequiringAppLaunch")))v4 = 5;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeFailureInvalidValue")))v4 = 6;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeFailureUnsupported")))v5 = 7;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTemporalSettingIntentResponseCodeFailureOtherWithReason"));
...
- (id)_dictionaryRepresentation
{
  ...
  v14[0] = CFSTR("code");
  v3 = -[INSetTemporalSettingIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 8)
  {
    v5 = *(&off_1E2294640 + v3);
  ...
  -[INSetTemporalSettingIntentResponse oldValue](self, "oldValue");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
  ...
  -[INSetTemporalSettingIntentResponse updatedValue](self, "updatedValue");
  ...
  -[INSetTemporalSettingIntentResponse errorDetail](self, "errorDetail");
