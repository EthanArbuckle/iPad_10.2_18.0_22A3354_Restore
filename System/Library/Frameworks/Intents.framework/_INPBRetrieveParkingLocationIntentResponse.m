...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_INPBRetrieveParkingLocationIntentResponse parkingLocation](self, "parkingLocation");
  ...
  -[_INPBRetrieveParkingLocationIntentResponse parkingNote](self, "parkingNote");
...
- (_INPBRetrieveParkingLocationIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBRetrieveParkingLocationIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBRetrieveParkingLocationIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBRetrieveParkingLocationIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBRetrieveParkingLocationIntentResponse data](self, "data");
...
{
  _INPBRetrieveParkingLocationIntentResponse *v5;
  id v6;
  id v7;

  v5 = -[_INPBRetrieveParkingLocationIntentResponse init](+[_INPBRetrieveParkingLocationIntentResponse allocWithZone:](_INPBRetrieveParkingLocationIntentResponse, "allocWithZone:"), "init");
  v6 = -[_INPBLocation copyWithZone:](self->_parkingLocation, "copyWithZone:", a3);
  -[_INPBRetrieveParkingLocationIntentResponse setParkingLocation:](v5, "setParkingLocation:", v6);

  v7 = -[_INPBString copyWithZone:](self->_parkingNote, "copyWithZone:", a3);
  -[_INPBRetrieveParkingLocationIntentResponse setParkingNote:](v5, "setParkingNote:", v7);
