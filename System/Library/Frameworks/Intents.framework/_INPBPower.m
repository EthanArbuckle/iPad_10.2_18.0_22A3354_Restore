...
- (_INPBPower)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBPower *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBPower initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBPower init](+[_INPBPower allocWithZone:](_INPBPower, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBPower setValues:](v5, "setValues:", v6);
