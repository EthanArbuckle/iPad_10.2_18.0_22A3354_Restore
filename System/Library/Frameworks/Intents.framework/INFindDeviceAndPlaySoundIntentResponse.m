...
{
  return -[INFindDeviceAndPlaySoundIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INFindDeviceAndPlaySoundIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  uint64_t v8;
  NSObject *v9;
  INFindDeviceAndPlaySoundIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INFindDeviceAndPlaySoundIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INFindDeviceAndPlaySoundIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INFindDeviceAndPlaySoundIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INFindDeviceAndPlaySoundIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INFindDeviceAndPlaySoundIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INFindDeviceAndPlaySoundIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INFindDeviceAndPlaySoundIntentResponseCodeFailureRequiringAppLaunch"));
...
- (void)setDevicesFounds:(id)a3
{
  ...
  objc_msgSend(v5, "setDevicesFounds:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = CFSTR("code");
  v3 = -[INFindDeviceAndPlaySoundIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 5)
  {
    v5 = *(&off_1E22940F0 + v3);
  ...
  v10[1] = CFSTR("devicesFounds");
  v11[0] = v5;
  -[INFindDeviceAndPlaySoundIntentResponse devicesFounds](self, "devicesFounds");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
