...
+ (id)successWithResolvedTimerType:(int64_t)a3
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INTimerTypeUnknown will be reformed to notRequired."), a2);
...
+ (id)confirmationRequiredWithTimerTypeToConfirm:(int64_t)a3
{
  ...
  if (!a3)
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INTimerTypeUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 191)
  {
    ...
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v8 >= 3)
          ...
          v9 = v8;
        -[_INPBIntentSlotValue addPayloadTimerType:](v7, "addPayloadTimerType:", v9);
      }
    }
  }
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v8 == 191)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
    {
      ...
      v10 = CFSTR("unknown");
      if (v9 == 2)
        v10 = CFSTR("sleepTimer");
      if (v9 == 1)
        v10 = CFSTR("defaultType");
      v11 = v10;
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INTimerTypeResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INTimerTypeResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
