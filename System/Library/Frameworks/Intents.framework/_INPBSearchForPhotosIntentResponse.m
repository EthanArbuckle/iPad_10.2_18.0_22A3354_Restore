...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  -[_INPBSearchForPhotosIntentResponse albumName](self, "albumName");
  v4 = (void *)objc_claimAutoreleasedReturnValue();

  if (v4)
    PBDataWriterWriteStringField();
  -[_INPBSearchForPhotosIntentResponse locationCreated](self, "locationCreated");
  ...
  if (-[_INPBSearchForPhotosIntentResponse hasSearchResultsCount](self, "hasSearchResultsCount"))
...
- (_INPBSearchForPhotosIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBSearchForPhotosIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBSearchForPhotosIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBSearchForPhotosIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSearchForPhotosIntentResponse data](self, "data");
...
{
  _INPBSearchForPhotosIntentResponse *v5;
  void *v6;
  id v7;

  v5 = -[_INPBSearchForPhotosIntentResponse init](+[_INPBSearchForPhotosIntentResponse allocWithZone:](_INPBSearchForPhotosIntentResponse, "allocWithZone:"), "init");
  v6 = (void *)-[NSString copyWithZone:](self->_albumName, "copyWithZone:", a3);
  -[_INPBSearchForPhotosIntentResponse setAlbumName:](v5, "setAlbumName:", v6);

  v7 = -[_INPBLocation copyWithZone:](self->_locationCreated, "copyWithZone:", a3);
  -[_INPBSearchForPhotosIntentResponse setLocationCreated:](v5, "setLocationCreated:", v7);

  if (-[_INPBSearchForPhotosIntentResponse hasSearchResultsCount](self, "hasSearchResultsCount"))
    -[_INPBSearchForPhotosIntentResponse setSearchResultsCount:](v5, "setSearchResultsCount:", -[_INPBSearchForPhotosIntentResponse searchResultsCount](self, "searchResultsCount"));
  return v5;
}
...
LABEL_11:
  ...
  v19 = -[_INPBSearchForPhotosIntentResponse hasSearchResultsCount](self, "hasSearchResultsCount");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBSearchForPhotosIntentResponse hasSearchResultsCount](self, "hasSearchResultsCount"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithInt:", -[_INPBSearchForPhotosIntentResponse searchResultsCount](self, "searchResultsCount"));
    v8 = (void *)objc_claimAutoreleasedReturnValue();
