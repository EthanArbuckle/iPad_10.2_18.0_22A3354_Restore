...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  if (-[_INPBMassValue hasMagnitude](self, "hasMagnitude"))
    PBDataWriterWriteDoubleField();
  if (-[_INPBMassValue hasUnit](self, "hasUnit"))
    PBDataWriterWriteInt32Field();
  -[_INPBMassValue valueMetadata](self, "valueMetadata");
...
- (_INPBMassValue)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBMassValue *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBMassValue initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBMassValue init](+[_INPBMassValue allocWithZone:](_INPBMassValue, "allocWithZone:"), "init");
  if (-[_INPBMassValue hasMagnitude](self, "hasMagnitude"))
  {
    -[_INPBMassValue magnitude](self, "magnitude");
    -[_INPBMassValue setMagnitude:](v5, "setMagnitude:");
  }
  if (-[_INPBMassValue hasUnit](self, "hasUnit"))
    -[_INPBMassValue setUnit:](v5, "setUnit:", -[_INPBMassValue unit](self, "unit"));
  v6 = -[_INPBValueMetadata copyWithZone:](self->_valueMetadata, "copyWithZone:", a3);
  -[_INPBMassValue setValueMetadata:](v5, "setValueMetadata:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = -[_INPBMassValue hasMagnitude](self, "hasMagnitude");
    if (v5 == objc_msgSend(v4, "hasMagnitude"))
    {
      ...
      {
        v8 = -[_INPBMassValue hasUnit](self, "hasUnit");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBMassValue hasUnit](self, "hasUnit"))
  {
    v6 = -[_INPBMassValue unit](self, "unit");
    if (v6 >= 0x11)
    {
