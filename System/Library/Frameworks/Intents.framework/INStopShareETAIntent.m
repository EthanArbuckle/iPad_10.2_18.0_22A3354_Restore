...
- (id)_metadata
{
  ...
  -[INStopShareETAIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  id v4;
  INStopShareETAIntent *v5;
  INStopShareETAIntent *v6;
  objc_super v8;
  ...
  v6 = v5;
  if (v5)
    -[INStopShareETAIntent setRecipients:](v5, "setRecipients:", v4);
...
- (id)_dictionaryRepresentation
{
  ...
  v6 = CFSTR("recipients");
  -[INStopShareETAIntent recipients](self, "recipients");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = v2;
  if (!v2)
  {
