...
+ (INNoteContentTypeResolutionResult)successWithResolvedNoteContentType:(INNoteContentType)resolvedNoteContentType
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INNoteContentTypeUnknown will be reformed to notRequired."), a2);
...
+ (INNoteContentTypeResolutionResult)confirmationRequiredWithNoteContentTypeToConfirm:(INNoteContentType)noteContentTypeToConfirm
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INNoteContentTypeUnknown is not supported."), 0);
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INNoteContentTypeResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INNoteContentTypeResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
