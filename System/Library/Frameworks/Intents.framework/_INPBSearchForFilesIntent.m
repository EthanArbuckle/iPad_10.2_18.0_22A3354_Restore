...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSearchForFilesIntent appId](self, "appId");
  ...
  -[_INPBSearchForFilesIntent entityName](self, "entityName");
  ...
  if (-[_INPBSearchForFilesIntent hasEntityType](self, "hasEntityType"))
    PBDataWriterWriteInt32Field();
  -[_INPBSearchForFilesIntent intentMetadata](self, "intentMetadata");
  ...
  if (-[_INPBSearchForFilesIntent hasScope](self, "hasScope", v18))
    PBDataWriterWriteInt32Field();
  -[_INPBSearchForFilesIntent scopeEntityName](self, "scopeEntityName");
...
- (_INPBSearchForFilesIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBSearchForFilesIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBSearchForFilesIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSearchForFilesIntent data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBSearchForFilesIntent init](+[_INPBSearchForFilesIntent allocWithZone:](_INPBSearchForFilesIntent, "allocWithZone:"), "init");
  v6 = -[_INPBString copyWithZone:](self->_appId, "copyWithZone:", a3);
  -[_INPBSearchForFilesIntent setAppId:](v5, "setAppId:", v6);

  v7 = -[_INPBString copyWithZone:](self->_entityName, "copyWithZone:", a3);
  -[_INPBSearchForFilesIntent setEntityName:](v5, "setEntityName:", v7);

  if (-[_INPBSearchForFilesIntent hasEntityType](self, "hasEntityType"))
    -[_INPBSearchForFilesIntent setEntityType:](v5, "setEntityType:", -[_INPBSearchForFilesIntent entityType](self, "entityType"));
  v8 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBSearchForFilesIntent setIntentMetadata:](v5, "setIntentMetadata:", v8);

  v9 = (void *)-[NSArray copyWithZone:](self->_properties, "copyWithZone:", a3);
  -[_INPBSearchForFilesIntent setProperties:](v5, "setProperties:", v9);

  if (-[_INPBSearchForFilesIntent hasScope](self, "hasScope"))
    -[_INPBSearchForFilesIntent setScope:](v5, "setScope:", -[_INPBSearchForFilesIntent scope](self, "scope"));
  v10 = -[_INPBString copyWithZone:](self->_scopeEntityName, "copyWithZone:", a3);
  -[_INPBSearchForFilesIntent setScopeEntityName:](v5, "setScopeEntityName:", v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  v17 = -[_INPBSearchForFilesIntent hasEntityType](self, "hasEntityType");
  ...
  -[_INPBSearchForFilesIntent properties](self, "properties");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  v29 = -[_INPBSearchForFilesIntent hasScope](self, "hasScope");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBSearchForFilesIntent hasEntityType](self, "hasEntityType"))
  {
    v8 = -[_INPBSearchForFilesIntent entityType](self, "entityType");
    if (v8 >= 4)
    {
  ...
  if (-[_INPBSearchForFilesIntent hasScope](self, "hasScope"))
  {
    v19 = -[_INPBSearchForFilesIntent scope](self, "scope");
    if (v19 >= 3)
    {
