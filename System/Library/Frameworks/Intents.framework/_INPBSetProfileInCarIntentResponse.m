...
- (_INPBSetProfileInCarIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBSetProfileInCarIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBSetProfileInCarIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSetProfileInCarIntentResponse data](self, "data");
...
{
  return -[_INPBSetProfileInCarIntentResponse init](+[_INPBSetProfileInCarIntentResponse allocWithZone:](_INPBSetProfileInCarIntentResponse, "allocWithZone:", a3), "init");
}
