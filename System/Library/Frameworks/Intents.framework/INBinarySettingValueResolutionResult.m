...
+ (id)successWithResolvedBinarySettingValue:(int64_t)a3
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INBinarySettingValueUnknown will be reformed to notRequired."), a2);
...
+ (id)confirmationRequiredWithBinarySettingValueToConfirm:(int64_t)a3
{
  ...
  if (!a3)
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INBinarySettingValueUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 234)
  {
    ...
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v8 < 3)
          ...
          v9 = 0x7FFFFFFFLL;
        -[_INPBIntentSlotValue addPayloadBinarySettingValue:](v7, "addPayloadBinarySettingValue:", v9);
      }
    }
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INBinarySettingValueResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INBinarySettingValueResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
