...
- (id)init
{
  return -[INSetAudioSourceInCarIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INSetAudioSourceInCarIntentResponse)initWithCode:(INSetAudioSourceInCarIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  __CFString *v8;
  NSObject *v9;
  INSetAudioSourceInCarIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INSetAudioSourceInCarIntentResponseCode v16;
  __int16 v17;
  __CFString *v18;
  __int16 v19;
  NSUserActivity *v20;
...
{
  INSetAudioSourceInCarIntentResponseCode v2;

  v2 = -[INSetAudioSourceInCarIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INSetAudioSourceInCarIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetAudioSourceInCarIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetAudioSourceInCarIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetAudioSourceInCarIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetAudioSourceInCarIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetAudioSourceInCarIntentResponseCodeFailureRequiringAppLaunch"));
