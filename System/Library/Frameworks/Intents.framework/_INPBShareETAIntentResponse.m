...
- (void)dealloc
{
  ...
  -[_INPBShareETAIntentResponse clearMediums](self, "clearMediums");
  v3.receiver = self;
  v3.super_class = (Class)_INPBShareETAIntentResponse;
  -[_INPBShareETAIntentResponse dealloc](&v3, sel_dealloc);
}
...
- (_INPBShareETAIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBShareETAIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBShareETAIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBShareETAIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBShareETAIntentResponse data](self, "data");
...
{
  _INPBShareETAIntentResponse *v5;
  void *v6;

  v5 = -[_INPBShareETAIntentResponse init](+[_INPBShareETAIntentResponse allocWithZone:](_INPBShareETAIntentResponse, "allocWithZone:"), "init");
  PBRepeatedInt32Copy();
  v6 = (void *)-[NSArray copyWithZone:](self->_recipients, "copyWithZone:", a3);
  -[_INPBShareETAIntentResponse setRecipients:](v5, "setRecipients:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBShareETAIntentResponse recipients](self, "recipients");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_mediums.count)
  {
    objc_msgSend(MEMORY[0x1E0C99DE8], "arrayWithCapacity:", -[_INPBShareETAIntentResponse mediumsCount](self, "mediumsCount"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
    if (-[_INPBShareETAIntentResponse mediumsCount](self, "mediumsCount"))
    {
      v5 = 0;
      do
      {
      ...
      while (v5 < -[_INPBShareETAIntentResponse mediumsCount](self, "mediumsCount"));
    }
