...
- (_INPBDialingContact)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDialingContact *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDialingContact initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBDialingContact data](self, "data");
...
{
  _INPBDialingContact *v5;
  void *v6;

  v5 = -[_INPBDialingContact init](+[_INPBDialingContact allocWithZone:](_INPBDialingContact, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBDialingContact setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBDialingContact values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
