...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  if (-[_INPBStartAudioCallIntentResponse hasAudioRoute](self, "hasAudioRoute"))
    PBDataWriterWriteInt32Field();
  -[_INPBStartAudioCallIntentResponse metrics](self, "metrics");
  ...
  -[_INPBStartAudioCallIntentResponse status](self, "status");
...
- (_INPBStartAudioCallIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBStartAudioCallIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBStartAudioCallIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBStartAudioCallIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBStartAudioCallIntentResponse data](self, "data");
...
{
  _INPBStartAudioCallIntentResponse *v5;
  id v6;
  void *v7;
  void *v8;

  v5 = -[_INPBStartAudioCallIntentResponse init](+[_INPBStartAudioCallIntentResponse allocWithZone:](_INPBStartAudioCallIntentResponse, "allocWithZone:"), "init");
  if (-[_INPBStartAudioCallIntentResponse hasAudioRoute](self, "hasAudioRoute"))
    -[_INPBStartAudioCallIntentResponse setAudioRoute:](v5, "setAudioRoute:", -[_INPBStartAudioCallIntentResponse audioRoute](self, "audioRoute"));
  v6 = -[_INPBCallMetrics copyWithZone:](self->_metrics, "copyWithZone:", a3);
  -[_INPBStartAudioCallIntentResponse setMetrics:](v5, "setMetrics:", v6);

  v7 = (void *)-[NSString copyWithZone:](self->_status, "copyWithZone:", a3);
  -[_INPBStartAudioCallIntentResponse setStatus:](v5, "setStatus:", v7);

  v8 = (void *)-[NSArray copyWithZone:](self->_targetContacts, "copyWithZone:", a3);
  -[_INPBStartAudioCallIntentResponse setTargetContacts:](v5, "setTargetContacts:", v8);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_21;
  v5 = -[_INPBStartAudioCallIntentResponse hasAudioRoute](self, "hasAudioRoute");
  ...
  -[_INPBStartAudioCallIntentResponse targetContacts](self, "targetContacts");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBStartAudioCallIntentResponse hasAudioRoute](self, "hasAudioRoute"))
  {
    v4 = -[_INPBStartAudioCallIntentResponse audioRoute](self, "audioRoute");
    if ((v4 - 2) >= 3)
    {
