...
{
  return -[INOpenSettingIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INOpenSettingIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  __CFString *v8;
  NSObject *v9;
  INOpenSettingIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INOpenSettingIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 7)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeFailureRequiringAppLaunch")))v4 = 5;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeFailureSettingUnsupported")))v4 = 6;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeFailureSettingNotFound")))v5 = 7;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INOpenSettingIntentResponseCodeFailureOtherWithReason"));
...
- (void)setPunchoutUrl:(id)a3
{
  ...
  objc_msgSend(v5, "setPunchoutUrl:", v4);
...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = CFSTR("code");
  v3 = -[INOpenSettingIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 8)
  {
    v5 = off_1E22949C8[v3];
  ...
  v13[0] = v5;
  v12[1] = CFSTR("punchoutUrl");
  -[INOpenSettingIntentResponse punchoutUrl](self, "punchoutUrl");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
  ...
  -[INOpenSettingIntentResponse errorDetail](self, "errorDetail");
