...
- (INHandleIntentForwardingActionResponse)initWithIntentResponse:(id)a3 launchContextActivityData:(id)a4 cacheItems:(id)a5 error:(id)a6
{
  ...
  id v12;
  id v13;
  INHandleIntentForwardingActionResponse *v14;
  INHandleIntentForwardingActionResponse *v15;
  objc_super v17;
...
- (INHandleIntentForwardingActionResponse)initWithCoder:(id)a3
{
  ...
  void *v15;
  void *v16;
  INHandleIntentForwardingActionResponse *v17;
  void *v19;
  void *v20;
  ...
  v17 = -[INHandleIntentForwardingActionResponse initWithIntentResponse:launchContextActivityData:cacheItems:error:](self, "initWithIntentResponse:launchContextActivityData:cacheItems:error:", v20, v19, v7, v16);
  return v17;
}
