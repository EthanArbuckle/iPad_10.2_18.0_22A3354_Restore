...
- (_INPBContact)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBContact *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBContact initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBContact init](+[_INPBContact allocWithZone:](_INPBContact, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBContact setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBContact values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
