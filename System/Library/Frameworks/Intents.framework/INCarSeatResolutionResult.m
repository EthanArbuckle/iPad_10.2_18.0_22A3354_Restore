...
+ (INCarSeatResolutionResult)successWithResolvedCarSeat:(INCarSeat)resolvedCarSeat
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INCarSeatUnknown will be reformed to notRequired."), a2);
...
+ (INCarSeatResolutionResult)confirmationRequiredWithCarSeatToConfirm:(INCarSeat)carSeatToConfirm
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INCarSeatUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 123)
  {
    ...
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v8 > 0xB)
          ...
          v9 = dword_18C311304[v8];
        -[_INPBIntentSlotValue addPayloadCarSeat:](v7, "addPayloadCarSeat:", v9);
      }
    }
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INCarSeatResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
