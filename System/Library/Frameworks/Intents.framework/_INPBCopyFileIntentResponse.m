...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_INPBCopyFileIntentResponse destinationName](self, "destinationName");
  ...
  -[_INPBCopyFileIntentResponse entityName](self, "entityName");
  ...
  if (-[_INPBCopyFileIntentResponse hasEntityType](self, "hasEntityType"))
    PBDataWriterWriteInt32Field();
  if (-[_INPBCopyFileIntentResponse hasOverwrite](self, "hasOverwrite"))
    PBDataWriterWriteBOOLField();
  if (-[_INPBCopyFileIntentResponse hasSuccess](self, "hasSuccess"))
    PBDataWriterWriteBOOLField();
...
- (_INPBCopyFileIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBCopyFileIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBCopyFileIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBCopyFileIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBCopyFileIntentResponse data](self, "data");
...
{
  _INPBCopyFileIntentResponse *v5;
  id v6;
  id v7;

  v5 = -[_INPBCopyFileIntentResponse init](+[_INPBCopyFileIntentResponse allocWithZone:](_INPBCopyFileIntentResponse, "allocWithZone:"), "init");
  v6 = -[_INPBString copyWithZone:](self->_destinationName, "copyWithZone:", a3);
  -[_INPBCopyFileIntentResponse setDestinationName:](v5, "setDestinationName:", v6);

  v7 = -[_INPBString copyWithZone:](self->_entityName, "copyWithZone:", a3);
  -[_INPBCopyFileIntentResponse setEntityName:](v5, "setEntityName:", v7);

  if (-[_INPBCopyFileIntentResponse hasEntityType](self, "hasEntityType"))
    -[_INPBCopyFileIntentResponse setEntityType:](v5, "setEntityType:", -[_INPBCopyFileIntentResponse entityType](self, "entityType"));
  if (-[_INPBCopyFileIntentResponse hasOverwrite](self, "hasOverwrite"))
    -[_INPBCopyFileIntentResponse setOverwrite:](v5, "setOverwrite:", -[_INPBCopyFileIntentResponse overwrite](self, "overwrite"));
  if (-[_INPBCopyFileIntentResponse hasSuccess](self, "hasSuccess"))
    -[_INPBCopyFileIntentResponse setSuccess:](v5, "setSuccess:", -[_INPBCopyFileIntentResponse success](self, "success"));
  return v5;
}
...
LABEL_11:
  ...
  v19 = -[_INPBCopyFileIntentResponse hasEntityType](self, "hasEntityType");
  if (v19 == objc_msgSend(v4, "hasEntityType"))
  {
    ...
    {
      v21 = -[_INPBCopyFileIntentResponse hasOverwrite](self, "hasOverwrite");
      if (v21 == objc_msgSend(v4, "hasOverwrite"))
      {
        ...
        {
          v23 = -[_INPBCopyFileIntentResponse hasSuccess](self, "hasSuccess");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBCopyFileIntentResponse hasEntityType](self, "hasEntityType"))
  {
    v8 = -[_INPBCopyFileIntentResponse entityType](self, "entityType");
    if (v8 >= 4)
    {
  ...
  if (-[_INPBCopyFileIntentResponse hasOverwrite](self, "hasOverwrite"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_INPBCopyFileIntentResponse overwrite](self, "overwrite"));
    v10 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  if (-[_INPBCopyFileIntentResponse hasSuccess](self, "hasSuccess"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_INPBCopyFileIntentResponse success](self, "success"));
