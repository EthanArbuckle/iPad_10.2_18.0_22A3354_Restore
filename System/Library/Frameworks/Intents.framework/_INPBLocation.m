...
- (_INPBLocation)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBLocation *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBLocation initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBLocation init](+[_INPBLocation allocWithZone:](_INPBLocation, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBLocation setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBLocation values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
