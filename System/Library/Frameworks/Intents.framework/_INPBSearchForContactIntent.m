...
- (void)writeTo:(id)a3
{
  ...
  -[_INPBSearchForContactIntent intentMetadata](self, "intentMetadata", v12);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  if (v10)
  {
    -[_INPBSearchForContactIntent intentMetadata](self, "intentMetadata");
...
- (_INPBSearchForContactIntent)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBSearchForContactIntent *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBSearchForContactIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBSearchForContactIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSearchForContactIntent data](self, "data");
...
{
  _INPBSearchForContactIntent *v5;
  void *v6;
  id v7;

  v5 = -[_INPBSearchForContactIntent init](+[_INPBSearchForContactIntent allocWithZone:](_INPBSearchForContactIntent, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_contactIdentifiers, "copyWithZone:", a3);
  -[_INPBSearchForContactIntent setContactIdentifiers:](v5, "setContactIdentifiers:", v6);

  v7 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBSearchForContactIntent setIntentMetadata:](v5, "setIntentMetadata:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[_INPBSearchForContactIntent contactIdentifiers](self, "contactIdentifiers");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  -[_INPBSearchForContactIntent intentMetadata](self, "intentMetadata", (_QWORD)v14);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
