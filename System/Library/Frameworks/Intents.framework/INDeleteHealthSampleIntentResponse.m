...
{
  return -[INDeleteHealthSampleIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INDeleteHealthSampleIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  __CFString *v8;
  NSObject *v9;
  INDeleteHealthSampleIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INDeleteHealthSampleIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 5)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeFailureRequiringAppLaunch")))v5 = 5;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteHealthSampleIntentResponseCodeFailureUUIDNotFound"));
