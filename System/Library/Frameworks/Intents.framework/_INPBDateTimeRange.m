...
- (_INPBDateTimeRange)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDateTimeRange *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDateTimeRange initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBDateTimeRange data](self, "data");
...
{
  _INPBDateTimeRange *v5;
  void *v6;

  v5 = -[_INPBDateTimeRange init](+[_INPBDateTimeRange allocWithZone:](_INPBDateTimeRange, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBDateTimeRange setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBDateTimeRange values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
