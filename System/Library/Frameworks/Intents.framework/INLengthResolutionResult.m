...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 19)
  {
    -[_INPBIntentSlotValue setType:](v7, "setType:", 11);
        ...
        if (v9)
        {
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              INIntentSlotValueTransformToDistanceValue(*(void **)(*((_QWORD *)&v31 + 1) + 8 * i));
              v13 = (void *)objc_claimAutoreleasedReturnValue();
              -[_INPBIntentSlotValue addPayloadDistanceValue:](v7, "addPayloadDistanceValue:", v13);
...
LABEL_25:
        ...
        -[_INPBIntentSlotValue addPayloadDistanceValue:](v7, "addPayloadDistanceValue:", v8);
LABEL_26:

      }
    }
  }
  else if (objc_msgSend(v6, "valueType") == 20)
  {
    -[_INPBIntentSlotValue setType:](v7, "setType:", 60);
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      objc_opt_class();
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v17)
        {
          ...
          do
          {
            for (j = 0; j != v18; ++j)
            {
              ...
              INIntentSlotValueTransformToDistance(*(void **)(*((_QWORD *)&v27 + 1) + 8 * j));
              v21 = (void *)objc_claimAutoreleasedReturnValue();
              -[_INPBDistanceList addDistance:](v15, "addDistance:", v21, (_QWORD)v27);
        ...
        -[_INPBIntentSlotValue addPayloadDistanceList:](v7, "addPayloadDistanceList:", v15);
      }
      else
      {
        objc_opt_class();
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 19 || objc_msgSend(v6, "valueType") == 20)
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0
      && (objc_msgSend(v5, "unit"),
