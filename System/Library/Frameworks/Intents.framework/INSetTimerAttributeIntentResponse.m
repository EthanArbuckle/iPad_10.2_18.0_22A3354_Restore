...
{
  return -[INSetTimerAttributeIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INSetTimerAttributeIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  uint64_t v8;
  NSObject *v9;
  INSetTimerAttributeIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INSetTimerAttributeIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 7)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeFailure")))
    v4 = 4;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeFailureRequiringAppLaunch")))v4 = 5;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeFailureNotFound")))
    v4 = 6;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeFailureNoTimers")))
    v5 = 7;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INSetTimerAttributeIntentResponseCodeFailureNotSupported"));
...
- (void)setUpdatedTimer:(id)a3
{
  ...
  objc_msgSend(v5, "setUpdatedTimer:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = CFSTR("code");
  v3 = -[INSetTimerAttributeIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 8)
  {
    v5 = *(&off_1E2292968 + v3);
  ...
  v10[1] = CFSTR("updatedTimer");
  v11[0] = v5;
  -[INSetTimerAttributeIntentResponse updatedTimer](self, "updatedTimer");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
