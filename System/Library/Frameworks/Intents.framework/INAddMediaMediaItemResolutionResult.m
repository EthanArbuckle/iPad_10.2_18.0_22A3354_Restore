...
+ (NSArray)successesWithResolvedMediaItems:(NSArray *)resolvedMediaItems
{
  ...
  v4.receiver = a1;
  v4.super_class = (Class)&OBJC_METACLASS___INAddMediaMediaItemResolutionResult;
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  ...
  v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INAddMediaMediaItemResolutionResult;
  ...
  if (v7)
  {
    ...
    v9 = objc_msgSend(v8, "hasAddMediaIntentMediaItemsUnsupportedReason");

    if (v9)
    {
      objc_msgSend(v6, "payloadUnsupported");
      v10 = (void *)objc_claimAutoreleasedReturnValue();
      v11 = objc_msgSend(v10, "addMediaIntentMediaItemsUnsupportedReason");
      switch(v11)
      {
        case 1:
          v12 = 1;
...
- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)INAddMediaMediaItemResolutionResult;
    ...
    && -[INIntentResolutionResult unsupportedReason](self, "unsupportedReason"))
  {
    ...
    objc_msgSend(v6, "setAddMediaIntentMediaItemsUnsupportedReason:", v8);
