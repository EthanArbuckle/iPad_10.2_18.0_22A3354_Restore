...
- (void)writeTo:(id)a3
{
  ...
  -[_INPBConfigureHomeIntent intentMetadata](self, "intentMetadata", v12);
  v10 = (void *)objc_claimAutoreleasedReturnValue();

  if (v10)
  {
    -[_INPBConfigureHomeIntent intentMetadata](self, "intentMetadata");
...
- (_INPBConfigureHomeIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBConfigureHomeIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBConfigureHomeIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBConfigureHomeIntent data](self, "data");
...
{
  _INPBConfigureHomeIntent *v5;
  void *v6;
  id v7;

  v5 = -[_INPBConfigureHomeIntent init](+[_INPBConfigureHomeIntent allocWithZone:](_INPBConfigureHomeIntent, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_entities, "copyWithZone:", a3);
  -[_INPBConfigureHomeIntent setEntities:](v5, "setEntities:", v6);

  v7 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBConfigureHomeIntent setIntentMetadata:](v5, "setIntentMetadata:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_12;
  -[_INPBConfigureHomeIntent entities](self, "entities");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)dictionaryRepresentation
{
  ...
  -[_INPBConfigureHomeIntent intentMetadata](self, "intentMetadata", (_QWORD)v14);
  v11 = (void *)objc_claimAutoreleasedReturnValue();
