...
- (void)writeTo:(id)a3
{
  ...
  v9 = a3;
  -[_INPBCompressFileIntent entityName](self, "entityName");
  ...
  if (-[_INPBCompressFileIntent hasEntityType](self, "hasEntityType"))
    PBDataWriterWriteInt32Field();
  -[_INPBCompressFileIntent intentMetadata](self, "intentMetadata");
...
- (_INPBCompressFileIntent)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBCompressFileIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBCompressFileIntent initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBCompressFileIntent data](self, "data");
...
{
  _INPBCompressFileIntent *v5;
  id v6;
  id v7;

  v5 = -[_INPBCompressFileIntent init](+[_INPBCompressFileIntent allocWithZone:](_INPBCompressFileIntent, "allocWithZone:"), "init");
  v6 = -[_INPBString copyWithZone:](self->_entityName, "copyWithZone:", a3);
  -[_INPBCompressFileIntent setEntityName:](v5, "setEntityName:", v6);

  if (-[_INPBCompressFileIntent hasEntityType](self, "hasEntityType"))
    -[_INPBCompressFileIntent setEntityType:](v5, "setEntityType:", -[_INPBCompressFileIntent entityType](self, "entityType"));
  v7 = -[_INPBIntentMetadata copyWithZone:](self->_intentMetadata, "copyWithZone:", a3);
  -[_INPBCompressFileIntent setIntentMetadata:](v5, "setIntentMetadata:", v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  v12 = -[_INPBCompressFileIntent hasEntityType](self, "hasEntityType");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBCompressFileIntent hasEntityType](self, "hasEntityType"))
  {
    v6 = -[_INPBCompressFileIntent entityType](self, "entityType");
    if (v6 >= 4)
    {
