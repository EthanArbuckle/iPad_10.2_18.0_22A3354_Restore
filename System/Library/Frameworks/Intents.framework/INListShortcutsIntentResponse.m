...
{
  return -[INListShortcutsIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INListShortcutsIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  uint64_t v8;
  NSObject *v9;
  INListShortcutsIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
...
- (int64_t)_intentResponseCode
{
  ...
  v2 = -[INListShortcutsIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INListShortcutsIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INListShortcutsIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INListShortcutsIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INListShortcutsIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INListShortcutsIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INListShortcutsIntentResponseCodeFailureRequiringAppLaunch"));
...
- (NSArray)shortcuts
{
  ...
  INIntentSlotValueTransformFromShortcutOverviews(v3);
...
- (void)setShortcuts:(id)a3
{
  ...
  INIntentSlotValueTransformToShortcutOverviews(v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue();

  objc_msgSend(v5, "setShortcuts:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = CFSTR("code");
  v3 = -[INListShortcutsIntentResponse code](self, "code");
  v4 = v3;
  if (v3 <= 5)
  {
    v5 = *(&off_1E2294020 + v3);
  ...
  v10[1] = CFSTR("shortcuts");
  v11[0] = v5;
  -[INListShortcutsIntentResponse shortcuts](self, "shortcuts");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
