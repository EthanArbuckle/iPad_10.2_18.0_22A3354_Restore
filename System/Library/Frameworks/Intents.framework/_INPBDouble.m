...
- (_INPBDouble)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDouble *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDouble initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBDouble init](+[_INPBDouble allocWithZone:](_INPBDouble, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBDouble setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBDouble values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
