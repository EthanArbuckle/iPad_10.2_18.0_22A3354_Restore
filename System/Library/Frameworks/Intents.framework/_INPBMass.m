...
- (_INPBMass)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBMass *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBMass initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBMass init](+[_INPBMass allocWithZone:](_INPBMass, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBMass setValues:](v5, "setValues:", v6);
