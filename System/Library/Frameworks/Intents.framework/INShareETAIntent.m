...
- (id)_metadata
{
  ...
  -[INShareETAIntent _typedBackingStore](self, "_typedBackingStore");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
...
- (INShareETAIntent)initWithRecipients:(id)a3
{
  ...
  v6 = v5;
  if (v5)
    -[INShareETAIntent setRecipients:](v5, "setRecipients:", v4);
...
- (id)_dictionaryRepresentation
{
  ...
  v6 = CFSTR("recipients");
  -[INShareETAIntent recipients](self, "recipients");
  v2 = (void *)objc_claimAutoreleasedReturnValue();
  v3 = v2;
  if (!v2)
  {
