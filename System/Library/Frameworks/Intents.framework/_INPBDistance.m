...
- (_INPBDistance)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDistance *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDistance initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBDistance init](+[_INPBDistance allocWithZone:](_INPBDistance, "allocWithZone:"), "init");
  v6 = (void *)-[NSArray copyWithZone:](self->_values, "copyWithZone:", a3);
  -[_INPBDistance setValues:](v5, "setValues:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    -[_INPBDistance values](self, "values");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
