...
- (void)writeTo:(id)a3
{
  ...
  v7 = a3;
  if (-[_INPBBoolValue hasValue](self, "hasValue"))
    PBDataWriterWriteBOOLField();
  -[_INPBBoolValue valueMetadata](self, "valueMetadata");
...
- (_INPBBoolValue)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBBoolValue *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBBoolValue initWithData:](self, "initWithData:", v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBBoolValue init](+[_INPBBoolValue allocWithZone:](_INPBBoolValue, "allocWithZone:"), "init");
  if (-[_INPBBoolValue hasValue](self, "hasValue"))
    -[_INPBBoolValue setValue:](v5, "setValue:", -[_INPBBoolValue value](self, "value"));
  v6 = -[_INPBValueMetadata copyWithZone:](self->_valueMetadata, "copyWithZone:", a3);
  -[_INPBBoolValue setValueMetadata:](v5, "setValueMetadata:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = -[_INPBBoolValue hasValue](self, "hasValue");
...
- (id)dictionaryRepresentation
{
  ...
  if (-[_INPBBoolValue hasValue](self, "hasValue"))
  {
    objc_msgSend(MEMORY[0x1E0CB37E8], "numberWithBool:", -[_INPBBoolValue value](self, "value"));
    v4 = (void *)objc_claimAutoreleasedReturnValue();
