...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBDataStringList conditionType](self, "conditionType");
...
- (_INPBDataStringList)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBDataStringList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBDataStringList initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBDataStringList data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBDataStringList init](+[_INPBDataStringList allocWithZone:](_INPBDataStringList, "allocWithZone:"), "init");
  v6 = -[_INPBCondition copyWithZone:](self->_conditionType, "copyWithZone:", a3);
  -[_INPBDataStringList setConditionType:](v5, "setConditionType:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[_INPBDataStringList dataStrings](self, "dataStrings");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
