...
- (void)writeTo:(id)a3
{
  ...
  v4 = a3;
  -[_INPBStringList conditionType](self, "conditionType");
...
- (_INPBStringList)initWithCoder:(id)a3
{
  ...
  v6 = (_INPBStringList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBStringList initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBStringList data](self, "data");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[_INPBStringList init](+[_INPBStringList allocWithZone:](_INPBStringList, "allocWithZone:"), "init");
  v6 = -[_INPBCondition copyWithZone:](self->_conditionType, "copyWithZone:", a3);
  -[_INPBStringList setConditionType:](v5, "setConditionType:", v6);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[_INPBStringList dataStrings](self, "dataStrings");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
