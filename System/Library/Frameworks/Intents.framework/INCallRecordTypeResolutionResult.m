...
+ (INCallRecordTypeResolutionResult)successWithResolvedCallRecordType:(INCallRecordType)resolvedCallRecordType
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INCallRecordTypeUnknown will be reformed to notRequired."), a2);
...
+ (INCallRecordTypeResolutionResult)confirmationRequiredWithCallRecordTypeToConfirm:(INCallRecordType)callRecordTypeToConfirm
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INCallRecordTypeUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 71 || objc_msgSend(v6, "valueType") == 72)
  {
    -[_INPBIntentSlotValue setType:](v7, "setType:", 1000);
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0 && (unint64_t)(objc_msgSend(v5, "integerValue") - 1) <= 7)
    {
      v8 = objc_msgSend(v5, "integerValue") - 1;
      if (v8 > 7)
        v9 = 0x7FFFFFFFLL;
      else
        v9 = dword_18C311748[v8];
      -[_INPBIntentSlotValue addPayloadCallRecordType:](v7, "addPayloadCallRecordType:", v9);
    }
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INCallRecordTypeResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INCallRecordTypeResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
