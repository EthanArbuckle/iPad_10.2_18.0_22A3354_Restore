...
- (id)init
{
  return -[INDeleteTasksIntentResponse initWithCode:userActivity:](self, "initWithCode:userActivity:", 0, 0);
}
...
- (INDeleteTasksIntentResponse)initWithCode:(INDeleteTasksIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  __CFString *v8;
  NSObject *v9;
  INDeleteTasksIntentResponse *v10;
  objc_super v12;
  uint8_t buf[4];
  const char *v14;
  __int16 v15;
  INDeleteTasksIntentResponseCode v16;
  __int16 v17;
  __CFString *v18;
  __int16 v19;
  NSUserActivity *v20;
...
{
  INDeleteTasksIntentResponseCode v2;

  v2 = -[INDeleteTasksIntentResponse code](self, "code");
  if ((unint64_t)(v2 - 1) > 4)
    return 0;
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v3 = a3;
  objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTasksIntentResponseCodeUnspecified"));
  v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTasksIntentResponseCodeReady"));
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTasksIntentResponseCodeInProgress")))
    v4 = 2;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTasksIntentResponseCodeSuccess")))
    v4 = 3;
  if (objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTasksIntentResponseCodeFailure")))
    v5 = 4;
  else
    v5 = v4;
  v6 = objc_msgSend(v3, "isEqualToString:", CFSTR("INDeleteTasksIntentResponseCodeFailureRequiringAppLaunch"));
...
- (void)setDeletedTasks:(NSArray *)deletedTasks
{
  ...
  objc_msgSend(v5, "setDeletedTasks:", v6);
  -[INIntentResponse _responseMessagePBRepresentation](self, "_responseMessagePBRepresentation");
...
{
  INDeleteTasksIntentResponseCode v3;
  unint64_t v4;
  __CFString *v5;
  void *v6;
  void *v7;
  ...
  v10[0] = CFSTR("code");
  v3 = -[INDeleteTasksIntentResponse code](self, "code");
  v4 = v3;
  ...
  v10[1] = CFSTR("deletedTasks");
  v11[0] = v5;
  -[INDeleteTasksIntentResponse deletedTasks](self, "deletedTasks");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  v7 = v6;
  if (!v6)
  {
