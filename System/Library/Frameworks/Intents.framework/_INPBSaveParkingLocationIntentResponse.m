...
- (void)writeTo:(id)a3
{
  ...
  v8 = a3;
  -[_INPBSaveParkingLocationIntentResponse parkingLocation](self, "parkingLocation");
  ...
  -[_INPBSaveParkingLocationIntentResponse parkingNote](self, "parkingNote");
...
- (_INPBSaveParkingLocationIntentResponse)initWithCoder:(id)a3
{
  id v4;
  void *v5;
  _INPBSaveParkingLocationIntentResponse *v6;
  uint64_t v7;
  void *v8;
  ...
  v6 = (_INPBSaveParkingLocationIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (v7 = objc_opt_class(),
        ...
        v6))
  {
    self = -[_INPBSaveParkingLocationIntentResponse initWithData:](self, "initWithData:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[_INPBSaveParkingLocationIntentResponse data](self, "data");
...
{
  _INPBSaveParkingLocationIntentResponse *v5;
  id v6;
  id v7;

  v5 = -[_INPBSaveParkingLocationIntentResponse init](+[_INPBSaveParkingLocationIntentResponse allocWithZone:](_INPBSaveParkingLocationIntentResponse, "allocWithZone:"), "init");
  v6 = -[_INPBLocation copyWithZone:](self->_parkingLocation, "copyWithZone:", a3);
  -[_INPBSaveParkingLocationIntentResponse setParkingLocation:](v5, "setParkingLocation:", v6);

  v7 = -[_INPBString copyWithZone:](self->_parkingNote, "copyWithZone:", a3);
  -[_INPBSaveParkingLocationIntentResponse setParkingNote:](v5, "setParkingNote:", v7);
