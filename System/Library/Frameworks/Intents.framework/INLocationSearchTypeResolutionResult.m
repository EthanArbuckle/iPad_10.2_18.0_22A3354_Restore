...
+ (INLocationSearchTypeResolutionResult)successWithResolvedLocationSearchType:(INLocationSearchType)resolvedLocationSearchType
{
  ...
  {
    NSLog((NSString *)CFSTR("Success resolution with INLocationSearchTypeUnknown will be reformed to notRequired."), a2);
...
+ (INLocationSearchTypeResolutionResult)confirmationRequiredWithLocationSearchTypeToConfirm:(INLocationSearchType)locationSearchTypeToConfirm
{
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99DA0], "exceptionWithName:reason:userInfo:", *MEMORY[0x1E0C99778], CFSTR("Confirmation of INLocationSearchTypeUnknown is not supported."), 0);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (objc_msgSend(v6, "valueType") == 127)
  {
    ...
    if (objc_msgSend(v6, "valueStyle") != 3)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0)
      {
        ...
        if (v8)
          ...
          v10 = 0;
        -[_INPBIntentSlotValue addPayloadLocationSearchType:](v7, "addPayloadLocationSearchType:", v10);
      }
    }
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  id v9;
  id v10;
  void (**v11)(id, INLocationSearchTypeResolutionResult *);
  int64_t v12;
  void *v13;
  void *v14;
  void *v15;
  ...
  id v40;
  void *v41;
  INLocationSearchTypeResolutionResult *v42;
  id v43;
  __int128 v44;
  __int128 v45;
  __int128 v46;
