...
_QWORD *___UTTypeTagsAreSuperset_block_invoke(uint64_t a1, unsigned int a2, unsigned int a3)
{
  uint64_t v3;
  uint64_t *v4;
  unsigned int v6;
...
uint64_t *___UTTypeTagsAreSuperset_block_invoke_2(uint64_t a1, unsigned int a2, unsigned int a3, _BYTE *a4)
{
  ...
  v7 = a3;
  v8 = a2;
  result = std::__hash_table<std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>,std::__unordered_map_hasher<unsigned int,std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>,std::hash<unsigned int>,std::equal_to<unsigned int>,true>,std::__unordered_map_equal<unsigned int,std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>,std::equal_to<unsigned int>,std::hash<unsigned int>,true>,std::allocator<std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>>>::find<unsigned int>((_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 48), &v8);
  if (!result
