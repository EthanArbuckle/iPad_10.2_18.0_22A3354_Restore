...
uint64_t *___UTTypeConformsTo_block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  result = std::__hash_table<std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>,std::__unordered_map_hasher<unsigned int,std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>,std::hash<unsigned int>,std::equal_to<unsigned int>,true>,std::__unordered_map_equal<unsigned int,std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>,std::equal_to<unsigned int>,std::hash<unsigned int>,true>,std::allocator<std::__hash_value_type<unsigned int,LSApplicationRecord * {__strong}>>>::find<unsigned int>((_QWORD *)(a2 + 200), (unsigned int *)(a1 + 48));
  if (result)
  {
    ...
    if (result)
    {
      *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 8) + 24) = *((_BYTE *)result + 20);
...
_QWORD *___UTTypeConformsTo_block_invoke_2(uint64_t a1, uint64_t a2)
{
  BOOL v3;
  uint64_t *v4;
  _QWORD *result;
