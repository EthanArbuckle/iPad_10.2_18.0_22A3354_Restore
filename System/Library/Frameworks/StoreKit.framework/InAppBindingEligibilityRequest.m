...
{
  id v5;
  InAppBindingEligibilityRequest *v6;
  InAppBindingEligibilityRequest *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)InAppBindingEligibilityRequest;
  v6 = -[InAppBindingEligibilityRequest init](&v9, sel_init);
  v7 = v6;
  if (v6)
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  -[InAppBindingEligibilityRequest pinningID](self, "pinningID");
...
- (InAppBindingEligibilityRequest)initWithCoder:(id)a3
{
  ...
  v6 = -[InAppBindingEligibilityRequest initWithPinningID:](self, "initWithPinningID:", v5);
  return v6;
}
