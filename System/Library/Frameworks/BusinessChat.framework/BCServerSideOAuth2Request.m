...
- (id)_initWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    if (v8)
    {
      +[BCServerSideOAuth2URLProvider URLProviderWithDictionary:](BCServerSideOAuth2URLProvider, "URLProviderWithDictionary:", v8);
      v9 = (void *)objc_claimAutoreleasedReturnValue();
      if (v9)
      {
        v13.receiver = self;
        v13.super_class = (Class)BCServerSideOAuth2Request;
        self = (BCServerSideOAuth2Request *)-[BCOAuth2Request _initWithDictionary:URLProvider:](&v13, sel__initWithDictionary_URLProvider_, v4, v9);
        v10 = self;
      }
      else
      {
