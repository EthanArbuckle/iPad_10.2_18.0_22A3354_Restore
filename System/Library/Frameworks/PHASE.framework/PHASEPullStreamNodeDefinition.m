...
{
  -[PHASEPullStreamNodeDefinition doesNotRecognizeSelector:](self, "doesNotRecognizeSelector:", a2);
...
- (PHASEPullStreamNodeDefinition)initWithMixerDefinition:(id)a3 format:(id)a4 identifier:(id)a5
{
  ...
  id v9;
  id v10;
  PHASEPullStreamNodeDefinition *v11;
  PHASEPullStreamNodeDefinition *v12;

  v8 = a3;
  v9 = a4;
  v10 = a5;
  v11 = -[PHASEPullStreamNodeDefinition initWithMixerDefinition:format:](self, "initWithMixerDefinition:format:", v8, v9);
  v12 = v11;
  if (v11)
...
- (PHASEPullStreamNodeDefinition)initWithMixerDefinition:(id)a3 format:(id)a4
{
  ...
  NSObject *v12;
  os_log_type_t v13;
  PHASEPullStreamNodeDefinition *v14;
  void *v15;
  _BOOL4 v16;
  id v17;
  void *v18;
  ...
  if (!v8)
    goto LABEL_23;
  v9 = (Phase::Logger *)objc_msgSend(v7, "commonFormat");
  if (v9 == (Phase::Logger *)1)
  {
    if (objc_msgSend(v7, "channelCount") < 2
      || (v9 = (Phase::Logger *)objc_msgSend(v7, "isInterleaved"), !(_DWORD)v9))
    {
      objc_msgSend(v7, "channelLayout");
...
LABEL_23:
      ...
      v19 = (Phase::Logger *)objc_msgSend(v7, "channelCount");
      switch((_DWORD)v19)
      {
        case 0:
...
LABEL_21:
        ...
        default:
          ...
          {
            v31 = objc_msgSend(v7, "channelCount");
