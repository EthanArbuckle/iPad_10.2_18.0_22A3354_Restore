...
+ (MLCAdamOptimizer)optimizerWithDescriptor:(MLCOptimizerDescriptor *)optimizerDescriptor beta1:(float)beta1 beta2:(float)beta2 epsilon:(float)epsilon timeStep:(NSUInteger)timeStep
{
  ...
  *(float *)&v15 = beta2;
  *(float *)&v16 = epsilon;
  v17 = (void *)objc_msgSend(v13, "initWithDescriptor:beta1:beta2:epsilon:usesAMSGrad:timeStep:", v12, 0, timeStep, v14, v15, v16);
...
- (MLCAdamOptimizer)initWithDescriptor:(id)a3 beta1:(float)a4 beta2:(float)a5 epsilon:(float)a6 usesAMSGrad:(BOOL)a7 timeStep:(unint64_t)a8
{
  _BOOL4 v9;
  id v15;
  MLCAdamOptimizer *v16;
  MLCAdamOptimizer *v17;
  uint64_t v18;
  objc_super v20;
  objc_super v21;
...
- (BOOL)compileForDevice:(id)a3
{
  ...
  -[MLCAdamOptimizer optimizerDescriptor](self, "optimizerDescriptor");
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  -[MLCAdamOptimizer beta1](self, "beta1");
  v9 = v8;
  -[MLCAdamOptimizer beta2](self, "beta2");
  v11 = v10;
  -[MLCAdamOptimizer epsilon](self, "epsilon");
  v13 = v12;
  v14 = -[MLCAdamOptimizer usesAMSGrad](self, "usesAMSGrad");
  v15 = -[MLCAdamOptimizer timeStep](self, "timeStep");
  LODWORD(v16) = v9;
  LODWORD(v17) = v11;
  LODWORD(v18) = v13;
  objc_msgSend(v6, "optimizerAdamWithDescriptor:beta1:beta2:epsilon:amsgrad:timeStep:isAdamW:", v7, v14, v15, 0, v16, v17, v18);
...
- (NSString)description
{
  ...
  -[MLCAdamOptimizer epsilon](self, "epsilon");
  v11 = v10;
  v12 = -[MLCAdamOptimizer usesAMSGrad](self, "usesAMSGrad");
  v13 = -[MLCAdamOptimizer timeStep](self, "timeStep");
  -[MLCAdamOptimizer optimizerDescriptor](self, "optimizerDescriptor");
