...
void sub_1CD052AC0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location, char a17)
{
  id *v17;
...
{
  DispatchXPCConnectionQueueIfNecessaryAndWait(a1, 1);
}

void sub_1CD052C28(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
  id *v16;
  uint64_t v17;
...
void sub_1CD052D5C(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_1CD053078(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_1CD053348(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, id location)
{
  id *v20;
  id *v21;
...
void sub_1CD0534BC(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
void sub_1CD0536E4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location, char a17)
{
  id *v17;
...
void sub_1CD053B34(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location, char a17)
{
  id *v17;
...
void sub_1CD053FE8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  uint64_t v10;
  va_list va;
  uint64_t v12;
...
void DispatchXPCConnectionQueueIfNecessaryAndWait(void *a1, int a2)
{
  ...
  if (DispatchXPCConnectionQueueIfNecessaryAndWait_onceToken != -1)
    dispatch_once(&DispatchXPCConnectionQueueIfNecessaryAndWait_onceToken, &__block_literal_global_25);
...
void sub_1CD054544(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_list va;
...
void sub_1CD05471C(_Unwind_Exception *a1)
{
  uint64_t v1;
