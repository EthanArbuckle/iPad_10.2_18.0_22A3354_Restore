...
void ___EXAuditTokenForCurrentProcess_block_invoke()
{
  ...
  task_info_outCnt = 8;
  v0 = task_info(*MEMORY[0x1E0C83DA0], 0xFu, _EXAuditTokenForCurrentProcess_sOurAuditToken, &task_info_outCnt);
  if (v0)
  {
    v1 = v0;
    _EXDefaultLog();
...
void ___EXAuditTokenForCurrentProcess_block_invoke_cold_1(int a1, NSObject *a2)
{
  ...
  v2 = 134217984;
  v3 = a1;
  _os_log_error_impl(&dword_190C25000, a2, OS_LOG_TYPE_ERROR, "Failed to get audit token for current process: %llx", (uint8_t *)&v2, 0xCu);
}
