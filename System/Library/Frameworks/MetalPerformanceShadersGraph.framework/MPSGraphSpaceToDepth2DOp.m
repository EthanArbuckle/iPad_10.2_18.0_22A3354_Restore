...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  objc_msgSend(v15, "stringWithFormat:", CFSTR("%@/%@/spaceToDepth2DGradient"), v8, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(WeakRetained, "depthToSpace2DTensor:widthAxisTensor:heightAxisTensor:depthAxisTensor:blockSize:usePixelShuffleOrder:name:", v20, v10, v11, v12, blockSize, pixelShuffleOrder, v17);
...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v14 = mlir::FileLineColLoc::get(StringAttr, 0x40Bu, 0);
  if (!v14)
...
LABEL_20:
  ...
  v28 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.space_to_depth_2d", (const unsigned __int8 *)0x15, Context);
  if (!v29)
  {
    v46 = 1283;
  ...
  v31 = llvm::DefaultDoCastIfPossible<mlir::mps::SpaceToDepth2DOp,mlir::Operation *,llvm::CastInfo<mlir::mps::SpaceToDepth2DOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v30);
  if (!v31)
  {
