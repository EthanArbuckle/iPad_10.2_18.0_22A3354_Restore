...
LABEL_20:
  ...
  v26 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.matrix_solver_lu", (const unsigned __int8 *)0x14, Context);
  if (!v27)
  {
    v48 = 1283;
  ...
  if (v31 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    *(_QWORD *)__dst = *(_QWORD *)(v30 + 8);
    ...
    if (v38 == 20
      && *(_QWORD *)AttrData == 0x7274616D2E73706DLL
      && *(_QWORD *)(AttrData + 8) == 0x65766C6F735F7869
