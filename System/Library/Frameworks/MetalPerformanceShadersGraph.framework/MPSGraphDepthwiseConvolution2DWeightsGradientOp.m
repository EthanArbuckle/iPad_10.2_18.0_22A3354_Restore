...
LABEL_20:
  ...
  v41 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.depthwise_conv_2d_weights_gradient", (const unsigned __int8 *)0x26, Context);
  if (!v42)
  {
    v75 = 1283;
  ...
  if (v46 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v55 == 38)
    {
      ...
      v57 = v56 && AttrData[2] == 0x65775F64325F766ELL;
      v58 = v57 && AttrData[3] == 0x72675F7374686769;
      if (v58 && *(_QWORD *)((char *)AttrData + 30) == 0x746E656964617267)
      {
        v75 = 1283;
