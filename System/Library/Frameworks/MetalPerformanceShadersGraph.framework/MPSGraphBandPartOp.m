...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v13 = mlir::FileLineColLoc::get(StringAttr, 0x2Au, 0);
  if (!v13)
...
LABEL_20:
  ...
  v27 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.band_part", (const unsigned __int8 *)0xD, Context);
  if (!v28)
  {
    v45 = 1283;
  ...
  v30 = llvm::DefaultDoCastIfPossible<mlir::mps::BandPartOp,mlir::Operation *,llvm::CastInfo<mlir::mps::BandPartOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v29);
  if (!v30)
  {
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  objc_msgSend(v15, "stringWithFormat:", CFSTR("%@/%@/bandpart"), v9, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(WeakRetained, "bandPartWithTensor:numLowerTensor:numUpperTensor:name:", v8, v12, v14, v17);
