...
- (MPSGraphRealToHermiteanFFTOp)initWithGraph:(id)a3 inputTensors:(id)a4 controlDependencies:(id)a5 descriptor:(id)a6 name:(id)a7
{
  ...
  MPSGraphRealToHermiteanFFTOp *v19;
...
LABEL_20:
  ...
  v32 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.real_to_hermitean_fft", (const unsigned __int8 *)0x19, Context);
  if (!v33)
  {
    v55 = 1283;
  ...
  if (v37 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v44 == 25
      && *(_QWORD *)AttrData == 0x6C6165722E73706DLL
      && *(_QWORD *)(AttrData + 8) == 0x6D7265685F6F745FLL
      && *(_QWORD *)(AttrData + 16) == 0x66665F6E61657469
