...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  objc_msgSend(v15, "stringWithFormat:", CFSTR("%@/%@/batchToSpaceGradient"), v9, v16);
  v17 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(WeakRetained, "spaceToBatchTensor:spatialAxesTensor:batchAxisTensor:blockDimensionsTensor:usePixelShuffleOrder:name:", v8, v11, v12, v13, pixelShuffleOrder, v17);
...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v14 = mlir::FileLineColLoc::get(StringAttr, 0x43Fu, 0);
  if (!v14)
...
LABEL_13:
  ...
  LOBYTE(v48) = v22;
  v23 = mlir::Builder::getStringAttr((mlir::StringAttr **)a3, (mlir::MLIRContext *)v47);
...
LABEL_20:
  ...
  v27 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.batch_to_space", (const unsigned __int8 *)0x12, Context);
  if (!v28)
  {
    v45 = 1283;
  ...
  v30 = llvm::DefaultDoCastIfPossible<mlir::mps::BatchToSpaceOp,mlir::Operation *,llvm::CastInfo<mlir::mps::BatchToSpaceOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v29);
  if (!v30)
  {
