...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v14 = mlir::FileLineColLoc::get(StringAttr, 0x4Eu, 0);
  if (!v14)
...
LABEL_20:
  ...
  v29 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.cumulative_maximum", (const unsigned __int8 *)0x16, Context);
  if (!v30)
  {
    v53 = 1283;
  ...
  if (v34 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    *(_QWORD *)__dst = *(_QWORD *)(v33 + 8);
    ...
    if (v42 == 22)
    {
      ...
      if (v43 && *(_QWORD *)((char *)AttrData + 14) == 0x6D756D6978616D5FLL)
      {
        v53 = 1283;
