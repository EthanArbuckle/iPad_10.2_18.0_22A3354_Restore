...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v12 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::LocalConvolutionOp>((uint64_t)a4, (mlir::StringAttr **)a3, (uint64_t)__p, 0xF1u, v11);
  if (v39 < 0)
  ...
  v19 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.local_convolution_weight_gradient", (const unsigned __int8 *)0x25, Context);
  if (!v20)
  {
    v46 = 1283;
  ...
  if (v24 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v32 == 37)
    {
      ...
      v34 = v33 && AttrData[2] == 0x65775F6E6F697475;
      v35 = v34 && AttrData[3] == 0x6172675F74686769;
      if (v35 && *(_QWORD *)((char *)AttrData + 29) == 0x746E656964617267)
      {
        v46 = 1283;
