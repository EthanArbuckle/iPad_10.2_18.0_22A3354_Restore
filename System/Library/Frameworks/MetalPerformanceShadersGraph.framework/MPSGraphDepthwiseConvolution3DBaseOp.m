...
- (MPSGraphDepthwiseConvolution3DBaseOp)initWithGraph:(id)a3 inputTensors:(id)a4 controlDependencies:(id)a5 descriptor:(id)a6 name:(id)a7
{
  ...
  id v15;
  id v16;
  MPSGraphDepthwiseConvolution3DOpDescriptor *v17;
  MPSGraphDepthwiseConvolution3DOpDescriptor *desc;
  MPSGraphDepthwiseConvolution3DBaseOp *v19;
  ...
  v15 = a6;
  v16 = a7;
  v17 = (MPSGraphDepthwiseConvolution3DOpDescriptor *)objc_msgSend(v15, "copy");
  desc = self->_desc;
  self->_desc = v17;
