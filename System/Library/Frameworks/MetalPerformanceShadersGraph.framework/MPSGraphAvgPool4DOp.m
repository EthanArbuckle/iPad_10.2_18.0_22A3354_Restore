...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v35 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::PoolAvgOp>((uint64_t)a4, (mlir::StringAttr **)a3, (uint64_t)__p, 0x292u, v30);
  if (v38 < 0)
  ...
  v20 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.pooling_average", (const unsigned __int8 *)0x13, Context);
  if (!v21)
  {
    v43 = 1283;
  ...
  v23 = llvm::DefaultDoCastIfPossible<mlir::mps::PoolAvgOp,mlir::Operation *,llvm::CastInfo<mlir::mps::PoolAvgOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v22);
  if (!v23)
  {
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  objc_msgSend(v12, "stringWithFormat:", CFSTR("%@/%@/avgPool4DGradient"), v11, v13);
  v14 = (void *)objc_claimAutoreleasedReturnValue();

  WeakRetained = objc_loadWeakRetained((id *)&self->super.super._graph);
  objc_msgSend(WeakRetained, "avgPooling4DGradientWithGradientTensor:sourceTensor:descriptor:name:", v10, v9, self->super._desc, v14);
