...
- (void)dealloc
{
  ...
  -[NSBatchDeleteResult dealloc](&v3, sel_dealloc);
}

- (NSBatchDeleteResult)initWithResultType:(unint64_t)a3 andObject:(id)a4
{
  NSBatchDeleteResult *v6;
  NSBatchDeleteResult *v7;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)NSBatchDeleteResult;
  v6 = -[NSBatchDeleteResult init](&v9, sel_init);
  v7 = v6;
  if (v6)
  {
    v6->_resultType = a3;
...
- (NSBatchDeleteResult)initWithSubresults:(id)a3
{
  ...
  v4 = -[NSBatchDeleteResult init](&v49, sel_init);
  if (!v4)
    return v4;
    ...
    while (1)
    {
      for (j = 0; j != v24; ++j)
      {
        ...
        if (v28 != objc_msgSend(v27, "resultType"))
        {
          ...
          v35 = &v50;
LABEL_49:
          objc_exception_throw((id)objc_msgSend(v31, "exceptionWithName:reason:userInfo:", v32, CFSTR("Mismatched result types during aggregation of batch delete results"), objc_msgSend(v33, "dictionaryWithObjects:forKeys:count:", v34, v35, 1)));
        }
