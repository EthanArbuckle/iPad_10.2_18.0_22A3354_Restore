...
{
  _NSFaultingMutableOrderedSetMutationMethods *v6;
  uint64_t v7;
  uint64_t v8;
  char *v9;
  CFIndex v10;
  ...
  v11 = _PFKeyValueMethodForPattern(a3, "insert%s:atIndexes:", v9);
  ...
  if ((unint64_t)v6->_insertObjectMethod | (unint64_t)v11
    && (v6->_removeObjectMethod = _PFKeyValueMethodForPattern(a3, "removeObjectFrom%sAtIndex:", v9),
        v12 = _PFKeyValueMethodForPattern(a3, "remove%sAtIndexes:", v9),
