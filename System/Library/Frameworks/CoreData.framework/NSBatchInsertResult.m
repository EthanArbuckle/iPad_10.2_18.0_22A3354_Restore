...
{
  NSBatchInsertResult *v6;
  NSBatchInsertResult *v7;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)NSBatchInsertResult;
  v6 = -[NSBatchInsertResult init](&v9, sel_init);
  v7 = v6;
  if (v6)
  {
    v6->_resultType = a3;
...
- (NSBatchInsertResult)initWithSubresults:(id)a3
{
  ...
  v4 = -[NSBatchInsertResult init](&v49, sel_init);
  if (!v4)
    return v4;
    ...
    while (1)
    {
      for (j = 0; j != v24; ++j)
      {
        ...
        if (v28 != objc_msgSend(v27, "resultType"))
        {
          ...
          v35 = &v50;
LABEL_49:
          objc_exception_throw((id)objc_msgSend(v31, "exceptionWithName:reason:userInfo:", v32, CFSTR("Mismatched result types during aggregation of batch insert results"), objc_msgSend(v33, "dictionaryWithObjects:forKeys:count:", v34, v35, 1)));
        }
...
- (void)dealloc
{
  ...
  -[NSBatchInsertResult dealloc](&v3, sel_dealloc);
}
