...
{
  CXEnableVideoCallAction *result;
  objc_super v6;
...
- (id)customDescription
{
  ...
  objc_msgSend(v3, "appendFormat:", CFSTR(" videoEnabled=%d"), -[CXEnableVideoCallAction isVideoEnabled](self, "isVideoEnabled"));
  return v3;
}
...
- (CXEnableVideoCallAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_videoEnabled = objc_msgSend(v4, "decodeBoolForKey:", v6);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = -[CXEnableVideoCallAction isVideoEnabled](self, "isVideoEnabled", v7.receiver, v7.super_class);
  NSStringFromSelector(sel_isVideoEnabled);
  v6 = (void *)objc_claimAutoreleasedReturnValue();
