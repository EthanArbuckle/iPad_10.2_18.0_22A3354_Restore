...
- (id)description
{
  ...
  -[ACProtobufKeyValuePair description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ACProtobufKeyValuePair dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (ACProtobufKeyValuePair)initWithValue:(id)a3 forKey:(id)a4
{
  id v6;
  id v7;
  ACProtobufKeyValuePair *v8;
  ACProtobufKeyValuePair *v9;
  ACProtobufKeyValuePair *v10;

  v6 = a3;
  v7 = a4;
  v8 = -[ACProtobufKeyValuePair init](self, "init");
  v9 = v8;
  if (v8)
  {
    -[ACProtobufKeyValuePair setKey:](v8, "setKey:", v7);
    -[ACProtobufKeyValuePair setValue:](v9, "setValue:", v6);
    v10 = v9;
  }
