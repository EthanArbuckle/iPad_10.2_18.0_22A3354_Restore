...
- (ACProtobufURL)initWithURL:(id)a3
{
  ...
  v4 = a3;
  if (v4 && (self = -[ACProtobufURL init](self, "init")) != 0)
  {
    objc_msgSend(v4, "absoluteString");
    v5 = (void *)objc_claimAutoreleasedReturnValue();
    -[ACProtobufURL setValue:](self, "setValue:", v5);
...
- (void)setUrl:(id)a3
{
  ...
  -[ACProtobufURL setValue:](self, "setValue:", v4);
...
- (NSURL)url
{
  ...
  -[ACProtobufURL value](self, "value");
...
- (id)description
{
  ...
  -[ACProtobufURL description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[ACProtobufURL dictionaryRepresentation](self, "dictionaryRepresentation");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
