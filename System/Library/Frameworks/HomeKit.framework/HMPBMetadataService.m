...
- (id)description
{
  ...
  -[HMPBMetadataService description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMPBMetadataService dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (svcDescription)
    objc_msgSend(v4, "setObject:forKey:", svcDescription, CFSTR("svcDescription"));
  return v4;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = -[NSString copyWithZone:](self->_svcDescription, "copyWithZone:", a3);
  v9 = (void *)v5[1];
  v5[1] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](uuidStr, "isEqual:")))
  {
    ...
    if ((unint64_t)svcDescription | v4[1])
      v7 = -[NSString isEqual:](svcDescription, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return -[NSString hash](self->_svcDescription, "hash") ^ v3;
}
