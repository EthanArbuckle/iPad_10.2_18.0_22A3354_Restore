...
{
  return (NSString *)CFSTR("kHMProvisionAnisetteDataResponse");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMProvisionAnisetteDataResponse");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMProvisionAnisetteDataResponse messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMProvisionAnisetteDataResponse didSucceed](self, "didSucceed");
  HMFBooleanToString();
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMProvisionAnisetteDataResponse: %@, did-succeed %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[HMProvisionAnisetteDataResponse didSucceed](self, "didSucceed", v5.receiver, v5.super_class), CFSTR("TRAnisetteDataMessages_dS"));
...
{
  id v4;
  HMProvisionAnisetteDataResponse *v5;
  objc_super v7;
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMProvisionAnisetteDataResponse"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMProvisionAnisetteDataResponse"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
