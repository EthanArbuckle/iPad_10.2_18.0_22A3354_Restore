...
- (HMAccessoryStringSetting)initWithKey:(id)a3 properties:(unint64_t)a4 value:(id)a5
{
  ...
  HMAccessoryStringSetting *v11;

  v8 = a5;
  v9 = a3;
  v10 = -[_HMAccessorySetting initWithType:properties:name:constraints:]([_HMAccessorySetting alloc], "initWithType:properties:name:constraints:", 3, a4, v9, 0);
