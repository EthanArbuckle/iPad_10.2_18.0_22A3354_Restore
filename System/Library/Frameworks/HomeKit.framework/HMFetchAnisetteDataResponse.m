...
{
  return (NSString *)CFSTR("kHMFetchAnisetteDataResponse");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMFetchAnisetteDataResponse");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMFetchAnisetteDataResponse messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMFetchAnisetteDataResponse anisetteData](self, "anisetteData");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMFetchAnisetteDataResponse: %@, anisette-data %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMFetchAnisetteDataResponse anisetteData](self, "anisetteData", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
...
{
  id v4;
  HMFetchAnisetteDataResponse *v5;
  uint64_t v6;
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMFetchAnisetteDataResponse"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMFetchAnisetteDataResponse"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
