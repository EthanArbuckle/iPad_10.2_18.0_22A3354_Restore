...
- (id)selectionTypeAsString:(int)a3
{
  ...
  if (!a3)
    return CFSTR("selectionTypeHomePodAccount");
  if (a3 == 1)
  {
    v3 = CFSTR("selectionTypeHomeUser");
  }
  else
  {
...
- (int)StringAsSelectionType:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("selectionTypeHomePodAccount")) & 1) != 0)
    v4 = 0;
  else
    v4 = objc_msgSend(v3, "isEqualToString:", CFSTR("selectionTypeHomeUser"));
...
- (id)description
{
  ...
  -[HMAccessoryInfoProtoPrimaryUserInfoEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMAccessoryInfoProtoPrimaryUserInfoEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    if (selectionType)
    {
      if (selectionType == 1)
      {
        v7 = CFSTR("selectionTypeHomeUser");
      }
      else
      {
    ...
    {
      v7 = CFSTR("selectionTypeHomePodAccount");
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (!objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
    goto LABEL_8;
  uuidString = self->_uuidString;
  if ((unint64_t)uuidString | *((_QWORD *)v4 + 2))
  {
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_selectionType == *((_DWORD *)v4 + 2))
    {
      v6 = 1;
      goto LABEL_9;
    }
