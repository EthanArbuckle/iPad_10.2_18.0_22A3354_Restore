...
{
  return (NSString *)CFSTR("kHMSyncAnisetteDataResponse");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMSyncAnisetteDataResponse");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMSyncAnisetteDataResponse messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMSyncAnisetteDataResponse didSucceed](self, "didSucceed");
  HMFBooleanToString();
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMSyncAnisetteDataResponse: %@, did-succeed %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[HMSyncAnisetteDataResponse didSucceed](self, "didSucceed", v5.receiver, v5.super_class), CFSTR("TRAnisetteDataMessages_dS"));
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMSyncAnisetteDataResponse"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMSyncAnisetteDataResponse"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
