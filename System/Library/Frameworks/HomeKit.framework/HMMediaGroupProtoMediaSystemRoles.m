...
- (id)description
{
  ...
  -[HMMediaGroupProtoMediaSystemRoles description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMMediaGroupProtoMediaSystemRoles dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (id)dictionaryRepresentation
{
  ...
  if (leftDestinationIdentifier)
    objc_msgSend(v3, "setObject:forKey:", leftDestinationIdentifier, CFSTR("leftDestinationIdentifier"));
  rightDestinationIdentifier = self->_rightDestinationIdentifier;
  if (rightDestinationIdentifier)
    objc_msgSend(v4, "setObject:forKey:", rightDestinationIdentifier, CFSTR("rightDestinationIdentifier"));
  return v4;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = -[NSString copyWithZone:](self->_leftDestinationIdentifier, "copyWithZone:", a3);
  v7 = (void *)v5[1];
  v5[1] = v6;

  v8 = -[NSString copyWithZone:](self->_rightDestinationIdentifier, "copyWithZone:", a3);
  v9 = (void *)v5[2];
  v5[2] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](leftDestinationIdentifier, "isEqual:")))
  {
    ...
    if ((unint64_t)rightDestinationIdentifier | v4[2])
      v7 = -[NSString isEqual:](rightDestinationIdentifier, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  v3 = -[NSString hash](self->_leftDestinationIdentifier, "hash");
  return -[NSString hash](self->_rightDestinationIdentifier, "hash") ^ v3;
}
...
{
  objc_storeStrong((id *)&self->_leftDestinationIdentifier, a3);
}
...
{
  objc_storeStrong((id *)&self->_rightDestinationIdentifier, a3);
}
