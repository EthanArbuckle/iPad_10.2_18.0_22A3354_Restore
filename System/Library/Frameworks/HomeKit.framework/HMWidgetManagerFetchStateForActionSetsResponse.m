...
- (HMWidgetManagerFetchStateForActionSetsResponse)initWithIsOnByActionSetsUniqueIdentifier:(id)a3 didExecutionFailByActionSetUniqueIdentifier:(id)a4
{
  id v7;
  id v8;
  HMWidgetManagerFetchStateForActionSetsResponse *v9;
  HMWidgetManagerFetchStateForActionSetsResponse *v10;
  objc_super v12;
  ...
  v9 = -[HMWidgetManagerFetchStateForActionSetsResponse init](&v12, sel_init);
  v10 = v9;
  if (v9)
  {
