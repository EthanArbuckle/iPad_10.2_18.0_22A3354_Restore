...
{
  return (NSString *)CFSTR("kHMFetchAnisetteDataRequest");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMFetchAnisetteDataRequest");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMFetchAnisetteDataRequest messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMFetchAnisetteDataRequest shouldProvision](self, "shouldProvision");
  HMFBooleanToString();
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMFetchAnisetteDataRequest: %@, should-provision %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[HMFetchAnisetteDataRequest shouldProvision](self, "shouldProvision", v5.receiver, v5.super_class), CFSTR("TRAnisetteDataMessages_sP"));
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMFetchAnisetteDataRequest"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMFetchAnisetteDataRequest"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
