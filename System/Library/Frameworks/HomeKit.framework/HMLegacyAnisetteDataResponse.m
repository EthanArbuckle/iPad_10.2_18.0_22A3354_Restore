...
{
  return (NSString *)CFSTR("kHMLegacyAnisetteDataResponse");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMLegacyAnisetteDataResponse");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMLegacyAnisetteDataResponse messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMLegacyAnisetteDataResponse anisetteData](self, "anisetteData");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMLegacyAnisetteDataResponse: %@, anisette-data %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMLegacyAnisetteDataResponse anisetteData](self, "anisetteData", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("TRAnisetteDataMessages_aD"));
...
{
  id v4;
  HMLegacyAnisetteDataResponse *v5;
  uint64_t v6;
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMLegacyAnisetteDataResponse"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMLegacyAnisetteDataResponse"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
