...
{
  return (NSString *)CFSTR("kHMLegacyAnisetteDataRequest");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMLegacyAnisetteDataRequest");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMLegacyAnisetteDataRequest messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMLegacyAnisetteDataRequest dsid](self, "dsid");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMFetchAnisetteDataResponse: %@, dsid %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMLegacyAnisetteDataRequest dsid](self, "dsid", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("TRAnisetteDataMessages_d"));
...
{
  id v4;
  HMLegacyAnisetteDataRequest *v5;
  uint64_t v6;
  NSString *dsid;
  objc_super v9;
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMLegacyAnisetteDataRequest"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMLegacyAnisetteDataRequest"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
