...
- (id)description
{
  ...
  -[HMAudioAnalysisEventBulletinEventProtoValueEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMAudioAnalysisEventBulletinEventProtoValueEvent dictionaryRepresentation](self, "dictionaryRepresentation");
...
- (void)copyTo:(id)a3
{
  ...
  v8 = a3;
  if (-[HMAudioAnalysisEventBulletinEventProtoValueEvent eventsCount](self, "eventsCount"))
  {
    objc_msgSend(v8, "clearEvents");
    v4 = -[HMAudioAnalysisEventBulletinEventProtoValueEvent eventsCount](self, "eventsCount");
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        -[HMAudioAnalysisEventBulletinEventProtoValueEvent eventsAtIndex:](self, "eventsAtIndex:", i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend(v4, "isMemberOfClass:", objc_opt_class()))
  {
    ...
    if ((unint64_t)events | v4[1])
      v6 = -[NSMutableArray isEqual:](events, "isEqual:");
    else
      v6 = 1;
  }
  else
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMAudioAnalysisEventBulletinEventProtoValueEvent addEvents:](self, "addEvents:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++), (_QWORD)v9);
      }
      while (v6 != v8);
