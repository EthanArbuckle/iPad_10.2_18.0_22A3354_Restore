...
{
  return (NSString *)CFSTR("kHMSyncAnisetteDataRequest");
}

- (NSString)xpcMessageName
{
  return (NSString *)CFSTR("xpckHMSyncAnisetteDataRequest");
}
...
- (NSDictionary)messagePayload
{
  ...
  -[HMSyncAnisetteDataRequest messageName](self, "messageName");
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMSyncAnisetteDataRequest simData](self, "simData");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "stringWithFormat:", CFSTR("[HMSyncAnisetteDataRequest: %@, sim-data %@]"), v4, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  -[HMSyncAnisetteDataRequest simData](self, "simData", v6.receiver, v6.super_class);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v4, "encodeObject:forKey:", v5, CFSTR("TRAnisetteDataMessages_sD"));
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  objc_msgSend(v4, "hmf_dataForKey:", CFSTR("kHMSyncAnisetteDataRequest"));
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v13 = 0;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v5, "hmf_dataForKey:", CFSTR("kHMSyncAnisetteDataRequest"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
