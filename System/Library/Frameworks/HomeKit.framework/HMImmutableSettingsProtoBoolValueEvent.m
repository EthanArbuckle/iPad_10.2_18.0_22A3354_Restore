...
- (id)description
{
  ...
  -[HMImmutableSettingsProtoBoolValueEvent description](&v8, sel_description);
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  -[HMImmutableSettingsProtoBoolValueEvent dictionaryRepresentation](self, "dictionaryRepresentation");
