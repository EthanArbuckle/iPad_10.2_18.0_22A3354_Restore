...
void __bt709HLG_CICP_tag_block_invoke()
{
  ...
  bt709HLG_CICP_tag_cicp = (uint64_t)ColorSyncProfileCopyTag(v0, CFSTR("cicp"));
  CFRelease(v0);
}
...
void __bt2100PQ_CICP_tag_block_invoke()
{
  ...
  bt2100PQ_CICP_tag_cicp = (uint64_t)ColorSyncProfileCopyTag(v0, CFSTR("cicp"));
  CFRelease(v0);
}
...
void __bt2100HLG_CICP_tag_block_invoke()
{
  ...
  bt2100HLG_CICP_tag_cicp = (uint64_t)ColorSyncProfileCopyTag(v0, CFSTR("cicp"));
  CFRelease(v0);
}
...
void __displayP3PQ_CICP_tag_block_invoke()
{
  ...
  displayP3PQ_CICP_tag_cicp = (uint64_t)ColorSyncProfileCopyTag(v0, CFSTR("cicp"));
  CFRelease(v0);
}
...
void __displayP3HLG_CICP_tag_block_invoke()
{
  ...
  displayP3HLG_CICP_tag_cicp = (uint64_t)ColorSyncProfileCopyTag(v0, CFSTR("cicp"));
  CFRelease(v0);
}
...
void __bt709PQ_CICP_tag_block_invoke()
{
  ...
  bt709PQ_CICP_tag_cicp = (uint64_t)ColorSyncProfileCopyTag(v0, CFSTR("cicp"));
  CFRelease(v0);
}
