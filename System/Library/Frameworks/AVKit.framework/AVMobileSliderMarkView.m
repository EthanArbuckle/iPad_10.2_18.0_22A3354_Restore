...
- (AVMobileSliderMarkView)init
{
  ...
  v2 = -[AVMobileSliderMarkView init](&v8, sel_init);
  if (v2)
  {
    objc_msgSend(MEMORY[0x1E0DC3658], "blackColor");
    v3 = (void *)objc_claimAutoreleasedReturnValue();
    -[AVMobileSliderMarkView setBackgroundColor:](v2, "setBackgroundColor:", v3);
    ...
    -[AVMobileSliderMarkView layer](v2, "layer");
...
- (void)layoutSubviews
{
  ...
  -[AVMobileSliderMarkView layoutSubviews](&v5, sel_layoutSubviews);
  v3 = *MEMORY[0x1E0C9D648];
  v4 = *(double *)(MEMORY[0x1E0C9D648] + 8);
  -[AVMobileSliderMarkView bounds](self, "bounds");
