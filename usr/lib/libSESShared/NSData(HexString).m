...
LABEL_16:
      ...
      {
        v13 = 0;
        v7 = malloc_type_malloc((unint64_t)objc_msgSend(v3, "length") >> 1, 0xE33E6C5DuLL);
...
LABEL_12:
        objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytesNoCopy:length:freeWhenDone:", v7, (unint64_t)objc_msgSend(v3, "length") >> 1, 1);
