...
+ (id)sharedInstance
{
  if (qword_1ED70F838 != -1)
    dispatch_once(&qword_1ED70F838, &__block_literal_global_4);
...
- (BOOL)checkNotificationCriteria:(int *)a3 :(const void *)a4 :(BOOL)a5
{
  ...
  *((_QWORD *)v12 + 1) = v10;
  ...
  v79 = v11 + 1;
  operator delete(v9);
  v13 = atomic_load((unsigned __int8 *)&qword_1ED70F840);
  if ((v13 & 1) == 0 && __cxa_guard_acquire(&qword_1ED70F840))
  {
    qword_1ED70F848 = (uint64_t)"mav_bedf_component_config_reset: Reset Requested by Component Cfg";
    qword_1ED70F850 = (uint64_t)"AutoBugCapture";
    qword_1ED70F858 = *MEMORY[0x1E0D01A78];
    __cxa_guard_release(&qword_1ED70F840);
  }
  v14 = *((char *)a4 + 23);
  if (v14 < 0)
  {
...
LABEL_37:
        if (v26 >= 0)
          ...
          v28 = *(char **)a4;
        v29 = (const void *)qword_1ED70F848;
        v30 = strlen((const char *)qword_1ED70F848);
        if (v30)
        {
          v31 = v30;
          v32 = &v28[v27];
          ...
          v33 = (const void *)qword_1ED70F850;
          v34 = strlen((const char *)qword_1ED70F850);
          if (v34)
          {
            v35 = v34;
            if (v27 >= v34)
            {
              v60 = *(char *)qword_1ED70F850;
              v61 = v27;
              v62 = v28;
              do
              {
            ...
            v36 = (const void *)qword_1ED70F858;
            v37 = strlen((const char *)qword_1ED70F858);
            if (v37)
            {
              v38 = v37;
              if (v27 >= v37)
              {
                v66 = *(char *)qword_1ED70F858;
                v67 = v28;
                while (v27 - v38 != -1)
                {
...
- (void)showUserNotification:(int)a3 dumpReason:()basic_string<char
{
  ...
  *(_QWORD *)&buf[16] = ___ZL17sABMLogServerInitRNSt3__110shared_ptrIN3ctu9LogServerEEE_block_invoke;
  v31 = &__block_descriptor_tmp_13_8;
...
LABEL_16:
  ...
  *(_WORD *)&buf[8] = 2080;
  *(_QWORD *)&buf[10] = v14;
  _os_log_impl(&dword_1BF566000, v11, OS_LOG_TYPE_DEFAULT, "#I Show user notification for radarType: %d with header: %s", buf, 0x12u);
LABEL_21:
...
LABEL_53:
  ...
  {
    if (MEMORY[0x1C3B8CD78](v42) == MEMORY[0x1E0C812C8])
    {
      xpc_retain(v42);
      v43 = v42;
    }
...
LABEL_98:
  ...
  if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315138;
    v88 = v64;
    _os_log_error_impl(&dword_1BF566000, v56, OS_LOG_TYPE_ERROR, "Failed to file the radar: %s", buf, 0xCu);
    if (SHIBYTE(v84) < 0)
