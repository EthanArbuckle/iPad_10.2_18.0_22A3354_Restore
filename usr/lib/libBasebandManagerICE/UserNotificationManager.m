...
+ (id)sharedInstance:()basic_string<char
{
  ...
  {
    __p = a3->var0.var0;
    if (qword_1ED70F790 == -1)
      goto LABEL_3;
LABEL_6:
    dispatch_once(&qword_1ED70F790, block);
    v3 = (id)qword_1ED70F788;
...
- (void)setUpNotificationCenter:(id)a3
{
  ...
  *((_QWORD *)&buf + 1) = 0x40000000;
  v17 = ___ZL17sABMLogServerInitRNSt3__110shared_ptrIN3ctu9LogServerEEE_block_invoke;
  v18 = &__block_descriptor_tmp_13_8;
  v19 = &GetABMLogServer(void)::sLogServer;
...
LABEL_5:
  ...
  v12 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v15) + 4);
  if (v9)
  {
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v5;
    _os_log_impl(&dword_1BF566000, v12, OS_LOG_TYPE_DEFAULT, "#I UserNotificationCenter created with bundleID %@", (uint8_t *)&buf, 0xCu);
  }
...
- (BOOL)setActionForHeader:(UserNotificationManager *)self notificationContent:(SEL)a2 callbackData:(NotificationInfo *)a3
{
  ...
  v7 = v3;
  v117 = v7;
  v8 = atomic_load((unsigned __int8 *)&qword_1ED70F798);
  v115 = self;
  if ((v8 & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_1ED70F798);
    if ((_DWORD)v7)
    {
      _MergedGlobals_1 = TelephonyUtilIsInternalBuild();
      __cxa_guard_release(&qword_1ED70F798);
    }
  }
  v9 = atomic_load((unsigned __int8 *)&qword_1ED70F7A8);
  if ((v9 & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_1ED70F7A8);
    if ((_DWORD)v7)
    {
      if (_MergedGlobals_1)
      ...
      qword_1ED70F7A0 = v113;
      __cxa_guard_release(&qword_1ED70F7A8);
    }
  }
  v10 = atomic_load((unsigned __int8 *)&qword_1ED70F7B8);
  if ((v10 & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_1ED70F7B8);
    if ((_DWORD)v7)
    {
      if (_MergedGlobals_1)
      ...
      qword_1ED70F7B0 = v114;
      __cxa_guard_release(&qword_1ED70F7B8);
    }
  }
...
LABEL_38:
  ...
  if (memcmp(v83, "Telephony_Dump_Started", v84) || v13 != 22)
  {
    ...
    *(_QWORD *)&buf = MEMORY[0x1E0C809B0];
    *((_QWORD *)&buf + 1) = 0x40000000;
    v121 = ___ZL17sABMLogServerInitRNSt3__110shared_ptrIN3ctu9LogServerEEE_block_invoke;
    v122 = &__block_descriptor_tmp_13_8;
    v123 = &GetABMLogServer(void)::sLogServer;
    if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
    {
      v86 = (std::__shared_weak_count *)*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1);
...
LABEL_187:
    ...
    v89 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v119) + 4);
    if (v86)
    {
    ...
    if (os_log_type_enabled(v89, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = p_var1;
      _os_log_error_impl(&dword_1BF566000, v89, OS_LOG_TYPE_ERROR, "Not supported header - %s", (uint8_t *)&buf, 0xCu);
      v92 = 0;
    }
    else
    {
...
LABEL_39:
  ...
  {
    objc_msgSend(MEMORY[0x1E0C99E98], "URLWithString:", qword_1ED70F7A0);
  ...
  else
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E0C99E98], "URLWithString:", qword_1ED70F7B0);
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v117, "setDefaultActionURL:", v32);
    }
    else
...
LABEL_215:
  ...
  *((_QWORD *)&buf + 1) = 0x40000000;
  ...
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v102 = (std::__shared_weak_count *)*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1);
...
LABEL_218:
  ...
  v105 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v118) + 4);
  if (!v102)
    goto LABEL_274;
...
LABEL_225:
      ...
      *(_QWORD *)((char *)&buf + 4) = a3;
      _os_log_impl(&dword_1BF566000, v105, OS_LOG_TYPE_DEFAULT, "#I Add callback for id: %s", (uint8_t *)&buf, 0xCu);
    }
  }
  else
  {
...
void __61__UserNotificationManager_showNotification_withCallBackData___block_invoke(uint64_t a1)
{
  ...
  context = (void *)MEMORY[0x1C3B8C85C]();
  v2 = objc_alloc_init(MEMORY[0x1E0CEC6E0]);
  v3 = *(void **)(a1 + 32);
  v4 = (_OWORD *)(a1 + 40);
  if (*(char *)(a1 + 63) < 0)
  {
    std::string::__init_copy_ctor_external(&v46, *(const std::string::value_type **)(a1 + 40), *(_QWORD *)(a1 + 48));
  }
  else
  {
    *(_OWORD *)&v46.__r_.__value_.__l.__data_ = *v4;
    v46.__r_.__value_.__r.__words[2] = *(_QWORD *)(a1 + 56);
  }
  v5 = (_OWORD *)(a1 + 64);
  if (*(char *)(a1 + 87) < 0)
  {
    std::string::__init_copy_ctor_external(&v47, *(const std::string::value_type **)(a1 + 64), *(_QWORD *)(a1 + 72));
  }
  else
  {
    *(_OWORD *)&v47.__r_.__value_.__l.__data_ = *v5;
    v47.__r_.__value_.__r.__words[2] = *(_QWORD *)(a1 + 80);
  }
  v6 = (_OWORD *)(a1 + 88);
  if (*(char *)(a1 + 111) < 0)
  {
    std::string::__init_copy_ctor_external(&v48, *(const std::string::value_type **)(a1 + 88), *(_QWORD *)(a1 + 96));
  }
  else
  {
    *(_OWORD *)&v48.__r_.__value_.__l.__data_ = *v6;
    v48.__r_.__value_.__r.__words[2] = *(_QWORD *)(a1 + 104);
  }
  ...
  v9 = objc_msgSend(v3, "setActionForHeader:notificationContent:callbackData:", &v46, v2, &v43);
  if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0)
    operator delete(__p.__r_.__value_.__l.__data_);
  if (object)
    dispatch_release(object);
...
LABEL_27:
  ...
  objc_msgSend(v10, "localizedStringForKey:value:table:", v12, &stru_1E7923080, CFSTR("Localizable"));
  ...
  if (!memcmp(v16, "Telephony_Dump_Insufficient", v17) && v15 == 27)
  {
    ...
    objc_msgSend(v19, "localizedStringForKey:value:table:", CFSTR("Telephony_Dump_Insufficient_Details_%@"), &stru_1E7923080, CFSTR("Localizable"));
...
LABEL_50:
  ...
  if (!memcmp(v24, "Telephony_Dump_Started", v25) && v23 == 22)
  {
    ...
    objc_msgSend(MEMORY[0x1E0CB3940], "stringWithUTF8String:", v6);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "localizedStringForKey:value:table:", v20, &stru_1E7923080, CFSTR("Localizable"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x1E0CB34D0], "bundleWithPath:", CFSTR("/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "localizedStringForKey:value:table:", CFSTR("Check_Settings_Cellular_Diagnostics"), &stru_1E7923080, CFSTR("Localizable"));
  v20 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_51:
  ...
  *((_QWORD *)&buf + 1) = 0x40000000;
  ...
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v33 = (std::__shared_weak_count *)*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1);
...
LABEL_56:
  ...
  v36 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v42) + 4);
  if (v33)
  {
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v39;
    _os_log_impl(&dword_1BF566000, v36, OS_LOG_TYPE_DEFAULT, "#I Add notification request with id: %s", (uint8_t *)&buf, 0xCu);
  }
...
LABEL_32:
  ...
  v42 = ___ZL17sABMLogServerInitRNSt3__110shared_ptrIN3ctu9LogServerEEE_block_invoke;
  v43 = &__block_descriptor_tmp_13_8;
  v44 = &GetABMLogServer(void)::sLogServer;
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v28 = (std::__shared_weak_count *)*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1);
...
LABEL_37:
  v31 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v38) + 4);
  if (!v28)
    goto LABEL_41;
...
LABEL_41:
  ...
  *(_DWORD *)buf = 136315394;
  ...
  v47 = 2080;
  v48 = v34;
  _os_log_impl(&dword_1BF566000, v31, OS_LOG_TYPE_DEFAULT, "#I Submitting CoreAnalytics event[%s] - %s", buf, 0x16u);
  if (SHIBYTE(v42) < 0)
...
LABEL_9:
  ...
  buf[1].__r_.__value_.__r.__words[0] = (std::string::size_type)&__block_descriptor_tmp_13_8;
  buf[1].__r_.__value_.__l.__size_ = (std::string::size_type)&GetABMLogServer(void)::sLogServer;
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v13 = (std::__shared_weak_count *)*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1);
    v70 = GetABMLogServer(void)::sLogServer;
    if (!*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1))
      goto LABEL_14;
  }
  else
...
LABEL_14:
  v16 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v70) + 4);
  if (!v13)
    goto LABEL_18;
...
LABEL_18:
  ...
  *(std::string::size_type *)((char *)buf[0].__r_.__value_.__r.__words + 4) = (std::string::size_type)v19;
  _os_log_impl(&dword_1BF566000, v16, OS_LOG_TYPE_DEFAULT, "#I Received notification response with id: %s", (uint8_t *)buf, 0xCu);
LABEL_22:
  v20 = *(_QWORD *)(a1 + 48);
  if (v20)
    (*(void (**)(void))(v20 + 16))();
...
LABEL_47:
          ...
          v68.__r_.__value_.__r.__words[2] = 0xAAAAAAAAAAAAAAAALL;
          ...
          *(_OWORD *)&v68.__r_.__value_.__l.__data_ = v38;
          ...
          if (*((char *)v27 + 95) < 0)
          {
            std::string::__init_copy_ctor_external(&v68, (const std::string::value_type *)v27[9], v27[10]);
          }
          else
          {
            *(_OWORD *)&v68.__r_.__value_.__l.__data_ = *(_OWORD *)v40;
            v68.__r_.__value_.__r.__words[2] = v27[11];
          }
          if (aBlock[0])
          {
            if (aBlock[1])
          ...
          if (SHIBYTE(v69.__r_.__value_.__r.__words[2]) < 0)
          {
            ...
            std::string::__assign_no_alias<false>((void **)&v69.__r_.__value_.__l.__data_, v41, v42);
          }
          else if ((*((_BYTE *)&v68.__r_.__value_.__s + 23) & 0x80) != 0)
          {
            std::string::__assign_no_alias<true>(&v69, v68.__r_.__value_.__l.__data_, v68.__r_.__value_.__l.__size_);
          }
          else
          {
            v69 = v68;
          ...
          if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
          {
            v51 = (std::__shared_weak_count *)*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1);
...
LABEL_107:
          ...
          v54 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v62) + 4);
          if (!v51)
            goto LABEL_159;
...
LABEL_114:
            ...
            *(std::string::size_type *)((char *)buf[0].__r_.__value_.__r.__words + 4) = (std::string::size_type)v57;
            _os_log_impl(&dword_1BF566000, v54, OS_LOG_TYPE_DEFAULT, "#I Remove callback for id: %s", (uint8_t *)buf, 0xCu);
            if (SHIBYTE(v68.__r_.__value_.__r.__words[2]) < 0)
              goto LABEL_117;
LABEL_121:
            v58 = aBlock[1];
...
LABEL_126:
  ...
  if ((SHIBYTE(buf[1].__r_.__value_.__r.__words[2]) & 0x80000000) == 0)
  {
    if ((*((_BYTE *)&v69.__r_.__value_.__s + 23) & 0x80) == 0)
      goto LABEL_126;
LABEL_129:
    std::string::__assign_no_alias<true>(buf[1].__r_.__value_.__r.__words, v69.__r_.__value_.__l.__data_, v69.__r_.__value_.__l.__size_);
    goto LABEL_137;
  }
