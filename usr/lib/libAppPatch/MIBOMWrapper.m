...
+ (BOOL)_countFilesAndBytesInArchiveAtURL:(id)a3 withBOMCopier:(_BOMCopier *)a4 totalFiles:(unint64_t *)a5 totalUncompressedBytes:(unint64_t *)a6 error:(id *)a7
{
  ...
  _CreateError((uint64_t)"+[MIBOMWrapper _countFilesAndBytesInArchiveAtURL:withBOMCopier:totalFiles:totalUncompressedBytes:error:]", 149, CFSTR("MIInstallerErrorDomain"), 4, 0, 0, CFSTR("Failed to count the files and bytes in archive : %d (%s)"), v9, v10);
...
+ (BOOL)extractZipArchiveAtURL:(id)a3 toURL:(id)a4 withError:(id *)a5 extractionProgressBlock:(id)a6
{
  ...
  if (a5)
    *a5 = 0;
  objc_msgSend(v12, "setObject:forKeyedSubscript:", MEMORY[0x24BDBD1C8], CFSTR("extractPKZip"));
  v42 = 0;
  BomSys_init();
  BomSys_set_open();
  ...
  if (v15)
  {
    ...
    if (v11)
    {
      ...
      if ((v19 & 1) != 0)
      {
        ...
        v20 = (void *)MEMORY[0x22767FFD0](v11);
        *((_QWORD *)&v43 + 1) = v18;
        *(_QWORD *)&v44 = 0;
        v21 = MEMORY[0x22767FFD0]();
    ...
    if (v32)
    {
      objc_msgSend(MEMORY[0x24BDD1540], "errorWithDomain:code:userInfo:", *MEMORY[0x24BDD1128], (int)v43, 0);
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      _CreateAndLogError((uint64_t)"+[MIBOMWrapper extractZipArchiveAtURL:toURL:withError:extractionProgressBlock:]", 223, CFSTR("MIInstallerErrorDomain"), 5, v33, &unk_24EBD2D18, CFSTR("Could not extract archive"), v34, (uint64_t)v38);
  ...
  {
    _CreateAndLogError((uint64_t)"+[MIBOMWrapper extractZipArchiveAtURL:toURL:withError:extractionProgressBlock:]", 189, CFSTR("MIInstallerErrorDomain"), 5, 0, 0, CFSTR("Failed to create copier"), v14, (uint64_t)v38);
    v23 = (void *)objc_claimAutoreleasedReturnValue();
