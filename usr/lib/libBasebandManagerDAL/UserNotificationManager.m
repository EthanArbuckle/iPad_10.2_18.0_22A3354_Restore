...
+ (id)sharedInstance:()basic_string<char
{
  ...
  {
    __p = a3->var0.var0;
    if (qword_2579B8B30 == -1)
      goto LABEL_3;
LABEL_6:
    dispatch_once(&qword_2579B8B30, block);
    v3 = (id)qword_2579B8B28;
...
- (void)setUpNotificationCenter:(id)a3
{
  ...
  if (self->fUserNotificationCenter)
    goto LABEL_15;
  objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("com.apple.telephony.%@"), v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = (UNUserNotificationCenter *)objc_msgSend(objc_alloc(MEMORY[0x24BDF88B8]), "initWithBundleIdentifier:", v5);
...
LABEL_5:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v5;
    _os_log_impl(&dword_24B855000, v12, OS_LOG_TYPE_DEFAULT, "#I UserNotificationCenter created with bundleID %@", (uint8_t *)&buf, 0xCu);
  }
...
- (BOOL)setActionForHeader:(UserNotificationManager *)self notificationContent:(SEL)a2 callbackData:(NotificationInfo *)a3
{
  ...
  v7 = v3;
  v117 = v7;
  v8 = atomic_load((unsigned __int8 *)&qword_2579B8B38);
  v115 = self;
  if ((v8 & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_2579B8B38);
    if ((_DWORD)v7)
    {
      _MergedGlobals_0 = TelephonyUtilIsInternalBuild();
      __cxa_guard_release(&qword_2579B8B38);
    }
  }
  v9 = atomic_load((unsigned __int8 *)&qword_2579B8B48);
  if ((v9 & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_2579B8B48);
    if ((_DWORD)v7)
    {
      if (_MergedGlobals_0)
      ...
      qword_2579B8B40 = v113;
      __cxa_guard_release(&qword_2579B8B48);
    }
  }
  v10 = atomic_load((unsigned __int8 *)&qword_2579B8B58);
  if ((v10 & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_2579B8B58);
    if ((_DWORD)v7)
    {
      if (_MergedGlobals_0)
      ...
      qword_2579B8B50 = v114;
      __cxa_guard_release(&qword_2579B8B58);
    }
  }
  if ((config::hw::watch(v7) & 1) != 0)
    objc_msgSend(MEMORY[0x24BDF8850], "iconForApplicationIdentifier:", CFSTR("com.apple.Preferences"));
  else
    objc_msgSend(MEMORY[0x24BDF8850], "iconForSystemImageNamed:", CFSTR("antenna.radiowaves.left.and.right"));
  ...
  if (!memcmp(v15, "Telephony_Dump_Ready", v16) && v14 == 20)
  {
    if (!_MergedGlobals_0)
      goto LABEL_39;
    objc_msgSend(MEMORY[0x24BDF8850], "iconForApplicationIdentifier:", CFSTR("com.apple.TapToRadar"));
    v12 = objc_claimAutoreleasedReturnValue();
    objc_msgSend(v117, "setIcon:", v12);
    goto LABEL_38;
  }
...
LABEL_38:
  ...
  if (memcmp(v83, "Telephony_Dump_Started", v84) || v13 != 22)
  {
    ...
    *((_QWORD *)&buf + 1) = 0x40000000;
    ...
    v124 = &__block_descriptor_tmp_13_5;
    v125 = &GetABMLogServer(void)::sLogServer;
    if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
    {
      v86 = *(std::__shared_weak_count **)algn_2579B8AE8;
      v120 = GetABMLogServer(void)::sLogServer;
      v121 = *(_QWORD *)algn_2579B8AE8;
      if (*(_QWORD *)algn_2579B8AE8)
        goto LABEL_187;
    }
    else
...
LABEL_187:
    ...
    if (os_log_type_enabled(v89, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_QWORD *)((char *)&buf + 4) = p_var1;
      _os_log_error_impl(&dword_24B855000, v89, OS_LOG_TYPE_ERROR, "Not supported header - %s", (uint8_t *)&buf, 0xCu);
      v92 = 0;
    }
    else
    {
...
LABEL_39:
  ...
  {
    objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", qword_2579B8B40);
  ...
  else
  {
    ...
    {
      objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", qword_2579B8B50);
      v32 = (void *)objc_claimAutoreleasedReturnValue();
      objc_msgSend(v117, "setDefaultActionURL:", v32);
    }
    else
    {
      ...
      {
        objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", CFSTR("prefs:root=MOBILE_DATA_SETTINGS_ID&path=CELLULAR_DIAGNOSTICS_ID"));
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v117, "setDefaultActionURL:", v32);
      }
      else
      {
        ...
        if (memcmp(var0, "Install_Logging_Profile_UIAllowed", v112) || var1 != 33)
          goto LABEL_57;
        objc_msgSend(MEMORY[0x24BDBCF48], "URLWithString:", CFSTR("prefs:root=General&path=ManagedConfigurationList"));
        v32 = (void *)objc_claimAutoreleasedReturnValue();
        objc_msgSend(v117, "setDefaultActionURL:", v32);
      }
    }
...
LABEL_215:
  ...
  *((_QWORD *)&buf + 1) = 0x40000000;
  ...
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v102 = *(std::__shared_weak_count **)algn_2579B8AE8;
    v118 = GetABMLogServer(void)::sLogServer;
    v119 = *(_QWORD *)algn_2579B8AE8;
    if (*(_QWORD *)algn_2579B8AE8)
    {
LABEL_218:
...
LABEL_225:
      ...
      *(_QWORD *)((char *)&buf + 4) = a3;
      _os_log_impl(&dword_24B855000, v105, OS_LOG_TYPE_DEFAULT, "#I Add callback for id: %s", (uint8_t *)&buf, 0xCu);
    }
  }
  else
  {
...
void __61__UserNotificationManager_showNotification_withCallBackData___block_invoke(uint64_t a1)
{
  ...
  context = (void *)MEMORY[0x24BD2A030]();
...
LABEL_26:
  ...
  if ((v9 & 1) == 0)
    goto LABEL_68;
LABEL_27:
  objc_msgSend(MEMORY[0x24BDD1488], "bundleWithPath:", CFSTR("/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"));
  ...
  objc_msgSend(v10, "localizedStringForKey:value:table:", v12, &stru_251CC14A0, CFSTR("Localizable"));
  ...
  if (!memcmp(v16, "Telephony_Dump_Insufficient", v17) && v15 == 27)
  {
    ...
    objc_msgSend(v19, "localizedStringForKey:value:table:", CFSTR("Telephony_Dump_Insufficient_Details_%@"), &stru_251CC14A0, CFSTR("Localizable"));
...
LABEL_50:
  ...
  if (!memcmp(v24, "Telephony_Dump_Started", v25) && v23 == 22)
  {
    ...
    objc_msgSend(MEMORY[0x24BDD17C8], "stringWithUTF8String:", v6);
    v20 = (void *)objc_claimAutoreleasedReturnValue();
    objc_msgSend(v19, "localizedStringForKey:value:table:", v20, &stru_251CC14A0, CFSTR("Localizable"));
    v21 = (void *)objc_claimAutoreleasedReturnValue();
  ...
  objc_msgSend(MEMORY[0x24BDD1488], "bundleWithPath:", CFSTR("/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"));
  v19 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v19, "localizedStringForKey:value:table:", CFSTR("Check_Settings_Cellular_Diagnostics"), &stru_251CC14A0, CFSTR("Localizable"));
  v20 = (void *)objc_claimAutoreleasedReturnValue();
...
LABEL_51:
  ...
  *((_QWORD *)&buf + 1) = 0x40000000;
  ...
  v52 = &__block_descriptor_tmp_13_5;
  v53 = &GetABMLogServer(void)::sLogServer;
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v33 = *(std::__shared_weak_count **)algn_2579B8AE8;
    v42 = GetABMLogServer(void)::sLogServer;
    v43 = *(_QWORD *)algn_2579B8AE8;
    if (*(_QWORD *)algn_2579B8AE8)
      goto LABEL_56;
  }
  else
...
LABEL_56:
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v39;
    _os_log_impl(&dword_24B855000, v36, OS_LOG_TYPE_DEFAULT, "#I Add notification request with id: %s", (uint8_t *)&buf, 0xCu);
  }
...
LABEL_9:
  ...
  if (!v10)
    v10 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x24BE055F0], v10);
  v11 = xpc_null_create();
  xpc_release(v10);
  xpc_release(v11);
  ...
  if (!v16)
    v16 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x24BE055F8], v16);
  v17 = xpc_null_create();
  xpc_release(v16);
  xpc_release(v17);
  if (v4)
  ...
  if (!v19)
    v19 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x24BE055E8], v19);
  v20 = xpc_null_create();
  xpc_release(v19);
  xpc_release(v20);
  memset(&__dst, 170, sizeof(__dst));
  v21 = (const void *)*MEMORY[0x24BE05558];
  v22 = strlen((const char *)*MEMORY[0x24BE05558]);
...
LABEL_32:
  ...
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    v28 = *(std::__shared_weak_count **)algn_2579B8AE8;
    v38 = GetABMLogServer(void)::sLogServer;
    v39 = *(_QWORD *)algn_2579B8AE8;
    if (!*(_QWORD *)algn_2579B8AE8)
      goto LABEL_37;
  }
  else
...
LABEL_41:
  ...
  *(_DWORD *)buf = 136315394;
  ...
  v48 = 2080;
  v49 = v34;
  _os_log_impl(&dword_24B855000, v31, OS_LOG_TYPE_DEFAULT, "#I Submitting CoreAnalytics event[%s] - %s", buf, 0x16u);
  if (SHIBYTE(v43) < 0)
...
LABEL_9:
  ...
  buf[0].__r_.__value_.__r.__words[0] = MEMORY[0x24BDAC760];
  ...
  buf[1].__r_.__value_.__r.__words[0] = (std::string::size_type)&__block_descriptor_tmp_13_5;
...
LABEL_18:
  ...
  *(std::string::size_type *)((char *)buf[0].__r_.__value_.__r.__words + 4) = (std::string::size_type)v19;
  _os_log_impl(&dword_24B855000, v16, OS_LOG_TYPE_DEFAULT, "#I Received notification response with id: %s", (uint8_t *)buf, 0xCu);
LABEL_22:
  v20 = *(_QWORD *)(a1 + 48);
  if (v20)
    (*(void (**)(void))(v20 + 16))();
...
LABEL_47:
          ...
          *(_OWORD *)&v69.__r_.__value_.__l.__data_ = v38;
          ...
          buf[0].__r_.__value_.__l.__size_ = 0x40000000;
          buf[0].__r_.__value_.__r.__words[2] = 0x24B927000;
          buf[1].__r_.__value_.__r.__words[0] = (std::string::size_type)&__block_descriptor_tmp_13_5;
          buf[1].__r_.__value_.__l.__size_ = (std::string::size_type)&GetABMLogServer(void)::sLogServer;
          if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
          {
            v51 = *(std::__shared_weak_count **)algn_2579B8AE8;
            v62 = GetABMLogServer(void)::sLogServer;
            v63 = *(_QWORD *)algn_2579B8AE8;
            if (*(_QWORD *)algn_2579B8AE8)
            {
LABEL_107:
...
LABEL_114:
            ...
            *(std::string::size_type *)((char *)buf[0].__r_.__value_.__r.__words + 4) = (std::string::size_type)v57;
            _os_log_impl(&dword_24B855000, v54, OS_LOG_TYPE_DEFAULT, "#I Remove callback for id: %s", (uint8_t *)buf, 0xCu);
            if (SHIBYTE(v69.__r_.__value_.__r.__words[2]) < 0)
              goto LABEL_117;
LABEL_121:
            v58 = aBlock[1];
