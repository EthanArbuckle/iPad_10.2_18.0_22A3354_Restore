...
- (void)setEcID:(id)a3
{
  UARPTLVPersonalizationECIDData *v4;
  uint64_t v5;
  NSData *ecID;
  id v7;
...
- (id)description
{
  ...
  objc_msgSend(v4, "stringWithFormat:", CFSTR("<%@: %@>"), v5, self->_ecID);
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationECIDData tlvType](UARPTLVPersonalizationECIDData, "tlvType");
  ecID = self->_ecID;
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationECIDData;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationECIDData tlvType](UARPTLVPersonalizationECIDData, "tlvType"));
