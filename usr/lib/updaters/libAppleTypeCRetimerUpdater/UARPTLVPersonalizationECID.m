...
{
  UARPTLVPersonalizationECID *obj;
...
- (id)description
{
  ...
  objc_msgSend(v4, "stringWithFormat:", CFSTR("<%@: 0x%016llx>"), v5, self->_ecID);
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationECID tlvType](UARPTLVPersonalizationECID, "tlvType");
  ecID = self->_ecID;
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationECID;
...
- (id)tlvValue
{
  ...
  ecID = self->_ecID;
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationECID;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationECID tlvType](UARPTLVPersonalizationECID, "tlvType"));
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = (void *)objc_opt_new();
    objc_msgSend(v5, "setEcID:", uarpNtohll(*(_QWORD *)a4));
  }
  else
  {
    v5 = 0;
