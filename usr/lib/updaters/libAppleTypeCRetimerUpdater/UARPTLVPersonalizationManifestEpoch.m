...
{
  UARPTLVPersonalizationManifestEpoch *obj;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationManifestEpoch tlvType](UARPTLVPersonalizationManifestEpoch, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationManifestEpoch;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationManifestEpoch;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationManifestEpoch tlvType](UARPTLVPersonalizationManifestEpoch, "tlvType"));
