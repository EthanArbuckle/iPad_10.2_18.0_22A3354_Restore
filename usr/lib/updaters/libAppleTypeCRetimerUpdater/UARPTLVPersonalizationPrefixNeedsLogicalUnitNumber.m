...
{
  UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber *obj;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber tlvType](UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber tlvType](UARPTLVPersonalizationPrefixNeedsLogicalUnitNumber, "tlvType"));
