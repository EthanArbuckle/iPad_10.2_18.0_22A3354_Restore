...
{
  UARPTLVPersonalizationSecurityMode *obj;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationSecurityMode tlvType](UARPTLVPersonalizationSecurityMode, "tlvType");
  v4 = *(&self->super.super._tlvLength + 1);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationSecurityMode;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationSecurityMode;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationSecurityMode tlvType](UARPTLVPersonalizationSecurityMode, "tlvType"));
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = (void *)objc_opt_new();
    objc_msgSend(v5, "setSecurityMode:", uarpNtohl(*(_DWORD *)a4));
  }
  else
  {
    v5 = 0;
