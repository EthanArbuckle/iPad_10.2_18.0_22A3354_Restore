...
- (BOOL)expandMetaData:(UARPSuperBinaryHeader *)a3
{
  ...
  if (-[NSData length](self->_data, "length") < v6)
    return 0;
  -[NSData subdataWithRange:](self->_data, "subdataWithRange:", a3->var4, a3->var5);
...
- (BOOL)preparePayload:(UARPPayloadHeader2 *)a3
{
  ...
  v5 = -[UARPAssetTag initWithChar1:char2:char3:char4:]([UARPAssetTag alloc], "initWithChar1:char2:char3:char4:", (char)a3->var1.var0, (char)a3->var1.var1, (char)a3->var1.var2, (char)a3->var1.var3);
  v6 = -[UARPAssetVersion initWithMajorVersion:minorVersion:releaseVersion:buildVersion:]([UARPAssetVersion alloc], "initWithMajorVersion:minorVersion:releaseVersion:buildVersion:", a3->var2.var0, a3->var2.var1, a3->var2.var2, a3->var2.var3);
  v7 = a3->var4 + a3->var3;
...
- (id)getBver
{
  ...
  v3 = -[UARPAssetTag initWithString:]([UARPAssetTag alloc], "initWithString:", CFSTR("FIRM"));
  -[UARPSuperBinary payloadWith4ccTag:](self, "payloadWith4ccTag:", v3);
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      v7 = -[FTABFile initWithData:]([FTABFile alloc], "initWithData:", v6);
      -[FTABFile bverString](v7, "bverString");
      v8 = (void *)objc_claimAutoreleasedReturnValue();
