...
- (void)setNonce:(id)a3
{
  UARPTLVPersonalizationNonce *v4;
  uint64_t v5;
  NSData *nonce;
  id v7;
...
- (id)description
{
  ...
  objc_msgSend(v4, "stringWithFormat:", CFSTR("<%@: %@>"), v5, self->_nonce);
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationNonce tlvType](UARPTLVPersonalizationNonce, "tlvType");
  nonce = self->_nonce;
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationNonce;
  -[UARPMetaDataTLVData generateTLV:tlvValue:](&v6, sel_generateTLV_tlvValue_, v3, nonce);
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationNonce tlvType](UARPTLVPersonalizationNonce, "tlvType"));
