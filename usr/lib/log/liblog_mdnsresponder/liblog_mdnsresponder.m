...
void *OSLogCopyFormattedString(const char *a1, void *a2)
{
  ...
  do
  {
    ...
    {
      v6 = ((uint64_t (*)(id))(&OSLogCopyFormattedString_formatters)[v4 + 1])(v3);
...
uint64_t MDNSOLCopyFormattedStringD2DServiceEvent(void *a1)
{
  ...
  {
    v2 = v1;
    v3 = CFSTR("D2DServiceFound");
    switch(objc_msgSend(v2, "longLongValue"))
    {
      case 0:
        break;
      case 1:
        v3 = CFSTR("D2DServiceLost");
        break;
      case 2:
        v3 = CFSTR("D2DServiceResolved");
        break;
      case 3:
        v3 = CFSTR("D2DServiceRetained");
        break;
      case 4:
        v3 = CFSTR("D2DServiceReleased");
        break;
      case 5:
        v3 = CFSTR("D2DServicePeerLost");
        break;
      default:
        v3 = 0;
        break;
  ...
  v4 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v3);
...
uint64_t MDNSOLCopyFormattedStringDNSScopeType(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    v4 = CFSTR("Service scoped");
    v5 = CFSTR("Interface scoped");
    if (v3 != 1)
      v5 = 0;
    if (v3 != 2)
      v4 = v5;
  ...
  v7 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v6);
...
uint64_t MDNSOLCopyFormattedStringmDNSLabelSequenceName(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    v9 = objc_alloc((Class)&off_255DB4D50);
    v10 = objc_alloc((Class)&off_255DB52F8);
    objc_msgSend(v1, "description");
    v11 = (void *)objc_claimAutoreleasedReturnValue();
    v12 = (void *)objc_msgSend(v10, "initWithFormat:", CFSTR("<fail decode - data type> %@"), v11);
    v7 = objc_msgSend(v9, "initWithString:", v12);
  ...
  {
    v7 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", CFSTR("<NULL DOMAIN NAME>"));
    v5 = 0;
    goto LABEL_10;
  }
  v2 = objc_retainAutorelease(v2);
  v3 = (unsigned __int8 *)objc_msgSend(v2, "bytes");
  v4 = (unint64_t)&v3[objc_msgSend(v2, "length")];
  bzero(v13, 0x3F1uLL);
  ...
  +[NSString stringWithUTF8String:](&off_255DB52F8, "stringWithUTF8String:", v13);
...
LABEL_13:
  ...
  v6 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v5);
  if (!v6)
    v6 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", CFSTR("<Could not create NSAttributedString>"));
  v7 = v6;
LABEL_10:
...
uint64_t MDNSOLCopyFormattedStringmDNSLabel(void *a1)
{
  ...
  if (!objc_msgSend(v2, "bytes") || !objc_msgSend(v2, "length"))
  {
    v7 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", CFSTR("<NULL DOMAIN LABEL>"));
LABEL_14:
    v5 = 0;
    goto LABEL_15;
  }
  v2 = objc_retainAutorelease(v2);
  v3 = *(unsigned __int8 *)objc_msgSend(v2, "bytes");
  if (v3 > 0x3F || objc_msgSend(v2, "length") != v3 + 1)
  {
    v13 = objc_alloc((Class)&off_255DB4D50);
    v14 = (void *)objc_msgSend(objc_alloc((Class)&off_255DB52F8), "initWithFormat:", CFSTR("failed to decode - invalid domain label length - data length: %lu, label length: %lu"), objc_msgSend(v2, "length"), v3);
    v7 = objc_msgSend(v13, "initWithString:", v14);
...
LABEL_19:
  ...
  if (v4)
    __s[v4 - 1] = 0;
  +[NSString stringWithUTF8String:](&off_255DB52F8, "stringWithUTF8String:", __s);
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  if (!v5)
    goto LABEL_19;
  v6 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v5);
...
uint64_t MDNSOLCopyFormattedStringHexSequence(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    v5 = objc_alloc((Class)&off_255DB4D50);
    v6 = objc_alloc((Class)&off_255DB52F8);
    objc_msgSend(v1, "description");
    v2 = (id)objc_claimAutoreleasedReturnValue();
    v7 = objc_msgSend(v6, "initWithFormat:", CFSTR("<failed to decode - invalid data type: %@>"), v2);
LABEL_7:
    v8 = (void *)v7;
    v3 = objc_msgSend(v5, "initWithString:", v7);
  ...
  {
    v5 = objc_alloc((Class)&off_255DB4D50);
    v7 = objc_msgSend(objc_alloc((Class)&off_255DB52F8), "initWithFormat:", CFSTR("<failed to decode - NIL data >"), v9);
    goto LABEL_7;
  }
  NSPrintTypedObject();
...
uint64_t MDNSOLCopyFormattedStringmDNSIPAddr(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    v12 = objc_alloc((Class)&off_255DB4D50);
    v13 = objc_alloc((Class)&off_255DB52F8);
    objc_msgSend(v1, "description");
    v14 = (void *)objc_claimAutoreleasedReturnValue();
    v15 = (void *)objc_msgSend(v13, "initWithFormat:", CFSTR("<fail decode - data type> %@"), v14);
    v8 = objc_msgSend(v12, "initWithString:", v15);
  ...
  {
    v9 = objc_alloc((Class)&off_255DB4D50);
    v10 = CFSTR("<NULL IP ADDRESS>");
LABEL_10:
    v8 = objc_msgSend(v9, "initWithString:", v10);
LABEL_11:
    v5 = 0;
    goto LABEL_12;
  }
  ...
  {
    v9 = objc_alloc((Class)&off_255DB4D50);
    v10 = CFSTR("<UNSPECIFIED IP ADDRESS>");
    goto LABEL_10;
  }
  v17 = &v18;
  NSPrintF();
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  v6 = objc_alloc((Class)&off_255DB4D50);
  if (!v5)
  {
    v16 = CFSTR("<Could not create NSString>");
LABEL_18:
    v7 = objc_msgSend(v6, "initWithString:", v16, v17);
    goto LABEL_8;
  }
  v7 = objc_msgSend(v6, "initWithString:", v5, &v18);
  if (!v7)
  {
    v6 = objc_alloc((Class)&off_255DB4D50);
    v16 = CFSTR("<Could not create NSAttributedString>");
    goto LABEL_18;
  }
LABEL_8:
  v8 = v7;
...
LABEL_6:
  ...
  v4 = CFSTR("KEV_DL_SIFFLAGS");
  switch((int)v3)
  {
    case 1:
      break;
    case 2:
      v4 = CFSTR("KEV_DL_SIFMETRICS");
      break;
    case 3:
      v4 = CFSTR("KEV_DL_SIFMTU");
      break;
    case 4:
      v4 = CFSTR("KEV_DL_SIFPHYS");
      break;
    case 5:
      v4 = CFSTR("KEV_DL_SIFMEDIA");
      break;
    case 6:
      v4 = CFSTR("KEV_DL_SIFGENERIC");
      break;
    case 7:
      v4 = CFSTR("KEV_DL_ADDMULTI");
      break;
    case 8:
      v4 = CFSTR("KEV_DL_DELMULTI");
      break;
    case 9:
      v4 = CFSTR("KEV_DL_IF_ATTACHED");
      break;
    case 10:
      v4 = CFSTR("KEV_DL_IF_DETACHING");
      break;
    case 11:
      v4 = CFSTR("KEV_DL_IF_DETACHED");
      break;
    case 12:
      v4 = CFSTR("KEV_DL_LINK_OFF");
      break;
    case 13:
      v4 = CFSTR("KEV_DL_LINK_ON");
      break;
    case 14:
      v4 = CFSTR("KEV_DL_PROTO_ATTACHED");
      break;
    case 15:
      v4 = CFSTR("KEV_DL_PROTO_DETACHED");
      break;
    case 16:
      v4 = CFSTR("KEV_DL_LINK_ADDRESS_CHANGED");
      break;
    case 17:
      v4 = CFSTR("KEV_DL_WAKEFLAGS_CHANGED");
      break;
    case 18:
      v4 = CFSTR("KEV_DL_IF_IDLE_ROUTE_REFCNT");
      break;
    case 19:
      v4 = CFSTR("KEV_DL_IFCAP_CHANGED");
      break;
    case 20:
      v4 = CFSTR("KEV_DL_LINK_QUALITY_METRIC_CHANGED");
      break;
    case 21:
      v4 = CFSTR("KEV_DL_NODE_PRESENCE");
      break;
    case 22:
      v4 = CFSTR("KEV_DL_NODE_ABSENCE");
      break;
    case 23:
      v4 = CFSTR("KEV_DL_PRIMARY_ELECTED");
      break;
    case 24:
      v4 = CFSTR("KEV_DL_ISSUES");
      break;
    case 25:
      v4 = CFSTR("KEV_DL_IFDELEGATE_CHANGED");
      break;
    case 27:
      v4 = CFSTR("KEV_DL_AWDL_UNRESTRICTED");
      break;
    case 28:
      v4 = CFSTR("KEV_DL_RRC_STATE_CHANGED");
      break;
    case 29:
      v4 = CFSTR("KEV_DL_QOS_MODE_CHANGED");
      break;
    case 30:
      v4 = CFSTR("KEV_DL_LOW_POWER_MODE_CHANGED");
      break;
    default:
      v4 = CFSTR("<Unknown Data-Link event>");
      break;
  }
LABEL_7:
  v5 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v4);
...
uint64_t MDNSOLCopyFormattedStringmDNSMACAddr(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    v8 = objc_alloc((Class)&off_255DB4D50);
    v9 = objc_alloc((Class)&off_255DB52F8);
    objc_msgSend(v1, "description");
    v10 = (void *)objc_claimAutoreleasedReturnValue();
    v11 = (void *)objc_msgSend(v9, "initWithFormat:", CFSTR("<fail decode - data type> %@"), v10);
    v6 = objc_msgSend(v8, "initWithString:", v11);
  ...
  if (!objc_msgSend(v2, "bytes") || !objc_msgSend(v2, "length"))
  {
    v6 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", CFSTR("<NULL MAC ADDRESS>"));
LABEL_9:
    v3 = 0;
    goto LABEL_10;
  }
  if (objc_msgSend(v2, "length") != 6)
  {
    v12 = objc_alloc((Class)&off_255DB4D50);
    v13 = (void *)objc_msgSend(objc_alloc((Class)&off_255DB52F8), "initWithFormat:", CFSTR("<fail decode - size> %zu != %d"), objc_msgSend(v2, "length"), 6);
    v6 = objc_msgSend(v12, "initWithString:", v13);

    goto LABEL_9;
  }
  v2 = objc_retainAutorelease(v2);
  v15 = objc_msgSend(v2, "bytes");
  NSPrintF();
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  v4 = objc_alloc((Class)&off_255DB4D50);
  if (!v3)
  {
    v14 = CFSTR("<Could not create NSString>");
LABEL_15:
    v5 = objc_msgSend(v4, "initWithString:", v14, v15);
    goto LABEL_7;
  }
  v5 = objc_msgSend(v4, "initWithString:", v3, v15);
  if (!v5)
  {
    v4 = objc_alloc((Class)&off_255DB4D50);
    v14 = CFSTR("<Could not create NSAttributedString>");
    goto LABEL_15;
  }
LABEL_7:
  v6 = v5;
...
uint64_t MDNSOLCopyFormattedStringMDNSNameHashTypeBytes(void *a1)
{
  ...
  v1 = a1;
  v2 = (void *)objc_msgSend(objc_alloc((Class)&off_255DB53E8), "initWithCapacity:", 0);
  if (!v2)
  {
    v12 = 0;
    goto LABEL_12;
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    if (objc_msgSend(v3, "bytes"))
    {
      ...
      if (v5 >= 6)
      {
        ...
        do
        {
          v9 = bswap32(*(_DWORD *)(v7 - 2));
          v10 = __rev16(*(unsigned __int16 *)(v7 + 2));
          v11 = DNSRecordTypeValueToString(v10);
          if (v11)
            objc_msgSend(v2, "appendFormat:", CFSTR("%s(%x %s)"), v8, v9, v11);
          else
            objc_msgSend(v2, "appendFormat:", CFSTR("%s(%x TYPE%u)"), v8, v9, v10);
          v7 += 6;
          v8 = " ";
          --v6;
        }
      ...
      v12 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v2);
      v1 = v19;
      goto LABEL_11;
    }
    v14 = objc_alloc((Class)&off_255DB4D50);
    v16 = objc_msgSend(objc_alloc((Class)&off_255DB52F8), "initWithFormat:", CFSTR("<failed to decode - NIL data >"), v18);
  }
  else
  {
    v14 = objc_alloc((Class)&off_255DB4D50);
    v15 = objc_alloc((Class)&off_255DB52F8);
    objc_msgSend(v1, "description");
    v3 = (id)objc_claimAutoreleasedReturnValue();
    v16 = objc_msgSend(v15, "initWithFormat:", CFSTR("<failed to decode - invalid data type: %@>"), v3);
  }
  v17 = (void *)v16;
  v12 = objc_msgSend(v14, "initWithString:", v16);
...
uint64_t MDNSOLCopyFormattedStringNetworkChangeEventFlag(void *a1)
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    objc_msgSend(v2, "appendFormat:", CFSTR("0x%llX {"), v4);
    v5 = 0;
    v6 = "";
    do
    {
      if ((v4 & (uint64_t)(&off_24F98B3F8)[v5 + 1]) != 0)
      {
        objc_msgSend(v2, "appendFormat:", CFSTR("%s%s"), v6, (&off_24F98B3F8)[v5]);
        v6 = ", ";
      }
      v5 += 2;
    }
  ...
  v7 = objc_msgSend(objc_alloc((Class)&off_255DB4D50), "initWithString:", v2);
