...
- (NFAssertionInternal)initWithDictionary:(id)a3
{
  ...
  v5 = -[NFAssertionInternal init](&v11, sel_init);
  if (v5)
  {
...
- (NFAssertionInternal)initWithCoder:(id)a3
{
  ...
  v5 = -[NFAssertionInternal init](&v9, sel_init);
  if (v5)
  {
...
- (id)description
{
  ...
  if (assertionType > 6)
    ...
    v3 = (const __CFString *)*((_QWORD *)&off_1E7D7F5F0 + assertionType);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0
      && (assertionType = self->_assertionType,
          assertionType == -[NFAssertionInternal assertionType](v4, "assertionType"))
      && (pid = self->_pid, pid == -[NFAssertionInternal pid](v4, "pid")))
    {
      assertionTime = self->_assertionTime;
      -[NFAssertionInternal assertionTime](v4, "assertionTime");
