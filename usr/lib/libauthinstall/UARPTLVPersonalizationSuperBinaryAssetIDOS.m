...
{
  UARPTLVPersonalizationSuperBinaryAssetIDOS *v4;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationSuperBinaryAssetIDOS tlvType](UARPTLVPersonalizationSuperBinaryAssetIDOS, "tlvType");
  v4 = *((unsigned __int16 *)&self->super.super._tlvLength + 2);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationSuperBinaryAssetIDOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationSuperBinaryAssetIDOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationSuperBinaryAssetIDOS tlvType](UARPTLVPersonalizationSuperBinaryAssetIDOS, "tlvType"));
  v6[1] = v2;
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = (void *)objc_opt_new();
    objc_msgSend(v5, "setAssetID:", uarpHtons(*(unsigned __int16 *)a4));
  }
  else
  {
    v5 = 0;
