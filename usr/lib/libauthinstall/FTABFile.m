...
- (NSString)dumpString
{
  ...
  v21 = 0u;
  v22 = 0u;
  -[FTABFile subfiles](self, "subfiles");
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v21 + 1) + 8 * v17), "dumpString");
...
- (FTABFile)init
{
  ...
  if (v2)
  {
    ...
    objc_msgSend(MEMORY[0x24BDBCE50], "dataWithBytes:length:", &kFTABMagicLowercase_0, 8);
...
- (void)writeToDestination
{
  ...
  v1 = (void *)objc_claimAutoreleasedReturnValue();
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_2(&dword_20D05A000, v2, v3, "Failed to write '%@' header", v4, v5, v6, v7, v8);
