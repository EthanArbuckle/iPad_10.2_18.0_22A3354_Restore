...
{
  UARPTLVPersonalizationProductionModeOS *v4;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationProductionModeOS metaDataTableEntry](UARPTLVPersonalizationProductionModeOS, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationProductionModeOS tlvType](UARPTLVPersonalizationProductionModeOS, "tlvType");
  v4 = *(&self->super.super._tlvLength + 1);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationProductionModeOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationProductionModeOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationProductionModeOS tlvType](UARPTLVPersonalizationProductionModeOS, "tlvType"));
  v6[1] = v2;
...
+ (id)tlvFromPropertyListValue:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    objc_msgSend(v5, "setProductionMode:", v6);
  }
  else
  {
    v5 = 0;
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = (void *)objc_opt_new();
    objc_msgSend(v5, "setProductionMode:", uarpHtonl(*(_DWORD *)a4));
  }
  else
  {
    v5 = 0;
