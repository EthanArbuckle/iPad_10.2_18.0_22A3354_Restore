...
{
  UARPTLVPersonalizationLifeOS *v4;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationLifeOS metaDataTableEntry](UARPTLVPersonalizationLifeOS, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationLifeOS tlvType](UARPTLVPersonalizationLifeOS, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationLifeOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationLifeOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationLifeOS tlvType](UARPTLVPersonalizationLifeOS, "tlvType"));
  v6[1] = v2;
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = (void *)objc_opt_new();
    objc_msgSend(v5, "setLife:", *(unsigned __int8 *)a4);
  }
  else
  {
    v5 = 0;
