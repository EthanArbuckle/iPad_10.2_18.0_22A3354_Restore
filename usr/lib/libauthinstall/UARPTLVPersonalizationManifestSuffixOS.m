...
{
  id v4;
  UARPTLVPersonalizationManifestSuffixOS *v5;
  uint64_t v6;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationManifestSuffixOS metaDataTableEntry](UARPTLVPersonalizationManifestSuffixOS, "metaDataTableEntry");
  v4 = (void *)MEMORY[0x24BDD17C8];
  v5 = (id)objc_msgSend(v3, "objectForKeyedSubscript:", CFSTR("Name"));
  v6 = (id)objc_msgSend(v4, "stringWithFormat:", CFSTR("<%@: %@>"), v5, self->_manifestSuffix);
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationManifestSuffixOS tlvType](UARPTLVPersonalizationManifestSuffixOS, "tlvType");
  manifestSuffix = self->_manifestSuffix;
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationManifestSuffixOS;
...
- (id)tlvValue
{
  ...
  manifestSuffix = self->_manifestSuffix;
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationManifestSuffixOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationManifestSuffixOS tlvType](UARPTLVPersonalizationManifestSuffixOS, "tlvType"));
  v6[1] = v2;
