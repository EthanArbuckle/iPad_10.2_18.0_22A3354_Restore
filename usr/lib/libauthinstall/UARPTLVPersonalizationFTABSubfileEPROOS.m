...
{
  UARPTLVPersonalizationFTABSubfileEPROOS *v4;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationFTABSubfileEPROOS metaDataTableEntry](UARPTLVPersonalizationFTABSubfileEPROOS, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationFTABSubfileEPROOS tlvType](UARPTLVPersonalizationFTABSubfileEPROOS, "tlvType");
  v4 = *((unsigned __int16 *)&self->super.super._tlvLength + 2);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationFTABSubfileEPROOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationFTABSubfileEPROOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationFTABSubfileEPROOS tlvType](UARPTLVPersonalizationFTABSubfileEPROOS, "tlvType"));
  v6[1] = v2;
