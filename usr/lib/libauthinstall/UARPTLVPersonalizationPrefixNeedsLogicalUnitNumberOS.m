...
{
  UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS *v4;
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS tlvType](UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS tlvType](UARPTLVPersonalizationPrefixNeedsLogicalUnitNumberOS, "tlvType"));
  v6[1] = v2;
...
+ (id)tlvFromPropertyListValue:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0)
  {
    ...
    objc_msgSend(v5, "setPrefixNeedsLogicalUnitNumber:", v6);
  }
  else
  {
    v5 = 0;
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = (void *)objc_opt_new();
    objc_msgSend(v5, "setPrefixNeedsLogicalUnitNumber:", *(unsigned __int8 *)a4);
  }
  else
  {
    v5 = 0;
