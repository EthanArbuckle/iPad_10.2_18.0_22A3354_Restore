...
{
  UARPTLVPersonalizationProvisioningOS *v4;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationProvisioningOS metaDataTableEntry](UARPTLVPersonalizationProvisioningOS, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationProvisioningOS tlvType](UARPTLVPersonalizationProvisioningOS, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationProvisioningOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationProvisioningOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationProvisioningOS tlvType](UARPTLVPersonalizationProvisioningOS, "tlvType"));
  v6[1] = v2;
