...
{
  id v4;
  UARPTLVPersonalizationFTABSubfileTagOS *v5;
  uint64_t v6;
  UARPAssetTagOS *tag;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationFTABSubfileTagOS metaDataTableEntry](UARPTLVPersonalizationFTABSubfileTagOS, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v8 = uarpHtonl(+[UARPTLVPersonalizationFTABSubfileTagOS tlvType](UARPTLVPersonalizationFTABSubfileTagOS, "tlvType"));
  objc_msgSend(v3, "appendBytes:length:", &v8, 4);
  v7 = uarpHtonl(4u);
  objc_msgSend(v3, "appendBytes:length:", &v7, 4);
  v4 = -[UARPTLVPersonalizationFTABSubfileTagOS tlvValue](self, "tlvValue");
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationFTABSubfileTagOS tlvType](UARPTLVPersonalizationFTABSubfileTagOS, "tlvType"));
  v6[1] = v2;
