...
- (UARPSuperBinaryPayloadOS)initWithData:(id)a3 metaData:(id)a4 tag:(id)a5 version:(id)a6
{
  ...
  v14 = -[UARPSuperBinaryPayloadOS init](&v36, sel_init);
  if (v14)
  {
    ...
    v33 = -[FTABFileOS initWithData:]([FTABFileOS alloc], "initWithData:", v14->_payloadData);
    ftab = v14->_ftab;
    v14->_ftab = v33;
...
- (id)personalizedData
{
  ...
  if (self->_ftab)
  {
    if (-[NSMutableArray count](self->_subfiles, "count"))
      -[FTABFileOS addSubfiles:](self->_ftab, "addSubfiles:", self->_subfiles);
    if (self->_manifest)
      -[FTABFileOS setManifest:](self->_ftab, "setManifest:");
    v3 = (NSData *)-[FTABFileOS writeToData](self->_ftab, "writeToData");
  }
  else
  {
...
- (BOOL)expandTLVs
{
  ...
  -[UARPSuperBinaryPayloadOS processTLVsForPersonalization](self, "processTLVsForPersonalization");
  return 1;
}
...
{
  return -[UARPSuperBinaryPayloadOS composeTSSRequest:asMeasurement:](self, "composeTSSRequest:asMeasurement:", a3, 0);
}
...
- (id)composeTSSRequest:(unint64_t)a3 asMeasurement:(BOOL)a4
{
  ...
  if (!v4)
  {
    ...
    v30 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("BoardID"), a3);
    v12 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[UARPSuperBinaryPayloadOS boardID](self, "boardID"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v12, v30);

    v28 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("ChipID"), a3);
    v13 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", -[UARPSuperBinaryPayloadOS chipID](self, "chipID"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v13, v28);

    v14 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("ECID"), a3);
    v15 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", -[UARPSuperBinaryPayloadOS ecID](self, "ecID"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v15, v14);

    v16 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("Nonce"), a3);
    v17 = -[UARPSuperBinaryPayloadOS nonce](self, "nonce");
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v17, v16);

    v18 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("ProductionMode"), a3);
    v19 = -[UARPSuperBinaryPayloadOS productionMode](self, "productionMode");
    ...
    v23 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("SecurityDomain"), a3);
    v24 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedChar:", -[UARPSuperBinaryPayloadOS securityDomain](self, "securityDomain"));
    -[NSMutableDictionary setObject:forKeyedSubscript:](self->_tssRequest, "setObject:forKeyedSubscript:", v24, v23);

    v25 = -[UARPSuperBinaryPayloadOS tssKeyName:unitNumber:](self, "tssKeyName:unitNumber:", CFSTR("SecurityMode"), a3);
    if (-[UARPSuperBinaryPayloadOS securityMode](self, "securityMode"))
      v26 = v21;
    else
      v26 = v20;
  ...
  -[UARPSuperBinaryPayloadOS processMeasurementsForTSSOptions:unitNumber:asMeasurement:](self, "processMeasurementsForTSSOptions:unitNumber:asMeasurement:", self->_tssRequest, a3, v4);
  return (id)objc_msgSend(MEMORY[0x24BDBCE70], "dictionaryWithDictionary:", self->_tssRequest);
}
      ...
      do
      {
        ...
        do
        {
          for (i = 0; i != v11; ++i)
          {
            ...
            {
              v16 = v15;
              v17 = (id)objc_msgSend(v16, "longname");
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              v18 = (id)objc_msgSend(v15, "digest");
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              if (a5)
                continue;
              if (-[UARPSuperBinaryPayloadOS securityMode](v30, "securityMode"))
            ...
            if ((objc_opt_isKindOfClass() & 1) != 0)
            {
              if (a5)
                continue;
              if (-[UARPSuperBinaryPayloadOS productionMode](v30, "productionMode"))
                v19 = MEMORY[0x24BDBD1C8];
              else
                v19 = MEMORY[0x24BDBD1C0];
              v20 = v8;
...
- (id)description
{
  ...
  v4 = (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithString:", v3);
...
- (id)tatsuMeasurements:(unint64_t)a3
{
  ...
  if (v5)
    v5 = -[UARPSuperBinaryPayloadOS composeTSSRequest:asMeasurement:](self, "composeTSSRequest:asMeasurement:", a3, 1);
  return v5;
}
...
- (void)addSubfile:(id)a3 tag:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  v8 = -[FTABSubfileOS initWithTag:data:]([FTABSubfileOS alloc], "initWithTag:data:", v6, v7);
...
LABEL_3:
    ...
    while (1)
    {
      ...
      v12 = (id)objc_msgSend(v11, "tag", (_QWORD)v15);
