...
{
  UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS *v4;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS metaDataTableEntry](UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS tlvType](UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = (id)objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS tlvType](UARPTLVPersonalizationTicketNeedsLogicalUnitNumberOS, "tlvType"));
  v6[1] = v2;
