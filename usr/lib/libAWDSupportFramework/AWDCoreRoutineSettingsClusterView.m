...
- (void)dealloc
{
  ...
  -[AWDCoreRoutineSettingsClusterView setSessionId:](self, "setSessionId:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineSettingsClusterView;
  -[AWDCoreRoutineSettingsClusterView dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineSettingsClusterView;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineSettingsClusterView description](&v3, sel_description), -[AWDCoreRoutineSettingsClusterView dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_clusterCount), CFSTR("clusterCount"));
    has = (char)self->_has;
  }
  if ((has & 4) != 0)
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_elsewhereCount), CFSTR("elsewhereCount"));
  return v3;
}
...
LABEL_19:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 2) == 0 || self->_clusterCount != *((_DWORD *)a3 + 4))
        goto LABEL_19;
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 4) == 0 || self->_elsewhereCount != *((_DWORD *)a3 + 5))
        goto LABEL_19;
      LOBYTE(v5) = 1;
    }
  }
...
- (unint64_t)hash
{
  ...
  {
    v5 = 2654435761 * self->_clusterCount;
...
LABEL_8:
  ...
  if ((*(_BYTE *)&self->_has & 4) == 0)
    goto LABEL_8;
LABEL_6:
  v6 = 2654435761 * self->_elsewhereCount;
  return v4 ^ v3 ^ v5 ^ v6;
}
