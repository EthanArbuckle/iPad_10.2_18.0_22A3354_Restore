...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallInvitationSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationSent;
  -[AWDFaceTimeCallInvitationSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallInvitationSent description](&v3, sel_description), -[AWDFaceTimeCallInvitationSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
