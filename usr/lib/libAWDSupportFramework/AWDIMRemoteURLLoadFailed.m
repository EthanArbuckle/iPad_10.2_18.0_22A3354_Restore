...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIMRemoteURLLoadFailed description](&v3, sel_description), -[AWDIMRemoteURLLoadFailed dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_3:
  ...
  *((_QWORD *)a3 + 8) = self->_navigationStartToRedirectStartMillis;
  *((_WORD *)a3 + 60) |= 0x80u;
  has = (__int16)self->_has;
  if ((has & 0x200) == 0)
  {
...
LABEL_18:
  *((_QWORD *)a3 + 10) = self->_redirectStartToRedirectEndMillis;
  *((_WORD *)a3 + 60) |= 0x200u;
  has = (__int16)self->_has;
  if ((has & 0x100) == 0)
  {
...
LABEL_19:
  *((_QWORD *)a3 + 9) = self->_redirectEndToFetchStartMillis;
  *((_WORD *)a3 + 60) |= 0x100u;
  has = (__int16)self->_has;
  if ((has & 0x40) == 0)
  {
...
LABEL_20:
  *((_QWORD *)a3 + 7) = self->_fetchStartToDomainLookupStartMillis;
  *((_WORD *)a3 + 60) |= 0x40u;
  has = (__int16)self->_has;
  if ((has & 0x10) == 0)
  {
...
LABEL_25:
  *((_QWORD *)a3 + 13) = self->_secureConnectionStartToConnectEndMillis;
  *((_WORD *)a3 + 60) |= 0x1000u;
  has = (__int16)self->_has;
  if ((has & 1) == 0)
  {
...
LABEL_27:
  *((_QWORD *)a3 + 11) = self->_requestStartToResponseStartMillis;
  *((_WORD *)a3 + 60) |= 0x400u;
  has = (__int16)self->_has;
  if ((has & 0x800) == 0)
  {
LABEL_14:
    if ((has & 0x20) == 0)
      return;
LABEL_29:
    *((_QWORD *)a3 + 6) = self->_errorCode;
    *((_WORD *)a3 + 60) |= 0x20u;
    return;
  }
LABEL_28:
  *((_QWORD *)a3 + 12) = self->_responseStartToResponseEndMillis;
  *((_WORD *)a3 + 60) |= 0x800u;
  if ((*(_WORD *)&self->_has & 0x20) != 0)
    goto LABEL_29;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 0x2000) != 0)
  {
    *((_QWORD *)result + 14) = self->_timestamp;
...
LABEL_3:
  ...
  *((_QWORD *)result + 8) = self->_navigationStartToRedirectStartMillis;
...
LABEL_19:
  *((_QWORD *)result + 10) = self->_redirectStartToRedirectEndMillis;
...
LABEL_20:
  *((_QWORD *)result + 9) = self->_redirectEndToFetchStartMillis;
...
LABEL_21:
  *((_QWORD *)result + 7) = self->_fetchStartToDomainLookupStartMillis;
...
LABEL_26:
  *((_QWORD *)result + 13) = self->_secureConnectionStartToConnectEndMillis;
...
LABEL_28:
  *((_QWORD *)result + 11) = self->_requestStartToResponseStartMillis;
...
LABEL_29:
  *((_QWORD *)result + 12) = self->_responseStartToResponseEndMillis;
  *((_WORD *)result + 60) |= 0x800u;
  if ((*(_WORD *)&self->_has & 0x20) == 0)
    return result;
LABEL_15:
  *((_QWORD *)result + 6) = self->_errorCode;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((has & 0x2000) != 0)
    {
      if ((*((_WORD *)a3 + 60) & 0x2000) == 0 || self->_timestamp != *((_QWORD *)a3 + 14))
        goto LABEL_71;
    }
...
LABEL_71:
    ...
    if ((has & 0x80) != 0)
    {
      if ((v7 & 0x80) == 0 || self->_navigationStartToRedirectStartMillis != *((_QWORD *)a3 + 8))
        goto LABEL_71;
    }
    else if ((v7 & 0x80) != 0)
    {
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x200) == 0 || self->_redirectStartToRedirectEndMillis != *((_QWORD *)a3 + 10))
        goto LABEL_71;
    }
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x100) == 0 || self->_redirectEndToFetchStartMillis != *((_QWORD *)a3 + 9))
        goto LABEL_71;
    }
    ...
    if ((has & 0x40) != 0)
    {
      if ((v7 & 0x40) == 0 || self->_fetchStartToDomainLookupStartMillis != *((_QWORD *)a3 + 7))
        goto LABEL_71;
    }
    else if ((v7 & 0x40) != 0)
    {
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x1000) == 0 || self->_secureConnectionStartToConnectEndMillis != *((_QWORD *)a3 + 13))
        goto LABEL_71;
    }
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x400) == 0 || self->_requestStartToResponseStartMillis != *((_QWORD *)a3 + 11))
        goto LABEL_71;
    }
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x800) == 0 || self->_responseStartToResponseEndMillis != *((_QWORD *)a3 + 12))
        goto LABEL_71;
    }
    ...
    if ((has & 0x20) != 0)
    {
      if ((v7 & 0x20) == 0 || self->_errorCode != *((_QWORD *)a3 + 6))
        goto LABEL_71;
      LOBYTE(v5) = 1;
    }
  }
...
LABEL_3:
  ...
  self->_navigationStartToRedirectStartMillis = *((_QWORD *)a3 + 8);
  *(_WORD *)&self->_has |= 0x80u;
  v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x200) == 0)
  {
...
LABEL_18:
  self->_redirectStartToRedirectEndMillis = *((_QWORD *)a3 + 10);
  *(_WORD *)&self->_has |= 0x200u;
  v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x100) == 0)
  {
...
LABEL_19:
  self->_redirectEndToFetchStartMillis = *((_QWORD *)a3 + 9);
  *(_WORD *)&self->_has |= 0x100u;
  v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x40) == 0)
  {
...
LABEL_20:
  self->_fetchStartToDomainLookupStartMillis = *((_QWORD *)a3 + 7);
  *(_WORD *)&self->_has |= 0x40u;
  v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x10) == 0)
  {
...
LABEL_25:
  self->_secureConnectionStartToConnectEndMillis = *((_QWORD *)a3 + 13);
  *(_WORD *)&self->_has |= 0x1000u;
  v3 = *((_WORD *)a3 + 60);
  if ((v3 & 1) == 0)
  {
...
LABEL_27:
  self->_requestStartToResponseStartMillis = *((_QWORD *)a3 + 11);
  *(_WORD *)&self->_has |= 0x400u;
  v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x800) == 0)
  {
LABEL_14:
    if ((v3 & 0x20) == 0)
      return;
LABEL_29:
    self->_errorCode = *((_QWORD *)a3 + 6);
    *(_WORD *)&self->_has |= 0x20u;
    return;
  }
LABEL_28:
  self->_responseStartToResponseEndMillis = *((_QWORD *)a3 + 12);
  *(_WORD *)&self->_has |= 0x800u;
