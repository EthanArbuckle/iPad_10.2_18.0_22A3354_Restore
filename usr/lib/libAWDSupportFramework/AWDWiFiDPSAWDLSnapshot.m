...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiDPSAWDLSnapshot description](&v3, sel_description), -[AWDWiFiDPSAWDLSnapshot dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_ts), CFSTR("ts"));
    has = (char)self->_has;
    if ((has & 2) == 0)
    {
LABEL_3:
      if ((has & 8) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_use), CFSTR("use"));
...
LABEL_4:
  if ((has & 4) != 0)
LABEL_5:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_sdb), CFSTR("sdb"));
  return v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 1) == 0 || self->_ts != *((_QWORD *)a3 + 1))
        goto LABEL_21;
    }
...
LABEL_21:
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 2) == 0 || self->_duration != *((_DWORD *)a3 + 4))
        goto LABEL_21;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 8) == 0 || self->_use != *((_DWORD *)a3 + 6))
        goto LABEL_21;
    }
    ...
    if ((*(_BYTE *)&self->_has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 28) & 4) == 0 || self->_sdb != *((_DWORD *)a3 + 5))
        goto LABEL_21;
      LOBYTE(v5) = 1;
    }
  }
