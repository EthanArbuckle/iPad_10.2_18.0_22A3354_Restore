...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSRegistrationControlChosen description](&v3, sel_description), -[AWDIDSRegistrationControlChosen dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_3:
      if ((has & 2) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_registrationControlStatus), CFSTR("registrationControlStatus"));
...
LABEL_4:
  if ((has & 8) != 0)
LABEL_5:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_isInterestingRegion), CFSTR("isInterestingRegion"));
  return v3;
}
...
LABEL_4:
    if ((has & 8) == 0)
      return;
LABEL_9:
    *((_BYTE *)a3 + 24) = self->_isInterestingRegion;
    *((_BYTE *)a3 + 28) |= 8u;
    return;
  }
LABEL_8:
...
LABEL_9:
  ...
  *((_BYTE *)result + 28) |= 2u;
  if ((*(_BYTE *)&self->_has & 8) == 0)
    return result;
LABEL_5:
  *((_BYTE *)result + 24) = self->_isInterestingRegion;
  *((_BYTE *)result + 28) |= 8u;
  return result;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 4) == 0 || self->_registrationType != *((_DWORD *)a3 + 5))
        goto LABEL_19;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 2) == 0 || self->_registrationControlStatus != *((_DWORD *)a3 + 4))
        goto LABEL_19;
    }
...
LABEL_4:
    if ((v3 & 8) == 0)
      return;
LABEL_9:
    self->_isInterestingRegion = *((_BYTE *)a3 + 24);
    *(_BYTE *)&self->_has |= 8u;
    return;
  }
LABEL_8:
