...
- (void)dealloc
{
  ...
  -[AWDNanoPhoneIncomingCallConnected setCallProviderIdentifier:](self, "setCallProviderIdentifier:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDNanoPhoneIncomingCallConnected;
  -[AWDNanoPhoneIncomingCallConnected dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDNanoPhoneIncomingCallConnected;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDNanoPhoneIncomingCallConnected description](&v3, sel_description), -[AWDNanoPhoneIncomingCallConnected dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_connectingMs), CFSTR("connectingMs"));
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 1) != 0)
  {
    *((_QWORD *)a3 + 1) = self->_connectingMs;
    *((_BYTE *)a3 + 36) |= 1u;
  }
  if (self->_callProviderIdentifier)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 1) != 0)
  {
    *(_QWORD *)(v5 + 8) = self->_connectingMs;
    *(_BYTE *)(v5 + 36) |= 1u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)a3 + 36) & 1) == 0 || self->_connectingMs != *((_QWORD *)a3 + 1))
      goto LABEL_25;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 1) != 0)
  {
    self->_connectingMs = *((_QWORD *)a3 + 1);
    *(_BYTE *)&self->_has |= 1u;
  }
  if (*((_QWORD *)a3 + 3))
