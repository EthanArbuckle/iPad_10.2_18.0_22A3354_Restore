...
- (void)dealloc
{
  ...
  -[AWDIDSOTRSessionNegotiation setService:](self, "setService:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSOTRSessionNegotiation;
  -[AWDIDSOTRSessionNegotiation dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSOTRSessionNegotiation;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSOTRSessionNegotiation description](&v3, sel_description), -[AWDIDSOTRSessionNegotiation dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_24:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 48) & 2) == 0 || self->_priority != *((_QWORD *)a3 + 2))
        goto LABEL_24;
    }
    ...
    if ((has & 8) != 0)
    {
      if ((*((_BYTE *)a3 + 48) & 8) == 0 || self->_result != *((_DWORD *)a3 + 8))
        goto LABEL_24;
      LOBYTE(v5) = 1;
    }
  }
