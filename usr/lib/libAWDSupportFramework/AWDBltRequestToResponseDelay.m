...
- (void)dealloc
{
  ...
  -[AWDBltRequestToResponseDelay setUniqueid:](self, "setUniqueid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDBltRequestToResponseDelay;
  -[AWDBltRequestToResponseDelay dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltRequestToResponseDelay;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDBltRequestToResponseDelay description](&v3, sel_description), -[AWDBltRequestToResponseDelay dictionaryRepresentation](self, "dictionaryRepresentation"));
}
