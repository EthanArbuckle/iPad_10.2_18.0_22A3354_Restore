...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDSafariContactAutoFillDidFillCustomContactSetEvent description](&v3, sel_description), -[AWDSafariContactAutoFillDidFillCustomContactSetEvent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
