...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallRelayUpdateReceived setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayUpdateReceived;
  -[AWDFaceTimeCallRelayUpdateReceived dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayUpdateReceived;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallRelayUpdateReceived description](&v3, sel_description), -[AWDFaceTimeCallRelayUpdateReceived dictionaryRepresentation](self, "dictionaryRepresentation"));
}
