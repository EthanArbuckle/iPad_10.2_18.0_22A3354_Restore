...
- (void)dealloc
{
  ...
  -[AWDIMessageDeliveredMessage setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIMessageDeliveredMessage;
  -[AWDIMessageDeliveredMessage dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIMessageDeliveredMessage;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIMessageDeliveredMessage description](&v3, sel_description), -[AWDIMessageDeliveredMessage dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
    objc_msgSend(v4, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_deliveryDuration), CFSTR("deliveryDuration"));
  return v4;
}
...
LABEL_13:
      ...
      {
        if ((*((_BYTE *)a3 + 32) & 2) == 0 || self->_deliveryDuration != *((_DWORD *)a3 + 4))
          goto LABEL_13;
        LOBYTE(v5) = 1;
      }
    }
