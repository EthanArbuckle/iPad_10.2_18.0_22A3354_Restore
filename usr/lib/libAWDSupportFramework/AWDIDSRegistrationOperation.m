...
- (void)dealloc
{
  ...
  -[AWDIDSRegistrationOperation setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRegistrationOperation;
  -[AWDIDSRegistrationOperation dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRegistrationOperation;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSRegistrationOperation description](&v3, sel_description), -[AWDIDSRegistrationOperation dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_12:
    if ((has & 0x10) == 0)
      goto LABEL_13;
LABEL_23:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_heartbeatRegister), CFSTR("heartbeatRegister"));
...
LABEL_13:
  if ((has & 8) != 0)
LABEL_14:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_heartbeatDelay), CFSTR("heartbeatDelay"));
  return v3;
}
