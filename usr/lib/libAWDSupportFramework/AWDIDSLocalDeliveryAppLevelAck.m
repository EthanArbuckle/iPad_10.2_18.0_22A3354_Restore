...
- (void)dealloc
{
  ...
  -[AWDIDSLocalDeliveryAppLevelAck setService:](self, "setService:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryAppLevelAck;
  -[AWDIDSLocalDeliveryAppLevelAck dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryAppLevelAck;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSLocalDeliveryAppLevelAck description](&v3, sel_description), -[AWDIDSLocalDeliveryAppLevelAck dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_24:
    ...
    if ((has & 1) != 0)
    {
      if ((*((_BYTE *)a3 + 48) & 1) == 0 || self->_isToDefaultPairedDevice != *((_QWORD *)a3 + 1))
        goto LABEL_24;
    }
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 48) & 2) == 0 || self->_linkType != *((_QWORD *)a3 + 2))
        goto LABEL_24;
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 48) & 4) == 0 || self->_priority != *((_QWORD *)a3 + 3))
        goto LABEL_24;
      LOBYTE(v5) = 1;
    }
  }
