...
- (void)dealloc
{
  ...
  -[AWDBltDelayAppReadyToSend setUniqueid:](self, "setUniqueid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayAppReadyToSend;
  -[AWDBltDelayAppReadyToSend dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayAppReadyToSend;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDBltDelayAppReadyToSend description](&v3, sel_description), -[AWDBltDelayAppReadyToSend dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_14:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 2) == 0 || self->_delayMs != *((_DWORD *)a3 + 4))
        goto LABEL_14;
      LOBYTE(v5) = 1;
    }
  }
