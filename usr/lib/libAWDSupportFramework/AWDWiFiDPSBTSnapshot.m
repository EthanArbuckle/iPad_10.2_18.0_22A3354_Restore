...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiDPSBTSnapshot description](&v3, sel_description), -[AWDWiFiDPSBTSnapshot dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      if ((*((_BYTE *)a3 + 24) & 1) == 0 || self->_ts != *((_QWORD *)a3 + 1))
        goto LABEL_16;
    }
...
LABEL_16:
    ...
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 24) & 2) == 0 || self->_duration != *((_DWORD *)a3 + 4))
        goto LABEL_16;
    }
    ...
    if ((*(_BYTE *)&self->_has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 24) & 4) == 0 || self->_use != *((_DWORD *)a3 + 5))
        goto LABEL_16;
      LOBYTE(v5) = 1;
    }
  }
