...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineStateModelConfidence description](&v3, sel_description), -[AWDCoreRoutineStateModelConfidence dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_3:
      if ((has & 8) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_nearbyLocations), CFSTR("nearbyLocations"));
  ...
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_impossibleTransitions), CFSTR("impossibleTransitions"));
  has = (char)self->_has;
  if ((has & 8) != 0)
    goto LABEL_9;
LABEL_4:
  if ((has & 2) != 0)
LABEL_5:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_confidence), CFSTR("confidence"));
  return v3;
}
...
LABEL_21:
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 4) == 0 || self->_impossibleTransitions != *((_DWORD *)a3 + 5))
        goto LABEL_21;
    }
    ...
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 28) & 2) == 0 || self->_confidence != *((_DWORD *)a3 + 4))
        goto LABEL_21;
    }
    ...
    if ((*(_BYTE *)&self->_has & 8) != 0)
    {
      if ((*((_BYTE *)a3 + 28) & 8) == 0 || self->_nearbyLocations != *((_DWORD *)a3 + 6))
        goto LABEL_21;
      LOBYTE(v5) = 1;
    }
  }
