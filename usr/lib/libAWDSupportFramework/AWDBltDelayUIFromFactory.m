...
- (void)dealloc
{
  ...
  -[AWDBltDelayUIFromFactory setUniqueid:](self, "setUniqueid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayUIFromFactory;
  -[AWDBltDelayUIFromFactory dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayUIFromFactory;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDBltDelayUIFromFactory description](&v3, sel_description), -[AWDBltDelayUIFromFactory dictionaryRepresentation](self, "dictionaryRepresentation"));
}
