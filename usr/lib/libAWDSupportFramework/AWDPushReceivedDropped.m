...
- (void)dealloc
{
  ...
  -[AWDPushReceivedDropped setGuid:](self, "setGuid:", 0);
  -[AWDPushReceivedDropped setTopic:](self, "setTopic:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDPushReceivedDropped;
  -[AWDPushReceivedDropped dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDPushReceivedDropped;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDPushReceivedDropped description](&v3, sel_description), -[AWDPushReceivedDropped dictionaryRepresentation](self, "dictionaryRepresentation"));
}
