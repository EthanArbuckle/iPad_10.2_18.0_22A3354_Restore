...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiNWActivityPowerStats description](&v3, sel_description), -[AWDWiFiNWActivityPowerStats dictionaryRepresentation](self, "dictionaryRepresentation"));
}
