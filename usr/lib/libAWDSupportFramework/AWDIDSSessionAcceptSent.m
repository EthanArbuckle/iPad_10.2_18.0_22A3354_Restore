...
- (void)dealloc
{
  ...
  -[AWDIDSSessionAcceptSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionAcceptSent;
  -[AWDIDSSessionAcceptSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionAcceptSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSSessionAcceptSent description](&v3, sel_description), -[AWDIDSSessionAcceptSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
