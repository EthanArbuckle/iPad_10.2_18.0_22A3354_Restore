...
- (void)dealloc
{
  ...
  -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta setServiceName:](self, "setServiceName:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta;
  -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta description](&v3, sel_description), -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta dictionaryRepresentation](self, "dictionaryRepresentation"));
}
