...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDSafariSetAutoFillQuickTypeSuggestionEvent description](&v3, sel_description), -[AWDSafariSetAutoFillQuickTypeSuggestionEvent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
