...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWifiAwdlHistogramBin description](&v3, sel_description), -[AWDWifiAwdlHistogramBin dictionaryRepresentation](self, "dictionaryRepresentation"));
}
