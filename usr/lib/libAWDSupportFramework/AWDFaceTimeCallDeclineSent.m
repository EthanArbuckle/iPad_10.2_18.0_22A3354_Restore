...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallDeclineSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallDeclineSent;
  -[AWDFaceTimeCallDeclineSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallDeclineSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallDeclineSent description](&v3, sel_description), -[AWDFaceTimeCallDeclineSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_13:
  objc_msgSend(v4, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_declineCode), CFSTR("declineCode"));
  has = (char)self->_has;
  if ((has & 0x20) == 0)
  {
LABEL_7:
...
LABEL_33:
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 2) == 0 || self->_declineCode != *((_DWORD *)a3 + 4))
          goto LABEL_33;
      }
...
LABEL_3:
  ...
  {
LABEL_4:
    v6 = 2654435761 * self->_declineCode;
    if ((*(_BYTE *)&self->_has & 0x20) != 0)
      goto LABEL_5;
    goto LABEL_11;
  }
