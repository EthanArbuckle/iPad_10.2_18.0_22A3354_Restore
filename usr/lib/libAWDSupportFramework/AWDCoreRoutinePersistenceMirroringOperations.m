...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutinePersistenceMirroringOperations description](&v3, sel_description), -[AWDCoreRoutinePersistenceMirroringOperations dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_13:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_recordsChanged), CFSTR("recordsChanged"));
  has = (char)self->_has;
  if ((has & 8) == 0)
  {
LABEL_6:
    if ((has & 1) == 0)
      goto LABEL_7;
LABEL_15:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithLongLong:", self->_timeIntervalSinceLastOperation), CFSTR("timeIntervalSinceLastOperation"));
    if ((*(_BYTE *)&self->_has & 0x20) == 0)
      return v3;
    goto LABEL_8;
  }
LABEL_14:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_errorCount), CFSTR("errorCount"));
  has = (char)self->_has;
  if ((has & 1) != 0)
    goto LABEL_15;
LABEL_7:
  if ((has & 0x20) != 0)
LABEL_8:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_qualityOfService), CFSTR("qualityOfService"));
  return v3;
}
...
LABEL_14:
  *((_QWORD *)a3 + 1) = self->_timeIntervalSinceLastOperation;
  *((_BYTE *)a3 + 44) |= 1u;
  if ((*(_BYTE *)&self->_has & 0x20) != 0)
    goto LABEL_15;
}
...
LABEL_15:
  *((_QWORD *)result + 1) = self->_timeIntervalSinceLastOperation;
  *((_BYTE *)result + 44) |= 1u;
  if ((*(_BYTE *)&self->_has & 0x20) == 0)
    return result;
LABEL_8:
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      if ((*((_BYTE *)a3 + 44) & 2) == 0 || self->_timestamp != *((_QWORD *)a3 + 2))
        goto LABEL_36;
    }
...
LABEL_36:
    ...
    {
      if ((*((_BYTE *)a3 + 44) & 4) == 0 || self->_deviceClass != *((_DWORD *)a3 + 6))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 44) & 0x10) == 0 || self->_operationType != *((_DWORD *)a3 + 8))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 44) & 0x40) == 0 || self->_recordsChanged != *((_DWORD *)a3 + 10))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 44) & 8) == 0 || self->_errorCount != *((_DWORD *)a3 + 7))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 44) & 1) == 0 || self->_timeIntervalSinceLastOperation != *((_QWORD *)a3 + 1))
        goto LABEL_36;
    }
    ...
    if ((*(_BYTE *)&self->_has & 0x20) != 0)
    {
      if ((*((_BYTE *)a3 + 44) & 0x20) == 0 || self->_qualityOfService != *((_DWORD *)a3 + 9))
        goto LABEL_36;
      LOBYTE(v5) = 1;
    }
  }
...
LABEL_14:
  self->_timeIntervalSinceLastOperation = *((_QWORD *)a3 + 1);
  *(_BYTE *)&self->_has |= 1u;
