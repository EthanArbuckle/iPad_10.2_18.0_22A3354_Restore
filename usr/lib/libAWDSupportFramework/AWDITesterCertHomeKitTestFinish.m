...
- (void)dealloc
{
  ...
  -[AWDITesterCertHomeKitTestFinish setAccessoryManufacturer:](self, "setAccessoryManufacturer:", 0);
  -[AWDITesterCertHomeKitTestFinish setAccessoryName:](self, "setAccessoryName:", 0);
  -[AWDITesterCertHomeKitTestFinish setTestUUID:](self, "setTestUUID:", 0);
  -[AWDITesterCertHomeKitTestFinish setTestName:](self, "setTestName:", 0);
  -[AWDITesterCertHomeKitTestFinish setTestStatus:](self, "setTestStatus:", 0);
  -[AWDITesterCertHomeKitTestFinish setTestResult:](self, "setTestResult:", 0);
  -[AWDITesterCertHomeKitTestFinish setTestErrorDescription:](self, "setTestErrorDescription:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestFinish;
  -[AWDITesterCertHomeKitTestFinish dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestFinish;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDITesterCertHomeKitTestFinish description](&v3, sel_description), -[AWDITesterCertHomeKitTestFinish dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v6 + 72) = -[NSString copyWithZone:](self->_testUUID, "copyWithZone:", a3);
  *(_QWORD *)(v6 + 48) = -[NSString copyWithZone:](self->_testName, "copyWithZone:", a3);

  *(_QWORD *)(v6 + 64) = -[NSString copyWithZone:](self->_testStatus, "copyWithZone:", a3);
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
  ...
  *(_QWORD *)(v6 + 56) = -[NSString copyWithZone:](self->_testResult, "copyWithZone:", a3);
  *(_QWORD *)(v6 + 32) = -[NSString copyWithZone:](self->_testErrorDescription, "copyWithZone:", a3);
  return (id)v6;
}
...
LABEL_26:
      ...
      || (v5 = -[NSString isEqual:](accessoryManufacturer, "isEqual:")) != 0)
    {
      ...
      {
        testUUID = self->_testUUID;
        if (!((unint64_t)testUUID | *((_QWORD *)a3 + 9))
          || (v5 = -[NSString isEqual:](testUUID, "isEqual:")) != 0)
        {
          testName = self->_testName;
          if (!((unint64_t)testName | *((_QWORD *)a3 + 6))
            || (v5 = -[NSString isEqual:](testName, "isEqual:")) != 0)
          {
            testStatus = self->_testStatus;
            if (!((unint64_t)testStatus | *((_QWORD *)a3 + 8))
              || (v5 = -[NSString isEqual:](testStatus, "isEqual:")) != 0)
            {
              if ((*(_BYTE *)&self->_has & 2) != 0)
              {
                if ((*((_BYTE *)a3 + 80) & 2) == 0 || self->_testIterations != *((_DWORD *)a3 + 10))
                  goto LABEL_26;
              }
              ...
              testResult = self->_testResult;
              if (!((unint64_t)testResult | *((_QWORD *)a3 + 7))
                || (v5 = -[NSString isEqual:](testResult, "isEqual:")) != 0)
              {
                testErrorDescription = self->_testErrorDescription;
                if ((unint64_t)testErrorDescription | *((_QWORD *)a3 + 4))
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v3 = 0;
  v4 = -[NSString hash](self->_accessoryManufacturer, "hash");
  v5 = -[NSString hash](self->_accessoryName, "hash");
  v6 = -[NSString hash](self->_testUUID, "hash");
  v7 = -[NSString hash](self->_testName, "hash");
  v8 = -[NSString hash](self->_testStatus, "hash");
  if ((*(_BYTE *)&self->_has & 2) != 0)
    v9 = 2654435761 * self->_testIterations;
  else
    v9 = 0;
  v10 = v4 ^ v3 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9;
  v11 = -[NSString hash](self->_testResult, "hash");
  return v10 ^ v11 ^ -[NSString hash](self->_testErrorDescription, "hash");
}
