...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallAcceptSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallAcceptSent;
  -[AWDFaceTimeCallAcceptSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallAcceptSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallAcceptSent description](&v3, sel_description), -[AWDFaceTimeCallAcceptSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
