...
- (void)dealloc
{
  ...
  -[AWDWiFiTDM setSliceStats:](self, "setSliceStats:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiTDM;
  -[AWDWiFiTDM dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiTDM;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiTDM description](&v3, sel_description), -[AWDWiFiTDM dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (void)writeTo:(id)a3
{
  ...
  v11 = 0u;
  sliceStats = self->_sliceStats;
  v4 = -[NSMutableArray countByEnumeratingWithState:objects:count:](sliceStats, "countByEnumeratingWithState:objects:count:", &v8, v12, 16);
  if (v4)
  {
    v5 = v4;
    v6 = *(_QWORD *)v9;
    do
    {
      ...
      v5 = -[NSMutableArray countByEnumeratingWithState:objects:count:](sliceStats, "countByEnumeratingWithState:objects:count:", &v8, v12, 16);
    }
    while (v5);
  }
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[AWDWiFiTDM sliceStatsCount](self, "sliceStatsCount"))
  {
    objc_msgSend(a3, "clearSliceStats");
    v5 = -[AWDWiFiTDM sliceStatsCount](self, "sliceStatsCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
        objc_msgSend(a3, "addSliceStats:", -[AWDWiFiTDM sliceStatsAtIndex:](self, "sliceStatsAtIndex:", i));
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = 0u;
  sliceStats = self->_sliceStats;
  v7 = -[NSMutableArray countByEnumeratingWithState:objects:count:](sliceStats, "countByEnumeratingWithState:objects:count:", &v13, v17, 16);
  if (v7)
  {
    v8 = v7;
    v9 = *(_QWORD *)v14;
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v5, "addSliceStats:", v11);

        ++v10;
      }
      while (v8 != v10);
      v8 = -[NSMutableArray countByEnumeratingWithState:objects:count:](sliceStats, "countByEnumeratingWithState:objects:count:", &v13, v17, 16);
    }
    while (v8);
  }
  return v5;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    sliceStats = self->_sliceStats;
    if ((unint64_t)sliceStats | *((_QWORD *)a3 + 1))
...
- (unint64_t)hash
{
  return -[NSMutableArray hash](self->_sliceStats, "hash");
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[AWDWiFiTDM addSliceStats:](self, "addSliceStats:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++));
      }
      while (v6 != v8);
