...
- (void)dealloc
{
  ...
  -[AWDITesterCertApplePayTestSubmission setAccessoryName:](self, "setAccessoryName:", 0);
  -[AWDITesterCertApplePayTestSubmission setTestUUID:](self, "setTestUUID:", 0);
  -[AWDITesterCertApplePayTestSubmission setTestName:](self, "setTestName:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertApplePayTestSubmission;
  -[AWDITesterCertApplePayTestSubmission dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertApplePayTestSubmission;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDITesterCertApplePayTestSubmission description](&v3, sel_description), -[AWDITesterCertApplePayTestSubmission dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v6 + 32) = -[NSString copyWithZone:](self->_testUUID, "copyWithZone:", a3);

  *(_QWORD *)(v6 + 24) = -[NSString copyWithZone:](self->_testName, "copyWithZone:", a3);
  return (id)v6;
}
...
LABEL_13:
    ...
    {
      testUUID = self->_testUUID;
      if (!((unint64_t)testUUID | *((_QWORD *)a3 + 4)) || (v5 = -[NSString isEqual:](testUUID, "isEqual:")) != 0)
      {
        testName = self->_testName;
        if ((unint64_t)testName | *((_QWORD *)a3 + 3))
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v3 = 0;
  v4 = -[NSString hash](self->_accessoryName, "hash") ^ v3;
  v5 = -[NSString hash](self->_testUUID, "hash");
  return v4 ^ v5 ^ -[NSString hash](self->_testName, "hash");
}
