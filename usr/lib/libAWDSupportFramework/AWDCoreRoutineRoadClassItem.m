...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineRoadClassItem description](&v3, sel_description), -[AWDCoreRoutineRoadClassItem dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_roadClass), CFSTR("roadClass"));
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 16) & 2) == 0 || self->_roadClass != *((_DWORD *)a3 + 3))
        goto LABEL_11;
    }
...
LABEL_11:
    ...
    if ((*(_BYTE *)&self->_has & 1) != 0)
    {
      if ((*((_BYTE *)a3 + 16) & 1) == 0 || self->_percentage != *((_DWORD *)a3 + 2))
        goto LABEL_11;
      LOBYTE(v5) = 1;
    }
  }
