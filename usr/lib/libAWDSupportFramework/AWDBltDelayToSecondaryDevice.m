...
- (void)dealloc
{
  ...
  -[AWDBltDelayToSecondaryDevice setUniqueid:](self, "setUniqueid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayToSecondaryDevice;
  -[AWDBltDelayToSecondaryDevice dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayToSecondaryDevice;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDBltDelayToSecondaryDevice description](&v3, sel_description), -[AWDBltDelayToSecondaryDevice dictionaryRepresentation](self, "dictionaryRepresentation"));
}
