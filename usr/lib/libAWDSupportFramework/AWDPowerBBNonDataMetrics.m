...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDPowerBBNonDataMetrics description](&v3, sel_description), -[AWDPowerBBNonDataMetrics dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_3:
  ...
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_scanPowerMicroWatt), CFSTR("ScanPowerMicroWatt"));
  has = (char)self->_has;
  if ((has & 8) == 0)
  {
LABEL_4:
...
LABEL_12:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_oOSPowerMicroWatt), CFSTR("OOSPowerMicroWatt"));
  has = (char)self->_has;
  if ((has & 0x10) == 0)
  {
LABEL_5:
...
LABEL_13:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_registrationPowerMicroWatt), CFSTR("RegistrationPowerMicroWatt"));
  has = (char)self->_has;
  if ((has & 4) == 0)
  {
LABEL_6:
    if ((has & 0x40) == 0)
      goto LABEL_7;
LABEL_15:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_voicePowerMicroWatt), CFSTR("VoicePowerMicroWatt"));
    if ((*(_BYTE *)&self->_has & 2) == 0)
      return v3;
    goto LABEL_8;
  }
LABEL_14:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_idlePowerMicroWatt), CFSTR("IdlePowerMicroWatt"));
  has = (char)self->_has;
  if ((has & 0x40) != 0)
    goto LABEL_15;
LABEL_7:
  if ((has & 2) != 0)
LABEL_8:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_aPWakeCacheFlushCnt), CFSTR("APWakeCacheFlushCnt"));
  return v3;
}
...
LABEL_36:
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 0x20) == 0 || self->_scanPowerMicroWatt != *((_DWORD *)a3 + 8))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 8) == 0 || self->_oOSPowerMicroWatt != *((_DWORD *)a3 + 6))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 0x10) == 0 || self->_registrationPowerMicroWatt != *((_DWORD *)a3 + 7))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 4) == 0 || self->_idlePowerMicroWatt != *((_DWORD *)a3 + 5))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 0x40) == 0 || self->_voicePowerMicroWatt != *((_DWORD *)a3 + 9))
        goto LABEL_36;
    }
    ...
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 40) & 2) == 0 || self->_aPWakeCacheFlushCnt != *((_DWORD *)a3 + 4))
        goto LABEL_36;
      LOBYTE(v5) = 1;
    }
  }
