...
- (void)dealloc
{
  ...
  -[AWDIMessageAttachmentDownload setGuid:](self, "setGuid:", 0);
  -[AWDIMessageAttachmentDownload setFirstLevelMMCSErrorDomain:](self, "setFirstLevelMMCSErrorDomain:", 0);
  -[AWDIMessageAttachmentDownload setSecondLevelMMCSErrorDomain:](self, "setSecondLevelMMCSErrorDomain:", 0);
  -[AWDIMessageAttachmentDownload setThirdLevelMMCSErrorDomain:](self, "setThirdLevelMMCSErrorDomain:", 0);
  -[AWDIMessageAttachmentDownload setFourthLevelMMCSErrorDomain:](self, "setFourthLevelMMCSErrorDomain:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIMessageAttachmentDownload;
  -[AWDIMessageAttachmentDownload dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIMessageAttachmentDownload;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIMessageAttachmentDownload description](&v3, sel_description), -[AWDIMessageAttachmentDownload dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_34:
  objc_msgSend(v4, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_downloadDuration), CFSTR("downloadDuration"));
  has = (__int16)self->_has;
  if ((has & 0x100) == 0)
  {
LABEL_10:
...
- (unint64_t)hash
{
  ...
  v22 = -[NSString hash](self->_guid, "hash");
  has = (__int16)self->_has;
  if ((has & 1) != 0)
  {
...
LABEL_22:
  ...
  if ((*(_WORD *)&self->_has & 0x20) != 0)
    ...
    v12 = 0;
  return v21 ^ v22 ^ v20 ^ v19 ^ v18 ^ v17 ^ v16 ^ v15 ^ v4 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10 ^ v11 ^ v12 ^ -[NSString hash](self->_fourthLevelMMCSErrorDomain, "hash");
}
