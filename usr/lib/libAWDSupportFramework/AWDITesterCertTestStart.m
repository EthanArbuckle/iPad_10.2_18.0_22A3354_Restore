...
- (void)dealloc
{
  ...
  -[AWDITesterCertTestStart setTestName:](self, "setTestName:", 0);
  -[AWDITesterCertTestStart setAccessoryName:](self, "setAccessoryName:", 0);
  -[AWDITesterCertTestStart setAccessoryType:](self, "setAccessoryType:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertTestStart;
  -[AWDITesterCertTestStart dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertTestStart;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDITesterCertTestStart description](&v3, sel_description), -[AWDITesterCertTestStart dictionaryRepresentation](self, "dictionaryRepresentation"));
}
