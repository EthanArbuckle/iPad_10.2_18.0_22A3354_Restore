...
- (void)dealloc
{
  ...
  -[AWDCoreRoutineFMCReturnToCarInstance setParkingId:](self, "setParkingId:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineFMCReturnToCarInstance;
  -[AWDCoreRoutineFMCReturnToCarInstance dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineFMCReturnToCarInstance;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineFMCReturnToCarInstance description](&v3, sel_description), -[AWDCoreRoutineFMCReturnToCarInstance dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_horizontalDistance), CFSTR("horizontalDistance"));
  return v3;
}
...
LABEL_19:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 2) == 0 || self->_horizontalAccuracy != *((_DWORD *)a3 + 4))
        goto LABEL_19;
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 4) == 0 || self->_horizontalDistance != *((_DWORD *)a3 + 5))
        goto LABEL_19;
      LOBYTE(v5) = 1;
    }
  }
