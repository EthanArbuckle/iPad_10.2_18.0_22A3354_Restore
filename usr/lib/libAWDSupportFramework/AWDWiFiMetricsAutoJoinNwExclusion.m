...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiMetricsAutoJoinNwExclusion description](&v3, sel_description), -[AWDWiFiMetricsAutoJoinNwExclusion dictionaryRepresentation](self, "dictionaryRepresentation"));
}
