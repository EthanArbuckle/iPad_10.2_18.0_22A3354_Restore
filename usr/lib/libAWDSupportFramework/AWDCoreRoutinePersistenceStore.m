...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutinePersistenceStore description](&v3, sel_description), -[AWDCoreRoutinePersistenceStore dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) == 0)
  {
    if ((*(_BYTE *)&self->_has & 4) == 0)
      goto LABEL_3;
LABEL_7:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithBool:", self->_migratorFailed), CFSTR("migratorFailed"));
...
LABEL_3:
  if ((has & 2) != 0)
LABEL_4:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_migratorDestroyedStoreReason), CFSTR("migratorDestroyedStoreReason"));
  return v3;
}
...
LABEL_7:
  ...
  *((_BYTE *)a3 + 20) = self->_migratorFailed;
  *((_BYTE *)a3 + 24) |= 4u;
  if ((*(_BYTE *)&self->_has & 2) != 0)
    goto LABEL_7;
}
...
LABEL_3:
  ...
  *((_BYTE *)result + 20) = self->_migratorFailed;
  *((_BYTE *)result + 24) |= 4u;
  if ((*(_BYTE *)&self->_has & 2) == 0)
    return result;
LABEL_4:
...
LABEL_15:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)a3 + 24) & 2) == 0 || self->_migratorDestroyedStoreReason != *((_DWORD *)a3 + 4))
      goto LABEL_19;
    LOBYTE(v5) = 1;
  }
  return v5;
...
LABEL_7:
  ...
  self->_migratorFailed = *((_BYTE *)a3 + 20);
  *(_BYTE *)&self->_has |= 4u;
  if ((*((_BYTE *)a3 + 24) & 2) != 0)
    goto LABEL_7;
}
