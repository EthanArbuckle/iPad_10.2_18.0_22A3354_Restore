...
- (void)dealloc
{
  ...
  -[AWDIDSRegistrationAuthenticate setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRegistrationAuthenticate;
  -[AWDIDSRegistrationAuthenticate dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRegistrationAuthenticate;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSRegistrationAuthenticate description](&v3, sel_description), -[AWDIDSRegistrationAuthenticate dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_12:
    if ((has & 0x10) == 0)
      goto LABEL_13;
LABEL_23:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_isPhoneUser), CFSTR("isPhoneUser"));
...
LABEL_13:
  if ((has & 8) != 0)
LABEL_14:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_isDSUser), CFSTR("isDSUser"));
  return v3;
}
