...
- (void)dealloc
{
  ...
  -[AWDIDSRegistrationPhoneNumberValidationFinished setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRegistrationPhoneNumberValidationFinished;
  -[AWDIDSRegistrationPhoneNumberValidationFinished dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRegistrationPhoneNumberValidationFinished;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSRegistrationPhoneNumberValidationFinished description](&v3, sel_description), -[AWDIDSRegistrationPhoneNumberValidationFinished dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) == 0)
  {
    if ((*(_BYTE *)&self->_has & 8) == 0)
      goto LABEL_7;
LABEL_11:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_validationDuration), CFSTR("validationDuration"));
...
LABEL_7:
  if ((has & 2) != 0)
LABEL_8:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_numberOfSMSSent), CFSTR("numberOfSMSSent"));
  return v3;
}
...
LABEL_24:
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 36) & 4) == 0 || self->_registrationError != *((_DWORD *)a3 + 7))
        goto LABEL_24;
    }
    ...
    if ((has & 8) != 0)
    {
      if ((*((_BYTE *)a3 + 36) & 8) == 0 || self->_validationDuration != *((_DWORD *)a3 + 8))
        goto LABEL_24;
    }
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 36) & 2) == 0 || self->_numberOfSMSSent != *((_DWORD *)a3 + 6))
        goto LABEL_24;
      LOBYTE(v5) = 1;
    }
  }
