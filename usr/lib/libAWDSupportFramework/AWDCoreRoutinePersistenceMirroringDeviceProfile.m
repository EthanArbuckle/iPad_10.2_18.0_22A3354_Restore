...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutinePersistenceMirroringDeviceProfile description](&v3, sel_description), -[AWDCoreRoutinePersistenceMirroringDeviceProfile dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_12:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_ageOfDevice), CFSTR("ageOfDevice"));
  has = (char)self->_has;
  if ((has & 0x40) == 0)
  {
LABEL_5:
...
LABEL_13:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_visitsAssociatedToDevice), CFSTR("visitsAssociatedToDevice"));
  has = (char)self->_has;
  if ((has & 8) == 0)
  {
LABEL_6:
    if ((has & 0x20) == 0)
      goto LABEL_7;
LABEL_15:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_transitionsAssociatedToDevice), CFSTR("transitionsAssociatedToDevice"));
    if ((*(_BYTE *)&self->_has & 0x10) == 0)
      return v3;
    goto LABEL_8;
  }
LABEL_14:
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_placesAssociatedToDevice), CFSTR("placesAssociatedToDevice"));
  has = (char)self->_has;
  if ((has & 0x20) != 0)
    goto LABEL_15;
LABEL_7:
  if ((has & 0x10) != 0)
LABEL_8:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_timeIntervalSinceLastRecordAssociation), CFSTR("timeIntervalSinceLastRecordAssociation"));
  return v3;
}
...
LABEL_36:
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 4) == 0 || self->_deviceClass != *((_DWORD *)a3 + 5))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 2) == 0 || self->_ageOfDevice != *((_DWORD *)a3 + 4))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 0x40) == 0 || self->_visitsAssociatedToDevice != *((_DWORD *)a3 + 9))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 8) == 0 || self->_placesAssociatedToDevice != *((_DWORD *)a3 + 6))
        goto LABEL_36;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 40) & 0x20) == 0 || self->_transitionsAssociatedToDevice != *((_DWORD *)a3 + 8))
        goto LABEL_36;
    }
    ...
    LOBYTE(v5) = (*((_BYTE *)a3 + 40) & 0x10) == 0;
    if ((*(_BYTE *)&self->_has & 0x10) != 0)
    {
      if ((*((_BYTE *)a3 + 40) & 0x10) == 0 || self->_timeIntervalSinceLastRecordAssociation != *((_DWORD *)a3 + 7))
        goto LABEL_36;
      LOBYTE(v5) = 1;
    }
  }
...
LABEL_3:
  ...
  {
LABEL_4:
    v4 = 2654435761 * self->_ageOfDevice;
    if ((*(_BYTE *)&self->_has & 0x40) != 0)
      goto LABEL_5;
    goto LABEL_12;
  }
LABEL_11:
  ...
  {
LABEL_5:
    v5 = 2654435761 * self->_visitsAssociatedToDevice;
    if ((*(_BYTE *)&self->_has & 8) != 0)
      goto LABEL_6;
    goto LABEL_13;
  }
LABEL_12:
  ...
  {
LABEL_6:
    v6 = 2654435761 * self->_placesAssociatedToDevice;
    if ((*(_BYTE *)&self->_has & 0x20) != 0)
      goto LABEL_7;
LABEL_14:
    v7 = 0;
...
LABEL_13:
  ...
  if ((*(_BYTE *)&self->_has & 0x20) == 0)
    goto LABEL_14;
LABEL_7:
  v7 = 2654435761 * self->_transitionsAssociatedToDevice;
  if ((*(_BYTE *)&self->_has & 0x10) == 0)
    goto LABEL_15;
LABEL_8:
  v8 = 2654435761 * self->_timeIntervalSinceLastRecordAssociation;
  return v3 ^ v2 ^ v4 ^ v5 ^ v6 ^ v7 ^ v8;
}
