...
- (id)buttonAsString:(int)a3
{
  if (a3 >= 0xA)
    ...
    return off_24C10E2C0[a3];
}

- (int)StringAsButton:(id)a3
{
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("BACK_BUTTON")) & 1) != 0)
    return 0;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("FORWARD_BUTTON")) & 1) != 0)
    return 1;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("SHARE_BUTTON")) & 1) != 0)
    return 2;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("BOOKMARK_BUTTON")) & 1) != 0)
    return 3;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("TAB_EXPOSE_BUTTON")) & 1) != 0)
    return 4;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("RELOAD_BUTTON")) & 1) != 0)
    return 5;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("STOP_BUTTON")) & 1) != 0)
    return 6;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("ADD_TAB_BUTTON")) & 1) != 0)
    return 7;
  if ((objc_msgSend(a3, "isEqualToString:", CFSTR("DOWNLOADS_BUTTON")) & 1) != 0)
    return 8;
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("FORMAT_MENU_BUTTON")))
    return 9;
  return 0;
}
...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDSafariTappedOnToolbarButtonEvent description](&v3, sel_description), -[AWDSafariTappedOnToolbarButtonEvent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
