...
- (void)dealloc
{
  ...
  -[AWDIDSSessionInvitationSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionInvitationSent;
  -[AWDIDSSessionInvitationSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionInvitationSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSSessionInvitationSent description](&v3, sel_description), -[AWDIDSSessionInvitationSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_14:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 28) & 2) == 0 || self->_numberOfRecipients != *((_DWORD *)a3 + 6))
        goto LABEL_14;
      LOBYTE(v5) = 1;
    }
  }
