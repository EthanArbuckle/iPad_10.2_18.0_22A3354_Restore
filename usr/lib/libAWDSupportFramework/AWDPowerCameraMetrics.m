...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDPowerCameraMetrics description](&v3, sel_description), -[AWDPowerCameraMetrics dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_3:
      if ((has & 2) == 0)
        goto LABEL_4;
LABEL_9:
      objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_cameraBackOnDuration), CFSTR("cameraBackOnDuration"));
  ...
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_cameraFrontOnDuration), CFSTR("cameraFrontOnDuration"));
  has = (char)self->_has;
  if ((has & 2) != 0)
    goto LABEL_9;
LABEL_4:
  if ((has & 8) != 0)
LABEL_5:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_cameraTorchOnDuration), CFSTR("cameraTorchOnDuration"));
  return v3;
}
...
LABEL_21:
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 4) == 0 || self->_cameraFrontOnDuration != *((_DWORD *)a3 + 5))
        goto LABEL_21;
    }
    ...
    {
      if ((*((_BYTE *)a3 + 28) & 2) == 0 || self->_cameraBackOnDuration != *((_DWORD *)a3 + 4))
        goto LABEL_21;
    }
    ...
    if ((*(_BYTE *)&self->_has & 8) != 0)
    {
      if ((*((_BYTE *)a3 + 28) & 8) == 0 || self->_cameraTorchOnDuration != *((_DWORD *)a3 + 6))
        goto LABEL_21;
      LOBYTE(v5) = 1;
    }
  }
