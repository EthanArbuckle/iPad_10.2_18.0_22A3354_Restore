...
- (void)dealloc
{
  ...
  -[AWDWiFiCLTM setSliceStats:](self, "setSliceStats:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiCLTM;
  -[AWDWiFiCLTM dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiCLTM;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiCLTM description](&v3, sel_description), -[AWDWiFiCLTM dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (void)copyTo:(id)a3
{
  ...
  if (-[AWDWiFiCLTM sliceStatsCount](self, "sliceStatsCount"))
  {
    objc_msgSend(a3, "clearSliceStats");
    v5 = -[AWDWiFiCLTM sliceStatsCount](self, "sliceStatsCount");
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
        objc_msgSend(a3, "addSliceStats:", -[AWDWiFiCLTM sliceStatsAtIndex:](self, "sliceStatsAtIndex:", i));
    }
  }
}
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(v6, "addSliceStats:", v12);
...
LABEL_9:
    ...
    sliceStats = self->_sliceStats;
    if ((unint64_t)sliceStats | *((_QWORD *)a3 + 2))
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    ...
    v2 = 0;
  return -[NSMutableArray hash](self->_sliceStats, "hash") ^ v2;
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[AWDWiFiCLTM addSliceStats:](self, "addSliceStats:", *(_QWORD *)(*((_QWORD *)&v9 + 1) + 8 * v8++));
      }
      while (v6 != v8);
