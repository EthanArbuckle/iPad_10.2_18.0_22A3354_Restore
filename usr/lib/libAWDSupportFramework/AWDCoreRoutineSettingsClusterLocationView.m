...
- (void)dealloc
{
  ...
  -[AWDCoreRoutineSettingsClusterLocationView setSessionId:](self, "setSessionId:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineSettingsClusterLocationView;
  -[AWDCoreRoutineSettingsClusterLocationView dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineSettingsClusterLocationView;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineSettingsClusterLocationView description](&v3, sel_description), -[AWDCoreRoutineSettingsClusterLocationView dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_countInCluster), CFSTR("countInCluster"));
    has = (char)self->_has;
  }
  if ((has & 4) != 0)
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_deletionCount), CFSTR("deletionCount"));
  return v3;
}
...
LABEL_19:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 2) == 0 || self->_countInCluster != *((_DWORD *)a3 + 4))
        goto LABEL_19;
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 32) & 4) == 0 || self->_deletionCount != *((_DWORD *)a3 + 5))
        goto LABEL_19;
      LOBYTE(v5) = 1;
    }
  }
