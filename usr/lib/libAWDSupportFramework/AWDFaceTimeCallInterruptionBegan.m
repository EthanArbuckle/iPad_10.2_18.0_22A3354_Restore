...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallInterruptionBegan setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInterruptionBegan;
  -[AWDFaceTimeCallInterruptionBegan dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInterruptionBegan;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallInterruptionBegan description](&v3, sel_description), -[AWDFaceTimeCallInterruptionBegan dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_33:
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 8) == 0 || self->_isVideoInterrupted != *((_DWORD *)a3 + 8))
          goto LABEL_33;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 2) == 0 || self->_isAudioInterrupted != *((_DWORD *)a3 + 6))
          goto LABEL_33;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 0x10) == 0 || self->_linkQuality != *((_DWORD *)a3 + 9))
          goto LABEL_33;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 4) == 0 || self->_isVideo != *((_DWORD *)a3 + 7))
          goto LABEL_33;
      }
