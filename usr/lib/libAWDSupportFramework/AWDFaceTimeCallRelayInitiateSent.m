...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallRelayInitiateSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateSent;
  -[AWDFaceTimeCallRelayInitiateSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallRelayInitiateSent description](&v3, sel_description), -[AWDFaceTimeCallRelayInitiateSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_28:
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 2) == 0 || self->_errorCode != *((_DWORD *)a3 + 4))
          goto LABEL_28;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 0x10) == 0 || self->_sendDuration != *((_DWORD *)a3 + 10))
          goto LABEL_28;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 4) == 0 || self->_isVideo != *((_DWORD *)a3 + 8))
          goto LABEL_28;
      }
      ...
      if ((*(_BYTE *)&self->_has & 8) != 0)
      {
        if ((*((_BYTE *)a3 + 44) & 8) == 0 || self->_onLockScreen != *((_DWORD *)a3 + 9))
          goto LABEL_28;
        LOBYTE(v5) = 1;
      }
    }
