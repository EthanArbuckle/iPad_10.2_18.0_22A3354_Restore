...
- (void)dealloc
{
  ...
  -[AWDIDSLocalDeliveryMessageSent setService:](self, "setService:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageSent;
  -[AWDIDSLocalDeliveryMessageSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSLocalDeliveryMessageSent description](&v3, sel_description), -[AWDIDSLocalDeliveryMessageSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
