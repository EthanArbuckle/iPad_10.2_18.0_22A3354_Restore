...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallInvitationReceived setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationReceived;
  -[AWDFaceTimeCallInvitationReceived dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationReceived;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallInvitationReceived description](&v3, sel_description), -[AWDFaceTimeCallInvitationReceived dictionaryRepresentation](self, "dictionaryRepresentation"));
}
