...
- (void)dealloc
{
  ...
  -[AWDITesterCertHomeKitTestSubmission setAccessoryManufacturer:](self, "setAccessoryManufacturer:", 0);
  -[AWDITesterCertHomeKitTestSubmission setAccessoryName:](self, "setAccessoryName:", 0);
  -[AWDITesterCertHomeKitTestSubmission setTestUUID:](self, "setTestUUID:", 0);
  -[AWDITesterCertHomeKitTestSubmission setTestName:](self, "setTestName:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestSubmission;
  -[AWDITesterCertHomeKitTestSubmission dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestSubmission;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDITesterCertHomeKitTestSubmission description](&v3, sel_description), -[AWDITesterCertHomeKitTestSubmission dictionaryRepresentation](self, "dictionaryRepresentation"));
}
