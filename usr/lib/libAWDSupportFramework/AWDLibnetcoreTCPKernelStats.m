...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDLibnetcoreTCPKernelStats description](&v3, sel_description), -[AWDLibnetcoreTCPKernelStats dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 0x400) != 0)
  {
    *((_QWORD *)result + 11) = self->_timestamp;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((has & 0x400) != 0)
    {
      if ((*((_WORD *)a3 + 48) & 0x400) == 0 || self->_timestamp != *((_QWORD *)a3 + 11))
        goto LABEL_56;
    }
...
LABEL_56:
    ...
    {
      if ((*((_WORD *)a3 + 48) & 0x200) == 0 || self->_numTfoSynDataSent != *((_QWORD *)a3 + 10))
        goto LABEL_56;
    }
    ...
    {
      if ((*((_WORD *)a3 + 48) & 0x100) == 0 || self->_numTfoSynDataRcv != *((_QWORD *)a3 + 9))
        goto LABEL_56;
    }
