...
- (void)dealloc
{
  ...
  -[AWDCoreRoutineFMCAssistanceInstance setParkingId:](self, "setParkingId:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineFMCAssistanceInstance;
  -[AWDCoreRoutineFMCAssistanceInstance dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineFMCAssistanceInstance;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineFMCAssistanceInstance description](&v3, sel_description), -[AWDCoreRoutineFMCAssistanceInstance dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) == 0)
  {
    if ((*(_BYTE *)&self->_has & 4) == 0)
      goto LABEL_7;
LABEL_11:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_assistanceValue), CFSTR("assistanceValue"));
    if ((*(_BYTE *)&self->_has & 8) == 0)
      return v3;
    goto LABEL_8;
  }
  objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_assistanceType), CFSTR("assistanceType"));
  has = (char)self->_has;
  if ((has & 4) != 0)
    goto LABEL_11;
LABEL_7:
...
LABEL_24:
    ...
    if ((has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 36) & 2) == 0 || self->_assistanceType != *((_DWORD *)a3 + 4))
        goto LABEL_24;
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 36) & 4) == 0 || self->_assistanceValue != *((_DWORD *)a3 + 5))
        goto LABEL_24;
    }
    ...
    if ((has & 8) != 0)
    {
      if ((*((_BYTE *)a3 + 36) & 8) == 0 || self->_uiPlacement != *((_DWORD *)a3 + 8))
        goto LABEL_24;
      LOBYTE(v5) = 1;
    }
  }
