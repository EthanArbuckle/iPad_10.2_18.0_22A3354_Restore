...
- (void)dealloc
{
  ...
  -[AWDBltPrimaryDevicePublicationToResponseDelay setUniqueid:](self, "setUniqueid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDBltPrimaryDevicePublicationToResponseDelay;
  -[AWDBltPrimaryDevicePublicationToResponseDelay dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltPrimaryDevicePublicationToResponseDelay;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDBltPrimaryDevicePublicationToResponseDelay description](&v3, sel_description), -[AWDBltPrimaryDevicePublicationToResponseDelay dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_7:
  if ((has & 8) != 0)
LABEL_8:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_publicationDate), CFSTR("publicationDate"));
  return v3;
}
...
LABEL_24:
    ...
    if ((has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 40) & 4) == 0 || self->_delayMs != *((_DWORD *)a3 + 5))
        goto LABEL_24;
    }
    ...
    if ((has & 8) != 0)
    {
      if ((*((_BYTE *)a3 + 40) & 8) == 0 || self->_publicationDate != *((_DWORD *)a3 + 6))
        goto LABEL_24;
      LOBYTE(v5) = 1;
    }
  }
