...
- (void)dealloc
{
  ...
  -[AWDBltDelayReceiveLocal setUniqueid:](self, "setUniqueid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayReceiveLocal;
  -[AWDBltDelayReceiveLocal dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayReceiveLocal;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDBltDelayReceiveLocal description](&v3, sel_description), -[AWDBltDelayReceiveLocal dictionaryRepresentation](self, "dictionaryRepresentation"));
}
