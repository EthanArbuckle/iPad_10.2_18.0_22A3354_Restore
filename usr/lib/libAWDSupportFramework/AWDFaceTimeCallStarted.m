...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallStarted setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallStarted;
  -[AWDFaceTimeCallStarted dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallStarted;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallStarted description](&v3, sel_description), -[AWDFaceTimeCallStarted dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_33:
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 8) == 0 || self->_isToPhoneNumber != *((_DWORD *)a3 + 8))
          goto LABEL_33;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 4) == 0 || self->_isToEmail != *((_DWORD *)a3 + 7))
          goto LABEL_33;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 2) == 0 || self->_isCallUpgrade != *((_DWORD *)a3 + 6))
          goto LABEL_33;
      }
      ...
      {
        if ((*((_BYTE *)a3 + 44) & 0x10) == 0 || self->_isVideo != *((_DWORD *)a3 + 9))
          goto LABEL_33;
      }
      ...
      if ((*(_BYTE *)&self->_has & 0x20) != 0)
      {
        if ((*((_BYTE *)a3 + 44) & 0x20) == 0 || self->_onLockScreen != *((_DWORD *)a3 + 10))
          goto LABEL_33;
        LOBYTE(v5) = 1;
      }
    }
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    ...
    {
LABEL_3:
      v5 = 2654435761 * self->_isToPhoneNumber;
      if ((*(_BYTE *)&self->_has & 4) != 0)
        goto LABEL_4;
      goto LABEL_10;
    }
...
LABEL_10:
  ...
  {
LABEL_5:
    v7 = 2654435761 * self->_isCallUpgrade;
    if ((*(_BYTE *)&self->_has & 0x10) != 0)
      goto LABEL_6;
LABEL_12:
    v8 = 0;
