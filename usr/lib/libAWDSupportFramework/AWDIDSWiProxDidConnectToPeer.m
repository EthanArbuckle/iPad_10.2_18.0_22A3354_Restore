...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDIDSWiProxDidConnectToPeer description](&v3, sel_description), -[AWDIDSWiProxDidConnectToPeer dictionaryRepresentation](self, "dictionaryRepresentation"));
}
