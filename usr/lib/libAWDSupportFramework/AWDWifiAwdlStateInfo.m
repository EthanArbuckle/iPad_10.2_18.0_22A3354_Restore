...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWifiAwdlStateInfo description](&v3, sel_description), -[AWDWifiAwdlStateInfo dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 20) & 2) == 0 || self->_count != *((_DWORD *)a3 + 4))
        goto LABEL_11;
    }
...
LABEL_11:
    ...
    if ((*(_BYTE *)&self->_has & 1) != 0)
    {
      if ((*((_BYTE *)a3 + 20) & 1) == 0 || self->_duration != *((_QWORD *)a3 + 1))
        goto LABEL_11;
      LOBYTE(v5) = 1;
    }
  }
