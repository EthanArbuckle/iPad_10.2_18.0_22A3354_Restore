...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiSDBSliceSpecific description](&v3, sel_description), -[AWDWiFiSDBSliceSpecific dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
LABEL_13:
    if ((has & 2) == 0)
      return;
LABEL_27:
    *((_QWORD *)a3 + 2) = self->_txDeferDuration;
    *((_WORD *)a3 + 38) |= 2u;
    return;
  }
LABEL_26:
  *((_QWORD *)a3 + 3) = self->_txPriDuration;
  *((_WORD *)a3 + 38) |= 4u;
  if ((*(_WORD *)&self->_has & 2) != 0)
    goto LABEL_27;
}
...
LABEL_26:
  *((_QWORD *)result + 4) = self->_txaDuration;
  *((_WORD *)result + 38) |= 8u;
  has = (__int16)self->_has;
  if ((has & 4) == 0)
  {
...
LABEL_27:
  *((_QWORD *)result + 3) = self->_txPriDuration;
  *((_WORD *)result + 38) |= 4u;
  if ((*(_WORD *)&self->_has & 2) == 0)
    return result;
LABEL_14:
  *((_QWORD *)result + 2) = self->_txDeferDuration;
  *((_WORD *)result + 38) |= 2u;
  return result;
}
...
LABEL_66:
    ...
    if ((has & 8) != 0)
    {
      if ((v7 & 8) == 0 || self->_txaDuration != *((_QWORD *)a3 + 4))
        goto LABEL_66;
    }
    else if ((v7 & 8) != 0)
    {
    ...
    if ((has & 4) != 0)
    {
      if ((v7 & 4) == 0 || self->_txPriDuration != *((_QWORD *)a3 + 3))
        goto LABEL_66;
    }
    else if ((v7 & 4) != 0)
    {
    ...
    if ((has & 2) != 0)
    {
      if ((v7 & 2) == 0 || self->_txDeferDuration != *((_QWORD *)a3 + 2))
        goto LABEL_66;
      LOBYTE(v5) = 1;
    }
  }
...
LABEL_13:
    if ((v3 & 2) == 0)
      return;
LABEL_27:
    self->_txDeferDuration = *((_QWORD *)a3 + 2);
    *(_WORD *)&self->_has |= 2u;
    return;
  }
LABEL_26:
  self->_txPriDuration = *((_QWORD *)a3 + 3);
  *(_WORD *)&self->_has |= 4u;
  if ((*((_WORD *)a3 + 38) & 2) != 0)
    goto LABEL_27;
}
