...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallRelayInitiateReceived setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateReceived;
  -[AWDFaceTimeCallRelayInitiateReceived dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateReceived;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallRelayInitiateReceived description](&v3, sel_description), -[AWDFaceTimeCallRelayInitiateReceived dictionaryRepresentation](self, "dictionaryRepresentation"));
}
