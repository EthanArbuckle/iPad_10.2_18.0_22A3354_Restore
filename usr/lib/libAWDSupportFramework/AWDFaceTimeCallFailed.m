...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallFailed setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallFailed;
  -[AWDFaceTimeCallFailed dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallFailed;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallFailed description](&v3, sel_description), -[AWDFaceTimeCallFailed dictionaryRepresentation](self, "dictionaryRepresentation"));
}
