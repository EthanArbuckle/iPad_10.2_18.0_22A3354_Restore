...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDCoreRoutineLearnedLocationReconciliationVisitDensity description](&v3, sel_description), -[AWDCoreRoutineLearnedLocationReconciliationVisitDensity dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) == 0)
  {
    if ((*(_BYTE *)&self->_has & 4) == 0)
      goto LABEL_3;
LABEL_7:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_totalBranchCount), CFSTR("totalBranchCount"));
...
LABEL_3:
  if ((has & 2) != 0)
LABEL_4:
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithInt:", self->_countDeviceLost), CFSTR("countDeviceLost"));
  return v3;
}
...
LABEL_16:
    ...
    if ((*(_BYTE *)&self->_has & 4) != 0)
    {
      if ((*((_BYTE *)a3 + 24) & 4) == 0 || self->_totalBranchCount != *((_DWORD *)a3 + 5))
        goto LABEL_16;
    }
    ...
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 24) & 2) == 0 || self->_countDeviceLost != *((_DWORD *)a3 + 4))
        goto LABEL_16;
      LOBYTE(v5) = 1;
    }
  }
