...
- (void)dealloc
{
  ...
  -[AWDPushProxyManagerReceive setGuid:](self, "setGuid:", 0);
  -[AWDPushProxyManagerReceive setTopic:](self, "setTopic:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDPushProxyManagerReceive;
  -[AWDPushProxyManagerReceive dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDPushProxyManagerReceive;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDPushProxyManagerReceive description](&v3, sel_description), -[AWDPushProxyManagerReceive dictionaryRepresentation](self, "dictionaryRepresentation"));
}
