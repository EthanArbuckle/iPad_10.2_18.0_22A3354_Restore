...
- (void)dealloc
{
  ...
  -[AWDWiFiNWActivityStateBin setState:](self, "setState:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiNWActivityStateBin;
  -[AWDWiFiNWActivityStateBin dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiNWActivityStateBin;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDWiFiNWActivityStateBin description](&v3, sel_description), -[AWDWiFiNWActivityStateBin dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
    objc_msgSend(v4, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedLongLong:", self->_residentTime), CFSTR("residentTime"));
  return v4;
}
...
- (void)copyTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *((_QWORD *)a3 + 1) = self->_residentTime;
    *((_BYTE *)a3 + 24) |= 1u;
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(_QWORD *)(v5 + 16) = -[NSString copyWithZone:](self->_state, "copyWithZone:", a3);
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    *(_QWORD *)(v5 + 8) = self->_residentTime;
    *(_BYTE *)(v5 + 24) |= 1u;
  }
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!((unint64_t)state | *((_QWORD *)a3 + 2)) || (v5 = -[NSString isEqual:](state, "isEqual:")) != 0)
    {
      ...
      if ((*(_BYTE *)&self->_has & 1) != 0)
        LOBYTE(v5) = (*((_BYTE *)a3 + 24) & 1) != 0 && self->_residentTime == *((_QWORD *)a3 + 1);
    }
  }
  return v5;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((*((_BYTE *)a3 + 24) & 1) != 0)
  {
    self->_residentTime = *((_QWORD *)a3 + 1);
    *(_BYTE *)&self->_has |= 1u;
  }
}
