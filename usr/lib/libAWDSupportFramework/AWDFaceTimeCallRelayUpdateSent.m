...
- (void)dealloc
{
  ...
  -[AWDFaceTimeCallRelayUpdateSent setGuid:](self, "setGuid:", 0);
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayUpdateSent;
  -[AWDFaceTimeCallRelayUpdateSent dealloc](&v3, sel_dealloc);
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayUpdateSent;
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDFaceTimeCallRelayUpdateSent description](&v3, sel_description), -[AWDFaceTimeCallRelayUpdateSent dictionaryRepresentation](self, "dictionaryRepresentation"));
}
