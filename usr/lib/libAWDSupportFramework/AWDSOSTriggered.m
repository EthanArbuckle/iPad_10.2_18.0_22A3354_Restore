...
- (id)description
{
  ...
  return (id)objc_msgSend(MEMORY[0x24BDD17C8], "stringWithFormat:", CFSTR("%@ %@"), -[AWDSOSTriggered description](&v3, sel_description), -[AWDSOSTriggered dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(MEMORY[0x24BDD16E0], "numberWithUnsignedInt:", self->_triggerMechanism), CFSTR("triggerMechanism"));
  return v3;
}
...
LABEL_11:
    ...
    if ((*(_BYTE *)&self->_has & 2) != 0)
    {
      if ((*((_BYTE *)a3 + 20) & 2) == 0 || self->_triggerMechanism != *((_DWORD *)a3 + 4))
        goto LABEL_11;
      LOBYTE(v5) = 1;
    }
  }
