...
int *libSystem_initializer(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  ...
  v11 = _libxpc_initializer(v10);
  if (MEMORY[0xFFFFFC100])
    v11 = kdebug_trace(735838224, 9, 0, 0, 0);
  _libtrace_init(v11);
  if (MEMORY[0xFFFFFC100])
  ...
  {
    *(_OWORD *)object = xmmword_1DEED8EC0;
...
{
  OUTLINED_FUNCTION_0(&dword_1DEED7000, a1, a3, "Libsystem end prewarm failed to look up mach service", a5, a6, a7, a8, 0);
}
