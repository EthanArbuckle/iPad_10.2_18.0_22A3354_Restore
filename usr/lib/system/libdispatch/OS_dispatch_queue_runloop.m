...
- (void)_xref_dispose
{
  ...
  j___dispatch_runloop_queue_xref_dispose((uint64_t)self, v9, v10, v11, v12, v13, v14, v15);
  v16.receiver = self;
  v16.super_class = (Class)OS_dispatch_queue_runloop;
  -[OS_dispatch_queue _xref_dispose](&v16, sel__xref_dispose);
}
