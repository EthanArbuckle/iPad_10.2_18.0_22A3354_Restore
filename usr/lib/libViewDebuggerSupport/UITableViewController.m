...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("tableView"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("clearsSelectionOnViewWillAppear"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("refreshControl"));
...
+ (id)fallback_debugHierarchyValueForPropertyWithName:(id)a3 onObject:(id)a4 outOptions:(id *)a5 outError:(id *)a6
{
  ...
  v8 = a3;
  v9 = a4;
  if (objc_msgSend(v8, "isEqualToString:", CFSTR("tableView")))
  {
    a6 = (id *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "viewIfLoaded"));

    if (a6)
    {
      v10 = (id *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "tableView"));
LABEL_7:
      a6 = v10;
      goto LABEL_29;
    }
  ...
  if (!objc_msgSend(v8, "isEqualToString:", CFSTR("refreshControl")))
  {
    v11 = v9;
    v12 = (NSString *)v8;
...
LABEL_28:
  ...
  if (a6)
  {
    v10 = (id *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "refreshControl"));
    goto LABEL_7;
  }
LABEL_29:
