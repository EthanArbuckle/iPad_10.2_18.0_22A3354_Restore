...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(v2, CFSTR("propertyName"), CFSTR("dataSource"));
  CFDictionaryAddValue(v2, CFSTR("propertyLogicalType"), CFSTR("DebugHierarchyLogicalPropertyTypeObjectInfo"));
  CFDictionaryAddValue(v2, CFSTR("propertyFormat"), CFSTR("objectInfo"));
  v10[1] = v2;
  v3 = CFDictionaryCreateMutable(0, 7, &kCFCopyStringDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("doubleSided"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("transitionStyle"));
  CFDictionaryAddValue(v4, CFSTR("propertyRuntimeType"), CFSTR("UIPageViewControllerTransitionStyle"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("navigationOrientation"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIPageViewControllerNavigationOrientation"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("spineLocation"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("UIPageViewControllerSpineLocation"));
  ...
  v10[5] = v6;
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v10, 6));
