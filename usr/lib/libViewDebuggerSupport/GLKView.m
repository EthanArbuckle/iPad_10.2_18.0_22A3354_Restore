...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("enableSetNeedsDisplay"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("drawableColorFormat"));
  CFDictionaryAddValue(v3, CFSTR("propertyRuntimeType"), CFSTR("GLKViewDrawableColorFormat"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("drawableDepthFormat"));
  CFDictionaryAddValue(v4, CFSTR("propertyRuntimeType"), CFSTR("GLKViewDrawableDepthFormat"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("drawableMultisample"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("GLKViewDrawableMultisample"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("drawableStencilFormat"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("GLKViewDrawableStencilFormat"));
