...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("preferredAction"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("message"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("preferredStyle"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("preferredStyle"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("UIAlertControllerStyle"));
