...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("selectedViewController"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("selectedIndex"));
  CFDictionaryAddValue(v3, CFSTR("propertyRuntimeType"), CFSTR("NSUInteger"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("moreNavigationController"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("tabBar"));
