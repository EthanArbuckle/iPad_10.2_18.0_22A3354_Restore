...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("activityIndicatorViewStyle"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("color"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("hidesWhenStopped"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("animating"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("activityIndicatorViewStyle"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("UIActivityIndicatorViewStyle"));
