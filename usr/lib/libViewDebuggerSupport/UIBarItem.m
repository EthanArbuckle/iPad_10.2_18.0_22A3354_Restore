...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("imageInsets"));
  CFDictionaryAddValue(v3, CFSTR("propertyRuntimeType"), CFSTR("UIEdgeInsets"));
  CFDictionaryAddValue(v3, CFSTR("propertyLogicalType"), CFSTR("DebugHierarchyLogicalPropertyTypeInsets"));
  CFDictionaryAddValue(v3, CFSTR("propertyFormat"), CFSTR("CGf, CGf, CGf, CGf"));
  v11[1] = v3;
  v4 = CFDictionaryCreateMutable(0, 7, &kCFCopyStringDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("title"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("tag"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("NSInteger"));
  ...
  CFRelease(v7);
  v11[4] = v6;
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v11, 5));
