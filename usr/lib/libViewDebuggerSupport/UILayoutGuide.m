...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("layoutFrame"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("owningView"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("identifier"));
