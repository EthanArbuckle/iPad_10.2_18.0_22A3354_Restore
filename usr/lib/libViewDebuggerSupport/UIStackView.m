...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("baselineRelativeArrangement"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("layoutMarginsRelativeArrangement"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("spacing"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("alignment"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIStackViewAlignment"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("axis"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("UILayoutConstraintAxis"));
  ...
  CFDictionaryAddValue(v7, CFSTR("propertyName"), CFSTR("distribution"));
  CFDictionaryAddValue(v7, CFSTR("propertyRuntimeType"), CFSTR("UIStackViewDistribution"));
