...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("numberOfSections"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("dataSource"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("delegate"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("collectionViewLayout"));
