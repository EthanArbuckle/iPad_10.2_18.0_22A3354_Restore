...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("session"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("activationState"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UISceneActivationState"));
