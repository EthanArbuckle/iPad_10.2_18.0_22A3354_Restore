...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("inputView"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("textDocumentProxy"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("primaryLanguage"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("hasFullAccess"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("needsInputModeSwitchKey"));
