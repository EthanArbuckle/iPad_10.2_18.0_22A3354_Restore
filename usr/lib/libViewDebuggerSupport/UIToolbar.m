...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("barTintColor"));
  CFDictionaryAddValue(Mutable, CFSTR("propertyRuntimeType"), CFSTR("UIColor"));
  CFDictionaryAddValue(Mutable, CFSTR("propertyLogicalType"), CFSTR("DebugHierarchyLogicalPropertyTypeColor"));
  v8[0] = Mutable;
  v3 = CFDictionaryCreateMutable(0, 7, &kCFCopyStringDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("delegate"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("translucent"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("barStyle"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIBarStyle"));
