...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("currentPage"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("currentPageIndicatorTintColor"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("defersCurrentPageDisplay"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("hidesForSinglePage"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("numberOfPages"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("NSInteger"));
  ...
  CFDictionaryAddValue(v7, CFSTR("propertyName"), CFSTR("pageIndicatorTintColor"));
  CFDictionaryAddValue(v7, CFSTR("propertyRuntimeType"), CFSTR("UIColor"));
