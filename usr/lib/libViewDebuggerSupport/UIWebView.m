...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("allowsInlineMediaPlayback"));
  ...
  CFDictionaryAddValue(v13, CFSTR("propertyName"), CFSTR("gapBetweenPages"));
  ...
  CFDictionaryAddValue(v12, CFSTR("propertyName"), CFSTR("keyboardDisplayRequiresUserAction"));
  ...
  CFDictionaryAddValue(v11, CFSTR("propertyName"), CFSTR("mediaPlaybackAllowsAirPlay"));
  ...
  CFDictionaryAddValue(v10, CFSTR("propertyName"), CFSTR("mediaPlaybackRequiresUserAction"));
  ...
  CFDictionaryAddValue(v2, CFSTR("propertyName"), CFSTR("pageLength"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("scalesPageToFit"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("suppressesIncrementalRendering"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("dataDetectorTypes"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIDataDetectorTypes"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("paginationBreakingMode"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("UIWebPaginationBreakingMode"));
  ...
  CFDictionaryAddValue(v7, CFSTR("propertyName"), CFSTR("paginationMode"));
  CFDictionaryAddValue(v7, CFSTR("propertyRuntimeType"), CFSTR("UIWebPaginationMode"));
  ...
  v16[11] = v7;
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v16, 12));
