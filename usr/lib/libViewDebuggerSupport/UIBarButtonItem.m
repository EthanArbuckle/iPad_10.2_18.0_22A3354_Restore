...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("style"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("tintColor"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("width"));
  ...
  CFDictionaryAddValue(v7, CFSTR("propertyName"), CFSTR("style"));
  CFDictionaryAddValue(v7, CFSTR("propertyRuntimeType"), CFSTR("UIBarButtonItemStyle"));
