...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("onTintColor"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("thumbTintColor"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("on"));
