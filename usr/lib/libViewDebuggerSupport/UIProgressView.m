...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("progress"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("progressImage"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("progressTintColor"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIColor"));
  CFDictionaryAddValue(v5, CFSTR("propertyLogicalType"), CFSTR("DebugHierarchyLogicalPropertyTypeColor"));
  v13[2] = v5;
  v6 = CFDictionaryCreateMutable(0, 7, &kCFCopyStringDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("trackImage"));
  ...
  CFDictionaryAddValue(v8, CFSTR("propertyName"), CFSTR("trackTintColor"));
  CFDictionaryAddValue(v8, CFSTR("propertyRuntimeType"), CFSTR("UIColor"));
  ...
  CFDictionaryAddValue(v9, CFSTR("propertyName"), CFSTR("progressViewStyle"));
  CFDictionaryAddValue(v9, CFSTR("propertyRuntimeType"), CFSTR("UIProgressViewStyle"));
  ...
  v13[5] = v9;
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v13, 6));
