...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("badgeValue"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("selectedImage"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("titlePositionAdjustment"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIOffset"));
  CFDictionaryAddValue(v5, CFSTR("propertyLogicalType"), CFSTR("DebugHierarchyLogicalPropertyTypeOffset"));
