...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(v11, CFSTR("propertyName"), CFSTR("delegate"));
  ...
  CFDictionaryAddValue(v2, CFSTR("propertyName"), CFSTR("dimsBackgroundDuringPresentation"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("hidesNavigationBarDuringPresentation"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("obscuresBackgroundDuringPresentation"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("searchBar"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("searchResultsController"));
  ...
  CFDictionaryAddValue(v7, CFSTR("propertyName"), CFSTR("searchResultsUpdater"));
  ...
  v12[7] = v7;
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v12, 8));
