...
+ (id)fallback_debugHierarchyObjectsInGroupWithID:(id)a3 onObject:(id)a4 outOptions:(id *)a5
{
  ...
  v7 = a4;
  if (objc_msgSend(a3, "isEqualToString:", CFSTR("com.apple.UIKit.UIView")))
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "subviews"));
    v11 = CFSTR("visibility");
    v12 = &off_55360;
    v9 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue(+[NSDictionary dictionaryWithObjects:forKeys:count:](NSDictionary, "dictionaryWithObjects:forKeys:count:", &v12, &v11, 1)));
    *a5 = v9;
...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, CFSTR("propertyName"), CFSTR("enabled"));
  ...
  CFDictionaryAddValue(v3, CFSTR("propertyName"), CFSTR("highlighted"));
  ...
  CFDictionaryAddValue(v4, CFSTR("propertyName"), CFSTR("selected"));
  ...
  CFDictionaryAddValue(v5, CFSTR("propertyName"), CFSTR("contentHorizontalAlignment"));
  CFDictionaryAddValue(v5, CFSTR("propertyRuntimeType"), CFSTR("UIControlContentHorizontalAlignment"));
  ...
  CFDictionaryAddValue(v6, CFSTR("propertyName"), CFSTR("contentVerticalAlignment"));
  CFDictionaryAddValue(v6, CFSTR("propertyRuntimeType"), CFSTR("UIControlContentHorizontalAlignment"));
  ...
  CFDictionaryAddValue(v7, CFSTR("propertyName"), CFSTR("state"));
  CFDictionaryAddValue(v7, CFSTR("propertyRuntimeType"), CFSTR("UIControlState"));
