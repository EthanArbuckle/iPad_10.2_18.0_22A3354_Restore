...
LABEL_10:
  ...
  objc_msgSend((id)objc_opt_class(), "createWithReceiverContactMO:", v3);
...
+ (id)createWithReceiverContactMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: receiverContactMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[SMReceiverContactMO managedObjectWithReceiverContact:inManagedObjectContext:](SMReceiverContactMO, "managedObjectWithReceiverContact:inManagedObjectContext:", a1, a3);
...
- (void)updateManagedObject:()RTCoreDataTransformable
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue();
  v5 = +[SMReceiverContactMO managedObjectWithReceiverContact:managedObject:inManagedObjectContext:](SMReceiverContactMO, "managedObjectWithReceiverContact:managedObject:inManagedObjectContext:", a1, v6, v4);
