...
{
  RTPlaceTypeClassifierModelMultiClassInput *result;
  objc_super v30;

  v30.receiver = self;
  v30.super_class = (Class)RTPlaceTypeClassifierModelMultiClassInput;
  result = -[RTPlaceTypeClassifierModelMultiClassInput init](&v30, sel_init);
  if (result)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)objc_msgSend(MEMORY[0x1E0C99E60], "setWithArray:", &unk_1E932C268);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_longest_charging_duration_bucketed")))
  {
    ...
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_longest_charging_duration_bucketed](self, "mean_daily_longest_charging_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_longest_screen_lock_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_longest_screen_lock_duration_bucketed](self, "mean_daily_longest_screen_lock_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_longest_uninterrupted_WiFi_connection_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_longest_uninterrupted_WiFi_connection_duration_bucketed](self, "mean_daily_longest_uninterrupted_WiFi_connection_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_total_charging_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_total_charging_duration_bucketed](self, "mean_daily_total_charging_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_total_screen_lock_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_total_screen_lock_duration_bucketed](self, "mean_daily_total_screen_lock_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_total_uninterrupted_WiFi_connection_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_total_uninterrupted_WiFi_connection_duration_bucketed](self, "mean_daily_total_uninterrupted_WiFi_connection_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_uninterrupted_WiFi_connection_stability_ratio_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput mean_daily_uninterrupted_WiFi_connection_stability_ratio_bucketed](self, "mean_daily_uninterrupted_WiFi_connection_stability_ratio_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("median_daily_longest_charging_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput median_daily_longest_charging_duration_bucketed](self, "median_daily_longest_charging_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("median_daily_longest_screen_lock_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput median_daily_longest_screen_lock_duration_bucketed](self, "median_daily_longest_screen_lock_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("median_daily_longest_uninterrupted_WiFi_connection_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput median_daily_longest_uninterrupted_WiFi_connection_duration_bucketed](self, "median_daily_longest_uninterrupted_WiFi_connection_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("median_daily_total_charging_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput median_daily_total_charging_duration_bucketed](self, "median_daily_total_charging_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("median_daily_total_screen_lock_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput median_daily_total_screen_lock_duration_bucketed](self, "median_daily_total_screen_lock_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("median_daily_total_uninterrupted_WiFi_connection_duration_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput median_daily_total_uninterrupted_WiFi_connection_duration_bucketed](self, "median_daily_total_uninterrupted_WiFi_connection_duration_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("percentage_of_days_with_charging_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput percentage_of_days_with_charging_bucketed](self, "percentage_of_days_with_charging_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("percentage_of_days_with_screen_lock_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput percentage_of_days_with_screen_lock_bucketed](self, "percentage_of_days_with_screen_lock_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("percentage_of_days_with_uninterrupted_WiFi_connection_bucketed")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput percentage_of_days_with_uninterrupted_WiFi_connection_bucketed](self, "percentage_of_days_with_uninterrupted_WiFi_connection_bucketed");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("is_iPhone")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput is_iPhone](self, "is_iPhone");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("is_iPad")))
  {
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput is_iPad](self, "is_iPad");
  }
  else
  {
    ...
    v5 = (void *)MEMORY[0x1E0C9E918];
    -[RTPlaceTypeClassifierModelMultiClassInput is_Watch](self, "is_Watch");
  }
