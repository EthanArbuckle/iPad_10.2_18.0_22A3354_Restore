...
{
  RTMapItemProviderCurrentPOIParameters *v3;
  RTMapItemProviderCurrentPOIParameters *v5;
  RTMapItemProviderCurrentPOIParameters *v6;
  NSObject *v7;
  objc_super v9;
  uint8_t buf[16];
  ...
  else
  {
    ...
    v5 = -[RTMapItemProviderCurrentPOIParameters init](&v9, sel_init);
    if (v5)
...
- (RTMapItemProviderCurrentPOIParameters)initWithDefaultsManager:(id)a3
{
  ...
  double v5;
  NSObject *v6;
  RTMapItemProviderCurrentPOIParameters *v7;
  uint8_t v9[16];

  if (a3)
  {
    objc_msgSend(a3, "objectForKey:", CFSTR("RTDefaultsMapItemProviderCurrentPOIDistanceThreshold"));
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0)
      ...
      v5 = 50.0;
    self = -[RTMapItemProviderCurrentPOIParameters initWithDistanceThreshold:](self, "initWithDistanceThreshold:", v5);
