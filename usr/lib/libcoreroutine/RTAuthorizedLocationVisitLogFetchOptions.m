...
- (RTAuthorizedLocationVisitLogFetchOptions)initWithAscending:(BOOL)a3 dateInterval:(id)a4 limit:(id)a5
{
  ...
  id v10;
  void *v11;
  RTAuthorizedLocationVisitLogFetchOptions *v12;
  id *p_isa;
  RTAuthorizedLocationVisitLogFetchOptions *v14;
  NSObject *v15;
  objc_super v17;
  uint8_t buf[16];
  ...
  if (v10 && !objc_msgSend(v10, "unsignedIntegerValue"))
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v15, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: !limit || (limit && limit.unsignedIntegerValue > 0)", buf, 2u);
    }
  ...
  else
  {
    ...
    v12 = -[RTAuthorizedLocationVisitLogFetchOptions init](&v17, sel_init);
...
- (BOOL)isEqual:(id)a3
{
  RTAuthorizedLocationVisitLogFetchOptions *v4;
  ...
  if (v4 == self)
    ...
    v6 = v4
      ...
      && -[RTAuthorizedLocationVisitLogFetchOptions isEqualToFetchOptions:](self, "isEqualToFetchOptions:", v5);
...
- (RTAuthorizedLocationVisitLogFetchOptions)initWithCoder:(id)a3
{
  ...
  v8 = -[RTAuthorizedLocationVisitLogFetchOptions initWithAscending:dateInterval:limit:](self, "initWithAscending:dateInterval:limit:", v5, v6, v7);
  return v8;
}
