...
LABEL_7:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 1024;
      v12 = 27;
      _os_log_error_impl(&dword_1D1A22000, v5, OS_LOG_TYPE_ERROR, "managedObject, %@, is not supported by SMInitiatorLocationMO+CoreDataTransformable (in %s:%d)", (uint8_t *)&v7, 0x1Cu);
    }

    goto LABEL_7;
  }
  objc_msgSend((id)objc_opt_class(), "createWithLocationMO:", v3);
...
+ (id)createWithLocationMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: locationMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[SMInitiatorLocationMO managedObjectWithLocation:inManagedObjectContext:](SMInitiatorLocationMO, "managedObjectWithLocation:inManagedObjectContext:", a1, a3);
