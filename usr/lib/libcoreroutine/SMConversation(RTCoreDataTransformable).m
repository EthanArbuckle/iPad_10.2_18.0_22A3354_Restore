...
LABEL_10:
  ...
  objc_msgSend((id)objc_opt_class(), "createWithSMConversationMO:", v3);
...
+ (id)createWithSMConversationMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: conversationMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[SMConversationMO managedObjectWithSMConversation:inManagedObjectContext:](SMConversationMO, "managedObjectWithSMConversation:inManagedObjectContext:", a1, a3);
