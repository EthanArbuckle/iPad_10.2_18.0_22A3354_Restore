...
- (char)_init
{
  ...
  v2.receiver = a1;
  v2.super_class = (Class)&off_1EFCDBC08;
  result = (char *)objc_msgSendSuper2(&v2, sel_init);
  if (result)
  {
    *(_DWORD *)&result[*MEMORY[0x1E0DDD238]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD240]] = 0;
  }
  return result;
}
...
- (id)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("%@, event type %d, value %d"), v4, objc_msgSend(a1, "eventType"), objc_msgSend(a1, "value"));
