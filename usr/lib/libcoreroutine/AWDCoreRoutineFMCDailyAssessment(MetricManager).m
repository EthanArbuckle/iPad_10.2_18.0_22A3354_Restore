...
- (char)_init
{
  ...
  v2.receiver = a1;
  v2.super_class = (Class)&off_1EFCDBFF8;
  result = (char *)objc_msgSendSuper2(&v2, sel_init);
  if (result)
  {
    *(_DWORD *)&result[*MEMORY[0x1E0DDD1D8]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD1E0]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD1E8]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD1F0]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD1F8]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD208]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD210]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E0DDD200]] = 0;
  }
  return result;
}
