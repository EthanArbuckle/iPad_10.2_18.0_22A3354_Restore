...
{
  return (id)objc_msgSend(a1, "managedObjectWithDeviceStatus:managedObject:inManagedObjectContext:", a3, 0, a4);
}
...
uint64_t __87__SMDeviceStatusMO_managedObjectWithDeviceStatus_managedObject_inManagedObjectContext___block_invoke(uint64_t a1)
{
  ...
  v3 = v2;
  if (!v2)
    v3 = -[SMDeviceStatusMO initWithContext:]([SMDeviceStatusMO alloc], "initWithContext:", *(_QWORD *)(a1 + 40));
  ...
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setBatteryRemaining:", (__int16)objc_msgSend(*(id *)(a1 + 48), "batteryRemaining"));
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setCellularStrength:", (__int16)objc_msgSend(*(id *)(a1 + 48), "cellularStrength"));
  objc_msgSend(*(id *)(a1 + 48), "date");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setDate:", v5);

  return objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setWifiStrength:", (__int16)objc_msgSend(*(id *)(a1 + 48), "wifiStrength"));
}

+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x1E0C97B48], "fetchRequestWithEntityName:", CFSTR("SMDeviceStatusMO"));
}
