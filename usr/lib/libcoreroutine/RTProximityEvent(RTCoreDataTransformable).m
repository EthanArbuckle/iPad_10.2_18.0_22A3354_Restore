...
LABEL_7:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 1024;
      v17 = 35;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "%@, managedObject, %@, is not supported by RTProximityEvent+CoreDataReadable (in %s:%d)", (uint8_t *)&v10, 0x26u);

    }
    goto LABEL_7;
  }
  v5 = v4;
  objc_msgSend((id)objc_opt_class(), "createWithProximityEventMO:", v5);
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[RTProximityEventMO managedObjectWithProximityEvent:inManagedObjectContext:](RTProximityEventMO, "managedObjectWithProximityEvent:inManagedObjectContext:", a1, a3);
