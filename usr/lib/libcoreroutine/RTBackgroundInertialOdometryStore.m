...
{
  RTBackgroundInertialOdometryStore *v4;
  NSObject *v5;
  objc_class *v7;
  void *v8;
  void *v9;
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_storeBackgroundInertialOdometrySamples:handler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
LABEL_3:
      ...
      v24[1] = 3221225472;
      v24[2] = __102__RTBackgroundInertialOdometryStore__fetchStoredBackgroundInertialOdometrySamplesWithContext_handler___block_invoke;
      v24[3] = &unk_1E9297A80;
      v25 = v6;
      v10 = v8;
      v26 = v10;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      v28 = "-[RTBackgroundInertialOdometryStore _fetchStoredBackgroundInertialOdometrySamplesWithContext:handler:]";
      v29 = 1024;
      LODWORD(v30) = 64;
...
void __102__RTBackgroundInertialOdometryStore__fetchStoredBackgroundInertialOdometrySamplesWithContext_handler___block_invoke(uint64_t a1, void *a2)
{
  ...
  v37 = a2;
  +[RTBackgroundInertialOdometrySampleMO fetchRequest](RTBackgroundInertialOdometrySampleMO, "fetchRequest");
  v3 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v3, "setReturnsObjectsAsFaults:", 0);
  v4 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3928]), "initWithKey:ascending:", CFSTR("cfAbsTimestamp"), 1);
  v45[0] = v4;
  ...
  objc_msgSend(v7, "predicateWithFormat:", CFSTR("%@ <= %K"), v10, CFSTR("cfAbsTimestamp"));
  ...
  objc_msgSend(v12, "predicateWithFormat:", CFSTR("%K <= %@"), CFSTR("cfAbsTimestamp"), v15);
    ...
    if (v26)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(MEMORY[0x1E0C9E358], "createWithManagedObject:", v30);
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_fetchStoredBackgroundInertialOdometrySamplesWithContext:handler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
- (void)_fetchStoredBackgroundInertialOdometrySamplesWithOptions:(id)a3 handler:(id)a4
{
  ...
  v9 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0D18348]), "initWithEnumerationOptions:", v6);
  -[RTBackgroundInertialOdometryStore _fetchStoredBackgroundInertialOdometrySamplesWithContext:handler:](self, "_fetchStoredBackgroundInertialOdometrySamplesWithContext:handler:", v9, v7);
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_fetchStoredBackgroundInertialOdometrySamplesWithOptions:handler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
- (void)_purgeBackgroundInertialOdometrySamplesPredating:(id)a3 handler:(id)a4
{
  ...
  if (v6)
  {
    ...
    -[RTStore purgePredating:predicateMappings:purgeLimit:handler:](self, "purgePredating:predicateMappings:purgeLimit:handler:", v6, v9, 86400, v7);
  }
  else
  {
    v10 = (void (**)(id, id))a4;
...
{
  return objc_msgSend(*(id *)(a1 + 32), "_purgeBackgroundInertialOdometrySamplesPredating:handler:", *(_QWORD *)(a1 + 40), *(_QWORD *)(a1 + 48));
}
...
LABEL_8:
  ...
  if (v8)
  {
    ...
    {
      -[RTBackgroundInertialOdometryStore fetchRequestFromStoredBackgroundInertialOdometrySampleOptions:](self, "fetchRequestFromStoredBackgroundInertialOdometrySampleOptions:", v9);
      v21 = (void *)objc_claimAutoreleasedReturnValue();
...
- (id)fetchRequestFromStoredBackgroundInertialOdometrySampleOptions:(id)a3
{
  ...
  if (v3)
  {
    ...
    v5 = (void *)objc_msgSend(objc_alloc(MEMORY[0x1E0CB3928]), "initWithKey:ascending:", CFSTR("cfAbsTimestamp"), 1);
    v27[0] = v5;
    ...
    objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%@ <= %K"), v11, CFSTR("cfAbsTimestamp"));
    v19 = (void *)objc_claimAutoreleasedReturnValue();
    v26[0] = v19;
    objc_msgSend(MEMORY[0x1E0CB3880], "predicateWithFormat:", CFSTR("%K <= %@"), CFSTR("cfAbsTimestamp"), v16);
