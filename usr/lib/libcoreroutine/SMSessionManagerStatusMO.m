...
{
  return (id)objc_msgSend(a1, "managedObjectWithSessionManagerStatus:managedObject:inManagedObjectContext:", a3, 0, a4);
}
...
{
  SMSessionManagerStatusMO *v2;
  SMSessionManagerStatusMO *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  v3 = v2;
  if (!v2)
    v3 = -[SMSessionManagerStatusMO initWithContext:]([SMSessionManagerStatusMO alloc], "initWithContext:", *(_QWORD *)(a1 + 40));
  ...
  objc_msgSend(*(id *)(a1 + 48), "stateQueryDate");
  v5 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setStateQueryDate:", v5);

  objc_msgSend(*(id *)(a1 + 48), "lastSessionIDDuringMagnetBreak");
  v6 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setLastSessionIDDuringMagnetBreak:", v6);

  objc_msgSend(*(id *)(a1 + 48), "state");
  v8 = (id)objc_claimAutoreleasedReturnValue();
  +[SMSessionManagerStateMO initWithSessionManagerState:inManagedObjectContext:](SMSessionManagerStateMO, "initWithSessionManagerState:inManagedObjectContext:", v8, *(_QWORD *)(a1 + 40));
  v7 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(*(id *)(*(_QWORD *)(*(_QWORD *)(a1 + 56) + 8) + 40), "setState:", v7);

}

+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x1E0C97B48], "fetchRequestWithEntityName:", CFSTR("SMSessionManagerStatusMO"));
}
