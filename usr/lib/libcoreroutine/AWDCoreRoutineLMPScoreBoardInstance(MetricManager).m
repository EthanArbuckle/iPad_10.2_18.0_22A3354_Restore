...
- (char)_init
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&off_1EFCDBA00;
  v1 = (char *)objc_msgSendSuper2(&v6, sel_init);
  v2 = v1;
  if (v1)
  {
    v3 = (int)*MEMORY[0x1E0DDD2E0];
    v4 = *(void **)&v1[v3];
    *(_QWORD *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E0DDD2D0]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD2D8]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD2E8]] = 0;
  }
  return v2;
}
...
- (id)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("%@, keyword %@, corrects %d, incorrects %d, unknowns %d"), v4, v5, objc_msgSend(a1, "corrects"), objc_msgSend(a1, "incorrects"), objc_msgSend(a1, "unknowns"));
  v6 = (void *)objc_claimAutoreleasedReturnValue();
