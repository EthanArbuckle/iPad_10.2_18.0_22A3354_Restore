  ...
  else if (a4)
  {
    ...
    *((_QWORD *)&v67 + 1) = &v67;
    ...
    if (dispatch_semaphore_wait(v17, v18))
    {
      ...
      objc_msgSend(MEMORY[0x1E0C99D80], "dictionaryWithObjects:forKeys:count:", &v66, &v65, 1, v45, v46, v47, v48);
    ...
    else
    {
      ...
      {
        v38 = objc_alloc(MEMORY[0x1E0D183B0]);
        v39 = v58[4];
        v40 = v58[5];
        v41 = v54[3];
  ...
  else
  {
    ...
    *(double *)&v58 = 0.0;
    ...
    else
    {
      ...
      objc_msgSend(v35, "errorWithDomain:code:userInfo:", *MEMORY[0x1E0D18598], 0, v36);
      v33 = (void *)objc_claimAutoreleasedReturnValue();
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_QWORD *)((char *)&v67 + 4) = v33;
        _os_log_error_impl(&dword_1D1A22000, v37, OS_LOG_TYPE_ERROR, "%@", (uint8_t *)&v67, 0xCu);
      }
...
- (void)shiftCoordinate:(CLLocationCoordinate2D)a3 accuracy:(double)a4 handler:(id)a5
{
  ...
  if (v9)
  {
    if ((objc_msgSend(MEMORY[0x1E0D27178], "isLocationShiftRequiredForCoordinate:", latitude, longitude) & 1) == 0)
      v9[2](v9, 0, latitude, longitude, a4);
    v10 = MEMORY[0x1E0C809B0];
    v22[0] = MEMORY[0x1E0C809B0];
    v22[1] = 3221225472;
    v22[2] = __54__RTLocationShifter_shiftCoordinate_accuracy_handler___block_invoke;
    v22[3] = &unk_1E929ACC0;
    v11 = v9;
    v23 = v11;
    v12 = (void *)MEMORY[0x1D8232094](v22);
    v17[0] = v10;
    v17[1] = 3221225472;
    v17[2] = __54__RTLocationShifter_shiftCoordinate_accuracy_handler___block_invoke_2;
    v17[3] = &unk_1E929ACE8;
    v18 = v11;
    v19 = latitude;
    v20 = longitude;
...
{
  return objc_msgSend(MEMORY[0x1E0D27178], "isLocationShiftRequiredForCoordinate:", a3.latitude, a3.longitude);
}
