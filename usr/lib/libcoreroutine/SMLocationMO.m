...
uint64_t __79__SMLocationMO_managedObjectWithLocation_managedObject_inManagedObjectContext___block_invoke(uint64_t a1)
{
  ...
  v3 = v2;
  if (!v2)
    v3 = -[SMLocationMO initWithContext:]([SMLocationMO alloc], "initWithContext:", *(_QWORD *)(a1 + 40));
...
+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x1E0C97B48], "fetchRequestWithEntityName:", CFSTR("SMLocationMO"));
}
