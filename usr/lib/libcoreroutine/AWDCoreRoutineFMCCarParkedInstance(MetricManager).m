...
- (char)_init
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&off_1EFCDA3D0;
  v1 = (char *)objc_msgSendSuper2(&v6, sel_init);
  v2 = v1;
  if (v1)
  {
    v3 = (int)*MEMORY[0x1E0DDD1C0];
    v4 = *(void **)&v1[v3];
    *(_QWORD *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E0DDD1B0]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD1C8]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD1D0]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD1B8]] = -1;
  }
  return v2;
}
...
- (id)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("%@, triggerTypes %d, horizontalAccuracy %d, qualityIndicator %d, triggerType %d, userSetLocation %d, locationType %d"), v4, objc_msgSend(a1, "triggerTypes"), objc_msgSend(a1, "horizontalAccuracy"), objc_msgSend(a1, "qualityIndicator"), objc_msgSend(a1, "triggerTypes"), objc_msgSend(a1, "userAssistanceRequired"), objc_msgSend(a1, "locationType"));
