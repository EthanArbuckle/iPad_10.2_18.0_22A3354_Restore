...
- (char)_init
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&off_1EFCDCE60;
  v1 = (char *)objc_msgSendSuper2(&v6, sel_init);
  if (v1)
  {
    v2 = objc_opt_new();
    v3 = (int)*MEMORY[0x1E0DDD218];
    v4 = *(void **)&v1[v3];
    *(_QWORD *)&v1[v3] = v2;
...
- (id)description
{
  ...
  if (objc_msgSend(a1, "assessmentsCount"))
  {
    v3 = 0;
    do
    {
      objc_msgSend(a1, "assessmentAtIndex:", v3);
    ...
    while (objc_msgSend(a1, "assessmentsCount") > v3);
  }
  v6 = (void *)MEMORY[0x1E0CB3940];
  v7 = (objc_class *)objc_opt_class();
  NSStringFromClass(v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue();
  v9 = objc_msgSend(a1, "assessmentsCount");
  objc_msgSend(v2, "description");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  objc_msgSend(v6, "stringWithFormat:", CFSTR("%@, count %lu, assessments %@"), v8, v9, v10);
