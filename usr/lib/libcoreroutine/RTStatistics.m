...
+ (double)calculateModelConfidenceWithCorrectPredictions:(double)a3 incorrectPredictions:(double)a4
{
  ...
  +[RTStatistics calculateModelConfidenceWithCorrectPredictions:incorrectPredictions:iterations:minimumConfidence:](RTStatistics, "calculateModelConfidenceWithCorrectPredictions:incorrectPredictions:iterations:minimumConfidence:", 20, a3, a4, 0.95);
  return result;
}
...
+ (double)calculateModelConfidenceWithCorrectPredictions:(double)a3 incorrectPredictions:(double)a4 iterations:(unint64_t)a5 minimumConfidence:(double)a6
{
  ...
  do
  {
    +[RTStatistics betaDistributionCdfAtX:paramA:paramB:](RTStatistics, "betaDistributionCdfAtX:paramA:paramB:", (v10 + v11) * 0.5, a3, a4);
    if (1.0 - v12 >= a6)
      v10 = (v10 + v11) * 0.5;
    else
      v11 = (v10 + v11) * 0.5;
