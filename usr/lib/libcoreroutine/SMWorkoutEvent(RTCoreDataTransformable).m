...
LABEL_10:
  ...
  objc_msgSend((id)objc_opt_class(), "createWithSMWorkoutEventMO:", v3);
...
+ (id)createWithSMWorkoutEventMO:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    *(_QWORD *)buf = 0;
    v13 = buf;
    v14 = 0x3032000000;
    v15 = __Block_byref_object_copy__164;
    v16 = __Block_byref_object_dispose__164;
    v17 = 0;
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: workoutEventMO", buf, 2u);
    }
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(MEMORY[0x1E0D8BAB8], "createWithManagedObject:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * v9), (_QWORD)v12);
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[SMWorkoutEventMO managedObjectWithSMWorkoutEvent:inManagedObjectContext:](SMWorkoutEventMO, "managedObjectWithSMWorkoutEvent:inManagedObjectContext:", a1, a3);
