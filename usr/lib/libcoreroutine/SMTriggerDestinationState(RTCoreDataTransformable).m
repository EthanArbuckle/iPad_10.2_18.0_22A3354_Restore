...
LABEL_7:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 1024;
      v12 = 33;
      _os_log_error_impl(&dword_1D1A22000, v5, OS_LOG_TYPE_ERROR, "managedObject, %@, is not supported by SMTriggerDestinationState+CoreDataTransformable (in %s:%d)", (uint8_t *)&v7, 0x1Cu);
    }

    goto LABEL_7;
  }
  objc_msgSend((id)objc_opt_class(), "createWithSMTriggerDestinationStateMO:", v3);
...
+ (id)createWithSMTriggerDestinationStateMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: triggerDestinationStateMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[SMTriggerDestinationStateMO initWithTriggerDestinationState:inManagedObjectContext:](SMTriggerDestinationStateMO, "initWithTriggerDestinationState:inManagedObjectContext:", a1, a3);
