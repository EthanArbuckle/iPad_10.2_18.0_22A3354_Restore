...
- (char)_init
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&off_1EFCDAD48;
  v1 = (char *)objc_msgSendSuper2(&v6, sel_init);
  v2 = v1;
  if (v1)
  {
    v3 = (int)*MEMORY[0x1E0DDD2A0];
    v4 = *(void **)&v1[v3];
    *(_QWORD *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E0DDD298]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD2A8]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E0DDD2B0]] = 0;
    v2[*MEMORY[0x1E0DDD2B8]] = 0;
  }
  return v2;
}
...
- (id)description
{
  ...
  objc_msgSend(v2, "stringWithFormat:", CFSTR("%@, confidence %d, occurrences %d, reason %d, suggested %d"), v4, objc_msgSend(a1, "confidence"), objc_msgSend(a1, "occurrences"), objc_msgSend(a1, "reason"), objc_msgSend(a1, "suggested"));
