...
LABEL_10:
  ...
  v8 = -[RTElevationMO initWithContext:]([RTElevationMO alloc], "initWithContext:", v6);
  objc_msgSend(v5, "elevation");
  -[RTElevationMO setElevation:](v8, "setElevation:");
  objc_msgSend(v5, "startDate");
  v9 = (void *)objc_claimAutoreleasedReturnValue();
  -[RTElevationMO setStartDate:](v8, "setStartDate:", v9);

  objc_msgSend(v5, "endDate");
  v10 = (void *)objc_claimAutoreleasedReturnValue();
  -[RTElevationMO setEndDate:](v8, "setEndDate:", v10);

  objc_msgSend(v5, "elevationUncertainty");
  -[RTElevationMO setElevationUncertainty:](v8, "setElevationUncertainty:");
  -[RTElevationMO setEstimationStatus:](v8, "setEstimationStatus:", (__int16)objc_msgSend(v5, "estimationStatus"));
LABEL_8:
...
+ (id)fetchRequest
{
  return (id)objc_msgSend(MEMORY[0x1E0C97B48], "fetchRequestWithEntityName:", CFSTR("RTElevationMO"));
}
