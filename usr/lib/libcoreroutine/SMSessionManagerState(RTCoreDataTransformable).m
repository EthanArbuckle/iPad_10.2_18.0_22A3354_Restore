...
LABEL_7:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 1024;
      v12 = 35;
      _os_log_error_impl(&dword_1D1A22000, v5, OS_LOG_TYPE_ERROR, "managedObject, %@, is not supported by SMSessionManagerState+CoreDataTransformable (in %s:%d)", (uint8_t *)&v7, 0x1Cu);
    }

    goto LABEL_7;
  }
  objc_msgSend((id)objc_opt_class(), "createWithSMSessionManagerStateMO:", v3);
...
+ (id)createWithSMSessionManagerStateMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D1A22000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: sessionManagerStateMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  ...
  if (a3)
  {
    +[SMSessionManagerStateMO initWithSessionManagerState:inManagedObjectContext:](SMSessionManagerStateMO, "initWithSessionManagerState:inManagedObjectContext:", a1, a3);
