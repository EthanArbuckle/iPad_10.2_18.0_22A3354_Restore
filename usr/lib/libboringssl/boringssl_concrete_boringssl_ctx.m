...
- (void)dealloc
{
  __SecTrust *peer_trust_ref;
  __SecKey *peer_public_key;
  __CFArray *peer_cert_chain;
  __CFArray *server_raw_public_key_certificates;
  __CFArray *client_raw_public_key_certificates;
  char *subject_name;
