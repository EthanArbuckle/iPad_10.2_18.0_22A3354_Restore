...
+ (id)PerformScript:(unint64_t)a3 seHandle:(id)a4 logSink:(id)a5
{
  ...
  v9->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA790;
  v11 = v7;
  v9[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA7E0;
  ...
  v14->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA820;
  v16 = v8;
  v14[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA870;
...
+ (id)PerformScriptWithName:(id)a3 seHandle:(id)a4 logSink:(id)a5
{
  ...
  v10->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA790;
  v12 = v8;
  v10[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA7E0;
  ...
  v15->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA820;
  v17 = v9;
  v15[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA870;
...
+ (id)PerformRecovery:(id)a3 logSink:(id)a4
{
  ...
  v7->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA790;
  v9 = v5;
  v7[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA7E0;
  ...
  v12->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA820;
  v14 = v6;
  v12[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA870;
...
+ (id)PerformScript:(unint64_t)a3 sefwPath:(id)a4 seHandle:(id)a5 logSink:(id)a6
{
  ...
  v12->__shared_weak_owners_ = 0;
  v12->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA790;
  v14 = v10;
  v12[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA7E0;
  v12[1].__shared_owners_ = (uint64_t)v14;
  v63 = v12 + 1;
  v64 = v12;
  do
  ...
  v17->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA820;
  v19 = v11;
  v17[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA870;
...
LABEL_14:
  ...
  caulk::__expected_detail::base<gsl::not_null<std::shared_ptr<SLAM::DefaultScriptProvider>>,SLAM::Error>::~base((uint64_t)v59);
  v41 = v62;
  if (v62)
  {
...
+ (id)PerformScriptWithName:(id)a3 sefwPath:(id)a4 seHandle:(id)a5 logSink:(id)a6
{
  ...
  v13->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA790;
  v15 = v11;
  v13[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA7E0;
  ...
  v18->__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA820;
  v20 = v12;
  v18[1].__vftable = (std::__shared_weak_count_vtbl *)&off_24D1BA870;
...
LABEL_14:
  ...
  caulk::__expected_detail::base<gsl::not_null<std::shared_ptr<SLAM::DefaultScriptProvider>>,SLAM::Error>::~base((uint64_t)v62);
  v42 = v65;
  if (v65)
  {
