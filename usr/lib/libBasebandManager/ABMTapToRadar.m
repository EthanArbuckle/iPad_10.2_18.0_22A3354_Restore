...
+ (id)sharedInstance
{
  if (qword_1ED70FF70 != -1)
    dispatch_once(&qword_1ED70FF70, &__block_literal_global_2);
...
void __21__ABMTapToRadar_init__block_invoke(uint64_t a1)
{
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 32) + 8) = 0;
  ...
  v2 = (const void *)*MEMORY[0x1E0CFB028];
  v3 = strlen((const char *)*MEMORY[0x1E0CFB028]);
...
- (BOOL)checkAudioTraces_sync
{
  ...
  v3 = (const char **)MEMORY[0x1E0CFBD20];
  if (!v2)
    v3 = (const char **)MEMORY[0x1E0CFBB60];
  v4 = *v3;
  v5 = strlen(*v3);
...
- (BOOL)checkTraces_sync:(int)a3
{
  ...
  if (((1 << a3) & 0x26) == 0)
  {
    if (((1 << a3) & 0x18) == 0)
      return v19;
    v7 = (const void *)*MEMORY[0x1E0CFAF68];
    v8 = strlen((const char *)*MEMORY[0x1E0CFAF68]);
...
LABEL_22:
  ...
  v3 = (const void *)*MEMORY[0x1E0CFAF68];
  v4 = strlen((const char *)*MEMORY[0x1E0CFAF68]);
...
- (BOOL)checkNotificationCriteria:(int *)a3 :(const void *)a4 :(BOOL)a5
{
  ...
  *((_QWORD *)v12 + 1) = v10;
  ...
  v79 = v11 + 1;
  operator delete(v9);
  v13 = atomic_load((unsigned __int8 *)&qword_1ED70FF78);
  if ((v13 & 1) == 0 && __cxa_guard_acquire(&qword_1ED70FF78))
  {
    qword_1ED70FF80 = (uint64_t)"mav_bedf_component_config_reset: Reset Requested by Component Cfg";
    qword_1ED70FF88 = (uint64_t)"AutoBugCapture";
    qword_1ED70FF90 = *MEMORY[0x1E0D01A78];
    __cxa_guard_release(&qword_1ED70FF78);
  }
  v14 = *((char *)a4 + 23);
  if (v14 < 0)
  {
...
LABEL_37:
        if (v26 >= 0)
          ...
          v28 = *(char **)a4;
        v29 = (const void *)qword_1ED70FF80;
        v30 = strlen((const char *)qword_1ED70FF80);
        if (v30)
        {
          v31 = v30;
          v32 = &v28[v27];
          ...
          v33 = (const void *)qword_1ED70FF88;
          v34 = strlen((const char *)qword_1ED70FF88);
          if (v34)
          {
            v35 = v34;
            if (v27 >= v34)
            {
              v60 = *(char *)qword_1ED70FF88;
              v61 = v27;
              v62 = v28;
              do
              {
            ...
            v36 = (const void *)qword_1ED70FF90;
            v37 = strlen((const char *)qword_1ED70FF90);
            if (v37)
            {
              v38 = v37;
              if (v27 >= v37)
              {
                v66 = *(char *)qword_1ED70FF90;
                v67 = v28;
                while (v27 - v38 != -1)
                {
...
- (void)showUserNotification:(int)a3 dumpReason:()basic_string<char
{
  ...
  *(_QWORD *)&buf[16] = ___ZL17sABMLogServerInitRNSt3__110shared_ptrIN3ctu9LogServerEEE_block_invoke;
  v31 = &__block_descriptor_tmp_13_2;
...
LABEL_16:
  ...
  *(_WORD *)&buf[8] = 2080;
  *(_QWORD *)&buf[10] = v14;
  _os_log_impl(&dword_1BF335000, v11, OS_LOG_TYPE_DEFAULT, "#I Show user notification for radarType: %d with header: %s", buf, 0x12u);
LABEL_21:
...
LABEL_35:
  ...
  v83 = 0x40000000;
  v84 = ___ZL17sABMLogServerInitRNSt3__110shared_ptrIN3ctu9LogServerEEE_block_invoke;
  v85 = &__block_descriptor_tmp_13_2;
...
LABEL_53:
  xpc_release(v26);
  v29 = xpc_int64_create(*(unsigned int *)(a1 + 136));
  if (!v29)
    v29 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E0CF1018], v29);
  v30 = xpc_null_create();
  xpc_release(v29);
  xpc_release(v30);
  v31 = (const char *)(a1 + 64);
  if (*(char *)(a1 + 87) < 0)
    v31 = *(const char **)v31;
  v32 = xpc_string_create(v31);
  if (!v32)
    v32 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E0CF1028], v32);
  v33 = xpc_null_create();
  xpc_release(v32);
  xpc_release(v33);
  v34 = (const char *)(a1 + 88);
  if (*(char *)(a1 + 111) < 0)
    v34 = *(const char **)v34;
  v35 = xpc_string_create(v34);
  if (!v35)
    v35 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E0CF1068], v35);
  v36 = xpc_null_create();
  xpc_release(v35);
  xpc_release(v36);
  v37 = (const char *)(a1 + 112);
  if (*(char *)(a1 + 135) < 0)
    v37 = *(const char **)v37;
  v38 = xpc_string_create(v37);
  if (!v38)
    v38 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E0CF10D8], v38);
  v39 = xpc_null_create();
  xpc_release(v38);
  xpc_release(v39);
  v40 = xpc_int64_create(0);
  if (!v40)
    v40 = xpc_null_create();
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E0CF1050], v40);
  v41 = xpc_null_create();
  xpc_release(v40);
  xpc_release(v41);
  ...
  {
    if (MEMORY[0x1C3B8A86C](v42) == MEMORY[0x1E0C812C8])
    {
      xpc_retain(v42);
      v43 = v42;
    }
  ...
  v70[0] = v19;
  v70[1] = 3321888768;
  v71 = __38__ABMTapToRadar_showNotification___::__block_invoke_2;
  v72 = &__block_descriptor_40_e8_32c16_ZTSN3xpc5arrayE_e10_v16__0r_v8l;
  v73 = v43;
  if (v43)
    xpc_retain(v43);
  else
  ...
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E0CF1100], v46);
  v47 = xpc_null_create();
  xpc_release(v46);
  xpc_release(v47);
  v69 = (xpc_object_t)0xAAAAAAAAAAAAAAAALL;
...
LABEL_91:
  ...
  *(_OWORD *)v67 = v51;
  ...
  if (sABMLogServerInit(std::shared_ptr<ctu::LogServer> &)::sOnce == -1)
  {
    ...
    v65 = GetABMLogServer(void)::sLogServer;
    if (*((_QWORD *)&GetABMLogServer(void)::sLogServer + 1))
      goto LABEL_98;
  }
  else
...
LABEL_98:
  ...
  v56 = *((_QWORD *)GetGlobalLogger((uint64_t *)&v65) + 4);
  if (v53)
  {
  ...
  {
    xpc::dict::to_debug_string((xpc::dict *)&xdict, &block);
    v64 = SHIBYTE(v84) >= 0 ? (void **)&block : block;
    *(_DWORD *)buf = 136315138;
    v88 = v64;
    _os_log_error_impl(&dword_1BF335000, v56, OS_LOG_TYPE_ERROR, "Failed to file the radar: %s", buf, 0xCu);
    if (SHIBYTE(v84) < 0)
