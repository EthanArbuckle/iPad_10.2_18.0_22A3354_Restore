...
{
  Class i;
  void (*v4)(OS_mrc_object *, SEL);
  objc_super v5;

  for (i = self[2].super.super.isa; i; i = *(Class *)i)
  {
    v4 = (void (*)(OS_mrc_object *, SEL))*((_QWORD *)i + 5);
    if (v4)
      v4(self, a2);
  }
  v5.receiver = self;
  v5.super_class = (Class)OS_mrc_object;
  -[OS_mrc_object dealloc](&v5, sel_dealloc);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0
    ...
    && (v7 = (uint64_t (*)(OS_mrc_object *, id))*((_QWORD *)isa + 4)) != 0)
  {
    return v7(self, a3);
  }
  else
