...
+ (id)sysdiagnoseEnumerator:(id)a3 WithVolume:(id)a4 WithFlags:(unint64_t)a5
{
  ...
  if (v13)
  {
    ...
    v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v18, "enumeratorAtURL:includingPropertiesForKeys:options:errorHandler:", v13, v19, a5, &stru_10000C738));
...
- (id)initCacheEnumeratorWithVolume:(id)a3 WithFlags:(unint64_t)a4
{
  ...
  v6 = (__CFString *)a3;
  v31.receiver = self;
  v31.super_class = (Class)SDCacheEnumerator;
  v7 = -[SDCacheEnumerator init](&v31, "init");
  if (v7)
  {
    if (!v6)
      v6 = CFSTR("/");
    ...
    v30 = 0u;
    obj = v10;
    v12 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v27, v34, 16);
    if (v12)
    {
      v13 = v12;
      v14 = *(_QWORD *)v28;
      do
      {
        for (i = 0; i != v13; i = (char *)i + 1)
        {
          ...
          v17 = objc_msgSend((id)objc_opt_class(v7), "sysdiagnoseEnumerator:WithVolume:WithFlags:", v16, v6, a4);
          ...
          else
          {
            ...
            {
              v21 = objc_msgSend(objc_retainAutorelease(v16), "UTF8String");
              *(_DWORD *)buf = 136446210;
              v33 = v21;
        ...
        v13 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v27, v34, 16);
      }
      while (v13);
    }

    v22 = (NSArray *)objc_msgSend(v11, "copy");
