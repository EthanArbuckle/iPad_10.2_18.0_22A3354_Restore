...
- (BTXpcService)initWithName:(const char *)a3 sessionClass:(Class)a4
{
  ...
  if (v10)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, 0, (CFNotificationCallback)sub_100004200, CFSTR("com.apple.language.changed"), 0, CFNotificationSuspensionBehaviorDeliverImmediately);
    p_isa = &v16->super.isa;
  }
  else
  {
...
- (void)_handleEvent:(id)a3
{
  ...
  else
  {
    v6 = type;
    v7 = qword_10000C908;
    v8 = os_log_type_enabled((os_log_t)qword_10000C908, OS_LOG_TYPE_ERROR);
    if (v6 == (xpc_type_t)&_xpc_type_error)
    {
      if (v8)
        sub_100005D78((uint64_t)v4, v7, v9, v10, v11, v12, v13, v14);
    }
    else if (v8)
    {
      sub_100005DE0((uint64_t)v4, v7, v9, v10, v11, v12, v13, v14);
    }
  }
