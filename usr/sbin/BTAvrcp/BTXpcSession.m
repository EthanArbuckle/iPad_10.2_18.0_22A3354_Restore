...
- (id)numberForKey:(const char *)a3 optional:(BOOL)a4 dict:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTXpcSession _objectForKey:dict:optional:converters:](self, "_objectForKey:dict:optional:converters:", a3, v9, v5, qword_10001F188));
...
- (id)stringForKey:(const char *)a3 optional:(BOOL)a4 dict:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTXpcSession _objectForKey:dict:optional:converters:](self, "_objectForKey:dict:optional:converters:", a3, v9, v5, qword_10001F198));
...
- (id)xpcDictForKey:(const char *)a3 optional:(BOOL)a4 dict:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTXpcSession _objectForKey:dict:optional:converters:](self, "_objectForKey:dict:optional:converters:", a3, v9, v5, qword_10001F1A8));
