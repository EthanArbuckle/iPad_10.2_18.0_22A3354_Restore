...
LABEL_40:
  ...
  v684[1] = 3221225472;
  v685 = (void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))sub_1000776B8;
  v686 = &unk_1000D5290;
  v687 = &v689;
  v688 = &v693;
  sub_1000776B8((uint64_t)v684, v7, v8, v9, v10, v11, v12, v13);
  v15 = v694[3];
  do
  {
...
LABEL_787:
  ...
  if (!v67)
  {
    ...
    -[__CFString UTF8String](v66, "UTF8String");
    objc_msgSend(objc_msgSend(v697, "debugDescription"), "UTF8String");
    sub_10002AAC4("CallTreeFrameLineRegex", "SPTextualReportParser.m", 1858, "%s: Unable to compile regex %s: %s", v570, v571, v572, v573, (char)"regex");
LABEL_1042:
    abort();
  }
  v643 = v67;
  ...
  if (!v69)
  {
    if (byte_1000E3CF8)
    {
      ...
      if (os_log_type_enabled(v459, OS_LOG_TYPE_ERROR))
        sub_1000922A8((uint64_t)-[__CFString UTF8String](v68, "UTF8String"), buf);
      *__error() = v458;
    }
    if (byte_1000E3CF9 && dword_1000E34A8 <= 3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v415, OS_LOG_TYPE_FAULT))
          sub_100092268((uint64_t)-[__CFString UTF8String](v68, "UTF8String"), v702);
        if (qword_1000E3D00)
          v416 = (FILE *)qword_1000E3D00;
        else
          v416 = __stderrp;
        fwrite("UNABLE TO FORMAT STRING\n", 0x18uLL, 1uLL, v416);
      }
  ...
  if (!v71)
  {
    if (byte_1000E3CF8)
    {
      ...
      if (os_log_type_enabled(v461, OS_LOG_TYPE_ERROR))
        sub_1000922A8((uint64_t)-[__CFString UTF8String](v70, "UTF8String"), buf);
      *__error() = v460;
    }
    if (byte_1000E3CF9 && dword_1000E34A8 <= 3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v420, OS_LOG_TYPE_FAULT))
          sub_100092268((uint64_t)-[__CFString UTF8String](v70, "UTF8String"), v702);
        if (qword_1000E3D00)
          v421 = (FILE *)qword_1000E3D00;
        else
          v421 = __stderrp;
        fwrite("UNABLE TO FORMAT STRING\n", 0x18uLL, 1uLL, v421);
      }
  ...
  if (!v72)
  {
    if (byte_1000E3CF8)
    {
      ...
      if (os_log_type_enabled(v463, OS_LOG_TYPE_ERROR))
        sub_1000922A8((uint64_t)objc_msgSend(CFSTR("^UUID:(?<whitespace>\\s*)(?:<?(?<binaryUuid>[\\dabcdef\\-]{32,36})>?|(?<binaryIndex>\\d+))$"), "UTF8String"), buf);
      *__error() = v462;
    }
    if (byte_1000E3CF9 && dword_1000E34A8 <= 3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v425, OS_LOG_TYPE_FAULT))
          sub_100092268((uint64_t)objc_msgSend(CFSTR("^UUID:(?<whitespace>\\s*)(?:<?(?<binaryUuid>[\\dabcdef\\-]{32,36})>?|(?<binaryIndex>\\d+))$"), "UTF8String"), v702);
        if (qword_1000E3D00)
          v426 = (FILE *)qword_1000E3D00;
        else
          v426 = __stderrp;
        fwrite("UNABLE TO FORMAT STRING\n", 0x18uLL, 1uLL, v426);
      }
    ...
    v552 = "UUIDLineRegex";
LABEL_1041:
    sub_10002AAC4(v552, "SPTextualReportParser.m", v551, "%s: Unable to compile regex %s", v547, v548, v549, v550, (char)"regex");
    goto LABEL_1042;
  }
  v612 = v72;
  v683 = 0;
  ...
  else
  {
    ...
    *(_QWORD *)&buf[16] = sub_10007D434;
    *(_QWORD *)&buf[24] = &unk_1000D5E68;
    *(_QWORD *)&buf[32] = v643;
    *(_QWORD *)&buf[40] = &v683;
    *(_QWORD *)&buf[48] = &v681;
    v704 = &v682;
    sub_10007A4EC(v14, 0, (uint64_t)buf);
    if (v681 <= 0)
    {
      if (byte_1000E3CF8)
      {
...
LABEL_268:
  if (self->_symbolicate)
  {
    ...
    sub_100077B0C(v14, (uint64_t)v643, (uint64_t)v618, v654, self->_useDsymForUUIDForEverything, (uint64_t)self->_findDsymsForIDs);
  }
  v657 = sub_100077CE4(v14, 0, (uint64_t)v618, v654);
  if (!v657)
  {
    if (byte_1000E3CF8)
    {
      ...
      if (!v162)
      {
        ...
        if (v199)
        {
          ...
          if (v202 == (id)0x7FFFFFFFFFFFFFFFLL)
            goto LABEL_349;
          v290 = sub_100079930(-[NSString substringWithRange:](v154, "substringWithRange:", v202, v201));
...
LABEL_303:
        ...
        if (self->_isHeavy != v683 && obj)
        {
          ...
          objc_msgSend(obj, "sortUsingComparator:", &stru_1000D5D08);
...
LABEL_1087:
            if (byte_1000E3CF8)
            {
              ...
              if (os_log_type_enabled(v586, OS_LOG_TYPE_ERROR))
                sub_100092380((uint64_t)objc_msgSend(objc_msgSend(v317, "debugDescription"), "UTF8String"), buf);
              *__error() = v585;
            }
            if (byte_1000E3CF9)
              v575 = dword_1000E34A8 <= 3;
            else
              v575 = 0;
            if (v575)
            {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v590, OS_LOG_TYPE_FAULT))
                  sub_100092340((uint64_t)objc_msgSend(objc_msgSend(v317, "debugDescription"), "UTF8String"), v702);
                if (qword_1000E3D00)
                  v591 = (FILE *)qword_1000E3D00;
                else
                  v591 = __stderrp;
                fwrite("UNABLE TO FORMAT STRING\n", 0x18uLL, 1uLL, v591);
              }
            ...
            sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 839, "%s: No angle bracket contents nor state info for non-frame (%s)", v576, v577, v578, v579, (char)"heaviestNode.angleBracketContents || heaviestNode.stateInfo");
            abort();
          }
          ...
          if (v328)
          {
            ...
            while (1)
            {
              ...
              sub_10007999C(v645, v681 + v682 * (v647 + v329++), *((_BYTE *)v317 + 8) & 1, *((_DWORD *)v317 + 3), v652, (const char *)objc_msgSend(v332, "UTF8String"), *((_QWORD *)v317 + 4), (const char *)objc_msgSend(*((id *)v317 + 5), "UTF8String"), 0, 0);
              v328 = (void *)*((_QWORD *)v317 + 2);
            }
...
LABEL_616:
              ...
              {
                objc_msgSend(v336, "sortUsingComparator:", &stru_1000D5D08);
          ...
          else
          {
            ...
            if (!v335 && !*((_QWORD *)v317 + 5))
              goto LABEL_1087;
            sub_10007A29C(v645, v681 + v682 * (v327 + v620), *((_BYTE *)v317 + 8) & 1, *((_DWORD *)v317 + 3), v652, (const char *)objc_msgSend(v335, "UTF8String"), (uint64_t)objc_msgSend(*((id *)v317 + 5), "UTF8String"), 0, 0);
          }
          v622 = v625;
          goto LABEL_616;
        }
        ...
        if (-[NSString containsString:](v154, "containsString:", CFSTR("Binary Images:")))
        {
          ...
          if (v648)
          {
            ...
            while (1)
            {
              ...
              v633 = (const char *)objc_msgSend(sub_100070F00(v373), "UTF8String");
              if (v373)
                v379 = *(void **)(v373 + 40);
              else
                v379 = 0;
              ...
              if ((int)v392 > (int)v357)
              {
                ...
                sub_10002AAC4("PrintLoadInfoLine", "SPTextualReportParser.m", 2436, "%s: Printed %d characters when max is %d: %s, %s, %s", v388, v389, v390, v391, (char)"numChars < nameAndVersionWidth + 1");
                abort();
              }
          ...
          if ((v654 & 1) == 0)
          {
            ...
            v657 = sub_100077CE4(v14, v642, (uint64_t)v618, 0);
          }
          Weak = 0;
          v610 = 0;
          v619 = 0;
...
LABEL_549:
      ...
      v671 = 0;
      v670 = 0;
      sub_100079AA8(v154, v642, v162, v654, v681, v682, &v676, &v675, &v674, &v673, &v672, &v697, &v671, (int *)&v670 + 1, &v670);
      v163 = v697;
      v164 = v697;
      v165 = v671;
      v166 = v671;
...
LABEL_952:
            ...
            -[NSString UTF8String](v497, "UTF8String");
            sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 659, "%s: Non-frame line has count but no indent level (%d: %s)", v581, v582, v583, v584, (char)"rawIndentLevel >= 0");
            abort();
          }
        }
      }
...
LABEL_481:
        ...
        sub_10007A29C(v645, v263 + (v260 + v172) * v262, v264, v167, v635, v265, (uint64_t)v266, SHIDWORD(v670), v670);
        v258 = v622;
        v6 = v617;
        v171 = v651;
        goto LABEL_579;
      ...
      if (!(_DWORD)v172)
      {
        ...
        while (1)
        {
          for (i = 0; i != v294; i = (char *)i + 1)
          {
            ...
            if ((sub_100070AB4((uint64_t)Weak, v674, 0, -1, (uint64_t)v671, (uint64_t)v697) & 1) != 0)
            {
              v171 = v651;
              if (Weak)
                goto LABEL_578;
LABEL_576:
              Weak = sub_100070470((uint64_t)SPTreeNode, 0, v674, 0, (void *)0xFFFFFFFFFFFFFFFFLL, v671, v697);
...
LABEL_545:
      ...
      if (!Weak)
      {
        ...
        sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 716, "%s: no previousNode for indent of %d (%d: %s)", v538, v539, v540, v541, (char)"previousNode");
LABEL_941:
        abort();
      }
      ...
      do
      {
        ...
        if (!Weak)
        {
          ...
          -[NSString UTF8String](v256, "UTF8String");
          sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 721, "%s: no previousNode for indent %d, previousIndentLevel %d (%d: %s)", v488, v489, v490, v491, (char)"previousNode");
          goto LABEL_941;
        }
        v261 = v640 - 1;
      ...
      LODWORD(v640) = v261;
LABEL_478:
      Weak = sub_10007092C((uint64_t)Weak, v674, 0, (void *)0xFFFFFFFFFFFFFFFFLL, v165, v163);
      v171 = v651;
LABEL_577:
      if (Weak)
LABEL_578:
...
LABEL_583:
    ...
    LOBYTE(v671) = 0;
    LOBYTE(v676) = 0;
    v156 = sub_100077DE0(v154, v155, v654, v681, v682);
    v634 = objc_msgSend(v155, "rangeWithName:", CFSTR("kernelDot"));
    v697 = (id)-1;
    v157 = sub_100077E74(v154, v642, v155, v657, v654, (unint64_t *)&v697);
    v158 = (unint64_t)v157;
    v627 = v156;
    v630 = v154;
    if (v616 == -1)
    ...
    if (v177 == (id)0x7FFFFFFFFFFFFFFFLL)
      ...
      v178 = (int)sub_100079930(-[NSString substringWithRange:](v630, "substringWithRange:", v177, v176));
    v179 = v697;
    LOBYTE(v671) = 0;
    *(_QWORD *)buf = _NSConcreteStackBlock;
    *(_QWORD *)&buf[8] = 3221225472;
    *(_QWORD *)&buf[16] = sub_10007D238;
    *(_QWORD *)&buf[24] = &unk_1000D5E40;
    *(_QWORD *)&buf[32] = v643;
    *(_QWORD *)&buf[40] = v621;
    v713 = v654;
    v710 = v681;
    ...
    *(_QWORD *)&buf[48] = v158;
    ...
    v706 = &v671;
    v709 = v178;
    sub_10007A4EC(v14, v642, (uint64_t)buf);
    v180 = v676;
    if ((_BYTE)v676)
      v181 = (uint64_t)v179;
    else
    ...
    {
      v639 = sub_100079930(-[NSString substringWithRange:](v630, "substringWithRange:", v186, v185));
      if ((v654 & 1) != 0)
      {
        v649 = sub_10007CB30(v630, v155, v158, (uint64_t)v179, v183 != 0, v180 != 0);
        v187 = 0;
        v188 = 0;
        LODWORD(v158) = 0;
        v189 = 0;
...
LABEL_483:
                  ...
                  while (v267 < (unint64_t)objc_msgSend(v649, "count"))
                  {
                    ...
                    v189 = v269;
                    sub_10007999C(v645, v275, v634 != (id)0x7FFFFFFFFFFFFFFFLL, v639, v619, v273, v624, v274, v613, v269);
                    ++v267;
                    v6 = v617;
                  }
...
LABEL_548:
              ...
              if ((_DWORD)v627)
              {
                if (!Weak)
                {
                  ...
                  -[NSString UTF8String](v630, "UTF8String");
                  sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 578, "%s: no previousNode for indent of %d (%d: %s)", v518, v519, v520, v521, (char)"previousNode");
                  goto LABEL_887;
                }
                if ((int)v640 >= (int)v627)
                {
                  ...
                  -[NSString UTF8String](v630, "UTF8String");
                  sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 583, "%s: no previousNode for indent %d, previousIndentLevel %d (%d: %s)", v452, v453, v454, v455, (char)"previousNode");
LABEL_887:
                  abort();
                }
LABEL_423:
                Weak = sub_10007092C((uint64_t)Weak, v634 != (id)0x7FFFFFFFFFFFFFFFLL, v649, (void *)v624, v188, 0);
              }
              else
              {
                if (obj)
...
LABEL_448:
                    ...
                    while (1)
                    {
                      ...
                      if ((sub_100070AB4((uint64_t)Weak, v634 != (id)0x7FFFFFFFFFFFFFFFLL, v649, v624, (uint64_t)v188, 0) & 1) != 0)break;
                      if (v251 == (id)++v253)
                      {
                        v251 = objc_msgSend(obj, "countByEnumeratingWithState:objects:count:", &v677, v701, 16);
                        if (v251)
...
LABEL_525:
                Weak = sub_100070470((uint64_t)SPTreeNode, 0, v634 != (id)0x7FFFFFFFFFFFFFFFLL, v649, (void *)v624, v188, 0);
                objc_msgSend(obj, "addObject:", Weak);
              }
              if (Weak)
LABEL_527:
        ...
        -[NSString UTF8String](v630, "UTF8String");
        sub_10002AAC4("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 484, "%s: No frame bodies in %s (%d: %s)", v438, v439, v440, v441, (char)"frameBodies.firstObject.length > 0");
LABEL_1086:
        abort();
      }
      if (objc_msgSend(v155, "rangeWithName:", CFSTR("countAndWhitespace")) != (id)0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        {
          v624 = sub_100079930(-[NSString substringWithRange:](v630, "substringWithRange:", v192, v191));
        }
        v649 = sub_10007CB30(v630, v155, v158, (uint64_t)v179, v183 != 0, v180 != 0);
        ...
        {
          v158 = sub_100079930(-[NSString substringWithRange:](v630, "substringWithRange:", v196, v195));
          v198 = objc_msgSend(v155, "rangeWithName:", CFSTR("endIndex"));
          if (v198 == (id)0x7FFFFFFFFFFFFFFFLL)
            v189 = v158;
          else
            v189 = sub_100079930(-[NSString substringWithRange:](v630, "substringWithRange:", v198, v197));
        }
        goto LABEL_363;
      }
      if (byte_1000E3CF8)
    ...
    sub_10002AAC4("ParseFrameLine", "SPTextualReportParser.m", v567, v566, v562, v563, v564, v565, (char)"range.location != NSNotFound");
    goto LABEL_1086;
  }
  v22 = 0;
  obj = 0;
