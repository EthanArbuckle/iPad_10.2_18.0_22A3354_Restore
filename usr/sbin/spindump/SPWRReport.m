  ...
  if (!((unint64_t)a7 | (unint64_t)a8))
  {
    if (byte_1000E3CF8)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        sub_10007DAE0(v17, v18, v19, v20, v21, v22, v23, v24);
      *__error() = v16;
    }
    if (byte_1000E3CF9)
      v25 = dword_1000E34A8 <= 3;
    else
      v25 = 0;
    if (v25)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT))
          sub_10007DA70(v28, v29, v30, v31, v32, v33, v34, v35);
        if (qword_1000E3D00)
    ...
    sub_10002AAC4("-[SPWRReport initWithReportReason:reportedSignpostTracker:task:timeRange:thread:dispatchQueue:]", "monitor-WorkflowResponsiveness.m", 95, "%s: No thread nor dispatch queue", (uint64_t)a5, (uint64_t)a6, (uint64_t)a7, (uint64_t)a8, (char)"thread || dispatchQueue");
    abort();
  }
