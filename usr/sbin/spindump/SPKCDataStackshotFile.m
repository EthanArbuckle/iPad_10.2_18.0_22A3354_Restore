...
LABEL_139:
  ...
  sub_10005A478(v60, (byte_1000E3D0C >> 3) & 1, (byte_1000E3D0C >> 2) & 1, (byte_1000E3D0C & 0x10) == 0);
  v83 = objc_alloc((Class)NSData);
  v84 = objc_msgSend(v83, "initWithBytesNoCopy:length:deallocator:", v35, v86.st_size, &stru_1000D5890);
