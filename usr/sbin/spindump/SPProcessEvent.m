...
- (void)takeTransaction
{
  ...
  {
    v3 = (void *)sub_10002AA34("Process Event [%d]", self->_targetProcessId);
...
- (SPProcessEvent)init
{
  ...
  if (v2)
  {
    *(_WORD *)&v2->_useDsymForUUIDForEverything = 0;
    ...
    v4 = byte_1000E3D0C;
    v3->_shouldSymbolicate = (byte_1000E3D0C & 8) != 0;
  ...
  if ((self->_targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000E3CF8)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
        sub_10008CDF8(p_targetProcessId);
      *__error() = v4;
    }
    if (byte_1000E3CF9)
      v6 = dword_1000E34A8 <= 0;
    else
      v6 = 0;
    if (!v6)
      goto LABEL_50;
    v7 = *__error();
    v8 = sub_10002AB88(self->_targetProcessId);
...
LABEL_49:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      sub_10008CD78(p_targetProcessId);
    goto LABEL_37;
  }
  if (byte_1000E3CF8)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      sub_10008CEE0((uint64_t)self, v15, v16);
    *__error() = v14;
  }
  if (byte_1000E3CF9)
    v17 = dword_1000E34A8 <= 0;
  else
    v17 = 0;
  if (v17)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_FAULT))
      sub_10008CE78((uint64_t)&self->_transaction, v26, v27, v28, v29, v30, v31, v32);
LABEL_37:
    if (qword_1000E3D00)
...
- (double)dataDuration
{
  ...
  if (dataTimeRange)
    return sub_10005BB24(-[SATimeRange startTime](dataTimeRange, "startTime"), -[SATimeRange endTime](self->_dataTimeRange, "endTime"));
  else
    return 0.0;
}
...
- (double)eventDuration
{
  ...
  if (eventTimeRange)
    return sub_10005BB24(-[SATimeRange startTime](eventTimeRange, "startTime"), -[SATimeRange endTime](self->_eventTimeRange, "endTime"));
  else
    return 0.0;
}
...
- (double)overlapDuration
{
  ...
  if (dataTimeRange)
  {
    ...
    return sub_10005BB24(v7, -[SATimeRange endTime](*p_eventTimeRange, "endTime"));
  }
  if (eventTimeRange)
  {
...
- (void)_setupSampleStore:(id)a3
{
    ...
    if (targetProcessId < 0)
    {
      if (byte_1000E3CF8)
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
          sub_10008D0B4(v62, v63, v64, v65, v66, v67, v68, v69);
        *__error() = v61;
      }
      if (byte_1000E3CF9)
        v70 = dword_1000E34A8 <= 3;
      else
        v70 = 0;
      if (v70)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v73, OS_LOG_TYPE_FAULT))
            sub_10008D044(v73, v74, v75, v76, v77, v78, v79, v80);
          if (qword_1000E3D00)
            v81 = (FILE *)qword_1000E3D00;
          else
            v81 = __stderrp;
          fwrite("UNABLE TO FORMAT STRING\n", 0x18uLL, 1uLL, v81);
        }
      ...
      sub_10002AAC4("-[SPProcessEvent _setupSampleStore:]", "SPProcessEvent.m", 267, "%s: nil sampleStore", v3, v4, v5, v6, (char)"sampleStore");
    }
    else
    {
      if (byte_1000E3CF8)
      ...
      if (byte_1000E3CF9)
        v55 = dword_1000E34A8 <= 3;
      else
        v55 = 0;
      if (v55)
      {
        v56 = *__error();
        v57 = sub_10002AB88(*p_targetProcessId);
      ...
      v91 = sub_10002AB88(*p_targetProcessId);
      sub_10002AAC4("-[SPProcessEvent _setupSampleStore:]", "SPProcessEvent.m", 267, "%s [%d]: %s: nil sampleStore", v92, v93, v94, v95, v91);
    }
    abort();
  }
  if ((targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000E3CF8)
    {
      ...
      {
        v13 = sub_10002AB88(*p_targetProcessId);
    ...
    if (byte_1000E3CF9)
      v15 = dword_1000E34A8 <= 1;
    else
      v15 = 0;
    if (!v15)
      goto LABEL_48;
    v16 = *__error();
    v17 = sub_10002AB88(*p_targetProcessId);
...
LABEL_48:
  ...
  sub_10005A478(a3, self->_shouldSymbolicate, self->_useDsymForUUIDForEverything, self->_shouldUseBulkSymbolication);
...
- (id)_samplePrinterForSampleStore:(id)a3
{
  ...
  if (!v5)
  {
    ...
    else
    {
      ...
      if (byte_1000E3CF9)
        v12 = dword_1000E34A8 <= 3;
      else
        v12 = 0;
      if (!v12)
        return 0;
      v13 = *__error();
      v14 = sub_10002AB88(*p_targetProcessId);
...
LABEL_3:
  ...
  objc_msgSend(v6, "setHeaderNote:", sub_1000495D8((int)-[SASamplePrintOptions printHeavyStacks](self->_printOptions, "printHeavyStacks"), v7));
LABEL_19:
...
- (BOOL)targetProcessIsThirdParty
{
  ...
  do
  {
    v6 = -[NSString hasPrefix:](self->_targetProcessAbsolutePath, "hasPrefix:", *(__CFString **)((char *)&off_1000D58B0 + v5));
    if ((v6 & 1) != 0)
      break;
    v7 = v5 == 40;
    v5 += 8;
