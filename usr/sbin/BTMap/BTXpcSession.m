...
- (id)numberForKey:(const char *)a3 optional:(BOOL)a4 dict:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTXpcSession _objectForKey:dict:optional:converters:](self, "_objectForKey:dict:optional:converters:", a3, v9, v5, qword_10000D050));
...
- (id)stringForKey:(const char *)a3 optional:(BOOL)a4 dict:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTXpcSession _objectForKey:dict:optional:converters:](self, "_objectForKey:dict:optional:converters:", a3, v9, v5, qword_10000D060));
...
- (id)xpcDictForKey:(const char *)a3 optional:(BOOL)a4 dict:(id)a5
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[BTXpcSession _objectForKey:dict:optional:converters:](self, "_objectForKey:dict:optional:converters:", a3, v9, v5, qword_10000D070));
...
- (id)_objectForKey:(const char *)a3 dict:(id)a4 optional:(BOOL)a5 converters:(id)a6
{
  ...
  if (v13)
  {
    v15 = +[NSValue valueWithPointer:](NSValue, "valueWithPointer:", xpc_get_type(v13));
    v16 = (void *)objc_claimAutoreleasedReturnValue(v15);
    v17 = (uint64_t (**)(_QWORD, _QWORD))objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "objectForKeyedSubscript:", v16));
    if (!v17)
    {
      v21 = (void *)objc_claimAutoreleasedReturnValue(+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"));
      objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("BTXpcSession.m"), 150, CFSTR("Invalid XPC value type for key \"%s\": %@"), a3, v14);

    }
    v18 = ((uint64_t (**)(_QWORD, void *))v17)[2](v17, v14);
  ...
  else
  {
    ...
    objc_msgSend(v16, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("BTXpcSession.m"), 154, CFSTR("Missing XPC value for key \"%s\"), a3);
    v19 = 0;
  }
