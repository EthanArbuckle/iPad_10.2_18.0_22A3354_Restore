...
- (TrustedPeersHelperHealthCheckResult)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)TrustedPeersHelperHealthCheckResult;
  ...
  if (v5)
  {
    ...
    v7 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(OTEscrowMoveRequestContext, v6), CFSTR("moveRequest"));
