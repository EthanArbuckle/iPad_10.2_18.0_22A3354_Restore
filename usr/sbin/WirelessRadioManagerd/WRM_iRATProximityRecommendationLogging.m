...
- (WRM_iRATProximityRecommendationLogging)init
{
  ...
  v2 = -[WRM_iRATProximityRecommendationLogging init](&v4, "init");
  if (v2)
  {
    -[WRM_iRATProximityRecommendationLogging setUuid:](v2, "setUuid:", objc_alloc_init((Class)NSUUID));
...
- (void)dealloc
{
  ...
  -[WRM_iRATProximityRecommendationLogging dealloc](&v3, "dealloc");
}
