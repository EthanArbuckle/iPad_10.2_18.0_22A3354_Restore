...
- (CMGpsOdometerEntry)initWithOdometerEntry:(CLOdometerEntry *)a3
{
  ...
  if (result)
  {
    ...
    *(_OWORD *)&result->gpsOdomEntry.startTime = v5;
    v8 = *(_OWORD *)&a3->timestampGps;
    v9 = *(_OWORD *)&a3->quality;
    v10 = *(_OWORD *)&a3->groundAltitude;
    ...
    *(_OWORD *)&result->gpsOdomEntry.timestampGps = v8;
    v11 = *(_OWORD *)&a3->gpsCourseRadians;
    v12 = *(_OWORD *)&a3->slope;
    v13 = *(_OWORD *)&a3->batchedLocationFixType;
...
- (id)date
{
  return +[NSDate dateWithTimeIntervalSinceReferenceDate:](NSDate, "dateWithTimeIntervalSinceReferenceDate:", self->gpsOdomEntry.startTime);
}
...
{
  __int128 v3;
  CLOdometerTrackProximityInfo v4;
  __int128 v5;
  __int128 v6;
  __int128 v7;
  __int128 v8;

  v3 = *(_OWORD *)&self->maxAbsSlope;
  *(_OWORD *)&retstr->gpsCourseRadians = *(_OWORD *)&self->gpsCourseAccuracy;
  *(_OWORD *)&retstr->slope = v3;
  v4 = *(CLOdometerTrackProximityInfo *)&self->trackProximityInfo.distanceToTrackMeters;
