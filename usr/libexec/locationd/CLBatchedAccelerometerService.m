...
+ (id)getSilo
{
  if (qword_102308180 != -1)
    dispatch_once(&qword_102308180, &stru_102183F18);
  return (id)qword_102308178;
}
...
{
  CLBatchedAccelerometerService *v2;
  CLBatchedAccelerometerService *v3;
  int64_t var0;
  objc_super v6;
  void *__p[2];
  uint64_t v8;
  ...
  v2 = -[CLBatchedSensorService initWithClientProtocol:](&v10, "initWithClientProtocol:", &OBJC_PROTOCOL___CLBatchedAccelerometerServiceClientProtocol);
  v3 = v2;
  if (v2)
  {
    ...
    if (byte_10230814F < 0)
    {
      sub_100115CE4(__p, (void *)xmmword_102308138, *((unint64_t *)&xmmword_102308138 + 1));
    }
    else
    {
      *(_OWORD *)__p = xmmword_102308138;
      v8 = unk_102308148;
    }
    v9 = dword_102308150;
    v6.receiver = v3;
...
- (void)registerForData:(id)a3
{
  ...
  {
    v13.receiver = self;
    v13.super_class = (Class)CLBatchedAccelerometerService;
    -[CLBatchedSensorService enableProvider](&v13, "enableProvider");
    if (qword_10229FFB0 != -1)
      dispatch_once(&qword_10229FFB0, &stru_102183F38);
    v4 = qword_10229FFB8;
    if (os_log_type_enabled((os_log_t)qword_10229FFB8, OS_LOG_TYPE_DEFAULT))
    {
      v12.receiver = self;
      v12.super_class = (Class)CLBatchedAccelerometerService;
    ...
    if (sub_1001BFF7C(115, 2))
    {
      ...
      v14 = 136446210;
      v15 = v7;
      _os_log_send_and_compose_impl(2, 0, __p, 1628, &_mh_execute_header, v6, 0, "[service-%{public}s] first client, creating manager", &v14, 12);
      v9 = v8;
      if (v19 < 0)
        operator delete(*(void **)buf);
      sub_100512490("Generic", 1, 0, 2, "-[CLBatchedAccelerometerService registerForData:]", "%s\n", v9);
      if (v9 != (char *)__p)
        free(v9);
    }
    objc_msgSend(-[CLBatchedAccelerometerService universe](self, "universe"), "silo");
    operator new();
  }
  v10.receiver = self;
  v10.super_class = (Class)CLBatchedAccelerometerService;
...
- (void)onBatchedData:(void *)a3 N:(int)a4
{
  NSObject *v7;
  void **v8;
  CLBatchedAccelerometerBufferWrapper *v9;
  NSMutableSet *v10;
  id v11;
  uint64_t v12;
  void *i;
  ...
  {
    v24.receiver = self;
    v24.super_class = (Class)CLBatchedAccelerometerService;
  ...
  if (sub_1001BFF7C(115, 2))
  {
    ...
    v14 = qword_10229FFB8;
    v23.receiver = self;
    v23.super_class = (Class)CLBatchedAccelerometerService;
    ...
    if (v29 < 0)
      operator delete(*(void **)buf);
    sub_100512490("Generic", 1, 0, 2, "-[CLBatchedAccelerometerService onBatchedData:N:]", "%s\n", v17);
    if (v17 != (char *)__p)
      free(v17);
  }
  v9 = -[CLBatchedAccelerometerBufferWrapper initWithMovedBuffer:]([CLBatchedAccelerometerBufferWrapper alloc], "initWithMovedBuffer:", a3);
  v21 = 0u;
  v22 = 0u;
  v19 = 0u;
  v20 = 0u;
  v18.receiver = self;
  v18.super_class = (Class)CLBatchedAccelerometerService;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v19 + 1) + 8 * (_QWORD)i), "onBatchedAccelerometerData:", v9);
      }
      v11 = -[NSMutableSet countByEnumeratingWithState:objects:count:](v10, "countByEnumeratingWithState:objects:count:", &v19, v25, 16);
    }
    while (v11);
