...
- (void)dealloc
{
  ...
  -[ALSCellTower setLocation:](self, "setLocation:", 0);
  v3.receiver = self;
  v3.super_class = (Class)ALSCellTower;
  -[ALSCellTower dealloc](&v3, "dealloc");
}
...
- (id)description
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)ALSCellTower;
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@ %@"), -[ALSCellTower description](&v3, "description"), -[ALSCellTower dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_100EFFFE8((uint64_t)self, (uint64_t)a3);
}
