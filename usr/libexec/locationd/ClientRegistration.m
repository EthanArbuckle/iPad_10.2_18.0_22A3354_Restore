...
- (void)dealloc
{
  ...
  -[ClientRegistration dealloc](&v3, "dealloc");
}
...
- (Name)name
{
  ...
  return (Name *)sub_1001AF190(retstr->fUserName.__r_.__value_.var0.var0.__data_, (__int128 *)(v1 + 16));
}
...
- (void)setName:(Name *)a3
{
  ...
  v5 = a3[2].fUserName.__r_.__value_.var0.var0.__data_[18];
  ...
  v6 = a3[4].fUserName.__r_.__value_.var0.var0.__data_[18];
...
- (void).cxx_destruct
{
  sub_100010174((uint64_t)&self->_name);
}
