...
+ (id)getSilo
{
  if (qword_102305628 != -1)
    dispatch_once(&qword_102305628, &stru_10215A768);
  return (id)qword_102305620;
}
...
- (void)beginService
{
  -[CLNotifierServiceAdapter setAdaptedNotifier:](self, "setAdaptedNotifier:", sub_1008BC8E4((uint64_t)-[CLFitnessTrackingNotifierAdapter universe](self, "universe")));
...
- (void)doAsync:(id)a3
{
  (*((void (**)(id, void *))a3 + 2))(a3, -[CLFitnessTrackingNotifierAdapter adaptee](self, "adaptee"));
}
