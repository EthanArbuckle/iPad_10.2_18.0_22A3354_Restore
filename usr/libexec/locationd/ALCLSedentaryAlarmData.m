...
- (id)description
{
  ...
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@ %@"), -[ALCLSedentaryAlarmData description](&v3, "description"), -[ALCLSedentaryAlarmData dictionaryRepresentation](self, "dictionaryRepresentation"));
}
...
- (id)dictionaryRepresentation
{
  ...
  if (type >= 8)
    ...
    v5 = (NSString *)*(&off_10213EA60 + type);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1004C25E0((uint64_t)self, (uint64_t)a3);
}
