...
- (PRBTRangingService)initWithQueue:(id)a3
{
  ...
  if (!v6)
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PRBTRangingService.mm"), 32, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("queue"));
...
{
  id v3;
  PRBTRangingService *v4;

  v3 = a3;
  v4 = -[PRBTRangingService initWithQueue:]([PRBTRangingService alloc], "initWithQueue:", v3);
...
- (BOOL)shouldAcceptNewConnection:(id)a3
{
  ...
  v7 = -[PRBTRangingService validateClientEntitlements:](self, "validateClientEntitlements:", v4);
  v8 = qword_10085F520;
  if (v7)
  {
    if (os_log_type_enabled((os_log_t)qword_10085F520, OS_LOG_TYPE_DEBUG))
      sub_1003C8AA4(v6, v8);
    v9 = -[PRBTRangingClientProxy initWithConnection:queue:]([PRBTRangingClientProxy alloc], "initWithConnection:queue:", v4, self->_queue);
...
- (void)handleXPCDisconnection:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PRBTRangingService.mm"), 112, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("proxy"));
