...
- (PRBeaconRangingService)initWithQueue:(id)a3
{
  ...
  if (!v6)
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PRBeaconRangingService.mm"), 34, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("queue"));

  }
  v12.receiver = self;
  v12.super_class = (Class)PRBeaconRangingService;
  v7 = -[PRBeaconRangingService init](&v12, "init");
  if (v7)
  {
...
{
  id v3;
  PRBeaconRangingService *v4;

  v3 = a3;
  v4 = -[PRBeaconRangingService initWithQueue:]([PRBeaconRangingService alloc], "initWithQueue:", v3);
...
- (BOOL)shouldAcceptNewConnection:(id)a3
{
  ...
  id v12;
  void *v13;
  PRBeaconRangingClientProxy *v14;
  PRBeaconRangingClientProxy *v15;
  _QWORD v17[4];
  PRBeaconRangingClientProxy *v18;
  id v19;
  int v20;
  _QWORD v21[4];
  PRBeaconRangingClientProxy *v22;
  id v23;
  int v24;
  id location;
  ...
  v7 = -[PRBeaconRangingService validateClientEntitlements:](self, "validateClientEntitlements:", v4);
  v8 = qword_10085F520;
  if (v7)
  {
    if (os_log_type_enabled((os_log_t)qword_10085F520, OS_LOG_TYPE_DEBUG))
      sub_1003C8BC0(v6, v8);
    v9 = -[PRBeaconRangingClientProxy initWithConnection:queue:]([PRBeaconRangingClientProxy alloc], "initWithConnection:queue:", v4, self->_queue);
...
- (void)handleXPCDisconnection:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PRBeaconRangingService.mm"), 113, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("proxy"));
