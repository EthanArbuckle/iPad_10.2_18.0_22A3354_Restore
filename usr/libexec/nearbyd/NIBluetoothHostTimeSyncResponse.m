...
- (NIBluetoothHostTimeSyncResponse)initWithDeviceEventCount:(unint64_t)a3 uwbDeviceTimeUs:(unint64_t)a4 uwbDeviceTimeUncertainty:(unsigned __int8)a5 uwbClockSkewMeasurementAvailable:(unsigned __int8)a6 deviceMaxPpm:(unsigned __int16)a7 success:(unsigned __int8)a8 retryDelay:(unsigned __int16)a9
{
  ...
  result = -[NIBluetoothHostTimeSyncResponse init](&v16, "init");
  if (result)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return objc_msgSend(v4, "initWithDeviceEventCount:uwbDeviceTimeUs:uwbDeviceTimeUncertainty:uwbClockSkewMeasurementAvailable:deviceMaxPpm:success:retryDelay:", self->_deviceEventCount, self->_uwbDeviceTimeUs, self->_uwbDeviceTimeUncertainty, self->_uwbClockSkewMeasurementAvailable, self->_deviceMaxPpm, self->_success, v6);
}
...
- (NIBluetoothHostTimeSyncResponse)initWithCoder:(id)a3
{
  ...
  if (self)
  {
    self->_deviceEventCount = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("deviceEventCount"));
    self->_uwbDeviceTimeUs = (unint64_t)objc_msgSend(v5, "decodeInt64ForKey:", CFSTR("uwbDeviceTimeUs"));
    ...
    self->_deviceMaxPpm = (unsigned __int16)objc_msgSend(v5, "decodeIntForKey:", CFSTR("deviceMaxPpm"));
    self->_success = objc_msgSend(v5, "decodeIntForKey:", CFSTR("success"));
    self->_retryDelay = (unsigned __int16)objc_msgSend(v5, "decodeIntForKey:", CFSTR("retryDelay"));
  }
