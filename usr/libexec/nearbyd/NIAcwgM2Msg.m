...
- (NIAcwgM2Msg)initWithSelectedUwbConfigId:(unsigned __int16)a3 selectedPulseShapeCombo:(unsigned __int8)a4 selectedChannelBitmask:(unsigned __int8)a5 supportedSyncCodeIndexBitmask:(unsigned int)a6 minRanMultiplier:(unsigned __int8)a7 supportedSlotBitmask:(unsigned __int8)a8 supportedHoppingConfigBitmask:(unsigned __int8)a9
{
  ...
  result = -[NIAcwgM2Msg init](&v16, "init");
  if (result)
  {
...
+ (id)fromStruct:(AcwgM2MsgStruct)a3
{
  ...
  LOBYTE(v4) = a3.var6;
  return objc_msgSend(objc_alloc((Class)a1), "initWithSelectedUwbConfigId:selectedPulseShapeCombo:selectedChannelBitmask:supportedSyncCodeIndexBitmask:minRanMultiplier:supportedSlotBitmask:supportedHoppingConfigBitmask:", a3.var0, a3.var1, a3.var2, a3.var3, a3.var4, a3.var5, v4);
}
...
- (NIAcwgM2Msg)initWithCoder:(id)a3
{
  ...
  if (self)
  {
    self->_selectedUwbConfigId = (unsigned __int16)objc_msgSend(v4, "decodeIntForKey:", CFSTR("selectedUwbConfigId"));
