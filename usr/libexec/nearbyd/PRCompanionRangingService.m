...
- (PRCompanionRangingService)initWithQueue:(id)a3
{
  ...
  if (!v6)
  {
    ...
    objc_msgSend(v11, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PRCompanionRangingService.mm"), 34, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("queue"));
...
{
  id v3;
  PRCompanionRangingService *v4;

  v3 = a3;
  v4 = -[PRCompanionRangingService initWithQueue:]([PRCompanionRangingService alloc], "initWithQueue:", v3);
...
- (BOOL)shouldAcceptNewConnection:(id)a3
{
  ...
  BOOL v7;
  NSObject *v8;
  PRCompanionRangingClientProxy *v9;
  id v10;
  void *v11;
  id v12;
  void *v13;
  ...
  v7 = -[PRCompanionRangingService validateClientEntitlements:](self, "validateClientEntitlements:", v4);
  v8 = qword_10085F520;
  if (v7)
  {
    if (os_log_type_enabled((os_log_t)qword_10085F520, OS_LOG_TYPE_DEBUG))
      sub_1003C8BC0(v6, v8);
    v9 = -[PRCompanionRangingClientProxy initWithConnection:queue:]([PRCompanionRangingClientProxy alloc], "initWithConnection:queue:", v4, self->_queue);
    ...
    objc_msgSend(v4, "setInterruptionHandler:", v22);
...
- (void)handleXPCDisconnection:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v10, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("PRCompanionRangingService.mm"), 115, CFSTR("Invalid parameter not satisfying: %@"), CFSTR("proxy"));
