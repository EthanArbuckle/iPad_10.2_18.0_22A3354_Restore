...
+ (id)cdEntityName
{
  return +[REMHashtag cdEntityName](REMHashtag, "cdEntityName");
}
...
- (void)setReminderIdentifier:(id)a3
{
  ...
  v4 = a3;
  v5 = objc_claimAutoreleasedReturnValue(-[REMCDHashtag reminderIdentifier](self, "reminderIdentifier"));
  v6 = (void *)v5;
  if (!v4 && v5)
  {
    v7 = objc_claimAutoreleasedReturnValue(+[REMLogStore write](REMLogStore, "write"));
    if (os_log_type_enabled(v7, OS_LOG_TYPE_FAULT))
      sub_10067D954(self, v7);

  }
  -[REMCDObject willChangeValueForKey:](self, "willChangeValueForKey:", CFSTR("reminderIdentifier"));
  -[REMCDHashtag setPrimitiveValue:forKey:](self, "setPrimitiveValue:forKey:", v4, CFSTR("reminderIdentifier"));

  -[REMCDObject didChangeValueForKey:](self, "didChangeValueForKey:", CFSTR("reminderIdentifier"));
}

+ (id)propertiesThatShouldTriggerReindexing
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100804C00);
}

+ (id)fetchRequest
{
  return +[NSFetchRequest fetchRequestWithEntityName:](NSFetchRequest, "fetchRequestWithEntityName:", CFSTR("REMCDHashtag"));
}
...
- (BOOL)isConnectedToAccountObject:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[REMCDHashtag reminder](self, "reminder"));
...
- (int64_t)parentEffectiveMinimumSupportedVersion
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[REMCDHashtag reminder](self, "reminder"));
  if (v3)
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(-[REMCDHashtag reminder](self, "reminder"));
...
{
  -[REMCDHashtag setReminder:](self, "setReminder:", 0);
}
...
+ (id)existingCloudObjectForRecordID:(id)a3 accountID:(id)a4 context:(id)a5
{
  ...
  v11 = a3;
  v12 = a5;
  v13 = (void *)static REMCDHashtag.existingCloudObject(for:accountID:managedObjectContext:)(v11, v8, v10, v12);
...
+ (id)newCloudObjectForRecord:(id)a3 account:(id)a4 context:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = static REMCDHashtag.newCloudObject(for:account:managedObjectContext:)(v8, v9, (uint64_t)v10);
...
- (id)existingLocalObjectToMergeWithPredicate:(id)a3
{
  ...
  v4 = a3;
  v5 = self;
  v6 = (void *)_sSo12REMCDHashtagC7reminddE26existingLocalObjectToMerge4withSo11REMCDObjectCSgSo11NSPredicateCSg_tF_0();
