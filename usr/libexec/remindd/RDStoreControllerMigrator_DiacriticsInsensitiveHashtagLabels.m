...
- (void)migrateStoreIfNeeded:(id)a3 metadata:(id)a4
{
  id v6;
  id v7;
  _TtC7remindd60RDStoreControllerMigrator_DiacriticsInsensitiveHashtagLabels *v8;
...
- (_TtC7remindd60RDStoreControllerMigrator_DiacriticsInsensitiveHashtagLabels)init
{
  ...
  return -[RDStoreControllerMigrator_DiacriticsInsensitiveHashtagLabels init](&v3, "init");
}
