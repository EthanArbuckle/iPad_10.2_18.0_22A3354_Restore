...
- (DataStreamBulkSendSessionCandidate)initWithProtocol:(id)a3 requestHeader:(id)a4 metadata:(id)a5
{
  ...
  id v9;
  id v10;
  DataStreamBulkSendSessionCandidate *v11;
  DataStreamBulkSendSessionCandidate *v12;
  uint64_t v13;
  ...
  v11 = -[DataStreamBulkSendSessionCandidate init](&v16, "init");
  v12 = v11;
  if (v11)
  {
...
- (void)acceptBulkSendSessionOnQueue:(id)a3 callback:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  v8 = (id)objc_claimAutoreleasedReturnValue(-[DataStreamBulkSendSessionCandidate bulkSendProtocol](self, "bulkSendProtocol"));
...
- (void)rejectBulkSendSessionWithStatus:(unsigned __int16)a3
{
  ...
  v3 = a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[DataStreamBulkSendSessionCandidate bulkSendProtocol](self, "bulkSendProtocol"));
