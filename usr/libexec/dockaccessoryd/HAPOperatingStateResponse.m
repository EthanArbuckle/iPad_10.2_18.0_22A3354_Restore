...
- (HAPOperatingStateResponse)init
{
  ...
  return -[HAPOperatingStateResponse init](&v3, "init");
}
...
- (HAPOperatingStateResponse)initWithState:(id)a3 abnormalReasons:(id)a4
{
  ...
  v9 = -[HAPOperatingStateResponse init](&v12, "init");
  v10 = v9;
  if (v9)
  {
...
LABEL_18:
    ...
    if (v30 == 2)
    {
      ...
      v15 = &v25;
      v16 = v9;
      v9 = (void *)objc_claimAutoreleasedReturnValue(+[HAPOperatingStateAbnormalReasonsWrapper parsedFromData:error:](HAPOperatingStateAbnormalReasonsWrapper, "parsedFromData:error:", v14, &v25));
      goto LABEL_9;
    }
    if (v30 == 1)
    {
      ...
      v15 = &v26;
      v16 = v10;
      v10 = (void *)objc_claimAutoreleasedReturnValue(+[HAPOperatingStateWrapper parsedFromData:error:](HAPOperatingStateWrapper, "parsedFromData:error:", v14, &v26));
LABEL_9:
      v17 = *v15;
...
- (id)serializeWithError:(id *)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](self, "state"));

  if (!v5)
    goto LABEL_5;
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](self, "state"));
  v19 = 0;
...
LABEL_5:
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](self, "abnormalReasons"));

    if (!v10)
      goto LABEL_17;
    v11 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](self, "abnormalReasons"));
    v18 = 0;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](self, "state"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](self, "abnormalReasons"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = (HAPOperatingStateResponse *)a3;
  if (self == v6)
  {
    v12 = 1;
  }
  ...
  {
    v7 = objc_opt_class(HAPOperatingStateResponse, v5);
    if ((objc_opt_isKindOfClass(v6, v7) & 1) != 0)
    {
      v8 = v6;
      v9 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](self, "state"));
      v10 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](v8, "state"));
      if (v9 != v10)
      {
        v11 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](self, "state"));
        v3 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](v8, "state"));
...
LABEL_14:
      ...
      v13 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](self, "abnormalReasons"));
      v14 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](v8, "abnormalReasons"));
      if (v13 == v14)
      {
        v12 = 1;
      }
      ...
      {
        v15 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](self, "abnormalReasons"));
        v16 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](v8, "abnormalReasons"));
...
- (NSString)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse state](self, "state"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[HAPOperatingStateResponse abnormalReasons](self, "abnormalReasons"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<HAPOperatingStateResponse state=%@, abnormalReasons=%@>"), v3, v4));
