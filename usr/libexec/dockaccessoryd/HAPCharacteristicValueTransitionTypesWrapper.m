...
- (HAPCharacteristicValueTransitionTypesWrapper)init
{
  ...
  result = -[HAPCharacteristicValueTransitionTypesWrapper init](&v3, "init");
  if (result)
    result->_value = 0;
  return result;
}
...
- (HAPCharacteristicValueTransitionTypesWrapper)initWithValue:(unint64_t)a3
{
  ...
  result = -[HAPCharacteristicValueTransitionTypesWrapper init](&v5, "init");
  if (result)
    result->_value = a3;
  return result;
}
...
{
  return sub_1000225E0(-[HAPCharacteristicValueTransitionTypesWrapper value](self, "value", a3));
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = (HAPCharacteristicValueTransitionTypesWrapper *)a3;
  if (self == v5)
  {
    v10 = 1;
  }
  ...
  {
    v6 = objc_opt_class(HAPCharacteristicValueTransitionTypesWrapper, v4);
    if ((objc_opt_isKindOfClass(v5, v6) & 1) != 0)
    {
      v7 = v5;
      v8 = -[HAPCharacteristicValueTransitionTypesWrapper value](self, "value");
      v9 = -[HAPCharacteristicValueTransitionTypesWrapper value](v7, "value");
...
- (NSString)description
{
  ...
  v2 = HAPCharacteristicValueTransitionTypesAsString(-[HAPCharacteristicValueTransitionTypesWrapper value](self, "value"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(v2);
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<HAPCharacteristicValueTransitionTypesWrapper value=%@>"), v3));
