...
- (HAPCharacteristicValueTransitionPoint)init
{
  ...
  return -[HAPCharacteristicValueTransitionPoint init](&v3, "init");
}
...
- (HAPCharacteristicValueTransitionPoint)initWithTargetValue:(id)a3 targetCompletionDuration:(id)a4 startDelayDuration:(id)a5
{
  ...
  v12 = -[HAPCharacteristicValueTransitionPoint init](&v15, "init");
  v13 = v12;
  if (v12)
  {
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  BOOL v25;
  uint64_t v26;
  HAPCharacteristicValueTransitionPoint *v28;
  id *v29;
  id v30;
  id v31;
  id v32;
...
LABEL_23:
  self = v28;
LABEL_24:
  -[HAPCharacteristicValueTransitionPoint setTargetValue:](self, "setTargetValue:", v12, v28);
...
- (id)serializeWithError:(id *)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](self, "targetValue"));

  if (v5)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](self, "targetValue"));
    v28 = 0;
...
LABEL_11:
  v15 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](self, "targetCompletionDuration"));

  if (!v15)
    goto LABEL_15;
  v16 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](self, "targetCompletionDuration"));
  v27 = 0;
...
LABEL_15:
    v19 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](self, "startDelayDuration"));

    if (!v19)
      goto LABEL_28;
    v20 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](self, "startDelayDuration"));
    v26 = 0;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](self, "targetValue"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](self, "targetCompletionDuration"));
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](self, "startDelayDuration"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  HAPCharacteristicValueTransitionPoint *v7;
  uint64_t v8;
  HAPCharacteristicValueTransitionPoint *v9;
  void *v10;
  void *v11;
  unsigned __int8 v12;
  void *v13;
  ...
  v7 = (HAPCharacteristicValueTransitionPoint *)a3;
  if (self == v7)
  {
    v12 = 1;
  }
  ...
  {
    v8 = objc_opt_class(HAPCharacteristicValueTransitionPoint, v6);
    if ((objc_opt_isKindOfClass(v7, v8) & 1) != 0)
    {
      v9 = v7;
      v10 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](self, "targetValue"));
      v11 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](v9, "targetValue"));
      if (v10 != v11)
      {
        v3 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](self, "targetValue"));
        v4 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](v9, "targetValue"));
      ...
      v13 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](self, "targetCompletionDuration"));
      v14 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](v9, "targetCompletionDuration"));
      if (v13 == v14)
      {
        v27 = v13;
      }
      ...
      {
        v15 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](self, "targetCompletionDuration"));
        v28 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](v9, "targetCompletionDuration"));
      ...
      v16 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](self, "startDelayDuration"));
      v17 = objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](v9, "startDelayDuration"));
      if (v16 == (void *)v17)
      {
      ...
      else
      {
        ...
        v20 = v11;
        v21 = v10;
        v22 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](v9, "startDelayDuration"));
...
- (NSString)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetValue](self, "targetValue"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint targetCompletionDuration](self, "targetCompletionDuration"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[HAPCharacteristicValueTransitionPoint startDelayDuration](self, "startDelayDuration"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<HAPCharacteristicValueTransitionPoint targetValue=%@, targetCompletionDuration=%@, startDelayDuration=%@>"), v3, v4, v5));
