...
- (HAPDataStreamTransportProtocolWrapper)init
{
  ...
  result = -[HAPDataStreamTransportProtocolWrapper init](&v3, "init");
  if (result)
    result->_value = 0;
  return result;
}
...
- (HAPDataStreamTransportProtocolWrapper)initWithValue:(int64_t)a3
{
  ...
  result = -[HAPDataStreamTransportProtocolWrapper init](&v5, "init");
  if (result)
    result->_value = a3;
  return result;
}
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (!v13)
  {
    -[HAPDataStreamTransportProtocolWrapper setValue:](self, "setValue:", v8);
    goto LABEL_10;
  }
  if (a4)
  {
...
{
  return sub_1000225E0(-[HAPDataStreamTransportProtocolWrapper value](self, "value", a3));
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = (HAPDataStreamTransportProtocolWrapper *)a3;
  if (self == v5)
  {
    v10 = 1;
  }
  ...
  {
    v6 = objc_opt_class(HAPDataStreamTransportProtocolWrapper, v4);
    if ((objc_opt_isKindOfClass(v5, v6) & 1) != 0)
    {
      v7 = v5;
      v8 = -[HAPDataStreamTransportProtocolWrapper value](self, "value");
      v9 = -[HAPDataStreamTransportProtocolWrapper value](v7, "value");
...
- (NSString)description
{
  ...
  v2 = HAPDataStreamTransportProtocolAsString(-[HAPDataStreamTransportProtocolWrapper value](self, "value"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(v2);
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<HAPDataStreamTransportProtocolWrapper value=%@>"), v3));
