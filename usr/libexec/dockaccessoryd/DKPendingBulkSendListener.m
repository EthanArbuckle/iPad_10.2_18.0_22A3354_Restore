...
- (DKPendingBulkSendListener)initWithListener:(id)a3 fileType:(id)a4
{
  id v6;
  id v7;
  DKPendingBulkSendListener *v8;
  DKPendingBulkSendListener *v9;
  objc_super v11;
  ...
  v8 = -[DKPendingBulkSendListener init](&v11, "init");
  v9 = v8;
  if (v8)
  {
...
{
  return (DataStreamBulkSendListener *)objc_loadWeakRetained((id *)&self->_listener);
}
