...
- (HAPDataStreamTransportSupportedConfiguration)init
{
  ...
  return -[HAPDataStreamTransportSupportedConfiguration init](&v3, "init");
}
...
- (HAPDataStreamTransportSupportedConfiguration)initWithConfigurations:(id)a3
{
  ...
  v5 = -[HAPDataStreamTransportSupportedConfiguration init](&v9, "init");
  if (v5)
  {
  ...
  if (v8 >= 1)
  {
    ...
    while (1)
    {
      ...
      if (v27 == 1)
      {
        ...
        {
          v22 = 0;
          v16 = (void *)objc_claimAutoreleasedReturnValue(+[HAPDataStreamTransportConfiguration parsedFromData:error:](HAPDataStreamTransportConfiguration, "parsedFromData:error:", v14, &v22));
          v15 = v22;
          if (!v15)
...
- (id)serializeWithError:(id *)a3
{
  ...
  v30 = 0u;
  v31 = 0u;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[HAPDataStreamTransportSupportedConfiguration configurations](self, "configurations"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = (HAPDataStreamTransportSupportedConfiguration *)a3;
  if (self == v5)
  {
    v12 = 1;
  }
  ...
  {
    v6 = objc_opt_class(HAPDataStreamTransportSupportedConfiguration, v4);
    if ((objc_opt_isKindOfClass(v5, v6) & 1) != 0)
    {
      v7 = v5;
      v8 = (void *)objc_claimAutoreleasedReturnValue(-[HAPDataStreamTransportSupportedConfiguration configurations](self, "configurations"));
      v9 = (void *)objc_claimAutoreleasedReturnValue(-[HAPDataStreamTransportSupportedConfiguration configurations](v7, "configurations"));
      if (v8 == v9)
      {
        v12 = 1;
      }
      ...
      {
        v10 = (void *)objc_claimAutoreleasedReturnValue(-[HAPDataStreamTransportSupportedConfiguration configurations](self, "configurations"));
        v11 = (void *)objc_claimAutoreleasedReturnValue(-[HAPDataStreamTransportSupportedConfiguration configurations](v7, "configurations"));
...
- (NSString)description
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[HAPDataStreamTransportSupportedConfiguration configurations](self, "configurations"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<HAPDataStreamTransportSupportedConfiguration configurations=%@>"), v2));
