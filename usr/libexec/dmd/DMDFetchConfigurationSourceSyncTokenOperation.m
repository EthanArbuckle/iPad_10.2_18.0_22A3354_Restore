...
+ (id)whitelistedClassesForRequest
{
  ...
  v2 = objc_opt_class(DMFFetchConfigurationSourceSyncTokenRequest, a2);
  return +[NSSet setWithObject:](NSSet, "setWithObject:", v2);
}

+ (id)requiredEntitlements
{
  return &off_1000C2C28;
}
...
- (void)runWithRequest:(id)a3
{
  ...
  v4 = (id)objc_opt_new(DMFFetchConfigurationSourceSyncTokenResultObject);
...
+ (BOOL)validateRequest:(id)a3 error:(id *)a4
{
  ...
  if (!objc_msgSendSuper2(&v11, "validateRequest:error:", v6, a4))
    goto LABEL_6;
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "configurationSource"));
