...
- (CEMFontInstallOperation)initWithFontDeclaration:(id)a3 resolver:(id)a4
{
  id v7;
  id v8;
  CEMFontInstallOperation *v9;
  CEMFontInstallOperation *v10;
  objc_super v12;
...
- (void)main
{
  ...
  v3 = (id)objc_claimAutoreleasedReturnValue(-[CEMFontInstallOperation resolver](self, "resolver"));
...
- (NSString)assetIdentifier
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[CEMFontInstallOperation fontDeclaration](self, "fontDeclaration"));
...
- (void)assetResolutionDidSucceedWithAssetURL:(id)a3
{
  ...
  void *v13;
  id v14;
  CEMFontAssetInstallMetadata *v15;
  uint64_t v16;
  NSObject *v17;
  uint64_t v18;
  id v19;
  ...
  if (-[CEMFontInstallOperation isExecuting](self, "isExecuting"))
  {
    if (v4)
    {
      v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSFileManager dmd_userFontDatabaseDirectoryURL](NSFileManager, "dmd_userFontDatabaseDirectoryURL"));
      ...
      if ((v7 & 1) != 0)
      {
        ...
        if ((v11 & 1) != 0)
        {
          v15 = objc_opt_new(CEMFontAssetInstallMetadata);
...
- (void)assetResolutionFailedWithError:(id)a3
{
  ...
  v4 = a3;
  if (-[CEMFontInstallOperation isExecuting](self, "isExecuting"))
    -[CEMFontInstallOperation endOperationWithError:](self, "endOperationWithError:", v4);
