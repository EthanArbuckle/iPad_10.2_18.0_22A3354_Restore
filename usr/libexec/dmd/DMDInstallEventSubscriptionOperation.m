...
+ (BOOL)validateRequest:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v14.receiver = a1;
  v14.super_class = (Class)&OBJC_METACLASS___DMDInstallEventSubscriptionOperation;
...
+ (id)whitelistedClassesForRequest
{
  ...
  v2 = objc_opt_class(DMDInstallEventSubscriptionRequest, a2);
...
- (void)runWithRequest:(id)a3
{
  ...
  v6[3] = &unk_1000BAD98;
  v6[4] = self;
  objc_msgSend(v5, "handleInstallSubscriptionRequest:completionHandler:", v4, v6);
