...
+ (id)whitelistedClassesForRequest
{
  ...
  v2 = objc_opt_class(DMFSetAppAssociatedDomainsEnableDirectDownloadsRequest, a2);
  return +[NSSet setWithObject:](NSSet, "setWithObject:", v2);
}

+ (id)requiredEntitlements
{
  return &off_1000C3078;
}
...
- (void)runWithRequest:(id)a3 bundleIdentifier:(id)a4
{
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "associatedDomainsEnableDirectDownloads"));

  v13 = 0;
  v10 = objc_msgSend(v8, "setAssociatedDomainsEnableDirectDownloads:forBundleIdentifier:error:", v9, v6, &v13);
  ...
  if (v10)
  {
    ...
    -[DMDSetAppAssociatedDomainsEnableDirectDownloadsOperation endOperationWithResultObject:](self, "endOperationWithResultObject:", 0);
  }
  else
  {
