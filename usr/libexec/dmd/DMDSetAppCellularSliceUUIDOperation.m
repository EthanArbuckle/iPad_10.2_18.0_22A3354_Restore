...
+ (id)whitelistedClassesForRequest
{
  ...
  v2 = objc_opt_class(DMFSetAppCellularSliceUUIDRequest, a2);
  return +[NSSet setWithObject:](NSSet, "setWithObject:", v2);
}

+ (id)requiredEntitlements
{
  return &off_1000C3168;
}
...
- (void)runWithRequest:(id)a3 bundleIdentifier:(id)a4
{
  ...
  v13 = 0;
  v10 = objc_msgSend(v8, "setCellularSliceUUIDString:forBundleIdentifier:error:", v9, v6, &v13);
  ...
  if (v10)
  {
    ...
    -[DMDSetAppCellularSliceUUIDOperation endOperationWithResultObject:](self, "endOperationWithResultObject:", 0);
  }
  else
  {
    -[DMDSetAppCellularSliceUUIDOperation endOperationWithError:](self, "endOperationWithError:", v11);
  }
