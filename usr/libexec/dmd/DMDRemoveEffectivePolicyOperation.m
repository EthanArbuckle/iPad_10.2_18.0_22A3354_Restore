...
+ (id)whitelistedClassesForRequest
{
  ...
  v2 = objc_opt_class(DMDRemoveEffectivePolicyRequest, a2);
...
- (void)runWithRequest:(id)a3
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "declarationIdentifier"));
  ...
  v9[3] = &unk_1000BAD98;
  v9[4] = self;
  objc_msgSend(v6, "removeEffectivePolicyFromOrganizationIdentifier:declarationIdentifier:completionHandler:", v7, v8, v9);
...
+ (BOOL)validateRequest:(id)a3 error:(id *)a4
{
  ...
  if (!v8)
  {
    ...
    v16 = CFSTR("request.declarationIdentifier");
    v9 = &v16;
    v10 = &v15;
LABEL_9:
