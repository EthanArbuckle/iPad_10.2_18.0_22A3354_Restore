...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyUploadBodyData;
  v3 = -[PDURLSessionProxyUploadBodyData description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyUploadBodyData dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if (bodyData)
    objc_msgSend(v3, "setObject:forKey:", bodyData, CFSTR("bodyData"));
  return v3;
}
...
- (BOOL)readFrom:(id)a3
{
  ...
  char v9;
  int v11;
  PDURLSessionProxyTaskMessage *bodyData;
  uint64_t Data;
  NSData *v15;
  _QWORD v17[2];
...
LABEL_13:
      ...
      if ((v7 >> 3) == 1)
      {
        ...
        v17[0] = 0;
        v17[1] = 0;
        if (!PBReaderPlaceMark(a3, v17) || (sub_10005C020((uint64_t)bodyData, (uint64_t)a3) & 1) == 0)
        {
...
- (void)writeTo:(id)a3
{
  ...
  if (bodyData)
  {
    PBDataWriterWriteDataField(v7, bodyData, 2);
    v4 = v7;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = -[NSData copyWithZone:](self->_bodyData, "copyWithZone:", a3);
  v9 = (void *)v5[1];
  v5[1] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[PDURLSessionProxyTaskMessage isEqual:](task, "isEqual:")))
  {
    ...
    if ((unint64_t)bodyData | v4[1])
      v7 = -[NSData isEqual:](bodyData, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return (unint64_t)-[NSData hash](self->_bodyData, "hash") ^ v3;
}
