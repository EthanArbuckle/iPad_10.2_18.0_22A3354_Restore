...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxySuspendTask;
  v3 = -[PDURLSessionProxySuspendTask description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxySuspendTask dictionaryRepresentation](self, "dictionaryRepresentation"));
