...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyDidReceiveData;
  v3 = -[PDURLSessionProxyDidReceiveData description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyDidReceiveData dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if (receivedData)
    objc_msgSend(v3, "setObject:forKey:", receivedData, CFSTR("receivedData"));
  return v3;
}
...
- (BOOL)readFrom:(id)a3
{
  ...
  char v9;
  int v11;
  PDURLSessionProxyTaskMessage *receivedData;
  uint64_t Data;
  NSData *v15;
  _QWORD v17[2];
...
LABEL_13:
      ...
      if ((v7 >> 3) == 1)
      {
        ...
        v17[0] = 0;
        v17[1] = 0;
        if (!PBReaderPlaceMark(a3, v17) || (sub_10005C020((uint64_t)receivedData, (uint64_t)a3) & 1) == 0)
        {
...
- (void)writeTo:(id)a3
{
  ...
  if (receivedData)
  {
    PBDataWriterWriteDataField(v7, receivedData, 2);
    v4 = v7;
  }
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend(v5, "setReceivedData:");
    v4 = v5;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = -[NSData copyWithZone:](self->_receivedData, "copyWithZone:", a3);
  v9 = (void *)v5[1];
  v5[1] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[PDURLSessionProxyTaskMessage isEqual:](task, "isEqual:")))
  {
    ...
    if ((unint64_t)receivedData | v4[1])
      v7 = -[NSData isEqual:](receivedData, "isEqual:");
    else
      v7 = 1;
  }
  else
...
- (unint64_t)hash
{
  ...
  return (unint64_t)-[NSData hash](self->_receivedData, "hash") ^ v3;
}
