...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyTaskWillBeRetried;
  v3 = -[PDURLSessionProxyTaskWillBeRetried description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyTaskWillBeRetried dictionaryRepresentation](self, "dictionaryRepresentation"));
