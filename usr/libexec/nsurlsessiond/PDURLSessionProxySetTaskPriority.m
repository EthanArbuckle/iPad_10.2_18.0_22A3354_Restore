...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxySetTaskPriority;
  v3 = -[PDURLSessionProxySetTaskPriority description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxySetTaskPriority dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_priority));
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("priority"));
...
- (void)writeTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    PBDataWriterWriteUint32Field(v6, self->_priority, 2);
    v4 = v6;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 24) & 1) != 0 && self->_priority == *((_DWORD *)v4 + 2))
    {
      v6 = 1;
      goto LABEL_9;
    }
