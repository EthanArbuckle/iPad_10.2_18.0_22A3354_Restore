...
{
  id v4;
  PDURLSessionProxyAuthChallenge *v5;
  void *v6;

  v4 = a3;
  v5 = -[PDURLSessionProxyAuthChallenge init](self, "init");
  if (v5)
  {
    ...
    -[PDURLSessionProxyAuthChallenge setArchiveList:](v5, "setArchiveList:", v6);
...
- (id)_actualAuthChallenge
{
  ...
  v3 = objc_opt_class(NSURLAuthenticationChallenge);
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyAuthChallenge archiveList](self, "archiveList"));
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyAuthChallenge;
  v3 = -[PDURLSessionProxyAuthChallenge description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyAuthChallenge dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_100065600((uint64_t)self, (uint64_t)a3);
}
