...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyOpenBodyStream;
  v3 = -[PDURLSessionProxyOpenBodyStream description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyOpenBodyStream dictionaryRepresentation](self, "dictionaryRepresentation"));
