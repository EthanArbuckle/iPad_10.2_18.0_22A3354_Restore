...
{
  id v4;
  PDURLSessionProxyResponse *v5;
  void *v6;

  v4 = a3;
  v5 = -[PDURLSessionProxyResponse init](self, "init");
  if (v5)
  {
    ...
    -[PDURLSessionProxyResponse setArchiveList:](v5, "setArchiveList:", v6);
...
- (id)_actualResponse
{
  ...
  v3 = objc_opt_class(NSURLResponse);
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyResponse archiveList](self, "archiveList"));
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyResponse;
  v3 = -[PDURLSessionProxyResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_10004916C((uint64_t)self, (uint64_t)a3);
}
