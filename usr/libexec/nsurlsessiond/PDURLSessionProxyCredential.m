...
{
  id v4;
  PDURLSessionProxyCredential *v5;
  void *v6;

  v4 = a3;
  v5 = -[PDURLSessionProxyCredential init](self, "init");
  if (v5)
  {
    ...
    -[PDURLSessionProxyCredential setArchiveList:](v5, "setArchiveList:", v6);
...
- (id)_actualCredential
{
  ...
  v3 = objc_opt_class(NSURLCredential);
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyCredential archiveList](self, "archiveList"));
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxyCredential;
  v3 = -[PDURLSessionProxyCredential description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxyCredential dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_10004EC90((uint64_t)self, (uint64_t)a3);
}
