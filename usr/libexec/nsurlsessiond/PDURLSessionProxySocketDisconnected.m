...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PDURLSessionProxySocketDisconnected;
  v3 = -[PDURLSessionProxySocketDisconnected description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[PDURLSessionProxySocketDisconnected dictionaryRepresentation](self, "dictionaryRepresentation"));
