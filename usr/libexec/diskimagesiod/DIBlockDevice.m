...
- (id)copyIOMediaWithError:(id *)a3
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[DIIOObject ioObjectWithClassName:iterateParent:error:](self, "ioObjectWithClassName:iterateParent:error:", CFSTR("IOMedia"), 0, a3));
...
- (NSString)mediumType
{
  ...
  v2 = -[DIIOObject copyPropertyWithClass:key:](self, "copyPropertyWithClass:key:", objc_opt_class(NSDictionary, a2), CFSTR("Device Characteristics"));
  v3 = v2;
  if (v2)
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "objectForKeyedSubscript:", CFSTR("Medium Type")));
...
- (id)copyRootBlockDeviceWithError:(id *)a3
{
  ...
  v5 = -[DIIOObject copyPropertyWithClass:key:](self, "copyPropertyWithClass:key:", objc_opt_class(NSNumber, a2), CFSTR("RootDeviceEntryID"));
...
+ (id)copyUnmatchedDiskImageWithRegEntryID:(unint64_t)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("Cannot find disk image with reg entry ID 0x%llx"), a3));
    v9 = (DIBlockDevice *)objc_claimAutoreleasedReturnValue(+[DIError nilWithEnumValue:verboseInfo:error:](DIError, "nilWithEnumValue:verboseInfo:error:", 153, v10, a4));
