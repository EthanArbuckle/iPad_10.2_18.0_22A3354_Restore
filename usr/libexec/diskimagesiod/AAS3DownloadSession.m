...
- (AAS3DownloadSession)initWithURL:(id)a3 streamBase:(id *)a4 maxAttempts:(unsigned int)a5 pauseInterval:(float)a6 maxRequestsInFlight:(unsigned int)a7
{
  ...
  char v51;
  id obj;
  $5315B4694A126D4B652A261A818437BB *v53;
  unsigned int v54;
  unsigned int v55;
  NSURLSessionConfiguration *v56;
  id v57;
  objc_super v58;
  ...
  if (v14)
  {
    ...
    v55 = a7;
    v57 = v13;
    v56 = +[NSURLSessionConfiguration ephemeralSessionConfiguration](NSURLSessionConfiguration, "ephemeralSessionConfiguration");
    ...
    for (i = *((_QWORD *)var2 + 349); i; i = *(_QWORD *)(i + 8))
    {
      ...
      if (*(_QWORD *)i)
      {
        ...
        if (v23 + 1 < 0x2000000001)
        {
          ...
          if (v25)
          {
            ...
            {
              *v27 = 0;
              v30 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", v27 + 1);
              v31 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", v26);
              objc_msgSend(v18, "setValue:forKey:", v30, v31);

            }
            else
            {
              sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 252, 121, 0, "invalid header: %s", v28, v29, (char)v26);
            }
            free(v26);
            continue;
          }
      ...
      v32 = __error();
      sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 250, 121, *v32, "malloc", v33, v34, v51);
    }
    if (*((_QWORD *)var2 + 350))
      sub_100024768((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession initWithURL:streamBase:maxAttempts:pauseInterval:maxRequestsInFlight:]", 259, 121, "Non supported options in AAS3DownloadSession (ignored): proxy_headers %s", v15, v16, v17, *((_QWORD *)var2 + 350));
    if (*((_QWORD *)var2 + 346))
    ...
    -[NSURLSessionConfiguration setHTTPMaximumConnectionsPerHost:](v56, "setHTTPMaximumConnectionsPerHost:", 16);
    ...
    v35 = +[NSURLSession sessionWithConfiguration:](NSURLSession, "sessionWithConfiguration:", v56);
...
- (int)addRequest:(id)a3
{
  ...
  if (v7)
  {
    sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession addRequest:]", 292, 121, 0, "euqueueRequest timed out", v8, v9, v15);
    v10 = -1;
  }
  else
  {
...
- (id)enqueueRequestWithSize:(unint64_t)a3 atOffset:(int64_t)a4 destinationBuffer:(char *)a5 destinationStream:(AAAsyncByteStream_impl *)a6 completionSemaphore:(id)a7
{
  ...
  if (!v13)
  {
    ...
    v18 = 332;
LABEL_8:
    sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession enqueueRequestWithSize:atOffset:destinationBuffer:destinationStream:completionSemaphore:]", v18, 121, 0, v17, v14, v15, v20);
    v16 = 0;
    goto LABEL_9;
  }
...
- (int64_t)readToBuffer:(void *)a3 size:(unint64_t)a4 atOffset:(int64_t)a5
{
  ...
  if (!v10)
  {
    ...
    sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession readToBuffer:size:atOffset:]", v26, 121, 0, v25, v22, v23, v28);
    a4 = -1;
    goto LABEL_14;
  }
...
- (int)syncRequests
{
  ...
  if (-[AAS3DownloadSession maxRequests](self, "maxRequests"))
  {
    ...
    sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession syncRequests]", 401, 121, 0, "Request timed out", v7, v8, v12);
    return -1;
  }
  else
  {
...
- (int)readToAsyncByteStream:(AAAsyncByteStream_impl *)a3 size:(unint64_t)a4 atOffset:(int64_t)a5
{
  ...
  if (a4)
  {
    ...
    if (v10)
    {
      ...
      v26 = -[AAS3DownloadSession cacheLock](self, "cacheLock");
      -[NSLock unlock](v26, "unlock");

      v21 = 0;
      goto LABEL_12;
    }
    v23 = -[AAS3DownloadSession cacheLock](self, "cacheLock");
    -[NSLock unlock](v23, "unlock");

    v21 = -[AAS3DownloadSession enqueueRequestWithSize:atOffset:destinationBuffer:destinationStream:completionSemaphore:](self, "enqueueRequestWithSize:atOffset:destinationBuffer:destinationStream:completionSemaphore:", a4, a5, 0, a3, 0);
    if (v21)
    {
LABEL_12:
      v22 = 0;
    ...
    sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"-[AAS3DownloadSession readToAsyncByteStream:size:atOffset:]", 451, 121, 0, "enqueueRequest", v24, v25, v28);
    v21 = 0;
    v22 = -1;
  }
  else
  {
    v20 = -[AAS3DownloadSession syncRequests](self, "syncRequests", a3, 0, a5);
    v21 = 0;
    v22 = v20 >> 31;
  }
LABEL_13:
...
+ (void)completeRequest:(id)a3 data:(id)a4 response:(id)a5 error:(id)a6
{
  ...
  v11 = a5;
  v12 = a6;
  v13 = objc_msgSend(v9, "downloadSession");
  v14 = objc_msgSend(v11, "statusCode");
  if (objc_msgSend(v13, "isCancelled") || v12 && objc_msgSend(v12, "code") == (id)-999)
  {
LABEL_2:
    v18 = 1;
    goto LABEL_3;
  ...
  if (v14 == (id)416)
  {
    v33 = objc_msgSend(objc_retainAutorelease(v10), "bytes");
    if (objc_msgSend(v9, "stream"))
      AAAsyncByteStreamProcess(objc_msgSend(v9, "stream"), v33, 0, objc_msgSend(v9, "offset"));
    goto LABEL_2;
  }
  if (v14 == (id)206)
  {
    v21 = (char *)objc_msgSend(v10, "length");
    v34 = (char *)objc_msgSend(v9, "nbyte");
    if (v21 >= v34)
      v30 = (size_t)v34;
    else
      v30 = (size_t)v21;
    v32 = (char *)objc_msgSend(objc_retainAutorelease(v10), "bytes");
LABEL_27:
    if (objc_msgSend(v9, "buf"))
      memcpy(objc_msgSend(v9, "buf"), v32, v30);
    if (objc_msgSend(v9, "stream"))
      AAAsyncByteStreamProcess(objc_msgSend(v9, "stream"), v32, v30, objc_msgSend(v9, "offset"));
  ...
  if (v14 == (id)200)
  {
    ...
    v24 = (uint64_t)objc_msgSend(v9, "offset");
    v25 = v24 & ~(v24 >> 63);
    v26 = (char *)objc_msgSend(v9, "offset");
    v27 = &v26[(_QWORD)objc_msgSend(v9, "nbyte")];
  ...
  if (v12 && (v35 = objc_msgSend(v12, "description")) != 0)
  {
    v36 = objc_retainAutorelease(v35);
    objc_msgSend(v36, "UTF8String");
    sub_100024768((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"+[AAS3DownloadSession completeRequest:data:response:error:]", 546, 121, "Request failed: %03ld %s", v37, v38, v39, (char)v14);

  }
  else
  {
    sub_100024768((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"+[AAS3DownloadSession completeRequest:data:response:error:]", 547, 121, "Request failed: %03ld (error not set)", v15, v16, v17, (char)v14);
  }
  if (objc_msgSend(v9, "remainingAttempts"))
  {
    ...
    sub_100024768((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"+[AAS3DownloadSession completeRequest:data:response:error:]", 554, 121, "Retrying request after %.0f seconds %zu bytes at offset %llu", v42, v43, v44, SLOBYTE(v41));
    objc_msgSend(v9, "pauseInterval");
    +[NSThread sleepForTimeInterval:](NSThread, "sleepForTimeInterval:", v45);
    objc_msgSend(v9, "pauseInterval");
    *(float *)&v47 = v46 + v46;
    objc_msgSend(v9, "setPauseInterval:", v47);
    if ((objc_msgSend(v9, "createAndResumeTask") & 0x80000000) == 0)
      goto LABEL_6;
    sub_100024658((uint64_t)"/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", (uint64_t)"+[AAS3DownloadSession completeRequest:data:response:error:]", 561, 121, 0, "createTask", v48, v49, v50);
  }
  v18 = 0xFFFFFFFFLL;
LABEL_3:
  objc_msgSend(v9, "setStatus:", v18);
  v19 = objc_msgSend(v9, "sem");

  if (v19)
  {
    v20 = objc_msgSend(v9, "sem");
