...
+ (id)options
{
  if (qword_1002697B0 != -1)
    dispatch_once(&qword_1002697B0, &stru_1002149D8);
  return (id)qword_1002697A8;
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)APPBLogAnalyticsResponse;
  v3 = -[APPBLogAnalyticsResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[APPBLogAnalyticsResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
