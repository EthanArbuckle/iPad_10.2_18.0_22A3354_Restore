...
+ (id)options
{
  if (qword_100269990 != -1)
    dispatch_once(&qword_100269990, &stru_100215428);
  return (id)qword_100269988;
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)APPBLogImpressionResponse;
  v3 = -[APPBLogImpressionResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[APPBLogImpressionResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
