...
+ (id)identifier
{
  return CFSTR("com.apple.ap.notifications");
}
...
- (BOOL)_validateParameters:(id *)a3
{
  ...
  if (-[APBiomeDataAdaptor _validateParameters:](&v15, "_validateParameters:"))
  {
    ...
    if (v10)
    {
      ...
      -[APNotificationsDataAdaptor setBundleIDs:](self, "setBundleIDs:", v13);

      v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](NSMutableDictionary, "dictionary"));
      -[APNotificationsDataAdaptor setFoundBundleIDs:](self, "setFoundBundleIDs:", v5);
LABEL_7:
...
- (id)_biomeStream
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "Usage"));
...
- (id)calculateResultFromEvents
{
  ...
  v15 = 0u;
  v16 = 0u;
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[APNotificationsDataAdaptor foundBundleIDs](self, "foundBundleIDs", 0));
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue(-[APNotificationsDataAdaptor minCount](self, "minCount"));
...
- (void)eventReceived:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v15, v4) & 1) != 0
    || (v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "eventBody")),
        v6 = objc_opt_class(BMNotificationUsage),
        isKindOfClass = objc_opt_isKindOfClass(v5, v6),
        v5,
        (isKindOfClass & 1) != 0))
  {
    v8 = v15;
    v9 = (void *)objc_claimAutoreleasedReturnValue(-[APNotificationsDataAdaptor bundleIDs](self, "bundleIDs"));
    ...
    if (v12)
    {
      ...
      -[APNotificationsDataAdaptor _incrementBundleIDCount:](self, "_incrementBundleIDCount:", v14);
  ...
  else
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_10008D580;
    block[3] = &unk_100212FE0;
    v17 = v15;
    if (qword_1002687C8 != -1)
      dispatch_once(&qword_1002687C8, block);
    v8 = v17;
  }
...
- (void)_incrementBundleIDCount:(id)a3
{
  ...
  v9 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[APNotificationsDataAdaptor foundBundleIDs](self, "foundBundleIDs"));
  ...
  if (!v5)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[APNotificationsDataAdaptor foundBundleIDs](self, "foundBundleIDs"));
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[APNotificationsDataAdaptor foundBundleIDs](self, "foundBundleIDs"));
