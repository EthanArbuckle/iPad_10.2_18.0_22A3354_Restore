...
+ (id)options
{
  if (qword_100269648 != -1)
    dispatch_once(&qword_100269648, &stru_100214220);
  return (id)qword_100269640;
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)APPBOptOutResponse;
  v3 = -[APPBOptOutResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[APPBOptOutResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
