...
+ (id)options
{
  if (qword_1002699F0 != -1)
    dispatch_once(&qword_1002699F0, &stru_1002155B0);
  return (id)qword_1002699E8;
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)APPBServerErrorResponse;
  v3 = -[APPBServerErrorResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[APPBServerErrorResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
