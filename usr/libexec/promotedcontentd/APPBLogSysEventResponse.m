...
+ (id)options
{
  if (qword_1002698A0 != -1)
    dispatch_once(&qword_1002698A0, &stru_100214E80);
  return (id)qword_100269898;
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)APPBLogSysEventResponse;
  v3 = -[APPBLogSysEventResponse description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[APPBLogSysEventResponse dictionaryRepresentation](self, "dictionaryRepresentation"));
