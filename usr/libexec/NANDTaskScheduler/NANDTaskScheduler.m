...
LABEL_11:
  ...
  v14 = a3;
  v15 = sub_100002904((uint64_t)v13, a2, a3, a4, a7);
  if (!v15)
  {
  ...
  {
    bzero(v18, v17);
    if ((sub_1000029C8((uint64_t)v13, a2, v14, a4, v19, v17, a6, a7) & 1) != 0)
    {
      *a5 = v16;
    }
    else
...
uint64_t sub_100002904(uint64_t a1, int a2, int a3, int a4, char a5)
{
  kern_return_t v7;
  uint64_t result;
  size_t outputStructCnt;
...
uint64_t sub_1000029C8(uint64_t a1, int a2, int a3, int a4, void *outputStruct, size_t a6, char a7, char a8)
{
  uint64_t v9;
  kern_return_t v15;
  size_t v16;
...
void *fetchTunnelBufferSkipSizeWrap(char **a1, int a2, _QWORD *a3)
{
  char **v5;
  uint64_t v6;
  size_t v7;
  ...
  if (a1 || findNandExporter_tunnel(&v11) && (v5 = v11) != 0 && *((_DWORD *)v11 + 4))
  {
    ...
    {
      bzero(v8, v7);
      if ((sub_1000029C8((uint64_t)v5, a2, 0, 0, v9, v7, 0, 1) & 1) != 0)
      {
        *a3 = v6;
      }
      else
...
uint64_t populateTunnelBuffer(uint64_t a1, void *a2, _QWORD *a3, int a4, int a5, int a6, char a7, char a8)
{
  unsigned int v16;
  unsigned int v17;
  FILE *v18;
  ...
  v16 = sub_100002904(a1, a4, a5, a6, a8);
  if (!v16)
  {
    v21 = 0;
    goto LABEL_16;
  ...
  if (!*a3 || v16 <= *a3)
  {
    ...
    bzero(a2, v23);
    if ((sub_1000029C8(a1, a4, a5, a6, a2, v23, a7, a8) & 1) == 0)
      goto LABEL_11;
    v21 = v17;
LABEL_16:
    result = 1;
...
uint64_t populateTunnelOutputBufferWithoutSizeQuery_withFlags(char **a1, int a2, int a3, int a4, void *outputStruct, size_t a6, char a7, char a8)
{
  ...
  {
    if ((sub_1000029C8((uint64_t)a1, a2, a3, a4, outputStruct, a6, a7, a8) & 1) != 0)
    {
      v15 = 1;
      goto LABEL_10;
    }
...
LABEL_13:
        v16 = (_QWORD *)a1;
LABEL_14:
        sub_1000196F0(v16, (const char *)&unk_10004228E, v19, v18);
        goto LABEL_15;
      default:
        switch(v7)
        {
...
LABEL_705:
                                        ...
                                        if (v7 == 1042)
                                        {
                                          ...
                                          v15 = 15;
LABEL_12:
                                          sub_100007B48(v21, v22, v20, v14, v15);
                                          goto LABEL_15;
                                        }
                                        if (v7 == 1080)
                                        {
...
uint64_t sub_100007B48(uint64_t result, int a2, const char *a3, uint64_t *a4, unsigned int a5)
{
  _QWORD *v7;
  uint64_t v8;
  uint64_t v9;
...
LABEL_42:
          if (a5 == 1)
          {
            return sub_1000196F0((_QWORD *)result, (const char *)&unk_10004228E, a3, v8);
          }
          else
          {
            v13 = 0;
            ...
            do
            {
              ...
              __str[100] = 0;
              result = sub_1000196F0(v7, a3, __str, a4[v13++]);
            }
            while (v14 != v13);
          }
        }
  ...
  if (a4 && a5)
  {
    if (a5 == 1)
    {
      if (a4 <= 8)
      {
        ...
        return AddSingleValueToGenericContext(a1, (const char *)&unk_10004228E, a2, v14);
      }
      else
      {
        return 0;
    ...
    else
    {
      ...
      do
      {
        ...
        if (a4 <= 8)
        {
          ...
          __str[100] = 0;
          v5 = AddSingleValueToGenericContext(a1, a2, __str, v14) & v5;
        }
        else
        {
          v5 = 0;
...
uint64_t sub_1000196F0(_QWORD *a1, const char *a2, const char *a3, uint64_t a4)
{
  char *v8;
  _QWORD *v9;
  _QWORD *v10;
...
void sub_10001998C()
{
  xpc_activity_register("com.apple.nand_task_scheduler", XPC_ACTIVITY_CHECK_IN, &stru_100044178);
}

void sub_1000199AC(id a1, OS_xpc_object *a2)
{
...
LABEL_5:
  ...
  v5 = populateTunnelOutputBufferWithoutSizeQuery_withFlags(0, 39, 1025, 0, &outputStruct, 4uLL, 0, 0);
  if (v5)
  {
    v6 = outputStruct;
  }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 67109120;
      v15 = v4;
      v12 = "iter# %u - DONE for now - more BDR";
      goto LABEL_31;
    }
  }
  else
...
LABEL_31:
  ...
  if (outputStruct && xpc_activity_should_defer(a2))
  {
    ...
    state = xpc_activity_set_state(a2, 3);
    goto LABEL_41;
  }
LABEL_39:
  state = os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT);
  if ((_DWORD)state)
  {
    *(_WORD *)buf = 0;
