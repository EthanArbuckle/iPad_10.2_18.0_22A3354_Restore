...
- (void)addMediaItemToIndex:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!v9)
    {
      ...
      if (v11)
      {
        v13 = objc_msgSend(v11, "indexOfObject:inSortedRange:options:usingComparator:", v4, 0, objc_msgSend(v11, "count"), 1024, &stru_100048C98);
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (i = 0; i != v10; i = (char *)i + 1)
      {
        ...
        v16 = objc_msgSend(v13, "indexOfObject:inSortedRange:options:usingComparator:", v15, 0, v14, 256, &stru_100048CD8);
