...
- (PTPOperationRequestPacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 39) >= 0xFFFFFFEB && *((_DWORD *)a3 + 1) == 6)
  {
    ...
    {
      v10 = (char *)a3 + 8;
      v7->_dataPhaseInfo = sub_1000273CC(&v10);
      v7->_operationCode = sub_100027350(&v10);
...
- (PTPOperationRequestPacket)initWithUSBBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 33) >= 0xFFFFFFEB && *((_WORD *)a3 + 2) == 1)
  {
    ...
    if (v7)
    {
      v11 = (char *)a3 + 6;
      v7->_dataPhaseInfo = 0;
      v7->_operationCode = sub_100027350(&v11);
      v8->_transactionID = sub_1000273CC(&v11);
      v8->_numParameters = (v3 - 12) >> 2;
      if ((v3 - 12) >= 4)
      {
        v9 = 0;
        do
          v8->_parameters[v9++] = sub_1000273CC(&v11);
...
- (id)contentForTCP
{
  ...
  sub_1000273B4((_DWORD **)&v7, 6);
  sub_1000273B4((_DWORD **)&v7, self->_dataPhaseInfo);
  sub_100027338(&v7, self->_operationCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  sub_100027338(&v9, 1);
  sub_100027338(&v9, self->_operationCode);
