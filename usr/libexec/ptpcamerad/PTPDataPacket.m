...
- (PTPDataPacket)initWithUSBBuffer:(void *)a3
{
  ...
  if (*(_DWORD *)a3 >= 0xCu && *((_WORD *)a3 + 2) == 2)
  {
    ...
    {
      v12 = (char *)a3 + 6;
      v7->_operationCode = sub_100027350(&v12);
      v7->_transactionID = sub_1000273CC(&v12);
...
- (id)contentForUSB
{
  ...
  sub_100027338((_WORD **)&__buf, 2);
  sub_100027338((_WORD **)&__buf, self->_operationCode);
  sub_1000273B4((_DWORD **)&__buf, self->_transactionID);
...
LABEL_15:
  ...
  v12 = -2;
LABEL_16:
  sub_1000273B4((_DWORD **)&__buf, v12);
...
- (id)description
{
  ...
  v3 = sub_100027910(self->_operationCode);
...
- (int64_t)copyToWrappedBytes:(id)a3 forTransport:(unsigned __int16)a4
{
  ...
  if ((v4 - 1) >= 2)
  {
    if (v4 == 3)
    {
      ...
      if (v7 == (char *)12)
      {
        sub_1000273B4((_DWORD **)&v28, 12);
        sub_1000273B4((_DWORD **)&v28, 10);
        goto LABEL_8;
      }
      ...
      if (!v18)
      {
        ...
        if (v20 < 0xFFFFFFFF00000000)
          ...
          v22 = v21;
        sub_1000273B4((_DWORD **)&v28, v22);
        v27 = v28;
        sub_1000273B4((_DWORD **)&v28, 10);
        sub_1000273B4((_DWORD **)&v28, self->_transactionID);
  ...
  if (v7 != (char *)12)
  {
    if (self->_offsetInBuffer == self->_range.location)
    {
      ...
      if (v14 >= 0xFFFFFFFF00000000)
        ...
        v17 = v16;
      sub_1000273B4((_DWORD **)&v28, v17);
      sub_100027338(&v28, 2);
      sub_100027338(&v28, self->_operationCode);
      sub_1000273B4((_DWORD **)&v28, self->_transactionID);
  ...
  if ((v4 - 1) >= 2)
  {
    if (v4 == 3)
    {
      ...
      if (v14 < 0xFFFFFFFF00000000)
        ...
        v16 = v15;
      sub_1000273B4((_DWORD **)&v19, v16);
      sub_1000273B4((_DWORD **)&v19, 10);
      goto LABEL_15;
    }
LABEL_16:
    v17 = 0;
  ...
  if (v9 >= 0xFFFFFFFF00000000)
    ...
    v12 = v11;
  sub_1000273B4((_DWORD **)&v19, v12);
  sub_100027338(&v19, 2);
  sub_100027338(&v19, self->_operationCode);
LABEL_15:
  sub_1000273B4((_DWORD **)&v19, self->_transactionID);
  v17 = 12;
