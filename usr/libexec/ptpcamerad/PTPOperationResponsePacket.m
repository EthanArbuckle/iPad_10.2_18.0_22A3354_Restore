...
- (PTPOperationResponsePacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 35) >= 0xFFFFFFEB && *((_DWORD *)a3 + 1) == 7)
  {
    ...
    {
      v10 = (char *)a3 + 8;
      v7->_responseCode = sub_100027350(&v10);
...
- (id)contentForTCP
{
  ...
  sub_1000273B4((_DWORD **)&v7, 7);
  sub_100027338(&v7, self->_responseCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  sub_100027338(&v9, 3);
  sub_100027338(&v9, self->_responseCode);
...
- (id)description
{
  ...
  v3 = sub_100028420(self->_responseCode);
