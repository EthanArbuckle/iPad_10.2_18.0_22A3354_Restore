...
- (BOOL)setupSchema
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
      sub_100031CB0(v4, v5, v6, v7, v8, v9, v10, v11);
...
- (void)setupPermissions
{
  ...
  sub_100002F20((const char *)objc_msgSend(v2, "UTF8String"));
...
LABEL_39:
  ...
  else
  {
    ...
    if (((!v35 | v36) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        sub_100031DC8(v19, v38, v39, v40, v41, v42, v43, v44);
      v15 = 4;
      goto LABEL_39;
    }
  }
...
- (unint64_t)tableRowCount:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      sub_100031E64((uint64_t)v4, v6, v8);
...
- (id)lastInsertRowID
{
  return +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", sqlite3_last_insert_rowid(self->_db));
}
