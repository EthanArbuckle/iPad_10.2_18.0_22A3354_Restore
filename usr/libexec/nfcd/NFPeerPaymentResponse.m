...
- (NFPeerPaymentResponse)initWithDictionary:(id)a3
{
  ...
  v5 = -[NFPeerPaymentResponse init](&v13, "init");
  if (v5)
  {
    v6 = objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("transactionData")));
    ...
    v10 = objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("transactionIdentifier")));
...
- (NFPeerPaymentResponse)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)NFPeerPaymentResponse;
  v5 = -[NFPeerPaymentResponse init](&v16, "init");
  if (v5)
  {
    v6 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSData), CFSTR("transactionData"));
    v7 = objc_claimAutoreleasedReturnValue(v6);
    transactionData = v5->_transactionData;
    v5->_transactionData = (NSData *)v7;

    v9 = +[NFNSCheckedDecoder coder:decodeDictOfClass:forKey:](NFNSCheckedDecoder, "coder:decodeDictOfClass:forKey:", v4, objc_opt_class(NSString), CFSTR("certificates"));
    v10 = objc_claimAutoreleasedReturnValue(v9);
    certificates = v5->_certificates;
    v5->_certificates = (NSDictionary *)v10;

    v12 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString), CFSTR("transactionIdentifier"));
    v13 = objc_claimAutoreleasedReturnValue(v12);
    transactionIdentifier = v5->_transactionIdentifier;
    v5->_transactionIdentifier = (NSString *)v13;
