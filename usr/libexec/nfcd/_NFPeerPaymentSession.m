...
+ (id)validateEntitlements:(id)a3
{
  ...
  if ((objc_msgSend(a3, "surfSessionAccess") & 1) != 0)
    return 0;
  ...
  if (Logger)
  {
    ...
    if (isMetaClass)
      v12 = 43;
    v8(3, "%c[%{public}s %{public}s]:%i Invalid entitlements, requiring surf access", v12, ClassName, Name, 24);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 67109890;
    ...
    v34 = 1024;
    v35 = 24;
    _os_log_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_ERROR, "%c[%{public}s %{public}s]:%i Invalid entitlements, requiring surf access", buf, 0x22u);
  }
  ...
  v22 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", CFSTR("%s:%d"), sel_getName(a2), 25);
  v27[3] = v22;
...
- (void)deleteKeyWithCompletion:(id)a3
{
  ...
  v5 = a3;
  v12.receiver = self;
  v12.super_class = (Class)_NFPeerPaymentSession;
  v6 = -[_NFSession workQueue](&v12, "workQueue");
  v7 = objc_claimAutoreleasedReturnValue(v6);
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100196E44;
...
- (void)performPeerPayment:(id)a3 request:(id)a4 completion:(id)a5
{
  ...
  v11 = a5;
  v22.receiver = self;
  v22.super_class = (Class)_NFPeerPaymentSession;
  v12 = -[_NFSession workQueue](&v22, "workQueue");
  v13 = objc_claimAutoreleasedReturnValue(v12);
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100197244;
