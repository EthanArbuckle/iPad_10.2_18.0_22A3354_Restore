...
- (BOOL)load
{
  ...
  if (v4)
  {
    ...
    v41[0] = v5;
    v41[1] = CFSTR("/Library/Apple");
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v41, 2));
  ...
  else
  {
    ...
    if (!v10)
    {
      ...
      -[WhitelistChecker setDomains:](self, "setDomains:", v19);

      v20 = (void *)objc_claimAutoreleasedReturnValue(-[WhitelistChecker domains](self, "domains"));
      if (v20)
        return 1;
      v32 = sub_1000604F0();
      v33 = objc_claimAutoreleasedReturnValue(v32);
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        sub_1000C3888(v33, v34, v35, v36, v37, v38, v39, v40);

      return 0;
    }
  }
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[WhitelistChecker domainsPlistFilePath](self, "domainsPlistFilePath"));
  v13 = (void *)objc_claimAutoreleasedReturnValue(+[MSDDomainsPlistPatcher patchDomainsPlist:](MSDDomainsPlistPatcher, "patchDomainsPlist:", v11));
  if (v13 && (v14 = objc_opt_class(NSDictionary, v12), (objc_opt_isKindOfClass(v13, v14) & 1) != 0))
  {
    v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "objectForKey:", CFSTR("SystemDomains")));
    v16 = (void *)objc_claimAutoreleasedReturnValue(+[NSDictionary dictionaryWithDictionary:](NSDictionary, "dictionaryWithDictionary:", v15));
    -[WhitelistChecker setDomains:](self, "setDomains:", v16);

    v17 = (void *)objc_claimAutoreleasedReturnValue(-[WhitelistChecker domains](self, "domains"));
    if (v17)
    {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      sub_1000C3854(v23, v25, v26, v27, v28, v29, v30, v31);
  }
  else
  {
    v22 = sub_1000604F0();
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      sub_1000C37E4((uint64_t)v11, v23);
  }
...
- (id)checkManifest:(id)a3
{
  ...
  v31 = 0u;
  v7 = v4;
  v27 = objc_msgSend(v7, "countByEnumeratingWithState:objects:count:", &v28, v36, 16);
  if (!v27)
    goto LABEL_20;
  v26 = *(_QWORD *)v29;
  ...
  *(_QWORD *)&v8 = 136315394;
  ...
  do
  {
    for (i = 0; i != v27; i = (char *)i + 1)
    {
      ...
      v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "objectForKey:", v11, v24));
      v13 = (void *)objc_claimAutoreleasedReturnValue(-[WhitelistChecker getRealPathForFile:withMetaData:](self, "getRealPathForFile:withMetaData:", v11, v12));
      v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(p_superclass + 474, "sharedInstance"));
      v15 = objc_msgSend(v14, "macOS");

      if (v15)
      {
        if (-[WhitelistChecker checkFile_macOS:withMetaData:](self, "checkFile_macOS:withMetaData:", v13, v12))
          goto LABEL_18;
        goto LABEL_15;
      }
      v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(p_superclass + 474, "sharedInstance"));
      if (objc_msgSend(v16, "iOS"))
      {

LABEL_12:
        v19 = -[WhitelistChecker checkFile_iOS:withMetaData:](self, "checkFile_iOS:withMetaData:", v13, v12);
        goto LABEL_14;
      }
      v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(p_superclass + 474, "sharedInstance"));
      v18 = objc_msgSend(v17, "rOS");

      if (v18)
        goto LABEL_12;
      v19 = -[WhitelistChecker checkFile_WatchAndTV:withMetaData:](self, "checkFile_WatchAndTV:withMetaData:", v13, v12);
LABEL_14:
      v7 = v25;
...
LABEL_15:
      ...
      {
        *(_DWORD *)buf = v24;
        v33 = "-[WhitelistChecker checkManifest:]";
        v34 = 2114;
        v35 = v11;
        _os_log_impl((void *)&_mh_execute_header, v21, OS_LOG_TYPE_DEFAULT, "%s:%{public}@ failed the check.", buf, 0x16u);
      }
    ...
    || objc_msgSend(v7, "isEqualToString:", CFSTR("NSFileTypeDirectory")))
  {
    ...
    if ((objc_msgSend(v5, "isEqualToString:", v8) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        sub_1000C38BC((uint64_t)v5, (uint64_t)v8, v10);
  ...
  if (v13)
  {
    ...
    while (2)
    {
      for (i = 0; i != v14; i = (char *)i + 1)
      {
        ...
        {
          v18 = v6;
          v19 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "stringByReplacingOccurrencesOfString:withString:", v17, &stru_100141020));
          v20 = 1;
          goto LABEL_20;
        }
      }
  ...
  if (v21)
  {
    ...
    while (2)
    {
      for (j = 0; j != v22; j = (char *)j + 1)
      {
        ...
        {
          v28 = objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "stringByReplacingOccurrencesOfString:withString:", v25, &stru_100141020));
