...
+ (id)sharedInstance
{
  if (qword_100175558 != -1)
    dispatch_once(&qword_100175558, &stru_10013F948);
  return (id)qword_100175550;
}

+ (BOOL)iOSHub
{
  if (qword_100175568 != -1)
    dispatch_once(&qword_100175568, &stru_10013F968);
  return byte_100175560;
}
...
- (void)setPlatformWithManifestProductList:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "objectAtIndexedSubscript:", 0));
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "objectAtIndexedSubscript:", 0));
  ...
  if ((objc_msgSend(v9, "containsString:", CFSTR("iphone")) & 1) != 0
    || (objc_msgSend(v9, "containsString:", CFSTR("ipad")) & 1) != 0
    || objc_msgSend(v9, "containsString:", CFSTR("ipod")))
  {
    -[MSDPlatform setIOS:](self, "setIOS:", 1);
    v10 = CFSTR("iOS");
  }
  else if (objc_msgSend(v9, "containsString:", CFSTR("watch")))
  {
    -[MSDPlatform setWatchOS:](self, "setWatchOS:", 1);
    v10 = CFSTR("watchOS");
  }
  else if (objc_msgSend(v9, "containsString:", CFSTR("appletv")))
  {
    -[MSDPlatform setTvOS:](self, "setTvOS:", 1);
    v10 = CFSTR("tvOS");
  }
  else if ((objc_msgSend(v9, "containsString:", CFSTR("mac")) & 1) != 0
         || objc_msgSend(v9, "containsString:", CFSTR("adp")))
  {
  ...
  {
    if (!objc_msgSend(v9, "containsString:", CFSTR("realitydevice")))
      goto LABEL_12;
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (i = 0; i != v7; i = (char *)i + 1)
      {
        ...
        v11 = objc_opt_class(NSString, v6);
        if ((objc_opt_isKindOfClass(v10, v11) & 1) == 0)
          goto LABEL_24;
        v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "lowercaseString", (_QWORD)v15));
        if (-[MSDPlatform watchOS](self, "watchOS")
          && !objc_msgSend(v12, "containsString:", CFSTR("watch"))
          || -[MSDPlatform tvOS](self, "tvOS") && !objc_msgSend(v12, "containsString:", CFSTR("appletv"))
          || -[MSDPlatform iOS](self, "iOS")
          && (objc_msgSend(v12, "containsString:", CFSTR("iphone")) & 1) == 0
          && (objc_msgSend(v12, "containsString:", CFSTR("ipad")) & 1) == 0
          && !objc_msgSend(v12, "containsString:", CFSTR("ipod"))
          || -[MSDPlatform macOS](self, "macOS")
          && (objc_msgSend(v12, "containsString:", CFSTR("mac")) & 1) == 0
          && !objc_msgSend(v12, "containsString:", CFSTR("adp"))
          || -[MSDPlatform rOS](self, "rOS")
          && !objc_msgSend(v12, "containsString:", CFSTR("realitydevice")))
        {
