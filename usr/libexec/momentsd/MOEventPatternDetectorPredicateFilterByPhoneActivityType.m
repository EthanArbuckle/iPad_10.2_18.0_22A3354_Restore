...
{
  MOEventPatternDetectorPredicateFilterByPhoneActivityType *v2;
  MOEventPatternDetectorPredicateFilterByPhoneActivityType *v3;
  MOEventPatternDetectorPredicateFilterByPhoneActivityType *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MOEventPatternDetectorPredicateFilterByPhoneActivityType;
  v2 = -[MOEventPatternDetectorPredicateFilterByPhoneActivityType init](&v6, "init");
  v3 = v2;
  if (v2)
    v4 = v2;
...
- (id)filterEvents:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithFormat:](NSPredicate, "predicateWithFormat:", CFSTR("%K = %lu AND %K = %lu"), CFSTR("category"), 16, CFSTR("provider"), 7));
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134217984;
    ...
    _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_INFO, "Found %lu phone activity events", buf, 0xCu);
  }
