...
{
  MOEventPatternDetectorPredicateFilterByValenceClassification *v2;
  MOEventPatternDetectorPredicateFilterByValenceClassification *v3;
  MOEventPatternDetectorPredicateFilterByValenceClassification *v4;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)MOEventPatternDetectorPredicateFilterByValenceClassification;
  v2 = -[MOEventPatternDetectorPredicateFilterByValenceClassification init](&v6, "init");
  v3 = v2;
  if (v2)
    v4 = v2;
...
- (id)filterEvents:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithFormat:](NSPredicate, "predicateWithFormat:", CFSTR("%K = %lu AND %K = %lu"), CFSTR("category"), 24, CFSTR("provider"), 1));
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134217984;
    ...
    _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_INFO, "Found %lu state of mind events", buf, 0xCu);
  }
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    v26 = 0u;
    v27 = 0u;
    obj = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "valueForKeyPath:", CFSTR("@distinctUnionOfObjects.stateOfMindEvent.valenceClassification")));
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithFormat:](NSPredicate, "predicateWithFormat:", CFSTR("stateOfMindEvent.valenceClassification == %@"), *(_QWORD *)(*((_QWORD *)&v24 + 1) + 8 * (_QWORD)v12)));
