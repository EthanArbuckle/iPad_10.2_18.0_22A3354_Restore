...
+ (id)onboardingDateKey:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)onboardingDateKey__mapping, "objectForKeyedSubscript:", v4));
...
void __64__MODefaultsManager_MOEventBundleSourceType__onboardingDateKey___block_invoke(id a1)
{
  ...
  v4[0] = CFSTR("OnboardingEarliestCollectDateMedia");
  v4[1] = CFSTR("OnboardingEarliestCollectDatePhoto");
  v3[2] = MOEventBundleSourceTypeContact[0];
  v3[3] = MOEventBundleSourceTypeActivity;
  v4[2] = CFSTR("OnboardingEarliestCollectDateCommunication");
  v4[3] = CFSTR("OnboardingEarliestCollectDateActivity");
  v3[4] = MOEventBundleSourceTypeVisitLocation[0];
  v3[5] = MOEventBundleSourceTypeThirdPartyMedia[0];
  v4[4] = CFSTR("OnboardingEarliestCollectDateLocation");
  v4[5] = CFSTR("OnboardingEarliestCollectDateMedia");
  v3[6] = MOEventBundleSourceTypePeopleContext[0];
  v3[7] = MOEventBundleSourceTypeStateOfMind[0];
  v4[6] = CFSTR("OnboardingEarliestCollectDatePeople");
  v4[7] = CFSTR("OnboardingEarliestCollectDateStateOfMind");
...
- (id)onboardingDateFor:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[MODefaultsManager onboardingDateKey:](MODefaultsManager, "onboardingDateKey:", a3));
  if (v4)
    v5 = (void *)objc_claimAutoreleasedReturnValue(-[MODefaultsManager objectForKey:](self, "objectForKey:", v4));
  else
    v5 = 0;
...
{
  OUTLINED_FUNCTION_0((void *)&_mh_execute_header, a1, a3, "%s, key cannot be nil!", a5, a6, a7, a8, 2u);
  OUTLINED_FUNCTION_1();
}
...
- (void)objectForKey:.cold.2()
{
  ...
  OUTLINED_FUNCTION_0_5((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: key (in %s:%d)", v2, v3, v4, v5, v6);
  OUTLINED_FUNCTION_1();
}
