...
- (SDAirDropHandlerPhoneLinks)initWithTransfer:(id)a3
{
  ...
  return -[SDAirDropHandler initWithTransfer:bundleIdentifier:](&v4, "initWithTransfer:bundleIdentifier:", a3, CFSTR("com.apple.InCallService"));
}
...
- (BOOL)canHandleTransfer
{
  ...
  if (!-[SDAirDropHandler isJustLinks](self, "isJustLinks"))
    return 0;
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[SDAirDropHandlerPhoneLinks candidateIdentifiers](self, "candidateIdentifiers"));
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
...
{
  return (id)SFLocalizedStringForKey(CFSTR("CALL_BUTTON_TITLE"), a2);
}
...
- (int64_t)transferTypes
{
  ...
  return -[SDAirDropHandlerGenericLinks transferTypes](&v3, "transferTypes") | 0x200000000;
}
...
- (id)suitableContentsDescription
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[SDAirDropHandler alertMessageLocalizedKeyForTypeDicts:](self, "alertMessageLocalizedKeyForTypeDicts:", &off_10074FA18));
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "formattedPhoneNumber"));

  v10 = SFLocalizedStringForKey(v4, v9);
  v11 = (void *)objc_claimAutoreleasedReturnValue(v10);
  v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSString localizedStringWithFormat:](NSString, "localizedStringWithFormat:", v11, v3, v8));
