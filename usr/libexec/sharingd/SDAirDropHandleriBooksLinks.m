...
- (SDAirDropHandleriBooksLinks)initWithTransfer:(id)a3
{
  ...
  return -[SDAirDropHandler initWithTransfer:bundleIdentifier:](&v4, "initWithTransfer:bundleIdentifier:", a3, CFSTR("com.apple.iBooks"));
}
...
- (BOOL)canHandleTransfer
{
  ...
  if (!-[SDAirDropHandler isJustLinks](self, "isJustLinks"))
    return 0;
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[SDAirDropHandleriBooksLinks candidateIdentifiers](self, "candidateIdentifiers"));
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
...
- (int64_t)transferTypes
{
  ...
  return -[SDAirDropHandlerGenericLinks transferTypes](&v3, "transferTypes") | 0x400000000;
}
...
- (id)suitableContentsDescription
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[SDAirDropHandler alertMessageLocalizedKeyForTypeDicts:](self, "alertMessageLocalizedKeyForTypeDicts:", &off_10074FFA0));
