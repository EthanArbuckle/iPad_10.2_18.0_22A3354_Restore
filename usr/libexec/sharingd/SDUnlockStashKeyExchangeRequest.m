...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDUnlockStashKeyExchangeRequest;
  v3 = -[SDUnlockStashKeyExchangeRequest description](&v8, "description");
...
- (void)writeTo:(id)a3
{
  ...
  if (key)
  {
    PBDataWriterWriteDataField(v7, key, 3);
    v4 = v7;
  }
