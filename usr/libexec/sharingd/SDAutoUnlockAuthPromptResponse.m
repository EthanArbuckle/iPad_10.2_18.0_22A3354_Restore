...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDAutoUnlockAuthPromptResponse;
  v3 = -[SDAutoUnlockAuthPromptResponse description](&v8, "description");
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](NSNumber, "numberWithBool:", self->_needsImageData));
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("needsImageData"));
...
- (void)writeTo:(id)a3
{
  ...
  keyData = self->_keyData;
  if (keyData)
    PBDataWriterWriteDataField(v6, keyData, 2);
  has = (char)self->_has;
  if ((has & 4) != 0)
  {
    PBDataWriterWriteBOOLField(v6, self->_needsImageData, 3);
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = -[NSData copyWithZone:](self->_keyData, "copyWithZone:", a3);
  v8 = (void *)v6[2];
  v6[2] = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  keyData = self->_keyData;
  if ((unint64_t)keyData | *((_QWORD *)v4 + 2))
  {
...
- (unint64_t)hash
{
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
    ...
    v3 = 0;
  v4 = (unint64_t)-[NSData hash](self->_keyData, "hash");
