...
- (SDAirDropHandleriCloudFamilyLinks)initWithTransfer:(id)a3
{
  ...
  return -[SDAirDropHandler initWithTransfer:bundleIdentifier:](&v4, "initWithTransfer:bundleIdentifier:", a3, CFSTR("com.apple.family"));
}
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        if (!SFIsiCloudFamilyLink(*(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * (_QWORD)i)))
        {
          v9 = 0;
          goto LABEL_13;
        }
...
- (int64_t)transferTypes
{
  ...
  return -[SDAirDropHandlerGenericLinks transferTypes](&v3, "transferTypes") | 0x20000000000;
}

- (id)suitableContentsTitle
{
  return (id)SFLocalizedStringForKey(CFSTR("FAMILY_INVITATION_TITLE"), a2);
}
...
- (id)suitableContentsDescription
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[SDAirDropHandler alertMessageLocalizedKeyForTypeDicts:](self, "alertMessageLocalizedKeyForTypeDicts:", &off_10074FC58));
...
{
  return (id)SFLocalizedStringForKey(CFSTR("SHOW_INVITATION_BUTTON_TITLE"), a2);
}
