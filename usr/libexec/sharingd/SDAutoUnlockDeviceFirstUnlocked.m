...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDAutoUnlockDeviceFirstUnlocked;
  v3 = -[SDAutoUnlockDeviceFirstUnlocked description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SDAutoUnlockDeviceFirstUnlocked dictionaryRepresentation](self, "dictionaryRepresentation"));
