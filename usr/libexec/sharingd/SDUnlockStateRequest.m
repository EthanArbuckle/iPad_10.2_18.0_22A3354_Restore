...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDUnlockStateRequest;
  v3 = -[SDUnlockStateRequest description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SDUnlockStateRequest dictionaryRepresentation](self, "dictionaryRepresentation"));
