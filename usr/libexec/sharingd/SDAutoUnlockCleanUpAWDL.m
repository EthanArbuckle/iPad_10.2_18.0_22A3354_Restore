...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDAutoUnlockCleanUpAWDL;
  v3 = -[SDAutoUnlockCleanUpAWDL description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SDAutoUnlockCleanUpAWDL dictionaryRepresentation](self, "dictionaryRepresentation"));
