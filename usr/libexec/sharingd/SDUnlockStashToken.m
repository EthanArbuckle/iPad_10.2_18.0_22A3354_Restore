...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDUnlockStashToken;
  v3 = -[SDUnlockStashToken description](&v8, "description");
...
- (id)dictionaryRepresentation
{
  ...
  if (stashToken)
    objc_msgSend(v3, "setObject:forKey:", stashToken, CFSTR("stashToken"));
  return v3;
}
...
- (void)writeTo:(id)a3
{
  ...
  if (stashToken)
  {
    PBDataWriterWriteDataField(v7, stashToken, 3);
    v4 = v7;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = -[NSData copyWithZone:](self->_stashToken, "copyWithZone:", a3);
  v9 = (void *)v6[2];
  v6[2] = v8;
...
LABEL_14:
  ...
  stashToken = self->_stashToken;
  if ((unint64_t)stashToken | *((_QWORD *)v4 + 2))
    v7 = -[NSData isEqual:](stashToken, "isEqual:");
  else
    v7 = 1;
LABEL_15:
...
{
  objc_storeStrong((id *)&self->_stashToken, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_stashToken, 0);
}
