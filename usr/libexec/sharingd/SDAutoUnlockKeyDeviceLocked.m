...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDAutoUnlockKeyDeviceLocked;
  v3 = -[SDAutoUnlockKeyDeviceLocked description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SDAutoUnlockKeyDeviceLocked dictionaryRepresentation](self, "dictionaryRepresentation"));
