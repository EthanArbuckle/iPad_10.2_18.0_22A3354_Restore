...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SDAutoUnlockDecryptionFailed;
  v3 = -[SDAutoUnlockDecryptionFailed description](&v8, "description");
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 1) != 0)
  {
    PBDataWriterWriteUint32Field(v6, self->_errorCode, 2);
    v4 = v6;
  }
