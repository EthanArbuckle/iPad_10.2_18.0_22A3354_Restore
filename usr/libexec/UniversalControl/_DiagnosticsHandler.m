...
- (_DiagnosticsHandler)initWithSubsystem:(const char *)a3 category:(const char *)a4 provider:(id)a5
{
  ...
  handler[2] = sub_100216308;
  handler[3] = &unk_100299628;
  v23 = v8;
  v16 = v12;
  v22 = v16;
  v17 = v8;
...
+ (id)tmpDir
{
  ...
  if (qword_1002DB858)
  {
    ...
    if ((objc_msgSend(v2, "fileExistsAtPath:isDirectory:", qword_1002DB858, &v7) & 1) != 0)
    {
      v3 = v7;

      if (v3)
        return (id)objc_claimAutoreleasedReturnValue(+[NSURL fileURLWithPath:isDirectory:relativeToURL:](NSURL, "fileURLWithPath:isDirectory:relativeToURL:", qword_1002DB858, 1, 0));
    }
    else
    {
