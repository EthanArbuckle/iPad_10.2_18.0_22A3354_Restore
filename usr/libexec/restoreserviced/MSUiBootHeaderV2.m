...
- (id)_hashData:(id)a3 withMethod:(id)a4
{
  ...
  if (objc_msgSend(a4, "isEqualToString:", kAMAuthInstallApParameterImg4DigestSHA1))
  {
    v7 = 20;
    v8 = (unsigned __int8 *)calloc(0x14uLL, 1uLL);
    CC_SHA1(objc_msgSend(a3, "bytes"), v6, v8);
  }
  else if (objc_msgSend(a4, "isEqualToString:", kAMAuthInstallApParameterImg4DigestSHA384))
  {
    v7 = 48;
