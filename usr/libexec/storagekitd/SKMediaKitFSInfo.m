...
- (NSString)volumeName
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "objectForKey:", CFSTR("Volume name")));
...
- (NSString)fsType
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[SKMediaKitFSInfo fsInfo](self, "fsInfo"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "objectForKey:", CFSTR("Filesystem")));
