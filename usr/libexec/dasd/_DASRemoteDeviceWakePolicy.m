...
{
  _DASRemoteDeviceWakePolicy *v2;
  _DASRemoteDeviceWakePolicy *v3;
  NSString *policyName;
  objc_super v6;
  ...
  if (v2)
  {
    ...
    v2->_policyName = (NSString *)CFSTR("Remote Device Wake Policy");
...
+ (id)policyInstance
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1000184B0;
  block[3] = &unk_10015D3A8;
  block[4] = a1;
  if (qword_1001AB3C8 != -1)
    dispatch_once(&qword_1001AB3C8, block);
  return (id)qword_1001AB3D0;
}
...
- (id)responseForActivity:(id)a3 withState:(id)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[_DASRemoteDeviceWakeMonitor sharedMonitorWithDaemon:](_DASRemoteDeviceWakeMonitor, "sharedMonitorWithDaemon:", v6));

  LODWORD(v6) = objc_msgSend(v7, "isRemoteDeviceAwake:", v5);
  ...
  -[_DASPolicyResponseRationale addRationaleForCondition:withRequiredValue:withCurrentValue:](v8, "addRationaleForCondition:withRequiredValue:withCurrentValue:", CFSTR("remoteDeviceAwake"), 1.0, v10);
