...
{
  _DASDiskSpacePolicy *v2;
  _DASDiskSpacePolicy *v3;
  NSString *policyName;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)_DASDiskSpacePolicy;
  v2 = -[_DASDiskSpacePolicy init](&v6, "init");
  v3 = v2;
  if (v2)
  {
    policyName = v2->_policyName;
    v2->_policyName = (NSString *)CFSTR("Disk Space Policy");
...
+ (id)policyInstance
{
  ...
  block[4] = a1;
  if (qword_1001AB6D0 != -1)
    dispatch_once(&qword_1001AB6D0, block);
  return (id)qword_1001AB6D8;
}
...
- (BOOL)appliesToActivity:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "diskVolume"));
  if (v4)
    v5 = objc_msgSend(v3, "downloadSize") != 0;
  else
    v5 = 0;
...
- (id)responseForActivity:(id)a3 withState:(id)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[_DASDiskSpaceMonitor sharedMonitorWithDaemon:](_DASDiskSpaceMonitor, "sharedMonitorWithDaemon:", v6));

  LODWORD(v6) = objc_msgSend(v7, "isDiskSpaceAvailableForActivity:", v5);
  ...
  -[_DASPolicyResponseRationale addRationaleForCondition:withRequiredValue:withCurrentValue:](v8, "addRationaleForCondition:withRequiredValue:withCurrentValue:", CFSTR("diskSpaceAvailable"), 1.0, v10);
