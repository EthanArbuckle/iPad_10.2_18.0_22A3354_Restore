...
- (void)analyzeValues:(id)a3 currentContext:(id)a4
{
  ...
  _QWORD block[4];
  id v12;
  _DASBatteryTemperatureAnalyzer *v13;
  id v14;
...
{
  id v11;
  _DASBatteryTemperatureAnalyzer *v12;
  _DASSignalQueue *v13;
  ...
  OS_dispatch_queue *executionQueue;
  _DASBatteryTemperatureAnalyzer *v21;
  uint64_t v22;
  _DASTimer *monitoringTimer;
  _QWORD v25[4];
  _DASBatteryTemperatureAnalyzer *v26;
  objc_super v27;

  v11 = a4;
  v27.receiver = self;
  v27.super_class = (Class)_DASBatteryTemperatureAnalyzer;
  ...
  if (v12)
  {
    ...
    v19 = dispatch_queue_create("com.apple.das.clas.batteryTemperatureQueue", v18);
...
{
  objc_storeStrong((id *)&self->_batterytemperatureQueue, a3);
}
