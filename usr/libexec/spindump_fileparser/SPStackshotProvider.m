...
- (SPStackshotProvider)init
{
  ...
  if (v2)
  {
    ...
    v3->_sampleStore = v7;
    sub_10005993C(v7, (byte_1000EBD4C >> 3) & 1, (byte_1000EBD4C >> 2) & 1, (byte_1000EBD4C & 0x10) == 0);
...
- (void)dealloc
{
  ...
  if (self->_numClientsSampling)
  {
    ...
    sub_1000301F0("-[SPStackshotProvider dealloc]", "SPSampleProvider.m", 499, "%s: Still have %d clients sampling when dealloc'ed", v2, v3, v4, v5, (char)"_numClientsSampling == 0");
    abort();
  }
...
- (void)startSamplingThread
{
  ...
  else
  {
    ...
    v25 = pthread_create(&self->_samplingThread, 0, (void *(__cdecl *)(void *))sub_1000700D0, self);
    if ((_DWORD)v25)
    {
      *(_QWORD *)__errnum = v25;
      if (byte_1000EBD38)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          sub_100096660((uint64_t)v33, buf, __errnum[0]);
        }
        *__error() = v31;
      }
      if (byte_1000EBD39)
      ...
      if (v26)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_FAULT))
          {
            ...
            sub_100096618((uint64_t)v39, v45, __errnum[0]);
          }
          if (qword_1000EBD40)
      ...
      strerror(__errnum[0]);
      sub_1000301F0("-[SPStackshotProvider startSamplingThread]", "SPSampleProvider.m", 517, "%s: Unable to create sampling thread: %d (%s)", v27, v28, v29, v30, (char)"ret == 0");
      abort();
    }
  }
  objc_sync_exit(self);
...
- (void)stopSamplingThread
{
  ...
  if (self->_samplingThread)
  {
    ...
    if (byte_1000EBD39)
    {
      ...
      else if ((byte_1000EBD4C & 0x18) == 0x10)
      {
        if (byte_1000EBD38)
        {
          v18 = *__error();
...
+ (id)sharedInstanceLock
{
  if (qword_1000EBCF0 != -1)
    dispatch_once(&qword_1000EBCF0, &stru_1000DDBA0);
  return (id)qword_1000EBCF8;
}
          ...
          if (byte_1000EBD39 && dword_1000EB4E8 <= 1)
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
                sub_100096B40((uint64_t)objc_msgSend(objc_msgSend(v8, "description"), "UTF8String"), (uint64_t)buf, v34);
              if (qword_1000EBD40)
  ...
  else
  {
    ...
    if (byte_1000EBD38)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        sub_100096A98((uint64_t)objc_msgSend(a3, "description"), v4, (uint64_t)buf, v17);
      *__error() = v16;
    }
    if (byte_1000EBD39)
    ...
    if (v18)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT))
          sub_100096A4C((uint64_t)objc_msgSend(a3, "description"), (uint64_t)v50, v4, v30);
        if (qword_1000EBD40)
          ...
          if (byte_1000EBD39 && dword_1000EB4E8 <= 1)
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v78, OS_LOG_TYPE_FAULT))
                sub_100096BD4((uint64_t)objc_msgSend(objc_msgSend(a5, "description"), "UTF8String"), (uint64_t)v122, v78);
              if (qword_1000EBD40)
...
- (void)stopAndWaitForAllSamplingToComplete:(BOOL)a3 withCompletionCallbackOnQueue:(id)a4 withBlock:(id)a5
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100073DD8;
  block[3] = &unk_1000DD608;
  block[4] = self;
