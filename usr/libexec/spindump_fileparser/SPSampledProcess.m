...
+ (id)copySampledProcessForPid:(int)a3 isWSBased:(BOOL)a4 createIfUnsampled:(BOOL)a5 wasSampled:(BOOL *)a6
{
  ...
  if (qword_1000EBCB0 != -1)
    dispatch_once(&qword_1000EBCB0, &stru_1000DD8E8);
  ...
  v16 = a4;
  v13[6] = a6;
  dispatch_sync((dispatch_queue_t)qword_1000EBCC0, v13);
...
{
  return objc_msgSend((id)qword_1000EBCB8, "allValues");
}
...
- (void)removeSelfFromPidCache
{
  ...
  if (self->super.super._isSelfInPidCache)
  {
    ...
    v4 = targetProcessId;
    v3[4] = self;
    dispatch_async((dispatch_queue_t)qword_1000EBCC0, v3);
  }
}
...
- (void)createHIDExitSource
{
  ...
  if ((*p_targetProcessId & 0x80000000) == 0)
  {
    ...
    if (!v9)
      return;
    v10 = *__error();
    v11 = sub_1000302B4(*p_targetProcessId);
...
LABEL_24:
      ...
      v11 = *__error();
      v12 = sub_1000302B4(*p_targetProcessId);
...
LABEL_52:
  ...
  if ((targetProcessId & 0x80000000) == 0)
  {
    ...
    if (byte_1000EBD39)
      v38 = dword_1000EB4E8 <= 3;
    else
      v38 = 0;
    if (!v38)
      return;
    v39 = *__error();
    v40 = sub_1000302B4(*v34);
...
- (void)setSamplingIntervalUs:(unsigned int)a3
{
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000EBD38)
    {
      ...
      {
        v32 = sub_1000302B4(self->super.super._targetProcessId);
    ...
    if (byte_1000EBD39)
      v7 = dword_1000EB4E8 <= 3;
    else
      v7 = 0;
    if (!v7)
      return;
    v8 = *__error();
    v9 = sub_1000302B4(self->super.super._targetProcessId);
...
LABEL_51:
    ...
    {
      v24 = sub_1000302B4(self->super.super._targetProcessId);
  ...
  if (self->super.super._timeoutTime <= a3)
  {
    ...
    if (targetProcessId < 0)
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_FAULT))
        sub_100094368(v55, v56, v57, v58, v59, v60, v61, v62);
    }
    else
    {
      if (byte_1000EBD38)
      {
        ...
        {
          v67 = sub_1000302B4(*p_targetProcessId);
      ...
      if (!v23)
        goto LABEL_103;
      v24 = *__error();
      v25 = sub_1000302B4(*p_targetProcessId);
...
LABEL_103:
        ...
        block[1] = 3221225472;
        block[2] = sub_100067D00;
        block[3] = &unk_1000DD138;
        block[4] = self;
        *(double *)&block[5] = v18;
        *(double *)&block[6] = v17;
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
        sub_1000942D4(&self->super.super._targetProcessId);
    }
    if (qword_1000EBD40)
    ...
    if (self->super.super._targetProcessId < 0)
    {
      if (byte_1000EBD38)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          sub_1000948C8(v23, v24, v25, v26, v27, v28, v29, v30);
        *__error() = v22;
      }
      if (byte_1000EBD39)
      ...
      if (v31)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
            sub_100094858(v34, v35, v36, v37, v38, v39, v40, v41);
          if (qword_1000EBD40)
      ...
      sub_1000301F0("-[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1121, "%s: Must provide both queue and block", v4, v5, v6, v7, (char)"queue && block");
    }
    else
    {
      if (byte_1000EBD38)
      ...
      {
        v17 = *__error();
        v18 = sub_1000302B4(*p_targetProcessId);
      ...
      v52 = sub_1000302B4(*p_targetProcessId);
      sub_1000301F0("-[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1121, "%s [%d]: %s: Must provide both queue and block", v53, v54, v55, v56, v52);
    }
    abort();
  }
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000EBD38)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
        sub_100094C80(p_targetProcessId, v3, v8);
      *__error() = v7;
    }
    if (byte_1000EBD39)
...
LABEL_51:
    ...
    v25 = sub_100030318();
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
      sub_100094BF0(p_targetProcessId);
    goto LABEL_39;
  }
  if (byte_1000EBD38)
  {
...
LABEL_88:
        ...
        v124[1] = 3221225472;
        v124[2] = sub_10006AF98;
        v124[3] = &unk_1000DDA50;
        v125 = v4;
        v124[4] = self;
        v124[5] = a3;
    ...
    else
    {
      ...
      if (!v21)
        goto LABEL_87;
      v22 = *__error();
      v23 = sub_1000302B4(*p_targetProcessId);
...
LABEL_181:
  ...
  v128[1] = 3221225472;
  v128[2] = sub_10006AC6C;
  v128[3] = &unk_1000DD938;
  v128[4] = self;
  sub_100063B2C((uint64_t)v128);
LABEL_208:
  LOBYTE(v4) = 8;
LABEL_209:
...
- (void)_saveReportToStream:(__sFILE *)a3
{
  ...
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_1000301F0("-[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1417, "%s: save report fail %d %d %d", v3, v4, v5, v6, (char)"stream && !_isSampling && _hasSampled");
    }
    else
    {
      if (byte_1000EBD38)
      {
        ...
        {
          v39 = (const char *)sub_1000302B4(self->super.super._targetProcessId);
          targetProcessId = self->super.super._targetProcessId;
      ...
      if (v43)
      {
        v47 = a3 != 0;
        v48 = *__error();
        v49 = sub_1000302B4(self->super.super._targetProcessId);
        ...
        else
        {
          ...
          {
            v52 = (const char *)sub_1000302B4(self->super.super._targetProcessId);
      ...
      v73 = sub_1000302B4(self->super.super._targetProcessId);
      sub_1000301F0("-[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1417, "%s [%d]: %s: save report fail %d %d %d", v74, v75, v76, v77, v73);
    }
    abort();
  }
  if (!self->super.super._isUrgent)
  {
    ...
    else
    {
      if (byte_1000EBD38)
      {
        ...
        {
          v12 = (const char *)sub_1000302B4(*p_targetProcessId);
      ...
      if (byte_1000EBD39)
        v14 = dword_1000EB4E8 <= 1;
      else
        v14 = 0;
      if (!v14)
        goto LABEL_54;
      v15 = *__error();
      v16 = sub_1000302B4(*p_targetProcessId);
...
- (void)_performSamplePrinterWork:(id)a3
{
  ...
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_1000301F0("-[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1433, "%s: save report fail %d %d %d", v3, v4, v5, v6, (char)"callback && !_isSampling && _hasSampled");
    }
    else
    {
      if (byte_1000EBD38)
      ...
      v73 = sub_1000302B4(self->super.super._targetProcessId);
      sub_1000301F0("-[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1433, "%s [%d]: %s: save report fail %d %d %d", v74, v75, v76, v77, v73);
    }
    abort();
  }
  if (!self->super.super._isUrgent)
