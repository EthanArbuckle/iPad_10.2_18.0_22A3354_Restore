...
- (id)metadataForFile:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v3, v4) & 1) != 0)
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[MSDFileMetadata fileMetaDataWithMetadataDictionary:](MSDFileMetadata, "fileMetaDataWithMetadataDictionary:", v3));
  else
    v5 = 0;
...
- (BOOL)enumerateAndCollectMetaData:(id)a3 relativeTo:(id)a4 skip:(id)a5 superSet:(id)a6 handler:(id)a7
{
  ...
  v24 = objc_claimAutoreleasedReturnValue(objc_msgSend(v21, "enumeratorAtURL:includingPropertiesForKeys:options:errorHandler:", v22, v23, 0, &stru_100048E30));
...
LABEL_40:
    ...
    if (v46)
    {
      ...
      v48 = (__CFString *)objc_claimAutoreleasedReturnValue(objc_msgSend(v50, "stringByReplacingOccurrencesOfString:withString:", *p_rootPath, &stru_100049858));
    ...
    else
    {
      ...
      v48 = (__CFString *)objc_claimAutoreleasedReturnValue(objc_msgSend(v49, "stringByReplacingOccurrencesOfString:withString:", *p_rootPath, &stru_100049858));
    }
