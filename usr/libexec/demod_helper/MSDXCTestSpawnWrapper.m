...
+ (id)sharedInstance
{
  if (qword_100053E70 != -1)
    dispatch_once(&qword_100053E70, &stru_1000490A8);
  return (id)qword_100053E68;
}
...
- (id)listAllTestScripts
{
  ...
  if (v32)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      sub_10002F7F0((uint64_t)v36, v33, v38);
...
- (id)_parseTestScriptsFromXCTSpawnResultDictionary:(id)a3
{
  ...
  if (v4)
  {
      ...
      if (v55)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v33 = -[MSDKPeerDemoTestScript initWithName:andMethods:]([MSDKPeerDemoTestScript alloc], "initWithName:andMethods:", v56, v21);
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        sub_10002FA04(v12, v42, v43, v44, v45, v46, v47, v48);
      v34 = 0;
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      sub_10002F9D4(v7, v35, v36, v37, v38, v39, v40, v41);
    v34 = 0;
  }
