...
{
  return CFSTR("com.apple.os-eligibility-domain.change.sulfur");
}
...
- (id)status
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "sulfurAsset"));
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v18.receiver = self;
        v18.super_class = (Class)SulfurDomain;
