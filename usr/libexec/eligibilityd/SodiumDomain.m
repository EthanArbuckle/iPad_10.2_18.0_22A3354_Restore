...
{
  return CFSTR("com.apple.os-eligibility-domain.change.sodium");
}
...
- (void)_internal_doInit
{
  ...
  -[SodiumDomain updateParameters](self, "updateParameters");
...
- (void)updateParameters
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "sodiumAsset"));
