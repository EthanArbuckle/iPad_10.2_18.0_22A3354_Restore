...
{
  return CFSTR("com.apple.os-eligibility-domain.change.argon");
}
...
- (void)_internal_doInit
{
  ...
  -[ArgonDomain updateParameters](self, "updateParameters");
...
- (ArgonDomain)init
{
  ...
  v3 = v2;
  if (v2)
    -[ArgonDomain _internal_doInit](v2, "_internal_doInit");
  return v3;
}
...
- (ArgonDomain)initWithCoder:(id)a3
{
  ...
  v4 = v3;
  if (v3)
    -[ArgonDomain _internal_doInit](v3, "_internal_doInit");
  return v4;
}
...
- (void)updateParameters
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "argonAsset"));
