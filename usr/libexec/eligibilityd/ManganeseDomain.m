...
{
  return CFSTR("com.apple.os-eligibility-domain.change.manganese");
}
...
- (void)_internal_doInit
{
  ...
  -[ManganeseDomain updateParameters](self, "updateParameters");
...
- (void)updateParameters
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "manganeseAsset"));
