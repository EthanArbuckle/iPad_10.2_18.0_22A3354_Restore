...
{
  return CFSTR("com.apple.os-eligibility-domain.change.nitrogen");
}
...
- (void)_internal_doInit
{
  ...
  -[NitrogenDomain updateParameters](self, "updateParameters");
...
- (NitrogenDomain)init
{
  ...
  v3 = v2;
  if (v2)
    -[NitrogenDomain _internal_doInit](v2, "_internal_doInit");
  return v3;
}
...
- (NitrogenDomain)initWithCoder:(id)a3
{
  ...
  v4 = v3;
  if (v3)
    -[NitrogenDomain _internal_doInit](v3, "_internal_doInit");
  return v4;
}
...
- (void)updateParameters
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "nitrogenAsset"));
