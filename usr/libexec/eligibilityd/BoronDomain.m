...
{
  return CFSTR("com.apple.os-eligibility-domain.change.boron");
}
...
- (void)_internal_doInit
{
  ...
  -[BoronDomain updateParameters](self, "updateParameters");
...
- (BoronDomain)init
{
  ...
  v3 = v2;
  if (v2)
    -[BoronDomain _internal_doInit](v2, "_internal_doInit");
  return v3;
}
...
- (BoronDomain)initWithCoder:(id)a3
{
  ...
  v4 = v3;
  if (v3)
    -[BoronDomain _internal_doInit](v3, "_internal_doInit");
  return v4;
}
...
- (void)updateParameters
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "boronAsset"));
