...
{
  return CFSTR("com.apple.os-eligibility-domain.change.beryllium");
}
...
- (void)_internal_doInit
{
  ...
  -[BerylliumDomain updateParameters](self, "updateParameters");
...
- (void)updateParameters
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "berylliumAsset"));
