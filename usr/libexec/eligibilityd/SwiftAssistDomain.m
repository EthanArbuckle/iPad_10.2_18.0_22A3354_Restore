...
{
  return CFSTR("com.apple.os-eligibility-domain.change.swift-assist");
}
...
{
  SwiftAssistDomain *v2;
  SwiftAssistDomain *v3;
  objc_super v5;
  ...
  v3 = v2;
  if (v2)
    -[SwiftAssistDomain _internal_doInit](v2, "_internal_doInit");
  return v3;
}
...
- (SwiftAssistDomain)initWithCoder:(id)a3
{
  ...
  v4 = v3;
  if (v3)
    -[SwiftAssistDomain _internal_doInit](v3, "_internal_doInit");
  return v4;
}
...
- (unint64_t)computeInputStatusForDeviceRegionCodesInput:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "swiftAssistAsset"));
