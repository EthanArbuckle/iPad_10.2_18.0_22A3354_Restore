...
{
  return CFSTR("com.apple.os-eligibility-domain.change.krypton");
}
...
- (KryptonDomain)init
{
  ...
  v3 = v2;
  if (v2)
    -[KryptonDomain _internal_doInit](v2, "_internal_doInit");
  return v3;
}
...
- (KryptonDomain)initWithCoder:(id)a3
{
  ...
  v4 = v3;
  if (v3)
    -[KryptonDomain _internal_doInit](v3, "_internal_doInit");
  return v4;
}
...
- (id)status
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "kryptonAsset"));
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v18.receiver = self;
        v18.super_class = (Class)KryptonDomain;
