...
{
  id v4;
  CDStoreAuthenticationGetAuthInfoResponse *v5;
  CFTypeID TypeID;
  NSString *v7;
  ...
  v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)CDStoreAuthenticationGetAuthInfoResponse;
  ...
  if (v5)
  {
    ...
    v12 = objc_opt_self(AMSDelegateAuthenticateRequest);
    v13 = (void *)objc_claimAutoreleasedReturnValue(v12);
    v14 = sub_100019F54(v4, CFSTR("storeAuthenticationRequest"), (uint64_t)v13);
...
- (id)makeRapportDictionary
{
  ...
  v4 = sub_10001A22C((uint64_t)self->_authenticationRequest);
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("storeAuthenticationRequest"));
...
- (NSString)description
{
  ...
  v4 = objc_msgSend(v3, "appendObject:withName:skipIfNil:", self->_authenticationRequest, CFSTR("authenticationRequest"), 1);
