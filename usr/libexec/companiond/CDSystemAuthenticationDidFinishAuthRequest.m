...
{
  id v4;
  CDSystemAuthenticationDidFinishAuthRequest *v5;
  uint64_t v6;
  void *v7;
  id v8;
  uint64_t v9;
  ...
  v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)CDSystemAuthenticationDidFinishAuthRequest;
  v5 = -[CDSystemAuthenticationDidFinishAuthRequest init](&v20, "init");
  if (v5)
  {
    v5->_enabled = CFDictionaryGetInt64(v4, CFSTR("authResponse"), 0) != 0;
...
- (id)makeRapportDictionary
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](NSNumber, "numberWithBool:", self->_enabled));
...
- (NSString)description
{
  ...
  v4 = objc_msgSend(v3, "appendBool:withName:", self->_enabled, CFSTR("enabled"));
