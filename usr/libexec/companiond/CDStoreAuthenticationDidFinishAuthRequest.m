...
{
  id v4;
  CDStoreAuthenticationDidFinishAuthRequest *v5;
  uint64_t v6;
  void *v7;
  id v8;
  uint64_t v9;
  ...
  v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)CDStoreAuthenticationDidFinishAuthRequest;
  v5 = -[CDStoreAuthenticationDidFinishAuthRequest init](&v25, "init");
  if (v5)
  {
    v6 = objc_opt_self(AMSDelegateAuthenticateResult);
    v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
    v8 = sub_100019F54(v4, CFSTR("storeAuthenticationResult"), (uint64_t)v7);
    v9 = objc_claimAutoreleasedReturnValue(v8);
    authenticationResult = v5->_authenticationResult;
    v5->_authenticationResult = (AMSDelegateAuthenticateResult *)v9;
...
- (id)makeRapportDictionary
{
  ...
  v4 = sub_10001A22C((uint64_t)self->_authenticationResult);
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("storeAuthenticationResult"));
...
- (NSString)description
{
  ...
  v4 = objc_msgSend(v3, "appendObject:withName:skipIfNil:", self->_authenticationResult, CFSTR("authenticationResult"), 1);
...
{
  objc_storeStrong((id *)&self->_authenticationResult, a3);
}
