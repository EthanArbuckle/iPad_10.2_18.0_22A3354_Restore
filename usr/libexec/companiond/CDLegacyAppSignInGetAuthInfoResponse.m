...
{
  id v4;
  CDLegacyAppSignInGetAuthInfoResponse *v5;
  uint64_t v6;
  void *v7;
  id v8;
  uint64_t v9;
  ...
  v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CDLegacyAppSignInGetAuthInfoResponse;
  v5 = -[CDLegacyAppSignInGetAuthInfoResponse init](&v12, "init");
  if (v5)
  {
    v6 = objc_opt_self(AKCredentialRequestContext);
    v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
    v8 = sub_100019F54(v4, CFSTR("CredentialRequest"), (uint64_t)v7);
...
- (id)makeRapportDictionary
{
  ...
  v4 = sub_10001A22C((uint64_t)self->_credentialRequest);
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  objc_msgSend(v3, "setObject:forKeyedSubscript:", v5, CFSTR("CredentialRequest"));
...
- (NSString)description
{
  ...
  v4 = objc_msgSend(v3, "appendObject:withName:skipIfNil:", self->_credentialRequest, CFSTR("credentialRequest"), 1);
