...
- (void)dealloc
{
  ...
  -[NFHWMonitor dealloc](&v3, "dealloc");
}
...
- (void)hardwareStateDidChange
{
  ...
  sub_10001595C("-[NFHWMonitor hardwareStateDidChange]", CFSTR("hardwareStateDidChange"), v2, v3, v4, v5, v6, v7, v9);
