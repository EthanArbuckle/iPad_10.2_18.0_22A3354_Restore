...
+ (id)sharedFactory
{
  if (qword_1000697C0 != -1)
    dispatch_once(&qword_1000697C0, &stru_100056420);
  return (id)qword_1000697B8;
}
...
- (Class)automationHelperClassWithName:(id)a3
{
  ...
  if (!-[FMFAutomationHelperFactory hasAttemptedLoad](self, "hasAttemptedLoad"))
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "pathForResource:ofType:", CFSTR("FMDAutomationHelpers"), CFSTR("bundle")));
    v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle bundleWithPath:](NSBundle, "bundleWithPath:", v8));
    -[FMFAutomationHelperFactory setAutomationHelperBundle:](self, "setAutomationHelperBundle:", v9);

    -[FMFAutomationHelperFactory setHasAttemptedLoad:](self, "setHasAttemptedLoad:", 1);
  }
  if (-[FMFAutomationHelperFactory hasAttemptedLoad](self, "hasAttemptedLoad")
    && (v10 = (void *)objc_claimAutoreleasedReturnValue(-[FMFAutomationHelperFactory automationHelperBundle](self, "automationHelperBundle")),
        v10,
        !v10))
  {
    v15 = 0;
  ...
  {
    v11 = (void *)objc_claimAutoreleasedReturnValue(-[FMFAutomationHelperFactory automationHelperBundle](self, "automationHelperBundle"));
