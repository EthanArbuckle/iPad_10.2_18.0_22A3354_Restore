...
- (void)deinitializeRequest
{
  ...
  -[FMRequestAckRegister setRegisterCommand:](self, "setRegisterCommand:", 0);
  -[FMRequestAckRegister setAckURL:](self, "setAckURL:", 0);
}
...
- (FMRequestAckRegister)initWithProvider:(id)a3 registerCommand:(id)a4 ackURL:(id)a5
{
  ...
  if (v10)
  {
    -[FMRequestAckRegister setRegisterCommand:](v10, "setRegisterCommand:", v8);
    -[FMRequestAckRegister setAckURL:](v11, "setAckURL:", v9);
  }
...
- (id)requestUrl
{
  return -[FMRequestAckRegister ackURL](self, "ackURL");
}
...
- (id)requestBody
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)FMRequestAckRegister;
  ...
  objc_msgSend(v4, "setObject:forKeyedSubscript:", &off_10005AF68, CFSTR("statusCode"));
  v9 = (void *)objc_claimAutoreleasedReturnValue(-[FMRequestAckRegister registerCommand](self, "registerCommand"));
...
- (BOOL)canReplace:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v4, v6) & 1) != 0)
  {
    ...
    if ((objc_opt_isKindOfClass(v7, v9) & 1) != 0)
    {
      ...
      if (v10 == v11)
      {
        v13 = (void *)objc_claimAutoreleasedReturnValue(-[FMRequestAckRegister registerCommand](self, "registerCommand"));
        v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "objectForKeyedSubscript:", CFSTR("id")));
        v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "registerCommand"));
