...
- (PTPObjectInfoDataset)initWithBytes:(char *)a3 length:(unsigned int)a4 contentType:(int)a5
{
  ...
  if (-[PTPObjectInfoDataset contentLengthValid:forContentType:](v8, "contentLengthValid:forContentType:", v6, v5))
  {
    ...
    if ((_DWORD)v5)
    {
      v9->_objectHandle = sub_1000205D4(&v40);
      if (v5 > 2)
        v6 = 0;
      else
        v6 = sub_1000205D4(&v40);
    }
    v9->_storageID = sub_1000205D4(&v40);
    v9->_objectFormat = sub_100020558(&v40);
    v9->_protectionStatus = sub_100020558(&v40);
    if (v5 > 1)
    {
      if ((v5 & 0xFFFFFFFE) == 2)
        v9->_objectCompressedSize = sub_100020628((_QWORD **)&v40);
      v18 = (_DWORD)v5 == 3;
      if ((v5 - 5) > 0xFFFFFFFD)
        goto LABEL_18;
    }
    ...
    {
      v18 = 0;
      v9->_objectCompressedSize = sub_1000205D4(&v40);
    }
    v9->_thumbFormat = sub_100020558(&v40);
    v9->_thumbCompressedSize = sub_1000205D4(&v40);
    v9->_thumbPixWidth = sub_1000205D4(&v40);
    v9->_thumbPixHeight = sub_1000205D4(&v40);
    v9->_imagePixWidth = sub_1000205D4(&v40);
    v9->_imagePixHeight = sub_1000205D4(&v40);
    v9->_imageBitDepth = sub_1000205D4(&v40);
LABEL_18:
    v9->_parentObject = sub_1000205D4(&v40);
    v9->_associationType = sub_100020558(&v40);
    v9->_associationDesc = sub_1000205D4(&v40);
    v9->_sequenceNumber = sub_1000205D4(&v40);
    v19 = sub_1000206E8((const void **)&v40, (unint64_t)v10);
    v20 = objc_claimAutoreleasedReturnValue(v19);
    filename = v9->_filename;
    v9->_filename = (NSString *)v20;

    v22 = sub_1000206E8((const void **)&v40, (unint64_t)v10);
    ...
    else
    {
      ...
      v26 = sub_1000206E8((const void **)&v40, (unint64_t)v10);
      v27 = objc_claimAutoreleasedReturnValue(v26);
      v28 = v9->_modificationDate;
      v9->_modificationDate = (NSString *)v27;

      v29 = sub_1000206E8((const void **)&v40, (unint64_t)v10);
...
- (id)content:(int)a3
{
  ...
  if (a3)
  {
    sub_1000205BC((_DWORD **)&v16, self->_objectHandle);
    if (a3 <= 2)
      sub_1000205BC((_DWORD **)&v16, SHIDWORD(v15));
  }
  sub_1000205BC((_DWORD **)&v16, self->_storageID);
  sub_100020540(&v16, self->_objectFormat);
  sub_100020540(&v16, self->_protectionStatus);
  if (a3 <= 1)
  {
    ...
    sub_1000205BC((_DWORD **)&v16, objectCompressedSize);
  }
  if ((a3 & 0xFFFFFFFE) == 2)
    sub_100020610((_QWORD **)&v16, self->_objectCompressedSize);
  if ((a3 - 5) <= 0xFFFFFFFD)
  {
    sub_100020540(&v16, self->_thumbFormat);
    sub_1000205BC((_DWORD **)&v16, self->_thumbCompressedSize);
    sub_1000205BC((_DWORD **)&v16, self->_thumbPixWidth);
    sub_1000205BC((_DWORD **)&v16, self->_thumbPixHeight);
    sub_1000205BC((_DWORD **)&v16, self->_imagePixWidth);
    sub_1000205BC((_DWORD **)&v16, self->_imagePixHeight);
    sub_1000205BC((_DWORD **)&v16, self->_imageBitDepth);
  }
  sub_1000205BC((_DWORD **)&v16, self->_parentObject);
  sub_100020540(&v16, self->_associationType);
  sub_1000205BC((_DWORD **)&v16, self->_associationDesc);
  sub_1000205BC((_DWORD **)&v16, self->_sequenceNumber);
  sub_10002071C((_BYTE **)&v16, self->_filename);
  if (a3 == 3)
  {
  ...
  {
    sub_10002071C((_BYTE **)&v16, self->_captureDate);
    sub_10002071C((_BYTE **)&v16, self->_modificationDate);
    ...
    if ((unint64_t)-[NSMutableString length](self->_keywords, "length") >= 0x100)
    {
      ...
      if (os_log_type_enabled((os_log_t)_gICOSLog, OS_LOG_TYPE_ERROR))
        sub_100030914(v9, v13);

    }
  }
  sub_10002071C((_BYTE **)&v16, *p_modificationDate);
  return v6;
}
...
- (id)description
{
  ...
  v3 = sub_100021990(self->_objectFormat);
  v20 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v4 = sub_100021930(self->_protectionStatus);
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  objectCompressedSize = self->_objectCompressedSize;
  v6 = sub_100021990(self->_thumbFormat);
  ...
  v14 = sub_100021BD4(self->_associationType);
...
- (int64_t)intervalSince1970
{
  ...
  if (!result)
  {
    result = sub_10001F51C(self->_captureDate);
