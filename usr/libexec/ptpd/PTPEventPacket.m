...
- (PTPEventPacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 27) >= 0xFFFFFFF3 && *((_DWORD *)a3 + 1) == 8)
  {
    ...
    {
      v10 = (char *)a3 + 8;
      v7->_eventCode = sub_100020558(&v10);
...
- (id)contentForTCP
{
  ...
  sub_1000205BC((_DWORD **)&v7, 8);
  sub_100020540(&v7, self->_eventCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  sub_100020540(&v9, 4);
  sub_100020540(&v9, self->_eventCode);
...
- (id)description
{
  ...
  v3 = sub_100021598(self->_eventCode);
