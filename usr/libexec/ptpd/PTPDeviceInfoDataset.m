...
- (void)setContent:(id)a3
{
  ...
  v38 = v6;
  self->_standardVersion = sub_10002056C((unint64_t *)&v38, (unint64_t)v7);
  self->_vendorExtensionID = sub_100020594((unint64_t *)&v38, (unint64_t)v7);
  self->_vendorExtensionVersion = sub_10002056C((unint64_t *)&v38, (unint64_t)v7);
  v8 = sub_1000206E8((const void **)&v38, (unint64_t)v7);
  ...
  self->_functionalMode = sub_10002056C((unint64_t *)&v38, (unint64_t)v7);
  v11 = sub_100020888(&v38, (unint64_t)v7);
...
- (void)updateContent
{
  ...
  if (self->_dirty && !self->_readOnlyObject)
  {
    ...
    v15.i64[0] = v10;
    v15.i64[1] = v11;
    -[NSMutableData setLength:](self->_content, "setLength:", vaddvq_s64(vaddq_s64((int64x2_t)vbslq_s8((int8x16_t)vceqzq_s64(v14), (int8x16_t)xmmword_1000380B0, (int8x16_t)vaddq_s64(vaddq_s64(v14, v14), (int64x2_t)xmmword_1000380A0)), (int64x2_t)vbicq_s8((int8x16_t)vaddq_s64(vaddq_s64(v15, v15), vdupq_n_s64(2uLL)), (int8x16_t)vceqzq_s64(v15))))+ v13+ 2 * (v5 + v4 + v6 + v7 + v8));
    v16 = -[NSMutableData mutableBytes](self->_content, "mutableBytes");
    sub_100020540(&v16, self->_standardVersion);
    sub_1000205BC((_DWORD **)&v16, self->_vendorExtensionID);
    sub_100020540(&v16, self->_vendorExtensionVersion);
    sub_10002071C((_BYTE **)&v16, self->_vendorExtensionDescription);
    sub_100020540(&v16, self->_functionalMode);
    sub_1000208C4(&v16, self->_operationsSupported);
    sub_1000208C4(&v16, self->_eventsSupported);
    sub_1000208C4(&v16, self->_devicePropertiesSupported);
    sub_1000208C4(&v16, self->_captureFormats);
    sub_1000208C4(&v16, self->_imageFormats);
    sub_10002071C((_BYTE **)&v16, self->_manufacturer);
    sub_10002071C((_BYTE **)&v16, self->_model);
    sub_10002071C((_BYTE **)&v16, self->_deviceVersion);
    sub_10002071C((_BYTE **)&v16, self->_serialNumber);
    self->_dirty = 0;
  }
}
...
- (id)description
{
  ...
  if (v5)
  {
    ...
    do
    {
      v7 = sub_1000209EC((uint64_t)objc_msgSend(v6, "unsignedShortValue"));
  ...
  if (v11)
  {
    ...
    do
    {
      v13 = sub_100021598((int)objc_msgSend(v12, "unsignedShortValue"));
  ...
  if (v17)
  {
    ...
    do
    {
      v19 = sub_10002174C((uint64_t)objc_msgSend(v18, "unsignedShortValue"));
  ...
  if (v23)
  {
    ...
    do
    {
      v25 = sub_100021990((int)objc_msgSend(v24, "unsignedShortValue"));
  ...
  if (v29)
  {
    ...
    do
    {
      v31 = sub_100021990((int)objc_msgSend(v30, "unsignedShortValue"));
