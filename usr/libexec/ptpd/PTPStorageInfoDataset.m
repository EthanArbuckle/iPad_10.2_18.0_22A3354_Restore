...
- (void)setContent:(id)a3
{
  ...
  v14 = v6;
  self->_storageType = sub_10002056C((unint64_t *)&v14, (unint64_t)v7);
  self->_filesystemType = sub_10002056C((unint64_t *)&v14, (unint64_t)v7);
  self->_accessCapability = sub_10002056C((unint64_t *)&v14, (unint64_t)v7);
  self->_maxCapacity = sub_1000205E8((unint64_t *)&v14, (unint64_t)v7);
  self->_freeSpaceInBytes = sub_1000205E8((unint64_t *)&v14, (unint64_t)v7);
  self->_freeSpaceInImages = sub_100020594((unint64_t *)&v14, (unint64_t)v7);
  v8 = sub_1000206E8(&v14, (unint64_t)v7);
  v9 = (NSString *)objc_claimAutoreleasedReturnValue(v8);
  storageDescription = self->_storageDescription;
  self->_storageDescription = v9;

  v11 = sub_1000206E8(&v14, (unint64_t)v7);
...
- (void)updateContent
{
  ...
  if (self->_dirty && !self->_readOnlyObject)
  {
    ...
    sub_100020540(&v7, self->_storageType);
    sub_100020540(&v7, self->_filesystemType);
    sub_100020540(&v7, self->_accessCapability);
    sub_100020610((_QWORD **)&v7, self->_maxCapacity);
    sub_100020610((_QWORD **)&v7, self->_freeSpaceInBytes);
    sub_1000205BC((_DWORD **)&v7, self->_freeSpaceInImages);
    sub_10002071C((_BYTE **)&v7, self->_storageDescription);
    sub_10002071C((_BYTE **)&v7, self->_volumeLabel);
  }
}
...
- (id)description
{
  ...
  v4 = sub_1000217EC(self->_storageType);
  v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
  objc_msgSend(v3, "appendFormat:", CFSTR("%@\n  _filesystemType:     "), v5);

  v6 = sub_100021844(self->_filesystemType);
  v7 = (void *)objc_claimAutoreleasedReturnValue(v6);
  objc_msgSend(v3, "appendFormat:", CFSTR("%@\n  _accessCapability:   "), v7);

  v8 = sub_1000218D8(self->_accessCapability);
