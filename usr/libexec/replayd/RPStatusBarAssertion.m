...
- (void)showStatusBarWithPid:(int)a3
{
  ...
  if (self->_assertion)
  {
    ...
    -[SBSStatusBarStyleOverridesCoordinator setRegisteredStyleOverrides:reply:](self->_coordinator, "setRegisteredStyleOverrides:reply:", 0x100000, &stru_100081588);
...
- (void)invalidateStatusBar
{
  ...
  if (self->_assertion)
  {
    ...
    -[SBSStatusBarStyleOverridesCoordinator setRegisteredStyleOverrides:reply:](self->_coordinator, "setRegisteredStyleOverrides:reply:", 0, &stru_1000815A8);
    coordinator = self->_coordinator;
    self->_coordinator = 0;
