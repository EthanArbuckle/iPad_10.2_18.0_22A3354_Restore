...
+ (id)_rpUserErrorForCode:(int64_t)a3 userInfo:(id)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle _rpLocalizedStringFromFrameworkBundleWithKey:](NSBundle, "_rpLocalizedStringFromFrameworkBundleWithKey:", v9));
  if (v10)
    objc_msgSend(v8, "setValue:forKey:", v10, NSLocalizedDescriptionKey);
  v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSError errorWithDomain:code:userInfo:](NSError, "errorWithDomain:code:userInfo:", CFSTR("com.apple.ReplayKit.RPRecordingErrorDomain"), a3, v8));
...
+ (id)_scUserErrorForCode:(int64_t)a3 userInfo:(id)a4
{
  ...
  if ((unint64_t)(a3 + 3821) > 0x14)
    ...
    v9 = off_100081090[a3 + 3821];
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle _rpLocalizedStringFromFrameworkBundleWithKey:](NSBundle, "_rpLocalizedStringFromFrameworkBundleWithKey:", v9));
  if (v10)
    objc_msgSend(v8, "setValue:forKey:", v10, NSLocalizedDescriptionKey);
  v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSError errorWithDomain:code:userInfo:](NSError, "errorWithDomain:code:userInfo:", CFSTR("com.apple.ScreenCaptureKit.SCStreamErrorDomain"), a3, v8));
