...
- (NSString)identifier
{
  return (NSString *)CFSTR("com.apple.mlruntimed.xpc_activity-fedstats");
}
...
- (NSString)description
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[MLRXPCActivityTaskFedStatsWithLockedDevice identifier](self, "identifier"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[MLRXPCActivityTaskFedStatsWithLockedDevice activity](self, "activity"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MLRXPCActivityTaskFedStatsWithLockedDevice criteria](self, "criteria"));
...
- (void)startTaskWithCompletion:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "allFedStatsUnrestrictedBundleIds"));

  v7 = (MLRTaskScheduler *)objc_claimAutoreleasedReturnValue(-[MLRXPCActivityTaskFedStatsWithLockedDevice createTaskScheduler](self, "createTaskScheduler"));
