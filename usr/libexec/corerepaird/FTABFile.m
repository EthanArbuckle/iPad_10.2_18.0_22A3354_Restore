...
- (NSString)dumpString
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile url](self, "url"));
  objc_msgSend(v3, "appendFormat:", CFSTR("Location: %@\n"), v4);

  objc_msgSend(v3, "appendFormat:", CFSTR("Generation: 0x%08x\n"), -[FTABFile generation](self, "generation"));
  objc_msgSend(v3, "appendFormat:", CFSTR("Valid: %u\n"), -[FTABFile valid](self, "valid"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile bootNonce](self, "bootNonce"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "byteString"));
  objc_msgSend(v3, "appendFormat:", CFSTR("Boot nonce: %@\n"), v6);

  v7 = objc_alloc((Class)NSString);
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile magic](self, "magic"));
  v9 = objc_msgSend(v7, "initWithData:encoding:", v8, 4);

  objc_msgSend(v3, "appendFormat:", CFSTR("Magic: %@\n"), v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile manifest](self, "manifest"));

  if (v10)
  {
    v11 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile manifest](self, "manifest"));
    v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "dumpString"));
  ...
  v21 = 0u;
  v22 = 0u;
  v13 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile subfiles](self, "subfiles"));
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(*(id *)(*((_QWORD *)&v21 + 1) + 8 * (_QWORD)v17), "dumpString"));
        objc_msgSend(v3, "appendFormat:", CFSTR("\n%@\n"), v18);
  ...
  v19 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithString:](NSString, "stringWithString:", v3));
  return (NSString *)v19;
}
...
- (FTABFile)initWithContentsOfURL:(id)a3
{
  ...
  v6 = -[FTABFile init](&v14, "init");
  if (!v6)
    goto LABEL_5;
  v13 = 0;
  v7 = objc_claimAutoreleasedReturnValue(+[NSData dataWithContentsOfURL:options:error:](NSData, "dataWithContentsOfURL:options:error:", v5, 1, &v13));
  v8 = v13;
...
- (FTABFile)init
{
  ...
  if (v2)
  {
    ...
    v8 = objc_claimAutoreleasedReturnValue(+[NSData dataWithBytes:length:](NSData, "dataWithBytes:length:", "rkosftab", 8));
    magic = v2->_magic;
    v2->_magic = (NSData *)v8;
...
- (BOOL)parseFileData
{
  ...
  if (self->_fileLength > 0x2F)
  {
    ...
    {
      v8 = (NSData *)objc_claimAutoreleasedReturnValue(+[NSData dataWithBytes:length:](NSData, "dataWithBytes:length:", v7, 8));
      magic = self->_magic;
      self->_magic = v8;

      self->_generation = *(_DWORD *)filePointer;
      self->_valid = *((_DWORD *)filePointer + 1);
      v10 = (NSData *)objc_claimAutoreleasedReturnValue(+[NSData dataWithBytes:length:](NSData, "dataWithBytes:length:", filePointer + 8, 8));
            ...
            i += 16)
      {
        ...
        if (!v20)
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR))
            sub_100032AEC((unsigned __int8 *)&filePointer[i + 48], v2);
          goto LABEL_26;
        }
        v21 = v20;
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "tag", (_QWORD)v13));
...
- (void)removeSubfileWithTag:(id)a3
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile subfileWithTag:](self, "subfileWithTag:", a3));
  if (v4)
  {
    v5 = v4;
...
- (id)description
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[NSData byteString](self->_bootNonce, "byteString"));
  ...
  v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithString:](NSString, "stringWithString:", v4));
...
- (BOOL)addSubfileWithTagName:(id)a3 contentsOfURL:(id)a4
{
  ...
  v7 = a4;
  v13 = 0;
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSData dataWithContentsOfURL:options:error:](NSData, "dataWithContentsOfURL:options:error:", v7, 1, &v13));
  v9 = v13;
  if (v8)
  {
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(*(id *)(*((_QWORD *)&v10 + 1) + 8 * (_QWORD)v8), "tag"));
...
LABEL_14:
  ...
  v17 = 0;
  v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSFileHandle fileHandleForWritingToURL:error:](NSFileHandle, "fileHandleForWritingToURL:error:", v3, &v17));
  v9 = (os_log_t)v17;
  if (!v13)
  {
...
- (BOOL)configureFileHandleWriteDestinationForURL:(id)a3
{
  ...
  v6 = (NSFileHandle *)objc_claimAutoreleasedReturnValue(-[FTABFile createFileHandleForWritingToURL:](self, "createFileHandleForWritingToURL:", v5));
...
- (void)configureDataWriteDestination
{
  ...
  v4 = (NSMutableData *)objc_claimAutoreleasedReturnValue(+[NSMutableData data](NSMutableData, "data"));
  dataWriteDestination = self->_dataWriteDestination;
...
- (BOOL)writeToDestination
{
  ...
  if (!-[FTABFile writeBytes:length:](self, "writeBytes:length:", v50, 48))
  {
    ...
    if (os_log_type_enabled(&v7->super.super, OS_LOG_TYPE_ERROR))
      sub_100029CCC(&v7->super.super, v22, v23, v24, v25, v26, v27, v28);
    goto LABEL_31;
  }
  v46 = 0u;
  v47 = 0u;
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        v42 = 0;
        v43 = 0;
        v14 = objc_retainAutorelease((id)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "tag")));
...
LABEL_30:
    ...
    && !-[FTABFile writeBytes:length:](self, "writeBytes:length:", -[FTABSubfile dataPointer](v15, "dataPointer"), -[FTABSubfile dataLength](self->_manifest, "dataLength")))
  {
    v7 = (NSMutableArray *)os_log_create("com.apple.accessoryupdater.ftab", "writing");
    if (os_log_type_enabled(&v7->super.super, OS_LOG_TYPE_ERROR))
      sub_100029C1C(&v7->super.super, v31, v32, v33, v34, v35, v36, v37);
LABEL_31:
    v21 = 0;
    goto LABEL_32;
  }
...
- (id)writeToData
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSData dataWithData:](NSData, "dataWithData:", self->_dataWriteDestination));
  dataWriteDestination = self->_dataWriteDestination;
  self->_dataWriteDestination = 0;
...
- (BOOL)writeSubfileToURL:(id)a3 tag:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile subfileWithTag:](self, "subfileWithTag:", v7));
  if (v8)
  {
    v9 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile createFileHandleForWritingToURL:](self, "createFileHandleForWritingToURL:", v6));
    if (v9)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile writeToData](self, "writeToData", a3));
...
- (NSString)bverString
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[FTABFile subfileWithTag:](self, "subfileWithTag:", CFSTR("bver")));
  v3 = v2;
  if (v2 && (v4 = objc_msgSend(v2, "dataLength")) != 0)
  {
    ...
    if (*((_BYTE *)objc_msgSend(v3, "dataPointer") + v4 - 1) == 10)
      ...
      v5 = v5;
    v6 = objc_msgSend(objc_alloc((Class)NSString), "initWithBytes:length:encoding:", objc_msgSend(v3, "dataPointer"), v5, 4);
  }
  else
  {
    v6 = 0;
