...
{
  id v4;
  UARPTLVPersonalizationFTABSubfileTagBackDeploy *v5;
  id v6;
  void *v7;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationFTABSubfileTagBackDeploy metaDataTableEntry](UARPTLVPersonalizationFTABSubfileTagBackDeploy, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v8 = uarpHtonl(+[UARPTLVPersonalizationFTABSubfileTagBackDeploy tlvType](UARPTLVPersonalizationFTABSubfileTagBackDeploy, "tlvType"));
  objc_msgSend(v3, "appendBytes:length:", &v8, 4);
  v7 = uarpHtonl(4u);
  objc_msgSend(v3, "appendBytes:length:", &v7, 4);
  v4 = -[UARPTLVPersonalizationFTABSubfileTagBackDeploy tlvValue](self, "tlvValue");
...
+ (id)metaDataTableEntry
{
  ...
  v6[0] = CFSTR("Personalization FTAB Payload Tag");
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationFTABSubfileTagBackDeploy tlvType](UARPTLVPersonalizationFTABSubfileTagBackDeploy, "tlvType"));
  v6[1] = v2;
...
+ (id)tlvFromPropertyListValue:(id)a3
{
  ...
  id v5;
  char *v6;
  UARPTLVPersonalizationFTABSubfileTagBackDeploy *v7;
  ...
  if ((objc_opt_isKindOfClass(v3, v4) & 1) != 0)
  {
    ...
    if (objc_msgSend(v5, "length") == (id)4)
    {
      ...
      v7 = objc_opt_new(UARPTLVPersonalizationFTABSubfileTagBackDeploy);
      ...
      -[UARPTLVPersonalizationFTABSubfileTagBackDeploy setTag:](v7, "setTag:", v8);
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  if (a3 == 4)
  {
    v5 = objc_opt_new(UARPTLVPersonalizationFTABSubfileTagBackDeploy);
    ...
    -[UARPTLVPersonalizationFTABSubfileTagBackDeploy setTag:](v5, "setTag:", v6);
