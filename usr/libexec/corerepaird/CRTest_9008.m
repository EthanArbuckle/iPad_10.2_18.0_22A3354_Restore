...
- (CRTest_9008)init
{
  ...
  if (v2)
  {
    -[CRTest setName:](v2, "setName:", CFSTR("9008"));
    -[CRTest setTestId:](v3, "setTestId:", &off_1000584C8);
...
- (BOOL)shouldRun:(id)a3
{
  ...
  {
    v5 = objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "rik"));
    if (v5)
    {
      v6 = (void *)v5;
...
- (void)update:(id)a3 testIndex:(int64_t)a4 testResult:(id)a5
{
  ...
  if (!v8 || !a5)
    goto LABEL_11;
  v25.receiver = self;
  v25.super_class = (Class)CRTest_9008;
