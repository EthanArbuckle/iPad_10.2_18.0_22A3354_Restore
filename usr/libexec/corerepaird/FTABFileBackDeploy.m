...
- (FTABFileBackDeploy)init
{
  ...
  if (v2)
  {
    ...
    v8 = +[NSData dataWithBytes:length:](NSData, "dataWithBytes:length:", &unk_100049498, 8);
    magic = v2->_magic;
    v2->_magic = v8;
    ...
    if (*((_QWORD *)filePointer + 4) == 0x42415446534F4B52 || *v7 == 0x62617466736F6B72)
    {
            ...
            i += 16)
      {
        ...
        if (!v20)
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR))
            sub_1000296C8((unsigned __int8 *)&filePointer[i + 48], v2);
          goto LABEL_26;
        }
        v21 = v20;
