...
- (BMMultiStreamVectorClock)init
{
  ...
  v2 = -[BMMultiStreamVectorClock init](&v6, "init");
  if (v2)
  {
...
- (unint64_t)hash
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[BMMultiStreamVectorClock allKeys](self, "allKeys"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  v4 = a3;
  v6 = objc_opt_class(BMMultiStreamVectorClock, v5);
  if ((objc_opt_isKindOfClass(v4, v6) & 1) != 0)
  {
    v7 = objc_alloc((Class)NSSet);
    v8 = (void *)objc_claimAutoreleasedReturnValue(-[BMMultiStreamVectorClock allKeys](self, "allKeys"));
      ...
      if (v14)
      {
        ...
        while (2)
        {
          for (i = 0; i != v15; i = (char *)i + 1)
          {
            ...
            v19 = (void *)objc_claimAutoreleasedReturnValue(-[BMMultiStreamVectorClock vectorClockForStreamIdentifier:](self, "vectorClockForStreamIdentifier:", v18));
            v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "vectorClockForStreamIdentifier:", v18));
            v21 = objc_msgSend(v19, "compareToTimestampVector:", v20);
...
- (BMMultiStreamVectorClock)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)BMMultiStreamVectorClock;
  v6 = -[BMMultiStreamVectorClock init](&v15, "init");
  if (v6)
  {
    v16[0] = objc_opt_class(NSString, v5);
    v16[1] = objc_opt_class(NSDictionary, v7);
    v16[2] = objc_opt_class(CKDistributedTimestampVector, v8);
...
+ (id)deserialize:(id)a3 error:(id *)a4
{
  ...
  {
    v5 = a3;
    v7 = +[NSKeyedUnarchiver unarchivedObjectOfClass:fromData:error:](NSKeyedUnarchiver, "unarchivedObjectOfClass:fromData:error:", objc_opt_class(BMMultiStreamVectorClock, v6), v5, a4);
