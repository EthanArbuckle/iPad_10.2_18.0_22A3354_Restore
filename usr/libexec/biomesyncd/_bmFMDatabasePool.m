...
+ (id)databasePoolWithURL:(id)a3 flags:(int)a4
{
  ...
  v9 = objc_msgSend(v7, "initWithPath:flags:", v8, v4);
  return v9;
}
...
- (_bmFMDatabasePool)initWithPath:(id)a3 flags:(int)a4 vfs:(id)a5
{
  ...
  if (v10)
  {
    ...
    v13 = objc_retainAutorelease(objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", CFSTR("fmdb.%@"), v10));
...
- (void)inDatabase:(id)a3
{
  ...
  v4 = (void (**)(id, id))a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[_bmFMDatabasePool db](self, "db"));
  v4[2](v4, v5);
...
- (void)beginTransaction:(int64_t)a3 withBlock:(id)a4
{
  ...
  v9 = 0;
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[_bmFMDatabasePool db](self, "db"));
  v8 = v7;
  switch(a3)
  {
    case 2:
...
- (id)inSavePoint:(id)a3
{
  ...
  v6 = qword_10007BEA0++;
  v7 = objc_msgSend(v5, "initWithFormat:", CFSTR("savePoint%ld"), v6);
  v18 = 0;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[_bmFMDatabasePool db](self, "db"));
  v17 = 0;
