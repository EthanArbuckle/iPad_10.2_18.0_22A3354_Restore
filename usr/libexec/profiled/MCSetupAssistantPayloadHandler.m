...
- (BOOL)installWithInstaller:(id)a3 options:(id)a4 interactionClient:(id)a5 outError:(id *)a6
{
  ...
  v12 = MCSetupAssistantErrorDomain;
  v13 = MCErrorArray(CFSTR("SETUP_ASSISTANT_SETTINGS_MULTIPLE_SETTINGS"));
  v14 = (void *)objc_claimAutoreleasedReturnValue(v13);
  v15 = MCErrorTypeFatal;
  v16 = (void *)objc_claimAutoreleasedReturnValue(+[NSError MCErrorWithDomain:code:descriptionArray:errorType:](NSError, "MCErrorWithDomain:code:descriptionArray:errorType:", v12, 56000, v14, MCErrorTypeFatal, 0));
