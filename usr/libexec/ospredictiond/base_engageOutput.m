...
- (base_engageOutput)initWithEngage:(int64_t)a3 classProbability:(id)a4
{
  ...
  v8 = -[base_engageOutput init](&v11, "init");
  v9 = v8;
  if (v8)
  {
    v8->_engage = a3;
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065A10);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[MLFeatureValue featureValueWithInt64:](MLFeatureValue, "featureValueWithInt64:", -[base_engageOutput engage](self, "engage")));
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[base_engageOutput classProbability](self, "classProbability"));
