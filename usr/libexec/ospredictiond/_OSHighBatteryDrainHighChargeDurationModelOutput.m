...
{
  id v7;
  _OSHighBatteryDrainHighChargeDurationModelOutput *v8;
  _OSHighBatteryDrainHighChargeDurationModelOutput *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)_OSHighBatteryDrainHighChargeDurationModelOutput;
  v8 = -[_OSHighBatteryDrainHighChargeDurationModelOutput init](&v11, "init");
  v9 = v8;
  if (v8)
  {
    v8->_label = a3;
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065980);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[MLFeatureValue featureValueWithInt64:](MLFeatureValue, "featureValueWithInt64:", -[_OSHighBatteryDrainHighChargeDurationModelOutput label](self, "label")));
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[_OSHighBatteryDrainHighChargeDurationModelOutput classProbability](self, "classProbability"));
