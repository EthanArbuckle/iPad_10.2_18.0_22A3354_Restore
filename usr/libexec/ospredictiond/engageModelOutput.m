...
{
  id v7;
  engageModelOutput *v8;
  engageModelOutput *v9;
  objc_super v11;

  v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)engageModelOutput;
  v8 = -[engageModelOutput init](&v11, "init");
  v9 = v8;
  if (v8)
  {
    v8->_engage = a3;
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065B60);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[MLFeatureValue featureValueWithInt64:](MLFeatureValue, "featureValueWithInt64:", -[engageModelOutput engage](self, "engage")));
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("classProbability")))
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[engageModelOutput classProbability](self, "classProbability"));
