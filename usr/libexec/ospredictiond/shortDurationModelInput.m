...
{
  shortDurationModelInput *result;
  objc_super v37;

  v37.receiver = self;
  v37.super_class = (Class)shortDurationModelInput;
  result = -[shortDurationModelInput init](&v37, "init");
  if (result)
  {
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065B18);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    -[shortDurationModelInput plugin_battery_level](self, "plugin_battery_level");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("time_from_plugin")))
  {
    -[shortDurationModelInput time_from_plugin](self, "time_from_plugin");
  }
  ...
  {
    -[shortDurationModelInput med_dur](self, "med_dur");
  }
  ...
  {
    -[shortDurationModelInput cnt_dur](self, "cnt_dur");
  }
  ...
  {
    -[shortDurationModelInput std_dur](self, "std_dur");
  }
  ...
  {
    -[shortDurationModelInput weekday_med_dur](self, "weekday_med_dur");
  }
  else
  {
    ...
    -[shortDurationModelInput weekday_std_dur](self, "weekday_std_dur");
  }
