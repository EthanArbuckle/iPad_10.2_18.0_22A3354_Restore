...
{
  _OSHighBatteryDrainLowChargeDurationModelInput *result;
  objc_super v26;

  v26.receiver = self;
  v26.super_class = (Class)_OSHighBatteryDrainLowChargeDurationModelInput;
  result = -[_OSHighBatteryDrainLowChargeDurationModelInput init](&v26, "init");
  if (result)
  {
    result->_activity = a3;
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065998);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput activity](self, "activity");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("n_events_prior")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput n_events_prior](self, "n_events_prior");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("batt_weekday_percentile_prior")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput batt_weekday_percentile_prior](self, "batt_weekday_percentile_prior");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("dist_from_total_mean")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput dist_from_total_mean](self, "dist_from_total_mean");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("drain_since_last_plugin")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput drain_since_last_plugin](self, "drain_since_last_plugin");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("max_batt_12")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput max_batt](self, "max_batt");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_activity")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput mean_activity](self, "mean_activity");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("mean_daily_plugins")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput mean_daily_plugins](self, "mean_daily_plugins");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("net_drain_since_max")))
  {
    -[_OSHighBatteryDrainLowChargeDurationModelInput net_drain_since_max](self, "net_drain_since_max");
  }
  else
  {
    ...
    {
      -[_OSHighBatteryDrainLowChargeDurationModelInput recent_drain_15min](self, "recent_drain_15min");
      goto LABEL_30;
    }
    if (objc_msgSend(v4, "isEqualToString:", CFSTR("recent_drain_3")))
    {
LABEL_20:
      -[_OSHighBatteryDrainLowChargeDurationModelInput recent_drain](self, "recent_drain");
    }
    else if (objc_msgSend(v4, "isEqualToString:", CFSTR("start_time_secs")))
    {
      -[_OSHighBatteryDrainLowChargeDurationModelInput start_time_secs](self, "start_time_secs");
    }
    else if (objc_msgSend(v4, "isEqualToString:", CFSTR("user_mean_drain")))
    {
      -[_OSHighBatteryDrainLowChargeDurationModelInput user_mean_drain](self, "user_mean_drain");
    }
    else
    {
      ...
      -[_OSHighBatteryDrainLowChargeDurationModelInput value](self, "value");
    }
  }
LABEL_30:
