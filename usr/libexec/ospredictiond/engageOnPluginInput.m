...
{
  engageOnPluginInput *result;
  objc_super v37;

  v37.receiver = self;
  v37.super_class = (Class)engageOnPluginInput;
  result = -[engageOnPluginInput init](&v37, "init");
  if (result)
  {
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065A58);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    -[engageOnPluginInput plugin_battery_level](self, "plugin_battery_level");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("time_from_plugin")))
  {
    -[engageOnPluginInput time_from_plugin](self, "time_from_plugin");
  }
  ...
  {
    -[engageOnPluginInput med_dur](self, "med_dur");
  }
  ...
  {
    -[engageOnPluginInput cnt_dur](self, "cnt_dur");
  }
  ...
  {
    -[engageOnPluginInput std_dur](self, "std_dur");
  }
  ...
  {
    -[engageOnPluginInput weekday_med_dur](self, "weekday_med_dur");
  }
  else
  {
    ...
    -[engageOnPluginInput weekday_std_dur](self, "weekday_std_dur");
  }
