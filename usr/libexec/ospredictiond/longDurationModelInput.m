...
{
  longDurationModelInput *result;
  objc_super v37;

  v37.receiver = self;
  v37.super_class = (Class)longDurationModelInput;
  result = -[longDurationModelInput init](&v37, "init");
  if (result)
  {
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_100065AE8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    -[longDurationModelInput plugin_battery_level](self, "plugin_battery_level");
  }
  else if (objc_msgSend(v4, "isEqualToString:", CFSTR("time_from_plugin")))
  {
    -[longDurationModelInput time_from_plugin](self, "time_from_plugin");
  }
  ...
  {
    -[longDurationModelInput med_dur](self, "med_dur");
  }
  ...
  {
    -[longDurationModelInput cnt_dur](self, "cnt_dur");
  }
  ...
  {
    -[longDurationModelInput std_dur](self, "std_dur");
  }
  ...
  {
    -[longDurationModelInput weekday_med_dur](self, "weekday_med_dur");
  }
  else
  {
    ...
    -[longDurationModelInput weekday_std_dur](self, "weekday_std_dur");
  }
