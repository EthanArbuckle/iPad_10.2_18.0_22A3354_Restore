...
- (NSArray)prefContextPrefixPriorityOrder
{
  ...
  return (NSArray *)(id)qword_10001E530;
}
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        v15 = -[__CFString isEqualToString:](v14, "isEqualToString:", &stru_1000189E8);
        if (v15)
          v16 = v29;
        else
  ...
  if (os_log_type_enabled(obj, OS_LOG_TYPE_DEBUG))
    sub_10000F158((uint64_t)v29, (uint64_t)a4, obj);
  v19 = 0;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (!-[NSString isEqualToString:](v9, "isEqualToString:", v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      sub_10000F1DC((uint64_t)v9, &self->_enablementPrefix, v11);
...
- (void)__createInternalSettings
{
  ...
  CFPreferencesSetValue(CFSTR("HangTracerInternalSettingsVersion"), &off_100019FA8, self->__htTaskingDomain, CFSTR("mobile"), kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(_QWORD *)buf = 0;
  ...
  notify_register_dispatch(off_10001E500, v32 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001E4E8, (int *)v44 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001E4F0, v40 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001E4F8, v36 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_10001E508, v26 + 6, (dispatch_queue_t)self->__prefsQueue, v21);
  -[HTPrefs setShouldPostHTPrefsChangedNotification:](self, "setShouldPostHTPrefsChangedNotification:", 1);
