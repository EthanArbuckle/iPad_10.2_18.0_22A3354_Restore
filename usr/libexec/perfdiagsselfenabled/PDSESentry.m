...
+ (BOOL)wantsEnablement
{
  ...
  v3 = objc_msgSend(v2, "pdseSentryPeriodDays");
  v4 = sub_10000E858(CFSTR("PDSESentry"));
...
+ (BOOL)willEnableDiagnostics
{
  ...
  v4 = (const __CFString *)sub_100003FD0((uint64_t)CFSTR("HangTracerEnableSignpostMonitoring"), (uint64_t)CFSTR("PDSESentry"));
  CFPreferencesSetValue(v4, kCFBooleanTrue, CFSTR("com.apple.da"), CFSTR("mobile"), kCFPreferencesAnyHost);
  v5 = sub_10000DFC0();
  v6 = objc_claimAutoreleasedReturnValue(v5);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    sub_10000F6BC((uint64_t)CFSTR("HangTracerEnableSignpostMonitoring"), (uint64_t)CFSTR("PDSESentry"), v6);
...
+ (BOOL)didDisableDiagnostics
{
  ...
  v23 = 0u;
  v24 = 0u;
  v4 = sub_100004004(CFSTR("com.apple.da"), CFSTR("mobile"), (uint64_t)CFSTR("PDSESentry"));
  ...
  v13 = sub_100004004(CFSTR("com.apple.da"), CFSTR("mobile"), (uint64_t)CFSTR("PDSESentry"));
