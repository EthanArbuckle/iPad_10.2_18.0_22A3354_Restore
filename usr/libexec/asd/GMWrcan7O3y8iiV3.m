...
- (GMWrcan7O3y8iiV3)init
{
  GMWrcan7O3y8iiV3 *v2;
  uint64_t v3;
  OS_os_transaction *BcUJq3Q7Dzl8BUQE;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)GMWrcan7O3y8iiV3;
  v2 = -[GMWrcan7O3y8iiV3 init](&v6, "init");
  if (v2)
  {
    v3 = os_transaction_create("com.apple.asd.ascse");
...
{
  objc_storeStrong((id *)&self->_PpszCwt7GD641hHj, a3);
}
