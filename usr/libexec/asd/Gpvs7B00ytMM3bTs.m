...
- (Gpvs7B00ytMM3bTs)initWithdEyUJuqYjUufZYGN:(id)a3 Po0NnEfbQHpSgzj7:(id)a4 jHoy3L8RogTTbjjB:(_yo6ptGgiZw8VbWk1 *)a5 X5iUjoUzZPsj1b68:(int64_t)a6
{
  id v10;
  id v11;
  Gpvs7B00ytMM3bTs *v12;
  PGiTJtLgUnKcxckL *v13;
  PGiTJtLgUnKcxckL *bindingsEvaluator;
  Hc1u6WJuVM53BcQE *v15;
  Hc1u6WJuVM53BcQE *kernelInfoEvaluator;
  KII4PpQSDEXNXgDb *v17;
  ...
  v12 = -[Gpvs7B00ytMM3bTs init](&v20, "init");
  if (v12)
  {
    v13 = -[PGiTJtLgUnKcxckL initWithdEyUJuqYjUufZYGN:]([PGiTJtLgUnKcxckL alloc], "initWithdEyUJuqYjUufZYGN:", v10);
    bindingsEvaluator = v12->_bindingsEvaluator;
    v12->_bindingsEvaluator = v13;

    v15 = -[Hc1u6WJuVM53BcQE initWithdEyUJuqYjUufZYGN:]([Hc1u6WJuVM53BcQE alloc], "initWithdEyUJuqYjUufZYGN:", v11);
    kernelInfoEvaluator = v12->_kernelInfoEvaluator;
    v12->_kernelInfoEvaluator = v15;

    v17 = -[KII4PpQSDEXNXgDb initWithSmoothFunctions:X5iUjoUzZPsj1b68:]([KII4PpQSDEXNXgDb alloc], "initWithSmoothFunctions:X5iUjoUzZPsj1b68:", a5, a6);
...
- (id)rk4Hn364TkSyMq2q:(unsigned int)a3 version:(unsigned int)a4
{
  ...
  {
    case 0u:
      v4 = (LnikKUnLg4pTiUUG *)objc_claimAutoreleasedReturnValue(-[Gpvs7B00ytMM3bTs bindingsEvaluator](self, "bindingsEvaluator"));
      return v4;
    case 1u:
      v5 = LXKFKpCcpHk2mY6n;
      goto LABEL_33;
    ...
    case 8u:
      ...
      goto LABEL_33;
    case 9u:
      v4 = (LnikKUnLg4pTiUUG *)objc_claimAutoreleasedReturnValue(-[Gpvs7B00ytMM3bTs kernelInfoEvaluator](self, "kernelInfoEvaluator"));
      return v4;
    case 0xAu:
      v5 = Y1qhGFeay19f76Cw;
      goto LABEL_33;
...
LABEL_33:
      ...
      break;
    default:
      v4 = -[LnikKUnLg4pTiUUG initWithType:]([LnikKUnLg4pTiUUG alloc], "initWithType:", *(_QWORD *)&a3);
      break;
  }
  return v4;
}
