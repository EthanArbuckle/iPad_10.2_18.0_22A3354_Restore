...
- (void)writeString:(id)a3
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_DEFAULT))
  {
    v6 = 138543362;
    v7 = v4;
    _os_log_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEFAULT, "%{public}@", (uint8_t *)&v6, 0xCu);
  }
...
- (void)writePrefix:(id)a3 label:(id)a4 args:(char *)a5
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2114;
    v14 = v9;
    _os_log_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEFAULT, "%{public}@%{public}@", (uint8_t *)&v11, 0x16u);
  }
  CFRelease(v9);
