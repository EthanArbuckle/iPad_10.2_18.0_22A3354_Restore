...
+ (id)URLOfModelInThisBundle
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "pathForResource:ofType:", CFSTR("ocv_drift_model"), CFSTR("mlmodelc")));
...
- (ocv_drift_model)initWithMLModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = -[ocv_drift_model init](&v10, "init");
    v7 = v6;
    if (v6)
...
- (ocv_drift_model)init
{
  ...
  v5 = -[ocv_drift_model initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v4, 0);
...
- (ocv_drift_model)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v9 = -[ocv_drift_model initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v8, v6, a4);
...
- (ocv_drift_model)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[ocv_drift_model initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (ocv_drift_model)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[ocv_drift_model initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[ocv_drift_model predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v6, v7, a4));
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  ocv_drift_modelOutput *v12;
  void *v13;
  void *v14;
  ocv_drift_modelOutput *v15;

  v8 = a4;
  v9 = a3;
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[ocv_drift_model model](self, "model"));
  ...
  if (v11)
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "featureValueForName:", CFSTR("Prediction")));
    v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "multiArrayValue"));
    v15 = -[ocv_drift_modelOutput initWithPrediction:](v12, "initWithPrediction:", v14);
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[ocv_drift_model model](self, "model"));
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[ocv_drift_model model](self, "model"));
...
- (id)predictionFromInput:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = -[ocv_drift_modelInput initWithInput:]([ocv_drift_modelInput alloc], "initWithInput:", v6);

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[ocv_drift_model predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4));
  return v8;
}
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  ocv_drift_modelOutput *v16;
  void *v17;
  void *v18;
  ocv_drift_modelOutput *v19;
  id v21;
  id v22;
  ...
  if (v12)
  {
    ...
    if ((uint64_t)objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v19 = -[ocv_drift_modelOutput initWithPrediction:](v16, "initWithPrediction:", v18);
