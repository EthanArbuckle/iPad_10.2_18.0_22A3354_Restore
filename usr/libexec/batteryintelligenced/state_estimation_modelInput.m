...
- (state_estimation_modelInput)initWithDaily_history_input:(id)a3 usage_history_input:(id)a4
{
  id v7;
  id v8;
  state_estimation_modelInput *v9;
  ...
  v9 = -[state_estimation_modelInput init](&v12, "init");
  v10 = v9;
  if (v9)
  {
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_10002F170);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v5 = objc_claimAutoreleasedReturnValue(-[state_estimation_modelInput daily_history_input](self, "daily_history_input"));
  }
  else
  {
    ...
    v5 = objc_claimAutoreleasedReturnValue(-[state_estimation_modelInput usage_history_input](self, "usage_history_input"));
  }
  v6 = (void *)v5;
