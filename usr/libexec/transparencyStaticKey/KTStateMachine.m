...
- (KTStateMachine)initWithName:(id)a3 states:(id)a4 flags:(id)a5 initialState:(id)a6 queue:(id)a7 stateEngine:(id)a8 lockStateTracker:(id)a9 reachabilityTracker:(id)a10 idsConfigBag:(id)a11
{
  ...
  if (v21)
  {
    ...
    v30 = objc_claimAutoreleasedReturnValue(+[NSBlockOperation blockOperationWithBlock:](NSBlockOperation, "blockOperationWithBlock:", &stru_1000714F0));
...
- (void)setCurrentState:(id)a3
{
  ...
  {
    v12 = (id)v5;
    v7 = objc_msgSend((id)v5, "isEqualToString:");
    v6 = v12;
    if ((v7 & 1) == 0)
    {
      if (self->_currentState)
      {
        v8 = objc_alloc_init(KTCondition);
        v9 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine mutableStateConditions](self, "mutableStateConditions"));
        objc_msgSend(v9, "setObject:forKeyedSubscript:", v8, self->_currentState);
      ...
      if (v12)
      {
        ...
        v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "objectForKeyedSubscript:", v12));
        objc_msgSend(v11, "fulfill");
          ...
          if (v15)
          {
            ...
            if (v16)
            {
              ...
              if (qword_10008ABA0 != -1)
                dispatch_once(&qword_10008ABA0, &stru_100071538);
              v20 = (void *)qword_10008ABA8;
...
- (void)_onqueueStartNextStateMachineOperation:(BOOL)a3
{
  ...
  if (!v6)
  {
    ...
    {
      if (qword_10008ABA0 != -1)
        dispatch_once(&qword_10008ABA0, &stru_100071558);
      v10 = (void *)qword_10008ABA8;
      if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
      {
        v11 = v10;
    ...
    else
    {
      ...
      {
        if (qword_10008ABA0 != -1)
          dispatch_once(&qword_10008ABA0, &stru_100071578);
        v14 = qword_10008ABA8;
        if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
        {
          v27 = 138543362;
      ...
      {
        if (qword_10008ABA0 != -1)
          dispatch_once(&qword_10008ABA0, &stru_100071598);
        v21 = (void *)qword_10008ABA8;
        if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
        {
          v22 = v21;
...
- (void)_onqueueRecheckConditions
{
  ...
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine pendingFlags](self, "pendingFlags"));
    ...
    if (v8)
    {
      ...
      do
      {
        for (i = 0; i != v8; i = (char *)i + 1)
        {
          if (*(_QWORD *)v42 != v10)
            objc_enumerationMutation(v7);
          v9 |= (unint64_t)objc_msgSend(*(id *)(*((_QWORD *)&v41 + 1) + 8 * (_QWORD)i), "conditions");
        }
        v8 = objc_msgSend(v7, "countByEnumeratingWithState:objects:count:", &v41, v45, 16);
      }
      while (v8);
      ...
      if (v9)
      {
        v12 = -[KTStateMachine conditionChecksInFlight](self, "conditionChecksInFlight");
        location = 0;
        objc_initWeak(&location, self);
        v13 = v9 & ~v12;
        if ((v13 & 1) != 0)
        {
          v14 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine lockStateTracker](self, "lockStateTracker"));
          v15 = objc_msgSend(v14, "isLocked");

          if (v15)
          {
            if (qword_10008ABA0 != -1)
              dispatch_once(&qword_10008ABA0, &stru_100071668);
            v16 = qword_10008ABA8;
            if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
            {
              *(_WORD *)buf = 0;
            ...
            v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSBlockOperation blockOperationWithBlock:](NSBlockOperation, "blockOperationWithBlock:", v37));
            -[KTStateMachine setCheckUnlockOperation:](self, "setCheckUnlockOperation:", v17);
            ...
            v18 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine checkUnlockOperation](self, "checkUnlockOperation"));
            v19 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine lockStateTracker](self, "lockStateTracker"));
            v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v19, "unlockDependency"));
            objc_msgSend(v18, "addNullableDependency:", v20);

            v21 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine operationQueue](self, "operationQueue"));
            v22 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine checkUnlockOperation](self, "checkUnlockOperation"));
        ...
        if ((v13 & 2) != 0)
        {
          v23 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine reachabilityTracker](self, "reachabilityTracker"));
          v24 = objc_msgSend(v23, "currentReachability");
          ...
          {
            if (qword_10008ABA0 != -1)
              dispatch_once(&qword_10008ABA0, &stru_1000716A8);
            v25 = qword_10008ABA8;
            if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
            {
              *(_WORD *)buf = 0;
            ...
            v26 = (void *)objc_claimAutoreleasedReturnValue(+[NSBlockOperation blockOperationWithBlock:](NSBlockOperation, "blockOperationWithBlock:", &v32));
            ...
            v27 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine checkReachabilityOperation](self, "checkReachabilityOperation"));
            v28 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine reachabilityTracker](self, "reachabilityTracker"));
            v29 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v28, "reachabilityDependency"));
            objc_msgSend(v27, "addNullableDependency:", v29);

            v30 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine operationQueue](self, "operationQueue"));
            v31 = (void *)objc_claimAutoreleasedReturnValue(-[KTStateMachine checkReachabilityOperation](self, "checkReachabilityOperation"));
...
LABEL_16:
      ...
      if (v24)
      {
        ...
        {
          if (qword_10008ABA0 != -1)
            dispatch_once(&qword_10008ABA0, &stru_100071708);
          v27 = (void *)qword_10008ABA8;
          if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
          {
            v28 = v27;
      ...
      {
        if (qword_10008ABA0 != -1)
          dispatch_once(&qword_10008ABA0, &stru_100071728);
        v37 = (void *)qword_10008ABA8;
        if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
        {
          v38 = v37;
...
LABEL_41:
    ...
    if (qword_10008ABA0 != -1)
      dispatch_once(&qword_10008ABA0, &stru_1000716E8);
    v21 = (void *)qword_10008ABA8;
    if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
    {
      v22 = v21;
...
- (void)doSimpleStateMachineRPC:(id)a3 op:(id)a4 sourceStates:(id)a5 reply:(id)a6
{
  ...
  v13 = a6;
  if (qword_10008ABA0 != -1)
    dispatch_once(&qword_10008ABA0, &stru_100071768);
  v14 = qword_10008ABA8;
  if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138543362;
...
{
  -[KTStateMachine setTimeout:](self, "setTimeout:", a3);
}
...
- (id)doWatchedStateMachineRPC:(id)a3 sourceStates:(id)a4 path:(id)a5 transitionOp:(id)a6 reply:(id)a7
{
  ...
  v17 = v14;
  if (qword_10008ABA0 != -1)
    dispatch_once(&qword_10008ABA0, &stru_1000717D0);
  v18 = qword_10008ABA8;
  if (os_log_type_enabled((os_log_t)qword_10008ABA8, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138543362;
