...
- (KTResultOperation)init
{
  ...
  if (v2)
  {
    ...
    -[KTResultOperation setCompletionBlock:](v2, "setCompletionBlock:", &stru_100070B80, v15, v16, v17, v18);
...
- (id)dependenciesDescriptionError
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "indexesOfObjectsPassingTest:", &stru_100070BC0));
...
- (id)_onqueueTimeoutError
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[KTResultOperation pendingDependenciesString:](self, "pendingDependenciesString:", &stru_100072BF0));
