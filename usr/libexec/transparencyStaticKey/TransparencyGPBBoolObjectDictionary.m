...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (v11)
    {
      ++v4;
      v12 = sub_10001A678(1);
      v13 = sub_1000354EC(v11, v7);
      v5 += (uint64_t)&v13[v12 + sub_100018CC8((int)v13 + (int)v12)];
    }
    v9 = 0;
    v3 = 1;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (values[v10])
    {
      ...
      v14 = v9 & 1;
      v15 = sub_10001A678(1);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000354EC(values[v10], v7) + v15);
      objc_msgSend(a3, "writeBool:value:", 1, v14);
      sub_10003561C(a3, (const char *)values[v10], v7);
    }
    v12 = 0;
    v9 = 1;
    v10 = 1;
