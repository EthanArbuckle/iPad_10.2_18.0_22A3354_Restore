...
{
  return -[TransparencyGPBInt32UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt32UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt32UInt64Dictionary *v8;
  ...
  v8 = -[TransparencyGPBInt32UInt64Dictionary init](&v13, "init");
  if (v8)
  {
...
{
  TransparencyGPBInt32UInt64Dictionary *v4;
  TransparencyGPBInt32UInt64Dictionary *v5;

  v4 = -[TransparencyGPBInt32UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBInt32UInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32UInt64Dictionary initWithDictionary:](+[TransparencyGPBInt32UInt64Dictionary allocWithZone:](TransparencyGPBInt32UInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32UInt64Dictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_100036768(v15, 1, v8);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100071DF0;
  v3[4] = a3;
  -[TransparencyGPBInt32UInt64Dictionary enumerateKeysAndUInt64sUsingBlock:](self, "enumerateKeysAndUInt64sUsingBlock:", v3);
}
