...
{
  return -[TransparencyGPBUInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt32DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt32DoubleDictionary *v8;
...
{
  TransparencyGPBUInt32DoubleDictionary *v4;
  TransparencyGPBUInt32DoubleDictionary *v5;

  v4 = -[TransparencyGPBUInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt32DoubleDictionary initWithDictionary:](+[TransparencyGPBUInt32DoubleDictionary allocWithZone:](TransparencyGPBUInt32DoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt32DoubleDictionary, a2);
