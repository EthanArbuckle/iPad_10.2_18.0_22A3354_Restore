...
{
  return -[TransparencyGPBBoolUInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBBoolUInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  TransparencyGPBBoolUInt64Dictionary *result;
  BOOL v9;
  uint64_t v10;
  unsigned int v11;
  unint64_t v12;
  ...
  result = -[TransparencyGPBBoolUInt64Dictionary init](&v13, "init");
  if (result)
    v9 = a5 == 0;
  else
    v9 = 1;
...
- (TransparencyGPBBoolUInt64Dictionary)initWithDictionary:(id)a3
{
  ...
  result = -[TransparencyGPBBoolUInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  if (a3 && result)
  {
    v5 = 0;
    v6 = 1;
...
{
  return -[TransparencyGPBBoolUInt64Dictionary initWithDictionary:](+[TransparencyGPBBoolUInt64Dictionary allocWithZone:](TransparencyGPBBoolUInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBBoolUInt64Dictionary, a2);
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v3])
    {
      ++v4;
      v12 = sub_10001A678(1);
      v13 = sub_100036FAC(values[v3], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      v15 = v9 & 1;
      v16 = sub_10001A678(1);
      objc_msgSend(a3, "writeInt32NoTag:", sub_100036FAC(values[v10], 2, v7) + v16);
      objc_msgSend(a3, "writeBool:value:", 1, v15);
      v17 = values[v10];
      if (v7 == 4)
      {
        objc_msgSend(a3, "writeFixed64:value:", 2, v17);
      }
      else if (v7 == 12)
      {
        objc_msgSend(a3, "writeUInt64:value:", 2, v17);
      }
    }
    v13 = 0;
    v9 = 1;
