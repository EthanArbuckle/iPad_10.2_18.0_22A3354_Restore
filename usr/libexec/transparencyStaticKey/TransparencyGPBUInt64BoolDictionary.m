...
{
  return -[TransparencyGPBUInt64BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt64BoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt64BoolDictionary *v8;
...
{
  TransparencyGPBUInt64BoolDictionary *v4;
  TransparencyGPBUInt64BoolDictionary *v5;

  v4 = -[TransparencyGPBUInt64BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt64BoolDictionary initWithDictionary:](+[TransparencyGPBUInt64BoolDictionary allocWithZone:](TransparencyGPBUInt64BoolDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt64BoolDictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_10001A678(2) + v13);
      if (v7 == 4)
      {
