  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v14 = &v13[sub_1000377C8((unint64_t)objc_msgSend(v12, "longLongValue"), 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000377C8((unint64_t)v14, 2, v7) + v15);
      objc_msgSend(a3, "writeString:value:", 1, v12);
      sub_100037964(a3, (uint64_t)v14, 2, v7);
