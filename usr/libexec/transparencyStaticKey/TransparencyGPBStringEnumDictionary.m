  ...
  if (result)
  {
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        v13 = &v12[sub_10001A5DC(2, objc_msgSend(v11, "intValue"))];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      v14 = sub_10001A6C4(1, v11);
      objc_msgSend(a3, "writeInt32NoTag:", sub_10001A5DC(2, v13) + v14);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  v6 = *(_QWORD *)&a3;
  v7 = sub_10001A6C4(1, a4->var7);
  v8 = +[NSMutableData dataWithLength:](NSMutableData, "dataWithLength:", &v7[sub_10001A5DC(2, v6)]);
