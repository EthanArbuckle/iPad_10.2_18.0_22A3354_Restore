...
+ (id)descriptor
{
  ...
  v2 = (id)qword_10008AB98;
  if (!qword_10008AB98)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", TransparencyGPBAny, CFSTR("Any"), off_10008A398, &off_10008A358, 2, 24, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_10006C130);
    qword_10008AB98 = (uint64_t)v2;
  }
  return v2;
}
...
{
  return (TransparencyGPBAny *)objc_msgSend(a1, "anyWithMessage:typeURLPrefix:error:", a3, CFSTR("type.googleapis.com/"), a4);
}
