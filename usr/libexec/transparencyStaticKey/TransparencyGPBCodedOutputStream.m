...
{
  sub_100017654((uint64_t *)&self->state_, *(uint64_t *)&a3);
}
...
- (void)writeDouble:(int)a3 value:(double)a4
{
  ...
  v6 = sub_100023730(a3, 1);
  sub_100017D4C(p_state, v6);
  sub_100017654(p_state, *(uint64_t *)&a4);
}

- (void)writeFloatNoTag:(float)a3
{
  sub_100017824((uint64_t *)&self->state_, SLODWORD(a3));
}
...
- (void)writeFloat:(int)a3 value:(float)a4
{
  ...
  p_state = (uint64_t *)&self->state_;
  v6 = sub_100023730(a3, 5);
  sub_100017D4C(p_state, v6);
  sub_100017824(p_state, SLODWORD(a4));
}

- (void)writeUInt64NoTag:(unint64_t)a3
{
  sub_100017944((uint64_t *)&self->state_, a3);
}
...
- (void)writeUInt64:(int)a3 value:(unint64_t)a4
{
  ...
  p_state = (uint64_t *)&self->state_;
  v6 = sub_100023730(a3, 0);
  sub_100017D4C(p_state, v6);
  sub_100017944(p_state, a4);
}
...
{
  sub_100017A78((uint64_t *)&self->state_, a3);
}
...
- (void)writeInt32:(int)a3 value:(int)a4
{
  ...
  v6 = sub_100023730(a3, 0);
  sub_100017D4C(p_state, v6);
  sub_100017A78(p_state, a4);
}

- (void)writeFixed64NoTag:(unint64_t)a3
{
  sub_100017654((uint64_t *)&self->state_, a3);
}
...
- (void)writeFixed64:(int)a3 value:(unint64_t)a4
{
  ...
  v6 = sub_100023730(a3, 1);
  sub_100017D4C(p_state, v6);
  sub_100017654(p_state, a4);
}

- (void)writeFixed32NoTag:(unsigned int)a3
{
  sub_100017824((uint64_t *)&self->state_, a3);
}
...
- (void)writeBoolNoTag:(BOOL)a3
{
  ...
  {
    sub_10001A098(&self->state_.bytes);
    position = self->state_.position;
  }
...
- (void)writeBool:(int)a3 value:(BOOL)a4
{
  ...
  p_state = (uint64_t *)&self->state_;
  v7 = sub_100023730(a3, 0);
  sub_100017D4C(p_state, v7);
  position = self->state_.position;
  if (position == self->state_.size)
  {
    sub_10001A098(p_state);
    position = self->state_.position;
  }
  bytes = self->state_.bytes;
  self->state_.position = position + 1;
...
- (void)writeStringNoTag:(id)a3
{
  ...
  sub_100017D4C((uint64_t *)&self->state_, v5);
  if (v5)
  {
...
- (void)writeGroupNoTag:(int)a3 value:(id)a4
{
  ...
  v6 = sub_100023730(a3, 4);
  sub_100017D4C((uint64_t *)&self->state_, v6);
}
...
- (void)writeGroup:(int)a3 value:(id)a4
{
  ...
  v5 = *(_QWORD *)&a3;
  p_state = (uint64_t *)&self->state_;
  v8 = sub_100023730(a3, 3);
  sub_100017D4C(p_state, v8);
...
{
  sub_100017D4C((uint64_t *)&self->state_, objc_msgSend(a3, "serializedSize"));
...
{
  sub_100017D4C((uint64_t *)&self->state_, objc_msgSend(a3, "length"));
...
{
  sub_100017D4C((uint64_t *)&self->state_, a3);
}

- (void)writeUInt32:(int)a3 value:(unsigned int)a4
{
  sub_1000180A8((uint64_t *)&self->state_, a3, a4);
}
...
{
  sub_100017D4C((uint64_t *)&self->state_, (2 * a3) ^ (a3 >> 31));
}
...
- (void)writeSInt32:(int)a3 value:(int)a4
{
  ...
  v6 = sub_100023730(a3, 0);
  sub_100017D4C(p_state, v6);
  sub_100017D4C(p_state, (2 * a4) ^ (a4 >> 31));
}

- (void)writeSInt64NoTag:(int64_t)a3
{
  sub_100017944((uint64_t *)&self->state_, (2 * a3) ^ (a3 >> 63));
}
...
- (void)writeSInt64:(int)a3 value:(int64_t)a4
{
  ...
  v6 = sub_100023730(a3, 0);
  sub_100017D4C(p_state, v6);
  sub_100017944(p_state, (2 * a4) ^ (a4 >> 63));
}
...
- (void)writeDoubleArray:(int)a3 values:(id)a4 tag:(unsigned int)a5
{
  ...
  if (a5)
  {
    if (objc_msgSend(a4, "count", *(_QWORD *)&a3))
    {
      ...
      sub_100017D4C((uint64_t *)&self->state_, a5);
      sub_100017D4C((uint64_t *)&self->state_, *((_DWORD *)v13 + 6));
...
- (void)writeMessageSetExtension:(int)a3 value:(id)a4
{
  ...
  p_state = (uint64_t *)&self->state_;
  v8 = sub_100023730(1, 3);
  sub_100017D4C(p_state, v8);
  sub_1000180A8(p_state, 2, a3);
  -[TransparencyGPBCodedOutputStream writeMessage:value:](self, "writeMessage:value:", 3, a4);
  v9 = sub_100023730(1, 4);
  sub_100017D4C(p_state, v9);
}
...
- (void)writeRawPtr:(const void *)a3 offset:(unint64_t)a4 length:(unint64_t)a5
{
  ...
  if (a3 && a5)
  {
    ...
    else
    {
      ...
      {
        +[NSException raise:format:](NSException, "raise:format:", CFSTR("WriteFailed"), &stru_100072BF0);
      }
    }
  }
}
...
- (void)writeTag:(unsigned int)a3 format:(int)a4
{
  ...
  p_state = (uint64_t *)&self->state_;
  v5 = sub_100023730(a3, a4);
  sub_100017D4C(p_state, v5);
}
