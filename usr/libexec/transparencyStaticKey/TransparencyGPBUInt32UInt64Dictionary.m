...
{
  return -[TransparencyGPBUInt32UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}
...
{
  TransparencyGPBUInt32UInt64Dictionary *v8;
...
{
  TransparencyGPBUInt32UInt64Dictionary *v4;
  TransparencyGPBUInt32UInt64Dictionary *v5;

  v4 = -[TransparencyGPBUInt32UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt32UInt64Dictionary initWithDictionary:](+[TransparencyGPBUInt32UInt64Dictionary allocWithZone:](TransparencyGPBUInt32UInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt32UInt64Dictionary, a2);
