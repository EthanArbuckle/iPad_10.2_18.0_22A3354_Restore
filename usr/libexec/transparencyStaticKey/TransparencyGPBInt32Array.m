...
- (TransparencyGPBInt32Array)init
{
  ...
  return -[TransparencyGPBInt32Array init](&v3, "init");
}

- (TransparencyGPBInt32Array)initWithValueArray:(id)a3
{
  return -[TransparencyGPBInt32Array initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}

- (TransparencyGPBInt32Array)initWithValues:(const int *)a3 count:(unint64_t)a4
{
  TransparencyGPBInt32Array *v6;
  TransparencyGPBInt32Array *v7;
  int *v8;

  v6 = -[TransparencyGPBInt32Array init](self, "init");
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
{
  TransparencyGPBInt32Array *v4;
  TransparencyGPBInt32Array *v5;

  v4 = -[TransparencyGPBInt32Array initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
    -[TransparencyGPBInt32Array internalResizeToCapacity:](v4, "internalResizeToCapacity:", a3);
  return v5;
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32Array initWithValues:count:](+[TransparencyGPBInt32Array allocWithZone:](TransparencyGPBInt32Array, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBInt32Array;
  -[TransparencyGPBInt32Array dealloc](&v3, "dealloc");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32Array, a2);
...
{
  -[TransparencyGPBInt32Array enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(int)a3
{
  ...
  v3 = a3;
  -[TransparencyGPBInt32Array addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const int *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[TransparencyGPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[TransparencyGPBInt32Array addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[TransparencyGPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[TransparencyGPBInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
