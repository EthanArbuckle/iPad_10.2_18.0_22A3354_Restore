...
- (void)changeDelays:(unint64_t)a3 continuingDelay:(unint64_t)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10001AE58;
  block[3] = &unk_100071460;
  block[4] = self;
  block[5] = a3;
  block[6] = a4;
...
- (id)makeOperationDependency
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[KTResultOperation named:withBlock:](KTResultOperation, "named:withBlock:", v4, &stru_100071480));
...
- (void)triggerAt:(unint64_t)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001B20C;
  block[3] = &unk_1000714D0;
...
- (void)_onqueueTrigger:(unint64_t)a3 maximumDelay:(unint64_t)a4
{
        ...
        v24))
  {
    ...
    handler[2] = sub_10001B980;
    handler[3] = &unk_100070710;
