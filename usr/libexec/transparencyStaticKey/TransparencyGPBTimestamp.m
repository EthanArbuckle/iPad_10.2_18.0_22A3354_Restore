...
+ (id)descriptor
{
  ...
  result = (id)qword_10008AC18;
  if (!qword_10008AC18)
  {
    LODWORD(v3) = 28;
    result = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", TransparencyGPBTimestamp, CFSTR("Timestamp"), off_10008A920, &off_10008A8E0, 2, 16, v3);
    qword_10008AC18 = (uint64_t)result;
  }
  return result;
}
