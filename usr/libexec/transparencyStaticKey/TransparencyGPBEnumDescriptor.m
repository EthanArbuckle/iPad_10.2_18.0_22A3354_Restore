...
+ (id)allocDescriptorForName:(id)a3 valueNames:(const char *)a4 values:(const int *)a5 count:(unsigned int)a6 enumVerifier:(void *)a7 flags:(unsigned int)a8
{
  ...
  if ((a8 & 0xFFFFFFFD) != 0)
    sub_100011E18();
  return objc_msgSend(objc_alloc((Class)a1), "initWithName:valueNames:values:count:enumVerifier:flags:", a3, a4, a5, v10, a7, v8);
}
...
- (id)getEnumTextFormatNameForIndex:(unsigned int)a3
{
  ...
  if (!extraTextFormatInfo || (v8 = (NSMutableString *)sub_100013DC0(extraTextFormatInfo, a3, v6)) == 0)
  {
