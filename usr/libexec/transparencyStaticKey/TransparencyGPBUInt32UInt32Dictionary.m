...
{
  return -[TransparencyGPBUInt32UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
}
...
{
  TransparencyGPBUInt32UInt32Dictionary *v8;
  ...
  v8 = -[TransparencyGPBUInt32UInt32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  TransparencyGPBUInt32UInt32Dictionary *v4;
  TransparencyGPBUInt32UInt32Dictionary *v5;

  v4 = -[TransparencyGPBUInt32UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBUInt32UInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt32UInt32Dictionary initWithDictionary:](+[TransparencyGPBUInt32UInt32Dictionary allocWithZone:](TransparencyGPBUInt32UInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt32UInt32Dictionary, a2);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_100035F44(objc_msgSend(v11, "unsignedIntValue"), 1, v8);
        v15 = sub_100035F44(objc_msgSend(v13, "unsignedIntValue"), 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_100035F44(v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_100035F44(v16, 2, v7) + v14);
      if (v8 == 1)
      {
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100071C60;
  v3[4] = a3;
  -[TransparencyGPBUInt32UInt32Dictionary enumerateKeysAndUInt32sUsingBlock:](self, "enumerateKeysAndUInt32sUsingBlock:", v3);
}
