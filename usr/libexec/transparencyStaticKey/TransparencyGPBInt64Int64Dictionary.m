  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = sub_1000377C8((unint64_t)objc_msgSend(v13, "longLongValue"), 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = sub_1000377C8((unint64_t)v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000377C8((unint64_t)v16, 2, v7) + v17);
      sub_100037964(a3, (uint64_t)v15, 1, v8);
      sub_100037964(a3, (uint64_t)v16, 2, v7);
