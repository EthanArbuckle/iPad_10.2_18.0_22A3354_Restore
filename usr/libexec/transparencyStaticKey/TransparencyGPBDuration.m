...
+ (id)descriptor
{
  ...
  result = (id)qword_10008ABB0;
  if (!qword_10008ABB0)
  {
    LODWORD(v3) = 28;
    result = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", TransparencyGPBDuration, CFSTR("Duration"), off_10008A4B0, &off_10008A470, 2, 16, v3);
    qword_10008ABB0 = (uint64_t)result;
  }
  return result;
}
