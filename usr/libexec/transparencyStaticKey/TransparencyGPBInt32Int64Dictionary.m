...
{
  return -[TransparencyGPBInt32Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt32Int64Dictionary *v8;
...
{
  TransparencyGPBInt32Int64Dictionary *v4;
  TransparencyGPBInt32Int64Dictionary *v5;

  v4 = -[TransparencyGPBInt32Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBInt32Int64Dictionary initWithDictionary:](+[TransparencyGPBInt32Int64Dictionary allocWithZone:](TransparencyGPBInt32Int64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32Int64Dictionary, a2);
