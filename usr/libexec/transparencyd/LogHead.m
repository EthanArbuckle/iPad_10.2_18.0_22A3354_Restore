...
+ (id)descriptor
{
  ...
  v2 = (id)qword_1002A75C8;
  if (!qword_1002A75C8)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", LogHead, CFSTR("LogHead"), &unk_1002A2BE0, &off_1002A2CD8, 8, 64, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_1002171F4);
    qword_1002A75C8 = (uint64_t)v2;
  }
  return v2;
}
