...
- (id)configBagURL
{
  ...
  if (v4 == 2)
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A908);
    v7 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)v15 = 0;
  ...
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A8E8);
    v5 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)v15 = 0;
...
- (id)configBagFileName
{
  ...
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A948);
    v5 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)v6 = 0;
  ...
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A928);
    v3 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)buf = 0;
...
- (id)configBagRequest
{
  ...
  if ((_DWORD)v4)
  {
    ...
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A968);
    v7 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEBUG))
    {
      v20 = 0;
...
LABEL_11:
  ...
  else
  {
    ...
    if (v11)
    {
      ...
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024A988);
      v7 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEBUG))
      {
        *(_WORD *)buf = 0;
  ...
  objc_msgSend(v5, "setValue:forHTTPHeaderField:", v13, off_1002A42E0);
  ...
  if (v15)
    objc_msgSend(v5, "setValue:forHTTPHeaderField:", v15, off_1002A42D8);
    ...
    && !-[TransparencyConfigBag currentEnvironment](self, "currentEnvironment"))
  {
    ...
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A9A8);
    v16 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_INFO))
    {
      *(_WORD *)v18 = 0;
...
- (void)getSettings
{
  ...
  if ((objc_opt_isKindOfClass(v3, v5) & 1) != 0)
  {
    ...
    if ((unint64_t)v6 <= 0x64)
    {
      v7 = v6;
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024A9C8);
      v8 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
      {
        v9 = 134217984;
...
- (BOOL)validateConfigEntries:(id)a3 error:(id *)a4
{
  ...
  if (objc_msgSend(v8, "count"))
  {
    ...
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024A9E8);
    v9 = (void *)qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
    {
      v10 = v9;
  ...
  else
  {
    ...
    if (v15)
    {
      ...
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024AA08);
      v16 = (void *)qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
      {
        v17 = v16;
...
- (BOOL)validateConfigBagCertificates:(id)a3 error:(id *)a4
{
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    if (!v10)
    {
      ...
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024AA48);
      v17 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
      {
        if (a4)
  ...
  else
  {
    ...
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024AA28);
    v19 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
    {
      LOWORD(v21) = 0;
...
- (BOOL)validateConfigBagSignature:(id)a3 error:(id *)a4
{
  ...
  if (v15)
  {
    ...
    if (v16)
    {
      ...
      if (v17)
      {
        ...
        {
          if (qword_1002A7A18 != -1)
            dispatch_once(&qword_1002A7A18, &stru_10024AAC8);
          v18 = qword_1002A7A20;
          if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
          {
            if (a4)
      ...
      else
      {
        ...
        if (qword_1002A7A18 != -1)
          dispatch_once(&qword_1002A7A18, &stru_10024AAA8);
        v22 = qword_1002A7A20;
        if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
        {
          LOWORD(v24) = 0;
    ...
    else
    {
      ...
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024AA88);
      v21 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
      {
        LOWORD(v24) = 0;
  ...
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024AA68);
    v20 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
    {
      LOWORD(v24) = 0;
  ...
  if ((objc_opt_isKindOfClass(v7, v9) & 1) != 0)
  {
    ...
    if ((objc_opt_isKindOfClass(v10, v12) & 1) != 0 && objc_msgSend(v10, "count"))
    {
        ...
        while (2)
        {
          for (i = 0; i != v16; i = (char *)i + 1)
          {
            ...
            if ((objc_opt_isKindOfClass(v19, v20) & 1) == 0)
            {
              ...
              v10 = v38;
              if (qword_1002A7A18 != -1)
                dispatch_once(&qword_1002A7A18, &stru_10024AB28);
              v31 = (void *)qword_1002A7A20;
              if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
              {
                v32 = v31;
      ...
      else
      {
        ...
        if (qword_1002A7A18 != -1)
          dispatch_once(&qword_1002A7A18, &stru_10024AB48);
        v10 = v38;
        v35 = (void *)qword_1002A7A20;
        if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
        {
          v36 = v35;
    ...
    else
    {
      ...
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024AB08);
      v29 = (void *)qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
      {
        v30 = v29;
        *(_DWORD *)buf = 136315138;
...
LABEL_35:
  ...
  else
  {
    ...
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024AAE8);
    v27 = (void *)qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
    {
      v28 = v27;
      *(_DWORD *)buf = 136315138;
...
- (BOOL)configureFromNetworkBagData:(id)a3 error:(id *)a4
{
  ...
  if (v7 && -[TransparencyConfigBag validateConfigBagEntries:error:](v8, "validateConfigBagEntries:error:", v7, a4))
  {
    ...
    if (v10)
    {
      ...
      {
        if (qword_1002A7A18 != -1)
          dispatch_once(&qword_1002A7A18, &stru_10024AB68);
        v13 = qword_1002A7A20;
        if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
        {
...
- (BOOL)configurationExpired
{
  ...
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024AB88);
    v7 = (void *)qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
    {
      v8 = v7;
      -[TransparencyConfigBag expirationTime](self, "expirationTime");
...
- (void)configureWithFetcher:(id)a3 completionHandler:(id)a4
{
    ...
    && (v6 || !-[TransparencyConfigBag configurationExpired](self, "configurationExpired")))
  {
    ...
    {
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024ABA8);
      v14 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
  ...
  else
  {
    ...
    {
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024ABC8);
      v12 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
    ...
    {
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024ABE8);
      v15 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
...
LABEL_13:
      ...
      objc_sync_exit(v9);
      if (qword_1002A7A18 != -1)
        dispatch_once(&qword_1002A7A18, &stru_10024AC08);
      v13 = qword_1002A7A20;
      if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
...
- (void)clearState:(id *)a3
{
  ...
  {
    if (qword_1002A7A18 != -1)
      dispatch_once(&qword_1002A7A18, &stru_10024AC28);
    v8 = qword_1002A7A20;
    if (os_log_type_enabled((os_log_t)qword_1002A7A20, OS_LOG_TYPE_ERROR))
    {
      if (a3)
