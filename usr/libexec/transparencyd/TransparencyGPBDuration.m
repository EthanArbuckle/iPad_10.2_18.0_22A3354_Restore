...
+ (id)descriptor
{
  ...
  result = (id)qword_1002A7358;
  if (!qword_1002A7358)
  {
    LODWORD(v3) = 28;
    result = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", TransparencyGPBDuration, CFSTR("Duration"), off_1002A14B8, &off_1002A1478, 2, 16, v3);
    qword_1002A7358 = (uint64_t)result;
  }
  return result;
}
