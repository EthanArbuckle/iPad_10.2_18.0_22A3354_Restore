...
+ (id)descriptor
{
  ...
  v2 = (id)qword_1002A7528;
  if (!qword_1002A7528)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", ConsistencyProofResponse_LogConsistencyResponse, CFSTR("LogConsistencyResponse"), &unk_1002A2750, &off_1002A2828, 3, 32, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_100216E8D);
    objc_msgSend(v2, "setupContainingMessageClass:", ConsistencyProofResponse);
    qword_1002A7528 = (uint64_t)v2;
  }
  return v2;
}
...
- (void)setResult:(unint64_t)a3 treeHead:(id)a4 error:(id)a5
{
  ...
  else
  {
    ...
    if (qword_1002A7AC8 != -1)
      dispatch_once(&qword_1002A7AC8, &stru_10024B718);
    v26 = (void *)qword_1002A7AD0;
    if (os_log_type_enabled((os_log_t)qword_1002A7AD0, OS_LOG_TYPE_DEFAULT))
    {
      v27 = v26;
          ...
          if (objc_msgSend(v12, "verifyWithError:", 0) == (id)1)
          {
            ...
            if (objc_msgSend(v20, "isEqual:", v22))
            {
                ...
                && (v25 = objc_msgSend(v19, "getUnsigned:", "revision"), v25 == objc_msgSend(v18, "revision")))
              {
                ...
                self = v43;
                if (qword_1002A7AC8 != -1)
                  dispatch_once(&qword_1002A7AC8, &stru_10024B738);
                v29 = (void *)qword_1002A7AD0;
