...
{
  return -[TransparencyGPBInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt32Int32Dictionary *v8;
  ...
  v8 = -[TransparencyGPBInt32Int32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  TransparencyGPBInt32Int32Dictionary *v4;
  TransparencyGPBInt32Int32Dictionary *v5;

  v4 = -[TransparencyGPBInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBInt32Int32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32Int32Dictionary initWithDictionary:](+[TransparencyGPBInt32Int32Dictionary allocWithZone:](TransparencyGPBInt32Int32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32Int32Dictionary, a2);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = sub_1000E3C18(objc_msgSend(v13, "intValue"), 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = sub_1000E3C18(v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000E3C18(v16, 2, v7) + v17);
      sub_1000E3DB4(a3, (uint64_t)v15, 1, v8);
      sub_1000E3DB4(a3, (uint64_t)v16, 2, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100244F60;
  v3[4] = a3;
  -[TransparencyGPBInt32Int32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}
