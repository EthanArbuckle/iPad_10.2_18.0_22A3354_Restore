...
+ (id)verifierOfType:(int)a3 key:(id)a4
{
  ...
  if (a3 == 3)
  {
    ...
    if (v6)
      goto LABEL_12;
    if (qword_1002A7AB8 != -1)
      dispatch_once(&qword_1002A7AB8, &stru_10024B6B8);
    v7 = qword_1002A7AC0;
    if (os_log_type_enabled((os_log_t)qword_1002A7AC0, OS_LOG_TYPE_ERROR))
    {
      LOWORD(v10[0]) = 0;
  ...
  if (qword_1002A7AB8 != -1)
    dispatch_once(&qword_1002A7AB8, &stru_10024B6D8);
  v8 = qword_1002A7AC0;
  if (os_log_type_enabled((os_log_t)qword_1002A7AC0, OS_LOG_TYPE_ERROR))
  {
    v10[0] = 67109120;
