...
- (unint64_t)verifyPerApplicationTreeEntry:(id)a3 mapHead:(id)a4 topLevelTreeEntry:(id)a5 error:(id *)a6
{
    ...
    if (v17 == 1)
    {
      ...
      else
      {
        if (qword_1002A7780 != -1)
          dispatch_once(&qword_1002A7780, &stru_100247F08);
        v21 = qword_1002A7788;
        v17 = 1;
        if (os_log_type_enabled((os_log_t)qword_1002A7788, OS_LOG_TYPE_INFO))
        {
          *(_WORD *)buf = 0;
          v17 = 1;
  ...
  {
    if (qword_1002A7780 != -1)
      dispatch_once(&qword_1002A7780, &stru_100247E60);
    v20 = qword_1002A7788;
    if (os_log_type_enabled((os_log_t)qword_1002A7788, OS_LOG_TYPE_INFO))
    {
      *(_WORD *)buf = 0;
...
- (unint64_t)verifyInclusionProofWithMapEntry:(id)a3 perAppLogEntry:(id)a4 topLevelTreeEntry:(id)a5 error:(id *)a6
{
  ...
  else
  {
    ...
    {
      if (qword_1002A7780 != -1)
        dispatch_once(&qword_1002A7780, &stru_100247F50);
      v12 = v26;
      v24 = qword_1002A7788;
...
- (TransparencyMapInclusionProofVerifier)initWithKeyStore:(id)a3 application:(id)a4
{
  id v6;
  void *v7;
  TransparencyMapInclusionProofVerifier *v8;

  v6 = a4;
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(a3, "keyBag"));
  v8 = -[TransparencyMapInclusionProofVerifier initWithKeyBag:application:](self, "initWithKeyBag:application:", v7, v6);
