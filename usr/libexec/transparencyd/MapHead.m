...
+ (id)descriptor
{
  ...
  v2 = (id)qword_1002A75D8;
  if (!qword_1002A75D8)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", MapHead, CFSTR("MapHead"), &unk_1002A2BE0, &off_1002A2E98, 9, 64, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_100217232);
    qword_1002A75D8 = (uint64_t)v2;
  }
  return v2;
}
