...
+ (id)descriptor
{
  ...
  v2 = (id)qword_1002A75E0;
  if (!qword_1002A75E0)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", MapEntry, CFSTR("MapEntry"), &unk_1002A2BE0, &off_1002A2FB8, 3, 32, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_100217246);
    qword_1002A75E0 = (uint64_t)v2;
  }
  return v2;
}
...
LABEL_11:
  ...
  if (a3)
    goto LABEL_11;
LABEL_12:
  if (qword_1002A7AF8 != -1)
    dispatch_once(&qword_1002A7AF8, &stru_10024BCB8);
  v27 = qword_1002A7B00;
  if (os_log_type_enabled((os_log_t)qword_1002A7B00, OS_LOG_TYPE_ERROR))
  {
    v28 = 134217984;
    v29 = v26;
