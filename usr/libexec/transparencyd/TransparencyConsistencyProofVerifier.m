...
- (BOOL)verifyConsistencyProof:(id)a3 startHash:(id)a4 startSize:(unint64_t)a5 endHash:(id)a6 endSize:(unint64_t)a7 error:(id *)a8
{
  ...
  if (!a5 || a7 <= a5)
  {
    ...
    if (qword_1002A7A68 != -1)
      dispatch_once(&qword_1002A7A68, &stru_10024B448);
    v39 = qword_1002A7A70;
    if (os_log_type_enabled((os_log_t)qword_1002A7A70, OS_LOG_TYPE_ERROR))
    {
...
LABEL_37:
    ...
    if (qword_1002A7A68 != -1)
      dispatch_once(&qword_1002A7A68, &stru_10024B468);
    v44 = (void *)qword_1002A7A70;
    if (os_log_type_enabled((os_log_t)qword_1002A7A70, OS_LOG_TYPE_ERROR))
    {
      v45 = v44;
...
- (unint64_t)verifyConsistencyProof:(id)a3 startLogHead:(id)a4 endLogHead:(id)a5 error:(id *)a6
{
  ...
  else
  {
    ...
    if (qword_1002A7A68 != -1)
      dispatch_once(&qword_1002A7A68, &stru_10024B488);
    v21 = qword_1002A7A70;
    if (os_log_type_enabled((os_log_t)qword_1002A7A70, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
