...
- (id)initIntending:(id)a3 errorState:(id)a4
{
  id v7;
  id v8;
  KTStateTransitionGroupOperation *v9;
  id *p_isa;
  objc_super v12;
...
- (id)description
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<KTStateTransitionGroupOperation(%@): intended:%@ actual:%@>"), v3, v4, v5));
