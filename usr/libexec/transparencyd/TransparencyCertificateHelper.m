  ...
  if (!v6)
  {
    ...
    if (!v6)
    {
      ...
      if (qword_1002A7BA8 != -1)
        dispatch_once(&qword_1002A7BA8, &stru_10024C560);
      v7 = qword_1002A7BB0;
      if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)v9 = 0;
...
+ (BOOL)addTrustedCertificate:(id)a3 trustedKeys:(id)a4 error:(id *)a5
{
  ...
  {
    if (qword_1002A7BA8 != -1)
      dispatch_once(&qword_1002A7BA8, &stru_10024C580);
    v15 = qword_1002A7BB0;
    if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
  ...
  if (!v10)
  {
    ...
    if (qword_1002A7BA8 != -1)
      dispatch_once(&qword_1002A7BA8, &stru_10024C5A0);
    v16 = qword_1002A7BB0;
    if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)v21 = 0;
  ...
  if (!v12)
  {
    ...
    if (qword_1002A7BA8 != -1)
      dispatch_once(&qword_1002A7BA8, &stru_10024C5C0);
    v18 = qword_1002A7BB0;
    if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
    {
      v20[0] = 0;
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        {
          if (qword_1002A7BA8 != -1)
            dispatch_once(&qword_1002A7BA8, &stru_10024C5E0);
          v14 = qword_1002A7BB0;
          if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
          {
            *(_WORD *)v16 = 0;
...
+ (BOOL)verifyLeaf:(id)a3 intermediates:(id)a4 policy:(__SecPolicy *)a5 error:(id *)a6
{
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      if (qword_1002A7BA8 != -1)
        dispatch_once(&qword_1002A7BA8, &stru_10024C620);
      v14 = qword_1002A7BB0;
      if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
      {
        LOWORD(v20[0]) = 0;
  ...
  {
    if (qword_1002A7BA8 != -1)
      dispatch_once(&qword_1002A7BA8, &stru_10024C600);
    v16 = qword_1002A7BB0;
    if (os_log_type_enabled((os_log_t)qword_1002A7BB0, OS_LOG_TYPE_ERROR))
    {
      LOWORD(trust[0]) = 0;
