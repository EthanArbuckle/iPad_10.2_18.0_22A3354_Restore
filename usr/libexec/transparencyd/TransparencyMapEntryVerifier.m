...
- (BOOL)verifyInclusionOfMapLeaf:(id)a3 position:(id)a4 treeHead:(id)a5 treeId:(unint64_t)a6 hashPath:(id)a7 error:(id *)a8
{
  ...
  if (v18 != (id)(8 * (_QWORD)objc_msgSend(v14, "length")))
  {
    ...
    if (qword_1002A7A98 != -1)
      dispatch_once(&qword_1002A7A98, &stru_10024B590);
    v35 = qword_1002A7AA0;
  ...
  if ((v33 & 1) == 0)
  {
    ...
    v17 = v45;
    if (qword_1002A7A98 != -1)
      dispatch_once(&qword_1002A7A98, &stru_10024B5B0);
    v38 = (void *)qword_1002A7AA0;
    if (os_log_type_enabled((os_log_t)qword_1002A7AA0, OS_LOG_TYPE_ERROR))
    {
      v39 = v38;
...
- (unint64_t)verifyMapEntryWithMapLeaf:(id)a3 hashesToRoot:(id)a4 signedMapHead:(id)a5 error:(id *)a6
{
  ...
  if (v13 == 1)
  {
    ...
    else
    {
      ...
      if (qword_1002A7A98 != -1)
        dispatch_once(&qword_1002A7A98, &stru_10024B610);
      v20 = qword_1002A7AA0;
      if (os_log_type_enabled((os_log_t)qword_1002A7AA0, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)v22 = 0;
