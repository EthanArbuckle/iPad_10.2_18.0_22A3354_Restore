...
{
  return -[TransparencyGPBUInt64UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
}
...
{
  TransparencyGPBUInt64UInt32Dictionary *v8;
...
{
  TransparencyGPBUInt64UInt32Dictionary *v4;
  TransparencyGPBUInt64UInt32Dictionary *v5;

  v4 = -[TransparencyGPBUInt64UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt64UInt32Dictionary initWithDictionary:](+[TransparencyGPBUInt64UInt32Dictionary allocWithZone:](TransparencyGPBUInt64UInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt64UInt32Dictionary, a2);
