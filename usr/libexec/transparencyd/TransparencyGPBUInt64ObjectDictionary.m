...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(0x100299000, a2);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_1000E445C((unint64_t)objc_msgSend(v11, "unsignedLongLongValue"), 1, v8);
        v15 = &sub_1000E299C(v13, v7)[v14];
        v12 += (uint64_t)&v15[sub_1000DE5AC(v15)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v16 = sub_1000E445C((unint64_t)v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000E299C(v14, v7) + v16);
      if (v8 == 4)
      {
      ...
      sub_1000E2ACC(a3, (const char *)v14, v7);
