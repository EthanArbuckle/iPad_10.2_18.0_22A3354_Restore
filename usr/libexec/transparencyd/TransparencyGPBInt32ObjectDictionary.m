...
{
  return -[TransparencyGPBInt32ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt32ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt32ObjectDictionary *v8;
  const void *v9;
  unsigned int v10;
  objc_super v12;
  ...
  v8 = -[TransparencyGPBInt32ObjectDictionary init](&v12, "init");
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          v10 = *a4++;
          -[NSMutableDictionary setObject:forKey:](v8->_dictionary, "setObject:forKey:", v9, +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", v10));
          ++a3;
          --a5;
        }
        while (a5);
...
{
  TransparencyGPBInt32ObjectDictionary *v4;
  TransparencyGPBInt32ObjectDictionary *v5;

  v4 = -[TransparencyGPBInt32ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBInt32ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt32ObjectDictionary initWithDictionary:](+[TransparencyGPBInt32ObjectDictionary allocWithZone:](TransparencyGPBInt32ObjectDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32ObjectDictionary, a2);
...
- (void)enumerateKeysAndObjectsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, objc_msgSend(v6, "intValue"), -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), &v7);
  }
  while (!v7);
}
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  ...
  v5 = objc_alloc_init(TransparencyGPBInt32ObjectDictionary);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_1000E3C18(objc_msgSend(v11, "intValue"), 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v16 = sub_1000E3C18(v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000E299C(v14, v7) + v16);
      sub_1000E3DB4(a3, (uint64_t)v15, 1, v8);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", a3->var2, +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", a4->var3));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100245050;
  v3[4] = a3;
  -[TransparencyGPBInt32ObjectDictionary enumerateKeysAndObjectsUsingBlock:](self, "enumerateKeysAndObjectsUsingBlock:", v3);
}

- (id)objectForKey:(int)a3
{
  return -[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", *(_QWORD *)&a3));
}
...
- (void)setObject:(id)a3 forKey:(int)a4
{
  ...
  if (!a3)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("Attempting to add nil object to a Dictionary"));
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", a3, +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", v4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000FE47C(autocreator, (uint64_t)self);
}
