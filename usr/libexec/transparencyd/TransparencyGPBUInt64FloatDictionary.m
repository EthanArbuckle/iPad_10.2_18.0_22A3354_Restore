...
{
  return -[TransparencyGPBUInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt64FloatDictionary *v8;
  double v9;
...
{
  TransparencyGPBUInt64FloatDictionary *v4;
  TransparencyGPBUInt64FloatDictionary *v5;

  v4 = -[TransparencyGPBUInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt64FloatDictionary initWithDictionary:](+[TransparencyGPBUInt64FloatDictionary allocWithZone:](TransparencyGPBUInt64FloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt64FloatDictionary, a2);
