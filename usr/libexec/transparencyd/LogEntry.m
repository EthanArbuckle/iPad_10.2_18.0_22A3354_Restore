...
+ (id)descriptor
{
  ...
  v2 = (id)qword_1002A75D0;
  if (!qword_1002A75D0)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", LogEntry, CFSTR("LogEntry"), &unk_1002A2BE0, &off_1002A2DD8, 6, 48, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_100217208);
    qword_1002A75D0 = (uint64_t)v2;
  }
  return v2;
}
...
LABEL_12:
      if (qword_1002A7AE8 != -1)
        dispatch_once(&qword_1002A7AE8, &stru_10024BB80);
      v14 = qword_1002A7AF0;
