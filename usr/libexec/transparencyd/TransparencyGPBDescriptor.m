...
+ (id)allocDescriptorForClass:(Class)a3 file:(id)a4 fields:(void *)a5 fieldCount:(unsigned int)a6 storageSize:(unsigned int)a7 flags:(unsigned int)a8
{
  ...
  objc_setAssociatedObject(v22, &unk_10021691C, v12, (void *)1);
  return v22;
}
      ...
      do
      {
        ...
        do
        {
          ...
          if ((*(_WORD *)(v10[1] + 28) & 0x40) != 0)
            objc_setAssociatedObject(v10, &unk_10021691D, v4, (void *)1);
          v9 = (char *)v9 + 1;
        }
        while (v7 != v9);
...
{
  objc_setAssociatedObject(self, &unk_10021691E, a3, 0);
}
...
- (void)setupMessageClassNameSuffix:(id)a3
{
  if (objc_msgSend(a3, "length"))
    objc_setAssociatedObject(self, &unk_10021691F, a3, (void *)1);
}
...
- (TransparencyGPBFileDescriptor)file
{
  ...
  AssociatedObject = (TransparencyGPBFileDescriptor *)objc_getAssociatedObject(self, &unk_10021691C);
  if (!AssociatedObject)
  {
    ...
    AssociatedObject = v6;
    objc_setAssociatedObject(v6, &unk_10021691C, v6, (void *)1);
  }
  objc_sync_exit(self);
...
{
  return (TransparencyGPBDescriptor *)objc_msgSend(objc_getAssociatedObject(self, &unk_10021691E), "descriptor");
}
...
- (NSString)fullName
{
  ...
  if (v4)
  {
    ...
    AssociatedObject = objc_getAssociatedObject(v4, &unk_10021691F);
    if (AssociatedObject)
    {
  ...
  v13 = objc_getAssociatedObject(self, &unk_10021691F);
  if (!v13)
    goto LABEL_14;
  v14 = v13;
