...
- (KTPendingFlag)initWithFlag:(id)a3 conditions:(unint64_t)a4 delayInSeconds:(double)a5
{
  ...
  v10 = -[KTPendingFlag init](&v16, "init");
  v11 = v10;
  if (v10)
  {
...
{
  return -[KTPendingFlag initWithFlag:conditions:after:](self, "initWithFlag:conditions:after:", a3, 0, a4);
}

- (KTPendingFlag)initWithFlag:(id)a3 scheduler:(id)a4
{
  return -[KTPendingFlag initWithFlag:conditions:scheduler:](self, "initWithFlag:conditions:scheduler:", a3, 0, a4);
}
...
- (id)description
{
  ...
  if (v3)
  {
    ...
    v5 = objc_claimAutoreleasedReturnValue(-[KTPendingFlag fireTime](self, "fireTime"));
LABEL_3:
    v6 = (void *)v5;
    v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<KTPendingFlag: %@: %@>"), v4, v5);
    goto LABEL_4;
  }
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[KTPendingFlag afterOperation](self, "afterOperation"));

  if (!v10)
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(-[KTPendingFlag flag](self, "flag"));
    v15 = sub_10010C280(-[KTPendingFlag conditions](self, "conditions"));
    v5 = objc_claimAutoreleasedReturnValue(v15);
    goto LABEL_3;
  }
  v11 = -[KTPendingFlag conditions](self, "conditions");
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[KTPendingFlag flag](self, "flag"));
  v12 = objc_claimAutoreleasedReturnValue(-[KTPendingFlag afterOperation](self, "afterOperation"));
  v6 = (void *)v12;
  if (v11)
  {
    v13 = sub_10010C280(-[KTPendingFlag conditions](self, "conditions"));
    v14 = (void *)objc_claimAutoreleasedReturnValue(v13);
    v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<KTPendingFlag: %@: %@ %@>"), v4, v6, v14));

    goto LABEL_5;
  }
  v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<KTPendingFlag: %@: %@>"), v4, v12);
LABEL_4:
