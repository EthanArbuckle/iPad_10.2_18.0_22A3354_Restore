...
- (TransparencyGPBFieldDescriptor)initWithFieldDescription:(void *)a3 descriptorFlags:(unsigned int)a4
{
  ...
  v7->setSel_ = sub_1000E156C("set", *((char **)a3 + (v4 & 1)), 0, 1);
  var6 = v8->var6;
  v10 = v7->description_->var5 & 0xF02;
  if ((v7->description_->var5 & 0xF02) != 0)
  {
    v11 = sub_1000E156C(0, *((char **)a3 + (v4 & 1)), "_Count", 0);
    v12 = 40;
LABEL_7:
  ...
  {
    v7->hasOrCountSel_ = sub_1000E156C("has", *((char **)a3 + (v4 & 1)), 0, 0);
    v11 = sub_1000E156C("setHas", *((char **)a3 + (v4 & 1)), 0, 1);
    v12 = 48;
    goto LABEL_7;
  }
LABEL_8:
...
- ($E4C39EFF89F956F9497E7CE1DE9E511A)defaultValue
{
  int64_t valueInt64;
  TransparencyGPBMessageFieldDescription *description;
  int var6;
  ...
  if ((description->var5 & 2) == 0)
  {
    ...
    {
      return ($E4C39EFF89F956F9497E7CE1DE9E511A)sub_100107E6C();
    }
    else
    {
      if (valueInt64)
        ...
        v7 = var6 == 14;
      if (v7)
        return ($E4C39EFF89F956F9497E7CE1DE9E511A)&stru_1002508B8;
    }
  }
  return ($E4C39EFF89F956F9497E7CE1DE9E511A)valueInt64;
}
...
- (id)textFormatName
{
  ...
  {
    AssociatedObject = objc_getAssociatedObject(self, &unk_10021691D);
    if (AssociatedObject)
      return sub_10010A3E4((char *)objc_msgSend(AssociatedObject, "pointerValue"), self->description_->var2, -[TransparencyGPBFieldDescriptor name](self, "name"));
    return 0;
  }
  else
  {
