...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  v6 = *(_QWORD *)&a3;
  v7 = sub_1000DFF54(1);
  v8 = +[NSMutableData dataWithLength:](NSMutableData, "dataWithLength:", sub_1000DFEB8(2, v6) + v7);
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v3])
    {
      ++v4;
      v12 = sub_1000DFF54(1);
      v13 = sub_1000E3C18(values[v3], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      v15 = v9 & 1;
      v16 = sub_1000DFF54(1);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000E3C18(values[v10], 2, v7) + v16);
      objc_msgSend(a3, "writeBool:value:", 1, v15);
      sub_1000E3DB4(a3, values[v10], 2, v7);
    }
    v13 = 0;
    v9 = 1;
    v10 = 1;
