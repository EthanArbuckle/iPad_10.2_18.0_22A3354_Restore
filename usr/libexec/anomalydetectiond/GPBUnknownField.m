...
- (GPBUnknownField)initWithNumber:(int)a3
{
  ...
  result = -[GPBUnknownField init](&v5, "init");
  if (result)
    result->number_ = a3;
  return result;
}
...
- (void)dealloc
{
  ...
  -[GPBUnknownField dealloc](&v3, "dealloc");
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = -[GPBUnknownField initWithNumber:](+[GPBUnknownField allocWithZone:](GPBUnknownField, "allocWithZone:"), "initWithNumber:", self->number_);
  v5->mutableFixed32List_ = (GPBUInt32Array *)-[GPBUInt32Array copyWithZone:](self->mutableFixed32List_, "copyWithZone:", a3);
  v5->mutableFixed64List_ = (GPBUInt64Array *)-[GPBUInt64Array copyWithZone:](self->mutableFixed64List_, "copyWithZone:", a3);
  ...
  v5->mutableVarintList_ = (GPBUInt64Array *)-[GPBUInt64Array copyWithZone:](self->mutableVarintList_, "copyWithZone:", a3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    goto LABEL_20;
  v5 = objc_opt_class(GPBUnknownField);
  if ((objc_opt_isKindOfClass(a3, v5) & 1) == 0 || self->number_ != *((_DWORD *)a3 + 2))
  {
    LOBYTE(v6) = 0;
    return v6;
  }
  if ((!-[GPBUInt64Array count](self->mutableVarintList_, "count") && !objc_msgSend(*((id *)a3 + 2), "count")
     || (v6 = -[GPBUInt64Array isEqual:](self->mutableVarintList_, "isEqual:", *((_QWORD *)a3 + 2))) != 0)
    && (!-[GPBUInt32Array count](self->mutableFixed32List_, "count") && !objc_msgSend(*((id *)a3 + 3), "count")
     || (v6 = -[GPBUInt32Array isEqual:](self->mutableFixed32List_, "isEqual:", *((_QWORD *)a3 + 3))) != 0)
    && (!-[GPBUInt64Array count](self->mutableFixed64List_, "count") && !objc_msgSend(*((id *)a3 + 4), "count")
     || (v6 = -[GPBUInt64Array isEqual:](self->mutableFixed64List_, "isEqual:", *((_QWORD *)a3 + 4))) != 0)
...
- (unint64_t)hash
{
  ...
  v3 = -[GPBUInt64Array hash](self->mutableVarintList_, "hash");
  v4 = (char *)-[GPBUInt32Array hash](self->mutableFixed32List_, "hash") + 32 * v3 - v3;
  v5 = (_BYTE *)-[GPBUInt64Array hash](self->mutableFixed64List_, "hash") - v4 + 32 * (_QWORD)v4;
...
- (unint64_t)serializedSize
{
  ...
  v31[4] = &v33;
  v32 = number;
  -[GPBUInt64Array enumerateValuesWithBlock:](mutableVarintList, "enumerateValuesWithBlock:", v31);
  ...
  v29[4] = &v33;
  v30 = number;
  -[GPBUInt32Array enumerateValuesWithBlock:](mutableFixed32List, "enumerateValuesWithBlock:", v29);
  ...
  v27[4] = &v33;
  v28 = number;
  -[GPBUInt64Array enumerateValuesWithBlock:](mutableFixed64List, "enumerateValuesWithBlock:", v27);
  v25 = 0u;
  v26 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        v11 = GPBComputeBytesSize(number, *(void **)(*((_QWORD *)&v23 + 1) + 8 * (_QWORD)i));
        v34[3] += (uint64_t)v11;
      }
      v8 = -[NSMutableArray countByEnumeratingWithState:objects:count:](mutableLengthDelimitedList, "countByEnumeratingWithState:objects:count:", &v23, v38, 16);
    }
  ...
  if (v13)
  {
    ...
    do
    {
      for (j = 0; j != v13; j = (char *)j + 1)
      {
        if (*(_QWORD *)v20 != v14)
          objc_enumerationMutation(mutableGroupList);
        v16 = GPBComputeUnknownGroupSize(number, *(void **)(*((_QWORD *)&v19 + 1) + 8 * (_QWORD)j));
        v34[3] += (uint64_t)v16;
      }
      v13 = -[NSMutableArray countByEnumeratingWithState:objects:count:](mutableGroupList, "countByEnumeratingWithState:objects:count:", &v19, v37, 16);
    }
...
- (unint64_t)serializedSizeAsMessageSetExtension
{
  ...
  do
  {
    for (i = 0; i != v5; i = (char *)i + 1)
    {
      if (*(_QWORD *)v11 != v7)
        objc_enumerationMutation(mutableLengthDelimitedList);
      v6 += (unint64_t)GPBComputeRawMessageSetExtensionSize(self->number_, *(void **)(*((_QWORD *)&v10 + 1) + 8 * (_QWORD)i));
    }
...
- (id)description
{
  ...
  v28[3] = &unk_100364B70;
  v28[4] = v3;
  -[GPBUInt64Array enumerateValuesWithBlock:](mutableVarintList, "enumerateValuesWithBlock:", v28);
  mutableFixed32List = self->mutableFixed32List_;
  v27[0] = _NSConcreteStackBlock;
  v27[1] = 3221225472;
  v27[2] = sub_1002986A4;
  v27[3] = &unk_100364B98;
  v27[4] = v3;
  -[GPBUInt32Array enumerateValuesWithBlock:](mutableFixed32List, "enumerateValuesWithBlock:", v27);
  mutableFixed64List = self->mutableFixed64List_;
  ...
  v26[3] = &unk_100364B70;
  v26[4] = v3;
  -[GPBUInt64Array enumerateValuesWithBlock:](mutableFixed64List, "enumerateValuesWithBlock:", v26);
  v24 = 0u;
  v25 = 0u;
  v22 = 0u;
  v23 = 0u;
...
- (void)mergeFromField:(id)a3
{
  ...
  if (objc_msgSend(v5, "count"))
  {
    ...
    if (mutableVarintList)
      -[GPBUInt64Array addValuesFromArray:](mutableVarintList, "addValuesFromArray:", v5);
    else
      self->mutableVarintList_ = (GPBUInt64Array *)objc_msgSend(v5, "copy");
  }
  ...
  if (objc_msgSend(v7, "count"))
  {
    ...
    if (mutableFixed32List)
      -[GPBUInt32Array addValuesFromArray:](mutableFixed32List, "addValuesFromArray:", v7);
    else
      self->mutableFixed32List_ = (GPBUInt32Array *)objc_msgSend(v7, "copy");
  }
  ...
  if (objc_msgSend(v9, "count"))
  {
    ...
    if (mutableFixed64List)
      -[GPBUInt64Array addValuesFromArray:](mutableFixed64List, "addValuesFromArray:", v9);
    else
      self->mutableFixed64List_ = (GPBUInt64Array *)objc_msgSend(v9, "copy");
  }
...
- (void)addVarint:(unint64_t)a3
{
  ...
  if (mutableVarintList)
    ...
    self->mutableVarintList_ = -[GPBUInt64Array initWithValues:count:]([GPBUInt64Array alloc], "initWithValues:count:", &v5, 1);
}
...
- (void)addFixed32:(unsigned int)a3
{
  ...
  if (mutableFixed32List)
    ...
    self->mutableFixed32List_ = -[GPBUInt32Array initWithValues:count:]([GPBUInt32Array alloc], "initWithValues:count:", &v5, 1);
}
...
- (void)addFixed64:(unint64_t)a3
{
  ...
  if (mutableFixed64List)
    ...
    self->mutableFixed64List_ = -[GPBUInt64Array initWithValues:count:]([GPBUInt64Array alloc], "initWithValues:count:", &v5, 1);
}
