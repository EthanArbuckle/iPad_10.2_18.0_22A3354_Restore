...
{
  return -[GPBInt32ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
}

- (GPBInt32ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  GPBInt32ObjectDictionary *v8;
  const void *v9;
  unsigned int v10;
  objc_super v12;
  ...
  v8 = -[GPBInt32ObjectDictionary init](&v12, "init");
  if (v8)
  {
...
{
  GPBInt32ObjectDictionary *v4;
  GPBInt32ObjectDictionary *v5;

  v4 = -[GPBInt32ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 4765, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32ObjectDictionary;
  -[GPBInt32ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt32ObjectDictionary initWithDictionary:](+[GPBInt32ObjectDictionary allocWithZone:](GPBInt32ObjectDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt32ObjectDictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365028;
  v3[4] = a3;
  -[GPBInt32ObjectDictionary enumerateKeysAndObjectsUsingBlock:](self, "enumerateKeysAndObjectsUsingBlock:", v3);
}
