...
{
  CSKappaTap2RadarConfiguration *result;
  objc_super v9;

  v9.receiver = self;
  v9.super_class = (Class)CSKappaTap2RadarConfiguration;
  result = -[CSKappaTap2RadarConfiguration init](&v9, "init");
  if (result)
  {
...
{
  if (qword_1003892A8 != -1)
    dispatch_once(&qword_1003892A8, &stru_100346E38);
  return (id)qword_100389298;
}
...
+ (id)tap2RadarUserConfiguration
{
  ...
  if (qword_1003892B0 != -1)
    dispatch_once(&qword_1003892B0, &stru_100346E58);
  ...
  v3 = objc_msgSend(v2, "BOOLForKey:", CFSTR("CSKappaTap2RadarAllowOnBattery"));
  v4 = objc_msgSend(v2, "integerForKey:", CFSTR("CSKappaTap2RadarCheckIntervalInSeconds"));
  v5 = objc_msgSend(v2, "integerForKey:", CFSTR("CSKappaTap2RadarCoolDownPeriodInSeconds"));
  v6 = (_QWORD *)qword_1003892A0;
  *(_BYTE *)(qword_1003892A0 + 8) = v3;
  if (v4)
    v6[2] = v4;
  if (v5)
    v6[3] = v5;
