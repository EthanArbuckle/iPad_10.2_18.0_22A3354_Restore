...
{
  return -[GPBStringUInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
}

- (GPBStringUInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  GPBStringUInt32Dictionary *v8;
  ...
  v8 = -[GPBStringUInt32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBStringUInt32Dictionary *v4;
  GPBStringUInt32Dictionary *v5;

  v4 = -[GPBStringUInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 8482, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBStringUInt32Dictionary;
  -[GPBStringUInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBStringUInt32Dictionary initWithDictionary:](+[GPBStringUInt32Dictionary allocWithZone:](GPBStringUInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBStringUInt32Dictionary);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_10029DEA4(objc_msgSend(v13, "unsignedIntValue"), 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_10029DEA4(v15, 2, v7) + v16);
      sub_1002B1C0C(a3, (uint64_t)v13, v8);
      sub_10029E090(a3, (uint64_t)v15, 2, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003652D0;
  v3[4] = a3;
  -[GPBStringUInt32Dictionary enumerateKeysAndUInt32sUsingBlock:](self, "enumerateKeysAndUInt32sUsingBlock:", v3);
}
