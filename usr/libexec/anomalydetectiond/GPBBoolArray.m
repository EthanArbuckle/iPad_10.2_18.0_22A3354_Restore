...
- (GPBBoolArray)init
{
  ...
  return -[GPBBoolArray init](&v3, "init");
}

- (GPBBoolArray)initWithValueArray:(id)a3
{
  return -[GPBBoolArray initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (GPBBoolArray)initWithValues:(const BOOL *)a3 count:(unint64_t)a4
{
  ...
  v6 = -[GPBBoolArray init](self, "init");
  v7 = v6;
  if (v6 && a3 && a4)
  {
    ...
    else
    {
      ...
      +[NSException raise:format:](NSException, "raise:format:", NSMallocException, CFSTR("Failed to allocate %lu bytes"), a4);
    }
  }
  return v7;
}
...
- (GPBBoolArray)initWithCapacity:(unint64_t)a3
{
  ...
  v4 = -[GPBBoolArray initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
    -[GPBBoolArray internalResizeToCapacity:](v4, "internalResizeToCapacity:", a3);
  return v5;
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBBoolArray initWithValues:count:](+[GPBBoolArray allocWithZone:](GPBBoolArray, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBArray.m"), 1874, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolArray;
  -[GPBBoolArray dealloc](&v3, "dealloc");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBBoolArray);
...
{
  -[GPBBoolArray enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)internalResizeToCapacity:(unint64_t)a3
{
  ...
  if (!v5)
  {
    self->_count = 0;
    self->_capacity = 0;
    +[NSException raise:format:](NSException, "raise:format:", NSMallocException, CFSTR("Failed to allocate %lu bytes"), a3);
  }
  self->_capacity = a3;
}
...
- (void)addValue:(BOOL)a3
{
  ...
  v3 = a3;
  -[GPBBoolArray addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const BOOL *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[GPBBoolArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[GPBBoolArray addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[GPBBoolArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[GPBBoolArray internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
