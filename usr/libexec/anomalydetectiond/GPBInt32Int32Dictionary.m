...
{
  return -[GPBInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (GPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  GPBInt32Int32Dictionary *v8;
  ...
  v8 = -[GPBInt32Int32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBInt32Int32Dictionary *v4;
  GPBInt32Int32Dictionary *v5;

  v4 = -[GPBInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 3411, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32Int32Dictionary;
  -[GPBInt32Int32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt32Int32Dictionary initWithDictionary:](+[GPBInt32Int32Dictionary allocWithZone:](GPBInt32Int32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt32Int32Dictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100364F38;
  v3[4] = a3;
  -[GPBInt32Int32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}
