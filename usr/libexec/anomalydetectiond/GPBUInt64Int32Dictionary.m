...
{
  return -[GPBUInt64Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (GPBUInt64Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  GPBUInt64Int32Dictionary *v8;
  ...
  v8 = -[GPBUInt64Int32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBUInt64Int32Dictionary *v4;
  GPBUInt64Int32Dictionary *v5;

  v4 = -[GPBUInt64Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 5161, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64Int32Dictionary;
  -[GPBUInt64Int32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt64Int32Dictionary initWithDictionary:](+[GPBUInt64Int32Dictionary allocWithZone:](GPBUInt64Int32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt64Int32Dictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365078;
  v3[4] = a3;
  -[GPBUInt64Int32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}
