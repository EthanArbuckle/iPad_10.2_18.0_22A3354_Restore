...
{
  return -[GPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", 0, 0, 0, 0);
}

- (GPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[GPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", a3, 0, 0, 0);
}
...
- (GPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unint64_t *)a5 count:(unint64_t)a6
{
  ...
  v10 = -[GPBUInt64EnumDictionary init](&v18, "init");
  if (v10)
  {
...
{
  GPBUInt64EnumDictionary *v4;
  GPBUInt64EnumDictionary *v5;

  v4 = -[GPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", objc_msgSend(a3, "validationFunc"), 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 6272, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64EnumDictionary;
  -[GPBUInt64EnumDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt64EnumDictionary initWithDictionary:](+[GPBUInt64EnumDictionary allocWithZone:](GPBUInt64EnumDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt64EnumDictionary);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_10029F1B0((unint64_t)objc_msgSend(v11, "unsignedLongLongValue"), 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = sub_10029F1B0((unint64_t)v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1002A2094(v16, v7) + v17);
      sub_10029F39C(a3, (uint64_t)v15, 1, v8);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  sub_10029F39C(v10, a4->var2, 1, v5);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365078;
  v3[4] = a3;
  -[GPBUInt64EnumDictionary enumerateKeysAndRawValuesUsingBlock:](self, "enumerateKeysAndRawValuesUsingBlock:", v3);
}
...
- (void)setEnum:(int)a3 forKey:(unint64_t)a4
{
  ...
  if ((((uint64_t (*)(_QWORD, SEL))self->_validationFunc)(*(_QWORD *)&a3, a2) & 1) == 0)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("GPBUInt64EnumDictionary: Attempt to set an unknown enum value (%d)"), v5);
