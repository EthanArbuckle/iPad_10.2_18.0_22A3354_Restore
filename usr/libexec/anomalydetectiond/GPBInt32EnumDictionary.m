...
{
  return -[GPBInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", 0, 0, 0, 0);
}

- (GPBInt32EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[GPBInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", a3, 0, 0, 0);
}

- (GPBInt32EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const int *)a5 count:(unint64_t)a6
{
  GPBInt32EnumDictionary *v10;
  ...
  v10 = -[GPBInt32EnumDictionary init](&v18, "init");
  if (v10)
  {
...
{
  GPBInt32EnumDictionary *v4;
  GPBInt32EnumDictionary *v5;

  v4 = -[GPBInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", objc_msgSend(a3, "validationFunc"), 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 4522, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32EnumDictionary;
  -[GPBInt32EnumDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt32EnumDictionary initWithDictionary:](+[GPBInt32EnumDictionary allocWithZone:](GPBInt32EnumDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt32EnumDictionary);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  sub_10029EA1C(v10, a4->var3, 1, v5);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100364F38;
  v3[4] = a3;
  -[GPBInt32EnumDictionary enumerateKeysAndRawValuesUsingBlock:](self, "enumerateKeysAndRawValuesUsingBlock:", v3);
}
...
- (void)setEnum:(int)a3 forKey:(int)a4
{
  ...
  if ((((uint64_t (*)(_QWORD, SEL))self->_validationFunc)(*(_QWORD *)&a3, a2) & 1) == 0)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("GPBInt32EnumDictionary: Attempt to set an unknown enum value (%d)"), v5);
