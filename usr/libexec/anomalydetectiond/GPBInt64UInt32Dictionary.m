...
{
  return -[GPBInt64UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
}

- (GPBInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  GPBInt64UInt32Dictionary *v8;
  ...
  v8 = -[GPBInt64UInt32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBInt64UInt32Dictionary *v4;
  GPBInt64UInt32Dictionary *v5;

  v4 = -[GPBInt64UInt32Dictionary initWithUInt32s:forKeys:count:](self, "initWithUInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 6728, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt64UInt32Dictionary;
  -[GPBInt64UInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt64UInt32Dictionary initWithDictionary:](+[GPBInt64UInt32Dictionary allocWithZone:](GPBInt64UInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt64UInt32Dictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365190;
  v3[4] = a3;
  -[GPBInt64UInt32Dictionary enumerateKeysAndUInt32sUsingBlock:](self, "enumerateKeysAndUInt32sUsingBlock:", v3);
}
