...
{
  return -[GPBUInt64BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
}

- (GPBUInt64BoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  GPBUInt64BoolDictionary *v8;
  ...
  v8 = -[GPBUInt64BoolDictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBUInt64BoolDictionary *v4;
  GPBUInt64BoolDictionary *v5;

  v4 = -[GPBUInt64BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 5710, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64BoolDictionary;
  -[GPBUInt64BoolDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt64BoolDictionary initWithDictionary:](+[GPBUInt64BoolDictionary allocWithZone:](GPBUInt64BoolDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt64BoolDictionary);
...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, objc_msgSend(v6, "unsignedLongLongValue"), objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "BOOLValue"), &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = sub_1002A04B4((uint64_t)objc_msgSend(v13, "BOOLValue"), 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1002A04B4((uint64_t)v16, 2, v7) + v17);
      sub_10029F39C(a3, (uint64_t)v15, 1, v8);
      sub_1002A0678(a3, (uint64_t)v16, 2, v7);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithBool:](NSNumber, "numberWithBool:", a3->var0), +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a4->var2));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003650F0;
  v3[4] = a3;
  -[GPBUInt64BoolDictionary enumerateKeysAndBoolsUsingBlock:](self, "enumerateKeysAndBoolsUsingBlock:", v3);
}
...
- (void)setBool:(BOOL)a3 forKey:(unint64_t)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithBool:](NSNumber, "numberWithBool:", a3), +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator)
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
