...
- (GPBDoubleArray)init
{
  ...
  return -[GPBDoubleArray init](&v3, "init");
}

- (GPBDoubleArray)initWithValueArray:(id)a3
{
  return -[GPBDoubleArray initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (GPBDoubleArray)initWithValues:(const double *)a3 count:(unint64_t)a4
{
  ...
  v6 = -[GPBDoubleArray init](self, "init");
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (GPBDoubleArray)initWithCapacity:(unint64_t)a3
{
  ...
  v4 = -[GPBDoubleArray initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
    -[GPBDoubleArray internalResizeToCapacity:](v4, "internalResizeToCapacity:", a3);
  return v5;
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBDoubleArray initWithValues:count:](+[GPBDoubleArray allocWithZone:](GPBDoubleArray, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBArray.m"), 1624, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBDoubleArray;
  -[GPBDoubleArray dealloc](&v3, "dealloc");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBDoubleArray);
  ...
  if (count)
  {
    for (i = 0; i != count; ++i)
    {
      if (i)
        ...
        v6 = CFSTR("%lf");
      -[NSMutableString appendFormat:](v3, "appendFormat:", v6, *(_QWORD *)&self->_values[i]);
    }
  }
...
{
  -[GPBDoubleArray enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(double)a3
{
  ...
  v3 = a3;
  -[GPBDoubleArray addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const double *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[GPBDoubleArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[GPBDoubleArray addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[GPBDoubleArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[GPBDoubleArray internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
