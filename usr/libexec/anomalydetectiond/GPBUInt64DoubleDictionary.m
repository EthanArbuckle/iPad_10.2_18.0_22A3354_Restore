...
{
  return -[GPBUInt64DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (GPBUInt64DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  GPBUInt64DoubleDictionary *v8;
  ...
  v8 = -[GPBUInt64DoubleDictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBUInt64DoubleDictionary *v4;
  GPBUInt64DoubleDictionary *v5;

  v4 = -[GPBUInt64DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 6076, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64DoubleDictionary;
  -[GPBUInt64DoubleDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt64DoubleDictionary initWithDictionary:](+[GPBUInt64DoubleDictionary allocWithZone:](GPBUInt64DoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt64DoubleDictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365140;
  v3[4] = a3;
  -[GPBUInt64DoubleDictionary enumerateKeysAndDoublesUsingBlock:](self, "enumerateKeysAndDoublesUsingBlock:", v3);
}
