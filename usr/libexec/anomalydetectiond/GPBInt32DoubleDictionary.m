...
{
  return -[GPBInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (GPBInt32DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  GPBInt32DoubleDictionary *v8;
  ...
  v8 = -[GPBInt32DoubleDictionary init](&v13, "init");
  if (v8)
  {
...
{
  GPBInt32DoubleDictionary *v4;
  GPBInt32DoubleDictionary *v5;

  v4 = -[GPBInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 4326, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32DoubleDictionary;
  -[GPBInt32DoubleDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt32DoubleDictionary initWithDictionary:](+[GPBInt32DoubleDictionary allocWithZone:](GPBInt32DoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt32DoubleDictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365000;
  v3[4] = a3;
  -[GPBInt32DoubleDictionary enumerateKeysAndDoublesUsingBlock:](self, "enumerateKeysAndDoublesUsingBlock:", v3);
}
