...
{
  return -[GPBUInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (GPBUInt32DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  GPBUInt32DoubleDictionary *v8;
  ...
  v8 = -[GPBUInt32DoubleDictionary init](&v13, "init");
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          LODWORD(v10) = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v11, +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", LODWORD(v10)));
          --a5;
        }
        while (a5);
      }
...
{
  GPBUInt32DoubleDictionary *v4;
  GPBUInt32DoubleDictionary *v5;

  v4 = -[GPBUInt32DoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 2576, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32DoubleDictionary;
  -[GPBUInt32DoubleDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt32DoubleDictionary initWithDictionary:](+[GPBUInt32DoubleDictionary allocWithZone:](GPBUInt32DoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt32DoubleDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = v16;
      LODWORD(v14) = sub_10029DEA4(v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1002A170C(v7) + v14);
      sub_10029E090(a3, (uint64_t)v15, 1, v8);
      sub_1002A18C8(a3, v7, v17);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:", a3->var6), +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", a4->var3));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100364EC0;
  v3[4] = a3;
  -[GPBUInt32DoubleDictionary enumerateKeysAndDoublesUsingBlock:](self, "enumerateKeysAndDoublesUsingBlock:", v3);
}
...
- (void)setDouble:(double)a3 forKey:(unsigned int)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:", a3), +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", *(_QWORD *)&a4));
  autocreator = self->_autocreator;
  if (autocreator)
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
