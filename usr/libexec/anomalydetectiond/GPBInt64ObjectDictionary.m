...
{
  return -[GPBInt64ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
}

- (GPBInt64ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  GPBInt64ObjectDictionary *v8;
  const void *v9;
  uint64_t v10;
  objc_super v12;
  ...
  v8 = -[GPBInt64ObjectDictionary init](&v12, "init");
  if (v8)
  {
...
{
  GPBInt64ObjectDictionary *v4;
  GPBInt64ObjectDictionary *v5;

  v4 = -[GPBInt64ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 8265, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt64ObjectDictionary;
  -[GPBInt64ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt64ObjectDictionary initWithDictionary:](+[GPBInt64ObjectDictionary allocWithZone:](GPBInt64ObjectDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt64ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v16 = sub_10029FB14((unint64_t)v15, 1, v8);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003652A8;
  v3[4] = a3;
  -[GPBInt64ObjectDictionary enumerateKeysAndObjectsUsingBlock:](self, "enumerateKeysAndObjectsUsingBlock:", v3);
}
