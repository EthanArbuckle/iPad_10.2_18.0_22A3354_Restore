...
{
  return -[GPBBoolInt64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (GPBBoolInt64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  GPBBoolInt64Dictionary *result;
  BOOL v9;
  uint64_t v10;
  unsigned int v11;
  int64_t v12;
  ...
  result = -[GPBBoolInt64Dictionary init](&v13, "init");
  if (result)
    v9 = a5 == 0;
  else
    v9 = 1;
...
- (GPBBoolInt64Dictionary)initWithDictionary:(id)a3
{
  ...
  result = -[GPBBoolInt64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  if (a3 && result)
  {
    v5 = 0;
    v6 = 1;
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 10726, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolInt64Dictionary;
  -[GPBBoolInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBBoolInt64Dictionary initWithDictionary:](+[GPBBoolInt64Dictionary allocWithZone:](GPBBoolInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBBoolInt64Dictionary);
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v4])
    {
      ...
      v13 = sub_10029FB14(values[v4], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_10029FB14(values[v10], 2, v7) + v16);
      objc_msgSend(a3, "writeBool:value:", 1, v15);
      sub_10029FD20(a3, values[v10], 2, v7);
    }
    v13 = 0;
    v9 = 1;
    v10 = 1;
