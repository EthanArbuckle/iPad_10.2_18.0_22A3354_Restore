...
{
  return -[GPBUInt32Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (GPBUInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  GPBUInt32Int64Dictionary *v8;
  ...
  v8 = -[GPBUInt32Int64Dictionary init](&v13, "init");
  if (v8)
  {
...
{
  GPBUInt32Int64Dictionary *v4;
  GPBUInt32Int64Dictionary *v5;

  v4 = -[GPBUInt32Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 2027, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32Int64Dictionary;
  -[GPBUInt32Int64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt32Int64Dictionary initWithDictionary:](+[GPBUInt32Int64Dictionary allocWithZone:](GPBUInt32Int64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt32Int64Dictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100364E48;
  v3[4] = a3;
  -[GPBUInt32Int64Dictionary enumerateKeysAndInt64sUsingBlock:](self, "enumerateKeysAndInt64sUsingBlock:", v3);
}
