...
{
  return -[GPBStringInt32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (GPBStringInt32Dictionary)initWithInt32s:(const int *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  GPBStringInt32Dictionary *v8;
  ...
  v8 = -[GPBStringInt32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBStringInt32Dictionary *v4;
  GPBStringInt32Dictionary *v5;

  v4 = -[GPBStringInt32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 8673, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBStringInt32Dictionary;
  -[GPBStringInt32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBStringInt32Dictionary initWithDictionary:](+[GPBStringInt32Dictionary allocWithZone:](GPBStringInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBStringInt32Dictionary);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_10029E810(objc_msgSend(v13, "intValue"), 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_10029E810(v15, 2, v7) + v16);
      sub_1002B1C0C(a3, (uint64_t)v13, v8);
      sub_10029EA1C(a3, (uint64_t)v15, 2, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003652F8;
  v3[4] = a3;
  -[GPBStringInt32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}
