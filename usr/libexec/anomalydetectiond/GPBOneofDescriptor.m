...
{
  GPBOneofDescriptor *v6;
  GPBOneofDescriptor *v7;
  id v8;
  id v9;
  uint64_t v10;
  void *i;
  ...
  v17.receiver = self;
  v17.super_class = (Class)GPBOneofDescriptor;
  v6 = -[GPBOneofDescriptor init](&v17, "init");
  v7 = v6;
  if (v6)
  {
    v6->name_ = a3;
    ...
    v7->caseSel_ = sub_10028F358(0, (char *)a3, "OneOfCase", 0);
  }
  return v7;
}
...
- (void)dealloc
{
  ...
  -[GPBOneofDescriptor dealloc](&v3, "dealloc");
}
