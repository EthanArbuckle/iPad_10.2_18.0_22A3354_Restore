...
{
  return -[GPBStringDoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
}

- (GPBStringDoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  GPBStringDoubleDictionary *v8;
  ...
  v8 = -[GPBStringDoubleDictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBStringDoubleDictionary *v4;
  GPBStringDoubleDictionary *v5;

  v4 = -[GPBStringDoubleDictionary initWithDoubles:forKeys:count:](self, "initWithDoubles:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 9628, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBStringDoubleDictionary;
  -[GPBStringDoubleDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBStringDoubleDictionary initWithDictionary:](+[GPBStringDoubleDictionary allocWithZone:](GPBStringDoubleDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBStringDoubleDictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003653C0;
  v3[4] = a3;
  -[GPBStringDoubleDictionary enumerateKeysAndDoublesUsingBlock:](self, "enumerateKeysAndDoublesUsingBlock:", v3);
}
