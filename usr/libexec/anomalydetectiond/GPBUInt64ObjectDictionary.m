...
{
  return -[GPBUInt64ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
}

- (GPBUInt64ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  GPBUInt64ObjectDictionary *v8;
  const void *v9;
  uint64_t v10;
  objc_super v12;
  ...
  v8 = -[GPBUInt64ObjectDictionary init](&v12, "init");
  if (v8)
  {
...
{
  GPBUInt64ObjectDictionary *v4;
  GPBUInt64ObjectDictionary *v5;

  v4 = -[GPBUInt64ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 6515, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64ObjectDictionary;
  -[GPBUInt64ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt64ObjectDictionary initWithDictionary:](+[GPBUInt64ObjectDictionary allocWithZone:](GPBUInt64ObjectDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt64ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v16 = sub_10029F1B0((unint64_t)v15, 1, v8);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365168;
  v3[4] = a3;
  -[GPBUInt64ObjectDictionary enumerateKeysAndObjectsUsingBlock:](self, "enumerateKeysAndObjectsUsingBlock:", v3);
}
