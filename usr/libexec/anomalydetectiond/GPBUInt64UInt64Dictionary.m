...
{
  return -[GPBUInt64UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}

- (GPBUInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  GPBUInt64UInt64Dictionary *v8;
  ...
  v8 = -[GPBUInt64UInt64Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBUInt64UInt64Dictionary *v4;
  GPBUInt64UInt64Dictionary *v5;

  v4 = -[GPBUInt64UInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 5344, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64UInt64Dictionary;
  -[GPBUInt64UInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt64UInt64Dictionary initWithDictionary:](+[GPBUInt64UInt64Dictionary allocWithZone:](GPBUInt64UInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt64UInt64Dictionary);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003650A0;
  v3[4] = a3;
  -[GPBUInt64UInt64Dictionary enumerateKeysAndUInt64sUsingBlock:](self, "enumerateKeysAndUInt64sUsingBlock:", v3);
}
