...
- (GPBEnumArray)init
{
  return -[GPBEnumArray initWithValidationFunction:](self, "initWithValidationFunction:", 0);
}

- (GPBEnumArray)initWithValueArray:(id)a3
{
  return -[GPBEnumArray initWithValidationFunction:rawValues:count:](self, "initWithValidationFunction:rawValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3), *((_QWORD *)a3 + 4));
}
...
- (GPBEnumArray)initWithValidationFunction:(void *)a3
{
  ...
  result = -[GPBEnumArray init](&v6, "init");
  if (result)
  {
    v5 = sub_1002C1EBC;
    if (a3)
...
- (GPBEnumArray)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 count:(unint64_t)a5
{
  ...
  v7 = -[GPBEnumArray initWithValidationFunction:](self, "initWithValidationFunction:", a3);
  v8 = v7;
  if (v7 && a4 && a5)
  {
...
- (GPBEnumArray)initWithValidationFunction:(void *)a3 capacity:(unint64_t)a4
{
  ...
  v5 = -[GPBEnumArray initWithValidationFunction:](self, "initWithValidationFunction:", a3);
  v6 = v5;
  if (a4 && v5)
    -[GPBEnumArray internalResizeToCapacity:](v5, "internalResizeToCapacity:", a4);
  return v6;
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBEnumArray initWithValidationFunction:rawValues:count:](+[GPBEnumArray allocWithZone:](GPBEnumArray, "allocWithZone:", a3), "initWithValidationFunction:rawValues:count:", self->_validationFunc, self->_values, self->_count);
}
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBArray.m"), 2148, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBEnumArray;
  -[GPBEnumArray dealloc](&v3, "dealloc");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBEnumArray);
...
{
  -[GPBEnumArray enumerateRawValuesWithOptions:usingBlock:](self, "enumerateRawValuesWithOptions:usingBlock:", 0, a3);
}
...
{
  -[GPBEnumArray enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addRawValue:(int)a3
{
  ...
  v3 = a3;
  -[GPBEnumArray addRawValues:count:](self, "addRawValues:count:", &v3, 1);
}
...
- (void)addRawValues:(const int *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[GPBEnumArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[GPBEnumArray addRawValues:count:](self, "addRawValues:count:", *((_QWORD *)a3 + 3), *((_QWORD *)a3 + 4));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[GPBEnumArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[GPBEnumArray internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
...
- (void)addValue:(int)a3
{
  ...
  v3 = a3;
  -[GPBEnumArray addValues:count:](self, "addValues:count:", &v3, 1);
}
  ...
  if (a3 && a4)
  {
    ...
    do
    {
      if ((validationFunc(a3[v7], a2) & 1) == 0)
        +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("%@: Attempt to set an unknown enum value (%d)"), objc_opt_class(self), a3[v7]);
      ++v7;
    }
    while (a4 != v7);
    count = self->_count;
    v10 = count + a4;
    if (count + a4 > self->_capacity)
      -[GPBEnumArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v10 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v10;
    memcpy(&self->_values[count], a3, 4 * a4);
    autocreator = self->_autocreator;
    if (autocreator)
...
- (void)insertValue:(int)a3 atIndex:(unint64_t)a4
{
  ...
  if ((((uint64_t (*)(uint64_t))self->_validationFunc)(v5) & 1) == 0)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("%@: Attempt to set an unknown enum value (%d)"), objc_opt_class(self), v5);
  count = self->_count;
  v9 = count + 1;
  if (count + 1 > self->_capacity)
    -[GPBEnumArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v9 & 0xFFFFFFFFFFFFFFF0) + 16);
  self->_count = v9;
  if (count != a4)
    memmove(&self->_values[a4 + 1], &self->_values[a4], 4 * (count - a4));
  self->_values[a4] = v5;
...
- (void)replaceValueAtIndex:(unint64_t)a3 withValue:(int)a4
{
  ...
  if ((((uint64_t (*)(uint64_t))self->_validationFunc)(v4) & 1) == 0)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("%@: Attempt to set an unknown enum value (%d)"), objc_opt_class(self), v4);
  self->_values[a3] = v4;
}
