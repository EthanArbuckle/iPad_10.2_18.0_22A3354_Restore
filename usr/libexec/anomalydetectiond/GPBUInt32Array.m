...
+ (GPBUInt32Array)arrayWithValue:(unsigned int)a3
{
  ...
  v4 = a3;
  return (GPBUInt32Array *)objc_msgSend(objc_alloc((Class)a1), "initWithValues:count:", &v4, 1);
}

+ (GPBUInt32Array)arrayWithValueArray:(id)a3
{
  return (GPBUInt32Array *)objc_msgSend(objc_alloc((Class)a1), "initWithValueArray:", a3);
}

+ (GPBUInt32Array)arrayWithCapacity:(unint64_t)a3
{
  return (GPBUInt32Array *)objc_msgSend(objc_alloc((Class)a1), "initWithCapacity:", a3);
}
...
- (GPBUInt32Array)init
{
  ...
  return -[GPBUInt32Array init](&v3, "init");
}

- (GPBUInt32Array)initWithValueArray:(id)a3
{
  return -[GPBUInt32Array initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (GPBUInt32Array)initWithValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  ...
  v6 = -[GPBUInt32Array init](self, "init");
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (GPBUInt32Array)initWithCapacity:(unint64_t)a3
{
  ...
  v4 = -[GPBUInt32Array initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
    -[GPBUInt32Array internalResizeToCapacity:](v4, "internalResizeToCapacity:", a3);
  return v5;
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBUInt32Array initWithValues:count:](+[GPBUInt32Array allocWithZone:](GPBUInt32Array, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBArray.m"), 624, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32Array;
  -[GPBUInt32Array dealloc](&v3, "dealloc");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBUInt32Array);
...
{
  -[GPBUInt32Array enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(unsigned int)a3
{
  ...
  v3 = a3;
  -[GPBUInt32Array addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[GPBUInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[GPBUInt32Array addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[GPBUInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[GPBUInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
