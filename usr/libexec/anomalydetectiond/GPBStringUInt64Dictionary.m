...
{
  return -[GPBStringUInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}

- (GPBStringUInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  GPBStringUInt64Dictionary *v8;
  ...
  v8 = -[GPBStringUInt64Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  GPBStringUInt64Dictionary *v4;
  GPBStringUInt64Dictionary *v5;

  v4 = -[GPBStringUInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 8864, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBStringUInt64Dictionary;
  -[GPBStringUInt64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBStringUInt64Dictionary initWithDictionary:](+[GPBStringUInt64Dictionary allocWithZone:](GPBStringUInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBStringUInt64Dictionary);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_10029F1B0((unint64_t)objc_msgSend(v13, "unsignedLongLongValue"), 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_10029F1B0((unint64_t)v15, 2, v7) + v16);
      sub_1002B1C0C(a3, (uint64_t)v13, v8);
      sub_10029F39C(a3, (uint64_t)v15, 2, v7);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a3->var2), a4->var2);
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365320;
  v3[4] = a3;
  -[GPBStringUInt64Dictionary enumerateKeysAndUInt64sUsingBlock:](self, "enumerateKeysAndUInt64sUsingBlock:", v3);
}
...
- (void)setUInt64:(unint64_t)a3 forKey:(id)a4
{
  ...
  if (!a4)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("Attempting to add nil key to a Dictionary"));
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a3), a4);
  autocreator = self->_autocreator;
  if (autocreator)
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
}
