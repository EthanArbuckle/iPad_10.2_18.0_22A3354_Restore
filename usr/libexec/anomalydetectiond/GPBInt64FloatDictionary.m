...
{
  return -[GPBInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (GPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  GPBInt64FloatDictionary *v8;
  double v9;
  ...
  v8 = -[GPBInt64FloatDictionary init](&v15, "init");
  if (v8)
  {
...
{
  GPBInt64FloatDictionary *v4;
  GPBInt64FloatDictionary *v5;

  v4 = -[GPBInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  if (self->_autocreator)
    -[NSAssertionHandler handleFailureInMethod:object:file:lineNumber:description:](+[NSAssertionHandler currentHandler](NSAssertionHandler, "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, CFSTR("GPBDictionary.m"), 7643, CFSTR("%@: Autocreator must be cleared before release, autocreator: %@"), objc_opt_class(self), self->_autocreator);

  v3.receiver = self;
  v3.super_class = (Class)GPBInt64FloatDictionary;
  -[GPBInt64FloatDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[GPBInt64FloatDictionary initWithDictionary:](+[GPBInt64FloatDictionary allocWithZone:](GPBInt64FloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(GPBInt64FloatDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = v16;
      LODWORD(v14) = sub_10029FB14((unint64_t)v15, 1, v8);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_100365258;
  v3[4] = a3;
  -[GPBInt64FloatDictionary enumerateKeysAndFloatsUsingBlock:](self, "enumerateKeysAndFloatsUsingBlock:", v3);
}
