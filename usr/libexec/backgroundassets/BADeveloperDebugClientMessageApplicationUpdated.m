...
{
  id v5;
  BADeveloperDebugClientMessageApplicationUpdated *v6;
  BADeveloperDebugClientMessageApplicationUpdated *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)BADeveloperDebugClientMessageApplicationUpdated;
  v6 = -[BADeveloperDebugClientMessage initWithMessageOperation:](&v9, "initWithMessageOperation:", 3);
  v7 = v6;
  if (v6)
...
- (BADeveloperDebugClientMessageApplicationUpdated)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)BADeveloperDebugClientMessageApplicationUpdated;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[BADeveloperDebugClientMessageApplicationUpdated appBundleIdentifier](self, "appBundleIdentifier", v6.receiver, v6.super_class));
