...
- (CKKSFixupRefetchAllCurrentItemPointers)initWithOperationDependencies:(id)a3 ckoperationGroup:(id)a4
{
  id v7;
  id v8;
  CKKSFixupRefetchAllCurrentItemPointers *v9;
  CKKSFixupRefetchAllCurrentItemPointers *v10;
  objc_super v12;
  ...
  if (v9)
  {
    ...
    objc_storeStrong((id *)&v10->_intendedState, CFSTR("fixup_fetch_tlkshares"));
...
- (id)description
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSFixupRefetchAllCurrentItemPointers deps](self, "deps"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "views"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<CKKSFixup:RefetchAllCurrentItemPointers (%@)>"), v3));
...
- (void)groupStart
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSFixupRefetchAllCurrentItemPointers deps](self, "deps"));
  ...
  v13 = 0u;
  v14 = 0u;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSFixupRefetchAllCurrentItemPointers deps](self, "deps"));
