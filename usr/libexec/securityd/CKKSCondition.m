...
- (CKKSCondition)init
{
  return (CKKSCondition *)-[CKKSCondition initToChain:](self, "initToChain:", 0);
}
...
- (void)fulfill
{
  ...
  v3 = objc_claimAutoreleasedReturnValue(-[CKKSCondition semaphore](self, "semaphore"));
  dispatch_semaphore_signal(v3);

  v4 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSCondition chain](self, "chain"));
  objc_msgSend(v4, "fulfill");

  -[CKKSCondition setChain:](self, "setChain:", 0);
}
...
- (int64_t)wait:(unint64_t)a3
{
  ...
  v5 = objc_claimAutoreleasedReturnValue(-[CKKSCondition semaphore](self, "semaphore"));
  v6 = dispatch_time(0, a3);
  v7 = dispatch_semaphore_wait(v5, v6);

  if (!v7)
  {
    v8 = objc_claimAutoreleasedReturnValue(-[CKKSCondition semaphore](self, "semaphore"));
