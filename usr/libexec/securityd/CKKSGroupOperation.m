...
- (CKKSGroupOperation)init
{
  ...
  v29.receiver = self;
  v29.super_class = (Class)CKKSGroupOperation;
  ...
  if (v2)
  {
    ...
    v9 = dispatch_queue_create("CKKSGroupOperationDispatchQueue", v8);
    queue = v2->_queue;
...
- (BOOL)isPending
{
  ...
  if (objc_msgSend(v3, "isPending"))
    v4 = -[CKKSGroupOperation isCancelled](self, "isCancelled") ^ 1;
  else
    LOBYTE(v4) = 0;
...
- (void)setName:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation operationQueue](self, "operationQueue"));
...
- (id)description
{
  ...
  *v4 = v6;
  if (v6 >= 0xB)
  {
    v7 = (__CFString *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation selfname](self, "selfname"));
...
LABEL_29:
  ...
  {
    v14 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation operationQueue](self, "operationQueue"));
      ...
      if (v25)
      {
        ...
        while (2)
        {
          for (i = 0; i != v26; i = (char *)i + 1)
          {
            ...
            v30 = objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation"));
            if (v29 == (void *)v30)
            {
...
LABEL_24:
    ...
    {
      v35 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation pendingDependenciesString:](self, "pendingDependenciesString:", CFSTR(" dep:")));
  ...
  v11 = objc_claimAutoreleasedReturnValue(-[CKKSResultOperation finishDate](self, "finishDate"));
  v12 = (void *)v11;
  if (v9)
  {
...
- (BOOL)isExecuting
{
  ...
  v8 = 0x2020000000;
  v9 = 0;
  v3 = objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation queue](self, "queue"));
...
- (void)start
{
  ...
  {
    v3 = CFSTR("isFinished");
    -[CKKSGroupOperation willChangeValueForKey:](self, "willChangeValueForKey:", CFSTR("isFinished"));
    v4 = objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation queue](self, "queue"));
    v5 = v4;
  ...
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation operationQueue](self, "operationQueue"));
    v8 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation"));
    objc_msgSend(v7, "addOperation:", v8);

    v3 = CFSTR("isExecuting");
    -[CKKSGroupOperation willChangeValueForKey:](self, "willChangeValueForKey:", CFSTR("isExecuting"));
    v4 = objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation queue](self, "queue"));
    v5 = v4;
...
- (void)cancel
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSBlockOperation blockOperationWithBlock:](NSBlockOperation, "blockOperationWithBlock:", &stru_1002DC330));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation"));
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation operationQueue](self, "operationQueue"));
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; i = (char *)i + 1)
      {
        ...
        v14 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation finishOperation](self, "finishOperation"));
  ...
  if (v20)
  {
    ...
    do
    {
      for (j = 0; j != v21; j = (char *)j + 1)
      {
        ...
        {
          v25 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation"));
          v26 = objc_msgSend(v24, "isEqual:", v25);

          if ((v26 & 1) == 0)
          {
            v27 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation finishOperation](self, "finishOperation"));
  ...
  if (v29)
    -[CKKSGroupOperation setFillInError:](self, "setFillInError:", 0);
  v30 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation operationQueue](self, "operationQueue", (_QWORD)v31));
...
- (void)completeOperation
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10006A56C;
  block[3] = &unk_1002EC350;
  block[4] = self;
  dispatch_sync(v3, block);

  -[CKKSGroupOperation didChangeValueForKey:](self, "didChangeValueForKey:", CFSTR("isExecuting"));
  -[CKKSGroupOperation didChangeValueForKey:](self, "didChangeValueForKey:", CFSTR("isFinished"));
}
...
- (void)addDependency:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation", v6.receiver, v6.super_class));
...
- (void)runBeforeGroupFinished:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation"));
  objc_msgSend(v4, "addDependency:", v5);

  -[CKKSGroupOperation dependOnBeforeGroupFinished:](self, "dependOnBeforeGroupFinished:", v4);
  v6 = (id)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation operationQueue](self, "operationQueue"));
...
- (void)dependOnBeforeGroupFinished:(id)a3
{
  ...
  if (v4)
  {
    if (-[CKKSGroupOperation isCancelled](self, "isCancelled"))
    {
      ...
      v6 = (CKKSGroupOperation *)objc_claimAutoreleasedReturnValue(v5);
      if (os_log_type_enabled(&v6->super.super.super.super, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
        _os_log_impl((void *)&_mh_execute_header, &v6->super.super.super.super, OS_LOG_TYPE_DEFAULT, "Can't add operation dependency to cancelled group", buf, 2u);
      }
      goto LABEL_8;
    }
    v7 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation finishOperation](self, "finishOperation"));
    objc_msgSend(v7, "addDependency:", v4);

    v8 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation finishOperation](self, "finishOperation"));
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation startOperation](self, "startOperation"));
    objc_msgSend(v4, "addDependency:", v10);

    v11 = objc_opt_class(CKKSResultOperation);
    if ((objc_opt_isKindOfClass(v4, v11) & 1) != 0)
    {
      v6 = self;
      objc_sync_enter(v6);
      v12 = (void *)objc_claimAutoreleasedReturnValue(-[CKKSGroupOperation internalSuccesses](v6, "internalSuccesses"));
