...
- (OTLeaveCliqueOperation)initWithDependencies:(id)a3 intendedState:(id)a4 errorState:(id)a5
{
  ...
  id v10;
  id v11;
  OTLeaveCliqueOperation *v12;
  OTLeaveCliqueOperation *v13;
  objc_super v15;
...
- (void)groupStart
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "Attempting to leave clique", buf, 2u);
  }

  v5 = objc_alloc_init((Class)NSOperation);
  -[OTLeaveCliqueOperation setFinishedOp:](self, "setFinishedOp:", v5);

  v6 = (void *)objc_claimAutoreleasedReturnValue(-[OTLeaveCliqueOperation finishedOp](self, "finishedOp"));
  -[CKKSGroupOperation dependOnBeforeGroupFinished:](self, "dependOnBeforeGroupFinished:", v6);

  *(_QWORD *)buf = 0xAAAAAAAAAAAAAAAALL;
  objc_initWeak((id *)buf, self);
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[OTLeaveCliqueOperation deps](self, "deps"));
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "cuttlefishXPCWrapper"));
  v9 = (void *)objc_claimAutoreleasedReturnValue(-[OTLeaveCliqueOperation deps](self, "deps"));
  ...
  objc_msgSend(v8, "departByDistrustingSelfWithSpecificUser:reply:", v10, v11);
