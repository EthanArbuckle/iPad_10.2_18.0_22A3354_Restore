...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SecDbKeychainSerializedSecretData;
  v3 = -[SecDbKeychainSerializedSecretData description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[SecDbKeychainSerializedSecretData dictionaryRepresentation](self, "dictionaryRepresentation"));
