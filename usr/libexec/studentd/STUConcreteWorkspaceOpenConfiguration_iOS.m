@implementation STUConcreteWorkspaceOpenConfiguration_iOS

- (STUConcreteWorkspaceOpenConfiguration_iOS)init
{
  STUConcreteWorkspaceOpenConfiguration_iOS *v2;
  STUConcreteWorkspaceOpenConfiguration_iOS *v3;
  NSDictionary *environment;
  objc_super v6;

  v6.receiver = self;
  v6.super_class = (Class)STUConcreteWorkspaceOpenConfiguration_iOS;
  v2 = -[STUConcreteWorkspaceOpenConfiguration_iOS init](&v6, "init");
  v3 = v2;
  if (v2)
  {
