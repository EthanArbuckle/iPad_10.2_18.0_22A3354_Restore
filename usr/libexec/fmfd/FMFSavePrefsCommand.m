...
{
  id v6;
  FMFSavePrefsCommand *v7;
  FMFSavePrefsCommand *v8;
  objc_super v10;
  ...
  if (v6 && v7)
  {
    -[FMFSavePrefsCommand setActiveDevice:](v7, "setActiveDevice:", v6);
  }
  else
  {
...
- (id)jsonBodyDictionary
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)FMFSavePrefsCommand;
  v3 = -[FMFBaseCmd jsonBodyDictionary](&v8, "jsonBodyDictionary");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FMFSavePrefsCommand activeDevice](self, "activeDevice"));
...
- (id)debugDescription
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[FMFSavePrefsCommand activeDevice](self, "activeDevice"));
