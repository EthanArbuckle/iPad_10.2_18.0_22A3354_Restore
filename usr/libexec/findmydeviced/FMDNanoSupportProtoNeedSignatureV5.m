...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)FMDNanoSupportProtoNeedSignatureV5;
  v3 = -[FMDNanoSupportProtoNeedSignatureV5 description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FMDNanoSupportProtoNeedSignatureV5 dictionaryRepresentation](self, "dictionaryRepresentation"));
