...
{
  uint64_t v4;
  FMDBluetoothDiscoveryToken *v5;
  uint64_t v6;
  FMDBluetoothDiscoveryToken *v7;
  unint64_t v8;
  unint64_t v9;
  BOOL v10;

  v5 = (FMDBluetoothDiscoveryToken *)a3;
  if (v5 == self)
  {
    v10 = 1;
  }
  else
  {
    ...
    {
      v7 = v5;
      v8 = -[FMDBluetoothDiscoveryToken hash](self, "hash");
      v9 = -[FMDBluetoothDiscoveryToken hash](v7, "hash");
