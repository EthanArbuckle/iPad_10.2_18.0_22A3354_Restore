...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)FMDNanoSupportProtoNeedSignatureV3;
  v3 = -[FMDNanoSupportProtoNeedSignatureV3 description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FMDNanoSupportProtoNeedSignatureV3 dictionaryRepresentation](self, "dictionaryRepresentation"));
