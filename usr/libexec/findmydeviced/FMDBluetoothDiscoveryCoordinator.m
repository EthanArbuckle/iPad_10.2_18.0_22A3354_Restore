...
- (void)scanningTimerFired
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    sub_10022BE0C(v4, v5, v6, v7, v8, v9, v10, v11);
...
- (void)updateDisccovery
{
  ...
  if (v4)
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "sortedArrayUsingComparator:", &stru_1002C4860));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
      sub_10022BE40(v24, v25, v26, v27, v28, v29, v30, v31);
