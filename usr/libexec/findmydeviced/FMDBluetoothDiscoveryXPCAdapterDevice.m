...
- (FMDBluetoothDiscoveryXPCAdapterDevice)initWithCoder:(id)a3
{
  id v4;
  uint64_t v5;
  FMDBluetoothDiscoveryXPCAdapterDevice *v6;
  id v7;
  void *v8;
  uint64_t v9;
  uint64_t v10;
  ...
  v4 = a3;
  v28.receiver = self;
  v28.super_class = (Class)FMDBluetoothDiscoveryXPCAdapterDevice;
  v6 = -[FMDBluetoothDiscoveryXPCAdapterDevice init](&v28, "init");
  if (v6)
  {
    v7 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSUUID, v5), CFSTR("identifier"));
    v8 = (void *)objc_claimAutoreleasedReturnValue(v7);
    -[FMDBluetoothDiscoveryXPCAdapterDevice setIdentifier:](v6, "setIdentifier:", v8);
    ...
    v18 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v10, v12, v14, v16, objc_opt_class(NSNumber, v17), 0);
    v19 = (void *)objc_claimAutoreleasedReturnValue(v18);
    v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v19, CFSTR("advertisementFields")));
    -[FMDBluetoothDiscoveryXPCAdapterDevice setAdvertisementFields:](v6, "setAdvertisementFields:", v20);

    v22 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v21), CFSTR("name"));
    v23 = (void *)objc_claimAutoreleasedReturnValue(v22);
    -[FMDBluetoothDiscoveryXPCAdapterDevice setName:](v6, "setName:", v23);

    -[FMDBluetoothDiscoveryXPCAdapterDevice setRssi:](v6, "setRssi:", objc_msgSend(v4, "decodeIntegerForKey:", CFSTR("rssi")));
    v25 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSData, v24), CFSTR("bluetoothAddress"));
    v26 = (void *)objc_claimAutoreleasedReturnValue(v25);
    -[FMDBluetoothDiscoveryXPCAdapterDevice setBluetoothAddress:](v6, "setBluetoothAddress:", v26);
