...
- (FMDMagSafeAccessory)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v37.receiver = self;
  v37.super_class = (Class)FMDMagSafeAccessory;
  v6 = -[FMDMagSafeAccessory init](&v37, "init");
  if (v6)
  {
    v7 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v5), CFSTR("accessoryIdentifier"));
    v8 = (void *)objc_claimAutoreleasedReturnValue(v7);
    -[FMDMagSafeAccessory setAccessoryIdentifier:](v6, "setAccessoryIdentifier:", v8);

    v10 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v9), CFSTR("accessoryType"));
    v11 = (void *)objc_claimAutoreleasedReturnValue(v10);
    -[FMDMagSafeAccessory setAccessoryType:](v6, "setAccessoryType:", v11);

    v13 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v12), CFSTR("firmwareVersion"));
    v14 = (void *)objc_claimAutoreleasedReturnValue(v13);
    -[FMDMagSafeAccessory setFirmwareVersion:](v6, "setFirmwareVersion:", v14);

    v16 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v15), CFSTR("name"));
    v17 = (void *)objc_claimAutoreleasedReturnValue(v16);
    -[FMDMagSafeAccessory setName:](v6, "setName:", v17);

    v19 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v18), CFSTR("style"));
    v20 = (void *)objc_claimAutoreleasedReturnValue(v19);
    -[FMDMagSafeAccessory setStyle:](v6, "setStyle:", v20);

    v22 = objc_opt_class(NSString, v21);
    v24 = objc_opt_class(NSNumber, v23);
    v26 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v22, v24, objc_opt_class(NSDictionary, v25), 0);
    v27 = (void *)objc_claimAutoreleasedReturnValue(v26);
    v28 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v27, CFSTR("serialNumbers")));
    -[FMDMagSafeAccessory setSerialNumbers:](v6, "setSerialNumbers:", v28);

    v29 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "decodeObjectOfClasses:forKey:", v27, CFSTR("additionalInfo")));
    -[FMDMagSafeAccessory setAdditionalInfo:](v6, "setAdditionalInfo:", v29);

    v31 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v30), CFSTR("deviceDiscoveryId"));
    v32 = (void *)objc_claimAutoreleasedReturnValue(v31);
    -[FMDMagSafeAccessory setDeviceDiscoveryId:](v6, "setDeviceDiscoveryId:", v32);

    -[FMDMagSafeAccessory setFindMyEnabled:](v6, "setFindMyEnabled:", objc_msgSend(v4, "decodeBoolForKey:", CFSTR("findMyEnabled")));
    v34 = objc_msgSend(v4, "decodeObjectOfClass:forKey:", objc_opt_class(NSString, v33), CFSTR("lastLostModeKeyRollTime"));
    v35 = (void *)objc_claimAutoreleasedReturnValue(v34);
    -[FMDMagSafeAccessory setLastLostModeKeyRollTime:](v6, "setLastLostModeKeyRollTime:", v35);
