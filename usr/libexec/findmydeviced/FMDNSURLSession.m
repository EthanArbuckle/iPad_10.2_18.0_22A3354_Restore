...
- (id)dataTaskWithRequest:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[FMDNSURLSession session](self, "session"));
...
- (id)dataTaskWithRequest:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FMDNSURLSession session](self, "session"));
...
- (void)getAllTasksWithCompletionHandler:(id)a3
{
  ...
  v4 = a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[FMDNSURLSession session](self, "session"));
...
- (void)finishTasksAndInvalidate
{
  ...
  v2 = (id)objc_claimAutoreleasedReturnValue(-[FMDNSURLSession session](self, "session"));
  objc_msgSend(v2, "finishTasksAndInvalidate");
...
- (void)URLSession:(id)a3 didBecomeInvalidWithError:(id)a4
{
  ...
  v6 = a4;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FMDNSURLSession delegate](self, "delegate"));
...
- (void)URLSession:(id)a3 didReceiveChallenge:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v7 = a5;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[FMDNSURLSession delegate](self, "delegate"));
...
{
  return (FMDURLSessionDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
