...
+ (void)fetchProcessRecords
{
  ...
  if (qword_10005F998 != -1)
    dispatch_once(&qword_10005F998, &stru_10004CF08);
  v34 = 0;
  v35 = 0;
  v36 = 0;
  ...
  else
  {
    ...
    if ((_DWORD)v36)
    {
      ...
      do
      {
        ...
        v13 = sub_1000274A0(*(_QWORD *)&v10[v8 + 4]);
        v14 = sub_1000274A0(*(_QWORD *)&v10[v8 + 12]);
        ...
        objc_msgSend((id)qword_10005F9A0, "insert:", v16);
    ...
    for (i = 0; i < (unint64_t)objc_msgSend((id)qword_10005F9A0, "count"); ++i)
    {
      v19 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10005F9A0, "objectAtIndex:", i));
      v20 = objc_msgSend(v19, "exitTimestamp");

      v21 = (void *)objc_claimAutoreleasedReturnValue(+[HTPrefs sharedPrefs](HTPrefs, "sharedPrefs"));
      v22 = v17 - (_QWORD)v20;
      LODWORD(v20) = sub_1000274A0((unint64_t)objc_msgSend(v21, "runloopHangTimeoutDurationMSec") + 30000) < (double)(v17 - (unint64_t)v20);
      ...
      if ((_DWORD)v20)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          v28 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10005F9A0, "getDescription:", i));
    ...
    objc_msgSend((id)qword_10005F9A0, "removeObjectsAtIndexes:", v4);
    v29 = (void *)os_transaction_create("com.apple.hangreporter.launch-exit-records");
    objc_msgSend((id)qword_10005F9A0, "setTransaction:", v29);
    ...
    v32 = objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10005F9A0, "timer"));
...
+ (id)getProcessExitsAndLaunchesDuringHang:(unint64_t)a3 endTime:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218240;
    v56 = sub_1000273EC(a3);
    v57 = 2048;
    v58 = sub_1000273EC(a4);
  ...
  if (objc_msgSend((id)qword_10005F9A0, "count"))
  {
    v6 = 0;
    v7 = 1;
    do
    {
      v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10005F9A0, "objectAtIndex:", v6));
      ...
      v48 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10005F9A0, "dateFormatter"));
      v9 = sub_100019F18((uint64_t)objc_msgSend(v8, "spawnTimestamp"), v41, v39);
      ...
      v45 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10005F9A0, "dateFormatter"));
      v10 = sub_100019F18((uint64_t)objc_msgSend(v8, "exitTimestamp"), v41, v39);
      ...
      if ((unint64_t)v11 <= a3)
        ...
        v14 = CFSTR("%.3lfs");
      v15 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v14, sub_100027440(v13));
      ...
      if ((unint64_t)v17 <= a3)
        ...
        v20 = CFSTR("%.3lfs");
      v21 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v20, sub_100027440(v19));
      v22 = (void *)objc_claimAutoreleasedReturnValue(v21);
      v54[5] = v22;
      v53[6] = CFSTR("processUptime");
      v23 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%.3lfs"), sub_100027440((_BYTE *)objc_msgSend(v8, "exitTimestamp") - (_BYTE *)objc_msgSend(v8, "spawnTimestamp")));
      v24 = (void *)objc_claimAutoreleasedReturnValue(v23);
      v54[6] = v24;
      v53[7] = CFSTR("exitReasonCode");
      v25 = sub_1000270F0((int)objc_msgSend(v8, "exitReasonNamespace"), (uint64_t)objc_msgSend(v8, "exitReasonCode"));
      v26 = (void *)objc_claimAutoreleasedReturnValue(v25);
      v54[7] = v26;
      v53[8] = CFSTR("exitReasonNamespace");
      v27 = sub_10002627C(objc_msgSend(v8, "exitReasonNamespace"));
    ...
    while ((unint64_t)objc_msgSend((id)qword_10005F9A0, "count") > v7++);
  }
...
{
  return sub_1000273EC(a3 - self->_requestedToRenderTimestamp) < 200.0;
}
