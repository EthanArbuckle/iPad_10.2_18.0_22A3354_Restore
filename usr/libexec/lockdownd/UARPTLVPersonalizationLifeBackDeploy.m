...
{
  UARPTLVPersonalizationLifeBackDeploy *v4;
...
- (id)description
{
  ...
  v3 = +[UARPTLVPersonalizationLifeBackDeploy metaDataTableEntry](UARPTLVPersonalizationLifeBackDeploy, "metaDataTableEntry");
...
- (id)generateTLV
{
  ...
  v3 = +[UARPTLVPersonalizationLifeBackDeploy tlvType](UARPTLVPersonalizationLifeBackDeploy, "tlvType");
  v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v6.receiver = self;
  v6.super_class = (Class)UARPTLVPersonalizationLifeBackDeploy;
...
- (id)tlvValue
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)UARPTLVPersonalizationLifeBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v6[0] = CFSTR("Personalization Life");
  v5[0] = CFSTR("Name");
  v5[1] = CFSTR("Value");
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationLifeBackDeploy tlvType](UARPTLVPersonalizationLifeBackDeploy, "tlvType"));
  v6[1] = v2;
...
+ (id)tlvFromPropertyListValue:(id)a3
{
  ...
  uint64_t v4;
  id v5;
  UARPTLVPersonalizationLifeBackDeploy *v6;
  id v7;
  ...
  {
    v5 = v3;
    v6 = objc_opt_new(UARPTLVPersonalizationLifeBackDeploy);
    v7 = objc_msgSend(v5, "unsignedCharValue");

    -[UARPTLVPersonalizationLifeBackDeploy setLife:](v6, "setLife:", v7);
  }
  else
  {
    v6 = 0;
...
{
  UARPTLVPersonalizationLifeBackDeploy *v5;

  if (a3 == 1)
  {
    v5 = objc_opt_new(UARPTLVPersonalizationLifeBackDeploy);
    -[UARPTLVPersonalizationLifeBackDeploy setLife:](v5, "setLife:", *(unsigned __int8 *)a4);
  }
  else
  {
    v5 = 0;
