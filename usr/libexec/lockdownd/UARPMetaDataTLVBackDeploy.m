    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (!objc_msgSend(v5, "caseInsensitiveCompare:", v13))
        {
          ...
          {
            v16 = -[__objc2_class tlvFromPropertyListValue:](*off_1001827F0[v15], "tlvFromPropertyListValue:", v19);
            v17 = v9;
            v9 = v16;
...
+ (id)metaDataTable
{
  if (qword_1001A8278 != -1)
    dispatch_once(&qword_1001A8278, &stru_1001827D0);
  return (id)qword_1001A8270;
}
