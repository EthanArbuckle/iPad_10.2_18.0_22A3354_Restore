...
{
  return -[TransparencyGPBUInt64ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt64ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt64ObjectDictionary *v8;
  const void *v9;
  uint64_t v10;
  objc_super v12;
  ...
  v8 = -[TransparencyGPBUInt64ObjectDictionary init](&v12, "init");
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          v10 = *a4++;
          -[NSMutableDictionary setObject:forKey:](v8->_dictionary, "setObject:forKey:", v9, +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", v10));
          ++a3;
          --a5;
        }
        while (a5);
...
{
  TransparencyGPBUInt64ObjectDictionary *v4;
  TransparencyGPBUInt64ObjectDictionary *v5;

  v4 = -[TransparencyGPBUInt64ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBUInt64ObjectDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt64ObjectDictionary initWithDictionary:](+[TransparencyGPBUInt64ObjectDictionary allocWithZone:](TransparencyGPBUInt64ObjectDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt64ObjectDictionary, a2);
...
- (void)enumerateKeysAndObjectsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, objc_msgSend(v6, "unsignedLongLongValue"), -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), &v7);
  }
  while (!v7);
}
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  ...
  v5 = objc_alloc_init(TransparencyGPBUInt64ObjectDictionary);
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_1000A50EC((unint64_t)objc_msgSend(v11, "unsignedLongLongValue"), 1, v8);
        v15 = &sub_1000A362C(v13, v7)[v14];
        v12 += (uint64_t)&v15[sub_10009F23C(v15)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v16 = sub_1000A50EC((unint64_t)v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A362C(v14, v7) + v16);
      if (v8 == 4)
      {
      ...
      sub_1000A375C(a3, (const char *)v14, v7);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", a3->var2, +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a4->var2));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10010BA90;
  v3[4] = a3;
  -[TransparencyGPBUInt64ObjectDictionary enumerateKeysAndObjectsUsingBlock:](self, "enumerateKeysAndObjectsUsingBlock:", v3);
}

- (id)objectForKey:(unint64_t)a3
{
  return -[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a3));
}
...
- (void)setObject:(id)a3 forKey:(unint64_t)a4
{
  ...
  if (!a3)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("Attempting to add nil object to a Dictionary"));
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", a3, +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000BF10C(autocreator, (uint64_t)self);
}
