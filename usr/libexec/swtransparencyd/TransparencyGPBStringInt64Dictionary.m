...
{
  return -[TransparencyGPBStringInt64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBStringInt64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TransparencyGPBStringInt64Dictionary *v8;
...
{
  TransparencyGPBStringInt64Dictionary *v4;
  TransparencyGPBStringInt64Dictionary *v5;

  v4 = -[TransparencyGPBStringInt64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBStringInt64Dictionary initWithDictionary:](+[TransparencyGPBStringInt64Dictionary allocWithZone:](TransparencyGPBStringInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBStringInt64Dictionary, a2);
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v14 = &v13[sub_1000A5908((unint64_t)objc_msgSend(v12, "longLongValue"), 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A5908((unint64_t)v14, 2, v7) + v15);
      objc_msgSend(a3, "writeString:value:", 1, v12);
      sub_1000A5AA4(a3, (uint64_t)v14, 2, v7);
