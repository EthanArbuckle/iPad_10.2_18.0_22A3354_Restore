...
+ (id)descriptor
{
  ...
  v2 = (id)qword_1001313F8;
  if (!qword_1001313F8)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", TransparencyGPBAny, CFSTR("Any"), off_10012A398, &off_10012A358, 2, 24, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_1000DFAB0);
    qword_1001313F8 = (uint64_t)v2;
  }
  return v2;
}
