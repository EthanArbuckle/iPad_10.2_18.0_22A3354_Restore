...
{
  return -[TransparencyGPBUInt32ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt32ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt32ObjectDictionary *v8;
  const void *v9;
  unsigned int v10;
  objc_super v12;
...
{
  TransparencyGPBUInt32ObjectDictionary *v4;
  TransparencyGPBUInt32ObjectDictionary *v5;

  v4 = -[TransparencyGPBUInt32ObjectDictionary initWithObjects:forKeys:count:](self, "initWithObjects:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt32ObjectDictionary initWithDictionary:](+[TransparencyGPBUInt32ObjectDictionary allocWithZone:](TransparencyGPBUInt32ObjectDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt32ObjectDictionary, a2);
