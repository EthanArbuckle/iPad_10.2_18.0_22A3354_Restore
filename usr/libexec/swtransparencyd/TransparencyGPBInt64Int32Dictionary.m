...
{
  return -[TransparencyGPBInt64Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt64Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt64Int32Dictionary *v8;
...
{
  TransparencyGPBInt64Int32Dictionary *v4;
  TransparencyGPBInt64Int32Dictionary *v5;

  v4 = -[TransparencyGPBInt64Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBInt64Int32Dictionary initWithDictionary:](+[TransparencyGPBInt64Int32Dictionary allocWithZone:](TransparencyGPBInt64Int32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt64Int32Dictionary, a2);
