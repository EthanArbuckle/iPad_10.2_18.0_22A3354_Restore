...
+ (id)descriptor
{
  ...
  result = (id)qword_100131358;
  if (!qword_100131358)
  {
    LODWORD(v3) = 28;
    result = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", TransparencyGPBTimestamp, CFSTR("Timestamp"), off_100129EB0, &off_100129E70, 2, 16, v3);
    qword_100131358 = (uint64_t)result;
  }
  return result;
}
