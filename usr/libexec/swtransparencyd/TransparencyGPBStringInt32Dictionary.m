...
{
  return -[TransparencyGPBStringInt32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBStringInt32Dictionary)initWithInt32s:(const int *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TransparencyGPBStringInt32Dictionary *v8;
...
{
  TransparencyGPBStringInt32Dictionary *v4;
  TransparencyGPBStringInt32Dictionary *v5;

  v4 = -[TransparencyGPBStringInt32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBStringInt32Dictionary initWithDictionary:](+[TransparencyGPBStringInt32Dictionary allocWithZone:](TransparencyGPBStringInt32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBStringInt32Dictionary, a2);
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v14 = &v13[sub_1000A48A8(objc_msgSend(v12, "intValue"), 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A48A8(v14, 2, v7) + v15);
      objc_msgSend(a3, "writeString:value:", 1, v12);
      sub_1000A4A44(a3, (uint64_t)v14, 2, v7);
