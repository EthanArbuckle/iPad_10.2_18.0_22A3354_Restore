...
- (int)readTag
{
  return sub_10009CE54((uint64_t)&self->state_);
}

- (void)checkLastTagWas:(int)a3
{
  if (self->state_.lastTag != a3)
    sub_10009CF08(-103, CFSTR("Unexpected tag read"));
}
...
- (BOOL)skipField:(int)a3
{
  ...
  {
    case 0:
      sub_10009CCF0((uint64_t *)&self->state_);
      goto LABEL_9;
    case 1:
      sub_10009D08C(&self->state_.bytes, 8);
      v7 = self->state_.bufferPos + 8;
      goto LABEL_8;
    case 2:
      v8 = sub_10009CCF0((uint64_t *)&self->state_);
      sub_10009D08C(&self->state_.bytes, v8);
      v7 = self->state_.bufferPos + v8;
      goto LABEL_8;
    case 3:
      -[TransparencyGPBCodedInputStream skipMessage](self, "skipMessage");
      v9 = sub_1000CC23C(a3);
      if (self->state_.lastTag != sub_1000CC22C(v9, 4))
        sub_10009CF08(-103, CFSTR("Unexpected tag read"));
      goto LABEL_9;
    case 5:
      sub_10009D08C(&self->state_.bytes, 4);
...
- (void)skipMessage
{
  ...
  p_state = &self->state_;
  do
    v4 = sub_10009CE54((uint64_t)p_state);
...
{
  return sub_10009CCF0((uint64_t *)&self->state_);
}
...
- (BOOL)readBool
{
  return sub_10009CCF0((uint64_t *)&self->state_) != 0;
}

- (id)readString
{
  return (id)(id)sub_10009CFFC((uint64_t *)&self->state_);
}
...
- (void)readGroup:(int)a3 message:(id)a4 extensionRegistry:(id)a5
{
  ...
  if (self->state_.lastTag != sub_1000CC22C(a3, 4))
    sub_10009CF08(-103, CFSTR("Unexpected tag read"));
...
- (void)readMapEntry:(id)a3 extensionRegistry:(id)a4 field:(id)a5 parentMessage:(id)a6
{
  ...
  ++self->state_.recursionDepth;
  sub_1000A37E0(a3, (uint64_t *)self, (uint64_t)a4, a5, a6);
  if (self->state_.lastTag)
    sub_10009CF08(-103, CFSTR("Unexpected tag read"));
  --self->state_.recursionDepth;
  self->state_.currentLimit = currentLimit;
...
- (id)readBytes
{
  return sub_10009D0E8((uint64_t *)&self->state_);
}
...
- (int)readSInt32
{
  ...
  v2 = sub_10009CCF0((uint64_t *)&self->state_);
  return -(v2 & 1) ^ (v2 >> 1);
}
