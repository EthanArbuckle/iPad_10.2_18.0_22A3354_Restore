...
+ (BOOL)setProtectionToClassDForURL:(id)a3 error:(id *)a4
{
  ...
  if (v6)
  {
    if (fcntl(v6, 64, 4) < 0)
    {
      ...
      if (qword_10012A800 != -1)
        dispatch_once(&qword_10012A800, &stru_100106820);
      v12 = (void *)qword_10012A808;
      if (os_log_type_enabled((os_log_t)qword_10012A808, OS_LOG_TYPE_ERROR))
      {
        v13 = v12;
        v14 = __error();
        v15 = strerror(*v14);
  ...
  else
  {
    ...
    if (qword_10012A800 != -1)
      dispatch_once(&qword_10012A800, &stru_100106840);
    v21 = (void *)qword_10012A808;
    if (os_log_type_enabled((os_log_t)qword_10012A808, OS_LOG_TYPE_ERROR))
    {
      v22 = v21;
      v23 = __error();
...
+ (id)applicationSupportPath:(id *)a3
{
  ...
  else
  {
    ...
    if (qword_10012A800 != -1)
      dispatch_once(&qword_10012A800, &stru_100106860);
    v12 = qword_10012A808;
    if (os_log_type_enabled((os_log_t)qword_10012A808, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)v14 = 0;
