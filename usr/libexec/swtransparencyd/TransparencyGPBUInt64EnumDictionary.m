...
{
  return -[TransparencyGPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", 0, 0, 0, 0);
}

- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TransparencyGPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", a3, 0, 0, 0);
}
...
{
  TransparencyGPBUInt64EnumDictionary *v10;
  ...
  v10 = -[TransparencyGPBUInt64EnumDictionary init](&v18, "init");
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v15, +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", v16));
        --a6;
      }
      while (a6);
    }
...
{
  TransparencyGPBUInt64EnumDictionary *v4;
  TransparencyGPBUInt64EnumDictionary *v5;

  v4 = -[TransparencyGPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", objc_msgSend(a3, "validationFunc"), 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBUInt64EnumDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt64EnumDictionary initWithDictionary:](+[TransparencyGPBUInt64EnumDictionary allocWithZone:](TransparencyGPBUInt64EnumDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt64EnumDictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A0B48(2, v15) + v13);
      if (v7 == 4)
      {
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  if (v5 == 4)
  {
    -[TransparencyGPBCodedOutputStream writeFixed64:value:](v10, "writeFixed64:value:", 1, var2);
  }
  else if (v5 == 12)
  {
    -[TransparencyGPBCodedOutputStream writeUInt64:value:](v10, "writeUInt64:value:", 1, var2);
  }
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10010B9A0;
  v3[4] = a3;
  -[TransparencyGPBUInt64EnumDictionary enumerateKeysAndRawValuesUsingBlock:](self, "enumerateKeysAndRawValuesUsingBlock:", v3);
}
...
- (BOOL)getEnum:(int *)a3 forKey:(unint64_t)a4
{
  ...
  v6 = -[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a4));
  v7 = v6;
  if (a3 && v6)
  {
...
- (void)enumerateKeysAndEnumsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v8, "unsignedLongLongValue"), v9, &v10);
  }
  while (!v10);
}
...
- (void)setEnum:(int)a3 forKey:(unint64_t)a4
{
  ...
  if ((((uint64_t (*)(_QWORD, SEL))self->_validationFunc)(*(_QWORD *)&a3, a2) & 1) == 0)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("TransparencyGPBUInt64EnumDictionary: Attempt to set an unknown enum value (%d)"), v5);
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", v5), +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000BF10C(autocreator, (uint64_t)self);
}
