...
- (TransparencyGPBFieldDescriptor)initWithFieldDescription:(void *)a3 descriptorFlags:(unsigned int)a4
{
  ...
  v7->setSel_ = sub_1000A21FC("set", *((char **)a3 + (v4 & 1)), 0, 1);
  var6 = v8->var6;
  v10 = v7->description_->var5 & 0xF02;
  if ((v7->description_->var5 & 0xF02) != 0)
  {
    v11 = sub_1000A21FC(0, *((char **)a3 + (v4 & 1)), "_Count", 0);
    v12 = 40;
LABEL_7:
  ...
  {
    v7->hasOrCountSel_ = sub_1000A21FC("has", *((char **)a3 + (v4 & 1)), 0, 0);
    v11 = sub_1000A21FC("setHas", *((char **)a3 + (v4 & 1)), 0, 1);
    v12 = 48;
    goto LABEL_7;
  }
LABEL_8:
...
- ($F1D6BA5D2F21EF5031E32B57B9859B92)defaultValue
{
  int64_t valueInt64;
  TransparencyGPBMessageFieldDescription *description;
  int var6;
  ...
  if ((description->var5 & 2) == 0)
  {
    ...
    {
      return ($F1D6BA5D2F21EF5031E32B57B9859B92)sub_1000C8AFC();
    }
    else
    {
      if (valueInt64)
        ...
        v7 = var6 == 14;
      if (v7)
        return ($F1D6BA5D2F21EF5031E32B57B9859B92)&stru_10010E2C8;
    }
  }
  return ($F1D6BA5D2F21EF5031E32B57B9859B92)valueInt64;
}
...
- (id)textFormatName
{
  ...
  {
    AssociatedObject = objc_getAssociatedObject(self, &unk_1000DF609);
    if (AssociatedObject)
      return sub_1000CB074((char *)objc_msgSend(AssociatedObject, "pointerValue"), self->description_->var2, -[TransparencyGPBFieldDescriptor name](self, "name"));
    return 0;
  }
  else
  {
