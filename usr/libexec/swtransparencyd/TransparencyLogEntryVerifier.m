...
- (BOOL)verifyInclusionOfLogLeaf:(id)a3 position:(unint64_t)a4 treeSize:(unint64_t)a5 treeHead:(id)a6 hashPath:(id)a7 error:(id *)a8
{
  ...
  if (a4 >= a5)
  {
    ...
    if (qword_10012A700 != -1)
      dispatch_once(&qword_10012A700, &stru_100105C50);
    v30 = qword_10012A708;
    if (os_log_type_enabled((os_log_t)qword_10012A708, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
...
LABEL_28:
    ...
    if (qword_10012A700 != -1)
      dispatch_once(&qword_10012A700, &stru_100105C70);
    v15 = v44;
    v35 = (void *)qword_10012A708;
    if (os_log_type_enabled((os_log_t)qword_10012A708, OS_LOG_TYPE_ERROR))
    {
      v36 = v35;
...
- (unint64_t)verifyLogEntryWithLogLeaf:(id)a3 position:(unint64_t)a4 hashesToRoot:(id)a5 signedLogHead:(id)a6 error:(id *)a7
{
  ...
  if (v15 == 1)
  {
    ...
    else
    {
      ...
      if (qword_10012A700 != -1)
        dispatch_once(&qword_10012A700, &stru_100105C90);
      v21 = qword_10012A708;
      if (os_log_type_enabled((os_log_t)qword_10012A708, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)v23 = 0;
