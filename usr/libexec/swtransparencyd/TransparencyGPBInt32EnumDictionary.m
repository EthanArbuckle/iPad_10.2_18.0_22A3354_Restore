...
{
  return -[TransparencyGPBInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", 0, 0, 0, 0);
}

- (TransparencyGPBInt32EnumDictionary)initWithValidationFunction:(void *)a3
{
  return -[TransparencyGPBInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", a3, 0, 0, 0);
}
...
{
  TransparencyGPBInt32EnumDictionary *v10;
  ...
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v15, +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", v16));
        --a6;
      }
      while (a6);
    }
...
{
  TransparencyGPBInt32EnumDictionary *v4;
  TransparencyGPBInt32EnumDictionary *v5;

  v4 = -[TransparencyGPBInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", objc_msgSend(a3, "validationFunc"), 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBInt32EnumDictionary initWithDictionary:](+[TransparencyGPBInt32EnumDictionary allocWithZone:](TransparencyGPBInt32EnumDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32EnumDictionary, a2);
...
- (void)enumerateKeysAndRawValuesUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, objc_msgSend(v6, "intValue"), objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "intValue"), &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v13 = sub_1000A48A8(objc_msgSend(v10, "intValue"), 1, v7);
        v14 = sub_1000A0B48(2, objc_msgSend(v12, "intValue")) + v13;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v16 = sub_1000A48A8(v14, 1, v7);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A0B48(2, v15) + v16);
      sub_1000A4A44(a3, (uint64_t)v14, 1, v7);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  v5 = a5;
  v7 = *(_QWORD *)&a3;
  v8 = sub_1000A48A8(a4->var1, 1, a5);
  v9 = +[NSMutableData dataWithLength:](NSMutableData, "dataWithLength:", sub_1000A0B48(2, v7) + v8);
  v10 = -[TransparencyGPBCodedOutputStream initWithData:]([TransparencyGPBCodedOutputStream alloc], "initWithData:", v9);
  sub_1000A4A44(v10, a4->var3, 1, v5);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", a3->var3), +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", a4->var3));
}
...
- (BOOL)getEnum:(int *)a3 forKey:(int)a4
{
  ...
  v6 = -[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", *(_QWORD *)&a4));
  v7 = v6;
  if (a3 && v6)
  {
...
- (void)enumerateKeysAndEnumsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, uint64_t, char *))a3 + 2))(a3, objc_msgSend(v8, "intValue"), v9, &v10);
  }
  while (!v10);
}
...
- (void)setRawValue:(int)a3 forKey:(int)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", *(_QWORD *)&a3), +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", *(_QWORD *)&a4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000BF10C(autocreator, (uint64_t)self);
}
...
- (void)setEnum:(int)a3 forKey:(int)a4
{
  ...
  if ((((uint64_t (*)(_QWORD, SEL))self->_validationFunc)(*(_QWORD *)&a3, a2) & 1) == 0)
    +[NSException raise:format:](NSException, "raise:format:", NSInvalidArgumentException, CFSTR("TransparencyGPBInt32EnumDictionary: Attempt to set an unknown enum value (%d)"), v5);
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", v5), +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", v4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000BF10C(autocreator, (uint64_t)self);
}
