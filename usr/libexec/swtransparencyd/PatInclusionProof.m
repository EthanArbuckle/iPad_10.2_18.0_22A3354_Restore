...
LABEL_32:
        ...
        if (qword_10012A5D0 != -1)
          dispatch_once(&qword_10012A5D0, &stru_100105A08);
        v21 = qword_10012A5D8;
        if (!os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
        {
LABEL_31:
          v18 = 0;
          goto LABEL_32;
      ...
      else
      {
        ...
        if (qword_10012A5D0 != -1)
          dispatch_once(&qword_10012A5D0, &stru_1001059E8);
        v25 = qword_10012A5D8;
        if (!os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
          goto LABEL_31;
        if (a3)
  ...
  if (qword_10012A5D0 != -1)
    dispatch_once(&qword_10012A5D0, &stru_1001059C8);
  v19 = qword_10012A5D8;
  if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
  {
    *(_WORD *)buf = 0;
...
LABEL_27:
      ...
      else
      {
        if (a3)
          *a3 = (id)objc_claimAutoreleasedReturnValue(+[TransparencyError errorWithDomain:code:underlyingError:description:](TransparencyError, "errorWithDomain:code:underlyingError:description:", kTransparencyErrorDecode, -165, *a3));
        if (qword_10012A5D0 != -1)
          dispatch_once(&qword_10012A5D0, &stru_100105A48);
        v18 = qword_10012A5D8;
        if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
        {
          if (a3)
  ...
  if (qword_10012A5D0 != -1)
    dispatch_once(&qword_10012A5D0, &stru_100105A28);
  v16 = qword_10012A5D8;
  if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
  {
    *(_WORD *)buf = 0;
...
- (int)earliestNextTreeVersionWithError:(id *)a3
{
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (qword_10012A5D0 != -1)
          dispatch_once(&qword_10012A5D0, &stru_100105A88);
        v16 = qword_10012A5D8;
        if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
        {
          if (a3)
  ...
  if (qword_10012A5D0 != -1)
    dispatch_once(&qword_10012A5D0, &stru_100105A68);
  v15 = qword_10012A5D8;
  if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
  {
    *(_WORD *)buf = 0;
...
- (unint64_t)shutdownTimeStamp:(id *)a3
{
    ...
    if (v10)
    {
      ...
      else
      {
        if (a3)
          *a3 = (id)objc_claimAutoreleasedReturnValue(+[TransparencyError errorWithDomain:code:underlyingError:description:](TransparencyError, "errorWithDomain:code:underlyingError:description:", kTransparencyErrorDecode, -233, *a3));
        if (qword_10012A5D0 != -1)
          dispatch_once(&qword_10012A5D0, &stru_100105AC8);
        v16 = qword_10012A5D8;
        if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
        {
          if (a3)
  ...
  if (a3)
    *a3 = (id)objc_claimAutoreleasedReturnValue(+[TransparencyError errorWithDomain:code:description:](TransparencyError, "errorWithDomain:code:description:", kTransparencyErrorDecode, -232, CFSTR("KT PAT closed proof missing node bytes")));
  if (qword_10012A5D0 != -1)
    dispatch_once(&qword_10012A5D0, &stru_100105AA8);
  v15 = qword_10012A5D8;
  if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
  {
    *(_WORD *)buf = 0;
...
- (int)earliestCurrentTreeVersionWithError:(id *)a3
{
    ...
    if (v10)
    {
      ...
      else
      {
        if (a3)
          *a3 = (id)objc_claimAutoreleasedReturnValue(+[TransparencyError errorWithDomain:code:underlyingError:description:](TransparencyError, "errorWithDomain:code:underlyingError:description:", kTransparencyErrorDecode, -165, *a3));
        if (qword_10012A5D0 != -1)
          dispatch_once(&qword_10012A5D0, &stru_100105B08);
        v15 = 999999999;
        v17 = qword_10012A5D8;
        if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
        {
  ...
  if (qword_10012A5D0 != -1)
    dispatch_once(&qword_10012A5D0, &stru_100105AE8);
  v15 = 999999999;
  v16 = qword_10012A5D8;
  if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
  {
...
LABEL_8:
  if (qword_10012A5D0 != -1)
    dispatch_once(&qword_10012A5D0, &stru_100105B28);
  v35 = qword_10012A5D8;
  if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
  {
    *(_WORD *)v36 = 0;
...
- (unint64_t)verifyConfigProof:(id *)a3
{
  ...
  if (result == 1)
  {
    ...
    if (v7)
    {
      ...
      if (qword_10012A5D0 != -1)
        dispatch_once(&qword_10012A5D0, &stru_100105B48);
      v19 = (void *)qword_10012A5D8;
      if (os_log_type_enabled((os_log_t)qword_10012A5D8, OS_LOG_TYPE_ERROR))
      {
        v20 = v19;
...
+ (id)descriptor
{
  ...
  v2 = (id)qword_10012A678;
  if (!qword_10012A678)
  {
    LODWORD(v4) = 28;
    v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:](TransparencyGPBDescriptor, "allocDescriptorForClass:messageName:fileDescription:fields:fieldCount:storageSize:flags:", PatInclusionProof, CFSTR("PatInclusionProof"), &unk_1001259B0, &off_100125E68, 2, 24, v4);
    objc_msgSend(v2, "setupExtraTextInfo:", &unk_1000DB3D8);
    qword_10012A678 = (uint64_t)v2;
  }
  return v2;
}
