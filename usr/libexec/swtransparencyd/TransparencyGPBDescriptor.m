...
+ (id)allocDescriptorForClass:(Class)a3 file:(id)a4 fields:(void *)a5 fieldCount:(unsigned int)a6 storageSize:(unsigned int)a7 flags:(unsigned int)a8
{
  ...
  objc_setAssociatedObject(v22, &unk_1000DF608, v12, (void *)1);
  return v22;
}
...
{
  return _objc_msgSend(a1, "allocDescriptorForClass:file:fields:fieldCount:storageSize:flags:", a3, a5, a6, *(_QWORD *)&a7, *(_QWORD *)&a8, a9);
}
      ...
      do
      {
        ...
        do
        {
          ...
          if ((*(_WORD *)(v10[1] + 28) & 0x40) != 0)
            objc_setAssociatedObject(v10, &unk_1000DF609, v4, (void *)1);
          v9 = (char *)v9 + 1;
        }
        while (v7 != v9);
...
{
  objc_setAssociatedObject(self, &unk_1000DF60A, a3, 0);
}

- (void)setupContainingMessageClassName:(const char *)a3
{
  -[TransparencyGPBDescriptor setupContainingMessageClass:](self, "setupContainingMessageClass:", objc_getClass(a3));
}

- (void)setupMessageClassNameSuffix:(id)a3
{
  if (objc_msgSend(a3, "length"))
    objc_setAssociatedObject(self, &unk_1000DF60B, a3, (void *)1);
}
...
- (TransparencyGPBFileDescriptor)file
{
  ...
  AssociatedObject = (TransparencyGPBFileDescriptor *)objc_getAssociatedObject(self, &unk_1000DF608);
  if (!AssociatedObject)
  {
    ...
    AssociatedObject = v6;
    objc_setAssociatedObject(v6, &unk_1000DF608, v6, (void *)1);
  }
  objc_sync_exit(self);
...
{
  return (TransparencyGPBDescriptor *)objc_msgSend(objc_getAssociatedObject(self, &unk_1000DF60A), "descriptor");
}
...
- (NSString)fullName
{
  ...
  if (v4)
  {
    ...
    AssociatedObject = objc_getAssociatedObject(v4, &unk_1000DF60B);
    if (AssociatedObject)
    {
  ...
  v13 = objc_getAssociatedObject(self, &unk_1000DF60B);
  if (!v13)
    goto LABEL_14;
  v14 = v13;
