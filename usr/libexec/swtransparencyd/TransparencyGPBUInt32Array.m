...
{
  return -[TransparencyGPBUInt32Array initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}

- (TransparencyGPBUInt32Array)initWithValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  TransparencyGPBUInt32Array *v6;
  TransparencyGPBUInt32Array *v7;
  unsigned int *v8;
...
{
  TransparencyGPBUInt32Array *v4;
  TransparencyGPBUInt32Array *v5;

  v4 = -[TransparencyGPBUInt32Array initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt32Array initWithValues:count:](+[TransparencyGPBUInt32Array allocWithZone:](TransparencyGPBUInt32Array, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt32Array, a2);
...
{
  -[TransparencyGPBUInt32Array enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(unsigned int)a3
{
  ...
  v3 = a3;
  -[TransparencyGPBUInt32Array addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[TransparencyGPBUInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[TransparencyGPBUInt32Array addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[TransparencyGPBUInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[TransparencyGPBUInt32Array internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
