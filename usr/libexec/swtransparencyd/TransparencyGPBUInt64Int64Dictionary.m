...
{
  return -[TransparencyGPBUInt64Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt64Int64Dictionary *v8;
...
{
  TransparencyGPBUInt64Int64Dictionary *v4;
  TransparencyGPBUInt64Int64Dictionary *v5;

  v4 = -[TransparencyGPBUInt64Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBUInt64Int64Dictionary initWithDictionary:](+[TransparencyGPBUInt64Int64Dictionary allocWithZone:](TransparencyGPBUInt64Int64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt64Int64Dictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A5908((unint64_t)v16, 2, v7) + v14);
      if (v8 == 4)
      {
