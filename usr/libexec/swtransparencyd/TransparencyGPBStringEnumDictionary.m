  ...
  if (result)
  {
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        v13 = &v12[sub_1000A0B48(2, objc_msgSend(v11, "intValue"))];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A0B48(2, v13) + v14);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  ...
  v6 = *(_QWORD *)&a3;
  v7 = sub_1000A0C30(1, a4->var7);
  v8 = +[NSMutableData dataWithLength:](NSMutableData, "dataWithLength:", &v7[sub_1000A0B48(2, v6)]);
