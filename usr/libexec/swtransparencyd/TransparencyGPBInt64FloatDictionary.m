...
{
  return -[TransparencyGPBInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt64FloatDictionary *v8;
  double v9;
  ...
  v8 = -[TransparencyGPBInt64FloatDictionary init](&v15, "init");
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v12, +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", v13));
          --a5;
        }
        while (a5);
      }
...
{
  TransparencyGPBInt64FloatDictionary *v4;
  TransparencyGPBInt64FloatDictionary *v5;

  v4 = -[TransparencyGPBInt64FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBInt64FloatDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64FloatDictionary initWithDictionary:](+[TransparencyGPBInt64FloatDictionary allocWithZone:](TransparencyGPBInt64FloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt64FloatDictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v16 = v15;
      LODWORD(v13) = sub_1000A5908((unint64_t)v14, 1, v7);
...
- (void)setTransparencyGPBGenericValue:(id *)a3 forTransparencyGPBGenericValueKey:(id *)a4
{
  ...
  LODWORD(v4) = a3->var1;
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v4), +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a4->var2));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10010BB80;
  v3[4] = a3;
  -[TransparencyGPBInt64FloatDictionary enumerateKeysAndFloatsUsingBlock:](self, "enumerateKeysAndFloatsUsingBlock:", v3);
}
...
- (void)setFloat:(float)a3 forKey:(int64_t)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:"), +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000BF10C(autocreator, (uint64_t)self);
}
