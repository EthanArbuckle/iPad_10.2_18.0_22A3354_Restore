...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  fields = self->fields_;
  if (fields)
    CFDictionaryApplyFunction(fields, (CFDictionaryApplierFunction)sub_1000C7F00, v4);
  return v4;
}
...
- (id)sortedFields
{
  ...
  if (Count)
  {
    ...
    while (Count != v7);
    qsort_b(&v15 - 2 * Count, Count, 0x10uLL, &stru_10010C070);
    v10 = v6 + 1;
  ...
  {
    qsort_b(v6, 0, 0x10uLL, &stru_10010C070);
  }
...
- (void)writeToCodedOutputStream:(id)a3
{
  ...
  if (fields)
  {
    ...
    else
    {
      ...
      while (Count != v9);
      qsort_b(&v14 - 2 * Count, Count, 0x10uLL, &stru_10010C090);
      v12 = (void **)(v8 + 1);
      do
      {
        v13 = *v12;
...
- (id)description
{
  ...
  -[NSMutableString appendString:](v3, "appendString:", sub_1000CAAA8(self, CFSTR("  ")));
...
- (unint64_t)serializedSize
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction((CFDictionaryRef)result, (CFDictionaryApplierFunction)sub_1000C843C, &context);
    return context;
  }
  return result;
}
...
- (void)writeAsMessageSetTo:(id)a3
{
  ...
  fields = self->fields_;
  if (fields)
    CFDictionaryApplyFunction(fields, (CFDictionaryApplierFunction)sub_1000C8484, a3);
}
...
- (unint64_t)serializedSizeAsMessageSet
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction((CFDictionaryRef)result, (CFDictionaryApplierFunction)sub_1000C84C4, &context);
    return context;
  }
  return result;
}
...
- (void)mergeUnknownFields:(id)a3
{
  ...
  if (a3)
  {
    ...
    if (v4)
      CFDictionaryApplyFunction(v4, (CFDictionaryApplierFunction)sub_1000C86B0, self);
  }
}
...
- (BOOL)mergeFieldFrom:(int)a3 input:(id)a4
{
  ...
  switch(v8)
  {
    case 0:
      v9 = 1;
      objc_msgSend(-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self, "mutableFieldForNumber:create:", v7, 1), "addVarint:", sub_10009CCEC(v10));
      break;
    case 1:
      v9 = 1;
      objc_msgSend(-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self, "mutableFieldForNumber:create:", v7, 1), "addFixed64:", sub_10009CD88(v10));
      break;
    case 2:
      v11 = (TransparencyGPBUnknownFieldSet *)sub_10009D0E8(v10);
      v9 = 1;
...
LABEL_6:
    ...
    case 5:
      v9 = 1;
      objc_msgSend(-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self, "mutableFieldForNumber:create:", v7, 1), "addFixed32:", sub_10009CDC0(v10));
      break;
    default:
      return v9;
  }
...
- (void)mergeFromCodedInputStream:(id)a3
{
  ...
  do
    v5 = sub_10009CE54((uint64_t)a3 + 8);
