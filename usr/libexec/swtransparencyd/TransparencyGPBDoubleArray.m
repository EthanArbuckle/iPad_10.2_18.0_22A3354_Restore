...
{
  return -[TransparencyGPBDoubleArray initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}

- (TransparencyGPBDoubleArray)initWithValues:(const double *)a3 count:(unint64_t)a4
{
  TransparencyGPBDoubleArray *v6;
  TransparencyGPBDoubleArray *v7;
  double *v8;
...
{
  TransparencyGPBDoubleArray *v4;
  TransparencyGPBDoubleArray *v5;

  v4 = -[TransparencyGPBDoubleArray initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBDoubleArray initWithValues:count:](+[TransparencyGPBDoubleArray allocWithZone:](TransparencyGPBDoubleArray, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBDoubleArray, a2);
...
{
  -[TransparencyGPBDoubleArray enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(double)a3
{
  ...
  v3 = a3;
  -[TransparencyGPBDoubleArray addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const double *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[TransparencyGPBDoubleArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[TransparencyGPBDoubleArray addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[TransparencyGPBDoubleArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[TransparencyGPBDoubleArray internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
