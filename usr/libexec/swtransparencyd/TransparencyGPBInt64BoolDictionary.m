...
{
  return -[TransparencyGPBInt64BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt64BoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt64BoolDictionary *v8;
  ...
  v8 = -[TransparencyGPBInt64BoolDictionary init](&v14, "init");
  if (v8)
  {
...
{
  TransparencyGPBInt64BoolDictionary *v4;
  TransparencyGPBInt64BoolDictionary *v5;

  v4 = -[TransparencyGPBInt64BoolDictionary initWithBools:forKeys:count:](self, "initWithBools:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBInt64BoolDictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64BoolDictionary initWithDictionary:](+[TransparencyGPBInt64BoolDictionary allocWithZone:](TransparencyGPBInt64BoolDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt64BoolDictionary, a2);
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v13 = sub_1000A5908((unint64_t)objc_msgSend(v10, "longLongValue"), 1, v7);
        objc_msgSend(v12, "BOOLValue");
        v14 = sub_1000A0BE4(2) + v13;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v16 = sub_1000A5908((unint64_t)v14, 1, v7);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A0BE4(2) + v16);
      sub_1000A5AA4(a3, (uint64_t)v14, 1, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10010BB58;
  v3[4] = a3;
  -[TransparencyGPBInt64BoolDictionary enumerateKeysAndBoolsUsingBlock:](self, "enumerateKeysAndBoolsUsingBlock:", v3);
}
