...
{
  return -[TransparencyGPBStringUInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBStringUInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  TransparencyGPBStringUInt64Dictionary *v8;
...
{
  TransparencyGPBStringUInt64Dictionary *v4;
  TransparencyGPBStringUInt64Dictionary *v5;

  v4 = -[TransparencyGPBStringUInt64Dictionary initWithUInt64s:forKeys:count:](self, "initWithUInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBStringUInt64Dictionary initWithDictionary:](+[TransparencyGPBStringUInt64Dictionary allocWithZone:](TransparencyGPBStringUInt64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBStringUInt64Dictionary, a2);
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v13 = sub_1000A0C30(1, v10);
        v14 = &v13[sub_1000A50EC((unint64_t)objc_msgSend(v12, "unsignedLongLongValue"), 2, v7)];
        v11 += (uint64_t)&v14[sub_10009F23C(v14)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v15 = sub_1000A0C30(1, v12);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A50EC((unint64_t)v14, 2, v7) + v15);
      objc_msgSend(a3, "writeString:value:", 1, v12);
      if (v7 == 4)
      {
        objc_msgSend(a3, "writeFixed64:value:", 2, v14);
      }
      else if (v7 == 12)
      {
        objc_msgSend(a3, "writeUInt64:value:", 2, v14);
      }
