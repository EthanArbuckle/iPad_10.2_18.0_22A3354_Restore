...
+ (__CFString)secKeyAlgorithmForProtoAlgorithm:(int)a3
{
  ...
  if (qword_10012A6F0 != -1)
    dispatch_once(&qword_10012A6F0, &stru_100105BD0);
  v5 = qword_10012A6F8;
  if (os_log_type_enabled((os_log_t)qword_10012A6F8, OS_LOG_TYPE_ERROR))
  {
    v6[0] = 67109120;
    v6[1] = a3;
...
+ (int)protoAlgorithmForSecKeyAlgorithm:(__CFString *)a3
{
  ...
  {
    if (qword_10012A6F0 != -1)
      dispatch_once(&qword_10012A6F0, &stru_100105BF0);
    v5 = qword_10012A6F8;
    if (os_log_type_enabled((os_log_t)qword_10012A6F8, OS_LOG_TYPE_ERROR))
    {
      v7 = 138412290;
...
+ (BOOL)verifyMessage:(id)a3 signature:(id)a4 spkiHash:(id)a5 trustedKeys:(id)a6 algorithm:(__CFString *)a7 error:(id *)a8
{
  ...
  if (a7)
  {
    ...
    if (v18)
    {
      ...
      {
        if (qword_10012A6F0 != -1)
          dispatch_once(&qword_10012A6F0, &stru_100105C30);
        v21 = qword_10012A6F8;
        if (os_log_type_enabled((os_log_t)qword_10012A6F8, OS_LOG_TYPE_ERROR))
        {
...
LABEL_13:
    ...
    else
    {
      ...
      if (qword_10012A6F0 != -1)
        dispatch_once(&qword_10012A6F0, &stru_100105C10);
      v25 = (void *)qword_10012A6F8;
      if (os_log_type_enabled((os_log_t)qword_10012A6F8, OS_LOG_TYPE_ERROR))
      {
        v26 = v25;
