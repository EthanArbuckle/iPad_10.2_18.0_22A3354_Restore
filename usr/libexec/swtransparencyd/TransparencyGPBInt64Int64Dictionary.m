...
{
  return -[TransparencyGPBInt64Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt64Int64Dictionary *v8;
  ...
  v8 = -[TransparencyGPBInt64Int64Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  TransparencyGPBInt64Int64Dictionary *v4;
  TransparencyGPBInt64Int64Dictionary *v5;

  v4 = -[TransparencyGPBInt64Int64Dictionary initWithInt64s:forKeys:count:](self, "initWithInt64s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBInt64Int64Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBInt64Int64Dictionary initWithDictionary:](+[TransparencyGPBInt64Int64Dictionary allocWithZone:](TransparencyGPBInt64Int64Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt64Int64Dictionary, a2);
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    if (!v6)
      break;
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, objc_msgSend(v6, "longLongValue"), objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "longLongValue"), &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = sub_1000A5908((unint64_t)objc_msgSend(v13, "longLongValue"), 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = sub_1000A5908((unint64_t)v15, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A5908((unint64_t)v16, 2, v7) + v17);
      sub_1000A5AA4(a3, (uint64_t)v15, 1, v8);
      sub_1000A5AA4(a3, (uint64_t)v16, 2, v7);
...
{
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a3->var2), +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a4->var2));
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10010BB30;
  v3[4] = a3;
  -[TransparencyGPBInt64Int64Dictionary enumerateKeysAndInt64sUsingBlock:](self, "enumerateKeysAndInt64sUsingBlock:", v3);
}
...
- (void)setInt64:(int64_t)a3 forKey:(int64_t)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a3), +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a4));
  autocreator = self->_autocreator;
  if (autocreator)
    sub_1000BF10C(autocreator, (uint64_t)self);
}
