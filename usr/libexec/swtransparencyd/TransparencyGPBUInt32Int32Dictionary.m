...
{
  return -[TransparencyGPBUInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBUInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  TransparencyGPBUInt32Int32Dictionary *v8;
  ...
  v8 = -[TransparencyGPBUInt32Int32Dictionary init](&v14, "init");
  if (v8)
  {
...
{
  TransparencyGPBUInt32Int32Dictionary *v4;
  TransparencyGPBUInt32Int32Dictionary *v5;

  v4 = -[TransparencyGPBUInt32Int32Dictionary initWithInt32s:forKeys:count:](self, "initWithInt32s:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
- (void)dealloc
{
  ...
  -[TransparencyGPBUInt32Int32Dictionary dealloc](&v3, "dealloc");
}

- (id)copyWithZone:(_NSZone *)a3
{
  return -[TransparencyGPBUInt32Int32Dictionary initWithDictionary:](+[TransparencyGPBUInt32Int32Dictionary allocWithZone:](TransparencyGPBUInt32Int32Dictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBUInt32Int32Dictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      objc_msgSend(a3, "writeInt32NoTag:", sub_1000A48A8(v16, 2, v7) + v14);
      if (v8 == 1)
      {
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10010B720;
  v3[4] = a3;
  -[TransparencyGPBUInt32Int32Dictionary enumerateKeysAndInt32sUsingBlock:](self, "enumerateKeysAndInt32sUsingBlock:", v3);
}
