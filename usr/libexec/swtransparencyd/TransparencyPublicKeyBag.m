...
- (TransparencyPublicKeyBag)initWithPublicKeysResponse:(id)a3 application:(id)a4 settings:(id)a5 allowOldKeys:(BOOL)a6 error:(id *)a7
{
  ...
  else
  {
    ...
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_100105FB8);
    v21 = (void *)qword_10012A790;
    a7 = v15;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      v22 = v21;
    ...
    && (v24 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "patConfigProof")), v24, v24))
  {
      ...
      && (v25 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "tltConfigProof")), v25, v25))
    {
      ...
      if (v26 && (v27 = (void *)v26, v28 = objc_msgSend(v12, "appLeafsArray_Count"), v27, v28))
      {
        ...
        if (qword_10012A788 != -1)
          dispatch_once(&qword_10012A788, &stru_100106038);
        v37 = qword_10012A790;
        if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
        {
          *(_WORD *)buf = 0;
...
LABEL_40:
      ...
      {
        if (qword_10012A788 != -1)
          dispatch_once(&qword_10012A788, &stru_100106018);
        v36 = qword_10012A790;
        if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
        {
          *(_WORD *)buf = 0;
    ...
    {
      if (v13[241] != (char *)-1)
        dispatch_once(&qword_10012A788, &stru_100105FF8);
      v35 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)buf = 0;
  ...
  {
    if (v13[241] != (char *)-1)
      dispatch_once(&qword_10012A788, &stru_100105FD8);
    v34 = qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
...
LABEL_46:
  if ((v33 & 1) == 0)
  {
    ...
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_100106058);
    v62 = (void *)qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      v63 = v62;
      v64 = v81;
...
LABEL_19:
  ...
  if (v25)
  {
    ...
    if (!v27)
    {
      ...
      v14 = v53;
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106098);
      v39 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        if (a7)
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        if (!v32)
        {
          ...
          v14 = v53;
          if (qword_10012A788 != -1)
            dispatch_once(&qword_10012A788, &stru_1001060D8);
          v33 = qword_10012A790;
          if (!os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
            goto LABEL_57;
          if (a7)
...
LABEL_59:
    ...
    v14 = v53;
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_1001060B8);
    v33 = qword_10012A790;
    if (!os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      goto LABEL_57;
    if (a7)
...
LABEL_22:
  ...
  if (qword_10012A788 != -1)
    dispatch_once(&qword_10012A788, &stru_100106078);
  v35 = qword_10012A790;
  if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
  {
...
LABEL_38:
            ...
            if (qword_10012A788 != -1)
              dispatch_once(&qword_10012A788, &stru_1001060F8);
            v48 = qword_10012A790;
            if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_INFO))
            {
              *(_WORD *)buf = 0;
            ...
            {
              if (qword_10012A788 != -1)
                dispatch_once(&qword_10012A788, &stru_100106118);
              v31 = v74;
              v42 = v75;
              v21 = v72;
              v45 = v73;
            ...
            if (v54)
            {
              ...
              if (qword_10012A788 != -1)
                dispatch_once(&qword_10012A788, &stru_100106158);
              v21 = v72;
              v57 = (void *)qword_10012A790;
              if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_INFO))
              {
                v58 = v57;
            ...
            v42 = v75;
            if (qword_10012A788 != -1)
              dispatch_once(&qword_10012A788, &stru_100106138);
            v31 = v74;
            v21 = v72;
            v64 = qword_10012A790;
            if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
...
- (id)createTrustedSthKeyStoreFromProofSPKI:(id)a3 signingKeysMap:(id)a4 error:(id *)a5
{
  ...
  else
  {
    ...
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_100106178);
    v15 = qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)v17 = 0;
...
- (BOOL)verifyCertificates:(id)a3 intermediates:(id)a4 application:(id)a5 error:(id *)a6
{
  ...
  if ((objc_msgSend(v13, "allowsInternalSecurityPolicies") & 1) != 0)
  {
    ...
    {
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106198);
      v16 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
  ...
  if (AppleKeyTransparency)
  {
    ...
    if (a6 && (v20 & 1) == 0)
    {
      *a6 = (id)objc_claimAutoreleasedReturnValue(+[TransparencyError errorWithDomain:code:underlyingError:description:](TransparencyError, "errorWithDomain:code:underlyingError:description:", CFSTR("TransparencyErrorVerify"), -29, v12, *a6));
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_1001061D8);
      v21 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        v22 = *a6;
  ...
  else
  {
    ...
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_1001061B8);
    v23 = qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
...
- (BOOL)processTltConfigProof:(id)a3 error:(id *)a4
{
  ...
  if (!objc_msgSend(v6, "verifyWithError:", a4))
  {
    ...
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_1001061F8);
    v17 = qword_10012A790;
    if (!os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      goto LABEL_37;
    if (a4)
  ...
  if (!objc_msgSend(v6, "nodePosition"))
  {
    ...
    {
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106238);
      v29 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        if (a4)
    ...
    if (v23)
    {
      ...
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106278);
      v26 = (void *)qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        v27 = v26;
        *(_DWORD *)buf = 67109376;
...
LABEL_52:
    ...
    {
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106258);
      v32 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)buf = 0;
  ...
  if (qword_10012A788 != -1)
    dispatch_once(&qword_10012A788, &stru_100106218);
  v13 = qword_10012A790;
  if (!os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    goto LABEL_37;
  *(_WORD *)buf = 0;
...
- (id)processPamHeadInPatProof:(id)a3 tltEntry:(id)a4 error:(id *)a5
{
  ...
  if (v11 && (objc_msgSend(v11, "hasObjectMapHead") ? (v13 = v12 == 0) : (v13 = 0), v13))
  {
    ...
    if (v23)
    {
      ...
      if (v26 == (id)1)
      {
        ...
        {
          if (qword_10012A788 != -1)
            dispatch_once(&qword_10012A788, &stru_1001062F8);
          v21 = v36;
          v32 = qword_10012A790;
          if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
          {
      ...
      {
        if (qword_10012A788 != -1)
          dispatch_once(&qword_10012A788, &stru_1001062D8);
        v34 = qword_10012A790;
        if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138412290;
    ...
    {
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_1001062B8);
      v33 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)buf = 0;
  ...
  {
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_100106298);
    v14 = qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
...
- (id)copyVRFKeyFromConfigProof:(id)a3 error:(id *)a4
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106338);
      v14 = (void *)qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        v15 = v14;
  ...
  {
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_100106318);
    v18 = (void *)qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      v19 = v18;
...
- (BOOL)processPatConfigProof:(id)a3 error:(id *)a4
{
  ...
  if (!-[TransparencyPublicKeyBag verifyConfigProof:error:](self, "verifyConfigProof:error:", v6, a4))
    goto LABEL_13;
  if (qword_10012A788 != -1)
    dispatch_once(&qword_10012A788, &stru_100106358);
  v7 = (void *)qword_10012A790;
  if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_DEFAULT))
  {
    v8 = v7;
  ...
  {
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_100106378);
    v11 = (void *)qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      v12 = v11;
  ...
  if (v16)
  {
    ...
    if (v18)
    {
      ...
      if (v23)
      {
        ...
        if (qword_10012A788 != -1)
          dispatch_once(&qword_10012A788, &stru_1001063B8);
        v25 = v29;
        v27 = qword_10012A790;
        if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
        {
    ...
    {
      if (qword_10012A788 != -1)
        dispatch_once(&qword_10012A788, &stru_100106398);
      v26 = qword_10012A790;
      if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)buf = 0;
...
- (BOOL)processPatClosedProof:(id)a3 error:(id *)a4
{
  ...
  if ((_DWORD)v10)
  {
    ...
    if (qword_10012A788 != -1)
      dispatch_once(&qword_10012A788, &stru_1001063D8);
    v14 = qword_10012A790;
    if (os_log_type_enabled((os_log_t)qword_10012A790, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 67109376;
