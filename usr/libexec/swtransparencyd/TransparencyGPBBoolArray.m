...
{
  return -[TransparencyGPBBoolArray initWithValues:count:](self, "initWithValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}

- (TransparencyGPBBoolArray)initWithValues:(const BOOL *)a3 count:(unint64_t)a4
{
  TransparencyGPBBoolArray *v6;
  TransparencyGPBBoolArray *v7;
  BOOL *v8;
...
{
  TransparencyGPBBoolArray *v4;
  TransparencyGPBBoolArray *v5;

  v4 = -[TransparencyGPBBoolArray initWithValues:count:](self, "initWithValues:count:", 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBBoolArray initWithValues:count:](+[TransparencyGPBBoolArray allocWithZone:](TransparencyGPBBoolArray, "allocWithZone:", a3), "initWithValues:count:", self->_values, self->_count);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBBoolArray, a2);
...
{
  -[TransparencyGPBBoolArray enumerateValuesWithOptions:usingBlock:](self, "enumerateValuesWithOptions:usingBlock:", 0, a3);
}
...
- (void)addValue:(BOOL)a3
{
  ...
  v3 = a3;
  -[TransparencyGPBBoolArray addValues:count:](self, "addValues:count:", &v3, 1);
}
...
- (void)addValues:(const BOOL *)a3 count:(unint64_t)a4
{
  ...
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity)
      -[TransparencyGPBBoolArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v8 & 0xFFFFFFFFFFFFFFF0) + 16);
    self->_count = v8;
...
{
  -[TransparencyGPBBoolArray addValues:count:](self, "addValues:count:", *((_QWORD *)a3 + 2), *((_QWORD *)a3 + 3));
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  if (count + 31 < self->_capacity)
    -[TransparencyGPBBoolArray internalResizeToCapacity:](self, "internalResizeToCapacity:", (v6 & 0xFFFFFFFFFFFFFFF0) + 16);
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21)
    -[TransparencyGPBBoolArray internalResizeToCapacity:](self, "internalResizeToCapacity:", 16);
}
