...
{
  return -[TransparencyGPBInt32FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
}

- (TransparencyGPBInt32FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  TransparencyGPBInt32FloatDictionary *v8;
  double v9;
...
{
  TransparencyGPBInt32FloatDictionary *v4;
  TransparencyGPBInt32FloatDictionary *v5;

  v4 = -[TransparencyGPBInt32FloatDictionary initWithFloats:forKeys:count:](self, "initWithFloats:forKeys:count:", 0, 0, 0);
  v5 = v4;
  if (a3 && v4)
...
{
  return -[TransparencyGPBInt32FloatDictionary initWithDictionary:](+[TransparencyGPBInt32FloatDictionary allocWithZone:](TransparencyGPBInt32FloatDictionary, "allocWithZone:", a3), "initWithDictionary:", self);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == a3)
    return 1;
  v5 = objc_opt_class(TransparencyGPBInt32FloatDictionary, a2);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v16 = v15;
      LODWORD(v13) = sub_1000A48A8(v14, 1, v7);
