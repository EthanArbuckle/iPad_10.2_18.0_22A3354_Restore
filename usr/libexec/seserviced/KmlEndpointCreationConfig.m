...
{
  KmlEndpointCreationConfig *v2;
  uint64_t v3;
  NSMutableData *apduData;
  uint64_t v5;
  NSMutableData *attestationData;
  NSData *publicKeyCertData;
  NSData *chainCertsData;
  NSData *rootCertData;
  NSData *mailboxMappingData;
  NSData *deviceConfigData;
  NSData *endpointCreationData;
  NSMutableArray *endpointCreationTLVs;
  NSArray *deviceConfigTlvs;
  NSString *vehicleReaderIdentifier;
  NSSet *v16;
  NSSet *endpointConfigurationRequiredTagsSet;
  objc_super v19;

  v19.receiver = self;
  v19.super_class = (Class)KmlEndpointCreationConfig;
  v2 = -[KmlEndpointCreationConfig init](&v19, "init");
  if (v2)
  {
    v3 = objc_claimAutoreleasedReturnValue(+[NSMutableData data](NSMutableData, "data"));
    apduData = v2->_apduData;
    v2->_apduData = (NSMutableData *)v3;

    v5 = objc_claimAutoreleasedReturnValue(+[NSMutableData data](NSMutableData, "data"));
    ...
    v16 = (NSSet *)objc_msgSend(objc_alloc((Class)NSSet), "initWithArray:", &off_100322D30);
