...
{
  SharingInitiatorCertChain *v2;
  SharingInitiatorCertChain *v3;
  NSData *endpointCertData;
  NSData *intermediateCertData;
  NSData *extCACertData;
  ...
  v2 = -[SharingInitiatorCertChain init](&v10, "init");
  v3 = v2;
  if (v2)
  {
...
{
  objc_storeStrong((id *)&self->_sharingInitiatorCertChainTlv, a3);
}
