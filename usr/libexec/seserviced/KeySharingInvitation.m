...
{
  KeySharingInvitation *v2;
  EndpointConfigForSharing *v3;
  EndpointConfigForSharing *endpointConfig;
  SharingKeyConfig *v5;
  SharingKeyConfig *keyConfig;
  SharingInitiatorCertChain *v7;
  SharingInitiatorCertChain *initiatorCertChain;
  KmlTlv *invitationTlv;
  KmlVersions *versionInformation;
  objc_super v12;

  v12.receiver = self;
  v12.super_class = (Class)KeySharingInvitation;
  v2 = -[KeySharingInvitation init](&v12, "init");
  if (v2)
  {
