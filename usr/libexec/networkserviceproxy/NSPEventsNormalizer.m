...
+ (id)URLOfModelInThisBundle
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "pathForResource:ofType:", CFSTR("NSPEventsNormalizer"), CFSTR("mlmodelc")));
  ...
  else
  {
    ...
    {
      *(_WORD *)v7 = 0;
      _os_log_error_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "Could not load NSPEventsNormalizer.mlmodelc in the bundle resource", v7, 2u);
    }
    v5 = 0;
  }
...
{
  id v5;
  NSPEventsNormalizer *v6;
  NSPEventsNormalizer *v7;
  NSPEventsNormalizer *v8;
  objc_super v10;

  v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NSPEventsNormalizer;
  v6 = -[NSPEventsNormalizer init](&v10, "init");
  v7 = v6;
...
- (NSPEventsNormalizer)init
{
  id v3;
  void *v4;
  NSPEventsNormalizer *v5;

  v3 = objc_msgSend((id)objc_opt_class(self), "URLOfModelInThisBundle");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = -[NSPEventsNormalizer initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v4, 0);
...
- (NSPEventsNormalizer)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  id v7;
  void *v8;
  NSPEventsNormalizer *v9;

  v6 = a3;
  v7 = objc_msgSend((id)objc_opt_class(self), "URLOfModelInThisBundle");
  v8 = (void *)objc_claimAutoreleasedReturnValue(v7);
  v9 = -[NSPEventsNormalizer initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v8, v6, a4);
...
- (NSPEventsNormalizer)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[NSPEventsNormalizer initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (NSPEventsNormalizer)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[NSPEventsNormalizer initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[NSPEventsNormalizer predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v6, v7, a4));
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  NSPEventsNormalizerOutput *v12;
  void *v13;
  void *v14;
  NSPEventsNormalizerOutput *v15;

  v8 = a4;
  v9 = a3;
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[NSPEventsNormalizer model](self, "model"));
  ...
  if (v11)
  {
    ...
    v15 = -[NSPEventsNormalizerOutput initWithIdentity:](v12, "initWithIdentity:", v14);
...
- (id)predictionFromNormalizer_input:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = -[NSPEventsNormalizerInput initWithNormalizer_input:]([NSPEventsNormalizerInput alloc], "initWithNormalizer_input:", v6);

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[NSPEventsNormalizer predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4));
  return v8;
}
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  NSPEventsNormalizerOutput *v16;
  void *v17;
  void *v18;
  NSPEventsNormalizerOutput *v19;
  id v21;
  id v22;
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[NSPEventsNormalizer model](self, "model"));
  ...
  if (v12)
  {
    ...
    if ((uint64_t)objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v19 = -[NSPEventsNormalizerOutput initWithIdentity:](v16, "initWithIdentity:", v18);
