...
{
  TSDgPTPUnicastUDPv4PtPPort *v4;
  TSDgPTPUnicastUDPv4PtPPort *v5;
  uint64_t v6;
  ...
  if (v4)
  {
    v6 = objc_claimAutoreleasedReturnValue(-[TSDgPTPUnicastUDPv4PtPPort _destinationIPv4Address](v4, "_destinationIPv4Address"));
...
- (id)_sourceAddressString
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)TSDgPTPUnicastUDPv4PtPPort;
...
+ (id)diagnosticInfoForService:(id)a3
{
  ...
  v4 = a3;
  v16.receiver = a1;
  v16.super_class = (Class)&OBJC_METACLASS___TSDgPTPUnicastUDPv4PtPPort;
  v5 = objc_msgSendSuper2(&v16, "diagnosticInfoForService:", v4);
  v6 = (void *)objc_claimAutoreleasedReturnValue(v5);
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", 3));
