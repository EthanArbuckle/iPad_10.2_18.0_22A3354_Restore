...
{
  TSDgPTPUnicastUDPv6EtEPort *v4;
  TSDgPTPUnicastUDPv6EtEPort *v5;
  uint64_t v6;
  ...
  if (v4)
  {
    v6 = objc_claimAutoreleasedReturnValue(-[TSDgPTPUnicastUDPv6EtEPort _destinationIPv6Address](v4, "_destinationIPv6Address"));
...
- (id)_sourceAddressString
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)TSDgPTPUnicastUDPv6EtEPort;
