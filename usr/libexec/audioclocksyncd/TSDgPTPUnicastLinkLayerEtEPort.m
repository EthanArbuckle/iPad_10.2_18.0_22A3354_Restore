...
{
  TSDgPTPUnicastLinkLayerEtEPort *v4;
  TSDgPTPUnicastLinkLayerEtEPort *v5;
  uint64_t v6;
  ...
  if (v4)
  {
    v6 = objc_claimAutoreleasedReturnValue(-[TSDgPTPUnicastLinkLayerEtEPort _destinationMACAddress](v4, "_destinationMACAddress"));
...
- (id)_sourceAddressString
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)TSDgPTPUnicastLinkLayerEtEPort;
...
+ (id)diagnosticInfoForService:(id)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", 5));
