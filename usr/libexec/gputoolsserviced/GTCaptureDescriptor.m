...
- (GTCaptureDescriptor)initWithRequestID:(unint64_t)a3
{
  ...
  v3 = -[GTCaptureRequest initWithRequestID:](&v6, "initWithRequestID:", a3);
  v4 = v3;
  if (v3)
...
- (GTCaptureDescriptor)initWithCoder:(id)a3
{
  ...
  v5 = -[GTCaptureRequest initWithCoder:](&v9, "initWithCoder:", v4);
  if (v5)
  {
    v5->_sessionID = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("sessionID"));
    v5->_triggerHitsToStart = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("triggerHitsToStart"));
    v5->_triggerHitsToEnd = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("triggerHitsToEnd"));
    ...
    v6 = objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "decodeObjectForKey:", CFSTR("outputURL")));
...
- (id)description
{
  ...
  v3 = -[GTCaptureDescriptor description](&v7, "description");
