...
- (GTCaptureProgressStatistics)initWithCoder:(id)a3
{
  ...
  v5 = -[GTCaptureProgressStatistics init](&v8, "init");
  if (v5)
  {
    v5->_frameCount = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("frameCount"));
    v5->_frameOther = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("frameOther"));
    v5->_commitCount = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("commitCount"));
    v5->_commitOther = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("commitOther"));
    v5->_resourceCount = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("resourceCount"));
    v5->_resourceDownloaded = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("resourceDownloaded"));
    v5->_GPUDataSize = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("GPUDataSize"));
    v5->_GPUDataDownloaded = (unint64_t)objc_msgSend(v4, "decodeInt64ForKey:", CFSTR("GPUDataDownloaded"));
    v6 = v5;
  }
