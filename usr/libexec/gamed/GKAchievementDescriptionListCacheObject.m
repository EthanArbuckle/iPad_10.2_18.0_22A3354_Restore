...
+ (id)entityName
{
  return CFSTR("AchievementDescriptionList");
}
...
- (void)updateWithServerRepresentation:(id)a3 expirationDate:(id)a4
{
  ...
  -[GKListCacheObject updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:](self, "updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:", v7, &stru_1002C2688, 1);
}
...
- (BOOL)isValid
{
  ...
  if (!-[GKExpiringCacheObject isValid](&v7, "isValid"))
    return 0;
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[GKAchievementDescriptionListCacheObject game](self, "game"));
