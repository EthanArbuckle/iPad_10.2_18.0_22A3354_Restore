...
{
  id v4;
  GKDelayedSetPhotoCacheWriter *v5;
  GKDelayedSetPhotoCacheWriter *v6;
  objc_super v8;

  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)GKDelayedSetPhotoCacheWriter;
  v5 = -[GKDelayedSetPhotoCacheWriter init](&v8, "init");
  v6 = v5;
  if (v5)
...
- (id)photosInsertSQL
{
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("INSERT INTO photos(           request_id,             photo_data,             avatar_type)             VALUES (%s, %s, %s);"),
           ":request_id",
           ":photo_data",
           ":avatar_type");
}
...
- (id)getOldPhotosSQL
{
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("            SELECT request_id             FROM requests             INNER JOIN photos USING (request_id)             WHERE player_gcid = %s;"),
           ":player_gcid");
}
...
- (void)writeResources:(id)a3 handler:(id)a4
{
  ...
  _QWORD v17[4];
  id v18;
  GKDelayedSetPhotoCacheWriter *v19;
