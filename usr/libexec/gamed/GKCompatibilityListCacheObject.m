...
+ (id)entityName
{
  return CFSTR("CompatibilityMatrixList");
}

+ (Class)entryClass
{
  return (Class)objc_opt_class(GKCompatibilityEntryCacheObject, a2);
}
...
- (void)updateWithServerRepresentation:(id)a3 expirationDate:(id)a4
{
  ...
  if (dispatch_queue_get_specific(v9, CFSTR("com.apple.gamed.cachequeue")) != CFSTR("com.apple.gamed.cachequeue"))
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%s not invoked on managed object context queue at %@"), "-[GKCompatibilityListCacheObject updateWithServerRepresentation:expirationDate:]", v10));
  ...
  -[GKListCacheObject updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:](self, "updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:", v15, &stru_1002C2840, 1);
