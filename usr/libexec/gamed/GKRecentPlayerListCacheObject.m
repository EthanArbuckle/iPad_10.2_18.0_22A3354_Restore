...
+ (id)entityName
{
  return CFSTR("RecentPlayerList");
}

+ (Class)entryClass
{
  return (Class)objc_opt_class(GKRecentPlayerListEntryCacheObject, a2);
}
...
- (void)updateWithServerRepresentation:(id)a3 expirationDate:(id)a4
{
  ...
  if (dispatch_queue_get_specific(v9, CFSTR("com.apple.gamed.cachequeue")) != CFSTR("com.apple.gamed.cachequeue"))
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%s not invoked on managed object context queue at %@"), "-[GKRecentPlayerListCacheObject updateWithServerRepresentation:expirationDate:]", v10));
  ...
  -[GKListCacheObject updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:](self, "updateEntriesWithRepresentations:entryForRepresentation:reuseEntriesByIndex:", v15, &stru_1002C2880, 1);
...
- (id)internalRepresentation
{
  ...
  _QWORD v20[4];
  id v21;
  GKRecentPlayerListCacheObject *v22;
  ...
  if (dispatch_queue_get_specific(v4, CFSTR("com.apple.gamed.cachequeue")) != CFSTR("com.apple.gamed.cachequeue"))
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%s not invoked on managed object context queue at %@"), "-[GKRecentPlayerListCacheObject internalRepresentation]", v5));
