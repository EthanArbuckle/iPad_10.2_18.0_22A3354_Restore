...
- (id)internalRepresentation
{
  ...
  if (dispatch_queue_get_specific(v4, CFSTR("com.apple.gamed.cachequeue")) != CFSTR("com.apple.gamed.cachequeue"))
  {
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%s not invoked on managed object context queue at %@"), "-[GKTopGamesListEntryCacheObject internalRepresentation]", v5));
...
+ (id)entityName
{
  return CFSTR("TopGamesListEntry");
}
