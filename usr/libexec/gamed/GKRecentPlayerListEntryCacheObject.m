...
+ (id)entityName
{
  return CFSTR("RecentPlayerEntry");
}
...
- (void)updateWithServerRepresentation:(id)a3
{
  ...
  if (dispatch_queue_get_specific(v6, CFSTR("com.apple.gamed.cachequeue")) != CFSTR("com.apple.gamed.cachequeue"))
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%s not invoked on managed object context queue at %@"), "-[GKRecentPlayerListEntryCacheObject updateWithServerRepresentation:]", v7));
...
- (id)internalRepresentation
{
  ...
  if (dispatch_queue_get_specific(v3, CFSTR("com.apple.gamed.cachequeue")) != CFSTR("com.apple.gamed.cachequeue"))
  {
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%s not invoked on managed object context queue at %@"), "-[GKRecentPlayerListEntryCacheObject internalRepresentation]", v4));
