...
- (void)_createSubviews
{
  ...
  void *v15;
  void *v16;
  MFComposeMultiView *v17;
  MFComposeMultiView *multiField;
  uint64_t v19;
  NSBundle *v20;
  void *v21;
  void *v22;
  MFMailComposeRecipientTextView *v23;
  MFMailComposeRecipientTextView *ccField;
  uint64_t v25;
  NSBundle *v26;
  void *v27;
  void *v28;
  MFMailComposeRecipientTextView *v29;
  MFMailComposeRecipientTextView *bccField;
  uint64_t v31;
  NSBundle *v32;
  void *v33;
  void *v34;
  MFComposeFromView *v35;
  MFComposeFromView *fromField;
  MFComposeSubjectView *v37;
  ...
  v42 = v6;
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &v42, 1));
  ...
  v14 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v13));
  v15 = (void *)objc_claimAutoreleasedReturnValue(v14);
  v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("TO"), &stru_100018898, CFSTR("Main")));
  -[MFMailComposeToField setLabel:](self->_toField, "setLabel:", v16);
  ...
  v17 = (MFComposeMultiView *)objc_msgSend(objc_alloc((Class)MFComposeMultiView), "initWithFrame:", 0.0, 0.0, Width, v10);
  multiField = self->_multiField;
  self->_multiField = v17;

  -[MFComposeMultiView setUserInteractionEnabled:](self->_multiField, "setUserInteractionEnabled:", 0);
  v20 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v19));
  v21 = (void *)objc_claimAutoreleasedReturnValue(v20);
  v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v21, "localizedStringForKey:value:table:", CFSTR("CC/BCC"), &stru_100018898, CFSTR("Main")));
  -[MFComposeMultiView setLabel:](self->_multiField, "setLabel:", v22);

  -[ComposePlaceholderView addSubview:](self, "addSubview:", self->_multiField);
  v23 = (MFMailComposeRecipientTextView *)objc_msgSend(objc_alloc((Class)MFMailComposeRecipientTextView), "initWithFrame:", 0.0, 0.0, Width, v10);
  ...
  v26 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v25));
  v27 = (void *)objc_claimAutoreleasedReturnValue(v26);
  v28 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v27, "localizedStringForKey:value:table:", CFSTR("CC"), &stru_100018898, CFSTR("Main")));
  -[MFMailComposeRecipientTextView setLabel:](self->_ccField, "setLabel:", v28);

  -[ComposePlaceholderView addSubview:](self, "addSubview:", self->_ccField);
  v29 = (MFMailComposeRecipientTextView *)objc_msgSend(objc_alloc((Class)MFMailComposeRecipientTextView), "initWithFrame:", 0.0, 0.0, Width, v10);
  ...
  v32 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v31));
  v33 = (void *)objc_claimAutoreleasedReturnValue(v32);
  v34 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v33, "localizedStringForKey:value:table:", CFSTR("BCC"), &stru_100018898, CFSTR("Main")));
  -[MFMailComposeRecipientTextView setLabel:](self->_bccField, "setLabel:", v34);

  -[ComposePlaceholderView addSubview:](self, "addSubview:", self->_bccField);
  v35 = (MFComposeFromView *)objc_msgSend(objc_alloc((Class)MFComposeFromView), "initWithFrame:", 0.0, 0.0, Width, v10);
  ...
  v37 = (MFComposeSubjectView *)objc_msgSend(objc_alloc((Class)MFComposeSubjectView), "initWithFrame:", 0.0, 0.0, Width, v10);
  subjectField = self->_subjectField;
  self->_subjectField = v37;
  ...
  v39 = (UIImageView *)objc_msgSend(objc_alloc((Class)UIImageView), "initWithFrame:", 0.0, 0.0, Width, v10);
  snapshotImageView = self->_snapshotImageView;
  self->_snapshotImageView = v39;

  v41 = (void *)objc_claimAutoreleasedReturnValue(+[UIColor systemBackgroundColor](UIColor, "systemBackgroundColor"));
  -[UIImageView setBackgroundColor:](self->_snapshotImageView, "setBackgroundColor:", v41);
...
- (void)_updateMultiFieldWithModel:(id)a3
{
  ...
  v16 = a3;
  v5 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v4));
  v6 = (void *)objc_claimAutoreleasedReturnValue(v5);
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("CC/BCC"), &stru_100018898, CFSTR("Main")));

  if (objc_msgSend(v16, "showSenderAddress"))
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "senderAddress"));

    if (v8)
    {
      v10 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v9));
      v11 = (void *)objc_claimAutoreleasedReturnValue(v10);
      v12 = objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "localizedStringForKey:value:table:", CFSTR("CC/BCC/FROM"), &stru_100018898, CFSTR("Main")));

      v7 = (void *)v12;
    }
  }
  v13 = (void *)objc_claimAutoreleasedReturnValue(-[ComposePlaceholderView multiField](self, "multiField"));
  v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "senderAddress"));
  objc_msgSend(v13, "setAccountDescription:", v14);

  v15 = (void *)objc_claimAutoreleasedReturnValue(-[ComposePlaceholderView multiField](self, "multiField"));
  objc_msgSend(v15, "setLabel:", v7);
...
- (void)_setSubject:(id)a3
{
  ...
  else
  {
    ...
    v3 = NSBundle;
    v11 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(MFMailComposeRecipientTextView, v10));
    if (v7)
    {
      v3 = (void *)objc_claimAutoreleasedReturnValue(v11);
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("NEW_MESSAGE_LONG"), &stru_100018898, CFSTR("Main")));
    }
    else
    {
      v4 = (void *)objc_claimAutoreleasedReturnValue(v11);
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("NEW_MESSAGE"), &stru_100018898, CFSTR("Main")));
    }
    v8 = v7 ^ 1;
  }
  v12 = (void *)objc_claimAutoreleasedReturnValue(-[ComposePlaceholderView navigationBar](self, "navigationBar"));
  v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "topItem"));
