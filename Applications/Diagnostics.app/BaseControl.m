...
- (_TtC11Diagnostics11BaseControl)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  _TtC11Diagnostics11BaseControl *v7;
  uint64_t (*v8)(void);
  _TtC11Diagnostics11BaseControl *v9;
  uint64_t v10;
  uint64_t v11;
  objc_super v13;
  ...
  v9 = v7;
  v10 = v8();
  v11 = (*(uint64_t (**)(uint64_t))((swift_isaMask & (uint64_t)v9->super.super.super.super.isa) + 0x58))(v10);
...
{
  _TtC11Diagnostics11BaseControl *result;

  result = (_TtC11Diagnostics11BaseControl *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100112360, "Diagnostics/BaseControl.swift", 29, 2, 21, 0);
  __break(1u);
  return result;
}
