...
- (void)showOnTopWithAnimated:(BOOL)a3 completion:(id)a4
{
  ...
  if (v6)
  {
    v7 = swift_allocObject(&unk_100137AB0, 24, 7);
    *(_QWORD *)(v7 + 16) = v6;
    v6 = sub_10003FF9C;
  }
  else
  ...
  v8 = self;
  sub_100066370(0, a3, (uint64_t)v6, v7);
...
- (void)scheduleModalPresentationWithPriority:(int64_t)a3 animated:(BOOL)a4 presentationCompletion:(id)a5
{
  ...
  if (v12)
  {
    v13 = swift_allocObject(&unk_10013B5C8, 24, 7);
    *(_QWORD *)(v13 + 16) = v12;
    v12 = sub_1000CA43C;
  }
  else
  ...
  sub_1000C5EF0(v18, 0, a3, a4, 0, 1, (uint64_t)v12, v13, (uint64_t)v11);
  sub_1000C6848(v11);
