...
- (BOOL)isValid
{
  ...
  if (v4)
  {
    v2 = (void *)objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo name](self, "name"));
    if (!v2)
    {
      v10 = 1;
      goto LABEL_11;
  ...
  v5 = objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo serialNumbers](self, "serialNumbers"));
  if (!v5)
  {
    v10 = 1;
    if (!v4)
  ...
  v6 = (void *)v5;
  v7 = objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo accessoryIdentifier](self, "accessoryIdentifier"));
  if (v7)
  {
    v8 = (void *)v7;
    v9 = (void *)objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo accessoryType](self, "accessoryType"));
    v10 = v9 == 0;
...
- (FMDMagSafeAccessory)initWithPhysicalAccessory:(id)a3 fmEnabled:(BOOL)a4
{
  ...
  if (v7)
  {
    ...
    -[FMDExtAccessoryInfo setAccessoryIdentifier:](v7, "setAccessoryIdentifier:", v9);
    ...
    -[FMDExtAccessoryInfo setSerialNumbers:](v7, "setSerialNumbers:", v11);

    v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "firmwareVersion"));
    -[FMDExtAccessoryInfo setFirmwareVersion:](v7, "setFirmwareVersion:", v12);
    ...
    if (objc_msgSend(v6, "isMF4i"))
    {
      ...
      -[FMDExtAccessoryInfo setAccessoryType:](v7, "setAccessoryType:", v16);

    }
    else
    {
      v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "accessoryType"));
      -[FMDExtAccessoryInfo setAccessoryType:](v7, "setAccessoryType:", v14);
    }

    v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "serialNumber"));
    -[FMDExtAccessoryInfo setDeviceDiscoveryId:](v7, "setDeviceDiscoveryId:", v17);

    if (v4)
    {
      v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "name"));
      -[FMDExtAccessoryInfo setName:](v7, "setName:", v18);
...
- (id)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo serialNumbers](self, "serialNumbers"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo firmwareVersion](self, "firmwareVersion"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo additionalInfo](self, "additionalInfo"));
  objc_msgSend(v4, "encodeObject:forKey:", v11, CFSTR("additionalInfo"));

  v12 = (void *)objc_claimAutoreleasedReturnValue(-[FMDExtAccessoryInfo deviceDiscoveryId](self, "deviceDiscoveryId"));
