...
- (NSString)domain
{
  ...
  if (!domain)
  {
    *(_QWORD *)&v4 = objc_opt_class(self, a2).n128_u64[0];
    ...
    v7 = (NSString *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "bundleIdentifier"));
    v8 = self->_domain;
    self->_domain = v7;
