...
- (void)fetchRTTConversationForCallUUID:(id)a3
{
  ...
  if (v7)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_10009E944;
    block[3] = &unk_100287008;
        ...
        for (i = 0; i != v6; i = (char *)i + 1)
        {
          ...
          if ((objc_msgSend(v9, "isMe") & 1) == 0)
          {
            ...
            if (objc_msgSend(v9, "isTranscription"))
            {
              ...
              v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", v12, &stru_10028DC20));

              v14 = objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "stringByReplacingOccurrencesOfString:withString:", v13, &stru_10028DC20));
              v10 = (void *)v14;
            }
...
- (NSString)text
{
  return (NSString *)sub_100153828(self, (uint64_t)a2, sub_100153870);
}
