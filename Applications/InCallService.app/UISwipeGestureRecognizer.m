...
+ (void)addSwipeGestureRecognizerToView:(id)a3 withTarget:(id)a4 action:(SEL)a5
{
  ...
  v7 = a4;
  v8 = a3;
  v9 = objc_msgSend(objc_alloc((Class)UISwipeGestureRecognizer), "initWithTarget:action:", v7, a5);
...
+ (void)addSwipeGestureRecognizerToView:(id)a3 withTarget:(id)a4 action:(SEL)a5 direction:(unint64_t)a6
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = objc_msgSend(objc_alloc((Class)UISwipeGestureRecognizer), "initWithTarget:action:", v9, a5);

  objc_msgSend(v11, "setDirection:", a6);
...
+ (void)addSwipeGestureRecognizerToView:(id)a3 withTarget:(id)a4 action:(SEL)a5 touchCount:(unint64_t)a6
{
  ...
  objc_msgSend(v11, "setNumberOfTouchesRequired:", a6);
  objc_msgSend(v10, "addGestureRecognizer:", v11);
...
+ (void)addSwipeGestureRecognizerToView:(id)a3 withTarget:(id)a4 action:(SEL)a5 direction:(unint64_t)a6 touchCount:(unint64_t)a7
{
  ...
  v11 = a4;
  v12 = a3;
  v13 = objc_msgSend(objc_alloc((Class)UISwipeGestureRecognizer), "initWithTarget:action:", v11, a5);

  objc_msgSend(v13, "setDirection:", a6);
