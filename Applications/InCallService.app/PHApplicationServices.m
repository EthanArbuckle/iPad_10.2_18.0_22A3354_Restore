...
+ (id)sharedInstance
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100087F50;
  block[3] = &unk_100284948;
  block[4] = a1;
  if (qword_1002DCAC0 != -1)
    dispatch_once(&qword_1002DCAC0, block);
  return (id)qword_1002DCAB8;
}
...
- (TUCallProviderManager)callProviderManager
{
  ...
  if (!v5)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100088534;
    block[3] = &unk_100286B18;
    v11 = &v12;
    v10 = v3;
