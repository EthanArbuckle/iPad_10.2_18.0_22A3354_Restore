...
{
  if (+[SOSUtilities BOOLOverrideForDefaultsKey:defaultValue:](SOSUtilities, "BOOLOverrideForDefaultsKey:defaultValue:", CFSTR("debug.countdown.mute"), 0))return 0;
  else
    return 10;
}
...
- (BOOL)playsSound
{
  return +[SOSUtilities shouldSilenceSOSFlow](SOSUtilities, "shouldSilenceSOSFlow") ^ 1;
}
