...
+ (id)contactStore
{
  ...
  {
    v3 = objc_alloc_init((Class)objc_opt_class(a1));
  }
  else
  {
    v4 = PHDefaultLog();
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
      sub_100052024(v5, v6, v7, v8, v9, v10, v11, v12);
...
+ (id)suggestedContactStore
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      sub_100052024(v6, v7, v8, v9, v10, v11, v12, v13);
...
LABEL_20:
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        sub_100052094((uint64_t)v20, v22, v25, v26, v27, v28, v29, v30);
      v17 = 0;
    }
