...
+ (id)sharedInstance
{
  ...
  block[3] = &unk_10007D3D8;
  block[4] = a1;
  if (qword_1000921F8 != -1)
    dispatch_once(&qword_1000921F8, block);
  return (id)qword_1000921F0;
}
...
- (MPVoicemailManagerProtocol)voicemailManager
{
  ...
  return (MPVoicemailManagerProtocol *)v7;
}

- (void)setVoicemailManager:(id)a3
{
  os_unfair_lock_s *p_accessorLock;
  MPVoicemailManagerProtocol **p_voicemailManager;
  MPVoicemailManagerProtocol *voicemailManager;
  MPVoicemailManagerProtocol *v8;

  v8 = (MPVoicemailManagerProtocol *)a3;
  p_accessorLock = &self->_accessorLock;
  os_unfair_lock_lock(&self->_accessorLock);
  voicemailManager = self->_voicemailManager;
  p_voicemailManager = &self->_voicemailManager;
  if (voicemailManager != v8)
    objc_storeStrong((id *)p_voicemailManager, a3);
  os_unfair_lock_unlock(p_accessorLock);
...
{
  os_unfair_lock_s *p_accessorLock;
  VMVoicemailManager **p_accountManager;
  VMVoicemailManager *accountManager;
  VMVoicemailManager *v8;

  v8 = (VMVoicemailManager *)a3;
  p_accessorLock = &self->_accessorLock;
  os_unfair_lock_lock(&self->_accessorLock);
...
+ (id)getFTVoiceMailOnVoicemailsChanged:(id)a3
{
  ...
  v3 = _Block_copy(a3);
  v4 = swift_allocObject(&unk_10007EFD8, 24, 7);
  *(_QWORD *)(v4 + 16) = v3;
  v5 = type metadata accessor for FaceTimeVoicemailManager(0);
  swift_allocObject(v5, *(unsigned int *)(v5 + 48), *(unsigned __int16 *)(v5 + 52));
  swift_retain(v4);
  v6 = (void *)sub_10003F9DC((uint64_t)sub_100052018, v4);
  swift_release(v4);
  return v6;
}
