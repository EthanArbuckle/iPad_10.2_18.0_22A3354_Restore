...
+ (id)currentDevice
{
  if (qword_100092278 != -1)
    dispatch_once(&qword_100092278, &stru_10007D6F0);
  return (id)qword_100092270;
}

+ (BOOL)isGeminiCapable
{
  if (qword_100092288 != -1)
    dispatch_once(&qword_100092288, &stru_10007D710);
  return byte_100092280;
}
