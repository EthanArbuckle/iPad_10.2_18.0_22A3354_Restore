...
- (PHRecentsController)initWithCallHistoryController:(id)a3 callProviderManager:(id)a4 contactStore:(id)a5 suggestedContactStore:(id)a6 metadataCache:(id)a7 voicemailController:(id)a8
{
  ...
  v41 = a8;
  v47.receiver = self;
  v47.super_class = (Class)PHRecentsController;
  v17 = -[PHRecentsController init](&v47, "init");
  v18 = v17;
  if (v17)
  {
    ...
    dispatch_queue_set_specific((dispatch_queue_t)v18->_serialQueue, off_100090B60, v18, 0);
    ...
    v34 = (TUSubtitleProvider *)objc_msgSend(objc_alloc((Class)TUSubtitleProvider), "initWithMetadataCache:callProviderManager:", v16, v44);
    ...
    v38 = v18->_serialQueue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100012228;
...
- (void)performJoinRequestForRecentCall:(id)a3 overrideProvider:(id)a4
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "PHRecentsController -performJoinRequestForRecentCall", buf, 2u);
  }

  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "validRemoteParticipantHandles"));
  ...
  v39 = 0u;
  v36 = v5;
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "validRemoteParticipantHandles"));
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; i = (char *)i + 1)
      {
        ...
        v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(*(id *)(*((_QWORD *)&v38 + 1) + 8 * (_QWORD)i), "tuHandle"));
        if (v15)
        {
          v16 = objc_alloc((Class)TUConversationMember);
          v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSSet setWithObject:](NSSet, "setWithObject:", v15));
          v18 = objc_msgSend(v16, "initWithHandles:", v17);
  ...
  {
    v19 = objc_msgSend(objc_alloc((Class)TUJoinConversationRequest), "initWithRemoteMembers:", v9);
    v20 = v36;
    -[NSObject setVideo:](v19, "setVideo:", objc_msgSend(v36, "mediaType") == (id)2);
    -[NSObject setVideoEnabled:](v19, "setVideoEnabled:", objc_msgSend(v36, "mediaType") == (id)2);
    -[NSObject setOriginatingUIType:](v19, "setOriginatingUIType:", 8);
    v21 = v35;
    if (v35)
      -[NSObject setProvider:](v19, "setProvider:", v35);
    v22 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController callProviderManager](self, "callProviderManager"));
    v23 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v22, "faceTimeProvider"));
    v24 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v36, "outgoingLocalParticipantUUID"));
    v25 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v23, "senderIdentityForAccountUUID:", v24));

    if (v25)
    {
      v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "handle"));
      -[NSObject setCallerID:](v19, "setCallerID:", v26);

    }
    v27 = (void *)objc_claimAutoreleasedReturnValue(+[TUCallProviderManager invitationPreferencesForRecentCall](TUCallProviderManager, "invitationPreferencesForRecentCall"));
    -[NSObject setInvitationPreferences:](v19, "setInvitationPreferences:", v27);

    v28 = objc_claimAutoreleasedReturnValue(-[PHRecentsController presentScreenTimeShield](self, "presentScreenTimeShield"));
    if (!v28)
      goto LABEL_20;
    v29 = (void *)v28;
    v30 = (void *)objc_claimAutoreleasedReturnValue(+[TUCallCenter sharedInstance](TUCallCenter, "sharedInstance"));
    v31 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v30, "callFilterController"));
    v32 = objc_msgSend(v31, "shouldRestrictJoinConversationRequest:performSynchronously:", v19, 1);
    ...
    if (v32)
    {
      v33 = (void (**)(_QWORD, _QWORD))objc_claimAutoreleasedReturnValue(-[PHRecentsController presentScreenTimeShield](self, "presentScreenTimeShield"));
      ((void (**)(_QWORD, NSObject *))v33)[2](v33, v19);
    }
    else
    {
LABEL_20:
      v33 = (void (**)(_QWORD, _QWORD))objc_claimAutoreleasedReturnValue(+[TUCallCenter sharedInstance](TUCallCenter, "sharedInstance"));
      objc_msgSend(v33, "launchAppForJoinRequest:", v19);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v43 = v36;
      _os_log_impl((void *)&_mh_execute_header, v19, OS_LOG_TYPE_DEFAULT, "Could not create join request for recent call: %@", buf, 0xCu);
    }
  }
    ...
    while (1)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        if ((objc_opt_respondsToSelector(v14, "recentsController:didUpdateCalls:") & 1) != 0)
        {
          ...
          block[0] = _NSConcreteStackBlock;
          block[1] = 3221225472;
          block[2] = sub_1000145A8;
          block[3] = &unk_10007D8F0;
          block[4] = v14;
          v21 = v6;
          v22 = v17;
    ...
    do
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        if ((objc_opt_respondsToSelector(v12, "recentsController:didChangeUnreadCallCount:") & 1) != 0)
        {
          ...
          block[0] = _NSConcreteStackBlock;
          block[1] = 3221225472;
          block[2] = sub_10001492C;
          block[3] = &unk_10007D918;
          block[4] = v12;
          v15 = v6;
          v16 = a4;
...
LABEL_9:
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "localizedStringForKey:value:table:", CFSTR("UNKNOWN_CALLER"), &stru_10007F010, CFSTR("PHRecents")));
...
- (id)fetchCallProviderForRecentCall:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "serviceProvider"));
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController callProviderManager](self, "callProviderManager"));
  if (!v6)
  {
    v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("Service provider is nil for the specified recent call: %@"), v4));
    NSLog(CFSTR("** TUAssertion failure: %@"), v12);

    _TUAssertShouldCrashApplication();
    goto LABEL_6;
  }
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController callProviderCache](self, "callProviderCache"));
  v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "objectForKey:", v6));

  if (!v9)
  {
    v10 = objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "providerForRecentCall:", v4));
    if (v10)
    {
      v9 = (void *)v10;
      v11 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController callProviderCache](self, "callProviderCache"));
...
- (id)fetchContactForContactCardDisplay:(id)a3
{
  ...
  if (objc_msgSend(v4, "canExceedUnifyingThreshold"))
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100015EC8;
    block[3] = &unk_10007D828;
    v10 = v4;
    v11 = &v12;
    block[4] = self;
    v6 = v4;
...
- (id)fetchUnifiedContactForID:(id)a3 withDescriptors:(id)a4
{
  ...
  if (!v7)
  {
    if (qword_1000922B8 != -1)
      dispatch_once(&qword_1000922B8, &stru_10007D9A0);
    v12 = (id)qword_1000922B0;
  }
  v32 = 0;
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      sub_100052784((uint64_t)v6, v19, v20, v21, v22, v23, v24, v25);
...
- (void)fetchContactsForHandles:(id)a3
{
  ...
  if (objc_msgSend(v6, "count"))
  {
    ...
    if (qword_1000922B8 != -1)
      dispatch_once(&qword_1000922B8, &stru_10007D9A0);
    v33 = v15;
    v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "contactsForHandles:keyDescriptors:alwaysUnifyLabeledValues:", v19, qword_1000922B0, 0));
...
- (id)fetchMutableItemForRecentCall:(id)a3 numberOfOccurences:(unint64_t)a4
{
  ...
  if (!v10 && v11 >= 1)
  {
    if (v11 == 1)
    {
      v13 = TUBundle();
      v14 = (void *)objc_claimAutoreleasedReturnValue(v13);
      v49 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("ONE_OTHER"), &stru_10007F010, CFSTR("TelephonyUtilities")));
    ...
    else
    {
      ...
      v186 = v6;
      v42 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v41, "localizedStringForKey:value:table:", CFSTR("%@_OTHERS"), &stru_10007F010, CFSTR("TelephonyUtilities")));
      v43 = v8;
  ...
  if (v10 <= 1)
  {
    ...
    v196[1] = 3221225472;
    v196[2] = sub_100017AD4;
    v196[3] = &unk_10007D940;
    v196[4] = self;
    v196[5] = v12;
...
LABEL_38:
    ...
    if (!objc_msgSend(v49, "length"))
    {
      ...
      v101 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v96, "localizedStringForKey:value:table:", v100, &stru_10007F010, CFSTR("PHRecents")));
      ...
      v107 = objc_claimAutoreleasedReturnValue(objc_msgSend(v104, "localizedStringForKey:value:table:", v106, &stru_10007F010, CFSTR("PHRecents")));
...
LABEL_30:
  ...
  if (v38 == 3)
  {
    ...
    if (v177 == 1)
    {
      ...
      v122 = v37;
      v123 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v121, "localizedStringForKey:value:table:", CFSTR("%@_%@_%@_AND_ONE_OTHER"), &stru_10007F010, CFSTR("TelephonyUtilities")));
    ...
    else
    {
      if (!v177)
      {
        ...
        v56 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v55, "localizedStringForKey:value:table:", CFSTR("%@_%@_AND_%@"), &stru_10007F010, CFSTR("TelephonyUtilities")));
...
LABEL_73:
        ...
        v139 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v138, "localizedStringForKey:value:table:", CFSTR("%@_%@_AND_%@"), &stru_10007F010, CFSTR("TelephonyUtilities")));
      ...
      v129 = objc_claimAutoreleasedReturnValue(objc_msgSend(v171, "localizedStringForKey:value:table:", CFSTR("%@_%@_%@_AND_%@_OTHERS"), &stru_10007F010, CFSTR("TelephonyUtilities")));
  ...
  if (v38 == 2)
  {
    if (v177 == 1)
    {
      ...
      v63 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v62, "localizedStringForKey:value:table:", CFSTR("%@_%@_AND_ONE_OTHER"), &stru_10007F010, CFSTR("TelephonyUtilities")));
    ...
    else
    {
      ...
      if (v177)
      {
        ...
        v63 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v172, "localizedStringForKey:value:table:", CFSTR("%@_%@_AND_%@_OTHERS"), &stru_10007F010, CFSTR("TelephonyUtilities")));
        v64 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "objectAtIndexedSubscript:", 0));
        v65 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "objectAtIndexedSubscript:", 1));
      ...
      else
      {
        ...
        v63 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v62, "localizedStringForKey:value:table:", CFSTR("%@_AND_%@"), &stru_10007F010, CFSTR("TelephonyUtilities")));
        v64 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "objectAtIndexedSubscript:", 0));
        v65 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "objectAtIndexedSubscript:", 1));
        v66 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", v63, v64, v65));
      }
    ...
    v150 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v149, "localizedStringForKey:value:table:", CFSTR("%@_AND_%@"), &stru_10007F010, CFSTR("TelephonyUtilities")));
  ...
  else if (v38 == 1)
  {
    ...
    if (v177 == 1)
    {
      ...
      v109 = v37;
      v110 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v39, "localizedStringForKey:value:table:", CFSTR("%@_AND_ONE_OTHER"), &stru_10007F010, CFSTR("TelephonyUtilities")));
    ...
    else
    {
      if (v177)
      {
        ...
        v115 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v114, "localizedStringForKey:value:table:", CFSTR("%@_AND_%@_OTHERS"), &stru_10007F010, CFSTR("TelephonyUtilities")));
        v175 = v37;
  ...
  else
  {
    ...
    else
    {
      ...
      v69 = objc_claimAutoreleasedReturnValue(objc_msgSend(v178, "localizedStringForKey:value:table:", CFSTR("%@_%@_%@_AND_%@_OTHER"), &stru_10007F010, CFSTR("TelephonyUtilities")));
      ...
      v79 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v179, "localizedStringForKey:value:table:", CFSTR("%@_%@_%@_AND_%@_OTHER"), &stru_10007F010, CFSTR("TelephonyUtilities")));
...
- (id)fetchRecentCalls
{
  ...
  if (objc_msgSend(v4, "isEqualToArray:", v6))
  {
    ...
    {
      *(_WORD *)v13 = 0;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "Recent calls array has not changed. Ignoring", v13, 2u);
    }
...
- (void)performSynchronousBlock:(id)a3
{
  ...
  if (dispatch_get_specific(off_100090B60) == self)
  {
...
LABEL_18:
  if (v20)
    ...
    v21 = v18;
LABEL_34:
  v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "localizedStringForKey:value:table:", v21, &stru_10007F010, 0));
...
- (id)localizedSubtitleForRecentCall:(id)a3
{
  ...
  if (v7)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("%@_BLOCKED_BY"), &stru_10007F010, CFSTR("PHRecents")));
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController fetchCallProviderForRecentCall:](self, "fetchCallProviderForRecentCall:", v4));
  v12 = v11;
  if (!v11)
    goto LABEL_26;
  if (objc_msgSend(v11, "isFaceTimeProvider"))
  {
    v13 = objc_msgSend(v4, "mediaType");
    v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v15 = v14;
    if (v13 == (id)2)
      v16 = CFSTR("RECENTS_FACETIME_VIDEO");
    else
      v16 = CFSTR("RECENTS_FACETIME_AUDIO");
    v18 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", v16, &stru_10007F010, CFSTR("PHRecents")));
    goto LABEL_22;
  }
  if (!objc_msgSend(v12, "isTelephonyProvider"))
  {
    v25 = objc_msgSend(v4, "mediaType");
    if (v25 == (id)1)
    {
      v26 = CFSTR("RECENTS_CALL_PROVIDER_NAME_%@_CALL_CATEGORY_AUDIO");
      goto LABEL_37;
    }
    if (v25 == (id)2)
    {
      v26 = CFSTR("RECENTS_CALL_PROVIDER_NAME_%@_CALL_CATEGORY_VIDEO");
LABEL_37:
      v33 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
      v34 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v33, "localizedStringForKey:value:table:", v26, &stru_10007F010, CFSTR("PHRecents")));
      v35 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "localizedName"));
      v18 = (id)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", v34, v35));
...
LABEL_26:
  ...
  v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "remoteParticipantHandles"));
  v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "anyObject"));
  ...
  v58 = 0u;
  v59 = 0u;
  obj = (id)objc_claimAutoreleasedReturnValue(-[PHRecentsController contactHandlesForHandle:](self, "contactHandlesForHandle:", v15));
  ...
  while (2)
  {
    for (i = 0; i != v18; i = (char *)i + 1)
    {
      if (*(_QWORD *)v57 != v19)
        objc_enumerationMutation(obj);
      v21 = *(_QWORD *)(*((_QWORD *)&v56 + 1) + 8 * (_QWORD)i);
      v22 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController contactCache](self, "contactCache"));
      v23 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v22, "objectForKeyedSubscript:", v21));
      v24 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v23, "value"));
      ...
      {
        v15 = v54;
        v29 = objc_msgSend(v54, "type");
        if (v29 == (id)3)
        {
          v30 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v24, "labeledValueForEmailAddress:", v21));
          v31 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v30, "label"));
        ...
        else
        {
          if (v29 == (id)2)
          {
            v36 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "isoCountryCode"));
            v31 = (void *)objc_claimAutoreleasedReturnValue(+[CNPhoneNumber phoneNumberWithDigits:countryCode:](CNPhoneNumber, "phoneNumberWithDigits:countryCode:", v21, v36));

            if (v31)
              v30 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v24, "labeledValueForPhoneNumber:", v31));
            else
              v30 = 0;
            v37 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v30, "label"));
            v18 = (id)objc_claimAutoreleasedReturnValue(+[CNLabeledValue localizedDisplayStringForLabel:propertyName:](CNLabeledValue, "localizedDisplayStringForLabel:propertyName:", v37, CNContactPhoneNumbersKey));
...
LABEL_46:
          ...
          v30 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v24, "labeledValueForSocialProfileWithUsername:", v21));
          v31 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v30, "label"));
          v32 = &CNContactSocialProfilesKey;
        }
        v18 = (id)objc_claimAutoreleasedReturnValue(+[CNLabeledValue localizedDisplayStringForLabel:propertyName:](CNLabeledValue, "localizedDisplayStringForLabel:propertyName:", v31, *v32));
LABEL_45:
...
LABEL_48:
  if (-[PHRecentsController isLocalizedSubtitleUnknown:](self, "isLocalizedSubtitleUnknown:", v18)
    && objc_msgSend(v4, "isJunk"))
  {
    v38 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "junkIdentificationCategory"));
    if (v38)
      v39 = (__CFString *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "junkIdentificationCategory"));
    else
      v39 = CFSTR("MAYBE_JUNK");

    v40 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v41 = objc_claimAutoreleasedReturnValue(objc_msgSend(v40, "localizedStringForKey:value:table:", v39, &stru_10007F010, CFSTR("PHRecents")));

    v18 = (id)v41;
  }
  if (-[PHRecentsController isLocalizedSubtitleUnknown:](self, "isLocalizedSubtitleUnknown:", v18))
  {
    v42 = (void *)objc_claimAutoreleasedReturnValue(+[TUMetadataDestinationID metadataDestinationIDsForCHRecentCall:](TUMetadataDestinationID, "metadataDestinationIDsForCHRecentCall:", v4));
    v43 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v42, "firstObject"));

    if (v43)
    {
      v44 = (void *)objc_claimAutoreleasedReturnValue(-[PHRecentsController metadataCache](self, "metadataCache"));
      v45 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v44, "metadataForDestinationID:", v43));
      ...
      if (v45)
      {
        ...
        {
          v46 = objc_msgSend(v45, "metadataForProvider:", objc_opt_class(TUMapsMetadataCacheDataProvider));
        ...
        if (-[PHRecentsController isLocalizedSubtitleUnknown:](self, "isLocalizedSubtitleUnknown:", v18)
          && (objc_msgSend(v4, "callerIdIsBlocked") & 1) == 0)
        {
          v48 = objc_msgSend(v45, "metadataForProvider:", objc_opt_class(TUCallDirectoryMetadataCacheDataProvider));
        ...
        if (-[PHRecentsController isLocalizedSubtitleUnknown:](self, "isLocalizedSubtitleUnknown:", v18))
        {
          v50 = objc_msgSend(v45, "metadataForProvider:", objc_opt_class(TUSuggestionsMetadataCacheDataProvider));
        ...
        if (-[PHRecentsController isLocalizedSubtitleUnknown:](self, "isLocalizedSubtitleUnknown:", v18))
        {
          v52 = objc_msgSend(v45, "metadataForProvider:", objc_opt_class(TUGeoLocationMetadataCacheDataProvider));
...
LABEL_27:
  ...
  {
    v27 = objc_claimAutoreleasedReturnValue(-[PHRecentsController unknownLabel](self, "unknownLabel"));
...
- (id)unknownLabel
{
  if (qword_100092298 != -1)
    dispatch_once(&qword_100092298, &stru_10007D960);
  return (id)qword_100092290;
}
