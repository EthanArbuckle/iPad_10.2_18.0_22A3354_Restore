...
- (id)sr_sirilandShim
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet calls](self, "calls"));
  v4 = v3;
  if (v3 && objc_msgSend(v3, "count"))
  {
    v66 = v4;
    v5 = objc_alloc_init((Class)SFCard);
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet title](self, "title"));
    objc_msgSend(v5, "setTitle:", v6);

    objc_msgSend(v5, "setType:", 1);
    v7 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet aceId](self, "aceId"));
    objc_msgSend(v5, "setCardId:", v7);

    objc_msgSend(v5, "setSource:", 2);
    v8 = objc_alloc_init((Class)NSMutableArray);
    v9 = objc_alloc_init((Class)NSMutableArray);
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet calls](self, "calls"));
    ...
    v67 = v9;
    v70 = v67;
    v12 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet _callHistoryRowsForCalls:callOperation:](self, "_callHistoryRowsForCalls:callOperation:", v10, v68));

    v13 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet _searchCallHistoryIntentForVoicemail:](self, "_searchCallHistoryIntentForVoicemail:", 0));
    v65 = v11;
    v14 = (void *)objc_claimAutoreleasedReturnValue(-[SAPhoneCallSnippet _searchCallHistoryIntentResponseForCallRecords:](self, "_searchCallHistoryIntentResponseForCallRecords:", v11));
    ...
    *(_QWORD *)&v36 = objc_opt_class(v13, v35).n128_u64[0];
    ...
    v45 = (SAPhoneCallSnippet *)objc_alloc_init((Class)SACardSnippet);
    ...
    -[SAPhoneCallSnippet setCardData:](v45, "setCardData:", v47);

    v48 = objc_msgSend(v67, "copy");
    -[SAPhoneCallSnippet setReferencedCommands:](v45, "setReferencedCommands:", v48);
    ...
    if (AFIsInternalInstall(v50, v51))
    {
      ...
      if (v53)
      {
        v54 = sub_10005B08C(CFSTR("CALL_HISTORY_SASH_TITLE"));
    ...
    -[SAPhoneCallSnippet setSash:](v45, "setSash:", v49);
    -[SAPhoneCallSnippet sr_applySnippetProperties:](v45, "sr_applySnippetProperties:", self);
