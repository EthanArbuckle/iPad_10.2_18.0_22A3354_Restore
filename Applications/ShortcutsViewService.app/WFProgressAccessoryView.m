...
- (WFProgressAccessoryView)initWithTintColor:(id)a3 runningContext:(id)a4
{
  ...
  v7 = a4;
  v24.receiver = self;
  v24.super_class = (Class)WFProgressAccessoryView;
  v8 = -[WFProgressAccessoryView initWithFrame:](&v24, "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  if (v8)
  {
    v9 = +[NSBundle bundleForClass:](NSBundle, "bundleForClass:", objc_opt_class(WFProgressAccessoryView));
    v10 = (void *)objc_claimAutoreleasedReturnValue(v9);
    v11 = objc_msgSend(objc_alloc((Class)BSUICAPackageView), "initWithPackageName:inBundle:", CFSTR("zoomy-progress-D73"), v10);
    objc_msgSend(v11, "setState:", CFSTR("compact"));
    micaView = v8->_micaView;
    v8->_micaView = (BSUICAPackageView *)v11;
    v13 = v11;
    ...
    v15 = (UIButton *)objc_claimAutoreleasedReturnValue(+[UIButton buttonWithConfiguration:primaryAction:](UIButton, "buttonWithConfiguration:primaryAction:", v14, 0));
    -[UIButton addTarget:action:forControlEvents:](v15, "addTarget:action:forControlEvents:", v8, "touchedDownCancelButton", 17);
    -[UIButton addTarget:action:forControlEvents:](v15, "addTarget:action:forControlEvents:", v8, "touchedUpCancelButton", 480);
    cancelButton = v8->_cancelButton;
    v8->_cancelButton = v15;
    v17 = v15;

    objc_storeStrong((id *)&v8->_runningContext, a4);
    -[WFProgressAccessoryView addSubview:](v8, "addSubview:", v13);
    -[WFProgressAccessoryView addSubview:](v8, "addSubview:", v17);
    -[WFProgressAccessoryView tintControlWithColor:animated:](v8, "tintControlWithColor:animated:", v6, 0);
    -[WFProgressAccessoryView updateProgressWithValue:](v8, "updateProgressWithValue:", 0.0);
    v25[0] = WFWorkflowRunKindAppShortcut;
    v25[1] = WFWorkflowRunKindAppIntent;
    v25[2] = WFWorkflowRunKindContextualAction;
    v25[3] = WFWorkflowRunKindINShortcut;
    v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v25, 4));

    v19 = (void *)objc_claimAutoreleasedReturnValue(-[WFProgressAccessoryView runningContext](v8, "runningContext"));
    v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v19, "runKind"));
    LODWORD(cancelButton) = objc_msgSend(v18, "containsObject:", v20);

    if ((_DWORD)cancelButton)
      v21 = 1;
    else
      v21 = 3;
    -[WFProgressAccessoryView setProgressSuppressionState:](v8, "setProgressSuppressionState:", v21);
    v22 = v8;
