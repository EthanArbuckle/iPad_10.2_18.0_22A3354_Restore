...
{
  return (STSelectUserIntentResponse *)sub_1000444F0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (STSelectUserIntentResponse)initWithBackingStore:(id)a3
{
  return (STSelectUserIntentResponse *)sub_1000444F0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
