...
- (int64_t)code
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___STSelectUserIntentResponse_code, v4, 0, 0);
  return *v2;
}
...
- (void)setCode:(int64_t)a3
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___STSelectUserIntentResponse_code, v5, 1, 0);
  *v4 = a3;
}
...
{
  id v6;
  STSelectUserIntentResponse *v7;
  int64_t *v8;
  STSelectUserIntentResponse *v9;
  _BYTE v11[24];

  v6 = a4;
  v7 = -[STSelectUserIntentResponse init](self, "init");
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___STSelectUserIntentResponse_code);
  swift_beginAccess((char *)v7 + OBJC_IVAR___STSelectUserIntentResponse_code, v11, 1, 0);
  *v8 = a3;
  v9 = v7;
  -[STSelectUserIntentResponse setUserActivity:](v9, "setUserActivity:", v6);
...
- (STSelectUserIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___STSelectUserIntentResponse_code) = 0;
  ...
  return -[STSelectUserIntentResponse init](&v3, "init");
}

- (STSelectUserIntentResponse)initWithCoder:(id)a3
{
  return (STSelectUserIntentResponse *)sub_10000849C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (STSelectUserIntentResponse)initWithBackingStore:(id)a3
{
  return (STSelectUserIntentResponse *)sub_10000849C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
