...
- (STSelectUserIntent)init
{
  ...
  return -[STSelectUserIntent init](&v3, "init");
}
...
- (STSelectUserIntent)initWithCoder:(id)a3
{
  ...
  return -[STSelectUserIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (STSelectUserIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for STSelectUserIntent();
  v11 = -[STSelectUserIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (STSelectUserIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for STSelectUserIntent();
  v15 = -[STSelectUserIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
