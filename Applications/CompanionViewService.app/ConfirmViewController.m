...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  -[ConfirmViewController viewDidAppear:](&v4, "viewDidAppear:", a3);
  sub_100004268(self);
}
...
{
  self->_cancelled = 1;
  -[ConfirmViewController dismissViewControllerAnimated:completion:](self, "dismissViewControllerAnimated:completion:", 1, 0);
}
