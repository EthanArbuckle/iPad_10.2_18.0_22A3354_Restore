...
- (void)viewDidLoad
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)PKPeerPaymentMessagesContentOfflineViewController;
  -[PKPeerPaymentMessagesContentOfflineViewController viewDidLoad](&v14, "viewDidLoad");
  ...
  v12 = PKLocalizedPeerPaymentString(CFSTR("PEER_PAYMENT_MESSAGES_OFFLINE_TITLE"));
