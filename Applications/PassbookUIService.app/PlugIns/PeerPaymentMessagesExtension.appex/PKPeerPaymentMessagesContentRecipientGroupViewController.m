...
- (void)viewDidLoad
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)PKPeerPaymentMessagesContentRecipientGroupViewController;
  -[PKPeerPaymentMessagesContentRecipientGroupViewController viewDidLoad](&v14, "viewDidLoad");
  ...
  v12 = PKLocalizedPeerPaymentString(CFSTR("PEER_PAYMENT_MESSAGES_RECIPIENT_INVALID_GROUP"));
