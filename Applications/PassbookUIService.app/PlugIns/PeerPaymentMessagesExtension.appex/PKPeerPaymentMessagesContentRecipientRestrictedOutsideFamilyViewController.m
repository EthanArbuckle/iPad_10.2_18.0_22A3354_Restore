...
- (void)viewDidLoad
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)PKPeerPaymentMessagesContentRecipientRestrictedOutsideFamilyViewController;
  -[PKPeerPaymentMessagesContentRecipientRestrictedOutsideFamilyViewController viewDidLoad](&v10, "viewDidLoad");
...
- (void)reloadContent
{
  ...
  v3 = PKLocalizedPeerPaymentLexingtonString(CFSTR("PEER_PAYMENT_MESSAGES_RECIPIENT_FAMILY_RESTRICTED_MESSAGE"));
