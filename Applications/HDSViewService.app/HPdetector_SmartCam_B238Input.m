...
{
  id v5;
  HPdetector_SmartCam_B238Input *v6;
  ...
  v6 = -[HPdetector_SmartCam_B238Input init](&v9, "init");
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_1000C71A8);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SmartCam_B238Input imageDescriptors](self, "imageDescriptors"));
