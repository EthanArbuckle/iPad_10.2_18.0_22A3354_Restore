...
+ (id)URLOfModelInThisBundle
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "pathForResource:ofType:", CFSTR("HPdetector_SmartCam_B238"), CFSTR("mlmodelc")));
...
{
  id v5;
  HPdetector_SmartCam_B238 *v6;
  HPdetector_SmartCam_B238 *v7;
  HPdetector_SmartCam_B238 *v8;
  objc_super v10;
  ...
  if (v5)
  {
    ...
    v6 = -[HPdetector_SmartCam_B238 init](&v10, "init");
    v7 = v6;
    if (v6)
...
- (HPdetector_SmartCam_B238)init
{
  id v3;
  void *v4;
  HPdetector_SmartCam_B238 *v5;

  v3 = objc_msgSend((id)objc_opt_class(self), "URLOfModelInThisBundle");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = -[HPdetector_SmartCam_B238 initWithContentsOfURL:error:](self, "initWithContentsOfURL:error:", v4, 0);
...
- (HPdetector_SmartCam_B238)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  id v7;
  void *v8;
  HPdetector_SmartCam_B238 *v9;

  v6 = a3;
  v7 = objc_msgSend((id)objc_opt_class(self), "URLOfModelInThisBundle");
  v8 = (void *)objc_claimAutoreleasedReturnValue(v7);
  v9 = -[HPdetector_SmartCam_B238 initWithContentsOfURL:configuration:error:](self, "initWithContentsOfURL:configuration:error:", v8, v6, a4);
...
- (HPdetector_SmartCam_B238)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = -[HPdetector_SmartCam_B238 initWithMLModel:](self, "initWithMLModel:", v5);
    v6 = self;
  }
  else
  {
...
- (HPdetector_SmartCam_B238)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = -[HPdetector_SmartCam_B238 initWithMLModel:](self, "initWithMLModel:", v6);
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SmartCam_B238 predictionFromFeatures:options:error:](self, "predictionFromFeatures:options:error:", v6, v7, a4));
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  void *v10;
  void *v11;
  HPdetector_SmartCam_B238Output *v12;
  void *v13;
  void *v14;
  HPdetector_SmartCam_B238Output *v15;

  v8 = a4;
  v9 = a3;
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SmartCam_B238 model](self, "model"));
  ...
  if (v11)
  {
    ...
    v15 = -[HPdetector_SmartCam_B238Output initWithHomePodDetected:](v12, "initWithHomePodDetected:", v14);
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SmartCam_B238 model](self, "model"));
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SmartCam_B238 model](self, "model"));
...
{
  id v6;
  HPdetector_SmartCam_B238Input *v7;
  void *v8;

  v6 = a3;
  v7 = -[HPdetector_SmartCam_B238Input initWithImageDescriptors:]([HPdetector_SmartCam_B238Input alloc], "initWithImageDescriptors:", v6);

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SmartCam_B238 predictionFromFeatures:error:](self, "predictionFromFeatures:error:", v7, a4));
  return v8;
}
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14;
  void *v15;
  HPdetector_SmartCam_B238Output *v16;
  void *v17;
  void *v18;
  HPdetector_SmartCam_B238Output *v19;
  id v21;
  id v22;
  ...
  if (v12)
  {
    ...
    if ((uint64_t)objc_msgSend(v12, "count") >= 1)
    {
      ...
      do
      {
        ...
        v19 = -[HPdetector_SmartCam_B238Output initWithHomePodDetected:](v16, "initWithHomePodDetected:", v18);
