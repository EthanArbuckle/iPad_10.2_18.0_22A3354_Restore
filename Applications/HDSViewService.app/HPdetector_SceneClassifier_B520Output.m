...
- (HPdetector_SceneClassifier_B520Output)initWithHomePodDetected:(id)a3
{
  ...
  HPdetector_SceneClassifier_B520Output *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HPdetector_SceneClassifier_B520Output;
  v6 = -[HPdetector_SceneClassifier_B520Output init](&v9, "init");
  v7 = v6;
  if (v6)
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:](NSSet, "setWithArray:", &off_1000C71F0);
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(-[HPdetector_SceneClassifier_B520Output HomePodDetected](self, "HomePodDetected"));
