...
- (id)getStringDefaultsForKey:(id)a3 withFallback:(id)a4
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    v21 = 2112;
    v22 = v7;
    _os_log_debug_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_DEBUG, "Default setting [%@] with value [s:%@] and fallback [s:%@]", (uint8_t *)&v17, 0x20u);
  }
...
- (int)getIntegerDefaultsForKey:(id)a3 withFallback:(int)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 1024;
    v20 = a4;
    _os_log_debug_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_DEBUG, "Default setting [%@] with value [i:%i] and fallback [i:%i]", (uint8_t *)&v15, 0x18u);
  }
...
- (BOOL)getBoolDefaultsForKey:(id)a3 withFallback:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v19 = 1024;
    v20 = v4;
    _os_log_debug_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_DEBUG, "Default setting [%@] with value [b:%i] and fallback [b:%i]", (uint8_t *)&v15, 0x18u);
  }
...
- (float)getFloatDefaultsForKey:(id)a3 withFallback:(float)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2048;
    v21 = a4;
    _os_log_debug_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEBUG, "Default setting [%@] with value [f:%f] and fallback [f:%f]", (uint8_t *)&v16, 0x20u);
  }
...
- (double)getDoubleDefaultsForKey:(id)a3 withFallback:(double)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2048;
    v21 = a4;
    _os_log_debug_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEBUG, "Default setting [%@] with value [d:%f] and fallback [d:%f]", (uint8_t *)&v16, 0x20u);
  }
