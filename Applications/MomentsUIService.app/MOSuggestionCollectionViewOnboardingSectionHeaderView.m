...
- (void)pressedNewEntryButton
{
  ...
  v2 = *(void (**)(_QWORD *__return_ptr))((swift_isaMask & (uint64_t)self->super.super.super.super.isa) + 0x78);
  v3 = self;
  v2(v9);
  if (v9[3])
  {
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC16MomentsUIService53MOSuggestionCollectionViewOnboardingSectionHeaderView_onboardingTipConstraints));
