...
- (ConfigurationIntent)init
{
  ...
  return -[ConfigurationIntent init](&v3, "init");
}
...
- (ConfigurationIntent)initWithCoder:(id)a3
{
  ...
  return -[ConfigurationIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (ConfigurationIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for ConfigurationIntent();
  v11 = -[ConfigurationIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (ConfigurationIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for ConfigurationIntent();
  v15 = -[ConfigurationIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
