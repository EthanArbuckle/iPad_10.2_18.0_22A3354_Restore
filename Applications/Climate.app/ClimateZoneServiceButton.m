@implementation ClimateZoneServiceButton

- (_TtC7Climate24ClimateZoneServiceButton)init
{
  _TtC7Climate24ClimateZoneServiceButton *result;

  result = (_TtC7Climate24ClimateZoneServiceButton *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD00000000000001FLL, 0x800000010008BB20, "Climate/ClimateZoneServiceButton.swift", 38, 2, 25, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC7Climate24ClimateZoneServiceButton_temperature));
}
