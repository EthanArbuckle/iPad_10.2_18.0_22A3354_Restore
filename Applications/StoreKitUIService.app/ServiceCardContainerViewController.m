...
- (void)viewDidLoad
{
  ...
  -[ServiceCardContainerViewController viewDidLoad](&v3, "viewDidLoad");
...
- (void)setChildViewController:(id)a3
{
  ...
  v12 = a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[ServiceCardContainerViewController childViewController](self, "childViewController"));

  v6 = v12;
  if (v5 != v12)
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(-[ServiceCardContainerViewController childViewController](self, "childViewController"));
    ...
    if (v12)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "view"));
      v10 = (void *)objc_claimAutoreleasedReturnValue(-[ServiceCardContainerViewController view](self, "view"));
      objc_msgSend(v10, "bounds");
      objc_msgSend(v9, "setFrame:");

      objc_msgSend(v9, "setAutoresizingMask:", 18);
      v11 = (void *)objc_claimAutoreleasedReturnValue(-[ServiceCardContainerViewController view](self, "view"));
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)ServiceCardContainerViewController;
  -[ServiceCardContainerViewController dealloc](&v3, "dealloc");
}
