...
- (void)dismissAnimated:(BOOL)a3
{
  ...
  v3 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[ServiceSKUIDonationViewController embeddedParent](self, "embeddedParent"));
  objc_msgSend(v5, "dismissHostViewController");

  v6.receiver = self;
  v6.super_class = (Class)ServiceSKUIDonationViewController;
  -[ServiceSKUIDonationViewController dismissAnimated:](&v6, "dismissAnimated:", v3);
}
...
- (void)dismissViewControllerAnimated:(BOOL)a3 completion:(id)a4
{
  ...
  v4 = a3;
  v6 = a4;
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[ServiceSKUIDonationViewController embeddedParent](self, "embeddedParent"));
  objc_msgSend(v7, "dismissHostViewController");

  v8.receiver = self;
  v8.super_class = (Class)ServiceSKUIDonationViewController;
  -[ServiceSKUIDonationViewController dismissViewControllerAnimated:completion:](&v8, "dismissViewControllerAnimated:completion:", v4, v6);
