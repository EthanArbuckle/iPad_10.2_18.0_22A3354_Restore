...
- (void)viewDidLoad
{
  ...
  -[FunCameraTextViewController setStickerBrowserViewController:](self, "setStickerBrowserViewController:", v4);

  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
  objc_msgSend(v5, "setDataSource:", self);

  v6 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "view"));

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
  -[FunCameraTextViewController addChildViewController:](self, "addChildViewController:", v8);

  v9 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController view](self, "view"));
  objc_msgSend(v9, "addSubview:", v7);

  objc_msgSend(v7, "setTranslatesAutoresizingMaskIntoConstraints:", 0);
  v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "leadingAnchor"));
  v27 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController view](self, "view"));
  ...
  v23 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController view](self, "view"));
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController view](self, "view"));
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController view](self, "view"));
  ...
  v18 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
...
- (void)updateSnapshotWithCompletionBlock:(id)a3
{
  ...
  v4 = a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[FunCameraTextViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
