...
- (void)setSourceView:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[PortalView portalLayer](self, "portalLayer"));
...
- (BOOL)hidesSourceView
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[PortalView portalLayer](self, "portalLayer"));
...
- (void)setHidesSourceView:(BOOL)a3
{
  ...
  v3 = a3;
  v4 = (id)objc_claimAutoreleasedReturnValue(-[PortalView portalLayer](self, "portalLayer"));
