...
- (GenericRequest)initWithDictionary:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "objectForKeyedSubscript:", CFSTR("createdTimeInterval")));
...
- (id)compile
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[GenericRequest date](self, "date"));
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v4, CFSTR("createdTimeInterval"));
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[GenericRequest uniqueIdentifier](self, "uniqueIdentifier"));
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v6, CFSTR("uniqueIdentifier"));

  v7 = (void *)objc_claimAutoreleasedReturnValue(-[GenericRequest itemIdentifier](self, "itemIdentifier"));
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v7, CFSTR("itemIdentifier"));

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[GenericRequest localizations](self, "localizations"));
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", -[GenericRequest status](self, "status")));
...
- (NSString)description
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[GenericRequest ap_generateDescriptionWithSubObjects:](self, "ap_generateDescriptionWithSubObjects:", v3));
