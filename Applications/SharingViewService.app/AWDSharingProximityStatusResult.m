...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)AWDSharingProximityStatusResult;
  v3 = -[AWDSharingProximityStatusResult description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AWDSharingProximityStatusResult dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", self->_rssi));
...
LABEL_7:
      if ((has & 2) == 0)
        goto LABEL_8;
LABEL_13:
      v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_dismissType));
      objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("dismissType"));
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", self->_smoothedRSSI));
  objc_msgSend(v3, "setObject:forKey:", v10, CFSTR("smoothedRSSI"));
...
LABEL_8:
  ...
  {
LABEL_9:
    v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_visibleMs));
    objc_msgSend(v3, "setObject:forKey:", v7, CFSTR("visibleMs"));
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 4) != 0)
  {
    PBDataWriterWriteInt32Field(v6, self->_rssi, 3);
    has = (char)self->_has;
    if ((has & 8) == 0)
    {
LABEL_7:
      if ((has & 2) == 0)
        goto LABEL_8;
LABEL_13:
      PBDataWriterWriteUint32Field(v6, self->_dismissType, 5);
      if ((*(_BYTE *)&self->_has & 0x10) == 0)
        goto LABEL_10;
      goto LABEL_9;
    }
  ...
  PBDataWriterWriteInt32Field(v6, self->_smoothedRSSI, 4);
  has = (char)self->_has;
  if ((has & 2) != 0)
    goto LABEL_13;
LABEL_8:
  if ((has & 0x10) != 0)
LABEL_9:
    PBDataWriterWriteUint32Field(v6, self->_visibleMs, 6);
LABEL_10:
...
LABEL_29:
  ...
  if ((has & 4) != 0)
  {
    if ((v7 & 4) == 0 || self->_rssi != *((_DWORD *)v4 + 5))
      goto LABEL_29;
  }
  else if ((v7 & 4) != 0)
  {
  ...
  if ((has & 8) != 0)
  {
    if ((v7 & 8) == 0 || self->_smoothedRSSI != *((_DWORD *)v4 + 8))
      goto LABEL_29;
  }
  else if ((v7 & 8) != 0)
  {
  ...
  if ((has & 2) != 0)
  {
    if ((v7 & 2) == 0 || self->_dismissType != *((_DWORD *)v4 + 4))
      goto LABEL_29;
  }
  else if ((v7 & 2) != 0)
  {
  ...
  if ((has & 0x10) != 0)
  {
    if ((v7 & 0x10) == 0 || self->_visibleMs != *((_DWORD *)v4 + 9))
      goto LABEL_29;
    v9 = 1;
  }
LABEL_30:
