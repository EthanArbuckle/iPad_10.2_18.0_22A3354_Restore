...
- (void)activate
{
  ...
  objc_msgSend(v5, "setAllowNonSecureHTTP:", IsAppleInternalBuild(v5) != 0);
  ...
  v17 = objc_opt_new(ACAccountStore);
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[ACAccountStore aa_primaryAppleAccount](v17, "aa_primaryAppleAccount"));
  v9 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithObjects:", &off_100183698, &off_1001836E8, 0);
  v10 = v9;
  if (self->_showWarranty)
    objc_msgSend(v9, "insertObject:atIndex:", &off_1001836C0, 1);
  if (objc_msgSend(v8, "aa_needsToVerifyTerms"))
    objc_msgSend(v10, "addObject:", &off_100183710);
  v23[0] = CFSTR("terms");
  v23[1] = CFSTR("format");
  v24[0] = v10;
  ...
  v12 = objc_msgSend(objc_alloc((Class)AAGenericTermsUIRequest), "initWithAccount:parameters:preferPassword:", v8, v11, 0);
  if (v12)
  {
    location = 0;
    ...
    -[RemoteUIController setHandlerForElementName:handler:](v13, "setHandlerForElementName:handler:", CFSTR("agree"), v20);
    ...
    -[RemoteUIController setHandlerForElementName:handler:](v14, "setHandlerForElementName:handler:", CFSTR("disagree"), v18);
    v15 = self->_termsController;
    v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "urlRequest"));
    -[RemoteUIController loadRequest:completion:](v15, "loadRequest:completion:", v16, &stru_10017DBC8);
...
- (void)_handleAgreeFromObjectModel:(id)a3
{
  ...
  v6 = objc_opt_new(ACAccountStore);
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[ACAccountStore aa_primaryAppleAccount](v6, "aa_primaryAppleAccount"));
...
{
  if (a4)
    -[SFTermsAndConditionsManager loadOfflineTerms](self, "loadOfflineTerms", a3);
}
...
- (void)remoteUIController:(id)a3 willPresentModalNavigationController:(id)a4
{
  ...
  if (self->_showingOfflineTerms)
  {
    ...
    v9 = SFLocalizedStringForKey(CFSTR("TERMS_DISAGREE_BUTTON_TITLE"));
    ...
    v14 = SFLocalizedStringForKey(CFSTR("TERMS_AGREE_BUTTON_TITLE"));
