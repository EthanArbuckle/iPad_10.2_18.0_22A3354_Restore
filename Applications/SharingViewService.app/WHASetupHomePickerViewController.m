...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupHomePickerViewController viewWillAppear:]", 30, "HomePicker ViewWillAppear\n");
  v5.receiver = self;
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupHomePickerViewController viewDidDisappear:]", 30, "HomePicker ViewDidDisappear\n");
  v5.receiver = self;
  v5.super_class = (Class)WHASetupHomePickerViewController;
  -[WHASetupHomePickerViewController viewDidDisappear:](&v5, "viewDidDisappear:", v3);
}
...
- (void)handleChooseButton:(id)a3
{
  ...
  WHASetupHomePickerViewController *v11;

  v4 = a3;
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupHomePickerViewController handleChooseButton:]", 30, "HomePicker Choose button\n");
  if (!BYTE1(self->_chooseButton))
  {
    BYTE1(self->_chooseButton) = 1;
    objc_msgSend(*(id *)((char *)&self->_homePickerView + 1), "setHidden:", 1);
    objc_msgSend(*(id *)(&self->_homeChosen + 1), "setHidden:", 0);
    ...
    else
    {
      ...
      {
        v7 = v6;
        if (v6 <= (uint64_t)objc_msgSend(*(id *)((char *)&self->_defaultHomeIndex + 1), "count"))
        {
          v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(*(id *)((char *)&self->_defaultHomeIndex + 1), "objectAtIndexedSubscript:", v7));
          objc_msgSend(self->super._mainController, "chooseHome:", v8);
...
- (void)handleDismissButton:(id)a3
{
  ...
  v4 = a3;
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupHomePickerViewController handleDismissButton:]", 30, "HomePicker Dismiss button\n");
...
- (int64_t)pickerView:(id)a3 numberOfRowsInComponent:(int64_t)a4
{
  ...
  return (int64_t)objc_msgSend(v5, "count");
}
...
- (id)pickerView:(id)a3 titleForRow:(int64_t)a4 forComponent:(int64_t)a5
{
  ...
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(&off_100183838, "objectAtIndexedSubscript:", a4));
  }
  else if (a4 < 0 || (uint64_t)objc_msgSend(*(id *)((char *)&self->_defaultHomeIndex + 1), "count") <= a4)
  {
    v7 = 0;
  }
  else
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(*(id *)((char *)&self->_defaultHomeIndex + 1), "objectAtIndexedSubscript:", a4));
    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "name"));
...
- (void)setHomes:(id)a3
{
  objc_storeStrong((id *)((char *)&self->_defaultHomeIndex + 1), a3);
}
