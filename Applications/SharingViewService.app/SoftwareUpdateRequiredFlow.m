...
- (void)configureWithContext:(id)a3 completion:(id)a4
{
  ...
  void (*v8)(const void *);
  id v9;
  _TtC18SharingViewService26SoftwareUpdateRequiredFlow *v10;
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v4 = v9.receiver;
  -[SoftwareUpdateRequiredFlow viewDidAppear:](&v9, "viewDidAppear:", v3);
  v5 = (void *)sub_100064288();
  if (v5)
  {
    v6 = v5;
    objc_msgSend(v5, "setStatusBarHidden:withDuration:", 1, 0.3, v9.receiver, v9.super_class);
    swift_unknownObjectRelease(v6);
  }
  v7 = objc_msgSend(objc_allocWithZone((Class)PRXSoftwareUpdateViewController), "init");
  v8 = objc_msgSend(v4, "presentProxCardFlowWithDelegate:initialViewController:", v4, v7);
...
- (_TtC18SharingViewService26SoftwareUpdateRequiredFlow)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v10;
  id v11;
  _TtC18SharingViewService26SoftwareUpdateRequiredFlow *v12;
  objc_super v14;
...
- (void)proxCardFlowDidDismiss
{
  void *v2;
  void *v3;
  _TtC18SharingViewService26SoftwareUpdateRequiredFlow *v4;

  v4 = self;
  v2 = (void *)sub_100064288();
  if (v2)
  {
    v3 = v2;
