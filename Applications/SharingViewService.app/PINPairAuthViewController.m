...
- (void)showWithFlags:(unsigned int)a3 throttleSeconds:(int)a4
{
  ...
  if ((a3 & 0x10000) != 0)
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("AUTH_INCORRECT"), &stru_10017E3D8, CFSTR("Localizable")));
    objc_msgSend(*(id *)(&self->super._didReactivateContainerViewAfterLayingOut + 1), "setText:", v10);

    v9 = objc_claimAutoreleasedReturnValue(+[UIColor systemRedColor](UIColor, "systemRedColor"));
  }
  else
  {
    ...
    objc_msgSend(*(id *)(&self->super._didReactivateContainerViewAfterLayingOut + 1), "setText:", v8);

    v9 = objc_claimAutoreleasedReturnValue(+[UIColor blackColor](UIColor, "blackColor"));
  }
  v11 = (void *)v9;
  objc_msgSend(*(id *)(&self->super._didReactivateContainerViewAfterLayingOut + 1), "setTextColor:", v9);
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (dword_1001A86D8 <= 30 && (dword_1001A86D8 != -1 || _LogCategory_Initialize(&dword_1001A86D8, 30)))
    LogPrintF(&dword_1001A86D8, "-[PINPairAuthViewController viewWillAppear:]", 30, "Auth ViewWillAppear\n");
  v15.receiver = self;
  ...
  objc_msgSend(*(id *)(&self->super._didReactivateContainerViewAfterLayingOut + 1), "setText:", v7);
  ...
  -[PINPairAuthViewController showWithFlags:throttleSeconds:](self, "showWithFlags:throttleSeconds:", 0, 0xFFFFFFFFLL);
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  if (dword_1001A86D8 <= 30 && (dword_1001A86D8 != -1 || _LogCategory_Initialize(&dword_1001A86D8, 30)))
    LogPrintF(&dword_1001A86D8, "-[PINPairAuthViewController viewDidDisappear:]", 30, "Auth ViewDidDisappear\n");
  v6.receiver = self;
  v6.super_class = (Class)PINPairAuthViewController;
  -[PINPairAuthViewController viewDidDisappear:](&v6, "viewDidDisappear:", v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNotificationCenter defaultCenter](NSNotificationCenter, "defaultCenter"));
...
- (void)handleDismissButton:(id)a3
{
  ...
  v4 = a3;
  if (dword_1001A86D8 <= 30 && (dword_1001A86D8 != -1 || _LogCategory_Initialize(&dword_1001A86D8, 30)))
    LogPrintF(&dword_1001A86D8, "-[PINPairAuthViewController handleDismissButton:]", 30, "Dismiss button\n");
...
- (void)_handleKeyboardWillShow:(id)a3
{
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue(-[PINPairAuthViewController view](self, "view"));
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue(-[PINPairAuthViewController view](self, "view"));
...
- (void)_handlePINEntered:(id)a3
{
  ...
  {
    v5 = objc_claimAutoreleasedReturnValue(objc_msgSend(self->super._mainController, "pairingSession"));
    -[NSObject clientTryPIN:](v5, "clientTryPIN:", v4);
  }
