...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupAuthViewController viewWillAppear:]", 30, "Done ViewWillAppear\n");
  v15.receiver = self;
  ...
  -[WHASetupAuthViewController showWithFlags:throttleSeconds:](self, "showWithFlags:throttleSeconds:", 0, 0xFFFFFFFFLL);
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupAuthViewController viewDidDisappear:]", 30, "Done ViewDidDisappear\n");
  v6.receiver = self;
  v6.super_class = (Class)WHASetupAuthViewController;
  -[WHASetupAuthViewController viewDidDisappear:](&v6, "viewDidDisappear:", v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNotificationCenter defaultCenter](NSNotificationCenter, "defaultCenter"));
...
- (void)handleDismissButton:(id)a3
{
  ...
  v4 = a3;
  if (dword_1001A9008 <= 30 && (dword_1001A9008 != -1 || _LogCategory_Initialize(&dword_1001A9008, 30)))
    LogPrintF(&dword_1001A9008, "-[WHASetupAuthViewController handleDismissButton:]", 30, "Dismiss button\n");
...
- (void)_handleKeyboardWillShow:(id)a3
{
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue(-[WHASetupAuthViewController view](self, "view"));
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue(-[WHASetupAuthViewController view](self, "view"));
...
- (void)_handlePINEntered:(id)a3
{
  ...
  {
    objc_msgSend(self->super._mainController, "_pairSetupTryPIN:", v4);
  }
...
- (void)showWithFlags:(unsigned int)a3 throttleSeconds:(int)a4
{
  ...
  objc_msgSend(*(id *)(&self->super._didReactivateContainerViewAfterLayingOut + 1), "setHidden:", 1, *(_QWORD *)&a4);
  v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
  v7 = v6;
  if ((a3 & 0x10000) != 0)
  {
    ...
    objc_msgSend(self->super._mainController, "setBadPINCount:", objc_msgSend(self->super._mainController, "badPINCount") + 1);
  }
  else
  {
