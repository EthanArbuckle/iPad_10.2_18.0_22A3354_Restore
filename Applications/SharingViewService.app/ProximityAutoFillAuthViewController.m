...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (dword_1001A8830 <= 30 && (dword_1001A8830 != -1 || _LogCategory_Initialize(&dword_1001A8830, 30)))
    LogPrintF(&dword_1001A8830, "-[ProximityAutoFillAuthViewController viewWillAppear:]", 30, "Auth ViewWillAppear\n");
  v13.receiver = self;
  ...
  v15[3] = v7;
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v15, 4));
  objc_msgSend(*(id *)((char *)&self->_infoLabel + 1), "setDigits:", v8);

  v9 = *(uint64_t *)((char *)&self->_pinWell1 + 1);
  v14[0] = *(UILabel **)((char *)&self->_pinLabel4 + 1);
  v14[1] = v9;
  v10 = *(uint64_t *)((char *)&self->_pinWell3 + 1);
  v14[2] = *(UIView **)((char *)&self->_pinWell2 + 1);
  v14[3] = v10;
  v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v14, 4));
  objc_msgSend(*(id *)((char *)&self->_infoLabel + 1), "setWells:", v11);
  ...
  v12[3] = &unk_10017E1C8;
  v12[4] = self;
  objc_msgSend(*(id *)((char *)&self->_infoLabel + 1), "setTextChangedHandler:", v12);
  -[ProximityAutoFillAuthViewController showWithFlags:throttleSeconds:](self, "showWithFlags:throttleSeconds:", 0, 0xFFFFFFFFLL);
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v3 = a3;
  if (dword_1001A8830 <= 30 && (dword_1001A8830 != -1 || _LogCategory_Initialize(&dword_1001A8830, 30)))
    LogPrintF(&dword_1001A8830, "-[ProximityAutoFillAuthViewController viewDidDisappear:]", 30, "Auth ViewDidDisappear\n");
  v6.receiver = self;
  v6.super_class = (Class)ProximityAutoFillAuthViewController;
  -[ProximityAutoFillAuthViewController viewDidDisappear:](&v6, "viewDidDisappear:", v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNotificationCenter defaultCenter](NSNotificationCenter, "defaultCenter"));
...
- (void)handleDismissButton:(id)a3
{
  ...
  v4 = a3;
  if (dword_1001A8830 <= 30 && (dword_1001A8830 != -1 || _LogCategory_Initialize(&dword_1001A8830, 30)))
    LogPrintF(&dword_1001A8830, "-[ProximityAutoFillAuthViewController handleDismissButton:]", 30, "Auth Dismiss button\n");
...
- (void)_handleKeyboardWillShow:(id)a3
{
  ...
  v4 = a3;
  if (dword_1001A8830 <= 30 && (dword_1001A8830 != -1 || _LogCategory_Initialize(&dword_1001A8830, 30)))
    LogPrintF(&dword_1001A8830, "-[ProximityAutoFillAuthViewController _handleKeyboardWillShow:]", 30, "Keyboard will show\n");
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue(-[ProximityAutoFillAuthViewController view](self, "view"));
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue(-[ProximityAutoFillAuthViewController view](self, "view"));
...
- (void)_handlePINEntered:(id)a3
{
  ...
  id v8;
  ProximityAutoFillAuthViewController *v9;
...
- (void)showWithFlags:(unsigned int)a3 throttleSeconds:(int)a4
{
  ...
  if ((a3 & 0x10000) != 0)
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("PROX_AUTOFILL_PIN_INCORRECT"), &stru_10017E3D8, CFSTR("Localizable")));
    objc_msgSend(*(id *)((char *)&self->_activityIndicatorView + 1), "setText:", v10);

    v11 = (void *)objc_claimAutoreleasedReturnValue(+[UIColor systemRedColor](UIColor, "systemRedColor"));
    objc_msgSend(*(id *)((char *)&self->_activityIndicatorView + 1), "setTextColor:", v11);
  ...
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("PROX_AUTOFILL_PIN_INFO_TV"), &stru_10017E3D8, CFSTR("Localizable")));
    ...
    objc_msgSend(*(id *)((char *)&self->_activityIndicatorView + 1), "setTextColor:", v9);
