...
- (void)viewDidLoad
{
  ...
  -[FunCameraEmojiStickersViewController viewDidLoad](&v29, "viewDidLoad");
  +[CFXEffect initEffectRegistry](CFXEffect, "initEffectRegistry");
  v3 = CFXEffectTypeIdentifierEmojiStickers;
  v28[0] = _NSConcreteStackBlock;
  v28[1] = 3221225472;
  v28[2] = sub_100001CB0;
  v28[3] = &unk_100004168;
  v28[4] = self;
  +[CFXEffectMessagesStickerUtilities cacheAnimatedStickerPreviewsForOverlayTypeId:atStickerSize:previewDuration:previewFrameRate:previewCompletedBlock:](CFXEffectMessagesStickerUtilities, "cacheAnimatedStickerPreviewsForOverlayTypeId:atStickerSize:previewDuration:previewFrameRate:previewCompletedBlock:", CFXEffectTypeIdentifierEmojiStickers, 0, 24, v28, 1.0);
  v4 = -[FunCameraStickerBrowserViewController initWithEffectTypeIdentifier:stickerSize:]([FunCameraStickerBrowserViewController alloc], "initWithEffectTypeIdentifier:stickerSize:", v3, 0);
  -[FunCameraEmojiStickersViewController setStickerBrowserViewController:](self, "setStickerBrowserViewController:", v4);

  v5 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
  objc_msgSend(v5, "setDataSource:", self);

  v6 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "view"));

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
  -[FunCameraEmojiStickersViewController addChildViewController:](self, "addChildViewController:", v8);

  v9 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController view](self, "view"));
  objc_msgSend(v9, "addSubview:", v7);

  objc_msgSend(v7, "setTranslatesAutoresizingMaskIntoConstraints:", 0);
  v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "leadingAnchor"));
  v27 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController view](self, "view"));
  ...
  v23 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController view](self, "view"));
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController view](self, "view"));
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController view](self, "view"));
  ...
  v18 = (void *)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
...
- (void)updateSnapshotWithCompletionBlock:(id)a3
{
  ...
  v4 = a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[FunCameraEmojiStickersViewController stickerBrowserViewController](self, "stickerBrowserViewController"));
