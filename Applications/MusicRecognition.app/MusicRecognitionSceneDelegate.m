...
- (void)setWindow:(id)a3
{
  ...
  v4 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC16MusicRecognition29MusicRecognitionSceneDelegate_window);
...
- (void)scene:(id)a3 willConnectToSession:(id)a4 options:(id)a5
{
  ...
  id v9;
  id v10;
  _TtC16MusicRecognition29MusicRecognitionSceneDelegate *v11;
...
- (_TtC16MusicRecognition29MusicRecognitionSceneDelegate)init
{
  ...
  *(Class *)((char *)&self->super.isa
  ...
  return -[MusicRecognitionSceneDelegate init](&v5, "init");
}
