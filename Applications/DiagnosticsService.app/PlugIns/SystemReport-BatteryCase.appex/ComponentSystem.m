...
- (ComponentSystem)init
{
  ...
  v2 = -[ComponentSystem init](&v6, "init");
  if (v2)
  {
    v3 = objc_claimAutoreleasedReturnValue(+[DSIOHIDDevice deviceMatchingAccessories:](DSIOHIDDevice, "deviceMatchingAccessories:", &off_10000D150));
    device = v2->_device;
...
- (BOOL)isPresent
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[ComponentSystem device](self, "device"));
  v3 = v2 != 0;
...
- (void)populateAttributes:(id)a3
{
  ...
  v12 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[ComponentSystem device](self, "device"));
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[ComponentSystem batterySerialNumber](self, "batterySerialNumber"));
  if (v7)
    objc_msgSend(v12, "setObject:forKeyedSubscript:", v7, CFSTR("batterySerialNumber"));
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[ComponentSystem device](self, "device"));
