...
- (void)setupWithInputs:(id)a3 responder:(id)a4
{
  ...
  -[WiFiPerformanceController setCopyForSyncing:](self, "setCopyForSyncing:", CFPreferencesGetAppBooleanValue(CFSTR("Diagnostic-4351.CopyForSyncing"), CFSTR("com.apple.Diagnostics"), &keyExistsAndHasValidFormat) != 0);
  if (!keyExistsAndHasValidFormat)
    -[WiFiPerformanceController setCopyForSyncing:](self, "setCopyForSyncing:", 0);
  v5 = DiagnosticLogHandleForCategory(3);
  v6 = objc_claimAutoreleasedReturnValue(v5);
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    v7 = -[WiFiPerformanceController copyForSyncing](self, "copyForSyncing");
    *(_DWORD *)buf = 67109376;
    v10 = v7;
    v11 = 1024;
...
- (void)start
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[WiFiPerformanceController result](self, "result"));
  ...
  v4[3] = &unk_100004168;
  v4[4] = self;
  AWDServerConsolidateDeviceDiagnostics(0, &_dispatch_main_q, v4);
}
...
- (id)_extractFilePaths:(id)a3
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "objectForKeyedSubscript:", kAwdDiagnosticsFileArray));
  if (!v5)
  {
    v18 = (void *)objc_claimAutoreleasedReturnValue(-[WiFiPerformanceController result](self, "result"));
    objc_msgSend(v18, "setStatusCode:", &off_100004288);

    v19 = DiagnosticLogHandleForCategory(3);
    v20 = objc_claimAutoreleasedReturnValue(v19);
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      sub_1000034D0(v20, v21, v22, v23, v24, v25, v26, v27);
    goto LABEL_24;
  }
  v6 = objc_opt_class(NSArray);
  if ((objc_opt_isKindOfClass(v5, v6) & 1) == 0)
  {
    v28 = (void *)objc_claimAutoreleasedReturnValue(-[WiFiPerformanceController result](self, "result"));
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      sub_100003530(v20, v30, v31, v32, v33, v34, v35, v36);
    goto LABEL_24;
  }
  if (!objc_msgSend(v5, "count"))
  {
    v37 = (void *)objc_claimAutoreleasedReturnValue(-[WiFiPerformanceController result](self, "result"));
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      sub_100003500(v20, v39, v40, v41, v42, v43, v44, v45);
LABEL_24:
...
LABEL_25:
  ...
  do
  {
    for (i = 0; i != v9; i = (char *)i + 1)
    {
      ...
      {
        v16 = (void *)objc_claimAutoreleasedReturnValue(-[WiFiPerformanceController result](self, "result"));
