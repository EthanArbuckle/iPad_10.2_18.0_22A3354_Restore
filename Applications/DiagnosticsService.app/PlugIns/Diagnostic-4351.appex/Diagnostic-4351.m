id archiveFiles(void *a1, void *a2, void *a3)
{
      ...
      do
      {
        ...
        if ((v16 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            sub_10000333C((uint64_t)v7, v30, v31, v32, v33, v34, v35, v36);
  ...
  if (!v20)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      sub_1000032D4((uint64_t)v7, v22, v23, v24, v25, v26, v27, v28);
LABEL_15:
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v55 = v6;
        _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "AWD result: %@", buf, 0xCu);
      }
...
LABEL_24:
      ...
      v11 = archiveFiles(v9, CFSTR("com.apple.Diagnostics.4351.XXXXXXXX"), 0);
      ...
      if (v20)
      {
        ...
        if ((v26 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
            sub_100003408((uint64_t)v27, v29, v30, v31, v32, v33, v34, v35);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          sub_10000346C((uint64_t)v21, v24, v45, v46, v47, v48, v49, v50);
        v27 = v21;
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        sub_1000033A4((uint64_t)v5, v27, v38, v39, v40, v41, v42, v43);
      v13 = 0;
      v10 = 0;
    }
...
void sub_100003254(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
{
  sub_1000029C8((void *)&_mh_execute_header, a2, a3, "ERROR archiving logs: %@", a5, a6, a7, a8, 2u);
}

void sub_10000333C(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_1000029C8((void *)&_mh_execute_header, a2, a3, "ERROR finding log(s): %@", a5, a6, a7, a8, 2u);
}

void sub_1000033A4(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_1000029C8((void *)&_mh_execute_header, a2, a3, "ERROR retrieving logs: %@", a5, a6, a7, a8, 2u);
  sub_10000326C();
}

void sub_100003408(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_1000029C8((void *)&_mh_execute_header, a2, a3, "Could not copy file: %@", a5, a6, a7, a8, 2u);
  sub_10000326C();
}

void sub_10000346C(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_1000029C8((void *)&_mh_execute_header, a2, a3, "Could not create directory: %@", a5, a6, a7, a8, 2u);
  sub_10000326C();
}

void sub_1000034D0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_100003254((void *)&_mh_execute_header, a1, a3, "ERROR AWD DiagnosticsFileArray not found in data!", a5, a6, a7, a8, 0);
  sub_100003264();
}

void sub_100003500(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_100003254((void *)&_mh_execute_header, a1, a3, "ERROR AWD DiagnosticsFileArray is empty!", a5, a6, a7, a8, 0);
  sub_100003264();
}

void sub_100003530(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  sub_100003254((void *)&_mh_execute_header, a1, a3, "ERROR AWD DiagnosticsFileArray is not an array!", a5, a6, a7, a8, 0);
  sub_100003264();
}
