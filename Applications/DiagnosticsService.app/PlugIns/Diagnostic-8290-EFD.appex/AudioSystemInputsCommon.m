...
- (BOOL)validateAndInitializeParameters:(id)a3
{
  ...
  v8 = (NSArray *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "dk_arrayFromRequiredKey:types:maxLength:failed:validator:", CFSTR("sources"), v7, 80, &v66, &stru_10001C670));
  sources = self->_sources;
  self->_sources = v8;

  if (!-[NSArray count](self->_sources, "count"))
    v66 = 1;
  dword_100024388 = -[NSArray count](self->_sources, "count") - 1;
  ...
  {
    v36 = (NSNumber *)objc_claimAutoreleasedReturnValue(objc_msgSend(v35, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("threshold"), &off_10001D7F0, &off_10001D800, &v66));
  ...
  if (!v66 && -[AudioSystemInputsCommon isAccessoryDetectorActive](self, "isAccessoryDetectorActive"))
  {
    ...
    v43 = (NSArray *)objc_claimAutoreleasedReturnValue(objc_msgSend(v39, "dk_arrayFromRequiredKey:types:maxLength:failed:validator:", CFSTR("modelNumbers"), v42, 50, &v66, &stru_10001C690));
  ...
  {
    v46 = (NSNumber *)objc_claimAutoreleasedReturnValue(objc_msgSend(v45, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("xThreshold"), &off_10001D810, &off_10001D820, &v66));
    orientationDetectorXThreshold = self->_orientationDetectorXThreshold;
    self->_orientationDetectorXThreshold = v46;

    v48 = (NSNumber *)objc_claimAutoreleasedReturnValue(objc_msgSend(v45, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("zThreshold"), &off_10001D810, &off_10001D820, &v66));
  ...
  v50 = (NSNumber *)objc_claimAutoreleasedReturnValue(objc_msgSend(v56, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("fileDownloadTimeout"), &off_10001D5B0, &off_10001D5C8, &v66));
  fileDownloadTimeout = self->_fileDownloadTimeout;
  self->_fileDownloadTimeout = v50;

  v52 = (NSNumber *)objc_claimAutoreleasedReturnValue(objc_msgSend(v56, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("sequenceTimeout"), &off_10001D5B0, &off_10001D5C8, &v66));
...
- (id)makeOutputFromDictionary:(id)a3 validationFailed:(BOOL *)a4
{
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", dword_100024388));
  v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("source"), &off_10001D5E0, v10, a4));
  objc_msgSend(v7, "setSource:", v11);

  v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "dk_numberFromRequiredKey:lowerBound:upperBound:failed:", CFSTR("volume"), &off_10001D830, &off_10001D840, a4));
