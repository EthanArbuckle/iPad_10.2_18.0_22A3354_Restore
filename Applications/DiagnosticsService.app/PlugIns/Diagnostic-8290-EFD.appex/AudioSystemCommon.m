...
- (void)parseTestResults:(id)a3 fromOutput:(id)a4 withFile:(id)a5 parsedResults:(id)a6 error:(id)a7
{
  ...
  if (!v53)
    goto LABEL_34;
  v54 = *(_QWORD *)v62;
  v17 = &ADAFPreferenceKeyHAENotificationFeatureEnabled_ptr;
  v51 = v16;
  while (2)
  {
    for (i = 0; i != v53; i = (char *)i + 1)
    {
      ...
      v21 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "numberWithDouble:"));
      v60 = v14;
        ...
        if (v23)
        {
          if (objc_msgSend(v23, "code") == (id)-70)
          {
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
              sub_100010E04((uint64_t)v56, v57, v46);
      ...
      v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17[62], "numberWithInteger:", objc_msgSend(v19, "inputID")));
