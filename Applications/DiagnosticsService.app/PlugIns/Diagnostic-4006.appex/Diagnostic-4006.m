...
void sub_100002104(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_list va;
...
id sub_100002780(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "cleanUpSystemClient");
}

void sub_1000028CC(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 2u);
}

void sub_1000028F0(os_log_t log)
{
  uint8_t v1[16];
...
void sub_100002930()
{
  ...
  sub_1000028E4();
  sub_1000028CC((void *)&_mh_execute_header, v0, v1, "[ERROR] - Invalid HID Event", v2, v3, v4, v5, v6);
  sub_1000028DC();
}
...
void sub_10000295C()
{
  ...
  sub_1000028E4();
  sub_1000028CC((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client could not be found.", v2, v3, v4, v5, v6);
  sub_1000028DC();
}
...
void sub_100002988()
{
  ...
  sub_1000028E4();
  sub_1000028CC((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client does not exist.", v2, v3, v4, v5, v6);
  sub_1000028DC();
}
...
void sub_1000029B4()
{
  ...
  sub_1000028E4();
  sub_1000028CC((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not open HID system.", v2, v3, v4, v5, v6);
  sub_1000028DC();
}
...
void sub_100002A18(uint8_t *buf, _BYTE *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
...
void sub_100002A54()
{
  ...
  sub_1000028E4();
  sub_1000028CC((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not set up system client.", v2, v3, v4, v5, v6);
  sub_1000028DC();
}
...
{
  return objc_msgSend(a1, "compassDataCount");
}
...
id objc_msgSend_setCompassDataCount_(void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "setCompassDataCount:");
}
