...
- (void)prepareNewIteration
{
  ...
  sub_100005D6C(__p, "prepareNewIteration");
  -[ViewController log:](self, "log:", __p);
  if (v4 < 0)
    operator delete(__p[0]);
...
- (void)startUI
{
  ...
  sub_100005D6C(&v34, "start UI");
  -[ViewController log:](self, "log:", &v34);
  if (SHIBYTE(v35) < 0)
    operator delete((void *)v34);
  sub_100005D6C(&v31, "_sessionMaxTimeOut ");
  ...
  *(_OWORD *)&v32.__r_.__value_.__l.__data_ = v6;
  ...
  sub_100005D6C(v28, " _consecutiveSceneErrorLimit ");
  if ((v29 & 0x80u) == 0)
    v7 = v28;
  else
    v7 = (void **)v28[0];
...
- (int)getJasperSensorId:(void *)a3
{
  ...
  if (DeviceCMInterface::getJasperModuleInfo(self->_diagnosticCMInterface, &theDict))
  {
    ...
    -[ViewController error:details:](self, "error:details:", CFSTR("unable to get JasperModuleInfo"), &stru_100029080);
  }
  else
  {
...
- (int)startStreaming
{
  ...
  sub_100005D6C(__p, "startStreaming started");
  -[ViewController log:](self, "log:", __p);
  if (v6 < 0)
    operator delete(__p[0]);
  if (self->_running)
...
- (int)initStreaming
{
  ...
  sub_100005D6C(__p, "initStreaming");
  -[ViewController log:](self, "log:", __p);
  if (v6 < 0)
    operator delete(__p[0]);
  *(_DWORD *)&v7.var0 = 65537;
  ...
  self->_diagnosticFinalResult = 2;
  -[ViewController error:details:](self, "error:details:", CFSTR("no JasperDevice"), &stru_100029080);
...
- (void)initFlow
{
  ...
  *(_DWORD *)&self->_avgRotAngles[8] = 0;
  sub_100005D6C(__p, "init flow started");
  -[ViewController log:](self, "log:", __p);
  if (v11 < 0)
    operator delete(__p[0]);
  ...
  if (self->_iterationsLimit >= 1)
  {
    ...
    {
      __p[0] = &v9;
      v6 = sub_10001A81C((uint64_t **)&self->_rgbjCalibrationResults, &v9, (uint64_t)&unk_100020547, (_DWORD **)__p);
      v6[6] = v6[5];
      ++v9;
    }
...
- (void)showPausedDialog
{
  ...
  v6 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("Device_Is_Motionless"), &stru_100029080, 0));

  v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("Device_Is_Motionless_Subtitle"), &stru_100029080, 0));
...
- (int)initDiagnosticRgbjFlow
{
  ...
  sub_100005D6C(__p, "set rgbj configuration to frameSelect(1)  featureVector(5)  dilutionRate(500)");
  -[ViewController log:](self, "log:", __p);
  if (v7 < 0)
    operator delete(__p[0]);
  ...
  else
  {
    if (!self->_resetExtrinsics)
      return 0;
    sub_100005D6C(__p, "set wide jasper extrinsics to 0");
    -[ViewController log:](self, "log:", __p);
    if (v7 < 0)
      operator delete(__p[0]);
  ...
  v4 = 2;
  self->_diagnosticFinalResult = 2;
  -[ViewController error:details:](self, "error:details:", v3, &stru_100029080);
  return v4;
}
...
- (int)getCalibResults:(ViewController *)self focalPoint:(SEL)a2
{
  ...
  v4 = v3;
  v5 = v2;
  sub_100005D6C(&__p, "getCalibResults");
  -[ViewController log:](self, "log:", &__p);
  if (SHIBYTE(v20) < 0)
    operator delete(__p);
  v26 = 0;
  if (DeviceCMInterface::getJasperCalib(self->_diagnosticCMInterface, &v26))
  {
    v7 = 2;
    self->_diagnosticFinalResult = 2;
    -[ViewController error:details:](self, "error:details:", CFSTR("unable to get JasperCalib"), &stru_100029080);
  }
  else
  {
...
- (void)loadNormalAppWindow
{
  ...
  sub_100005D6C(__p, "loadNormalAppWindow");
  -[ViewController log:](self, "log:", __p);
  if (v150 < 0)
    operator delete(__p[0]);
  self->_progress = 0.0;
  ...
  objc_msgSend(v147, "setLocations:", &off_10002C118);
...
- (void)compareResults:(float *)a3
{
  ...
  sub_100005D6C(&v48, "compareResults started");
  ...
  v48 = 0;
  v49 = 0uLL;
  sub_10001AACC((uint64_t)&v43, 0x10uLL);
...
- (void)dogWatch:(id)a3
{
  ...
  if (v325[1] == 1)
  {
    sub_100005D6C(__p, "Driver reported disk is full with RgbjReport_FailedToSave");
    -[ViewController log:](self, "log:", __p);
  ...
  *(_QWORD *)__p = &self->_iterationNumber;
  v7 = sub_10001A81C((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100020547, (_DWORD **)__p);
  v8 = v7[6];
  v9 = v7[7];
  if (v8 >= v9)
  {
    ...
    if (v15 >= 0x555555555555555)
      ...
      v16 = v14;
    if (v16)
      v17 = (char *)sub_10001AB50((uint64_t)(v7 + 7), v16);
    else
      v17 = 0;
  ...
  v7[6] = v11;
  *(_QWORD *)__p = &self->_iterationNumber;
  v24 = sub_10001A81C((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100020547, (_DWORD **)__p);
  if ((char *)v24[6] - (char *)v24[5] == 24)
  {
    -[ViewController hideInProgressView](self, "hideInProgressView");
    -[ViewController hideWarningWindow](self, "hideWarningWindow");
    v25 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "localizedStringForKey:value:table:", CFSTR("Pan_Slowly"), &stru_100029080, 0));
  ...
  *(_QWORD *)__p = &self->_iterationNumber;
  v69 = sub_10001A81C((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100020547, (_DWORD **)__p);
  *(_QWORD *)__p = &self->_iterationNumber;
  v70 = sub_10001A81C((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100020547, (_DWORD **)__p);
  v72 = v70[5];
  v71 = v70[6];
  v73 = v69[5];
  ...
  *(_OWORD *)__p = v118;
  ...
  v122 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v121, "localizedStringForKey:value:table:", CFSTR("Pan_Slowly"), &stru_100029080, 0));
  ...
  if (v325[0] > *v102)
  {
    ...
    v134 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v133, "localizedStringForKey:value:table:", CFSTR("Bad_Scene"), &stru_100029080, 0));
    v135 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v136 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v135, "localizedStringForKey:value:table:", CFSTR("Bad_Scene_Subtitle"), &stru_100029080, 0));
    ...
    v138 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v137, "localizedStringForKey:value:table:", CFSTR("Pan_Slowly"), &stru_100029080, 0));
  ...
  if (SDWORD1(__val) <= *v80)
  {
    ...
    if (v139 < (signed int)self->_textMargin)
      goto LABEL_199;
    v137 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v138 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v137, "localizedStringForKey:value:table:", CFSTR("No_Objects_Found"), &stru_100029080, 0));
    v140 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v141 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v140, "localizedStringForKey:value:table:", CFSTR("No_Objects_Found_Subtitle"), &stru_100029080, 0));
...
LABEL_199:
  if (SHIDWORD(__val) < self->_calibUpdateEachIsfEntiresLimit)
  {
      ...
      || self->_consecutiveSceneError > (signed int)self->_topTextHeight)
    {
      ...
      *(_OWORD *)__p = v162;
      ...
      v164 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v163, "localizedStringForKey:value:table:", CFSTR("Timed_Out"), &stru_100029080, 0));
      -[ViewController showWarningWindow:subMessage:](self, "showWarningWindow:subMessage:", v164, &stru_100029080);
      ...
      v289[1] = 3221225472;
      v289[2] = sub_100016D84;
      v289[3] = &unk_100028E48;
      v289[4] = self;
      dispatch_async(v166, v289);
    }
    goto LABEL_168;
  }
  sub_100005D6C(__p, "dogWatch finishing sub iteration");
  -[ViewController log:](self, "log:", __p);
  if ((__p[23] & 0x80000000) != 0)
    operator delete(*(void **)__p);
  ...
  v303[1] = 3221225472;
  v303[2] = sub_100016B04;
  v303[3] = &unk_100028E48;
  v303[4] = self;
  ...
  {
    -[ViewController error:details:](self, "error:details:", CFSTR("failed to forceSaveWideJasperCalib"), &stru_100029080);
    goto LABEL_168;
  }
  DWORD2(v302) = 0;
  *(_QWORD *)&v302 = 0;
  ...
  if (!-[ViewController getCalibResults:focalPoint:](self, "getCalibResults:focalPoint:", &v302, &v300))
  {
    ...
    sub_100013BE0("iteration ", (const void **)&v321.__r_.__value_.__l.__data_, (void **)&v306.__r_.__value_.__l.__data_);
    ...
    *((_BYTE *)&v321.__r_.__value_.__s + 23) = v222;
    ...
    if (v223 < self->_iterationTotalSuccessfullRunsLimit)
      goto LABEL_359;
    sub_100005D6C(__p, "dogWatch finishing iteration");
    -[ViewController log:](self, "log:", __p);
    if ((__p[23] & 0x80000000) != 0)
      operator delete(*(void **)__p);
    anon_b8 = self->_anon_b8;
    sub_100016B50((void **)self->_anon_b8, &v302);
    ...
    *(_OWORD *)&v320.__r_.__value_.__l.__data_ = v245;
    ...
    if (self->_diagnosticFinalResult == -3)
    {
      ...
      v292[1] = 3221225472;
      v292[2] = sub_100016C2C;
      v292[3] = &unk_100028E48;
      v292[4] = self;
      v254 = v292;
    }
    else
...
LABEL_359:
        ...
        v290[1] = 3221225472;
        v290[2] = sub_100016C78;
        v290[3] = &unk_100028E48;
        v290[4] = self;
...
LABEL_448:
      ...
      *(_OWORD *)&self->_prclResult.swideFocalPoint[2] = v287;
      sub_100005D6C(&v319, "dogWatch finishing all iterations");
      ...
      v291[1] = 3221225472;
      v291[2] = sub_100016C70;
      v291[3] = &unk_100028E48;
      v291[4] = self;
      v254 = v291;
    }
...
- (void)error:(id)a3 details:(id)a4
{
  ...
  sub_100005D6C(__p, (char *)objc_msgSend(v5, "UTF8String"));
  -[ViewController log:](self, "log:", __p);
  if (v7 < 0)
    operator delete(__p[0]);
...
- (void)handleResume
{
  ...
  {
    self->_inResume = 1;
    sub_100005D6C(__p, "handleResume");
    -[ViewController log:](self, "log:", __p);
    if (v7 < 0)
      operator delete(__p[0]);
    backgroundDispatchQueue = self->_backgroundDispatchQueue;
...
- (void)handleSuspend
{
  ...
  v4 = self;
  objc_sync_enter(v4);
  sub_100005D6C(__p, "handleSuspend");
...
- (void)endTest
{
  ...
  *(_OWORD *)__p = v5;
  ...
  {
    sub_100005D6C(__p, "_skipSummaryScreen is true");
    -[ViewController log:](self, "log:", __p);
    if (SHIBYTE(v9) < 0)
      operator delete(__p[0]);
  ...
  sub_100005D6C(__p, "_skipSummaryScreen is false");
  -[ViewController log:](self, "log:", __p);
  if (SHIBYTE(v9) < 0)
    operator delete(__p[0]);
...
- (void)buttonClicked:(id)a3
{
  ...
  sub_100005D6C(__p, "button clicked");
  -[ViewController log:](self, "log:", __p);
  if (v5 < 0)
    operator delete(__p[0]);
}
...
- (void)setUpperViewLabelText:(id)a3
{
  ...
  sub_100005D6C(v10, (char *)objc_msgSend(v4, "UTF8String"));
...
- (void)showWarningWindow:(id)a3 subMessage:(id)a4
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100019290;
  block[3] = &unk_100028EE8;
  block[4] = self;
  v10 = a4;
  v11 = v6;
  v7 = v6;
...
- (void)quitButtonTapped
{
  ...
  sub_100005D6C(__p, "Quit button tapped!");
  -[ViewController log:](self, "log:", __p);
  if (v4 < 0)
    operator delete(__p[0]);
  -[ViewController endTest](self, "endTest");
...
- (void).cxx_destruct
{
  ...
  sub_10001ABC8((uint64_t)&self->_rgbjCalibrationResults, (_QWORD *)self->_rgbjCalibrationResults.__tree_.__pair1_.__value_.__left_);
