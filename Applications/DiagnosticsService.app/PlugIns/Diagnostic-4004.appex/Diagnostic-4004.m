...
void sub_100001CE0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_list va;
...
void sub_100001CF8(uint64_t a1)
{
  void *v2;
  void *v3;
  void *v4;
...
void sub_1000024A8(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 2u);
}

id sub_100002664(uint64_t a1)
{
...
void sub_1000028F0()
{
  ...
  sub_1000024C0();
  sub_1000024A8((void *)&_mh_execute_header, v0, v1, "[ERROR] - Invalid HID Event", v2, v3, v4, v5, v6);
  sub_1000024B8();
}
...
void sub_10000291C()
{
  ...
  sub_1000024C0();
  sub_1000024A8((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client could not be found.", v2, v3, v4, v5, v6);
  sub_1000024B8();
}
...
void sub_100002948()
{
  ...
  sub_1000024C0();
  sub_1000024A8((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client does not exist.", v2, v3, v4, v5, v6);
  sub_1000024B8();
}
...
void sub_100002974()
{
  ...
  sub_1000024C0();
  sub_1000024A8((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not open HID system.", v2, v3, v4, v5, v6);
  sub_1000024B8();
}
...
void sub_1000029D8(uint8_t *buf, _BYTE *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
...
void sub_100002A14()
{
  ...
  sub_1000024C0();
  sub_1000024A8((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not set up system client.", v2, v3, v4, v5, v6);
  sub_1000024B8();
}

void sub_100002A40(os_log_t log)
{
  uint8_t v1[16];
...
{
  return objc_msgSend(a1, "barometerDataCount");
}
...
id objc_msgSend_setBarometerDataCount_(void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "setBarometerDataCount:");
}
