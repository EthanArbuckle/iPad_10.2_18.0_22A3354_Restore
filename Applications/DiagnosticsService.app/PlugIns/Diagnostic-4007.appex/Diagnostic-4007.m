void sub_100001708(id a1)
{
  ...
  qword_100008910 = (uint64_t)v1;

}

void sub_100001C28(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_list va;
...
void sub_1000020A8(_Unwind_Exception *a1)
{
  void *v1;
...
id sub_1000022A4(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "cleanUpSystemClient");
}

void sub_1000023F0(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 2u);
}

id sub_1000025AC(uint64_t a1)
{
...
void sub_1000028D0()
{
  ...
  sub_100002408();
  sub_1000023F0((void *)&_mh_execute_header, v0, v1, "[ERROR] - Invalid HID Event", v2, v3, v4, v5, v6);
  sub_100002400();
}
...
void sub_1000028FC()
{
  ...
  sub_100002408();
  sub_1000023F0((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client could not be found.", v2, v3, v4, v5, v6);
  sub_100002400();
}
...
void sub_100002928()
{
  ...
  sub_100002408();
  sub_1000023F0((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client does not exist.", v2, v3, v4, v5, v6);
  sub_100002400();
}
...
void sub_100002954()
{
  ...
  sub_100002408();
  sub_1000023F0((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not open HID system.", v2, v3, v4, v5, v6);
  sub_100002400();
}
...
void sub_1000029F4()
{
  ...
  sub_100002408();
  sub_1000023F0((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not set up system client.", v2, v3, v4, v5, v6);
  sub_100002400();
}
...
{
  return objc_msgSend(a1, "gyroDataCount");
}
...
id objc_msgSend_setGyroDataCount_(void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "setGyroDataCount:");
}
