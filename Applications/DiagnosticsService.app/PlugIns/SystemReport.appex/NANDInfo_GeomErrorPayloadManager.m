...
- (void)populateOtherStats:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v4, v5) & 1) != 0)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    v7 = objc_msgSend(&off_1000B2590, "countByEnumeratingWithState:objects:count:", &v16, v20, 16);
    if (v7)
    {
      v8 = v7;
      v9 = 0;
      ...
      do
      {
        ...
        {
          if (*(_QWORD *)v17 != v10)
            objc_enumerationMutation(&off_1000B2590);
        ...
        while (v8 != v11);
        v8 = objc_msgSend(&off_1000B2590, "countByEnumeratingWithState:objects:count:", &v16, v20, 16);
      }
      while (v8);
...
LABEL_25:
        ...
        {
          objc_msgSend(v14, "setObject:forKeyedSubscript:", &off_1000B27A0, CFSTR("ESR_page_i"));
          objc_msgSend(v14, "setObject:forKeyedSubscript:", &off_1000B27A0, CFSTR("ESR_page_i_status"));
