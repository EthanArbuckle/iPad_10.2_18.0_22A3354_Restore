...
{
  return sub_1000029BC((uint64_t)self, (uint64_t)a2, (uint64_t)a3, &OBJC_IVAR___MicrophoneTestInputs_predicates);
}
...
{
  return sub_1000029BC((uint64_t)self, (uint64_t)a2, (uint64_t)a3, &OBJC_IVAR___MicrophoneTestInputs_specifications);
}

- (MicrophoneTestInputs)init
{
  return (MicrophoneTestInputs *)sub_100002A1C();
}
