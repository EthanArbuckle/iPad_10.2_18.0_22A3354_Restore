...
{
  return (_TtC8AppStore15ShelfFooterView *)sub_100441564(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore15ShelfFooterView *v5;
  uint64_t v6;
  uint64_t v7;
  id v8;
  double v9;
...
- (void)layoutSubviews
{
  ...
  _TtC8AppStore15ShelfFooterView *v4;
  uint64_t v5;
  uint64_t v6;
  double v7;
  double v8;
...
- (void)prepareForReuse
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore15ShelfFooterView_separator];
  v4 = sub_100008FE4(0, (unint64_t *)&qword_10082A430, UIColor_ptr);
  v6 = (void *)static UIColor.defaultLine.getter(v4, v5);
  objc_msgSend(v3, "setBackgroundColor:", v6, v8.receiver, v8.super_class);

  v7 = *(void **)&v2[OBJC_IVAR____TtC8AppStore15ShelfFooterView_titleButton];
...
- (void).cxx_destruct
{
  ...
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore15ShelfFooterView_footerAction), *(_QWORD *)&self->separator[OBJC_IVAR____TtC8AppStore15ShelfFooterView_footerAction]);
}
