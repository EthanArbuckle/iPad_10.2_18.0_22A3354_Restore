...
{
  return (_TtC20ProductPageExtension21LockupPlaceholderView *)sub_1001304EC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  double height;
  double width;
  _TtC20ProductPageExtension21LockupPlaceholderView *v8;
  uint64_t v9;
  uint64_t v10;
  double v11;
  double v12;
...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension21LockupPlaceholderView *v2;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension21LockupPlaceholderView_contentType;
