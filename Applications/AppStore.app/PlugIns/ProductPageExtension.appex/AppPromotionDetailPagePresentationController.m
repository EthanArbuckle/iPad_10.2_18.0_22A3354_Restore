...
- (_TtC20ProductPageExtension44AppPromotionDetailPagePresentationController)initWithPresentedViewController:(id)a3 presentingViewController:(id)a4
{
  id v5;
  id v6;
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *result;
...
{
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v2;
  double v3;
  double v4;
  double v5;
  double v6;
...
{
  id v6;
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v7;

  v6 = a3;
  swift_unknownObjectRetain(a4);
  v7 = self;
  sub_10002E21C((uint64_t)v6, a4);
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  double height;
  double width;
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v8;

  height = a3.height;
  width = a3.width;
  swift_unknownObjectRetain(a4);
  v8 = self;
  sub_10002E3A4(a4, width, height);
  swift_unknownObjectRelease(a4);
...
{
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v4;
...
{
  if (a3)
    objc_msgSend(*(id *)((char *)&self->super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension44AppPromotionDetailPagePresentationController_overlayView), "removeFromSuperview");
}

- (void)didTapOverlayView:(id)a3
{
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v4;
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v5;
  _TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *v6;

  v4 = (_TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *)a3;
  v6 = self;
  if (-[AppPromotionDetailPagePresentationController state](v4, "state") == (id)3)
  {
    v5 = (_TtC20ProductPageExtension44AppPromotionDetailPagePresentationController *)-[AppPromotionDetailPagePresentationController presentedViewController](v6, "presentedViewController");
...
- (void).cxx_destruct
{
  ...
  sub_10002FB7C((uint64_t)self+ OBJC_IVAR____TtC20ProductPageExtension44AppPromotionDetailPagePresentationController_interactiveDismissal);
  swift_unknownObjectWeakDestroy((char *)self+ OBJC_IVAR____TtC20ProductPageExtension44AppPromotionDetailPagePresentationController_dismissalScrollView);
}
