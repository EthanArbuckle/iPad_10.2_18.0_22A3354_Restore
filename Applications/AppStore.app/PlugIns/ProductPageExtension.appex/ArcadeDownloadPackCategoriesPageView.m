...
{
  return (_TtC20ProductPageExtension36ArcadeDownloadPackCategoriesPageView *)sub_100079278(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
{
  _TtC20ProductPageExtension36ArcadeDownloadPackCategoriesPageView *v2;
  double v3;
  double v4;
  double v5;
  id v6;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC20ProductPageExtension36ArcadeDownloadPackCategoriesPageView *v5;
  id v6;
  uint64_t v7;
  uint64_t v8;
  double v9;
