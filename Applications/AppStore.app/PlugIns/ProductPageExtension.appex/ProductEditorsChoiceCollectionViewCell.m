...
{
  return (_TtC20ProductPageExtension38ProductEditorsChoiceCollectionViewCell *)sub_1004B473C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension38ProductEditorsChoiceCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v9;
  id v10;
  _TtC20ProductPageExtension38ProductEditorsChoiceCollectionViewCell *result;
  ...
  v7 = OBJC_IVAR____TtC20ProductPageExtension38ProductEditorsChoiceCollectionViewCell_editorsChoiceView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v9, "init");
  ...
  result = (_TtC20ProductPageExtension38ProductEditorsChoiceCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/ProductEditorsChoiceCollectionViewCell.swift", 65, 2, 24, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_1000119FC((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension38ProductEditorsChoiceCollectionViewCell_itemLayoutContext);
