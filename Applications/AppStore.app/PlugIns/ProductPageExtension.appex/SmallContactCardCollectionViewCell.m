...
{
  return (_TtC20ProductPageExtension34SmallContactCardCollectionViewCell *)sub_10006C6C0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, (uint64_t)self, (uint64_t)a2);
}
...
- (_TtC20ProductPageExtension34SmallContactCardCollectionViewCell)initWithCoder:(id)a3
{
  ...
  uint64_t v6;
  id v7;
  _TtC20ProductPageExtension34SmallContactCardCollectionViewCell *result;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension34SmallContactCardCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/SmallContactCardCollectionViewCell.swift", 61, 2, 35, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_100010F2C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension34SmallContactCardCollectionViewCell_itemLayoutContext, &qword_1008081F0);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
