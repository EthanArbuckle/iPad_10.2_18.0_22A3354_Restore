...
{
  return (_TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView *)sub_1000DCBA4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)dealloc
{
  ...
  void *v4;
  _TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView *v5;
  objc_super v6;
...
- (void).cxx_destruct
{
  ...
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_impressionsCalculator);
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_impressionsUpdateBlock), *(_QWORD *)&self->lockupView[OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_impressionsUpdateBlock]);
  swift_unknownObjectWeakDestroy((char *)self+ OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_otherOverlayToExchangeSubviewsWith);
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_clickActionHandler), *(_QWORD *)&self->lockupView[OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_clickActionHandler]);
}
...
- (void)animationDidStart:(id)a3
{
  ...
  void *v5;
  id v6;
  _TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView *v7;
...
- (void)animationDidStop:(id)a3 finished:(BOOL)a4
{
  ...
  void *v6;
  id v7;
  _TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView *v8;
...
- (void)willMoveToWindow:(id)a3
{
  ...
  Strong = (char *)swift_unknownObjectWeakLoadStrong(&v4[OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_otherOverlayToExchangeSubviewsWith]);
  if (Strong)
  {
    v7 = Strong;
    sub_1000DDBEC(Strong);

    swift_unknownObjectWeakAssign(v8);
  }
...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView *v2;
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v6 = *(id *)&v5[OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_lockupView];
...
- (void)handleTapWithGestureRecognizer:(id)a3
{
  ...
  if (v5)
  {
    v6 = *(_QWORD *)&v8->lockupView[OBJC_IVAR____TtC20ProductPageExtension35TodayCardMarketingLockupOverlayView_clickActionHandler];
    v7 = swift_retain(v6);
    v5(v7);
