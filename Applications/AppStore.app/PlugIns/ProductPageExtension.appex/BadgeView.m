...
{
  return (_TtC20ProductPageExtension9BadgeView *)sub_10042AD28(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
{
  void *v3;
  _TtC20ProductPageExtension9BadgeView *v4;
  id v5;
  objc_super v6;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_leadingValue;
  v4 = type metadata accessor for BadgeLeadingValue(0);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  swift_bridgeObjectRelease(*(_QWORD *)&self->caption[OBJC_IVAR____TtC20ProductPageExtension9BadgeView_caption]);
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_captionView));
  swift_bridgeObjectRelease(*(_QWORD *)&self->caption[OBJC_IVAR____TtC20ProductPageExtension9BadgeView_heading]);
  v5 = swift_bridgeObjectRelease(*(_QWORD *)&self->caption[OBJC_IVAR____TtC20ProductPageExtension9BadgeView_valueText]);
  v6 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_captionCappingType;
  v7 = type metadata accessor for BadgeCaptionCappingType(0, v5);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v7 - 8) + 8))(v6, v7);

  v8 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_valueViewAlignment;
  v9 = type metadata accessor for BadgeValueViewAlignment(0);
  v10.n128_f64[0] = (*(double (**)(char *, uint64_t))(*(_QWORD *)(v9 - 8) + 8))(v8, v9);
  v11 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_spacing;
  v12 = type metadata accessor for BadgeViewSpacing(0, v10);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v12 - 8) + 8))(v11, v12);
  sub_100010F2C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_action, &qword_100819850);
  v13 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension9BadgeView_badgeType;
...
{
  _TtC20ProductPageExtension9BadgeView *v2;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  CGFloat width;
  _TtC20ProductPageExtension9BadgeView *v5;
  __n128 v6;
  double v7;
  double v8;
  double v9;
...
{
  id v5;
  _TtC20ProductPageExtension9BadgeView *v6;

  v5 = a3;
  v6 = self;
  sub_10042C764((uint64_t)a3);
