...
- (void)setFrame:(CGRect)a3
{
  ...
  double x;
  objc_class *v8;
  _TtCC20ProductPageExtension30ArticleContainerViewControllerP33_DBD3BDFA863817F76B447E10483B1F7213ContainerView *v9;
  double v10;
  CGFloat v11;
  double v12;
  CGFloat v13;
  ...
  if (!CGRectEqualToRect(v27, v28))
  {
    ...
    if (v22)
    {
      v23 = *(_QWORD *)&v9->frameUpdatedCallback[OBJC_IVAR____TtCC20ProductPageExtension30ArticleContainerViewControllerP33_DBD3BDFA863817F76B447E10483B1F7213ContainerView_frameUpdatedCallback];
...
- (void).cxx_destruct
{
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtCC20ProductPageExtension30ArticleContainerViewControllerP33_DBD3BDFA863817F76B447E10483B1F7213ContainerView_frameUpdatedCallback), *(_QWORD *)&self->frameUpdatedCallback[OBJC_IVAR____TtCC20ProductPageExtension30ArticleContainerViewControllerP33_DBD3BDFA863817F76B447E10483B1F7213ContainerView_frameUpdatedCallback]);
}
