...
{
  return (_TtC20ProductPageExtension28CarouselItemModuleHeaderView *)sub_1004978B0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  _TtC20ProductPageExtension28CarouselItemModuleHeaderView *v4;
  uint64_t v5;
  uint64_t v6;
  double v7;
  double v8;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC20ProductPageExtension28CarouselItemModuleHeaderView *v5;
  id v6;
  uint64_t v7;
  uint64_t v8;
  double v9;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension28CarouselItemModuleHeaderView_displayOptions;
