    ...
    if ((_stringCompareWithSmolCheck(_:_:expecting:)(0x73736572676F7270, 0xE800000000000000, v4, v6, 0) & 1) == 0)
    {
      ...
      if ((_stringCompareWithSmolCheck(_:_:expecting:)(0x6F72507265746E65, 0xED00007373657267, v4, v6, 0) & 1) == 0)
      {
        ...
        if ((_stringCompareWithSmolCheck(_:_:expecting:)(0x676F725074697865, 0xEC00000073736572, v4, v6, 0) & 1) == 0)
        {
          ...
          v13.super_class = (Class)&OBJC_METACLASS____TtC20ProductPageExtension20InstallProgressLayer;
...
- (id)actionForKey:(id)a3
{
  ...
  uint64_t v5;
  uint64_t v6;
  _TtC20ProductPageExtension20InstallProgressLayer *v7;
  id v8;

  v4 = static String._unconditionallyBridgeFromObjectiveC(_:)(a3);
  v6 = v5;
  v7 = self;
  v8 = sub_1000AC674(v4, v6);
...
{
  CGContext *v4;
  _TtC20ProductPageExtension20InstallProgressLayer *v5;
...
{
  return (_TtC20ProductPageExtension20InstallProgressLayer *)sub_1000AD06C();
}
...
- (_TtC20ProductPageExtension20InstallProgressLayer)initWithLayer:(id)a3
{
  ...
  return (_TtC20ProductPageExtension20InstallProgressLayer *)sub_1000AD154(v5);
}

- (_TtC20ProductPageExtension20InstallProgressLayer)initWithCoder:(id)a3
{
  return (_TtC20ProductPageExtension20InstallProgressLayer *)sub_1000AD2A4(a3);
}
