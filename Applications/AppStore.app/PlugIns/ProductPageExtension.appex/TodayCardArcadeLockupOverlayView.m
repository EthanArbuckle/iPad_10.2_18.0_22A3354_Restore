...
{
  return (_TtC20ProductPageExtension32TodayCardArcadeLockupOverlayView *)sub_10040F17C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)_setContinuousCornerRadius:(double)a3
{
  ...
  v5 = objc_msgSend(*(id *)&v4[OBJC_IVAR____TtC20ProductPageExtension32TodayCardArcadeLockupOverlayView_arcadeLockupView], "layer");
...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension32TodayCardArcadeLockupOverlayView *v2;
...
- (void).cxx_destruct
{
  ...
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC20ProductPageExtension32TodayCardArcadeLockupOverlayView_impressionsCalculator);
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension32TodayCardArcadeLockupOverlayView_impressionsUpdateBlock), *(_QWORD *)&self->arcadeLockupView[OBJC_IVAR____TtC20ProductPageExtension32TodayCardArcadeLockupOverlayView_impressionsUpdateBlock]);
}
