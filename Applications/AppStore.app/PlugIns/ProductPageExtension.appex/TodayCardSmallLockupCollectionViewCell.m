...
{
  return (_TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell *)sub_100055C08(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell *result;

  v5 = OBJC_IVAR____TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/TodayCardSmallLockupCollectionViewCell.swift", 65, 2, 42, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell_lockupView];
...
- (void)prepareForReuse
{
  ...
  v3 = objc_retain(*(id *)(*(_QWORD *)&v2[OBJC_IVAR____TtC20ProductPageExtension38TodayCardSmallLockupCollectionViewCell_lockupView]
