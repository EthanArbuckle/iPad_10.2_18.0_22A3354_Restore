...
{
  return (_TtC20ProductPageExtension22HeroCarouselScrollView *)sub_1002DAA54(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)setFrame:(CGRect)a3
{
  ...
  double x;
  objc_class *v8;
  _TtC20ProductPageExtension22HeroCarouselScrollView *v9;
  double v10;
  CGFloat v11;
  double v12;
  CGFloat v13;
...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension22HeroCarouselScrollView *v2;
...
{
  id v4;
  _TtC20ProductPageExtension22HeroCarouselScrollView *v5;
...
{
  id v5;
  _TtC20ProductPageExtension22HeroCarouselScrollView *v6;
...
- (void).cxx_destruct
{
  sub_100010D1C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension22HeroCarouselScrollView_pagingDelegate);
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC20ProductPageExtension22HeroCarouselScrollView_pageTrackerLookup));
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC20ProductPageExtension22HeroCarouselScrollView_pageTrackers));
  swift_release();
}
