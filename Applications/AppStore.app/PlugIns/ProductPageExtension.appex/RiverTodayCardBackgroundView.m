...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension28RiverTodayCardBackgroundView *v2;
...
{
  sub_10054E37C(self, (uint64_t)a2, (uint64_t)a3, sub_1005EE944);
}

- (void)didEnterBackground:(id)a3
{
  sub_10054E37C(self, (uint64_t)a2, (uint64_t)a3, sub_1005EF1DC);
}
...
- (void)preferredContentSizeDidChangeWithView:(id)a3 previousTraitCollection:(id)a4
{
  id v6;
  id v7;
  _TtC20ProductPageExtension28RiverTodayCardBackgroundView *v8;
...
{
  _TtC20ProductPageExtension28RiverTodayCardBackgroundView *result;

  result = (_TtC20ProductPageExtension28RiverTodayCardBackgroundView *)_swift_stdlib_reportUnimplementedInitializer("ProductPageExtension.RiverTodayCardBackgroundView", 49, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtC20ProductPageExtension28RiverTodayCardBackgroundView_colors));
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension28RiverTodayCardBackgroundView_meshTransforms));
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension28RiverTodayCardBackgroundView_riverViewStyling;
