...
{
  _TtC20ProductPageExtension40ProductPageReviewsOverflowViewController *result;

  result = (_TtC20ProductPageExtension40ProductPageReviewsOverflowViewController *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/ProductPageReviewsOverflowViewController.swift", 67, 2, 57, 0);
  __break(1u);
  return result;
}
...
- (void)viewDidLoad
{
  _TtC20ProductPageExtension40ProductPageReviewsOverflowViewController *v2;
...
- (_TtC20ProductPageExtension40ProductPageReviewsOverflowViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  v4 = a4;
  result = (_TtC20ProductPageExtension40ProductPageReviewsOverflowViewController *)_swift_stdlib_reportUnimplementedInitializer("ProductPageExtension.ProductPageReviewsOverflowViewController", 61, "init(nibName:bundle:)", 21, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension40ProductPageReviewsOverflowViewController_objectGraph));
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension40ProductPageReviewsOverflowViewController_itemLayoutContext;
