...
{
  return (_TtC20ProductPageExtension20AppPromotionCardView *)sub_1000A3A3C();
}
...
- (void)dealloc
{
  ...
  void *v4;
  _TtC20ProductPageExtension20AppPromotionCardView *v5;
  objc_super v6;
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension20AppPromotionCardView_lockupTapGestureRecognizer));
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension20AppPromotionCardView_lockupViewTappedAction), *(_QWORD *)&self->shadowView[OBJC_IVAR____TtC20ProductPageExtension20AppPromotionCardView_lockupViewTappedAction]);
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC20ProductPageExtension20AppPromotionCardView_videoView);
}

- (void)layoutSubviews
{
  _TtC20ProductPageExtension20AppPromotionCardView *v2;
...
- (void)handleTapWithGestureRecognizer:(id)a3
{
  ...
  id v6;
  uint64_t v7;
  _TtC20ProductPageExtension20AppPromotionCardView *v8;
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->shadowView[OBJC_IVAR____TtC20ProductPageExtension20AppPromotionCardView_lockupViewTappedAction];
    v6 = a3;
    v8 = self;
...
{
  return (_TtC11AppStoreKit16DynamicTypeLabel *)objc_retainAutoreleaseReturnValue(*(id *)(*(char **)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension20AppPromotionCardView_subtitleView)
                                                                                        + qword_1008203F0));
}
