...
- (void)setFrame:(CGRect)a3
{
  ...
  double x;
  objc_class *v8;
  _TtC20ProductPageExtension18ExpandableTextView *v9;
  double v10;
  double v11;
  double v12;
  double v13;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v6 = *(void **)&v5[OBJC_IVAR____TtC20ProductPageExtension18ExpandableTextView_textLabel];
...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension18ExpandableTextView *v2;
...
- (void)tintColorDidChange
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension18ExpandableTextView_moreButton];
...
- (void)moreFrom:(id)a3
{
  ...
  id v6;
  uint64_t v7;
  _TtC20ProductPageExtension18ExpandableTextView *v8;
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->textLabel[OBJC_IVAR____TtC20ProductPageExtension18ExpandableTextView_moreTapHandler];
    v6 = a3;
    v8 = self;
...
{
  _TtC20ProductPageExtension18ExpandableTextView *result;

  result = (_TtC20ProductPageExtension18ExpandableTextView *)_swift_stdlib_reportUnimplementedInitializer("ProductPageExtension.ExpandableTextView", 39, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension18ExpandableTextView_moreTapHandler), *(_QWORD *)&self->textLabel[OBJC_IVAR____TtC20ProductPageExtension18ExpandableTextView_moreTapHandler]);
}

- (BOOL)hasContent
{
  return objc_msgSend(*(id *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension18ExpandableTextView_textLabel), "hasContent");
}
