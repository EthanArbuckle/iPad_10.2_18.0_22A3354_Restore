...
{
  return (_TtC20ProductPageExtension28ArtworkSectionBackgroundView *)sub_10050CD18(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  CGRect.subtracting(insets:)(*(double *)&v2[OBJC_IVAR____TtC20ProductPageExtension28ArtworkSectionBackgroundView_insets], *(double *)&v2[OBJC_IVAR____TtC20ProductPageExtension28ArtworkSectionBackgroundView_insets + 8], *(double *)&v2[OBJC_IVAR____TtC20ProductPageExtension28ArtworkSectionBackgroundView_insets + 16], *(double *)&v2[OBJC_IVAR____TtC20ProductPageExtension28ArtworkSectionBackgroundView_insets + 24], v3, v4, v5, v6);
