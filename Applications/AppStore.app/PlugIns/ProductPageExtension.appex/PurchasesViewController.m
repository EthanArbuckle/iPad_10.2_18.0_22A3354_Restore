...
- (void)viewDidLoad
{
  _TtC20ProductPageExtension23PurchasesViewController *v2;
...
{
  sub_10038EE58(self, (uint64_t)a2, a3, (const char **)&selRef_viewWillAppear_, 0);
}

- (void)as_viewWillBecomeFullyVisible
{
  sub_10038EEDC(self, (uint64_t)a2, (const char **)&selRef_as_viewWillBecomeFullyVisible, 0);
}

- (void)viewDidDisappear:(BOOL)a3
{
  sub_10038EE58(self, (uint64_t)a2, a3, (const char **)&selRef_viewDidDisappear_, 1);
}

- (void)as_viewDidBecomePartiallyVisible
{
  sub_10038EEDC(self, (uint64_t)a2, (const char **)&selRef_as_viewDidBecomePartiallyVisible, 1);
}
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  double height;
  double width;
  _TtC20ProductPageExtension23PurchasesViewController *v8;

  height = a3.height;
  width = a3.width;
  swift_unknownObjectRetain(a4);
  v8 = self;
  sub_10038F278((uint64_t)a4, width, height);
...
{
  id v5;
  _TtC20ProductPageExtension23PurchasesViewController *v6;

  v5 = a3;
  v6 = self;
  sub_10038F6B4((uint64_t)a3);
...
- (void)searchBar:(id)a3 textDidChange:(id)a4
{
  ...
  uint64_t v8;
  id v9;
  _TtC20ProductPageExtension23PurchasesViewController *v10;
...
- (CGRect)_searchBar:(id)a3 proposedSearchFieldFrame:(CGRect)a4
{
  CGFloat height;
  CGFloat y;
  _TtC20ProductPageExtension23PurchasesViewController *v7;
  id v8;
  double v9;
  double v10;
  double v11;
...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.super.super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension23PurchasesViewController_shelfDataSource));
  swift_release(*(Class *)((char *)&self->super.super.super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension23PurchasesViewController_presenter));
  swift_release(*(Class *)((char *)&self->super.super.super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension23PurchasesViewController_artworkLoader));
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension23PurchasesViewController_navigationBarPalettePresenter));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
