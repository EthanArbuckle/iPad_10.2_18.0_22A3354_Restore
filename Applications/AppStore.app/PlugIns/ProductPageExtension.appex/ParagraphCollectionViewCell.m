...
{
  return (_TtC20ProductPageExtension27ParagraphCollectionViewCell *)sub_10031190C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension27ParagraphCollectionViewCell)initWithCoder:(id)a3
{
  ...
  void *v10;
  id v11;
  _TtC20ProductPageExtension27ParagraphCollectionViewCell *result;

  v5 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension27ParagraphCollectionViewCell_itemLayoutContext;
  v6 = type metadata accessor for ItemLayoutContext(0);
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(_QWORD *)(v6 - 8) + 56))(v5, 1, 1, v6);
  v7 = OBJC_IVAR____TtC20ProductPageExtension27ParagraphCollectionViewCell_expandableTextView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)sub_100607B44(v10, 0.0, 0.0, 0.0, 0.0);

  result = (_TtC20ProductPageExtension27ParagraphCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/ParagraphCollectionViewCell.swift", 54, 2, 46, 0);
  __break(1u);
  return result;
}
...
{
  _TtC20ProductPageExtension27ParagraphCollectionViewCell *v2;
...
- (void).cxx_destruct
{
  sub_1000119FC((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension27ParagraphCollectionViewCell_itemLayoutContext);
