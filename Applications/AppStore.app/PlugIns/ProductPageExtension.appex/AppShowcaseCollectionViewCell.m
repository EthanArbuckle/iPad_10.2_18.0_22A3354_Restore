...
{
  return (_TtC20ProductPageExtension29AppShowcaseCollectionViewCell *)sub_100398074(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension29AppShowcaseCollectionViewCell)initWithCoder:(id)a3
{
  ...
  uint64_t v11;
  uint64_t v12;
  _TtC20ProductPageExtension29AppShowcaseCollectionViewCell *result;
  ...
  v7 = OBJC_IVAR____TtC20ProductPageExtension29AppShowcaseCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v8, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  swift_unknownObjectWeakInit((char *)self + OBJC_IVAR____TtC20ProductPageExtension29AppShowcaseCollectionViewCell_videoView);
  ...
  result = (_TtC20ProductPageExtension29AppShowcaseCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/AppShowcaseCollectionViewCell.swift", 56, 2, 94, 0);
  __break(1u);
  return result;
}
...
{
  _TtC20ProductPageExtension29AppShowcaseCollectionViewCell *v2;
...
- (void).cxx_destruct
{
  ...
  sub_100010F2C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension29AppShowcaseCollectionViewCell_itemLayoutContext, &qword_1008081F0);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension29AppShowcaseCollectionViewCell_lockupView));
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC20ProductPageExtension29AppShowcaseCollectionViewCell_videoView);
