...
{
  return (_TtC20ProductPageExtension31CarouselItemSingleModuleOverlay *)sub_1005F28F8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  _TtC20ProductPageExtension31CarouselItemSingleModuleOverlay *v4;
  uint64_t v5;
  uint64_t v6;
  double v7;
  double v8;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC20ProductPageExtension31CarouselItemSingleModuleOverlay *v5;
  double v6;
  double v7;
  double v8;
  double v9;
  ...
  sub_1005F2CF8(v12);
  v7 = sub_1005F25B0((uint64_t)v12, sub_1000E1918, v6, height);
  v9 = v8;
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveEvent:(id)a4
{
  id v6;
  id v7;
  _TtC20ProductPageExtension31CarouselItemSingleModuleOverlay *v8;
  BOOL v9;
...
- (void)handleSelection:(id)a3
{
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->headerView[OBJC_IVAR____TtC20ProductPageExtension31CarouselItemSingleModuleOverlay_selectionHandler];
    v6 = a3;
    v8 = self;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension31CarouselItemSingleModuleOverlay_displayOptions;
  v4 = type metadata accessor for HeroCarouselItemOverlay.DisplayOptions(0);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension31CarouselItemSingleModuleOverlay_selectionHandler), *(_QWORD *)&self->headerView[OBJC_IVAR____TtC20ProductPageExtension31CarouselItemSingleModuleOverlay_selectionHandler]);
}
