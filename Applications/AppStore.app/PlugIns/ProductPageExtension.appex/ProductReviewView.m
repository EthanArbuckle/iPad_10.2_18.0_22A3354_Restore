...
{
  return (_TtC20ProductPageExtension17ProductReviewView *)sub_1004F2920(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension17ProductReviewView)initWithCoder:(id)a3
{
  ...
  v3 = a3;
  return (_TtC20ProductPageExtension17ProductReviewView *)sub_1004F639C();
}

- (void)layoutSubviews
{
  _TtC20ProductPageExtension17ProductReviewView *v2;
...
- (void)stateChangedFor:(id)a3
{
  ...
  uint64_t v6;
  __n128 v7;
  _TtC20ProductPageExtension17ProductReviewView *v8;
  ...
  if (objc_msgSend(v4, "state") == (id)1)
  {
    ...
    if (v5)
    {
      v6 = *(_QWORD *)&v8->titleLabel[OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_actionHandler];
      v7 = swift_retain(v6);
      v5(v7);
...
{
  sub_1004F5D64((char *)self, (uint64_t)a2, (uint64_t)a3, &OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_moreReviewTapHandler);
}

- (void)moreResponseFrom:(id)a3
{
  sub_1004F5D64((char *)self, (uint64_t)a2, (uint64_t)a3, &OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_moreResponseTapHandler);
}
...
- (void).cxx_destruct
{
  ...
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_moreReviewTapHandler), *(_QWORD *)&self->titleLabel[OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_moreReviewTapHandler]);
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_moreResponseTapHandler), *(_QWORD *)&self->titleLabel[OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_moreResponseTapHandler]);
  objc_release(*(id *)((char *)&self->super.super.super.isa
  ...
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_actionHandler), *(_QWORD *)&self->titleLabel[OBJC_IVAR____TtC20ProductPageExtension17ProductReviewView_actionHandler]);
}
