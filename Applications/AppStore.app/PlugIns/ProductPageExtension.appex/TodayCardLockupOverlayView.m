...
{
  return (_TtC20ProductPageExtension26TodayCardLockupOverlayView *)sub_100407800(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)dealloc
{
  ...
  void *v4;
  _TtC20ProductPageExtension26TodayCardLockupOverlayView *v5;
  objc_super v6;
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_tapGestureRecognizer));
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_impressionsCalculator);
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_impressionsUpdateBlock), *(_QWORD *)&self->lockupView[OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_impressionsUpdateBlock]);
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_separatorView));
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_clickActionHandler), *(_QWORD *)&self->lockupView[OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_clickActionHandler]);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  char *v9;
  void *v10;
  _TtC20ProductPageExtension26TodayCardLockupOverlayView *v11;
  id v12;
  double v13;
  double v14;
  double v15;
  ...
  sub_10020FBC4((uint64_t)v9, (uint64_t)v12, width, height);
  v14 = v13;
...
- (void)layoutSubviews
{
  _TtC20ProductPageExtension26TodayCardLockupOverlayView *v2;
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  id v6;
  id v7;
  _TtC20ProductPageExtension26TodayCardLockupOverlayView *v8;
  BOOL v9;
...
- (void)handleTapWithGestureRecognizer:(id)a3
{
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->lockupView[OBJC_IVAR____TtC20ProductPageExtension26TodayCardLockupOverlayView_clickActionHandler];
    v6 = a3;
    v8 = self;
...
- (void)setAccessibilityElements:(id)isa
{
  objc_class *ObjectType;
  uint64_t v6;
  _TtC20ProductPageExtension26TodayCardLockupOverlayView *v7;
  _TtC20ProductPageExtension26TodayCardLockupOverlayView *v8;
  objc_super v9;
