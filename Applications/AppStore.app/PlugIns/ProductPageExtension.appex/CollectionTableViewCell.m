...
- (void)layoutSubviews
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension23CollectionTableViewCell_collectionView];
  if (v3)
  {
    v4 = v3;
...
- (_TtC20ProductPageExtension23CollectionTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  return (_TtC20ProductPageExtension23CollectionTableViewCell *)sub_100246390(a3, (uint64_t)a4, v6);
}
...
- (_TtC20ProductPageExtension23CollectionTableViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
  ...
  swift_unknownObjectWeakInit((char *)self + OBJC_IVAR____TtC20ProductPageExtension23CollectionTableViewCell_delegate);
  *(Class *)((char *)&self->super.super.super.super.isa
...
- (void).cxx_destruct
{
  ...
  sub_100010D1C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension23CollectionTableViewCell_delegate);
