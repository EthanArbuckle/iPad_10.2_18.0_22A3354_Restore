...
{
  return (_TtC20ProductPageExtension20SegmentedControlView *)sub_1004AD74C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension20SegmentedControlView)initWithCoder:(id)a3
{
  _QWORD *v4;
  id v5;
  _TtC20ProductPageExtension20SegmentedControlView *result;
  ...
  *v4 = 0;
  ...
  result = (_TtC20ProductPageExtension20SegmentedControlView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/SegmentedControlView.swift", 47, 2, 53, 0);
  __break(1u);
  return result;
}
...
{
  CGFloat width;
  _TtC20ProductPageExtension20SegmentedControlView *v4;
  id v5;
  double v6;
  double v7;
  double v8;
  ...
  v5 = objc_msgSend(*(id *)((char *)&v4->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension20SegmentedControlView_segmentedControl), "sizeThatFits:");
...
- (void)selectedIndexChangedIn:(id)a3
{
  ...
  uint64_t v5;
  id v6;
  _TtC20ProductPageExtension20SegmentedControlView *v7;

  v3 = *(void (**)(id))((char *)&self->super.super.super.isa
                                 + OBJC_IVAR____TtC20ProductPageExtension20SegmentedControlView_segmentDidChangeHandler);
  if (v3)
  {
    v5 = *(_QWORD *)&self->segmentedControl[OBJC_IVAR____TtC20ProductPageExtension20SegmentedControlView_segmentDidChangeHandler];
    v6 = a3;
    v7 = self;
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension20SegmentedControlView_segmentedControl));
  sub_100018908(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension20SegmentedControlView_segmentDidChangeHandler), *(_QWORD *)&self->segmentedControl[OBJC_IVAR____TtC20ProductPageExtension20SegmentedControlView_segmentDidChangeHandler]);
}
