...
{
  _TtC20ProductPageExtension36AppPromotionDetailPageCloseAnimation *v5;
  double v6;
  id v7;
  _TtC20ProductPageExtension36AppPromotionDetailPageCloseAnimation *v8;
  double v9;
  ...
  else
  {
    ...
    v8 = (_TtC20ProductPageExtension36AppPromotionDetailPageCloseAnimation *)objc_msgSend(objc_allocWithZone((Class)UIViewPropertyAnimator), "initWithDuration:timingParameters:", v7, 0.0);
...
{
  _TtC20ProductPageExtension36AppPromotionDetailPageCloseAnimation *result;

  result = (_TtC20ProductPageExtension36AppPromotionDetailPageCloseAnimation *)_swift_stdlib_reportUnimplementedInitializer("ProductPageExtension.AppPromotionDetailPageCloseAnimation", 57, "init()", 6, 0);
  __break(1u);
  return result;
}
