...
+ (id)rootDictForPath:(id)a3
{
  ...
  {
    v25 = 0;
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSData dataWithContentsOfURL:options:error:](NSData, "dataWithContentsOfURL:options:error:", v4, 1, &v25));
    v6 = v25;
    v8 = v6;
    if (v5)
    {
      v9 = objc_opt_class(CALayer, v7);
      v11 = objc_opt_class(NSMutableDictionary, v10);
      v13 = objc_opt_class(NSArray, v12);
      v15 = objc_opt_class(NSNumber, v14);
      v17 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v9, v11, v13, v15, objc_opt_class(NSString, v16), 0);
      v18 = (void *)objc_claimAutoreleasedReturnValue(v17);
      v24 = v8;
      v19 = (void *)objc_claimAutoreleasedReturnValue(+[NSKeyedUnarchiver unarchivedObjectOfClasses:fromData:error:](NSKeyedUnarchiver, "unarchivedObjectOfClasses:fromData:error:", v18, v5, &v24));
      v20 = v24;

      if (v20)
      {
        v21 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "lastPathComponent"));
        NSLog(CFSTR("Unable to open Mica file: %@"), v21);

        v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "description"));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v13 = objc_msgSend((id)objc_opt_class(self, v12), "allocWithZone:", a3);
  -[AppStoreMicaPlayer retinaScale](self, "retinaScale");
  v14 = objc_msgSend(v13, "initWithPath:retinaScale:rootLayer:publishedObjects:", v6, v8, v11);
...
+ (id)updatePublishedObjects:(id)a3 toReferenceLayersInTree:(id)a4 ratherThanLayersInTree:(id)a5
{
  ...
  v8 = a4;
  v9 = a5;
  v32 = (id)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionary](NSMutableDictionary, "dictionary"));
  if (v7 && objc_msgSend(v7, "count"))
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "mp_allLayersInTree"));
    v28 = v9;
    v30 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "mp_allAnimationsInTree"));
    v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "mp_allLayersInTree"));
    v29 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "mp_allAnimationsInTree"));
    v33 = 0u;
    v34 = 0u;
    v35 = 0u;
    v36 = 0u;
    ...
    if (v12)
    {
      ...
      do
      {
        for (i = 0; i != v13; i = (char *)i + 1)
        {
          ...
          v16 = *(_QWORD *)(*((_QWORD *)&v33 + 1) + 8 * (_QWORD)i);
          v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "objectForKeyedSubscript:", v16));
          v19 = objc_opt_class(CALayer, v18);
          isKindOfClass = objc_opt_isKindOfClass(v17, v19);
          v22 = v10;
          v23 = v11;
          if ((isKindOfClass & 1) != 0
            || (v24 = objc_opt_class(CAAnimation, v20),
                v25 = objc_opt_isKindOfClass(v17, v24),
                v23 = v29,
                v22 = v30,
                (v25 & 1) != 0))
          {
            v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v23, "objectAtIndexedSubscript:", objc_msgSend(v22, "indexOfObjectIdenticalTo:", v17)));
            objc_msgSend(v32, "setObject:forKeyedSubscript:", v26, v16);
...
- (id)publishedLayerWithKey:(id)a3 required:(BOOL)a4
{
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[AppStoreMicaPlayer publishedObjectWithKey:required:](self, "publishedObjectWithKey:required:", a3, a4));
  if (v5)
  {
    v6 = objc_opt_class(CALayer, v4);
