...
- (void)layoutSubviews
{
  ...
  v4 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension10MirrorView_artworkLayer];
...
- (void).cxx_destruct
{
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC20ProductPageExtension15VideoMirrorView_sourceVideoView);
