...
{
  return (_TtC20ProductPageExtension31TodayDebugSectionBackgroundView *)sub_1003E9790(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension31TodayDebugSectionBackgroundView)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC20ProductPageExtension31TodayDebugSectionBackgroundView *result;

  v5 = OBJC_IVAR____TtC20ProductPageExtension31TodayDebugSectionBackgroundView_sectionTypeIndicator;
  v6 = objc_allocWithZone((Class)UIView);
  v7 = a3;
  *(Class *)((char *)&self->super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "init");

  result = (_TtC20ProductPageExtension31TodayDebugSectionBackgroundView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/TodayDebugSectionBackgroundView.swift", 58, 2, 37, 0);
  __break(1u);
  return result;
}
...
{
  objc_class *v3;
  _TtC20ProductPageExtension31TodayDebugSectionBackgroundView *v4;
  void *v5;
  double MinX;
  double MinY;
  double v8;
  ...
  if (qword_100805B10 != -1)
    swift_once(&qword_100805B10, sub_1003E9780);
  v8 = *(double *)&qword_100820D80;
