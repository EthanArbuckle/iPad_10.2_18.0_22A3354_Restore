...
- (_TtC20ProductPageExtension27ArcadeHeaderButtonContainer)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC20ProductPageExtension27ArcadeHeaderButtonContainer *result;

  v5 = OBJC_IVAR____TtC20ProductPageExtension27ArcadeHeaderButtonContainer_stackView;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC20ProductPageExtension27ArcadeHeaderButtonContainer *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/ArcadeHeaderButtonContainer.swift", 54, 2, 49, 0);
  __break(1u);
  return result;
}
...
- (_TtC20ProductPageExtension27ArcadeHeaderButtonContainer)initWithFrame:(CGRect)a3
{
  ...
  result = (_TtC20ProductPageExtension27ArcadeHeaderButtonContainer *)_swift_stdlib_reportUnimplementedInitializer("ProductPageExtension.ArcadeHeaderButtonContainer", 48, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC20ProductPageExtension27ArcadeHeaderButtonContainer_objectGraph));
