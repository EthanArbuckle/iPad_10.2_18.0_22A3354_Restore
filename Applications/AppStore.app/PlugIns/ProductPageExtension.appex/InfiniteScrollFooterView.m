...
{
  return (_TtC20ProductPageExtension24InfiniteScrollFooterView *)sub_1004C2130(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC20ProductPageExtension24InfiniteScrollFooterView)initWithCoder:(id)a3
{
  _TtC20ProductPageExtension24InfiniteScrollFooterView *result;

  result = (_TtC20ProductPageExtension24InfiniteScrollFooterView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/InfiniteScrollFooterView.swift", 51, 2, 32, 0);
  __break(1u);
  return result;
}
...
{
  CGFloat width;
  _TtC20ProductPageExtension24InfiniteScrollFooterView *v4;
  id v5;
  uint64_t v6;
  uint64_t v7;
  uint64_t v8;
  ...
  sub_10000EFC4(v6, (uint64_t)qword_10086A818);
...
{
  _TtC20ProductPageExtension24InfiniteScrollFooterView *v2;
  id v3;
  uint64_t v4;
  uint64_t v5;
  uint64_t v6;
  ...
  sub_10000EFC4(v4, (uint64_t)qword_10086A818);
  type metadata accessor for TraitEnvironmentPlaceholder(0);
...
- (void)layoutSubviews
{
  ...
  v8 = v7;
  v10 = v9;
  v11 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension24InfiniteScrollFooterView_activityIndicator];
...
{
  sub_1004C26BC(self, (uint64_t)a2, a3, (const char **)&selRef_willMoveToWindow_);
}

- (void)willMoveToSuperview:(id)a3
{
  sub_1004C26BC(self, (uint64_t)a2, a3, (const char **)&selRef_willMoveToSuperview_);
}
