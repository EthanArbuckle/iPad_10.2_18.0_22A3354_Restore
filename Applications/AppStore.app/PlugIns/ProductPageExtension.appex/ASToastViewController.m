...
- (void)viewDidLayoutSubviews
{
  ...
  v94.receiver = self;
  v94.super_class = (Class)ASToastViewController;
  -[ASToastViewController viewDidLayoutSubviews](&v94, "viewDidLayoutSubviews");
  ...
  *(double *)&v92 = v14 + 25.0;
  *((double *)&v92 + 1) = v15 + 40.0;
  *(double *)&v93 = v16 + -50.0;
  *((double *)&v93 + 1) = v17 + -65.0;
  ...
  v37 = objc_msgSend((id)objc_opt_class(self, v36), "_primaryLabelFont");
  ...
  v40 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController primaryLabel](self, "primaryLabel"));
  ((void (*)(_QWORD *, void *, _QWORD, double))v35[2])(v35, v40, 0, 18.0);

  v42 = objc_msgSend((id)objc_opt_class(self, v41), "_secondaryLabelFont");
  v43 = (void *)objc_claimAutoreleasedReturnValue(v42);
  v44 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController secondaryLabel](self, "secondaryLabel"));
  objc_msgSend(v44, "setFont:", v43);

  v45 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController secondaryLabel](self, "secondaryLabel"));
  ((void (*)(_QWORD *, void *, _QWORD, double))v35[2])(v35, v45, 0, 25.5);

  v46 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController toastView](self, "toastView"));
  ...
  v53 = v85[3];
  v54 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController toastView](self, "toastView"));
  v55 = v54;
  v56 = fmin(v53 + 25.0, 450.0);
  if (v56 < 250.0)
    v56 = 250.0;
  v57 = v56;
  objc_msgSend(v54, "setBounds:", v48, v50, v52, ceilf(v57));

  v58 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController toastView](self, "toastView"));
  v59 = objc_msgSend(v58, "frame");
  v64 = UIRectCenteredXInRectScale(v59, v60, v61, v62, v63, v79, v81, v80, v8, v11);
  v66 = v65;
  v68 = v67;
  v70 = v69;

  v71 = UIRectCenteredYInRectScale(v64, v66, v68, v70, v79, v81, v80, v8, v11);
  v73 = v72;
  v75 = v74;
  v77 = v76;
  v78 = (void *)objc_claimAutoreleasedReturnValue(-[ASToastViewController toastView](self, "toastView"));
