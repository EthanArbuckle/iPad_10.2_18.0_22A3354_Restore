...
{
  return (_TtC20ProductPageExtension23QuoteCollectionViewCell *)sub_1004D20B4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension23QuoteCollectionViewCell)initWithCoder:(id)a3
{
  ...
  _QWORD *v7;
  id v8;
  _TtC20ProductPageExtension23QuoteCollectionViewCell *result;
  ...
  *v7 = 0;
  ...
  result = (_TtC20ProductPageExtension23QuoteCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100685560, "ProductPageExtension/QuoteCollectionViewCell.swift", 50, 2, 42, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_1000119FC((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension23QuoteCollectionViewCell_itemLayoutContext);
