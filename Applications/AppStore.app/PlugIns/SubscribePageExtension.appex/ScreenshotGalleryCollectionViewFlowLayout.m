...
- (_TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout)init
{
  char *v3;
  uint64_t v4;
  _TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout *v5;
  objc_super v7;
...
- (_TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout)initWithCoder:(id)a3
{
  ...
  uint64_t v6;
  id v7;
  _TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout *result;
  ...
  result = (_TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/ScreenshotGalleryCollectionViewFlowLayout.swift", 70, 2, 36, 0);
  __break(1u);
  return result;
}
...
- (void)dealloc
{
  _TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout *v2;
  id v3;
  void *v4;
  id v5;
  objc_super v6;
...
- (void).cxx_destruct
{
  sub_1000DE220((uint64_t)self+ OBJC_IVAR____TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout_indexPathAtInitialScroll);
}
...
- (CGPoint)targetContentOffsetForProposedContentOffset:(CGPoint)a3 withScrollingVelocity:(CGPoint)a4
{
  ...
  double v6;
  double v7;
  _TtC22SubscribePageExtension41ScreenshotGalleryCollectionViewFlowLayout *v8;
  double v9;
  double v10;
  double v11;
  double v12;
