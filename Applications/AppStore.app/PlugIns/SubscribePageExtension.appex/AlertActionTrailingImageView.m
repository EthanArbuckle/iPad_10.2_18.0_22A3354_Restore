...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension28AlertActionTrailingImageView *v2;
...
- (void)tintColorDidChange
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension28AlertActionTrailingImageView_label];
...
{
  double width;
  _TtC22SubscribePageExtension28AlertActionTrailingImageView *v4;
  double v5;
  double v6;
  double v7;
  double v8;
...
{
  _TtC22SubscribePageExtension28AlertActionTrailingImageView *result;

  result = (_TtC22SubscribePageExtension28AlertActionTrailingImageView *)_swift_stdlib_reportUnimplementedInitializer("SubscribePageExtension.AlertActionTrailingImageView", 51, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
