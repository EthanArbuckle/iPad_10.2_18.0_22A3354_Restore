...
{
  return (_TtC22SubscribePageExtension26FootnoteCollectionViewCell *)sub_100207D6C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension26FootnoteCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v9;
  id v10;
  _TtC22SubscribePageExtension26FootnoteCollectionViewCell *result;

  v5 = (char *)self + OBJC_IVAR____TtC22SubscribePageExtension26FootnoteCollectionViewCell_itemLayoutContext;
  v6 = type metadata accessor for ItemLayoutContext(0);
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(_QWORD *)(v6 - 8) + 56))(v5, 1, 1, v6);
  v7 = OBJC_IVAR____TtC22SubscribePageExtension26FootnoteCollectionViewCell_footnoteView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v9, "init");
  ...
  result = (_TtC22SubscribePageExtension26FootnoteCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/FootnoteCollectionViewCell.swift", 55, 2, 30, 0);
  __break(1u);
  return result;
}
...
{
  _TtC22SubscribePageExtension26FootnoteCollectionViewCell *v2;
...
{
  _TtC22SubscribePageExtension26FootnoteCollectionViewCell *v4;
...
- (void).cxx_destruct
{
  sub_100028A60((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension26FootnoteCollectionViewCell_itemLayoutContext);
