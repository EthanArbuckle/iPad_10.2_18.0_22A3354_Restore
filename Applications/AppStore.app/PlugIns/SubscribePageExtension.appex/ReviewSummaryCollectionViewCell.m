...
{
  return (_TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell *)sub_10059F6F8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v8;
  id v9;
  _TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell *result;
  ...
  v7 = OBJC_IVAR____TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell_reviewSummaryView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v8, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/ReviewSummaryCollectionViewCell.swift", 60, 2, 26, 0);
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell *v5;
  id v6;
  double v7;
  double v8;
  double v9;
  ...
  v7 = sub_10024D984((uint64_t)v6, width, height);
  v9 = v8;
...
- (void).cxx_destruct
{
  sub_100028A60((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension31ReviewSummaryCollectionViewCell_itemLayoutContext);
