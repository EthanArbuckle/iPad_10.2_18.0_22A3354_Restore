...
{
  return (_TtC22SubscribePageExtension18AgeRatingBadgeView *)sub_1003F0404(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)tintColorDidChange
{
  void *v2;
  id v3;
  _TtC22SubscribePageExtension18AgeRatingBadgeView *v4;
...
- (void)drawRect:(CGRect)a3
{
  ...
  CGFloat y;
  CGFloat x;
  _TtC22SubscribePageExtension18AgeRatingBadgeView *v7;
  ...
  x = a3.origin.x;
  v7 = self;
  sub_1003F0A58(x, y, width, height);
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC22SubscribePageExtension18AgeRatingBadgeView_scalableCornerRadius;
