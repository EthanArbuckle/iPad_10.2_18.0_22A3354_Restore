...
{
  _TtC22SubscribePageExtension34BaseCollectionViewLayoutAttributes *v4;
  uint64_t v5;
  _QWORD *v6;
  void *v7;
  _QWORD v9[3];
  ...
  v4 = self;
  sub_1005FD258((uint64_t)a3, (uint64_t)v9);

  v5 = v10;
  v6 = sub_100011064(v9, v10);
...
- (BOOL)isEqual:(id)a3
{
  _TtC22SubscribePageExtension34BaseCollectionViewLayoutAttributes *v5;
  uint64_t v6;
  _TtC22SubscribePageExtension34BaseCollectionViewLayoutAttributes *v7;
  BOOL v8;
  _OWORD v10[2];
