...
{
  return (_TtC22SubscribePageExtension30SearchActionCollectionViewCell *)sub_100028450(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension30SearchActionCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v8;
  id v9;
  _TtC22SubscribePageExtension30SearchActionCollectionViewCell *result;
  ...
  v7 = OBJC_IVAR____TtC22SubscribePageExtension30SearchActionCollectionViewCell_actionContentView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v8, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC22SubscribePageExtension30SearchActionCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/SearchActionCollectionViewCell.swift", 59, 2, 32, 0);
  __break(1u);
  return result;
}
...
- (void)prepareForReuse
{
  ...
  v3 = *(_QWORD *)&v2[OBJC_IVAR____TtC22SubscribePageExtension30SearchActionCollectionViewCell_actionContentView];
...
- (void).cxx_destruct
{
  sub_100028A60((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension30SearchActionCollectionViewCell_itemLayoutContext);
