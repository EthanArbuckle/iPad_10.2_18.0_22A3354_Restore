...
{
  return (_TtC22SubscribePageExtension27StoryCardCollectionViewCell *)sub_1002A9784(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (void)layoutSubviews
{
  _TtC22SubscribePageExtension27StoryCardCollectionViewCell *v2;
...
{
  uint64_t v4;
  _TtC22SubscribePageExtension27StoryCardCollectionViewCell *v5;
  NSArray v6;
  _TtC22SubscribePageExtension27StoryCardCollectionViewCell *v7;
  objc_super v8;
...
- (void).cxx_destruct
{
  ...
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC22SubscribePageExtension27StoryCardCollectionViewCell_objectGraph);
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC22SubscribePageExtension27StoryCardCollectionViewCell_todayCard);
}
