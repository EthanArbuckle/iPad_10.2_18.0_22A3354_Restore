...
{
  return (_TtC22SubscribePageExtension27EditorsChoiceBackgroundView *)sub_1002E84D8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension27EditorsChoiceBackgroundView)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC22SubscribePageExtension27EditorsChoiceBackgroundView *result;

  v5 = OBJC_IVAR____TtC22SubscribePageExtension27EditorsChoiceBackgroundView_imageView;
  v6 = objc_allocWithZone((Class)UIImageView);
  v7 = a3;
  *(Class *)((char *)&self->super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "init");

  result = (_TtC22SubscribePageExtension27EditorsChoiceBackgroundView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/EditorsChoiceBackgroundView.swift", 56, 2, 67, 0);
  __break(1u);
  return result;
}
