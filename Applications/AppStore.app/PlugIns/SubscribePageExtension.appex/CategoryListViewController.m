...
- (_TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController)initWithCoder:(id)a3
{
  _QWORD *v4;
  id v5;
  _TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *result;
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/SelectCategoryViewController.swift", 57, 2, 187, 0);
  __break(1u);
  return result;
}
...
- (void)viewDidLoad
{
  _TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *v2;
...
{
  sub_10033D57C(self, (uint64_t)a2, (const char **)&selRef_as_viewWillBecomeFullyVisible, 0);
}
...
{
  sub_10033D57C(self, (uint64_t)a2, (const char **)&selRef_as_viewDidBecomePartiallyVisible, 1);
}
...
- (void)dismissSelf
{
  ...
  uint64_t v3;
  uint64_t v4;
  _TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *v5;
  ...
  v3 = *(uint64_t *)((char *)&v5->super.super.super.super.isa
                  + OBJC_IVAR____TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController_selectionHandler);
  v4 = *(_QWORD *)&v5->dataSource[OBJC_IVAR____TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController_selectionHandler];
  *v2 = 0;
  v2[1] = 0;
  sub_100019310(v3, v4);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  uint64_t v9;
  id v10;
  _TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *v11;
  int64_t v12;
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  char *v10;
  id v11;
  _TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *v12;
  id v13;
  uint64_t v15;
  ...
  v11 = a3;
  v12 = self;
  v13 = sub_10033D7AC(v11, (uint64_t)v10);
...
- (void)tableView:(id)a3 didEndDisplayingCell:(id)a4 forRowAtIndexPath:(id)a5
{
  ...
  id v13;
  id v14;
  _TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *v15;
  id v16;
  unint64_t v17;
  unint64_t v18;
  id v19;
...
- (_TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController)initWithStyle:(int64_t)a3
{
  ...
  result = (_TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController *)_swift_stdlib_reportUnimplementedInitializer("SubscribePageExtension.CategoryListViewController", 49, "init(style:)", 12, 0);
  __break(1u);
  return result;
}
...
{
  sub_10033DF50((uint64_t)self, (uint64_t)a2, (uint64_t)a3, a4, (uint64_t)"SubscribePageExtension.CategoryListViewController", 49);
}
...
- (void).cxx_destruct
{
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.super.isa
                         + OBJC_IVAR____TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController_artworkLoader));
  v3 = (char *)self
     + OBJC_IVAR____TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController_parentIndexPath;
  v4 = type metadata accessor for IndexPath(0);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  sub_100019310(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController_selectionHandler), *(_QWORD *)&self->dataSource[OBJC_IVAR____TtC22SubscribePageExtensionP33_E8A3C8C9EB70237120159EB97F20AEB326CategoryListViewController_selectionHandler]);
