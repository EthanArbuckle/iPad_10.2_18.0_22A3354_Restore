...
{
  _TtC22SubscribePageExtension42ArcadeDownloadPackCategoriesViewController *v2;
...
- (void).cxx_destruct
{
  swift_release(*(_QWORD *)&self->super.OBWelcomeController_opaque[OBJC_IVAR____TtC22SubscribePageExtension42ArcadeDownloadPackCategoriesViewController_presenter]);
