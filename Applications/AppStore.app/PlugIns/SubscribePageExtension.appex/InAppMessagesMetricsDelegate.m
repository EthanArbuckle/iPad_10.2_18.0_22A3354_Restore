...
- (void)messageDidReportMetricsEvent:(id)a3 eventProperties:(id)a4
{
  ...
  char *v16;
  uint64_t v17;
  _TtC22SubscribePageExtension28InAppMessagesMetricsDelegate *v18;
  uint64_t v19;
  uint64_t v20;
  uint64_t v21;
  uint64_t v22;
  id v23;
  _TtC22SubscribePageExtension28InAppMessagesMetricsDelegate *v24;
  uint64_t v25;

  v24 = self;
  v25 = type metadata accessor for MetricsFieldsContext(0, a2);
  v6 = *(_QWORD *)(v25 - 8);
  __chkstk_darwin(v25);
  ...
  v20 = (*(uint64_t (**)(char *, uint64_t, uint64_t))(v10 + 16))(v12, (uint64_t)v18 + OBJC_IVAR____TtC22SubscribePageExtension28InAppMessagesMetricsDelegate_metricsPipeline, v9);
...
{
  _TtC22SubscribePageExtension28InAppMessagesMetricsDelegate *result;

  result = (_TtC22SubscribePageExtension28InAppMessagesMetricsDelegate *)_swift_stdlib_reportUnimplementedInitializer("SubscribePageExtension.InAppMessagesMetricsDelegate", 51, "init()", 6, 0);
  __break(1u);
  return result;
}
