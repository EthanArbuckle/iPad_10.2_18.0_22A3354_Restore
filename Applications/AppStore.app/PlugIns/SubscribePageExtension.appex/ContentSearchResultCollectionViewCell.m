...
{
  return (_TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell *)sub_10019B588(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v7;
  uint64_t v8;
  _TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell *result;

  v5 = OBJC_IVAR____TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  v8 = OBJC_IVAR____TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell_screenshots;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/ContentSearchResultCollectionViewCell.swift", 66, 2, 66, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell *v2;
...
- (void)prepareForReuse
{
  ...
  v6 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell_screenshots];
  sub_10052DDD4();
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.super.isa
                                     + OBJC_IVAR____TtC22SubscribePageExtension37ContentSearchResultCollectionViewCell_preferredImageSizes));
}
