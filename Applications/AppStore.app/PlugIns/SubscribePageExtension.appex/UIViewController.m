...
+ (void)as_activatePresentationHack
{
  ...
  block[3] = &unk_10071FF18;
  block[4] = a1;
  if (qword_10081D4B8 != -1)
    dispatch_once(&qword_10081D4B8, block);
}
...
- (_TtP22SubscribePageExtension20PageTraitEnvironment_)snapshotPageTraitEnvironment
{
  ...
  *(_QWORD *)v10 = v4;
  *((_QWORD *)v10 + 1) = v6;
  *(_QWORD *)&v9[OBJC_IVAR____TtC22SubscribePageExtension28SnapshotPageTraitEnvironment_traitCollection] = v7;
  v13.receiver = v9;
  v13.super_class = v8;
