...
{
  return (_TtC22SubscribePageExtension16AppEventCardView *)sub_10015D5B4();
}
...
- (void)dealloc
{
  _TtC22SubscribePageExtension16AppEventCardView *v2;
  uint64_t v3;

  v2 = self;
  sub_10015ADEC((uint64_t)v2, v3);
}
...
- (void).cxx_destruct
{
  ...
  sub_100019310(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC22SubscribePageExtension16AppEventCardView_lockupViewTappedAction), *(_QWORD *)&self->shadowView[OBJC_IVAR____TtC22SubscribePageExtension16AppEventCardView_lockupViewTappedAction]);
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC22SubscribePageExtension16AppEventCardView_videoView);
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  uint64_t v7;
  _QWORD *v8;
  _TtC22SubscribePageExtension16AppEventCardView *v9;
  double v10;
  double v11;
  double v12;
  double v13;
  ...
  sub_1005B08AC(v9, v8, width, height);
  v11 = v10;
  v13 = v12;
...
- (void)handleTapWithGestureRecognizer:(id)a3
{
  ...
  id v6;
  uint64_t v7;
  _TtC22SubscribePageExtension16AppEventCardView *v8;
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->shadowView[OBJC_IVAR____TtC22SubscribePageExtension16AppEventCardView_lockupViewTappedAction];
    v6 = a3;
    v8 = self;
...
- (void)notifyMeButtonTapped:(id)a3
{
  uint64_t v3;
  id v5;
  _TtC22SubscribePageExtension16AppEventCardView *v6;
