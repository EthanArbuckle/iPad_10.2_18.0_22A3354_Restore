...
{
  return (_TtC22SubscribePageExtension20PlatformSelectorView *)sub_10035782C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension20PlatformSelectorView)initWithCoder:(id)a3
{
  _QWORD *v4;
  id v5;
  _TtC22SubscribePageExtension20PlatformSelectorView *result;
  ...
  *v4 = 0;
  ...
  result = (_TtC22SubscribePageExtension20PlatformSelectorView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/PlatformSelectorView.swift", 49, 2, 132, 0);
  __break(1u);
  return result;
}
...
- (void)didTapSelectorView
{
  ...
  uint64_t v3;
  uint64_t v4;
  _TtC22SubscribePageExtension20PlatformSelectorView *v5;

  v2 = *(void (**)(uint64_t))((char *)&self->super.super.super.super.isa
                                      + OBJC_IVAR____TtC22SubscribePageExtension20PlatformSelectorView_didSelectHandler);
  if (v2)
  {
    v3 = *(_QWORD *)&self->descriptionWithBadgesAsHeadingLabel[OBJC_IVAR____TtC22SubscribePageExtension20PlatformSelectorView_didSelectHandler];
    v5 = self;
...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension20PlatformSelectorView *v2;
...
- (_TtC11AppStoreKit16DynamicTypeLabel)accessibilityDescriptionLabel
{
  ...
  char *v6;
  uint64_t v7;
  _TtC22SubscribePageExtension20PlatformSelectorView *v8;
  id v9;
  uint64_t v11;
  ...
  v7 = *(uint64_t *)((char *)&self->super.super.super.super.isa
                  + OBJC_IVAR____TtC22SubscribePageExtension20PlatformSelectorView_numberOfBadges);
  v8 = self;
  static BadgeDisplayStyle.style(forBadgeCount:pageTraits:indentForBadges:)(v7, v8, 0, 1);
  v9 = sub_1003581DC((uint64_t)v6);
...
- (void).cxx_destruct
{
  ...
  sub_100019310(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC22SubscribePageExtension20PlatformSelectorView_didSelectHandler), *(_QWORD *)&self->descriptionWithBadgesAsHeadingLabel[OBJC_IVAR____TtC22SubscribePageExtension20PlatformSelectorView_didSelectHandler]);
}
