...
{
  uint64_t v2;
  _TtC22SubscribePageExtension28RiverTodayCardBackgroundView *v3;

  v3 = self;
  sub_10013786C((uint64_t)v3, v2);
...
{
  sub_100139484(self, (uint64_t)a2, (uint64_t)a3, sub_100137710);
}

- (void)didEnterBackground:(id)a3
{
  sub_100139484(self, (uint64_t)a2, (uint64_t)a3, sub_100137FA8);
}
...
- (void)preferredContentSizeDidChangeWithView:(id)a3 previousTraitCollection:(id)a4
{
  id v6;
  id v7;
  _TtC22SubscribePageExtension28RiverTodayCardBackgroundView *v8;
...
{
  _TtC22SubscribePageExtension28RiverTodayCardBackgroundView *result;

  result = (_TtC22SubscribePageExtension28RiverTodayCardBackgroundView *)_swift_stdlib_reportUnimplementedInitializer("SubscribePageExtension.RiverTodayCardBackgroundView", 51, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtC22SubscribePageExtension28RiverTodayCardBackgroundView_colors));
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC22SubscribePageExtension28RiverTodayCardBackgroundView_meshTransforms));
  v3 = (char *)self + OBJC_IVAR____TtC22SubscribePageExtension28RiverTodayCardBackgroundView_riverViewStyling;
