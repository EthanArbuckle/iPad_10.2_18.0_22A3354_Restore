...
{
  return (_TtC22SubscribePageExtension34ArcadeDownloadPackCategoryListView *)sub_1003E68B0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC22SubscribePageExtension34ArcadeDownloadPackCategoryListView *v5;
  id v6;
  double v7;
  double v8;
  double v9;
...
{
  _TtC22SubscribePageExtension34ArcadeDownloadPackCategoryListView *v2;
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtC22SubscribePageExtension34ArcadeDownloadPackCategoryListView_categoryViews));
}
