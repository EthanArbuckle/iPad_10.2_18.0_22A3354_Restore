...
{
  return (_TtC22SubscribePageExtension35AppPromotionOfferCollectionViewCell *)sub_100411818();
}
...
- (_TtC22SubscribePageExtension35AppPromotionOfferCollectionViewCell)initWithCoder:(id)a3
{
  ...
  uint64_t v6;
  id v7;
  _TtC22SubscribePageExtension35AppPromotionOfferCollectionViewCell *result;
  ...
  result = (_TtC22SubscribePageExtension35AppPromotionOfferCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/AppPromotionOfferCollectionViewCell.swift", 64, 2, 34, 0);
  __break(1u);
  return result;
}
...
{
  _TtC22SubscribePageExtension35AppPromotionOfferCollectionViewCell *v2;
...
- (void).cxx_destruct
{
  sub_100011088((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension35AppPromotionOfferCollectionViewCell_itemLayoutContext, &qword_1007F4A50);
