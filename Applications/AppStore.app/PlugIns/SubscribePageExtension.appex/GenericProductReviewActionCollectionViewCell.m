...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension44GenericProductReviewActionCollectionViewCell *v2;
...
- (void).cxx_destruct
{
  sub_100028A60((uint64_t)self+ OBJC_IVAR____TtC22SubscribePageExtension44GenericProductReviewActionCollectionViewCell_itemLayoutContext);
