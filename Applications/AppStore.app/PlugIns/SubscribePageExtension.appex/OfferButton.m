...
- (void)setFrame:(CGRect)a3
{
  ...
  _TtC22SubscribePageExtension11OfferButton *v9;
  double v10;
  CGFloat v11;
  double v12;
  CGFloat v13;
  ...
  sub_100134148(v11, v13, v15, v17);

}

- (_TtC22SubscribePageExtension11OfferButton)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension11OfferButton *)sub_100134678(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)dealloc
{
  objc_class *ObjectType;
  void *v4;
  _TtC22SubscribePageExtension11OfferButton *v5;
  id v6;
  objc_super v7;
...
- (void).cxx_destruct
{
  ...
  sub_100011088((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton_presenter, &qword_1007FC378);
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton_objectGraph);
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton_layoutDelegate);
  sub_100011088((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton_isEnabledObserver, &qword_1007F6E90);
  _s22SubscribePageExtension38ProductRatingsCompactProductPageLayoutV7MetricsVwxx_0((Class *)((char *)&self->super.super.super.super.isa
                                                                                            + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration));
}

- (void)layoutSubviews
{
  objc_class *ObjectType;
  _TtC22SubscribePageExtension11OfferButton *v4;
  uint64_t v5;
  uint64_t v6;
  uint64_t v7;
  double v8;
  ...
  v5 = (uint64_t)v4 + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration;
  swift_beginAccess((char *)v4 + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration, &v18, 0, 0);
  sub_100011020(v5, (uint64_t)v19);
  v6 = v20;
  v7 = v21;
...
- (void)invalidateIntrinsicContentSize
{
  ...
  v3 = &v2[OBJC_IVAR____TtC22SubscribePageExtension11OfferButton_cachedIntrinsicContentSize];
  *(_QWORD *)v3 = 0;
  *((_QWORD *)v3 + 1) = 0;
  v3[16] = 1;
...
{
  _TtC22SubscribePageExtension11OfferButton *v2;
  double v3;
  double v4;
  double v5;
  double v6;
...
{
  _TtC22SubscribePageExtension11OfferButton *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
- (BOOL)isHighlighted
{
  return sub_100135898(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
...
- (void)setHighlighted:(BOOL)a3
{
  _BOOL8 v3;
  objc_class *ObjectType;
  _TtC22SubscribePageExtension11OfferButton *v6;
  uint64_t v7;
  uint64_t v8;
  uint64_t v9;
  double v10;
  ...
  v7 = (uint64_t)v6 + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration;
  swift_beginAccess((char *)v6 + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration, &v19, 0, 0);
  sub_100011020(v7, (uint64_t)v20);
  v8 = v21;
  v9 = v22;
...
- (void)tintColorDidChange
{
  ...
  v5 = (uint64_t)v4 + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration;
  swift_beginAccess((char *)v4 + OBJC_IVAR____TtC22SubscribePageExtension11OfferButton__configuration, &v9, 0, 0);
  sub_100011020(v5, (uint64_t)v10);
  v6 = v11;
  v7 = v12;
