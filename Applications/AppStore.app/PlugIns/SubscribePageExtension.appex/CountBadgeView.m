...
{
  id v4;
  _TtC22SubscribePageExtension14CountBadgeView *result;

  *((_BYTE *)&self->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension14CountBadgeView_size) = 1;
  v4 = a3;

  result = (_TtC22SubscribePageExtension14CountBadgeView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/CountBadgeView.swift", 43, 2, 76, 0);
  __break(1u);
  return result;
}
...
{
  _TtC22SubscribePageExtension14CountBadgeView *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
{
  objc_class *v3;
  _TtC22SubscribePageExtension14CountBadgeView *v4;
  void *v5;
  double v6;
  double v7;
  double v8;
...
- (_TtC22SubscribePageExtension14CountBadgeView)initWithFrame:(CGRect)a3
{
  ...
  result = (_TtC22SubscribePageExtension14CountBadgeView *)_swift_stdlib_reportUnimplementedInitializer("SubscribePageExtension.CountBadgeView", 37, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
