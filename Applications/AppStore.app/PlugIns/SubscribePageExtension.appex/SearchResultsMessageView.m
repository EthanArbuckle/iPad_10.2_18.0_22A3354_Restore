...
{
  return (_TtC22SubscribePageExtension24SearchResultsMessageView *)sub_100394F54(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension24SearchResultsMessageView *v2;
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  double height;
  double width;
  _TtC22SubscribePageExtension24SearchResultsMessageView *v8;
  double v9;
  double v10;
  double v11;
  double v12;
  ...
  v8 = self;
  v9 = sub_100395E28((uint64_t)a4, width, height);
  v11 = v10;
  v13 = v12;
  v15 = v14;
...
- (void).cxx_destruct
{
  ...
  sub_100011088((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension24SearchResultsMessageView_actionRunnerProviderProxy, (uint64_t *)&unk_100812400);
}
