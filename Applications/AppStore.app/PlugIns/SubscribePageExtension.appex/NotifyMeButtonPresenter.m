...
- (void)appExitedWhileAppeared
{
  ...
  v4 = *(void **)&self->_TtCs12_SwiftObject_opaque[OBJC_IVAR____TtC22SubscribePageExtension23NotifyMeButtonPresenter_displayTimeReachedTimer];
  swift_retain(self);
  if (v4)
  {
...
- (void)displayTimeReached
{
  ...
  v3 = &self->_TtCs12_SwiftObject_opaque[OBJC_IVAR____TtC22SubscribePageExtension23NotifyMeButtonPresenter_view];
  swift_beginAccess(&self->_TtCs12_SwiftObject_opaque[OBJC_IVAR____TtC22SubscribePageExtension23NotifyMeButtonPresenter_view], v10, 0, 0);
