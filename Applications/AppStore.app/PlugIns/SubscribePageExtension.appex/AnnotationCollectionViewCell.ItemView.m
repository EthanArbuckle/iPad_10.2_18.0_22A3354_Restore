...
{
  return (_TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView *)sub_1004A6D28(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView)initWithCoder:(id)a3
{
  id v4;
  _TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView *result;
  ...
  *((_BYTE *)&self->super.super.super.isa
  ...
  result = (_TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/AnnotationCollectionViewCell+ItemView.swift", 66, 2, 91, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  uint64_t v11;
  char *v12;
  _TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView *v13;
  double v14;
  objc_super v15;
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  uint64_t v10;
  char *v11;
  _TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView *v12;
  double v13;
  double v14;
  double v15;
  double v16;
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView_leadingPairLabels));
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtCC22SubscribePageExtension28AnnotationCollectionViewCell8ItemView_trailingPairLabels));
}
