...
- (ASReportAConcernReasonDataSource)initWithTableView:(id)a3
{
  ...
  v6 = -[ASReportAConcernReasonDataSource init](&v9, "init");
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_tableView, a3);
    objc_msgSend(v5, "registerClass:forCellReuseIdentifier:", objc_opt_class(UITableViewCell), CFSTR("ASConcernReasonCell"));
  }
