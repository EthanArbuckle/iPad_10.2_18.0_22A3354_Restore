...
{
  return (_TtC22SubscribePageExtension27TodayCardLockupListItemView *)sub_10046B4FC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension27TodayCardLockupListItemView)initWithCoder:(id)a3
{
  ...
  _OWORD *v7;
  id v8;
  _TtC22SubscribePageExtension27TodayCardLockupListItemView *result;
  ...
  *v7 = 0u;
  ...
  result = (_TtC22SubscribePageExtension27TodayCardLockupListItemView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/TodayCardLockupListOverlayView.swift", 59, 2, 68, 0);
  __break(1u);
  return result;
}
...
{
  _TtC22SubscribePageExtension27TodayCardLockupListItemView *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension27TodayCardLockupListItemView *v2;
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (v9
    ...
    && (sub_10000EF74(), (static NSObject.== infix(_:_:)(v9, v7) & 1) == 0))
  {
...
- (void)setAccessibilityLabel:(id)a3
{
  ...
  uint64_t v6;
  uint64_t v7;
  _TtC22SubscribePageExtension27TodayCardLockupListItemView *v8;
  _TtC22SubscribePageExtension27TodayCardLockupListItemView *v9;
  objc_super v10;
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC22SubscribePageExtension27TodayCardLockupListItemView_label));
  sub_100011088((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension27TodayCardLockupListItemView_clickAction, (uint64_t *)&unk_1008052E0);
  sub_100011088((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension27TodayCardLockupListItemView_clickSender, &qword_1007F6E90);
}
