...
{
  return (_TtC22SubscribePageExtension20PresentationLinkView *)sub_1003FD5D4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC22SubscribePageExtension20PresentationLinkView)initWithCoder:(id)a3
{
  _TtC22SubscribePageExtension20PresentationLinkView *result;

  result = (_TtC22SubscribePageExtension20PresentationLinkView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/PresentationLinkView.swift", 49, 2, 36, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  double v10;
  double v11;
  _TtC22SubscribePageExtension20PresentationLinkView *v12;
  CGRect v13;
