...
{
  return (_TtC22SubscribePageExtension23StorefrontAgeRatingView *)sub_1001C70D0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension23StorefrontAgeRatingView)initWithCoder:(id)a3
{
  ...
  id v7;
  uint64_t v8;
  _TtC22SubscribePageExtension23StorefrontAgeRatingView *result;

  v5 = OBJC_IVAR____TtC22SubscribePageExtension23StorefrontAgeRatingView_label;
  v6 = objc_allocWithZone((Class)UILabel);
  v7 = a3;
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, "init");
  v8 = OBJC_IVAR____TtC22SubscribePageExtension23StorefrontAgeRatingView_fontMetrics;
  *(Class *)((char *)&self->super.super.super.isa + v8) = (Class)objc_msgSend(objc_allocWithZone((Class)UIFontMetrics), "initForTextStyle:", UIFontTextStyleSubheadline);
  ...
  result = (_TtC22SubscribePageExtension23StorefrontAgeRatingView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010062E5C0, "SubscribePageExtension/StorefrontAgeRatingView.swift", 52, 2, 42, 0);
  __break(1u);
  return result;
}
...
{
  void *v2;
  _TtC22SubscribePageExtension23StorefrontAgeRatingView *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
- (void)layoutSubviews
{
  _TtC22SubscribePageExtension23StorefrontAgeRatingView *v2;
