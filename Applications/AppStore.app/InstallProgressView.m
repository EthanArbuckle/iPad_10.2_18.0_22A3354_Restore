...
{
  return (_TtC8AppStore19InstallProgressView *)sub_1003F29E0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore19InstallProgressView)initWithCoder:(id)a3
{
  ...
  _QWORD *v5;
  id v6;
  _TtC8AppStore19InstallProgressView *result;
  ...
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore19InstallProgressView_progress) = 0;
  ...
  result = (_TtC8AppStore19InstallProgressView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/InstallProgressView.swift", 34, 2, 89, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore19InstallProgressView_completionHandler), *(_QWORD *)&self->state[OBJC_IVAR____TtC8AppStore19InstallProgressView_completionHandler]);
}
