...
{
  return (_TtC8AppStore20PlatformSelectorView *)sub_100108DD8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore20PlatformSelectorView)initWithCoder:(id)a3
{
  _QWORD *v4;
  id v5;
  _TtC8AppStore20PlatformSelectorView *result;
  ...
  *v4 = 0;
  ...
  result = (_TtC8AppStore20PlatformSelectorView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/PlatformSelectorView.swift", 35, 2, 132, 0);
  __break(1u);
  return result;
}
...
- (void)didTapSelectorView
{
  ...
  uint64_t v3;
  uint64_t v4;
  _TtC8AppStore20PlatformSelectorView *v5;

  v2 = *(void (**)(uint64_t))((char *)&self->super.super.super.super.isa
                                      + OBJC_IVAR____TtC8AppStore20PlatformSelectorView_didSelectHandler);
  if (v2)
  {
    v3 = *(_QWORD *)&self->descriptionWithBadgesAsHeadingLabel[OBJC_IVAR____TtC8AppStore20PlatformSelectorView_didSelectHandler];
    v5 = self;
...
- (void)layoutSubviews
{
  _TtC8AppStore20PlatformSelectorView *v2;
...
- (_TtC11AppStoreKit16DynamicTypeLabel)accessibilityDescriptionLabel
{
  ...
  char *v6;
  uint64_t v7;
  _TtC8AppStore20PlatformSelectorView *v8;
  id v9;
  uint64_t v11;
  ...
  v7 = *(uint64_t *)((char *)&self->super.super.super.super.isa
                  + OBJC_IVAR____TtC8AppStore20PlatformSelectorView_numberOfBadges);
  v8 = self;
  static BadgeDisplayStyle.style(forBadgeCount:pageTraits:indentForBadges:)(v7, v8, 0, 1);
  v9 = sub_100109788((uint64_t)v6);
...
- (void).cxx_destruct
{
  ...
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC8AppStore20PlatformSelectorView_didSelectHandler), *(_QWORD *)&self->descriptionWithBadgesAsHeadingLabel[OBJC_IVAR____TtC8AppStore20PlatformSelectorView_didSelectHandler]);
}
