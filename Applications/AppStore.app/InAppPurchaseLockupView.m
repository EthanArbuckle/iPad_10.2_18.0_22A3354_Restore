...
- (_TtC8AppStore23InAppPurchaseLockupView)initWithCoder:(id)a3
{
  ...
  uint64_t v7;
  id v8;
  _TtC8AppStore23InAppPurchaseLockupView *result;
  ...
  *((_BYTE *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore23InAppPurchaseLockupView_isHeightConstrained) = 0;
  v8 = a3;

  result = (_TtC8AppStore23InAppPurchaseLockupView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/InAppPurchaseLockupView.swift", 38, 2, 162, 0);
  __break(1u);
  return result;
}
...
{
  _TtC8AppStore23InAppPurchaseLockupView *v2;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  double width;
  uint64_t v5;
  _TtC8AppStore23InAppPurchaseLockupView *v6;
  __n128 v7;
  uint64_t v8;
  uint64_t v9;
  uint64_t v10;
  ...
  v9 = sub_10007AF70(v8, (uint64_t)qword_10088EA18);
  v10 = type metadata accessor for InAppPurchaseLockupViewLayout(0);
  v11 = sub_100005C94(&qword_100842088, (uint64_t (*)(uint64_t))&type metadata accessor for InAppPurchaseLockupViewLayout, (uint64_t)&protocol conformance descriptor for InAppPurchaseLockupViewLayout);
...
- (_TtC8AppStore23InAppPurchaseLockupView)initWithFrame:(CGRect)a3
{
  ...
  result = (_TtC8AppStore23InAppPurchaseLockupView *)_swift_stdlib_reportUnimplementedInitializer("AppStore.InAppPurchaseLockupView", 32, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore23InAppPurchaseLockupView_theme;
