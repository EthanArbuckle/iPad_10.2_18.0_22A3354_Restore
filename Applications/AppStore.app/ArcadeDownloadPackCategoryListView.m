...
{
  return (_TtC8AppStore34ArcadeDownloadPackCategoryListView *)sub_1003E02F4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore34ArcadeDownloadPackCategoryListView *v5;
  id v6;
  double v7;
  double v8;
  double v9;
  ...
  objc_msgSend(*(id *)((char *)&v5->super.super.super.isa+ OBJC_IVAR____TtC8AppStore34ArcadeDownloadPackCategoryListView_contentView), "systemLayoutSizeFittingSize:", width, height);
  v8 = v7;
  v10 = v9;
  v11 = sub_1003E08CC();
...
{
  _TtC8AppStore34ArcadeDownloadPackCategoryListView *v2;
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtC8AppStore34ArcadeDownloadPackCategoryListView_categoryViews));
}
