...
{
  return (_TtC8AppStore25ShelfDisplayingFlowLayout *)sub_10015E7D0();
}
...
- (_TtC8AppStore25ShelfDisplayingFlowLayout)initWithCoder:(id)a3
{
  ...
  uint64_t v6;
  id v7;
  _TtC8AppStore25ShelfDisplayingFlowLayout *result;

  v5 = OBJC_IVAR____TtC8AppStore25ShelfDisplayingFlowLayout_multiColumnMinYBySection;
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)sub_100551C30((uint64_t)_swiftEmptyArrayStorage);
  v6 = OBJC_IVAR____TtC8AppStore25ShelfDisplayingFlowLayout_multiColumnOrigins;
  v7 = a3;
  *(Class *)((char *)&self->super.super.super.isa + v6) = (Class)sub_10054FC48((uint64_t)_swiftEmptyArrayStorage);

  result = (_TtC8AppStore25ShelfDisplayingFlowLayout *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/ShelfDisplayingFlowLayout.swift", 40, 2, 42, 0);
  __break(1u);
  return result;
}
...
- (id)layoutAttributesForElementsInRect:(CGRect)a3
{
  ...
  double y;
  double x;
  _TtC8AppStore25ShelfDisplayingFlowLayout *v7;
  uint64_t v8;
  uint64_t v9;
  NSArray v10;
  ...
  x = a3.origin.x;
  v7 = self;
  sub_10015E9D0(x, y, width, height);
  v9 = v8;
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  uint64_t v7;
  char *v8;
  _TtC8AppStore25ShelfDisplayingFlowLayout *v9;
  id v10;
  uint64_t v12;
...
- (id)layoutAttributesForDecorationViewOfKind:(id)a3 atIndexPath:(id)a4
{
  ...
  uint64_t v12;
  uint64_t v13;
  _TtC8AppStore25ShelfDisplayingFlowLayout *v14;
  id v15;
  __n128 v16;
  _TtC8AppStore25ShelfDisplayingFlowLayout *v17;
  NSString v18;
  Class isa;
  objc_class *v20;
  objc_super v22;
  ...
  if (v11 == 0xD00000000000001FLL && v13 == 0x80000001006AE450
    || (_stringCompareWithSmolCheck(_:_:expecting:)(v11, v13, 0xD00000000000001FLL, 0x80000001006AE450, 0) & 1) != 0)
  {
    v14 = self;
    v15 = sub_10015F460(v11, v13);
...
- (id)invalidationContextForBoundsChange:(CGRect)a3
{
  ...
  x = a3.origin.x;
  v7 = self;
  v8 = sub_10015F2DC(x, y, width, height);
