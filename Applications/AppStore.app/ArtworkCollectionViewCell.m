...
{
  return (_TtC8AppStore25ArtworkCollectionViewCell *)sub_1003F00A8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, (uint64_t)self, (uint64_t)a2);
}
...
- (_TtC8AppStore25ArtworkCollectionViewCell)initWithCoder:(id)a3
{
  ...
  uint64_t v6;
  id v7;
  _TtC8AppStore25ArtworkCollectionViewCell *result;
  ...
  result = (_TtC8AppStore25ArtworkCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/ArtworkCollectionViewCell.swift", 40, 2, 28, 0);
  __break(1u);
  return result;
}
...
- (void)prepareForReuse
{
  ...
  v3 = *(id *)&v2[OBJC_IVAR____TtC8AppStore25ArtworkCollectionViewCell_artworkView];
...
- (void).cxx_destruct
{
  ...
  sub_10008D294((uint64_t)self + OBJC_IVAR____TtC8AppStore25ArtworkCollectionViewCell_itemLayoutContext);
}
