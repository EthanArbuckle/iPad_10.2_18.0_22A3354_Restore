...
- (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow)initWithFrame:(CGRect)a3
{
  ...
  _TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow *v9;
  objc_super v11;
...
{
  id v3;
  _TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow *result;

  v3 = a3;
  result = (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow *)_swift_stdlib_reportUnimplementedInitializer("AppStore.StatusBarOverlayWindow", 31, "init(windowScene:)", 18, 0);
  __break(1u);
  return result;
}
...
- (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow)initWithContentRect:(CGRect)a3
{
  ...
  result = (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow *)_swift_stdlib_reportUnimplementedInitializer("AppStore.StatusBarOverlayWindow", 31, "init(contentRect:)", 18, 0);
  __break(1u);
  return result;
}
