...
{
  return (_TtC8AppStore30SearchActionCollectionViewCell *)sub_10054819C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, (uint64_t)self, (uint64_t)a2);
}
...
- (_TtC8AppStore30SearchActionCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v8;
  id v9;
  _TtC8AppStore30SearchActionCollectionViewCell *result;
  ...
  v7 = OBJC_IVAR____TtC8AppStore30SearchActionCollectionViewCell_actionContentView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v8, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC8AppStore30SearchActionCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/SearchActionCollectionViewCell.swift", 45, 2, 32, 0);
  __break(1u);
  return result;
}
...
- (void)prepareForReuse
{
  ...
  v3 = *(_QWORD *)&v2[OBJC_IVAR____TtC8AppStore30SearchActionCollectionViewCell_actionContentView];
  ArtworkView.image.setter(0);
  objc_msgSend(*(id *)(v3 + OBJC_IVAR____TtC8AppStore23SearchActionContentView_linkLabel), "setText:", 0, v4.receiver, v4.super_class);
...
- (void).cxx_destruct
{
  sub_10008D294((uint64_t)self + OBJC_IVAR____TtC8AppStore30SearchActionCollectionViewCell_itemLayoutContext);
