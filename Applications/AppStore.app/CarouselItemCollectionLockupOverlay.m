...
{
  _TtC8AppStore35CarouselItemCollectionLockupOverlay *result;

  sub_100465A38(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}
...
{
  objc_class *v3;
  _TtC8AppStore35CarouselItemCollectionLockupOverlay *v4;
  __n128 v5;
  uint64_t v6;
  uint64_t v7;
  double v8;
  ...
  v19.super_class = v3;
  v4 = self;
  -[CarouselItemCollectionLockupOverlay layoutSubviews](&v19, "layoutSubviews");
  objc_msgSend(*(id *)((char *)&v4->super.super.super.isa+ OBJC_IVAR____TtC8AppStore35CarouselItemCollectionLockupOverlay_materialBackground), "setFrame:", LayoutMarginsAware<>.layoutFrame.getter(v3).n128_f64[0]);
  sub_100466470(0, v16, v5);
  v6 = v17;
  v7 = v18;
  ...
  *(_QWORD *)&v8 = LayoutMarginsAware<>.layoutFrame.getter(v3).n128_u64[0];
  ...
  v12 = v11;
  v14 = v13;
  v15 = -[CarouselItemCollectionLockupOverlay traitCollection](v4, "traitCollection");
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore35CarouselItemCollectionLockupOverlay *v5;
  __n128 v6;
  double v7;
  double v8;
  double v9;
  ...
  width = a3.width;
  v5 = self;
  sub_100466470(1, v12, v6);
  v7 = sub_1005725C0((uint64_t)v12, width, height);
  v9 = v8;
...
- (void)handleSelection:(id)a3
{
  ...
  id v6;
  uint64_t v7;
  _TtC8AppStore35CarouselItemCollectionLockupOverlay *v8;
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->materialBackground[OBJC_IVAR____TtC8AppStore35CarouselItemCollectionLockupOverlay_selectionHandler];
    v6 = a3;
    v8 = self;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore35CarouselItemCollectionLockupOverlay_displayOptions;
  ...
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC8AppStore35CarouselItemCollectionLockupOverlay_selectionHandler), *(_QWORD *)&self->materialBackground[OBJC_IVAR____TtC8AppStore35CarouselItemCollectionLockupOverlay_selectionHandler]);
}
