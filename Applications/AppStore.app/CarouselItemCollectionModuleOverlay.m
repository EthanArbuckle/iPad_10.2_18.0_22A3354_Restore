...
{
  return (_TtC8AppStore35CarouselItemCollectionModuleOverlay *)sub_100572914(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  _TtC8AppStore35CarouselItemCollectionModuleOverlay *v4;
  uint64_t v5;
  uint64_t v6;
  double v7;
  double v8;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore35CarouselItemCollectionModuleOverlay *v5;
  double v6;
  double v7;
  double v8;
  double v9;
  ...
  sub_100572CA8(v12);
  v7 = sub_1005725CC((uint64_t)v12, sub_10024B4EC, v6, height);
  v9 = v8;
...
- (void)handleSelection:(id)a3
{
  ...
  id v6;
  uint64_t v7;
  _TtC8AppStore35CarouselItemCollectionModuleOverlay *v8;
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->headerView[OBJC_IVAR____TtC8AppStore35CarouselItemCollectionModuleOverlay_selectionHandler];
    v6 = a3;
    v8 = self;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore35CarouselItemCollectionModuleOverlay_displayOptions;
  v4 = type metadata accessor for HeroCarouselItemOverlay.DisplayOptions(0);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC8AppStore35CarouselItemCollectionModuleOverlay_selectionHandler), *(_QWORD *)&self->headerView[OBJC_IVAR____TtC8AppStore35CarouselItemCollectionModuleOverlay_selectionHandler]);
}
