...
{
  return (_TtC8AppStore16ArcadeHeaderView *)sub_100217704(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (void)layoutSubviews
{
  _TtC8AppStore16ArcadeHeaderView *v2;
...
{
  void *v2;
  _TtC8AppStore16ArcadeHeaderView *v3;
