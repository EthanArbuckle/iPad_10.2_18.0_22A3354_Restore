...
{
  _TtC8AppStore31CarouselItemMaterialTextOverlay *result;

  sub_100233DE0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}
...
{
  objc_class *v3;
  _TtC8AppStore31CarouselItemMaterialTextOverlay *v4;
  __n128 v5;
  uint64_t v6;
  uint64_t v7;
  double v8;
  ...
  objc_msgSend(*(id *)((char *)&v4->super.super.super.isa+ OBJC_IVAR____TtC8AppStore31CarouselItemMaterialTextOverlay_materialBackground), "setFrame:", LayoutMarginsAware<>.layoutFrame.getter(v3).n128_f64[0]);
  sub_1002348E0(0, v16, v5);
  v6 = v17;
  v7 = v18;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore31CarouselItemMaterialTextOverlay *v5;
  __n128 v6;
  double v7;
  double v8;
  double v9;
...
- (void)handleSelection:(id)a3
{
  ...
  id v6;
  uint64_t v7;
  _TtC8AppStore31CarouselItemMaterialTextOverlay *v8;
  ...
  if (v3)
  {
    v5 = *(_QWORD *)&self->materialBackground[OBJC_IVAR____TtC8AppStore31CarouselItemMaterialTextOverlay_selectionHandler];
    v6 = a3;
    v8 = self;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore31CarouselItemMaterialTextOverlay_displayOptions;
  ...
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC8AppStore31CarouselItemMaterialTextOverlay_selectionHandler), *(_QWORD *)&self->materialBackground[OBJC_IVAR____TtC8AppStore31CarouselItemMaterialTextOverlay_selectionHandler]);
}
