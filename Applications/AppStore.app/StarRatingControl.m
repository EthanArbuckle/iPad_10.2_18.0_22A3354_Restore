...
- (_TtC8AppStore17StarRatingControl)initWithCoder:(id)a3
{
  _OWORD *v4;
  id v5;
  _TtC8AppStore17StarRatingControl *result;
  ...
  *v4 = xmmword_1006818D0;
  v4[1] = xmmword_1006818D0;
  v5 = a3;

  result = (_TtC8AppStore17StarRatingControl *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/StarRatingControl.swift", 32, 2, 66, 0);
  __break(1u);
  return result;
}
...
{
  _TtC8AppStore17StarRatingControl *v3;
  id v4;
  double v5;
  double v6;
  double v7;
...
- (void)drawRect:(CGRect)a3
{
  ...
  CGFloat y;
  CGFloat x;
  _TtC8AppStore17StarRatingControl *v7;
  ...
  x = a3.origin.x;
  v7 = self;
  sub_1004D4308(x, y, width, height);
...
- (uint64_t)beginTrackingWithTouch:(void *)a3 withEvent:(void *)a4
{
  ...
  sub_1004D4CE0(v9);
  v10 = *(_QWORD *)&v8[OBJC_IVAR____TtC8AppStore17StarRatingControl_rating];
  *(_QWORD *)&v8[OBJC_IVAR____TtC8AppStore17StarRatingControl_rating] = v11;
  if (v10 != v11)
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  id v7;
  id v8;
  _TtC8AppStore17StarRatingControl *v9;
...
- (void)cancelTrackingWithEvent:(id)a3
{
  ...
  v4 = *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore17StarRatingControl_rating);
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  double v10;
  id v11;
  _TtC8AppStore17StarRatingControl *v12;
  double v13;
  double v14;
  double v15;
  double v16;
  ...
  v8 = *(double *)&self->rating[OBJC_IVAR____TtC8AppStore17StarRatingControl_touchOutsideMargin];
  v9 = *(double *)&self->lastSentRating[OBJC_IVAR____TtC8AppStore17StarRatingControl_touchOutsideMargin];
  v10 = *(double *)&self->touchOutsideMargin[OBJC_IVAR____TtC8AppStore17StarRatingControl_touchOutsideMargin];
  v11 = a4;
  v12 = self;
...
{
  return (NSString *)sub_1004D4F4C(self, (uint64_t)a2, 0xD00000000000001FLL, (void *)0x80000001006C7530);
}

- (void)setAccessibilityLabel:(id)a3
{
  sub_1004D505C(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_setAccessibilityLabel_);
}

- (NSString)accessibilityHint
{
  return (NSString *)sub_1004D4F4C(self, (uint64_t)a2, 0xD00000000000001ELL, (void *)0x80000001006C7510);
}
...
- (NSString)accessibilityValue
{
  ...
  v2 = *(Swift::Int *)((char *)self + OBJC_IVAR____TtC8AppStore17StarRatingControl_rating);
  if (v2 < 0)
  {
    __break(1u);
  }
  ...
  {
    v3 = self;
    v4._object = (void *)0x80000001006C74F0;
...
{
  sub_1004D505C(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_setAccessibilityValue_);
}

- (NSArray)accessibilityCustomActions
{
  _TtC8AppStore17StarRatingControl *v2;
  unint64_t v3;
  NSArray v4;
  ...
  if (v3)
  {
    sub_100008FE4(0, (unint64_t *)&unk_100849630, UIAccessibilityCustomAction_ptr);
...
- (void)setAccessibilityCustomActions:(id)a3
{
  ...
  uint64_t v6;
  _TtC8AppStore17StarRatingControl *v7;
  _TtC8AppStore17StarRatingControl *v8;
  objc_super v9;

  isa = a3;
  if (a3)
  {
    v5 = sub_100008FE4(0, (unint64_t *)&unk_100849630, UIAccessibilityCustomAction_ptr);
...
- (_TtC8AppStore17StarRatingControl)initWithFrame:(CGRect)a3
{
  ...
  result = (_TtC8AppStore17StarRatingControl *)_swift_stdlib_reportUnimplementedInitializer("AppStore.StarRatingControl", 26, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
