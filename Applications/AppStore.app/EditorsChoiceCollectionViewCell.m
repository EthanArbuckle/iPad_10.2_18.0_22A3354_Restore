...
{
  return (_TtC8AppStore31EditorsChoiceCollectionViewCell *)sub_1001EB69C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore31EditorsChoiceCollectionViewCell)initWithCoder:(id)a3
{
  ...
  uint64_t v10;
  uint64_t v11;
  _TtC8AppStore31EditorsChoiceCollectionViewCell *result;

  v5 = OBJC_IVAR____TtC8AppStore31EditorsChoiceCollectionViewCell_editorsChoiceReviewView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v7, "init");
  v9 = (char *)self + OBJC_IVAR____TtC8AppStore31EditorsChoiceCollectionViewCell_itemLayoutContext;
  v11 = type metadata accessor for ItemLayoutContext(0, v10);
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(_QWORD *)(v11 - 8) + 56))(v9, 1, 1, v11);

  result = (_TtC8AppStore31EditorsChoiceCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/EditorsChoiceCollectionViewCell.swift", 46, 2, 46, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  _TtC8AppStore31EditorsChoiceCollectionViewCell *v2;
...
{
  void *v3;
  _TtC8AppStore31EditorsChoiceCollectionViewCell *v4;
  double v5;
  double v6;
  double v7;
  double v8;
...
- (void)moreFrom:(id)a3
{
  ...
  id v7;
  uint64_t v8;
  _TtC8AppStore31EditorsChoiceCollectionViewCell *v9;
  ...
  if (*(_QWORD *)v3)
  {
    ...
    v7 = a3;
    v9 = self;
    v8 = sub_10003A340((uint64_t)v4, v6);
    v4(v8);
    sub_10003A350((uint64_t)v4, v6);
...
{
  return (_TtC11AppStoreKit16DynamicTypeLabel *)objc_retainAutoreleaseReturnValue(*(id *)(*(char **)((char *)&self->super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore31EditorsChoiceCollectionViewCell_editorsChoiceReviewView)
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore31EditorsChoiceCollectionViewCell_editorsChoiceReviewView));
  sub_10008D294((uint64_t)self + OBJC_IVAR____TtC8AppStore31EditorsChoiceCollectionViewCell_itemLayoutContext);
}
