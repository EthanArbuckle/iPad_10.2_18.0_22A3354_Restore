...
{
  return (_TtC8AppStore29PlaceholderCollectionViewCell *)sub_10025AB60(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, (uint64_t)self, (uint64_t)a2);
}
...
- (_TtC8AppStore29PlaceholderCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v8;
  id v9;
  _TtC8AppStore29PlaceholderCollectionViewCell *result;
  ...
  v7 = OBJC_IVAR____TtC8AppStore29PlaceholderCollectionViewCell_placeholderView;
  v8 = objc_allocWithZone((Class)UIView);
  v9 = a3;
  *(Class *)((char *)&self->super.super.super.super.super.isa + v7) = (Class)objc_msgSend(v8, "init");

  result = (_TtC8AppStore29PlaceholderCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/PlaceholderCollectionViewCell.swift", 44, 2, 28, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  v3 = *(id *)&v2[OBJC_IVAR____TtC8AppStore29PlaceholderCollectionViewCell_placeholderView];
...
- (void).cxx_destruct
{
  sub_10008D294((uint64_t)self + OBJC_IVAR____TtC8AppStore29PlaceholderCollectionViewCell_itemLayoutContext);
