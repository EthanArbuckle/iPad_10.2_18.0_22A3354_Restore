...
{
  _TtC8AppStore32ScreenshotsGalleryViewController *v4;
...
- (void)viewDidLoad
{
  _TtC8AppStore32ScreenshotsGalleryViewController *v2;
...
{
  id v5;
  _TtC8AppStore32ScreenshotsGalleryViewController *v6;

  v5 = a3;
  v6 = self;
  sub_10033D8BC((uint64_t)a3);
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  double height;
  double width;
  _TtC8AppStore32ScreenshotsGalleryViewController *v8;

  height = a3.height;
  width = a3.width;
  swift_unknownObjectRetain(a4);
  v8 = self;
  sub_10033D9D8(a4, width, height);
...
{
  id v4;
  _TtC8AppStore32ScreenshotsGalleryViewController *v5;
...
- (int64_t)collectionView:(id)a3 numberOfItemsInSection:(int64_t)a4
{
  ...
  uint64_t v7;
  id v8;
  _TtC8AppStore32ScreenshotsGalleryViewController *v9;
  int64_t v10;
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  char *v10;
  id v11;
  _TtC8AppStore32ScreenshotsGalleryViewController *v12;
  void *v13;
  uint64_t v15;
...
- (void)collectionView:(id)a3 willDisplayCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  id v13;
  id v14;
  _TtC8AppStore32ScreenshotsGalleryViewController *v15;
  uint64_t v16;
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  v14 = OBJC_IVAR____TtC8AppStore32ScreenshotsGalleryViewController_selectedIndex;
...
{
  return sub_10033E314(self, (uint64_t)a2, a3, a4, a5, (SEL *)&selRef_setMinimumInteritemSpacing_);
}

- (double)collectionView:(id)a3 layout:(id)a4 minimumLineSpacingForSectionAtIndex:(int64_t)a5
{
  return sub_10033E314(self, (uint64_t)a2, a3, a4, a5, (SEL *)&selRef_setMinimumLineSpacing_);
}
...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.super.super.super.super.isa
                         + OBJC_IVAR____TtC8AppStore32ScreenshotsGalleryViewController_platform));
