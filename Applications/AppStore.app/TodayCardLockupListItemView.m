...
{
  return (_TtC8AppStore27TodayCardLockupListItemView *)sub_100470F70(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore27TodayCardLockupListItemView)initWithCoder:(id)a3
{
  ...
  _OWORD *v7;
  id v8;
  _TtC8AppStore27TodayCardLockupListItemView *result;

  *((_BYTE *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore27TodayCardLockupListItemView_displaysLabel) = 1;
  ...
  *v7 = 0u;
  ...
  result = (_TtC8AppStore27TodayCardLockupListItemView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/TodayCardLockupListOverlayView.swift", 45, 2, 68, 0);
  __break(1u);
  return result;
}
...
{
  _TtC8AppStore27TodayCardLockupListItemView *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
- (void)layoutSubviews
{
  _TtC8AppStore27TodayCardLockupListItemView *v2;
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (v9
    ...
    && (sub_10003D7F8(), (static NSObject.== infix(_:_:)(v9, v7) & 1) == 0))
  {
...
- (void)setAccessibilityLabel:(id)a3
{
  ...
  uint64_t v6;
  uint64_t v7;
  _TtC8AppStore27TodayCardLockupListItemView *v8;
  double v9;
  _TtC8AppStore27TodayCardLockupListItemView *v10;
  objc_super v11;
  ...
  -[TodayCardLockupListItemView setAccessibilityLabel:](&v11, "setAccessibilityLabel:", a3, v9);
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore27TodayCardLockupListItemView_label));
  sub_1000057AC((uint64_t)self + OBJC_IVAR____TtC8AppStore27TodayCardLockupListItemView_clickAction, (uint64_t *)&unk_100835F20);
  sub_1000057AC((uint64_t)self + OBJC_IVAR____TtC8AppStore27TodayCardLockupListItemView_clickSender, (uint64_t *)&unk_10082B490);
}
