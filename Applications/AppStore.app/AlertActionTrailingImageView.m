...
- (void)layoutSubviews
{
  _TtC8AppStore28AlertActionTrailingImageView *v2;
...
- (void)tintColorDidChange
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore28AlertActionTrailingImageView_label];
...
{
  double width;
  _TtC8AppStore28AlertActionTrailingImageView *v4;
  double v5;
  double v6;
  double v7;
  double v8;
...
{
  _TtC8AppStore28AlertActionTrailingImageView *result;

  result = (_TtC8AppStore28AlertActionTrailingImageView *)_swift_stdlib_reportUnimplementedInitializer("AppStore.AlertActionTrailingImageView", 37, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
