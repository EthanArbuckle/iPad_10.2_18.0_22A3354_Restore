...
- (id)mp_deepCopyLayer
{
  ...
  v3 = objc_msgSend(objc_alloc((Class)objc_opt_class(self)), "initWithLayer:", self);
  if (v3)
  {
...
LABEL_11:
  ...
  if ((objc_opt_isKindOfClass(self, qword_1008542A8) & 1) != 0)
  {
    v5 = &off_1007872F8;
    goto LABEL_11;
  }
  v6 = objc_opt_class(CAScrollLayer);
  ...
  {
    v7 = objc_opt_class(CATiledLayer);
