...
- (_TtC8AppStore23VideoCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  _TtC8AppStore23VideoCollectionViewCell *v7;
  _TtC8AppStore23VideoCollectionViewCell *v8;
  id v9;
  objc_super v11;
  ...
  swift_unknownObjectWeakInit((char *)v7 + OBJC_IVAR____TtC8AppStore23VideoCollectionViewCell_videoView, 0);
...
{
  _TtC8AppStore23VideoCollectionViewCell *result;

  static VideoConfiguration.defaultConfiguration.getter(a3);
  swift_unknownObjectWeakInit((char *)self + OBJC_IVAR____TtC8AppStore23VideoCollectionViewCell_videoView, 0);

  result = (_TtC8AppStore23VideoCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/VideoCollectionViewCell.swift", 38, 2, 51, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  *(_QWORD *)&v5 = LayoutMarginsAware<>.layoutFrame.getter(v4).n128_u64[0];
  ...
  Strong = (void *)swift_unknownObjectWeakLoadStrong(&v2[OBJC_IVAR____TtC8AppStore23VideoCollectionViewCell_videoView]);
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore23VideoCollectionViewCell_configuration;
  v4 = type metadata accessor for VideoConfiguration(0);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC8AppStore23VideoCollectionViewCell_videoView);
}
