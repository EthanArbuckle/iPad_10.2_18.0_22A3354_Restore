...
- (_TtCC8AppStore32ReviewsHorizontalShelfDataSource8CardView)initWithFrame:(CGRect)a3
{
  ...
  double y;
  double x;
  _TtCC8AppStore32ReviewsHorizontalShelfDataSource8CardView *v7;
  objc_super v9;
...
{
  id v4;
  _TtCC8AppStore32ReviewsHorizontalShelfDataSource8CardView *result;
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  result = (_TtCC8AppStore32ReviewsHorizontalShelfDataSource8CardView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/ReviewsHorizontalShelfDataSource.swift", 47, 2, 58, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  _TtCC8AppStore32ReviewsHorizontalShelfDataSource8CardView *v2;
