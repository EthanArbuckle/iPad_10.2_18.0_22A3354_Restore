...
- (_TtC8AppStore32CarouselItemLockupCollectionView)initWithCoder:(id)a3
{
  ...
  uint64_t v6;
  id v7;
  _TtC8AppStore32CarouselItemLockupCollectionView *result;
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  v6 = sub_10007B804(&qword_1008318F0);
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(_QWORD *)(v6 - 8) + 56))(v5, 1, 1, v6);
  *(Class *)((char *)&self->super.super.super.isa
           + OBJC_IVAR____TtC8AppStore32CarouselItemLockupCollectionView_numberOfArtworks) = 0;
  v7 = a3;

  result = (_TtC8AppStore32CarouselItemLockupCollectionView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/CarouselItemLockupCollectionView.swift", 47, 2, 39, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  _TtC8AppStore32CarouselItemLockupCollectionView *v4;
  uint64_t v5;
  uint64_t v6;
  double v7;
  double v8;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore32CarouselItemLockupCollectionView *v5;
  id v6;
  uint64_t v7;
  uint64_t v8;
  double v9;
...
- (_TtC8AppStore32CarouselItemLockupCollectionView)initWithFrame:(CGRect)a3
{
  ...
  result = (_TtC8AppStore32CarouselItemLockupCollectionView *)_swift_stdlib_reportUnimplementedInitializer("AppStore.CarouselItemLockupCollectionView", 41, "init(frame:)", 12, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtC8AppStore32CarouselItemLockupCollectionView_artworkViews));
  sub_1004BE758((uint64_t)self + OBJC_IVAR____TtC8AppStore32CarouselItemLockupCollectionView____lazy_storage___artworkViewPool);
}
