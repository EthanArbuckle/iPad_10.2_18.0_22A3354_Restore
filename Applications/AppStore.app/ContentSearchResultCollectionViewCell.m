...
{
  return (_TtC8AppStore37ContentSearchResultCollectionViewCell *)sub_1002E2E70(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore37ContentSearchResultCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v7;
  uint64_t v8;
  _TtC8AppStore37ContentSearchResultCollectionViewCell *result;

  v5 = OBJC_IVAR____TtC8AppStore37ContentSearchResultCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  v8 = OBJC_IVAR____TtC8AppStore37ContentSearchResultCollectionViewCell_screenshots;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC8AppStore37ContentSearchResultCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/ContentSearchResultCollectionViewCell.swift", 52, 2, 66, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  _TtC8AppStore37ContentSearchResultCollectionViewCell *v2;
...
- (void)prepareForReuse
{
  ...
  v6 = *(void **)&v2[OBJC_IVAR____TtC8AppStore37ContentSearchResultCollectionViewCell_screenshots];
  sub_1001BED40();
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.super.isa
                                     + OBJC_IVAR____TtC8AppStore37ContentSearchResultCollectionViewCell_preferredImageSizes));
}
