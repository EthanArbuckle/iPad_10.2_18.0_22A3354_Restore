...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC8AppStore27JourneyDrivenOnboardingStep_bag));
...
{
  sub_10021FC00(self, (int)a2, a3, a4, a5, (void (*)(id, void *))sub_1002204F8);
}
...
- (void)engagement:(id)a3 didUpdateEngagementRequest:(id)a4 placement:(id)a5 serviceType:(id)a6 completion:(id)a7
{
  ...
  id v19;
  id v20;
  _TtC8AppStore27JourneyDrivenOnboardingStep *v21;
  ...
  v20 = a4;
  v21 = self;
  sub_1002206F8(v19, a4, v13, v15, v16, v18);
  _Block_release(v12);
...
{
  sub_10021FC00(self, (int)a2, a3, a4, a5, (void (*)(id, void *))sub_100220928);
}
...
- (void)engagement:(id)a3 didUpdateRequest:(id)a4 placement:(id)a5 serviceType:(id)a6
{
  ...
  id v16;
  id v17;
  _TtC8AppStore27JourneyDrivenOnboardingStep *v18;
  ...
  v17 = a4;
  v18 = self;
  sub_10021FC8C(v16, a4, v10, v12, v13, v15);
...
{
  _TtC8AppStore27JourneyDrivenOnboardingStep *result;

  result = (_TtC8AppStore27JourneyDrivenOnboardingStep *)_swift_stdlib_reportUnimplementedInitializer("AppStore.JourneyDrivenOnboardingStep", 36, "init()", 6, 0);
  __break(1u);
  return result;
}
