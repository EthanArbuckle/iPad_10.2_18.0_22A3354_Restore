...
{
  _TtC8AppStore31TodayTransitionDismissAnimation *v5;
  id v6;
  id v7;
  uint64_t v8;
  double result;
...
{
  _TtC8AppStore31TodayTransitionDismissAnimation *result;

  result = (_TtC8AppStore31TodayTransitionDismissAnimation *)_swift_stdlib_reportUnimplementedInitializer("AppStore.TodayTransitionDismissAnimation", 40, "init()", 6, 0);
  __break(1u);
  return result;
}
