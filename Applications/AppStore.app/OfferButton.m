...
- (void)tintColorDidChange
{
  ...
  v5 = (uint64_t)v4 + OBJC_IVAR____TtC8AppStore11OfferButton__configuration;
  swift_beginAccess((char *)v4 + OBJC_IVAR____TtC8AppStore11OfferButton__configuration, &v9, 0, 0);
  sub_100022500(v5, (uint64_t)v10);
  v6 = v11;
  v7 = v12;
  sub_100060B40(v10, v11);
  v8 = sub_100064098();
  dispatch thunk of OfferButtonConfiguration.reapply<A>(colorsTo:)(v4, ObjectType, v8, v6, v7);
  _s8AppStore27ProductRatingsRegularLayoutV7MetricsVwxx_0(v10);
...
{
  id v5;
  _TtC8AppStore11OfferButton *v6;

  v5 = a3;
  v6 = self;
  sub_100063DB4((uint64_t)a3);

}

- (CGSize)sizeThatFits:(CGSize)a3
{
  _TtC8AppStore11OfferButton *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
{
  return (_TtC8AppStore11OfferButton *)sub_100060D54(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)layoutSubviews
{
  ...
  v5 = (uint64_t)v4 + OBJC_IVAR____TtC8AppStore11OfferButton__configuration;
  swift_beginAccess((char *)v4 + OBJC_IVAR____TtC8AppStore11OfferButton__configuration, &v18, 0, 0);
  sub_100022500(v5, (uint64_t)v19);
  v6 = v20;
  v7 = v21;
  sub_100060B40(v19, v20);
  ...
  _s8AppStore27ProductRatingsRegularLayoutV7MetricsVwxx_0(v19);
...
- (void).cxx_destruct
{
  ...
  sub_1000057AC((uint64_t)self + OBJC_IVAR____TtC8AppStore11OfferButton_presenter, &qword_10082E958);
  swift_weakDestroy((char *)self + OBJC_IVAR____TtC8AppStore11OfferButton_objectGraph);
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC8AppStore11OfferButton_layoutDelegate);
  sub_1000057AC((uint64_t)self + OBJC_IVAR____TtC8AppStore11OfferButton_isEnabledObserver, (uint64_t *)&unk_10082B490);
  _s8AppStore27ProductRatingsRegularLayoutV7MetricsVwxx_0((Class *)((char *)&self->super.super.super.super.isa
...
- (BOOL)isHighlighted
{
  return sub_100126ECC(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  v7 = (uint64_t)v6 + OBJC_IVAR____TtC8AppStore11OfferButton__configuration;
  swift_beginAccess((char *)v6 + OBJC_IVAR____TtC8AppStore11OfferButton__configuration, &v19, 0, 0);
  sub_100022500(v7, (uint64_t)v20);
  v8 = v21;
  v9 = v22;
  sub_100060B40(v20, v21);
  ...
  _s8AppStore27ProductRatingsRegularLayoutV7MetricsVwxx_0(v20);
