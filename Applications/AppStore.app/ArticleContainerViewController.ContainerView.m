...
- (void)setFrame:(CGRect)a3
{
  ...
  double x;
  objc_class *v8;
  _TtCC8AppStore30ArticleContainerViewControllerP33_3306EAC28C78331905A290D09A08BB9913ContainerView *v9;
  double v10;
  CGFloat v11;
  double v12;
  CGFloat v13;
  ...
  if (!CGRectEqualToRect(v27, v28))
  {
    ...
    if (v22)
    {
      v23 = *(_QWORD *)&v9->frameUpdatedCallback[OBJC_IVAR____TtCC8AppStore30ArticleContainerViewControllerP33_3306EAC28C78331905A290D09A08BB9913ContainerView_frameUpdatedCallback];
...
- (void).cxx_destruct
{
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtCC8AppStore30ArticleContainerViewControllerP33_3306EAC28C78331905A290D09A08BB9913ContainerView_frameUpdatedCallback), *(_QWORD *)&self->frameUpdatedCallback[OBJC_IVAR____TtCC8AppStore30ArticleContainerViewControllerP33_3306EAC28C78331905A290D09A08BB9913ContainerView_frameUpdatedCallback]);
}
