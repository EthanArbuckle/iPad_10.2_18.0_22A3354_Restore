...
- (void)layoutSubviews
{
  ...
  sub_1000487A0();
  sub_1000480EC();
  v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore43MediumAdLockupWithScreenshotsBackgroundView_baseGradientView];
...
{
  return (_TtC8AppStore43MediumAdLockupWithScreenshotsBackgroundView *)sub_100052754(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)setAccessibilityElements:(id)isa
{
  ...
  uint64_t v6;
  _TtC8AppStore43MediumAdLockupWithScreenshotsBackgroundView *v7;
  _TtC8AppStore43MediumAdLockupWithScreenshotsBackgroundView *v8;
  objc_super v9;
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore43MediumAdLockupWithScreenshotsBackgroundView_topOverlayGradientView));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore43MediumAdLockupWithScreenshotsBackgroundView_lockupView));
}
