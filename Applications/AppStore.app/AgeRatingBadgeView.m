...
{
  return (_TtC8AppStore18AgeRatingBadgeView *)sub_1004C9A20(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)tintColorDidChange
{
  void *v2;
  id v3;
  _TtC8AppStore18AgeRatingBadgeView *v4;
...
- (void)drawRect:(CGRect)a3
{
  ...
  CGFloat x;
  uint64_t v7;
  _TtC8AppStore18AgeRatingBadgeView *v8;
  ...
  x = a3.origin.x;
  v8 = self;
  sub_1004CA074(x, y, width, height, (uint64_t)v8, v7);
...
- (void)layoutSubviews
{
  ...
  v5 = *(Class *)((char *)&v4->super.super.super.isa + OBJC_IVAR____TtC8AppStore18AgeRatingBadgeView_ageLabel);
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore18AgeRatingBadgeView_scalableCornerRadius;
