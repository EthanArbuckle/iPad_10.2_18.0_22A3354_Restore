...
{
  return (_TtC8AppStore34InstallPagePreInstallFreeOfferView *)sub_1001D82FC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC8AppStore34InstallPagePreInstallFreeOfferView *v5;
  uint64_t v6;
  double v7;
  double v8;
  double v9;
  ...
  width = a3.width;
  v5 = self;
  v7 = sub_1001D9040(width, height, (uint64_t)v5, v6);
  v9 = v8;
...
- (void)layoutSubviews
{
  _TtC8AppStore34InstallPagePreInstallFreeOfferView *v2;
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore34InstallPagePreInstallFreeOfferView_metrics;
