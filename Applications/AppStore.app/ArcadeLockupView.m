...
- (_TtC8AppStore16ArcadeLockupView)initWithFrame:(CGRect)a3
{
  ...
  _OWORD *v5;
  _QWORD *v6;
  _TtC8AppStore16ArcadeLockupView *result;

  v4 = OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButton;
  ...
  *v6 = 0;
  ...
  result = (_TtC8AppStore16ArcadeLockupView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000042, 0x80000001006B1D00, "AppStore/ArcadeLockupView.swift", 31, 2, 62, 0);
  __break(1u);
  return result;
}
...
- (_TtC8AppStore16ArcadeLockupView)initWithCoder:(id)a3
{
  ...
  v5 = OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButton;
  ...
  *v9 = 0;
  ...
  result = (_TtC8AppStore16ArcadeLockupView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/ArcadeLockupView.swift", 31, 2, 66, 0);
  __break(1u);
  return result;
}
...
{
  _TtC8AppStore16ArcadeLockupView *v3;
  double v4;
  double v5;
  double v6;
  double v7;
...
- (void)layoutSubviews
{
  _TtC8AppStore16ArcadeLockupView *v2;
...
- (void)offerButtonWasTapped
{
  ...
  uint64_t v3;
  uint64_t v4;
  _TtC8AppStore16ArcadeLockupView *v5;

  v2 = *(void (**)(uint64_t))((char *)&self->super.super.super.isa
                                      + OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButtonTapHandler);
  if (v2)
  {
    v3 = *(_QWORD *)&self->wordmarkView[OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButtonTapHandler];
    v4 = *(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButton);
    v5 = self;
    sub_10003A340((uint64_t)v2, v3);
    v2(v4);
...
- (void)setAccessibilityIdentifier:(id)a3
{
  uint64_t v4;
  uint64_t v5;
  _TtC8AppStore16ArcadeLockupView *v6;
  NSString v7;
  _TtC8AppStore16ArcadeLockupView *v8;
  objc_super v9;
...
- (void).cxx_destruct
{
  ...
  sub_1000608D4((uint64_t)self + OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerLabelPresenter);
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore16ArcadeLockupView_metrics;
  v4 = type metadata accessor for ArcadeLockupLayout.Metrics(0);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  sub_10003A350(*(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButtonTapHandler), *(_QWORD *)&self->wordmarkView[OBJC_IVAR____TtC8AppStore16ArcadeLockupView_offerButtonTapHandler]);
}
