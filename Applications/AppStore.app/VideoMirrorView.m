...
- (void)layoutSubviews
{
  ...
  v4 = *(void **)&v2[OBJC_IVAR____TtC8AppStore10MirrorView_artworkLayer];
...
- (void).cxx_destruct
{
  swift_unknownObjectWeakDestroy((char *)self + OBJC_IVAR____TtC8AppStore15VideoMirrorView_sourceVideoView);
