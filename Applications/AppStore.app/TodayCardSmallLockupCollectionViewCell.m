...
{
  return (_TtC8AppStore38TodayCardSmallLockupCollectionViewCell *)sub_1000647CC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore38TodayCardSmallLockupCollectionViewCell)initWithCoder:(id)a3
{
  ...
  id v6;
  id v7;
  _TtC8AppStore38TodayCardSmallLockupCollectionViewCell *result;

  v5 = OBJC_IVAR____TtC8AppStore38TodayCardSmallLockupCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC8AppStore38TodayCardSmallLockupCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/TodayCardSmallLockupCollectionViewCell.swift", 53, 2, 42, 0);
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.isa+ OBJC_IVAR____TtC8AppStore38TodayCardSmallLockupCollectionViewCell_lockupView), "sizeThatFits:", a3.width, a3.height);
  result.height = v4;
  result.width = v3;
  return result;
}
...
- (void)prepareForReuse
{
  ...
  v3 = objc_retain(*(id *)(*(_QWORD *)&v2[OBJC_IVAR____TtC8AppStore38TodayCardSmallLockupCollectionViewCell_lockupView]
