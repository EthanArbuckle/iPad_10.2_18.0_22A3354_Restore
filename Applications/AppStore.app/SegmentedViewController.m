...
- (void)viewDidLoad
{
  _TtC8AppStore23SegmentedViewController *v2;
...
{
  id v5;
  _TtC8AppStore23SegmentedViewController *v6;
...
{
  double width;
  _TtC8AppStore23SegmentedViewController *v7;
  double v8;
  double v9;
  double v10;
  double v11;
...
- (void)takeSelectedIndexFrom:(id)a3
{
  ...
  v6 = *(uint64_t *)((char *)&v7->super.super.super.isa + OBJC_IVAR____TtC8AppStore23SegmentedViewController_selectedIndex);
  *(Class *)((char *)&v7->super.super.super.isa + OBJC_IVAR____TtC8AppStore23SegmentedViewController_selectedIndex) = v5;
  sub_10027FDA8(v6, (unint64_t)v5);
...
- (_TtC8AppStore23SegmentedViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  v8 = a4;
  return (_TtC8AppStore23SegmentedViewController *)sub_100281B74(v5, v7, a4);
}

- (_TtC8AppStore23SegmentedViewController)initWithCoder:(id)a3
{
  return (_TtC8AppStore23SegmentedViewController *)sub_100281D18(a3);
}
...
- (void).cxx_destruct
{
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC8AppStore23SegmentedViewController_multipleScrollObserver));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore23SegmentedViewController_selectedViewController));
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.isa
                                     + OBJC_IVAR____TtC8AppStore23SegmentedViewController_columnViewControllers));
  objc_release(*(id *)((char *)&self->super.super.super.isa
