...
{
  return (_TtC8AppStore32LinkableHeaderCollectionViewCell *)sub_10019F494(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore32LinkableHeaderCollectionViewCell)initWithCoder:(id)a3
{
  _TtC8AppStore32LinkableHeaderCollectionViewCell *result;

  result = (_TtC8AppStore32LinkableHeaderCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001006A63C0, "AppStore/LinkableHeaderCollectionViewCell.swift", 47, 2, 32, 0);
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  *(_QWORD *)&v5 = LayoutMarginsAware<>.layoutFrame.getter(v4).n128_u64[0];
  ...
  objc_msgSend(*(id *)&v2[OBJC_IVAR____TtC8AppStore32LinkableHeaderCollectionViewCell_headerView], "setFrame:", v5, v7, v9, v11);
}
