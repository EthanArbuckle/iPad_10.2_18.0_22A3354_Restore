...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)UtraFreqInfo;
  v3 = -[UtraFreqInfo description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[UtraFreqInfo dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000FF5BC((uint64_t)self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    PBDataWriterWriteUint32Field(v4, self->_uarfcn, 1);
    v4 = v6;
    has = (char)self->_has;
  }
  if ((has & 1) != 0)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 2) == 0 || self->_uarfcn != *((_DWORD *)v4 + 3))
      goto LABEL_11;
  }
...
LABEL_11:
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_prio != *((_DWORD *)v4 + 2))
      goto LABEL_11;
    v6 = 1;
  }
LABEL_12:
