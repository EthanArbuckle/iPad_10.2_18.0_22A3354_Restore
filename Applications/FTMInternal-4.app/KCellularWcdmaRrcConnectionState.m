...
- (int)StringAsReleaseCause:(id)a3
{
  ...
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_CONN_REJECT_UNSPECIFIED")) & 1) != 0)
  {
    v4 = 17;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_SIM_RADIO_CONFLICT")) & 1) != 0)
  {
    v4 = 18;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_CONN_RELEASE")) & 1) != 0)
  {
    v4 = 19;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_UNSPECIFIED")) & 1) != 0)
  {
    v4 = 20;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_PRE_EMPTIVE_RELEASE")) & 1) != 0)
  {
    v4 = 21;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_CONGESTION")) & 1) != 0)
  {
    v4 = 22;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_RE_ESTABLISHMENT_REJECT")) & 1) != 0)
  {
    v4 = 23;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_DIRECTED_SIGCONN_RE_ESTABLISHMENT")) & 1) != 0)
  {
    v4 = 24;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_USER_INACTIVITY")) & 1) != 0)
  {
    v4 = 25;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_RL_FAILURE")) & 1) != 0)
  {
    v4 = 26;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("KRRC_REL_RLC_LINK_ERROR")))
  {
    v4 = 27;
  }
  else
...
- (id)description
{
  ...
  v3 = -[KCellularWcdmaRrcConnectionState description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[KCellularWcdmaRrcConnectionState dictionaryRepresentation](self, "dictionaryRepresentation"));
...
LABEL_17:
    ...
    if (releaseCause >= 0x1C)
      v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(unknown: %i)"), self->_releaseCause));
    else
      v13 = *(&off_10025F648 + releaseCause);
...
LABEL_13:
  ...
  if (establishmentCause >= 0x17)
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(unknown: %i)"), self->_establishmentCause));
  else
    v11 = *(&off_10025F590 + establishmentCause);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000D02D4((uint64_t)self, (uint64_t)a3);
}
...
LABEL_4:
    if ((has & 4) == 0)
      goto LABEL_5;
LABEL_11:
    PBDataWriterWriteInt32Field(v5, self->_releaseCause, 4);
    if ((*(_BYTE *)&self->_has & 0x10) == 0)
      goto LABEL_7;
    goto LABEL_6;
  }
LABEL_10:
  PBDataWriterWriteInt32Field(v5, self->_establishmentCause, 3);
  has = (char)self->_has;
  if ((has & 4) != 0)
    goto LABEL_11;
LABEL_5:
