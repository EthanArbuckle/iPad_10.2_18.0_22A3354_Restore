...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)KCellularTrackingAreaId;
  v3 = -[KCellularTrackingAreaId description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[KCellularTrackingAreaId dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_tac));
    objc_msgSend(v4, "setObject:forKey:", v6, CFSTR("tac"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000E6740((uint64_t)self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    PBDataWriterWriteUint32Field(v6, self->_tac, 2);
    v4 = v6;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 20) & 1) != 0 && self->_tac == *((_DWORD *)v4 + 4))
    {
      v7 = 1;
      goto LABEL_9;
    }
