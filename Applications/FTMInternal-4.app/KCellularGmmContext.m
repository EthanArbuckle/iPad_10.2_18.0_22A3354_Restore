...
- (int)StringAsUpdateStatus:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("GPRS_STATUS_UPDATED")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("GPRS_STATUS_NOT_UPDATED")) & 1) != 0)
  {
    v4 = 1;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("GPRS_STATUS_ROAMING_NOT_ALLOWED")))
  {
    v4 = 2;
  }
  else
...
- (int)StringAsRegProc:(id)a3
{
  ...
  v3 = a3;
  if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_LOCATION_AREA_UPDATE")) & 1) != 0)
  {
    v4 = 0;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_ATTACH")) & 1) != 0)
  {
    v4 = 1;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_ROUTING_AREA_UPDATE")) & 1) != 0)
  {
    v4 = 2;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_COMBINED_RAU")) & 1) != 0)
  {
    v4 = 3;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_COMBINED_ATTACH")) & 1) != 0)
  {
    v4 = 4;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_NW_DETACH")) & 1) != 0)
  {
    v4 = 5;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_SERVICE_REQ")) & 1) != 0)
  {
    v4 = 6;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_NW_ABORT")) & 1) != 0)
  {
    v4 = 7;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_TRACKING_AREA_UPDATE")) & 1) != 0)
  {
    v4 = 8;
  }
  else if ((objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_COMBINED_TAU")) & 1) != 0)
  {
    v4 = 9;
  }
  else if (objc_msgSend(v3, "isEqualToString:", CFSTR("KNAS_MM_REG_PROC_PROC_NONE")))
  {
    v4 = 10;
  }
  else
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)KCellularGmmContext;
  v3 = -[KCellularGmmContext description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[KCellularGmmContext dictionaryRepresentation](self, "dictionaryRepresentation"));
...
LABEL_27:
  ...
  if (rai)
  {
    v11 = (void *)objc_claimAutoreleasedReturnValue(-[RoutingAreaId dictionaryRepresentation](rai, "dictionaryRepresentation"));
    objc_msgSend(v3, "setObject:forKey:", v11, CFSTR("rai"));

  }
  v12 = (__int16)self->_has;
  if ((v12 & 2) != 0)
  {
    v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_pTmsi));
    objc_msgSend(v3, "setObject:forKey:", v15, CFSTR("p_tmsi"));
...
LABEL_31:
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_t3312DurS));
  objc_msgSend(v3, "setObject:forKey:", v16, CFSTR("t3312_dur_s"));
...
LABEL_39:
  ...
  if (procFailureCause >= 0x10)
    ...
    v18 = *(&off_10025EF88 + procFailureCause);
...
LABEL_82:
    ...
    if (regProc >= 0xB)
      v22 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(unknown: %i)"), self->_regProc));
    else
      v22 = *(&off_10025F008 + regProc);
    objc_msgSend(v3, "setObject:forKey:", v22, CFSTR("reg_proc"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_10007CE08((uint64_t)self, (uint64_t)a3);
}
...
LABEL_5:
  rai = self->_rai;
  if (rai)
    PBDataWriterWriteSubmessage(v7, rai, 4);
  v6 = (__int16)self->_has;
  if ((v6 & 2) != 0)
  {
    PBDataWriterWriteUint32Field(v7, self->_pTmsi, 5);
    v6 = (__int16)self->_has;
    if ((v6 & 0x80) == 0)
    {
LABEL_9:
  ...
  PBDataWriterWriteUint32Field(v7, self->_t3312DurS, 6);
  v6 = (__int16)self->_has;
  if ((v6 & 4) == 0)
  {
LABEL_10:
...
LABEL_11:
    if ((v6 & 8) == 0)
      goto LABEL_12;
LABEL_22:
    PBDataWriterWriteInt32Field(v7, self->_regProc, 9);
    if ((*(_WORD *)&self->_has & 0x40) == 0)
      goto LABEL_14;
    goto LABEL_13;
  }
...
LABEL_5:
  v8 = -[RoutingAreaId copyWithZone:](self->_rai, "copyWithZone:", a3);
  v9 = (void *)v6[3];
  v6[3] = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x10) != 0)
  {
    if ((v7 & 0x10) == 0 || self->_regStatus != *((_DWORD *)v4 + 9))
      goto LABEL_50;
  }
  else if ((v7 & 0x10) != 0)
  {
...
LABEL_50:
  ...
  if ((has & 2) != 0)
  {
    if ((v9 & 2) == 0 || self->_pTmsi != *((_DWORD *)v4 + 4))
      goto LABEL_50;
  }
  else if ((v9 & 2) != 0)
  {
  ...
  if ((has & 0x80) != 0)
  {
    if ((v9 & 0x80) == 0 || self->_t3312DurS != *((_DWORD *)v4 + 12))
      goto LABEL_50;
  }
  else if ((v9 & 0x80) != 0)
  {
  ...
  if ((has & 4) != 0)
  {
    if ((v9 & 4) == 0 || self->_procFailureCause != *((_DWORD *)v4 + 5))
      goto LABEL_50;
  }
  else if ((v9 & 4) != 0)
  {
  ...
  if ((has & 0x20) != 0)
  {
    if ((v9 & 0x20) == 0 || self->_rejectCause != *((_DWORD *)v4 + 10))
      goto LABEL_50;
  }
  else if ((v9 & 0x20) != 0)
  {
  ...
  if ((has & 8) != 0)
  {
    if ((v9 & 8) == 0 || self->_regProc != *((_DWORD *)v4 + 8))
      goto LABEL_50;
  }
  else if ((v9 & 8) != 0)
  {
...
LABEL_7:
  v6 = 0;
LABEL_8:
  v7 = -[RoutingAreaId hash](self->_rai, "hash");
...
LABEL_3:
  ...
  self->_regStatus = *((_DWORD *)v4 + 9);
  *(_WORD *)&self->_has |= 0x10u;
  if ((*((_WORD *)v4 + 28) & 0x100) != 0)
  {
LABEL_4:
    self->_updateStatus = *((_DWORD *)v4 + 13);
    *(_WORD *)&self->_has |= 0x100u;
  }
LABEL_5:
  rai = self->_rai;
...
LABEL_24:
  self->_procFailureCause = *((_DWORD *)v5 + 5);
  *(_WORD *)&self->_has |= 4u;
  v9 = *((_WORD *)v5 + 28);
  if ((v9 & 0x20) == 0)
  {
...
LABEL_25:
  self->_rejectCause = *((_DWORD *)v5 + 10);
  *(_WORD *)&self->_has |= 0x20u;
  v9 = *((_WORD *)v5 + 28);
  if ((v9 & 8) != 0)
    goto LABEL_26;
...
- (void)setRai:(id)a3
{
  objc_storeStrong((id *)&self->_rai, a3);
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_rai, 0);
}
