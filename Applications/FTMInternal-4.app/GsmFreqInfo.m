...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)GsmFreqInfo;
  v3 = -[GsmFreqInfo description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[GsmFreqInfo dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 1) != 0)
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", self->_arfcn));
    objc_msgSend(v3, "setObject:forKey:", v5, CFSTR("arfcn"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_10000E5EC((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 16) & 1) == 0 || self->_arfcn != *((_DWORD *)v4 + 2))
      goto LABEL_11;
  }
