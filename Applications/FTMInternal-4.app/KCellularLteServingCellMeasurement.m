...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)KCellularLteServingCellMeasurement;
  v3 = -[KCellularLteServingCellMeasurement description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[KCellularLteServingCellMeasurement dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](NSNumber, "numberWithBool:", self->_isConnectedMode));
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("is_connected_mode"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_10004865C((uint64_t)self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 4) != 0)
    PBDataWriterWriteBOOLField(v5, self->_isConnectedMode, 2);
  v14 = 0u;
  v15 = 0u;
  v12 = 0u;
  v13 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((_BYTE *)v4 + 28) = self->_isConnectedMode;
    *((_BYTE *)v4 + 32) |= 4u;
  }
  v10 = v4;
  if (-[KCellularLteServingCellMeasurement rxInfosCount](self, "rxInfosCount"))
  {
    objc_msgSend(v10, "clearRxInfos");
    v6 = -[KCellularLteServingCellMeasurement rxInfosCount](self, "rxInfosCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        v9 = (void *)objc_claimAutoreleasedReturnValue(-[KCellularLteServingCellMeasurement rxInfoAtIndex:](self, "rxInfoAtIndex:", i));
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((_BYTE *)v5 + 28) = self->_isConnectedMode;
    *((_BYTE *)v5 + 32) |= 4u;
  }
  v17 = 0u;
  v18 = 0u;
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v6 & 4) != 0)
  {
    self->_isConnectedMode = *((_BYTE *)v4 + 28);
    *(_BYTE *)&self->_has |= 4u;
  }
  v14 = 0u;
  v15 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[KCellularLteServingCellMeasurement addRxInfo:](self, "addRxInfo:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * (_QWORD)i), (_QWORD)v12);
      }
