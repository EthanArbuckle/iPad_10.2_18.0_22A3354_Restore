...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)GsmCellMeasResult;
  v3 = -[GsmCellMeasResult description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[GsmCellMeasResult dictionaryRepresentation](self, "dictionaryRepresentation"));
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000A5F00((uint64_t)self, (uint64_t)a3);
}
