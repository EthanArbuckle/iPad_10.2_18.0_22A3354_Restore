...
{
  -[NSMutableArray removeAllObjects](self->_utraNcells, "removeAllObjects");
}
...
- (void)addUtraNcell:(id)a3
{
  ...
  -[NSMutableArray addObject:](utraNcells, "addObject:", v4);

}

- (unint64_t)utraNcellsCount
{
  return (unint64_t)-[NSMutableArray count](self->_utraNcells, "count");
}

- (id)utraNcellAtIndex:(unint64_t)a3
{
  return -[NSMutableArray objectAtIndex:](self->_utraNcells, "objectAtIndex:", a3);
}

+ (Class)utraNcellType
{
  return (Class)objc_opt_class(UtraNeighborCell, a2);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)UtraReselectionInfo;
  v3 = -[UtraReselectionInfo description](&v8, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[UtraReselectionInfo dictionaryRepresentation](self, "dictionaryRepresentation"));
...
LABEL_5:
  if (-[NSMutableArray count](self->_utraNcells, "count"))
  {
    v6 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_utraNcells, "count"));
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
    v19 = 0u;
    ...
    objc_msgSend(v3, "setObject:forKey:", v6, CFSTR("utra_ncell"));
  }
  return v3;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_10013CCC4(self, (uint64_t)a3);
}
...
LABEL_5:
  v10 = v4;
  if (-[UtraReselectionInfo utraNcellsCount](self, "utraNcellsCount"))
  {
    objc_msgSend(v10, "clearUtraNcells");
    v6 = -[UtraReselectionInfo utraNcellsCount](self, "utraNcellsCount");
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
      {
        v9 = (void *)objc_claimAutoreleasedReturnValue(-[UtraReselectionInfo utraNcellAtIndex:](self, "utraNcellAtIndex:", i));
        objc_msgSend(v10, "addUtraNcell:", v9);
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; i = (char *)i + 1)
      {
        ...
        objc_msgSend(v6, "addUtraNcell:", v13);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((_BYTE *)v4 + 32) & 4) == 0 || self->_tReselection != *((_DWORD *)v4 + 4))
      goto LABEL_19;
  }
...
LABEL_19:
  ...
  if ((*(_BYTE *)&self->_has & 2) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 2) == 0 || self->_sfMedium != *((_DWORD *)v4 + 3))
      goto LABEL_19;
  }
  ...
  if ((*(_BYTE *)&self->_has & 1) != 0)
  {
    if ((*((_BYTE *)v4 + 32) & 1) == 0 || self->_sfHigh != *((_DWORD *)v4 + 2))
      goto LABEL_19;
  }
  ...
  utraNcells = self->_utraNcells;
  if ((unint64_t)utraNcells | *((_QWORD *)v4 + 3))
    v7 = -[NSMutableArray isEqual:](utraNcells, "isEqual:");
  else
    v7 = 1;
LABEL_20:
...
LABEL_7:
    v4 = 0;
    return v3 ^ v2 ^ v4 ^ (unint64_t)-[NSMutableArray hash](self->_utraNcells, "hash");
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        if (*(_QWORD *)v13 != v10)
          objc_enumerationMutation(v7);
        -[UtraReselectionInfo addUtraNcell:](self, "addUtraNcell:", *(_QWORD *)(*((_QWORD *)&v12 + 1) + 8 * (_QWORD)i), (_QWORD)v12);
      }
...
{
  objc_storeStrong((id *)&self->_utraNcells, a3);
}

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_utraNcells, 0);
}
