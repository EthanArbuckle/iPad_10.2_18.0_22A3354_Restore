...
- (BOOL)authPassed
{
  ...
  v4 = objc_msgSend(v3, "isEqualToNumber:", &off_100028B30);
...
- (void)getPairingDataWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    v14 = self;
    v15 = v4;
    objc_msgSend(v10, "getPublicNVMKeyValues:forEndpoint:withReply:", &off_100028C50, v11, v12);
...
- (void)setupKeysWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (-[FMDMagSafeRawInfo enableCAAPI:](self, "enableCAAPI:", CFSTR("enableProvisionAccessoryForFindMy")))
    {
      ...
      block[1] = 3221225472;
      block[2] = sub_100013FBC;
      block[3] = &unk_100025818;
      block[4] = self;
