...
+ (id)defaultStorageLocation
{
  ...
  v3 = objc_msgSend(v2, "initWithIdentifier:", off_1000310C0);
...
+ (id)sharedInstance
{
  if (qword_100031290 != -1)
    dispatch_once(&qword_100031290, &stru_100024868);
  return (id)qword_100031288;
}
