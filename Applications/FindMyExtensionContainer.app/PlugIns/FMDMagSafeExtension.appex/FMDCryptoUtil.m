  ...
  if (v6 && v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        sub_1000173A0((uint64_t)v20, v22, v23, v24, v25, v26, v27, v28);
...
+ (void)testCrypto
{
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
          sub_100017438((uint64_t)v34, v36, v37, v38, v39, v40, v41, v42);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      sub_100017404(v8, v26, v27, v28, v29, v30, v31, v32);
  }
...
+ (void)testCrypto2:(id)a3 privateKey:(id)a4
{
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          sub_100017438((uint64_t)v26, v28, v40, v41, v42, v43, v44, v45);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      sub_100017404(v16, v31, v32, v33, v34, v35, v36, v37);
  }
