...
- (void)dealloc
{
  ...
  -[NSProgress removeObserver:forKeyPath:context:](self->_progress, "removeObserver:forKeyPath:context:", self, CFSTR("fractionCompleted"), off_10003F7F0);
  v3.receiver = self;
...
- (void)setProgress:(id)a3
{
  ...
  if (progress != v5)
  {
    ...
    if (v5)
    {
      -[NSProgress addObserver:forKeyPath:options:context:](v5, "addObserver:forKeyPath:options:context:", self, CFSTR("fractionCompleted"), 0, off_10003F7F0);
