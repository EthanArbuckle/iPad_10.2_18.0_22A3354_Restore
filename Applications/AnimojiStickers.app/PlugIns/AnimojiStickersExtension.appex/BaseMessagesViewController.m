...
- (NSString)landscapeOverlayMessage
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "localizedStringForKey:value:table:", CFSTR("StickersLandscapeTrapMessage"), &stru_10000C578, CFSTR("Localizable")));
...
{
  return (UIViewController *)(id)qword_100011C30;
}

+ (void)setPendingChildViewController:(id)a3
{
  objc_storeStrong((id *)&qword_100011C30, a3);
}
