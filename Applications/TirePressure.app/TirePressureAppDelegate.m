...
- (BOOL)application:(id)a3 didFinishLaunchingWithOptions:(id)a4
{
  ...
  unint64_t v9;
  id v10;
  _TtC12TirePressure23TirePressureAppDelegate *v11;
...
- (_TtC12TirePressure23TirePressureAppDelegate)init
{
  ...
  *(Class *)((char *)&self->super.super.isa
  ...
  return -[TirePressureAppDelegate init](&v3, "init");
}
...
- (void).cxx_destruct
{
  ...
  swift_release(*(Class *)((char *)&self->super.super.isa
                         + OBJC_IVAR____TtC12TirePressure23TirePressureAppDelegate____lazy_storage___assetManager));
}
