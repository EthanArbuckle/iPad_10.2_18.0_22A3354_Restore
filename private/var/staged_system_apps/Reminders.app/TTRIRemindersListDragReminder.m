...
{
  _TtC9Reminders29TTRIRemindersListDragReminder *result;

  result = (_TtC9Reminders29TTRIRemindersListDragReminder *)_swift_stdlib_reportUnimplementedInitializer("Reminders.TTRIRemindersListDragReminder", 39, "init()", 6, 0);
  __break(1u);
  return result;
}
...
+ (int64_t)itemProviderVisibilityForRepresentationWithTypeIdentifier:(id)a3
{
  ...
  if (qword_10063D730 != -1)
    swift_once(&qword_10063D730, sub_1003E559C);
  if (v3 == qword_100659968 && v5 == unk_100659970)
  {
  ...
  {
    v7 = _stringCompareWithSmolCheck(_:_:expecting:)(v3, v5, qword_100659968, unk_100659970, 0);
    swift_bridgeObjectRelease(v5);
    if ((v7 & 1) != 0)
      return 3;
    else
...
- (id)loadDataWithTypeIdentifier:(id)a3 forItemProviderCompletionHandler:(id)a4
{
  ...
  void *v8;
  void *v9;
  _TtC9Reminders29TTRIRemindersListDragReminder *v10;
  id v11;
  ...
  _Block_copy(v6);
  v10 = self;
  v11 = sub_1003E5D64(v7, v9, (uint64_t)v10, (void (**)(_QWORD, _QWORD, _QWORD))v6);
  _Block_release(v6);
  _Block_release(v6);
