...
- (BOOL)prepareForTestWithOptions:(id)a3
{
  ...
  if (v5)
  {
    ...
    -[SearchByNameTest setExtraResults:](self, "setExtraResults:", v6);

    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "objectForKey:", CFSTR("animate")));
    -[SearchByNameTest setAnimate:](self, "setAnimate:", objc_msgSend(v7, "BOOLValue"));
    ...
    -[SearchByNameTest setAllSearchQueries:](self, "setAllSearchQueries:", v9);
    -[SearchByNameTest setCurrentQueryIndex:](self, "setCurrentQueryIndex:", 0);
...
- (void)startSearchQuery
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[SearchByNameTest allSearchQueries](self, "allSearchQueries"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "objectAtIndex:", -[SearchByNameTest currentQueryIndex](self, "currentQueryIndex")));

  -[SearchByNameTest setLastSearchBeginTime:](self, "setLastSearchBeginTime:", CFAbsoluteTimeGetCurrent());
  kdebug_trace(725483604, 0, 0, 0, 0);
  ...
  v7[3] = &unk_10001C488;
  v7[4] = self;
  objc_msgSend(v6, "searchForString:animated:completionBlock:", v4, -[SearchByNameTest animate](self, "animate"), v7);
