...
- (BOOL)prepareForTestWithOptions:(id)a3
{
  ...
  v4 = a3;
  v33.receiver = self;
  v33.super_class = (Class)ScrollEditingContactTest;
  ...
  if (v5)
  {
    ...
    if (v11)
    {
      ...
      -[ScrollEditingContactTest setNavControllerDelegate:](self, "setNavControllerDelegate:", v13);

      v14 = (void *)objc_claimAutoreleasedReturnValue(-[ScrollEditingContactTest navControllerDelegate](self, "navControllerDelegate"));
...
- (void)prepareForNextTest
{
  ...
  -[ScrollEditingContactTest resetDelegate](self, "resetDelegate");
  v3.receiver = self;
...
- (void)resetDelegate
{
  ...
  if (v9 == v4)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[ScrollEditingContactTest navControllerDelegate](self, "navControllerDelegate"));
  ...
  if (v7
    ...
    && ((v10 = objc_opt_class(CNContactViewController),
      ...
      : (v11 = v8),
        ...
        v12))
  {
    -[ScrollEditingContactTest editAndScrollContactViewController:](self, "editAndScrollContactViewController:", v8);
...
{
  -[ScrollEditingContactTest didShow:](self, "didShow:", a4);
}
