...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return objc_msgSend([v4 alloc], "initWithCGImage:scale:orientation:", self->mCGImage, self->mOrientation, self->mScale);
}
