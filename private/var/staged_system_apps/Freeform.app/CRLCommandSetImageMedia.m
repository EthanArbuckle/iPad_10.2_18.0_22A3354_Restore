...
- (_TtC8Freeform23CRLCommandSetImageMedia)initWithId:(id)a3 imageData:(id)a4 thumbnailData:(id)a5
{
  ...
  id v14;
  id v15;
  _TtC8Freeform23CRLCommandSetImageMedia *v16;
  objc_super v18;
  ...
  (*(void (**)(char *, char *, uint64_t))(v10 + 16))((char *)self + OBJC_IVAR____TtC8Freeform23CRLCommandSetImageMedia_id, v12, v9);
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC8Freeform23CRLCommandSetImageMedia_thumbnailData) = (Class)a5;
  v13 = (objc_class *)type metadata accessor for CRLCommandSetImageMedia(0);
  v18.receiver = self;
  v18.super_class = v13;
  v14 = a4;
  v15 = a5;
...
- (_TtC8Freeform23CRLCommandSetImageMedia)initWithImageItem:(id)a3 imageData:(id)a4 thumbnailData:(id)a5
{
  ...
  uint64_t v18;
  Class isa;
  _TtC8Freeform23CRLCommandSetImageMedia *v20;
  uint64_t v22;
  ...
  (*(void (**)(char *, uint64_t))(v10 + 8))(v12, v9);
  v20 = -[CRLCommandSetImageMedia initWithId:imageData:thumbnailData:](self, "initWithId:imageData:thumbnailData:", isa, v16, v17);
...
{
  _TtC8Freeform23CRLCommandSetImageMedia *result;

  result = (_TtC8Freeform23CRLCommandSetImageMedia *)_swift_stdlib_reportUnimplementedInitializer("Freeform.CRLCommandSetImageMedia", 32, "init()", 6, 0);
  __break(1u);
  return result;
}
