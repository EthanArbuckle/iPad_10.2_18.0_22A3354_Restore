...
- (BOOL)crl_conformsToUTI:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[CRLIngestionTypes nativeTypes](CRLIngestionTypes, "nativeTypes"));
  v6 = objc_msgSend(v5, "containsObject:", v4);

  if (v6)
  {
    v7 = -[NSString isEqualToString:](self, "isEqualToString:", v4);
  }
  else
  {
    v8 = (void *)objc_claimAutoreleasedReturnValue(+[UTType typeWithIdentifier:](UTType, "typeWithIdentifier:", self));
    if (v8
      && (v9 = (void *)objc_claimAutoreleasedReturnValue(+[CRLIngestionTypes unsupportedImageTypes](CRLIngestionTypes, "unsupportedImageTypes")), v10 = objc_msgSend(v9, "containsObject:", v4), v9, (v10 & 1) == 0))
    {
      v11 = objc_claimAutoreleasedReturnValue(+[UTType typeWithIdentifier:](UTType, "typeWithIdentifier:", v4));
      if (v11)
      {
        v12 = (void *)v11;
        v7 = objc_msgSend(v8, "conformsToType:", v11);
      }
      else
      {
        +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_1012382D0);
        if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
          sub_100DFAB7C();
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_1012382F0);
        v13 = off_1013D9070;
        if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
          sub_100DE87A4(v13);
        v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLUTIUtilities) crl_conformsToUTI:]"));
        v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLUtility/CRLUTIUtilities.m"));
        +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v12, v14, 61, 0, "Could not instantiate UTType for %@", v4);
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        if (-[NSString crl_conformsToUTI:](self, "crl_conformsToUTI:", *(_QWORD *)(*((_QWORD *)&v11 + 1) + 8 * (_QWORD)i), (_QWORD)v11))
        {
          v9 = 1;
          goto LABEL_11;
        }
...
- (NSString)crl_UTIFilenameExtension
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[UTType typeWithIdentifier:](UTType, "typeWithIdentifier:", self));
  if (!v3)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101238310);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DFAC0C();
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101238330);
    v4 = off_1013D9070;
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DE87A4(v4);
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLUTIUtilities) crl_UTIFilenameExtension]"));
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLUtility/CRLUTIUtilities.m"));
    +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v5, v6, 79, 0, "Failed to create UTType for %@", self);

  }
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "preferredFilenameExtension"));
...
- (NSString)crl_pathUTI
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[NSString pathExtension](self, "pathExtension"));
  if (!v3)
    goto LABEL_10;
  if (-[NSString isAbsolutePath](self, "isAbsolutePath"))
  {
    ...
    v5 = objc_msgSend(v4, "fileExistsAtPath:isDirectory:", self, &v12);
    v6 = (id *)&UTTypeData;
    if ((v5 & (v12 == 0)) == 0)
      v6 = (id *)&UTTypeDirectory;
    v7 = *v6;

    v8 = UTTagClassFilenameExtension;
    v9 = (void *)objc_claimAutoreleasedReturnValue(+[UTType typeWithTag:tagClass:conformingToType:](UTType, "typeWithTag:tagClass:conformingToType:", v3, UTTagClassFilenameExtension, v7));

    if (objc_msgSend(v9, "isDynamic"))
    {
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue(+[UTType typeWithTag:tagClass:conformingToType:](UTType, "typeWithTag:tagClass:conformingToType:", v3, v8, 0));
  if (objc_msgSend(v9, "isDynamic"))
  {
...
- (NSString)crl_normalizedFilenameExtension
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[NSString crl_pathUTI](self, "crl_pathUTI"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "crl_UTIFilenameExtension"));
...
- (BOOL)crl_pathExtensionConformsToUTI:(id)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = (id)objc_claimAutoreleasedReturnValue(+[UTType typesWithTag:tagClass:conformingToType:](UTType, "typesWithTag:tagClass:conformingToType:", v3, UTTagClassFilenameExtension, 0));
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        if ((objc_msgSend(v8, "isDynamic", (_QWORD)v12) & 1) == 0)
        {
          v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "identifier"));
          v10 = objc_msgSend(v9, "crl_conformsToUTI:", v3);
...
LABEL_38:
        ...
        {
LABEL_42:
          v8 = (__CFString *)-[__CFString mutableCopyWithZone:](v2, "mutableCopyWithZone:", 0);
...
LABEL_43:
            v29 = 10;
            v7 = objc_msgSend(objc_alloc((Class)NSString), "initWithCharacters:length:", &v29, 1);
          }
LABEL_44:
...
LABEL_34:
      ...
      if (v37 <= v21 || v6 > v21)
      {
        ...
        if (v35 >= i - v11)
          ...
          v27 = v35;
        v38.length = v27 + v11 + v5;
        v38.location = v9 - v11 + v34;
...
- (unint64_t)crlwp_findIndexOfCharacter:(unsigned __int16)a3 range:(_NSRange)a4
{
  ...
  v6 = a3;
  v33.length = -[NSString length](self, "length");
  v32.location = location;
  v32.length = length;
  v33.location = 0;
  v8 = NSIntersectionRange(v32, v33);
  if (!v8.length)
    return 0x7FFFFFFFFFFFFFFFLL;
  theString = (CFStringRef)self;
  v29 = v8;
  CharactersPtr = CFStringGetCharactersPtr((CFStringRef)self);
  v9 = CharactersPtr ? 0 : CFStringGetCStringPtr((CFStringRef)self, 0x600u);
  v30 = 0;
  v31 = 0;
  v28 = v9;
  ...
  for (i = 64; ; ++i)
  {
    ...
    {
      v15 = CharactersPtr[v12 + v29.location];
    }
    else if (v28)
    {
      v15 = v28[v29.location + v12];
    }
    else
    {
      if (v31 <= v12 || v11 > v12)
...
- (_NSRange)crlwp_rangeOfCharactersFromSet:(id)a3 index:(unint64_t)a4
{
  ...
  v9 = -[NSString rangeOfCharacterFromSet:options:range:](self, "rangeOfCharacterFromSet:options:range:", v6, 0, a4, v7 - a4);
  v10 = v8;
  if (v8)
  {
    v11 = a4 + 1;
...
- (_NSRange)crlwp_rangeOfWordAtCharacterIndex:(unint64_t)a3 range:(_NSRange)a4 includePreviousWord:(BOOL)a5
{
  ...
  v5 = -[NSString crlwp_rangeOfWordAtCharacterIndex:range:includePreviousWord:includeHyphenation:](self, "crlwp_rangeOfWordAtCharacterIndex:range:includePreviousWord:includeHyphenation:", a3, a4.location, a4.length, a5, 0);
  result.length = v6;
...
LABEL_6:
      +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123B988);
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
        sub_100DFF530();
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123B9A8);
      v17 = off_1013D9070;
      ...
      v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_rangeOfWordAtCharacterIndex:range:includePreviousWord:includeHyphenation:]"));
      v19 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
      +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v18, v19, 968, 0, "Specified range is out of range of string");
...
LABEL_21:
      +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123B9C8);
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
        sub_100DFF4B0();
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123B9E8);
      v22 = off_1013D9070;
      ...
      v23 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_rangeOfWordAtCharacterIndex:range:includePreviousWord:includeHyphenation:]"));
      v24 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
      +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v23, v24, 969, 0, "Character index out of range");
  ...
  {
    CharacterAtIndex = CFStringGetCharacterAtIndex((CFStringRef)self, a3);
    v21 = 0;
    if ((_DWORD)CharacterAtIndex && v15 > a3)
      v21 = sub_1001AE368(CharacterAtIndex) ^ 1;
  }
  if (v7 && a3 > location)
  {
    v25 = CFStringGetCharacterAtIndex((CFStringRef)self, a3 - 1);
    v26 = sub_1001AE368(v25);
    v21 |= v26 ^ 1;
    if (!v26)
      --a3;
  }
  if (v21 && length)
  {
    ...
    v42.length = length;
    v27 = CFStringTokenizerCreate(0, (CFStringRef)self, v42, 4uLL, 0);
    v28 = v27;
    if (v27)
    {
    ...
    if (v31 != -1 && v30 != 0)
    {
      ...
      if (v6)
      {
        if ((CFStringTokenizerAdvanceToNextToken(v28) & 0x10) != 0
          && (v34 = CFStringTokenizerGetCurrentTokenRange(v28), v34.length == 1))
        {
          v35 = v34.location;
          v12 = v31;
          v13 = v30;
          do
          {
            if (!-[NSString crlwp_isHyphenationAtCharacterIndex:](self, "crlwp_isHyphenationAtCharacterIndex:", v35))
              break;
            if (CFStringTokenizerAdvanceToNextToken(v28) != 1)
              break;
            v43 = (NSRange)CFStringTokenizerGetCurrentTokenRange(v28);
            v40.location = v12;
            v40.length = v13;
            v36 = NSUnionRange(v40, v43);
            v12 = v36.location;
            v13 = v36.length;
            if ((CFStringTokenizerAdvanceToNextToken(v28) & 0x10) == 0)
              break;
            v37 = CFStringTokenizerGetCurrentTokenRange(v28);
            v35 = v37.location;
          }
          while (v37.length == 1);
        }
...
- (BOOL)crlwp_isHyphenationAtCharacterIndex:(unint64_t)a3
{
  ...
  v3 = -[NSString characterAtIndex:](self, "characterAtIndex:", a3);
  result = 1;
  if (v3 > 8207)
  {
    v5 = v3 - 8208;
...
- (BOOL)crlwp_isAllWhitespaceInRange:(_NSRange)a3
{
  ...
  v32.length = -[NSString length](self, "length");
  v30.location = location;
  v30.length = length;
  v32.location = 0;
  v6 = NSIntersectionRange(v30, v32);
  if (v6.length)
  {
    theString = (CFStringRef)self;
    v27 = v6;
    ...
    else
    {
      ...
      do
      {
        ...
        {
          v14 = CharactersPtr[v10 + v27.location];
        }
        else if (v26)
        {
          v14 = v26[v27.location + v10];
        }
        else
        {
          v15 = v28;
          if (v29 <= v10 || v28 > v10)
          {
            ...
            if ((uint64_t)v27.length >= v19)
              v13 = v19;
            v31.length = v13 + v18;
            v31.location = v20 + v27.location;
            CFStringGetCharacters(theString, v31, buffer);
            v15 = v28;
          }
          v14 = buffer[v10 - v15];
        }
        if ((sub_1001AE368(v14) & 1) == 0)
          break;
        v8 = ++v10 >= (int64_t)v6.length;
        --v9;
        ++v11;
      }
      while (v6.length != v10);
...
- (id)crlwp_replaceOccurrencesOfCharactersInSet:(id)a3 minimumConsecutiveLength:(unint64_t)a4 replaceString:(id)a5
{
  ...
  v8 = (const __CFCharacterSet *)a3;
  v9 = a5;
  if (!v9)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_10123BA08);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DFF5B0();
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_10123BA28);
    v10 = off_1013D9070;
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_replaceOccurrencesOfCharactersInSet:minimumConsecutiveLength:replaceString:]"));
    v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
  ...
  if (v13 && range.length >= 1)
  {
    if (CharactersPtr)
    {
      v15 = CharactersPtr[range.location];
    }
    else if (CStringPtr)
    {
      v15 = CStringPtr[range.location];
    }
    else
    {
  ...
  IsCharacterMember = CFCharacterSetIsCharacterMember(v8, v15);
  ...
  {
    v17 = v53[range.location + 1];
  }
  else
  {
    if (length < 2 || (v47 = v55, v55 >= 2))
    {
      if (range.length >= 0x40uLL)
        v48.length = 64;
      else
  ...
  v18 = CFCharacterSetIsCharacterMember(v8, v17);
  v49 = self;
  if (v13)
  {
    v19 = 0;
    ...
    while (1)
    {
      v23 = IsCharacterMember;
      IsCharacterMember = v21;
      if (v23)
      {
        if (v19 < v22)
          v22 = v19;
        ...
        if (!v21)
        {
          if (v20 >= a4)
          {
            ...
            {
              v26 = v57;
              v27 = ((char *)v58 - (char *)v57) >> 4;
              v28 = v27 + 1;
              if ((unint64_t)(v27 + 1) >> 60)
                sub_100007810();
              v29 = (char *)v59 - (char *)v57;
              if (v59 - v57 > v28)
                v28 = v29 >> 3;
              ...
              if (v30)
              {
                v31 = (char *)sub_10001FB2C((uint64_t)&v59, v30);
                v26 = v57;
                v24 = v58;
              }
              else
...
LABEL_59:
    ...
    v34 = v19 + 2;
    if ((uint64_t)(v19 + 2) < 0 || (v35 = range.length, range.length <= v34))
    {
      v38 = 0;
    }
    else
    {
      v36 = (UniChar *)CharactersPtr;
      if (CharactersPtr)
      {
        v37 = range.location + v34;
      }
      else
      {
        if (v53)
        {
          v38 = v53[range.location + v34];
          goto LABEL_58;
        }
        if (length <= v34 || (v39 = v55, v55 > v34))
        {
          v40 = v19 - 2;
          if ((unint64_t)v34 < 4)
            v40 = 0;
          ...
          v55 = v40;
          length = v35;
          v60.location = range.location + v40;
          v60.length = v35 - v40;
...
LABEL_58:
    v21 = CFCharacterSetIsCharacterMember(v8, v38) != 0;
    goto LABEL_59;
  }
LABEL_71:
  if (v58 == v57)
  ...
  {
    v41 = (NSString *)-[NSString mutableCopy](v49, "mutableCopy");
    for (i = v58; i != v57; i -= 2)
    {
      v43 = *(i - 2);
      v44 = *(i - 1);
...
+ (unint64_t)crlwp_numberForString:(id)a3 withListNumberFormat:(unint64_t)a4
{
  ...
  if (objc_msgSend(v5, "length"))
  {
    ...
    if (!qword_101414E80)
    {
      v8 = objc_alloc_init((Class)NSMutableCharacterSet);
      v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithCharacters:length:](NSString, "stringWithCharacters:length:", &unk_100EECC82, 3));
      objc_msgSend(v8, "addCharactersInString:", v9);

      v10 = (void *)qword_101414E80;
      qword_101414E80 = (uint64_t)v8;

    }
    if (a4 >= 3)
    {
      v11 = objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "crl_stringByRemovingCharactersInSet:", qword_101414E80));

      v7 = (void *)v11;
    }
    if ((unint64_t)objc_msgSend(v7, "length") >= 0x65)
    {
      v12 = objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "substringWithRange:", 0, 100));
    ...
    switch(a4)
    {
      ...
      case 1uLL:
      case 2uLL:
        v13 = sub_10014D638(v7);
        goto LABEL_15;
      case 3uLL:
      case 4uLL:
      case 5uLL:
        v13 = sub_10014D740(v7);
        goto LABEL_15;
      case 6uLL:
      case 7uLL:
      case 8uLL:
        v13 = sub_10014D860(v7);
        goto LABEL_15;
      case 9uLL:
      case 0xAuLL:
      case 0xBuLL:
        v13 = sub_10014D8A4(v7);
        goto LABEL_15;
      case 0xCuLL:
      case 0xDuLL:
      case 0xEuLL:
        v13 = sub_10014D99C(v7);
LABEL_15:
        v14 = v13;
        break;
      default:
        +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_10123BA48);
        if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
          sub_100DFF64C();
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_10123BA68);
        v16 = off_1013D9070;
        ...
        v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "+[NSString(CRLWPAdditions) crlwp_numberForString:withListNumberFormat:]"));
        v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
...
+ (unint64_t)crlwp_numberForString:(id)a3 withPageNumberFormat:(int)a4
{
  ...
  if (objc_msgSend(v5, "length"))
  {
    ...
    if ((unint64_t)objc_msgSend(v7, "length") >= 0x65)
    {
      v8 = objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "substringWithRange:", 0, 100));
...
LABEL_20:
      ...
      default:
        ...
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_10123BA88);
        if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
          sub_100DFF6D8(v11);
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_10123BAA8);
        v12 = off_1013D9070;
        ...
        v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "+[NSString(CRLWPAdditions) crlwp_numberForString:withPageNumberFormat:]"));
        v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
...
{
  return +[NSString crlwp_stringForValue:withListNumberFormat:includeFormatting:](NSString, "crlwp_stringForValue:withListNumberFormat:includeFormatting:", *(_QWORD *)&a3, a4, 1);
}
...
+ (id)crlwp_stringForValue:(unsigned int)a3 withListNumberFormat:(unint64_t)a4 includeFormatting:(BOOL)a5
{
  ...
  switch(a4)
  {
    case 0uLL:
      ...
      goto LABEL_67;
    case 1uLL:
      v10 = sub_10014F234(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v10);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 2uLL:
      v11 = sub_10014F234(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v11);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 3uLL:
      v12 = sub_10014F408(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v12);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 4uLL:
      v13 = sub_10014F408(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v13);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 5uLL:
      v14 = sub_10014F408(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v14);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 6uLL:
      v15 = sub_10014F66C(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v15);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 7uLL:
      v16 = sub_10014F66C(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v16);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 8uLL:
      v17 = sub_10014F66C(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v17);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 9uLL:
      v18 = sub_100152260(a3, (uint64_t)aAbcdefghijklmn_0, 0x1AuLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v18);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0xAuLL:
      v19 = sub_100152260(a3, (uint64_t)aAbcdefghijklmn_0, 0x1AuLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v19);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0xBuLL:
      v20 = sub_100152260(a3, (uint64_t)aAbcdefghijklmn_0, 0x1AuLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v20);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0xCuLL:
      v21 = sub_10014F6B4(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v21);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0xDuLL:
      v22 = sub_10014F6B4(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v22);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0xEuLL:
      v23 = sub_10014F6B4(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v23);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0xFuLL:
      v24 = sub_10014F798(*(uint64_t *)&a3, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v24);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x10uLL:
      v25 = sub_10014F798(*(uint64_t *)&a3, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v25);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x11uLL:
      v26 = sub_10014F798(*(uint64_t *)&a3, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v26);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x12uLL:
      v27 = sub_100152C28(a3, (uint64_t)&unk_100EECE94, 0x2EuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v27);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x13uLL:
      v28 = sub_100152C28(a3, (uint64_t)&unk_100EECE94, 0x2EuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v28);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x14uLL:
      v29 = sub_100152C28(a3, (uint64_t)&unk_100EECE94, 0x2EuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v29);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x15uLL:
      v30 = sub_100152C28(a3, (uint64_t)&unk_100EECE94, 0x2EuLL, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v30);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x16uLL:
      v31 = sub_100152C28(a3, (uint64_t)&unk_100EECE94, 0x2EuLL, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v31);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x17uLL:
      v32 = sub_100152C28(a3, (uint64_t)&unk_100EECE94, 0x2EuLL, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v32);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x18uLL:
      v33 = sub_100152C28(a3, (uint64_t)&unk_100EECEF0, 0x2FuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v33);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x19uLL:
      v34 = sub_100152C28(a3, (uint64_t)&unk_100EECEF0, 0x2FuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v34);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x1AuLL:
      v35 = sub_100152C28(a3, (uint64_t)&unk_100EECEF0, 0x2FuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v35);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x1BuLL:
      v36 = sub_100152C28(a3, (uint64_t)&unk_100EECEF0, 0x2FuLL, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v36);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x1CuLL:
      v37 = sub_100152C28(a3, (uint64_t)&unk_100EECEF0, 0x2FuLL, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v37);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x1DuLL:
      v38 = sub_100152C28(a3, (uint64_t)&unk_100EECEF0, 0x2FuLL, 1);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v38);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x1EuLL:
      v39 = sub_10014F798(*(uint64_t *)&a3, 1u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v39);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x1FuLL:
      v40 = sub_10014F798(*(uint64_t *)&a3, 1u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v40);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x20uLL:
      v41 = sub_10014F798(*(uint64_t *)&a3, 1u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v41);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x21uLL:
      v42 = sub_10014F798(*(uint64_t *)&a3, 2u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v42);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x22uLL:
      v43 = sub_10014F798(*(uint64_t *)&a3, 2u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v43);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x23uLL:
      v44 = sub_10014F798(*(uint64_t *)&a3, 2u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v44);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x24uLL:
      v45 = sub_10014F798(*(uint64_t *)&a3, 3u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v45);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x25uLL:
      v46 = sub_10014F798(*(uint64_t *)&a3, 3u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v46);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x26uLL:
      v47 = sub_10014F798(*(uint64_t *)&a3, 3u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v47);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x27uLL:
      v48 = sub_10014F798(*(uint64_t *)&a3, 4u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v48);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x28uLL:
      v49 = sub_10014F798(*(uint64_t *)&a3, 4u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v49);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x29uLL:
      v50 = sub_10014F798(*(uint64_t *)&a3, 4u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v50);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x2AuLL:
      v51 = sub_10014F798(*(uint64_t *)&a3, 5u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v51);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x2BuLL:
      v52 = sub_10014F798(*(uint64_t *)&a3, 5u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v52);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x2CuLL:
      v53 = sub_10014F798(*(uint64_t *)&a3, 5u);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v53);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x2DuLL:
      v54 = sub_100152C28(a3, (uint64_t)&unk_100EECF4E, 0xEuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v54);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x2EuLL:
      v55 = sub_100152C28(a3, (uint64_t)&unk_100EECF4E, 0xEuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v55);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x2FuLL:
      v56 = sub_100152C28(a3, (uint64_t)&unk_100EECF4E, 0xEuLL, 0);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v56);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x30uLL:
      v57 = sub_10014FA74(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v57);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@"), v8));
      goto LABEL_67;
    case 0x31uLL:
      v58 = sub_10014FC9C(a3, CFSTR("ar"));
      v8 = (void *)objc_claimAutoreleasedReturnValue(v58);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x32uLL:
      v59 = sub_10014FC9C(a3, CFSTR("ar"));
      v8 = (void *)objc_claimAutoreleasedReturnValue(v59);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x33uLL:
      v60 = sub_10014FC9C(a3, CFSTR("ar"));
      v8 = (void *)objc_claimAutoreleasedReturnValue(v60);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x34uLL:
      v61 = sub_100152260(a3, (uint64_t)&unk_100EECF8A, 0x1CuLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v61);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x35uLL:
      v62 = sub_100152260(a3, (uint64_t)&unk_100EECF8A, 0x1CuLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v62);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x36uLL:
      v63 = sub_100152260(a3, (uint64_t)&unk_100EECF8A, 0x1CuLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v63);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x37uLL:
      v64 = sub_10014FF14(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v64);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x38uLL:
      v65 = sub_10014FF14(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v65);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x39uLL:
      v66 = sub_10014FF14(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v66);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x3AuLL:
      v67 = sub_100152260(a3, (uint64_t)&unk_100EED000, 0x16uLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v67);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x3BuLL:
      v68 = sub_100152260(a3, (uint64_t)&unk_100EED000, 0x16uLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v68);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x3CuLL:
      v69 = sub_100152260(a3, (uint64_t)&unk_100EED000, 0x16uLL);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v69);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
      goto LABEL_67;
    case 0x3DuLL:
      v70 = sub_1001502A8(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v70);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@"), v8));
      goto LABEL_67;
    case 0x3EuLL:
      v71 = sub_1001502A8(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v71);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@."), v8));
      goto LABEL_67;
    case 0x3FuLL:
      v72 = sub_1001502A8(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v72);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("(%@)"), v8));
      goto LABEL_67;
    case 0x40uLL:
      v73 = sub_1001502A8(a3);
      v8 = (void *)objc_claimAutoreleasedReturnValue(v73);
      v9 = objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@)"), v8));
LABEL_67:
      v74 = (__CFString *)v9;
...
LABEL_75:
    ...
    default:
      ...
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BAC8);
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
        sub_100DFF780();
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BAE8);
      v80 = off_1013D9070;
      ...
      v81 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "+[NSString(CRLWPAdditions) crlwp_stringForValue:withListNumberFormat:includeFormatting:]"));
      v82 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
      +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v81, v82, 1438, 0, "Label format (%lu) invalid for numeric list.", a4);
  ...
  if (!a5)
  {
    if (qword_101414E90 != -1)
      dispatch_once(&qword_101414E90, &stru_10123BB08);
    v75 = objc_claimAutoreleasedReturnValue(-[__CFString crl_stringByRemovingCharactersInSet:](v74, "crl_stringByRemovingCharactersInSet:", qword_101414E88));
...
- (BOOL)crlwp_NSDetectorMatchStringIsStrictPhoneNumber
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet letterCharacterSet](NSCharacterSet, "letterCharacterSet"));
  v4 = -[NSString rangeOfCharacterFromSet:](self, "rangeOfCharacterFromSet:", v3);

  if (v4 != (id)0x7FFFFFFFFFFFFFFFLL)
    return 1;
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet punctuationCharacterSet](NSCharacterSet, "punctuationCharacterSet"));
  v6 = -[NSString rangeOfCharacterFromSet:](self, "rangeOfCharacterFromSet:", v5);

  if (v6 != (id)0x7FFFFFFFFFFFFFFFLL
    || -[NSString length](self, "length")
    && !u_charDigitValue(-[NSString crlwp_utf32CharacterAtIndex:](self, "crlwp_utf32CharacterAtIndex:", 0)))
  {
    return 1;
  }
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet whitespaceCharacterSet](NSCharacterSet, "whitespaceCharacterSet"));
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[NSString componentsSeparatedByCharactersInSet:](self, "componentsSeparatedByCharactersInSet:", v7));
    ...
    if (v10)
    {
      ...
      while (2)
      {
        for (i = 0; i != v10; i = (char *)i + 1)
        {
          ...
          if ((unint64_t)objc_msgSend(v14, "length", (_QWORD)v17) > 3)
          {
            v15 = 1;
            goto LABEL_22;
          }
...
{
  return -[NSString crlwp_contentsScriptInRange:](self, "crlwp_contentsScriptInRange:", 0, -[NSString length](self, "length"));
}
...
- (int)crlwp_contentsScriptInRange:(_NSRange)a3
{
  ...
  length = a3.length;
  location = a3.location;
  if (a3.location >= -[NSString length](self, "length"))
    return 0;
  v6 = -[NSString characterAtIndex:](self, "characterAtIndex:", location);
  v7 = v6;
  v8 = 1;
  if (length >= 2 && (v6 & 0xFC00) == 0xD800)
  {
    v9 = -[NSString characterAtIndex:](self, "characterAtIndex:", location + 1);
    v8 = (v9 & 0xFC00) == 0xDC00 ? 2 : 1;
    if ((v9 & 0xFC00) == 0xDC00)
      v7 = v9 + (v7 << 10) - 56613888;
  }
  v10 = sub_1001ADB64(v7);
  if (v10 && length > v8)
  {
    theString = (CFStringRef)self;
    v31 = v8 + location;
...
+ (id)crlwp_stringForValue:(unsigned int)a3 withPageNumberFormat:(int)a4
{
  ...
  switch(a4)
  {
    ...
    case 2:
      ...
      break;
    case 3:
      v8 = sub_100152260(a3, (uint64_t)aAbcdefghijklmn_0, 0x1AuLL);
...
- (unsigned)crlwp_utf32CharacterAtIndex:(unint64_t)a3
{
  ...
  if (v5 <= a3)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_10123BB28);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DFFD0C();
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_10123BB48);
    v11 = off_1013D9070;
    ...
    v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:]"));
    ...
    +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v12, v13, 1635, 0, "index out of bounds");
  ...
  {
    v6 = v5;
    v7 = -[NSString characterAtIndex:](self, "characterAtIndex:", a3);
    if ((v7 & 0xFC00) == 0xDC00)
    {
      +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BB68);
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
        sub_100DFFC0C();
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BB88);
      v8 = off_1013D9070;
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:]"));
      ...
      +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v9, v10, 1639, 0, "index inside surrogate pair");

    }
    else if (a3 + 1 < v6 && (v7 & 0xFC00) == 0xD800)
    {
      v15 = -[NSString characterAtIndex:](self, "characterAtIndex:");
      ...
      else
      {
        +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_10123BBA8);
        if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
          sub_100DFFC8C();
        if (qword_10147E370 != -1)
          dispatch_once(&qword_10147E370, &stru_10123BBC8);
        v16 = off_1013D9070;
        if (os_log_type_enabled((os_log_t)v16, OS_LOG_TYPE_ERROR))
        {
          objc_claimAutoreleasedReturnValue(+[CRLAssertionHandler packedBacktraceString](CRLAssertionHandler, "packedBacktraceString"));
        ...
        v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:]"));
        v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
        +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v17, v18, 1643, 0, "invalid surrogate pair");
...
- (unsigned)crlwp_utf32CharacterAtIndex:(unint64_t)a3 planeClassification:(int64_t *)a4
{
  ...
  v7 = -[NSString length](self, "length");
  v8 = -[NSString characterAtIndex:](self, "characterAtIndex:", a3);
  if ((v8 & 0xFC00) == 0xD800)
  {
    if (a4)
      *a4 = 1;
    if (v7 - 1 == a3)
    {
      v11 = +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BC68);
      v12 = off_1013D9070;
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 67110402;
      ...
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BC88);
      v13 = off_1013D9070;
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:planeClassification:]"));
      v15 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
    ...
    {
      v16 = -[NSString characterAtIndex:](self, "characterAtIndex:", a3 + 1);
      if ((v16 & 0xFC00) == 0xDC00)
      {
        v10 = v16 + ((_DWORD)v8 << 10);
        goto LABEL_24;
      }
      v25 = +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BCA8);
      v26 = off_1013D9070;
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 67110402;
      ...
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BCC8);
      v27 = off_1013D9070;
      ...
      v28 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:planeClassification:]"));
      v29 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
  ...
  else if ((v8 & 0xFC00) == 0xDC00)
  {
    ...
    if (a3)
    {
      v9 = -[NSString characterAtIndex:](self, "characterAtIndex:", a3 - 1);
      if ((v9 & 0xFC00) == 0xD800)
      {
        v10 = v8 + (v9 << 10);
LABEL_24:
      ...
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BC28);
      v21 = off_1013D9070;
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 67110402;
      ...
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BC48);
      v22 = off_1013D9070;
      if (os_log_type_enabled((os_log_t)v22, OS_LOG_TYPE_ERROR))
      {
        objc_claimAutoreleasedReturnValue(+[CRLAssertionHandler packedBacktraceString](CRLAssertionHandler, "packedBacktraceString"));
      ...
      v23 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:planeClassification:]"));
      v24 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
    ...
    else
    {
      +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BBE8);
      if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
        sub_100DFFD8C();
      if (qword_10147E370 != -1)
        dispatch_once(&qword_10147E370, &stru_10123BC08);
      v17 = off_1013D9070;
      if (os_log_type_enabled((os_log_t)v17, OS_LOG_TYPE_ERROR))
      {
        objc_claimAutoreleasedReturnValue(+[CRLAssertionHandler packedBacktraceString](CRLAssertionHandler, "packedBacktraceString"));
      ...
      v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_utf32CharacterAtIndex:planeClassification:]"));
      v19 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
...
- (BOOL)crlwp_isLowerCaseFromIndex:(unint64_t)a3
{
  ...
  if (v5 <= a3)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_10123BCE8);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DFFE34();
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_10123BD08);
    v9 = off_1013D9070;
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLWPAdditions) crlwp_isLowerCaseFromIndex:]"));
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLWP/NSString+CRLWPAdditions.mm"));
    +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v10, v11, 1762, 0, "index is out of bounds");

    return 1;
  }
  else
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet uppercaseLetterCharacterSet](NSCharacterSet, "uppercaseLetterCharacterSet"));
    v8 = -[NSString rangeOfCharacterFromSet:options:range:](self, "rangeOfCharacterFromSet:options:range:", v7, 2, a3, v6) == (id)0x7FFFFFFFFFFFFFFFLL;
...
- (id)crlwp_stringWithAddedIsolatesBasedOn:(int64_t)a3
{
  ...
  if (-[NSString length](self, "length") >= 2 && (a3 == -1 || sub_1001B0F48(self) != a3))
    v5 = (id)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("⁨%@⁩"), self));
  else
...
- (id)crlwp_stringWithUnambiguousNeutralEnding
{
  ...
  v4 = v3 - 1;
  if (v3 <= 1
    || (v5 = v3, v6 = sub_1001B0F48(self), v6 == -1)
    || (v7 = v6,
        v8 = -[NSString crlwp_utf32CharacterAtIndex:planeClassification:](self, "crlwp_utf32CharacterAtIndex:planeClassification:", v4, 0), v8 >= 0x10000)&& v5 == 2|| sub_1001B0EFC(v8) != 6)
  {
    v10 = -[NSString copy](self, "copy");
  }
  else
  {
    if (v7)
      ...
      v9 = CFSTR("\u200E");
    v10 = (id)objc_claimAutoreleasedReturnValue(-[NSString stringByAppendingString:](self, "stringByAppendingString:", v9));
  }
  return v10;
}
...
- (id)crlwp_stringWithoutControlCharacters
{
  ...
  while (1)
  {
    v5 = objc_msgSend(v2, "rangeOfCharacterFromSet:", v3);
    if (v5 == (id)0x7FFFFFFFFFFFFFFFLL)
      break;
    objc_msgSend(v2, "deleteCharactersInRange:", v5, v4);
  }
...
LABEL_12:
    ...
    if ((v4 & 0x10) != 0)
    {
      if (objc_msgSend(v7, "characterIsMember:", v11))
      {
        ...
        v13 = CFSTR("[\"“”]");
LABEL_11:
        objc_msgSend(v12, "appendFormat:", v13, v29);
        goto LABEL_12;
      }
...
LABEL_13:
  if ((v4 & 8) != 0)
  {
    v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSRegularExpression regularExpressionWithPattern:options:error:](NSRegularExpression, "regularExpressionWithPattern:options:error:", CFSTR("\\b"), 0, 0));
    if (v14)
    {
      v15 = objc_msgSend(v5, "crl_range");
      v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "matchesInString:options:range:", v5, 0, v15, v16));
      if (objc_msgSend(v17, "count"))
      {
        v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "objectAtIndex:", 0));
        v19 = (unint64_t)objc_msgSend(v18, "range");
        v21 = v19 | v20;

        if (!v21)
        {
          v22 = objc_claimAutoreleasedReturnValue(+[NSMutableString stringWithFormat:](NSMutableString, "stringWithFormat:", CFSTR("\\b%@"), v9));
      ...
      if (objc_msgSend(v17, "count"))
      {
        v23 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "lastObject"));
        ...
        if (v24 == v26 && !v30)
        {
          v27 = objc_claimAutoreleasedReturnValue(+[NSMutableString stringWithFormat:](NSMutableString, "stringWithFormat:", CFSTR("%@\\b"), v9));
...
- (_NSRange)crl_rangeOfString:(id)a3 searchOptions:(unint64_t)a4 updatingSearchRange:(_NSRange *)a5
{
  ...
  if ((a4 & 4) != 0)
  {
    v14 = -[NSString crl_rangeOfString:options:updatingSearchRange:](self, "crl_rangeOfString:options:updatingSearchRange:", v10, v8 | 4, a5);
    v16 = v17;
  }
  else
  {
    *(_QWORD *)&v11 = objc_opt_class(self, v9).n128_u64[0];
    v13 = objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "crl_regexStringForSearchString:options:", v10, a4, v11));

    v14 = -[NSString crl_rangeOfString:options:updatingSearchRange:](self, "crl_rangeOfString:options:updatingSearchRange:", v13, v8 | 0x400, a5);
    v16 = v15;
    v10 = (id)v13;
  }
...
- (id)crl_stringByCapitalizingToMatchString:(id)a3 range:(_NSRange)a4 searchOptions:(unint64_t)a5
{
  ...
  {
    v12 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet lowercaseLetterCharacterSet](NSCharacterSet, "lowercaseLetterCharacterSet"));
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSCharacterSet uppercaseLetterCharacterSet](NSCharacterSet, "uppercaseLetterCharacterSet"));
    v14 = (id)-[NSString characterAtIndex:](v10, "characterAtIndex:", 0);
    v15 = objc_msgSend(v9, "characterAtIndex:", location);
    if (objc_msgSend(v12, "characterIsMember:", v14)
      && objc_msgSend(v13, "characterIsMember:", v15))
    {
      v16 = (void *)objc_claimAutoreleasedReturnValue(-[NSString substringWithRange:](v10, "substringWithRange:", 0, 1));
      v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "capitalizedString"));

      if (objc_msgSend(v17, "length"))
      {
        v18 = -[NSString mutableCopy](v10, "mutableCopy");
        objc_msgSend(v18, "replaceCharactersInRange:withString:", 0, 1, v17);
...
- (id)crl_stringByReplacingOccurrencesOfString:(id)a3 withString:(id)a4 searchOptions:(unint64_t)a5 range:(_NSRange)a6 replacementCount:(unint64_t *)a7
{
  ...
  if (length)
  {
    ...
    do
    {
      v18 = -[NSString crl_rangeOfString:searchOptions:updatingSearchRange:](v17, "crl_rangeOfString:searchOptions:updatingSearchRange:", v12, a5, &v29, v27);
      if (v18 != (id)0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        if (!v16)
        {
          v16 = (NSString *)-[NSString mutableCopy](v17, "mutableCopy");

          v17 = v16;
        }
        v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "crl_stringByCapitalizingToMatchString:range:searchOptions:", v17, v20, v21, a5));
        -[NSString replaceCharactersInRange:withString:](v16, "replaceCharactersInRange:withString:", v20, v21, v22);
        ++v15;
        v23 = (char *)objc_msgSend(v13, "length");
...
- (id)crl_stringByUniquingPathInsideDirectory:(id)a3 withFormat:(id)a4
{
  ...
  if (!v6)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_1012524E0);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100E2179C();
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252500);
    v8 = off_1013D9070;
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DE7468(v8);
...
- (id)crl_stringByRemovingCharactersInSet:(id)a3 options:(unsigned int)a4
{
  ...
  else
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252520);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100E21830();
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252540);
    v9 = off_1013D9070;
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DE7468(v9);
...
- (id)crl_escapeForIcuRegex
{
  ...
  if (qword_1014154A8 != -1)
    dispatch_once(&qword_1014154A8, &stru_101252560);
  v3 = self;
  v4 = -[NSString length](v3, "length");
  *(_QWORD *)&v13 = -[NSString rangeOfCharacterFromSet:](v3, "rangeOfCharacterFromSet:", qword_1014154A0);
    ...
    if (v4 != (char *)v13)
    {
      do
      {
        ...
        *((_QWORD *)&v13 + 1) = &v4[-v13];
        ...
        if (v4 != (char *)v13)
        {
          *(_QWORD *)&v12 = -[NSString rangeOfCharacterFromSet:options:range:](v3, "rangeOfCharacterFromSet:options:range:", qword_1014154A0, 0, (_QWORD)v13);
          *((_QWORD *)&v12 + 1) = v9;
          v13 = v12;
...
- (id)crl_tolerantStringByAppendingPathExtension:(id)a3
{
  ...
  v4 = a3;
  if (!-[NSString isEqualToString:](self, "isEqualToString:", &stru_1012A72B0)
    && !objc_msgSend(v4, "isEqualToString:", &stru_1012A72B0))
  {
...
{
  if (qword_1014154B8 != -1)
    dispatch_once(&qword_1014154B8, &stru_1012525E0);
  return -[NSString stringByReplacingOccurrencesOfString:withString:](self, "stringByReplacingOccurrencesOfString:withString:", qword_1014154B0, &stru_1012A72B0);
}
...
{
  if (qword_1014154C0 != -1)
    dispatch_once(&qword_1014154C0, &stru_101252600);
  return -[NSString crl_stringByReplacingInstancesOfCharactersInSet:withString:](self, "crl_stringByReplacingInstancesOfCharactersInSet:withString:", qword_1014154C8, CFSTR("-"));
}

- (id)crl_stringWithNormalizedQuotationMarks
{
  if (qword_1014154D0 != -1)
    dispatch_once(&qword_1014154D0, &stru_101252620);
  return -[NSString crl_stringByReplacingInstancesOfCharactersInSet:withString:](self, "crl_stringByReplacingInstancesOfCharactersInSet:withString:", qword_1014154D8, CFSTR("'"));
}
...
- (id)crl_stringWithoutBidiControls
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[NSString crl_stringByReplacingInstancesOfCharactersInSet:withString:](self, "crl_stringByReplacingInstancesOfCharactersInSet:withString:", v3, &stru_1012A72B0));
...
- (id)crl_regexForTitleParsingWithLocalizedCopyString:(id)a3 isFirstCopyFormatString:(BOOL)a4
{
  ...
  else
  {
    ...
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252640);
    v15 = off_1013D9070;
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 67110402;
    ...
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252660);
    v16 = off_1013D9070;
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DE7468(v16);
...
- (id)crl_stringByApplyingSubstitutions:(id)a3
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "sortedArrayUsingComparator:", &stru_1012526C8));
...
- (void)crl_appendJSONStringToString:(id)a3
{
  ...
  v4 = a3;
  if (qword_1014154E8 != -1)
    dispatch_once(&qword_1014154E8, &stru_1012526E8);
  objc_msgSend(v4, "appendString:", CFSTR("\"));
  if (-[NSString rangeOfCharacterFromSet:](self, "rangeOfCharacterFromSet:", qword_1014154E0) != (id)0x7FFFFFFFFFFFFFFFLL)
  {
    v5 = -[NSString length](self, "length");
...
+ (id)crl_stringWithItemProviderData:(id)a3 typeIdentifier:(id)a4 error:(id *)a5
{
  ...
  if (!v8)
  {
    ...
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252708);
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100E21958((uint64_t)v7, v9);
    if (qword_10147E370 != -1)
      dispatch_once(&qword_10147E370, &stru_101252728);
    v10 = off_1013D9070;
    if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
      sub_100DE7468(v10);
...
- (BOOL)crl_isCJKString
{
  ...
  for (i = 0; (id)i != v6; v9 = i >= (unint64_t)v6)
  {
    ...
    v14 = vmaxv_u8((uint8x8_t)vmovn_s16((int16x8_t)vcgtq_u16((uint16x8_t)xmmword_100EEF5E0, (uint16x8_t)vaddq_s16(v12, (int16x8_t)xmmword_100EEF5D0)))) | vmaxv_u16((uint16x4_t)vceq_s16(v13, (int16x4_t)0x3190300011002E80));
  ...
  if (v3)
  {
    ...
    if (!v4)
    {
      if (qword_10147E368 != -1)
        dispatch_once(&qword_10147E368, &stru_101252748);
      v5 = off_1013D9068;
...
- (id)crl_initRedactedWithFormat:(id)a3 arguments:(char *)a4
{
  ...
  v6 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:arguments:", v5, a4);
  if (qword_1014154F8 != -1)
    dispatch_once(&qword_1014154F8, &stru_101252768);
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_1014154F0, "stringByReplacingMatchesInString:options:range:withTemplate:", v6, 0, 0, objc_msgSend(v6, "length"), CFSTR("<redacted>")));
...
{
  return -[NSString hasPrefix:](self, "hasPrefix:", CFSTR("com.apple.freeform.pasteboardState"));
}
...
- (id)crl_attributedStringAllowingHyphenationWithAlignment:(int64_t)a3 color:(id)a4
{
  ...
  v11 = objc_msgSend(v9, "initWithString:attributes:", self, v10);
  return v11;
}
...
- (id)crl_writeToFileUsingName:(id)a3 error:(id *)a4
{
  ...
  v12 = v11;
  v13 = self;
  sub_100B5DCB4(v10, v12, (uint64_t)v9);
