...
+ (id)crlaxCastFrom:(id)a3
{
  ...
  v3 = a3;
  v5 = (void *)objc_opt_class(CRLColumnAccessibility, v4);
...
- (_NSRange)crlaxRange
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[CRLColumnAccessibility crlaxTarget](self, "crlaxTarget"));
