    ...
    do
    {
      ...
      do
      {
        ...
        if (qword_10147E4C0 != -1)
          dispatch_once(&qword_10147E4C0, &stru_1012308F0);
        v15 = off_1013D91C0;
        if (os_log_type_enabled((os_log_t)off_1013D91C0, OS_LOG_TYPE_DEBUG))
          sub_100DEE618(v68, v15, v14, &v69);
...
- (void)p_logItemProviderError:(id)a3 error:(id)a4
{
  ...
  v6 = a4;
  if (qword_10147E4C0 != -1)
    dispatch_once(&qword_10147E4C0, &stru_101230A78);
  v7 = off_1013D91C0;
  if (os_log_type_enabled((os_log_t)off_1013D91C0, OS_LOG_TYPE_ERROR))
    sub_100DEE844(v7, v5, v6);
