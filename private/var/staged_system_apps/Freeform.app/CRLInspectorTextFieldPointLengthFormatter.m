...
{
  return (CRLInspectorTextFieldPointLengthFormatter *)+[CRLInspectorTextFieldNumberFormatter pointsFormatter](CRLInspectorTextFieldNumberFormatter, "pointsFormatter");
}
...
- (BOOL)p_getObjectValue:(id *)a3 forString:(id)a4 withMinimum:(id)a5 andMaximum:(id)a6 originalValue:(id)a7 errorDescription:(id *)a8 valueObjectWasAdjusted:(BOOL *)a9
{
  ...
  v15 = a6;
  v16 = a7;
  v30[0] = qword_1014159B0;
  v30[1] = qword_1014159C0;
...
{
  return (id)qword_1014159B0;
}

- (id)crlaxLocalizedDescriptionFromValue:(id)a3
{
  return objc_msgSend((id)qword_1014159B0, "crlaxLocalizedDescriptionFromValue:", a3);
}
