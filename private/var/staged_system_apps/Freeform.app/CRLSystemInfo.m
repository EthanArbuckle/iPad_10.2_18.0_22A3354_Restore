...
+ (NSString)osVersion
{
  if (qword_101414C98 != -1)
    dispatch_once(&qword_101414C98, &stru_101231178);
  return (NSString *)(id)qword_101414C90;
}

+ (NSString)hwModel
{
  if (qword_101414CA8 != -1)
    dispatch_once(&qword_101414CA8, &stru_101231198);
  return (NSString *)(id)qword_101414CA0;
}
