...
- (id)crl_stringByUniquingPathInsideDirectory:(id)a3 withFormat:(id)a4
{
  ...
  if (!v6)
  {
    ...
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_100061568);
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
      sub_10004BE7C();
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_100061588);
...
- (id)crl_stringByRemovingCharactersInSet:(id)a3 options:(unsigned int)a4
{
  ...
  else
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount](CRLAssertionHandler, "_atomicIncrementAssertCount");
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_1000615A8);
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
      sub_10004BF10();
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_1000615C8);
...
- (id)crl_escapeForIcuRegex
{
  ...
  if (qword_10006DA48 != -1)
    dispatch_once(&qword_10006DA48, &stru_1000615E8);
  v3 = self;
  v4 = -[NSString length](v3, "length");
  *(_QWORD *)&v13 = -[NSString rangeOfCharacterFromSet:](v3, "rangeOfCharacterFromSet:", qword_10006DA40);
    ...
    if (v4 != (char *)v13)
    {
      do
      {
        ...
        *((_QWORD *)&v13 + 1) = &v4[-v13];
        ...
        if (v4 != (char *)v13)
        {
          *(_QWORD *)&v12 = -[NSString rangeOfCharacterFromSet:options:range:](v3, "rangeOfCharacterFromSet:options:range:", qword_10006DA40, 0, (_QWORD)v13);
          *((_QWORD *)&v12 + 1) = v9;
          v13 = v12;
...
- (id)crl_tolerantStringByAppendingPathExtension:(id)a3
{
  ...
  v4 = a3;
  if (!-[NSString isEqualToString:](self, "isEqualToString:", &stru_1000637E8)
    && !objc_msgSend(v4, "isEqualToString:", &stru_1000637E8))
  {
...
{
  if (qword_10006DA58 != -1)
    dispatch_once(&qword_10006DA58, &stru_100061668);
  return -[NSString stringByReplacingOccurrencesOfString:withString:](self, "stringByReplacingOccurrencesOfString:withString:", qword_10006DA50, &stru_1000637E8);
}
...
{
  if (qword_10006DA60 != -1)
    dispatch_once(&qword_10006DA60, &stru_100061688);
  return -[NSString crl_stringByReplacingInstancesOfCharactersInSet:withString:](self, "crl_stringByReplacingInstancesOfCharactersInSet:withString:", qword_10006DA68, CFSTR("-"));
}

- (id)crl_stringWithNormalizedQuotationMarks
{
  if (qword_10006DA70 != -1)
    dispatch_once(&qword_10006DA70, &stru_1000616A8);
  return -[NSString crl_stringByReplacingInstancesOfCharactersInSet:withString:](self, "crl_stringByReplacingInstancesOfCharactersInSet:withString:", qword_10006DA78, CFSTR("'"));
}
...
- (id)crl_stringWithoutBidiControls
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[NSString crl_stringByReplacingInstancesOfCharactersInSet:withString:](self, "crl_stringByReplacingInstancesOfCharactersInSet:withString:", v3, &stru_1000637E8));
...
- (id)crl_regexForTitleParsingWithLocalizedCopyString:(id)a3 isFirstCopyFormatString:(BOOL)a4
{
  ...
  else
  {
    ...
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_1000616C8);
    ...
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_1000616E8);
...
- (id)crl_stringByApplyingSubstitutions:(id)a3
{
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "sortedArrayUsingComparator:", &stru_100061750));
...
- (void)crl_appendJSONStringToString:(id)a3
{
  ...
  v4 = a3;
  if (qword_10006DA88 != -1)
    dispatch_once(&qword_10006DA88, &stru_100061770);
  objc_msgSend(v4, "appendString:", CFSTR("\"));
  if (-[NSString rangeOfCharacterFromSet:](self, "rangeOfCharacterFromSet:", qword_10006DA80) != (id)0x7FFFFFFFFFFFFFFFLL)
  {
    v5 = -[NSString length](self, "length");
...
+ (id)crl_stringWithItemProviderData:(id)a3 typeIdentifier:(id)a4 error:(id *)a5
{
  ...
  if (!v8)
  {
    ...
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_100061790);
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
      sub_10004C038((uint64_t)v7, v9);
    if (CRLAssertCat_init_token != -1)
      dispatch_once(&CRLAssertCat_init_token, &stru_1000617B0);
...
- (BOOL)crl_isCJKString
{
  ...
  for (i = 0; (id)i != v6; v9 = i >= (unint64_t)v6)
  {
    ...
    v14 = vmaxv_u8((uint8x8_t)vmovn_s16((int16x8_t)vcgtq_u16((uint16x8_t)xmmword_100050E30, (uint16x8_t)vaddq_s16(v12, (int16x8_t)xmmword_100050E20)))) | vmaxv_u16((uint16x4_t)vceq_s16(v13, (int16x4_t)0x3190300011002E80));
  ...
  if (v3)
  {
    ...
    if (!v4)
    {
      if (CRLDefaultCat_init_token != -1)
        dispatch_once(&CRLDefaultCat_init_token, &stru_1000617D0);
...
- (id)crl_initRedactedWithFormat:(id)a3 arguments:(char *)a4
{
  ...
  v6 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:arguments:", v5, a4);
  if (qword_10006DA98 != -1)
    dispatch_once(&qword_10006DA98, &stru_1000617F0);
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_10006DA90, "stringByReplacingMatchesInString:options:range:withTemplate:", v6, 0, 0, objc_msgSend(v6, "length"), CFSTR("<redacted>")));
