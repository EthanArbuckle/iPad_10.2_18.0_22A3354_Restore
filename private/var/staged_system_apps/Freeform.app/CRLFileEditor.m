...
- (void)addMiniFormatterElementsToArray:(id)a3 atPoint:(CGPoint)a4
{
  ...
  double x;
  id v7;
  _TtC8Freeform13CRLFileEditor *v8;

  y = a4.y;
  x = a4.x;
  v7 = a3;
  v8 = self;
  sub_1006986A4(v7, x, y);
...
+ (id)keyPathsForValuesAffectingSelectedObjectsSupportingReplacement
{
  ...
  v2 = sub_1004B5E10((uint64_t)&off_101264CC8);
  swift_arrayDestroy(&unk_101264CE8, 1, &type metadata for String);
...
{
  _TtC8Freeform13CRLFileEditor *v2;
  NSSet *v3;
  uint64_t v4;
  unint64_t v5;
  uint64_t v6;
...
{
  _TtC8Freeform13CRLFileEditor *v5;
  id v6;
  uint64_t v7;
  _QWORD *v8;
  uint64_t v9;
...
- (void)replaceSelectedMediaWithData:(id)a3 actionString:(id)a4 completion:(id)a5
{
  ...
  void *v12;
  uint64_t v13;
  _TtC8Freeform13CRLFileEditor *v14;
...
LABEL_5:
  ...
  if (!v8)
    goto LABEL_5;
LABEL_3:
  v13 = swift_allocObject(&unk_101276130, 24, 7);
  *(_QWORD *)(v13 + 16) = v8;
  v8 = sub_10069934C;
LABEL_6:
  v14 = self;
  sub_100698EA8(v10, v11, a4, v8, v13);
...
- (void)replaceCanvasElementInfo:(id)a3 withFilesAtURLs:(id)a4 allowedTypes:(id)a5 actionString:(id)a6 completion:(id)a7
{
  ...
  void *v16;
  uint64_t v17;
  _TtC8Freeform13CRLFileEditor *v18;
  uint64_t v19;
...
LABEL_7:
  ...
  if (!v12)
    goto LABEL_7;
LABEL_5:
  v17 = swift_allocObject(&unk_1012760E0, 24, 7);
  *(_QWORD *)(v17 + 16) = v12;
  v12 = sub_100565828;
LABEL_8:
  v18 = self;
  v19 = swift_unknownObjectRetain(a3);
  sub_1006990A4(v19, v14, (Class)a5, v15, a6, v12, v17);
