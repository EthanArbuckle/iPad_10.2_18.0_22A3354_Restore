...
- (_TtC8Freeform23CRLCommandSetPathSource)initWithId:(id)a3 pathSource:(id)a4
{
  ...
  v9 = a4;
  v10 = (_TtC8Freeform23CRLCommandSetPathSource *)sub_1009EA334((uint64_t)v8, v9);
...
- (_TtC8Freeform23CRLCommandSetPathSource)initWithShapeItem:(id)a3 pathSource:(id)a4
{
  ...
  v17 = -[CRLCommandSetPathSource initWithId:pathSource:](self, "initWithId:pathSource:", isa, v14);
...
{
  _TtC8Freeform23CRLCommandSetPathSource *result;

  result = (_TtC8Freeform23CRLCommandSetPathSource *)_swift_stdlib_reportUnimplementedInitializer("Freeform.CRLCommandSetPathSource", 32, "init()", 6, 0);
  __break(1u);
  return result;
}
