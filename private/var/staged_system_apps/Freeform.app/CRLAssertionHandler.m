...
+ (id)p_performBlockIgnoringAssertions:(id)a3 onlyFatal:(BOOL)a4
{
  ...
  v7 = objc_retainBlock((id)qword_101414FE0);
  ...
  v10 = (void *)qword_101414FE0;
  qword_101414FE0 = (uint64_t)v9;

  v5[2](v5);
  v11 = objc_retainBlock(v7);
  v12 = (void *)qword_101414FE0;
  qword_101414FE0 = (uint64_t)v11;
...
+ (void)logFullBacktrace
{
  ...
  if (qword_10147E370 != -1)
    dispatch_once(&qword_10147E370, &stru_101241760);
  v3 = off_1013D9070;
...
+ (void)_logBacktraceWithCallStackSymbols:(id)a3
{
  ...
  v4 = a3;
  if (qword_10147E370 != -1)
    dispatch_once(&qword_10147E370, &stru_101241780);
  v5 = off_1013D9070;
  if (os_log_type_enabled((os_log_t)off_1013D9070, OS_LOG_TYPE_ERROR))
    sub_100E077A8(v5, (uint64_t)v4);
  objc_msgSend(a1, "simulateCrashWithMessage:", CFSTR("+[CRLAssert logBacktrace]"));
...
+ (id)packedBacktraceStringWithReturnAddresses:(id)a3
{
  ...
  if (qword_101414FE8 != -1)
    dispatch_once(&qword_101414FE8, &stru_1012417A0);
      ...
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (dladdr(v11, &v79))
        {
          ...
          if ((objc_msgSend(v5, "containsObject:", v12) & 1) == 0)
          {
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&dword_101415000);
            v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_101414FF8, "objectForKeyedSubscript:", v12));
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_101415000);
            if (v13)
            {
              v14 = v55;
              v15 = v13;
...
LABEL_30:
        ...
        if (ncmds)
        {
          ...
          {
            v31 = v30;
            v32 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionaryWithSharedKeySet:](NSMutableDictionary, "dictionaryWithSharedKeySet:", qword_101414FF0));
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&dword_101415000);
            objc_msgSend((id)qword_101414FF8, "setObject:forKeyedSubscript:", v32, v21);
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_101415000);
...
+ (void)simulateCrashWithMessage:(id)a3
{
  ...
  v3 = a3;
  if (qword_101415010 != -1)
  {
    v7 = v3;
    dispatch_once(&qword_101415010, &stru_1012417C0);
    v3 = v7;
  }
  v4 = (void (*)(uint64_t, _QWORD, id))off_101415008;
  if (off_101415008)
  {
    v6 = v3;
    v5 = getpid();
...
+ (void)handleFailureInFunction:(id)a3 file:(id)a4 lineNumber:(int64_t)a5 isFatal:(BOOL)a6 format:(id)a7 args:(char *)a8
{
  ...
  else
  {
    ...
    v19 = atomic_load(&dword_101415018);
...
+ (int)_atomicIncrementAssertCount
{
  ...
  do
    result = __ldaxr(&dword_101415018);
  while (__stlxr(result + 1, &dword_101415018));
  return result;
}
