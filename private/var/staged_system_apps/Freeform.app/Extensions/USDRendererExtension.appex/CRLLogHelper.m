...
+ (id)sharedInstance
{
  if (qword_100085A98 != -1)
    dispatch_once(&qword_100085A98, &stru_100071A20);
  return (id)qword_100085A90;
}
...
- (BOOL)incrementThrottleCountAndCheckThottleMax:(unint64_t)a3
{
  ...
  if (v5 == a3)
  {
    if (CRLPerformanceCat_init_token != -1)
      dispatch_once(&CRLPerformanceCat_init_token, &stru_100071A40);
  ...
  {
    if (CRLPerformanceCat_init_token != -1)
      dispatch_once(&CRLPerformanceCat_init_token, &stru_100071A60);
