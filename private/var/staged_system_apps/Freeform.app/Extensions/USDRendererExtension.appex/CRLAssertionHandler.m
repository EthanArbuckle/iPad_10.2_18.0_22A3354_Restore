...
+ (id)p_performBlockIgnoringAssertions:(id)a3 onlyFatal:(BOOL)a4
{
  ...
  v7 = objc_retainBlock((id)qword_100085AF0);
  ...
  v10 = (void *)qword_100085AF0;
  qword_100085AF0 = (uint64_t)v9;

  v5[2](v5);
  v11 = objc_retainBlock(v7);
  v12 = (void *)qword_100085AF0;
  qword_100085AF0 = (uint64_t)v11;
...
+ (void)logFullBacktrace
{
  ...
  if (CRLAssertCat_init_token != -1)
    dispatch_once(&CRLAssertCat_init_token, &stru_100071CF0);
...
+ (void)_logBacktraceWithCallStackSymbols:(id)a3
{
  ...
  v4 = a3;
  if (CRLAssertCat_init_token != -1)
    dispatch_once(&CRLAssertCat_init_token, &stru_100071D10);
  v5 = CRLAssertCat_log_t;
  if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
    sub_10004E704(v5, (uint64_t)v4);
  objc_msgSend(a1, "simulateCrashWithMessage:", CFSTR("+[CRLAssert logBacktrace]"));
...
+ (id)packedBacktraceStringWithReturnAddresses:(id)a3
{
  ...
  if (qword_100085AF8 != -1)
    dispatch_once(&qword_100085AF8, &stru_100071D30);
      ...
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (dladdr(v11, &v79))
        {
          ...
          if ((objc_msgSend(v5, "containsObject:", v12) & 1) == 0)
          {
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&dword_100085B10);
            v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_100085B08, "objectForKeyedSubscript:", v12));
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_100085B10);
            if (v13)
            {
              v14 = v55;
              v15 = v13;
...
LABEL_30:
        ...
        if (ncmds)
        {
          ...
          {
            v31 = v30;
            v32 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionaryWithSharedKeySet:](NSMutableDictionary, "dictionaryWithSharedKeySet:", qword_100085B00));
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&dword_100085B10);
            objc_msgSend((id)qword_100085B08, "setObject:forKeyedSubscript:", v32, v21);
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_100085B10);
...
+ (void)simulateCrashWithMessage:(id)a3
{
  ...
  v3 = a3;
  if (qword_100085B20 != -1)
  {
    v7 = v3;
    dispatch_once(&qword_100085B20, &stru_100071D50);
    v3 = v7;
  }
  v4 = (void (*)(uint64_t, _QWORD, id))off_100085B18;
  if (off_100085B18)
  {
    v6 = v3;
    v5 = getpid();
...
+ (void)handleFailureInFunction:(id)a3 file:(id)a4 lineNumber:(int64_t)a5 isFatal:(BOOL)a6 format:(id)a7 args:(char *)a8
{
  ...
  else
  {
    ...
    v19 = atomic_load((unsigned int *)&unk_100085B28);
...
+ (int)_atomicIncrementAssertCount
{
  ...
  do
    result = __ldaxr((unsigned int *)&unk_100085B28);
  while (__stlxr(result + 1, (unsigned int *)&unk_100085B28));
  return result;
}
