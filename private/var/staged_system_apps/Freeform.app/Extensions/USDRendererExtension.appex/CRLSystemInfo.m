...
+ (NSString)osVersion
{
  if (qword_100085A18 != -1)
    dispatch_once(&qword_100085A18, &stru_100071668);
  return (NSString *)(id)qword_100085A10;
}

+ (NSString)hwModel
{
  if (qword_100085A28 != -1)
    dispatch_once(&qword_100085A28, &stru_100071688);
  return (NSString *)(id)qword_100085A20;
}
