...
{
  return objc_msgSend((id)type metadata accessor for ImagePlaygroundViewController(0, a2), "available");
}
...
- (_TtC20USDRendererExtension41CRLGenerativePlaygroundAvailabilityHelper)init
{
  ...
  return -[CRLGenerativePlaygroundAvailabilityHelper init](&v3, "init");
}
