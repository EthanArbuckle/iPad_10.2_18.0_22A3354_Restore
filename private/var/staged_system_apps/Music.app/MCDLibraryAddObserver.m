...
- (void)updateRequestForTracklist:(id)a3
{
  ...
  if (objc_msgSend(v7, "type") == (id)1)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 138543362;
      v40 = v12;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_INFO, "LibraryAddObserver: Song updated %{public}@", (uint8_t *)&v39, 0xCu);
  ...
  if (!v30)
  {
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        sub_100DE9808((uint64_t)v4, v30, v33, v34, v35, v36, v37, v38);
    }
  }
...
- (void)addSongToLibrary
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "Adding song to library", v6, 2u);
  }
...
- (void)addAlbumToLibrary
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "Adding album to library", v6, 2u);
  }
...
- (void)addPlaylistToLibrary
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "Adding playlist to library", v6, 2u);
  }
...
- (void)_addItemToLibrary:(id)a3
{
  ...
  if (v4)
  {
    ...
    -[NSObject appendSection:](v5, "appendSection:", &stru_101122068);
...
- (BOOL)isSongAddable
{
  ...
  v4 = objc_msgSend(v3, "currentStatus");
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2114;
    v20 = v10;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "isSongAddable: %p\n\tisCloudLibraryEnabled: %{public}@\n\tlibraryAdded: %{public}@\n\tlibraryAddEligible: %{public}@", (uint8_t *)&v13, 0x2Au);
...
- (BOOL)isSongAdded
{
  ...
  v3 = objc_msgSend(v2, "currentStatus") == (id)1;
...
- (BOOL)shouldShowFavoriteSong
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    v33 = 2114;
    v34 = v20;
    _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_INFO, "shouldShowFavoriteSong: %p\n\tlibraryAdded: %{public}@\n\tlibraryAddEligible: %{public}@\n\tisHomeSharing: %{public}@", buf, 0x2Au);
...
- (BOOL)isAlbumAddable
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2114;
    v23 = v10;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "isAlbumAddable: %p\n\tdidReceiveAlbumResponse: %{public}@\n\tisCloudLibraryEnabled: %{public}@\n\tlibraryAdded: %{public}@\n\tlibraryAddEligible: %{public}@", (uint8_t *)&v14, 0x34u);
...
- (BOOL)isPlaylistAddable
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2114;
    v19 = v8;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "isPlaylistAddable: %p\n\tdidReceivePlaylistResponse: %{public}@\n\tisCloudLibraryEnabled: %{public}@\n\tlibraryAdded: %{public}@", (uint8_t *)&v12, 0x2Au);
...
LABEL_7:
      _os_log_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_INFO, v14, (uint8_t *)&v24, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      sub_100DE98B0((uint64_t)v5, v11, v18, v19, v20, v21, v22, v23);
  }
