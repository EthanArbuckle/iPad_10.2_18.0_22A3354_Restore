...
- (void)initiateRadioPlaybackForArtist:(id)a3 playActivityFeatureName:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v16 = v11;
    _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_DEFAULT, "Initiating radio playback for artist: %{public}@", buf, 0xCu);
...
- (void)_initiatePlaybackAndPushNPViewControllerForPlaybackRequest:(id)a3 startItemIdentifiers:(id)a4 shuffle:(BOOL)a5 playActivityFeatureName:(id)a6
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_DEFAULT, "Initiating playback for library content", buf, 2u);
  }
