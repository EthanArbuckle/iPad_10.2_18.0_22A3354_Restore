...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess(&v2[OBJC_IVAR____TtC5Music22TintColorObservingView_tintColorDidChangeCallback], v8, 0, 0);
  v4 = *(void (**)(void))v3;
  if (!*(_QWORD *)v3)
    goto LABEL_4;
  v5 = *((_QWORD *)v3 + 1);
  v6 = objc_msgSend(v2, "tintColor", swift_retain().n128_f64[0]);
  if (v6)
  {
    v7 = v6;
    v4();
...
- (void).cxx_destruct
{
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC5Music22TintColorObservingView_tintColorDidChangeCallback), *(_QWORD *)&self->tintColorDidChangeCallback[OBJC_IVAR____TtC5Music22TintColorObservingView_tintColorDidChangeCallback]);
}
