...
- (void)layoutSubviews
{
  ...
  v3 = *(void (**)(__n128))&v2[OBJC_IVAR____TtCC5Music19NowPlayingQueueCell8TextView_didLayoutSubviews];
  if (v3)
  {
    v4 = *(_QWORD *)&v2[OBJC_IVAR____TtCC5Music19NowPlayingQueueCell8TextView_didLayoutSubviews + 8];
    v5 = swift_retain();
    v3(v5);
...
- (_TtCC5Music19NowPlayingQueueCell8TextView)initWithCoder:(id)a3
{
  ...
  *v5 = 0;
  ...
  v8.receiver = self;
  v8.super_class = v6;
  return -[NowPlayingQueueCell.TextView initWithCoder:](&v8, "initWithCoder:", a3);
}

- (void).cxx_destruct
{
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.super.super.isa+ OBJC_IVAR____TtCC5Music19NowPlayingQueueCell8TextView_didLayoutSubviews), *(_QWORD *)&self->didLayoutSubviews[OBJC_IVAR____TtCC5Music19NowPlayingQueueCell8TextView_didLayoutSubviews]);
}
