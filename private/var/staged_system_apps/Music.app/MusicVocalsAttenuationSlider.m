...
- (MusicVocalsAttenuationSlider)initWithCoder:(id)a3
{
  ...
  result = (MusicVocalsAttenuationSlider *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100E2B820, "MusicCoreUI/VocalsAttenuationSlider.swift", 41, 2, 26, 0);
  __break(1u);
  return result;
}
