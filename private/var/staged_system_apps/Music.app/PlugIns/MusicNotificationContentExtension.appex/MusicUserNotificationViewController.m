...
- (_TtC33MusicNotificationContentExtension35MusicUserNotificationViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  NSString v9;
  id v10;
  _TtC33MusicNotificationContentExtension35MusicUserNotificationViewController *v11;
  objc_super v13;
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for MusicUserNotificationViewController();
  v11 = -[MusicUserNotificationViewController initWithNibName:bundle:](&v13, "initWithNibName:bundle:", v9, a4);
...
- (_TtC33MusicNotificationContentExtension35MusicUserNotificationViewController)initWithCoder:(id)a3
{
  ...
  return -[MusicUserNotificationViewController initWithCoder:](&v5, "initWithCoder:", a3);
}
