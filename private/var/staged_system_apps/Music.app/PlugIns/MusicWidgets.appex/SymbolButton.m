...
- (void)tintColorDidChange
{
  ...
  sub_10000D964(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_1003F8E80((uint64_t)v4);
  sub_10000E750((uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
...
- (BOOL)isHighlighted
{
  return sub_1003F77E0(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_1003F77E0(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_1003F77E0(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
{
  sub_1002AA940((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.SymbolButton", 24);
}

- (void).cxx_destruct
{
  swift_bridgeObjectRelease();
  sub_1000DB26C(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider]);
  sub_1000DB26C(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler]);
  sub_10000E750((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_1000DB26C(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu]);
  ...
  sub_100011694((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_100560960);
}
