...
- (void)imagePickerController:(id)a3 didFinishPickingMediaWithInfo:(id)a4
{
  ...
  v8 = v7;
  v9 = sub_10001254C(&qword_10055F270, (uint64_t (*)(uint64_t))type metadata accessor for InfoKey, (uint64_t)&unk_100439BFC);
...
- (void)documentPickerWasCancelled:(id)a3
{
  ...
  sub_1003C8D90((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker, (uint64_t)v7);
  v8 = &v7[*(int *)(v5 + 32)];
  v9 = *(_QWORD *)v8;
  v10 = *((_QWORD *)v8 + 1);
  LOBYTE(v8) = v8[16];
...
- (void)presentationControllerDidDismiss:(id)a3
{
  ...
  v11 = (char)v4;
  v8 = 0;
  v7 = sub_10000B4C8(&qword_10055F240);
...
- (void).cxx_destruct
{
  sub_1003C8DD4((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker);
  sub_1000DB26C(*(uint64_t *)((char *)&self->super.isa + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_pickHandler), *(_QWORD *)&self->pickHandler[OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_pickHandler]);
  swift_bridgeObjectRelease();
