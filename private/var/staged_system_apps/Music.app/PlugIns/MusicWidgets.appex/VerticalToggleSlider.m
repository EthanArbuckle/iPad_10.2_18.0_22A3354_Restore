...
- (CGSize)intrinsicContentSize
{
  ...
  if (*((_BYTE *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_mode) == 2)
  {
    ...
    v4 = self;
    if (v3 != -1)
      swift_once(&qword_1005581C0, sub_1004104E0);
    v5 = &xmmword_100560AB8;
  }
  else
  {
    v6 = qword_1005581C8;
...
- (BOOL)isEnabled
{
  return sub_10040F5A8(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}

- (void)setEnabled:(BOOL)a3
{
  sub_10040F644(self, (uint64_t)a2, a3, (const char **)&selRef_isEnabled, (SEL *)&selRef_setEnabled_, (void (*)(id))sub_10040D160);
}
...
- (BOOL)isHighlighted
{
  return sub_10040F5A8(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}

- (void)setHighlighted:(BOOL)a3
{
  sub_10040F644(self, (uint64_t)a2, a3, (const char **)&selRef_isHighlighted, (SEL *)&selRef_setHighlighted_, (void (*)(id))sub_10040F768);
}
...
- (void).cxx_destruct
{
  ...
  sub_1003352C8(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_packageDefinition), *((_QWORD *)v3 + 1), *((void **)v3 + 2), *((_QWORD *)v3 + 3), *((_QWORD *)v3 + 4), *((_QWORD *)v3 + 5), *((_QWORD *)v3 + 6), *((_QWORD *)v3 + 7), *((_QWORD *)v3 + 8), *((_QWORD *)v3 + 9));
