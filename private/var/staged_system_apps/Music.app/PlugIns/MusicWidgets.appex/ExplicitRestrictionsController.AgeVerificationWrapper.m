...
- (void)cloudServiceSetupViewControllerDidDismiss:(id)a3
{
  ...
  v5 = swift_allocObject(&unk_10050E698, 24, 7);
  *(_QWORD *)(v5 + 16) = self;
  v6 = self;
  v7 = a3;
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)(sub_10020CEB0, v5);
