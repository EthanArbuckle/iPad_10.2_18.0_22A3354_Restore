...
- (_TtCC11MusicCoreUI12SymbolButtonP33_0D6450BB937596549C350B7D294A2A9314BackgroundView)initWithCoder:(id)a3
{
  ...
  *v4 = 0;
  ...
  result = (_TtCC11MusicCoreUI12SymbolButtonP33_0D6450BB937596549C350B7D294A2A9314BackgroundView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x800000010044BC20, "MusicCoreUI/SymbolButton.swift", 30, 2, 1397, 0);
  __break(1u);
  return result;
}
...
{
  sub_1002AA940((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.BackgroundView", 26);
}
