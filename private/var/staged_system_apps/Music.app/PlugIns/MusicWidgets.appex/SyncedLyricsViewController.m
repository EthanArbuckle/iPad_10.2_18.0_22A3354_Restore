...
- (void).cxx_destruct
{
  ...
  sub_10019FB08((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate);
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_lyrics));
  sub_100011694((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_10055A2F0);
  sub_1000DB26C(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler), *(_QWORD *)&self->isPlayingSpatial[OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler]);
