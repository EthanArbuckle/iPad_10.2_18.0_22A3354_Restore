...
{
  if (qword_10058D808 != -1)
    dispatch_once(&qword_10058D808, &stru_100526ED8);
  return (MusicMonogramArtworkDataSource *)(id)qword_10058D800;
}

+ (OS_dispatch_queue)loadingQueue
{
  if (qword_10058D818 != -1)
    dispatch_once(&qword_10058D818, &stru_100526EF8);
  return (OS_dispatch_queue *)(id)qword_10058D810;
}
...
- (void)loadRepresentationForArtworkCatalog:(id)a3 completionHandler:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100419B34;
  block[3] = &unk_100526F48;
  v15 = v6;
  v16 = self;
  v17 = v7;
  v12 = v7;
