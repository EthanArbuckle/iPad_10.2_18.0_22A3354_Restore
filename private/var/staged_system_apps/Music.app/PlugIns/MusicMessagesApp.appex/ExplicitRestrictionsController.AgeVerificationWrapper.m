...
- (void)dealloc
{
  ...
  if (v4)
  {
    ...
    v6 = self;
    sub_10000DCE8((uint64_t)v4, v5);
    v4(0, 0);
    sub_10000DCF8((uint64_t)v4, v5);
  }
  else
  {
    v7 = self;
...
- (void)cloudServiceSetupViewControllerDidDismiss:(id)a3
{
  ...
  v5 = swift_allocObject(&unk_100479050, 24, 7);
  *(_QWORD *)(v5 + 16) = self;
  v6 = self;
  v7 = a3;
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)(sub_10018BF00, v5);
