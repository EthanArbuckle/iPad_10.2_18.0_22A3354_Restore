...
- (_TtCCC11MusicCoreUI20SyncedLyricsLineView4Line8LineView)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  result = (_TtCCC11MusicCoreUI20SyncedLyricsLineView4Line8LineView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001003A4070, "MusicCoreUI/Line.swift", 22, 2, 285, 0);
  __break(1u);
  return result;
}
