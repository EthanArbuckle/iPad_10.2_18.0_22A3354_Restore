...
{
  if (qword_1004F4438 != -1)
    dispatch_once(&qword_1004F4438, &stru_100491890);
  return (MusicMonogramArtworkDataSource *)(id)qword_1004F4430;
}

+ (OS_dispatch_queue)loadingQueue
{
  if (qword_1004F4448 != -1)
    dispatch_once(&qword_1004F4448, &stru_1004918B0);
  return (OS_dispatch_queue *)(id)qword_1004F4440;
}
...
- (void)loadRepresentationForArtworkCatalog:(id)a3 completionHandler:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100399550;
  block[3] = &unk_100491900;
  v15 = v6;
  v16 = self;
  v17 = v7;
  v12 = v7;
