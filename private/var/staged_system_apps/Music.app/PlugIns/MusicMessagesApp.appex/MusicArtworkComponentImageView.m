...
- (MusicArtworkComponentImageView)initWithImage:(id)a3
{
  ...
  swift_weakInit((char *)self + OBJC_IVAR___MusicArtworkComponentImageView_artworkComponent, 0);
...
{
  return (MusicArtworkComponentImageView *)sub_10001A258(a3);
}
...
- (void).cxx_destruct
{
  ...
  sub_10001B210(*(id *)((char *)&self->super.super.super.super.isa
