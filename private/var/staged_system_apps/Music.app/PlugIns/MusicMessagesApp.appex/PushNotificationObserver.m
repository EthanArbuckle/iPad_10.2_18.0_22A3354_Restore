...
LABEL_3:
      ...
      v16 = (_QWORD *)swift_allocObject(&unk_100478900, 64, 7);
      v16[2] = 0;
      v16[3] = 0;
      v16[4] = self;
      v16[5] = v12;
      ...
      v17 = a3;
      swift_bridgeObjectRetain();
      v18 = sub_1000E6084((uint64_t)v11, (uint64_t)&unk_1004BF1D0, (uint64_t)v16);
      swift_release(v18);
...
- (_TtC9MusicCore24PushNotificationObserver)init
{
  ...
  swift_retain(self);
  *(_QWORD *)self->registeredHandlers = sub_1000B93FC((uint64_t)_swiftEmptyArrayStorage);
