...
- (_TtCE14MusicUtilitiesCSo14NSUserDefaultsP33_0EE8F48931DDE162065F15584D7CE3A39_Observer)init
{
  ...
  v4 = self;
  *(Class *)((char *)&self->super.isa + v3) = (Class)sub_10021C11C((uint64_t)_swiftEmptyArrayStorage);
...
LABEL_8:
  sub_1002478F8(v10, v12, (uint64_t)v21, v18, (uint64_t)a6);

  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  sub_100220A84((uint64_t)v21);
}
