...
- (CGSize)intrinsicContentSize
{
  ...
  if (*((_BYTE *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_mode) == 2)
  {
    ...
    v4 = self;
    if (v3 != -1)
      swift_once(&qword_1004C5220, sub_10038FF00);
    v5 = &xmmword_1004CDB18;
  }
  else
  {
    v6 = qword_1004C5228;
    v7 = self;
    if (v6 != -1)
      swift_once(&qword_1004C5228, sub_10038FF18);
    v5 = &xmmword_1004CDB28;
  }
  v8 = *(double *)v5;
  v9 = *((double *)v5 + 1);
...
- (BOOL)isEnabled
{
  return sub_10038EFC8(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}

- (void)setEnabled:(BOOL)a3
{
  sub_10038F064(self, (uint64_t)a2, a3, (const char **)&selRef_isEnabled, (SEL *)&selRef_setEnabled_, (void (*)(id))sub_10038CB80);
}
...
- (BOOL)isHighlighted
{
  return sub_10038EFC8(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}

- (void)setHighlighted:(BOOL)a3
{
  sub_10038F064(self, (uint64_t)a2, a3, (const char **)&selRef_isHighlighted, (SEL *)&selRef_setHighlighted_, (void (*)(id))sub_10038F188);
}
...
- (void).cxx_destruct
{
  ...
  sub_1002B43D0(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_packageDefinition), *((_QWORD *)v3 + 1), *((void **)v3 + 2), *((_QWORD *)v3 + 3), *((_QWORD *)v3 + 4), *((_QWORD *)v3 + 5), *((_QWORD *)v3 + 6), *((_QWORD *)v3 + 7), *((_QWORD *)v3 + 8), *((_QWORD *)v3 + 9));
  ...
  swift_release(*(Class *)((char *)&self->super.super.super.super.isa
                         + OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_sceneActivationObserver));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
