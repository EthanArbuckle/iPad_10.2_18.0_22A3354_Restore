...
- (void).cxx_destruct
{
  ...
  sub_10000FF08((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate);
  swift_release(*(Class *)((char *)&self->super.super.super.isa
                         + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_lyrics));
  sub_10000FE2C((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_1004C7350);
  sub_10000DCF8(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler), *(_QWORD *)&self->isPlayingSpatial[OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler]);
