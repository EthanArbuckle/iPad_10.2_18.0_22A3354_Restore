...
- (void).cxx_destruct
{
  sub_10000DCF8(*(uint64_t *)((char *)&self->super.isa + OBJC_IVAR____TtC14MusicUtilities28CAAnimationCompletionHandler_animating), *(_QWORD *)&self->animating[OBJC_IVAR____TtC14MusicUtilities28CAAnimationCompletionHandler_animating]);
  sub_10000DCF8(*(uint64_t *)((char *)&self->super.isa + OBJC_IVAR____TtC14MusicUtilities28CAAnimationCompletionHandler_completion), *(_QWORD *)&self->animating[OBJC_IVAR____TtC14MusicUtilities28CAAnimationCompletionHandler_completion]);
