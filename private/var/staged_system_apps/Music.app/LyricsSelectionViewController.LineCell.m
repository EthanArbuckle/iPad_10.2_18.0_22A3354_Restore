...
- (void)setHighlighted:(BOOL)a3
{
  _BOOL8 v3;
  objc_class *v5;
  _TtCC5Music29LyricsSelectionViewController8LineCell *v6;
  char v7;
  objc_super v8;
  objc_super v9;
...
{
  return (_TtCC5Music29LyricsSelectionViewController8LineCell *)sub_10091CC24(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (void)layoutSubviews
{
  _TtCC5Music29LyricsSelectionViewController8LineCell *v2;
...
{
  return (UIBezierPath *)objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.isa+ OBJC_IVAR____TtCC5Music29LyricsSelectionViewController8LineCell_containerView), "accessibilityPath");
}

- (void)setAccessibilityPath:(id)a3
{
  sub_10091F348(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_setAccessibilityPath_);
}
...
- (NSString)accessibilityLabel
{
  ...
  v2 = *(_QWORD *)&self->text[OBJC_IVAR____TtCC5Music29LyricsSelectionViewController8LineCell_text];
...
{
  sub_10091F1F8(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_setAccessibilityLabel_);
}
...
{
  sub_10091F1F8(self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_setAccessibilityHint_);
}
...
{
  sub_10091F348(self, (uint64_t)a2, a3, (SEL *)&selRef_setAccessibilityTraits_);
}

- (void).cxx_destruct
{
  swift_bridgeObjectRelease(*(_QWORD *)&self->text[OBJC_IVAR____TtCC5Music29LyricsSelectionViewController8LineCell_text]);
