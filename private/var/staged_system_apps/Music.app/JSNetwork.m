...
{
  sub_100D86B34(self, (uint64_t)a2, a3, (uint64_t)&unk_10111D188, (uint64_t (*)(void))sub_100D86FB4);
}

- (void)environmentMonitorDidChangeTelephonyStatus:(id)a3
{
  sub_100D86B34(self, (uint64_t)a2, a3, (uint64_t)&unk_10111D160, (uint64_t (*)(void))sub_100D86FB0);
}
