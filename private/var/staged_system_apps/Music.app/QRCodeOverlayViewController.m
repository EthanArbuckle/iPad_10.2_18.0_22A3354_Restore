...
- (void).cxx_destruct
{
  ...
  sub_1000652DC(*(_QWORD *)&self->backgroundView[OBJC_IVAR____TtC11MusicCoreUI27QRCodeOverlayViewController_qrCode], *(_QWORD *)&self->qrCodeView[OBJC_IVAR____TtC11MusicCoreUI27QRCodeOverlayViewController_qrCode]);
