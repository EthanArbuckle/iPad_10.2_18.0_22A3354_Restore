...
- (MCDNowPlayingContentManager)initWithDelegate:(id)a3 dataSource:(id)a4 bundleID:(id)a5
{
  ...
  if (v11)
  {
    ...
    v32 = &v31;
    v33 = 0x2050000000;
    v13 = (void *)get_MCDNowPlayingContentManagerClass_softClass;
    v34 = get_MCDNowPlayingContentManagerClass_softClass;
    if (!get_MCDNowPlayingContentManagerClass_softClass)
    {
      location[0] = _NSConcreteStackBlock;
      location[1] = (id)3221225472;
      location[2] = __get_MCDNowPlayingContentManagerClass_block_invoke;
      location[3] = &unk_1339000;
      location[4] = &v31;
      __get_MCDNowPlayingContentManagerClass_block_invoke((uint64_t)location);
      v13 = (void *)v32[3];
    }
    ...
    if (_os_feature_enabled_impl("MediaRemote", "wrangler"))
    {
      ...
      v25 = (void *)objc_claimAutoreleasedReturnValue(+[MCDSharePlayTogetherViewModel notificationName](_TtC16MusicApplication29MCDSharePlayTogetherViewModel, "notificationName"));
    ...
    v27[1] = 3221225472;
    v27[2] = __68__MCDNowPlayingContentManager_initWithDelegate_dataSource_bundleID___block_invoke;
    v27[3] = &unk_1338FB0;
...
void __68__MCDNowPlayingContentManager_initWithDelegate_dataSource_bundleID___block_invoke(uint64_t a1)
{
  void *v1;
  _QWORD *WeakRetained;
...
- (void)_processResponse:(id)a3 error:(id)a4
{
  ...
  if (v15)
  {
    ...
    if (objc_msgSend(v23, "type") == (char *)&dword_C + 1)
    {
      ...
      if ((v28 & 1) == 0)
      {
        ...
        if ((v30 & 1) != 0)
        {
          v31 = soft_MCDMusicGeneralLogging_3();
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_QWORD *)((char *)&buf + 4) = v34;
            _os_log_impl(&dword_0, v32, OS_LOG_TYPE_DEFAULT, "Setting radio station: %{public}@", (uint8_t *)&buf, 0xCu);
  ...
  if (v39 != (id)-[MCDNowPlayingContentManager playerState](self, "playerState"))
  {
    ...
    *((_QWORD *)&buf + 1) = &buf;
    v48 = 0x2020000000;
    v41 = (_QWORD *)getMCDPlaybackStateChangedNotificationSymbolLoc_ptr;
    v49 = getMCDPlaybackStateChangedNotificationSymbolLoc_ptr;
    if (!getMCDPlaybackStateChangedNotificationSymbolLoc_ptr)
    {
      v42 = (void *)MusicCarDisplayUILibrary_16();
      v41 = dlsym(v42, "MCDPlaybackStateChangedNotification");
      *(_QWORD *)(*((_QWORD *)&buf + 1) + 24) = v41;
      getMCDPlaybackStateChangedNotificationSymbolLoc_ptr = (uint64_t)v41;
    }
...
- (void)updateNoContentView
{
  ...
  void *v5;
  void *v6;
  _TtC16MusicApplication20CarPlayNoContentView *v7;
  void *v8;
  void *v9;
...
LABEL_5:
    ...
    if (!v6)
    {
      v7 = [_TtC16MusicApplication20CarPlayNoContentView alloc];
      v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("There’s no music in the queue."), &stru_13E1990, 0));
...
- (void)setCurrentAttributionCatalog:(id)a3
{
  ...
  if ((objc_msgSend(v5, "isArtworkVisuallyIdenticalToCatalog:", self->_currentAttributionCatalog) & 1) == 0)
  {
    ...
    v14[1] = 3221225472;
    v14[2] = __60__MCDNowPlayingContentManager_setCurrentAttributionCatalog___block_invoke;
    v14[3] = &unk_133A208;
    ...
    v11[1] = 3221225472;
    v11[2] = __60__MCDNowPlayingContentManager_setCurrentAttributionCatalog___block_invoke_2;
    v11[3] = &unk_133A258;
...
void __60__MCDNowPlayingContentManager_setCurrentAttributionCatalog___block_invoke(uint64_t a1)
{
  id WeakRetained;
  void *v3;
  void *v4;
...
void __60__MCDNowPlayingContentManager_setCurrentAttributionCatalog___block_invoke_2(uint64_t a1, uint64_t a2, void *a3)
{
  id v4;
  id v5;
  _QWORD block[4];
  ...
  block[1] = 3221225472;
  block[2] = __60__MCDNowPlayingContentManager_setCurrentAttributionCatalog___block_invoke_3;
  block[3] = &unk_133A230;
...
void __60__MCDNowPlayingContentManager_setCurrentAttributionCatalog___block_invoke_3(uint64_t a1)
{
  id WeakRetained;
  id v3;
  void *v4;
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (_os_feature_enabled_impl("MediaPlayer", "QueueFA"))
  {
    ...
    v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "localizedStringForKey:value:table:", v9, &stru_13E1990, 0));
  ...
  else
  {
    ...
    v10 = soft_MCDCarDisplayBundle_1();
    v6 = (void *)objc_claimAutoreleasedReturnValue(v10);
    v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("AUTOPLAY_SECTION_TITLE"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
  }
LABEL_9:
...
- (void)playbackManager:(id)a3 shouldShowError:(id)a4
{
  ...
  v5 = soft_MCDCarDisplayBundle_1();
  v6 = (void *)objc_claimAutoreleasedReturnValue(v5);
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("ADD_STATION_FAILED_ALERT_TITLE"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
  v8 = soft_MCDCarDisplayBundle_1();
  v9 = (void *)objc_claimAutoreleasedReturnValue(v8);
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "localizedStringForKey:value:table:", CFSTR("ADD_STATION_FAILED_ALERT_MESSAGE"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)v11, "localizedStringForKey:value:table:", CFSTR("OK"), &stru_13E1990, 0));
...
- (id)customPlaybackControlButtonsForNowPlayingViewController:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v18 = soft_MCDCarDisplayBundle_1();
    v19 = (void *)objc_claimAutoreleasedReturnValue(v18);
    v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v19, "localizedStringForKey:value:table:", CFSTR("ACCESSIBILITY_AUTOPLAY"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v89[0] = v20;
    v21 = soft_MCDCarDisplayBundle_1();
    v22 = (void *)objc_claimAutoreleasedReturnValue(v21);
    v23 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v22, "localizedStringForKey:value:table:", CFSTR("ACCESSIBILITY_INFINITY"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v89[1] = v23;
  ...
  if (v30)
  {
    ...
    v34 = (char *)objc_msgSend(v33, "actionAtQueueEnd");

    if ((char *)-[MCDNowPlayingContentManager previousActionAtQueueEnd](self, "previousActionAtQueueEnd") != v34)
    {
      v35 = (void *)objc_claimAutoreleasedReturnValue(-[MCDNowPlayingContentManager autoplayButton](self, "autoplayButton"));
      objc_msgSend(v35, "setSelected:", v34 == (_BYTE *)&dword_0 + 3);
  ...
  if (!v36)
  {
    ...
    v64 = soft_MCDCarDisplayBundle_1();
    v65 = (void *)objc_claimAutoreleasedReturnValue(v64);
    v66 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v65, "localizedStringForKey:value:table:", CFSTR("ACCESSIBILITY_FAVORITE"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v88[0] = v66;
    v67 = soft_MCDCarDisplayBundle_1();
    v68 = (void *)objc_claimAutoreleasedReturnValue(v67);
    v69 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v68, "localizedStringForKey:value:table:", CFSTR("ACCESSIBILITY_STAR"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v88[1] = v69;
...
- (void)nowPlayingViewController:(id)a3 didSelectButton:(id)a4
{
  ...
  if (v5 == v18)
  {
    ...
    if (objc_msgSend(v6, "actionAtQueueEnd") == (char *)&dword_0 + 3)
      v7 = 2;
    else
      v7 = 3;
    ...
    if (a4 != 1)
    {
      if (a4 == 2)
      {
        if (-[_MCDNowPlayingContentManager nowPlayingViewControllerIsPlaying:](self->_impl, "nowPlayingViewControllerIsPlaying:", v11))
        {
          ...
          v14 = soft_MCDMusicGeneralLogging_3();
          ...
          if (v13)
          {
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_0, v15, OS_LOG_TYPE_DEFAULT, "Showing stop button", buf, 2u);
            }
          ...
          else
          {
            ...
            {
              *(_WORD *)v27 = 0;
              _os_log_impl(&dword_0, v15, OS_LOG_TYPE_DEFAULT, "Showing pause button", v27, 2u);
            }
        ...
        {
          v23 = soft_MCDMusicGeneralLogging_3();
          v24 = objc_claimAutoreleasedReturnValue(v23);
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
          {
            *(_WORD *)v26 = 0;
            _os_log_impl(&dword_0, v24, OS_LOG_TYPE_DEFAULT, "Showing play button", v26, 2u);
          }
...
- (BOOL)nowPlayingViewControllerCanShowAddToLibrary:(id)a3
{
  ...
  {
    v6 = soft_MCDMusicGeneralLogging_3();
    v7 = objc_claimAutoreleasedReturnValue(v6);
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)v11 = 0;
      _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEFAULT, "Subscriber cannot add catalog content to their Cloud Library, hiding Add Library button from Now Playing", v11, 2u);
    }
...
- (BOOL)nowPlayingViewControllerCanShowMore:(id)a3
{
  ...
  v7 = soft_MCDMusicGeneralLogging_3();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 1024;
    v14 = v6;
    _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Show CTA: Create Station: %d, Add to Library: %d, allowsTasteActions: %d", (uint8_t *)v10, 0x14u);
  }
...
- (void)nowPlayingViewControllerAlbumArtistButtonTapped:(id)a3
{
  ...
  if (v6 && !-[MCDNowPlayingContentManager isCurrentPlayingAlbumInLibrary](self, "isCurrentPlayingAlbumInLibrary"))
  {
    ...
    v13 = soft_MCDMusicGeneralLogging_3();
  ...
  else
  {
    ...
    v9 = soft_MCDMusicGeneralLogging_3();
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = (uint8_t *)&v15;
LABEL_7:
      _os_log_impl(&dword_0, v10, OS_LOG_TYPE_DEFAULT, v11, v12, 2u);
    }
  }
...
- (void)_addItemsToLibrary
{
  ...
  v3 = objc_msgSend(getMCDAlertControllerClass(), "alertControllerWithTitle:message:preferredStyle:", 0, 0, 0);
    ...
    || -[MCDLibraryAddObserver isSongAdded](self->_libraryAddObserver, "isSongAdded"))
  {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", v7, &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v32[0] = _NSConcreteStackBlock;
    v32[1] = 3221225472;
    v32[2] = __49__MCDNowPlayingContentManager__addItemsToLibrary__block_invoke;
    v32[3] = &unk_133A280;
    ...
    || -[MCDLibraryAddObserver isAlbumAdded](self->_libraryAddObserver, "isAlbumAdded"))
  {
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "localizedStringForKey:value:table:", v12, &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v30[0] = _NSConcreteStackBlock;
    v30[1] = 3221225472;
    v30[2] = __49__MCDNowPlayingContentManager__addItemsToLibrary__block_invoke_2;
    v30[3] = &unk_133A280;
  ...
  {
    v15 = soft_MCDCarDisplayBundle_1();
    ...
    v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "localizedStringForKey:value:table:", v17, &stru_13E1990, CFSTR("MusicCarDisplayUI")));
    v25 = _NSConcreteStackBlock;
    v26 = 3221225472;
    v27 = __49__MCDNowPlayingContentManager__addItemsToLibrary__block_invoke_3;
    v28 = &unk_133A280;
  ...
  v21 = objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "localizedStringForKey:value:table:", CFSTR("Cancel"), &stru_13E1990, 0));
...
void __49__MCDNowPlayingContentManager__addItemsToLibrary__block_invoke(uint64_t a1)
{
  void *v1;
  id WeakRetained;
...
void __49__MCDNowPlayingContentManager__addItemsToLibrary__block_invoke_2(uint64_t a1)
{
  void *v1;
  id WeakRetained;
...
void __49__MCDNowPlayingContentManager__addItemsToLibrary__block_invoke_3(uint64_t a1)
{
  void *v1;
  id WeakRetained;
...
- (BOOL)_allowsTasteActionsForGenericObject:(id)a3
{
  ...
  v4 = a3;
  if (objc_msgSend(v4, "type") == (char *)&dword_0 + 1)
  {
    ...
    v7 = (int *)objc_msgSend(v6, "type");

    if (v7 == &dword_4 && !objc_msgSend(v5, "isLibraryAddEligible"))
    {
      v8 = 0;
    }
...
- (void)nowPlayingViewControllerMore:(id)a3
{
  ...
  v4 = a3;
  v5 = objc_msgSend(getMCDAlertControllerClass(), "alertControllerWithTitle:message:preferredStyle:", 0, 0, 0);
  v6 = (void *)objc_claimAutoreleasedReturnValue(v5);
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("Go to Album"), &stru_13E1990, 0));
      v54[0] = _NSConcreteStackBlock;
      v54[1] = 3221225472;
      v54[2] = __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke;
      v54[3] = &unk_133A2A8;
  ...
  if (-[MCDNowPlayingContentManager _showAddToLibraryOptions](self, "_showAddToLibraryOptions"))
  {
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Add to Library"), &stru_13E1990, 0));
    v52[0] = _NSConcreteStackBlock;
    v52[1] = 3221225472;
    v52[2] = __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_2;
    v52[3] = &unk_133A280;
  ...
  if (-[MCDNowPlayingContentManager _itemCanCreateRadioStation](self, "_itemCanCreateRadioStation"))
  {
    ...
    v20 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v21 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "localizedStringForKey:value:table:", CFSTR("Create Station"), &stru_13E1990, 0));
    v49[0] = _NSConcreteStackBlock;
    v49[1] = 3221225472;
    v49[2] = __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_3;
    v49[3] = &unk_1338E80;
    v22 = v18;
    v50 = v22;
    v23 = v17;
  ...
  if (v33 == 1)
  {
    ...
    else if ((objc_msgSend(v28, "isFavorite") & 1) == 0)
    {
      if (objc_msgSend(v28, "isDisliked"))
      {
        ...
        v36 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v35, "localizedStringForKey:value:table:", CFSTR("Undo Suggest Less"), &stru_13E1990, 0));
        v48[0] = _NSConcreteStackBlock;
        v48[1] = 3221225472;
        v48[2] = __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_4;
        v48[3] = &unk_1338E80;
        v48[4] = self;
        v48[5] = v28;
      ...
      else
      {
        ...
        v40 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v39, "localizedStringForKey:value:table:", CFSTR("Suggest Less"), &stru_13E1990, 0));
        v47[0] = _NSConcreteStackBlock;
        v47[1] = 3221225472;
        v47[2] = __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_5;
        v47[3] = &unk_1338E80;
        v47[4] = self;
        v47[5] = v28;
  ...
  v43 = objc_claimAutoreleasedReturnValue(objc_msgSend(v42, "localizedStringForKey:value:table:", CFSTR("Cancel"), &stru_13E1990, 0));
...
void __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke(uint64_t a1)
{
  id WeakRetained;
...
void __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_2(uint64_t a1)
{
  id WeakRetained;
...
id __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_3(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "performPlaybackRequestWithCommand:", *(_QWORD *)(a1 + 40));
}

id __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_4(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "performFavoriteChangeRequestFor:action:", *(_QWORD *)(a1 + 40), 1);
}

id __60__MCDNowPlayingContentManager_nowPlayingViewControllerMore___block_invoke_5(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "performFavoriteChangeRequestFor:action:", *(_QWORD *)(a1 + 40), 0);
}
...
- (BOOL)_nowPlayingViewControllerIsFuseSubscriber
{
  ...
  v3 = objc_msgSend(v2, "userSubscriptionState") == (char *)&dword_0 + 2;
...
- (void)nowPlayingViewControllerAttributionButtonTapped:(id)a3
{
  void *v4;
  unsigned int v5;
  _TtC16MusicApplication41MCDSharePlayTogetherSessionViewController *v6;
  void *v7;
  _TtC16MusicApplication41MCDSharePlayTogetherSessionViewController *v8;
  MCDPlaylistTracksTableViewController *v9;
  void *v10;
  _TtC16MusicApplication41MCDSharePlayTogetherSessionViewController *v11;
  ...
  if (v5)
  {
    v6 = [_TtC16MusicApplication41MCDSharePlayTogetherSessionViewController alloc];
...
- (BOOL)currentPlayingSongFoundIn:(id)a3
{
  ...
  v6[1] = 3221225472;
  v6[2] = __57__MCDNowPlayingContentManager_currentPlayingSongFoundIn___block_invoke;
  v6[3] = &unk_133A2D0;
  v6[4] = self;
  v6[5] = &v7;
...
void __57__MCDNowPlayingContentManager_currentPlayingSongFoundIn___block_invoke(uint64_t a1, uint64_t a2, void *a3, _BYTE *a4)
{
  void *v6;
  id v7;
  void *v8;
  ...
  if ((v8 & 1) == 0)
  {
    ...
    if (v3)
    {
      if (v4)
      {
        ...
        v11[0] = _NSConcreteStackBlock;
        v11[1] = 3221225472;
        v11[2] = __88__MCDNowPlayingContentManager_requestAndUpdateLibraryResponseForCurrentPlayingSongAlbum__block_invoke;
        v11[3] = &unk_133A2F8;
...
void __88__MCDNowPlayingContentManager_requestAndUpdateLibraryResponseForCurrentPlayingSongAlbum__block_invoke(id *a1, void *a2)
{
  _QWORD *WeakRetained;
  void *v4;
  void *v5;
...
- (void)performFavoriteChangeRequestFor:(id)a3 action:(int64_t)a4
{
  ...
  v9[1] = 3221225472;
  v9[2] = __70__MCDNowPlayingContentManager_performFavoriteChangeRequestFor_action___block_invoke;
...
void __70__MCDNowPlayingContentManager_performFavoriteChangeRequestFor_action___block_invoke(uint64_t a1, void *a2)
{
  id v3;
  id v4;
  NSObject *v5;
  ...
  if (v3)
  {
    v4 = soft_MCDMusicGeneralLogging_3();
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v9 = 2112;
      v10 = v3;
      _os_log_impl(&dword_0, v5, OS_LOG_TYPE_DEFAULT, "Failed favoriteChangeRequestAction=%ld with error=%@", (uint8_t *)&v7, 0x16u);
    }
...
- (void)updateSharePlayTogetherState
{
  ...
  if (v66)
  {
    ...
    else
    {
      ...
      objc_msgSend(v5, "setTitleTextAttributesTransformer:", &__block_literal_global_18);
    ...
    if ((uint64_t)objc_msgSend(v66, "pendingParticipantsCount") >= 1)
    {
      ...
      v36 = soft_MCDCarDisplayBundle_1();
      v37 = (void *)objc_claimAutoreleasedReturnValue(v36);
      v38 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v37, "localizedStringForKey:value:table:", CFSTR("%ld Pending"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
...
NSMutableDictionary *__cdecl __59__MCDNowPlayingContentManager_updateSharePlayTogetherState__block_invoke(id a1, NSDictionary *a2)
{
  id v2;
  void *v3;
...
- (void)sharePlayTogetherButtonTapped
{
  ...
  v3 = [_TtC16MusicApplication41MCDSharePlayTogetherSessionViewController alloc];
...
- (_TtC16MusicApplication20CarPlayNoContentView)noContentView
{
