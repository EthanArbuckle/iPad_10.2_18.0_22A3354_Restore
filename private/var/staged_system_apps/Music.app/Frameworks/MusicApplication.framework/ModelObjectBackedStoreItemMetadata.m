...
{
  return (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_CCD6C4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithDownloadAssetDictionary_);
}

- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithStorePlatformDictionary:(id)a3
{
  return (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_CCD6C4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithStorePlatformDictionary_);
}
...
- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithStorePlatformDictionary:(id)a3 expirationDate:(id)a4
{
  ...
  if (a4)
  {
    static Date._unconditionallyBridgeFromObjectiveC(_:)(a4, v10);
...
- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithStorePlatformDictionary:(id)a3 parentStoreItemMetadata:(id)a4 expirationDate:(id)a5
{
  ...
  uint64_t v14;
  id v15;
  _TtC9MusicCore34ModelObjectBackedStoreItemMetadata *v16;
  uint64_t v18;

  v8 = __swift_instantiateConcreteTypeFromMangledName(&qword_14FDE40);
  __chkstk_darwin(v8);
  ...
  if (a5)
  {
    static Date._unconditionallyBridgeFromObjectiveC(_:)(a5, v12);
  ...
  v15 = a4;
  v16 = (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_CD54D0(v11, (uint64_t)v15, (uint64_t)v10);
...
{
  return (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_CCD6C4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithStoreMusicAPIDictionary_);
}
...
- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithCoder:(id)a3
{
  ...
  *((_QWORD *)v4 + 1) = 0;
  ...
  result = (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000000010C4100, "MusicCore/ModelObjectBackedStoreItemMetadata.swift", 50, 2, 49, 0);
  __break(1u);
  return result;
}
...
- (NSString)artistName
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.artistName.getter);
}

- (id)artistStoreID
{
  return sub_CD3B4C(self, (uint64_t)a2, (void (*)(_QWORD *__return_ptr))ModelObjectBackedStoreItemMetadata.artistStoreID.getter);
}
...
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.collectionName.getter);
}

- (id)collectionStoreID
{
  return sub_CD3B4C(self, (uint64_t)a2, (void (*)(_QWORD *__return_ptr))ModelObjectBackedStoreItemMetadata.collectionStoreID.getter);
}
...
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.composerName.getter);
}

- (NSString)copyrightText
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.copyrightText.getter);
}

- (NSString)curatorName
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.curatorName.getter);
}

- (NSString)descriptionText
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.descriptionText.getter);
}
...
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.editorNotes.getter);
}

- (NSString)shortEditorNotes
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.shortEditorNotes.getter);
}
...
- (NSString)handle
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.handle.getter);
}
...
- (NSString)itemKind
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.itemKind.getter);
}

- (NSDate)lastModifiedDate
{
  return (NSDate *)sub_CD3300(self, (uint64_t)a2, &qword_14FDE40, (void (*)(void))ModelObjectBackedStoreItemMetadata.lastModifiedDate.getter, (uint64_t (*)(_QWORD))&type metadata accessor for Date, (uint64_t (*)(void))&Date._bridgeToObjectiveC());
}
...
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.movementName.getter);
}
...
- (NSString)name
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.name.getter);
}

- (NSString)nameRaw
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.nameRaw.getter);
}

- (NSDate)releaseDate
{
  return (NSDate *)sub_CD3300(self, (uint64_t)a2, &qword_14FDE40, (void (*)(void))ModelObjectBackedStoreItemMetadata.releaseDate.getter, (uint64_t (*)(_QWORD))&type metadata accessor for Date, (uint64_t (*)(void))&Date._bridgeToObjectiveC());
}

- (id)socialProfileID
{
  return sub_CD3B4C(self, (uint64_t)a2, (void (*)(_QWORD *__return_ptr))ModelObjectBackedStoreItemMetadata.socialProfileID.getter);
}
...
- (NSString)shortName
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.shortName.getter);
}

- (NSURL)shortURL
{
  return (NSURL *)sub_CD3300(self, (uint64_t)a2, &qword_14FAC20, (void (*)(void))ModelObjectBackedStoreItemMetadata.shortURL.getter, (uint64_t (*)(_QWORD))&type metadata accessor for URL, (uint64_t (*)(void))&URL._bridgeToObjectiveC());
}
...
- (NSURL)URL
{
  return (NSURL *)sub_CD3300(self, (uint64_t)a2, &qword_14FAC20, (void (*)(void))ModelObjectBackedStoreItemMetadata.url.getter, (uint64_t (*)(_QWORD))&type metadata accessor for URL, (uint64_t (*)(void))&URL._bridgeToObjectiveC());
}

- (NSString)workName
{
  return (NSString *)sub_CD5168(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.workName.getter);
}
