...
{
  return sub_34A1A8((int)self, (int)a2, (int)a3, a4, (uint64_t)&unk_135AFD0, (uint64_t)sub_34BD80, (uint64_t)&block_descriptor_132);
}
...
- (NSString)shortDescription
{
  ...
  v2 = self;
  v3 = -[MPModelCurator name](v2, "name", 0x22203A656D614ELL);
  if (v3)
  {
    v4 = v3;
