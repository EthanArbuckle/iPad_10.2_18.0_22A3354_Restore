...
- (void)viewDidLoad
{
  ...
  objc_msgSend(v3, "setTableCellConfigurationBlock:", &__block_literal_global_5);

}

void __38__MCDGenresViewController_viewDidLoad__block_invoke(id a1, UITableViewCell *a2, MPModelObject *a3, MPModelObject *a4, UITableView *a5, NSIndexPath *a6)
{
  MPModelObject *v8;
  UITableViewCell *v9;
  void *v10;
...
- (id)textForHeaderViewInContentManager:(id)a3
{
  ...
  {
    v4 = soft_MCDCarDisplayBundle();
    v5 = (void *)objc_claimAutoreleasedReturnValue(v4);
    v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("RECENTLY_ADDED_GENRES"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
...
- (id)contentManager:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (!a4 && v5)
  {
    v7 = soft_MCDCarDisplayBundle();
    v8 = (void *)objc_claimAutoreleasedReturnValue(v7);
    v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("RECENTLY_ADDED_GENRES"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
