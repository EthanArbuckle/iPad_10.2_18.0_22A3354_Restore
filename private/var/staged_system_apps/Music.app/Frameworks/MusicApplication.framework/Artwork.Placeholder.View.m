...
- (_TtCVV11MusicCoreUI7Artwork11Placeholder4View)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, "init");
  ...
  result = (_TtCVV11MusicCoreUI7Artwork11Placeholder4View *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000000010C4100, "MusicCoreUI/ArtworkPlaceholder.swift", 36, 2, 100, 0);
  __break(1u);
  return result;
}
