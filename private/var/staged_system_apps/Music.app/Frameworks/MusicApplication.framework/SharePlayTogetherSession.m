...
- (void).cxx_destruct
{
  ...
  v4 = __swift_instantiateConcreteTypeFromMangledName(&qword_1502DD8);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v4 - 8) + 8))(v3, v4);
  v5 = (char *)self + OBJC_IVAR____TtC9MusicCore24SharePlayTogetherSession__participants;
  v6 = __swift_instantiateConcreteTypeFromMangledName(&qword_1502DF8);
  (*(void (**)(char *, uint64_t))(*(_QWORD *)(v6 - 8) + 8))(v5, v6);
  v7 = (char *)self + OBJC_IVAR____TtC9MusicCore24SharePlayTogetherSession__connectedParticipantsCount;
  v8 = __swift_instantiateConcreteTypeFromMangledName((uint64_t *)&unk_1502E10);
...
- (void)groupSessionDidConnect:(id)a3
{
  ...
  v12 = (_QWORD *)swift_allocObject(&unk_13BBE68, 48, 7);
  v12[2] = v11;
  v12[3] = &protocol witness table for MainActor;
  v12[4] = a3;
  v12[5] = v9;
  sub_C51ED8((uint64_t)v7, (uint64_t)&unk_1503028, (uint64_t)v12);
...
- (void)groupSession:(id)a3 didInvalidateWithError:(id)a4
{
  ...
  v17 = (_QWORD *)swift_allocObject(&unk_13BBE40, 48, 7);
  v17[2] = v16;
  v17[3] = &protocol witness table for MainActor;
  v17[4] = v13;
  v17[5] = v14;
  sub_C51ED8((uint64_t)v9, (uint64_t)&unk_1503020, (uint64_t)v17);
  swift_unknownObjectRelease(a3);
...
{
  sub_D3B3D4(self, (uint64_t)a2, (uint64_t)a3, (uint64_t)a4, "session:didUpdateParticipants", (uint64_t)&unk_13BBFA8, (uint64_t)&unk_15030E0);
}

- (void)groupSession:(id)a3 didUpdatePendingParticipants:(id)a4
{
  sub_D3B3D4(self, (uint64_t)a2, (uint64_t)a3, (uint64_t)a4, "session:didUpdatePendingParticipants:", (uint64_t)&unk_13BBF80, (uint64_t)&unk_15030D0);
}

- (void)groupSession:(id)a3 didUpdateMembers:(id)a4
{
  sub_D3B3D4(self, (uint64_t)a2, (uint64_t)a3, (uint64_t)a4, "session:didUpdateMembers:", (uint64_t)&unk_13BBF58, (uint64_t)&unk_15030C0);
}
