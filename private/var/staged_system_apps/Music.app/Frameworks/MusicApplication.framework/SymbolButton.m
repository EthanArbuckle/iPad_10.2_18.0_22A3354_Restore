...
- (void)tintColorDidChange
{
  ...
  sub_5BDB8(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_EDBC34((uint64_t)v4);
...
- (BOOL)isHighlighted
{
  return sub_EDA594(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_EDA594(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_EDA594(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
{
  sub_2EA80C((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.SymbolButton", 24);
}

- (void).cxx_destruct
{
  swift_bridgeObjectRelease();
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider]);
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler]);
  sub_5C0DC((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu]);
  ...
  sub_56024((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_150EC30);
}
