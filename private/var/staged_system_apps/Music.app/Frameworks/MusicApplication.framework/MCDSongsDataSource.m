...
- (id)itemSortDescriptors
{
  ...
  {
    MCDSortByRecentlyPlayed_0 = getMCDSortByRecentlyPlayed_0();
    v5 = objc_claimAutoreleasedReturnValue(MCDSortByRecentlyPlayed_0);
  ...
  v25 = &v24;
  v26 = 0x2020000000;
  v6 = (_QWORD *)getMCDSortByRecentlyAddedSymbolLoc_ptr_0;
  v27 = getMCDSortByRecentlyAddedSymbolLoc_ptr_0;
  if (!getMCDSortByRecentlyAddedSymbolLoc_ptr_0)
  {
    v7 = (void *)MusicCarDisplayUILibrary_9();
    v6 = dlsym(v7, "MCDSortByRecentlyAdded");
    v25[3] = (uint64_t)v6;
    getMCDSortByRecentlyAddedSymbolLoc_ptr_0 = (uint64_t)v6;
  }
  ...
  {
    v10 = getMCDSortByRecentlyPlayed_0();
...
LABEL_18:
    ...
    v25 = &v24;
    v26 = 0x2020000000;
    v15 = (_QWORD *)getMCDSortByArtistSymbolLoc_ptr_0;
    v27 = getMCDSortByArtistSymbolLoc_ptr_0;
    if (!getMCDSortByArtistSymbolLoc_ptr_0)
    {
      v16 = (void *)MusicCarDisplayUILibrary_9();
      v15 = dlsym(v16, "MCDSortByArtist");
      v25[3] = (uint64_t)v15;
      getMCDSortByArtistSymbolLoc_ptr_0 = (uint64_t)v15;
    }
    _Block_object_dispose(&v24, 8);
    if (v15)
    {
