...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  else
  {
    ...
    v15 = v7[24];
    v16 = self;
    sub_DC0024(width, height, v14, v8);
    v10 = v17;
    sub_DC0024(width, height, v13, v15);
    v12 = v18;
...
- (void).cxx_destruct
{
  sub_5C0DC((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_typedConfiguration, type metadata accessor for Artwork);
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_imageDidChangeHandler), *(_QWORD *)&self->imageDidChangeHandler[OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_imageDidChangeHandler]);
