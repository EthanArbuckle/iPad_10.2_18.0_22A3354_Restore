...
- (void)layoutSubviews
{
  ...
  v3 = soft_MCDCarDisplayBundle_2();
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("SIRI_ACTION_CELL_TITLE"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
