...
- (void)layoutSubviews
{
  ...
  v45.receiver = self;
  v45.super_class = (Class)MCDAlertButtonView;
  -[MCDAlertButtonView layoutSubviews](&v45, "layoutSubviews");
  ...
  v47.origin.y = 0.0;
  v47.size.width = 24.0;
  v47.size.height = 24.0;
  v15 = CGRectGetWidth(v47);
  v16 = UIRectCenteredYInRectScale(Width - v15 + -20.0, 0.0, 24.0, 24.0, v4, v6, v8, v10, v13);
  v20 = MPURectByApplyingUserInterfaceLayoutDirectionInRect(v16, v17, v18, v19, v4, v6, v8, v10);
  v43 = v21;
  v44 = v20;
  v23 = v22;
  v42 = v24;
  v25 = v8 - (v22 + 20.0);
  v26 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlertButtonView label](self, "label"));
  objc_msgSend(v26, "sizeThatFits:", v25, v10);
  v28 = v27;

  v29 = UIRectCenteredYInRectScale(20.0, 0.0, v25 + -20.0, v28, v4, v6, v8, v10, v13);
  v33 = MPURectByApplyingUserInterfaceLayoutDirectionInRect(v29, v30, v31, v32, v4, v6, v8, v10);
  v35 = v34;
  v37 = v36;
  v39 = v38;
  v40 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlertButtonView imageView](self, "imageView"));
  objc_msgSend(v40, "setFrame:", v44, v43, v23, v42);

  v41 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlertButtonView label](self, "label"));
