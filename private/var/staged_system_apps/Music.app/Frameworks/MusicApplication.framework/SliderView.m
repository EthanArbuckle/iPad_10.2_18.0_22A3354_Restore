...
{
  return (_TtC11MusicCoreUI10SliderView *)sub_ECFF08(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void).cxx_destruct
{
  ...
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI10SliderView_valueChangedHandler), *(_QWORD *)&self->stackView[OBJC_IVAR____TtC11MusicCoreUI10SliderView_valueChangedHandler]);
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI10SliderView_cancelledHandler), *(_QWORD *)&self->stackView[OBJC_IVAR____TtC11MusicCoreUI10SliderView_cancelledHandler]);
}
