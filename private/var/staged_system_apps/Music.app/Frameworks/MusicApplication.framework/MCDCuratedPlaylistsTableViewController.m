...
- (void)viewDidLoad
{
  ...
  *((_QWORD *)&buf + 1) = &buf;
  v19 = 0x2020000000;
  v10 = getMCDMusicGeneralLoggingSymbolLoc_ptr_0;
  v20 = getMCDMusicGeneralLoggingSymbolLoc_ptr_0;
  if (!getMCDMusicGeneralLoggingSymbolLoc_ptr_0)
  {
    v11 = (void *)MusicCarDisplayUILibrary_1();
    v10 = dlsym(v11, "MCDMusicGeneralLogging");
    *(_QWORD *)(*((_QWORD *)&buf + 1) + 24) = v10;
    getMCDMusicGeneralLoggingSymbolLoc_ptr_0 = v10;
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_QWORD *)((char *)&buf + 4) = v14;
    _os_log_impl(&dword_0, v13, OS_LOG_TYPE_DEFAULT, "Loading content item view, title: %@", (uint8_t *)&buf, 0xCu);

  }
  v16[0] = _NSConcreteStackBlock;
  v16[1] = 3221225472;
  v16[2] = __53__MCDCuratedPlaylistsTableViewController_viewDidLoad__block_invoke;
  v16[3] = &unk_13391D0;
  v16[4] = self;
...
void __53__MCDCuratedPlaylistsTableViewController_viewDidLoad__block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4, void *a5)
{
  id v8;
  id v9;
  uint64_t v10;
  ...
  {
    v11 = objc_msgSend(*(id *)(a1 + 32), "_contentItemIsPlaying:", v8);
    v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "window"));
    v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "screen"));
    objc_msgSend(v13, "scale");
    objc_msgSend(v14, "configureWithPlaylist:currentlyPlaying:artworkScale:showCurator:", v8, v11, 1);
