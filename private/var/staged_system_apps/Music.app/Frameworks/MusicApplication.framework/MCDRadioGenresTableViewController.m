...
- (void)viewDidLoad
{
  ...
  v12 = &v11;
  v13 = 0x2020000000;
  v3 = (uint64_t (*)(void))getMCDCarDisplayBundleSymbolLoc_ptr_11;
  v14 = getMCDCarDisplayBundleSymbolLoc_ptr_11;
  if (!getMCDCarDisplayBundleSymbolLoc_ptr_11)
  {
    v10[0] = _NSConcreteStackBlock;
    v10[1] = 3221225472;
    v10[2] = __getMCDCarDisplayBundleSymbolLoc_block_invoke_6;
    v10[3] = &unk_1339000;
    v10[4] = &v11;
    __getMCDCarDisplayBundleSymbolLoc_block_invoke_6((uint64_t)v10);
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("All Genres"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
  ...
  objc_msgSend(v7, "setTableCellConfigurationBlock:", &__block_literal_global_15);

}

void __48__MCDRadioGenresTableViewController_viewDidLoad__block_invoke(id a1, UITableViewCell *a2, MPModelObject *a3, MPModelObject *a4, UITableView *a5, NSIndexPath *a6)
{
  UITableViewCell *v7;
  void *v8;
  void *v9;
