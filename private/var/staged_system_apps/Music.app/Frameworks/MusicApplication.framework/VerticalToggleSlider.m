...
- (CGSize)intrinsicContentSize
{
  ...
  if (*((_BYTE *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_mode) == 2)
  {
    ...
    v4 = self;
    if (v3 != -1)
      swift_once(&qword_1506490, sub_EF3020);
    v5 = &xmmword_150ED88;
  }
  else
  {
    ...
    v7 = self;
    if (v6 != -1)
      swift_once(&qword_1506498, sub_EF3038);
    v5 = &xmmword_150ED98;
  }
  v8 = *(double *)v5;
  v9 = *((double *)v5 + 1);
...
- (BOOL)isEnabled
{
  return sub_EF20E8(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}

- (void)setEnabled:(BOOL)a3
{
  sub_EF2184(self, (uint64_t)a2, a3, (const char **)&selRef_isEnabled, (SEL *)&selRef_setEnabled_, (void (*)(id))sub_EEFCD8);
}
...
- (BOOL)isHighlighted
{
  return sub_EF20E8(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}

- (void)setHighlighted:(BOOL)a3
{
  sub_EF2184(self, (uint64_t)a2, a3, (const char **)&selRef_isHighlighted, (SEL *)&selRef_setHighlighted_, (void (*)(id))sub_EF22A8);
}
...
- (void).cxx_destruct
{
  ...
  sub_2A473C(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_packageDefinition), *((_QWORD *)v3 + 1), *((void **)v3 + 2), *((_QWORD *)v3 + 3), *((_QWORD *)v3 + 4), *((_QWORD *)v3 + 5), *((_QWORD *)v3 + 6), *((_QWORD *)v3 + 7), *((_QWORD *)v3 + 8), *((_QWORD *)v3 + 9));
