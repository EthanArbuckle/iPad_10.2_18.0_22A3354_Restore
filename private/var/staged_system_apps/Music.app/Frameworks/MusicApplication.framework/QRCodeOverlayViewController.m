...
- (void).cxx_destruct
{
  ...
  sub_50C60(*(_QWORD *)&self->backgroundView[OBJC_IVAR____TtC11MusicCoreUI27QRCodeOverlayViewController_qrCode], *(_QWORD *)&self->qrCodeView[OBJC_IVAR____TtC11MusicCoreUI27QRCodeOverlayViewController_qrCode]);
