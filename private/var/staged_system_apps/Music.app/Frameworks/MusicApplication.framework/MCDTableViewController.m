...
- (void)setLimitedUI:(BOOL)a3
{
  ...
  if (v6)
  {
    ...
    v14[1] = 3221225472;
    v14[2] = __39__MCDTableViewController_setLimitedUI___block_invoke;
    v14[3] = &unk_1338FD8;
    v15 = v6;
    v12[0] = _NSConcreteStackBlock;
    v12[1] = 3221225472;
    v12[2] = __39__MCDTableViewController_setLimitedUI___block_invoke_2;
    v12[3] = &unk_13394B0;
    v13 = v15;
...
id __39__MCDTableViewController_setLimitedUI___block_invoke(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "setAlpha:", 0.0);
}

id __39__MCDTableViewController_setLimitedUI___block_invoke_2(uint64_t a1)
{
...
+ (void)addLeadingView:(id)a3 toCell:(id)a4
{
  ...
  {
    objc_msgSend(v25, "sizeForArtwork");
    v8 = v7;
  }
  else
  {
  ...
  v14 = v13;
  v16 = v15;
  objc_msgSend(v25, "addSubview:", v5);
  objc_msgSend(v25, "setSeparatorInset:", 0.0, v8 + 4.0 + 8.0, 0.0, 0.0);
  v26.origin.x = v10;
  v26.origin.y = v12;
  v26.size.width = v14;
  v26.size.height = v16;
  v17 = (v8 - CGRectGetWidth(v26)) * 0.5 + 4.0;
  objc_msgSend(v25, "frame");
  v18 = CGRectGetHeight(v27) * 0.5 - v16 * 0.5;
  ...
  v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "contentView"));
  objc_msgSend(v20, "frame");
  objc_msgSend(v5, "setFrame:", MPURectByApplyingUserInterfaceLayoutDirectionInRect(v17, v18, v14, v16, v21, v22, v23, v24));
...
+ (id)addAlbumArtViewWithImage:(id)a3 radiusKind:(unint64_t)a4 toCell:(id)a5
{
  ...
  if (v7 && v8)
  {
    ...
    if (objc_msgSend(v7, "renderingMode") == (char *)&dword_0 + 2)
    {
...
LABEL_13:
        ...
        objc_msgSend(v10, "setFrame:", MPURectByApplyingUserInterfaceLayoutDirectionInRect(4.0, 4.0, v14, v14, v19, v20, v21, v22));
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (!self->_nowPlayingButton)
  {
    ...
    v23 = &v22;
    v24 = 0x2020000000;
    v9 = (id *)getMCDMusicBundleIdentifierSymbolLoc_ptr_1;
    v25 = (void *)getMCDMusicBundleIdentifierSymbolLoc_ptr_1;
    if (!getMCDMusicBundleIdentifierSymbolLoc_ptr_1)
    {
      v10 = (void *)MusicCarDisplayUILibrary_6();
      v9 = (id *)dlsym(v10, "MCDMusicBundleIdentifier");
      v23[3] = (uint64_t)v9;
      getMCDMusicBundleIdentifierSymbolLoc_ptr_1 = (uint64_t)v9;
    }
    ...
    if (v9)
    {
      ...
      v23 = &v22;
      v24 = 0x2020000000;
      v13 = getMCDGetNowPlayingButtonSymbolLoc_ptr;
      v25 = getMCDGetNowPlayingButtonSymbolLoc_ptr;
      if (!getMCDGetNowPlayingButtonSymbolLoc_ptr)
      {
        v14 = (void *)MusicCarDisplayUILibrary_6();
        v13 = dlsym(v14, "MCDGetNowPlayingButton");
        v23[3] = (uint64_t)v13;
        getMCDGetNowPlayingButtonSymbolLoc_ptr = v13;
      }
      _Block_object_dispose(&v22, 8);
      if (v13)
      {
    ...
    v20 = (_Unwind_Exception *)soft_MCDMusicGeneralLogging_cold_1();
    _Block_object_dispose(&v22, 8);
    _Unwind_Resume(v20);
  }
LABEL_12:
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  if (v5 && objc_msgSend(v5, "initiallyInteractive"))
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __40__MCDTableViewController_viewDidAppear___block_invoke;
    v8[3] = &unk_13394D8;
    v8[4] = self;
    v9 = v3;
  ...
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(-[MCDTableViewController tableView](self, "tableView"));
    soft_MCDClearTableViewSelection(v7, v3);
...
void __40__MCDTableViewController_viewDidAppear___block_invoke(uint64_t a1, void *a2)
{
  id v3;
  ...
  if ((objc_msgSend(a2, "isCancelled") & 1) == 0)
  {
    ...
    soft_MCDClearTableViewSelection(v3, *(unsigned __int8 *)(a1 + 40));
...
- (void)_nowPlayingDidChangeNotification:(id)a3
{
  ...
  v3[1] = 3221225472;
  v3[2] = __59__MCDTableViewController__nowPlayingDidChangeNotification___block_invoke;
  v3[3] = &unk_13394B0;
  v3[4] = self;
...
id *__59__MCDTableViewController__nowPlayingDidChangeNotification___block_invoke(id *result, char a2)
{
  if ((a2 & 1) == 0)
    return (id *)objc_msgSend(result[4], "_itemDidChange");
  return result;
}
