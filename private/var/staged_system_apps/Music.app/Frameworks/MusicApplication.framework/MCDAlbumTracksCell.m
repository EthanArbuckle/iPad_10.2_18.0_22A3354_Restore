...
- (MCDAlbumTracksCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  void *v24;
  _TtC16MusicApplication30CarPlayNowPlayingIndicatorView *v25;
  ...
  if (v4)
  {
    ...
    v25 = objc_alloc_init(_TtC16MusicApplication30CarPlayNowPlayingIndicatorView);
    ...
    v29 = (void *)objc_claimAutoreleasedReturnValue(MCDPlaybackStateChangedNotification);
...
- (void)configureWithAlbumTrack:(id)a3 currentlyPlaying:(BOOL)a4 album:(id)a5 contentAvailable:(BOOL)a6
{
  ...
  if (!v13)
  {
    v15 = soft_MCDCarDisplayBundle_2();
    v6 = (void *)objc_claimAutoreleasedReturnValue(v15);
    v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("Unknown Title"), &stru_13E1990, CFSTR("MusicCarDisplayUI")));
  }
  ...
  if (objc_msgSend(v11, "trackNumber"))
  {
    ...
    v24 = &v23;
    v25 = 0x2020000000;
    v18 = getMCDFormattedNumberStringSymbolLoc_ptr;
    v26 = getMCDFormattedNumberStringSymbolLoc_ptr;
    if (!getMCDFormattedNumberStringSymbolLoc_ptr)
    {
      v19 = (void *)MusicCarDisplayUILibrary_18();
      v18 = dlsym(v19, "MCDFormattedNumberString");
      v24[3] = (uint64_t)v18;
      getMCDFormattedNumberStringSymbolLoc_ptr = v18;
    }
    _Block_object_dispose(&v23, 8);
    if (!v18)
    {
      v22 = (_Unwind_Exception *)soft_MCDMusicGeneralLogging_cold_1();
      _Block_object_dispose(&v23, 8);
      _Unwind_Resume(v22);
    }
...
- (void)setHighlighted:(BOOL)a3 animated:(BOOL)a4
{
  ...
  v8 = v7;
  v9 = objc_opt_class(_TtC16MusicApplication30CarPlayNowPlayingIndicatorView);
...
- (void)layoutSubviews
{
  ...
  v3 = -[MCDAlbumTracksCell isContentUnavailable](self, "isContentUnavailable");
  if (v3)
  {
    ContentDisabledAlpha = UIInterfaceGetContentDisabledAlpha(v3, v4);
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlbumTracksCell contentView](self, "contentView"));
    v7 = v6;
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlbumTracksCell contentView](self, "contentView"));
  ...
  v18 = -[MCDAlbumTracksCell isCurrentlyPlaying](self, "isCurrentlyPlaying");
  -[UIView setHidden:](self->_currentlyPlayingView, "setHidden:", v18 ^ 1);
  -[UILabel setHidden:](self->_trackNumberLabel, "setHidden:", v18);
  y = CGRectZero.origin.y;
  v20 = (void *)objc_claimAutoreleasedReturnValue(-[UILabel font](self->_trackNumberLabel, "font"));
  objc_msgSend(v20, "lineHeight");
  v22 = v21;
  v71 = v21;

  v23 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlbumTracksCell textLabel](self, "textLabel"));
  v24 = objc_msgSend(v23, "frame");
  v70 = v11;
  v25 = v13;
  MPURectByRemovingUserInterfaceLayoutDirectionInRect(v24, v26, v27, v28, v29, v11, v13, v15, v17);

  v73.origin.x = 12.0;
  v73.size.width = 21.0;
  v73.origin.y = y;
  v73.size.height = v22;
  v30 = CGRectGetMaxX(v73) + 12.0;
  v31 = floorf(v30);
  v32 = v15;
  v33 = v15 - (v31 + 12.0);
  v34 = floorf(v33);
  v35 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlbumTracksCell textLabel](self, "textLabel"));
  v36 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v35, "font"));
  ...
  v41 = v11;
  v42 = v32;
  v43 = MPURectByApplyingUserInterfaceLayoutDirectionInRect(v31, v40, v34, v38, v41, v25, v32, v17);
  v45 = v44;
  v47 = v46;
  v49 = v48;
  ...
  v51 = (void *)objc_claimAutoreleasedReturnValue(-[MCDAlbumTracksCell textLabel](self, "textLabel"));
  v52 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v51, "font"));
  objc_msgSend(v52, "ascender");
  v54 = v53 + v40;

  v55 = (void *)objc_claimAutoreleasedReturnValue(-[UILabel font](self->_trackNumberLabel, "font"));
  objc_msgSend(v55, "ascender");
  *(float *)&v56 = v54 - v56;
  v57 = floorf(*(float *)&v56);

  -[UILabel setFrame:](self->_trackNumberLabel, "setFrame:", MPURectByApplyingUserInterfaceLayoutDirectionInRect(12.0, v57, 21.0, v71, v70, v25, v42, v17));
