...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  CGFloat x;
  id v8;
  _TtC16MusicApplication35NowPlayingTransportControlStackView *v9;
  ...
  v8 = a4;
  v9 = self;
  LOBYTE(v4) = sub_2A2F88(v4, x, y);

  return v4 & 1;
}

- (_TtC16MusicApplication35NowPlayingTransportControlStackView)initWithFrame:(CGRect)a3
{
  double height;
  double width;
  double y;
  ...
  *((_BYTE *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC16MusicApplication35NowPlayingTransportControlStackView_useBoundsAsPointInside) = 0;
  v8.receiver = self;
...
- (_TtC16MusicApplication35NowPlayingTransportControlStackView)initWithCoder:(id)a3
{
  objc_super v5;
