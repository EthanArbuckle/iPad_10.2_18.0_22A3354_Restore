...
+ (id)requiredPlaylistEntryPropertiesForModelClass:(Class)a3
{
  ...
  if ((Class)objc_opt_class(MPModelSong) == a3)
  {
    v10 = objc_msgSend((id)objc_opt_class(a1), "requiredPropertiesForSongs");
    v11 = (void *)objc_claimAutoreleasedReturnValue(v10);
    v12 = objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "propertySetByCombiningWithPropertySet:", v11));
...
{
  return objc_msgSend((id)objc_opt_class(self), "requiredPropertiesForSongs");
}
