...
- (void)shareGestureHandler:(id)a3
{
  ...
  v5 = self;
  if (-[SyncedLyricsViewController state](v4, "state") == (char *)&dword_0 + 1
...
- (void).cxx_destruct
{
  ...
  sub_64880((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate);
  swift_release();
  sub_56024((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_15085C0);
  sub_5C198(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler), *(_QWORD *)&self->isPlayingSpatial[OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler]);
