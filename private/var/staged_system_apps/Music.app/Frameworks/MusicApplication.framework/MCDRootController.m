...
- (void)showNowPlaying:(BOOL)a3
{
  ...
  v11 = &v10;
  v12 = 0x2020000000;
  v5 = (uint64_t (*)(void))getMCDMusicGeneralLoggingSymbolLoc_ptr_7;
  v13 = getMCDMusicGeneralLoggingSymbolLoc_ptr_7;
  if (!getMCDMusicGeneralLoggingSymbolLoc_ptr_7)
  {
    v9[0] = _NSConcreteStackBlock;
    v9[1] = 3221225472;
    v9[2] = __getMCDMusicGeneralLoggingSymbolLoc_block_invoke_1;
    v9[3] = &unk_1339000;
    v9[4] = &v10;
    __getMCDMusicGeneralLoggingSymbolLoc_block_invoke_1((uint64_t)v9);
  ...
  {
    LOWORD(v9[0]) = 0;
    _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEFAULT, "Launching to Now Playing", (uint8_t *)v9, 2u);
  }
