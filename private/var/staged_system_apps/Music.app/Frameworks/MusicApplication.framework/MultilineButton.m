...
{
  return (_TtC16MusicApplication15MultilineButton *)sub_9B2AF0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (BOOL)isEnabled
{
  return sub_9B34B8(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}

- (void)setEnabled:(BOOL)a3
{
  _TtC16MusicApplication15MultilineButton *v4;

  v4 = self;
  sub_9B3544(a3, (SEL *)&selRef_isEnabled, (SEL *)&selRef_setEnabled_);

}

- (BOOL)isHighlighted
{
  return sub_9B34B8(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_9B34B8(self, (uint64_t)a2, (SEL *)&selRef_isSelected);
}
...
- (void)setSelected:(BOOL)a3
{
  ...
  v4 = self;
  sub_9B3544(a3, (SEL *)&selRef_isSelected, (SEL *)&selRef_setSelected_);

}

- (void)layoutSubviews
{
  _TtC16MusicApplication15MultilineButton *v2;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  double height;
  double width;
  _TtC16MusicApplication15MultilineButton *v5;
  double v6;
  double v7;
  double v8;
  double v9;
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  double x;
  id v7;
  _TtC16MusicApplication15MultilineButton *v8;
  unsigned __int8 v9;
...
- (void)setAccessibilityLabel:(id)a3
{
  _TtC16MusicApplication15MultilineButton *v4;
  NSString v5;
  _TtC16MusicApplication15MultilineButton *v6;
  objc_super v7;
  ...
  -[MultilineButton setAccessibilityLabel:](&v7, "setAccessibilityLabel:", v5);
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC16MusicApplication15MultilineButton_lineComponents));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
  ...
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC16MusicApplication15MultilineButton_backgroundImagesForStates));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
