...
{
  return CFSTR("MusicModelRelationshipTVShowEpisodeDetailItemContentItem");
}

+ (id)__headlineText_KEY
{
  return CFSTR("MusicModelPropertyTVShowEpisodeDetailItemHeadlineText");
}

+ (id)__titleText_KEY
{
  return CFSTR("MusicModelPropertyTVShowEpisodeDetailItemTitleText");
}

+ (id)__showNameText_KEY
{
  return CFSTR("MusicModelPropertyTVShowEpisodeDetailItemShowNameText");
}

+ (id)__descriptionText_KEY
{
  return CFSTR("MusicModelPropertyTVShowEpisodeDetailItemDescriptionText");
}

+ (id)__episodeInformationItems_KEY
{
  return CFSTR("MusicModelPropertyTVShowEpisodeDetailItemEpisodeInformationItems");
}

+ (id)__backgroundArtworkCatalogBlock_KEY
{
  return CFSTR("MusicModelPropertyTVShowEpisodeDetailItemBackgroundArtwork");
}
...
- (id)backgroundArtworkCatalog
{
  ...
  v3 = objc_claimAutoreleasedReturnValue(-[MusicModelTVShowEpisodeDetailItem backgroundArtworkCatalogBlock](self, "backgroundArtworkCatalogBlock"));
  v4 = (void *)v3;
  if (v3)
  {
    v5 = (*(uint64_t (**)(uint64_t, MusicModelTVShowEpisodeDetailItem *))(v3 + 16))(v3, self);
...
+ (id)requiredStoreLibraryPersonalizationProperties
{
  ...
  if (v2)
  {
    ...
    v7 = CFSTR("MusicModelRelationshipTVShowEpisodeDetailItemContentItem");
    v8 = v2;
...
- (id)personalizationScopedPropertiesForProperties:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MusicModelTVShowEpisodeDetailItem contentItem](self, "contentItem"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "relationships"));

  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "objectForKey:", CFSTR("MusicModelRelationshipTVShowEpisodeDetailItemContentItem")));
  v8 = v7;
  if (!v7)
...
- (id)relativeModelObjectForStoreLibraryPersonalization
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[MusicModelTVShowEpisodeDetailItem contentItem](self, "contentItem"));
...
- (id)objectWithStoreLibraryPersonalizationRelativeModelObject:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MusicModelTVShowEpisodeDetailItem identifiers](self, "identifiers"));
  ...
  v10 = v4;
  v6 = v4;
  v7 = -[MusicModelTVShowEpisodeDetailItem copyWithIdentifiers:block:](self, "copyWithIdentifiers:block:", v5, v9);
...
{
  id v4;
  MusicModelTVShowEpisodeDetailItem *v5;
  id v6;

  v4 = a3;
  v5 = self;
  v6 = sub_5CCEA4(v4, MusicModelRelationshipTVShowEpisodeDetailItemContentItem);
