...
- (BOOL)isHidden
{
  return sub_EDA594(self, (uint64_t)a2, (uint64_t (*)(_QWORD))type metadata accessor for SymbolButton.BadgeView, (SEL *)&selRef_isHidden);
}
...
{
  sub_2EA80C((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.BadgeView", 21);
}
