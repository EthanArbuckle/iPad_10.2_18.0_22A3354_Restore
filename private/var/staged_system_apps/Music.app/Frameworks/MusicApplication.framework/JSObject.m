...
- (void)dealloc
{
  ...
  else
  {
    ...
    v5 = self;
    if (v4 != -1)
      swift_once(&qword_150F488, sub_F0555C);
    ...
    sub_10F850();
    v9 = (_QWORD *)swift_allocObject(&unk_13D93B0, 40, 7);
    v9[2] = v6;
    v9[3] = v8;
    v9[4] = v7;
    swift_bridgeObjectRetain_n(v7, 2);
    v10 = v6;
    static OS_dispatch_queue.asyncOnMainIfNeeded(_:)(sub_F4C5CC, (uint64_t)v9);
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = JSObject.isEqual(_:)((uint64_t)v10);

  sub_18DF2C((uint64_t)v10);
  return v8 & 1;
}
