...
- (BOOL)itemIsPlayable:(id)a3
{
  ...
  {
LABEL_8:
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[ModelPlayabilityController shared](_TtC16MusicApplication26ModelPlayabilityController, "shared"));
    v10 = objc_msgSend(v11, "calculatePlayabilityStatusWithModel:", v4) == 0;
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  v11 = (char *)objc_msgSend(v10, "numberOfItemsInSection:", a4);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  if (-[_MCDContentManager showSiriCellInLimitedUI](self, "showSiriCellInLimitedUI")
    ...
    && objc_msgSend(v7, "row") == (char *)&dword_8 + 3)
  {
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
    ...
    && objc_msgSend(v7, "row") == (char *)&dword_8 + 3)
  {
    ...
    v31 = &v30;
    v32 = 0x2020000000;
    v10 = (_QWORD *)getMCDMusicBundleIdentifierSymbolLoc_ptr_4;
    v33 = getMCDMusicBundleIdentifierSymbolLoc_ptr_4;
    if (!getMCDMusicBundleIdentifierSymbolLoc_ptr_4)
    {
      v11 = (void *)MusicCarDisplayUILibrary_20();
      v10 = dlsym(v11, "MCDMusicBundleIdentifier");
      v31[3] = (uint64_t)v10;
      getMCDMusicBundleIdentifierSymbolLoc_ptr_4 = (uint64_t)v10;
    }
    _Block_object_dispose(&v30, 8);
    if (!v10)
    {
      v29 = (_Unwind_Exception *)soft_MCDMusicGeneralLogging_cold_1();
      _Block_object_dispose(&v30, 8);
      _Unwind_Resume(v29);
    }
    ...
    objc_msgSend(v13, "activateWithContext:completion:", v12, &__block_literal_global_20);
    goto LABEL_18;
  }
  if (-[_MCDContentManager showShuffleAll](self, "showShuffleAll") && !objc_msgSend(v7, "section"))
  {
...
- (void)tableView:(id)a3 willDisplayHeaderView:(id)a4 forSection:(int64_t)a5
{
     ...
     || -[_MCDContentManager showLocalContent](self, "showLocalContent")))
  {
    ...
    if ((objc_opt_isKindOfClass(v8, v11) & 1) != 0)
    {
      ...
      v19 = &v18;
      v20 = 0x2020000000;
      v13 = getMCDSetupTableHeaderViewSymbolLoc_ptr_0;
      v21 = getMCDSetupTableHeaderViewSymbolLoc_ptr_0;
      if (!getMCDSetupTableHeaderViewSymbolLoc_ptr_0)
      {
        v14 = (void *)MusicCarDisplayUILibrary_20();
        v13 = dlsym(v14, "MCDSetupTableHeaderView");
        v19[3] = (uint64_t)v13;
        getMCDSetupTableHeaderViewSymbolLoc_ptr_0 = v13;
      }
      _Block_object_dispose(&v18, 8);
      if (!v13)
      {
        v17 = (_Unwind_Exception *)soft_MCDMusicGeneralLogging_cold_1();
        _Block_object_dispose(&v18, 8);
        _Unwind_Resume(v17);
      }
      ((void (*)(id))v13)(v12);
...
- (void)_initiatePlaybackForItem:(id)a3 shuffled:(BOOL)a4
{
  ...
  if ((objc_opt_isKindOfClass(v6, v7) & 1) != 0)
  {
    ...
    v29 = &v28;
    v30 = 0x2020000000;
    v9 = getMCDMPModelObjectForGenericObjectSymbolLoc_ptr;
    v31 = getMCDMPModelObjectForGenericObjectSymbolLoc_ptr;
    if (!getMCDMPModelObjectForGenericObjectSymbolLoc_ptr)
    {
      v10 = (void *)MusicCarDisplayUILibrary_20();
      v9 = dlsym(v10, "MCDMPModelObjectForGenericObject");
      v29[3] = (uint64_t)v9;
      getMCDMPModelObjectForGenericObjectSymbolLoc_ptr = v9;
    }
...
- (id)_textForHeaderView
{
  ...
  if ((objc_opt_respondsToSelector(v3, "textForHeaderViewInContentManager:") & 1) != 0)
  {
    ...
    v5 = (char *)objc_msgSend(v4, "numberOfSections");
...
- (void)_performRequest
{
  ...
  v7 = soft_MCDMusicGeneralLogging_5();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412802;
    ...
    v17 = 1024;
    v18 = v9;
    _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "%@ Performing request: %@, as operation: %c", buf, 0x1Cu);
  }
  ...
  else
  {
    ...
    v11[1] = 3221225472;
    v11[2] = __37___MCDContentManager__performRequest__block_invoke;
    v11[3] = &unk_133A620;
...
- (void)_processResponse:(id)a3 error:(id)a4
{
  ...
  v9 = soft_MCDMusicGeneralLogging_5();
  ...
  if (!v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      v20 = 2112;
      v21 = v8;
      _os_log_impl(&dword_0, v11, OS_LOG_TYPE_DEFAULT, "%@ Processing response of request: %@", buf, 0x16u);
    }

    v16[0] = _NSConcreteStackBlock;
    v16[1] = 3221225472;
    v16[2] = __45___MCDContentManager__processResponse_error___block_invoke_97;
    v16[3] = &unk_1338EF8;
    v16[4] = self;
    v14 = (id *)v16;
    v15 = v6;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    -[_MCDContentManager _processResponse:error:].cold.1((uint64_t)self, (uint64_t)v8, v11);
  ...
  if ((v13 & 1) != 0)
  {
    ...
    v17[1] = 3221225472;
    v17[2] = __45___MCDContentManager__processResponse_error___block_invoke;
    v17[3] = &unk_1338EF8;
    v17[4] = self;
    v14 = (id *)v17;
    v15 = v7;
...
- (void)_processResponse:(os_log_t)log error:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3;
  uint64_t v4;
  __int16 v5;
  ...
  v5 = 2112;
  v6 = a2;
  _os_log_error_impl(&dword_0, log, OS_LOG_TYPE_ERROR, "ERROR! %@, Processing response of request: %@", (uint8_t *)&v3, 0x16u);
}
