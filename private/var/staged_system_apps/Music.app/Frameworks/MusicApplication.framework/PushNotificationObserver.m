...
LABEL_3:
      ...
      v16 = (_QWORD *)swift_allocObject(&unk_13B7508, 64, 7);
      v16[2] = 0;
      v16[3] = 0;
      v16[4] = self;
      v16[5] = v12;
      ...
      v17 = a3;
      swift_bridgeObjectRetain();
      sub_C51ED8((uint64_t)v11, (uint64_t)&unk_1500440, (uint64_t)v16);
      swift_release();
...
- (_TtC9MusicCore24PushNotificationObserver)init
{
  ...
  swift_retain();
  *(_QWORD *)&self->connection[8] = sub_C26AF4((uint64_t)_swiftEmptyArrayStorage);
  *(_OWORD *)&self->connection[16] = 0u;
  *(_OWORD *)&self->pushConfiguration[8] = 0u;
  *(_QWORD *)&self[1].$defaultActor[8] = 0;
  swift_release();
  v4.receiver = self;
