...
- (void)initiatePlaybackForSong:(id)a3 useResultsAsPlaybackQueue:(BOOL)a4 itemList:(id)a5 playActivityFeatureName:(id)a6
{
  ...
  v19 = MPCloudController_ptr;
  v20 = MPCloudController_ptr;
  if (!v18)
    goto LABEL_19;
  v21 = v18;
  v22 = *(_QWORD *)v47;
  do
  {
    for (i = 0; i != v21; i = (char *)i + 1)
    {
      ...
      v25 = objc_opt_class(v19[86]);
      if ((objc_opt_isKindOfClass(v24, v25) & 1) == 0)
      {
        v32 = objc_opt_class(v20[80]);
...
LABEL_13:
      ...
      v26 = v24;
      if (objc_msgSend(v26, "itemType") == (char *)&dword_4 + 3)
      {
...
LABEL_26:
  ...
  v44[1] = 3221225472;
  v44[2] = __110__MCDStorePlaybackManager_initiatePlaybackForSong_useResultsAsPlaybackQueue_itemList_playActivityFeatureName___block_invoke;
  v44[3] = &unk_1339918;
  v44[4] = self;
  v45 = v37;
  v39 = v37;
...
void __110__MCDStorePlaybackManager_initiatePlaybackForSong_useResultsAsPlaybackQueue_itemList_playActivityFeatureName___block_invoke(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  void *v5;
...
- (void)initiatePlaybackForPlaylist:(id)a3 lastResponse:(id)a4 shuffled:(BOOL)a5 playActivityFeatureName:(id)a6
{
  ...
  v18[1] = 3221225472;
  v18[2] = __101__MCDStorePlaybackManager_initiatePlaybackForPlaylist_lastResponse_shuffled_playActivityFeatureName___block_invoke;
  v18[3] = &unk_1339940;
  v19 = v10;
  v20 = v11;
  v23 = a5;
...
id __101__MCDStorePlaybackManager_initiatePlaybackForPlaylist_lastResponse_shuffled_playActivityFeatureName___block_invoke(uint64_t a1, void *a2)
{
  void *v3;
  id v4;
  uint64_t v5;
  ...
  v4 = objc_msgSend(v3, "totalItemCount");
...
- (void)initiatePlaybackForRadioStation:(id)a3 lastResponse:(id)a4 shuffled:(BOOL)a5 playActivityFeatureName:(id)a6
{
  ...
  if (v12)
  {
    ...
    v13[1] = 3221225472;
    v13[2] = __105__MCDStorePlaybackManager_initiatePlaybackForRadioStation_lastResponse_shuffled_playActivityFeatureName___block_invoke;
    v13[3] = &unk_1339968;
    v14 = v12;
    v15 = v9;
    v16 = self;
...
void __105__MCDStorePlaybackManager_initiatePlaybackForRadioStation_lastResponse_shuffled_playActivityFeatureName___block_invoke(_QWORD *a1, void *a2)
{
  uint64_t v3;
  id v4;
  void *v5;
...
- (void)_initiatePlaybackForItem:(id)a3 shouldShuffle:(BOOL)a4 playActivityFeatureName:(id)a5
{
  ...
  v8 = a3;
  v9 = a5;
  v10 = soft_MCDMusicGeneralLogging_0();
  v11 = objc_claimAutoreleasedReturnValue(v10);
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_0, v11, OS_LOG_TYPE_DEFAULT, "Initiating playback for store item", buf, 2u);
  }

  v14[0] = _NSConcreteStackBlock;
  v14[1] = 3221225472;
  v14[2] = __90__MCDStorePlaybackManager__initiatePlaybackForItem_shouldShuffle_playActivityFeatureName___block_invoke;
  v14[3] = &unk_1339990;
  v14[4] = self;
  v15 = v8;
  v17 = a4;
...
void __90__MCDStorePlaybackManager__initiatePlaybackForItem_shouldShuffle_playActivityFeatureName___block_invoke(uint64_t a1, void *a2)
{
  void *v3;
  uint64_t v4;
  uint64_t v5;
...
- (id)_setupPlaybackIntentForQueuedSongsLength:(int64_t)a3 startItemIdentifiers:(id)a4
{
  ...
  v6 = a4;
  v7 = soft_MCDMusicGeneralLogging_0();
  v8 = objc_claimAutoreleasedReturnValue(v7);
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    *(_WORD *)v17 = 0;
    _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Setting up playback for queued songs", v17, 2u);
  }
...
- (id)_normalizedStringStoreIDForContentItem:(id)a3
{
  ...
  {
    v6 = v4;
    v7 = (int *)objc_msgSend(v6, "itemType");
    if (v7 == (int *)((char *)&dword_4 + 3))
    {
