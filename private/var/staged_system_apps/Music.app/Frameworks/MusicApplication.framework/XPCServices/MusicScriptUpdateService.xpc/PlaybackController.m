...
- (void)engine:(id)a3 didFailToPlayFirstItem:(id)a4 withError:(id)a5
{
  ...
  v9 = (_QWORD *)swift_allocObject(&unk_10044F9D8, 40, 7);
  v9[2] = a5;
  v9[3] = self;
  v9[4] = a4;
  v10 = a4;
  ...
  v15 = v10;
  v16 = a3;
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)((uint64_t (*)(void))sub_10016DA1C, (uint64_t)v9);
...
- (void)engine:(id)a3 requiresAuthorizationToPlayItem:(id)a4 reason:(int64_t)a5 authorizationHandler:(id)a6
{
  ...
  v10 = _Block_copy(a6);
  v11 = swift_allocObject(&unk_10044F988, 24, 7);
  *(_QWORD *)(v11 + 16) = v10;
  sub_1000087DC(0, (unint64_t *)&qword_100490BC0, OS_dispatch_queue_ptr);
  v12 = (_QWORD *)swift_allocObject(&unk_10044F9B0, 56, 7);
  v12[2] = a5;
  v12[3] = self;
  v12[4] = a4;
  v12[5] = sub_10016C830;
  ...
  v16 = a3;
  swift_retain(v11);
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)(sub_10016BD6C, (uint64_t)v12);
...
- (void).cxx_destruct
{
  sub_10000682C((Class *)((char *)&self->super.isa + OBJC_IVAR____TtC9MusicCore18PlaybackController_coordinator));
