...
- (void)tintColorDidChange
{
  ...
  sub_100082248(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_100359758((uint64_t)v4);
...
- (BOOL)isHighlighted
{
  return sub_1003580B8(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_1003580B8(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_1003580B8(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
{
  sub_10020A7D4((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.SymbolButton", 24);
}

- (void).cxx_destruct
{
  swift_bridgeObjectRelease();
  sub_10003A5C8(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider]);
  sub_10003A5C8(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler]);
  sub_100006798((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_10003A5C8(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu]);
  ...
  sub_100008758((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_1004A1520);
}
