...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  v7 = sub_1000087DC(0, &qword_1004A1000, UITouch_ptr);
  v8 = sub_10034F3D8();
...
- (_TtCC11MusicCoreUI10SliderViewP33_54515F1554A39BA10CF5FF24DBCB49D920PanGestureRecognizer)initWithTarget:(id)a3 action:(SEL)a4
{
  ...
  return (_TtCC11MusicCoreUI10SliderViewP33_54515F1554A39BA10CF5FF24DBCB49D920PanGestureRecognizer *)sub_10034C6AC((uint64_t)v8, (uint64_t)a4);
}
