...
- (_TtC11MusicCoreUI24LineProgressGradientView)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa + v8) = (Class)objc_msgSend(objc_allocWithZone((Class)UIView), "init");
  ...
  result = (_TtC11MusicCoreUI24LineProgressGradientView *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001003B2590, "MusicCoreUI/Utils.swift", 23, 2, 58, 0);
  __break(1u);
  return result;
}
