...
- (_TtCO14MusicUtilities7CTLabel5Frame)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtCO14MusicUtilities7CTLabel5Frame_colorOverride) = 0;
  ...
  result = (_TtCO14MusicUtilities7CTLabel5Frame *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001003B2590, "MusicUtilities/CoreText+Utilities.swift", 39, 2, 210, 0);
  __break(1u);
  return result;
}
...
{
  sub_10020A7D4((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicUtilities.Frame", 20);
}
