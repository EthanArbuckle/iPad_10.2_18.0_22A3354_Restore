...
{
  sub_1001EFF0C(self, (uint64_t)a2, a3, (uint64_t)&unk_1004557C8, (uint64_t)&unk_100496948);
}

- (void)environmentMonitorDidChangeNetworkType:(id)a3
{
  sub_1001EFF0C(self, (uint64_t)a2, a3, (uint64_t)&unk_1004557A0, (uint64_t)&unk_100496940);
}

- (void)environmentMonitorDidChangeThermalLevel:(id)a3
{
  sub_1001EFF0C(self, (uint64_t)a2, a3, (uint64_t)&unk_100455778, (uint64_t)&unk_100496938);
}
