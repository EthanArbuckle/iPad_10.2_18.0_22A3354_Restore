...
- (BOOL)isHidden
{
  return sub_1003580B8(self, (uint64_t)a2, (uint64_t (*)(_QWORD))type metadata accessor for SymbolButton.BadgeView, (SEL *)&selRef_isHidden);
}
...
{
  sub_10020A7D4((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.BadgeView", 21);
}
