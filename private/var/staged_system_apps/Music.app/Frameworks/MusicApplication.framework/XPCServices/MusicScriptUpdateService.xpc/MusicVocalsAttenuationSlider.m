...
- (MusicVocalsAttenuationSlider)initWithCoder:(id)a3
{
  ...
  result = (MusicVocalsAttenuationSlider *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001003B2590, "MusicCoreUI/VocalsAttenuationSlider.swift", 41, 2, 26, 0);
  __break(1u);
  return result;
}
