...
- (BOOL)isEnabled
{
  return sub_10036FEF0(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}

- (void)setEnabled:(BOOL)a3
{
  sub_10036FF8C(self, (uint64_t)a2, a3, (const char **)&selRef_isEnabled, (SEL *)&selRef_setEnabled_, (void (*)(id))sub_10036DAA8);
}
...
- (BOOL)isHighlighted
{
  return sub_10036FEF0(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}

- (void)setHighlighted:(BOOL)a3
{
  sub_10036FF8C(self, (uint64_t)a2, a3, (const char **)&selRef_isHighlighted, (SEL *)&selRef_setHighlighted_, (void (*)(id))sub_1003700B0);
}
...
- (void).cxx_destruct
{
  ...
  sub_100295178(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI20VerticalToggleSlider_packageDefinition), *((_QWORD *)v3 + 1), *((void **)v3 + 2), *((_QWORD *)v3 + 3), *((_QWORD *)v3 + 4), *((_QWORD *)v3 + 5), *((_QWORD *)v3 + 6), *((_QWORD *)v3 + 7), *((_QWORD *)v3 + 8), *((_QWORD *)v3 + 9));
