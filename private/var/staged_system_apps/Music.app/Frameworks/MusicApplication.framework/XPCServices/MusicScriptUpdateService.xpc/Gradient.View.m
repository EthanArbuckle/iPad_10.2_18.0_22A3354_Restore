...
- (_TtCV11MusicCoreUI8Gradient4View)initWithCoder:(id)a3
{
  ...
  result = (_TtCV11MusicCoreUI8Gradient4View *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001003B2590, "MusicCoreUI/Gradient.swift", 26, 2, 52, 0);
  __break(1u);
  return result;
}
...
+ (Class)layerClass
{
  sub_1000087DC(0, (unint64_t *)&qword_10049B1D0, CAGradientLayer_ptr);
