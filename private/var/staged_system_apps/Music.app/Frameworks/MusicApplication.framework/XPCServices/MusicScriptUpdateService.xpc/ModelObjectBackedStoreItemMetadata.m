...
{
  return (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_10014362C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithDownloadAssetDictionary_);
}

- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithStorePlatformDictionary:(id)a3
{
  return (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_10014362C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithStorePlatformDictionary_);
}
...
- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithStorePlatformDictionary:(id)a3 parentStoreItemMetadata:(id)a4 expirationDate:(id)a5
{
  ...
  v8 = sub_100005574(&qword_100490730);
  __chkstk_darwin(v8);
  ...
  v14 = a4;
  v15 = (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_10014B478(v11, (uint64_t)v14, (uint64_t)v10);
...
{
  return (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)sub_10014362C((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithStoreMusicAPIDictionary_);
}
...
- (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata)initWithCoder:(id)a3
{
  ...
  *((_QWORD *)v4 + 1) = 0;
  ...
  result = (_TtC9MusicCore34ModelObjectBackedStoreItemMetadata *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x80000001003B2590, "MusicCore/ModelObjectBackedStoreItemMetadata.swift", 50, 2, 49, 0);
  __break(1u);
  return result;
}
...
- (NSString)artistName
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.artistName.getter);
}

- (id)artistStoreID
{
  return sub_100149AF4(self, (uint64_t)a2, (void (*)(_QWORD *__return_ptr))ModelObjectBackedStoreItemMetadata.artistStoreID.getter);
}
...
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.collectionName.getter);
}

- (id)collectionStoreID
{
  return sub_100149AF4(self, (uint64_t)a2, (void (*)(_QWORD *__return_ptr))ModelObjectBackedStoreItemMetadata.collectionStoreID.getter);
}
...
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.composerName.getter);
}

- (NSString)copyrightText
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.copyrightText.getter);
}

- (NSString)curatorName
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.curatorName.getter);
}

- (NSString)descriptionText
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.descriptionText.getter);
}
...
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.editorNotes.getter);
}

- (NSString)shortEditorNotes
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.shortEditorNotes.getter);
}
...
- (NSString)handle
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.handle.getter);
}
...
- (NSString)itemKind
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.itemKind.getter);
}

- (NSDate)lastModifiedDate
{
  return (NSDate *)sub_1001492A8(self, (uint64_t)a2, &qword_100490730, (void (*)(void))ModelObjectBackedStoreItemMetadata.lastModifiedDate.getter, (uint64_t (*)(_QWORD))&type metadata accessor for Date, (uint64_t (*)(void))&Date._bridgeToObjectiveC());
}
...
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.movementName.getter);
}
...
- (NSString)name
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.name.getter);
}

- (NSString)nameRaw
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.nameRaw.getter);
}

- (NSDate)releaseDate
{
  return (NSDate *)sub_1001492A8(self, (uint64_t)a2, &qword_100490730, (void (*)(void))ModelObjectBackedStoreItemMetadata.releaseDate.getter, (uint64_t (*)(_QWORD))&type metadata accessor for Date, (uint64_t (*)(void))&Date._bridgeToObjectiveC());
}

- (id)socialProfileID
{
  return sub_100149AF4(self, (uint64_t)a2, (void (*)(_QWORD *__return_ptr))ModelObjectBackedStoreItemMetadata.socialProfileID.getter);
}
...
- (NSString)shortName
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.shortName.getter);
}

- (NSURL)shortURL
{
  return (NSURL *)sub_1001492A8(self, (uint64_t)a2, &qword_10048D510, (void (*)(void))ModelObjectBackedStoreItemMetadata.shortURL.getter, (uint64_t (*)(_QWORD))&type metadata accessor for URL, (uint64_t (*)(void))&URL._bridgeToObjectiveC());
}
...
- (NSURL)URL
{
  return (NSURL *)sub_1001492A8(self, (uint64_t)a2, &qword_10048D510, (void (*)(void))ModelObjectBackedStoreItemMetadata.url.getter, (uint64_t (*)(_QWORD))&type metadata accessor for URL, (uint64_t (*)(void))&URL._bridgeToObjectiveC());
}

- (NSString)workName
{
  return (NSString *)sub_10014B110(self, (uint64_t)a2, ModelObjectBackedStoreItemMetadata.workName.getter);
}
