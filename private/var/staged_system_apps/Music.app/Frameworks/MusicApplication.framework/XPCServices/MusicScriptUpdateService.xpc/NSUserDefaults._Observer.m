...
- (_TtCE14MusicUtilitiesCSo14NSUserDefaultsP33_0EE8F48931DDE162065F15584D7CE3A39_Observer)init
{
  ...
  v4 = self;
  *(Class *)((char *)&self->super.isa + v3) = (Class)sub_1001FCC90((uint64_t)_swiftEmptyArrayStorage);
...
LABEL_8:
  sub_10022856C(v10, v12, (uint64_t)v21, v18, (uint64_t)a6);

  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  sub_1002015F8((uint64_t)v21);
}
