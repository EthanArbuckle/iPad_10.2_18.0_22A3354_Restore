...
- (void)imagePickerController:(id)a3 didFinishPickingMediaWithInfo:(id)a4
{
  ...
  v8 = v7;
  v9 = sub_100006924(&qword_10049FE30, (uint64_t (*)(uint64_t))type metadata accessor for InfoKey, (uint64_t)&unk_10039675C);
...
- (void)documentPickerWasCancelled:(id)a3
{
  ...
  sub_100329614((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker, (uint64_t)v7);
  v8 = &v7[*(int *)(v5 + 32)];
  v9 = *(_QWORD *)v8;
  v10 = *((_QWORD *)v8 + 1);
  LOBYTE(v8) = v8[16];
  ...
  v11 = a3;
  v12 = self;
  v13 = sub_100005574(&qword_10049FE00);
...
- (void)presentationControllerDidDismiss:(id)a3
{
  ...
  v11 = (char)v4;
  v8 = 0;
  v7 = sub_100005574(&qword_10049FE00);
...
- (void).cxx_destruct
{
  sub_100329658((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker);
  sub_10003A5C8(*(uint64_t *)((char *)&self->super.isa + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_pickHandler), *(_QWORD *)&self->pickHandler[OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_pickHandler]);
  swift_bridgeObjectRelease();
