...
{
  if (qword_101241798 != -1)
    dispatch_once(&qword_101241798, &stru_101110C38);
  return (MusicMonogramArtworkDataSource *)(id)qword_101241790;
}

+ (OS_dispatch_queue)loadingQueue
{
  if (qword_1012417A8 != -1)
    dispatch_once(&qword_1012417A8, &stru_101110C58);
  return (OS_dispatch_queue *)(id)qword_1012417A0;
}
...
- (void)loadRepresentationForArtworkCatalog:(id)a3 completionHandler:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100CEB4BC;
  block[3] = &unk_101110CA8;
  v13 = v6;
  v14 = self;
  v15 = v7;
  v10 = v7;
