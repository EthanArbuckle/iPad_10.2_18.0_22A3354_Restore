...
- (id)textForHeaderViewInContentManager:(id)a3
{
  ...
  if (-[MCDTableViewController limitedUI](self, "limitedUI"))
  {
    ...
    v13 = &v12;
    v14 = 0x2020000000;
    v5 = (uint64_t (*)(void))off_1011ECB38;
    v15 = off_1011ECB38;
    if (!off_1011ECB38)
    {
    ...
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "localizedStringForKey:value:table:", CFSTR("RECENTLY_PLAYED_ALBUMS"), &stru_101122068, CFSTR("MusicCarDisplayUI")));
