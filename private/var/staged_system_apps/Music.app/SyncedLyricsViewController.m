...
- (void).cxx_destruct
{
  ...
  memcpy(v4, (char *)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_specs, 0x219uLL);
  sub_10024E458((uint64_t)v4);
  sub_10013C71C((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate, v3);
  swift_release();
  sub_10004FF60((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_1011E0480);
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler), *(_QWORD *)&self->isPlayingSpatial[OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_shareHandler]);
