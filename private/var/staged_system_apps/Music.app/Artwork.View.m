...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  else
  {
    ...
    v17 = v7[24];
    v18 = self;
    sub_100BAE608(width, height, v16, v8);
    v12 = v19;
    sub_100BAE608(width, height, v15, v17);
    v14 = v20;
...
- (void).cxx_destruct
{
  sub_10005B748((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_typedConfiguration, type metadata accessor for Artwork);
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_imageDidChangeHandler), *(_QWORD *)&self->imageDidChangeHandler[OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_imageDidChangeHandler]);
