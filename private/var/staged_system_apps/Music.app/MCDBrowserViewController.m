...
{
  _TtC5Music20CarPlayNoContentView *v3;
  void *v4;
  void *v5;
  void *v6;
  void *v7;
  ...
  {
    v3 = [_TtC5Music20CarPlayNoContentView alloc];
    v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("Privacy Information"), &stru_101122068, 0));
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("When you’re not driving, open Music on your iPhone and review the privacy information."), &stru_101122068, 0));
    v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Dismiss"), &stru_101122068, 0));
    v10 = -[CarPlayNoContentView initWithTitle:subtitle:buttonTitle:buttonHandler:](v3, "initWithTitle:subtitle:buttonTitle:buttonHandler:", v5, v7, v9, &stru_1010A9510);
    ...
    {
      *(_WORD *)v15 = 0;
      _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "Showing message about content restriction that should be resolved on device", v15, 2u);
    }
  ...
  else
  {
    ...
    v10 = (_TtC5Music20CarPlayNoContentView *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &tabBarController, 1));
...
- (MCDBrowserViewController)init
{
  ...
  if (v2)
  {
    ...
    v15 = &v14;
    v16 = 0x2020000000;
    v9 = (_QWORD *)qword_1011ECDD8;
    v17 = qword_1011ECDD8;
    if (!qword_1011ECDD8)
    {
      v10 = (void *)sub_100031474();
      v9 = dlsym(v10, "MCDContentItemsChangedNotification");
      v15[3] = (uint64_t)v9;
      qword_1011ECDD8 = (uint64_t)v9;
    }
...
- (id)_createViewControllerForIdentifier:(id)a3
{
  ...
  if (!v8)
  {
    ...
    if (v20)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v21, "localizedStringForKey:value:table:", CFSTR("Library"), &stru_101122068, 0));
    ...
    if (v24)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "localizedStringForKey:value:table:", CFSTR("Home"), &stru_101122068, 0));
...
LABEL_16:
    ...
    if (v30)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v31, "localizedStringForKey:value:table:", CFSTR("Browse"), &stru_101122068, 0));
      ...
      if (_os_feature_enabled_impl("Music", "in_with_the_new"))
      {
        ...
        v33 = objc_claimAutoreleasedReturnValue(objc_msgSend(v32, "localizedStringForKey:value:table:", CFSTR("New"), &stru_101122068, 0));
    ...
    if (v39)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v40, "localizedStringForKey:value:table:", CFSTR("Playlists"), &stru_101122068, 0));
...
LABEL_21:
  ...
  if (objc_msgSend(v9, "allowsRadioContent"))
  {
    ...
    if (v13)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Radio"), &stru_101122068, 0));
...
- (void)pushSharePlayTogetherSettings
{
  ...
  char isKindOfClass;
  void *v8;
  _TtC5Music41MCDSharePlayTogetherSessionViewController *v9;
  id v10;
  ...
  if (!-[MCDBrowserViewController deviceAcknowledgementRequired](self, "deviceAcknowledgementRequired"))
  {
    ...
    if (v3)
    {
      ...
      v6 = objc_opt_class(_TtC5Music41MCDSharePlayTogetherSessionViewController);
      isKindOfClass = objc_opt_isKindOfClass(v5, v6);

      if ((isKindOfClass & 1) != 0)
      {
        v8 = (void *)objc_claimAutoreleasedReturnValue(-[MCDBrowserViewController viewControllers](self, "viewControllers"));
        v9 = (_TtC5Music41MCDSharePlayTogetherSessionViewController *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "lastObject"));

        -[MCDSharePlayTogetherSessionViewController dismissQRCode](v9, "dismissQRCode");
      }
      else
      {
        v9 = -[MCDSharePlayTogetherSessionViewController initWithViewModel:]([_TtC5Music41MCDSharePlayTogetherSessionViewController alloc], "initWithViewModel:", v10);
...
- (id)nowPlayingButtonView
{
  ...
  if (!nowPlayingButtonView)
  {
    ...
    v16 = &v15;
    v17 = 0x2020000000;
    v7 = (id *)qword_1011ECE10;
    v18 = qword_1011ECE10;
    if (!qword_1011ECE10)
    {
      v8 = (void *)sub_100031474();
      v7 = (id *)dlsym(v8, "MCDMusicBundleIdentifier");
      v16[3] = (uint64_t)v7;
      qword_1011ECE10 = (uint64_t)v7;
    }
    _Block_object_dispose(&v15, 8);
    if (!v7)
    {
      v14 = (_Unwind_Exception *)sub_100DE9368();
      _Block_object_dispose(&v15, 8);
      _Unwind_Resume(v14);
    }
    v9 = *v7;
...
- (void)MCD_popNowPlayingViewControllerAnimated:(BOOL)a3
{
  ...
  if ((isKindOfClass & 1) != 0)
  {
    ...
    {
      *(_WORD *)v12 = 0;
      _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_DEFAULT, "Dismissing Now Playing view", v12, 2u);
    }
...
- (void)_nowPlayingButtonTouchUpInside:(id)a3
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "Pushing to Now Playing from button touch up inside", v6, 2u);
  }
...
- (void)setTabIdentifiers:(id)a3
{
  ...
  v4 = a3;
  if (qword_1011ECDC0 != -1)
    dispatch_once(&qword_1011ECDC0, &stru_1010A9550);
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_1011ECDB0, "objectForKeyedSubscript:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * (_QWORD)i), (_QWORD)v20));
        if (v14)
