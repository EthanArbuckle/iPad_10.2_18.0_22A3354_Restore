...
- (id)titleForIdentifier:(id)a3
{
  ...
  if (v7)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Recently Downloaded"), &stru_101122068, 0));
