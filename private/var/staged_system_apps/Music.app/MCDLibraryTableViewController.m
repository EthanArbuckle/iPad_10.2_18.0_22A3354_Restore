...
{
  void *v4;
  _TtC5Music31LibraryTableNavigationTitleView *v5;
  void *v6;
  _TtC5Music31LibraryTableNavigationTitleView *v7;
  void *v8;
  id v9;
  void *v10;
  void *v11;
...
LABEL_6:
  ...
  v16 = +[LibraryFilterOptionsController isFilteringToFavoritesWithStorageKey:legacyStorageKey:](_TtC5Music30LibraryFilterOptionsController, "isFilteringToFavoritesWithStorageKey:legacyStorageKey:", v13, v15);
...
- (void)filterButtonTapped
{
  ...
  v26 = &v25;
  v27 = 0x2050000000;
  v5 = (void *)qword_1011ECBB8;
  v28 = qword_1011ECBB8;
  if (!qword_1011ECBB8)
  {
    location[0] = _NSConcreteStackBlock;
    location[1] = (id)3221225472;
    location[2] = sub_100018D80;
    location[3] = &unk_1010A89D8;
    location[4] = &v25;
    sub_100018D80((uint64_t)location);
    v5 = (void *)v26[3];
  }
  ...
  v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "localizedStringForKey:value:table:", CFSTR("Favorites"), &stru_101122068, 0));
  if (v4)
    v13 = v8;
  else
    v13 = 0;
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("Cancel"), &stru_101122068, 0));
...
- (id)showAllActionTitle:(id)a3
{
  ...
  v25 = (__CFString *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "localizedStringForKey:value:table:", v9, &stru_101122068, 0));
...
LABEL_5:
  v12 = (__CFString *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "localizedStringForKey:value:table:", v11, &stru_101122068, 0));
  ...
  *(_QWORD *)&v19[16] = 0x2020000000;
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v19[22] = 2112;
    ...
    v25 = 2112;
    v26 = v17;
    _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "%@ Received response %@ from %@: itemCount=%ld, showFavoriteContent=%d, request=%@", v19, 0x3Au);
...
- (BOOL)contentManager:(id)a3 canDrillIntoItem:(id)a4
{
  ...
  v4 = a4;
  v6 = objc_opt_class(MPModelGenre, v5);
  if ((objc_opt_isKindOfClass(v4, v6) & 1) != 0
    || (v8 = objc_opt_class(MPModelAlbum, v7), (objc_opt_isKindOfClass(v4, v8) & 1) != 0)
    || (v10 = objc_opt_class(MPModelPerson, v9), (objc_opt_isKindOfClass(v4, v10) & 1) != 0))
  {
    isKindOfClass = 1;
  }
  else
  {
    v14 = objc_opt_class(MPModelPlaylist, v11);
    isKindOfClass = objc_opt_isKindOfClass(v4, v14);
  }
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass(dataSource, v12) & 1) != 0)
      {
        ...
        if (v13)
        {
          ...
          if (v15)
          {
            v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "localizedStringForKey:value:table:", CFSTR("Add music by %@ to save it here, or start a station to hear similar music."), &stru_101122068, 0));
            ...
            v21 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "localizedStringForKey:value:table:", CFSTR("Start Station"), &stru_101122068, 0));

            self->_isShowingButton = 1;
          }
          else
          {
            v28 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "localizedStringForKey:value:table:", CFSTR("Add music by %@ to save it here."), &stru_101122068, 0));
      ...
      v30 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v24, "localizedStringForKey:value:table:", v26, &stru_101122068, 0));

    }
    v21 = 0;
LABEL_18:
    v27 = objc_msgSend(objc_alloc((Class)sub_100018874()), "initWithTitle:subtitle:buttonText:", 0, v30, v21);
  ...
  v7 = objc_msgSend(objc_alloc((Class)sub_100018874()), "initWithTitle:subtitle:", 0, v30);
