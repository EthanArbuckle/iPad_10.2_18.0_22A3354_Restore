...
{
  id v3;
  _TtC5Music6Window *v4;

  v3 = a3;
  v4 = (_TtC5Music6Window *)sub_10004B8F4(v3);
...
- (_TtC5Music6Window)initWithCoder:(id)a3
{
  ...
  _QWORD *v5;
  id v6;
  _TtC5Music6Window *result;

  v4 = (Class *)((char *)&self->super.super.super.super.isa
               + OBJC_IVAR____TtC5Music6Window_screenDimensionsDidChangeHandler);
  *v4 = 0;
  v4[1] = 0;
  v5 = (Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC5Music6Window_boundsSizeDidChangeHandler);
  *v5 = 0;
  v5[1] = 0;
  *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC5Music6Window_overrideTraitCollection) = 0;
  v6 = a3;

  result = (_TtC5Music6Window *)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0xD000000000000025, 0x8000000100E2B820, "Music/Window.swift", 18, 2, 38, 0);
  __break(1u);
  return result;
}
...
- (void)sendEvent:(id)a3
{
  ...
  objc_msgSend(v7, "postNotificationName:object:", qword_10124C6C0, v5);

}

- (void)layoutSubviews
{
  _TtC5Music6Window *v2;
...
- (_TtC5Music6Window)initWithContentRect:(CGRect)a3
{
  ...
  result = (_TtC5Music6Window *)_swift_stdlib_reportUnimplementedInitializer("Music.Window", 12, "init(contentRect:)", 18, 0);
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC5Music6Window_screenDimensionsDidChangeHandler), *(_QWORD *)&self->screenDimensionsDidChangeHandler[OBJC_IVAR____TtC5Music6Window_screenDimensionsDidChangeHandler]);
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC5Music6Window_boundsSizeDidChangeHandler), *(_QWORD *)&self->screenDimensionsDidChangeHandler[OBJC_IVAR____TtC5Music6Window_boundsSizeDidChangeHandler]);
