...
- (void)viewDidLoad
{
  ...
  v15 = &v14;
  v16 = 0x2020000000;
  v3 = (uint64_t (*)(void))off_1011ECA90;
  v17 = off_1011ECA90;
  if (!off_1011ECA90)
  {
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "Loading view for Browse", buf, 2u);
  }

  v6 = (void *)objc_claimAutoreleasedReturnValue(-[MCDFuseTableViewController contentManager](self, "contentManager"));
  objc_msgSend(v6, "setTableCellConfigurationBlock:", &stru_1010A8C88);
