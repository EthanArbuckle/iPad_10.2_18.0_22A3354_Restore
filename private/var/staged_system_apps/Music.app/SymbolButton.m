...
- (void)tintColorDidChange
{
  ...
  sub_10005B704(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_100CCA988((uint64_t)v4);
...
- (BOOL)isHighlighted
{
  return sub_100CC92E8(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_100CC92E8(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_100CC92E8(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
{
  sub_1000535F0((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.SymbolButton", 24);
}

- (void).cxx_destruct
{
  swift_bridgeObjectRelease();
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.super.isa+ OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider]);
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler]);
  sub_10005B748((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_10004BA30(*(uint64_t *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu), *(_QWORD *)&self->debugLabel[OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_buildMenu]);
  ...
  sub_10004FF60((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_1011E6AF0);
}
