...
- (BOOL)isHidden
{
  return sub_100CC92E8(self, (uint64_t)a2, (uint64_t (*)(_QWORD))type metadata accessor for SymbolButton.BadgeView, (SEL *)&selRef_isHidden);
}
...
{
  sub_1000535F0((uint64_t)self, (uint64_t)a2, (uint64_t)"MusicCoreUI.BadgeView", 21);
}
