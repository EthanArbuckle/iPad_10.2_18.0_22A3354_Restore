...
- (void)imagePickerController:(id)a3 didFinishPickingMediaWithInfo:(id)a4
{
  ...
  v8 = v7;
  v9 = sub_100048748(&qword_1011E5400, (uint64_t (*)(uint64_t))_s3__C7InfoKeyVMa_0, (uint64_t)&unk_100EE9D5C);
...
- (void)documentPickerWasCancelled:(id)a3
{
  ...
  sub_100C9B34C((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker, (uint64_t)v7);
  v8 = &v7[*(int *)(v5 + 32)];
  v9 = *(_QWORD *)v8;
  v10 = *((_QWORD *)v8 + 1);
  LOBYTE(v8) = v8[16];
...
- (void)presentationControllerDidDismiss:(id)a3
{
  ...
  v11 = (char)v4;
  v8 = 0;
  v7 = sub_100007E8C(&qword_1011E53D0);
...
- (void).cxx_destruct
{
  sub_100C9B390((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker);
  sub_10004BA30(*(uint64_t *)((char *)&self->super.isa + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_pickHandler), *(_QWORD *)&self->pickHandler[OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_pickHandler]);
  swift_bridgeObjectRelease();
