...
- (void).cxx_destruct
{
  sub_10004FF60((uint64_t)self + OBJC_IVAR____TtC11MusicJSCore18JSStoreHTTPRequest_url, &qword_10119E460);
  ...
  sub_10004FF60((uint64_t)self + OBJC_IVAR____TtC11MusicJSCore18JSStoreHTTPRequest_responseExpirationDate, (uint64_t *)&unk_1011A30A0);
}
