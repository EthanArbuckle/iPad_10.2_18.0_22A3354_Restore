...
LABEL_20:
        ...
        v43 = sub_100011DF0();
        v30 = (MCDCompilationsTableViewController *)objc_claimAutoreleasedReturnValue(v43);
...
LABEL_21:
  ...
  else
  {
    ...
    v56 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v53, "localizedStringForKey:value:table:", v55, &stru_101122068, 0));

    v68 = 0;
    v69 = &v68;
    v70 = 0x2050000000;
    v57 = (void *)qword_1011ECB20;
    v71 = qword_1011ECB20;
    if (!qword_1011ECB20)
    {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        if ((objc_opt_isKindOfClass(v9, v10) & 1) != 0)
        {
          ...
          if (!v12)
          {
            if (-[NSObject type](v11, "type") != (id)4
          ...
          v17 = (uint64_t)-[NSObject type](v11, "type", v28);
          if (v17 > 3)
          {
            if (v17 == 4)
            {
