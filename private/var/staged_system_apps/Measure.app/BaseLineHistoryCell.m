...
- (_TtC7Measure19BaseLineHistoryCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  return (_TtC7Measure19BaseLineHistoryCell *)sub_100065CE8(a3, (uint64_t)a4, v6);
}

- (_TtC7Measure19BaseLineHistoryCell)initWithCoder:(id)a3
{
  return (_TtC7Measure19BaseLineHistoryCell *)sub_100065E90(a3);
}

- (void)prepareForReuse
{
  _TtC7Measure19BaseLineHistoryCell *v2;
