...
- (void)searchableIndex:(id)a3 reindexAllSearchableItemsWithAcknowledgementHandler:(id)a4
{
  ...
  v8 = v4;
  v6 = v4;
  objc_msgSend(v5, "updateSpotlightIndexForBundleID:withCompletion:", CFSTR("com.apple.tv"), v7);
...
- (void)searchableIndex:(id)a3 reindexSearchableItemsWithIdentifiers:(id)a4 acknowledgementHandler:(id)a5
{
  ...
  v11 = v6;
  v9 = v6;
  objc_msgSend(v8, "updateSpotlightIndexMetadataForItemsWithIdentifiers:bundleID:withCompletion:", v7, CFSTR("com.apple.tv"), v10);
