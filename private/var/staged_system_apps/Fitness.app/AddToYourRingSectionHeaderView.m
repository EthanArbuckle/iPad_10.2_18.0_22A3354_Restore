...
{
  return (_TtC10FitnessApp30AddToYourRingSectionHeaderView *)sub_100168FF0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC10FitnessApp30AddToYourRingSectionHeaderView)initWithCoder:(id)a3
{
  return (_TtC10FitnessApp30AddToYourRingSectionHeaderView *)sub_10016910C(a3);
}
