        ...
        for (i = 0; i != v6; i = (char *)i + 1)
        {
          ...
          if ((objc_msgSend(v9, "isMe") & 1) == 0)
          {
            ...
            if (objc_msgSend(v9, "isTranscription"))
            {
              ...
              v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", v12, &stru_10008B240));

              v14 = objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "stringByReplacingOccurrencesOfString:withString:", v13, &stru_10008B240));
              v10 = (void *)v14;
            }
