...
- (UIWindow)window
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___CNKClarityUISceneDelegate_window, v4, 0, 0);
  return (UIWindow *)*v2;
}
...
- (void)setWindow:(id)a3
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___CNKClarityUISceneDelegate_window, v7, 1, 0);
  v5 = *v4;
  *v4 = a3;
  v6 = a3;
...
- (CNKClarityUISceneDelegate)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___CNKClarityUISceneDelegate_window) = 0;
  ...
  return -[CNKClarityUISceneDelegate init](&v3, "init");
}
