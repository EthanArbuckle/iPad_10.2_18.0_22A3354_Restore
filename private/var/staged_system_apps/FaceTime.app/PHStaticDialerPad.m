...
- (void)layoutSubviews
{
  ...
  do
  {
    ...
    do
    {
      ...
      objc_msgSend(v13, "setAllowedPressTypes:", &off_10008DCB0);
...
- (void)didUpdateFocusInContext:(id)a3 withAnimationCoordinator:(id)a4
{
  ...
  -[PHStaticDialerPad performTapActionCancelForHighlightedKey](self, "performTapActionCancelForHighlightedKey");
  v15.receiver = self;
  v15.super_class = (Class)PHStaticDialerPad;
  -[PHStaticDialerPad didUpdateFocusInContext:withAnimationCoordinator:](&v15, "didUpdateFocusInContext:withAnimationCoordinator:", v6, v7);
  ...
  if (v8
    && (v9 = (void *)v8,
        ...
        v11 = objc_opt_class(CPKeyView),
        isKindOfClass = objc_opt_isKindOfClass(v10, v11),
        v10,
        v9,
        (isKindOfClass & 1) != 0))
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "nextFocusedItem"));
    v14 = (uint64_t)objc_msgSend(v13, "keyIndex");
  ...
  -[PHStaticDialerPad highlightKeyAtIndex:](self, "highlightKeyAtIndex:", v14);
