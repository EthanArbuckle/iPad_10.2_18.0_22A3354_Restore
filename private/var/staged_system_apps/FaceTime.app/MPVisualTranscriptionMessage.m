...
{
  return (MPVisualTranscriptionMessage *)sub_100042260((char *)self, (uint64_t)a2, a3, &OBJC_IVAR___MPVisualTranscriptionMessage_vmTranscript, type metadata accessor for VisualTranscriptionMessage);
}
...
- (MPVisualTranscriptionMessage)init
{
  ...
  result = (MPVisualTranscriptionMessage *)_swift_stdlib_reportUnimplementedInitializer("FaceTime.VisualTranscriptionMessage", 35, "init()", 6, 0);
  __break(1u);
  return result;
}
