...
{
  if (qword_1000A3648 != -1)
    dispatch_once(&qword_1000A3648, &stru_100089890);
  return byte_1000A3640;
}

+ (id)currentDevice
{
  if (qword_1000A3638 != -1)
    dispatch_once(&qword_1000A3638, &stru_100089870);
  return (id)qword_1000A3630;
}
