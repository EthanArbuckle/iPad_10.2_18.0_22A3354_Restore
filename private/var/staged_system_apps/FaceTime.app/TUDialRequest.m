...
+ (id)dialRequestForCallProvider:(id)a3 handle:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      sub_1000553CC(v5, (uint64_t)v7, v10);
...
+ (id)dialRequestForUserActivity:(id)a3 callProviderManager:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          sub_100055500((uint64_t)v11, v32);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
        sub_1000554CC(v12, v24, v25, v26, v27, v28, v29, v30);
      v22 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      sub_100055498(v11, v15, v16, v17, v18, v19, v20, v21);
    v22 = 0;
  }
