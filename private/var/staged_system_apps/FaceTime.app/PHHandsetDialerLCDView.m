...
- (PHHandsetDialerLCDView)initWithFrame:(CGRect)a3 forDialerType:(int)a4
{
  ...
  if (v5)
  {
    ...
    -[PHLCDViewTextField setText:](v5->_numberTextField, "setText:", &stru_10008B240);
...
- (void)createPillViewForSenderIdentity:(id)a3
{
  ...
  if (!v5)
  {
    v6 = objc_msgSend(objc_alloc((Class)TPPillView), "initWithTitle:frame:", &stru_10008B240, CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
...
- (id)newAddContactButton
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("ADD_NUMBER"), &stru_10008B240, CFSTR("Dialer")));
