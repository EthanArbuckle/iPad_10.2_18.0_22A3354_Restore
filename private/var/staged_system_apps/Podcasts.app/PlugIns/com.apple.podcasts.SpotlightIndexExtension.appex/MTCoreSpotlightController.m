...
- (void)updateSearchableIndexWithReason:(id)a3 searchableIndex:(id)a4 entityLoadingBlock:(id)a5 completion:(id)a6
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1000080E0;
  block[3] = &unk_100014790;
  block[4] = self;
  v20 = v10;
  v21 = v11;
  v22 = v12;
...
- (MTCoreSpotlightController)initWithAnnotator:(id)a3
{
  ...
  v6 = -[MTCoreSpotlightController init](&v16, "init");
  if (v6)
  {
    ...
    v12 = objc_alloc((Class)CSSearchableIndex);
    v13 = (CSSearchableIndex *)objc_msgSend(v12, "initWithName:bundleIdentifier:", CFSTR("Podcasts"), kMTApplicationBundleIdentifier);
...
- (void)libraryDidChange:(id)a3
{
  ...
  v4 = a3;
  v5 = -[MTCoreSpotlightController hasDeferredIndexAll](self, "hasDeferredIndexAll");
  if (v5)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "Dropping index update request (context:didInsertObjects:) since we haven't yet received the initial indexAllData", buf, 2u);
    }

  }
  else
  {
    v22[0] = kMTPodcastEntityName;
    v22[1] = kMTEpisodeEntityName;
    v22[2] = kMTPlaylistEntityName;
    v8 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v22, 3));
    v9 = objc_msgSend(v4, "hasInsertsForEntityNames:", v8);
    ...
    if (v9)
    {
      *(_QWORD *)buf = 0;
      ...
      v21 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "importContext"));

      v11 = (void *)*((_QWORD *)v17 + 5);
...
- (void)searchableIndex:(id)a3 reindexAllSearchableItemsWithAcknowledgementHandler:(id)a4
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100009A08;
  block[3] = &unk_100014A20;
  block[4] = self;
  v12 = v6;
  v13 = v7;
  v9 = v7;
