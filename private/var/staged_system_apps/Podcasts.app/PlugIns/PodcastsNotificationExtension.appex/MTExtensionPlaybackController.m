...
+ (void)_setPlaybackQueueWithIdentifier:(id)a3 startPlayback:(BOOL)a4 assetInfo:(id)a5 requesterSharedUserId:(id)a6 sharedUserIdFromPlayableITunesAccount:(id)a7 playerID:(id)a8 mrCompletion:(id)a9
{
  ...
  {
    v21 = objc_msgSend(a1, "playbackQueueForIdentifier:startPlayback:assetInfo:", v15, v13, v16);
    v22 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableDictionary dictionaryWithCapacity:](NSMutableDictionary, "dictionaryWithCapacity:", 2));
    v23 = v22;
    if (v17)
      objc_msgSend(v22, "setObject:forKey:", v17, CFSTR("requesterUserId"));
    v35 = v17;
    v24 = v16;
    if (v18)
      objc_msgSend(v23, "setObject:forKey:", v18, CFSTR("sharedUserId"));
    MRSystemAppPlaybackQueueSetUserInfo(v21, v23);
    global_queue = dispatch_get_global_queue(0, 0);
    v26 = (void *)objc_claimAutoreleasedReturnValue(global_queue);
    LocalOrigin = MRMediaRemoteGetLocalOrigin();
    v28 = (const void *)MRNowPlayingClientCreate(0, kMTApplicationBundleIdentifier);
    v34 = v19;
    v29 = (const void *)MRNowPlayingPlayerCreate(v19, 0);
    v30 = MRNowPlayingPlayerPathCreate(LocalOrigin, v28, v29);
    if (v28)
      CFRelease(v28);
    v16 = v24;
    if (v29)
      CFRelease(v29);
    v39 = kMRMediaRemoteOptionAssistantSetQueueTrueCompletion;
    v40 = &off_100029F68;
    ...
    v36[3] = &unk_100028870;
    v37 = v20;
    MRMediaRemoteSetAppPlaybackQueueForPlayer(v21, v31, v30, 0, v26, v36);
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v33, OS_LOG_TYPE_ERROR, "Failed to set playback queue: empty playback request identifier provided", buf, 2u);
    }
