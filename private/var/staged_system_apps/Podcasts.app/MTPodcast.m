...
- (void)setTitle:(id)a3
{
  ...
  v9 = (unint64_t)a3;
  v4 = objc_claimAutoreleasedReturnValue(-[MTPodcast title](self, "title"));
  v5 = v9 | v4;
...
- (void)setSubscribed:(BOOL)a3
{
  ...
  if (-[MTPodcast subscribed](self, "subscribed") != a3)
  {
    ...
    v7 = (id)objc_claimAutoreleasedReturnValue(+[SyncKeysRepository shared](_TtC18PodcastsFoundation18SyncKeysRepository, "shared"));
...
- (void)setChannel:(id)a3
{
  ...
  v8 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast channel](self, "channel"));
  v5 = objc_msgSend(v8, "isEqual:", v4);

  if ((v5 & 1) == 0)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast channel](self, "channel"));
    v7 = kPodcastChannel;
    ...
    -[MTPodcast setChannelStoreId:](self, "setChannelStoreId:", objc_msgSend(v8, "storeId"));
    -[MTPodcast _updateChannelRelationship:deassociate:](self, "_updateChannelRelationship:deassociate:", v6, 1);
    -[MTPodcast _updateChannelRelationship:deassociate:](self, "_updateChannelRelationship:deassociate:", v8, 0);
...
- (void)_updateChannelRelationship:(id)a3 deassociate:(BOOL)a4
{
  ...
  if (a3)
  {
    v4 = a4;
    v6 = a3;
    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "podcastUuids"));
    v10 = (NSMutableSet *)objc_msgSend(v7, "mutableCopy");

    v8 = v10;
    if (!v10)
      v8 = objc_opt_new(NSMutableSet);
    v11 = v8;
    v9 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast uuid](self, "uuid"));
    if (v4)
...
- (void)updateEpisodesMetadataIdentifiers
{
  ...
  v9 = 0u;
  v10 = 0u;
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast episodes](self, "episodes", 0));
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((_QWORD *)&v7 + 1) + 8 * (_QWORD)v6), "updateUPPIdentifierIfNeeded");
        v6 = (char *)v6 + 1;
      }
      while (v4 != v6);
...
- (void)prepareForDeletion
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast channel](self, "channel"));
  -[MTPodcast _updateChannelRelationship:deassociate:](self, "_updateChannelRelationship:deassociate:", v3, 1);
...
- (id)countOfNewEpisodes
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[MTPodcastDerivedPropertyObserver sharedInstance](MTPodcastDerivedPropertyObserver, "sharedInstance"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast uuid](self, "uuid"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v3, "countOfNewEpisodesForPodcast:", v4)));
...
- (id)countOfUnplayedEpisodes
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[MTPodcastDerivedPropertyObserver sharedInstance](MTPodcastDerivedPropertyObserver, "sharedInstance"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[MTPodcast uuid](self, "uuid"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v3, "countOfUnplayedEpisodesForPodcast:", v4)));
...
- (void)setLastDatePlayed:(double)a3
{
  ...
  -[MTPodcast lastDatePlayed](self, "lastDatePlayed");
  if (v5 < a3)
  {
    ...
    v8 = (id)objc_claimAutoreleasedReturnValue(+[PodcastsStateCoordinator shared](_TtC8Podcasts24PodcastsStateCoordinator, "shared"));
    objc_msgSend(v8, "unsafeDidBumpLastDatePlayedFor:", self);
...
+ (id)allPossibleEpisodeListSortOrderProperties
{
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "mt_compactMap:", &stru_1004AAE38));
