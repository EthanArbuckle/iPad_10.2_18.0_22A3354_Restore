...
- (void).cxx_destruct
{
  ...
  sub_10003D380((Class *)((char *)&self->super.isa + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage));
  swift_unknownObjectRelease(*(Class *)((char *)&self->super.isa
                                      + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_cloudSyncBugReporter));
  ...
  swift_release(*(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_signpostState));
}
...
- (BOOL)hasLocalChanges
{
  ...
  _TtC8Podcasts21InterestSyncProcessor *v7;
  uint64_t v9;
  _QWORD v10[3];
  uint64_t v11;
  uint64_t v12;

  v3 = (uint64_t)self + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage;
  swift_beginAccess((char *)self + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage, &v9, 0, 0);
...
- (id)versionForGetTransaction:(id)a3 key:(id)a4
{
  ...
  unint64_t v8;
  id v9;
  _TtC8Podcasts21InterestSyncProcessor *v10;
  uint64_t v11;
  uint64_t v12;
  NSString v13;
...
- (id)dataForSetTransaction:(id)a3 key:(id)a4 version:(id *)a5
{
  ...
  unint64_t v10;
  id v11;
  _TtC8Podcasts21InterestSyncProcessor *v12;
  uint64_t v13;
  unint64_t v14;
  unint64_t v15;
  Class isa;
...
- (void)successfulGetTransaction:(id)a3 withData:(id)a4 forKey:(id)a5 version:(id)a6 finishedBlock:(id)a7
{
  ...
  id v13;
  id v14;
  _TtC8Podcasts21InterestSyncProcessor *v15;
  id v16;
  unint64_t v17;
  unint64_t v18;
  uint64_t v19;
...
LABEL_8:
  ...
  if (!v11)
    goto LABEL_8;
LABEL_6:
  v25 = swift_allocObject(&unk_1004B41D8, 24, 7);
  *(_QWORD *)(v25 + 16) = v11;
  v26 = sub_1001CE028;
LABEL_9:
  sub_1001DFD1C((uint64_t)a4, v18, v19, v21, v22, v24, (void (*)(_QWORD))v26, v25);
...
LABEL_8:
  ...
  if (!v11)
    goto LABEL_8;
LABEL_6:
  v25 = swift_allocObject(&unk_1004B41B0, 24, 7);
  *(_QWORD *)(v25 + 16) = v11;
  v26 = sub_1001CE028;
LABEL_9:
  sub_1001DFF18(v19, v21, v22, v24, (void (*)(_QWORD))v26, v25);
  sub_10002CA30((uint64_t)v26, v25);
  swift_bridgeObjectRelease(v21);
  swift_bridgeObjectRelease(v24);
  sub_1001C0F60((uint64_t)a4, v18);
...
LABEL_8:
  ...
  if (!v11)
    goto LABEL_8;
LABEL_6:
  v25 = swift_allocObject(&unk_1004B4188, 24, 7);
  *(_QWORD *)(v25 + 16) = v11;
  v26 = sub_1001CE020;
LABEL_9:
  sub_1001E0108((uint64_t)a4, v18, v19, v21, v22, v24, (uint64_t (*)(_QWORD))v26, v25);
  sub_10002CA30((uint64_t)v26, v25);
  swift_bridgeObjectRelease(v21);
  swift_bridgeObjectRelease(v24);
  sub_1001C0F60((uint64_t)a4, v18);
...
- (void)transaction:(id)a3 didProcessResponseWithDomainVersion:(id)a4
{
  ...
  id v13;
  _TtC8Podcasts21InterestSyncProcessor *v14;
  _BYTE v15[24];
  ...
  v9 = (char *)self + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage;
  swift_beginAccess((char *)self + OBJC_IVAR____TtC8Podcasts21InterestSyncProcessor_interestSyncStorage, v15, 33, 0);
  v10 = *((_QWORD *)v9 + 3);
  v11 = *((_QWORD *)v9 + 4);
