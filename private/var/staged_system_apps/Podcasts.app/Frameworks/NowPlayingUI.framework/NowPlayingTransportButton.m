...
{
  _TtC12NowPlayingUI25NowPlayingTransportButton *result;

  sub_131F7C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}
...
- (BOOL)isHighlighted
{
  return sub_1328D8(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isEnabled
{
  return sub_1328D8(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}
...
- (CGSize)intrinsicContentSize
{
  ...
  v4 = v3;
  v6 = v5;
  v7 = *(double *)&v2[OBJC_IVAR____TtC12NowPlayingUI25NowPlayingTransportButton_highlightIndicatorWidth];
...
- (void)layoutSubviews
{
  _TtC12NowPlayingUI25NowPlayingTransportButton *v2;
