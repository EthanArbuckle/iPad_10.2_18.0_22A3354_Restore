...
+ (id)uniqueIdentifierForPodcastInPlayerItem:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "episode"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "podcast"));

  if (v6)
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "episode"));
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "podcast"));
    v9 = objc_claimAutoreleasedReturnValue(objc_msgSend(a1, "uniqueIdentifierForObject:", v8));
LABEL_5:
    v10 = (void *)v9;

    goto LABEL_6;
  }
  if (objc_msgSend(v4, "podcastStoreId"))
  {
    v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", objc_msgSend(v4, "podcastStoreId")));
    v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "stringValue"));
    v9 = objc_claimAutoreleasedReturnValue(objc_msgSend(CFSTR("ps"), "stringByAppendingString:", v8));
    goto LABEL_5;
  }
  v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "podcastFeedUrl"));
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "podcastFeedUrl"));
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(CFSTR("p"), "stringByAppendingString:", v7));
LABEL_6:
...
+ (id)uniqueIdentifierForObject:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass(v4, v5) & 1) == 0)
  {
    ...
    else
    {
      ...
      {
        v13 = objc_opt_class(MTPlayerItem);
        if ((objc_opt_isKindOfClass(v4, v13) & 1) != 0)
        {
          v14 = v4;
          v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(a1, "uniqueIdentifierForPodcastInPlayerItem:", v14));
          if (!objc_msgSend(v6, "length"))
          {
            v15 = objc_claimAutoreleasedReturnValue(objc_msgSend(a1, "uniqueIdentifierForEpisodeInPlayerItem:", v14));
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue(-[__CFString stringByAppendingString:](v16, "stringByAppendingString:", v7));
...
+ (void)prepareSearchableItemForObject:(id)a3 annotator:(id)a4 completion:(id)a5
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        v14 = objc_opt_class(MTPlayerItem);
        isKindOfClass = objc_opt_isKindOfClass(v8, v14);
        if ((isKindOfClass & 1) != 0)
        {
          objc_msgSend(a1, "prepareSearchableItemForPlayerItem:annotator:completion:", v8, v9, v10);
        }
        else
        {
...
+ (id)uniqueIdentifierForEpisodeInPlayerItem:(id)a3
{
  ...
  if (v5)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "episode"));
    v7 = objc_claimAutoreleasedReturnValue(objc_msgSend(a1, "uniqueIdentifierForObject:", v6));
  }
  else
  {
    if (objc_msgSend(v4, "episodeStoreId"))
    {
      v6 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", objc_msgSend(v4, "episodeStoreId")));
      v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "stringValue"));
      v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(CFSTR("es"), "stringByAppendingString:", v9));

      goto LABEL_6;
    }
    v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "episodeGuid"));
    ...
    v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "episodeGuid"));
    v7 = objc_claimAutoreleasedReturnValue(objc_msgSend(CFSTR("e"), "stringByAppendingString:", v6));
  }
  v8 = (void *)v7;
LABEL_6:
...
+ (void)prepareSearchableItemForPlayerItem:(id)a3 annotator:(id)a4 completion:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "episode"));
  if (v11)
  {
    objc_msgSend(a1, "prepareSearchableItemForEpisode:annotator:completion:", v11, v9, v10);
  }
  else
  {
    v12 = objc_msgSend(objc_alloc((Class)CSSearchableItemAttributeSet), "initWithItemContentType:", kUTTypeAudiovisualContent);
    ...
    v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "album"));
    objc_msgSend(v12, "setContainerTitle:", v15);

    v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "itemDescription"));
    objc_msgSend(v12, "setContentDescription:", v16);

    v17 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "itemDescription"));
    objc_msgSend(v12, "setInformation:", v17);

    objc_msgSend(v8, "duration");
    v18 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:"));
    objc_msgSend(v12, "setDuration:", v18);

    v19 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithBool:](NSNumber, "numberWithBool:", objc_msgSend(v8, "isLocal")));
    objc_msgSend(v12, "setLocal:", v19);

    v20 = (void *)objc_claimAutoreleasedReturnValue(+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", objc_msgSend(v8, "isLocal") ^ 1));
    objc_msgSend(v12, "setStreamable:", v20);

    v21 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "pubDate"));
    objc_msgSend(v12, "setContentCreationDate:", v21);
    ...
    if (v22)
    {
      ...
      v36 = v23;
      v24 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &v36, 1));
      objc_msgSend(v12, "setAuthors:", v24);
    ...
    if (v25)
    {
      v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "url"));
      objc_msgSend(v12, "setContentURL:", v26);

    }
    v27 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(a1, "uniqueIdentifierForEpisodeInPlayerItem:", v8));
    v28 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(a1, "uniqueIdentifierForPodcastInPlayerItem:", v8));
    objc_msgSend(v12, "setRelatedUniqueIdentifier:", v28);
    objc_msgSend(v12, "setDomainIdentifier:", v28);
    v29 = objc_alloc_init((Class)CSSearchableItem);
    objc_msgSend(v29, "setUniqueIdentifier:", v27);
    objc_msgSend(v29, "setAttributeSet:", v12);
    v30 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "annotateItem:withPlayerItem:", v29, v8));

    v31 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "podcastUuid"));
    ...
    v35 = v10;
    v32 = v30;
    objc_msgSend(a1, "configureArtworkForSearchableItemAttributeSet:withPodcastUuid:completion:", v12, v31, v33);
