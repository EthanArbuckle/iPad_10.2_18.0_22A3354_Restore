...
- (MTCoreSpotlightIndexBatchGenerator)initWithStartingIndexPath:(id)a3
{
  ...
  if (v5)
  {
    if (qword_100567428 != -1)
      dispatch_once(&qword_100567428, &stru_1004A98D8);
    v17 = 0;
    v18 = &v17;
    v19 = 0x2020000000;
    v20 = 0;
    ...
    block[1] = 3221225472;
    block[2] = sub_1000BBD8C;
    block[3] = &unk_1004A6530;
    block[4] = &v17;
    dispatch_sync((dispatch_queue_t)qword_100567430, block);
    v6 = v18[3];
...
- (id)nextBatchWithTransformationBlock:(id)a3
{
  ...
  {
    -[NSFetchRequest setFetchOffset:](self->_currentFetchRequest, "setFetchOffset:", 5 * self->_nextIndexPath.batch);
    v7 = 0;
    v29 = 0;
    v30 = &v29;
    v31 = 0x3032000000;
    ...
    while (!objc_msgSend(v7, "count") && !*((_BYTE *)v20 + 24))
    {
      ...
      if (!objc_msgSend((id)v24[5], "count") && !*((_BYTE *)v20 + 24))
      {
        ...
        -[NSFetchRequest setFetchOffset:](self->_currentFetchRequest, "setFetchOffset:", 5 * v9);
      }
...
- (BOOL)collectNextBatch:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MTCoreSpotlightIndexBatchGenerator nextBatchWithTransformationBlock:](self, "nextBatchWithTransformationBlock:", &stru_1004A9868));
...
- (id)_entitiesByRemovingAlreadyProcessedFrom:(id)a3
{
  ...
  v11[4] = self;
  v3 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "mt_filter:", v11));
  ...
  if (v7 >= 1)
  {
    v8 = _MTLogCategorySpotlight(v6);
    v9 = objc_claimAutoreleasedReturnValue(v8);
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 67109120;
      v13 = v7;
      _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_DEFAULT, "[BatchGenerator] filtering out %d already encountered items", buf, 8u);
    }
