...
- (void)turnPage
{
  ...
  if (v6)
  {
    if ((objc_msgSend(v6, "simulateManualPageTurn:time:", 1, 2.0) & 1) != 0)
      goto LABEL_9;
    goto LABEL_8;
  }
  ...
  v12 = +[RETestDriver simulateManualPageTurnWithViewController:rtl:time:](_TtC5Books12RETestDriver, "simulateManualPageTurnWithViewController:rtl:time:", v11, 1, 2.0);
