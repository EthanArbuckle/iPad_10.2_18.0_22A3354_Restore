...
- (void)turnPage
{
  ...
  if (v6)
  {
    if ((objc_msgSend(v6, "turnPages:animated:", -1, 1) & 1) != 0)
      goto LABEL_9;
    goto LABEL_8;
  }
  ...
  {
    *(_WORD *)v13 = 0;
    _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_INFO, "Asking RETestDriver to turn page", v13, 2u);
  }

  v11 = (void *)objc_claimAutoreleasedReturnValue(-[PPTBasicTest bookController](self, "bookController"));
  v12 = +[RETestDriver turnPageWithViewController:forward:](_TtC5Books12RETestDriver, "turnPageWithViewController:forward:", v11, 0);
