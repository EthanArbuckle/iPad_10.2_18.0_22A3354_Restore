...
{
  BKLibraryBookshelfLibraryWantToReadViewConfiguration *v2;
  void *v3;
  void *v4;
  uint64_t v5;
  void *v6;
...
- (id)viewTitle
{
  return +[BCCollection titleForDefaultCollectionID:](BCCollection, "titleForDefaultCollectionID:", kBKCollectionDefaultIDWantToRead);
}
...
- (id)sortControlConfig
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[BKLibraryManager predicateForCollectionMembersInCollectionID:hideUnownedItems:allowExplicit:](BKLibraryManager, "predicateForCollectionMembersInCollectionID:hideUnownedItems:allowExplicit:", kBKCollectionDefaultIDWantToRead, 0, 1));
  ...
  v12[0] = v6;
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSSortDescriptor sortDescriptorWithKey:ascending:](NSSortDescriptor, "sortDescriptorWithKey:ascending:", CFSTR("assetID"), 0));
  v12[1] = v7;
  ...
  -[BKLibrarySortByMode setAllowsReordering:](v2, "setAllowsReordering:", 1);
  v11 = v2;
