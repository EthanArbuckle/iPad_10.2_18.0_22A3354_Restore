...
- (_TUIAugmentedDynamicArray)initWithArray:(id)a3 augmenter:(id)a4
{
  id v6;
  id v7;
  _TUIAugmentedDynamicArray *v8;
  _TUIAugmentedDynamicArray *v9;
  uint64_t v10;
...
- (id)newInstanceWithGeneration:(id)a3 count:(unint64_t)a4 observer:(id)a5
{
  ...
  v8 = a5;
  v9 = a3;
  v10 = -[_TUIDynamicArrayInstance initWithArray:generation:count:observer:]([_TUIAugmentedDynamicArrayInstance alloc], "initWithArray:generation:count:observer:", self, v9, a4, v8);

  -[_TUIAugmentedDynamicArrayInstance setDataAugmenter:](v10, "setDataAugmenter:", self->_augmenter);
  return v10;
}
