...
- (TUIHoverInteraction)initWithDelegate:(id)a3 view:(id)a4
{
  ...
  v8 = -[TUIHoverInteraction init](&v15, "init");
  v9 = v8;
  if (v8)
  {
...
- (void)_hoverGesture:(id)a3
{
  if (self->_gestureRecognizer == a3)
    -[TUIHoverInteraction _updateState](self, "_updateState");
}
...
- (id)activeRegions
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[NSSet allObjects](self->_regionState, "allObjects"));
...
{
  void (**v4)(id, TUIHoverInteraction *);
...
{
  void (**v6)(id, _TUIHoverRegionBuilder *);
  _TUIHoverRegionBuilder *v7;
  void *v8;
  id v9;
  void *v10;
  id v11;
  ...
  v11 = a3;
  v6 = (void (**)(id, _TUIHoverRegionBuilder *))a4;
  v7 = objc_alloc_init(_TUIHoverRegionBuilder);
  if (v6)
    v6[2](v6, v7);
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[_TUIHoverRegionBuilder bounds](v7, "bounds"));
  v9 = objc_msgSend(v8, "count");

  if (v9)
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[_TUIHoverRegionBuilder bounds](v7, "bounds"));
...
- (void)_updateSettled
{
  ...
  if (self->_checkSettled)
  {
    ...
    -[TUIHoverInteraction _checkIfSettledWithTime:](self, "_checkIfSettledWithTime:", v3);
  }
}
...
- (void)_updateState
{
  ...
  v3 = -[TUIHoverInteraction isHovering](self, "isHovering");
  if ((char *)-[UIHoverGestureRecognizer state](self->_gestureRecognizer, "state") - 1 <= (_BYTE *)&dword_0 + 1)
    -[TUIHoverInteraction _updateSettled](self, "_updateSettled");
...
{
  return (TUIHoverInteractionDelegate *)objc_loadWeakRetained((id *)&self->_delegate);
}
