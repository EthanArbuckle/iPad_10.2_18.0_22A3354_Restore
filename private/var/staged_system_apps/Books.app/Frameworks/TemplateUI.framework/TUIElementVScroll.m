...
{
  if (qword_2CB1C8 != -1)
    dispatch_once(&qword_2CB1C8, &stru_23DAD0);
  return (id)qword_2CB1C0;
}
...
+ (Class)objectClass
{
  return (Class)objc_opt_class(TUIVScrollBox, a2);
}
...
+ (void)configureObject:(id)a3 withBuilder:(id)a4 context:(id)a5
{
  ...
  v7 = a4;
  v8 = a5;
  v9 = objc_msgSend(v7, "finalizeModelsWithParent:box:context:", v16, v16, v8);
  if (objc_msgSend(v16, "acceptsDrop"))
  {
    ...
    if (v11)
    {
      ...
      v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "actionDelegate"));
      v15 = -[TUIElementActionTriggerHandler initWithActionsData:actionObject:actionDelegate:](v12, "initWithActionsData:actionObject:actionDelegate:", v10, v13, v14);
      objc_msgSend(v16, "setDropHandler:", v15);
