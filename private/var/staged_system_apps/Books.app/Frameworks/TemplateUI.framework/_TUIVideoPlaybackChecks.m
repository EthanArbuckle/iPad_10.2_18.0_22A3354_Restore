...
- (id)description
{
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("<_TUIVideoPlaybackChecks assetKeysLoaded: %d, playbackLikelyToKeepUp: %d, itemIsReadyToPlay: %d, playerHasNoWaitingReason: %d>"), self->_assetKeysLoaded, self->_playbackLikelyToKeepUp, self->_itemIsReadyToPlay, self->_playerHasNoWaitingReason);
}
