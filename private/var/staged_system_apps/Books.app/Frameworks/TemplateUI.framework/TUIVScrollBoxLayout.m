...
{
  TUIVScrollBoxLayout *v5;
  TUIVScrollBoxLayout *v6;
  uint64_t v7;
  objc_super v9;
...
- (void)computeLayout
{
  ...
  v17 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "firstObject"));

  v8 = (void *)objc_claimAutoreleasedReturnValue(-[TUILayout layoutAncestor](self, "layoutAncestor"));
  v9 = objc_msgSend(v8, "shouldUpdateContainingMetricsForScrollableContent");

  if (v9)
    objc_msgSend(v17, "setContainingWidth:", v4);
  objc_msgSend(v17, "validateLayout");
  if ((objc_opt_respondsToSelector(v17, "layoutScrollContentScrollSizeWithProposedSize:") & 1) != 0)
  {
    objc_msgSend(v17, "layoutScrollContentScrollSizeWithProposedSize:", v4, v6);
    v4 = v10;
    v6 = v11;
  }
  -[TUILayout setComputedNaturalSize:](self, "setComputedNaturalSize:", v4, v6);
  v12 = -[TUIAnchorSet initWithAxis:]([TUIMutableAnchorSet alloc], "initWithAxis:", 2);
  v13 = (void *)objc_claimAutoreleasedReturnValue(-[TUILayout box](self, "box"));
  objc_msgSend(v13, "anchorOffset");
  -[TUIAnchorSet setOffset:](v12, "setOffset:");

  v14 = (void *)objc_claimAutoreleasedReturnValue(-[TUILayout controller](self, "controller"));
  objc_msgSend(v14, "contentsScale");
  -[TUIMutableAnchorSet finalizeWithContentsScale:](v12, "finalizeWithContentsScale:");

  -[TUILayout appendChildAnchorsToSet:inRoot:](self, "appendChildAnchorsToSet:inRoot:", v12, self);
  v15 = (TUIAnchorSet *)-[TUIMutableAnchorSet copy](v12, "copy");
...
{
  if ((objc_opt_respondsToSelector(a3, "layoutScrollContentScrollSizeWithProposedSize:") & 1) != 0)
...
- (CGRect)computedErasableBounds
{
  ...
  -[TUILayout computedErasableBounds](&v21, "computedErasableBounds");
  v4 = v3;
  v6 = v5;
  v8 = v7;
  v10 = v9;
  ...
  if ((objc_opt_respondsToSelector(v16, "layoutScrollContentShouldClipVertically") & 1) != 0
    && !objc_msgSend(v16, "layoutScrollContentShouldClipVertically"))
  {
    v14 = v10;
    v12 = v6;
  }
...
- (id)newRenderModelCompatibleWithKind:(unint64_t)a3 context:(id)a4
{
  ...
  double v33;
  double v34;
  TUIRenderUpdateCollectionController *v35;
  void *v36;
  void *v37;
  void *v38;
  unsigned __int8 v39;
  ...
  {
    v7 = objc_claimAutoreleasedReturnValue(-[TUIVScrollBoxLayout _embeddedCollectionModelWithContext:](self, "_embeddedCollectionModelWithContext:", v6));
    ...
    v36 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "uid"));
    v37 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "UUID"));
    v50 = (void *)objc_claimAutoreleasedReturnValue(-[TUILayout box](self, "box"));
    v38 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v50, "identifier"));
    v47 = (void *)objc_claimAutoreleasedReturnValue(-[TUIVScrollBoxLayout modelIdentifierForScrollable](self, "modelIdentifierForScrollable"));
    ...
    v48 = (void *)objc_claimAutoreleasedReturnValue(-[TUILayout box](self, "box"));
    v39 = objc_msgSend(v48, "acceptsDrop");
    v51 = v6;
    ...
    LOBYTE(v45) = v39;
    v26 = (void *)objc_claimAutoreleasedReturnValue(+[TUIEmbeddedCollectionView renderModelWithUpdateController:uid:UUID:identifier:scrollIdentifier:ancestorScrollIdentifier:scrollPolicy:pageGap:gradientInsets:gradientFraction:acceptsDrop:dropHandler:decelerationRate:](TUIEmbeddedCollectionView, "renderModelWithUpdateController:uid:UUID:identifier:scrollIdentifier:ancestorScrollIdentifier:scrollPolicy:pageGap:gradientInsets:gradientFraction:acceptsDrop:dropHandler:decelerationRate:", v35, v36, v37, v38, v47, v46, 0.0, top, left, bottom, right, v53, *(_QWORD *)&v30, *(_QWORD *)&v29, *(_QWORD *)&v28,
                      *(_QWORD *)&v27,
                      v45,
                      v41,
                      v43));
    ...
    v6 = v51;
    -[TUILayout renderModelSizeWithContext:](self, "renderModelSizeWithContext:", v51);
...
- (void)validateRenderModelWithContext:(id)a3 transactionGroup:(id)a4
{
  ...
  v6 = a4;
  v7 = (id)objc_claimAutoreleasedReturnValue(-[TUIVScrollBoxLayout _embeddedCollectionModelWithContext:](self, "_embeddedCollectionModelWithContext:", a3));
