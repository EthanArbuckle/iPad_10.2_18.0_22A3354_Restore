...
- (id)tui_deepCopyLayer
{
  ...
  if (v3)
  {
      ...
      if (v6)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v12 = objc_msgSend(v8, "tui_deepCopyLayer");
            if (v12)
    ...
    if (v13)
    {
      v15 = objc_msgSend(v13, "tui_deepCopyLayer");
      if (v15)
    ...
    v38 = 0u;
    v39 = 0u;
    v16 = (void *)objc_claimAutoreleasedReturnValue(-[CALayer tui_propertiesToCopy](self, "tui_propertiesToCopy", v14));
...
- (id)tui_propertiesToCopy
{
  ...
  if (!qword_2CB1F0)
    qword_2CB1F0 = (uint64_t)NSClassFromString(CFSTR("CAShapeLayer"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[CALayer tui_basicPropertiesToCopy](self, "tui_basicPropertiesToCopy"));
...
LABEL_11:
  ...
  if ((objc_opt_isKindOfClass(self, qword_2CB1F0) & 1) != 0)
  {
    v6 = &off_252290;
    goto LABEL_11;
  }
...
- (id)tui_allLayersInTree
{
  ...
  -[CALayer tui_addLayerAndSublayersToArray:allowHiddenLayers:](self, "tui_addLayerAndSublayersToArray:allowHiddenLayers:", v3, 1);
  return v3;
}
...
- (void)tui_addLayerAndSublayersToArray:(id)a3 allowHiddenLayers:(BOOL)a4
{
  ...
  if (v4 || !-[CALayer isHidden](self, "isHidden"))
  {
    ...
    if (v7)
    {
      ...
      objc_msgSend(v8, "tui_addLayerAndSublayersToArray:allowHiddenLayers:", v6, v4);
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(*(id *)(*((_QWORD *)&v14 + 1) + 8 * (_QWORD)v13), "tui_addLayerAndSublayersToArray:allowHiddenLayers:", v6, v4);
          v13 = (char *)v13 + 1;
        }
        while (v11 != v13);
...
- (id)tui_allAnimationsInTree
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[CALayer tui_allLayersInTree](self, "tui_allLayersInTree"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSMutableArray array](NSMutableArray, "array"));
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
...
- (id)tui_uniqueAnimationKeyWithPrefix:(id)a3
{
  ...
  {
    v7 = v5;
    v5 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", CFSTR("%@-%lu"), v4, v6);

    v8 = (void *)objc_claimAutoreleasedReturnValue(-[CALayer animationForKey:](self, "animationForKey:", v5));
    ++v6;
  }
  while (v8);
