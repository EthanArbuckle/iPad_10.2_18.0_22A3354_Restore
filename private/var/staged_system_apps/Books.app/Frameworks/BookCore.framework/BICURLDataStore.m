...
- (BICURLDataStore)initWithCachePath:(id)a3
{
  ...
  v23.receiver = self;
  v23.super_class = (Class)BICURLDataStore;
  v3 = -[BICURLDataStore init](&v23, "init", a3);
  if (v3)
  {
    ...
    -[BICWorkQueue setIdentifier:](v3->_workQueue, "setIdentifier:", CFSTR("URLDataStore"));
...
- (BOOL)canStoreDescribedImage:(id)a3
{
  ...
  if (v4)
  {
    v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "urlString"));
    v6 = objc_msgSend(v5, "isEqualToString:", CFSTR("test")) ^ 1;
...
- (void)afterAllStoreOperationsCompletedPerformBlock:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[BICURLDataStore workQueue](self, "workQueue"));
  ...
  v7 = v4;
  v9 = v7;
  objc_msgSend(v6, "addWorkItemWithPriority:description:block:", v5, CFSTR("URLDataStore after all ops"), v8);
...
- (void)fetchImagesForEntry:(id)a3 forRequest:(id)a4 completion:(id)a5
{
  ...
  if (v12)
  {
    v13 = (void *)objc_claimAutoreleasedReturnValue(-[BICURLDataStore delegate](self, "delegate"));
    v14 = objc_msgSend(v13, "canFetchCoverForURL:", v12);
    objc_initWeak(&location, self);
    v15 = BICCacheStatsOperationNetworkDownloadQueueStart;
    if (v14)
      v15 = BICCacheStatsOperationNetworkDownloadQueueStartFromDataSource;
    +[BICCacheStats logOperation:forRequest:](BICCacheStats, "logOperation:forRequest:", *v15, v9);
    v16 = (void *)objc_claimAutoreleasedReturnValue(-[BICURLDataStore completionQueue](self, "completionQueue"));
    v17 = (void *)objc_claimAutoreleasedReturnValue(-[BICURLDataStore workQueue](self, "workQueue"));
    ...
    v19 = v16;
    v27 = v19;
    objc_msgSend(v17, "addWorkItemWithPriority:description:block:", v23, CFSTR("URLDataStore read"), v22);
