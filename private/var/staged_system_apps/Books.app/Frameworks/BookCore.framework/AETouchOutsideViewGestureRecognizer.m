...
- (AETouchOutsideViewGestureRecognizer)initWithTarget:(id)a3 action:(SEL)a4 watchView:(id)a5
{
  id v8;
  id v9;
  AETouchOutsideViewGestureRecognizer *v10;
  AETouchOutsideViewGestureRecognizer *v11;
  NSMutableSet *v12;
  ...
  v10 = -[AETouchOutsideViewGestureRecognizer initWithTarget:action:](&v15, "initWithTarget:action:", 0, 0);
  v11 = v10;
  if (v10)
  {
    ...
    -[AETouchOutsideViewGestureRecognizer setDelegate:](v11, "setDelegate:", v11);
    -[AETouchOutsideViewGestureRecognizer addTarget:action:](v11, "addTarget:action:", v8, a4);
  }
...
- (void)dealloc
{
  ...
  -[AETouchOutsideViewGestureRecognizer dealloc](&v4, "dealloc");
}

- (void)addTarget:(id)a3 action:(SEL)a4
{
  id v6;
  AETouchOutsideViewGestureRecognizerTarget *v7;

  v6 = a3;
  v7 = objc_alloc_init(AETouchOutsideViewGestureRecognizerTarget);
  -[AETouchOutsideViewGestureRecognizerTarget setTarget:](v7, "setTarget:", v6);

  -[AETouchOutsideViewGestureRecognizerTarget setAction:](v7, "setAction:", a4);
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (!v6
          || (v13 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(*(id *)(*((_QWORD *)&v24 + 1) + 8 * (_QWORD)v11), "target")),
              v13,
              v13 == v6))
        {
          if (!a4 || objc_msgSend(v12, "action") == a4)
  ...
  if (v15)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NSMutableSet removeObject:](self->mTargets, "removeObject:", *(_QWORD *)(*((_QWORD *)&v20 + 1) + 8 * (_QWORD)v18));
        v18 = (char *)v18 + 1;
      }
      while (v16 != v18);
...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = (void *)objc_claimAutoreleasedReturnValue(-[AETouchOutsideViewGestureRecognizer watchView](self, "watchView"));
  v9 = v8;
  if (v8)
  {
    ...
    if (v19)
    {
      ...
      do
      {
        for (i = 0; i != v20; i = (char *)i + 1)
        {
          ...
          objc_msgSend(*(id *)(*((_QWORD *)&v51 + 1) + 8 * (_QWORD)i), "locationInView:", v9);
          v58.x = v24;
          v58.y = v25;
          v59.origin.x = v11;
          v59.origin.y = v13;
  ...
  v47 = 0u;
  v48 = 0u;
  v27 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "allTouches"));
  ...
  if (v28)
  {
    ...
    do
    {
      for (j = 0; j != v29; j = (char *)j + 1)
      {
        ...
        v30 |= objc_msgSend(v6, "containsObject:", *(_QWORD *)(*((_QWORD *)&v47 + 1) + 8 * (_QWORD)j)) ^ 1;
      }
    ...
    if (v34)
    {
      ...
      do
      {
        for (k = 0; k != v35; k = (char *)k + 1)
        {
          ...
          v38 = *(void **)(*((_QWORD *)&v43 + 1) + 8 * (_QWORD)k);
          v39 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v38, "target"));
  ...
  if (v26 & 1 | ((v30 & 1) == 0))
    ...
    v40 = 1;
  -[AETouchOutsideViewGestureRecognizer setState:](self, "setState:", v40);
