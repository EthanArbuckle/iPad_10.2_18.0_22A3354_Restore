...
- (id)anyFrameJavascript:(int64_t)a3
{
  ...
  if (a3)
    ...
    v5 = (void *)objc_claimAutoreleasedReturnValue(+[image_filtering source](image_filtering, "source", v3, v4));
  return v5;
}
...
- (id)anyFrameJavascriptURL:(int64_t)a3
{
  ...
  {
    v4 = (void *)objc_claimAutoreleasedReturnValue(+[image_filtering sourceName](image_filtering, "sourceName"));
