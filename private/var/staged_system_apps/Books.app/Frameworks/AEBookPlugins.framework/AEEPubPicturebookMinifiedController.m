...
{
  id v5;
  AEEPubPicturebookMinifiedController *v6;
  AEEPubPicturebookMinifiedController *v7;
  objc_super v9;

  v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)AEEPubPicturebookMinifiedController;
  v6 = -[AEEPubPicturebookMinifiedController init](&v9, "init");
  v7 = v6;
  if (v6)
...
- (void)minifiedControllerWillUnloadAsset
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[AEEPubPicturebookMinifiedController minifiedControllerLoadedAssetViewController](self, "minifiedControllerLoadedAssetViewController"));
  objc_msgSend(v3, "close:", 0);

  v4 = (void *)objc_claimAutoreleasedReturnValue(-[AEEPubPicturebookMinifiedController minifiedControllerLoadedAssetViewController](self, "minifiedControllerLoadedAssetViewController"));
  v5 = objc_opt_respondsToSelector(v4, "assetViewControllerWillUnload");

  if ((v5 & 1) != 0)
  {
    v6 = (id)objc_claimAutoreleasedReturnValue(-[AEEPubPicturebookMinifiedController minifiedControllerLoadedAssetViewController](self, "minifiedControllerLoadedAssetViewController"));
...
- (void)minifiedControllerSaveState
{
  ...
  v2 = (id)objc_claimAutoreleasedReturnValue(-[AEEPubPicturebookMinifiedController minifiedControllerLoadedAssetViewController](self, "minifiedControllerLoadedAssetViewController"));
