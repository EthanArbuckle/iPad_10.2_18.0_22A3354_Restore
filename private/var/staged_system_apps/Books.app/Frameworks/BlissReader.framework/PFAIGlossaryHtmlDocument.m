...
+ (id)elementReaders
{
  ...
  if (!qword_5436E0)
  {
    ...
    if (!qword_5436E0)
    {
      ...
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:", "body", PFXCommonXhtmlNS[0], objc_opt_class(PFAIGlossaryBody));
      ...
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:", "aside", PFXCommonXhtmlNS[0], objc_opt_class(PFXFallthroughReader));
      ...
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:", "dt", PFXCommonXhtmlNS[0], objc_opt_class(PFAIGlossaryDefinitions));
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:", "dd", PFXCommonXhtmlNS[0], objc_opt_class(PFAIGlossaryDefinitions));
      ...
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:", "image", PFXCommonSvgNS[0], objc_opt_class(PFXImage));
      ...
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:", "object", PFXCommonXhtmlNS[0], objc_opt_class(PFAIGlossaryObject));
      __dmb(0xBu);
      qword_5436E0 = (uint64_t)v4;
    }
    objc_sync_exit(a1);
    return (id)qword_5436E0;
  }
  return result;
}
