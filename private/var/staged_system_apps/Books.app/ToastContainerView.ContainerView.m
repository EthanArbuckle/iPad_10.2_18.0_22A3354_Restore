...
- (void)didMoveToSuperview
{
  ...
  v2 = (char *)v4.receiver;
  -[ToastContainerView.ContainerView didMoveToSuperview](&v4, "didMoveToSuperview");
  Strong = (void *)swift_unknownObjectWeakLoadStrong(&v2[OBJC_IVAR____TtCC5Books18ToastContainerViewP33_4DBEA752A9924E02BEA433C77282CE1A13ContainerView_layoutDelegate]);
...
- (_TtCC5Books18ToastContainerViewP33_4DBEA752A9924E02BEA433C77282CE1A13ContainerView)initWithFrame:(CGRect)a3
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  swift_unknownObjectWeakInit((char *)self+ OBJC_IVAR____TtCC5Books18ToastContainerViewP33_4DBEA752A9924E02BEA433C77282CE1A13ContainerView_layoutDelegate);
  v9.receiver = self;
...
- (_TtCC5Books18ToastContainerViewP33_4DBEA752A9924E02BEA433C77282CE1A13ContainerView)initWithCoder:(id)a3
{
  ...
  return -[ToastContainerView.ContainerView initWithCoder:](&v6, "initWithCoder:", a3);
}

- (void).cxx_destruct
{
  swift_unknownObjectWeakDestroy((char *)self+ OBJC_IVAR____TtCC5Books18ToastContainerViewP33_4DBEA752A9924E02BEA433C77282CE1A13ContainerView_layoutDelegate);
}
