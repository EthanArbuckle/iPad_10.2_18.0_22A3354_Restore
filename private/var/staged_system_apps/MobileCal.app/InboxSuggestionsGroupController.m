...
- (id)titleForHeader
{
  ...
  *(_QWORD *)&v2 = objc_opt_class(self).n128_u64[0];
  ...
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "localizedStringForKey:value:table:", CFSTR("Siri Suggestions"), &stru_1001B67C0, 0));
...
- (id)filteredNotificationsFromArray:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[NSPredicate predicateWithBlock:](NSPredicate, "predicateWithBlock:", &stru_1001B55A0));
