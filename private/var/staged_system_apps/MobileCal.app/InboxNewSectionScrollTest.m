...
- (InboxNewSectionScrollTest)initWithApplication:(id)a3 model:(id)a4 options:(id)a5
{
  ...
  v9 = a5;
  v18.receiver = self;
  v18.super_class = (Class)InboxNewSectionScrollTest;
...
- (void)dealloc
{
  ...
  objc_msgSend(v3, "removeObserver:name:object:", self, CFSTR("InboxNewSectionViewController_ViewDidAppearNotification"), 0);

  v4.receiver = self;
  v4.super_class = (Class)InboxNewSectionScrollTest;
  -[InboxNewSectionScrollTest dealloc](&v4, "dealloc");
}
...
- (void)_inboxDidAppear:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "showNewSection"));
