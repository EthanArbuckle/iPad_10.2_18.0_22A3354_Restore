...
{
  return (ConfigurationIntentResponse *)sub_1000ABA58((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (ConfigurationIntentResponse)initWithBackingStore:(id)a3
{
  return (ConfigurationIntentResponse *)sub_1000ABA58((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
