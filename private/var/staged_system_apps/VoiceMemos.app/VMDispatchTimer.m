...
- (id)init:(double)a3 leeway:(double)a4 queue:(id)a5 block:(id)a6
{
  ...
  v13 = -[VMDispatchTimer init](&v20, "init");
  v14 = v13;
  if (!v13)
    goto LABEL_4;
  objc_storeStrong((id *)&v13->_queue, a5);
  v14->_interval = a3;
  v15 = dispatch_source_create((dispatch_source_type_t)&_dispatch_source_type_timer, 0, 0, v11);
...
- (void)dealloc
{
  ...
  -[VMDispatchTimer dealloc](&v3, "dealloc");
}
