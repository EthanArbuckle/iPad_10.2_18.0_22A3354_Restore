...
- (SecurityAccessoryConfigurationIntent)init
{
  ...
  return -[SecurityAccessoryConfigurationIntent init](&v3, "init");
}
...
- (SecurityAccessoryConfigurationIntent)initWithCoder:(id)a3
{
  ...
  return -[SecurityAccessoryConfigurationIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (SecurityAccessoryConfigurationIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  NSString v9;
  id v10;
  SecurityAccessoryConfigurationIntent *v11;
  objc_super v13;
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for SecurityAccessoryConfigurationIntent();
  v11 = -[SecurityAccessoryConfigurationIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (SecurityAccessoryConfigurationIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for SecurityAccessoryConfigurationIntent();
  v15 = -[SecurityAccessoryConfigurationIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
