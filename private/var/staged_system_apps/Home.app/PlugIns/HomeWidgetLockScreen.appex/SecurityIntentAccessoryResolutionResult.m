...
+ (id)successWithResolvedObject:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "HomeWidgetLockScreen/SecurityIntentAccessory.swift", 50, 2, 47, 0);
  __break(1u);
  return result;
}
...
+ (id)disambiguationWithObjectsToDisambiguate:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "HomeWidgetLockScreen/SecurityIntentAccessory.swift", 50, 2, 52, 0);
  __break(1u);
  return result;
}
...
+ (id)confirmationRequiredWithObjectToConfirm:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "HomeWidgetLockScreen/SecurityIntentAccessory.swift", 50, 2, 57, 0);
  __break(1u);
  return result;
}
...
- (SecurityIntentAccessoryResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  id v7;
  Class isa;
  SecurityIntentAccessoryResolutionResult *v9;
  SecurityIntentAccessoryResolutionResult *v10;
  objc_super v12;
  ...
  swift_bridgeObjectRelease(v6);
  v12.receiver = self;
  v12.super_class = (Class)type metadata accessor for SecurityIntentAccessoryResolutionResult();
  v9 = -[SecurityIntentAccessoryResolutionResult initWithJSONDictionary:forIntent:](&v12, "initWithJSONDictionary:forIntent:", isa, v7);
