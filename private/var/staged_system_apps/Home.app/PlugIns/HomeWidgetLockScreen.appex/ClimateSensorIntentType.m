...
- (ClimateSensorIntentType)initWithIdentifier:(id)a3 displayString:(id)a4 pronunciationHint:(id)a5
{
  ...
  return (ClimateSensorIntentType *)ClimateSensorIntentType.init(identifier:display:pronunciationHint:)(v7, v9, v10, v12, v13, v15);
}
...
- (ClimateSensorIntentType)initWithCoder:(id)a3
{
  ...
  return -[ClimateSensorIntentType initWithCoder:](&v5, "initWithCoder:", a3);
}
