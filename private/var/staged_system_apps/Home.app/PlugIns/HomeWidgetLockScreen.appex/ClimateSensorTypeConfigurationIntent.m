...
- (ClimateSensorTypeConfigurationIntent)init
{
  ...
  return -[ClimateSensorTypeConfigurationIntent init](&v3, "init");
}
...
- (ClimateSensorTypeConfigurationIntent)initWithCoder:(id)a3
{
  ...
  return -[ClimateSensorTypeConfigurationIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (ClimateSensorTypeConfigurationIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  NSString v9;
  id v10;
  ClimateSensorTypeConfigurationIntent *v11;
  objc_super v13;
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for ClimateSensorTypeConfigurationIntent();
  v11 = -[ClimateSensorTypeConfigurationIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (ClimateSensorTypeConfigurationIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for ClimateSensorTypeConfigurationIntent();
  v15 = -[ClimateSensorTypeConfigurationIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
