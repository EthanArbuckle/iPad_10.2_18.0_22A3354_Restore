...
{
  return (ClimateSensorTypeConfigurationIntentResponse *)sub_10005D6F0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (ClimateSensorTypeConfigurationIntentResponse)initWithBackingStore:(id)a3
{
  return (ClimateSensorTypeConfigurationIntentResponse *)sub_10005D6F0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
