...
- (SecurityAccessoryConfigurationIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  SecurityAccessoryConfigurationIntentResponse *v8;
  objc_super v10;

  v6 = a4;
  v10.receiver = self;
  v10.super_class = (Class)SecurityAccessoryConfigurationIntentResponse;
  v7 = -[SecurityAccessoryConfigurationIntentResponse init](&v10, "init");
  v8 = v7;
  if (v7)
  {
    v7->_code = a3;
    -[SecurityAccessoryConfigurationIntentResponse setUserActivity:](v7, "setUserActivity:", v6);
  }
