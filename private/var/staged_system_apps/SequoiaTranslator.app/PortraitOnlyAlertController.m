...
- (_TtC17SequoiaTranslator27PortraitOnlyAlertController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  NSString v7;
  id v8;
  _TtC17SequoiaTranslator27PortraitOnlyAlertController *v9;
  objc_super v11;
  ...
  v9 = -[PortraitOnlyAlertController initWithNibName:bundle:](&v11, "initWithNibName:bundle:", v7, a4);
...
- (_TtC17SequoiaTranslator27PortraitOnlyAlertController)initWithCoder:(id)a3
{
  ...
  return -[PortraitOnlyAlertController initWithCoder:](&v5, "initWithCoder:", a3);
}
