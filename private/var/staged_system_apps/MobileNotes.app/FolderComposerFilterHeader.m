...
- (void)_bridgedUpdateConfigurationUsingState:(id)a3
{
  ...
  uint64_t v12;
  char *v13;
  _TtC11MobileNotes26FolderComposerFilterHeader *v14;
  uint64_t v15;
  uint64_t v16;
  _QWORD *v17;
  _QWORD v19[5];
  ...
  v16 = *(_QWORD *)&v14->text[OBJC_IVAR____TtC11MobileNotes26FolderComposerFilterHeader_text];
...
- (_TtC11MobileNotes26FolderComposerFilterHeader)initWithCoder:(id)a3
{
  ...
  *v6 = 0;
  ...
  return -[FolderComposerFilterHeader initWithCoder:](&v8, "initWithCoder:", a3);
}

- (void).cxx_destruct
{
  swift_bridgeObjectRelease(*(_QWORD *)&self->text[OBJC_IVAR____TtC11MobileNotes26FolderComposerFilterHeader_text]);
}
