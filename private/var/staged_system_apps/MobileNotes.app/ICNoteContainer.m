...
- (void)undoablySetOrder:(unint64_t)a3 ofChild:(id)a4
{
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Set Folder Order"), &stru_1005704B8, 0));
...
- (void)undoablyRemoveFromOrder:(id)a3
{
  ...
  v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("Remove Folder Order"), &stru_1005704B8, 0));
