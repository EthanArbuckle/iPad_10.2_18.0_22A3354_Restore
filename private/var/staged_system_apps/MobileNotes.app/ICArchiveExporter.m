...
- (id)createArchiveForObjects:(id)a3 progress:(id)a4 error:(id *)a5
{
  ...
  v12 = sub_1000163BC(0, (unint64_t *)&qword_1005D9080, ICCloudSyncingObject_ptr);
  v13 = static Array._unconditionallyBridgeFromObjectiveC(_:)(a3, v12);
  v14 = self;
  v15 = a4;
  v16 = sub_10036E9F8(v13, (uint64_t)v14);
  sub_100360AB8((uint64_t)v16, (uint64_t)v15, (uint64_t)v11);
...
- (void).cxx_destruct
{
  swift_release(*(Class *)((char *)&self->super.isa + OBJC_IVAR___ICArchiveExporter_exporter));
}
