@implementation FolderComposerFilterCellAttachments

- (_TtC11MobileNotes35FolderComposerFilterCellAttachments)initWithFrame:(CGRect)a3
{
  return (_TtC11MobileNotes35FolderComposerFilterCellAttachments *)sub_10012F684(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC11MobileNotes35FolderComposerFilterCellAttachments)initWithCoder:(id)a3
{
  return (_TtC11MobileNotes35FolderComposerFilterCellAttachments *)sub_10012F788(a3);
}

- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC11MobileNotes35FolderComposerFilterCellAttachments____lazy_storage___menu));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.super.isa
