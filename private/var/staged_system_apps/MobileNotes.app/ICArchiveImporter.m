...
{
  _TtC11MobileNotes17ICArchiveImporter *result;
  _TtC11MobileNotes17ICArchiveImporter *v4;
  id v5;
  _TtC11MobileNotes17ICArchiveImporter *v6;

  result = (_TtC11MobileNotes17ICArchiveImporter *)objc_msgSend((id)objc_opt_self(ICNoteContext), "sharedContext");
  if (result
    && (v4 = result,
...
- (_TtC11MobileNotes17ICArchiveImporter)initWithContext:(id)a3
{
  ...
  _BYTE *v11;
  __int16 v12;
  _TtC11MobileNotes17ICArchiveImporter *v13;
  uint64_t v14;
  ...
  if (v10)
    ...
    v12 = 0;
  v13 = (_TtC11MobileNotes17ICArchiveImporter *)sub_10021DFC4(v7, v12 | IsAlexandriaDemoModeEnabled, 0, 0, v8, v11, 0.0);
...
- (void)dealloc
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_didReceiveMemoryWarningObserver, v10, 0, 0);
  sub_100012CE8((uint64_t)v4, (uint64_t)v9, &qword_1005CF190);
  v5 = (void *)objc_opt_self(NSNotificationCenter);
  v6 = self;
  v7 = objc_msgSend(v5, "defaultCenter");
  sub_10021E28C((uint64_t)v9, v7);
...
- (void).cxx_destruct
{
  ...
  swift_unknownObjectRelease(*(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_fileManager), v3);
  swift_bridgeObjectRelease(*(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_errors));
  sub_100012DDC((uint64_t)self + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_didReceiveMemoryWarningObserver, &qword_1005CF190);
}
...
- (NSDictionary)errors
{
  ...
  v2 = (uint64_t *)((char *)self + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_errors);
  swift_beginAccess((char *)self + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_errors, v6, 0, 0);
  v3 = *v2;
...
- (void)setErrors:(id)a3
{
  ...
  v9 = (uint64_t *)((char *)self + OBJC_IVAR____TtC11MobileNotes17ICArchiveImporter_errors);
...
- (BOOL)importArchiveAtURL:(id)a3 intoNoteContainerWithID:(id)a4 progress:(id)a5 error:(id *)a6
{
  ...
  id v14;
  id v15;
  _TtC11MobileNotes17ICArchiveImporter *v16;
  _BYTE v18[16];
  _TtC11MobileNotes17ICArchiveImporter *v19;
  id v20;
  _BYTE *v21;
  id v22;
  ...
  v15 = a5;
  v16 = self;
  NSManagedObjectContext.performAndWait<A>(_:)(sub_10021FE4C, v18, (char *)&type metadata for () + 8);
