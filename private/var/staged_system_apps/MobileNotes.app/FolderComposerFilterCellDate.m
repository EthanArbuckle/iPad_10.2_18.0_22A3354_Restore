...
{
  return (_TtC11MobileNotes28FolderComposerFilterCellDate *)sub_1003593A4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC11MobileNotes28FolderComposerFilterCellDate)initWithCoder:(id)a3
{
  return (_TtC11MobileNotes28FolderComposerFilterCellDate *)sub_1003594CC(a3);
}
