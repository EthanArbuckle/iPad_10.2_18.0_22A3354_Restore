...
- (void)undoablySetFolder:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
          ...
          (objc_msgSend(v8, "isTrashFolder") & 1) != 0))
    {
      ...
      v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "localizedStringForKey:value:table:", CFSTR("Trash Note"), &stru_1000DAF38, 0));
    ...
    else
    {
      ...
      v11 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("Move Note"), &stru_1000DAF38, 0));
...
+ (id)undoablyDuplicateNotes:(id)a3
{
    ...
    && (+[ICNote containsUnduplicatableNotes:](ICNote, "containsUnduplicatableNotes:", v3) & 1) == 0)
  {
    ...
    v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "localizedStringForKey:value:table:", CFSTR("Duplicate Notes"), &stru_1000DAF38, 0));
...
- (id)undoablyDuplicate
{
  ...
  if (-[ICNote isDuplicatable](self, "isDuplicatable"))
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localizedStringForKey:value:table:", CFSTR("Duplicate Note"), &stru_1000DAF38, 0));
