...
+ (id)sharedManager
{
  if (qword_1000ED6E0 != -1)
    dispatch_once(&qword_1000ED6E0, &stru_1000D6748);
  return (id)qword_1000ED6E8;
}
...
- (id)mediaUTIs
{
  if (qword_1000ED6F8[0] != -1)
    dispatch_once(qword_1000ED6F8, &stru_1000D68A8);
  return (id)qword_1000ED6F0;
}
