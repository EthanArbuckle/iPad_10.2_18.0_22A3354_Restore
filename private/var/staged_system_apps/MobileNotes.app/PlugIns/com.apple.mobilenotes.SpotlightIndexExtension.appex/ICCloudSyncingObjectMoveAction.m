...
- (ICCloudSyncingObjectMoveAction)init
{
  ...
  result = (ICCloudSyncingObjectMoveAction *)_swift_stdlib_reportUnimplementedInitializer("com_apple_mobilenotes_SpotlightIndexExtension.MoveAction", 56, "init()", 6, 0);
  __break(1u);
  return result;
}
