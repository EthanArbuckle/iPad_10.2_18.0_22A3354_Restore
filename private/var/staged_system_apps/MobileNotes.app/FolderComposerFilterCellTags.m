...
{
  return (_TtC11MobileNotes28FolderComposerFilterCellTags *)sub_100132134(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC11MobileNotes28FolderComposerFilterCellTags)initWithCoder:(id)a3
{
  return (_TtC11MobileNotes28FolderComposerFilterCellTags *)sub_100132208(a3);
}
