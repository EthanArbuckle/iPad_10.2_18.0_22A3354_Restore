...
+ (void)importArchivesForCurrentLaunchConfigurationIfNeeded
{
  ...
  v4 = (void *)objc_claimAutoreleasedReturnValue(+[ICLaunchConfiguration currentConfiguration](ICLaunchConfiguration, "currentConfiguration"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "cloudAccountArchiveName"));

  if (v5)
  {
    v6 = (void *)objc_claimAutoreleasedReturnValue(+[ICAccount cloudKitAccountInContext:](ICAccount, "cloudKitAccountInContext:", v3));
    if (v6)
    {
      +[ICNoteContext importArchiveAtPath:intoAccount:](ICNoteContext, "importArchiveAtPath:intoAccount:", v5, v6);
    }
    else
    {
  ...
  v8 = (void *)objc_claimAutoreleasedReturnValue(+[ICLaunchConfiguration currentConfiguration](ICLaunchConfiguration, "currentConfiguration"));
  v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v8, "localAccountArchiveName"));

  if (v9)
  {
    +[ICNoteContext enableLocalAccount](ICNoteContext, "enableLocalAccount");
    v10 = (void *)objc_claimAutoreleasedReturnValue(+[ICAccount localAccountInContext:](ICAccount, "localAccountInContext:", v3));
    +[ICNoteContext importArchiveAtPath:intoAccount:](ICNoteContext, "importArchiveAtPath:intoAccount:", v9, v10);
...
- (id)importNoteFromFileAtURL:(id)a3
{
  ...
  v23 = 0;
  v24 = 0;
  v5 = objc_msgSend(objc_alloc((Class)NSAttributedString), "initWithURL:options:documentAttributes:error:", v4, &__NSDictionary0__struct, &v24, &v23);
  v6 = v24;
  v7 = v23;
  if (v7)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      sub_100405194((uint64_t)v4, (uint64_t)v7, v8);
    v9 = 0;
  }
  else
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[ICNoteContext managedObjectContext](self, "managedObjectContext"));
    v8 = objc_claimAutoreleasedReturnValue(+[ICFolder defaultFolderInContext:](ICFolder, "defaultFolderInContext:", v10));

    v9 = +[ICNote newEmptyNoteInFolder:](ICNote, "newEmptyNoteInFolder:", v8);
    objc_msgSend(v9, "updateChangeCountWithReason:", CFSTR("Imported test note"));
    v11 = objc_alloc_init((Class)ICTextController);
    v12 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "textStorage"));
    objc_msgSend(v12, "setStyler:", v11);

    v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "textStorage"));
    objc_msgSend(v13, "setConvertAttributes:", 1);

    v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "textStorage"));
    objc_msgSend(v14, "replaceCharactersInRange:withAttributedString:", 0, 0, v5);

    v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "textStorage"));
    objc_msgSend(v15, "setConvertAttributes:", 0);

    v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "textStorage"));
    objc_msgSend(v16, "setStyler:", 0);

    -[ICNoteContext randomNegativeIntervalWithMinDays:maxDays:](self, "randomNegativeIntervalWithMinDays:maxDays:", 1.0, 60.0);
    v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSDate dateWithTimeIntervalSinceNow:](NSDate, "dateWithTimeIntervalSinceNow:"));
    objc_msgSend(v9, "setModificationDate:", v17);

    -[ICNoteContext randomNegativeIntervalWithMinDays:maxDays:](self, "randomNegativeIntervalWithMinDays:maxDays:", 2.0, 30.0);
    v19 = v18;
    v20 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "modificationDate"));
    v21 = (void *)objc_claimAutoreleasedReturnValue(+[NSDate dateWithTimeInterval:sinceDate:](NSDate, "dateWithTimeInterval:sinceDate:", v20, v19));
...
+ (BOOL)isActive
{
  ...
  v3 = (char *)objc_msgSend(v2, "applicationState");
...
+ (id)beginBackgroundTaskNamed:(id)a3
{
  ...
  v13 = v3;
  v5 = v3;
  v6 = objc_msgSend(v4, "beginBackgroundTaskWithName:expirationHandler:", v5, &v9);

  v14 = v6;
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSValue value:withObjCType:](NSValue, "value:withObjCType:", &v14, "Q", v9, v10, v11, v12));
...
{
  void *v3;
  UIBackgroundTaskIdentifier v4;

  v4 = UIBackgroundTaskInvalid;
  objc_msgSend(a3, "getValue:", &v4);
  if (v4 != UIBackgroundTaskInvalid)
  {
    v3 = (void *)objc_claimAutoreleasedReturnValue(+[UIApplication sharedApplication](UIApplication, "sharedApplication"));
    objc_msgSend(v3, "endBackgroundTask:", v4);
...
+ (void)importArchiveAtPath:(id)a3 intoAccount:(id)a4
{
  ...
  void *v12;
  void *v13;
  _TtC11MobileNotes17ICArchiveImporter *v14;
  void *v15;
  id v16;
  NSObject *v17;
  _BOOL4 v18;
  ...
  if (v8)
  {
    v9 = (void *)objc_claimAutoreleasedReturnValue(+[NSURL fileURLWithPath:](NSURL, "fileURLWithPath:", v5));
  }
  else
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v11 = (void *)objc_claimAutoreleasedReturnValue(+[ICArchive packageExtension](ICArchive, "packageExtension"));
    v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "URLForResource:withExtension:", v5, v11));
  ...
  v14 = -[ICArchiveImporter initWithContext:]([_TtC11MobileNotes17ICArchiveImporter alloc], "initWithContext:", v13);
  v15 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "objectID"));
  v19 = 0;
  -[ICArchiveImporter importArchiveAtURL:intoNoteContainerWithID:progress:error:](v14, "importArchiveAtURL:intoNoteContainerWithID:progress:error:", v9, v15, 0, &v19);
  v16 = v19;
  ...
  {
    if (v18)
      sub_10040BE30((uint64_t)v16, (uint64_t)v6, v17);
  }
  else if (v18)
  {
    sub_10040BDBC((uint64_t)v6, v17);
  }
...
- (void)undoablyDeleteAttachment:(id)a3
{
  ...
  if ((objc_msgSend(v9, "markedForDeletion") & 1) == 0)
  {
    ...
    if ((v4 & 1) == 0)
    {
      ...
      v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "localizedStringForKey:value:table:", CFSTR("Delete Attachment"), &stru_1005704B8, 0));
...
- (id)undoablyCopyNote:(id)a3 toFolder:(id)a4 moveAction:(id)a5 actionName:(id)a6
{
  ...
  if (!v13)
  {
    ...
    v13 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Copy Note"), &stru_1005704B8, 0));
  ...
  if (v15)
  {
    ...
    if (v12 && (v18 & 1) == 0)
    {
      ...
      {
LABEL_9:
        v22 = (void *)objc_claimAutoreleasedReturnValue(+[NSUndoManager shared](NSUndoManager, "shared"));
        v23 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v22, "prepareWithInvocationTarget:", self));
        objc_msgSend(v23, "undoablyDeleteNote:moveAction:actionName:", v16, v12, v13);

        v24 = (void *)objc_claimAutoreleasedReturnValue(+[NSUndoManager shared](NSUndoManager, "shared"));
        objc_msgSend(v24, "setActionName:", v13);
...
- (id)undoablyCopyNotes:(id)a3 toFolder:(id)a4 actionName:(id)a5
{
  ...
  id v22;
  void *v23;
  ICCloudSyncingObjectMoveAction *v24;
  void *v25;
  void *v26;
  id v27;
  void *v29;
  ...
  if (!v32)
  {
    ...
    v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "localizedStringForKey:value:table:", CFSTR("Copy %lu Notes"), &stru_1005704B8, 0));
    v32 = (id)objc_claimAutoreleasedReturnValue(+[NSString localizedStringWithFormat:](NSString, "localizedStringWithFormat:", v10, objc_msgSend(v7, "count")));
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; i = (char *)i + 1)
      {
        ...
        v16 = ICCheckedProtocolCast(&OBJC_PROTOCOL___ICNoteUndoSupport, *(_QWORD *)(*((_QWORD *)&v33 + 1) + 8 * (_QWORD)i));
        v17 = (void *)objc_claimAutoreleasedReturnValue(v16);
        if (v17)
        {
          v18 = objc_opt_class(ICNote);
          v19 = ICDynamicCast(v18, v17);
          v20 = (void *)objc_claimAutoreleasedReturnValue(v19);
          v21 = v20;
          if (v8)
            v22 = v8;
          else
            v22 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v20, "folder"));
          v23 = v22;
          if (v21)
            v24 = -[ICCloudSyncingObjectMoveAction initWithNote:toFolder:isCopy:]([ICCloudSyncingObjectMoveAction alloc], "initWithNote:toFolder:isCopy:", v21, v22, 1);
          else
            v24 = 0;
          v25 = (void *)objc_claimAutoreleasedReturnValue(-[ICNoteContext undoablyCopyNote:toFolder:moveAction:actionName:](self, "undoablyCopyNote:toFolder:moveAction:actionName:", v17, v23, v24, v32));
          objc_msgSend(v31, "ic_addNonNilObject:", v25);
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue(+[NSUndoManager shared](NSUndoManager, "shared"));
  objc_msgSend(v26, "setActionName:", v32);

  v27 = objc_msgSend(v31, "copy");
  return v27;
}
...
- (id)adjustedDestinationFolderForNoteContainer:(id)a3 sourceFolder:(id)a4
{
  ...
  if (objc_msgSend(v8, "isSmartFolder") || !v8)
    v9 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "defaultFolder"));
  else
    v9 = v8;
  v10 = v9;
...
- (void)undoablyMoveNotes:(id)a3 toNoteContainer:(id)a4 actionName:(id)a5 workerContext:(id)a6 completionHandler:(id)a7
{
  ...
  if (!v14)
  {
    ...
    v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("Move %lu Notes"), &stru_1005704B8, 0));
...
- (void)undoablyDeleteNote:(id)a3 moveAction:(id)a4 actionName:(id)a5
{
  ...
  if ((objc_msgSend(v8, "markedForDeletion") & 1) == 0)
  {
    ...
    if (!v10)
    {
      ...
      {
        v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
        v10 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Delete Note"), &stru_1005704B8, 0));
...
- (void)undoablyUndeleteNote:(id)a3 moveAction:(id)a4 actionName:(id)a5
{
  ...
  else
  {
    ...
    v12 = objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "localizedStringForKey:value:table:", CFSTR("Delete Note"), &stru_1005704B8, 0));
  }
...
- (id)undoablyAddFolderToAccount:(id)a3 moveAction:(id)a4 actionName:(id)a5
{
  ...
  else
  {
    ...
    v13 = a3;
    v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
    v9 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v14, "localizedStringForKey:value:table:", CFSTR("Add Folder"), &stru_1005704B8, 0));
...
- (id)undoablyCopyFolder:(id)a3 toAccount:(id)a4 copyingNotes:(BOOL)a5 moveAction:(id)a6 actionName:(id)a7
{
  ...
  if (!v15)
  {
    ...
    v15 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v16, "localizedStringForKey:value:table:", CFSTR("Copy Folder"), &stru_1005704B8, 0));
  ...
  v19 = objc_opt_class(ICFolder);
  v20 = ICDynamicCast(v19, v12);
  v21 = (void *)objc_claimAutoreleasedReturnValue(v20);
  v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v21, "smartFolderQueryJSON"));
  objc_msgSend(v17, "setSmartFolderQueryJSON:", v22);
  ...
  if ((objc_msgSend(v10, "isDeletable") & 1) != 0)
  {
    if ((objc_msgSend(v10, "markedForDeletion") & 1) == 0)
    {
      if (!v12)
      {
        ...
        v12 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "localizedStringForKey:value:table:", CFSTR("Delete Folder"), &stru_1005704B8, 0));
...
- (void)undoablyUndeleteFolder:(id)a3 didMarkNotesForDeletion:(BOOL)a4 moveAction:(id)a5 actionName:(id)a6
{
  ...
  if (!v11)
  {
    ...
    v11 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "localizedStringForKey:value:table:", CFSTR("Delete Folder"), &stru_1005704B8, 0));
...
- (id)addNewNoteByCopyingNote:(id)a3 toFolder:(id)a4
{
  ...
  if ((objc_opt_isKindOfClass(v5, v7) & 1) != 0 && (objc_msgSend(v5, "isPasswordProtected") & 1) != 0)
  {
    v8 = v5;
    if (objc_msgSend(v8, "isAuthenticated"))
    {
      v9 = (id)objc_claimAutoreleasedReturnValue(+[ICNote duplicateNote:intoFolder:isPasswordProtected:removeOriginalNote:](ICNote, "duplicateNote:intoFolder:isPasswordProtected:removeOriginalNote:", v8, v6, 1, 0));
    }
    else
    {
  ...
  {
    v9 = +[ICNote newEmptyNoteInFolder:](ICNote, "newEmptyNoteInFolder:", v6);
    if ((objc_msgSend(v5, "copyValuesToNote:", v9) & 1) == 0)
      +[ICNote deleteNote:](ICNote, "deleteNote:", v9);
  }
  objc_msgSend(v9, "updateChangeCountWithReason:", CFSTR("Copied note"));
...
- (void)undoablyUnmoveNoteIDs:(id)a3 toFolderIDs:(id)a4 originalToCopyNoteIDs:(id)a5 actionName:(id)a6 noteToFolderIDsForRedo:(id)a7 workerContext:(id)a8
{
  ...
  v22 = v15;
  v23 = v14;
  -[ICNoteContext undoablyProcessNoteIDs:progressStringBlock:workerContext:processNoteBlock:completionHandler:](self, "undoablyProcessNoteIDs:progressStringBlock:workerContext:processNoteBlock:completionHandler:", v19, &stru_100555210, v16, v24, 0);
...
- (void)undoablyMoveNoteIDs:(id)a3 toFolderIDs:(id)a4 actionName:(id)a5 workerContext:(id)a6 completionHandler:(id)a7
{
  ...
  v25 = v39;
  v26 = v38;
  -[ICNoteContext undoablyProcessNoteIDs:progressStringBlock:workerContext:processNoteBlock:completionHandler:](self, "undoablyProcessNoteIDs:progressStringBlock:workerContext:processNoteBlock:completionHandler:", v15, &stru_100555258, v22, v36, v28);
