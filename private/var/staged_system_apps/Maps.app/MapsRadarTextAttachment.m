...
- (MapsRadarTextAttachment)initWithFileName:(id)a3 text:(id)a4
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315906;
      v19 = "-[MapsRadarTextAttachment initWithFileName:text:]";
      v20 = 2080;
  ...
  v17.receiver = self;
  v17.super_class = (Class)MapsRadarTextAttachment;
...
+ (id)attachmentWithFileName:(id)a3 text:(id)a4
{
  ...
  v6 = a4;
  v7 = a3;
  v8 = objc_msgSend(objc_alloc((Class)a1), "initWithFileName:text:", v7, v6);
...
- (id)temporaryFileURL
{
  ...
  if (!temporaryFileURL)
  {
    ...
    v9 = (void *)objc_claimAutoreleasedReturnValue(-[MapsRadarTextAttachment text](self, "text"));
    v19 = 0;
    v10 = objc_msgSend(v9, "writeToURL:atomically:encoding:error:", v5, 1, 4, &v19);
    v11 = v19;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v16 = (void *)objc_claimAutoreleasedReturnValue(-[MapsRadarTextAttachment text](self, "text"));
        *(_DWORD *)buf = 138413058;
        ...
        v26 = 2112;
        v27 = v11;
        _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_ERROR, "Failed to save file with name '%@' from text '%@' at path '%@': %@", buf, 0x2Au);
...
- (id)description
{
  MapsRadarTextAttachment *v2;
  id v3;
  void ***v4;
  MapsRadarTextAttachment *v5;
  MapsRadarTextAttachment *v6;
  objc_class *v7;
  NSString *v8;
  void *v9;
  void *v10;
  ...
  -[MapsRadarTextAttachment _maps_buildDescriptionWithBlock:](v2, "_maps_buildDescriptionWithBlock:", v4);
  v5 = v2;
  v6 = v5;
  if (!v5)
  {
  ...
  {
    v10 = (void *)objc_claimAutoreleasedReturnValue(-[MapsRadarTextAttachment performSelector:](v6, "performSelector:", "accessibilityIdentifier"));
    v11 = v10;
...
{
  void (**v4)(id, const __CFString *, NSString *);
  objc_super v5;
