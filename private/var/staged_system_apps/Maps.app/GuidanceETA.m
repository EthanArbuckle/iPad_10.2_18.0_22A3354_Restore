...
LABEL_6:
  ...
  dispatch_once(&qword_1014D2A90, &stru_1011BD458);
  if (!v5)
    goto LABEL_6;
LABEL_3:
...
LABEL_7:
  ...
  objc_msgSend((id)qword_1014D2A88, "setLocalizedDateFormatFromTemplate:", v15);
  objc_msgSend((id)qword_1014D2A88, "setTimeZone:", self->_destinationTimeZone);
  v18 = (void *)qword_1014D2A88;
...
+ (id)_arrivalTimeStringForEtaDate:(id)a3 timeZone:(id)a4 includingAMPMSymbols:(BOOL)a5
{
  ...
  v7 = a3;
  v8 = a4;
  if (qword_1014D2AA0 != -1)
    dispatch_once(&qword_1014D2AA0, &stru_1011BD478);
  objc_msgSend((id)qword_1014D2A98, "setTimeZone:", v8);
  if (v5)
    v9 = CFSTR("j:mm");
  else
    v9 = CFSTR("J:mm");
  objc_msgSend((id)qword_1014D2A98, "setLocalizedDateFormatFromTemplate:", v9);
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend((id)qword_1014D2A98, "stringFromDate:", v7));
...
- (void)_computeDistanceProperties
{
  ...
  v3 = GEORoundedMeasurementForDistance(2 * (self->_transportType == 2));
  ...
  if (qword_1014D2AB0 != -1)
    dispatch_once(&qword_1014D2AB0, &stru_1011BD498);
  v13 = (id)qword_1014D2AA8;
  ...
  if (qword_1014D2AC0 != -1)
    dispatch_once(&qword_1014D2AC0, &stru_1011BD4B8);
  v16 = (id)qword_1014D2AB8;
