...
{
  DirectionsWorkHistoryItem *v2;
  void *v3;
  objc_super v5;

  v5.receiver = self;
  v5.super_class = (Class)DirectionsWorkHistoryItem;
  v2 = -[DirectionsWorkHistoryItem init](&v5, "init");
  if (v2)
  {
    ...
    -[DirectionsWorkHistoryItem setCurrentLocation:](v2, "setCurrentLocation:", v3);
...
- (AddressBookAddress)workAddress
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "meCardWorkAddress"));
...
- (void)updateModel:(id)a3
{
  ...
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "localizedStringForKey:value:table:", CFSTR("Work [Address Book label]"), CFSTR("localized string not found"), 0));
  objc_msgSend(v4, "setFirstLine:", v6);

  v7 = (void *)objc_claimAutoreleasedReturnValue(-[DirectionsWorkHistoryItem workAddress](self, "workAddress"));
  v8 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v7, "singleLineAddress"));
  objc_msgSend(v4, "setSecondLine:", v8);

  v9 = (void *)objc_claimAutoreleasedReturnValue(-[DirectionsWorkHistoryItem workAddress](self, "workAddress"));
  ...
  {
    v12 = (void *)objc_claimAutoreleasedReturnValue(-[DirectionsWorkHistoryItem workAddress](self, "workAddress"));
    v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v12, "geocodingError"));

    if (!v13)
    {
      v14 = (void *)objc_claimAutoreleasedReturnValue(-[DirectionsWorkHistoryItem workAddress](self, "workAddress"));
  ...
  objc_msgSend(v4, "setDebugSubtitle:", CFSTR("[Work]"));
...
- (id)entryWithTicket:(id)a3
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[DirectionsWorkHistoryItem currentLocation](self, "currentLocation"));
