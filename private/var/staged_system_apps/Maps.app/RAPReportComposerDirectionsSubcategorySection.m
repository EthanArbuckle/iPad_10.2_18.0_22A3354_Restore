...
- (RAPReportComposerDirectionsSubcategorySection)initWithQuestion:(id)a3 selection:(id)a4
{
  id v7;
  id v8;
  RAPReportComposerDirectionsSubcategorySection *v9;
  RAPReportComposerDirectionsSubcategorySection *v10;
  id v11;
  id selection;
  objc_super v14;
  ...
  if (v9)
  {
    ...
    -[RAPMenu addObserver:changeHandler:](v10->_question, "addObserver:changeHandler:", v10, &stru_1011DCCB8);
  }
