...
- (GCDTimer)initWithTimeInterval:(double)a3 queue:(id)a4 repeating:(BOOL)a5 block:(id)a6
{
  ...
  if (v12)
  {
    ...
    v16 = objc_claimAutoreleasedReturnValue(+[NSDate dateWithTimeIntervalSinceNow:](NSDate, "dateWithTimeIntervalSinceNow:", a3));
...
- (id)description
{
  ...
  v3 = -[GCDTimer description](&v9, "description");
  v4 = (void *)objc_claimAutoreleasedReturnValue(v3);
  if (-[GCDTimer isRepeating](self, "isRepeating"))
    v5 = "YES";
  else
    v5 = "NO";
  v6 = (void *)objc_claimAutoreleasedReturnValue(-[GCDTimer fireDate](self, "fireDate"));
  v7 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@ <repeating: %s, next fire: %@>"), v4, v5, v6));
...
- (void)dealloc
{
  ...
  -[GCDTimer dealloc](&v3, "dealloc");
}

+ (id)scheduledTimerWithTimeInterval:(double)a3 queue:(id)a4 block:(id)a5
{
  return objc_msgSend(a1, "scheduledTimerWithTimeInterval:queue:repeating:block:", a4, 0, a5, a3);
}
