...
- (TwoLinesMapsSuggestionsEntryOutlineCellModel)initWithMapsSuggestionsEntry:(id)a3 accessoryModels:(id)a4 backgroundModel:(id)a5
{
  ...
  id v10;
  id v11;
  TwoLinesMapsSuggestionsEntryOutlineCellModel *v12;
...
- (BOOL)isEqual:(id)a3
{
  TwoLinesMapsSuggestionsEntryOutlineCellModel *v4;
  TwoLinesMapsSuggestionsEntryOutlineCellModel *v5;
  uint64_t v6;
  TwoLinesMapsSuggestionsEntryOutlineCellModel *v7;
  ...
  else if (v4 && (v6 = objc_opt_class(self), (objc_opt_isKindOfClass(v5, v6) & 1) != 0))
  {
    v7 = v5;
    v14.receiver = self;
    v14.super_class = (Class)TwoLinesMapsSuggestionsEntryOutlineCellModel;
    if (-[TwoLinesBasicOutlineCellModel isEqual:](&v14, "isEqual:", v7))
    {
      v8 = (MapsSuggestionsEntry *)objc_claimAutoreleasedReturnValue(-[TwoLinesMapsSuggestionsEntryOutlineCellModel entry](v7, "entry"));
      v9 = v8;
      if (v8 == self->_entry || -[MapsSuggestionsEntry isEqual:](v8, "isEqual:"))
      {
        v10 = (NSArray *)objc_claimAutoreleasedReturnValue(-[TwoLinesMapsSuggestionsEntryOutlineCellModel accessoryModels](v7, "accessoryModels"));
        v11 = v10;
