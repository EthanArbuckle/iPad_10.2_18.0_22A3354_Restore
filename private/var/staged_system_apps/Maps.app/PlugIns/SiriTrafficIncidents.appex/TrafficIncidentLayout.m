...
- (BOOL)shouldInvalidateLayoutForLocation:(id)a3
{
  ...
  if (self->_layoutRequestLocation)
  {
    ...
    v9 = v8;
    v11 = v10;
    v12 = (void *)objc_claimAutoreleasedReturnValue(-[GEOLocation latLng](self->_layoutRequestLocation, "latLng"));
    v13 = objc_msgSend(v12, "coordinate");
    v16 = GEOCalculateDistance(v13, v9, v11, v14, v15);

    if (v16 >= (double)self->_layoutFreshnessRadius)
    {
      v18 = 1;
    }
    else
    {
      ...
      if (v6 >= 0.0)
        v17 = v6;
      v18 = v17 > (double)self->_layoutTimeToLive;
    }
    v24 = MAPSGetIncidentsReportingLog();
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = self;
      v21 = "TrafficIncidentLayout: shouldInvalidateLayout %d for %@";
      v22 = v20;
      v23 = 18;
      goto LABEL_11;
    }
  ...
  {
    v19 = MAPSGetIncidentsReportingLog();
    v20 = objc_claimAutoreleasedReturnValue(v19);
    LOBYTE(v18) = 1;
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      LOWORD(v26[0]) = 0;
      v21 = "TrafficIncidentLayout: Initial fetching";
      v22 = v20;
      v23 = 2;
LABEL_11:
      _os_log_impl((void *)&_mh_execute_header, v22, OS_LOG_TYPE_INFO, v21, (uint8_t *)v26, v23);
    }
  }
