...
- (void)didUpdateDataFetcher:(id)a3
{
  ...
  v4 = a3;
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MapsAppTestGuidesHome updatedDataFetchers](self, "updatedDataFetchers"));
  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "object"));

  objc_msgSend(v5, "addObject:", v6);
  v7 = (void *)objc_claimAutoreleasedReturnValue(-[MapsAppTestGuidesHome updatedDataFetchers](self, "updatedDataFetchers"));
  v8 = objc_msgSend(v7, "count");
  v9 = -[MapsAppTestGuidesHome numberOfDataFetchers](self, "numberOfDataFetchers");
...
- (void)continueAfterCollectingDataFromDataFetchers
{
  ...
  +[PPTNotificationCenter addOnceObserverForName:object:usingBlock:](PPTNotificationCenter, "addOnceObserverForName:object:usingBlock:", CFSTR("PPTTest_GuidesHome_DidDisplaySections"), 0, v4);
  v3[0] = _NSConcreteStackBlock;
  v3[1] = 3221225472;
  v3[2] = sub_100591BC8;
  v3[3] = &unk_1011AC860;
  v3[4] = self;
  -[MapsAppTestGuidesHome _dispatchAfterShortDelay:](self, "_dispatchAfterShortDelay:", v3);
  objc_destroyWeak(&v5);
  objc_destroyWeak(&location);
}
...
- (void)runScrollTest
{
  ...
  -[MapsAppTest startedSubTest:](self, "startedSubTest:", CFSTR("scrollingGuidesHome"));
  objc_initWeak(&location, self);
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[MapsAppTest testCoordinator](self, "testCoordinator"));
  ...
  v10 = objc_msgSend(objc_alloc((Class)RPTScrollViewTestParameters), "initWithTestName:scrollBounds:scrollContentLength:direction:completionHandler:", CFSTR("scrollingGuidesHome"), 1, &stru_1011BBEE0, v6, v7, v8, v9, v5);
  v17 = v10;
  ...
  v14 = CFSTR("scrollingGuidesHome");
  v12 = +[RPTGroupScrollTestParameters newWithTestName:parameters:completionHandler:](RPTGroupScrollTestParameters, "newWithTestName:parameters:completionHandler:", CFSTR("scrollingGuidesHome"), v11, v13);
