...
- (_DragCustomFeature)initWithCustomFeature:(id)a3 coordinate:(id)a4
{
  ...
  double var0;
  id v8;
  _DragCustomFeature *v9;
  _DragCustomFeature *v10;
  _DragCustomFeature *v11;
  objc_super v13;
  ...
  v9 = -[_DragCustomFeature init](&v13, "init");
  v10 = v9;
  if (v9)
  {
...
+ (id)customFeatureForMapItem:(id)a3
{
  ...
  if ((objc_msgSend(v9, "hasAttributes") & 1) == 0)
  {
    v10 = objc_msgSend(objc_alloc((Class)GEOFeatureStyleAttributes), "initWithAttributes:", 4, 226, 5, 3, 6, 348, 10, 0, 0);

    v9 = v10;
  }
  v11 = objc_msgSend(v9, "copy");

  v15 = xmmword_100E3FF30;
  v16 = 0x100010024;
  ...
  v13 = -[_DragCustomFeature initWithCustomFeature:coordinate:]([_DragCustomFeature alloc], "initWithCustomFeature:coordinate:", v8, v5, v7);
  return v13;
}
