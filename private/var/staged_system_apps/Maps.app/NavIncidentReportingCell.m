...
{
  NavIncidentReportingCell *v4;
  NavIncidentReportingCell *v5;
  objc_class *v6;
  NSString *v7;
  void *v8;
  void *v9;
  ...
  v52.receiver = self;
  v52.super_class = (Class)NavIncidentReportingCell;
  v4 = -[NavIncidentReportingCell initWithStyle:reuseIdentifier:](&v52, "initWithStyle:reuseIdentifier:", a3, a4);
  v5 = v4;
  if (v4)
  {
    ...
    -[NavIncidentReportingCell setAccessibilityIdentifier:](v5, "setAccessibilityIdentifier:", v8);

    v9 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    objc_msgSend(v9, "setAccessibilityIdentifier:", CFSTR("NavIncidentReportingCellContent"));
    ...
    -[NavIncidentReportingCell setBackgroundConfiguration:](v5, "setBackgroundConfiguration:", v51);
    ...
    v13 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v17 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v50 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v44 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v35 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v31 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v19 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
    ...
    v23 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell contentView](v5, "contentView"));
...
- (void)prepareForReuse
{
  ...
  -[NavIncidentReportingCell prepareForReuse](&v3, "prepareForReuse");
  -[NavIncidentReportingCell setItem:](self, "setItem:", 0);
}
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v4 = a3;
  -[NavIncidentReportingCell traitCollectionDidChange:](&v8, "traitCollectionDidChange:", v4);
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell traitCollection](self, "traitCollection", v8.receiver, v8.super_class));
  v6 = objc_msgSend(v5, "userInterfaceStyle");
  v7 = objc_msgSend(v4, "userInterfaceStyle");

  if (v6 != v7)
  {
    -[NavIncidentReportingCell _updateContent](self, "_updateContent");
    -[NavIncidentReportingCell setNeedsUpdateConfiguration](self, "setNeedsUpdateConfiguration");
  }
}
...
- (void)_updateContent
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell item](self, "item"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "displayText"));
  -[UILabel setText:](self->_titleLabel, "setText:", v4);

  v6 = (id)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell item](self, "item"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v6, "displayImage"));
  -[UIImageView setImage:](self->_leadingImageView, "setImage:", v5);
...
- (void)updateConfigurationUsingState:(id)a3
{
  ...
  v10 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell backgroundConfiguration](self, "backgroundConfiguration"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v4, "updatedConfigurationForState:", v10));

  v6 = (void *)objc_claimAutoreleasedReturnValue(-[NavIncidentReportingCell traitCollection](self, "traitCollection"));
  ...
  -[NavIncidentReportingCell setBackgroundConfiguration:](self, "setBackgroundConfiguration:", v5);
}
...
+ (double)heightForCellWithItem:(id)a3 width:(double)a4
{
  ...
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v5, "displayText"));
