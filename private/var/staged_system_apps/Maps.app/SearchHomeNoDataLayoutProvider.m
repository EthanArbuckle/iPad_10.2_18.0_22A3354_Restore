...
- (id)cellClasses
{
  ...
  v3 = objc_opt_class(NoRecentlySearchCollectionViewCell);
  return (id)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &v3, 1));
}

- (id)cellReuseIdentifier
{
  return +[NoRecentlySearchCollectionViewCell identifier](NoRecentlySearchCollectionViewCell, "identifier");
}
...
- (id)cellForRowAtIndexPath:(id)a3 collectionView:(id)a4 item:(id)a5
{
  ...
  v7 = a4;
  v8 = a3;
  v9 = (void *)objc_claimAutoreleasedReturnValue(-[SearchHomeNoDataLayoutProvider cellReuseIdentifier](self, "cellReuseIdentifier"));
  ...
  objc_msgSend(v10, "setHeightConstraint:withPriority:", v12, v13);
  return v10;
}
...
- (id)layoutSectionWithLayoutEnvironment:(id)a3 estimatedHeaderHeight:(double)a4 estimatedFooterHeight:(double)a5 deletionBlock:(id)a6 objectsCount:(unint64_t)a7 mapsTheme:(id)a8
{
  ...
  NSObject *v20;
  int v22;
  SearchHomeNoDataLayoutProvider *v23;
  void *v24;
  ...
  v10 = (void *)objc_claimAutoreleasedReturnValue(+[NSCollectionLayoutDimension fractionalHeightDimension:](NSCollectionLayoutDimension, "fractionalHeightDimension:", 1.0));
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue(+[NSCollectionLayoutDimension fractionalHeightDimension:](NSCollectionLayoutDimension, "fractionalHeightDimension:", 1.0));
