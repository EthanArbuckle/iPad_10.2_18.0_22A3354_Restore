...
- (int64_t)code
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___TodayIntentResponse_code, v4, 0, 0);
  return *v2;
}
...
- (void)setCode:(int64_t)a3
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___TodayIntentResponse_code, v5, 1, 0);
  *v4 = a3;
}
...
- (TodayIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  int64_t *v8;
  TodayIntentResponse *v9;
  _BYTE v11[24];

  v6 = a4;
  v7 = -[TodayIntentResponse init](self, "init");
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___TodayIntentResponse_code);
  swift_beginAccess((char *)v7 + OBJC_IVAR___TodayIntentResponse_code, v11, 1, 0);
  *v8 = a3;
  v9 = v7;
  -[TodayIntentResponse setUserActivity:](v9, "setUserActivity:", v6);
...
- (TodayIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___TodayIntentResponse_code) = 0;
  ...
  return -[TodayIntentResponse init](&v3, "init");
}

- (TodayIntentResponse)initWithCoder:(id)a3
{
  return (TodayIntentResponse *)sub_10007E484((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (TodayIntentResponse)initWithBackingStore:(id)a3
{
  return (TodayIntentResponse *)sub_10007E484((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
