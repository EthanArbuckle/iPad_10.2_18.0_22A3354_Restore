...
- (void)visibleItemsDidChangeAtDate:(id)a3 withTriggerEvent:(unint64_t)a4 trackableWidgetState:(id)a5
{
  ...
  if (a4 == 4)
  {
    ...
    if (!v12 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
      sub_100082EF8();
    v27 = v10;
    v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v10, "fc_arrayOfObjectsPassingTest:", &stru_1000AAE30));
  ...
  v26 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v25, "fc_arrayByTransformingWithBlock:", &stru_1000AAE70));
