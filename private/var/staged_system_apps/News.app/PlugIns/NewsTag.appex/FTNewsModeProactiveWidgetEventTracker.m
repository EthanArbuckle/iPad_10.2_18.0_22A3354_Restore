...
+ (id)widgetEventTrackerWithMaxRowCount:(unint64_t)a3
{
  ...
  v4 = -[FTConditionalWidgetEventTracker initWithWidgetEventTracker:predicate:]([FTConditionalWidgetEventTracker alloc], "initWithWidgetEventTracker:predicate:", v3, &stru_1000AA5C8);
