...
- (NSString)entryID
{
  ...
  v2 = *(_QWORD *)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_entryID + 8];
...
- (NSString)contentID
{
  ...
  v2 = *(_QWORD *)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_contentID + 8];
  if (v2)
  {
    swift_bridgeObjectRetain(*(_QWORD *)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_contentID + 8]);
    v3 = String._bridgeToObjectiveC()();
    swift_bridgeObjectRelease(v2);
  }
  else
...
{
  return *(_QWORD *)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_appearanceType];
}

- (unint64_t)stackKind
{
  return *(_QWORD *)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_stackKind];
}

- (unint64_t)stackLocation
{
  return *(_QWORD *)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_stackLocation];
}
...
- (unint64_t)absoluteOrderOfItem:(id)a3
{
  ...
  swift_unknownObjectRetain(a3);
  v6 = sub_100067318((uint64_t)v5, (uint64_t)a3);
  v8 = v7;
...
- (id)sectionForItem:(id)a3
{
  ...
  v5 = *(void **)&self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_results];
  swift_unknownObjectRetain(a3);
  swift_retain(self);
  ...
  swift_unknownObjectRetain(a3);
  v10 = sub_10006719C((uint64_t)v9, (uint64_t)a3);
  swift_release(self);
...
- (id)extentsOfSections:(id)a3
{
  ...
  v5 = sub_10002CC78(0, (unint64_t *)&qword_1000BBD00, NTSection_ptr);
  ...
  v9 = sub_100066E34();
  v10 = Array.mapToDictionary<A>(_:)(sub_100067074, v13, v6, v5, v8, v9);
  swift_release(self);
...
- (unint64_t)activeDisplayMode
{
  ...
  v7 = &self->entryID[OBJC_IVAR____TtC7NewsTag20TrackableWidgetState_layoutContext];
