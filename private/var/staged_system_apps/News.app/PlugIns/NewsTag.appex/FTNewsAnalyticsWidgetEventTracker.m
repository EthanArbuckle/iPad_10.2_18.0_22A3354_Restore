...
- (FTNewsAnalyticsWidgetEventTracker)initWithUserIDProvider:(id)a3
{
  ...
  if (v5)
  {
    ...
    v12 = -[FTConditionalWidgetEventTracker initWithWidgetEventTracker:predicate:]([FTConditionalWidgetEventTracker alloc], "initWithWidgetEventTracker:predicate:", v11, &stru_1000AAB10);
...
- (void)widgetDidDisappearAtDate:(id)a3 withTrackableWidgetState:(id)a4
{
  ...
  v14 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v13, "fc_arrayByTransformingWithBlock:", &stru_1000AAB50));
