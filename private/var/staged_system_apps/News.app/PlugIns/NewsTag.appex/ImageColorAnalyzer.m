...
- (NSArray)dominantColors
{
  ...
  v10 = 0;
  v11 = 0;
  sub_10001B36C(&__p, self->_analyzedColors.completeColorList.__begin_, (uint64_t)self->_analyzedColors.completeColorList.__end_, self->_analyzedColors.completeColorList.__end_ - self->_analyzedColors.completeColorList.__begin_);
  v4 = (char *)__p;
  if (v10 != __p)
  {
    v5 = 0;
...
{
  return objc_msgSend(a3, "_isSimilarToColor:withinPercentage:", a4, 0.2);
}

- (void).cxx_destruct
{
  sub_10001B28C(&self->_analyzedColors.backgroundColor.mRed);
}

- (id).cxx_construct
{
  sub_10001B2EC((uint64_t)&self->_analyzedColors);
  return self;
}
