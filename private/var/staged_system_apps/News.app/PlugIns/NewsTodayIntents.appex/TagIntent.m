...
- (TagIntent)initWithCoder:(id)a3
{
  ...
  return -[TagIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (TagIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for TagIntent();
  v11 = -[TagIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (TagIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for TagIntent();
  v15 = -[TagIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
