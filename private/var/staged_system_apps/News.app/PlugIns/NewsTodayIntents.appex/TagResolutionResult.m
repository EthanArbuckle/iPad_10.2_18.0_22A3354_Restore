...
+ (id)successWithResolvedObject:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "NewsTodayIntents/Tag.swift", 26, 2, 50, 0);
  __break(1u);
  return result;
}
...
+ (id)disambiguationWithObjectsToDisambiguate:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "NewsTodayIntents/Tag.swift", 26, 2, 55, 0);
  __break(1u);
  return result;
}
...
+ (id)confirmationRequiredWithObjectToConfirm:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "NewsTodayIntents/Tag.swift", 26, 2, 60, 0);
  __break(1u);
  return result;
}
