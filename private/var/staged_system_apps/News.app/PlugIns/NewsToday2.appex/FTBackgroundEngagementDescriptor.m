...
- (FTBackgroundEngagementDescriptor)init
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(+[NSString stringWithFormat:](NSString, "stringWithFormat:", CFSTR("%@: %s"), CFSTR("Do not call method"), "-[FTBackgroundEngagementDescriptor init]"));
