...
{
  return (TodayIntentResponse *)sub_100090164((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (TodayIntentResponse)initWithBackingStore:(id)a3
{
  return (TodayIntentResponse *)sub_100090164((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
