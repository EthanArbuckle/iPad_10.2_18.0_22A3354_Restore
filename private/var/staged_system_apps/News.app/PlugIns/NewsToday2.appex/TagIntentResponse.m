...
{
  return (TagIntentResponse *)sub_10008F610((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (TagIntentResponse)initWithBackingStore:(id)a3
{
  return (TagIntentResponse *)sub_10008F610((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
