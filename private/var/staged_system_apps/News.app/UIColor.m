...
+ (UIColor)colorWithContentColorPair:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "lightColor"));
  objc_msgSend(v4, "red");
  v6 = v5;
  v7 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "lightColor"));
  objc_msgSend(v7, "green");
  v9 = v8;
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "lightColor"));
  objc_msgSend(v10, "blue");
  v12 = v11;
  v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "lightColor"));
  objc_msgSend(v13, "alpha");
  v15 = (void *)objc_claimAutoreleasedReturnValue(+[UIColor colorWithRed:green:blue:alpha:](UIColor, "colorWithRed:green:blue:alpha:", v6, v9, v12, v14));

  v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "darkColor"));
  objc_msgSend(v16, "red");
  v18 = v17;
  v19 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "darkColor"));
  objc_msgSend(v19, "green");
  v21 = v20;
  v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "darkColor"));
  objc_msgSend(v22, "blue");
  v24 = v23;
  v25 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "darkColor"));

  objc_msgSend(v25, "alpha");
  v27 = (void *)objc_claimAutoreleasedReturnValue(+[UIColor colorWithRed:green:blue:alpha:](UIColor, "colorWithRed:green:blue:alpha:", v18, v21, v24, v26));
  ...
  v28 = v15;
  v29 = v27;
  v30 = (void *)objc_claimAutoreleasedReturnValue(+[UIColor colorWithDynamicProvider:](UIColor, "colorWithDynamicProvider:", v32));
...
{
  if (qword_10010A7B0 != -1)
    dispatch_once(&qword_10010A7B0, &stru_1000DDEE0);
  return (id)qword_10010A7A8;
}
...
{
  if (qword_10010A7C0 != -1)
    dispatch_once(&qword_10010A7C0, &stru_1000DDF00);
  return (id)qword_10010A7B8;
}

+ (id)fr_subscriptionOnlyTextColor
{
  if (qword_10010A7D0 != -1)
    dispatch_once(&qword_10010A7D0, &stru_1000DDF20);
  return (id)qword_10010A7C8;
}

+ (id)fr_savedStoriesHeaderColor
{
  if (qword_10010A7E0 != -1)
    dispatch_once(&qword_10010A7E0, &stru_1000DDF40);
  return (id)qword_10010A7D8;
}

+ (id)fr_forYouStoriesHeaderColor
{
  if (qword_10010A7F0 != -1)
    dispatch_once(&qword_10010A7F0, &stru_1000DDF60);
  return (id)qword_10010A7E8;
}

+ (id)fr_trendingStoriesHeaderColor
{
  if (qword_10010A800 != -1)
    dispatch_once(&qword_10010A800, &stru_1000DDF80);
  return (id)qword_10010A7F8;
}
...
+ (id)fr_defaultDarkBarColor
{
  ...
  {
    if (qword_10010A810 != -1)
      dispatch_once(&qword_10010A810, &stru_1000DDFA0);
    v2 = (id)qword_10010A808;
  }
  return v2;
}
...
+ (id)fr_defaultLightBarColor
{
  ...
  {
    if (qword_10010A820 != -1)
      dispatch_once(&qword_10010A820, &stru_1000DDFC0);
    v2 = (id)qword_10010A818;
  }
  return v2;
}
...
+ (id)fr_dynamicDefaultLightBarColor
{
  ...
  if (UIAccessibilityIsReduceTransparencyEnabled())
  {
    if (qword_10010A830 != -1)
      dispatch_once(&qword_10010A830, &stru_1000DDFE0);
    v2 = &qword_10010A828;
  }
  else
  {
    if (qword_10010A840 != -1)
      dispatch_once(&qword_10010A840, &stru_1000DE000);
    v2 = &qword_10010A838;
  }
  return (id)*v2;
}
...
{
  if (qword_10010A850 != -1)
    dispatch_once(&qword_10010A850, &stru_1000DE020);
  return (id)qword_10010A848;
}
...
{
  if (qword_10010A860 != -1)
    dispatch_once(&qword_10010A860, &stru_1000DE040);
  return (id)qword_10010A858;
}
...
{
  if (qword_10010A870 != -1)
    dispatch_once(&qword_10010A870, &stru_1000DE060);
  return (id)qword_10010A868;
}

+ (id)fr_searchResultsCellSelectedBackgroundColor
{
  if (qword_10010A880 != -1)
    dispatch_once(&qword_10010A880, &stru_1000DE080);
  return (id)qword_10010A878;
}

+ (id)fr_searchNoResultsTextColor
{
  if (qword_10010A890 != -1)
    dispatch_once(&qword_10010A890, &stru_1000DE0A0);
  return (id)qword_10010A888;
}

+ (id)fr_searchResultsSectionHeaderBackgroundColor
{
  if (qword_10010A8A0 != -1)
    dispatch_once(&qword_10010A8A0, &stru_1000DE0C0);
  return (id)qword_10010A898;
}

+ (id)fr_searchResultsSectionHeaderTextColor
{
  if (qword_10010A8B0 != -1)
    dispatch_once(&qword_10010A8B0, &stru_1000DE0E0);
  return (id)qword_10010A8A8;
}
...
{
  if (qword_10010A8C0 != -1)
    dispatch_once(&qword_10010A8C0, &stru_1000DE100);
  return (id)qword_10010A8B8;
}

+ (id)fr_searchResultsCellSelectedTintColor
{
  if (qword_10010A8D0 != -1)
    dispatch_once(&qword_10010A8D0, &stru_1000DE120);
  return (id)qword_10010A8C8;
}
...
+ (id)fr_keylineColor
{
  if (qword_10010A8E0 != -1)
    dispatch_once(&qword_10010A8E0, &stru_1000DE140);
  return (id)qword_10010A8D8;
}

+ (id)fr_topicCardBorderColorForDarkBackground
{
  if (qword_10010A8F0 != -1)
    dispatch_once(&qword_10010A8F0, &stru_1000DE160);
  return (id)qword_10010A8E8;
}

+ (id)fr_topicCardBorderColorForLightBackground
{
  if (qword_10010A900 != -1)
    dispatch_once(&qword_10010A900, &stru_1000DE180);
  return (id)qword_10010A8F8;
}
...
{
  if (qword_10010A910 != -1)
    dispatch_once(&qword_10010A910, &stru_1000DE1A0);
  return (id)qword_10010A908;
}

+ (id)fr_topicCardDividerColorForLightBackground
{
  if (qword_10010A920 != -1)
    dispatch_once(&qword_10010A920, &stru_1000DE1C0);
  return (id)qword_10010A918;
}
...
{
  if (qword_10010A930 != -1)
    dispatch_once(&qword_10010A930, &stru_1000DE1E0);
  return (id)qword_10010A928;
}
...
- (void)print
{
  -[UIColor _getRGBA:](self, "_getRGBA:", &stru_1000DE268);
  -[UIColor _getHSBA:](self, "_getHSBA:", &stru_1000DE288);
}
...
{
  if (qword_10010A940 != -1)
    dispatch_once(&qword_10010A940, &stru_1000DE2D0);
  return (id)qword_10010A938;
}
...
{
  if (qword_10010A950 != -1)
    dispatch_once(&qword_10010A950, &stru_1000DE2F0);
  return (id)qword_10010A948;
}
...
{
  if (qword_10010A960 != -1)
    dispatch_once(&qword_10010A960, &stru_1000DE310);
  return (id)qword_10010A958;
}

+ (id)fr_followingInstructionTextColor
{
  if (qword_10010A970 != -1)
    dispatch_once(&qword_10010A970, &stru_1000DE330);
  return (id)qword_10010A968;
}
