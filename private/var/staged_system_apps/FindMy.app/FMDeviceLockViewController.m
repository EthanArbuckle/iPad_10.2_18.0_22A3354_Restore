...
LABEL_5:
    v14 = 0;
    v16 = 0;
    return (_TtC6FindMy26FMDeviceLockViewController *)sub_1001529D0(v9, v11, (uint64_t)a4, v13, v14, v16, a6);
  }
...
- (_TtC6FindMy26FMDeviceLockViewController)initWithTitle:(id)a3 detailText:(id)a4 icon:(id)a5 contentLayout:(int64_t)a6
{
  ...
  NSString v14;
  NSString v15;
  _TtC6FindMy26FMDeviceLockViewController *v16;
  objc_super v18;
  ...
  v18.receiver = self;
  v18.super_class = (Class)type metadata accessor for FMDeviceLockViewController(0);
