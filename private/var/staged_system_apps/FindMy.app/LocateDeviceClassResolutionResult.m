...
- (LocateDeviceClassResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  id v7;
  Class isa;
  LocateDeviceClassResolutionResult *v9;
  LocateDeviceClassResolutionResult *v10;
  objc_super v12;
  ...
  v12.receiver = self;
  v12.super_class = (Class)type metadata accessor for LocateDeviceClassResolutionResult();
  v9 = -[LocateDeviceClassResolutionResult initWithJSONDictionary:forIntent:](&v12, "initWithJSONDictionary:forIntent:", isa, v7);
