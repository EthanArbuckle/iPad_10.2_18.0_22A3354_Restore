...
- (LocateIntent)init
{
  ...
  return -[LocateIntent init](&v3, "init");
}
...
- (LocateIntent)initWithCoder:(id)a3
{
  ...
  return -[LocateIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (LocateIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for LocateIntent();
  v11 = -[LocateIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (LocateIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for LocateIntent();
  v15 = -[LocateIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
