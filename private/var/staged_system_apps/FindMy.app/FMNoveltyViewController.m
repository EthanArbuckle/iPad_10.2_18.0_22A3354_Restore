...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v4 = v8.receiver;
  -[FMNoveltyViewController viewWillAppear:](&v8, "viewWillAppear:", v3);
...
- (NSArray)keyCommands
{
  uint64_t v3;
  uint64_t v4;
  _TtC6FindMy23FMNoveltyViewController *v5;
  NSString v6;
  id v7;
  uint64_t v8;
  Class isa;
...
{
  double v2;
  _TtC6FindMy23FMNoveltyViewController *v3;
...
LABEL_5:
    v14 = 0;
    v16 = 0;
    return (_TtC6FindMy23FMNoveltyViewController *)sub_1004412E4(v9, v11, (uint64_t)a4, v13, v14, v16, a6);
  }
...
- (_TtC6FindMy23FMNoveltyViewController)initWithTitle:(id)a3 detailText:(id)a4 icon:(id)a5 contentLayout:(int64_t)a6
{
  ...
  v14 = a5;
  return (_TtC6FindMy23FMNoveltyViewController *)sub_10044153C(v9, v11, (uint64_t)a4, v13, a5, a6);
}

- (void).cxx_destruct
{
  swift_release(*(_QWORD *)&self->OBWelcomeController_opaque[OBJC_IVAR____TtC6FindMy23FMNoveltyViewController_mediator]);

  swift_bridgeObjectRelease(*(_QWORD *)&self->mediator[OBJC_IVAR____TtC6FindMy23FMNoveltyViewController_onboardingPrivacyBundleIdentifier]);
  sub_10005E190((uint64_t)&self->OBWelcomeController_opaque[OBJC_IVAR____TtC6FindMy23FMNoveltyViewController_delegate]);
}
