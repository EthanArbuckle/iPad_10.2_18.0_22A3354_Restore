...
- (void)layoutSubviews
{
  ...
  -[FMPlatteredTableViewCell layoutSubviews](&v2, "layoutSubviews");
}
...
- (_TtC6FindMy27FMEmailUpdatesTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  uint64_t v7;
  NSString v8;
  _TtC6FindMy27FMEmailUpdatesTableViewCell *v9;
  objc_super v11;
  ...
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for FMEmailUpdatesTableViewCell();
  v9 = -[FMPlatteredTableViewCell initWithStyle:reuseIdentifier:](&v11, "initWithStyle:reuseIdentifier:", a3, v8);
...
- (_TtC6FindMy27FMEmailUpdatesTableViewCell)initWithCoder:(id)a3
{
  ...
  return -[FMPlatteredTableViewCell initWithCoder:](&v5, "initWithCoder:", a3);
}
