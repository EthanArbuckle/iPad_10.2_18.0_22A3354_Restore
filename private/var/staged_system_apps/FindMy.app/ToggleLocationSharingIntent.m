...
- (ToggleLocationSharingIntent)init
{
  ...
  return -[ToggleLocationSharingIntent init](&v3, "init");
}
...
- (ToggleLocationSharingIntent)initWithCoder:(id)a3
{
  ...
  return -[ToggleLocationSharingIntent initWithCoder:](&v5, "initWithCoder:", a3);
}
...
- (ToggleLocationSharingIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  NSString v9;
  id v10;
  ToggleLocationSharingIntent *v11;
  objc_super v13;
  ...
  v13.receiver = self;
  v13.super_class = (Class)type metadata accessor for ToggleLocationSharingIntent();
  v11 = -[ToggleLocationSharingIntent initWithIdentifier:backingStore:](&v13, "initWithIdentifier:backingStore:", v9, a4);
...
- (ToggleLocationSharingIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  NSString v13;
  NSDictionary v14;
  ToggleLocationSharingIntent *v15;
  objc_super v17;
  ...
  v17.receiver = self;
  v17.super_class = (Class)type metadata accessor for ToggleLocationSharingIntent();
  v15 = -[ToggleLocationSharingIntent initWithDomain:verb:parametersByName:](&v17, "initWithDomain:verb:parametersByName:", v12, v13, v14.super.isa);
