...
+ (id)successWithResolvedObject:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "FindMyWidgetItems/ItemSource.swift", 34, 2, 47, 0);
  __break(1u);
  return result;
}
...
+ (id)disambiguationWithObjectsToDisambiguate:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "FindMyWidgetItems/ItemSource.swift", 34, 2, 52, 0);
  __break(1u);
  return result;
}
...
+ (id)confirmationRequiredWithObjectToConfirm:(id)a3
{
  ...
  result = (id)_assertionFailure(_:_:file:line:flags:)("Fatal error", 11, 2, 0, 0xE000000000000000, "FindMyWidgetItems/ItemSource.swift", 34, 2, 57, 0);
  __break(1u);
  return result;
}
