...
{
  return (FriendSelectorIntentResponse *)sub_100016658((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (FriendSelectorIntentResponse)initWithBackingStore:(id)a3
{
  return (FriendSelectorIntentResponse *)sub_100016658((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
