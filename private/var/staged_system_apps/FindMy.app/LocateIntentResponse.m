...
- (int64_t)code
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___LocateIntentResponse_code, v4, 0, 0);
  return *v2;
}
...
- (void)setCode:(int64_t)a3
{
  ...
  swift_beginAccess((char *)self + OBJC_IVAR___LocateIntentResponse_code, v5, 1, 0);
  *v4 = a3;
}
...
{
  id v6;
  LocateIntentResponse *v7;
  int64_t *v8;
  LocateIntentResponse *v9;
  _BYTE v11[24];

  v6 = a4;
  v7 = -[LocateIntentResponse init](self, "init");
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___LocateIntentResponse_code);
  swift_beginAccess((char *)v7 + OBJC_IVAR___LocateIntentResponse_code, v11, 1, 0);
  *v8 = a3;
  v9 = v7;
  -[LocateIntentResponse setUserActivity:](v9, "setUserActivity:", v6);
...
- (LocateIntentResponse)init
{
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___LocateIntentResponse_code) = 0;
  ...
  return -[LocateIntentResponse init](&v3, "init");
}

- (LocateIntentResponse)initWithCoder:(id)a3
{
  return (LocateIntentResponse *)sub_10046DD40((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (LocateIntentResponse)initWithBackingStore:(id)a3
{
  return (LocateIntentResponse *)sub_10046DD40((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
