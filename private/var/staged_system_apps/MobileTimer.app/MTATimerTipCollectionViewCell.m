...
- (void)prepareForReuse
{
  ...
  -[MTATimerTipCollectionViewCell prepareForReuse](&v4, "prepareForReuse");
  ...
  if (siriTipView != v5)
  {
    ...
    *p_siriTipView = 0;
    ...
    if (v5)
    {
      ...
      v9 = (void *)objc_claimAutoreleasedReturnValue(-[MTATimerTipCollectionViewCell contentView](self, "contentView"));
      ...
      v13 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v11, "constraintEqualToAnchor:constant:", v12, 16.0));
      v23[2] = v13;
