...
{
  MTASingleTimerTableViewCell *v4;
  MTASingleTimerTableViewCell *v5;
  objc_super v7;

  v7.receiver = self;
  v7.super_class = (Class)MTASingleTimerTableViewCell;
  v4 = -[MTASingleTimerTableViewCell initWithStyle:reuseIdentifier:](&v7, "initWithStyle:reuseIdentifier:", a3, a4);
  v5 = v4;
  if (v4)
  {
    -[MTASingleTimerTableViewCell setupControlsView](v4, "setupControlsView");
    -[MTASingleTimerTableViewCell setupLayoutConstraints](v5, "setupLayoutConstraints");
  }
  return v5;
}
...
- (void)setupControlsView
{
  ...
  v3 = -[MTATimerControlsView initWithDelegate:style:timerControlState:]([MTATimerControlsView alloc], "initWithDelegate:style:timerControlState:", 0, 2, 0);
  -[MTASingleTimerTableViewCell setControlsView:](self, "setControlsView:", v3);

  v4 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
  objc_msgSend(v4, "setTranslatesAutoresizingMaskIntoConstraints:", 0);

  v6 = (id)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell contentView](self, "contentView"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
...
- (void)setupLayoutConstraints
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "leadingAnchor"));
  v5 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell contentView](self, "contentView"));
  ...
  v9 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
  v10 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v9, "trailingAnchor"));
  v11 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell contentView](self, "contentView"));
  ...
  v15 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
  v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "topAnchor"));
  v17 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell contentView](self, "contentView"));
  ...
  v21 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
  v22 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v21, "bottomAnchor"));
  v23 = (void *)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell contentView](self, "contentView"));
...
- (void)updateWithLatestDuration:(id)a3
{
  ...
  v5 = v4;
  v6 = (id)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
  objc_msgSend(v6, "setCountDownDuration:", v5);
...
- (void)updateDelegate:(id)a3
{
  ...
  v4 = a3;
  v5 = (id)objc_claimAutoreleasedReturnValue(-[MTASingleTimerTableViewCell controlsView](self, "controlsView"));
