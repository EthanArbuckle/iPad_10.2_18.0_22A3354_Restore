...
+ (id)successWithResolvedObject:(id)a3
{
  ...
  static WeatherLocationResolutionResult.success(with:)((uint64_t)a1, (uint64_t)a2, (uint64_t)a3, v3, v4, v5, v6, v7);
}
...
+ (id)disambiguationWithObjectsToDisambiguate:(id)a3
{
  ...
  static WeatherLocationResolutionResult.disambiguation(with:)(v5, v6, v7, v8, v9, v10, v11, v12);
}
...
+ (id)confirmationRequiredWithObjectToConfirm:(id)a3
{
  ...
  static WeatherLocationResolutionResult.confirmationRequired(with:)((uint64_t)a1, (uint64_t)a2, (uint64_t)a3, v3, v4, v5, v6, v7);
}
