...
- (double)midXToMidXSpacing
{
  ...
  result = *(double *)&qword_1005AA000;
  v3 = -*(double *)&qword_1005AA000;
  if (*(double *)&qword_1005AA000 >= 0.0)
    v3 = *(double *)&qword_1005AA000;
  if (v3 < 2.22044605e-16)
  {
    ...
    *(double *)&qword_1005AA000 = v5 * 1.5;

    return *(double *)&qword_1005AA000;
  }
  return result;
}
...
+ (unint64_t)statusIndicatorOptionsForMessage:(id)a3
{
  ...
  v3 = a3;
  v4 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "flags"));
  v5 = objc_msgSend(v4, "read");

  v6 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v3, "flags"));
  LODWORD(v4) = objc_msgSend(v6, "flagged");

  v7 = objc_msgSend(v3, "conversationNotificationLevel");
  v8 = objc_msgSend(v3, "isBlocked");
  v9 = v5 ^ 1;
  if ((_DWORD)v4)
    v9 |= 4uLL;
  if (v7 == (id)2)
