...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100154F4C;
  block[3] = &unk_10051A7D0;
  block[4] = a1;
  if (qword_1005AA0F8 != -1)
    dispatch_once(&qword_1005AA0F8, block);
  return (OS_os_log *)(id)qword_1005AA0F0;
}
...
- (MFConversationItemHeaderBlock)initWithFrame:(CGRect)a3 contactStore:(id)a4 accountsProvider:(id)a5
{
  ...
  if (v13)
  {
    ...
    byte_1005AA100 = objc_msgSend(v16, "BOOLForKey:", CFSTR("ShowMessageHeaderDetails"));

    v15->_showDetails = byte_1005AA100;
...
- (void)createPrimaryViews
{
  ...
  -[MFConversationItemHeaderBlock createPrimaryViews](&v52, "createPrimaryViews");
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("FROM_HEADER"), &stru_100531B00, CFSTR("Main")));
  v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
  v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "localizedStringForKey:value:table:", CFSTR("FROM_TITLE"), &stru_100531B00, CFSTR("Main")));
  ...
  else
  {
    ...
    v53 = v36;
    v37 = (void *)objc_claimAutoreleasedReturnValue(+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", &v53, 1));
  ...
  {
    v49 = (void *)objc_claimAutoreleasedReturnValue(-[MFConversationItemHeaderBlock delegate](self, "delegate"));
    v50 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v49, "popoverManagerForForConversationItemHeader:", self));

    v51 = (void *)objc_claimAutoreleasedReturnValue(-[MFConversationItemHeaderBlock primaryAtomList](self, "primaryAtomList"));
    objc_msgSend(v50, "addPassthroughViewProvider:", v51);
...
- (void)_showMessageInfo
{
  ...
  if (_os_feature_enabled_impl("Mail", "AttachmentsSharedWithYou"))
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100159C14;
    block[3] = &unk_100520DD0;
    v20 = WeakRetained;
    v21 = self;
    v22 = &v41;
    v23 = v39;
  ...
  if (self->_showDetails != v6)
  {
    if (-[MFConversationItemHeaderBlock _shouldSaveHeaderDetailsButtonSettings](self, "_shouldSaveHeaderDetailsButtonSettings"))
    {
      ...
      if (byte_1005AA100 != v6)
      {
        ...
        byte_1005AA100 = self->_showDetails;
      }
    }
  }
...
- (void)setOtherSigners:(id)a3
{
  ...
  v6 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(a3, "ef_map:", &stru_100520E10));
