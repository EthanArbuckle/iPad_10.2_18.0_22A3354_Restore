...
- (void)updateImageViews
{
  ...
  if (v3)
  {
    ...
    do
    {
      v12 = qword_1004C9810[v10];
      if ((v12 & v3) != 0)
      {
        v13 = (void *)objc_claimAutoreleasedReturnValue(-[MessageStatusIndicatorManager statusIndicatorColorWithOptionsMask:](self, "statusIndicatorColorWithOptionsMask:", qword_1004C9810[v10]));
