...
- (MFDiskFreeSpaceMonitor)init
{
  ...
  if (v2)
  {
    ...
    *((_QWORD *)v2 + 2) = v9;
    ...
    handler[2] = sub_10003C494;
    handler[3] = &unk_10051AA98;
    v12 = v2;
    v19 = v12;
    dispatch_source_set_event_handler(v11, handler);
    dispatch_resume(*((dispatch_object_t *)v2 + 2));
    v13 = (void *)objc_claimAutoreleasedReturnValue(+[NSNotificationCenter defaultCenter](NSNotificationCenter, "defaultCenter"));
    objc_msgSend(v13, "addObserver:selector:name:object:", v12, "handleDidPurgeSpace:", off_1005A22E0, 0);
...
+ (id)defaultMonitor
{
  if (qword_1005AA138 != -1)
    dispatch_once(&qword_1005AA138, &stru_100520F58);
  return (id)qword_1005AA140;
}
