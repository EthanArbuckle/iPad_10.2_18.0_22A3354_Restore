...
- (DockedPlaceholderView)initWithFrame:(CGRect)a3
{
  ...
  v26.receiver = self;
  v26.super_class = (Class)DockedPlaceholderView;
  v3 = -[DockedPlaceholderView initWithFrame:](&v26, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v7 = -[DockedHeaderView initWithFrame:]([DockedHeaderView alloc], "initWithFrame:", 0.0, 0.0, CGRectGetWidth(v27), 50.0);
    ...
    objc_msgSend((id)objc_opt_class(v3), "defaultCornerRadius");
...
- (void)_updateShadow
{
  ...
  if (-[DockedPlaceholderView falseShadowEdge](self, "falseShadowEdge"))
  {
    ...
    else
    {
      ...
      objc_msgSend(v34, "setLocations:", &off_100542130);
