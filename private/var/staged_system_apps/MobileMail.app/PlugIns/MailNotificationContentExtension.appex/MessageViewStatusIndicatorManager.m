...
- (void)updateImageViews
{
  ...
  if (v3)
  {
    ...
    do
    {
      v12 = qword_100036BB8[v10];
      if ((v12 & v3) != 0)
      {
        v13 = (void *)objc_claimAutoreleasedReturnValue(-[MessageStatusIndicatorManager statusIndicatorColorWithOptionsMask:](self, "statusIndicatorColorWithOptionsMask:", qword_100036BB8[v10]));
