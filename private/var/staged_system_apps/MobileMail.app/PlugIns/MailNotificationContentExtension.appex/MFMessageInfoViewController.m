...
+ (id)log
{
  ...
  block[4] = a1;
  if (qword_1000443A8 != -1)
    dispatch_once(&qword_1000443A8, block);
  return (id)qword_1000443A0;
}
...
- (void)viewDidLoad
{
  ...
  v3 = _EFLocalizedString(CFSTR("Info"), &unk_100043890, &unk_100043898);
...
- (id)_contactViewControllerForAddress:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      sub_10001DB28(v18, (uint64_t)v6, buf, v17);
    }
