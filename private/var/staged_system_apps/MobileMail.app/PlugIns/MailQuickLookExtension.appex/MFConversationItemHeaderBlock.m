...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100007870;
  block[3] = &unk_100034950;
  block[4] = a1;
  if (qword_10003FB78 != -1)
    dispatch_once(&qword_10003FB78, block);
  return (OS_os_log *)(id)qword_10003FB70;
}
...
- (MFConversationItemHeaderBlock)initWithFrame:(CGRect)a3 contactStore:(id)a4 accountsProvider:(id)a5
{
  ...
  if (v13)
  {
    ...
    byte_10003FB80 = objc_msgSend(v16, "BOOLForKey:", CFSTR("ShowMessageHeaderDetails"));

    v15->_showDetails = byte_10003FB80;
...
- (void)createPrimaryViews
{
  ...
  v16 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v15, "localizedStringForKey:value:table:", CFSTR("FROM_HEADER"), &stru_1000351F8, CFSTR("Main")));
  v17 = (void *)objc_claimAutoreleasedReturnValue(+[NSBundle mainBundle](NSBundle, "mainBundle"));
  v18 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v17, "localizedStringForKey:value:table:", CFSTR("FROM_TITLE"), &stru_1000351F8, CFSTR("Main")));
  ...
  if (self->_showDetails != v6)
  {
    if (-[MFConversationItemHeaderBlock _shouldSaveHeaderDetailsButtonSettings](self, "_shouldSaveHeaderDetailsButtonSettings"))
    {
      ...
      if (byte_10003FB80 != v6)
      {
        ...
        byte_10003FB80 = self->_showDetails;
      }
    }
  }
...
- (void)setOtherSigners:(id)a3
{
  ...
  v6 = (id)objc_claimAutoreleasedReturnValue(objc_msgSend(a3, "ef_map:", &stru_100034B70));
