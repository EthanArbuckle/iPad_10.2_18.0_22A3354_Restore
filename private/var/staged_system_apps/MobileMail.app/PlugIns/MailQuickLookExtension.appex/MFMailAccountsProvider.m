...
- (NSArray)receivingAddresses
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "ef_map:", &stru_100034C78));
...
- (id)_displayedAccountsIdentifiers
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[MFMailAccountsProvider displayedAccounts](self, "displayedAccounts"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "ef_compactMap:", &stru_100034D48));
  v4 = v3;
  if (v3)
    v5 = v3;
  else
...
- (id)_focusedAccountsIdentifiers
{
  ...
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "ef_compactMap:", &stru_100034D68));
...
- (NSSet)autofetchAccounts
{
  ...
  v2 = (void *)objc_claimAutoreleasedReturnValue(-[MFMailAccountsProvider displayedAccounts](self, "displayedAccounts"));
  v3 = (void *)objc_claimAutoreleasedReturnValue(objc_msgSend(v2, "ef_filter:", &stru_100034D88));
