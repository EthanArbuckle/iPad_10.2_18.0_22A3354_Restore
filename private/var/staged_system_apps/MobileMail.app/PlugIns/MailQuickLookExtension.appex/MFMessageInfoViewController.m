...
+ (id)log
{
  ...
  block[4] = a1;
  if (qword_10003FB90 != -1)
    dispatch_once(&qword_10003FB90, block);
  return (id)qword_10003FB88;
}
...
- (void)viewDidLoad
{
  ...
  v3 = _EFLocalizedString(CFSTR("Info"), &unk_10003F138, &unk_10003F140);
...
- (id)_contactViewControllerForAddress:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      sub_10001B9B0(v18, (uint64_t)v6, buf, v17);
    }
