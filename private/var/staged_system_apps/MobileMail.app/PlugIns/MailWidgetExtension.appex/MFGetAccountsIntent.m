...
- (MFGetAccountsIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v17 = v8;
  v19 = static String._unconditionallyBridgeFromObjectiveC(_:)(a4);
  v20 = v9;
  if (a5)
  {
  ...
  v11 = (MFGetAccountsIntent *)MFGetAccountsIntent.init(domain:verb:parametersByName:)(v16, v17, v19, v20, v13);
